...
{
    mEnabledFilters.insert(MurmurHash("PASESession"));
    mEnabledFilters.insert(MurmurHash("CASESession"));
    mEnabledFilters.insert(MurmurHash("NetworkCommissioning"));
    mEnabledFilters.insert(MurmurHash("GeneralCommissioning"));
    mEnabledFilters.insert(MurmurHash("OperationalCredentials"));
    mEnabledFilters.insert(MurmurHash("CASEServer"));
    mEnabledFilters.insert(MurmurHash("Fabric"));
}
