...
{
    VerifyOrDieWithMsg(::chip::Platform::MemoryDebugCheckPointer(buffer, buffer ? (buffer->alloc_size + kStructureSize) : 0),
                       chipSystemLayer, "%s:%d %s(): invalid pointer", nullptr, 0, nullptr);
}
#endif
