...
public:
    ...
    void HandleDispatchQueueEvents() override;
...
protected:
    ...
    void EnableTimer(TimerList::Node *);
    void DisableTimer(TimerList::Node *);
...
#if CONFIG_BUILD_FOR_HOST_UNIT_TEST
private:
    bool mInDrainMode = false;
    std::unordered_set<chip::System::TimerList::Node *> mTimerInDrainMode;
#endif
};
