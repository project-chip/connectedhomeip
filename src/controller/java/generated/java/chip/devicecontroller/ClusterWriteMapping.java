...
public class ClusterWriteMapping {
  public Map<String, Map<String, InteractionInfo>> getWriteAttributeMap() {
    ...
    Map<String, InteractionInfo> writeDishwasherControlInteractionInfo = new LinkedHashMap<>();
    Map<String, CommandParameterInfo> writeDishwasherControlSteamWashCommandParams = new LinkedHashMap<String, CommandParameterInfo>();
    CommandParameterInfo dishwasherControlsteamWashCommandParameterInfo =
        new CommandParameterInfo(
            "value", 
            Boolean.class, 
            Boolean.class 
        );
    writeDishwasherControlSteamWashCommandParams.put(
        "value",
        dishwasherControlsteamWashCommandParameterInfo
    );
    InteractionInfo writeDishwasherControlSteamWashAttributeInteractionInfo = new InteractionInfo(
      (cluster, callback, commandArguments) -> {
        ((ChipClusters.DishwasherControlCluster) cluster).writeSteamWashAttribute(
          (DefaultClusterCallback) callback,
          (Boolean) commandArguments.get("value")
        );
      },
      () -> new ClusterInfoMapping.DelegatedDefaultClusterCallback(),
      writeDishwasherControlSteamWashCommandParams
    );
    writeDishwasherControlInteractionInfo.put("writeSteamWashAttribute", writeDishwasherControlSteamWashAttributeInteractionInfo);
    Map<String, CommandParameterInfo> writeDishwasherControlHeatedDryCommandParams = new LinkedHashMap<String, CommandParameterInfo>();
    CommandParameterInfo dishwasherControlheatedDryCommandParameterInfo =
        new CommandParameterInfo(
            "value", 
            Boolean.class, 
            Boolean.class 
        );
    writeDishwasherControlHeatedDryCommandParams.put(
        "value",
        dishwasherControlheatedDryCommandParameterInfo
    );
    InteractionInfo writeDishwasherControlHeatedDryAttributeInteractionInfo = new InteractionInfo(
      (cluster, callback, commandArguments) -> {
        ((ChipClusters.DishwasherControlCluster) cluster).writeHeatedDryAttribute(
          (DefaultClusterCallback) callback,
          (Boolean) commandArguments.get("value")
        );
      },
      () -> new ClusterInfoMapping.DelegatedDefaultClusterCallback(),
      writeDishwasherControlHeatedDryCommandParams
    );
    writeDishwasherControlInteractionInfo.put("writeHeatedDryAttribute", writeDishwasherControlHeatedDryAttributeInteractionInfo);
    Map<String, CommandParameterInfo> writeDishwasherControlExtendedDryCommandParams = new LinkedHashMap<String, CommandParameterInfo>();
    CommandParameterInfo dishwasherControlextendedDryCommandParameterInfo =
        new CommandParameterInfo(
            "value", 
            Boolean.class, 
            Boolean.class 
        );
    writeDishwasherControlExtendedDryCommandParams.put(
        "value",
        dishwasherControlextendedDryCommandParameterInfo
    );
    InteractionInfo writeDishwasherControlExtendedDryAttributeInteractionInfo = new InteractionInfo(
      (cluster, callback, commandArguments) -> {
        ((ChipClusters.DishwasherControlCluster) cluster).writeExtendedDryAttribute(
          (DefaultClusterCallback) callback,
          (Boolean) commandArguments.get("value")
        );
      },
      () -> new ClusterInfoMapping.DelegatedDefaultClusterCallback(),
      writeDishwasherControlExtendedDryCommandParams
    );
    writeDishwasherControlInteractionInfo.put("writeExtendedDryAttribute", writeDishwasherControlExtendedDryAttributeInteractionInfo);
    writeAttributeMap.put("dishwasherControl", writeDishwasherControlInteractionInfo);
