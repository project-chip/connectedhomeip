...
public class ClusterWriteMapping {
  public Map<String, Map<String, InteractionInfo>> getWriteAttributeMap() {
    ...
    Map<String, CommandParameterInfo> writeDishwasherAlarmMaskCommandParams = new LinkedHashMap<String, CommandParameterInfo>();
    ...
    writeDishwasherAlarmMaskCommandParams.put(
        "value",
        dishwasherAlarmmaskCommandParameterInfo
    );
    InteractionInfo writeDishwasherAlarmMaskAttributeInteractionInfo = new InteractionInfo(
      (cluster, callback, commandArguments) -> {
        ((ChipClusters.DishwasherAlarmCluster) cluster).writeMaskAttribute(
          (DefaultClusterCallback) callback,
          (Long) commandArguments.get("value")
        );
      },
    ...
    writeDishwasherAlarmInteractionInfo.put("writeMaskAttribute", writeDishwasherAlarmMaskAttributeInteractionInfo);
