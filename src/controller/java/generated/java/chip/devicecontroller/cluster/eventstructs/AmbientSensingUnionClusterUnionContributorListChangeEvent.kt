...
class AmbientSensingUnionClusterUnionContributorListChangeEvent(
  val unionContributorList:
    List<chip.devicecontroller.cluster.structs.AmbientSensingUnionClusterUnionMemberStruct>
) {
  ...
  companion object {
    ...
    fun fromTlv(
      ...
      val unionContributorList =
        buildList<
          chip.devicecontroller.cluster.structs.AmbientSensingUnionClusterUnionMemberStruct
        > {
