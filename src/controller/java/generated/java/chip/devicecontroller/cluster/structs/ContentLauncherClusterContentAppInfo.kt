...
class ContentLauncherClusterContentAppInfo(
  val contentAppVendorID: UInt,
  val contentAppProductID: UInt,
  val data: String,
) {
  ...
  companion object {
    ...
    fun fromTlv(tlvTag: Tag, tlvReader: TlvReader): ContentLauncherClusterContentAppInfo {
      ...
      val contentAppVendorID = tlvReader.getUInt(ContextSpecificTag(TAG_CONTENT_APP_VENDOR_ID))
      val contentAppProductID = tlvReader.getUInt(ContextSpecificTag(TAG_CONTENT_APP_PRODUCT_ID))
