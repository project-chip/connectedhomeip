...
class TonerCartridgeMonitoringClusterReplacementProductStruct(
  ...
  override fun toString(): String = buildString {
    append("TonerCartridgeMonitoringClusterReplacementProductStruct {\n")
  ...
  companion object {
    ...
    fun fromTlv(
      tag: Tag,
      tlvReader: TlvReader
    ): TonerCartridgeMonitoringClusterReplacementProductStruct {
      ...
      return TonerCartridgeMonitoringClusterReplacementProductStruct(
