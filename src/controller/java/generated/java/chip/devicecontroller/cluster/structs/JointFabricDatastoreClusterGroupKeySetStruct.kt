...
class JointFabricDatastoreClusterGroupKeySetStruct(
  ...
  override fun toString(): String = buildString {
    append("JointFabricDatastoreClusterGroupKeySetStruct {\n")
  ...
  companion object {
    ...
    fun fromTlv(tlvTag: Tag, tlvReader: TlvReader): JointFabricDatastoreClusterGroupKeySetStruct {
      ...
      return JointFabricDatastoreClusterGroupKeySetStruct(
        groupKeySetID,
