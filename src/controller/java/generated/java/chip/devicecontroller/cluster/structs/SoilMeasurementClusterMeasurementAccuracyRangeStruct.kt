...
class SoilMeasurementClusterMeasurementAccuracyRangeStruct (
    val rangeMin: Long,
    val rangeMax: Long,
  ...
  companion object {
    ...
    fun fromTlv(tlvTag: Tag, tlvReader: TlvReader) : SoilMeasurementClusterMeasurementAccuracyRangeStruct {
      ...
      return SoilMeasurementClusterMeasurementAccuracyRangeStruct(rangeMin, rangeMax, percentMax, percentMin, percentTypical, fixedMax, fixedMin, fixedTypical)
    }
  }
}
