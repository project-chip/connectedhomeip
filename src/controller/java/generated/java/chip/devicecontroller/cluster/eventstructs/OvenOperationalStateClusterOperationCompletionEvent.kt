...
class OvenOperationalStateClusterOperationCompletionEvent(
  val completionErrorCode: UInt,
  val totalOperationalTime: Optional<ULong>?,
  val pausedTime: Optional<ULong>?
) {
  override fun toString(): String = buildString {
    append("OvenOperationalStateClusterOperationCompletionEvent {\n")
  ...
  companion object {
    ...
    fun fromTlv(
      ...
      return OvenOperationalStateClusterOperationCompletionEvent(
        completionErrorCode,
