...
class ElectricalAlarmClusterNotifyEvent(
  val active: ULong,
  val inactive: ULong,
  val state: ULong,
  val mask: ULong,
  ...
  override fun toString(): String = buildString {
    append("ElectricalAlarmClusterNotifyEvent {\n")
  ...
  companion object {
    ...
    fun fromTlv(tlvTag: Tag, tlvReader: TlvReader): ElectricalAlarmClusterNotifyEvent {
      ...
      return ElectricalAlarmClusterNotifyEvent(active, inactive, state, mask)
    }
  }
}
