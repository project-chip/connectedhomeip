...
class MediaFileManagementClusterSharedFilesAddedEvent(val requestID: UInt, val responseID: UInt) {
  ...
  companion object {
    ...
    fun fromTlv(
      ...
      val requestID = tlvReader.getUInt(ContextSpecificTag(TAG_REQUEST_ID))
      val responseID = tlvReader.getUInt(ContextSpecificTag(TAG_RESPONSE_ID))
