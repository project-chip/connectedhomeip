...
class DemandReponseLoadControlClusterLoadControlEventStatusChangeEvent (
    ...
    val control: UInt,
    val temperatureControl: chip.devicecontroller.cluster.structs.DemandReponseLoadControlClusterTemperatureControlStruct,
    val averageLoadControl: chip.devicecontroller.cluster.structs.DemandReponseLoadControlClusterAverageLoadControlStruct,
    val dutyCycleControl: chip.devicecontroller.cluster.structs.DemandReponseLoadControlClusterDutyCycleControlStruct,
    val powerSavingsControl: chip.devicecontroller.cluster.structs.DemandReponseLoadControlClusterPowerSavingsControlStruct,
    val heatingSourceControl: chip.devicecontroller.cluster.structs.DemandReponseLoadControlClusterHeatingSourceControlStruct,
  ...
  companion object {
    ...
    fun fromTlv(tlvTag: Tag, tlvReader: TlvReader) : DemandReponseLoadControlClusterLoadControlEventStatusChangeEvent {
      ...
      val temperatureControl = chip.devicecontroller.cluster.structs.DemandReponseLoadControlClusterTemperatureControlStruct.fromTlv(ContextSpecificTag(TAG_TEMPERATURE_CONTROL), tlvReader)
      val averageLoadControl = chip.devicecontroller.cluster.structs.DemandReponseLoadControlClusterAverageLoadControlStruct.fromTlv(ContextSpecificTag(TAG_AVERAGE_LOAD_CONTROL), tlvReader)
      val dutyCycleControl = chip.devicecontroller.cluster.structs.DemandReponseLoadControlClusterDutyCycleControlStruct.fromTlv(ContextSpecificTag(TAG_DUTY_CYCLE_CONTROL), tlvReader)
      val powerSavingsControl = chip.devicecontroller.cluster.structs.DemandReponseLoadControlClusterPowerSavingsControlStruct.fromTlv(ContextSpecificTag(TAG_POWER_SAVINGS_CONTROL), tlvReader)
      val heatingSourceControl = chip.devicecontroller.cluster.structs.DemandReponseLoadControlClusterHeatingSourceControlStruct.fromTlv(ContextSpecificTag(TAG_HEATING_SOURCE_CONTROL), tlvReader)
