...
class GroupKeyManagementClusterGroupKeySetStruct (
  ...
  companion object {
    ...
    fun fromTlv(tlvTag: Tag, tlvReader: TlvReader) : GroupKeyManagementClusterGroupKeySetStruct {
      ...
      val groupKeyMulticastPolicy = tlvReader.getUInt(ContextSpecificTag(TAG_GROUP_KEY_MULTICAST_POLICY))
      
      tlvReader.exitContainer()

      return GroupKeyManagementClusterGroupKeySetStruct(groupKeySetID, groupKeySecurityPolicy, epochKey0, epochStartTime0, epochKey1, epochStartTime1, epochKey2, epochStartTime2, groupKeyMulticastPolicy)
    }
  }
}
