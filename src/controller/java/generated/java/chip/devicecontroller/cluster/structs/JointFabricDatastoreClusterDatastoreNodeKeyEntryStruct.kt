...
class JointFabricDatastoreClusterDatastoreNodeKeyEntryStruct(
  val nodeID: ULong,
  val groupKeySetId: UInt,
  val statusEntry: JointFabricDatastoreClusterDatastoreStatusEntryStruct,
) {
  override fun toString(): String = buildString {
    append("JointFabricDatastoreClusterDatastoreNodeKeyEntryStruct {\n")
  ...
  companion object {
    ...
    fun fromTlv(
      tlvTag: Tag,
      tlvReader: TlvReader,
    ): JointFabricDatastoreClusterDatastoreNodeKeyEntryStruct {
      ...
      return JointFabricDatastoreClusterDatastoreNodeKeyEntryStruct(
        nodeID,
        groupKeySetId,
        statusEntry,
      )
