...
class DeviceEnergyManagementClusterPowerRangeAdjustEndEvent(
  val cause: UInt,
  val duration: ULong,
  val energyUse: Long,
) {
  override fun toString(): String = buildString {
    append("DeviceEnergyManagementClusterPowerRangeAdjustEndEvent {\n")
    append("\tcause : $cause\n")
  ...
  companion object {
    ...
    fun fromTlv(
      tlvTag: Tag,
      tlvReader: TlvReader,
    ): DeviceEnergyManagementClusterPowerRangeAdjustEndEvent {
      ...
      return DeviceEnergyManagementClusterPowerRangeAdjustEndEvent(cause, duration, energyUse)
    }
  }
}
