...
class ElectricalProtectionAlarmClusterNotifyEvent(
  val active: ULong,
  val inactive: ULong,
  val state: ULong,
  val mask: ULong,
  ...
  override fun toString(): String = buildString {
    append("ElectricalProtectionAlarmClusterNotifyEvent {\n")
  ...
  companion object {
    ...
    fun fromTlv(tlvTag: Tag, tlvReader: TlvReader): ElectricalProtectionAlarmClusterNotifyEvent {
      ...
      return ElectricalProtectionAlarmClusterNotifyEvent(active, inactive, state, mask)
    }
  }
}
