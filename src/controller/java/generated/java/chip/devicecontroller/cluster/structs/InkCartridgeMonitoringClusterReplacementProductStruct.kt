...
class InkCartridgeMonitoringClusterReplacementProductStruct(
  ...
  override fun toString(): String = buildString {
    append("InkCartridgeMonitoringClusterReplacementProductStruct {\n")
  ...
  companion object {
    ...
    fun fromTlv(
      tag: Tag,
      tlvReader: TlvReader
    ): InkCartridgeMonitoringClusterReplacementProductStruct {
      ...
      return InkCartridgeMonitoringClusterReplacementProductStruct(
