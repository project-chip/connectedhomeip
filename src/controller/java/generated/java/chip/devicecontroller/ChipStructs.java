...
public static class BasicInformationClusterHomeLocationStruct {
  ...
  public BasicInformationClusterHomeLocationStruct(
    String locationName,
  ...
  public static BasicInformationClusterHomeLocationStruct decodeTlv(BaseTLVType tlvValue) {
    if (tlvValue == null || tlvValue.type() != TLVType.Struct) {
      return null;
    }
    ...
    return new BasicInformationClusterHomeLocationStruct(
      locationName,
      floorNumber,
      areaType
    );
  ...
  public String toString() {
    StringBuilder output = new StringBuilder();
    output.append("BasicInformationClusterHomeLocationStruct {\n");
