...
public static class JointFabricDatastoreClusterDatastoreEndpointGroupIDEntry {
  public Long nodeID;
  public Integer endpointID;
  public Integer groupID;
  public ChipStructs.JointFabricDatastoreClusterDatastoreStatusEntry statusEntry;
  ...
  public JointFabricDatastoreClusterDatastoreEndpointGroupIDEntry(
    Long nodeID,
    Integer endpointID,
    Integer groupID,
    ChipStructs.JointFabricDatastoreClusterDatastoreStatusEntry statusEntry
  ...
  public static JointFabricDatastoreClusterDatastoreEndpointGroupIDEntry decodeTlv(BaseTLVType tlvValue) {
    if (tlvValue == null || tlvValue.type() != TLVType.Struct) {
      return null;
    }
    Long nodeID = null;
    ...
    return new JointFabricDatastoreClusterDatastoreEndpointGroupIDEntry(
      nodeID,
      endpointID,
      groupID,
      statusEntry
  ...
  public String toString() {
    StringBuilder output = new StringBuilder();
    output.append("JointFabricDatastoreClusterDatastoreEndpointGroupIDEntry {\n");
    output.append("\tnodeID: ");
    output.append(nodeID);
    output.append("\n");
    output.append("\tendpointID: ");
...
public static class JointFabricDatastoreClusterDatastoreEndpointBindingEntry {
  public Long nodeID;
  public Integer endpointID;
  public Integer listID;
  public ChipStructs.JointFabricDatastoreClusterTargetStruct binding;
  public ChipStructs.JointFabricDatastoreClusterDatastoreStatusEntry statusEntry;
  private static final long NODE_ID_ID = 0L;
  private static final long ENDPOINT_ID_ID = 1L;
  ...
  public JointFabricDatastoreClusterDatastoreEndpointBindingEntry(
    Long nodeID,
    Integer endpointID,
    Integer listID,
    ChipStructs.JointFabricDatastoreClusterTargetStruct binding,
    ChipStructs.JointFabricDatastoreClusterDatastoreStatusEntry statusEntry
  ) {
    this.nodeID = nodeID;
    this.endpointID = endpointID;
  ...
  public static JointFabricDatastoreClusterDatastoreEndpointBindingEntry decodeTlv(BaseTLVType tlvValue) {
    if (tlvValue == null || tlvValue.type() != TLVType.Struct) {
      return null;
    }
    Long nodeID = null;
    Integer endpointID = null;
    Integer listID = null;
    ChipStructs.JointFabricDatastoreClusterTargetStruct binding = null;
    ChipStructs.JointFabricDatastoreClusterDatastoreStatusEntry statusEntry = null;
    for (StructElement element: ((StructType)tlvValue).value()) {
      if (element.contextTagNum() == NODE_ID_ID) {
        if (element.value(BaseTLVType.class).type() == TLVType.UInt) {
        ...
        if (element.value(BaseTLVType.class).type() == TLVType.Struct) {
          StructType castingValue = element.value(StructType.class);
          binding = ChipStructs.JointFabricDatastoreClusterTargetStruct.decodeTlv(castingValue);
        }
      } else if (element.contextTagNum() == STATUS_ENTRY_ID) {
        if (element.value(BaseTLVType.class).type() == TLVType.Struct) {
          StructType castingValue = element.value(StructType.class);
    ...
    return new JointFabricDatastoreClusterDatastoreEndpointBindingEntry(
      nodeID,
      endpointID,
      listID,
      binding,
  ...
  public String toString() {
    StringBuilder output = new StringBuilder();
    output.append("JointFabricDatastoreClusterDatastoreEndpointBindingEntry {\n");
    output.append("\tnodeID: ");
    output.append(nodeID);
    output.append("\n");
    output.append("\tendpointID: ");
...
public static class JointFabricDatastoreClusterDatastoreACLEntry {
  public Long nodeID;
  public Integer listID;
  public ChipStructs.JointFabricDatastoreClusterAccessControlEntryStruct ACLEntry;
  public ChipStructs.JointFabricDatastoreClusterDatastoreStatusEntry statusEntry;
  private static final long NODE_ID_ID = 0L;
  ...
  public JointFabricDatastoreClusterDatastoreACLEntry(
    Long nodeID,
    Integer listID,
    ChipStructs.JointFabricDatastoreClusterAccessControlEntryStruct ACLEntry,
    ChipStructs.JointFabricDatastoreClusterDatastoreStatusEntry statusEntry
  ) {
    this.nodeID = nodeID;
    this.listID = listID;
  ...
  public static JointFabricDatastoreClusterDatastoreACLEntry decodeTlv(BaseTLVType tlvValue) {
    ...
    Long nodeID = null;
    Integer listID = null;
    ChipStructs.JointFabricDatastoreClusterAccessControlEntryStruct ACLEntry = null;
    ChipStructs.JointFabricDatastoreClusterDatastoreStatusEntry statusEntry = null;
    for (StructElement element: ((StructType)tlvValue).value()) {
      if (element.contextTagNum() == NODE_ID_ID) {
        if (element.value(BaseTLVType.class).type() == TLVType.UInt) {
        ...
        if (element.value(BaseTLVType.class).type() == TLVType.Struct) {
          StructType castingValue = element.value(StructType.class);
          ACLEntry = ChipStructs.JointFabricDatastoreClusterAccessControlEntryStruct.decodeTlv(castingValue);
        }
      } else if (element.contextTagNum() == STATUS_ENTRY_ID) {
        if (element.value(BaseTLVType.class).type() == TLVType.Struct) {
          StructType castingValue = element.value(StructType.class);
