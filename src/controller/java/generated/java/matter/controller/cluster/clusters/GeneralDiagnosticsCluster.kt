...
class GeneralDiagnosticsCluster(private val controller: MatterController, private val endpointId: UShort) {
  class TimeSnapshotResponse(
    val systemTimeMs: ULong, 
    val posixTimeMs: ULong?
  )

  class PayloadTestResponse(
...
class NetworkInterfacesAttribute(
  ...
  sealed class NetworkInterfacesAttributeSubscriptionState {
    data class Success(
    val value: List<GeneralDiagnosticsClusterNetworkInterface>
    ) : NetworkInterfacesAttributeSubscriptionState()
    
    data class Error(val exception: Exception) : NetworkInterfacesAttributeSubscriptionState()

    object SubscriptionEstablished : NetworkInterfacesAttributeSubscriptionState()    
  }  
class ActiveHardwareFaultsAttribute(
    val value: List<UByte>?
  )

  sealed class ActiveHardwareFaultsAttributeSubscriptionState {
    data class Success(
    val value: List<UByte>?
    ) : ActiveHardwareFaultsAttributeSubscriptionState()
    
    data class Error(val exception: Exception) : ActiveHardwareFaultsAttributeSubscriptionState()

    object SubscriptionEstablished : ActiveHardwareFaultsAttributeSubscriptionState()    
  }  
class ActiveRadioFaultsAttribute(
    val value: List<UByte>?
  )

  sealed class ActiveRadioFaultsAttributeSubscriptionState {
    data class Success(
    val value: List<UByte>?
    ) : ActiveRadioFaultsAttributeSubscriptionState()
    
    data class Error(val exception: Exception) : ActiveRadioFaultsAttributeSubscriptionState()

    object SubscriptionEstablished : ActiveRadioFaultsAttributeSubscriptionState()    
  }  
class ActiveNetworkFaultsAttribute(
    val value: List<UByte>?
  )

  sealed class ActiveNetworkFaultsAttributeSubscriptionState {
    data class Success(
    val value: List<UByte>?
    ) : ActiveNetworkFaultsAttributeSubscriptionState()
    
    data class Error(val exception: Exception) : ActiveNetworkFaultsAttributeSubscriptionState()

    object SubscriptionEstablished : ActiveNetworkFaultsAttributeSubscriptionState()    
  }  
class DeviceLoadStatusAttribute(
    val value: GeneralDiagnosticsClusterDeviceLoadStruct?
  )
...
class AttributeListAttribute(
  ...
  suspend fun testEventTrigger(enableKey: ByteArray
      ,eventTrigger: ULong
  ...
  suspend fun timeSnapshot(timedInvokeTimeout: Duration? = null): TimeSnapshotResponse {
    ...
    while (!tlvReader.isEndOfContainer()) {
      ...
      if (tag == ContextSpecificTag(TAG_SYSTEM_TIME_MS)) {systemTimeMs_decoded = tlvReader.getULong(tag)} else
      
      if (tag == ContextSpecificTag(TAG_POSIX_TIME_MS)) {posixTimeMs_decoded = 
          if (tlvReader.isNull()) {
    ...
    return TimeSnapshotResponse(
      systemTimeMs_decoded,
      posixTimeMs_decoded
    )
  }

  suspend fun payloadTestRequest(enableKey: ByteArray
      ,value: UByte
      ,count: UShort
      ,timedInvokeTimeout: Duration? = null): PayloadTestResponse {
...
suspend fun readNetworkInterfacesAttribute(): NetworkInterfacesAttribute {val ATTRIBUTE_ID: UInt = 0u
    ...
    requireNotNull(attributeData) { 
      "Networkinterfaces attribute not found in response" 
    }

    // Decode the TLV data into the appropriate type
    val tlvReader = TlvReader(attributeData.data)
    val decodedValue: List<GeneralDiagnosticsClusterNetworkInterface> = buildList<GeneralDiagnosticsClusterNetworkInterface> {
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(NetworkInterfacesAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { 
            "Networkinterfaces attribute not found in Node State update" 
          }
      ...
      tlvReader.exitContainer()
          ...
          emit(NetworkInterfacesAttributeSubscriptionState.Success(decodedValue))
        }
        SubscriptionState.SubscriptionEstablished -> {
          emit(NetworkInterfacesAttributeSubscriptionState.SubscriptionEstablished)
        }
      }
    }    
  }
suspend fun readRebootCountAttribute(): UShort {val ATTRIBUTE_ID: UInt = 1u
    ...
    requireNotNull(attributeData) { 
      "Rebootcount attribute not found in response" 
    }
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { 
            "Rebootcount attribute not found in Node State update" 
          }
...
suspend fun readUpTimeAttribute(): ULong? {val ATTRIBUTE_ID: UInt = 2u
    ...
    requireNotNull(attributeData) { 
      "Uptime attribute not found in response" 
    }
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { 
            "Uptime attribute not found in Node State update" 
          }
...
suspend fun readTotalOperationalHoursAttribute(): UInt? {val ATTRIBUTE_ID: UInt = 3u
    ...
    requireNotNull(attributeData) { 
      "Totaloperationalhours attribute not found in response" 
    }
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { 
            "Totaloperationalhours attribute not found in Node State update" 
          }
...
suspend fun readBootReasonAttribute(): UByte? {val ATTRIBUTE_ID: UInt = 4u
    ...
    requireNotNull(attributeData) { 
      "Bootreason attribute not found in response" 
    }
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { 
            "Bootreason attribute not found in Node State update" 
          }
...
suspend fun readActiveHardwareFaultsAttribute(): ActiveHardwareFaultsAttribute {val ATTRIBUTE_ID: UInt = 5u
    ...
    requireNotNull(attributeData) { 
      "Activehardwarefaults attribute not found in response" 
    }
  ...
  suspend fun subscribeActiveHardwareFaultsAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(ActiveHardwareFaultsAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
          ...
          requireNotNull(attributeData) { 
            "Activehardwarefaults attribute not found in Node State update" 
          }
      ...
      null
          ...
          decodedValue?.let {
            emit(ActiveHardwareFaultsAttributeSubscriptionState.Success(it))
          }
          
        }
        SubscriptionState.SubscriptionEstablished -> {
          emit(ActiveHardwareFaultsAttributeSubscriptionState.SubscriptionEstablished)
        }
      }
    }    
  }
suspend fun readActiveRadioFaultsAttribute(): ActiveRadioFaultsAttribute {val ATTRIBUTE_ID: UInt = 6u
    ...
    requireNotNull(attributeData) { 
      "Activeradiofaults attribute not found in response" 
    }
  ...
  suspend fun subscribeActiveRadioFaultsAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(ActiveRadioFaultsAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
          ...
          requireNotNull(attributeData) { 
            "Activeradiofaults attribute not found in Node State update" 
          }
      ...
      null
          ...
          decodedValue?.let {
            emit(ActiveRadioFaultsAttributeSubscriptionState.Success(it))
          }
          
        }
        SubscriptionState.SubscriptionEstablished -> {
          emit(ActiveRadioFaultsAttributeSubscriptionState.SubscriptionEstablished)
        }
      }
    }    
  }
suspend fun readActiveNetworkFaultsAttribute(): ActiveNetworkFaultsAttribute {val ATTRIBUTE_ID: UInt = 7u
    ...
    requireNotNull(attributeData) { 
      "Activenetworkfaults attribute not found in response" 
    }
  ...
  suspend fun subscribeActiveNetworkFaultsAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(ActiveNetworkFaultsAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
          ...
          requireNotNull(attributeData) { 
            "Activenetworkfaults attribute not found in Node State update" 
          }
      ...
      null
          ...
          decodedValue?.let {
            emit(ActiveNetworkFaultsAttributeSubscriptionState.Success(it))
          }
          
        }
        SubscriptionState.SubscriptionEstablished -> {
          emit(ActiveNetworkFaultsAttributeSubscriptionState.SubscriptionEstablished)
        }
      }
    }    
  }
suspend fun readTestEventTriggersEnabledAttribute(): Boolean {val ATTRIBUTE_ID: UInt = 8u
    ...
    requireNotNull(attributeData) { 
      "Testeventtriggersenabled attribute not found in response" 
    }
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { 
            "Testeventtriggersenabled attribute not found in Node State update" 
          }
...
suspend fun readDeviceLoadStatusAttribute(): DeviceLoadStatusAttribute {val ATTRIBUTE_ID: UInt = 10u
    ...
    requireNotNull(attributeData) { 
      "Deviceloadstatus attribute not found in response" 
    }

    // Decode the TLV data into the appropriate type
    val tlvReader = TlvReader(attributeData.data)
    val decodedValue: GeneralDiagnosticsClusterDeviceLoadStruct? = if (tlvReader.isNextTag(AnonymousTag)) {
  ...
  suspend fun subscribeDeviceLoadStatusAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(DeviceLoadStatusAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
      ...
      null
          ...
          decodedValue?.let {
            emit(DeviceLoadStatusAttributeSubscriptionState.Success(it))
          }
