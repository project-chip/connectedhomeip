...
class SmokeConcentrationMeasurementCluster(
  ...
  companion object {
    private val logger = Logger.getLogger(SmokeConcentrationMeasurementCluster::class.java.name)
    const val CLUSTER_ID: UInt = 1076u
  }
}
