...
class FanControlCluster(private val controller: MatterController, private val endpointId: UShort) {class PercentSettingAttribute(
    val value: UByte?
  )

  sealed class PercentSettingAttributeSubscriptionState {
    data class Success(
    val value: UByte?
    ) : PercentSettingAttributeSubscriptionState()
    
    data class Error(val exception: Exception) : PercentSettingAttributeSubscriptionState()

    object SubscriptionEstablished : PercentSettingAttributeSubscriptionState()    
  }  
class SpeedSettingAttribute(
    val value: UByte?
  )

  sealed class SpeedSettingAttributeSubscriptionState {
    data class Success(
    val value: UByte?
    ) : SpeedSettingAttributeSubscriptionState()
    
    data class Error(val exception: Exception) : SpeedSettingAttributeSubscriptionState()

    object SubscriptionEstablished : SpeedSettingAttributeSubscriptionState()    
  }  
...
class AttributeListAttribute(
  ...
  suspend fun step(direction: UByte
      ,wrap: Boolean?
      ,lowestOff: Boolean?
    ...
    val TAG_WRAP_REQ: Int = 1
    wrap?.let {
      tlvWriter.put(ContextSpecificTag(TAG_WRAP_REQ), wrap)
    }

    val TAG_LOWEST_OFF_REQ: Int = 2
    lowestOff?.let {
      tlvWriter.put(ContextSpecificTag(TAG_LOWEST_OFF_REQ), lowestOff)
    }    
...
suspend fun readFanModeAttribute(): UByte {val ATTRIBUTE_ID: UInt = 0u
    ...
    requireNotNull(attributeData) { 
      "Fanmode attribute not found in response" 
    }
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { 
            "Fanmode attribute not found in Node State update" 
          }
...
suspend fun readFanModeSequenceAttribute(): UByte {val ATTRIBUTE_ID: UInt = 1u
    ...
    requireNotNull(attributeData) { 
      "Fanmodesequence attribute not found in response" 
    }
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { 
            "Fanmodesequence attribute not found in Node State update" 
          }
...
suspend fun readPercentSettingAttribute(): PercentSettingAttribute {val ATTRIBUTE_ID: UInt = 2u
    ...
    requireNotNull(attributeData) { 
      "Percentsetting attribute not found in response" 
    }
    ...
    return PercentSettingAttribute(decodedValue)
  }
  ...
  suspend fun subscribePercentSettingAttribute(
    minInterval: Int,
    maxInterval: Int
  ): Flow<PercentSettingAttributeSubscriptionState> {
    val ATTRIBUTE_ID: UInt = 2u
    val attributePaths = listOf(
      AttributePath(
          endpointId = endpointId,
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(PercentSettingAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
          ...
          requireNotNull(attributeData) { 
            "Percentsetting attribute not found in Node State update" 
          }
      ...
      null
          ...
          decodedValue?.let {
            emit(PercentSettingAttributeSubscriptionState.Success(it))
          }
          
        }
        SubscriptionState.SubscriptionEstablished -> {
          emit(PercentSettingAttributeSubscriptionState.SubscriptionEstablished)
        }
      }
    }    
  }
suspend fun readPercentCurrentAttribute(): UByte {val ATTRIBUTE_ID: UInt = 3u
    ...
    requireNotNull(attributeData) { 
      "Percentcurrent attribute not found in response" 
    }
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { 
            "Percentcurrent attribute not found in Node State update" 
          }
...
suspend fun readSpeedMaxAttribute(): UByte? {val ATTRIBUTE_ID: UInt = 4u
    ...
    requireNotNull(attributeData) { 
      "Speedmax attribute not found in response" 
    }
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { 
            "Speedmax attribute not found in Node State update" 
          }
...
suspend fun readSpeedSettingAttribute(): SpeedSettingAttribute {val ATTRIBUTE_ID: UInt = 5u
    ...
    requireNotNull(attributeData) { 
      "Speedsetting attribute not found in response" 
    }
    ...
    return SpeedSettingAttribute(decodedValue)
  }
  ...
  suspend fun subscribeSpeedSettingAttribute(
    minInterval: Int,
    maxInterval: Int
  ): Flow<SpeedSettingAttributeSubscriptionState> {
    val ATTRIBUTE_ID: UInt = 5u
    val attributePaths = listOf(
      AttributePath(
          endpointId = endpointId,
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(SpeedSettingAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
          ...
          requireNotNull(attributeData) { 
            "Speedsetting attribute not found in Node State update" 
          }
      ...
      null
          ...
          decodedValue?.let {
            emit(SpeedSettingAttributeSubscriptionState.Success(it))
          }
          
        }
        SubscriptionState.SubscriptionEstablished -> {
          emit(SpeedSettingAttributeSubscriptionState.SubscriptionEstablished)
        }
      }
    }    
  }
suspend fun readSpeedCurrentAttribute(): UByte? {val ATTRIBUTE_ID: UInt = 6u
    ...
    requireNotNull(attributeData) { 
      "Speedcurrent attribute not found in response" 
    }
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { 
            "Speedcurrent attribute not found in Node State update" 
          }
...
suspend fun readRockSupportAttribute(): UByte? {val ATTRIBUTE_ID: UInt = 7u
    ...
    requireNotNull(attributeData) { 
      "Rocksupport attribute not found in response" 
    }
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { 
            "Rocksupport attribute not found in Node State update" 
          }
...
suspend fun readRockSettingAttribute(): UByte? {val ATTRIBUTE_ID: UInt = 8u
    ...
    requireNotNull(attributeData) { 
      "Rocksetting attribute not found in response" 
    }
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { 
            "Rocksetting attribute not found in Node State update" 
          }
...
suspend fun readWindSupportAttribute(): UByte? {val ATTRIBUTE_ID: UInt = 9u
    ...
    requireNotNull(attributeData) { 
      "Windsupport attribute not found in response" 
    }
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { 
            "Windsupport attribute not found in Node State update" 
          }
...
suspend fun readWindSettingAttribute(): UByte? {val ATTRIBUTE_ID: UInt = 10u
    ...
    requireNotNull(attributeData) { 
      "Windsetting attribute not found in response" 
    }
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { 
            "Windsetting attribute not found in Node State update" 
          }
...
suspend fun readAirflowDirectionAttribute(): UByte? {val ATTRIBUTE_ID: UInt = 11u
    ...
    requireNotNull(attributeData) { 
      "Airflowdirection attribute not found in response" 
    }
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { 
            "Airflowdirection attribute not found in Node State update" 
          }
...
suspend fun readClusterRevisionAttribute(): UShort {val ATTRIBUTE_ID: UInt = 65533u
  ...
  companion object {
    private val logger = Logger.getLogger(FanControlCluster::class.java.name)
