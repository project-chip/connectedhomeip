...
class WaterHeaterManagementCluster(private val controller: MatterController, private val endpointId: UShort) {class GeneratedCommandListAttribute(
    val value: List<UInt>
  )
...
class AttributeListAttribute(
  ...
  suspend fun boost(duration: UInt
      ,oneShot: Boolean?
    ...
    oneShot?.let {
      tlvWriter.put(ContextSpecificTag(TAG_ONE_SHOT_REQ), oneShot)
    }
    ...
    targetReheat?.let {
      tlvWriter.put(ContextSpecificTag(TAG_TARGET_REHEAT_REQ), targetReheat)
    }    
...
suspend fun readHeaterTypesAttribute(): UByte {val ATTRIBUTE_ID: UInt = 0u
    ...
    requireNotNull(attributeData) { 
      "Heatertypes attribute not found in response" 
    }
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { 
            "Heatertypes attribute not found in Node State update" 
          }
...
suspend fun readHeatDemandAttribute(): UByte {val ATTRIBUTE_ID: UInt = 1u
    ...
    requireNotNull(attributeData) { 
      "Heatdemand attribute not found in response" 
    }
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { 
            "Heatdemand attribute not found in Node State update" 
          }
...
suspend fun readTankVolumeAttribute(): UShort? {val ATTRIBUTE_ID: UInt = 2u
    ...
    requireNotNull(attributeData) { 
      "Tankvolume attribute not found in response" 
    }
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { 
            "Tankvolume attribute not found in Node State update" 
          }
...
suspend fun readEstimatedHeatRequiredAttribute(): Long? {val ATTRIBUTE_ID: UInt = 3u
    ...
    requireNotNull(attributeData) { 
      "Estimatedheatrequired attribute not found in response" 
    }
...
suspend fun readTankPercentageAttribute(): UByte? {val ATTRIBUTE_ID: UInt = 4u
    ...
    requireNotNull(attributeData) { 
      "Tankpercentage attribute not found in response" 
    }
...
suspend fun readBoostStateAttribute(): UByte {val ATTRIBUTE_ID: UInt = 5u
    ...
    requireNotNull(attributeData) { 
      "Booststate attribute not found in response" 
    }
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { 
            "Booststate attribute not found in Node State update" 
          }
