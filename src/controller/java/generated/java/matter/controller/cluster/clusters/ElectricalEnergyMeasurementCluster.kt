...
class ElectricalEnergyMeasurementCluster(private val controller: MatterController, private val endpointId: UShort) {class AccuracyAttribute(
    val value: ElectricalEnergyMeasurementClusterMeasurementAccuracyStruct
  )
...
class CumulativeEnergyImportedAttribute(
  ...
  sealed class CumulativeEnergyImportedAttributeSubscriptionState {
    data class Success(
    val value: ElectricalEnergyMeasurementClusterEnergyMeasurementStruct?
    ) : CumulativeEnergyImportedAttributeSubscriptionState()
    
    data class Error(val exception: Exception) : CumulativeEnergyImportedAttributeSubscriptionState()

    object SubscriptionEstablished : CumulativeEnergyImportedAttributeSubscriptionState()    
  }  
class CumulativeEnergyExportedAttribute(
    val value: ElectricalEnergyMeasurementClusterEnergyMeasurementStruct?
  )

  sealed class CumulativeEnergyExportedAttributeSubscriptionState {
    data class Success(
    val value: ElectricalEnergyMeasurementClusterEnergyMeasurementStruct?
    ) : CumulativeEnergyExportedAttributeSubscriptionState()
    
    data class Error(val exception: Exception) : CumulativeEnergyExportedAttributeSubscriptionState()

    object SubscriptionEstablished : CumulativeEnergyExportedAttributeSubscriptionState()    
  }  
class PeriodicEnergyImportedAttribute(
    val value: ElectricalEnergyMeasurementClusterEnergyMeasurementStruct?
  )

  sealed class PeriodicEnergyImportedAttributeSubscriptionState {
    data class Success(
    val value: ElectricalEnergyMeasurementClusterEnergyMeasurementStruct?
    ) : PeriodicEnergyImportedAttributeSubscriptionState()
...
class PeriodicEnergyExportedAttribute(
  ...
  sealed class PeriodicEnergyExportedAttributeSubscriptionState {
    data class Success(
    val value: ElectricalEnergyMeasurementClusterEnergyMeasurementStruct?
    ) : PeriodicEnergyExportedAttributeSubscriptionState()
...
suspend fun readAccuracyAttribute(): AccuracyAttribute {val ATTRIBUTE_ID: UInt = 0u
    ...
    requireNotNull(attributeData) { 
      "Accuracy attribute not found in response" 
    }

    // Decode the TLV data into the appropriate type
    val tlvReader = TlvReader(attributeData.data)
    val decodedValue: ElectricalEnergyMeasurementClusterMeasurementAccuracyStruct = ElectricalEnergyMeasurementClusterMeasurementAccuracyStruct.fromTlv(AnonymousTag, tlvReader)
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(AccuracyAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { 
            "Accuracy attribute not found in Node State update" 
          }
...
suspend fun readCumulativeEnergyImportedAttribute(): CumulativeEnergyImportedAttribute {val ATTRIBUTE_ID: UInt = 1u
    ...
    requireNotNull(attributeData) { 
      "Cumulativeenergyimported attribute not found in response" 
    }

    // Decode the TLV data into the appropriate type
    val tlvReader = TlvReader(attributeData.data)
    val decodedValue: ElectricalEnergyMeasurementClusterEnergyMeasurementStruct? = if (!tlvReader.isNull()) {
  ...
  suspend fun subscribeCumulativeEnergyImportedAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(CumulativeEnergyImportedAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
          ...
          requireNotNull(attributeData) { 
            "Cumulativeenergyimported attribute not found in Node State update" 
          }
      ...
      null
          ...
          decodedValue?.let {
            emit(CumulativeEnergyImportedAttributeSubscriptionState.Success(it))
          }
          
        }
        SubscriptionState.SubscriptionEstablished -> {
          emit(CumulativeEnergyImportedAttributeSubscriptionState.SubscriptionEstablished)
        }
      }
    }    
  }
suspend fun readCumulativeEnergyExportedAttribute(): CumulativeEnergyExportedAttribute {val ATTRIBUTE_ID: UInt = 2u
    ...
    requireNotNull(attributeData) { 
      "Cumulativeenergyexported attribute not found in response" 
    }
  ...
  suspend fun subscribeCumulativeEnergyExportedAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(CumulativeEnergyExportedAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
          ...
          requireNotNull(attributeData) { 
            "Cumulativeenergyexported attribute not found in Node State update" 
          }
      ...
      null
          ...
          decodedValue?.let {
            emit(CumulativeEnergyExportedAttributeSubscriptionState.Success(it))
          }
          
        }
        SubscriptionState.SubscriptionEstablished -> {
          emit(CumulativeEnergyExportedAttributeSubscriptionState.SubscriptionEstablished)
        }
      }
    }    
  }
suspend fun readPeriodicEnergyImportedAttribute(): PeriodicEnergyImportedAttribute {val ATTRIBUTE_ID: UInt = 3u
    ...
    requireNotNull(attributeData) { 
      "Periodicenergyimported attribute not found in response" 
    }
  ...
  suspend fun subscribePeriodicEnergyImportedAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(PeriodicEnergyImportedAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
          ...
          requireNotNull(attributeData) { 
            "Periodicenergyimported attribute not found in Node State update" 
          }
      ...
      null
          ...
          decodedValue?.let {
            emit(PeriodicEnergyImportedAttributeSubscriptionState.Success(it))
          }
          
        }
        SubscriptionState.SubscriptionEstablished -> {
          emit(PeriodicEnergyImportedAttributeSubscriptionState.SubscriptionEstablished)
        }
      }
    }    
  }
suspend fun readPeriodicEnergyExportedAttribute(): PeriodicEnergyExportedAttribute {val ATTRIBUTE_ID: UInt = 4u
    ...
    requireNotNull(attributeData) { 
      "Periodicenergyexported attribute not found in response" 
    }
  ...
  suspend fun subscribePeriodicEnergyExportedAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(PeriodicEnergyExportedAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
          ...
          requireNotNull(attributeData) { 
            "Periodicenergyexported attribute not found in Node State update" 
          }
      ...
      null
          ...
          decodedValue?.let {
            emit(PeriodicEnergyExportedAttributeSubscriptionState.Success(it))
          }
          
        }
        SubscriptionState.SubscriptionEstablished -> {
          emit(PeriodicEnergyExportedAttributeSubscriptionState.SubscriptionEstablished)
        }
      }
    }    
  }
suspend fun readCumulativeEnergyResetAttribute(): CumulativeEnergyResetAttribute {val ATTRIBUTE_ID: UInt = 5u
    ...
    requireNotNull(attributeData) { 
      "Cumulativeenergyreset attribute not found in response" 
    }

    // Decode the TLV data into the appropriate type
    val tlvReader = TlvReader(attributeData.data)
    val decodedValue: ElectricalEnergyMeasurementClusterCumulativeEnergyResetStruct? = if (!tlvReader.isNull()) {
      if (tlvReader.isNextTag(AnonymousTag)) {
      ElectricalEnergyMeasurementClusterCumulativeEnergyResetStruct.fromTlv(AnonymousTag, tlvReader)
    } else {
      null
    }
    } else {
  ...
  suspend fun subscribeCumulativeEnergyResetAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(CumulativeEnergyResetAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
      ...
      null
          ...
          decodedValue?.let {
            emit(CumulativeEnergyResetAttributeSubscriptionState.Success(it))
          }
