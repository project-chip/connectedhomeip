...
class AttributeListAttribute(
  ...
  suspend fun provisionEndpoint(hostname: ByteArray
    ...
    while (!tlvReader.isEndOfContainer()) {
      ...
      if (tag == ContextSpecificTag(TAG_ENDPOINT_ID)) {endpointID_decoded = tlvReader.getUShort(tag)}  
  ...
  suspend fun findEndpoint(endpointID: UShort
    ...
    while (!tlvReader.isEndOfContainer()) {
      ...
      if (tag == ContextSpecificTag(TAG_ENDPOINT)) {endpoint_decoded = TlsClientManagementClusterTLSEndpointStruct.fromTlv(tag, tlvReader)}  
