...
class TlsClientManagementCluster(private val controller: MatterController, private val endpointId: UShort) {
  ...
  class FindEndpointResponse(
    val endpoints: List<TlsClientManagementClusterTLSEndpointStruct>
  )
...
class AttributeListAttribute(
  ...
  suspend fun findEndpoint(endpointID: UShort?
    ...
    var endpoints_decoded: List<TlsClientManagementClusterTLSEndpointStruct>? = null
    ...
    while (!tlvReader.isEndOfContainer()) {
      ...
      if (tag == ContextSpecificTag(TAG_ENDPOINTS)) {endpoints_decoded = buildList<TlsClientManagementClusterTLSEndpointStruct> {
