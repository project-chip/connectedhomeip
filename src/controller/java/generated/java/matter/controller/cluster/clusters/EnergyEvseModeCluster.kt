...
class EnergyEvseModeCluster(private val controller: MatterController, private val endpointId: UShort) {
  class ChangeToModeResponse(
    val status: UByte, 
    val statusText: String?
  )
class SupportedModesAttribute(
    val value: List<EnergyEvseModeClusterModeOptionStruct>
  )
...
suspend fun readSupportedModesAttribute(): SupportedModesAttribute {val ATTRIBUTE_ID: UInt = 0u
    ...
    val decodedValue: List<EnergyEvseModeClusterModeOptionStruct> = buildList<EnergyEvseModeClusterModeOptionStruct> {
