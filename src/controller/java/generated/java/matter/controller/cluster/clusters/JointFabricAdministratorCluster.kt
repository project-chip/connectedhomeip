...
class JointFabricAdministratorCluster(
  ...
  class AdministratorFabricIndexAttribute(val value: UByte?)

  sealed class AdministratorFabricIndexAttributeSubscriptionState {
    data class Success(val value: UByte?) : AdministratorFabricIndexAttributeSubscriptionState()
  ...
  suspend fun addICAC(ICACValue: ByteArray, timedInvokeTimeout: Duration? = null): ICACResponse {
    ...
    return ICACResponse(statusCode_decoded)
  }

  suspend fun openJointCommissioningWindow(
  ...
  suspend fun announceJointFabricAdministrator(
    endpointID: UShort,
    timedInvokeTimeout: Duration? = null
  ) {
  ...
  suspend fun readAdministratorFabricIndexAttribute(): AdministratorFabricIndexAttribute {
    ...
    requireNotNull(attributeData) { "Administratorfabricindex attribute not found in response" }
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(
            AdministratorFabricIndexAttributeSubscriptionState.Error(
              Exception(
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          decodedValue?.let { emit(AdministratorFabricIndexAttributeSubscriptionState.Success(it)) }
        }
