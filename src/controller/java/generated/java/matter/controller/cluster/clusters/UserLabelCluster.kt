...
class UserLabelCluster(private val controller: MatterController, private val endpointId: UShort) {class LabelListAttribute(
...
suspend fun readLabelListAttribute(): LabelListAttribute {val ATTRIBUTE_ID: UInt = 0u
    ...
    val decodedValue: List<UserLabelClusterLabelStruct> = buildList<UserLabelClusterLabelStruct> {
