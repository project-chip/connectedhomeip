...
class BridgedDeviceBasicInformationClusterLocationDescriptorStruct(
  val locationName: String,
  val floorNumber: Short?,
  val areaType: UByte?
) {
  override fun toString(): String = buildString {
    append("BridgedDeviceBasicInformationClusterLocationDescriptorStruct {\n")
  ...
  companion object {
    ...
    fun fromTlv(tlvTag: Tag, tlvReader: TlvReader): BridgedDeviceBasicInformationClusterLocationDescriptorStruct {
      ...
      return BridgedDeviceBasicInformationClusterLocationDescriptorStruct(locationName, floorNumber, areaType)
    }
  }
}
