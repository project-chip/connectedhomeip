...
class WaterHeaterModeCluster(
  private val controller: MatterController,
  private val endpointId: UShort,
) {
  class ChangeToModeResponse(val status: UByte, val statusText: String?)

  class SupportedModesAttribute(val value: List<WaterHeaterModeClusterModeOptionStruct>)

  sealed class SupportedModesAttributeSubscriptionState {
    data class Success(val value: List<WaterHeaterModeClusterModeOptionStruct>) :
  ...
  suspend fun readSupportedModesAttribute(): SupportedModesAttribute {
    ...
    val decodedValue: List<WaterHeaterModeClusterModeOptionStruct> =
      buildList<WaterHeaterModeClusterModeOptionStruct> {
