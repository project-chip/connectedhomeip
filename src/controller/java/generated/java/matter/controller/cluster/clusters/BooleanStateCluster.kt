...
class BooleanStateCluster(
  ...
  suspend fun readStateValueAttribute(): Boolean {
    ...
    requireNotNull(attributeData) { "Statevalue attribute not found in response" }
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { "Statevalue attribute not found in Node State update" }
