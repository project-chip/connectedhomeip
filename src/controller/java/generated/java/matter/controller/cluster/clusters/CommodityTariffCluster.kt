...
class AttributeListAttribute(
  ...
  suspend fun getTariffComponent(tariffComponentID: UInt
    ...
    while (!tlvReader.isEndOfContainer()) {
      ...
      if (tag == ContextSpecificTag(TAG_TARIFF_COMPONENT)) {tariffComponent_decoded = CommodityTariffClusterTariffComponentStruct.fromTlv(tag, tlvReader)}  
  ...
  suspend fun getDayEntry(dayEntryID: UInt
    ...
    while (!tlvReader.isEndOfContainer()) {
      ...
      if (tag == ContextSpecificTag(TAG_DAY_ENTRY)) {dayEntry_decoded = CommodityTariffClusterDayEntryStruct.fromTlv(tag, tlvReader)}  
