...
class CommodityTariffCluster(private val controller: MatterController, private val endpointId: UShort) {
  ...
  class GetDayEntryResponse(
    val dayEntry: CommodityTariffClusterDayEntryStruct
  )
class TariffInfoAttribute(
    val value: CommodityTariffClusterTariffInformationStruct?
  )
...
class StartDateAttribute(
  ...
  sealed class StartDateAttributeSubscriptionState {
    data class Success(
    val value: UInt?
    ) : StartDateAttributeSubscriptionState()
...
class DayEntriesAttribute(
    val value: List<CommodityTariffClusterDayEntryStruct>?
  )
...
class DayPatternsAttribute(
    val value: List<CommodityTariffClusterDayPatternStruct>?
  )
...
class CalendarPeriodsAttribute(
    val value: List<CommodityTariffClusterCalendarPeriodStruct>?
  )
...
class IndividualDaysAttribute(
    val value: List<CommodityTariffClusterDayStruct>?
  )
...
class CurrentDayAttribute(
    val value: CommodityTariffClusterDayStruct?
  )
...
class CurrentDayEntryAttribute(
    val value: CommodityTariffClusterDayEntryStruct?
  )
...
class CurrentDayEntryDateAttribute(
    val value: UInt?
  )
  ...
  sealed class CurrentDayEntryDateAttributeSubscriptionState {
    data class Success(
    val value: UInt?
    ) : CurrentDayEntryDateAttributeSubscriptionState()
...
class NextDayEntryDateAttribute(
    val value: UInt?
  )
  ...
  sealed class NextDayEntryDateAttributeSubscriptionState {
    data class Success(
    val value: UInt?
    ) : NextDayEntryDateAttributeSubscriptionState()
...
class TariffComponentsAttribute(
...
class TariffPeriodsAttribute(
    val value: List<CommodityTariffClusterTariffPeriodStruct>?
  )
...
class CurrentTariffComponentsAttribute(
  ...
  sealed class CurrentTariffComponentsAttributeSubscriptionState {
    ...
    data class Error(val exception: Exception) : CurrentTariffComponentsAttributeSubscriptionState()
...
class DefaultRandomizationOffsetAttribute(
    val value: Short?
  )
  ...
  sealed class DefaultRandomizationOffsetAttributeSubscriptionState {
    ...
    data class Error(val exception: Exception) : DefaultRandomizationOffsetAttributeSubscriptionState()

    object SubscriptionEstablished : DefaultRandomizationOffsetAttributeSubscriptionState()    
  }  
class DefaultRandomizationTypeAttribute(
    val value: UByte?
  )
  ...
  sealed class DefaultRandomizationTypeAttributeSubscriptionState {
    ...
    data class Error(val exception: Exception) : DefaultRandomizationTypeAttributeSubscriptionState()
...
class AttributeListAttribute(
  ...
  suspend fun getTariffComponent(tariffComponentID: UInt
      ,timedInvokeTimeout: Duration? = null): GetTariffComponentResponse {
    ...
    while (!tlvReader.isEndOfContainer()) {
      ...
      if (tag == ContextSpecificTag(TAG_LABEL)) {label_decoded = 
          if (tlvReader.isNull()) {
      ...
      if (tag == ContextSpecificTag(TAG_DAY_ENTRY_I_DS)) {dayEntryIDs_decoded = buildList<UInt> {
      ...
      if (tag == ContextSpecificTag(TAG_TARIFF_COMPONENT)) {tariffComponent_decoded = CommodityTariffClusterTariffComponentStruct.fromTlv(tag, tlvReader)} else
      {
  ...
  suspend fun getDayEntry(dayEntryID: UInt
      ,timedInvokeTimeout: Duration? = null): GetDayEntryResponse {
    ...
    while (!tlvReader.isEndOfContainer()) {
      ...
      if (tag == ContextSpecificTag(TAG_DAY_ENTRY)) {dayEntry_decoded = CommodityTariffClusterDayEntryStruct.fromTlv(tag, tlvReader)} else
      {
        tlvReader.skipElement()
      }
    }
...
suspend fun readTariffInfoAttribute(): TariffInfoAttribute {val ATTRIBUTE_ID: UInt = 0u
    ...
    requireNotNull(attributeData) { 
      "Tariffinfo attribute not found in response" 
    }

    // Decode the TLV data into the appropriate type
    val tlvReader = TlvReader(attributeData.data)
    val decodedValue: CommodityTariffClusterTariffInformationStruct? = if (!tlvReader.isNull()) {
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(TariffInfoAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { 
            "Tariffinfo attribute not found in Node State update" 
          }
      ...
      null
          ...
          decodedValue?.let {
            emit(TariffInfoAttributeSubscriptionState.Success(it))
          }
...
suspend fun readTariffUnitAttribute(): TariffUnitAttribute {val ATTRIBUTE_ID: UInt = 1u
...
suspend fun readStartDateAttribute(): StartDateAttribute {val ATTRIBUTE_ID: UInt = 2u
    ...
    requireNotNull(attributeData) { 
      "Startdate attribute not found in response" 
    }
  ...
  suspend fun subscribeStartDateAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(StartDateAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
          ...
          requireNotNull(attributeData) { 
            "Startdate attribute not found in Node State update" 
          }
      ...
      null
          ...
          decodedValue?.let {
            emit(StartDateAttributeSubscriptionState.Success(it))
          }
...
suspend fun readDayEntriesAttribute(): DayEntriesAttribute {val ATTRIBUTE_ID: UInt = 3u
    ...
    requireNotNull(attributeData) { 
      "Dayentries attribute not found in response" 
    }

    // Decode the TLV data into the appropriate type
    val tlvReader = TlvReader(attributeData.data)
    val decodedValue: List<CommodityTariffClusterDayEntryStruct>? = if (!tlvReader.isNull()) {
  ...
  suspend fun subscribeDayEntriesAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(DayEntriesAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
          ...
          requireNotNull(attributeData) { 
            "Dayentries attribute not found in Node State update" 
          }
      ...
      null
          ...
          decodedValue?.let {
            emit(DayEntriesAttributeSubscriptionState.Success(it))
          }
...
suspend fun readDayPatternsAttribute(): DayPatternsAttribute {val ATTRIBUTE_ID: UInt = 4u
    ...
    requireNotNull(attributeData) { 
      "Daypatterns attribute not found in response" 
    }

    // Decode the TLV data into the appropriate type
    val tlvReader = TlvReader(attributeData.data)
    val decodedValue: List<CommodityTariffClusterDayPatternStruct>? = if (!tlvReader.isNull()) {
  ...
  suspend fun subscribeDayPatternsAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(DayPatternsAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
          ...
          requireNotNull(attributeData) { 
            "Daypatterns attribute not found in Node State update" 
          }
      ...
      null
          ...
          decodedValue?.let {
            emit(DayPatternsAttributeSubscriptionState.Success(it))
          }
...
suspend fun readCalendarPeriodsAttribute(): CalendarPeriodsAttribute {val ATTRIBUTE_ID: UInt = 5u
    ...
    requireNotNull(attributeData) { 
      "Calendarperiods attribute not found in response" 
    }

    // Decode the TLV data into the appropriate type
    val tlvReader = TlvReader(attributeData.data)
    val decodedValue: List<CommodityTariffClusterCalendarPeriodStruct>? = if (!tlvReader.isNull()) {
  ...
  suspend fun subscribeCalendarPeriodsAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(CalendarPeriodsAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
      ...
      null
          ...
          decodedValue?.let {
            emit(CalendarPeriodsAttributeSubscriptionState.Success(it))
          }
...
suspend fun readIndividualDaysAttribute(): IndividualDaysAttribute {val ATTRIBUTE_ID: UInt = 6u
    ...
    requireNotNull(attributeData) { 
      "Individualdays attribute not found in response" 
    }

    // Decode the TLV data into the appropriate type
    val tlvReader = TlvReader(attributeData.data)
    val decodedValue: List<CommodityTariffClusterDayStruct>? = if (!tlvReader.isNull()) {
  ...
  suspend fun subscribeIndividualDaysAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(IndividualDaysAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
      ...
      null
          ...
          decodedValue?.let {
            emit(IndividualDaysAttributeSubscriptionState.Success(it))
          }
...
suspend fun readCurrentDayAttribute(): CurrentDayAttribute {val ATTRIBUTE_ID: UInt = 7u
    ...
    requireNotNull(attributeData) { 
      "Currentday attribute not found in response" 
    }

    // Decode the TLV data into the appropriate type
    val tlvReader = TlvReader(attributeData.data)
    val decodedValue: CommodityTariffClusterDayStruct? = if (!tlvReader.isNull()) {
  ...
  suspend fun subscribeCurrentDayAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(CurrentDayAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
          ...
          requireNotNull(attributeData) { 
            "Currentday attribute not found in Node State update" 
          }
      ...
      null
          ...
          decodedValue?.let {
            emit(CurrentDayAttributeSubscriptionState.Success(it))
          }
...
suspend fun readNextDayAttribute(): NextDayAttribute {val ATTRIBUTE_ID: UInt = 8u
    ...
    requireNotNull(attributeData) { 
      "Nextday attribute not found in response" 
    }
  ...
  suspend fun subscribeNextDayAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(NextDayAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
          ...
          requireNotNull(attributeData) { 
            "Nextday attribute not found in Node State update" 
          }
      ...
      null
          ...
          decodedValue?.let {
            emit(NextDayAttributeSubscriptionState.Success(it))
          }
...
suspend fun readCurrentDayEntryAttribute(): CurrentDayEntryAttribute {val ATTRIBUTE_ID: UInt = 9u
    ...
    requireNotNull(attributeData) { 
      "Currentdayentry attribute not found in response" 
    }

    // Decode the TLV data into the appropriate type
    val tlvReader = TlvReader(attributeData.data)
    val decodedValue: CommodityTariffClusterDayEntryStruct? = if (!tlvReader.isNull()) {
  ...
  suspend fun subscribeCurrentDayEntryAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(CurrentDayEntryAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
      ...
      null
          ...
          decodedValue?.let {
            emit(CurrentDayEntryAttributeSubscriptionState.Success(it))
          }
...
suspend fun readCurrentDayEntryDateAttribute(): CurrentDayEntryDateAttribute {val ATTRIBUTE_ID: UInt = 10u
    ...
    requireNotNull(attributeData) { 
      "Currentdayentrydate attribute not found in response" 
    }
  ...
  suspend fun subscribeCurrentDayEntryDateAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(CurrentDayEntryDateAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
      ...
      null
          ...
          decodedValue?.let {
            emit(CurrentDayEntryDateAttributeSubscriptionState.Success(it))
          }
...
suspend fun readNextDayEntryAttribute(): NextDayEntryAttribute {val ATTRIBUTE_ID: UInt = 11u
    ...
    requireNotNull(attributeData) { 
      "Nextdayentry attribute not found in response" 
    }
  ...
  suspend fun subscribeNextDayEntryAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(NextDayEntryAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
          ...
          requireNotNull(attributeData) { 
            "Nextdayentry attribute not found in Node State update" 
          }
      ...
      null
          ...
          decodedValue?.let {
            emit(NextDayEntryAttributeSubscriptionState.Success(it))
          }
...
suspend fun readNextDayEntryDateAttribute(): NextDayEntryDateAttribute {val ATTRIBUTE_ID: UInt = 12u
    ...
    requireNotNull(attributeData) { 
      "Nextdayentrydate attribute not found in response" 
    }
  ...
  suspend fun subscribeNextDayEntryDateAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(NextDayEntryDateAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
      ...
      null
          ...
          decodedValue?.let {
            emit(NextDayEntryDateAttributeSubscriptionState.Success(it))
          }
...
suspend fun readTariffComponentsAttribute(): TariffComponentsAttribute {val ATTRIBUTE_ID: UInt = 13u
    ...
    requireNotNull(attributeData) { 
      "Tariffcomponents attribute not found in response" 
    }

    // Decode the TLV data into the appropriate type
    val tlvReader = TlvReader(attributeData.data)
    val decodedValue: List<CommodityTariffClusterTariffComponentStruct>? = if (!tlvReader.isNull()) {
  ...
  suspend fun subscribeTariffComponentsAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(TariffComponentsAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
      ...
      null
          ...
          decodedValue?.let {
            emit(TariffComponentsAttributeSubscriptionState.Success(it))
          }
...
suspend fun readTariffPeriodsAttribute(): TariffPeriodsAttribute {val ATTRIBUTE_ID: UInt = 14u
    ...
    requireNotNull(attributeData) { 
      "Tariffperiods attribute not found in response" 
    }

    // Decode the TLV data into the appropriate type
    val tlvReader = TlvReader(attributeData.data)
    val decodedValue: List<CommodityTariffClusterTariffPeriodStruct>? = if (!tlvReader.isNull()) {
  ...
  suspend fun subscribeTariffPeriodsAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(TariffPeriodsAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
          ...
          requireNotNull(attributeData) { 
            "Tariffperiods attribute not found in Node State update" 
          }
      ...
      null
          ...
          decodedValue?.let {
            emit(TariffPeriodsAttributeSubscriptionState.Success(it))
          }
...
suspend fun readCurrentTariffComponentsAttribute(): CurrentTariffComponentsAttribute {val ATTRIBUTE_ID: UInt = 15u
    ...
    requireNotNull(attributeData) { 
      "Currenttariffcomponents attribute not found in response" 
    }
  ...
  suspend fun subscribeCurrentTariffComponentsAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(CurrentTariffComponentsAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
      ...
      null
          ...
          decodedValue?.let {
            emit(CurrentTariffComponentsAttributeSubscriptionState.Success(it))
          }
...
suspend fun readNextTariffComponentsAttribute(): NextTariffComponentsAttribute {val ATTRIBUTE_ID: UInt = 16u
    ...
    requireNotNull(attributeData) { 
      "Nexttariffcomponents attribute not found in response" 
    }
  ...
  suspend fun subscribeNextTariffComponentsAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(NextTariffComponentsAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
      ...
      null
          ...
          decodedValue?.let {
            emit(NextTariffComponentsAttributeSubscriptionState.Success(it))
          }
...
suspend fun readDefaultRandomizationOffsetAttribute(): DefaultRandomizationOffsetAttribute {val ATTRIBUTE_ID: UInt = 17u
    ...
    requireNotNull(attributeData) { 
      "Defaultrandomizationoffset attribute not found in response" 
    }
  ...
  suspend fun subscribeDefaultRandomizationOffsetAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(DefaultRandomizationOffsetAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
...
suspend fun readDefaultRandomizationTypeAttribute(): DefaultRandomizationTypeAttribute {val ATTRIBUTE_ID: UInt = 18u
    ...
    requireNotNull(attributeData) { 
      "Defaultrandomizationtype attribute not found in response" 
    }
  ...
  suspend fun subscribeDefaultRandomizationTypeAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(DefaultRandomizationTypeAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
      ...
      null
          ...
          decodedValue?.let {
            emit(DefaultRandomizationTypeAttributeSubscriptionState.Success(it))
          }
