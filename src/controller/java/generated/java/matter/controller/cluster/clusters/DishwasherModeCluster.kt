...
class DishwasherModeCluster(
  ...
  sealed class SupportedModesAttributeSubscriptionState {
    data class Success(val value: List<DishwasherModeClusterModeOptionStruct>) :
  ...
  suspend fun readSupportedModesAttribute(): SupportedModesAttribute {
    ...
    val decodedValue: List<DishwasherModeClusterModeOptionStruct> =
      buildList<DishwasherModeClusterModeOptionStruct> {
        tlvReader.enterArray(AnonymousTag)
        while (!tlvReader.isEndOfContainer()) {
          add(DishwasherModeClusterModeOptionStruct.fromTlv(AnonymousTag, tlvReader))
        }
        tlvReader.exitContainer()
      }
  ...
  companion object {
    private val logger = Logger.getLogger(DishwasherModeCluster::class.java.name)
