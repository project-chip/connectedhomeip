...
class AmbientSensingUnionClusterUnionContributorRemovedEvent(
  ...
  fun toTlv(tlvTag: Tag, tlvWriter: TlvWriter) {
    tlvWriter.apply {
      ...
      removedContributor.toTlv(ContextSpecificTag(TAG_REMOVED_CONTRIBUTOR), this)
      endStructure()
    }
  }
  ...
  companion object {
    ...
    fun fromTlv(
      ...
      val removedContributor =
        matter.controller.cluster.structs.AmbientSensingUnionClusterUnionContributorStruct.fromTlv(
          ContextSpecificTag(TAG_REMOVED_CONTRIBUTOR),
          tlvReader,
        )
