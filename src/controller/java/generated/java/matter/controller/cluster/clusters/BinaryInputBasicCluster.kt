...
class BinaryInputBasicCluster(private val controller: MatterController, private val endpointId: UShort) {class GeneratedCommandListAttribute(
    val value: List<UInt>
  )
...
suspend fun readActiveTextAttribute(): String? {val ATTRIBUTE_ID: UInt = 4u
    ...
    requireNotNull(attributeData) { 
      "Activetext attribute not found in response" 
    }
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { 
            "Activetext attribute not found in Node State update" 
          }
...
suspend fun readDescriptionAttribute(): String? {val ATTRIBUTE_ID: UInt = 28u
    ...
    requireNotNull(attributeData) { 
      "Description attribute not found in response" 
    }
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { 
            "Description attribute not found in Node State update" 
          }
...
suspend fun readInactiveTextAttribute(): String? {val ATTRIBUTE_ID: UInt = 46u
    ...
    requireNotNull(attributeData) { 
      "Inactivetext attribute not found in response" 
    }
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { 
            "Inactivetext attribute not found in Node State update" 
          }
...
suspend fun readOutOfServiceAttribute(): Boolean {val ATTRIBUTE_ID: UInt = 81u
    ...
    requireNotNull(attributeData) { 
      "Outofservice attribute not found in response" 
    }
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { 
            "Outofservice attribute not found in Node State update" 
          }
...
suspend fun readPolarityAttribute(): UByte? {val ATTRIBUTE_ID: UInt = 84u
    ...
    requireNotNull(attributeData) { 
      "Polarity attribute not found in response" 
    }
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { 
            "Polarity attribute not found in Node State update" 
          }
...
suspend fun readPresentValueAttribute(): Boolean {val ATTRIBUTE_ID: UInt = 85u
    ...
    requireNotNull(attributeData) { 
      "Presentvalue attribute not found in response" 
    }
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { 
            "Presentvalue attribute not found in Node State update" 
          }
...
suspend fun readReliabilityAttribute(): UByte? {val ATTRIBUTE_ID: UInt = 103u
    ...
    requireNotNull(attributeData) { 
      "Reliability attribute not found in response" 
    }
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { 
            "Reliability attribute not found in Node State update" 
          }
...
suspend fun readStatusFlagsAttribute(): UByte {val ATTRIBUTE_ID: UInt = 111u
    ...
    requireNotNull(attributeData) { 
      "Statusflags attribute not found in response" 
    }
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { 
            "Statusflags attribute not found in Node State update" 
          }
...
suspend fun readApplicationTypeAttribute(): UInt? {val ATTRIBUTE_ID: UInt = 256u
    ...
    requireNotNull(attributeData) { 
      "Applicationtype attribute not found in response" 
    }
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { 
            "Applicationtype attribute not found in Node State update" 
          }
