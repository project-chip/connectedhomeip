...
class ContentControlCluster(private val controller: MatterController, private val endpointId: UShort) {
  class ResetPINResponse(
    val PINCode: String
  )
class OnDemandRatingsAttribute(
    val value: List<ContentControlClusterRatingNameStruct>?
  )
...
class ScheduledContentRatingsAttribute(
    val value: List<ContentControlClusterRatingNameStruct>?
  )
  ...
  sealed class ScheduledContentRatingsAttributeSubscriptionState {
    ...
    data class Error(val exception: Exception) : ScheduledContentRatingsAttributeSubscriptionState()

    object SubscriptionEstablished : ScheduledContentRatingsAttributeSubscriptionState()    
  }  
class BlockChannelListAttribute(
    val value: List<ContentControlClusterBlockChannelStruct>?
  )
...
class BlockApplicationListAttribute(
    val value: List<ContentControlClusterAppInfoStruct>?
  )
...
class BlockContentTimeWindowAttribute(
    val value: List<ContentControlClusterTimeWindowStruct>?
  )
...
class AttributeListAttribute(
  ...
  suspend fun updatePIN(oldPIN: String
      ,newPIN: String
    ...
    tlvWriter.put(ContextSpecificTag(TAG_OLD_PIN_REQ), oldPIN)
  ...
  suspend fun resetPIN(timedInvokeTimeout: Duration): ResetPINResponse {
    ...
    while (!tlvReader.isEndOfContainer()) {
      ...
      if (tag == ContextSpecificTag(TAG_PIN_CODE)) {PINCode_decoded = tlvReader.getString(tag)} else
      {
  ...
  suspend fun addBonusTime(PINCode: String?
      ,bonusTime: UInt
    ...
    PINCode?.let {
      tlvWriter.put(ContextSpecificTag(TAG_PIN_CODE_REQ), PINCode)
    }
  ...
  suspend fun setScreenDailyTime(screenTime: UInt
      ,timedInvokeTimeout: Duration? = null) {
  ...
  suspend fun setOnDemandRatingThreshold(rating: String
      ,timedInvokeTimeout: Duration? = null) {
  ...
  suspend fun setScheduledContentRatingThreshold(rating: String
      ,timedInvokeTimeout: Duration? = null) {
  ...
  suspend fun addBlockChannels(channels: List<ContentControlClusterBlockChannelStruct>
      ,timedInvokeTimeout: Duration? = null) {
  ...
  suspend fun removeBlockChannels(channelIndexes: List<UShort>
      ,timedInvokeTimeout: Duration? = null) {
  ...
  suspend fun addBlockApplications(applications: List<ContentControlClusterAppInfoStruct>
      ,timedInvokeTimeout: Duration? = null) {
  ...
  suspend fun removeBlockApplications(applications: List<ContentControlClusterAppInfoStruct>
      ,timedInvokeTimeout: Duration? = null) {
  ...
  suspend fun setBlockContentTimeWindow(timeWindow: ContentControlClusterTimeWindowStruct
      ,timedInvokeTimeout: Duration? = null) {
  ...
  suspend fun removeBlockContentTimeWindow(timeWindowIndexes: List<UShort>
      ,timedInvokeTimeout: Duration? = null) {
...
suspend fun readEnabledAttribute(): Boolean {val ATTRIBUTE_ID: UInt = 0u
...
suspend fun readOnDemandRatingsAttribute(): OnDemandRatingsAttribute {val ATTRIBUTE_ID: UInt = 1u
    ...
    requireNotNull(attributeData) { 
      "Ondemandratings attribute not found in response" 
    }

    // Decode the TLV data into the appropriate type
    val tlvReader = TlvReader(attributeData.data)
    val decodedValue: List<ContentControlClusterRatingNameStruct>? = if (tlvReader.isNextTag(AnonymousTag)) {
  ...
  suspend fun subscribeOnDemandRatingsAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(OnDemandRatingsAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
      ...
      null
          ...
          decodedValue?.let {
            emit(OnDemandRatingsAttributeSubscriptionState.Success(it))
          }
...
suspend fun readOnDemandRatingThresholdAttribute(): String? {val ATTRIBUTE_ID: UInt = 2u
    ...
    requireNotNull(attributeData) { 
      "Ondemandratingthreshold attribute not found in response" 
    }
...
suspend fun readScheduledContentRatingsAttribute(): ScheduledContentRatingsAttribute {val ATTRIBUTE_ID: UInt = 3u
    ...
    requireNotNull(attributeData) { 
      "Scheduledcontentratings attribute not found in response" 
    }
  ...
  suspend fun subscribeScheduledContentRatingsAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(ScheduledContentRatingsAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
      ...
      null
          ...
          decodedValue?.let {
            emit(ScheduledContentRatingsAttributeSubscriptionState.Success(it))
          }
...
suspend fun readScheduledContentRatingThresholdAttribute(): String? {val ATTRIBUTE_ID: UInt = 4u
...
suspend fun readScreenDailyTimeAttribute(): UInt? {val ATTRIBUTE_ID: UInt = 5u
    ...
    requireNotNull(attributeData) { 
      "Screendailytime attribute not found in response" 
    }
...
suspend fun readRemainingScreenTimeAttribute(): UInt? {val ATTRIBUTE_ID: UInt = 6u
    ...
    requireNotNull(attributeData) { 
      "Remainingscreentime attribute not found in response" 
    }
...
suspend fun readBlockUnratedAttribute(): Boolean? {val ATTRIBUTE_ID: UInt = 7u
    ...
    requireNotNull(attributeData) { 
      "Blockunrated attribute not found in response" 
    }
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { 
            "Blockunrated attribute not found in Node State update" 
          }
...
suspend fun readBlockChannelListAttribute(): BlockChannelListAttribute {val ATTRIBUTE_ID: UInt = 8u
    ...
    requireNotNull(attributeData) { 
      "Blockchannellist attribute not found in response" 
    }

    // Decode the TLV data into the appropriate type
    val tlvReader = TlvReader(attributeData.data)
    val decodedValue: List<ContentControlClusterBlockChannelStruct>? = if (tlvReader.isNextTag(AnonymousTag)) {
  ...
  suspend fun subscribeBlockChannelListAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(BlockChannelListAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
      ...
      null
          ...
          decodedValue?.let {
            emit(BlockChannelListAttributeSubscriptionState.Success(it))
          }
...
suspend fun readBlockApplicationListAttribute(): BlockApplicationListAttribute {val ATTRIBUTE_ID: UInt = 9u
    ...
    requireNotNull(attributeData) { 
      "Blockapplicationlist attribute not found in response" 
    }

    // Decode the TLV data into the appropriate type
    val tlvReader = TlvReader(attributeData.data)
    val decodedValue: List<ContentControlClusterAppInfoStruct>? = if (tlvReader.isNextTag(AnonymousTag)) {
  ...
  suspend fun subscribeBlockApplicationListAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(BlockApplicationListAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
      ...
      null
          ...
          decodedValue?.let {
            emit(BlockApplicationListAttributeSubscriptionState.Success(it))
          }
...
suspend fun readBlockContentTimeWindowAttribute(): BlockContentTimeWindowAttribute {val ATTRIBUTE_ID: UInt = 10u
    ...
    requireNotNull(attributeData) { 
      "Blockcontenttimewindow attribute not found in response" 
    }

    // Decode the TLV data into the appropriate type
    val tlvReader = TlvReader(attributeData.data)
    val decodedValue: List<ContentControlClusterTimeWindowStruct>? = if (tlvReader.isNextTag(AnonymousTag)) {
  ...
  suspend fun subscribeBlockContentTimeWindowAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(BlockContentTimeWindowAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
      ...
      null
          ...
          decodedValue?.let {
            emit(BlockContentTimeWindowAttributeSubscriptionState.Success(it))
          }
