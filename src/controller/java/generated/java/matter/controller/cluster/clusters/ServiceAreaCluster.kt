...
class ServiceAreaCluster(private val controller: MatterController, private val endpointId: UShort) {
  ...
  class SkipCurrentLocationResponse(
    val status: UByte, 
    val statusText: String?
  )
...
class AttributeListAttribute(
  ...
  suspend fun skipCurrentLocation(timedInvokeTimeout: Duration? = null): SkipCurrentLocationResponse {
    ...
    return SkipCurrentLocationResponse(
      status_decoded,
      statusText_decoded
    )
  }
