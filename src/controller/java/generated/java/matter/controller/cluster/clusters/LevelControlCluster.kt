...
class LevelControlCluster(private val controller: MatterController, private val endpointId: UShort) {class CurrentLevelAttribute(
    val value: UByte?
  )
...
class OnLevelAttribute(
  ...
  sealed class OnLevelAttributeSubscriptionState {
    data class Success(
    val value: UByte?
    ) : OnLevelAttributeSubscriptionState()
...
class OnTransitionTimeAttribute(
  ...
  sealed class OnTransitionTimeAttributeSubscriptionState {
    data class Success(
    val value: UShort?
    ) : OnTransitionTimeAttributeSubscriptionState()
...
class OffTransitionTimeAttribute(
  ...
  sealed class OffTransitionTimeAttributeSubscriptionState {
    data class Success(
    val value: UShort?
    ) : OffTransitionTimeAttributeSubscriptionState()
...
class DefaultMoveRateAttribute(
  ...
  sealed class DefaultMoveRateAttributeSubscriptionState {
    data class Success(
    val value: UByte?
    ) : DefaultMoveRateAttributeSubscriptionState()
...
class StartUpCurrentLevelAttribute(
  ...
  sealed class StartUpCurrentLevelAttributeSubscriptionState {
    data class Success(
    val value: UByte?
    ) : StartUpCurrentLevelAttributeSubscriptionState()
...
class AttributeListAttribute(
  ...
  suspend fun moveToLevel(level: UByte
  ...
  suspend fun move(moveMode: UByte
      ,rate: UByte?
      ,optionsMask: UByte
      ,optionsOverride: UByte
      ,timedInvokeTimeout: Duration? = null) {
  ...
  suspend fun step(stepMode: UByte
      ,stepSize: UByte
      ,transitionTime: UShort?
      ,optionsMask: UByte
      ,optionsOverride: UByte
  ...
  suspend fun stop(optionsMask: UByte
      ,optionsOverride: UByte
      ,timedInvokeTimeout: Duration? = null) {
  ...
  suspend fun moveToLevelWithOnOff(level: UByte
      ,transitionTime: UShort?
      ,optionsMask: UByte
      ,optionsOverride: UByte
      ,timedInvokeTimeout: Duration? = null) {
  ...
  suspend fun moveWithOnOff(moveMode: UByte
      ,rate: UByte?
      ,optionsMask: UByte
      ,optionsOverride: UByte
      ,timedInvokeTimeout: Duration? = null) {
  ...
  suspend fun stepWithOnOff(stepMode: UByte
      ,stepSize: UByte
      ,transitionTime: UShort?
      ,optionsMask: UByte
      ,optionsOverride: UByte
  ...
  suspend fun stopWithOnOff(optionsMask: UByte
      ,optionsOverride: UByte
      ,timedInvokeTimeout: Duration? = null) {
...
suspend fun readCurrentLevelAttribute(): CurrentLevelAttribute {val ATTRIBUTE_ID: UInt = 0u
...
suspend fun readRemainingTimeAttribute(): UShort? {val ATTRIBUTE_ID: UInt = 1u
...
suspend fun readMinLevelAttribute(): UByte? {val ATTRIBUTE_ID: UInt = 2u
...
suspend fun readMaxLevelAttribute(): UByte? {val ATTRIBUTE_ID: UInt = 3u
...
suspend fun readCurrentFrequencyAttribute(): UShort? {val ATTRIBUTE_ID: UInt = 4u
    ...
    requireNotNull(attributeData) { 
      "Currentfrequency attribute not found in response" 
    }
...
suspend fun readMinFrequencyAttribute(): UShort? {val ATTRIBUTE_ID: UInt = 5u
    ...
    requireNotNull(attributeData) { 
      "Minfrequency attribute not found in response" 
    }
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { 
            "Minfrequency attribute not found in Node State update" 
          }
...
suspend fun readMaxFrequencyAttribute(): UShort? {val ATTRIBUTE_ID: UInt = 6u
    ...
    requireNotNull(attributeData) { 
      "Maxfrequency attribute not found in response" 
    }
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { 
            "Maxfrequency attribute not found in Node State update" 
          }
...
suspend fun readOnOffTransitionTimeAttribute(): UShort? {val ATTRIBUTE_ID: UInt = 16u
    ...
    requireNotNull(attributeData) { 
      "Onofftransitiontime attribute not found in response" 
    }
...
suspend fun readOnLevelAttribute(): OnLevelAttribute {val ATTRIBUTE_ID: UInt = 17u
    ...
    requireNotNull(attributeData) { 
      "Onlevel attribute not found in response" 
    }
  ...
  suspend fun subscribeOnLevelAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(OnLevelAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
          ...
          requireNotNull(attributeData) { 
            "Onlevel attribute not found in Node State update" 
          }
      ...
      null
          ...
          decodedValue?.let {
            emit(OnLevelAttributeSubscriptionState.Success(it))
          }
...
suspend fun readOnTransitionTimeAttribute(): OnTransitionTimeAttribute {val ATTRIBUTE_ID: UInt = 18u
    ...
    requireNotNull(attributeData) { 
      "Ontransitiontime attribute not found in response" 
    }
  ...
  suspend fun subscribeOnTransitionTimeAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(OnTransitionTimeAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
      ...
      null
          ...
          decodedValue?.let {
            emit(OnTransitionTimeAttributeSubscriptionState.Success(it))
          }
...
suspend fun readOffTransitionTimeAttribute(): OffTransitionTimeAttribute {val ATTRIBUTE_ID: UInt = 19u
    ...
    requireNotNull(attributeData) { 
      "Offtransitiontime attribute not found in response" 
    }
  ...
  suspend fun subscribeOffTransitionTimeAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(OffTransitionTimeAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
      ...
      null
          ...
          decodedValue?.let {
            emit(OffTransitionTimeAttributeSubscriptionState.Success(it))
          }
...
suspend fun readDefaultMoveRateAttribute(): DefaultMoveRateAttribute {val ATTRIBUTE_ID: UInt = 20u
    ...
    requireNotNull(attributeData) { 
      "Defaultmoverate attribute not found in response" 
    }
  ...
  suspend fun subscribeDefaultMoveRateAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(DefaultMoveRateAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
      ...
      null
          ...
          decodedValue?.let {
            emit(DefaultMoveRateAttributeSubscriptionState.Success(it))
          }
...
suspend fun readStartUpCurrentLevelAttribute(): StartUpCurrentLevelAttribute {val ATTRIBUTE_ID: UInt = 16384u
    ...
    requireNotNull(attributeData) { 
      "Startupcurrentlevel attribute not found in response" 
    }
  ...
  suspend fun subscribeStartUpCurrentLevelAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(StartUpCurrentLevelAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
      ...
      null
          ...
          decodedValue?.let {
            emit(StartUpCurrentLevelAttributeSubscriptionState.Success(it))
          }
