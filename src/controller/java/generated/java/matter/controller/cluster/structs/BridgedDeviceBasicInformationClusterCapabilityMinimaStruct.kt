...
class BridgedDeviceBasicInformationClusterCapabilityMinimaStruct(
  val caseSessionsPerFabric: UShort,
  val subscriptionsPerFabric: UShort,
) {
  override fun toString(): String = buildString {
    append("BridgedDeviceBasicInformationClusterCapabilityMinimaStruct {\n")
  ...
  companion object {
    ...
    fun fromTlv(
      tlvTag: Tag,
      tlvReader: TlvReader,
    ): BridgedDeviceBasicInformationClusterCapabilityMinimaStruct {
      ...
      return BridgedDeviceBasicInformationClusterCapabilityMinimaStruct(
