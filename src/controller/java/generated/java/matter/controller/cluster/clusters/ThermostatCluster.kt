...
class ThermostatCluster(private val controller: MatterController, private val endpointId: UShort) {
  ...
  class AddThermostatSuggestionResponse(
    val uniqueID: UByte
  )
...
class LocalTemperatureAttribute(
  ...
  sealed class LocalTemperatureAttributeSubscriptionState {
    data class Success(
    val value: Short?
    ) : LocalTemperatureAttributeSubscriptionState()
...
class OutdoorTemperatureAttribute(
  ...
  sealed class OutdoorTemperatureAttributeSubscriptionState {
    data class Success(
    val value: Short?
    ) : OutdoorTemperatureAttributeSubscriptionState()
...
class SetpointChangeAmountAttribute(
  ...
  sealed class SetpointChangeAmountAttributeSubscriptionState {
    data class Success(
    val value: Short?
    ) : SetpointChangeAmountAttributeSubscriptionState()
...
class OccupiedSetbackAttribute(
  ...
  sealed class OccupiedSetbackAttributeSubscriptionState {
    data class Success(
    val value: UByte?
    ) : OccupiedSetbackAttributeSubscriptionState()
...
class OccupiedSetbackMinAttribute(
  ...
  sealed class OccupiedSetbackMinAttributeSubscriptionState {
    data class Success(
    val value: UByte?
    ) : OccupiedSetbackMinAttributeSubscriptionState()
...
class OccupiedSetbackMaxAttribute(
  ...
  sealed class OccupiedSetbackMaxAttributeSubscriptionState {
    data class Success(
    val value: UByte?
    ) : OccupiedSetbackMaxAttributeSubscriptionState()
...
class UnoccupiedSetbackAttribute(
  ...
  sealed class UnoccupiedSetbackAttributeSubscriptionState {
    data class Success(
    val value: UByte?
    ) : UnoccupiedSetbackAttributeSubscriptionState()
...
class UnoccupiedSetbackMinAttribute(
  ...
  sealed class UnoccupiedSetbackMinAttributeSubscriptionState {
    data class Success(
    val value: UByte?
    ) : UnoccupiedSetbackMinAttributeSubscriptionState()
...
class UnoccupiedSetbackMaxAttribute(
  ...
  sealed class UnoccupiedSetbackMaxAttributeSubscriptionState {
    data class Success(
    val value: UByte?
    ) : UnoccupiedSetbackMaxAttributeSubscriptionState()
...
class ACCoilTemperatureAttribute(
  ...
  sealed class ACCoilTemperatureAttributeSubscriptionState {
    data class Success(
    val value: Short?
    ) : ACCoilTemperatureAttributeSubscriptionState()
...
class NumberOfScheduleTransitionPerDayAttribute(
  ...
  sealed class NumberOfScheduleTransitionPerDayAttributeSubscriptionState {
    ...
    data class Error(val exception: Exception) : NumberOfScheduleTransitionPerDayAttributeSubscriptionState()
...
class ActivePresetHandleAttribute(
  ...
  sealed class ActivePresetHandleAttributeSubscriptionState {
    data class Success(
    val value: ByteArray?
    ) : ActivePresetHandleAttributeSubscriptionState()
...
class ActiveScheduleHandleAttribute(
  ...
  sealed class ActiveScheduleHandleAttributeSubscriptionState {
    data class Success(
    val value: ByteArray?
    ) : ActiveScheduleHandleAttributeSubscriptionState()
...
class SetpointHoldExpiryTimestampAttribute(
  ...
  sealed class SetpointHoldExpiryTimestampAttributeSubscriptionState {
    ...
    data class Error(val exception: Exception) : SetpointHoldExpiryTimestampAttributeSubscriptionState()
...
class CurrentThermostatSuggestionAttribute(
  ...
  sealed class CurrentThermostatSuggestionAttributeSubscriptionState {
    ...
    data class Error(val exception: Exception) : CurrentThermostatSuggestionAttributeSubscriptionState()

    object SubscriptionEstablished : CurrentThermostatSuggestionAttributeSubscriptionState()    
  }  
class ThermostatSuggestionNotFollowingReasonAttribute(
    val value: UShort?
  )
  ...
  sealed class ThermostatSuggestionNotFollowingReasonAttributeSubscriptionState {
    ...
    data class Error(val exception: Exception) : ThermostatSuggestionNotFollowingReasonAttributeSubscriptionState()

    object SubscriptionEstablished : ThermostatSuggestionNotFollowingReasonAttributeSubscriptionState()    
  }  
...
class AttributeListAttribute(
  ...
  suspend fun setpointRaiseLower(mode: UByte
      ,amount: Byte
  ...
  suspend fun setWeeklySchedule(numberOfTransitionsForSequence: UByte
  ...
  suspend fun getWeeklySchedule(daysToReturn: UByte
      ,modeToReturn: UByte
      ,timedInvokeTimeout: Duration? = null): GetWeeklyScheduleResponse {
    ...
    while (!tlvReader.isEndOfContainer()) {
      ...
      if (tag == ContextSpecificTag(TAG_NUMBER_OF_TRANSITIONS_FOR_SEQUENCE)) {numberOfTransitionsForSequence_decoded = tlvReader.getUByte(tag)} else
      
      if (tag == ContextSpecificTag(TAG_DAY_OF_WEEK_FOR_SEQUENCE)) {dayOfWeekForSequence_decoded = tlvReader.getUByte(tag)} else
      
      if (tag == ContextSpecificTag(TAG_MODE_FOR_SEQUENCE)) {modeForSequence_decoded = tlvReader.getUByte(tag)} else
      
      if (tag == ContextSpecificTag(TAG_TRANSITIONS)) {transitions_decoded = buildList<ThermostatClusterWeeklyScheduleTransitionStruct> {
  ...
  suspend fun setActiveScheduleRequest(scheduleHandle: ByteArray
      ,timedInvokeTimeout: Duration? = null) {
  ...
  suspend fun setActivePresetRequest(presetHandle: ByteArray?
      ,timedInvokeTimeout: Duration? = null) {
  ...
  suspend fun addThermostatSuggestion(presetHandle: ByteArray
      ,effectiveTime: UInt?
      ,expirationInMinutes: UShort
      ,timedInvokeTimeout: Duration? = null): AddThermostatSuggestionResponse {
    ...
    effectiveTime?.let {
      tlvWriter.put(ContextSpecificTag(TAG_EFFECTIVE_TIME_REQ), effectiveTime)
    }
    ...
    while (!tlvReader.isEndOfContainer()) {
      ...
      if (tag == ContextSpecificTag(TAG_UNIQUE_ID)) {uniqueID_decoded = tlvReader.getUByte(tag)} else
      {
        tlvReader.skipElement()
      }
    }
  ...
  suspend fun removeThermostatSuggestion(uniqueID: UByte
      ,timedInvokeTimeout: Duration? = null) {
  ...
  suspend fun atomicRequest(requestType: UByte
      ,attributeRequests: List<UInt>
      ,timeout: UShort?
      ,timedInvokeTimeout: Duration? = null): AtomicResponse {
    ...
    while (!tlvReader.isEndOfContainer()) {
      ...
      if (tag == ContextSpecificTag(TAG_ATTRIBUTE_STATUS)) {attributeStatus_decoded = buildList<ThermostatClusterAtomicAttributeStatusStruct> {
      tlvReader.enterArray(tag)
      while(!tlvReader.isEndOfContainer()) {
      ...
      if (tag == ContextSpecificTag(TAG_TIMEOUT)) {timeout_decoded = 
          if (tlvReader.isNull()) {
...
suspend fun readLocalTemperatureAttribute(): LocalTemperatureAttribute {val ATTRIBUTE_ID: UInt = 0u
    ...
    requireNotNull(attributeData) { 
      "Localtemperature attribute not found in response" 
    }
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(LocalTemperatureAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
      ...
      null
          ...
          decodedValue?.let {
            emit(LocalTemperatureAttributeSubscriptionState.Success(it))
          }
...
suspend fun readOutdoorTemperatureAttribute(): OutdoorTemperatureAttribute {val ATTRIBUTE_ID: UInt = 1u
    ...
    requireNotNull(attributeData) { 
      "Outdoortemperature attribute not found in response" 
    }
  ...
  suspend fun subscribeOutdoorTemperatureAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(OutdoorTemperatureAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
      ...
      null
          ...
          decodedValue?.let {
            emit(OutdoorTemperatureAttributeSubscriptionState.Success(it))
          }
...
suspend fun readOccupancyAttribute(): UByte? {val ATTRIBUTE_ID: UInt = 2u
    ...
    requireNotNull(attributeData) { 
      "Occupancy attribute not found in response" 
    }
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { 
            "Occupancy attribute not found in Node State update" 
          }
...
suspend fun readAbsMinHeatSetpointLimitAttribute(): Short? {val ATTRIBUTE_ID: UInt = 3u
    ...
    requireNotNull(attributeData) { 
      "Absminheatsetpointlimit attribute not found in response" 
    }
...
suspend fun readAbsMaxHeatSetpointLimitAttribute(): Short? {val ATTRIBUTE_ID: UInt = 4u
    ...
    requireNotNull(attributeData) { 
      "Absmaxheatsetpointlimit attribute not found in response" 
    }
...
suspend fun readAbsMinCoolSetpointLimitAttribute(): Short? {val ATTRIBUTE_ID: UInt = 5u
    ...
    requireNotNull(attributeData) { 
      "Absmincoolsetpointlimit attribute not found in response" 
    }
...
suspend fun readAbsMaxCoolSetpointLimitAttribute(): Short? {val ATTRIBUTE_ID: UInt = 6u
    ...
    requireNotNull(attributeData) { 
      "Absmaxcoolsetpointlimit attribute not found in response" 
    }
...
suspend fun readPICoolingDemandAttribute(): UByte? {val ATTRIBUTE_ID: UInt = 7u
    ...
    requireNotNull(attributeData) { 
      "Picoolingdemand attribute not found in response" 
    }
...
suspend fun readPIHeatingDemandAttribute(): UByte? {val ATTRIBUTE_ID: UInt = 8u
    ...
    requireNotNull(attributeData) { 
      "Piheatingdemand attribute not found in response" 
    }
...
suspend fun readHVACSystemTypeConfigurationAttribute(): UByte? {val ATTRIBUTE_ID: UInt = 9u
...
suspend fun readLocalTemperatureCalibrationAttribute(): Byte? {val ATTRIBUTE_ID: UInt = 16u
...
suspend fun readOccupiedCoolingSetpointAttribute(): Short? {val ATTRIBUTE_ID: UInt = 17u
    ...
    requireNotNull(attributeData) { 
      "Occupiedcoolingsetpoint attribute not found in response" 
    }
...
suspend fun readOccupiedHeatingSetpointAttribute(): Short? {val ATTRIBUTE_ID: UInt = 18u
    ...
    requireNotNull(attributeData) { 
      "Occupiedheatingsetpoint attribute not found in response" 
    }
...
suspend fun readUnoccupiedCoolingSetpointAttribute(): Short? {val ATTRIBUTE_ID: UInt = 19u
    ...
    requireNotNull(attributeData) { 
      "Unoccupiedcoolingsetpoint attribute not found in response" 
    }
...
suspend fun readUnoccupiedHeatingSetpointAttribute(): Short? {val ATTRIBUTE_ID: UInt = 20u
    ...
    requireNotNull(attributeData) { 
      "Unoccupiedheatingsetpoint attribute not found in response" 
    }
...
suspend fun readMinHeatSetpointLimitAttribute(): Short? {val ATTRIBUTE_ID: UInt = 21u
    ...
    requireNotNull(attributeData) { 
      "Minheatsetpointlimit attribute not found in response" 
    }
...
suspend fun readMaxHeatSetpointLimitAttribute(): Short? {val ATTRIBUTE_ID: UInt = 22u
    ...
    requireNotNull(attributeData) { 
      "Maxheatsetpointlimit attribute not found in response" 
    }
...
suspend fun readMinCoolSetpointLimitAttribute(): Short? {val ATTRIBUTE_ID: UInt = 23u
    ...
    requireNotNull(attributeData) { 
      "Mincoolsetpointlimit attribute not found in response" 
    }
...
suspend fun readMaxCoolSetpointLimitAttribute(): Short? {val ATTRIBUTE_ID: UInt = 24u
    ...
    requireNotNull(attributeData) { 
      "Maxcoolsetpointlimit attribute not found in response" 
    }
...
suspend fun readMinSetpointDeadBandAttribute(): Byte? {val ATTRIBUTE_ID: UInt = 25u
    ...
    requireNotNull(attributeData) { 
      "Minsetpointdeadband attribute not found in response" 
    }
...
suspend fun readRemoteSensingAttribute(): UByte? {val ATTRIBUTE_ID: UInt = 26u
    ...
    requireNotNull(attributeData) { 
      "Remotesensing attribute not found in response" 
    }
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { 
            "Remotesensing attribute not found in Node State update" 
          }
...
suspend fun readControlSequenceOfOperationAttribute(): UByte {val ATTRIBUTE_ID: UInt = 27u
    ...
    requireNotNull(attributeData) { 
      "Controlsequenceofoperation attribute not found in response" 
    }
...
suspend fun readSystemModeAttribute(): UByte {val ATTRIBUTE_ID: UInt = 28u
    ...
    requireNotNull(attributeData) { 
      "Systemmode attribute not found in response" 
    }
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { 
            "Systemmode attribute not found in Node State update" 
          }
...
suspend fun readThermostatRunningModeAttribute(): UByte? {val ATTRIBUTE_ID: UInt = 30u
    ...
    requireNotNull(attributeData) { 
      "Thermostatrunningmode attribute not found in response" 
    }
...
suspend fun readStartOfWeekAttribute(): UByte? {val ATTRIBUTE_ID: UInt = 32u
    ...
    requireNotNull(attributeData) { 
      "Startofweek attribute not found in response" 
    }
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { 
            "Startofweek attribute not found in Node State update" 
          }
...
suspend fun readNumberOfWeeklyTransitionsAttribute(): UByte? {val ATTRIBUTE_ID: UInt = 33u
    ...
    requireNotNull(attributeData) { 
      "Numberofweeklytransitions attribute not found in response" 
    }
...
suspend fun readNumberOfDailyTransitionsAttribute(): UByte? {val ATTRIBUTE_ID: UInt = 34u
    ...
    requireNotNull(attributeData) { 
      "Numberofdailytransitions attribute not found in response" 
    }
...
suspend fun readTemperatureSetpointHoldAttribute(): UByte? {val ATTRIBUTE_ID: UInt = 35u
    ...
    requireNotNull(attributeData) { 
      "Temperaturesetpointhold attribute not found in response" 
    }
...
suspend fun readTemperatureSetpointHoldDurationAttribute(): TemperatureSetpointHoldDurationAttribute {val ATTRIBUTE_ID: UInt = 36u
  ...
  suspend fun subscribeTemperatureSetpointHoldDurationAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(TemperatureSetpointHoldDurationAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
...
suspend fun readThermostatProgrammingOperationModeAttribute(): UByte? {val ATTRIBUTE_ID: UInt = 37u
...
suspend fun readThermostatRunningStateAttribute(): UShort? {val ATTRIBUTE_ID: UInt = 41u
    ...
    requireNotNull(attributeData) { 
      "Thermostatrunningstate attribute not found in response" 
    }
...
suspend fun readSetpointChangeSourceAttribute(): UByte? {val ATTRIBUTE_ID: UInt = 48u
    ...
    requireNotNull(attributeData) { 
      "Setpointchangesource attribute not found in response" 
    }
...
suspend fun readSetpointChangeAmountAttribute(): SetpointChangeAmountAttribute {val ATTRIBUTE_ID: UInt = 49u
    ...
    requireNotNull(attributeData) { 
      "Setpointchangeamount attribute not found in response" 
    }
  ...
  suspend fun subscribeSetpointChangeAmountAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(SetpointChangeAmountAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
      ...
      null
          ...
          decodedValue?.let {
            emit(SetpointChangeAmountAttributeSubscriptionState.Success(it))
          }
...
suspend fun readSetpointChangeSourceTimestampAttribute(): UInt? {val ATTRIBUTE_ID: UInt = 50u
...
suspend fun readOccupiedSetbackAttribute(): OccupiedSetbackAttribute {val ATTRIBUTE_ID: UInt = 52u
    ...
    requireNotNull(attributeData) { 
      "Occupiedsetback attribute not found in response" 
    }
  ...
  suspend fun subscribeOccupiedSetbackAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(OccupiedSetbackAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
      ...
      null
          ...
          decodedValue?.let {
            emit(OccupiedSetbackAttributeSubscriptionState.Success(it))
          }
...
suspend fun readOccupiedSetbackMinAttribute(): OccupiedSetbackMinAttribute {val ATTRIBUTE_ID: UInt = 53u
    ...
    requireNotNull(attributeData) { 
      "Occupiedsetbackmin attribute not found in response" 
    }
  ...
  suspend fun subscribeOccupiedSetbackMinAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(OccupiedSetbackMinAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
      ...
      null
          ...
          decodedValue?.let {
            emit(OccupiedSetbackMinAttributeSubscriptionState.Success(it))
          }
...
suspend fun readOccupiedSetbackMaxAttribute(): OccupiedSetbackMaxAttribute {val ATTRIBUTE_ID: UInt = 54u
    ...
    requireNotNull(attributeData) { 
      "Occupiedsetbackmax attribute not found in response" 
    }
  ...
  suspend fun subscribeOccupiedSetbackMaxAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(OccupiedSetbackMaxAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
      ...
      null
          ...
          decodedValue?.let {
            emit(OccupiedSetbackMaxAttributeSubscriptionState.Success(it))
          }
...
suspend fun readUnoccupiedSetbackAttribute(): UnoccupiedSetbackAttribute {val ATTRIBUTE_ID: UInt = 55u
    ...
    requireNotNull(attributeData) { 
      "Unoccupiedsetback attribute not found in response" 
    }
  ...
  suspend fun subscribeUnoccupiedSetbackAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(UnoccupiedSetbackAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
      ...
      null
          ...
          decodedValue?.let {
            emit(UnoccupiedSetbackAttributeSubscriptionState.Success(it))
          }
...
suspend fun readUnoccupiedSetbackMinAttribute(): UnoccupiedSetbackMinAttribute {val ATTRIBUTE_ID: UInt = 56u
    ...
    requireNotNull(attributeData) { 
      "Unoccupiedsetbackmin attribute not found in response" 
    }
  ...
  suspend fun subscribeUnoccupiedSetbackMinAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(UnoccupiedSetbackMinAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
      ...
      null
          ...
          decodedValue?.let {
            emit(UnoccupiedSetbackMinAttributeSubscriptionState.Success(it))
          }
...
suspend fun readUnoccupiedSetbackMaxAttribute(): UnoccupiedSetbackMaxAttribute {val ATTRIBUTE_ID: UInt = 57u
    ...
    requireNotNull(attributeData) { 
      "Unoccupiedsetbackmax attribute not found in response" 
    }
  ...
  suspend fun subscribeUnoccupiedSetbackMaxAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(UnoccupiedSetbackMaxAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
      ...
      null
          ...
          decodedValue?.let {
            emit(UnoccupiedSetbackMaxAttributeSubscriptionState.Success(it))
          }
...
suspend fun readEmergencyHeatDeltaAttribute(): UByte? {val ATTRIBUTE_ID: UInt = 58u
    ...
    requireNotNull(attributeData) { 
      "Emergencyheatdelta attribute not found in response" 
    }
...
suspend fun readACTypeAttribute(): UByte? {val ATTRIBUTE_ID: UInt = 64u
    ...
    requireNotNull(attributeData) { 
      "Actype attribute not found in response" 
    }
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { 
            "Actype attribute not found in Node State update" 
          }
...
suspend fun readACCapacityAttribute(): UShort? {val ATTRIBUTE_ID: UInt = 65u
    ...
    requireNotNull(attributeData) { 
      "Accapacity attribute not found in response" 
    }
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { 
            "Accapacity attribute not found in Node State update" 
          }
...
suspend fun readACRefrigerantTypeAttribute(): UByte? {val ATTRIBUTE_ID: UInt = 66u
    ...
    requireNotNull(attributeData) { 
      "Acrefrigeranttype attribute not found in response" 
    }
...
suspend fun readACCompressorTypeAttribute(): UByte? {val ATTRIBUTE_ID: UInt = 67u
    ...
    requireNotNull(attributeData) { 
      "Accompressortype attribute not found in response" 
    }
...
suspend fun readACErrorCodeAttribute(): UInt? {val ATTRIBUTE_ID: UInt = 68u
    ...
    requireNotNull(attributeData) { 
      "Acerrorcode attribute not found in response" 
    }
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { 
            "Acerrorcode attribute not found in Node State update" 
          }
...
suspend fun readACLouverPositionAttribute(): UByte? {val ATTRIBUTE_ID: UInt = 69u
    ...
    requireNotNull(attributeData) { 
      "Aclouverposition attribute not found in response" 
    }
...
suspend fun readACCoilTemperatureAttribute(): ACCoilTemperatureAttribute {val ATTRIBUTE_ID: UInt = 70u
    ...
    requireNotNull(attributeData) { 
      "Accoiltemperature attribute not found in response" 
    }
  ...
  suspend fun subscribeACCoilTemperatureAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(ACCoilTemperatureAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
      ...
      null
          ...
          decodedValue?.let {
            emit(ACCoilTemperatureAttributeSubscriptionState.Success(it))
          }
...
suspend fun readACCapacityformatAttribute(): UByte? {val ATTRIBUTE_ID: UInt = 71u
    ...
    requireNotNull(attributeData) { 
      "Accapacityformat attribute not found in response" 
    }
...
suspend fun readPresetTypesAttribute(): PresetTypesAttribute {val ATTRIBUTE_ID: UInt = 72u
    ...
    requireNotNull(attributeData) { 
      "Presettypes attribute not found in response" 
    }

    // Decode the TLV data into the appropriate type
    val tlvReader = TlvReader(attributeData.data)
    val decodedValue: List<ThermostatClusterPresetTypeStruct>? = if (tlvReader.isNextTag(AnonymousTag)) {
  ...
  suspend fun subscribePresetTypesAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(PresetTypesAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
          ...
          requireNotNull(attributeData) { 
            "Presettypes attribute not found in Node State update" 
          }
      ...
      null
          ...
          decodedValue?.let {
            emit(PresetTypesAttributeSubscriptionState.Success(it))
          }
...
suspend fun readScheduleTypesAttribute(): ScheduleTypesAttribute {val ATTRIBUTE_ID: UInt = 73u
    ...
    requireNotNull(attributeData) { 
      "Scheduletypes attribute not found in response" 
    }

    // Decode the TLV data into the appropriate type
    val tlvReader = TlvReader(attributeData.data)
    val decodedValue: List<ThermostatClusterScheduleTypeStruct>? = if (tlvReader.isNextTag(AnonymousTag)) {
  ...
  suspend fun subscribeScheduleTypesAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(ScheduleTypesAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
          ...
          requireNotNull(attributeData) { 
            "Scheduletypes attribute not found in Node State update" 
          }
      ...
      null
          ...
          decodedValue?.let {
            emit(ScheduleTypesAttributeSubscriptionState.Success(it))
          }
...
suspend fun readNumberOfPresetsAttribute(): UByte? {val ATTRIBUTE_ID: UInt = 74u
    ...
    requireNotNull(attributeData) { 
      "Numberofpresets attribute not found in response" 
    }
...
suspend fun readNumberOfSchedulesAttribute(): UByte? {val ATTRIBUTE_ID: UInt = 75u
    ...
    requireNotNull(attributeData) { 
      "Numberofschedules attribute not found in response" 
    }
...
suspend fun readNumberOfScheduleTransitionsAttribute(): UByte? {val ATTRIBUTE_ID: UInt = 76u
    ...
    requireNotNull(attributeData) { 
      "Numberofscheduletransitions attribute not found in response" 
    }
...
suspend fun readNumberOfScheduleTransitionPerDayAttribute(): NumberOfScheduleTransitionPerDayAttribute {val ATTRIBUTE_ID: UInt = 77u
  ...
  suspend fun subscribeNumberOfScheduleTransitionPerDayAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(NumberOfScheduleTransitionPerDayAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
...
suspend fun readActivePresetHandleAttribute(): ActivePresetHandleAttribute {val ATTRIBUTE_ID: UInt = 78u
    ...
    requireNotNull(attributeData) { 
      "Activepresethandle attribute not found in response" 
    }
  ...
  suspend fun subscribeActivePresetHandleAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(ActivePresetHandleAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
      ...
      null
          ...
          decodedValue?.let {
            emit(ActivePresetHandleAttributeSubscriptionState.Success(it))
          }
...
suspend fun readActiveScheduleHandleAttribute(): ActiveScheduleHandleAttribute {val ATTRIBUTE_ID: UInt = 79u
    ...
    requireNotNull(attributeData) { 
      "Activeschedulehandle attribute not found in response" 
    }
  ...
  suspend fun subscribeActiveScheduleHandleAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(ActiveScheduleHandleAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
      ...
      null
          ...
          decodedValue?.let {
            emit(ActiveScheduleHandleAttributeSubscriptionState.Success(it))
          }
...
suspend fun readPresetsAttribute(): PresetsAttribute {val ATTRIBUTE_ID: UInt = 80u
    ...
    requireNotNull(attributeData) { 
      "Presets attribute not found in response" 
    }

    // Decode the TLV data into the appropriate type
    val tlvReader = TlvReader(attributeData.data)
    val decodedValue: List<ThermostatClusterPresetStruct>? = if (tlvReader.isNextTag(AnonymousTag)) {
  ...
  suspend fun subscribePresetsAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(PresetsAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
          ...
          requireNotNull(attributeData) { 
            "Presets attribute not found in Node State update" 
          }
      ...
      null
          ...
          decodedValue?.let {
            emit(PresetsAttributeSubscriptionState.Success(it))
          }
...
suspend fun readSchedulesAttribute(): SchedulesAttribute {val ATTRIBUTE_ID: UInt = 81u
    ...
    requireNotNull(attributeData) { 
      "Schedules attribute not found in response" 
    }

    // Decode the TLV data into the appropriate type
    val tlvReader = TlvReader(attributeData.data)
    val decodedValue: List<ThermostatClusterScheduleStruct>? = if (tlvReader.isNextTag(AnonymousTag)) {
  ...
  suspend fun subscribeSchedulesAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(SchedulesAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
          ...
          requireNotNull(attributeData) { 
            "Schedules attribute not found in Node State update" 
          }
      ...
      null
          ...
          decodedValue?.let {
            emit(SchedulesAttributeSubscriptionState.Success(it))
          }
...
suspend fun readSetpointHoldExpiryTimestampAttribute(): SetpointHoldExpiryTimestampAttribute {val ATTRIBUTE_ID: UInt = 82u
    ...
    requireNotNull(attributeData) { 
      "Setpointholdexpirytimestamp attribute not found in response" 
    }
  ...
  suspend fun subscribeSetpointHoldExpiryTimestampAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(SetpointHoldExpiryTimestampAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
...
suspend fun readMaxThermostatSuggestionsAttribute(): UByte? {val ATTRIBUTE_ID: UInt = 83u
    ...
    requireNotNull(attributeData) { 
      "Maxthermostatsuggestions attribute not found in response" 
    }
...
suspend fun readThermostatSuggestionsAttribute(): ThermostatSuggestionsAttribute {val ATTRIBUTE_ID: UInt = 84u
    ...
    requireNotNull(attributeData) { 
      "Thermostatsuggestions attribute not found in response" 
    }

    // Decode the TLV data into the appropriate type
    val tlvReader = TlvReader(attributeData.data)
    val decodedValue: List<ThermostatClusterThermostatSuggestionStruct>? = if (tlvReader.isNextTag(AnonymousTag)) {
  ...
  suspend fun subscribeThermostatSuggestionsAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(ThermostatSuggestionsAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
      ...
      null
          ...
          decodedValue?.let {
            emit(ThermostatSuggestionsAttributeSubscriptionState.Success(it))
          }
...
suspend fun readCurrentThermostatSuggestionAttribute(): CurrentThermostatSuggestionAttribute {val ATTRIBUTE_ID: UInt = 85u
    ...
    requireNotNull(attributeData) { 
      "Currentthermostatsuggestion attribute not found in response" 
    }

    // Decode the TLV data into the appropriate type
    val tlvReader = TlvReader(attributeData.data)
    val decodedValue: ThermostatClusterThermostatSuggestionStruct? = if (!tlvReader.isNull()) {
      if (tlvReader.isNextTag(AnonymousTag)) {
  ...
  suspend fun subscribeCurrentThermostatSuggestionAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(CurrentThermostatSuggestionAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
...
suspend fun readThermostatSuggestionNotFollowingReasonAttribute(): ThermostatSuggestionNotFollowingReasonAttribute {val ATTRIBUTE_ID: UInt = 86u
  ...
  suspend fun subscribeThermostatSuggestionNotFollowingReasonAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(ThermostatSuggestionNotFollowingReasonAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
      ...
      null
        ...
        SubscriptionState.SubscriptionEstablished -> {
          emit(ThermostatSuggestionNotFollowingReasonAttributeSubscriptionState.SubscriptionEstablished)
        }
      }
    }    
  }
