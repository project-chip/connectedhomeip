...
class SoftwareDiagnosticsCluster(private val controller: MatterController, private val endpointId: UShort) {class ThreadMetricsAttribute(
    val value: List<SoftwareDiagnosticsClusterThreadMetricsStruct>?
  )

  sealed class ThreadMetricsAttributeSubscriptionState {
    data class Success(
    val value: List<SoftwareDiagnosticsClusterThreadMetricsStruct>?
    ) : ThreadMetricsAttributeSubscriptionState()
    
    data class Error(val exception: Exception) : ThreadMetricsAttributeSubscriptionState()

    object SubscriptionEstablished : ThreadMetricsAttributeSubscriptionState()    
  }  
...
suspend fun readThreadMetricsAttribute(): ThreadMetricsAttribute {val ATTRIBUTE_ID: UInt = 0u
    ...
    requireNotNull(attributeData) { 
      "Threadmetrics attribute not found in response" 
    }

    // Decode the TLV data into the appropriate type
    val tlvReader = TlvReader(attributeData.data)
    val decodedValue: List<SoftwareDiagnosticsClusterThreadMetricsStruct>? = if (tlvReader.isNextTag(AnonymousTag)) {
  ...
  suspend fun subscribeThreadMetricsAttribute(
    minInterval: Int,
    maxInterval: Int
  ): Flow<ThreadMetricsAttributeSubscriptionState> {
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(ThreadMetricsAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { 
            "Threadmetrics attribute not found in Node State update" 
          }
      ...
      null
          ...
          decodedValue?.let {
            emit(ThreadMetricsAttributeSubscriptionState.Success(it))
          }
          
        }
        SubscriptionState.SubscriptionEstablished -> {
          emit(ThreadMetricsAttributeSubscriptionState.SubscriptionEstablished)
        }
      }
    }    
  }
suspend fun readCurrentHeapFreeAttribute(): ULong? {val ATTRIBUTE_ID: UInt = 1u
    ...
    requireNotNull(attributeData) { 
      "Currentheapfree attribute not found in response" 
    }
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { 
            "Currentheapfree attribute not found in Node State update" 
          }
...
suspend fun readCurrentHeapUsedAttribute(): ULong? {val ATTRIBUTE_ID: UInt = 2u
    ...
    requireNotNull(attributeData) { 
      "Currentheapused attribute not found in response" 
    }
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { 
            "Currentheapused attribute not found in Node State update" 
          }
...
suspend fun readCurrentHeapHighWatermarkAttribute(): ULong? {val ATTRIBUTE_ID: UInt = 3u
    ...
    requireNotNull(attributeData) { 
      "Currentheaphighwatermark attribute not found in response" 
    }
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { 
            "Currentheaphighwatermark attribute not found in Node State update" 
          }
