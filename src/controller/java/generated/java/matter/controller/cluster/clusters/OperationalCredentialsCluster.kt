...
class AttributeListAttribute(
  ...
  suspend fun CSRRequest(CSRNonce: ByteArray
    ...
    while (!tlvReader.isEndOfContainer()) {
      ...
      if (tag == ContextSpecificTag(TAG_N_O_C_S_R_ELEMENTS)) {NOCSRElements_decoded = tlvReader.getByteArray(tag)}  
  ...
  suspend fun addNOC(NOCValue: ByteArray
    ...
    ICACValue?.let {
      tlvWriter.put(ContextSpecificTag(TAG_I_C_A_C_VALUE_REQ), ICACValue)
    }
