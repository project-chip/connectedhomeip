...
class EcosystemInformationCluster(private val controller: MatterController, private val endpointId: UShort) {class DeviceDirectoryAttribute(
...
suspend fun readDeviceDirectoryAttribute(): DeviceDirectoryAttribute {val ATTRIBUTE_ID: UInt = 0u
...
suspend fun readLocationDirectoryAttribute(): LocationDirectoryAttribute {val ATTRIBUTE_ID: UInt = 1u
