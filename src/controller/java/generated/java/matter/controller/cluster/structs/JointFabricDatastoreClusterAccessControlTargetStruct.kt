...
class JointFabricDatastoreClusterAccessControlTargetStruct(
  val cluster: UInt?,
  val endpoint: UShort?,
  val deviceType: UInt?,
) {
  override fun toString(): String = buildString {
    append("JointFabricDatastoreClusterAccessControlTargetStruct {\n")
  ...
  companion object {
    ...
    fun fromTlv(
      tlvTag: Tag,
      tlvReader: TlvReader,
    ): JointFabricDatastoreClusterAccessControlTargetStruct {
      ...
      return JointFabricDatastoreClusterAccessControlTargetStruct(cluster, endpoint, deviceType)
    }
  }
}
