...
class AttributeListAttribute(
  ...
  suspend fun setTimeZone(timeZone: List<TimeSynchronizationClusterTimeZoneStruct>
    ...
    while (!tlvReader.isEndOfContainer()) {
      ...
      if (tag == ContextSpecificTag(TAG_D_S_T_OFFSET_REQUIRED)) {DSTOffsetRequired_decoded = tlvReader.getBoolean(tag)}  
  ...
  suspend fun setDefaultNTP(defaultNTP: String?
    ...
    defaultNTP?.let {
      tlvWriter.put(ContextSpecificTag(TAG_DEFAULT_N_T_P_REQ), defaultNTP)
    }    
    tlvWriter.endStructure()
