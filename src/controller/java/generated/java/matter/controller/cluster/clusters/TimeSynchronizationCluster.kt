...
class TimeSynchronizationCluster(
  ...
  sealed class TrustedTimeSourceAttributeSubscriptionState {
    data class Success(val value: TimeSynchronizationClusterTrustedTimeSourceStruct?) :
  ...
  sealed class DefaultNTPAttributeSubscriptionState {
    data class Success(val value: String?) : DefaultNTPAttributeSubscriptionState()
  ...
  sealed class TimeZoneAttributeSubscriptionState {
    data class Success(val value: List<TimeSynchronizationClusterTimeZoneStruct>?) :
  ...
  sealed class DSTOffsetAttributeSubscriptionState {
    data class Success(val value: List<TimeSynchronizationClusterDSTOffsetStruct>?) :
  ...
  sealed class LocalTimeAttributeSubscriptionState {
    data class Success(val value: ULong?) : LocalTimeAttributeSubscriptionState()
  ...
  suspend fun setDefaultNTP(defaultNTP: String?, timedInvokeTimeout: Duration? = null) {
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(
            UTCTimeAttributeSubscriptionState.Error(
              Exception(
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { "Utctime attribute not found in Node State update" }
          ...
          decodedValue?.let { emit(UTCTimeAttributeSubscriptionState.Success(it)) }
        }
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { "Granularity attribute not found in Node State update" }
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { "Timesource attribute not found in Node State update" }
  ...
  suspend fun subscribeTrustedTimeSourceAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(
            TrustedTimeSourceAttributeSubscriptionState.Error(
              Exception(
                "Subscription terminated with error code: ${subscriptionState.terminationCause}"
              )
            )
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          decodedValue?.let { emit(TrustedTimeSourceAttributeSubscriptionState.Success(it)) }
        }
        SubscriptionState.SubscriptionEstablished -> {
  ...
  suspend fun subscribeDefaultNTPAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(
            DefaultNTPAttributeSubscriptionState.Error(
              Exception(
                "Subscription terminated with error code: ${subscriptionState.terminationCause}"
              )
            )
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { "Defaultntp attribute not found in Node State update" }
          ...
          decodedValue?.let { emit(DefaultNTPAttributeSubscriptionState.Success(it)) }
        }
        SubscriptionState.SubscriptionEstablished -> {
  ...
  suspend fun subscribeTimeZoneAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(
            TimeZoneAttributeSubscriptionState.Error(
              Exception(
                "Subscription terminated with error code: ${subscriptionState.terminationCause}"
              )
            )
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          decodedValue?.let { emit(TimeZoneAttributeSubscriptionState.Success(it)) }
        }
        SubscriptionState.SubscriptionEstablished -> {
  ...
  suspend fun subscribeDSTOffsetAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(
            DSTOffsetAttributeSubscriptionState.Error(
              Exception(
                "Subscription terminated with error code: ${subscriptionState.terminationCause}"
              )
            )
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { "Dstoffset attribute not found in Node State update" }
          ...
          decodedValue?.let { emit(DSTOffsetAttributeSubscriptionState.Success(it)) }
        }
        SubscriptionState.SubscriptionEstablished -> {
  ...
  suspend fun subscribeLocalTimeAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(
            LocalTimeAttributeSubscriptionState.Error(
              Exception(
                "Subscription terminated with error code: ${subscriptionState.terminationCause}"
              )
            )
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { "Localtime attribute not found in Node State update" }
          ...
          decodedValue?.let { emit(LocalTimeAttributeSubscriptionState.Success(it)) }
        }
        SubscriptionState.SubscriptionEstablished -> {
