...
class OnOffCluster(private val controller: MatterController, private val endpointId: UShort) {class StartUpOnOffAttribute(
    val value: UByte?
  )
  ...
  sealed class StartUpOnOffAttributeSubscriptionState {
    data class Success(
    val value: UByte?
    ) : StartUpOnOffAttributeSubscriptionState()
...
class AttributeListAttribute(
  ...
  suspend fun offWithEffect(effectIdentifier: UByte
      ,effectVariant: UByte
  ...
  suspend fun onWithTimedOff(onOffControl: UByte
      ,onTime: UShort
      ,offWaitTime: UShort
      ,timedInvokeTimeout: Duration? = null) {
...
suspend fun readOnOffAttribute(): Boolean {val ATTRIBUTE_ID: UInt = 0u
    ...
    requireNotNull(attributeData) { 
      "Onoff attribute not found in response" 
    }
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { 
            "Onoff attribute not found in Node State update" 
          }
...
suspend fun readGlobalSceneControlAttribute(): Boolean? {val ATTRIBUTE_ID: UInt = 16384u
    ...
    requireNotNull(attributeData) { 
      "Globalscenecontrol attribute not found in response" 
    }
...
suspend fun readOnTimeAttribute(): UShort? {val ATTRIBUTE_ID: UInt = 16385u
    ...
    requireNotNull(attributeData) { 
      "Ontime attribute not found in response" 
    }
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { 
            "Ontime attribute not found in Node State update" 
          }
...
suspend fun readOffWaitTimeAttribute(): UShort? {val ATTRIBUTE_ID: UInt = 16386u
    ...
    requireNotNull(attributeData) { 
      "Offwaittime attribute not found in response" 
    }
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { 
            "Offwaittime attribute not found in Node State update" 
          }
...
suspend fun readStartUpOnOffAttribute(): StartUpOnOffAttribute {val ATTRIBUTE_ID: UInt = 16387u
    ...
    requireNotNull(attributeData) { 
      "Startuponoff attribute not found in response" 
    }
  ...
  suspend fun subscribeStartUpOnOffAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(StartUpOnOffAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
          ...
          requireNotNull(attributeData) { 
            "Startuponoff attribute not found in Node State update" 
          }
      ...
      null
          ...
          decodedValue?.let {
            emit(StartUpOnOffAttributeSubscriptionState.Success(it))
          }
