...
class JointFabricDatastoreClusterDatastoreGroupIDEntry(
  val groupID: UShort,
  val statusEntry: JointFabricDatastoreClusterDatastoreStatusEntry,
) {
  override fun toString(): String = buildString {
    append("JointFabricDatastoreClusterDatastoreGroupIDEntry {\n")
  ...
  companion object {
    ...
    private const val TAG_STATUS_ENTRY = 1

    fun fromTlv(
      tlvTag: Tag,
      tlvReader: TlvReader,
    ): JointFabricDatastoreClusterDatastoreGroupIDEntry {
      ...
      return JointFabricDatastoreClusterDatastoreGroupIDEntry(groupID, statusEntry)
    }
  }
}
