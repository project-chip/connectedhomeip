...
class BooleanStateConfigurationCluster(private val controller: MatterController, private val endpointId: UShort) {class GeneratedCommandListAttribute(
    val value: List<UInt>
  )
...
class AttributeListAttribute(
  ...
  suspend fun suppressAlarm(alarmsToSuppress: UByte
    ...
    val TAG_ALARMS_TO_SUPPRESS_REQ: Int = 0
    tlvWriter.put(ContextSpecificTag(TAG_ALARMS_TO_SUPPRESS_REQ), alarmsToSuppress)    
  ...
  suspend fun enableDisableAlarm(alarmsToEnableDisable: UByte
      ,timedInvokeTimeout: Duration? = null) {
...
suspend fun readCurrentSensitivityLevelAttribute(): UByte? {val ATTRIBUTE_ID: UInt = 0u
    ...
    requireNotNull(attributeData) { 
      "Currentsensitivitylevel attribute not found in response" 
    }
...
suspend fun readSupportedSensitivityLevelsAttribute(): UByte? {val ATTRIBUTE_ID: UInt = 1u
    ...
    requireNotNull(attributeData) { 
      "Supportedsensitivitylevels attribute not found in response" 
    }
...
suspend fun readDefaultSensitivityLevelAttribute(): UByte? {val ATTRIBUTE_ID: UInt = 2u
    ...
    requireNotNull(attributeData) { 
      "Defaultsensitivitylevel attribute not found in response" 
    }
...
suspend fun readAlarmsActiveAttribute(): UByte? {val ATTRIBUTE_ID: UInt = 3u
    ...
    requireNotNull(attributeData) { 
      "Alarmsactive attribute not found in response" 
    }
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { 
            "Alarmsactive attribute not found in Node State update" 
          }
...
suspend fun readAlarmsSuppressedAttribute(): UByte? {val ATTRIBUTE_ID: UInt = 4u
    ...
    requireNotNull(attributeData) { 
      "Alarmssuppressed attribute not found in response" 
    }
...
suspend fun readAlarmsEnabledAttribute(): UByte? {val ATTRIBUTE_ID: UInt = 5u
    ...
    requireNotNull(attributeData) { 
      "Alarmsenabled attribute not found in response" 
    }
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { 
            "Alarmsenabled attribute not found in Node State update" 
          }
...
suspend fun readAlarmsSupportedAttribute(): UByte? {val ATTRIBUTE_ID: UInt = 6u
    ...
    requireNotNull(attributeData) { 
      "Alarmssupported attribute not found in response" 
    }
...
suspend fun readSensorFaultAttribute(): UShort? {val ATTRIBUTE_ID: UInt = 7u
    ...
    requireNotNull(attributeData) { 
      "Sensorfault attribute not found in response" 
    }
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { 
            "Sensorfault attribute not found in Node State update" 
          }
