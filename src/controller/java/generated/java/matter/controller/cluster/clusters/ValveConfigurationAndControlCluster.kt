...
class ValveConfigurationAndControlCluster(
  ...
  sealed class AutoCloseTimeAttributeSubscriptionState {
    data class Success(val value: ULong?) : AutoCloseTimeAttributeSubscriptionState()
  ...
  sealed class RemainingDurationAttributeSubscriptionState {
    data class Success(val value: UInt?) : RemainingDurationAttributeSubscriptionState()
  ...
  sealed class CurrentStateAttributeSubscriptionState {
    data class Success(val value: UByte?) : CurrentStateAttributeSubscriptionState()
  ...
  sealed class TargetStateAttributeSubscriptionState {
    data class Success(val value: UByte?) : TargetStateAttributeSubscriptionState()
  ...
  sealed class CurrentLevelAttributeSubscriptionState {
    data class Success(val value: UByte?) : CurrentLevelAttributeSubscriptionState()
  ...
  sealed class TargetLevelAttributeSubscriptionState {
    data class Success(val value: UByte?) : TargetLevelAttributeSubscriptionState()
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(
            OpenDurationAttributeSubscriptionState.Error(
              Exception(
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { "Openduration attribute not found in Node State update" }
          ...
          decodedValue?.let { emit(OpenDurationAttributeSubscriptionState.Success(it)) }
        }
  ...
  suspend fun subscribeAutoCloseTimeAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(
            AutoCloseTimeAttributeSubscriptionState.Error(
              Exception(
                "Subscription terminated with error code: ${subscriptionState.terminationCause}"
              )
            )
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { "Autoclosetime attribute not found in Node State update" }
          ...
          decodedValue?.let { emit(AutoCloseTimeAttributeSubscriptionState.Success(it)) }
        }
        SubscriptionState.SubscriptionEstablished -> {
  ...
  suspend fun subscribeRemainingDurationAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(
            RemainingDurationAttributeSubscriptionState.Error(
              Exception(
                "Subscription terminated with error code: ${subscriptionState.terminationCause}"
              )
            )
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          decodedValue?.let { emit(RemainingDurationAttributeSubscriptionState.Success(it)) }
        }
        SubscriptionState.SubscriptionEstablished -> {
  ...
  suspend fun subscribeCurrentStateAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(
            CurrentStateAttributeSubscriptionState.Error(
              Exception(
                "Subscription terminated with error code: ${subscriptionState.terminationCause}"
              )
            )
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          decodedValue?.let { emit(CurrentStateAttributeSubscriptionState.Success(it)) }
        }
        SubscriptionState.SubscriptionEstablished -> {
  ...
  suspend fun subscribeCurrentLevelAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(
            CurrentLevelAttributeSubscriptionState.Error(
              Exception(
                "Subscription terminated with error code: ${subscriptionState.terminationCause}"
              )
            )
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { "Currentlevel attribute not found in Node State update" }
          ...
          decodedValue?.let { emit(CurrentLevelAttributeSubscriptionState.Success(it)) }
        }
        SubscriptionState.SubscriptionEstablished -> {
  ...
  suspend fun subscribeTargetLevelAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(
            TargetLevelAttributeSubscriptionState.Error(
              Exception(
                "Subscription terminated with error code: ${subscriptionState.terminationCause}"
              )
            )
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { "Targetlevel attribute not found in Node State update" }
          ...
          decodedValue?.let { emit(TargetLevelAttributeSubscriptionState.Success(it)) }
        }
        SubscriptionState.SubscriptionEstablished -> {
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { "Valvefault attribute not found in Node State update" }
