...
class ValveConfigurationAndControlCluster(private val controller: MatterController, private val endpointId: UShort) {class OpenDurationAttribute(
    val value: UInt?
  )

  sealed class OpenDurationAttributeSubscriptionState {
    data class Success(
    val value: UInt?
    ) : OpenDurationAttributeSubscriptionState()
...
class DefaultOpenDurationAttribute(
    val value: UInt?
  )
  ...
  sealed class DefaultOpenDurationAttributeSubscriptionState {
    data class Success(
    val value: UInt?
    ) : DefaultOpenDurationAttributeSubscriptionState()
...
class AutoCloseTimeAttribute(
  ...
  sealed class AutoCloseTimeAttributeSubscriptionState {
    data class Success(
    val value: ULong?
    ) : AutoCloseTimeAttributeSubscriptionState()
    
    data class Error(val exception: Exception) : AutoCloseTimeAttributeSubscriptionState()
...
class RemainingDurationAttribute(
  ...
  sealed class RemainingDurationAttributeSubscriptionState {
    data class Success(
    val value: UInt?
    ) : RemainingDurationAttributeSubscriptionState()
    
    data class Error(val exception: Exception) : RemainingDurationAttributeSubscriptionState()
...
class CurrentLevelAttribute(
  ...
  sealed class CurrentLevelAttributeSubscriptionState {
    data class Success(
    val value: UByte?
    ) : CurrentLevelAttributeSubscriptionState()
    
    data class Error(val exception: Exception) : CurrentLevelAttributeSubscriptionState()

    object SubscriptionEstablished : CurrentLevelAttributeSubscriptionState()    
  }  
class TargetLevelAttribute(
    val value: UByte?
  )

  sealed class TargetLevelAttributeSubscriptionState {
    data class Success(
    val value: UByte?
    ) : TargetLevelAttributeSubscriptionState()
    
    data class Error(val exception: Exception) : TargetLevelAttributeSubscriptionState()
...
class AttributeListAttribute(
  ...
  suspend fun open(openDuration: UInt?
      ,targetLevel: UByte?
    ...
    openDuration?.let {
      tlvWriter.put(ContextSpecificTag(TAG_OPEN_DURATION_REQ), openDuration)
    }

    val TAG_TARGET_LEVEL_REQ: Int = 1
    targetLevel?.let {
      tlvWriter.put(ContextSpecificTag(TAG_TARGET_LEVEL_REQ), targetLevel)
    }    
...
suspend fun readOpenDurationAttribute(): OpenDurationAttribute {val ATTRIBUTE_ID: UInt = 0u
    ...
    requireNotNull(attributeData) { 
      "Openduration attribute not found in response" 
    }
  ...
  suspend fun subscribeOpenDurationAttribute(
    minInterval: Int,
    maxInterval: Int
  ): Flow<OpenDurationAttributeSubscriptionState> {
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(OpenDurationAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { 
            "Openduration attribute not found in Node State update" 
          }
      ...
      null
          ...
          decodedValue?.let {
            emit(OpenDurationAttributeSubscriptionState.Success(it))
          }
          
        }
        SubscriptionState.SubscriptionEstablished -> {
          emit(OpenDurationAttributeSubscriptionState.SubscriptionEstablished)
        }
      }
    }    
  }
suspend fun readDefaultOpenDurationAttribute(): DefaultOpenDurationAttribute {val ATTRIBUTE_ID: UInt = 1u
    ...
    requireNotNull(attributeData) { 
      "Defaultopenduration attribute not found in response" 
    }
  ...
  suspend fun writeDefaultOpenDurationAttribute(
    value: UInt,
  ...
  suspend fun subscribeDefaultOpenDurationAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(DefaultOpenDurationAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
      ...
      null
          ...
          decodedValue?.let {
            emit(DefaultOpenDurationAttributeSubscriptionState.Success(it))
          }
...
suspend fun readAutoCloseTimeAttribute(): AutoCloseTimeAttribute {val ATTRIBUTE_ID: UInt = 2u
    ...
    requireNotNull(attributeData) { 
      "Autoclosetime attribute not found in response" 
    }
  ...
  suspend fun subscribeAutoCloseTimeAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(AutoCloseTimeAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
          ...
          requireNotNull(attributeData) { 
            "Autoclosetime attribute not found in Node State update" 
          }
      ...
      null
          ...
          decodedValue?.let {
            emit(AutoCloseTimeAttributeSubscriptionState.Success(it))
          }
          
        }
        SubscriptionState.SubscriptionEstablished -> {
          emit(AutoCloseTimeAttributeSubscriptionState.SubscriptionEstablished)
        }
      }
    }    
  }
suspend fun readRemainingDurationAttribute(): RemainingDurationAttribute {val ATTRIBUTE_ID: UInt = 3u
    ...
    requireNotNull(attributeData) { 
      "Remainingduration attribute not found in response" 
    }
  ...
  suspend fun subscribeRemainingDurationAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(RemainingDurationAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
          ...
          requireNotNull(attributeData) { 
            "Remainingduration attribute not found in Node State update" 
          }
      ...
      null
          ...
          decodedValue?.let {
            emit(RemainingDurationAttributeSubscriptionState.Success(it))
          }
          
        }
        SubscriptionState.SubscriptionEstablished -> {
          emit(RemainingDurationAttributeSubscriptionState.SubscriptionEstablished)
        }
      }
    }    
  }
suspend fun readCurrentStateAttribute(): CurrentStateAttribute {val ATTRIBUTE_ID: UInt = 4u
    ...
    requireNotNull(attributeData) { 
      "Currentstate attribute not found in response" 
    }
  ...
  suspend fun subscribeCurrentStateAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(CurrentStateAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
          ...
          requireNotNull(attributeData) { 
            "Currentstate attribute not found in Node State update" 
          }
      ...
      null
          ...
          decodedValue?.let {
            emit(CurrentStateAttributeSubscriptionState.Success(it))
          }
          
        }
        SubscriptionState.SubscriptionEstablished -> {
          emit(CurrentStateAttributeSubscriptionState.SubscriptionEstablished)
        }
      }
    }    
  }
suspend fun readTargetStateAttribute(): TargetStateAttribute {val ATTRIBUTE_ID: UInt = 5u
    ...
    requireNotNull(attributeData) { 
      "Targetstate attribute not found in response" 
    }
  ...
  suspend fun subscribeTargetStateAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(TargetStateAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
          ...
          requireNotNull(attributeData) { 
            "Targetstate attribute not found in Node State update" 
          }
      ...
      null
          ...
          decodedValue?.let {
            emit(TargetStateAttributeSubscriptionState.Success(it))
          }
...
suspend fun readCurrentLevelAttribute(): CurrentLevelAttribute {val ATTRIBUTE_ID: UInt = 6u
    ...
    requireNotNull(attributeData) { 
      "Currentlevel attribute not found in response" 
    }
  ...
  suspend fun subscribeCurrentLevelAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(CurrentLevelAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
          ...
          requireNotNull(attributeData) { 
            "Currentlevel attribute not found in Node State update" 
          }
      ...
      null
          ...
          decodedValue?.let {
            emit(CurrentLevelAttributeSubscriptionState.Success(it))
          }
          
        }
        SubscriptionState.SubscriptionEstablished -> {
          emit(CurrentLevelAttributeSubscriptionState.SubscriptionEstablished)
        }
      }
    }    
  }
suspend fun readTargetLevelAttribute(): TargetLevelAttribute {val ATTRIBUTE_ID: UInt = 7u
    ...
    requireNotNull(attributeData) { 
      "Targetlevel attribute not found in response" 
    }
  ...
  suspend fun subscribeTargetLevelAttribute(
    minInterval: Int,
    maxInterval: Int
  ): Flow<TargetLevelAttributeSubscriptionState> {
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(TargetLevelAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
          ...
          requireNotNull(attributeData) { 
            "Targetlevel attribute not found in Node State update" 
          }
      ...
      null
          ...
          decodedValue?.let {
            emit(TargetLevelAttributeSubscriptionState.Success(it))
          }
          
        }
        SubscriptionState.SubscriptionEstablished -> {
          emit(TargetLevelAttributeSubscriptionState.SubscriptionEstablished)
        }
      }
    }    
  }
suspend fun readDefaultOpenLevelAttribute(): UByte? {val ATTRIBUTE_ID: UInt = 8u
    ...
    requireNotNull(attributeData) { 
      "Defaultopenlevel attribute not found in response" 
    }
  ...
  suspend fun writeDefaultOpenLevelAttribute(
    value: UByte,
    timedWriteTimeout: Duration? = null) {
...
suspend fun readValveFaultAttribute(): UShort? {val ATTRIBUTE_ID: UInt = 9u
    ...
    requireNotNull(attributeData) { 
      "Valvefault attribute not found in response" 
    }
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { 
            "Valvefault attribute not found in Node State update" 
          }
...
suspend fun readLevelStepAttribute(): UByte? {val ATTRIBUTE_ID: UInt = 10u
    ...
    requireNotNull(attributeData) { 
      "Levelstep attribute not found in response" 
    }
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { 
            "Levelstep attribute not found in Node State update" 
          }
