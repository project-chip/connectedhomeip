...
class ServiceAreaClusterLocationInfoStruct(
  ...
  companion object {
    ...
    fun fromTlv(tlvTag: Tag, tlvReader: TlvReader): ServiceAreaClusterLocationInfoStruct {
      ...
      ServiceAreaClusterHomeLocationStruct.fromTlv(ContextSpecificTag(TAG_LOCATION_INFO), tlvReader)
    } else {
      ...
      return ServiceAreaClusterLocationInfoStruct(locationInfo, landmarkTag, positionTag, surfaceTag)
    }
  }
}
