...
class MulticastClusterMulticastTargetStruct(
  val groupId: UShort,
  val endpoints: List<UShort>,
  val fabricIndex: UByte,
) {
  override fun toString(): String = buildString {
    append("MulticastClusterMulticastTargetStruct {\n")
  ...
  companion object {
    ...
    fun fromTlv(tlvTag: Tag, tlvReader: TlvReader): MulticastClusterMulticastTargetStruct {
      ...
      return MulticastClusterMulticastTargetStruct(groupId, endpoints, fabricIndex)
    }
  }
}
