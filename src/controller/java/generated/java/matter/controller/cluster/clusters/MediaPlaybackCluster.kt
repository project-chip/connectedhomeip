...
class StartTimeAttribute(
  ...
  sealed class StartTimeAttributeSubscriptionState {
    data class Success(
    val value: ULong?
    ) : StartTimeAttributeSubscriptionState()
...
class DurationAttribute(
  ...
  sealed class DurationAttributeSubscriptionState {
    data class Success(
    val value: ULong?
    ) : DurationAttributeSubscriptionState()
...
class SeekRangeEndAttribute(
  ...
  sealed class SeekRangeEndAttributeSubscriptionState {
    data class Success(
    val value: ULong?
    ) : SeekRangeEndAttributeSubscriptionState()
...
class SeekRangeStartAttribute(
  ...
  sealed class SeekRangeStartAttributeSubscriptionState {
    data class Success(
    val value: ULong?
    ) : SeekRangeStartAttributeSubscriptionState()
...
class ActiveAudioTrackAttribute(
...
class AvailableAudioTracksAttribute(
    val value: List<MediaPlaybackClusterTrackStruct>?
  )
...
class ActiveTextTrackAttribute(
    val value: MediaPlaybackClusterTrackStruct?
  )
...
class AvailableTextTracksAttribute(
    val value: List<MediaPlaybackClusterTrackStruct>?
  )
...
class AttributeListAttribute(
  ...
  suspend fun rewind(audioAdvanceUnmuted: Boolean?
      ,timedInvokeTimeout: Duration? = null): PlaybackResponse {
  ...
  suspend fun fastForward(audioAdvanceUnmuted: Boolean?
      ,timedInvokeTimeout: Duration? = null): PlaybackResponse {
  ...
  suspend fun skipForward(deltaPositionMilliseconds: ULong
      ,timedInvokeTimeout: Duration? = null): PlaybackResponse {
    ...
    tlvWriter.put(ContextSpecificTag(TAG_DELTA_POSITION_MILLISECONDS_REQ), deltaPositionMilliseconds)    
    tlvWriter.endStructure()
  ...
  suspend fun skipBackward(deltaPositionMilliseconds: ULong
      ,timedInvokeTimeout: Duration? = null): PlaybackResponse {
  ...
  suspend fun seek(position: ULong
      ,timedInvokeTimeout: Duration? = null): PlaybackResponse {
  ...
  suspend fun activateAudioTrack(trackID: String
  ...
  suspend fun activateTextTrack(trackID: String
      ,timedInvokeTimeout: Duration? = null) {
...
suspend fun readCurrentStateAttribute(): UByte {val ATTRIBUTE_ID: UInt = 0u
...
suspend fun readStartTimeAttribute(): StartTimeAttribute {val ATTRIBUTE_ID: UInt = 1u
    ...
    requireNotNull(attributeData) { 
      "Starttime attribute not found in response" 
    }
  ...
  suspend fun subscribeStartTimeAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(StartTimeAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
          ...
          requireNotNull(attributeData) { 
            "Starttime attribute not found in Node State update" 
          }
      ...
      null
          ...
          decodedValue?.let {
            emit(StartTimeAttributeSubscriptionState.Success(it))
          }
...
suspend fun readDurationAttribute(): DurationAttribute {val ATTRIBUTE_ID: UInt = 2u
    ...
    requireNotNull(attributeData) { 
      "Duration attribute not found in response" 
    }
  ...
  suspend fun subscribeDurationAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(DurationAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
          ...
          requireNotNull(attributeData) { 
            "Duration attribute not found in Node State update" 
          }
      ...
      null
          ...
          decodedValue?.let {
            emit(DurationAttributeSubscriptionState.Success(it))
          }
...
suspend fun readSampledPositionAttribute(): SampledPositionAttribute {val ATTRIBUTE_ID: UInt = 3u
    ...
    requireNotNull(attributeData) { 
      "Sampledposition attribute not found in response" 
    }

    // Decode the TLV data into the appropriate type
    val tlvReader = TlvReader(attributeData.data)
    val decodedValue: MediaPlaybackClusterPlaybackPositionStruct? = if (!tlvReader.isNull()) {
      if (tlvReader.isNextTag(AnonymousTag)) {
  ...
  suspend fun subscribeSampledPositionAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(SampledPositionAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
      ...
      null
          ...
          decodedValue?.let {
            emit(SampledPositionAttributeSubscriptionState.Success(it))
          }
...
suspend fun readPlaybackSpeedAttribute(): Float? {val ATTRIBUTE_ID: UInt = 4u
    ...
    requireNotNull(attributeData) { 
      "Playbackspeed attribute not found in response" 
    }
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { 
            "Playbackspeed attribute not found in Node State update" 
          }
...
suspend fun readSeekRangeEndAttribute(): SeekRangeEndAttribute {val ATTRIBUTE_ID: UInt = 5u
    ...
    requireNotNull(attributeData) { 
      "Seekrangeend attribute not found in response" 
    }
  ...
  suspend fun subscribeSeekRangeEndAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(SeekRangeEndAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
          ...
          requireNotNull(attributeData) { 
            "Seekrangeend attribute not found in Node State update" 
          }
      ...
      null
          ...
          decodedValue?.let {
            emit(SeekRangeEndAttributeSubscriptionState.Success(it))
          }
...
suspend fun readSeekRangeStartAttribute(): SeekRangeStartAttribute {val ATTRIBUTE_ID: UInt = 6u
    ...
    requireNotNull(attributeData) { 
      "Seekrangestart attribute not found in response" 
    }
  ...
  suspend fun subscribeSeekRangeStartAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(SeekRangeStartAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
      ...
      null
          ...
          decodedValue?.let {
            emit(SeekRangeStartAttributeSubscriptionState.Success(it))
          }
...
suspend fun readActiveAudioTrackAttribute(): ActiveAudioTrackAttribute {val ATTRIBUTE_ID: UInt = 7u
    ...
    requireNotNull(attributeData) { 
      "Activeaudiotrack attribute not found in response" 
    }

    // Decode the TLV data into the appropriate type
    val tlvReader = TlvReader(attributeData.data)
    val decodedValue: MediaPlaybackClusterTrackStruct? = if (!tlvReader.isNull()) {
      if (tlvReader.isNextTag(AnonymousTag)) {
  ...
  suspend fun subscribeActiveAudioTrackAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(ActiveAudioTrackAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
      ...
      null
          ...
          decodedValue?.let {
            emit(ActiveAudioTrackAttributeSubscriptionState.Success(it))
          }
...
suspend fun readAvailableAudioTracksAttribute(): AvailableAudioTracksAttribute {val ATTRIBUTE_ID: UInt = 8u
    ...
    requireNotNull(attributeData) { 
      "Availableaudiotracks attribute not found in response" 
    }

    // Decode the TLV data into the appropriate type
    val tlvReader = TlvReader(attributeData.data)
    val decodedValue: List<MediaPlaybackClusterTrackStruct>? = if (!tlvReader.isNull()) {
      if (tlvReader.isNextTag(AnonymousTag)) {
  ...
  suspend fun subscribeAvailableAudioTracksAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(AvailableAudioTracksAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
      ...
      null
          ...
          decodedValue?.let {
            emit(AvailableAudioTracksAttributeSubscriptionState.Success(it))
          }
...
suspend fun readActiveTextTrackAttribute(): ActiveTextTrackAttribute {val ATTRIBUTE_ID: UInt = 9u
    ...
    requireNotNull(attributeData) { 
      "Activetexttrack attribute not found in response" 
    }
  ...
  suspend fun subscribeActiveTextTrackAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(ActiveTextTrackAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
      ...
      null
          ...
          decodedValue?.let {
            emit(ActiveTextTrackAttributeSubscriptionState.Success(it))
          }
...
suspend fun readAvailableTextTracksAttribute(): AvailableTextTracksAttribute {val ATTRIBUTE_ID: UInt = 10u
    ...
    requireNotNull(attributeData) { 
      "Availabletexttracks attribute not found in response" 
    }
  ...
  suspend fun subscribeAvailableTextTracksAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(AvailableTextTracksAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
      ...
      null
          ...
          decodedValue?.let {
            emit(AvailableTextTracksAttributeSubscriptionState.Success(it))
          }
