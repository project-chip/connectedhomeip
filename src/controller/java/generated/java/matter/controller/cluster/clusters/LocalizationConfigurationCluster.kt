...
class LocalizationConfigurationCluster(
  ...
  sealed class SupportedLocalesAttributeSubscriptionState {
    data class Success(val value: List<String>) : SupportedLocalesAttributeSubscriptionState()
  ...
  suspend fun readActiveLocaleAttribute(): String {
    ...
    requireNotNull(attributeData) { "Activelocale attribute not found in response" }
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { "Activelocale attribute not found in Node State update" }
  ...
  suspend fun readSupportedLocalesAttribute(): SupportedLocalesAttribute {
    ...
    requireNotNull(attributeData) { "Supportedlocales attribute not found in response" }
  ...
  suspend fun subscribeSupportedLocalesAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(
            SupportedLocalesAttributeSubscriptionState.Error(
              Exception(
                "Subscription terminated with error code: ${subscriptionState.terminationCause}"
              )
            )
