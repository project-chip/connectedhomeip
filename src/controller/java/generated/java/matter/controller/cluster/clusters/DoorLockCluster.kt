...
class LockStateAttribute(
  ...
  sealed class LockStateAttributeSubscriptionState {
    data class Success(
    val value: UByte?
    ) : LockStateAttributeSubscriptionState()
...
class DoorStateAttribute(
  ...
  sealed class DoorStateAttributeSubscriptionState {
    data class Success(
    val value: UByte?
    ) : DoorStateAttributeSubscriptionState()
...
class AliroReaderVerificationKeyAttribute(
    val value: ByteArray?
  )
  ...
  sealed class AliroReaderVerificationKeyAttributeSubscriptionState {
    ...
    data class Error(val exception: Exception) : AliroReaderVerificationKeyAttributeSubscriptionState()

    object SubscriptionEstablished : AliroReaderVerificationKeyAttributeSubscriptionState()    
  }  
class AliroReaderGroupIdentifierAttribute(
    val value: ByteArray?
  )
  ...
  sealed class AliroReaderGroupIdentifierAttributeSubscriptionState {
    ...
    data class Error(val exception: Exception) : AliroReaderGroupIdentifierAttributeSubscriptionState()

    object SubscriptionEstablished : AliroReaderGroupIdentifierAttributeSubscriptionState()    
  }  
class AliroExpeditedTransactionSupportedProtocolVersionsAttribute(
  ...
  sealed class AliroExpeditedTransactionSupportedProtocolVersionsAttributeSubscriptionState {
    ...
    object SubscriptionEstablished : AliroExpeditedTransactionSupportedProtocolVersionsAttributeSubscriptionState()    
  }  
class AliroGroupResolvingKeyAttribute(
    val value: ByteArray?
  )
  ...
  sealed class AliroGroupResolvingKeyAttributeSubscriptionState {
    data class Success(
    val value: ByteArray?
    ) : AliroGroupResolvingKeyAttributeSubscriptionState()
...
class AliroSupportedBLEUWBProtocolVersionsAttribute(
    val value: List<ByteArray>?
  )
  ...
  sealed class AliroSupportedBLEUWBProtocolVersionsAttributeSubscriptionState {
    ...
    data class Error(val exception: Exception) : AliroSupportedBLEUWBProtocolVersionsAttributeSubscriptionState()

    object SubscriptionEstablished : AliroSupportedBLEUWBProtocolVersionsAttributeSubscriptionState()    
  }  
...
class AttributeListAttribute(
  ...
  suspend fun lockDoor(PINCode: ByteArray?
  ...
  suspend fun unlockDoor(PINCode: ByteArray?
      ,timedInvokeTimeout: Duration) {
  ...
  suspend fun unlockWithTimeout(timeout: UShort
      ,PINCode: ByteArray?
      ,timedInvokeTimeout: Duration) {
  ...
  suspend fun setWeekDaySchedule(weekDayIndex: UByte
      ,userIndex: UShort
      ,daysMask: UByte
      ,startHour: UByte
      ,startMinute: UByte
  ...
  suspend fun getWeekDaySchedule(weekDayIndex: UByte
      ,userIndex: UShort
      ,timedInvokeTimeout: Duration? = null): GetWeekDayScheduleResponse {
    ...
    while (!tlvReader.isEndOfContainer()) {
      ...
      if (tag == ContextSpecificTag(TAG_WEEK_DAY_INDEX)) {weekDayIndex_decoded = tlvReader.getUByte(tag)} else
      
      if (tag == ContextSpecificTag(TAG_USER_INDEX)) {userIndex_decoded = tlvReader.getUShort(tag)} else
      
      if (tag == ContextSpecificTag(TAG_STATUS)) {status_decoded = tlvReader.getUByte(tag)} else
      
      if (tag == ContextSpecificTag(TAG_DAYS_MASK)) {daysMask_decoded = 
          if (tlvReader.isNull()) {
      ...
      if (tag == ContextSpecificTag(TAG_START_HOUR)) {startHour_decoded = 
          if (tlvReader.isNull()) {
            tlvReader.getNull(tag)
            null
          } else {
      ...
      if (tag == ContextSpecificTag(TAG_START_MINUTE)) {startMinute_decoded = 
          if (tlvReader.isNull()) {
            tlvReader.getNull(tag)
            null
          } else {
      ...
      if (tag == ContextSpecificTag(TAG_END_HOUR)) {endHour_decoded = 
          if (tlvReader.isNull()) {
            tlvReader.getNull(tag)
            null
          } else {
      ...
      if (tag == ContextSpecificTag(TAG_END_MINUTE)) {endMinute_decoded = 
          if (tlvReader.isNull()) {
            tlvReader.getNull(tag)
            null
          } else {
  ...
  suspend fun clearWeekDaySchedule(weekDayIndex: UByte
      ,userIndex: UShort
      ,timedInvokeTimeout: Duration? = null) {
  ...
  suspend fun setYearDaySchedule(yearDayIndex: UByte
      ,userIndex: UShort
      ,localStartTime: UInt
      ,localEndTime: UInt
      ,timedInvokeTimeout: Duration? = null) {
  ...
  suspend fun getYearDaySchedule(yearDayIndex: UByte
      ,userIndex: UShort
      ,timedInvokeTimeout: Duration? = null): GetYearDayScheduleResponse {
    ...
    while (!tlvReader.isEndOfContainer()) {
      ...
      if (tag == ContextSpecificTag(TAG_YEAR_DAY_INDEX)) {yearDayIndex_decoded = tlvReader.getUByte(tag)} else
      
      if (tag == ContextSpecificTag(TAG_USER_INDEX)) {userIndex_decoded = tlvReader.getUShort(tag)} else
      
      if (tag == ContextSpecificTag(TAG_STATUS)) {status_decoded = tlvReader.getUByte(tag)} else
      
      if (tag == ContextSpecificTag(TAG_LOCAL_START_TIME)) {localStartTime_decoded = 
          if (tlvReader.isNull()) {
            tlvReader.getNull(tag)
            null
          } else {
      ...
      if (tag == ContextSpecificTag(TAG_LOCAL_END_TIME)) {localEndTime_decoded = 
          if (tlvReader.isNull()) {
            tlvReader.getNull(tag)
            null
          } else {
  ...
  suspend fun clearYearDaySchedule(yearDayIndex: UByte
      ,userIndex: UShort
      ,timedInvokeTimeout: Duration? = null) {
  ...
  suspend fun setHolidaySchedule(holidayIndex: UByte
      ,localStartTime: UInt
      ,localEndTime: UInt
      ,operatingMode: UByte
      ,timedInvokeTimeout: Duration? = null) {
  ...
  suspend fun getHolidaySchedule(holidayIndex: UByte
      ,timedInvokeTimeout: Duration? = null): GetHolidayScheduleResponse {
    ...
    while (!tlvReader.isEndOfContainer()) {
      ...
      if (tag == ContextSpecificTag(TAG_HOLIDAY_INDEX)) {holidayIndex_decoded = tlvReader.getUByte(tag)} else
      ...
      if (tag == ContextSpecificTag(TAG_OPERATING_MODE)) {operatingMode_decoded = 
          if (tlvReader.isNull()) {
            tlvReader.getNull(tag)
            null
          } else {
  ...
  suspend fun setUser(operationType: UByte
      ,userIndex: UShort
      ,userName: String?
      ,userUniqueID: UInt?
      ,userStatus: UByte?
    ...
    userName?.let {
      tlvWriter.put(ContextSpecificTag(TAG_USER_NAME_REQ), userName)
    }

    val TAG_USER_UNIQUE_ID_REQ: Int = 3
    userUniqueID?.let {
      tlvWriter.put(ContextSpecificTag(TAG_USER_UNIQUE_ID_REQ), userUniqueID)
    }
  ...
  suspend fun getUser(userIndex: UShort
      ,timedInvokeTimeout: Duration? = null): GetUserResponse {
    ...
    while (!tlvReader.isEndOfContainer()) {
      ...
      if (tag == ContextSpecificTag(TAG_USER_NAME)) {userName_decoded = 
          if (tlvReader.isNull()) {
            tlvReader.getNull(tag)
            null
          } else {
      ...
      if (tag == ContextSpecificTag(TAG_USER_UNIQUE_ID)) {userUniqueID_decoded = 
          if (tlvReader.isNull()) {
            tlvReader.getNull(tag)
            null
          } else {
      ...
      if (tag == ContextSpecificTag(TAG_USER_STATUS)) {userStatus_decoded = 
          if (tlvReader.isNull()) {
            tlvReader.getNull(tag)
            null
          } else {
      ...
      if (tag == ContextSpecificTag(TAG_USER_TYPE)) {userType_decoded = 
          if (tlvReader.isNull()) {
            tlvReader.getNull(tag)
            null
          } else {
      ...
      if (tag == ContextSpecificTag(TAG_CREDENTIAL_RULE)) {credentialRule_decoded = 
          if (tlvReader.isNull()) {
            tlvReader.getNull(tag)
            null
          } else {
      ...
      if (tag == ContextSpecificTag(TAG_CREDENTIALS)) {credentials_decoded = 
          if (tlvReader.isNull()) {
            tlvReader.getNull(tag)
            null
          } else {
      ...
      if (tag == ContextSpecificTag(TAG_CREATOR_FABRIC_INDEX)) {creatorFabricIndex_decoded = 
          if (tlvReader.isNull()) {
            tlvReader.getNull(tag)
            null
          } else {
      ...
      if (tag == ContextSpecificTag(TAG_LAST_MODIFIED_FABRIC_INDEX)) {lastModifiedFabricIndex_decoded = 
          if (tlvReader.isNull()) {
            tlvReader.getNull(tag)
            null
          } else {
      ...
      if (tag == ContextSpecificTag(TAG_NEXT_USER_INDEX)) {nextUserIndex_decoded = 
          if (tlvReader.isNull()) {
            tlvReader.getNull(tag)
            null
          } else {
  ...
  suspend fun clearUser(userIndex: UShort
      ,timedInvokeTimeout: Duration) {
  ...
  suspend fun setCredential(operationType: UByte
      ,credential: DoorLockClusterCredentialStruct
      ,credentialData: ByteArray
      ,userIndex: UShort?
      ,userStatus: UByte?
      ,userType: UByte?
      ,timedInvokeTimeout: Duration): SetCredentialResponse {
    ...
    while (!tlvReader.isEndOfContainer()) {
      ...
      if (tag == ContextSpecificTag(TAG_USER_INDEX)) {userIndex_decoded = 
          if (tlvReader.isNull()) {
            tlvReader.getNull(tag)
            null
          } else {
      ...
      if (tag == ContextSpecificTag(TAG_NEXT_CREDENTIAL_INDEX)) {nextCredentialIndex_decoded = 
          if (tlvReader.isNull()) {
            tlvReader.getNull(tag)
            null
          } else {
  ...
  suspend fun getCredentialStatus(credential: DoorLockClusterCredentialStruct
      ,timedInvokeTimeout: Duration? = null): GetCredentialStatusResponse {
    ...
    while (!tlvReader.isEndOfContainer()) {
      ...
      if (tag == ContextSpecificTag(TAG_CREDENTIAL_EXISTS)) {credentialExists_decoded = tlvReader.getBoolean(tag)} else
      ...
      if (tag == ContextSpecificTag(TAG_CREDENTIAL_DATA)) {credentialData_decoded = 
          if (tlvReader.isNull()) {
            tlvReader.getNull(tag)
            null
          } else {
  ...
  suspend fun clearCredential(credential: DoorLockClusterCredentialStruct?
      ,timedInvokeTimeout: Duration) {
  ...
  suspend fun unboltDoor(PINCode: ByteArray?
      ,timedInvokeTimeout: Duration) {
  ...
  suspend fun setAliroReaderConfig(signingKey: ByteArray
...
suspend fun readLockStateAttribute(): LockStateAttribute {val ATTRIBUTE_ID: UInt = 0u
    ...
    requireNotNull(attributeData) { 
      "Lockstate attribute not found in response" 
    }
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(LockStateAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { 
            "Lockstate attribute not found in Node State update" 
          }
      ...
      null
          ...
          decodedValue?.let {
            emit(LockStateAttributeSubscriptionState.Success(it))
          }
...
suspend fun readLockTypeAttribute(): UByte {val ATTRIBUTE_ID: UInt = 1u
    ...
    requireNotNull(attributeData) { 
      "Locktype attribute not found in response" 
    }
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { 
            "Locktype attribute not found in Node State update" 
          }
...
suspend fun readActuatorEnabledAttribute(): Boolean {val ATTRIBUTE_ID: UInt = 2u
    ...
    requireNotNull(attributeData) { 
      "Actuatorenabled attribute not found in response" 
    }
...
suspend fun readDoorStateAttribute(): DoorStateAttribute {val ATTRIBUTE_ID: UInt = 3u
    ...
    requireNotNull(attributeData) { 
      "Doorstate attribute not found in response" 
    }
  ...
  suspend fun subscribeDoorStateAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(DoorStateAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
          ...
          requireNotNull(attributeData) { 
            "Doorstate attribute not found in Node State update" 
          }
      ...
      null
          ...
          decodedValue?.let {
            emit(DoorStateAttributeSubscriptionState.Success(it))
          }
...
suspend fun readDoorOpenEventsAttribute(): UInt? {val ATTRIBUTE_ID: UInt = 4u
    ...
    requireNotNull(attributeData) { 
      "Dooropenevents attribute not found in response" 
    }
...
suspend fun readDoorClosedEventsAttribute(): UInt? {val ATTRIBUTE_ID: UInt = 5u
    ...
    requireNotNull(attributeData) { 
      "Doorclosedevents attribute not found in response" 
    }
...
suspend fun readOpenPeriodAttribute(): UShort? {val ATTRIBUTE_ID: UInt = 6u
    ...
    requireNotNull(attributeData) { 
      "Openperiod attribute not found in response" 
    }
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { 
            "Openperiod attribute not found in Node State update" 
          }
...
suspend fun readNumberOfTotalUsersSupportedAttribute(): UShort? {val ATTRIBUTE_ID: UInt = 17u
...
suspend fun readNumberOfPINUsersSupportedAttribute(): UShort? {val ATTRIBUTE_ID: UInt = 18u
    ...
    requireNotNull(attributeData) { 
      "Numberofpinuserssupported attribute not found in response" 
    }
...
suspend fun readNumberOfRFIDUsersSupportedAttribute(): UShort? {val ATTRIBUTE_ID: UInt = 19u
    ...
    requireNotNull(attributeData) { 
      "Numberofrfiduserssupported attribute not found in response" 
    }
...
suspend fun readNumberOfWeekDaySchedulesSupportedPerUserAttribute(): UByte? {val ATTRIBUTE_ID: UInt = 20u
...
suspend fun readNumberOfYearDaySchedulesSupportedPerUserAttribute(): UByte? {val ATTRIBUTE_ID: UInt = 21u
...
suspend fun readNumberOfHolidaySchedulesSupportedAttribute(): UByte? {val ATTRIBUTE_ID: UInt = 22u
...
suspend fun readMaxPINCodeLengthAttribute(): UByte? {val ATTRIBUTE_ID: UInt = 23u
    ...
    requireNotNull(attributeData) { 
      "Maxpincodelength attribute not found in response" 
    }
...
suspend fun readMinPINCodeLengthAttribute(): UByte? {val ATTRIBUTE_ID: UInt = 24u
    ...
    requireNotNull(attributeData) { 
      "Minpincodelength attribute not found in response" 
    }
...
suspend fun readMaxRFIDCodeLengthAttribute(): UByte? {val ATTRIBUTE_ID: UInt = 25u
    ...
    requireNotNull(attributeData) { 
      "Maxrfidcodelength attribute not found in response" 
    }
...
suspend fun readMinRFIDCodeLengthAttribute(): UByte? {val ATTRIBUTE_ID: UInt = 26u
    ...
    requireNotNull(attributeData) { 
      "Minrfidcodelength attribute not found in response" 
    }
...
suspend fun readCredentialRulesSupportAttribute(): UByte? {val ATTRIBUTE_ID: UInt = 27u
    ...
    requireNotNull(attributeData) { 
      "Credentialrulessupport attribute not found in response" 
    }
...
suspend fun readNumberOfCredentialsSupportedPerUserAttribute(): UByte? {val ATTRIBUTE_ID: UInt = 28u
...
suspend fun readLanguageAttribute(): String? {val ATTRIBUTE_ID: UInt = 33u
    ...
    requireNotNull(attributeData) { 
      "Language attribute not found in response" 
    }
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { 
            "Language attribute not found in Node State update" 
          }
...
suspend fun readLEDSettingsAttribute(): UByte? {val ATTRIBUTE_ID: UInt = 34u
    ...
    requireNotNull(attributeData) { 
      "Ledsettings attribute not found in response" 
    }
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { 
            "Ledsettings attribute not found in Node State update" 
          }
...
suspend fun readAutoRelockTimeAttribute(): UInt? {val ATTRIBUTE_ID: UInt = 35u
    ...
    requireNotNull(attributeData) { 
      "Autorelocktime attribute not found in response" 
    }
...
suspend fun readSoundVolumeAttribute(): UByte? {val ATTRIBUTE_ID: UInt = 36u
    ...
    requireNotNull(attributeData) { 
      "Soundvolume attribute not found in response" 
    }
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { 
            "Soundvolume attribute not found in Node State update" 
          }
...
suspend fun readOperatingModeAttribute(): UByte {val ATTRIBUTE_ID: UInt = 37u
    ...
    requireNotNull(attributeData) { 
      "Operatingmode attribute not found in response" 
    }
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { 
            "Operatingmode attribute not found in Node State update" 
          }
...
suspend fun readSupportedOperatingModesAttribute(): UShort {val ATTRIBUTE_ID: UInt = 38u
    ...
    requireNotNull(attributeData) { 
      "Supportedoperatingmodes attribute not found in response" 
    }
...
suspend fun readDefaultConfigurationRegisterAttribute(): UShort? {val ATTRIBUTE_ID: UInt = 39u
...
suspend fun readEnableLocalProgrammingAttribute(): Boolean? {val ATTRIBUTE_ID: UInt = 40u
    ...
    requireNotNull(attributeData) { 
      "Enablelocalprogramming attribute not found in response" 
    }
...
suspend fun readEnableOneTouchLockingAttribute(): Boolean? {val ATTRIBUTE_ID: UInt = 41u
    ...
    requireNotNull(attributeData) { 
      "Enableonetouchlocking attribute not found in response" 
    }
...
suspend fun readEnableInsideStatusLEDAttribute(): Boolean? {val ATTRIBUTE_ID: UInt = 42u
    ...
    requireNotNull(attributeData) { 
      "Enableinsidestatusled attribute not found in response" 
    }
...
suspend fun readEnablePrivacyModeButtonAttribute(): Boolean? {val ATTRIBUTE_ID: UInt = 43u
    ...
    requireNotNull(attributeData) { 
      "Enableprivacymodebutton attribute not found in response" 
    }
...
suspend fun readLocalProgrammingFeaturesAttribute(): UByte? {val ATTRIBUTE_ID: UInt = 44u
    ...
    requireNotNull(attributeData) { 
      "Localprogrammingfeatures attribute not found in response" 
    }
...
suspend fun readWrongCodeEntryLimitAttribute(): UByte? {val ATTRIBUTE_ID: UInt = 48u
    ...
    requireNotNull(attributeData) { 
      "Wrongcodeentrylimit attribute not found in response" 
    }
...
suspend fun readUserCodeTemporaryDisableTimeAttribute(): UByte? {val ATTRIBUTE_ID: UInt = 49u
...
suspend fun readSendPINOverTheAirAttribute(): Boolean? {val ATTRIBUTE_ID: UInt = 50u
    ...
    requireNotNull(attributeData) { 
      "Sendpinovertheair attribute not found in response" 
    }
...
suspend fun readRequirePINforRemoteOperationAttribute(): Boolean? {val ATTRIBUTE_ID: UInt = 51u
...
suspend fun readExpiringUserTimeoutAttribute(): UShort? {val ATTRIBUTE_ID: UInt = 53u
    ...
    requireNotNull(attributeData) { 
      "Expiringusertimeout attribute not found in response" 
    }
...
suspend fun readAliroReaderVerificationKeyAttribute(): AliroReaderVerificationKeyAttribute {val ATTRIBUTE_ID: UInt = 128u
    ...
    requireNotNull(attributeData) { 
      "Aliroreaderverificationkey attribute not found in response" 
    }
  ...
  suspend fun subscribeAliroReaderVerificationKeyAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(AliroReaderVerificationKeyAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
...
suspend fun readAliroReaderGroupIdentifierAttribute(): AliroReaderGroupIdentifierAttribute {val ATTRIBUTE_ID: UInt = 129u
    ...
    requireNotNull(attributeData) { 
      "Aliroreadergroupidentifier attribute not found in response" 
    }
  ...
  suspend fun subscribeAliroReaderGroupIdentifierAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(AliroReaderGroupIdentifierAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
...
suspend fun readAliroReaderGroupSubIdentifierAttribute(): ByteArray? {val ATTRIBUTE_ID: UInt = 130u
...
suspend fun readAliroExpeditedTransactionSupportedProtocolVersionsAttribute(): AliroExpeditedTransactionSupportedProtocolVersionsAttribute {val ATTRIBUTE_ID: UInt = 131u
    ...
    // Decode the TLV data into the appropriate type
    val tlvReader = TlvReader(attributeData.data)
    val decodedValue: List<ByteArray>? = if (tlvReader.isNextTag(AnonymousTag)) {
      buildList<ByteArray> {
  ...
  suspend fun subscribeAliroExpeditedTransactionSupportedProtocolVersionsAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(AliroExpeditedTransactionSupportedProtocolVersionsAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
      ...
      null
          ...
          decodedValue?.let {
            emit(AliroExpeditedTransactionSupportedProtocolVersionsAttributeSubscriptionState.Success(it))
          }
          
        }
        SubscriptionState.SubscriptionEstablished -> {
          emit(AliroExpeditedTransactionSupportedProtocolVersionsAttributeSubscriptionState.SubscriptionEstablished)
        }
      }
    }    
  }
suspend fun readAliroGroupResolvingKeyAttribute(): AliroGroupResolvingKeyAttribute {val ATTRIBUTE_ID: UInt = 132u
    ...
    requireNotNull(attributeData) { 
      "Alirogroupresolvingkey attribute not found in response" 
    }
  ...
  suspend fun subscribeAliroGroupResolvingKeyAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(AliroGroupResolvingKeyAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
      ...
      null
          ...
          decodedValue?.let {
            emit(AliroGroupResolvingKeyAttributeSubscriptionState.Success(it))
          }
...
suspend fun readAliroSupportedBLEUWBProtocolVersionsAttribute(): AliroSupportedBLEUWBProtocolVersionsAttribute {val ATTRIBUTE_ID: UInt = 133u
  ...
  suspend fun subscribeAliroSupportedBLEUWBProtocolVersionsAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(AliroSupportedBLEUWBProtocolVersionsAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
      ...
      null
        ...
        SubscriptionState.SubscriptionEstablished -> {
          emit(AliroSupportedBLEUWBProtocolVersionsAttributeSubscriptionState.SubscriptionEstablished)
        }
      }
    }    
  }
suspend fun readAliroBLEAdvertisingVersionAttribute(): UByte? {val ATTRIBUTE_ID: UInt = 134u
    ...
    requireNotNull(attributeData) { 
      "Alirobleadvertisingversion attribute not found in response" 
    }
...
suspend fun readNumberOfAliroCredentialIssuerKeysSupportedAttribute(): UShort? {val ATTRIBUTE_ID: UInt = 135u
...
suspend fun readNumberOfAliroEndpointKeysSupportedAttribute(): UShort? {val ATTRIBUTE_ID: UInt = 136u
