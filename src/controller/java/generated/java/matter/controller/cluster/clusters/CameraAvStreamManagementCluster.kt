...
class CameraAvStreamManagementCluster(
  ...
  class WatermarkEnabledAttribute(val value: List<CameraAvStreamManagementClusterPerStreamStruct>?)

  sealed class WatermarkEnabledAttributeSubscriptionState {
    data class Success(val value: List<CameraAvStreamManagementClusterPerStreamStruct>?) :
      WatermarkEnabledAttributeSubscriptionState()

    data class Error(val exception: Exception) : WatermarkEnabledAttributeSubscriptionState()

    object SubscriptionEstablished : WatermarkEnabledAttributeSubscriptionState()
  }

  class OSDEnabledAttribute(val value: List<CameraAvStreamManagementClusterPerStreamStruct>?)

  sealed class OSDEnabledAttributeSubscriptionState {
    data class Success(val value: List<CameraAvStreamManagementClusterPerStreamStruct>?) :
      OSDEnabledAttributeSubscriptionState()

    data class Error(val exception: Exception) : OSDEnabledAttributeSubscriptionState()

    object SubscriptionEstablished : OSDEnabledAttributeSubscriptionState()
  }
  ...
  suspend fun videoStreamModify(
    ...
    resolution.toTlv(ContextSpecificTag(TAG_RESOLUTION_REQ), tlvWriter)
    tlvWriter.endStructure()
  ...
  suspend fun setStreamPriority(timedInvokeTimeout: Duration? = null) {
  ...
  suspend fun readHDRCapableAttribute(): Boolean? {
    ...
    requireNotNull(attributeData) { "Hdrcapable attribute not found in response" }
  ...
  suspend fun subscribeHDRCapableAttribute(
    minInterval: Int,
    maxInterval: Int,
  ): Flow<BooleanSubscriptionState> {
    val ATTRIBUTE_ID: UInt = 11u
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { "Hdrcapable attribute not found in Node State update" }
  ...
  suspend fun readHDRModeAttribute(): Boolean? {
    ...
    requireNotNull(attributeData) { "Hdrmode attribute not found in response" }
  ...
  suspend fun writeHDRModeAttribute(value: Boolean, timedWriteTimeout: Duration? = null) {
    val ATTRIBUTE_ID: UInt = 14u
  ...
  suspend fun subscribeHDRModeAttribute(
    minInterval: Int,
    maxInterval: Int,
  ): Flow<BooleanSubscriptionState> {
    val ATTRIBUTE_ID: UInt = 14u
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { "Hdrmode attribute not found in Node State update" }
  ...
  suspend fun readSoftRecordingPrivacyModeSettingAttribute(): Boolean? {
    ...
    requireNotNull(attributeData) {
      "Softrecordingprivacymodesetting attribute not found in response"
    }
  ...
  suspend fun writeSoftRecordingPrivacyModeSettingAttribute(
    value: Boolean,
    timedWriteTimeout: Duration? = null,
  ) {
    val ATTRIBUTE_ID: UInt = 22u
  ...
  suspend fun subscribeSoftRecordingPrivacyModeSettingAttribute(
    minInterval: Int,
    maxInterval: Int,
  ): Flow<BooleanSubscriptionState> {
    val ATTRIBUTE_ID: UInt = 22u
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) {
            "Softrecordingprivacymodesetting attribute not found in Node State update"
          }
  ...
  suspend fun readSoftLivestreamPrivacyModeSettingAttribute(): Boolean? {
    ...
    requireNotNull(attributeData) {
      "Softlivestreamprivacymodesetting attribute not found in response"
    }
  ...
  suspend fun writeSoftLivestreamPrivacyModeSettingAttribute(
    value: Boolean,
    timedWriteTimeout: Duration? = null,
  ) {
    val ATTRIBUTE_ID: UInt = 23u
  ...
  suspend fun subscribeSoftLivestreamPrivacyModeSettingAttribute(
    minInterval: Int,
    maxInterval: Int,
  ): Flow<BooleanSubscriptionState> {
    val ATTRIBUTE_ID: UInt = 23u
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) {
            "Softlivestreamprivacymodesetting attribute not found in Node State update"
          }
  ...
  suspend fun readHardPrivacyModeAttribute(): Boolean? {
    ...
    requireNotNull(attributeData) { "Hardprivacymode attribute not found in response" }
  ...
  suspend fun subscribeHardPrivacyModeAttribute(
    minInterval: Int,
    maxInterval: Int,
  ): Flow<BooleanSubscriptionState> {
    val ATTRIBUTE_ID: UInt = 24u
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) {
            "Hardprivacymode attribute not found in Node State update"
          }
  ...
  suspend fun readAwbAttribute(): Boolean? {
    ...
    requireNotNull(attributeData) { "Awb attribute not found in response" }
  ...
  suspend fun writeAwbAttribute(value: Boolean, timedWriteTimeout: Duration? = null) {
    val ATTRIBUTE_ID: UInt = 27u
  ...
  suspend fun subscribeAwbAttribute(
    minInterval: Int,
    maxInterval: Int,
  ): Flow<BooleanSubscriptionState> {
    val ATTRIBUTE_ID: UInt = 27u
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { "Awb attribute not found in Node State update" }
  ...
  suspend fun readShutterSpeedAttribute(): Boolean? {
    ...
    requireNotNull(attributeData) { "Shutterspeed attribute not found in response" }
  ...
  suspend fun writeShutterSpeedAttribute(value: Boolean, timedWriteTimeout: Duration? = null) {
    val ATTRIBUTE_ID: UInt = 28u
  ...
  suspend fun subscribeShutterSpeedAttribute(
    minInterval: Int,
    maxInterval: Int,
  ): Flow<BooleanSubscriptionState> {
    val ATTRIBUTE_ID: UInt = 28u
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { "Shutterspeed attribute not found in Node State update" }
  ...
  suspend fun readIsoAttribute(): Boolean? {
    ...
    requireNotNull(attributeData) { "Iso attribute not found in response" }
  ...
  suspend fun writeIsoAttribute(value: Boolean, timedWriteTimeout: Duration? = null) {
    val ATTRIBUTE_ID: UInt = 29u
  ...
  suspend fun subscribeIsoAttribute(
    minInterval: Int,
    maxInterval: Int,
  ): Flow<BooleanSubscriptionState> {
    val ATTRIBUTE_ID: UInt = 29u
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { "Iso attribute not found in Node State update" }
  ...
  suspend fun readSpeakerEnabledAttribute(): Boolean? {
    ...
    requireNotNull(attributeData) { "Speakerenabled attribute not found in response" }
  ...
  suspend fun writeSpeakerEnabledAttribute(value: Boolean, timedWriteTimeout: Duration? = null) {
    val ATTRIBUTE_ID: UInt = 31u
  ...
  suspend fun subscribeSpeakerEnabledAttribute(
    minInterval: Int,
    maxInterval: Int,
  ): Flow<BooleanSubscriptionState> {
    val ATTRIBUTE_ID: UInt = 31u
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) {
            "Speakerenabled attribute not found in Node State update"
          }
  ...
  suspend fun readMicStatusAttribute(): Boolean? {
    ...
    requireNotNull(attributeData) { "Micstatus attribute not found in response" }
  ...
  suspend fun writeMicStatusAttribute(value: Boolean, timedWriteTimeout: Duration? = null) {
    val ATTRIBUTE_ID: UInt = 35u
  ...
  suspend fun subscribeMicStatusAttribute(
    minInterval: Int,
    maxInterval: Int,
  ): Flow<BooleanSubscriptionState> {
    val ATTRIBUTE_ID: UInt = 35u
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { "Micstatus attribute not found in Node State update" }
  ...
  suspend fun readMicVolumeLevelAttribute(): UByte? {
    ...
    requireNotNull(attributeData) { "Micvolumelevel attribute not found in response" }
  ...
  suspend fun writeMicVolumeLevelAttribute(value: UByte, timedWriteTimeout: Duration? = null) {
    val ATTRIBUTE_ID: UInt = 36u
  ...
  suspend fun subscribeMicVolumeLevelAttribute(
    minInterval: Int,
    maxInterval: Int,
  ): Flow<UByteSubscriptionState> {
    val ATTRIBUTE_ID: UInt = 36u
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) {
            "Micvolumelevel attribute not found in Node State update"
          }
  ...
  suspend fun readMicMaxLevelAttribute(): UByte? {
    ...
    requireNotNull(attributeData) { "Micmaxlevel attribute not found in response" }
  ...
  suspend fun writeMicMaxLevelAttribute(value: UByte, timedWriteTimeout: Duration? = null) {
    val ATTRIBUTE_ID: UInt = 37u
  ...
  suspend fun subscribeMicMaxLevelAttribute(
    minInterval: Int,
    maxInterval: Int,
  ): Flow<UByteSubscriptionState> {
    val ATTRIBUTE_ID: UInt = 37u
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { "Micmaxlevel attribute not found in Node State update" }
  ...
  suspend fun readMicMinLevelAttribute(): UByte? {
    ...
    requireNotNull(attributeData) { "Micminlevel attribute not found in response" }
  ...
  suspend fun writeMicMinLevelAttribute(value: UByte, timedWriteTimeout: Duration? = null) {
    val ATTRIBUTE_ID: UInt = 38u
  ...
  suspend fun subscribeMicMinLevelAttribute(
    minInterval: Int,
    maxInterval: Int,
  ): Flow<UByteSubscriptionState> {
    val ATTRIBUTE_ID: UInt = 38u
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { "Micminlevel attribute not found in Node State update" }
  ...
  suspend fun readMicAGCEnabledAttribute(): Boolean? {
    ...
    requireNotNull(attributeData) { "Micagcenabled attribute not found in response" }
  ...
  suspend fun writeMicAGCEnabledAttribute(value: Boolean, timedWriteTimeout: Duration? = null) {
    val ATTRIBUTE_ID: UInt = 39u
  ...
  suspend fun subscribeMicAGCEnabledAttribute(
    minInterval: Int,
    maxInterval: Int,
  ): Flow<BooleanSubscriptionState> {
    val ATTRIBUTE_ID: UInt = 39u
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { "Micagcenabled attribute not found in Node State update" }
  ...
  suspend fun readStatusLightAttribute(): Boolean? {
    ...
    requireNotNull(attributeData) { "Statuslight attribute not found in response" }
  ...
  suspend fun writeStatusLightAttribute(value: Boolean, timedWriteTimeout: Duration? = null) {
    val ATTRIBUTE_ID: UInt = 45u
  ...
  suspend fun subscribeStatusLightAttribute(
    minInterval: Int,
    maxInterval: Int,
  ): Flow<BooleanSubscriptionState> {
    val ATTRIBUTE_ID: UInt = 45u
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { "Statuslight attribute not found in Node State update" }
  ...
  suspend fun readWatermarkEnabledAttribute(): WatermarkEnabledAttribute {
    ...
    requireNotNull(attributeData) { "Watermarkenabled attribute not found in response" }

    // Decode the TLV data into the appropriate type
    val tlvReader = TlvReader(attributeData.data)
    val decodedValue: List<CameraAvStreamManagementClusterPerStreamStruct>? =
      if (tlvReader.isNextTag(AnonymousTag)) {
        buildList<CameraAvStreamManagementClusterPerStreamStruct> {
          tlvReader.enterArray(AnonymousTag)
          while (!tlvReader.isEndOfContainer()) {
            add(CameraAvStreamManagementClusterPerStreamStruct.fromTlv(AnonymousTag, tlvReader))
          }
          tlvReader.exitContainer()
        }
      } else {
    ...
    return WatermarkEnabledAttribute(decodedValue)
  }

  suspend fun subscribeWatermarkEnabledAttribute(
    minInterval: Int,
    maxInterval: Int,
  ): Flow<WatermarkEnabledAttributeSubscriptionState> {
    val ATTRIBUTE_ID: UInt = 48u
    val attributePaths =
      listOf(
        AttributePath(endpointId = endpointId, clusterId = CLUSTER_ID, attributeId = ATTRIBUTE_ID)
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(
            WatermarkEnabledAttributeSubscriptionState.Error(
              Exception(
                "Subscription terminated with error code: ${subscriptionState.terminationCause}"
              )
            )
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) {
            "Watermarkenabled attribute not found in Node State update"
          }
          ...
          val decodedValue: List<CameraAvStreamManagementClusterPerStreamStruct>? =
            if (tlvReader.isNextTag(AnonymousTag)) {
              buildList<CameraAvStreamManagementClusterPerStreamStruct> {
                ...
                while (!tlvReader.isEndOfContainer()) {
                  add(
                    CameraAvStreamManagementClusterPerStreamStruct.fromTlv(AnonymousTag, tlvReader)
                  )
                }
                tlvReader.exitContainer()
              }
          ...
          decodedValue?.let { emit(WatermarkEnabledAttributeSubscriptionState.Success(it)) }
        }
        SubscriptionState.SubscriptionEstablished -> {
          emit(WatermarkEnabledAttributeSubscriptionState.SubscriptionEstablished)
        }
      }
    }
  }

  suspend fun readOSDEnabledAttribute(): OSDEnabledAttribute {
    ...
    requireNotNull(attributeData) { "Osdenabled attribute not found in response" }
    ...
    return OSDEnabledAttribute(decodedValue)
  }

  suspend fun subscribeOSDEnabledAttribute(
    minInterval: Int,
    maxInterval: Int,
  ): Flow<OSDEnabledAttributeSubscriptionState> {
    val ATTRIBUTE_ID: UInt = 49u
    val attributePaths =
      listOf(
        AttributePath(endpointId = endpointId, clusterId = CLUSTER_ID, attributeId = ATTRIBUTE_ID)
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(
            OSDEnabledAttributeSubscriptionState.Error(
              Exception(
                "Subscription terminated with error code: ${subscriptionState.terminationCause}"
              )
            )
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { "Osdenabled attribute not found in Node State update" }
          ...
          decodedValue?.let { emit(OSDEnabledAttributeSubscriptionState.Success(it)) }
        }
        SubscriptionState.SubscriptionEstablished -> {
          emit(OSDEnabledAttributeSubscriptionState.SubscriptionEstablished)
        }
      }
    }
  }
