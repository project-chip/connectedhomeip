...
class DeviceEnergyManagementModeCluster(private val controller: MatterController, private val endpointId: UShort) {
  class ChangeToModeResponse(
    val status: UByte, 
    val statusText: String?
  )
class SupportedModesAttribute(
    val value: List<DeviceEnergyManagementModeClusterModeOptionStruct>
  )
...
suspend fun readSupportedModesAttribute(): SupportedModesAttribute {val ATTRIBUTE_ID: UInt = 0u
    ...
    val decodedValue: List<DeviceEnergyManagementModeClusterModeOptionStruct> = buildList<DeviceEnergyManagementModeClusterModeOptionStruct> {
