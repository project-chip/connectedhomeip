...
class PushAvStreamTransportClusterCMAFContainerOptionsStruct(
  val fragmentDuration: UShort,
  val chunkDuration: UShort,
  val segmentGroup: UByte,
  ...
  companion object {
    ...
    fun fromTlv(
      ...
      val fragmentDuration = tlvReader.getUShort(ContextSpecificTag(TAG_FRAGMENT_DURATION))
      val chunkDuration = tlvReader.getUShort(ContextSpecificTag(TAG_CHUNK_DURATION))
      val segmentGroup = tlvReader.getUByte(ContextSpecificTag(TAG_SEGMENT_GROUP))
