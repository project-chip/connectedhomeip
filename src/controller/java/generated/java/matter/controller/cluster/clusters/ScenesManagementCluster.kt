...
class ScenesManagementCluster(private val controller: MatterController, private val endpointId: UShort) {
  ...
  class RemoveAllScenesResponse(
    val status: UByte, 
    val groupID: UShort
  )

  class StoreSceneResponse(
    val status: UByte, 
    val groupID: UShort, 
    val sceneID: UByte
  )
  ...
  class EnhancedAddSceneResponse(
    val status: UByte, 
    val groupID: UShort, 
    val sceneID: UByte
  )
...
class LastConfiguredByAttribute(
    val value: ULong?
  )
  ...
  sealed class LastConfiguredByAttributeSubscriptionState {
    data class Success(
    val value: ULong?
    ) : LastConfiguredByAttributeSubscriptionState()
...
class FabricSceneInfoAttribute(
    val value: List<ScenesManagementClusterSceneInfoStruct>
  )
...
class AttributeListAttribute(
  ...
  suspend fun addScene(groupID: UShort
      ,sceneID: UByte
      ,transitionTime: UShort
      ,sceneName: String
      ,extensionFieldSets: List<ScenesManagementClusterExtensionFieldSet>
      ,timedInvokeTimeout: Duration? = null): AddSceneResponse {
    ...
    while (!tlvReader.isEndOfContainer()) {
      ...
      if (tag == ContextSpecificTag(TAG_GROUP_I_D)) {groupID_decoded = tlvReader.getUShort(tag)}  
      
      if (tag == ContextSpecificTag(TAG_SCENE_I_D)) {sceneID_decoded = tlvReader.getUByte(tag)}  
  ...
  suspend fun viewScene(groupID: UShort
      ,sceneID: UByte
      ,timedInvokeTimeout: Duration? = null): ViewSceneResponse {
    ...
    while (!tlvReader.isEndOfContainer()) {
      ...
      if (tag == ContextSpecificTag(TAG_TRANSITION_TIME)) {transitionTime_decoded = 
          if (tlvReader.isNull()) {
      ...
      if (tag == ContextSpecificTag(TAG_SCENE_NAME)) {sceneName_decoded = 
          if (tlvReader.isNull()) {
            tlvReader.getNull(tag)
            null
          } else {
      ...
      if (tag == ContextSpecificTag(TAG_EXTENSION_FIELD_SETS)) {extensionFieldSets_decoded = 
          if (tlvReader.isNull()) {
            tlvReader.getNull(tag)
            null
          } else {
  ...
  suspend fun removeScene(groupID: UShort
      ,sceneID: UByte
      ,timedInvokeTimeout: Duration? = null): RemoveSceneResponse {
  ...
  suspend fun removeAllScenes(groupID: UShort
      ,timedInvokeTimeout: Duration? = null): RemoveAllScenesResponse {
  ...
  suspend fun storeScene(groupID: UShort
      ,sceneID: UByte
      ,timedInvokeTimeout: Duration? = null): StoreSceneResponse {
  ...
  suspend fun recallScene(groupID: UShort
      ,sceneID: UByte
      ,transitionTime: UShort?
  ...
  suspend fun getSceneMembership(groupID: UShort
      ,timedInvokeTimeout: Duration? = null): GetSceneMembershipResponse {
    ...
    while (!tlvReader.isEndOfContainer()) {
      ...
      if (tag == ContextSpecificTag(TAG_CAPACITY)) {capacity_decoded = 
          if (tlvReader.isNull()) {
            tlvReader.getNull(tag)
            null
          } else {
      ...
      if (tag == ContextSpecificTag(TAG_SCENE_LIST)) {sceneList_decoded = 
          if (tlvReader.isNull()) {
            tlvReader.getNull(tag)
            null
          } else {
  ...
  suspend fun enhancedAddScene(groupID: UShort
      ,sceneID: UByte
      ,transitionTime: UShort
      ,sceneName: String
      ,extensionFieldSets: List<ScenesManagementClusterExtensionFieldSet>
      ,timedInvokeTimeout: Duration? = null): EnhancedAddSceneResponse {
  ...
  suspend fun enhancedViewScene(groupID: UShort
      ,sceneID: UByte
      ,timedInvokeTimeout: Duration? = null): EnhancedViewSceneResponse {
  ...
  suspend fun copyScene(mode: UByte
    ...
    while (!tlvReader.isEndOfContainer()) {
      ...
      if (tag == ContextSpecificTag(TAG_GROUP_IDENTIFIER_FROM)) {groupIdentifierFrom_decoded = tlvReader.getUShort(tag)}  
      
      if (tag == ContextSpecificTag(TAG_SCENE_IDENTIFIER_FROM)) {sceneIdentifierFrom_decoded = tlvReader.getUByte(tag)}  
...
suspend fun readSceneCountAttribute(): UByte? {val ATTRIBUTE_ID: UInt = 0u
    ...
    requireNotNull(attributeData) { 
      "Scenecount attribute not found in response" 
    }
  ...
  suspend fun subscribeSceneCountAttribute(
    minInterval: Int,
    maxInterval: Int
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { 
            "Scenecount attribute not found in Node State update" 
          }
...
suspend fun readCurrentSceneAttribute(): UByte? {val ATTRIBUTE_ID: UInt = 1u
    ...
    requireNotNull(attributeData) { 
      "Currentscene attribute not found in response" 
    }
  ...
  suspend fun subscribeCurrentSceneAttribute(
    minInterval: Int,
    maxInterval: Int
  ): Flow<UByteSubscriptionState> {
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { 
            "Currentscene attribute not found in Node State update" 
          }
...
suspend fun readCurrentGroupAttribute(): UShort? {val ATTRIBUTE_ID: UInt = 2u
    ...
    requireNotNull(attributeData) { 
      "Currentgroup attribute not found in response" 
    }
  ...
  suspend fun subscribeCurrentGroupAttribute(
    minInterval: Int,
    maxInterval: Int
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { 
            "Currentgroup attribute not found in Node State update" 
          }
...
suspend fun readSceneValidAttribute(): Boolean? {val ATTRIBUTE_ID: UInt = 3u
    ...
    requireNotNull(attributeData) { 
      "Scenevalid attribute not found in response" 
    }
  ...
  suspend fun subscribeSceneValidAttribute(
    minInterval: Int,
    maxInterval: Int
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { 
            "Scenevalid attribute not found in Node State update" 
          }
...
suspend fun readNameSupportAttribute(): UByte {val ATTRIBUTE_ID: UInt = 4u
    ...
    requireNotNull(attributeData) { 
      "Namesupport attribute not found in response" 
    }
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { 
            "Namesupport attribute not found in Node State update" 
          }
...
suspend fun readLastConfiguredByAttribute(): LastConfiguredByAttribute {val ATTRIBUTE_ID: UInt = 5u
    ...
    requireNotNull(attributeData) { 
      "Lastconfiguredby attribute not found in response" 
    }
  ...
  suspend fun subscribeLastConfiguredByAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(LastConfiguredByAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
      ...
      null
          ...
          decodedValue?.let {
            emit(LastConfiguredByAttributeSubscriptionState.Success(it))
          }
...
suspend fun readSceneTableSizeAttribute(): UShort {val ATTRIBUTE_ID: UInt = 6u
    ...
    requireNotNull(attributeData) { 
      "Scenetablesize attribute not found in response" 
    }
...
suspend fun readFabricSceneInfoAttribute(): FabricSceneInfoAttribute {val ATTRIBUTE_ID: UInt = 7u
    ...
    requireNotNull(attributeData) { 
      "Fabricsceneinfo attribute not found in response" 
    }

    // Decode the TLV data into the appropriate type
    val tlvReader = TlvReader(attributeData.data)
    val decodedValue: List<ScenesManagementClusterSceneInfoStruct> = buildList<ScenesManagementClusterSceneInfoStruct> {
  ...
  suspend fun subscribeFabricSceneInfoAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(FabricSceneInfoAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
