...
class AttributeListAttribute(
  ...
  suspend fun addScene(groupID: UShort
    ...
    while (!tlvReader.isEndOfContainer()) {
      ...
      if (tag == ContextSpecificTag(TAG_GROUP_ID)) {groupID_decoded = tlvReader.getUShort(tag)}  
      
      if (tag == ContextSpecificTag(TAG_SCENE_ID)) {sceneID_decoded = tlvReader.getUByte(tag)}  
