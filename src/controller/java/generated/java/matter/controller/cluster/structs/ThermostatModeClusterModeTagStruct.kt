...
class ThermostatModeClusterModeTagStruct(val mfgCode: Optional<UShort>, val value: UShort) {
  override fun toString(): String = buildString {
    append("ThermostatModeClusterModeTagStruct {\n")
  ...
  companion object {
    ...
    fun fromTlv(tlvTag: Tag, tlvReader: TlvReader): ThermostatModeClusterModeTagStruct {
      ...
      return ThermostatModeClusterModeTagStruct(mfgCode, value)
    }
  }
}
