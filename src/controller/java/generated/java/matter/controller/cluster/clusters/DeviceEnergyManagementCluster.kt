...
class DeviceEnergyManagementCluster(private val controller: MatterController, private val endpointId: UShort) {class PowerAdjustmentCapabilityAttribute(
  ...
  sealed class PowerAdjustmentCapabilityAttributeSubscriptionState {
    ...
    data class Error(val exception: Exception) : PowerAdjustmentCapabilityAttributeSubscriptionState()

    object SubscriptionEstablished : PowerAdjustmentCapabilityAttributeSubscriptionState()    
  }  
class ForecastAttribute(
    val value: DeviceEnergyManagementClusterForecastStruct?
  )
...
class AttributeListAttribute(
  ...
  suspend fun powerAdjustRequest(power: Long
      ,duration: UInt
      ,cause: UByte
  ...
  suspend fun startTimeAdjustRequest(requestedStartTime: UInt
      ,cause: UByte
      ,timedInvokeTimeout: Duration? = null) {
  ...
  suspend fun pauseRequest(duration: UInt
      ,cause: UByte
      ,timedInvokeTimeout: Duration? = null) {
  ...
  suspend fun modifyForecastRequest(forecastID: UInt
  ...
  suspend fun requestConstraintBasedForecast(constraints: List<DeviceEnergyManagementClusterConstraintsStruct>
      ,cause: UByte
      ,timedInvokeTimeout: Duration? = null) {
...
suspend fun readESATypeAttribute(): UByte {val ATTRIBUTE_ID: UInt = 0u
    ...
    requireNotNull(attributeData) { 
      "Esatype attribute not found in response" 
    }
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { 
            "Esatype attribute not found in Node State update" 
          }
...
suspend fun readESACanGenerateAttribute(): Boolean {val ATTRIBUTE_ID: UInt = 1u
    ...
    requireNotNull(attributeData) { 
      "Esacangenerate attribute not found in response" 
    }
...
suspend fun readESAStateAttribute(): UByte {val ATTRIBUTE_ID: UInt = 2u
    ...
    requireNotNull(attributeData) { 
      "Esastate attribute not found in response" 
    }
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { 
            "Esastate attribute not found in Node State update" 
          }
...
suspend fun readAbsMinPowerAttribute(): Long {val ATTRIBUTE_ID: UInt = 3u
    ...
    requireNotNull(attributeData) { 
      "Absminpower attribute not found in response" 
    }
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { 
            "Absminpower attribute not found in Node State update" 
          }
...
suspend fun readAbsMaxPowerAttribute(): Long {val ATTRIBUTE_ID: UInt = 4u
    ...
    requireNotNull(attributeData) { 
      "Absmaxpower attribute not found in response" 
    }
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { 
            "Absmaxpower attribute not found in Node State update" 
          }
...
suspend fun readPowerAdjustmentCapabilityAttribute(): PowerAdjustmentCapabilityAttribute {val ATTRIBUTE_ID: UInt = 5u
    ...
    requireNotNull(attributeData) { 
      "Poweradjustmentcapability attribute not found in response" 
    }

    // Decode the TLV data into the appropriate type
    val tlvReader = TlvReader(attributeData.data)
    val decodedValue: DeviceEnergyManagementClusterPowerAdjustCapabilityStruct? = if (!tlvReader.isNull()) {
  ...
  suspend fun subscribePowerAdjustmentCapabilityAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(PowerAdjustmentCapabilityAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
...
suspend fun readForecastAttribute(): ForecastAttribute {val ATTRIBUTE_ID: UInt = 6u
    ...
    requireNotNull(attributeData) { 
      "Forecast attribute not found in response" 
    }

    // Decode the TLV data into the appropriate type
    val tlvReader = TlvReader(attributeData.data)
    val decodedValue: DeviceEnergyManagementClusterForecastStruct? = if (!tlvReader.isNull()) {
      if (tlvReader.isNextTag(AnonymousTag)) {
  ...
  suspend fun subscribeForecastAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(ForecastAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
          ...
          requireNotNull(attributeData) { 
            "Forecast attribute not found in Node State update" 
          }
      ...
      null
          ...
          decodedValue?.let {
            emit(ForecastAttributeSubscriptionState.Success(it))
          }
...
suspend fun readOptOutStateAttribute(): UByte? {val ATTRIBUTE_ID: UInt = 7u
    ...
    requireNotNull(attributeData) { 
      "Optoutstate attribute not found in response" 
    }
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { 
            "Optoutstate attribute not found in Node State update" 
          }
