...
class RvcCleanModeCluster(
  ...
  sealed class SupportedModesAttributeSubscriptionState {
    data class Success(val value: List<RvcCleanModeClusterModeOptionStruct>) :
  ...
  suspend fun readSupportedModesAttribute(): SupportedModesAttribute {
    ...
    val decodedValue: List<RvcCleanModeClusterModeOptionStruct> =
      buildList<RvcCleanModeClusterModeOptionStruct> {
