...
class ThreadNetworkDiagnosticsCluster(
  ...
  sealed class ChannelAttributeSubscriptionState {
    data class Success(val value: UShort?) : ChannelAttributeSubscriptionState()
  ...
  sealed class RoutingRoleAttributeSubscriptionState {
    data class Success(val value: UByte?) : RoutingRoleAttributeSubscriptionState()
  ...
  sealed class NetworkNameAttributeSubscriptionState {
    data class Success(val value: String?) : NetworkNameAttributeSubscriptionState()
  ...
  sealed class PanIdAttributeSubscriptionState {
    data class Success(val value: UShort?) : PanIdAttributeSubscriptionState()
  ...
  sealed class ExtendedPanIdAttributeSubscriptionState {
    data class Success(val value: ULong?) : ExtendedPanIdAttributeSubscriptionState()
  ...
  sealed class MeshLocalPrefixAttributeSubscriptionState {
    data class Success(val value: ByteArray?) : MeshLocalPrefixAttributeSubscriptionState()
  ...
  sealed class NeighborTableAttributeSubscriptionState {
    data class Success(val value: List<ThreadNetworkDiagnosticsClusterNeighborTableStruct>) :
  ...
  sealed class RouteTableAttributeSubscriptionState {
    data class Success(val value: List<ThreadNetworkDiagnosticsClusterRouteTableStruct>) :
  ...
  sealed class PartitionIdAttributeSubscriptionState {
    data class Success(val value: UInt?) : PartitionIdAttributeSubscriptionState()
  ...
  sealed class WeightingAttributeSubscriptionState {
    data class Success(val value: UShort?) : WeightingAttributeSubscriptionState()
  ...
  sealed class StableDataVersionAttributeSubscriptionState {
    data class Success(val value: UShort?) : StableDataVersionAttributeSubscriptionState()
  ...
  sealed class LeaderRouterIdAttributeSubscriptionState {
    data class Success(val value: UByte?) : LeaderRouterIdAttributeSubscriptionState()
  ...
  sealed class ActiveTimestampAttributeSubscriptionState {
    data class Success(val value: ULong?) : ActiveTimestampAttributeSubscriptionState()
  ...
  sealed class PendingTimestampAttributeSubscriptionState {
    data class Success(val value: ULong?) : PendingTimestampAttributeSubscriptionState()
  ...
  sealed class DelayAttributeSubscriptionState {
    data class Success(val value: UInt?) : DelayAttributeSubscriptionState()
  ...
  sealed class SecurityPolicyAttributeSubscriptionState {
    data class Success(val value: ThreadNetworkDiagnosticsClusterSecurityPolicy?) :
  ...
  sealed class ChannelPage0MaskAttributeSubscriptionState {
    data class Success(val value: ByteArray?) : ChannelPage0MaskAttributeSubscriptionState()
  ...
  class ExtAddressAttribute(val value: ULong?)

  sealed class ExtAddressAttributeSubscriptionState {
    data class Success(val value: ULong?) : ExtAddressAttributeSubscriptionState()
  ...
  class Rloc16Attribute(val value: UShort?)

  sealed class Rloc16AttributeSubscriptionState {
    data class Success(val value: UShort?) : Rloc16AttributeSubscriptionState()
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(
            ChannelAttributeSubscriptionState.Error(
              Exception(
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { "Channel attribute not found in Node State update" }
          ...
          decodedValue?.let { emit(ChannelAttributeSubscriptionState.Success(it)) }
        }
  ...
  suspend fun subscribeRoutingRoleAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(
            RoutingRoleAttributeSubscriptionState.Error(
              Exception(
                "Subscription terminated with error code: ${subscriptionState.terminationCause}"
              )
            )
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { "Routingrole attribute not found in Node State update" }
          ...
          decodedValue?.let { emit(RoutingRoleAttributeSubscriptionState.Success(it)) }
        }
        SubscriptionState.SubscriptionEstablished -> {
  ...
  suspend fun subscribeNetworkNameAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(
            NetworkNameAttributeSubscriptionState.Error(
              Exception(
                "Subscription terminated with error code: ${subscriptionState.terminationCause}"
              )
            )
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { "Networkname attribute not found in Node State update" }
          ...
          decodedValue?.let { emit(NetworkNameAttributeSubscriptionState.Success(it)) }
        }
        SubscriptionState.SubscriptionEstablished -> {
  ...
  suspend fun subscribePanIdAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(
            PanIdAttributeSubscriptionState.Error(
              Exception(
                "Subscription terminated with error code: ${subscriptionState.terminationCause}"
              )
            )
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { "Panid attribute not found in Node State update" }
          ...
          decodedValue?.let { emit(PanIdAttributeSubscriptionState.Success(it)) }
        }
        SubscriptionState.SubscriptionEstablished -> {
  ...
  suspend fun subscribeExtendedPanIdAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(
            ExtendedPanIdAttributeSubscriptionState.Error(
              Exception(
                "Subscription terminated with error code: ${subscriptionState.terminationCause}"
              )
            )
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { "Extendedpanid attribute not found in Node State update" }
          ...
          decodedValue?.let { emit(ExtendedPanIdAttributeSubscriptionState.Success(it)) }
        }
        SubscriptionState.SubscriptionEstablished -> {
  ...
  suspend fun subscribeMeshLocalPrefixAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(
            MeshLocalPrefixAttributeSubscriptionState.Error(
              Exception(
                "Subscription terminated with error code: ${subscriptionState.terminationCause}"
              )
            )
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          decodedValue?.let { emit(MeshLocalPrefixAttributeSubscriptionState.Success(it)) }
        }
        SubscriptionState.SubscriptionEstablished -> {
  ...
  suspend fun subscribeNeighborTableAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(
            NeighborTableAttributeSubscriptionState.Error(
              Exception(
                "Subscription terminated with error code: ${subscriptionState.terminationCause}"
              )
            )
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { "Neighbortable attribute not found in Node State update" }
          ...
          val decodedValue: List<ThreadNetworkDiagnosticsClusterNeighborTableStruct> =
            buildList<ThreadNetworkDiagnosticsClusterNeighborTableStruct> {
              ...
              while (!tlvReader.isEndOfContainer()) {
                add(
                  ThreadNetworkDiagnosticsClusterNeighborTableStruct.fromTlv(
                    AnonymousTag,
                    tlvReader,
                  )
                )
  ...
  suspend fun subscribeRouteTableAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(
            RouteTableAttributeSubscriptionState.Error(
              Exception(
                "Subscription terminated with error code: ${subscriptionState.terminationCause}"
              )
            )
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { "Routetable attribute not found in Node State update" }
          ...
          val decodedValue: List<ThreadNetworkDiagnosticsClusterRouteTableStruct> =
            buildList<ThreadNetworkDiagnosticsClusterRouteTableStruct> {
              ...
              while (!tlvReader.isEndOfContainer()) {
                add(
                  ThreadNetworkDiagnosticsClusterRouteTableStruct.fromTlv(AnonymousTag, tlvReader)
                )
              }
              tlvReader.exitContainer()
            }
  ...
  suspend fun subscribePartitionIdAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(
            PartitionIdAttributeSubscriptionState.Error(
              Exception(
                "Subscription terminated with error code: ${subscriptionState.terminationCause}"
              )
            )
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { "Partitionid attribute not found in Node State update" }
          ...
          decodedValue?.let { emit(PartitionIdAttributeSubscriptionState.Success(it)) }
        }
        SubscriptionState.SubscriptionEstablished -> {
  ...
  suspend fun subscribeWeightingAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(
            WeightingAttributeSubscriptionState.Error(
              Exception(
                "Subscription terminated with error code: ${subscriptionState.terminationCause}"
              )
            )
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { "Weighting attribute not found in Node State update" }
          ...
          decodedValue?.let { emit(WeightingAttributeSubscriptionState.Success(it)) }
        }
        SubscriptionState.SubscriptionEstablished -> {
  ...
  suspend fun subscribeDataVersionAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(
            DataVersionAttributeSubscriptionState.Error(
              Exception(
                "Subscription terminated with error code: ${subscriptionState.terminationCause}"
              )
            )
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { "Dataversion attribute not found in Node State update" }
          ...
          decodedValue?.let { emit(DataVersionAttributeSubscriptionState.Success(it)) }
        }
        SubscriptionState.SubscriptionEstablished -> {
  ...
  suspend fun subscribeStableDataVersionAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(
            StableDataVersionAttributeSubscriptionState.Error(
              Exception(
                "Subscription terminated with error code: ${subscriptionState.terminationCause}"
              )
            )
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          decodedValue?.let { emit(StableDataVersionAttributeSubscriptionState.Success(it)) }
        }
        SubscriptionState.SubscriptionEstablished -> {
  ...
  suspend fun subscribeLeaderRouterIdAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(
            LeaderRouterIdAttributeSubscriptionState.Error(
              Exception(
                "Subscription terminated with error code: ${subscriptionState.terminationCause}"
              )
            )
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          decodedValue?.let { emit(LeaderRouterIdAttributeSubscriptionState.Success(it)) }
        }
        SubscriptionState.SubscriptionEstablished -> {
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { "Txtotalcount attribute not found in Node State update" }
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { "Txackedcount attribute not found in Node State update" }
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { "Txdatacount attribute not found in Node State update" }
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { "Txbeaconcount attribute not found in Node State update" }
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { "Txothercount attribute not found in Node State update" }
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { "Txretrycount attribute not found in Node State update" }
  ...
  suspend fun readTxDirectMaxRetryExpiryCountAttribute(): UInt? {
    ...
    requireNotNull(attributeData) { "Txdirectmaxretryexpirycount attribute not found in response" }
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { "Txerrccacount attribute not found in Node State update" }
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { "Rxtotalcount attribute not found in Node State update" }
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { "Rxdatacount attribute not found in Node State update" }
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { "Rxbeaconcount attribute not found in Node State update" }
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { "Rxothercount attribute not found in Node State update" }
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { "Rxerrseccount attribute not found in Node State update" }
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { "Rxerrfcscount attribute not found in Node State update" }
  ...
  suspend fun subscribeActiveTimestampAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(
            ActiveTimestampAttributeSubscriptionState.Error(
              Exception(
                "Subscription terminated with error code: ${subscriptionState.terminationCause}"
              )
            )
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          decodedValue?.let { emit(ActiveTimestampAttributeSubscriptionState.Success(it)) }
        }
        SubscriptionState.SubscriptionEstablished -> {
  ...
  suspend fun subscribePendingTimestampAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(
            PendingTimestampAttributeSubscriptionState.Error(
              Exception(
                "Subscription terminated with error code: ${subscriptionState.terminationCause}"
              )
            )
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          decodedValue?.let { emit(PendingTimestampAttributeSubscriptionState.Success(it)) }
        }
        SubscriptionState.SubscriptionEstablished -> {
  ...
  suspend fun subscribeDelayAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(
            DelayAttributeSubscriptionState.Error(
              Exception(
                "Subscription terminated with error code: ${subscriptionState.terminationCause}"
              )
            )
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { "Delay attribute not found in Node State update" }
          ...
          decodedValue?.let { emit(DelayAttributeSubscriptionState.Success(it)) }
        }
        SubscriptionState.SubscriptionEstablished -> {
  ...
  suspend fun subscribeSecurityPolicyAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(
            SecurityPolicyAttributeSubscriptionState.Error(
              Exception(
                "Subscription terminated with error code: ${subscriptionState.terminationCause}"
              )
            )
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          decodedValue?.let { emit(SecurityPolicyAttributeSubscriptionState.Success(it)) }
        }
        SubscriptionState.SubscriptionEstablished -> {
  ...
  suspend fun subscribeChannelPage0MaskAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(
            ChannelPage0MaskAttributeSubscriptionState.Error(
              Exception(
                "Subscription terminated with error code: ${subscriptionState.terminationCause}"
              )
            )
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          decodedValue?.let { emit(ChannelPage0MaskAttributeSubscriptionState.Success(it)) }
        }
        SubscriptionState.SubscriptionEstablished -> {
  ...
  suspend fun readOperationalDatasetComponentsAttribute(): OperationalDatasetComponentsAttribute {
    ...
    requireNotNull(attributeData) { "Operationaldatasetcomponents attribute not found in response" }
  ...
  suspend fun subscribeOperationalDatasetComponentsAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(
            OperationalDatasetComponentsAttributeSubscriptionState.Error(
              Exception(
                "Subscription terminated with error code: ${subscriptionState.terminationCause}"
              )
            )
  ...
  suspend fun subscribeActiveNetworkFaultsListAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(
            ActiveNetworkFaultsListAttributeSubscriptionState.Error(
              Exception(
                "Subscription terminated with error code: ${subscriptionState.terminationCause}"
              )
            )
  ...
  suspend fun readExtAddressAttribute(): ExtAddressAttribute {
    ...
    requireNotNull(attributeData) { "Extaddress attribute not found in response" }
  ...
  suspend fun subscribeExtAddressAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(
            ExtAddressAttributeSubscriptionState.Error(
              Exception(
                "Subscription terminated with error code: ${subscriptionState.terminationCause}"
              )
            )
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { "Extaddress attribute not found in Node State update" }
          ...
          decodedValue?.let { emit(ExtAddressAttributeSubscriptionState.Success(it)) }
        }
        SubscriptionState.SubscriptionEstablished -> {
  ...
  suspend fun readRloc16Attribute(): Rloc16Attribute {
    ...
    requireNotNull(attributeData) { "Rloc16 attribute not found in response" }
  ...
  suspend fun subscribeRloc16Attribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(
            Rloc16AttributeSubscriptionState.Error(
              Exception(
                "Subscription terminated with error code: ${subscriptionState.terminationCause}"
              )
            )
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { "Rloc16 attribute not found in Node State update" }
          ...
          decodedValue?.let { emit(Rloc16AttributeSubscriptionState.Success(it)) }
        }
        SubscriptionState.SubscriptionEstablished -> {
