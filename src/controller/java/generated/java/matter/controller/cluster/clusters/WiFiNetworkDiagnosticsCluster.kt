...
class WiFiNetworkDiagnosticsCluster(private val controller: MatterController, private val endpointId: UShort) {class BssidAttribute(
    val value: ByteArray?
  )
  ...
  sealed class BssidAttributeSubscriptionState {
    data class Success(
    val value: ByteArray?
    ) : BssidAttributeSubscriptionState()
...
class SecurityTypeAttribute(
  ...
  sealed class SecurityTypeAttributeSubscriptionState {
    data class Success(
    val value: UByte?
    ) : SecurityTypeAttributeSubscriptionState()
...
class WiFiVersionAttribute(
  ...
  sealed class WiFiVersionAttributeSubscriptionState {
    data class Success(
    val value: UByte?
    ) : WiFiVersionAttributeSubscriptionState()
...
class ChannelNumberAttribute(
  ...
  sealed class ChannelNumberAttributeSubscriptionState {
    data class Success(
    val value: UShort?
    ) : ChannelNumberAttributeSubscriptionState()
...
class RssiAttribute(
  ...
  sealed class RssiAttributeSubscriptionState {
    data class Success(
    val value: Byte?
    ) : RssiAttributeSubscriptionState()
...
class BeaconLostCountAttribute(
  ...
  sealed class BeaconLostCountAttributeSubscriptionState {
    data class Success(
    val value: UInt?
    ) : BeaconLostCountAttributeSubscriptionState()
...
class BeaconRxCountAttribute(
  ...
  sealed class BeaconRxCountAttributeSubscriptionState {
    data class Success(
    val value: UInt?
    ) : BeaconRxCountAttributeSubscriptionState()
...
class PacketMulticastRxCountAttribute(
  ...
  sealed class PacketMulticastRxCountAttributeSubscriptionState {
    data class Success(
    val value: UInt?
    ) : PacketMulticastRxCountAttributeSubscriptionState()
...
class PacketMulticastTxCountAttribute(
  ...
  sealed class PacketMulticastTxCountAttributeSubscriptionState {
    data class Success(
    val value: UInt?
    ) : PacketMulticastTxCountAttributeSubscriptionState()
...
class PacketUnicastRxCountAttribute(
  ...
  sealed class PacketUnicastRxCountAttributeSubscriptionState {
    data class Success(
    val value: UInt?
    ) : PacketUnicastRxCountAttributeSubscriptionState()
...
class PacketUnicastTxCountAttribute(
  ...
  sealed class PacketUnicastTxCountAttributeSubscriptionState {
    data class Success(
    val value: UInt?
    ) : PacketUnicastTxCountAttributeSubscriptionState()
...
class CurrentMaxRateAttribute(
  ...
  sealed class CurrentMaxRateAttributeSubscriptionState {
    data class Success(
    val value: ULong?
    ) : CurrentMaxRateAttributeSubscriptionState()
...
class OverrunCountAttribute(
  ...
  sealed class OverrunCountAttributeSubscriptionState {
    data class Success(
    val value: ULong?
    ) : OverrunCountAttributeSubscriptionState()
...
suspend fun readBssidAttribute(): BssidAttribute {val ATTRIBUTE_ID: UInt = 0u
    ...
    requireNotNull(attributeData) { 
      "Bssid attribute not found in response" 
    }
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(BssidAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { 
            "Bssid attribute not found in Node State update" 
          }
      ...
      null
          ...
          decodedValue?.let {
            emit(BssidAttributeSubscriptionState.Success(it))
          }
...
suspend fun readSecurityTypeAttribute(): SecurityTypeAttribute {val ATTRIBUTE_ID: UInt = 1u
    ...
    requireNotNull(attributeData) { 
      "Securitytype attribute not found in response" 
    }
  ...
  suspend fun subscribeSecurityTypeAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(SecurityTypeAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
          ...
          requireNotNull(attributeData) { 
            "Securitytype attribute not found in Node State update" 
          }
      ...
      null
          ...
          decodedValue?.let {
            emit(SecurityTypeAttributeSubscriptionState.Success(it))
          }
...
suspend fun readWiFiVersionAttribute(): WiFiVersionAttribute {val ATTRIBUTE_ID: UInt = 2u
    ...
    requireNotNull(attributeData) { 
      "Wifiversion attribute not found in response" 
    }
  ...
  suspend fun subscribeWiFiVersionAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(WiFiVersionAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
          ...
          requireNotNull(attributeData) { 
            "Wifiversion attribute not found in Node State update" 
          }
      ...
      null
          ...
          decodedValue?.let {
            emit(WiFiVersionAttributeSubscriptionState.Success(it))
          }
...
suspend fun readChannelNumberAttribute(): ChannelNumberAttribute {val ATTRIBUTE_ID: UInt = 3u
    ...
    requireNotNull(attributeData) { 
      "Channelnumber attribute not found in response" 
    }
  ...
  suspend fun subscribeChannelNumberAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(ChannelNumberAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
          ...
          requireNotNull(attributeData) { 
            "Channelnumber attribute not found in Node State update" 
          }
      ...
      null
          ...
          decodedValue?.let {
            emit(ChannelNumberAttributeSubscriptionState.Success(it))
          }
...
suspend fun readRssiAttribute(): RssiAttribute {val ATTRIBUTE_ID: UInt = 4u
    ...
    requireNotNull(attributeData) { 
      "Rssi attribute not found in response" 
    }
  ...
  suspend fun subscribeRssiAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(RssiAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
          ...
          requireNotNull(attributeData) { 
            "Rssi attribute not found in Node State update" 
          }
      ...
      null
          ...
          decodedValue?.let {
            emit(RssiAttributeSubscriptionState.Success(it))
          }
...
suspend fun readBeaconLostCountAttribute(): BeaconLostCountAttribute {val ATTRIBUTE_ID: UInt = 5u
    ...
    requireNotNull(attributeData) { 
      "Beaconlostcount attribute not found in response" 
    }
  ...
  suspend fun subscribeBeaconLostCountAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(BeaconLostCountAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
      ...
      null
          ...
          decodedValue?.let {
            emit(BeaconLostCountAttributeSubscriptionState.Success(it))
          }
...
suspend fun readBeaconRxCountAttribute(): BeaconRxCountAttribute {val ATTRIBUTE_ID: UInt = 6u
    ...
    requireNotNull(attributeData) { 
      "Beaconrxcount attribute not found in response" 
    }
  ...
  suspend fun subscribeBeaconRxCountAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(BeaconRxCountAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
          ...
          requireNotNull(attributeData) { 
            "Beaconrxcount attribute not found in Node State update" 
          }
      ...
      null
          ...
          decodedValue?.let {
            emit(BeaconRxCountAttributeSubscriptionState.Success(it))
          }
...
suspend fun readPacketMulticastRxCountAttribute(): PacketMulticastRxCountAttribute {val ATTRIBUTE_ID: UInt = 7u
    ...
    requireNotNull(attributeData) { 
      "Packetmulticastrxcount attribute not found in response" 
    }
  ...
  suspend fun subscribePacketMulticastRxCountAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(PacketMulticastRxCountAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
      ...
      null
          ...
          decodedValue?.let {
            emit(PacketMulticastRxCountAttributeSubscriptionState.Success(it))
          }
...
suspend fun readPacketMulticastTxCountAttribute(): PacketMulticastTxCountAttribute {val ATTRIBUTE_ID: UInt = 8u
    ...
    requireNotNull(attributeData) { 
      "Packetmulticasttxcount attribute not found in response" 
    }
  ...
  suspend fun subscribePacketMulticastTxCountAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(PacketMulticastTxCountAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
      ...
      null
          ...
          decodedValue?.let {
            emit(PacketMulticastTxCountAttributeSubscriptionState.Success(it))
          }
...
suspend fun readPacketUnicastRxCountAttribute(): PacketUnicastRxCountAttribute {val ATTRIBUTE_ID: UInt = 9u
    ...
    requireNotNull(attributeData) { 
      "Packetunicastrxcount attribute not found in response" 
    }
  ...
  suspend fun subscribePacketUnicastRxCountAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(PacketUnicastRxCountAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
      ...
      null
          ...
          decodedValue?.let {
            emit(PacketUnicastRxCountAttributeSubscriptionState.Success(it))
          }
...
suspend fun readPacketUnicastTxCountAttribute(): PacketUnicastTxCountAttribute {val ATTRIBUTE_ID: UInt = 10u
    ...
    requireNotNull(attributeData) { 
      "Packetunicasttxcount attribute not found in response" 
    }
  ...
  suspend fun subscribePacketUnicastTxCountAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(PacketUnicastTxCountAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
      ...
      null
          ...
          decodedValue?.let {
            emit(PacketUnicastTxCountAttributeSubscriptionState.Success(it))
          }
...
suspend fun readCurrentMaxRateAttribute(): CurrentMaxRateAttribute {val ATTRIBUTE_ID: UInt = 11u
    ...
    requireNotNull(attributeData) { 
      "Currentmaxrate attribute not found in response" 
    }
  ...
  suspend fun subscribeCurrentMaxRateAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(CurrentMaxRateAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
      ...
      null
          ...
          decodedValue?.let {
            emit(CurrentMaxRateAttributeSubscriptionState.Success(it))
          }
...
suspend fun readOverrunCountAttribute(): OverrunCountAttribute {val ATTRIBUTE_ID: UInt = 12u
  ...
  suspend fun subscribeOverrunCountAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(OverrunCountAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
      ...
      null
          ...
          decodedValue?.let {
            emit(OverrunCountAttributeSubscriptionState.Success(it))
          }
