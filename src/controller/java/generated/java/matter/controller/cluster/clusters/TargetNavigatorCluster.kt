...
class TargetNavigatorCluster(
  ...
  sealed class TargetListAttributeSubscriptionState {
    data class Success(val value: List<TargetNavigatorClusterTargetInfoStruct>) :
  ...
  suspend fun readTargetListAttribute(): TargetListAttribute {
    ...
    requireNotNull(attributeData) { "Targetlist attribute not found in response" }

    // Decode the TLV data into the appropriate type
    val tlvReader = TlvReader(attributeData.data)
    val decodedValue: List<TargetNavigatorClusterTargetInfoStruct> =
      buildList<TargetNavigatorClusterTargetInfoStruct> {
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(
            TargetListAttributeSubscriptionState.Error(
              Exception(
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { "Targetlist attribute not found in Node State update" }
  ...
  suspend fun readCurrentTargetAttribute(): UByte? {
    ...
    requireNotNull(attributeData) { "Currenttarget attribute not found in response" }
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { "Currenttarget attribute not found in Node State update" }
