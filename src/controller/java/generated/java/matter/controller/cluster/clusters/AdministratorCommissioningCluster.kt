...
class AdministratorCommissioningCluster(private val controller: MatterController, private val endpointId: UShort) {class AdminFabricIndexAttribute(
    val value: UByte?
  )
  ...
  sealed class AdminFabricIndexAttributeSubscriptionState {
    data class Success(
    val value: UByte?
    ) : AdminFabricIndexAttributeSubscriptionState()
...
class AdminVendorIdAttribute(
  ...
  sealed class AdminVendorIdAttributeSubscriptionState {
    data class Success(
    val value: UShort?
    ) : AdminVendorIdAttributeSubscriptionState()
...
class AttributeListAttribute(
  ...
  suspend fun openCommissioningWindow(commissioningTimeout: UShort
...
suspend fun readWindowStatusAttribute(): UByte {val ATTRIBUTE_ID: UInt = 0u
    ...
    requireNotNull(attributeData) { 
      "Windowstatus attribute not found in response" 
    }
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { 
            "Windowstatus attribute not found in Node State update" 
          }
...
suspend fun readAdminFabricIndexAttribute(): AdminFabricIndexAttribute {val ATTRIBUTE_ID: UInt = 1u
    ...
    requireNotNull(attributeData) { 
      "Adminfabricindex attribute not found in response" 
    }
  ...
  suspend fun subscribeAdminFabricIndexAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(AdminFabricIndexAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
      ...
      null
          ...
          decodedValue?.let {
            emit(AdminFabricIndexAttributeSubscriptionState.Success(it))
          }
...
suspend fun readAdminVendorIdAttribute(): AdminVendorIdAttribute {val ATTRIBUTE_ID: UInt = 2u
    ...
    requireNotNull(attributeData) { 
      "Adminvendorid attribute not found in response" 
    }
  ...
  suspend fun subscribeAdminVendorIdAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(AdminVendorIdAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
          ...
          requireNotNull(attributeData) { 
            "Adminvendorid attribute not found in Node State update" 
          }
      ...
      null
          ...
          decodedValue?.let {
            emit(AdminVendorIdAttributeSubscriptionState.Success(it))
          }
