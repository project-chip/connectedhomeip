...
class StatusAttribute(
    val value: JointFabricDatastoreClusterDatastoreStatusStruct
  )
...
suspend fun readStatusAttribute(): StatusAttribute {val ATTRIBUTE_ID: UInt = 8u
    ...
    // Decode the TLV data into the appropriate type
    val tlvReader = TlvReader(attributeData.data)
    val decodedValue: JointFabricDatastoreClusterDatastoreStatusStruct = JointFabricDatastoreClusterDatastoreStatusStruct.fromTlv(AnonymousTag, tlvReader)
...
suspend fun readNodeKeySetListAttribute(): NodeKeySetListAttribute {val ATTRIBUTE_ID: UInt = 11u
    ...
    // Decode the TLV data into the appropriate type
    val tlvReader = TlvReader(attributeData.data)
    val decodedValue: List<JointFabricDatastoreClusterDatastoreNodeKeySetEntry> = buildList<JointFabricDatastoreClusterDatastoreNodeKeySetEntry> {
      tlvReader.enterArray(AnonymousTag)
      while(!tlvReader.isEndOfContainer()) {
