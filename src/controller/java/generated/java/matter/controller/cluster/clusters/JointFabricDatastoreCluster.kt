...
class JointFabricDatastoreCluster(
  ...
  class StatusEntryAttribute(val value: JointFabricDatastoreClusterDatastoreStatusEntry)

  sealed class StatusEntryAttributeSubscriptionState {
    data class Success(val value: JointFabricDatastoreClusterDatastoreStatusEntry) :
  ...
  class EndpointGroupIdListAttribute(
    val value: List<JointFabricDatastoreClusterDatastoreEndpointGroupIDEntry>
  )

  sealed class EndpointGroupIdListAttributeSubscriptionState {
    data class Success(val value: List<JointFabricDatastoreClusterDatastoreEndpointGroupIDEntry>) :
  ...
  class EndpointBindingListAttribute(
    val value: List<JointFabricDatastoreClusterDatastoreEndpointBindingEntry>
  )

  sealed class EndpointBindingListAttributeSubscriptionState {
    data class Success(val value: List<JointFabricDatastoreClusterDatastoreEndpointBindingEntry>) :
  ...
  class NodeKeySetListAttribute(val value: List<JointFabricDatastoreClusterDatastoreNodeKeyEntry>)

  sealed class NodeKeySetListAttributeSubscriptionState {
    data class Success(val value: List<JointFabricDatastoreClusterDatastoreNodeKeyEntry>) :
  ...
  class NodeAclListAttribute(val value: List<JointFabricDatastoreClusterDatastoreACLEntry>)

  sealed class NodeAclListAttributeSubscriptionState {
    data class Success(val value: List<JointFabricDatastoreClusterDatastoreACLEntry>) :
  ...
  class NodeEndpointListAttribute(
    val value: List<JointFabricDatastoreClusterDatastoreEndpointEntry>
  )

  sealed class NodeEndpointListAttributeSubscriptionState {
    data class Success(val value: List<JointFabricDatastoreClusterDatastoreEndpointEntry>) :
  ...
  suspend fun addBindingToEndpointForNode(
    nodeID: ULong,
    endpointID: UShort,
    binding: JointFabricDatastoreClusterTargetStruct,
    timedInvokeTimeout: Duration? = null,
  ) {
  ...
  suspend fun addACLToNode(
    nodeID: ULong,
    ACLEntry: JointFabricDatastoreClusterAccessControlEntryStruct,
    timedInvokeTimeout: Duration? = null,
  ) {
  ...
  suspend fun readStatusEntryAttribute(): StatusEntryAttribute {
    ...
    // Decode the TLV data into the appropriate type
    val tlvReader = TlvReader(attributeData.data)
    val decodedValue: JointFabricDatastoreClusterDatastoreStatusEntry =
      JointFabricDatastoreClusterDatastoreStatusEntry.fromTlv(AnonymousTag, tlvReader)
  ...
  suspend fun readEndpointGroupIdListAttribute(): EndpointGroupIdListAttribute {
    ...
    // Decode the TLV data into the appropriate type
    val tlvReader = TlvReader(attributeData.data)
    val decodedValue: List<JointFabricDatastoreClusterDatastoreEndpointGroupIDEntry> =
      buildList<JointFabricDatastoreClusterDatastoreEndpointGroupIDEntry> {
        tlvReader.enterArray(AnonymousTag)
        while (!tlvReader.isEndOfContainer()) {
          add(
            JointFabricDatastoreClusterDatastoreEndpointGroupIDEntry.fromTlv(
              AnonymousTag,
              tlvReader,
            )
          )
  ...
  suspend fun readEndpointBindingListAttribute(): EndpointBindingListAttribute {
    ...
    // Decode the TLV data into the appropriate type
    val tlvReader = TlvReader(attributeData.data)
    val decodedValue: List<JointFabricDatastoreClusterDatastoreEndpointBindingEntry> =
      buildList<JointFabricDatastoreClusterDatastoreEndpointBindingEntry> {
        tlvReader.enterArray(AnonymousTag)
        while (!tlvReader.isEndOfContainer()) {
          add(
            JointFabricDatastoreClusterDatastoreEndpointBindingEntry.fromTlv(
              AnonymousTag,
              tlvReader,
            )
          )
  ...
  suspend fun readNodeKeySetListAttribute(): NodeKeySetListAttribute {
    ...
    // Decode the TLV data into the appropriate type
    val tlvReader = TlvReader(attributeData.data)
    val decodedValue: List<JointFabricDatastoreClusterDatastoreNodeKeyEntry> =
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          val decodedValue: List<JointFabricDatastoreClusterDatastoreNodeKeyEntry> =
            buildList<JointFabricDatastoreClusterDatastoreNodeKeyEntry> {
              ...
              while (!tlvReader.isEndOfContainer()) {
                add(
                  JointFabricDatastoreClusterDatastoreNodeKeyEntry.fromTlv(AnonymousTag, tlvReader)
                )
              }
              tlvReader.exitContainer()
            }
  ...
  suspend fun readNodeAclListAttribute(): NodeAclListAttribute {
    ...
    // Decode the TLV data into the appropriate type
    val tlvReader = TlvReader(attributeData.data)
    val decodedValue: List<JointFabricDatastoreClusterDatastoreACLEntry> =
  ...
  suspend fun readNodeEndpointListAttribute(): NodeEndpointListAttribute {
    ...
    // Decode the TLV data into the appropriate type
    val tlvReader = TlvReader(attributeData.data)
    val decodedValue: List<JointFabricDatastoreClusterDatastoreEndpointEntry> =
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          val decodedValue: List<JointFabricDatastoreClusterDatastoreEndpointEntry> =
            buildList<JointFabricDatastoreClusterDatastoreEndpointEntry> {
              ...
              while (!tlvReader.isEndOfContainer()) {
                add(
                  JointFabricDatastoreClusterDatastoreEndpointEntry.fromTlv(AnonymousTag, tlvReader)
                )
              }
              tlvReader.exitContainer()
            }
