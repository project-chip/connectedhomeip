...
class JointFabricDatastoreCluster(private val controller: MatterController, private val endpointId: UShort) {class GroupKeySetListAttribute(
...
class StatusAttribute(
    val value: JointFabricDatastoreClusterDatastoreStatusEntryStruct
  )
...
class NodeACLListAttribute(
    val value: List<JointFabricDatastoreClusterDatastoreACLEntryStruct>
  )
...
class AttributeListAttribute(
  ...
  suspend fun addKeySet(groupKeySet: JointFabricDatastoreClusterDatastoreGroupKeySetStruct
  ...
  suspend fun updateKeySet(groupKeySet: JointFabricDatastoreClusterDatastoreGroupKeySetStruct
      ,timedInvokeTimeout: Duration? = null) {
  ...
  suspend fun removeKeySet(groupKeySetID: UShort
      ,timedInvokeTimeout: Duration? = null) {
  ...
  suspend fun updateGroup(groupID: UShort
      ,friendlyName: String?
      ,groupKeySetID: UShort?
      ,groupCAT: UShort?
      ,groupCATVersion: UShort?
  ...
  suspend fun addAdmin(nodeID: ULong
      ,friendlyName: String
      ,vendorID: UShort
      ,icac: ByteArray
      ,timedInvokeTimeout: Duration? = null) {
  ...
  suspend fun updateAdmin(nodeID: ULong?
      ,friendlyName: String?
      ,icac: ByteArray?
      ,timedInvokeTimeout: Duration? = null) {
  ...
  suspend fun removeAdmin(nodeID: ULong
      ,timedInvokeTimeout: Duration? = null) {
  ...
  suspend fun addPendingNode(nodeID: ULong
      ,friendlyName: String
      ,timedInvokeTimeout: Duration? = null) {
  ...
  suspend fun refreshNode(nodeID: ULong
      ,timedInvokeTimeout: Duration? = null) {
  ...
  suspend fun updateNode(nodeID: ULong
      ,friendlyName: String
      ,timedInvokeTimeout: Duration? = null) {
  ...
  suspend fun removeNode(nodeID: ULong
      ,timedInvokeTimeout: Duration? = null) {
  ...
  suspend fun updateEndpointForNode(endpointID: UShort
      ,nodeID: ULong
      ,friendlyName: String
      ,timedInvokeTimeout: Duration? = null) {
  ...
  suspend fun addGroupIDToEndpointForNode(nodeID: ULong
      ,endpointID: UShort
      ,groupID: UShort
      ,timedInvokeTimeout: Duration? = null) {
  ...
  suspend fun removeGroupIDFromEndpointForNode(nodeID: ULong
      ,endpointID: UShort
      ,groupID: UShort
      ,timedInvokeTimeout: Duration? = null) {
  ...
  suspend fun addBindingToEndpointForNode(nodeID: ULong
      ,endpointID: UShort
  ...
  suspend fun removeBindingFromEndpointForNode(listID: UShort
      ,endpointID: UShort
      ,nodeID: ULong
      ,timedInvokeTimeout: Duration? = null) {
  ...
  suspend fun addACLToNode(nodeID: ULong
  ...
  suspend fun removeACLFromNode(listID: UShort
      ,nodeID: ULong
      ,timedInvokeTimeout: Duration? = null) {
...
suspend fun readAnchorRootCAAttribute(): ByteArray {val ATTRIBUTE_ID: UInt = 0u
    ...
    requireNotNull(attributeData) { 
      "Anchorrootca attribute not found in response" 
    }
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { 
            "Anchorrootca attribute not found in Node State update" 
          }
...
suspend fun readAnchorNodeIDAttribute(): ULong {val ATTRIBUTE_ID: UInt = 1u
    ...
    requireNotNull(attributeData) { 
      "Anchornodeid attribute not found in response" 
    }
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { 
            "Anchornodeid attribute not found in Node State update" 
          }
...
suspend fun readAnchorVendorIDAttribute(): UShort {val ATTRIBUTE_ID: UInt = 2u
    ...
    requireNotNull(attributeData) { 
      "Anchorvendorid attribute not found in response" 
    }
...
suspend fun readFriendlyNameAttribute(): String {val ATTRIBUTE_ID: UInt = 3u
    ...
    requireNotNull(attributeData) { 
      "Friendlyname attribute not found in response" 
    }
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { 
            "Friendlyname attribute not found in Node State update" 
          }
...
suspend fun readGroupKeySetListAttribute(): GroupKeySetListAttribute {val ATTRIBUTE_ID: UInt = 4u
    ...
    requireNotNull(attributeData) { 
      "Groupkeysetlist attribute not found in response" 
    }

    // Decode the TLV data into the appropriate type
    val tlvReader = TlvReader(attributeData.data)
    val decodedValue: List<JointFabricDatastoreClusterDatastoreGroupKeySetStruct> = buildList<JointFabricDatastoreClusterDatastoreGroupKeySetStruct> {
      tlvReader.enterArray(AnonymousTag)
      while(!tlvReader.isEndOfContainer()) {
        add(JointFabricDatastoreClusterDatastoreGroupKeySetStruct.fromTlv(AnonymousTag, tlvReader))
      }
  ...
  suspend fun subscribeGroupKeySetListAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(GroupKeySetListAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
...
suspend fun readGroupListAttribute(): GroupListAttribute {val ATTRIBUTE_ID: UInt = 5u
    ...
    requireNotNull(attributeData) { 
      "Grouplist attribute not found in response" 
    }

    // Decode the TLV data into the appropriate type
    val tlvReader = TlvReader(attributeData.data)
    val decodedValue: List<JointFabricDatastoreClusterDatastoreGroupInformationEntryStruct> = buildList<JointFabricDatastoreClusterDatastoreGroupInformationEntryStruct> {
      tlvReader.enterArray(AnonymousTag)
      while(!tlvReader.isEndOfContainer()) {
        add(JointFabricDatastoreClusterDatastoreGroupInformationEntryStruct.fromTlv(AnonymousTag, tlvReader))
      }
      tlvReader.exitContainer()
    }
  ...
  suspend fun subscribeGroupListAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(GroupListAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
          ...
          requireNotNull(attributeData) { 
            "Grouplist attribute not found in Node State update" 
          }
...
suspend fun readNodeListAttribute(): NodeListAttribute {val ATTRIBUTE_ID: UInt = 6u
    ...
    requireNotNull(attributeData) { 
      "Nodelist attribute not found in response" 
    }

    // Decode the TLV data into the appropriate type
    val tlvReader = TlvReader(attributeData.data)
    val decodedValue: List<JointFabricDatastoreClusterDatastoreNodeInformationEntryStruct> = buildList<JointFabricDatastoreClusterDatastoreNodeInformationEntryStruct> {
      tlvReader.enterArray(AnonymousTag)
      while(!tlvReader.isEndOfContainer()) {
        add(JointFabricDatastoreClusterDatastoreNodeInformationEntryStruct.fromTlv(AnonymousTag, tlvReader))
      }
      tlvReader.exitContainer()
    }
  ...
  suspend fun subscribeNodeListAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(NodeListAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
          ...
          requireNotNull(attributeData) { 
            "Nodelist attribute not found in Node State update" 
          }
...
suspend fun readAdminListAttribute(): AdminListAttribute {val ATTRIBUTE_ID: UInt = 7u
    ...
    requireNotNull(attributeData) { 
      "Adminlist attribute not found in response" 
    }

    // Decode the TLV data into the appropriate type
    val tlvReader = TlvReader(attributeData.data)
    val decodedValue: List<JointFabricDatastoreClusterDatastoreAdministratorInformationEntryStruct> = buildList<JointFabricDatastoreClusterDatastoreAdministratorInformationEntryStruct> {
      tlvReader.enterArray(AnonymousTag)
      while(!tlvReader.isEndOfContainer()) {
        add(JointFabricDatastoreClusterDatastoreAdministratorInformationEntryStruct.fromTlv(AnonymousTag, tlvReader))
      }
      tlvReader.exitContainer()
    }
  ...
  suspend fun subscribeAdminListAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(AdminListAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
          ...
          requireNotNull(attributeData) { 
            "Adminlist attribute not found in Node State update" 
          }
...
suspend fun readStatusAttribute(): StatusAttribute {val ATTRIBUTE_ID: UInt = 8u
    ...
    // Decode the TLV data into the appropriate type
    val tlvReader = TlvReader(attributeData.data)
    val decodedValue: JointFabricDatastoreClusterDatastoreStatusEntryStruct = JointFabricDatastoreClusterDatastoreStatusEntryStruct.fromTlv(AnonymousTag, tlvReader)
  ...
  suspend fun subscribeStatusAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(StatusAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
...
suspend fun readEndpointGroupIDListAttribute(): EndpointGroupIDListAttribute {val ATTRIBUTE_ID: UInt = 9u
    ...
    requireNotNull(attributeData) { 
      "Endpointgroupidlist attribute not found in response" 
    }

    // Decode the TLV data into the appropriate type
    val tlvReader = TlvReader(attributeData.data)
    val decodedValue: List<JointFabricDatastoreClusterDatastoreEndpointGroupIDEntryStruct> = buildList<JointFabricDatastoreClusterDatastoreEndpointGroupIDEntryStruct> {
      tlvReader.enterArray(AnonymousTag)
      while(!tlvReader.isEndOfContainer()) {
        add(JointFabricDatastoreClusterDatastoreEndpointGroupIDEntryStruct.fromTlv(AnonymousTag, tlvReader))
      }
      tlvReader.exitContainer()
    }
  ...
  suspend fun subscribeEndpointGroupIDListAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(EndpointGroupIDListAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
...
suspend fun readEndpointBindingListAttribute(): EndpointBindingListAttribute {val ATTRIBUTE_ID: UInt = 10u
    ...
    requireNotNull(attributeData) { 
      "Endpointbindinglist attribute not found in response" 
    }

    // Decode the TLV data into the appropriate type
    val tlvReader = TlvReader(attributeData.data)
    val decodedValue: List<JointFabricDatastoreClusterDatastoreEndpointBindingEntryStruct> = buildList<JointFabricDatastoreClusterDatastoreEndpointBindingEntryStruct> {
      tlvReader.enterArray(AnonymousTag)
      while(!tlvReader.isEndOfContainer()) {
        add(JointFabricDatastoreClusterDatastoreEndpointBindingEntryStruct.fromTlv(AnonymousTag, tlvReader))
      }
      tlvReader.exitContainer()
    }
  ...
  suspend fun subscribeEndpointBindingListAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(EndpointBindingListAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
...
suspend fun readNodeKeySetListAttribute(): NodeKeySetListAttribute {val ATTRIBUTE_ID: UInt = 11u
    ...
    requireNotNull(attributeData) { 
      "Nodekeysetlist attribute not found in response" 
    }

    // Decode the TLV data into the appropriate type
    val tlvReader = TlvReader(attributeData.data)
    val decodedValue: List<JointFabricDatastoreClusterDatastoreNodeKeySetEntryStruct> = buildList<JointFabricDatastoreClusterDatastoreNodeKeySetEntryStruct> {
      tlvReader.enterArray(AnonymousTag)
      while(!tlvReader.isEndOfContainer()) {
        add(JointFabricDatastoreClusterDatastoreNodeKeySetEntryStruct.fromTlv(AnonymousTag, tlvReader))
      }
      tlvReader.exitContainer()
    }
  ...
  suspend fun subscribeNodeKeySetListAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(NodeKeySetListAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
...
suspend fun readNodeACLListAttribute(): NodeACLListAttribute {val ATTRIBUTE_ID: UInt = 12u
    ...
    requireNotNull(attributeData) { 
      "Nodeacllist attribute not found in response" 
    }

    // Decode the TLV data into the appropriate type
    val tlvReader = TlvReader(attributeData.data)
    val decodedValue: List<JointFabricDatastoreClusterDatastoreACLEntryStruct> = buildList<JointFabricDatastoreClusterDatastoreACLEntryStruct> {
      tlvReader.enterArray(AnonymousTag)
      while(!tlvReader.isEndOfContainer()) {
  ...
  suspend fun subscribeNodeACLListAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(NodeACLListAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
          ...
          requireNotNull(attributeData) { 
            "Nodeacllist attribute not found in Node State update" 
          }
...
suspend fun readNodeEndpointListAttribute(): NodeEndpointListAttribute {val ATTRIBUTE_ID: UInt = 13u
    ...
    requireNotNull(attributeData) { 
      "Nodeendpointlist attribute not found in response" 
    }

    // Decode the TLV data into the appropriate type
    val tlvReader = TlvReader(attributeData.data)
    val decodedValue: List<JointFabricDatastoreClusterDatastoreEndpointEntryStruct> = buildList<JointFabricDatastoreClusterDatastoreEndpointEntryStruct> {
      tlvReader.enterArray(AnonymousTag)
      while(!tlvReader.isEndOfContainer()) {
        add(JointFabricDatastoreClusterDatastoreEndpointEntryStruct.fromTlv(AnonymousTag, tlvReader))
      }
      tlvReader.exitContainer()
    }
  ...
  suspend fun subscribeNodeEndpointListAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(NodeEndpointListAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
