...
class LastNetworkingStatusAttribute(
  ...
  sealed class LastNetworkingStatusAttributeSubscriptionState {
    data class Success(
    val value: UByte?
    ) : LastNetworkingStatusAttributeSubscriptionState()
...
class LastNetworkIDAttribute(
  ...
  sealed class LastNetworkIDAttributeSubscriptionState {
    data class Success(
    val value: ByteArray?
    ) : LastNetworkIDAttributeSubscriptionState()
...
class LastConnectErrorValueAttribute(
  ...
  sealed class LastConnectErrorValueAttributeSubscriptionState {
    data class Success(
    val value: Int?
    ) : LastConnectErrorValueAttributeSubscriptionState()
...
class SupportedWiFiBandsAttribute(
  ...
  sealed class SupportedWiFiBandsAttributeSubscriptionState {
    data class Success(
    val value: List<UByte>?
    ) : SupportedWiFiBandsAttributeSubscriptionState()
...
class AttributeListAttribute(
  ...
  suspend fun scanNetworks(ssid: ByteArray?
      ,breadcrumb: ULong?
      ,timedInvokeTimeout: Duration? = null): ScanNetworksResponse {
    ...
    var wiFiScanResults_decoded: List<NetworkCommissioningClusterWiFiInterfaceScanResultStruct>? = null
    
    val TAG_THREAD_SCAN_RESULTS: Int = 3
    var threadScanResults_decoded: List<NetworkCommissioningClusterThreadInterfaceScanResultStruct>? = null
    ...
    while (!tlvReader.isEndOfContainer()) {
      ...
      if (tag == ContextSpecificTag(TAG_NETWORKING_STATUS)) {networkingStatus_decoded = tlvReader.getUByte(tag)} else
      
      if (tag == ContextSpecificTag(TAG_DEBUG_TEXT)) {debugText_decoded = 
          if (tlvReader.isNull()) {
      ...
      if (tag == ContextSpecificTag(TAG_WI_FI_SCAN_RESULTS)) {wiFiScanResults_decoded = 
          if (tlvReader.isNull()) {
            tlvReader.getNull(tag)
            null
          } else {
      ...
      while(!tlvReader.isEndOfContainer()) {
        add(NetworkCommissioningClusterWiFiInterfaceScanResultStruct.fromTlv(AnonymousTag, tlvReader))
      }
      ...
      if (tag == ContextSpecificTag(TAG_THREAD_SCAN_RESULTS)) {threadScanResults_decoded = 
          if (tlvReader.isNull()) {
            tlvReader.getNull(tag)
            null
          } else {
      ...
      tlvReader.enterArray(tag)
      while(!tlvReader.isEndOfContainer()) {
        add(NetworkCommissioningClusterThreadInterfaceScanResultStruct.fromTlv(AnonymousTag, tlvReader))
      }
      tlvReader.exitContainer()
    }
    } else {
  ...
  suspend fun addOrUpdateWiFiNetwork(ssid: ByteArray
      ,credentials: ByteArray
      ,breadcrumb: ULong?
      ,networkIdentity: ByteArray?
      ,clientIdentifier: ByteArray?
      ,possessionNonce: ByteArray?
      ,timedInvokeTimeout: Duration? = null): NetworkConfigResponse {
    ...
    while (!tlvReader.isEndOfContainer()) {
      ...
      if (tag == ContextSpecificTag(TAG_NETWORK_INDEX)) {networkIndex_decoded = 
          if (tlvReader.isNull()) {
            tlvReader.getNull(tag)
            null
          } else {
      ...
      if (tag == ContextSpecificTag(TAG_CLIENT_IDENTITY)) {clientIdentity_decoded = 
          if (tlvReader.isNull()) {
            tlvReader.getNull(tag)
            null
          } else {
      ...
      if (tag == ContextSpecificTag(TAG_POSSESSION_SIGNATURE)) {possessionSignature_decoded = 
          if (tlvReader.isNull()) {
            tlvReader.getNull(tag)
            null
          } else {
  ...
  suspend fun addOrUpdateThreadNetwork(operationalDataset: ByteArray
      ,breadcrumb: ULong?
      ,timedInvokeTimeout: Duration? = null): NetworkConfigResponse {
  ...
  suspend fun removeNetwork(networkID: ByteArray
      ,breadcrumb: ULong?
      ,timedInvokeTimeout: Duration? = null): NetworkConfigResponse {
  ...
  suspend fun connectNetwork(networkID: ByteArray
      ,breadcrumb: ULong?
      ,timedInvokeTimeout: Duration? = null): ConnectNetworkResponse {
    ...
    while (!tlvReader.isEndOfContainer()) {
      ...
      if (tag == ContextSpecificTag(TAG_ERROR_VALUE)) {errorValue_decoded = 
          if (tlvReader.isNull()) {
            tlvReader.getNull(tag)
            null
          } else {
  ...
  suspend fun reorderNetwork(networkID: ByteArray
      ,networkIndex: UByte
      ,breadcrumb: ULong?
      ,timedInvokeTimeout: Duration? = null): NetworkConfigResponse {
  ...
  suspend fun queryIdentity(keyIdentifier: ByteArray
      ,possessionNonce: ByteArray?
      ,timedInvokeTimeout: Duration? = null): QueryIdentityResponse {
    ...
    while (!tlvReader.isEndOfContainer()) {
      ...
      if (tag == ContextSpecificTag(TAG_IDENTITY)) {identity_decoded = tlvReader.getByteArray(tag)} else
...
suspend fun readMaxNetworksAttribute(): UByte {val ATTRIBUTE_ID: UInt = 0u
    ...
    requireNotNull(attributeData) { 
      "Maxnetworks attribute not found in response" 
    }
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { 
            "Maxnetworks attribute not found in Node State update" 
          }
...
suspend fun readNetworksAttribute(): NetworksAttribute {val ATTRIBUTE_ID: UInt = 1u
    ...
    requireNotNull(attributeData) { 
      "Networks attribute not found in response" 
    }

    // Decode the TLV data into the appropriate type
    val tlvReader = TlvReader(attributeData.data)
    val decodedValue: List<NetworkCommissioningClusterNetworkInfoStruct> = buildList<NetworkCommissioningClusterNetworkInfoStruct> {
  ...
  suspend fun subscribeNetworksAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(NetworksAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
          ...
          requireNotNull(attributeData) { 
            "Networks attribute not found in Node State update" 
          }
...
suspend fun readScanMaxTimeSecondsAttribute(): UByte? {val ATTRIBUTE_ID: UInt = 2u
    ...
    requireNotNull(attributeData) { 
      "Scanmaxtimeseconds attribute not found in response" 
    }
...
suspend fun readConnectMaxTimeSecondsAttribute(): UByte? {val ATTRIBUTE_ID: UInt = 3u
    ...
    requireNotNull(attributeData) { 
      "Connectmaxtimeseconds attribute not found in response" 
    }
...
suspend fun readInterfaceEnabledAttribute(): Boolean {val ATTRIBUTE_ID: UInt = 4u
    ...
    requireNotNull(attributeData) { 
      "Interfaceenabled attribute not found in response" 
    }
...
suspend fun readLastNetworkingStatusAttribute(): LastNetworkingStatusAttribute {val ATTRIBUTE_ID: UInt = 5u
    ...
    requireNotNull(attributeData) { 
      "Lastnetworkingstatus attribute not found in response" 
    }
  ...
  suspend fun subscribeLastNetworkingStatusAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(LastNetworkingStatusAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
      ...
      null
          ...
          decodedValue?.let {
            emit(LastNetworkingStatusAttributeSubscriptionState.Success(it))
          }
...
suspend fun readLastNetworkIDAttribute(): LastNetworkIDAttribute {val ATTRIBUTE_ID: UInt = 6u
    ...
    requireNotNull(attributeData) { 
      "Lastnetworkid attribute not found in response" 
    }
  ...
  suspend fun subscribeLastNetworkIDAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(LastNetworkIDAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
          ...
          requireNotNull(attributeData) { 
            "Lastnetworkid attribute not found in Node State update" 
          }
      ...
      null
          ...
          decodedValue?.let {
            emit(LastNetworkIDAttributeSubscriptionState.Success(it))
          }
...
suspend fun readLastConnectErrorValueAttribute(): LastConnectErrorValueAttribute {val ATTRIBUTE_ID: UInt = 7u
    ...
    requireNotNull(attributeData) { 
      "Lastconnecterrorvalue attribute not found in response" 
    }

    // Decode the TLV data into the appropriate type
    val tlvReader = TlvReader(attributeData.data)
    val decodedValue: Int? = if (!tlvReader.isNull()) {
  ...
  suspend fun subscribeLastConnectErrorValueAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(LastConnectErrorValueAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
      ...
      null
          ...
          decodedValue?.let {
            emit(LastConnectErrorValueAttributeSubscriptionState.Success(it))
          }
...
suspend fun readSupportedWiFiBandsAttribute(): SupportedWiFiBandsAttribute {val ATTRIBUTE_ID: UInt = 8u
    ...
    requireNotNull(attributeData) { 
      "Supportedwifibands attribute not found in response" 
    }

    // Decode the TLV data into the appropriate type
    val tlvReader = TlvReader(attributeData.data)
    val decodedValue: List<UByte>? = if (tlvReader.isNextTag(AnonymousTag)) {
      buildList<UByte> {
      tlvReader.enterArray(AnonymousTag)
      while(!tlvReader.isEndOfContainer()) {
  ...
  suspend fun subscribeSupportedWiFiBandsAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(SupportedWiFiBandsAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
      ...
      null
          ...
          decodedValue?.let {
            emit(SupportedWiFiBandsAttributeSubscriptionState.Success(it))
          }
...
suspend fun readSupportedThreadFeaturesAttribute(): UShort? {val ATTRIBUTE_ID: UInt = 9u
    ...
    requireNotNull(attributeData) { 
      "Supportedthreadfeatures attribute not found in response" 
    }
...
suspend fun readThreadVersionAttribute(): UShort? {val ATTRIBUTE_ID: UInt = 10u
    ...
    requireNotNull(attributeData) { 
      "Threadversion attribute not found in response" 
    }
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { 
            "Threadversion attribute not found in Node State update" 
          }
