...
class AttributeListAttribute(
  ...
  suspend fun scanNetworks(ssid: ByteArray?
    ...
    while (!tlvReader.isEndOfContainer()) {
      ...
      if (tag == ContextSpecificTag(TAG_NETWORKING_STATUS)) {networkingStatus_decoded = tlvReader.getUByte(tag)}  
  ...
  suspend fun queryIdentity(keyIdentifier: ByteArray
    ...
    while (!tlvReader.isEndOfContainer()) {
      ...
      if (tag == ContextSpecificTag(TAG_IDENTITY)) {identity_decoded = tlvReader.getByteArray(tag)}  
