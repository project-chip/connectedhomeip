...
class GeneralCommissioningCluster(
  ...
  class TCAcceptedVersionAttribute(val value: UShort?)

  sealed class TCAcceptedVersionAttributeSubscriptionState {
    data class Success(val value: UShort?) : TCAcceptedVersionAttributeSubscriptionState()

    data class Error(val exception: Exception) : TCAcceptedVersionAttributeSubscriptionState()

    object SubscriptionEstablished : TCAcceptedVersionAttributeSubscriptionState()
  }

  class TCMinRequiredVersionAttribute(val value: UShort?)

  sealed class TCMinRequiredVersionAttributeSubscriptionState {
    data class Success(val value: UShort?) : TCMinRequiredVersionAttributeSubscriptionState()

    data class Error(val exception: Exception) : TCMinRequiredVersionAttributeSubscriptionState()

    object SubscriptionEstablished : TCMinRequiredVersionAttributeSubscriptionState()
  }

  class TCAcknowledgementsRequiredAttribute(val value: Boolean?)

  sealed class TCAcknowledgementsRequiredAttributeSubscriptionState {
    data class Success(val value: Boolean?) :
      TCAcknowledgementsRequiredAttributeSubscriptionState()

    data class Error(val exception: Exception) :
      TCAcknowledgementsRequiredAttributeSubscriptionState()

    object SubscriptionEstablished : TCAcknowledgementsRequiredAttributeSubscriptionState()
  }
  ...
  suspend fun readTCAcceptedVersionAttribute(): TCAcceptedVersionAttribute {
    ...
    return TCAcceptedVersionAttribute(decodedValue)
  }

  suspend fun subscribeTCAcceptedVersionAttribute(
    minInterval: Int,
    maxInterval: Int,
  ): Flow<TCAcceptedVersionAttributeSubscriptionState> {
    val ATTRIBUTE_ID: UInt = 5u
    val attributePaths =
      listOf(
        AttributePath(endpointId = endpointId, clusterId = CLUSTER_ID, attributeId = ATTRIBUTE_ID)
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(
            TCAcceptedVersionAttributeSubscriptionState.Error(
              Exception(
                "Subscription terminated with error code: ${subscriptionState.terminationCause}"
              )
            )
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          decodedValue?.let { emit(TCAcceptedVersionAttributeSubscriptionState.Success(it)) }
        }
        SubscriptionState.SubscriptionEstablished -> {
          emit(TCAcceptedVersionAttributeSubscriptionState.SubscriptionEstablished)
        }
      }
    }
  }

  suspend fun readTCMinRequiredVersionAttribute(): TCMinRequiredVersionAttribute {
    ...
    return TCMinRequiredVersionAttribute(decodedValue)
  }

  suspend fun subscribeTCMinRequiredVersionAttribute(
    minInterval: Int,
    maxInterval: Int,
  ): Flow<TCMinRequiredVersionAttributeSubscriptionState> {
    val ATTRIBUTE_ID: UInt = 6u
    val attributePaths =
      listOf(
        AttributePath(endpointId = endpointId, clusterId = CLUSTER_ID, attributeId = ATTRIBUTE_ID)
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(
            TCMinRequiredVersionAttributeSubscriptionState.Error(
              Exception(
                "Subscription terminated with error code: ${subscriptionState.terminationCause}"
              )
            )
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          decodedValue?.let { emit(TCMinRequiredVersionAttributeSubscriptionState.Success(it)) }
        }
        SubscriptionState.SubscriptionEstablished -> {
          emit(TCMinRequiredVersionAttributeSubscriptionState.SubscriptionEstablished)
        }
      }
    }
  }
  ...
  suspend fun readTCAcknowledgementsRequiredAttribute(): TCAcknowledgementsRequiredAttribute {
    ...
    return TCAcknowledgementsRequiredAttribute(decodedValue)
  }

  suspend fun subscribeTCAcknowledgementsRequiredAttribute(
    minInterval: Int,
    maxInterval: Int,
  ): Flow<TCAcknowledgementsRequiredAttributeSubscriptionState> {
    val ATTRIBUTE_ID: UInt = 8u
    val attributePaths =
      listOf(
        AttributePath(endpointId = endpointId, clusterId = CLUSTER_ID, attributeId = ATTRIBUTE_ID)
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(
            TCAcknowledgementsRequiredAttributeSubscriptionState.Error(
              Exception(
                "Subscription terminated with error code: ${subscriptionState.terminationCause}"
              )
            )
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          decodedValue?.let {
            emit(TCAcknowledgementsRequiredAttributeSubscriptionState.Success(it))
          }
        }
        SubscriptionState.SubscriptionEstablished -> {
          emit(TCAcknowledgementsRequiredAttributeSubscriptionState.SubscriptionEstablished)
        }
      }
    }
  }
