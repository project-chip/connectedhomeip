...
class ApplicationBasicCluster(private val controller: MatterController, private val endpointId: UShort) {class ApplicationAttribute(
...
class AllowedVendorListAttribute(
  ...
  sealed class AllowedVendorListAttributeSubscriptionState {
    data class Success(
    val value: List<UShort>
    ) : AllowedVendorListAttributeSubscriptionState()
...
suspend fun readVendorNameAttribute(): String? {val ATTRIBUTE_ID: UInt = 0u
...
suspend fun readVendorIDAttribute(): UShort? {val ATTRIBUTE_ID: UInt = 1u
...
suspend fun readApplicationNameAttribute(): String {val ATTRIBUTE_ID: UInt = 2u
    ...
    requireNotNull(attributeData) { 
      "Applicationname attribute not found in response" 
    }
...
suspend fun readProductIDAttribute(): UShort? {val ATTRIBUTE_ID: UInt = 3u
...
suspend fun readApplicationAttribute(): ApplicationAttribute {val ATTRIBUTE_ID: UInt = 4u
    ...
    requireNotNull(attributeData) { 
      "Application attribute not found in response" 
    }

    // Decode the TLV data into the appropriate type
    val tlvReader = TlvReader(attributeData.data)
    val decodedValue: ApplicationBasicClusterApplicationStruct = ApplicationBasicClusterApplicationStruct.fromTlv(AnonymousTag, tlvReader)
  ...
  suspend fun subscribeApplicationAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(ApplicationAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
          ...
          requireNotNull(attributeData) { 
            "Application attribute not found in Node State update" 
          }
...
suspend fun readStatusAttribute(): UByte {val ATTRIBUTE_ID: UInt = 5u
...
suspend fun readApplicationVersionAttribute(): String {val ATTRIBUTE_ID: UInt = 6u
    ...
    requireNotNull(attributeData) { 
      "Applicationversion attribute not found in response" 
    }
...
suspend fun readAllowedVendorListAttribute(): AllowedVendorListAttribute {val ATTRIBUTE_ID: UInt = 7u
    ...
    requireNotNull(attributeData) { 
      "Allowedvendorlist attribute not found in response" 
    }
  ...
  suspend fun subscribeAllowedVendorListAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(AllowedVendorListAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
