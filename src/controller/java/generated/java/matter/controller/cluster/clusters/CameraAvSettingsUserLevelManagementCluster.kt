...
class CameraAvSettingsUserLevelManagementCluster(
  ...
  suspend fun readMovementStateAttribute(): UByte? {
    ...
    requireNotNull(attributeData) { "Movementstate attribute not found in response" }
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { "Movementstate attribute not found in Node State update" }
