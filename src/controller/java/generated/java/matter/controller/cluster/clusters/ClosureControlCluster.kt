...
class ClosureControlCluster(private val controller: MatterController, private val endpointId: UShort) {class CountdownTimeAttribute(
    val value: UInt?
  )
  ...
  sealed class CountdownTimeAttributeSubscriptionState {
    data class Success(
    val value: UInt?
    ) : CountdownTimeAttributeSubscriptionState()
...
class CurrentErrorListAttribute(
  ...
  sealed class CurrentErrorListAttributeSubscriptionState {
    data class Success(
    val value: List<UByte>
    ) : CurrentErrorListAttributeSubscriptionState()
...
class OverallStateAttribute(
    val value: ClosureControlClusterOverallStateStruct?
  )

  sealed class OverallStateAttributeSubscriptionState {
    data class Success(
    val value: ClosureControlClusterOverallStateStruct?
    ) : OverallStateAttributeSubscriptionState()
    
    data class Error(val exception: Exception) : OverallStateAttributeSubscriptionState()

    object SubscriptionEstablished : OverallStateAttributeSubscriptionState()    
  }  
class OverallTargetAttribute(
    val value: ClosureControlClusterOverallTargetStruct?
  )

  sealed class OverallTargetAttributeSubscriptionState {
    data class Success(
    val value: ClosureControlClusterOverallTargetStruct?
    ) : OverallTargetAttributeSubscriptionState()
    
    data class Error(val exception: Exception) : OverallTargetAttributeSubscriptionState()

    object SubscriptionEstablished : OverallTargetAttributeSubscriptionState()    
  }  
...
class AttributeListAttribute(
  ...
  suspend fun moveTo(position: UByte?
      ,latch: Boolean?
      ,speed: UByte?
    ...
    latch?.let {
      tlvWriter.put(ContextSpecificTag(TAG_LATCH_REQ), latch)
    }

    val TAG_SPEED_REQ: Int = 2
    speed?.let {
      tlvWriter.put(ContextSpecificTag(TAG_SPEED_REQ), speed)
    }    
    tlvWriter.endStructure()
...
suspend fun readCountdownTimeAttribute(): CountdownTimeAttribute {val ATTRIBUTE_ID: UInt = 0u
    ...
    requireNotNull(attributeData) { 
      "Countdowntime attribute not found in response" 
    }
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(CountdownTimeAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { 
            "Countdowntime attribute not found in Node State update" 
          }
      ...
      null
          ...
          decodedValue?.let {
            emit(CountdownTimeAttributeSubscriptionState.Success(it))
          }
...
suspend fun readMainStateAttribute(): UByte {val ATTRIBUTE_ID: UInt = 1u
    ...
    requireNotNull(attributeData) { 
      "Mainstate attribute not found in response" 
    }
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { 
            "Mainstate attribute not found in Node State update" 
          }
...
suspend fun readCurrentErrorListAttribute(): CurrentErrorListAttribute {val ATTRIBUTE_ID: UInt = 2u
    ...
    requireNotNull(attributeData) { 
      "Currenterrorlist attribute not found in response" 
    }
  ...
  suspend fun subscribeCurrentErrorListAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(CurrentErrorListAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
...
suspend fun readOverallStateAttribute(): OverallStateAttribute {val ATTRIBUTE_ID: UInt = 3u
    ...
    requireNotNull(attributeData) { 
      "Overallstate attribute not found in response" 
    }

    // Decode the TLV data into the appropriate type
    val tlvReader = TlvReader(attributeData.data)
    val decodedValue: ClosureControlClusterOverallStateStruct? = if (!tlvReader.isNull()) {
      ClosureControlClusterOverallStateStruct.fromTlv(AnonymousTag, tlvReader)
    } else {
      tlvReader.getNull(AnonymousTag)
      null
    }
    ...
    return OverallStateAttribute(decodedValue)
  }

  suspend fun subscribeOverallStateAttribute(
    minInterval: Int,
    maxInterval: Int
  ): Flow<OverallStateAttributeSubscriptionState> {
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(OverallStateAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
          ...
          requireNotNull(attributeData) { 
            "Overallstate attribute not found in Node State update" 
          }
      ...
      null
          ...
          decodedValue?.let {
            emit(OverallStateAttributeSubscriptionState.Success(it))
          }
          
        }
        SubscriptionState.SubscriptionEstablished -> {
          emit(OverallStateAttributeSubscriptionState.SubscriptionEstablished)
        }
      }
    }    
  }
suspend fun readOverallTargetAttribute(): OverallTargetAttribute {val ATTRIBUTE_ID: UInt = 4u
    ...
    requireNotNull(attributeData) { 
      "Overalltarget attribute not found in response" 
    }

    // Decode the TLV data into the appropriate type
    val tlvReader = TlvReader(attributeData.data)
    val decodedValue: ClosureControlClusterOverallTargetStruct? = if (!tlvReader.isNull()) {
      ClosureControlClusterOverallTargetStruct.fromTlv(AnonymousTag, tlvReader)
    } else {
      tlvReader.getNull(AnonymousTag)
      null
    }
    ...
    return OverallTargetAttribute(decodedValue)
  }

  suspend fun subscribeOverallTargetAttribute(
    minInterval: Int,
    maxInterval: Int
  ): Flow<OverallTargetAttributeSubscriptionState> {
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(OverallTargetAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
          ...
          requireNotNull(attributeData) { 
            "Overalltarget attribute not found in Node State update" 
          }
      ...
      null
          ...
          decodedValue?.let {
            emit(OverallTargetAttributeSubscriptionState.Success(it))
          }
          
        }
        SubscriptionState.SubscriptionEstablished -> {
          emit(OverallTargetAttributeSubscriptionState.SubscriptionEstablished)
        }
      }
    }    
  }
