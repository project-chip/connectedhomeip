...
class RefrigeratorAndTemperatureControlledCabinetModeCluster(
  ...
  suspend fun readSupportedModesAttribute(): SupportedModesAttribute {
    ...
    val decodedValue: List<RefrigeratorAndTemperatureControlledCabinetModeClusterModeOptionStruct> =
      buildList<RefrigeratorAndTemperatureControlledCabinetModeClusterModeOptionStruct> {
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          val tlvReader = TlvReader(attributeData.data)
          val decodedValue:
            List<RefrigeratorAndTemperatureControlledCabinetModeClusterModeOptionStruct> =
            buildList<RefrigeratorAndTemperatureControlledCabinetModeClusterModeOptionStruct> {
              tlvReader.enterArray(AnonymousTag)
              while (!tlvReader.isEndOfContainer()) {
                add(
  ...
  companion object {
    private val logger =
      Logger.getLogger(RefrigeratorAndTemperatureControlledCabinetModeCluster::class.java.name)
