...
class ElectricalPowerMeasurementCluster(private val controller: MatterController, private val endpointId: UShort) {class AccuracyAttribute(
...
class RangesAttribute(
    val value: List<ElectricalPowerMeasurementClusterMeasurementRangeStruct>?
  )
...
class VoltageAttribute(
  ...
  sealed class VoltageAttributeSubscriptionState {
    data class Success(
    val value: Long?
    ) : VoltageAttributeSubscriptionState()
...
class ActiveCurrentAttribute(
  ...
  sealed class ActiveCurrentAttributeSubscriptionState {
    data class Success(
    val value: Long?
    ) : ActiveCurrentAttributeSubscriptionState()
...
class ReactiveCurrentAttribute(
    val value: Long?
  )
  ...
  sealed class ReactiveCurrentAttributeSubscriptionState {
    data class Success(
    val value: Long?
    ) : ReactiveCurrentAttributeSubscriptionState()
...
class ApparentCurrentAttribute(
    val value: Long?
  )
  ...
  sealed class ApparentCurrentAttributeSubscriptionState {
    data class Success(
    val value: Long?
    ) : ApparentCurrentAttributeSubscriptionState()
...
class ActivePowerAttribute(
  ...
  sealed class ActivePowerAttributeSubscriptionState {
    data class Success(
    val value: Long?
    ) : ActivePowerAttributeSubscriptionState()
...
class ReactivePowerAttribute(
  ...
  sealed class ReactivePowerAttributeSubscriptionState {
    data class Success(
    val value: Long?
    ) : ReactivePowerAttributeSubscriptionState()
...
class ApparentPowerAttribute(
  ...
  sealed class ApparentPowerAttributeSubscriptionState {
    data class Success(
    val value: Long?
    ) : ApparentPowerAttributeSubscriptionState()
...
class RMSVoltageAttribute(
  ...
  sealed class RMSVoltageAttributeSubscriptionState {
    data class Success(
    val value: Long?
    ) : RMSVoltageAttributeSubscriptionState()
...
class RMSCurrentAttribute(
  ...
  sealed class RMSCurrentAttributeSubscriptionState {
    data class Success(
    val value: Long?
    ) : RMSCurrentAttributeSubscriptionState()
...
class RMSPowerAttribute(
  ...
  sealed class RMSPowerAttributeSubscriptionState {
    data class Success(
    val value: Long?
    ) : RMSPowerAttributeSubscriptionState()
...
class FrequencyAttribute(
  ...
  sealed class FrequencyAttributeSubscriptionState {
    data class Success(
    val value: Long?
    ) : FrequencyAttributeSubscriptionState()
...
class PowerFactorAttribute(
  ...
  sealed class PowerFactorAttributeSubscriptionState {
    data class Success(
    val value: Long?
    ) : PowerFactorAttributeSubscriptionState()
...
class NeutralCurrentAttribute(
  ...
  sealed class NeutralCurrentAttributeSubscriptionState {
    data class Success(
    val value: Long?
    ) : NeutralCurrentAttributeSubscriptionState()
...
suspend fun readPowerModeAttribute(): UByte {val ATTRIBUTE_ID: UInt = 0u
    ...
    requireNotNull(attributeData) { 
      "Powermode attribute not found in response" 
    }
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { 
            "Powermode attribute not found in Node State update" 
          }
...
suspend fun readNumberOfMeasurementTypesAttribute(): UByte {val ATTRIBUTE_ID: UInt = 1u
    ...
    requireNotNull(attributeData) { 
      "Numberofmeasurementtypes attribute not found in response" 
    }
...
suspend fun readAccuracyAttribute(): AccuracyAttribute {val ATTRIBUTE_ID: UInt = 2u
    ...
    // Decode the TLV data into the appropriate type
    val tlvReader = TlvReader(attributeData.data)
    val decodedValue: List<ElectricalPowerMeasurementClusterMeasurementAccuracyStruct> = buildList<ElectricalPowerMeasurementClusterMeasurementAccuracyStruct> {
      tlvReader.enterArray(AnonymousTag)
      while(!tlvReader.isEndOfContainer()) {
        add(ElectricalPowerMeasurementClusterMeasurementAccuracyStruct.fromTlv(AnonymousTag, tlvReader))
      }
...
suspend fun readRangesAttribute(): RangesAttribute {val ATTRIBUTE_ID: UInt = 3u
    ...
    requireNotNull(attributeData) { 
      "Ranges attribute not found in response" 
    }

    // Decode the TLV data into the appropriate type
    val tlvReader = TlvReader(attributeData.data)
    val decodedValue: List<ElectricalPowerMeasurementClusterMeasurementRangeStruct>? = if (tlvReader.isNextTag(AnonymousTag)) {
      buildList<ElectricalPowerMeasurementClusterMeasurementRangeStruct> {
      tlvReader.enterArray(AnonymousTag)
      while(!tlvReader.isEndOfContainer()) {
        add(ElectricalPowerMeasurementClusterMeasurementRangeStruct.fromTlv(AnonymousTag, tlvReader))
      }
      tlvReader.exitContainer()
    }
    } else {
  ...
  suspend fun subscribeRangesAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(RangesAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
          ...
          requireNotNull(attributeData) { 
            "Ranges attribute not found in Node State update" 
          }
      ...
      null
          ...
          decodedValue?.let {
            emit(RangesAttributeSubscriptionState.Success(it))
          }
...
suspend fun readVoltageAttribute(): VoltageAttribute {val ATTRIBUTE_ID: UInt = 4u
    ...
    requireNotNull(attributeData) { 
      "Voltage attribute not found in response" 
    }
  ...
  suspend fun subscribeVoltageAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(VoltageAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
          ...
          requireNotNull(attributeData) { 
            "Voltage attribute not found in Node State update" 
          }
      ...
      null
          ...
          decodedValue?.let {
            emit(VoltageAttributeSubscriptionState.Success(it))
          }
...
suspend fun readActiveCurrentAttribute(): ActiveCurrentAttribute {val ATTRIBUTE_ID: UInt = 5u
    ...
    requireNotNull(attributeData) { 
      "Activecurrent attribute not found in response" 
    }
  ...
  suspend fun subscribeActiveCurrentAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(ActiveCurrentAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
          ...
          requireNotNull(attributeData) { 
            "Activecurrent attribute not found in Node State update" 
          }
      ...
      null
          ...
          decodedValue?.let {
            emit(ActiveCurrentAttributeSubscriptionState.Success(it))
          }
...
suspend fun readReactiveCurrentAttribute(): ReactiveCurrentAttribute {val ATTRIBUTE_ID: UInt = 6u
    ...
    requireNotNull(attributeData) { 
      "Reactivecurrent attribute not found in response" 
    }
  ...
  suspend fun subscribeReactiveCurrentAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(ReactiveCurrentAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
      ...
      null
          ...
          decodedValue?.let {
            emit(ReactiveCurrentAttributeSubscriptionState.Success(it))
          }
...
suspend fun readApparentCurrentAttribute(): ApparentCurrentAttribute {val ATTRIBUTE_ID: UInt = 7u
    ...
    requireNotNull(attributeData) { 
      "Apparentcurrent attribute not found in response" 
    }
  ...
  suspend fun subscribeApparentCurrentAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(ApparentCurrentAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
      ...
      null
          ...
          decodedValue?.let {
            emit(ApparentCurrentAttributeSubscriptionState.Success(it))
          }
...
suspend fun readActivePowerAttribute(): ActivePowerAttribute {val ATTRIBUTE_ID: UInt = 8u
  ...
  suspend fun subscribeActivePowerAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(ActivePowerAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
      ...
      null
          ...
          decodedValue?.let {
            emit(ActivePowerAttributeSubscriptionState.Success(it))
          }
...
suspend fun readReactivePowerAttribute(): ReactivePowerAttribute {val ATTRIBUTE_ID: UInt = 9u
  ...
  suspend fun subscribeReactivePowerAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(ReactivePowerAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
      ...
      null
          ...
          decodedValue?.let {
            emit(ReactivePowerAttributeSubscriptionState.Success(it))
          }
...
suspend fun readApparentPowerAttribute(): ApparentPowerAttribute {val ATTRIBUTE_ID: UInt = 10u
  ...
  suspend fun subscribeApparentPowerAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(ApparentPowerAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
      ...
      null
          ...
          decodedValue?.let {
            emit(ApparentPowerAttributeSubscriptionState.Success(it))
          }
...
suspend fun readRMSVoltageAttribute(): RMSVoltageAttribute {val ATTRIBUTE_ID: UInt = 11u
  ...
  suspend fun subscribeRMSVoltageAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(RMSVoltageAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
      ...
      null
          ...
          decodedValue?.let {
            emit(RMSVoltageAttributeSubscriptionState.Success(it))
          }
...
suspend fun readRMSCurrentAttribute(): RMSCurrentAttribute {val ATTRIBUTE_ID: UInt = 12u
  ...
  suspend fun subscribeRMSCurrentAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(RMSCurrentAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
      ...
      null
          ...
          decodedValue?.let {
            emit(RMSCurrentAttributeSubscriptionState.Success(it))
          }
...
suspend fun readRMSPowerAttribute(): RMSPowerAttribute {val ATTRIBUTE_ID: UInt = 13u
    ...
    requireNotNull(attributeData) { 
      "Rmspower attribute not found in response" 
    }
  ...
  suspend fun subscribeRMSPowerAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(RMSPowerAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
          ...
          requireNotNull(attributeData) { 
            "Rmspower attribute not found in Node State update" 
          }
      ...
      null
          ...
          decodedValue?.let {
            emit(RMSPowerAttributeSubscriptionState.Success(it))
          }
...
suspend fun readFrequencyAttribute(): FrequencyAttribute {val ATTRIBUTE_ID: UInt = 14u
    ...
    requireNotNull(attributeData) { 
      "Frequency attribute not found in response" 
    }
  ...
  suspend fun subscribeFrequencyAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(FrequencyAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
          ...
          requireNotNull(attributeData) { 
            "Frequency attribute not found in Node State update" 
          }
      ...
      null
          ...
          decodedValue?.let {
            emit(FrequencyAttributeSubscriptionState.Success(it))
          }
...
suspend fun readHarmonicCurrentsAttribute(): HarmonicCurrentsAttribute {val ATTRIBUTE_ID: UInt = 15u
    ...
    requireNotNull(attributeData) { 
      "Harmoniccurrents attribute not found in response" 
    }

    // Decode the TLV data into the appropriate type
    val tlvReader = TlvReader(attributeData.data)
    val decodedValue: List<ElectricalPowerMeasurementClusterHarmonicMeasurementStruct>? = if (!tlvReader.isNull()) {
      if (tlvReader.isNextTag(AnonymousTag)) {
      buildList<ElectricalPowerMeasurementClusterHarmonicMeasurementStruct> {
      tlvReader.enterArray(AnonymousTag)
      while(!tlvReader.isEndOfContainer()) {
        add(ElectricalPowerMeasurementClusterHarmonicMeasurementStruct.fromTlv(AnonymousTag, tlvReader))
      }
      tlvReader.exitContainer()
    }
    } else {
  ...
  suspend fun subscribeHarmonicCurrentsAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(HarmonicCurrentsAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
      ...
      null
          ...
          decodedValue?.let {
            emit(HarmonicCurrentsAttributeSubscriptionState.Success(it))
          }
...
suspend fun readHarmonicPhasesAttribute(): HarmonicPhasesAttribute {val ATTRIBUTE_ID: UInt = 16u
    ...
    requireNotNull(attributeData) { 
      "Harmonicphases attribute not found in response" 
    }
  ...
  suspend fun subscribeHarmonicPhasesAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(HarmonicPhasesAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
      ...
      null
          ...
          decodedValue?.let {
            emit(HarmonicPhasesAttributeSubscriptionState.Success(it))
          }
...
suspend fun readPowerFactorAttribute(): PowerFactorAttribute {val ATTRIBUTE_ID: UInt = 17u
  ...
  suspend fun subscribePowerFactorAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(PowerFactorAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
      ...
      null
          ...
          decodedValue?.let {
            emit(PowerFactorAttributeSubscriptionState.Success(it))
          }
...
suspend fun readNeutralCurrentAttribute(): NeutralCurrentAttribute {val ATTRIBUTE_ID: UInt = 18u
  ...
  suspend fun subscribeNeutralCurrentAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(NeutralCurrentAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
      ...
      null
          ...
          decodedValue?.let {
            emit(NeutralCurrentAttributeSubscriptionState.Success(it))
          }
