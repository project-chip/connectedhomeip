...
suspend fun readObjectCountReachedAttribute(): Boolean? {val ATTRIBUTE_ID: UInt = 6u
...
suspend fun readHoldTimeAttribute(): UShort {val ATTRIBUTE_ID: UInt = 7u
...
suspend fun readHoldTimeLimitsAttribute(): HoldTimeLimitsAttribute {val ATTRIBUTE_ID: UInt = 8u
...
suspend fun readPredictedActivityAttribute(): PredictedActivityAttribute {val ATTRIBUTE_ID: UInt = 9u
