...
class AmbientContextSensingCluster(
  private val controller: MatterController,
  private val endpointId: UShort,
) {
  class AmbientContextTypeAttribute(
  ...
  sealed class AmbientContextTypeAttributeSubscriptionState {
    data class Success(val value: List<AmbientContextSensingClusterAmbientContextTypeStruct>?) :
  ...
  class ObjectCountConfigAttribute(val value: AmbientContextSensingClusterObjectCountConfigStruct?)

  sealed class ObjectCountConfigAttributeSubscriptionState {
    data class Success(val value: AmbientContextSensingClusterObjectCountConfigStruct?) :
      ObjectCountConfigAttributeSubscriptionState()

    data class Error(val exception: Exception) : ObjectCountConfigAttributeSubscriptionState()

    object SubscriptionEstablished : ObjectCountConfigAttributeSubscriptionState()
  }

  class HoldTimeLimitsAttribute(val value: AmbientContextSensingClusterHoldTimeLimitsStruct)

  sealed class HoldTimeLimitsAttributeSubscriptionState {
    data class Success(val value: AmbientContextSensingClusterHoldTimeLimitsStruct) :
  ...
  sealed class PredictedActivityAttributeSubscriptionState {
    data class Success(val value: List<AmbientContextSensingClusterPredictedActivityStruct>?) :
  ...
  suspend fun readHumanActivityDetectedAttribute(): Boolean? {
    ...
    requireNotNull(attributeData) { "Humanactivitydetected attribute not found in response" }
  ...
  suspend fun readObjectIdentifiedAttribute(): Boolean? {
    ...
    requireNotNull(attributeData) { "Objectidentified attribute not found in response" }
  ...
  suspend fun readAudioContextDetectedAttribute(): Boolean? {
    ...
    requireNotNull(attributeData) { "Audiocontextdetected attribute not found in response" }
  ...
  suspend fun readAmbientContextTypeAttribute(): AmbientContextTypeAttribute {
    ...
    requireNotNull(attributeData) { "Ambientcontexttype attribute not found in response" }

    // Decode the TLV data into the appropriate type
    val tlvReader = TlvReader(attributeData.data)
    val decodedValue: List<AmbientContextSensingClusterAmbientContextTypeStruct>? =
      if (tlvReader.isNextTag(AnonymousTag)) {
        buildList<AmbientContextSensingClusterAmbientContextTypeStruct> {
          tlvReader.enterArray(AnonymousTag)
          while (!tlvReader.isEndOfContainer()) {
            add(
              AmbientContextSensingClusterAmbientContextTypeStruct.fromTlv(AnonymousTag, tlvReader)
            )
          }
  ...
  suspend fun subscribeAmbientContextTypeAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(
            AmbientContextTypeAttributeSubscriptionState.Error(
              Exception(
                "Subscription terminated with error code: ${subscriptionState.terminationCause}"
              )
            )
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          val decodedValue: List<AmbientContextSensingClusterAmbientContextTypeStruct>? =
            if (tlvReader.isNextTag(AnonymousTag)) {
              buildList<AmbientContextSensingClusterAmbientContextTypeStruct> {
                ...
                while (!tlvReader.isEndOfContainer()) {
                  add(
                    AmbientContextSensingClusterAmbientContextTypeStruct.fromTlv(
                      AnonymousTag,
                      tlvReader,
                    )
                  )
          ...
          decodedValue?.let { emit(AmbientContextTypeAttributeSubscriptionState.Success(it)) }
        }
        SubscriptionState.SubscriptionEstablished -> {
  ...
  suspend fun readAmbientContextTypeSupportedAttribute(): AmbientContextTypeSupportedAttribute {
    ...
    requireNotNull(attributeData) { "Ambientcontexttypesupported attribute not found in response" }
  ...
  suspend fun subscribeAmbientContextTypeSupportedAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(
            AmbientContextTypeSupportedAttributeSubscriptionState.Error(
              Exception(
                "Subscription terminated with error code: ${subscriptionState.terminationCause}"
              )
            )
  ...
  suspend fun readObjectCountConfigAttribute(): ObjectCountConfigAttribute {
    ...
    requireNotNull(attributeData) { "Objectcountconfig attribute not found in response" }

    // Decode the TLV data into the appropriate type
    val tlvReader = TlvReader(attributeData.data)
    val decodedValue: AmbientContextSensingClusterObjectCountConfigStruct? =
      if (tlvReader.isNextTag(AnonymousTag)) {
        AmbientContextSensingClusterObjectCountConfigStruct.fromTlv(AnonymousTag, tlvReader)
      } else {
        null
      }

    return ObjectCountConfigAttribute(decodedValue)
  }

  suspend fun writeObjectCountConfigAttribute(
    value: AmbientContextSensingClusterObjectCountConfigStruct,
  ...
  suspend fun subscribeObjectCountConfigAttribute(
    minInterval: Int,
    maxInterval: Int,
  ): Flow<ObjectCountConfigAttributeSubscriptionState> {
    val ATTRIBUTE_ID: UInt = 6u
    val attributePaths =
      listOf(
        AttributePath(endpointId = endpointId, clusterId = CLUSTER_ID, attributeId = ATTRIBUTE_ID)
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(
            ObjectCountConfigAttributeSubscriptionState.Error(
              Exception(
                "Subscription terminated with error code: ${subscriptionState.terminationCause}"
              )
            )
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) {
            "Objectcountconfig attribute not found in Node State update"
          }
          ...
          decodedValue?.let { emit(ObjectCountConfigAttributeSubscriptionState.Success(it)) }
        }
        SubscriptionState.SubscriptionEstablished -> {
          emit(ObjectCountConfigAttributeSubscriptionState.SubscriptionEstablished)
        }
      }
    }
  }

  suspend fun readObjectCountAttribute(): UShort? {
    ...
    requireNotNull(attributeData) { "Objectcount attribute not found in response" }
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { "Objectcount attribute not found in Node State update" }
  ...
  suspend fun readSimultaneousDetectionLimitAttribute(): UByte {
    ...
    requireNotNull(attributeData) { "Simultaneousdetectionlimit attribute not found in response" }
  ...
  suspend fun readHoldTimeLimitsAttribute(): HoldTimeLimitsAttribute {
    ...
    // Decode the TLV data into the appropriate type
    val tlvReader = TlvReader(attributeData.data)
    val decodedValue: AmbientContextSensingClusterHoldTimeLimitsStruct =
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          emit(HoldTimeLimitsAttributeSubscriptionState.Success(decodedValue))
        }
        SubscriptionState.SubscriptionEstablished -> {
  ...
  suspend fun readPredictedActivityAttribute(): PredictedActivityAttribute {
    ...
    requireNotNull(attributeData) { "Predictedactivity attribute not found in response" }

    // Decode the TLV data into the appropriate type
    val tlvReader = TlvReader(attributeData.data)
    val decodedValue: List<AmbientContextSensingClusterPredictedActivityStruct>? =
      if (tlvReader.isNextTag(AnonymousTag)) {
        buildList<AmbientContextSensingClusterPredictedActivityStruct> {
          tlvReader.enterArray(AnonymousTag)
          while (!tlvReader.isEndOfContainer()) {
            add(
              AmbientContextSensingClusterPredictedActivityStruct.fromTlv(AnonymousTag, tlvReader)
            )
          }
          tlvReader.exitContainer()
        }
  ...
  suspend fun subscribePredictedActivityAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(
            PredictedActivityAttributeSubscriptionState.Error(
              Exception(
                "Subscription terminated with error code: ${subscriptionState.terminationCause}"
              )
            )
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          val decodedValue: List<AmbientContextSensingClusterPredictedActivityStruct>? =
            if (tlvReader.isNextTag(AnonymousTag)) {
              buildList<AmbientContextSensingClusterPredictedActivityStruct> {
                ...
                while (!tlvReader.isEndOfContainer()) {
                  add(
                    AmbientContextSensingClusterPredictedActivityStruct.fromTlv(
                      AnonymousTag,
                      tlvReader,
                    )
                  )
          ...
          decodedValue?.let { emit(PredictedActivityAttributeSubscriptionState.Success(it)) }
        }
        SubscriptionState.SubscriptionEstablished -> {
