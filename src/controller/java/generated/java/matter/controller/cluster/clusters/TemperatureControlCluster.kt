...
class TemperatureControlCluster(private val controller: MatterController, private val endpointId: UShort) {class SupportedTemperatureLevelsAttribute(
  ...
  sealed class SupportedTemperatureLevelsAttributeSubscriptionState {
    ...
    data class Error(val exception: Exception) : SupportedTemperatureLevelsAttributeSubscriptionState()
...
class AttributeListAttribute(
  ...
  suspend fun setTemperature(targetTemperature: Short?
...
suspend fun readTemperatureSetpointAttribute(): Short? {val ATTRIBUTE_ID: UInt = 0u
    ...
    requireNotNull(attributeData) { 
      "Temperaturesetpoint attribute not found in response" 
    }
...
suspend fun readMinTemperatureAttribute(): Short? {val ATTRIBUTE_ID: UInt = 1u
    ...
    requireNotNull(attributeData) { 
      "Mintemperature attribute not found in response" 
    }
...
suspend fun readMaxTemperatureAttribute(): Short? {val ATTRIBUTE_ID: UInt = 2u
    ...
    requireNotNull(attributeData) { 
      "Maxtemperature attribute not found in response" 
    }
...
suspend fun readStepAttribute(): Short? {val ATTRIBUTE_ID: UInt = 3u
...
suspend fun readSelectedTemperatureLevelAttribute(): UByte? {val ATTRIBUTE_ID: UInt = 4u
    ...
    requireNotNull(attributeData) { 
      "Selectedtemperaturelevel attribute not found in response" 
    }
...
suspend fun readSupportedTemperatureLevelsAttribute(): SupportedTemperatureLevelsAttribute {val ATTRIBUTE_ID: UInt = 5u
    ...
    requireNotNull(attributeData) { 
      "Supportedtemperaturelevels attribute not found in response" 
    }
  ...
  suspend fun subscribeSupportedTemperatureLevelsAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(SupportedTemperatureLevelsAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
