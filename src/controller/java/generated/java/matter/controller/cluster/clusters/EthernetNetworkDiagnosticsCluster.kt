...
class EthernetNetworkDiagnosticsCluster(private val controller: MatterController, private val endpointId: UShort) {class PHYRateAttribute(
    val value: UByte?
  )
  ...
  sealed class PHYRateAttributeSubscriptionState {
    data class Success(
    val value: UByte?
    ) : PHYRateAttributeSubscriptionState()
...
class FullDuplexAttribute(
  ...
  sealed class FullDuplexAttributeSubscriptionState {
    data class Success(
    val value: Boolean?
    ) : FullDuplexAttributeSubscriptionState()
...
class CarrierDetectAttribute(
  ...
  sealed class CarrierDetectAttributeSubscriptionState {
    data class Success(
    val value: Boolean?
    ) : CarrierDetectAttributeSubscriptionState()
...
suspend fun readPHYRateAttribute(): PHYRateAttribute {val ATTRIBUTE_ID: UInt = 0u
    ...
    requireNotNull(attributeData) { 
      "Phyrate attribute not found in response" 
    }
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(PHYRateAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { 
            "Phyrate attribute not found in Node State update" 
          }
      ...
      null
          ...
          decodedValue?.let {
            emit(PHYRateAttributeSubscriptionState.Success(it))
          }
...
suspend fun readFullDuplexAttribute(): FullDuplexAttribute {val ATTRIBUTE_ID: UInt = 1u
    ...
    requireNotNull(attributeData) { 
      "Fullduplex attribute not found in response" 
    }
  ...
  suspend fun subscribeFullDuplexAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(FullDuplexAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
          ...
          requireNotNull(attributeData) { 
            "Fullduplex attribute not found in Node State update" 
          }
      ...
      null
          ...
          decodedValue?.let {
            emit(FullDuplexAttributeSubscriptionState.Success(it))
          }
...
suspend fun readPacketRxCountAttribute(): ULong? {val ATTRIBUTE_ID: UInt = 2u
    ...
    requireNotNull(attributeData) { 
      "Packetrxcount attribute not found in response" 
    }
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { 
            "Packetrxcount attribute not found in Node State update" 
          }
...
suspend fun readPacketTxCountAttribute(): ULong? {val ATTRIBUTE_ID: UInt = 3u
    ...
    requireNotNull(attributeData) { 
      "Packettxcount attribute not found in response" 
    }
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { 
            "Packettxcount attribute not found in Node State update" 
          }
...
suspend fun readTxErrCountAttribute(): ULong? {val ATTRIBUTE_ID: UInt = 4u
    ...
    requireNotNull(attributeData) { 
      "Txerrcount attribute not found in response" 
    }
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { 
            "Txerrcount attribute not found in Node State update" 
          }
...
suspend fun readCollisionCountAttribute(): ULong? {val ATTRIBUTE_ID: UInt = 5u
    ...
    requireNotNull(attributeData) { 
      "Collisioncount attribute not found in response" 
    }
...
suspend fun readCarrierDetectAttribute(): CarrierDetectAttribute {val ATTRIBUTE_ID: UInt = 7u
    ...
    requireNotNull(attributeData) { 
      "Carrierdetect attribute not found in response" 
    }
  ...
  suspend fun subscribeCarrierDetectAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(CarrierDetectAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
          ...
          requireNotNull(attributeData) { 
            "Carrierdetect attribute not found in Node State update" 
          }
      ...
      null
          ...
          decodedValue?.let {
            emit(CarrierDetectAttributeSubscriptionState.Success(it))
          }
...
suspend fun readTimeSinceResetAttribute(): ULong? {val ATTRIBUTE_ID: UInt = 8u
    ...
    requireNotNull(attributeData) { 
      "Timesincereset attribute not found in response" 
    }
