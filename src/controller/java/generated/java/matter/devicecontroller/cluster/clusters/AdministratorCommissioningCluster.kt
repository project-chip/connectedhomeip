...
class AdministratorCommissioningCluster(private val controller: MatterController, private val endpointId: UShort) {
  ...
  suspend fun openCommissioningWindow(commissioningTimeout: UShort, PAKEPasscodeVerifier: ByteArray, discriminator: UShort, iterations: UInt, salt: ByteArray, timedInvokeTimeoutMs: Int) {
    val commandId = 0L

    // Implementation needs to be added here    
  }

  suspend fun openBasicCommissioningWindow(commissioningTimeout: UShort, timedInvokeTimeoutMs: Int) {
    val commandId = 1L
