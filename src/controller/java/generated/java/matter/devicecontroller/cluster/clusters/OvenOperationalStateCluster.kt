...
class OvenOperationalStateCluster(
  private val controller: MatterController,
  private val endpointId: UShort
) {
  class OperationalCommandResponse(
    val commandResponseState: OvenOperationalStateClusterErrorStateStruct
  )
  ...
  class OperationalStateListAttribute(
    val value: List<OvenOperationalStateClusterOperationalStateStruct>
  )

  class OperationalErrorAttribute(val value: OvenOperationalStateClusterErrorStateStruct)
