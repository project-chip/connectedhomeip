...
class DemandResponseLoadControlClusterLoadControlEventStatusChangeEvent(
  ...
  val control: UInt,
  val temperatureControl: Optional<matter.devicecontroller.cluster.structs.DemandResponseLoadControlClusterTemperatureControlStruct>?,
  val averageLoadControl: Optional<matter.devicecontroller.cluster.structs.DemandResponseLoadControlClusterAverageLoadControlStruct>?,
  val dutyCycleControl: Optional<matter.devicecontroller.cluster.structs.DemandResponseLoadControlClusterDutyCycleControlStruct>?,
  val powerSavingsControl: Optional<matter.devicecontroller.cluster.structs.DemandResponseLoadControlClusterPowerSavingsControlStruct>?,
  val heatingSourceControl: Optional<matter.devicecontroller.cluster.structs.DemandResponseLoadControlClusterHeatingSourceControlStruct>?
) {
  ...
  companion object {
    ...
    fun fromTlv(tlvTag: Tag, tlvReader: TlvReader) : DemandResponseLoadControlClusterLoadControlEventStatusChangeEvent {
      ...
      val temperatureControl = if (!tlvReader.isNull()) {
        ...
        Optional.of(matter.devicecontroller.cluster.structs.DemandResponseLoadControlClusterTemperatureControlStruct.fromTlv(ContextSpecificTag(TAG_TEMPERATURE_CONTROL), tlvReader))
      } else {
        Optional.empty()
      }
      } else {
      ...
      val averageLoadControl = if (!tlvReader.isNull()) {
        ...
        Optional.of(matter.devicecontroller.cluster.structs.DemandResponseLoadControlClusterAverageLoadControlStruct.fromTlv(ContextSpecificTag(TAG_AVERAGE_LOAD_CONTROL), tlvReader))
      } else {
        Optional.empty()
      }
      } else {
      ...
      val dutyCycleControl = if (!tlvReader.isNull()) {
        ...
        Optional.of(matter.devicecontroller.cluster.structs.DemandResponseLoadControlClusterDutyCycleControlStruct.fromTlv(ContextSpecificTag(TAG_DUTY_CYCLE_CONTROL), tlvReader))
      } else {
        Optional.empty()
      }
      } else {
      ...
      val powerSavingsControl = if (!tlvReader.isNull()) {
        ...
        Optional.of(matter.devicecontroller.cluster.structs.DemandResponseLoadControlClusterPowerSavingsControlStruct.fromTlv(ContextSpecificTag(TAG_POWER_SAVINGS_CONTROL), tlvReader))
      } else {
        Optional.empty()
      }
      } else {
      ...
      val heatingSourceControl = if (!tlvReader.isNull()) {
        ...
        Optional.of(matter.devicecontroller.cluster.structs.DemandResponseLoadControlClusterHeatingSourceControlStruct.fromTlv(ContextSpecificTag(TAG_HEATING_SOURCE_CONTROL), tlvReader))
      } else {
        Optional.empty()
      }
      } else {
