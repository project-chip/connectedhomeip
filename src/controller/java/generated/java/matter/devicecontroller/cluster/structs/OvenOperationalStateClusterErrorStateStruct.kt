...
class OvenOperationalStateClusterErrorStateStruct(
  ...
  companion object {
    ...
    fun fromTlv(tlvTag: Tag, tlvReader: TlvReader): OvenOperationalStateClusterErrorStateStruct {
      ...
      return OvenOperationalStateClusterErrorStateStruct(
        errorStateID,
        errorStateLabel,
        errorStateDetails
      )
