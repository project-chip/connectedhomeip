...
class OtaSoftwareUpdateRequestorCluster(
  ...
  suspend fun readDefaultOTAProvidersAttribute(): DefaultOTAProvidersAttribute {
    val ATTRIBUTE_ID_DEFAULTOTAPROVIDERS: UInt = 0u

    val attributePath =
      AttributePath(
        endpointId = endpointId,
        clusterId = CLUSTER_ID,
        attributeId = ATTRIBUTE_ID_DEFAULTOTAPROVIDERS
      )
    ...
    if (response.successes.isNotEmpty()) {
      ...
      val attributeData =
        response.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
          it.path.attributeId == ATTRIBUTE_ID_DEFAULTOTAPROVIDERS
        }
  ...
  suspend fun readUpdatePossibleAttribute(): Boolean {
    val ATTRIBUTE_ID_UPDATEPOSSIBLE: UInt = 1u

    val attributePath =
      AttributePath(
        endpointId = endpointId,
        clusterId = CLUSTER_ID,
        attributeId = ATTRIBUTE_ID_UPDATEPOSSIBLE
      )
    ...
    if (response.successes.isNotEmpty()) {
      ...
      val attributeData =
        response.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
          it.path.attributeId == ATTRIBUTE_ID_UPDATEPOSSIBLE
        }
  ...
  suspend fun readUpdateStateAttribute(): UByte {
    val ATTRIBUTE_ID_UPDATESTATE: UInt = 2u

    val attributePath =
      AttributePath(
        endpointId = endpointId,
        clusterId = CLUSTER_ID,
        attributeId = ATTRIBUTE_ID_UPDATESTATE
      )
    ...
    if (response.successes.isNotEmpty()) {
      ...
      val attributeData =
        response.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
          it.path.attributeId == ATTRIBUTE_ID_UPDATESTATE
        }
  ...
  suspend fun readUpdateStateProgressAttribute(): UpdateStateProgressAttribute {
    val ATTRIBUTE_ID_UPDATESTATEPROGRESS: UInt = 3u

    val attributePath =
      AttributePath(
        endpointId = endpointId,
        clusterId = CLUSTER_ID,
        attributeId = ATTRIBUTE_ID_UPDATESTATEPROGRESS
      )
    ...
    if (response.successes.isNotEmpty()) {
      ...
      val attributeData =
        response.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
          it.path.attributeId == ATTRIBUTE_ID_UPDATESTATEPROGRESS
        }
