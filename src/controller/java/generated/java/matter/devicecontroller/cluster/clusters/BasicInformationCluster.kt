...
class BasicInformationCluster(
  ...
  suspend fun readDataModelRevisionAttribute(): UShort {
    val ATTRIBUTE_ID_DATAMODELREVISION: UInt = 0u

    val attributePath =
      AttributePath(
        endpointId = endpointId,
        clusterId = CLUSTER_ID,
        attributeId = ATTRIBUTE_ID_DATAMODELREVISION
      )
    ...
    if (response.successes.isNotEmpty()) {
      ...
      val attributeData =
        response.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
          it.path.attributeId == ATTRIBUTE_ID_DATAMODELREVISION
        }
  ...
  suspend fun readProductIDAttribute(): UShort {
    val ATTRIBUTE_ID_PRODUCTID: UInt = 4u
  ...
  suspend fun readLocationAttribute(): String {
    val ATTRIBUTE_ID_LOCATION: UInt = 6u

    val attributePath =
      AttributePath(
        endpointId = endpointId,
        clusterId = CLUSTER_ID,
        attributeId = ATTRIBUTE_ID_LOCATION
      )
    ...
    if (response.successes.isNotEmpty()) {
      ...
      val attributeData =
        response.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
          it.path.attributeId == ATTRIBUTE_ID_LOCATION
        }
  ...
  suspend fun readLocalConfigDisabledAttribute(): Boolean? {
    val ATTRIBUTE_ID_LOCALCONFIGDISABLED: UInt = 16u

    val attributePath =
      AttributePath(
        endpointId = endpointId,
        clusterId = CLUSTER_ID,
        attributeId = ATTRIBUTE_ID_LOCALCONFIGDISABLED
      )
    ...
    if (response.successes.isNotEmpty()) {
      ...
      val attributeData =
        response.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
          it.path.attributeId == ATTRIBUTE_ID_LOCALCONFIGDISABLED
        }
  ...
  suspend fun readCapabilityMinimaAttribute(): CapabilityMinimaAttribute {
    val ATTRIBUTE_ID_CAPABILITYMINIMA: UInt = 19u

    val attributePath =
      AttributePath(
        endpointId = endpointId,
        clusterId = CLUSTER_ID,
        attributeId = ATTRIBUTE_ID_CAPABILITYMINIMA
      )
    ...
    if (response.successes.isNotEmpty()) {
      ...
      val attributeData =
        response.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
          it.path.attributeId == ATTRIBUTE_ID_CAPABILITYMINIMA
        }
  ...
  suspend fun readSpecificationVersionAttribute(): UInt {
    val ATTRIBUTE_ID_SPECIFICATIONVERSION: UInt = 21u

    val attributePath =
      AttributePath(
        endpointId = endpointId,
        clusterId = CLUSTER_ID,
        attributeId = ATTRIBUTE_ID_SPECIFICATIONVERSION
      )
    ...
    if (response.successes.isNotEmpty()) {
      ...
      val attributeData =
        response.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
          it.path.attributeId == ATTRIBUTE_ID_SPECIFICATIONVERSION
        }
  ...
  suspend fun readMaxPathsPerInvokeAttribute(): UShort {
    val ATTRIBUTE_ID_MAXPATHSPERINVOKE: UInt = 22u

    val attributePath =
      AttributePath(
        endpointId = endpointId,
        clusterId = CLUSTER_ID,
        attributeId = ATTRIBUTE_ID_MAXPATHSPERINVOKE
      )
    ...
    if (response.successes.isNotEmpty()) {
      ...
      val attributeData =
        response.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
          it.path.attributeId == ATTRIBUTE_ID_MAXPATHSPERINVOKE
        }
