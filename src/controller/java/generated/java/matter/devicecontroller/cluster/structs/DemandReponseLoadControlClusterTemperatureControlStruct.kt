...
class DemandReponseLoadControlClusterTemperatureControlStruct(
  val coolingTempOffset: UShort?,
  val heatTempOffset: UShort?,
  val coolingTempSetpoint: UShort?,
  val heatingTempSetpoint: UShort?
) {
