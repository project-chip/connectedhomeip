...
class LaundryWasherControlsCluster(
  ...
  suspend fun readSpinSpeedsAttribute(): SpinSpeedsAttribute {
    val ATTRIBUTE_ID_SPINSPEEDS: UInt = 0u

    val attributePath =
      AttributePath(
        endpointId = endpointId,
        clusterId = CLUSTER_ID,
        attributeId = ATTRIBUTE_ID_SPINSPEEDS
      )
    ...
    if (response.successes.isNotEmpty()) {
      ...
      val attributeData =
        response.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
          it.path.attributeId == ATTRIBUTE_ID_SPINSPEEDS
        }
  ...
  suspend fun readSpinSpeedCurrentAttribute(): SpinSpeedCurrentAttribute {
    val ATTRIBUTE_ID_SPINSPEEDCURRENT: UInt = 1u

    val attributePath =
      AttributePath(
        endpointId = endpointId,
        clusterId = CLUSTER_ID,
        attributeId = ATTRIBUTE_ID_SPINSPEEDCURRENT
      )
    ...
    if (response.successes.isNotEmpty()) {
      ...
      val attributeData =
        response.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
          it.path.attributeId == ATTRIBUTE_ID_SPINSPEEDCURRENT
        }
  ...
  suspend fun readNumberOfRinsesAttribute(): UByte? {
    val ATTRIBUTE_ID_NUMBEROFRINSES: UInt = 2u

    val attributePath =
      AttributePath(
        endpointId = endpointId,
        clusterId = CLUSTER_ID,
        attributeId = ATTRIBUTE_ID_NUMBEROFRINSES
      )
    ...
    if (response.successes.isNotEmpty()) {
      ...
      val attributeData =
        response.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
          it.path.attributeId == ATTRIBUTE_ID_NUMBEROFRINSES
        }
  ...
  suspend fun readSupportedRinsesAttribute(): SupportedRinsesAttribute {
    val ATTRIBUTE_ID_SUPPORTEDRINSES: UInt = 3u

    val attributePath =
      AttributePath(
        endpointId = endpointId,
        clusterId = CLUSTER_ID,
        attributeId = ATTRIBUTE_ID_SUPPORTEDRINSES
      )
    ...
    if (response.successes.isNotEmpty()) {
      ...
      val attributeData =
        response.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
          it.path.attributeId == ATTRIBUTE_ID_SUPPORTEDRINSES
        }
