...
class TemperatureControlCluster(
  ...
  suspend fun readTemperatureSetpointAttribute(): Short? {
    val ATTRIBUTE_ID_TEMPERATURESETPOINT: UInt = 0u

    val attributePath =
      AttributePath(
        endpointId = endpointId,
        clusterId = CLUSTER_ID,
        attributeId = ATTRIBUTE_ID_TEMPERATURESETPOINT
      )
    ...
    if (response.successes.isNotEmpty()) {
      ...
      val attributeData =
        response.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
          it.path.attributeId == ATTRIBUTE_ID_TEMPERATURESETPOINT
        }
  ...
  suspend fun readMinTemperatureAttribute(): Short? {
    val ATTRIBUTE_ID_MINTEMPERATURE: UInt = 1u

    val attributePath =
      AttributePath(
        endpointId = endpointId,
        clusterId = CLUSTER_ID,
        attributeId = ATTRIBUTE_ID_MINTEMPERATURE
      )
    ...
    if (response.successes.isNotEmpty()) {
      ...
      val attributeData =
        response.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
          it.path.attributeId == ATTRIBUTE_ID_MINTEMPERATURE
        }
  ...
  suspend fun readMaxTemperatureAttribute(): Short? {
    val ATTRIBUTE_ID_MAXTEMPERATURE: UInt = 2u

    val attributePath =
      AttributePath(
        endpointId = endpointId,
        clusterId = CLUSTER_ID,
        attributeId = ATTRIBUTE_ID_MAXTEMPERATURE
      )
    ...
    if (response.successes.isNotEmpty()) {
      ...
      val attributeData =
        response.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
          it.path.attributeId == ATTRIBUTE_ID_MAXTEMPERATURE
        }
  ...
  suspend fun readStepAttribute(): Short? {
    val ATTRIBUTE_ID_STEP: UInt = 3u

    val attributePath =
      AttributePath(
        endpointId = endpointId,
        clusterId = CLUSTER_ID,
        attributeId = ATTRIBUTE_ID_STEP
      )
    ...
    if (response.successes.isNotEmpty()) {
      ...
      val attributeData =
        response.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
          it.path.attributeId == ATTRIBUTE_ID_STEP
        }
  ...
  suspend fun readSelectedTemperatureLevelAttribute(): UByte? {
    val ATTRIBUTE_ID_SELECTEDTEMPERATURELEVEL: UInt = 4u

    val attributePath =
      AttributePath(
        endpointId = endpointId,
        clusterId = CLUSTER_ID,
        attributeId = ATTRIBUTE_ID_SELECTEDTEMPERATURELEVEL
      )
    ...
    if (response.successes.isNotEmpty()) {
      ...
      val attributeData =
        response.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
          it.path.attributeId == ATTRIBUTE_ID_SELECTEDTEMPERATURELEVEL
        }
  ...
  suspend fun readSupportedTemperatureLevelsAttribute(): SupportedTemperatureLevelsAttribute {
    val ATTRIBUTE_ID_SUPPORTEDTEMPERATURELEVELS: UInt = 5u

    val attributePath =
      AttributePath(
        endpointId = endpointId,
        clusterId = CLUSTER_ID,
        attributeId = ATTRIBUTE_ID_SUPPORTEDTEMPERATURELEVELS
      )
    ...
    if (response.successes.isNotEmpty()) {
      ...
      val attributeData =
        response.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
          it.path.attributeId == ATTRIBUTE_ID_SUPPORTEDTEMPERATURELEVELS
        }
