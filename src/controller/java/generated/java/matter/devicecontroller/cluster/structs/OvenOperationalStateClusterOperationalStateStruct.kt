...
class OvenOperationalStateClusterOperationalStateStruct(
  val operationalStateID: UInt,
  val operationalStateLabel: Optional<String>
) {
  override fun toString(): String = buildString {
    append("OvenOperationalStateClusterOperationalStateStruct {\n")
  ...
  companion object {
    ...
    fun fromTlv(
      ...
      return OvenOperationalStateClusterOperationalStateStruct(
        operationalStateID,
