...
class ApplicationBasicCluster(private val controller: MatterController, private val endpointId: UShort) {
  class ApplicationAttribute(
    val value: ApplicationBasicClusterApplicationStruct
  )

  class AllowedVendorListAttribute(
  ...
  suspend fun subscribeApplicationNameAttribute(
    minInterval: Int,
    maxInterval: Int
  ): CharString {
    // Implementation needs to be added here
  ...
  suspend fun subscribeApplicationVersionAttribute(
    minInterval: Int,
    maxInterval: Int
  ): CharString {
    // Implementation needs to be added here
