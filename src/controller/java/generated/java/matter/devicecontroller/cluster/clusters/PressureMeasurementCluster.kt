...
class PressureMeasurementCluster(
  ...
  suspend fun readScaledValueAttribute(): ScaledValueAttribute {
    val ATTRIBUTE_ID_SCALEDVALUE: UInt = 16u

    val attributePath =
      AttributePath(
        endpointId = endpointId,
        clusterId = CLUSTER_ID,
        attributeId = ATTRIBUTE_ID_SCALEDVALUE
      )
    ...
    if (response.successes.isNotEmpty()) {
      ...
      val attributeData =
        response.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
          it.path.attributeId == ATTRIBUTE_ID_SCALEDVALUE
        }
  ...
  suspend fun readMinScaledValueAttribute(): MinScaledValueAttribute {
    val ATTRIBUTE_ID_MINSCALEDVALUE: UInt = 17u

    val attributePath =
      AttributePath(
        endpointId = endpointId,
        clusterId = CLUSTER_ID,
        attributeId = ATTRIBUTE_ID_MINSCALEDVALUE
      )
    ...
    if (response.successes.isNotEmpty()) {
      ...
      val attributeData =
        response.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
          it.path.attributeId == ATTRIBUTE_ID_MINSCALEDVALUE
        }
  ...
  suspend fun readMaxScaledValueAttribute(): MaxScaledValueAttribute {
    val ATTRIBUTE_ID_MAXSCALEDVALUE: UInt = 18u

    val attributePath =
      AttributePath(
        endpointId = endpointId,
        clusterId = CLUSTER_ID,
        attributeId = ATTRIBUTE_ID_MAXSCALEDVALUE
      )
    ...
    if (response.successes.isNotEmpty()) {
      ...
      val attributeData =
        response.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
          it.path.attributeId == ATTRIBUTE_ID_MAXSCALEDVALUE
        }
  ...
  suspend fun readScaledToleranceAttribute(): UShort? {
    val ATTRIBUTE_ID_SCALEDTOLERANCE: UInt = 19u

    val attributePath =
      AttributePath(
        endpointId = endpointId,
        clusterId = CLUSTER_ID,
        attributeId = ATTRIBUTE_ID_SCALEDTOLERANCE
      )
    ...
    if (response.successes.isNotEmpty()) {
      ...
      val attributeData =
        response.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
          it.path.attributeId == ATTRIBUTE_ID_SCALEDTOLERANCE
        }
  ...
  suspend fun readScaleAttribute(): Byte? {
    val ATTRIBUTE_ID_SCALE: UInt = 20u

    val attributePath =
      AttributePath(
        endpointId = endpointId,
        clusterId = CLUSTER_ID,
        attributeId = ATTRIBUTE_ID_SCALE
      )
    ...
    if (response.successes.isNotEmpty()) {
      ...
      val attributeData =
        response.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
          it.path.attributeId == ATTRIBUTE_ID_SCALE
        }
