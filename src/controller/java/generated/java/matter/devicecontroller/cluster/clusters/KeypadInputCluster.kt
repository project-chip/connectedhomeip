...
class KeypadInputCluster(private val controller: MatterController, private val endpointId: UShort) {
  class SendKeyResponse(val status: UByte)
  ...
  suspend fun sendKey(keyCode: UByte, timedInvokeTimeoutMs: Int? = null): SendKeyResponse {
    ...
    val TAG_KEY_CODE_REQ: Int = 0
    tlvWriter.put(ContextSpecificTag(TAG_KEY_CODE_REQ), keyCode)
  ...
  companion object {
    private val logger = Logger.getLogger(KeypadInputCluster::class.java.name)
