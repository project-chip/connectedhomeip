...
class GroupKeyManagementCluster(
  ...
  suspend fun readGroupKeyMapAttribute(): GroupKeyMapAttribute {
    val ATTRIBUTE_ID_GROUPKEYMAP: UInt = 0u

    val attributePath =
      AttributePath(
        endpointId = endpointId,
        clusterId = CLUSTER_ID,
        attributeId = ATTRIBUTE_ID_GROUPKEYMAP
      )
    ...
    if (response.successes.isNotEmpty()) {
      ...
      val attributeData =
        response.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
          it.path.attributeId == ATTRIBUTE_ID_GROUPKEYMAP
        }
  ...
  suspend fun readGroupTableAttribute(): GroupTableAttribute {
    val ATTRIBUTE_ID_GROUPTABLE: UInt = 1u

    val attributePath =
      AttributePath(
        endpointId = endpointId,
        clusterId = CLUSTER_ID,
        attributeId = ATTRIBUTE_ID_GROUPTABLE
      )
    ...
    if (response.successes.isNotEmpty()) {
      ...
      val attributeData =
        response.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
          it.path.attributeId == ATTRIBUTE_ID_GROUPTABLE
        }
  ...
  suspend fun readMaxGroupsPerFabricAttribute(): UShort {
    val ATTRIBUTE_ID_MAXGROUPSPERFABRIC: UInt = 2u

    val attributePath =
      AttributePath(
        endpointId = endpointId,
        clusterId = CLUSTER_ID,
        attributeId = ATTRIBUTE_ID_MAXGROUPSPERFABRIC
      )
    ...
    if (response.successes.isNotEmpty()) {
      ...
      val attributeData =
        response.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
          it.path.attributeId == ATTRIBUTE_ID_MAXGROUPSPERFABRIC
        }
  ...
  suspend fun readMaxGroupKeysPerFabricAttribute(): UShort {
    val ATTRIBUTE_ID_MAXGROUPKEYSPERFABRIC: UInt = 3u

    val attributePath =
      AttributePath(
        endpointId = endpointId,
        clusterId = CLUSTER_ID,
        attributeId = ATTRIBUTE_ID_MAXGROUPKEYSPERFABRIC
      )
    ...
    if (response.successes.isNotEmpty()) {
      ...
      val attributeData =
        response.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
          it.path.attributeId == ATTRIBUTE_ID_MAXGROUPKEYSPERFABRIC
        }
