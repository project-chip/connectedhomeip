...
class ManualCodeTest {
    ...
    fun testCheckDecimalStringValidity() {
        ...
        try {
            ManualOnboardingPayloadParser.checkDecimalStringValidity(
    ...
    fun testShortCodeCharLengths() {
        val numBits =
            1 + kSetupPINCodeFieldLengthInBits + kManualSetupDiscriminatorFieldLengthInBits
    ...
    fun testReadCharsFromDecimalString() {
        ...
        index.set(2)
        number =
            ManualOnboardingPayloadParser.readDigitsFromDecimalString("6256276377282", index, 7)
