...
class TlvReadWriteTest {
    ...
    fun testTlvSampleData_read() {
        TlvReader(testTlvSampleData).apply {
            ...
            assertThat(getBool(FullyQualifiedTag(6, TEST_VENDOR_ID, TEST_PRODUCT_ID, 2u)))
                .isEqualTo(true)
    ...
    fun testCopyElement_replaceTag() {
        ...
        val expectedEncoding =
            TlvWriter().startStructure(tag).endStructure().validateTlv().getEncoded()
    ...
    fun putSignedLongArray() {
        ...
        val encoding =
            "16 00 2a 00 ef 02 f0 67 fd ff 03 00 90 2f 50 09 00 00 00 18".octetsToByteArray()
