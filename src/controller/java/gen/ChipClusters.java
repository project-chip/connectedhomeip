...
public class ChipClusters {
  ...
  public static class OtaSoftwareUpdateProviderCluster extends BaseChipCluster {
    ...
    public void queryImage(QueryImageResponseCallback callback, int vendorId, int productId, int imageType, int hardwareVersion, long currentVersion, int protocolsSupported, String location, int requestorCanConsent, byte[] metadataForProvider) {
    ...
    private native void queryImage(long chipClusterPtr, QueryImageResponseCallback callback, int vendorId, int productId, int imageType, int hardwareVersion, long currentVersion, int protocolsSupported, String location, int requestorCanConsent, byte[] metadataForProvider);
  ...
  public static class OperationalCredentialsCluster extends BaseChipCluster {
    ...
    public void addOpCert(OpCertResponseCallback callback, byte[] nOCArray, byte[] iPKValue, long caseAdminNode, int adminVendorId) {
    ...
    private native void addOpCert(long chipClusterPtr, OpCertResponseCallback callback, byte[] nOCArray, byte[] iPKValue, long caseAdminNode, int adminVendorId);
