...
public class ChipClusters {
  ...
  public static class OperationalCredentialsCluster extends BaseChipCluster {
    ...
    public void addOpCert(OpCertResponseCallback callback, byte[] noc, byte[] iCACertificate, byte[] iPKValue, long caseAdminNode, int adminVendorId) {
      addOpCert(chipClusterPtr, callback, noc, iCACertificate, iPKValue, caseAdminNode, adminVendorId);
    }
    ...
    private native void addOpCert(long chipClusterPtr, OpCertResponseCallback callback, byte[] noc, byte[] iCACertificate, byte[] iPKValue, long caseAdminNode, int adminVendorId);
  ...
  public static class TrustedRootCertificatesCluster extends BaseChipCluster {
    public TrustedRootCertificatesCluster(long devicePtr, int endpointId) {
      super(devicePtr, endpointId);
    }
