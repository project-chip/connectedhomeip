    ...
    void * context, const chip::app::Clusters::OperationalState::Commands::OperationalCommandResponse::DecodableType & dataResponse)
{
    ...
    LogErrorOnFailure(chip::JniReferences::GetInstance().CharToStringUTF(dataResponse.commandResponseState.errorStateLabel,
                                                                         CommandResponseState_errorStateLabel));
    jobject CommandResponseState_errorStateDetails;
    LogErrorOnFailure(chip::JniReferences::GetInstance().CharToStringUTF(dataResponse.commandResponseState.errorStateDetails,
    ...
    jmethodID errorStateStructStructCtor_0 =
        env->GetMethodID(errorStateStructStructClass_0, "<init>", "(Ljava/lang/Integer;Ljava/lang/String;Ljava/lang/String;)V");
...
CHIPWasherControlsClusterWasherControlCommandResponseCallback::CHIPWasherControlsClusterWasherControlCommandResponseCallback(
    jobject javaCallback) :
    Callback::Callback<CHIPWasherControlsClusterWasherControlCommandResponseCallbackType>(CallbackFn, this)
{
    JNIEnv * env = JniReferences::GetInstance().GetEnvForCurrentThread();
    if (env == nullptr)
    {
...
void CHIPWasherControlsClusterWasherControlCommandResponseCallback::CallbackFn(
    void * context, const chip::app::Clusters::WasherControls::Commands::WasherControlCommandResponse::DecodableType & dataResponse)
{
    chip::DeviceLayer::StackUnlock unlock;
    CHIP_ERROR err = CHIP_NO_ERROR;
    JNIEnv * env   = JniReferences::GetInstance().GetEnvForCurrentThread();
    ...
    std::unique_ptr<CHIPWasherControlsClusterWasherControlCommandResponseCallback,
                    void (*)(CHIPWasherControlsClusterWasherControlCommandResponseCallback *)>
        cppCallback(reinterpret_cast<CHIPWasherControlsClusterWasherControlCommandResponseCallback *>(context),
                    chip::Platform::Delete<CHIPWasherControlsClusterWasherControlCommandResponseCallback>);
    VerifyOrReturn(cppCallback != nullptr, ChipLogError(Zcl, "Error invoking Java callback: failed to cast native callback"));
