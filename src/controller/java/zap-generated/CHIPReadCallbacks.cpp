...
CHIPTestClusterListLongOctetStringAttributeCallback::CHIPTestClusterListLongOctetStringAttributeCallback(jobject javaCallback) :
    chip::Callback::Callback<TestClusterListLongOctetStringListAttributeCallback>(CallbackFn, this)
{
    JNIEnv * env = chip::JniReferences::GetInstance().GetEnvForCurrentThread();
    if (env == nullptr)
    {
    ...
    void * context, const chip::app::DataModel::DecodableList<chip::ByteSpan> & list)
{
    ...
    std::unique_ptr<CHIPTestClusterListLongOctetStringAttributeCallback> cppCallback(
        reinterpret_cast<CHIPTestClusterListLongOctetStringAttributeCallback *>(context));
