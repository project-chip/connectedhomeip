...
public class ChipClusters {
  ...
  public static class OperationalCredentialsCluster extends BaseChipCluster {
    ...
    public void addNOC(NOCResponseCallback callback, byte[] nOCArray, byte[] iPKValue, long caseAdminNode, int adminVendorId) {
    ...
    private native void addNOC(long chipClusterPtr, NOCResponseCallback callback, byte[] nOCArray, byte[] iPKValue, long caseAdminNode, int adminVendorId);
    ...
    private native void updateNOC(long chipClusterPtr, NOCResponseCallback callback, byte[] nOCArray);
