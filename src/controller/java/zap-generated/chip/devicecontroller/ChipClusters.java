...
public class ChipClusters {
  ...
  public static Map<String, Class> getClusterMapping() {
    Map<String, Class> clusterMap;
      clusterMap.put("AccountLogin", AccountLoginCluster.getClass());
      clusterMap.put("AdministratorCommissioning", AdministratorCommissioningCluster.getClass());
      clusterMap.put("ApplicationBasic", ApplicationBasicCluster.getClass());
      clusterMap.put("ApplicationLauncher", ApplicationLauncherCluster.getClass());
      clusterMap.put("AudioOutput", AudioOutputCluster.getClass());
      clusterMap.put("BarrierControl", BarrierControlCluster.getClass());
      clusterMap.put("Basic", BasicCluster.getClass());
      clusterMap.put("BinaryInputBasic", BinaryInputBasicCluster.getClass());
      clusterMap.put("Binding", BindingCluster.getClass());
      clusterMap.put("BridgedDeviceBasic", BridgedDeviceBasicCluster.getClass());
      clusterMap.put("ColorControl", ColorControlCluster.getClass());
      clusterMap.put("ContentLauncher", ContentLauncherCluster.getClass());
      clusterMap.put("Descriptor", DescriptorCluster.getClass());
      clusterMap.put("DiagnosticLogs", DiagnosticLogsCluster.getClass());
      clusterMap.put("DoorLock", DoorLockCluster.getClass());
      clusterMap.put("ElectricalMeasurement", ElectricalMeasurementCluster.getClass());
      clusterMap.put("EthernetNetworkDiagnostics", EthernetNetworkDiagnosticsCluster.getClass());
      clusterMap.put("FixedLabel", FixedLabelCluster.getClass());
      clusterMap.put("FlowMeasurement", FlowMeasurementCluster.getClass());
      clusterMap.put("GeneralCommissioning", GeneralCommissioningCluster.getClass());
      clusterMap.put("GeneralDiagnostics", GeneralDiagnosticsCluster.getClass());
      clusterMap.put("GroupKeyManagement", GroupKeyManagementCluster.getClass());
      clusterMap.put("Groups", GroupsCluster.getClass());
      clusterMap.put("Identify", IdentifyCluster.getClass());
      clusterMap.put("KeypadInput", KeypadInputCluster.getClass());
      clusterMap.put("LevelControl", LevelControlCluster.getClass());
      clusterMap.put("LowPower", LowPowerCluster.getClass());
      clusterMap.put("MediaInput", MediaInputCluster.getClass());
      clusterMap.put("MediaPlayback", MediaPlaybackCluster.getClass());
      clusterMap.put("NetworkCommissioning", NetworkCommissioningCluster.getClass());
      clusterMap.put("OtaSoftwareUpdateProvider", OtaSoftwareUpdateProviderCluster.getClass());
      clusterMap.put("OtaSoftwareUpdateRequestor", OtaSoftwareUpdateRequestorCluster.getClass());
      clusterMap.put("OccupancySensing", OccupancySensingCluster.getClass());
      clusterMap.put("OnOff", OnOffCluster.getClass());
      clusterMap.put("OnOffSwitchConfiguration", OnOffSwitchConfigurationCluster.getClass());
      clusterMap.put("OperationalCredentials", OperationalCredentialsCluster.getClass());
      clusterMap.put("PowerSource", PowerSourceCluster.getClass());
      clusterMap.put("PressureMeasurement", PressureMeasurementCluster.getClass());
      clusterMap.put("PumpConfigurationAndControl", PumpConfigurationAndControlCluster.getClass());
      clusterMap.put("RelativeHumidityMeasurement", RelativeHumidityMeasurementCluster.getClass());
      clusterMap.put("Scenes", ScenesCluster.getClass());
      clusterMap.put("SoftwareDiagnostics", SoftwareDiagnosticsCluster.getClass());
      clusterMap.put("Switch", SwitchCluster.getClass());
      clusterMap.put("TvChannel", TvChannelCluster.getClass());
      clusterMap.put("TargetNavigator", TargetNavigatorCluster.getClass());
      clusterMap.put("TemperatureMeasurement", TemperatureMeasurementCluster.getClass());
      clusterMap.put("TestCluster", TestClusterCluster.getClass());
      clusterMap.put("Thermostat", ThermostatCluster.getClass());
      clusterMap.put("ThermostatUserInterfaceConfiguration", ThermostatUserInterfaceConfigurationCluster.getClass());
      clusterMap.put("ThreadNetworkDiagnostics", ThreadNetworkDiagnosticsCluster.getClass());
      clusterMap.put("WakeOnLan", WakeOnLanCluster.getClass());
      clusterMap.put("WiFiNetworkDiagnostics", WiFiNetworkDiagnosticsCluster.getClass());
      clusterMap.put("WindowCovering", WindowCoveringCluster.getClass());
    return clusterMap;
    }
  }
  ...
  public static class DoorLockCluster extends BaseChipCluster {
    ...
    public void setPin(SetPinResponseCallback callback, int userId, int userStatus, int userType, String pin) {
      setPin(chipClusterPtr, callback, userId, userStatus, userType, pin);
    }


    public void setRfid(SetRfidResponseCallback callback, int userId, int userStatus, int userType, String id) {
    ...
    public void unlockWithTimeout(UnlockWithTimeoutResponseCallback callback, int timeoutInSeconds, String pin) {
    ...
    private native void lockDoor(long chipClusterPtr, LockDoorResponseCallback callback, String pin);
    ...
    private native void setPin(long chipClusterPtr, SetPinResponseCallback callback, int userId, int userStatus, int userType, String pin);

    private native void setRfid(long chipClusterPtr, SetRfidResponseCallback callback, int userId, int userStatus, int userType, String id);
    ...
    private native void unlockDoor(long chipClusterPtr, UnlockDoorResponseCallback callback, String pin);

    private native void unlockWithTimeout(long chipClusterPtr, UnlockWithTimeoutResponseCallback callback, int timeoutInSeconds, String pin);
  ...
  public static class OtaSoftwareUpdateProviderCluster extends BaseChipCluster {
    ...
    public void notifyUpdateApplied(DefaultClusterCallback callback, byte[] updateToken, long currentVersion) {
      notifyUpdateApplied(chipClusterPtr, callback, updateToken, currentVersion);
    }


    public void queryImage(QueryImageResponseCallback callback, int vendorId, int productId, int imageType, int hardwareVersion, long currentVersion, int protocolsSupported, String location, boolean requestorCanConsent, byte[] metadataForProvider) {
      queryImage(chipClusterPtr, callback, vendorId, productId, imageType, hardwareVersion, currentVersion, protocolsSupported, location, requestorCanConsent, metadataForProvider);
    }
    ...
    private native void notifyUpdateApplied(long chipClusterPtr, DefaultClusterCallback callback, byte[] updateToken, long currentVersion);

    private native void queryImage(long chipClusterPtr, QueryImageResponseCallback callback, int vendorId, int productId, int imageType, int hardwareVersion, long currentVersion, int protocolsSupported, String location, boolean requestorCanConsent, byte[] metadataForProvider);
  ...
  public static class OtaSoftwareUpdateRequestorCluster extends BaseChipCluster {
    ...
    public void announceOtaProvider(DefaultClusterCallback callback, byte[] serverLocation, int vendorId, int announcementReason, byte[] metadataForNode) {
      announceOtaProvider(chipClusterPtr, callback, serverLocation, vendorId, announcementReason, metadataForNode);
    }

    private native void announceOtaProvider(long chipClusterPtr, DefaultClusterCallback callback, byte[] serverLocation, int vendorId, int announcementReason, byte[] metadataForNode);
