...
public class ChipClusters {
  ...
  public static class AccessControlCluster extends BaseChipCluster {
    ...
    public void writeAclAttribute(DefaultClusterCallback callback, ArrayList<ChipStructs.AccessControlClusterAccessControlEntry> value) {
      writeAclAttribute(chipClusterPtr, callback, value, null);
    }

    public void writeAclAttribute(DefaultClusterCallback callback, ArrayList<ChipStructs.AccessControlClusterAccessControlEntry> value, int timedWriteTimeoutMs) {
    ...
    public void writeExtensionAttribute(DefaultClusterCallback callback, ArrayList<ChipStructs.AccessControlClusterExtensionEntry> value) {
      writeExtensionAttribute(chipClusterPtr, callback, value, null);
    }

    public void writeExtensionAttribute(DefaultClusterCallback callback, ArrayList<ChipStructs.AccessControlClusterExtensionEntry> value, int timedWriteTimeoutMs) {
...
,
    ...
    private native void writeAclAttribute(long chipClusterPtr, DefaultClusterCallback callback, ArrayList<ChipStructs.AccessControlClusterAccessControlEntry> value, @Nullable Integer timedWriteTimeoutMs);
    ...
    private native void writeExtensionAttribute(long chipClusterPtr, DefaultClusterCallback callback, ArrayList<ChipStructs.AccessControlClusterExtensionEntry> value, @Nullable Integer timedWriteTimeoutMs);
...
, int minInterval, int maxInterval);
  ...
  public static class AdministratorCommissioningCluster extends BaseChipCluster {
    ...
    public void openCommissioningWindow(DefaultClusterCallback callback
      ...
      openCommissioningWindow(chipClusterPtr, callback, commissioningTimeout, PAKEVerifier, discriminator, iterations, salt, passcodeID, null);
    }

    public void openCommissioningWindow(DefaultClusterCallback callback
      , Integer commissioningTimeout, byte[] PAKEVerifier, Integer discriminator, Long iterations, byte[] salt, Integer passcodeID
      , int timedInvokeTimeoutMs) {
      openCommissioningWindow(chipClusterPtr, callback, commissioningTimeout, PAKEVerifier, discriminator, iterations, salt, passcodeID, timedInvokeTimeoutMs);
    }
...
, int minInterval, int maxInterval);
  ...
  public static class ApplicationLauncherCluster extends BaseChipCluster {
    ...
    public void launchAppRequest(LauncherResponseCallback callback
      , String data, ChipStructs.ApplicationLauncherClusterApplicationLauncherApplication application) {
    ...
    public void subscribeApplicationLauncherListAttribute(
        ApplicationLauncherListAttributeCallback callback
      ,
      int minInterval, int maxInterval) {
      subscribeApplicationLauncherListAttribute(chipClusterPtr, callback, minInterval, maxInterval);
    }
...
,
    ...
    private native void subscribeApplicationLauncherListAttribute(long chipClusterPtr,
        ApplicationLauncherListAttributeCallback callback
      , int minInterval, int maxInterval);
...
, int minInterval, int maxInterval);
  ...
  public static class AudioOutputCluster extends BaseChipCluster {
    ...
    public void subscribeAudioOutputListAttribute(
        AudioOutputListAttributeCallback callback
      ,
      int minInterval, int maxInterval) {
      subscribeAudioOutputListAttribute(chipClusterPtr, callback, minInterval, maxInterval);
    }
...
,
    ...
    private native void subscribeAudioOutputListAttribute(long chipClusterPtr,
        AudioOutputListAttributeCallback callback
      , int minInterval, int maxInterval);
...
, int minInterval, int maxInterval);
  ...
  public static class BindingCluster extends BaseChipCluster {
    ...
    public void unbind(DefaultClusterCallback callback
      , Long nodeId, Integer groupId, Integer endpointId, Long clusterId
      , int timedInvokeTimeoutMs) {
      unbind(chipClusterPtr, callback, nodeId, groupId, endpointId, clusterId, timedInvokeTimeoutMs);
    }
...
, int minInterval, int maxInterval);
  ...
  public static class ChannelCluster extends BaseChipCluster {
    ...
    public void changeChannelByNumberRequest(DefaultClusterCallback callback
      , Integer majorNumber, Integer minorNumber
      , int timedInvokeTimeoutMs) {
      changeChannelByNumberRequest(chipClusterPtr, callback, majorNumber, minorNumber, timedInvokeTimeoutMs);
    }
...
, int minInterval, int maxInterval);
  ...
  public static class ContentLauncherCluster extends BaseChipCluster {
    ...
    public void launchContentRequest(LaunchResponseCallback callback
      , Boolean autoPlay, String data, ArrayList<ChipStructs.ContentLauncherClusterContentSearch> search) {
    ...
    public void launchURLRequest(LaunchResponseCallback callback
      , String contentURL, String displayString, ChipStructs.ContentLauncherClusterBrandingInformation brandingInformation) {
      launchURLRequest(chipClusterPtr, callback, contentURL, displayString, brandingInformation, null);
    }

    public void launchURLRequest(LaunchResponseCallback callback
      , String contentURL, String displayString, ChipStructs.ContentLauncherClusterBrandingInformation brandingInformation
      , int timedInvokeTimeoutMs) {
      launchURLRequest(chipClusterPtr, callback, contentURL, displayString, brandingInformation, timedInvokeTimeoutMs);
    }
    ...
    public void subscribeAcceptHeaderListAttribute(
        AcceptHeaderListAttributeCallback callback
      ,
      int minInterval, int maxInterval) {
      subscribeAcceptHeaderListAttribute(chipClusterPtr, callback, minInterval, maxInterval);
    }
...
,
    ...
    private native void subscribeAcceptHeaderListAttribute(long chipClusterPtr,
        AcceptHeaderListAttributeCallback callback
      , int minInterval, int maxInterval);
...
,
    ...
    private native void subscribeDeviceListAttribute(long chipClusterPtr,
        DeviceListAttributeCallback callback
      , int minInterval, int maxInterval);
...
, int minInterval, int maxInterval);
  ...
  public static class DoorLockCluster extends BaseChipCluster {
    ...
    public void setCredential(SetCredentialResponseCallback callback
      , Integer operationType, ChipStructs.DoorLockClusterDlCredential credential, byte[] credentialData, @Nullable Integer userIndex, @Nullable Integer userStatus, @Nullable Integer userType) {
      setCredential(chipClusterPtr, callback, operationType, credential, credentialData, userIndex, userStatus, userType, null);
    }
    ...
    public void setUser(DefaultClusterCallback callback
      ...
      setUser(chipClusterPtr, callback, operationType, userIndex, userName, userUniqueId, userStatus, userType, credentialRule, null);
    }
    ...
    public interface GetCredentialStatusResponseCallback {
      void onSuccess(Boolean credentialExists, @Nullable Integer userIndex, @Nullable Integer nextCredentialIndex);

      void onError(Exception error);
    }

    public interface GetUserResponseCallback {
      void onSuccess(Integer userIndex, @Nullable String userName, @Nullable Long userUniqueId, @Nullable Integer userStatus, @Nullable Integer userType, @Nullable Integer credentialRule, @Nullable ArrayList<ChipStructs.DoorLockClusterDlCredential> credentials, @Nullable Integer creatorFabricIndex, @Nullable Integer lastModifiedFabricIndex, @Nullable Integer nextUserIndex);
...
, int minInterval, int maxInterval);
  ...
  public static class GeneralCommissioningCluster extends BaseChipCluster {
    ...
    public void armFailSafe(ArmFailSafeResponseCallback callback
      , Integer expiryLengthSeconds, Long breadcrumb, Long timeoutMs
      , int timedInvokeTimeoutMs) {
      armFailSafe(chipClusterPtr, callback, expiryLengthSeconds, breadcrumb, timeoutMs, timedInvokeTimeoutMs);
    }
    ...
    public void setRegulatoryConfig(SetRegulatoryConfigResponseCallback callback
      ...
      setRegulatoryConfig(chipClusterPtr, callback, location, countryCode, breadcrumb, timeoutMs, null);
    }

    public void setRegulatoryConfig(SetRegulatoryConfigResponseCallback callback
      , Integer location, String countryCode, Long breadcrumb, Long timeoutMs
      , int timedInvokeTimeoutMs) {
      setRegulatoryConfig(chipClusterPtr, callback, location, countryCode, breadcrumb, timeoutMs, timedInvokeTimeoutMs);
    }
    ...
    public interface SetRegulatoryConfigResponseCallback {
      ...
      public interface BasicCommissioningInfoListAttributeCallback {
        void onSuccess( List<ChipStructs.GeneralCommissioningClusterBasicCommissioningInfoType> valueList);
        void onError(Exception ex);
        default void onSubscriptionEstablished() {}
      }
      public interface AttributeListAttributeCallback {
...
,
    ...
    public void subscribeBasicCommissioningInfoListAttribute(
      ...
      ,
      int minInterval, int maxInterval) {
      subscribeBasicCommissioningInfoListAttribute(chipClusterPtr, callback, minInterval, maxInterval);
    }
...
, int minInterval, int maxInterval);
    ...
    private native void subscribeBasicCommissioningInfoListAttribute(long chipClusterPtr,
        BasicCommissioningInfoListAttributeCallback callback
      , int minInterval, int maxInterval);
...
, int minInterval, int maxInterval);
  ...
  public static class LevelControlCluster extends BaseChipCluster {
    ...
    public void move(DefaultClusterCallback callback
      , Integer moveMode, Integer rate, Integer optionMask, Integer optionOverride
      , int timedInvokeTimeoutMs) {
      move(chipClusterPtr, callback, moveMode, rate, optionMask, optionOverride, timedInvokeTimeoutMs);
    }
    ...
    public void moveToLevel(DefaultClusterCallback callback
      ...
      moveToLevel(chipClusterPtr, callback, level, transitionTime, optionMask, optionOverride, null);
    }

    public void moveToLevel(DefaultClusterCallback callback
      , Integer level, Integer transitionTime, Integer optionMask, Integer optionOverride
      , int timedInvokeTimeoutMs) {
      moveToLevel(chipClusterPtr, callback, level, transitionTime, optionMask, optionOverride, timedInvokeTimeoutMs);
    }
    ...
    public void step(DefaultClusterCallback callback
      ...
      step(chipClusterPtr, callback, stepMode, stepSize, transitionTime, optionMask, optionOverride, null);
    }

    public void step(DefaultClusterCallback callback
      , Integer stepMode, Integer stepSize, Integer transitionTime, Integer optionMask, Integer optionOverride
      , int timedInvokeTimeoutMs) {
      step(chipClusterPtr, callback, stepMode, stepSize, transitionTime, optionMask, optionOverride, timedInvokeTimeoutMs);
    }
    ...
    public void stepWithOnOff(DefaultClusterCallback callback
      , Integer stepMode, Integer stepSize, Integer transitionTime
      , int timedInvokeTimeoutMs) {
      stepWithOnOff(chipClusterPtr, callback, stepMode, stepSize, transitionTime, timedInvokeTimeoutMs);
    }
...
, int minInterval, int maxInterval);
  ...
  public static class MediaInputCluster extends BaseChipCluster {
    ...
    public void subscribeMediaInputListAttribute(
        MediaInputListAttributeCallback callback
      ,
      int minInterval, int maxInterval) {
      subscribeMediaInputListAttribute(chipClusterPtr, callback, minInterval, maxInterval);
    }
...
,
    ...
    private native void subscribeMediaInputListAttribute(long chipClusterPtr,
        MediaInputListAttributeCallback callback
      , int minInterval, int maxInterval);
...
, int minInterval, int maxInterval);
  ...
  public static class MediaPlaybackCluster extends BaseChipCluster {
    ...
    public void skipBackwardRequest(PlaybackResponseCallback callback
      , Long deltaPositionMilliseconds
      , int timedInvokeTimeoutMs) {
      skipBackwardRequest(chipClusterPtr, callback, deltaPositionMilliseconds, timedInvokeTimeoutMs);
    }
...
, int minInterval, int maxInterval);
    ...
    private native void subscribePlaybackSpeedAttribute(long chipClusterPtr,
        FloatAttributeCallback callback
, int minInterval, int maxInterval);
...
, int minInterval, int maxInterval);
  ...
  public static class NetworkCommissioningCluster extends BaseChipCluster {
    ...
    public interface ScanNetworksResponseCallback {
      void onSuccess(Integer networkingStatus, String debugText, Optional<ArrayList<ChipStructs.NetworkCommissioningClusterWiFiInterfaceScanResult>> wiFiScanResults, Optional<ArrayList<ChipStructs.NetworkCommissioningClusterThreadInterfaceScanResult>> threadScanResults);
...
, int minInterval, int maxInterval);
  ...
  public static class OperationalCredentialsCluster extends BaseChipCluster {
    ...
    public void addNOC(NOCResponseCallback callback
      ...
      addNOC(chipClusterPtr, callback, NOCValue, ICACValue, IPKValue, caseAdminNode, adminVendorId, null);
    }

    public void addNOC(NOCResponseCallback callback
      , byte[] NOCValue, Optional<byte[]> ICACValue, byte[] IPKValue, Long caseAdminNode, Integer adminVendorId
      , int timedInvokeTimeoutMs) {
      addNOC(chipClusterPtr, callback, NOCValue, ICACValue, IPKValue, caseAdminNode, adminVendorId, timedInvokeTimeoutMs);
    }
    ...
    public void removeTrustedRootCertificate(DefaultClusterCallback callback
      , byte[] trustedRootIdentifier
      , int timedInvokeTimeoutMs) {
      removeTrustedRootCertificate(chipClusterPtr, callback, trustedRootIdentifier, timedInvokeTimeoutMs);
    }
...
,
    ...
    private native void subscribeFabricsListAttribute(long chipClusterPtr,
        FabricsListAttributeCallback callback
      , int minInterval, int maxInterval);
...
, int minInterval, int maxInterval);
    ...
    private native void subscribeActiveBatteryFaultsAttribute(long chipClusterPtr,
        ActiveBatteryFaultsAttributeCallback callback
      , int minInterval, int maxInterval);
...
, int minInterval, int maxInterval);
  ...
  public static class ScenesCluster extends BaseChipCluster {
    ...
    public void addScene(AddSceneResponseCallback callback
      , Integer groupId, Integer sceneId, Integer transitionTime, String sceneName, ArrayList<ChipStructs.ScenesClusterSceneExtensionFieldSet> extensionFieldSets) {
    ...
    public interface GetSceneMembershipResponseCallback {
      void onSuccess(Integer status, Integer capacity, Integer groupId, Integer sceneCount, ArrayList<Integer> sceneList);
    ...
    public interface ViewSceneResponseCallback {
      void onSuccess(Integer status, Integer groupId, Integer sceneId, Integer transitionTime, String sceneName, ArrayList<ChipStructs.ScenesClusterSceneExtensionFieldSet> extensionFieldSets);
...
, int minInterval, int maxInterval);
  ...
  public static class TargetNavigatorCluster extends BaseChipCluster {
    ...
    public void subscribeTargetNavigatorListAttribute(
        TargetNavigatorListAttributeCallback callback
      ,
      int minInterval, int maxInterval) {
      subscribeTargetNavigatorListAttribute(chipClusterPtr, callback, minInterval, maxInterval);
    }
...
,
    ...
    private native void subscribeTargetNavigatorListAttribute(long chipClusterPtr,
        TargetNavigatorListAttributeCallback callback
      , int minInterval, int maxInterval);
...
, int minInterval, int maxInterval);
  ...
  public static class TestClusterCluster extends BaseChipCluster {
    ...
    public void testEmitTestEventRequest(TestEmitTestEventResponseCallback callback
...
,
    ...
    public void writeListStructOctetStringAttribute(DefaultClusterCallback callback, ArrayList<ChipStructs.TestClusterClusterTestListStructOctet> value) {
      writeListStructOctetStringAttribute(chipClusterPtr, callback, value, null);
    }

    public void writeListStructOctetStringAttribute(DefaultClusterCallback callback, ArrayList<ChipStructs.TestClusterClusterTestListStructOctet> value, int timedWriteTimeoutMs) {
...
,
    ...
    public void writeListNullablesAndOptionalsStructAttribute(DefaultClusterCallback callback, ArrayList<ChipStructs.TestClusterClusterNullablesAndOptionalsStruct> value) {
      writeListNullablesAndOptionalsStructAttribute(chipClusterPtr, callback, value, null);
    }

    public void writeListNullablesAndOptionalsStructAttribute(DefaultClusterCallback callback, ArrayList<ChipStructs.TestClusterClusterNullablesAndOptionalsStruct> value, int timedWriteTimeoutMs) {
...
, int minInterval, int maxInterval);
    ...
    private native void subscribeListInt8uAttribute(long chipClusterPtr,
        ListInt8uAttributeCallback callback
      , int minInterval, int maxInterval);
    ...
    private native void subscribeListOctetStringAttribute(long chipClusterPtr,
        ListOctetStringAttributeCallback callback
      , int minInterval, int maxInterval);
    ...
    private native void writeListStructOctetStringAttribute(long chipClusterPtr, DefaultClusterCallback callback, ArrayList<ChipStructs.TestClusterClusterTestListStructOctet> value, @Nullable Integer timedWriteTimeoutMs);
    private native void subscribeListStructOctetStringAttribute(long chipClusterPtr,
        ListStructOctetStringAttributeCallback callback
      , int minInterval, int maxInterval);
...
, int minInterval, int maxInterval);
    ...
    private native void writeListNullablesAndOptionalsStructAttribute(long chipClusterPtr, DefaultClusterCallback callback, ArrayList<ChipStructs.TestClusterClusterNullablesAndOptionalsStruct> value, @Nullable Integer timedWriteTimeoutMs);
    private native void subscribeListNullablesAndOptionalsStructAttribute(long chipClusterPtr,
        ListNullablesAndOptionalsStructAttributeCallback callback
      , int minInterval, int maxInterval);
...
, int minInterval, int maxInterval);
    ...
    private native void subscribeListLongOctetStringAttribute(long chipClusterPtr,
        ListLongOctetStringAttributeCallback callback
      , int minInterval, int maxInterval);
    ...
    private native void subscribeTimedWriteBooleanAttribute(long chipClusterPtr,
        BooleanAttributeCallback callback
, int minInterval, int maxInterval);

    private native void readGeneralErrorBooleanAttribute(long chipClusterPtr,
        BooleanAttributeCallback callback
    );
    ...
    private native void subscribeGeneralErrorBooleanAttribute(long chipClusterPtr,
        BooleanAttributeCallback callback
, int minInterval, int maxInterval);

    private native void readClusterErrorBooleanAttribute(long chipClusterPtr,
        BooleanAttributeCallback callback
    );
    ...
    private native void subscribeClusterErrorBooleanAttribute(long chipClusterPtr,
        BooleanAttributeCallback callback
, int minInterval, int maxInterval);
...
, int minInterval, int maxInterval);
  ...
  public static class ThermostatCluster extends BaseChipCluster {
    ...
    public void setWeeklySchedule(DefaultClusterCallback callback
      , Integer numberOfTransitionsForSequence, Integer dayOfWeekForSequence, Integer modeForSequence, ArrayList<Integer> payload) {
      setWeeklySchedule(chipClusterPtr, callback, numberOfTransitionsForSequence, dayOfWeekForSequence, modeForSequence, payload, null);
    }
    ...
    public interface GetRelayStatusLogResponseCallback {
      void onSuccess(Integer timeOfDay, Integer relayStatus, Integer localTemperature, Integer humidityInPercentage, Integer setpoint, Integer unreadEntries);

      void onError(Exception error);
    }

    public interface GetWeeklyScheduleResponseCallback {
      void onSuccess(Integer numberOfTransitionsForSequence, Integer dayOfWeekForSequence, Integer modeForSequence, ArrayList<Integer> payload);
  ...
  public static class ThreadNetworkDiagnosticsCluster extends BaseChipCluster {
    ...
    private native void resetCounts(long chipClusterPtr, DefaultClusterCallback Callback
      ...
      public interface SecurityPolicyAttributeCallback {
        void onSuccess( List<ChipStructs.ThreadNetworkDiagnosticsClusterSecurityPolicy> valueList);
        void onError(Exception ex);
        default void onSubscriptionEstablished() {}
      }
      public interface OperationalDatasetComponentsAttributeCallback {
        void onSuccess( List<ChipStructs.ThreadNetworkDiagnosticsClusterOperationalDatasetComponents> valueList);
        void onError(Exception ex);
        default void onSubscriptionEstablished() {}
      }
...
, int minInterval, int maxInterval);
    ...
    private native void subscribeNeighborTableListAttribute(long chipClusterPtr,
        NeighborTableListAttributeCallback callback
      , int minInterval, int maxInterval);
    ...
    private native void subscribeRouteTableListAttribute(long chipClusterPtr,
        RouteTableListAttributeCallback callback
      , int minInterval, int maxInterval);
...
, int minInterval, int maxInterval);
    ...
    private native void subscribeSecurityPolicyAttribute(long chipClusterPtr,
        SecurityPolicyAttributeCallback callback
      , int minInterval, int maxInterval);
...
, int minInterval, int maxInterval);
    ...
    private native void subscribeOperationalDatasetComponentsAttribute(long chipClusterPtr,
        OperationalDatasetComponentsAttributeCallback callback
      , int minInterval, int maxInterval);
...
, int minInterval, int maxInterval);
  ...
  public static class WindowCoveringCluster extends BaseChipCluster {
    ...
    public void goToLiftPercentage(DefaultClusterCallback callback
      ...
      goToLiftPercentage(chipClusterPtr, callback, liftPercentageValue, liftPercent100thsValue, null);
    }

    public void goToLiftPercentage(DefaultClusterCallback callback
      , Integer liftPercentageValue, Integer liftPercent100thsValue
      , int timedInvokeTimeoutMs) {
      goToLiftPercentage(chipClusterPtr, callback, liftPercentageValue, liftPercent100thsValue, timedInvokeTimeoutMs);
    }
    ...
    public void goToTiltPercentage(DefaultClusterCallback callback
      ...
      goToTiltPercentage(chipClusterPtr, callback, tiltPercentageValue, tiltPercent100thsValue, null);
    }

    public void goToTiltPercentage(DefaultClusterCallback callback
      , Integer tiltPercentageValue, Integer tiltPercent100thsValue
      , int timedInvokeTimeoutMs) {
      goToTiltPercentage(chipClusterPtr, callback, tiltPercentageValue, tiltPercent100thsValue, timedInvokeTimeoutMs);
    }
