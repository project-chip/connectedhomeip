...
public byte[] data;
  ...
  public AccessControlClusterExtensionEntry(
    Integer fabricIndex
      , byte[] data
  ) {
    this.fabricIndex = fabricIndex;
...
public String name;
  ...
  public AudioOutputClusterOutputInfo(
    Integer index
      , Integer outputType
      , String name
  ) {
...
public Integer metric;
  ...
  public ContentLauncherClusterDimension(
    Double width
      , Double height
      , Integer metric
  ) {
...
public String value;
  ...
  public ContentLauncherClusterAdditionalInfo(
    String name
      , String value
  ) {
    this.name = name;
...
public ChipStructs.ContentLauncherClusterDimension size;
  ...
  public ContentLauncherClusterStyleInformation(
    String imageUrl
      , String color
      , ChipStructs.ContentLauncherClusterDimension size
  ) {
...
public Integer revision;
  ...
  public DescriptorClusterDeviceType(
    Long type
      , Integer revision
  ) {
    this.type = type;
...
public Integer credentialIndex;
  ...
  public DoorLockClusterDlCredential(
...
public Long failSafeExpiryLengthMs;
  ...
  public GeneralCommissioningClusterBasicCommissioningInfoType(
...
public Long position;
  ...
  public MediaPlaybackClusterPlaybackPosition(
    Long updatedAt
      , Long position
  ) {
...
public Integer value;
  ...
  public ModeSelectClusterSemanticTag(
    Integer mfgCode
      , Integer value
  ) {
...
public String name;
  ...
  public TargetNavigatorClusterTargetInfo(
    Integer identifier
      , String name
  ) {
...
public byte[] operationalCert;
  ...
  public TestClusterClusterTestListStructOctet(
    Long fabricIndex
