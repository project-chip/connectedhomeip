        ...
        case Attributes::BasicCommissioningInfoList::Id: {
            ...
            *aError = app::DataModel::Decode(aReader, cppValue);
            ...
            while (iter_value_0.Next())
            {
                ...
                {
                    ChipLogError(Zcl,
                                 "Could not find ChipStructs$GeneralCommissioningClusterBasicCommissioningInfoType constructor");
                    return nullptr;
                }
        ...
        case Attributes::GroupKeyMap::Id: {
            ...
            *aError = app::DataModel::Decode(aReader, cppValue);
            ...
            while (iter_value_0.Next())
            {
                ...
                newElement_0 = env->NewObject(groupKeyStructClass, groupKeyStructCtor, newElement_0_fabricIndex,
        ...
        case Attributes::GroupTable::Id: {
            ...
            *aError = app::DataModel::Decode(aReader, cppValue);
            ...
            while (iter_value_0.Next())
            {
                ...
                jmethodID groupInfoStructCtor =
                    env->GetMethodID(groupInfoStructClass, "<init>",
                                     "(Ljava/lang/Integer;Ljava/lang/Integer;Ljava/util/ArrayList;Ljava/lang/String;)V");
                ...
                newElement_0 = env->NewObject(groupInfoStructClass, groupInfoStructCtor, newElement_0_fabricIndex,
