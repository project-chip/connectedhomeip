...
jobject DecodeAttributeValue(const app::ConcreteAttributePath & aPath, TLV::TLVReader & aReader, CHIP_ERROR * aError)
{
    ...
    newElement_3 = env->NewObject(targetStructClass, targetStructCtor
    ...
    chip::JniReferences::GetInstance().AddToList(value, newElement_0);
      ...
      jobject newElement_0_endpoints;
        ...
        std::string newElement_2CtorSignature = "(I)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint16_t>(newElement_2ClassName.c_str(), newElement_2CtorSignature.c_str(), entry_2, newElement_2);
  ...
  chip::JniReferences::GetInstance().CreateOptional(newElement_0_groupNameInsideOptional, newElement_0_groupName);
    ...
    value = env->NewObject(playbackPositionStructClass, playbackPositionStructCtor
      ...
      jobject newElement_0_mode;
        ...
        std::string newElement_2_mfgCodeCtorSignature = "(I)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint16_t>(newElement_2_mfgCodeClassName.c_str(), newElement_2_mfgCodeCtorSignature.c_str(), entry_2.mfgCode, newElement_2_mfgCode);
        ...
        std::string newElement_2_valueCtorSignature = "(I)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint16_t>(newElement_2_valueClassName.c_str(), newElement_2_valueCtorSignature.c_str(), entry_2.value, newElement_2_value);
      
    jclass semanticTagStructClass;
    err = chip::JniReferences::GetInstance().GetClassRef(env, "chip/devicecontroller/ChipStructs$ModeSelectClusterSemanticTag", semanticTagStructClass);
    if (err != CHIP_NO_ERROR) {
      ChipLogError(Zcl, "Could not find class ChipStructs$ModeSelectClusterSemanticTag");
      return nullptr;
    }
    jmethodID semanticTagStructCtor = env->GetMethodID(semanticTagStructClass, "<init>"
        , "(Ljava/lang/Integer;Ljava/lang/Integer;)V");
    ...
    newElement_2 = env->NewObject(semanticTagStructClass, semanticTagStructCtor
      , newElement_2_mfgCode
      , newElement_2_value
    );
    ...
    chip::JniReferences::GetInstance().AddToList(value, newElement_0);
      ...
      chip::JniReferences::GetInstance().CreateBoxedObject<uint16_t>(newElement_0_vendorIdClassName.c_str(), newElement_0_vendorIdCtorSignature.c_str(), static_cast<uint16_t>(entry_0.vendorId), newElement_0_vendorId);
  ...
  chip::JniReferences::GetInstance().CreateOptional(newElement_0_optionalStructInsideOptional, newElement_0_optionalStruct);
    ...
    newElement_0_nullableOptionalStructInsideOptional = env->NewObject(simpleStructStructClass, simpleStructStructCtor
      ...
      chip::JniReferences::GetInstance().CreateBoxedObject<uint8_t>(newElement_3ClassName.c_str(), newElement_3CtorSignature.c_str(), static_cast<uint8_t>(entry_3), newElement_3);
    ...
    chip::JniReferences::GetInstance().AddToList(newElement_0_optionalListInsideOptional, newElement_3);
      ...
      chip::JniReferences::GetInstance().CreateBoxedObject<uint8_t>(newElement_4ClassName.c_str(), newElement_4CtorSignature.c_str(), static_cast<uint8_t>(entry_4), newElement_4);
    ...
    value = env->NewObject(simpleStructStructClass, simpleStructStructCtor
      ...
      if (entry_0.averageRssi.IsNull()) {
        ...
        std::string newElement_0_averageRssiCtorSignature = "(I)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<int8_t>(newElement_0_averageRssiClassName.c_str(), newElement_0_averageRssiCtorSignature.c_str(), entry_0.averageRssi.Value(), newElement_0_averageRssi);
      }
      ...
      if (entry_0.lastRssi.IsNull()) {
        ...
        std::string newElement_0_lastRssiCtorSignature = "(I)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<int8_t>(newElement_0_lastRssiClassName.c_str(), newElement_0_lastRssiCtorSignature.c_str(), entry_0.lastRssi.Value(), newElement_0_lastRssi);
      }
    ...
    chip::JniReferences::GetInstance().AddToList(value, newElement_0);
        ...
        std::string value_rotationTimeCtorSignature = "(I)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint16_t>(value_rotationTimeClassName.c_str(), value_rotationTimeCtorSignature.c_str(), cppValue.Value().rotationTime, value_rotationTime);
            jobject value_flags;
              std::string value_flagsClassName = "java/lang/Integer";
        std::string value_flagsCtorSignature = "(I)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint16_t>(value_flagsClassName.c_str(), value_flagsCtorSignature.c_str(), cppValue.Value().flags, value_flags);
    ...
    value = env->NewObject(securityPolicyStructClass, securityPolicyStructCtor
      , value_rotationTime
      , value_flags
    );
}
        ...
        std::string value_activeTimestampPresentCtorSignature = "(Z)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<bool>(value_activeTimestampPresentClassName.c_str(), value_activeTimestampPresentCtorSignature.c_str(), cppValue.Value().activeTimestampPresent, value_activeTimestampPresent);
        ...
        std::string value_pendingTimestampPresentCtorSignature = "(Z)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<bool>(value_pendingTimestampPresentClassName.c_str(), value_pendingTimestampPresentCtorSignature.c_str(), cppValue.Value().pendingTimestampPresent, value_pendingTimestampPresent);
        ...
        std::string value_masterKeyPresentCtorSignature = "(Z)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<bool>(value_masterKeyPresentClassName.c_str(), value_masterKeyPresentCtorSignature.c_str(), cppValue.Value().masterKeyPresent, value_masterKeyPresent);
        ...
        std::string value_networkNamePresentCtorSignature = "(Z)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<bool>(value_networkNamePresentClassName.c_str(), value_networkNamePresentCtorSignature.c_str(), cppValue.Value().networkNamePresent, value_networkNamePresent);
        ...
        std::string value_extendedPanIdPresentCtorSignature = "(Z)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<bool>(value_extendedPanIdPresentClassName.c_str(), value_extendedPanIdPresentCtorSignature.c_str(), cppValue.Value().extendedPanIdPresent, value_extendedPanIdPresent);
        ...
        std::string value_meshLocalPrefixPresentCtorSignature = "(Z)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<bool>(value_meshLocalPrefixPresentClassName.c_str(), value_meshLocalPrefixPresentCtorSignature.c_str(), cppValue.Value().meshLocalPrefixPresent, value_meshLocalPrefixPresent);
        ...
        std::string value_delayPresentCtorSignature = "(Z)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<bool>(value_delayPresentClassName.c_str(), value_delayPresentCtorSignature.c_str(), cppValue.Value().delayPresent, value_delayPresent);
        ...
        std::string value_panIdPresentCtorSignature = "(Z)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<bool>(value_panIdPresentClassName.c_str(), value_panIdPresentCtorSignature.c_str(), cppValue.Value().panIdPresent, value_panIdPresent);
        ...
        std::string value_channelPresentCtorSignature = "(Z)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<bool>(value_channelPresentClassName.c_str(), value_channelPresentCtorSignature.c_str(), cppValue.Value().channelPresent, value_channelPresent);
        ...
        std::string value_pskcPresentCtorSignature = "(Z)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<bool>(value_pskcPresentClassName.c_str(), value_pskcPresentCtorSignature.c_str(), cppValue.Value().pskcPresent, value_pskcPresent);
        ...
        std::string value_securityPolicyPresentCtorSignature = "(Z)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<bool>(value_securityPolicyPresentClassName.c_str(), value_securityPolicyPresentCtorSignature.c_str(), cppValue.Value().securityPolicyPresent, value_securityPolicyPresent);
        ...
        std::string value_channelMaskPresentCtorSignature = "(Z)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<bool>(value_channelMaskPresentClassName.c_str(), value_channelMaskPresentCtorSignature.c_str(), cppValue.Value().channelMaskPresent, value_channelMaskPresent);
    ...
    value = env->NewObject(operationalDatasetComponentsStructClass, operationalDatasetComponentsStructCtor
      , value_activeTimestampPresent
      , value_pendingTimestampPresent
      , value_masterKeyPresent
      , value_networkNamePresent
      , value_extendedPanIdPresent
      , value_meshLocalPrefixPresent
      , value_delayPresent
      , value_panIdPresent
      , value_channelPresent
      , value_pskcPresent
      , value_securityPolicyPresent
      , value_channelMaskPresent
    );
}
                    return value;
                }
