...
jobject DecodeAttributeValue(const app::ConcreteAttributePath & aPath, TLV::TLVReader & aReader, CHIP_ERROR * aError)
{
    ...
    switch (aPath.mClusterId)
    {
      ...
      chip::JniReferences::GetInstance().CreateBoxedObject<uint8_t>(newElement_0_privilegeClassName.c_str(), newElement_0_privilegeCtorSignature.c_str(), static_cast<uint8_t>(entry_0.privilege), newElement_0_privilege);
      ...
      chip::JniReferences::GetInstance().CreateBoxedObject<uint8_t>(newElement_0_authModeClassName.c_str(), newElement_0_authModeCtorSignature.c_str(), static_cast<uint8_t>(entry_0.authMode), newElement_0_authMode);
      ...
      if (entry_0.subjects.IsNull()) {
        ...
        std::string newElement_NaNCtorSignature = "(J)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint64_t>(newElement_NaNClassName.c_str(), newElement_NaNCtorSignature.c_str(), entry_NaN, newElement_NaN);
      ...
      if (entry_NaN.cluster.IsNull()) {
        ...
        std::string newElement_NaN_clusterCtorSignature = "(J)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint32_t>(newElement_NaN_clusterClassName.c_str(), newElement_NaN_clusterCtorSignature.c_str(), entry_NaN.cluster.Value(), newElement_NaN_cluster);
      }
      ...
      if (entry_NaN.endpoint.IsNull()) {
        ...
        std::string newElement_NaN_endpointCtorSignature = "(I)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint16_t>(newElement_NaN_endpointClassName.c_str(), newElement_NaN_endpointCtorSignature.c_str(), entry_NaN.endpoint.Value(), newElement_NaN_endpoint);
      }
      ...
      if (entry_NaN.deviceType.IsNull()) {
        ...
        std::string newElement_NaN_deviceTypeCtorSignature = "(J)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint32_t>(newElement_NaN_deviceTypeClassName.c_str(), newElement_NaN_deviceTypeCtorSignature.c_str(), entry_NaN.deviceType.Value(), newElement_NaN_deviceType);
      }

    jclass targetStructClass;
    err = chip::JniReferences::GetInstance().GetClassRef(env, "chip/devicecontroller/ChipStructs$AccessControlClusterTarget", targetStructClass);
    if (err != CHIP_NO_ERROR) {
      ChipLogError(Zcl, "Could not find class ChipStructs$AccessControlClusterTarget");
      return nullptr;
    }
    jmethodID targetStructCtor = env->GetMethodID(targetStructClass, "<init>"
    ...
    newElement_NaN = env->NewObject(targetStructClass, targetStructCtor
      , newElement_NaN_cluster
      , newElement_NaN_endpoint
      , newElement_NaN_deviceType
    );
    ...
    jmethodID accessControlEntryStructCtor = env->GetMethodID(accessControlEntryStructClass, "<init>"
    ...
    newElement_0 = env->NewObject(accessControlEntryStructClass, accessControlEntryStructCtor
      , newElement_0_privilege
      , newElement_0_authMode
      , newElement_0_subjects
      , newElement_0_targets
    ...
    chip::JniReferences::GetInstance().AddToList(value, newElement_0);
        ...
        env->SetByteArrayRegion(newElement_0_dataByteArray, 0, static_cast<jsize>(entry_0.data.size()), reinterpret_cast<const jbyte *>(entry_0.data.data()));
    ...
    jmethodID extensionEntryStructCtor = env->GetMethodID(extensionEntryStructClass, "<init>"
    ...
    newElement_0 = env->NewObject(extensionEntryStructClass, extensionEntryStructCtor
      , newElement_0_data
      , newElement_0_fabricIndex
    );
    chip::JniReferences::GetInstance().AddToList(value, newElement_0);
        ...
        std::string valueCtorSignature = "(I)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint16_t>(valueClassName.c_str(), valueCtorSignature.c_str(), cppValue, value);
                          return value;
                }
        ...
        std::string newElement_0CtorSignature = "(J)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint32_t>(newElement_0ClassName.c_str(), newElement_0CtorSignature.c_str(), entry_0, newElement_0);
          chip::JniReferences::GetInstance().AddToList(value, newElement_0);
                      }
                    return value;
                }
                ...
                case Attributes::WindowStatus::Id: {
                    ...
                    *aError = app::DataModel::Decode(aReader, cppValue);
                    ...
                    jobject value;
                            std::string valueClassName = "java/lang/Integer";
        std::string valueCtorSignature = "(I)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint8_t>(valueClassName.c_str(), valueCtorSignature.c_str(), cppValue, value);
                          return value;
                }
        ...
        std::string value_catalogVendorIdCtorSignature = "(I)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint16_t>(value_catalogVendorIdClassName.c_str(), value_catalogVendorIdCtorSignature.c_str(), cppValue.catalogVendorId, value_catalogVendorId);
            jobject value_applicationId;
              value_applicationId = env->NewStringUTF(std::string(cppValue.applicationId.data(), cppValue.applicationId.size()).c_str());

    jclass applicationBasicApplicationStructClass;
    err = chip::JniReferences::GetInstance().GetClassRef(env, "chip/devicecontroller/ChipStructs$ApplicationBasicClusterApplicationBasicApplication", applicationBasicApplicationStructClass);
    if (err != CHIP_NO_ERROR) {
      ChipLogError(Zcl, "Could not find class ChipStructs$ApplicationBasicClusterApplicationBasicApplication");
      return nullptr;
    }
    jmethodID applicationBasicApplicationStructCtor = env->GetMethodID(applicationBasicApplicationStructClass, "<init>"
    ...
    value = env->NewObject(applicationBasicApplicationStructClass, applicationBasicApplicationStructCtor
                ...
                case Attributes::Status::Id: {
                    ...
                    *aError = app::DataModel::Decode(aReader, cppValue);
                    ...
                    jobject value;
                          std::string valueClassName = "java/lang/Integer";
      std::string valueCtorSignature = "(I)V";
      chip::JniReferences::GetInstance().CreateBoxedObject<uint8_t>(valueClassName.c_str(), valueCtorSignature.c_str(), static_cast<uint8_t>(cppValue), value);
                    return value;
                }
      ...
      chip::JniReferences::GetInstance().CreateBoxedObject<uint16_t>(newElement_0ClassName.c_str(), newElement_0CtorSignature.c_str(), static_cast<uint16_t>(entry_0), newElement_0);
    chip::JniReferences::GetInstance().AddToList(value, newElement_0);
                      }
                    return value;
                }
        ...
        std::string value_application_catalogVendorIdCtorSignature = "(I)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint16_t>(value_application_catalogVendorIdClassName.c_str(), value_application_catalogVendorIdCtorSignature.c_str(), cppValue.Value().application.catalogVendorId, value_application_catalogVendorId);
            jobject value_application_applicationId;
              value_application_applicationId = env->NewStringUTF(std::string(cppValue.Value().application.applicationId.data(), cppValue.Value().application.applicationId.size()).c_str());

    jclass applicationStructClass;
    err = chip::JniReferences::GetInstance().GetClassRef(env, "chip/devicecontroller/ChipStructs$ApplicationLauncherClusterApplication", applicationStructClass);
    if (err != CHIP_NO_ERROR) {
      ChipLogError(Zcl, "Could not find class ChipStructs$ApplicationLauncherClusterApplication");
      return nullptr;
    }
    jmethodID applicationStructCtor = env->GetMethodID(applicationStructClass, "<init>"
        , "(Ljava/lang/Integer;Ljava/lang/String;)V");
    ...
    value_application = env->NewObject(applicationStructClass, applicationStructCtor
      ...
      if (!cppValue.Value().endpoint.HasValue()) {
        ...
        std::string value_endpointInsideOptionalCtorSignature = "(I)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint16_t>(value_endpointInsideOptionalClassName.c_str(), value_endpointInsideOptionalCtorSignature.c_str(), cppValue.Value().endpoint.Value(), value_endpointInsideOptional);
        chip::JniReferences::GetInstance().CreateOptional(value_endpointInsideOptional, value_endpoint);
      }

    jclass applicationEPStructClass;
    err = chip::JniReferences::GetInstance().GetClassRef(env, "chip/devicecontroller/ChipStructs$ApplicationLauncherClusterApplicationEP", applicationEPStructClass);
    if (err != CHIP_NO_ERROR) {
      ChipLogError(Zcl, "Could not find class ChipStructs$ApplicationLauncherClusterApplicationEP");
      return nullptr;
    }
    jmethodID applicationEPStructCtor = env->GetMethodID(applicationEPStructClass, "<init>"
    ...
    value = env->NewObject(applicationEPStructClass, applicationEPStructCtor
      , value_application
      , value_endpoint
    );
}
        ...
        std::string newElement_0_indexCtorSignature = "(I)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint8_t>(newElement_0_indexClassName.c_str(), newElement_0_indexCtorSignature.c_str(), entry_0.index, newElement_0_index);
      ...
      chip::JniReferences::GetInstance().CreateBoxedObject<uint8_t>(newElement_0_outputTypeClassName.c_str(), newElement_0_outputTypeCtorSignature.c_str(), static_cast<uint8_t>(entry_0.outputType), newElement_0_outputType);
    ...
    err = chip::JniReferences::GetInstance().GetClassRef(env, "chip/devicecontroller/ChipStructs$AudioOutputClusterOutputInfo", outputInfoStructClass);
    if (err != CHIP_NO_ERROR) {
    ...
    newElement_0 = env->NewObject(outputInfoStructClass, outputInfoStructCtor
      , newElement_0_index
      , newElement_0_outputType
      , newElement_0_name
    );
    chip::JniReferences::GetInstance().AddToList(value, newElement_0);
                      }
                ...
                case Attributes::VendorID::Id: {
                    ...
                    *aError = app::DataModel::Decode(aReader, cppValue);
                    ...
                    jobject value;
                          std::string valueClassName = "java/lang/Integer";
      std::string valueCtorSignature = "(I)V";
      chip::JniReferences::GetInstance().CreateBoxedObject<uint16_t>(valueClassName.c_str(), valueCtorSignature.c_str(), static_cast<uint16_t>(cppValue), value);
                    return value;
                }
        ...
        std::string valueCtorSignature = "(J)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint32_t>(valueClassName.c_str(), valueCtorSignature.c_str(), cppValue, value);
                          return value;
                }
        ...
        std::string valueCtorSignature = "(Z)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<bool>(valueClassName.c_str(), valueCtorSignature.c_str(), cppValue, value);
                          return value;
                }
        ...
        std::string value_caseSessionsPerFabricCtorSignature = "(I)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint16_t>(value_caseSessionsPerFabricClassName.c_str(), value_caseSessionsPerFabricCtorSignature.c_str(), cppValue.caseSessionsPerFabric, value_caseSessionsPerFabric);
    ...
    jmethodID capabilityMinimaStructStructCtor = env->GetMethodID(capabilityMinimaStructStructClass, "<init>"
    ...
    value = env->NewObject(capabilityMinimaStructStructClass, capabilityMinimaStructStructCtor
      ...
      if (!entry_0.node.HasValue()) {
        ...
        std::string newElement_0_nodeInsideOptionalCtorSignature = "(J)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint64_t>(newElement_0_nodeInsideOptionalClassName.c_str(), newElement_0_nodeInsideOptionalCtorSignature.c_str(), entry_0.node.Value(), newElement_0_nodeInsideOptional);
      ...
      if (!entry_0.group.HasValue()) {
        ...
        std::string newElement_0_groupInsideOptionalCtorSignature = "(I)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint16_t>(newElement_0_groupInsideOptionalClassName.c_str(), newElement_0_groupInsideOptionalCtorSignature.c_str(), entry_0.group.Value(), newElement_0_groupInsideOptional);
      ...
      if (!entry_0.endpoint.HasValue()) {
        ...
        std::string newElement_0_endpointInsideOptionalCtorSignature = "(I)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint16_t>(newElement_0_endpointInsideOptionalClassName.c_str(), newElement_0_endpointInsideOptionalCtorSignature.c_str(), entry_0.endpoint.Value(), newElement_0_endpointInsideOptional);
      ...
      if (!entry_0.cluster.HasValue()) {
        ...
        std::string newElement_0_clusterInsideOptionalCtorSignature = "(J)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint32_t>(newElement_0_clusterInsideOptionalClassName.c_str(), newElement_0_clusterInsideOptionalCtorSignature.c_str(), entry_0.cluster.Value(), newElement_0_clusterInsideOptional);
    ...
    jmethodID targetStructStructCtor = env->GetMethodID(targetStructStructClass, "<init>"
    ...
    newElement_0 = env->NewObject(targetStructStructClass, targetStructStructCtor
      , newElement_0_node
      , newElement_0_group
    ...
    chip::JniReferences::GetInstance().AddToList(value, newElement_0);
        ...
        std::string newElement_0_actionIDCtorSignature = "(I)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint16_t>(newElement_0_actionIDClassName.c_str(), newElement_0_actionIDCtorSignature.c_str(), entry_0.actionID, newElement_0_actionID);
            jobject newElement_0_name;
              newElement_0_name = env->NewStringUTF(std::string(entry_0.name.data(), entry_0.name.size()).c_str());
      ...
      jobject newElement_0_endpointListID;
        ...
        std::string newElement_0_endpointListIDCtorSignature = "(I)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint16_t>(newElement_0_endpointListIDClassName.c_str(), newElement_0_endpointListIDCtorSignature.c_str(), entry_0.endpointListID, newElement_0_endpointListID);
        ...
        std::string newElement_0_supportedCommandsCtorSignature = "(I)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint16_t>(newElement_0_supportedCommandsClassName.c_str(), newElement_0_supportedCommandsCtorSignature.c_str(), entry_0.supportedCommands, newElement_0_supportedCommands);
      ...
      chip::JniReferences::GetInstance().CreateBoxedObject<uint8_t>(newElement_0_statusClassName.c_str(), newElement_0_statusCtorSignature.c_str(), static_cast<uint8_t>(entry_0.status), newElement_0_status);

    jclass actionStructStructClass;
    err = chip::JniReferences::GetInstance().GetClassRef(env, "chip/devicecontroller/ChipStructs$BridgedActionsClusterActionStruct", actionStructStructClass);
    if (err != CHIP_NO_ERROR) {
      ChipLogError(Zcl, "Could not find class ChipStructs$BridgedActionsClusterActionStruct");
      return nullptr;
    }
    jmethodID actionStructStructCtor = env->GetMethodID(actionStructStructClass, "<init>"
    ...
    newElement_0 = env->NewObject(actionStructStructClass, actionStructStructCtor
      , newElement_0_actionID
      , newElement_0_name
      , newElement_0_type
      , newElement_0_endpointListID
      , newElement_0_supportedCommands
      , newElement_0_status
    );
    chip::JniReferences::GetInstance().AddToList(value, newElement_0);
                      }
      ...
      jobject newElement_0_endpoints;
        ...
        std::string newElement_NaNCtorSignature = "(I)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint16_t>(newElement_NaNClassName.c_str(), newElement_NaNCtorSignature.c_str(), entry_NaN, newElement_NaN);
          chip::JniReferences::GetInstance().AddToList(newElement_0_endpoints, newElement_NaN);
        }

    jclass endpointListStructStructClass;
    err = chip::JniReferences::GetInstance().GetClassRef(env, "chip/devicecontroller/ChipStructs$BridgedActionsClusterEndpointListStruct", endpointListStructStructClass);
    if (err != CHIP_NO_ERROR) {
      ChipLogError(Zcl, "Could not find class ChipStructs$BridgedActionsClusterEndpointListStruct");
      return nullptr;
    }
    jmethodID endpointListStructStructCtor = env->GetMethodID(endpointListStructStructClass, "<init>"
    ...
    newElement_0 = env->NewObject(endpointListStructStructClass, endpointListStructStructCtor
      , newElement_0_endpointListID
      , newElement_0_name
      , newElement_0_type
    ...
    chip::JniReferences::GetInstance().AddToList(value, newElement_0);
      ...
      chip::JniReferences::GetInstance().CreateBoxedObject<uint16_t>(valueClassName.c_str(), valueCtorSignature.c_str(), static_cast<uint16_t>(cppValue), value);
        ...
        std::string newElement_0_majorNumberCtorSignature = "(I)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint16_t>(newElement_0_majorNumberClassName.c_str(), newElement_0_majorNumberCtorSignature.c_str(), entry_0.majorNumber, newElement_0_majorNumber);
        ...
        std::string newElement_0_minorNumberCtorSignature = "(I)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint16_t>(newElement_0_minorNumberClassName.c_str(), newElement_0_minorNumberCtorSignature.c_str(), entry_0.minorNumber, newElement_0_minorNumber);
            jobject newElement_0_name;
      if (!entry_0.name.HasValue()) {
        chip::JniReferences::GetInstance().CreateOptional(nullptr, newElement_0_name);
      } else {
        jobject newElement_0_nameInsideOptional;
                newElement_0_nameInsideOptional = env->NewStringUTF(std::string(entry_0.name.Value().data(), entry_0.name.Value().size()).c_str());
  chip::JniReferences::GetInstance().CreateOptional(newElement_0_nameInsideOptional, newElement_0_name);
      ...
      if (!entry_0.callSign.HasValue()) {
        ...
        jobject newElement_0_callSignInsideOptional;
                newElement_0_callSignInsideOptional = env->NewStringUTF(std::string(entry_0.callSign.Value().data(), entry_0.callSign.Value().size()).c_str());
  chip::JniReferences::GetInstance().CreateOptional(newElement_0_callSignInsideOptional, newElement_0_callSign);
      ...
      if (!entry_0.affiliateCallSign.HasValue()) {
        ...
        jobject newElement_0_affiliateCallSignInsideOptional;
                newElement_0_affiliateCallSignInsideOptional = env->NewStringUTF(std::string(entry_0.affiliateCallSign.Value().data(), entry_0.affiliateCallSign.Value().size()).c_str());
  chip::JniReferences::GetInstance().CreateOptional(newElement_0_affiliateCallSignInsideOptional, newElement_0_affiliateCallSign);
      }

    jclass channelInfoStructClass;
    err = chip::JniReferences::GetInstance().GetClassRef(env, "chip/devicecontroller/ChipStructs$ChannelClusterChannelInfo", channelInfoStructClass);
    if (err != CHIP_NO_ERROR) {
      ChipLogError(Zcl, "Could not find class ChipStructs$ChannelClusterChannelInfo");
      return nullptr;
    }
    jmethodID channelInfoStructCtor = env->GetMethodID(channelInfoStructClass, "<init>"
    ...
    chip::JniReferences::GetInstance().AddToList(value, newElement_0);
              ...
              value_operatorName = env->NewStringUTF(std::string(cppValue.Value().operatorName.data(), cppValue.Value().operatorName.size()).c_str());
      ...
      if (!cppValue.Value().lineupName.HasValue()) {
        ...
        jobject value_lineupNameInsideOptional;
                value_lineupNameInsideOptional = env->NewStringUTF(std::string(cppValue.Value().lineupName.Value().data(), cppValue.Value().lineupName.Value().size()).c_str());
  chip::JniReferences::GetInstance().CreateOptional(value_lineupNameInsideOptional, value_lineupName);
      ...
      if (!cppValue.Value().postalCode.HasValue()) {
        ...
        jobject value_postalCodeInsideOptional;
                value_postalCodeInsideOptional = env->NewStringUTF(std::string(cppValue.Value().postalCode.Value().data(), cppValue.Value().postalCode.Value().size()).c_str());
  chip::JniReferences::GetInstance().CreateOptional(value_postalCodeInsideOptional, value_postalCode);
      ...
      chip::JniReferences::GetInstance().CreateBoxedObject<uint8_t>(value_lineupInfoTypeClassName.c_str(), value_lineupInfoTypeCtorSignature.c_str(), static_cast<uint8_t>(cppValue.Value().lineupInfoType), value_lineupInfoType);

    jclass lineupInfoStructClass;
    err = chip::JniReferences::GetInstance().GetClassRef(env, "chip/devicecontroller/ChipStructs$ChannelClusterLineupInfo", lineupInfoStructClass);
    if (err != CHIP_NO_ERROR) {
      ChipLogError(Zcl, "Could not find class ChipStructs$ChannelClusterLineupInfo");
      return nullptr;
    }
    jmethodID lineupInfoStructCtor = env->GetMethodID(lineupInfoStructClass, "<init>"
    ...
    value = env->NewObject(lineupInfoStructClass, lineupInfoStructCtor
      , value_operatorName
      , value_lineupName
      , value_postalCode
      , value_lineupInfoType
        ...
        std::string value_majorNumberCtorSignature = "(I)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint16_t>(value_majorNumberClassName.c_str(), value_majorNumberCtorSignature.c_str(), cppValue.Value().majorNumber, value_majorNumber);
        ...
        std::string value_minorNumberCtorSignature = "(I)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint16_t>(value_minorNumberClassName.c_str(), value_minorNumberCtorSignature.c_str(), cppValue.Value().minorNumber, value_minorNumber);
            jobject value_name;
      if (!cppValue.Value().name.HasValue()) {
        ...
        jobject value_nameInsideOptional;
                value_nameInsideOptional = env->NewStringUTF(std::string(cppValue.Value().name.Value().data(), cppValue.Value().name.Value().size()).c_str());
  chip::JniReferences::GetInstance().CreateOptional(value_nameInsideOptional, value_name);
      ...
      if (!cppValue.Value().callSign.HasValue()) {
        ...
        jobject value_callSignInsideOptional;
                value_callSignInsideOptional = env->NewStringUTF(std::string(cppValue.Value().callSign.Value().data(), cppValue.Value().callSign.Value().size()).c_str());
  chip::JniReferences::GetInstance().CreateOptional(value_callSignInsideOptional, value_callSign);
      ...
      if (!cppValue.Value().affiliateCallSign.HasValue()) {
        ...
        jobject value_affiliateCallSignInsideOptional;
                value_affiliateCallSignInsideOptional = env->NewStringUTF(std::string(cppValue.Value().affiliateCallSign.Value().data(), cppValue.Value().affiliateCallSign.Value().size()).c_str());
  chip::JniReferences::GetInstance().CreateOptional(value_affiliateCallSignInsideOptional, value_affiliateCallSign);
      }
    ...
    value = env->NewObject(channelInfoStructClass, channelInfoStructCtor
      , value_majorNumber
      , value_minorNumber
      , value_name
      , value_callSign
    ...
    chip::JniReferences::GetInstance().AddToList(value, newElement_0);
        ...
        std::string newElement_0_typeCtorSignature = "(J)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint32_t>(newElement_0_typeClassName.c_str(), newElement_0_typeCtorSignature.c_str(), entry_0.type, newElement_0_type);
    ...
    jmethodID deviceTypeStructCtor = env->GetMethodID(deviceTypeStructClass, "<init>"
    ...
    newElement_0 = env->NewObject(deviceTypeStructClass, deviceTypeStructCtor
      , newElement_0_type
                    ...
                    *aError = app::DataModel::Decode(aReader, cppValue);
                    ...
                    if (cppValue.IsNull()) {
                      value = nullptr;
                            ...
                            std::string valueClassName = "java/lang/Integer";
      std::string valueCtorSignature = "(I)V";
      chip::JniReferences::GetInstance().CreateBoxedObject<uint8_t>(valueClassName.c_str(), valueCtorSignature.c_str(), static_cast<uint8_t>(cppValue.Value()), value);
}
                    return value;
                }
                ...
                case Attributes::SupportedOperatingModes::Id: {
                    ...
                    *aError = app::DataModel::Decode(aReader, cppValue);
                    ...
                    jobject value;
                            std::string valueClassName = "java/lang/Integer";
        std::string valueCtorSignature = "(I)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint16_t>(valueClassName.c_str(), valueCtorSignature.c_str(), cppValue.Raw(), value);
                          return value;
                }
                ...
                case Attributes::TotalActivePower::Id: {
                    ...
                    *aError = app::DataModel::Decode(aReader, cppValue);
                    ...
                    jobject value;
                            std::string valueClassName = "java/lang/Long";
        std::string valueCtorSignature = "(J)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<int32_t>(valueClassName.c_str(), valueCtorSignature.c_str(), cppValue, value);
                          return value;
                }
                ...
                case Attributes::ActivePower::Id: {
                    ...
                    *aError = app::DataModel::Decode(aReader, cppValue);
                    ...
                    jobject value;
                            std::string valueClassName = "java/lang/Integer";
        std::string valueCtorSignature = "(I)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<int16_t>(valueClassName.c_str(), valueCtorSignature.c_str(), cppValue, value);
                          return value;
                }
                    ...
                    *aError = app::DataModel::Decode(aReader, cppValue);
                    ...
                    if (cppValue.IsNull()) {
                      value = nullptr;
                              ...
                              std::string valueClassName = "java/lang/Boolean";
        std::string valueCtorSignature = "(Z)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<bool>(valueClassName.c_str(), valueCtorSignature.c_str(), cppValue.Value(), value);
      }
                    return value;
                }
                case Attributes::PacketRxCount::Id: {
                    ...
                    *aError = app::DataModel::Decode(aReader, cppValue);
                    ...
                    jobject value;
                            std::string valueClassName = "java/lang/Long";
        std::string valueCtorSignature = "(J)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint64_t>(valueClassName.c_str(), valueCtorSignature.c_str(), cppValue, value);
                          return value;
                }
    ...
    err = chip::JniReferences::GetInstance().GetClassRef(env, "chip/devicecontroller/ChipStructs$FixedLabelClusterLabelStruct", labelStructStructClass);
    if (err != CHIP_NO_ERROR) {
      ChipLogError(Zcl, "Could not find class ChipStructs$FixedLabelClusterLabelStruct");
      return nullptr;
    }
    jmethodID labelStructStructCtor = env->GetMethodID(labelStructStructClass, "<init>"
    ...
    newElement_0 = env->NewObject(labelStructStructClass, labelStructStructCtor
      , newElement_0_label
      , newElement_0_value
    );
    chip::JniReferences::GetInstance().AddToList(value, newElement_0);
                    ...
                    *aError = app::DataModel::Decode(aReader, cppValue);
                    ...
                    if (cppValue.IsNull()) {
                      value = nullptr;
                              ...
                              std::string valueClassName = "java/lang/Integer";
        std::string valueCtorSignature = "(I)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint16_t>(valueClassName.c_str(), valueCtorSignature.c_str(), cppValue.Value(), value);
      }
                    return value;
                }
    ...
    jmethodID basicCommissioningInfoStructCtor = env->GetMethodID(basicCommissioningInfoStructClass, "<init>"
    ...
    value = env->NewObject(basicCommissioningInfoStructClass, basicCommissioningInfoStructCtor
      ...
      jobject newElement_0_isOperational;
        ...
        std::string newElement_0_isOperationalCtorSignature = "(Z)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<bool>(newElement_0_isOperationalClassName.c_str(), newElement_0_isOperationalCtorSignature.c_str(), entry_0.isOperational, newElement_0_isOperational);
      ...
      if (entry_0.offPremiseServicesReachableIPv4.IsNull()) {
        ...
        std::string newElement_0_offPremiseServicesReachableIPv4CtorSignature = "(Z)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<bool>(newElement_0_offPremiseServicesReachableIPv4ClassName.c_str(), newElement_0_offPremiseServicesReachableIPv4CtorSignature.c_str(), entry_0.offPremiseServicesReachableIPv4.Value(), newElement_0_offPremiseServicesReachableIPv4);
      }
      ...
      if (entry_0.offPremiseServicesReachableIPv6.IsNull()) {
        ...
        std::string newElement_0_offPremiseServicesReachableIPv6CtorSignature = "(Z)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<bool>(newElement_0_offPremiseServicesReachableIPv6ClassName.c_str(), newElement_0_offPremiseServicesReachableIPv6CtorSignature.c_str(), entry_0.offPremiseServicesReachableIPv6.Value(), newElement_0_offPremiseServicesReachableIPv6);
      }
      jobject newElement_0_hardwareAddress;
        ...
        env->SetByteArrayRegion(newElement_0_hardwareAddressByteArray, 0, static_cast<jsize>(entry_0.hardwareAddress.size()), reinterpret_cast<const jbyte *>(entry_0.hardwareAddress.data()));
      ...
      jobject newElement_0_IPv4Addresses;
        ...
        env->SetByteArrayRegion(newElement_NaNByteArray, 0, static_cast<jsize>(entry_NaN.size()), reinterpret_cast<const jbyte *>(entry_NaN.data()));
    ...
    err = chip::JniReferences::GetInstance().GetClassRef(env, "chip/devicecontroller/ChipStructs$GeneralDiagnosticsClusterNetworkInterfaceType", networkInterfaceTypeStructClass);
    if (err != CHIP_NO_ERROR) {
      ChipLogError(Zcl, "Could not find class ChipStructs$GeneralDiagnosticsClusterNetworkInterfaceType");
      return nullptr;
    }
    jmethodID networkInterfaceTypeStructCtor = env->GetMethodID(networkInterfaceTypeStructClass, "<init>"
        , "(Ljava/lang/String;Ljava/lang/Boolean;Ljava/lang/Boolean;Ljava/lang/Boolean;[BLjava/util/ArrayList;Ljava/util/ArrayList;Ljava/lang/Integer;)V");
    ...
    newElement_0 = env->NewObject(networkInterfaceTypeStructClass, networkInterfaceTypeStructCtor
      , newElement_0_name
      , newElement_0_isOperational
      , newElement_0_offPremiseServicesReachableIPv4
      , newElement_0_offPremiseServicesReachableIPv6
      , newElement_0_hardwareAddress
      , newElement_0_IPv4Addresses
      , newElement_0_IPv6Addresses
      , newElement_0_type
    );
    chip::JniReferences::GetInstance().AddToList(value, newElement_0);
                      }
        ...
        std::string newElement_0_groupKeySetIDCtorSignature = "(I)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint16_t>(newElement_0_groupKeySetIDClassName.c_str(), newElement_0_groupKeySetIDCtorSignature.c_str(), entry_0.groupKeySetID, newElement_0_groupKeySetID);
            jobject newElement_0_fabricIndex;
              std::string newElement_0_fabricIndexClassName = "java/lang/Integer";
        std::string newElement_0_fabricIndexCtorSignature = "(I)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint8_t>(newElement_0_fabricIndexClassName.c_str(), newElement_0_fabricIndexCtorSignature.c_str(), entry_0.fabricIndex, newElement_0_fabricIndex);
    ...
    newElement_0 = env->NewObject(groupKeyMapStructStructClass, groupKeyMapStructStructCtor
    ...
    chip::JniReferences::GetInstance().AddToList(value, newElement_0);
      ...
      if (!entry_0.groupName.HasValue()) {
        ...
        jobject newElement_0_groupNameInsideOptional;
                newElement_0_groupNameInsideOptional = env->NewStringUTF(std::string(entry_0.groupName.Value().data(), entry_0.groupName.Value().size()).c_str());
  chip::JniReferences::GetInstance().CreateOptional(newElement_0_groupNameInsideOptional, newElement_0_groupName);
    ...
    jmethodID groupInfoMapStructStructCtor = env->GetMethodID(groupInfoMapStructStructClass, "<init>"
    ...
    newElement_0 = env->NewObject(groupInfoMapStructStructClass, groupInfoMapStructStructCtor
      , newElement_0_groupId
      , newElement_0_endpoints
                    ...
                    *aError = app::DataModel::Decode(aReader, cppValue);
                    ...
                    if (cppValue.IsNull()) {
                      value = nullptr;
                              ...
                              std::string valueClassName = "java/lang/Integer";
        std::string valueCtorSignature = "(I)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint8_t>(valueClassName.c_str(), valueCtorSignature.c_str(), cppValue.Value(), value);
      }
                    return value;
                }
                case Attributes::GeneratedCommandList::Id: {
    ...
    chip::JniReferences::GetInstance().AddToList(value, newElement_0);
      ...
      chip::JniReferences::GetInstance().CreateBoxedObject<uint8_t>(newElement_0_inputTypeClassName.c_str(), newElement_0_inputTypeCtorSignature.c_str(), static_cast<uint8_t>(entry_0.inputType), newElement_0_inputType);
      jobject newElement_0_name;
              newElement_0_name = env->NewStringUTF(std::string(entry_0.name.data(), entry_0.name.size()).c_str());
    ...
    err = chip::JniReferences::GetInstance().GetClassRef(env, "chip/devicecontroller/ChipStructs$MediaInputClusterInputInfo", inputInfoStructClass);
    if (err != CHIP_NO_ERROR) {
      ChipLogError(Zcl, "Could not find class ChipStructs$MediaInputClusterInputInfo");
      return nullptr;
    }
    jmethodID inputInfoStructCtor = env->GetMethodID(inputInfoStructClass, "<init>"
    ...
    newElement_0 = env->NewObject(inputInfoStructClass, inputInfoStructCtor
      , newElement_0_index
    ...
    chip::JniReferences::GetInstance().AddToList(value, newElement_0);
      ...
      chip::JniReferences::GetInstance().CreateBoxedObject<uint8_t>(valueClassName.c_str(), valueCtorSignature.c_str(), static_cast<uint8_t>(cppValue), value);
                    ...
                    *aError = app::DataModel::Decode(aReader, cppValue);
                    ...
                    if (cppValue.IsNull()) {
                      value = nullptr;
                              ...
                              std::string valueClassName = "java/lang/Long";
        std::string valueCtorSignature = "(J)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint64_t>(valueClassName.c_str(), valueCtorSignature.c_str(), cppValue.Value(), value);
      }
                    return value;
                }
        ...
        std::string value_updatedAtCtorSignature = "(J)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint64_t>(value_updatedAtClassName.c_str(), value_updatedAtCtorSignature.c_str(), cppValue.Value().updatedAt, value_updatedAt);
      ...
      if (cppValue.Value().position.IsNull()) {
        ...
        std::string value_positionCtorSignature = "(J)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint64_t>(value_positionClassName.c_str(), value_positionCtorSignature.c_str(), cppValue.Value().position.Value(), value_position);
      }

    jclass playbackPositionStructClass;
    err = chip::JniReferences::GetInstance().GetClassRef(env, "chip/devicecontroller/ChipStructs$MediaPlaybackClusterPlaybackPosition", playbackPositionStructClass);
    if (err != CHIP_NO_ERROR) {
      ChipLogError(Zcl, "Could not find class ChipStructs$MediaPlaybackClusterPlaybackPosition");
      return nullptr;
    }
    jmethodID playbackPositionStructCtor = env->GetMethodID(playbackPositionStructClass, "<init>"
    ...
    value = env->NewObject(playbackPositionStructClass, playbackPositionStructCtor
      , value_updatedAt
      , value_position
    );
}
        ...
        std::string valueCtorSignature = "(F)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<float>(valueClassName.c_str(), valueCtorSignature.c_str(), cppValue, value);
                          return value;
                }
      ...
      jobject newElement_0_mode;
        ...
        std::string newElement_0_modeCtorSignature = "(I)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint8_t>(newElement_0_modeClassName.c_str(), newElement_0_modeCtorSignature.c_str(), entry_0.mode, newElement_0_mode);
    ...
    newElement_0 = env->NewObject(modeOptionStructStructClass, modeOptionStructStructCtor
      , newElement_0_label
      , newElement_0_mode
      , newElement_0_semanticTag
    );
    chip::JniReferences::GetInstance().AddToList(value, newElement_0);
                      }
                    return value;
        ...
        env->SetByteArrayRegion(newElement_0_networkIDByteArray, 0, static_cast<jsize>(entry_0.networkID.size()), reinterpret_cast<const jbyte *>(entry_0.networkID.data()));
    ...
    jmethodID networkInfoStructCtor = env->GetMethodID(networkInfoStructClass, "<init>"
    ...
    newElement_0 = env->NewObject(networkInfoStructClass, networkInfoStructCtor
      , newElement_0_networkID
    ...
    chip::JniReferences::GetInstance().AddToList(value, newElement_0);
      ...
      chip::JniReferences::GetInstance().CreateBoxedObject<uint8_t>(valueClassName.c_str(), valueCtorSignature.c_str(), static_cast<uint8_t>(cppValue.Value()), value);
        ...
        env->SetByteArrayRegion(valueByteArray, 0, static_cast<jsize>(cppValue.Value().size()), reinterpret_cast<const jbyte *>(cppValue.Value().data()));
                    ...
                    *aError = app::DataModel::Decode(aReader, cppValue);
                    ...
                    if (cppValue.IsNull()) {
                      value = nullptr;
                              ...
                              std::string valueClassName = "java/lang/Long";
        std::string valueCtorSignature = "(J)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<int32_t>(valueClassName.c_str(), valueCtorSignature.c_str(), cppValue.Value(), value);
      }
                    return value;
                }
                case Attributes::GeneratedCommandList::Id: {
        ...
        std::string newElement_0_providerNodeIDCtorSignature = "(J)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint64_t>(newElement_0_providerNodeIDClassName.c_str(), newElement_0_providerNodeIDCtorSignature.c_str(), entry_0.providerNodeID, newElement_0_providerNodeID);
            jobject newElement_0_endpoint;
              std::string newElement_0_endpointClassName = "java/lang/Integer";
        std::string newElement_0_endpointCtorSignature = "(I)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint16_t>(newElement_0_endpointClassName.c_str(), newElement_0_endpointCtorSignature.c_str(), entry_0.endpoint, newElement_0_endpoint);
            jobject newElement_0_fabricIndex;
              std::string newElement_0_fabricIndexClassName = "java/lang/Integer";
        std::string newElement_0_fabricIndexCtorSignature = "(I)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint8_t>(newElement_0_fabricIndexClassName.c_str(), newElement_0_fabricIndexCtorSignature.c_str(), entry_0.fabricIndex, newElement_0_fabricIndex);
    ...
    jmethodID providerLocationStructCtor = env->GetMethodID(providerLocationStructClass, "<init>"
    ...
    newElement_0 = env->NewObject(providerLocationStructClass, providerLocationStructCtor
    ...
    chip::JniReferences::GetInstance().AddToList(value, newElement_0);
      ...
      chip::JniReferences::GetInstance().CreateBoxedObject<uint8_t>(valueClassName.c_str(), valueCtorSignature.c_str(), static_cast<uint8_t>(cppValue.Value()), value);
        ...
        env->SetByteArrayRegion(newElement_0_nocByteArray, 0, static_cast<jsize>(entry_0.noc.size()), reinterpret_cast<const jbyte *>(entry_0.noc.data()));
      ...
      if (entry_0.icac.IsNull()) {
        ...
        env->SetByteArrayRegion(newElement_0_icacByteArray, 0, static_cast<jsize>(entry_0.icac.Value().size()), reinterpret_cast<const jbyte *>(entry_0.icac.Value().data()));
    ...
    jmethodID NOCStructStructCtor = env->GetMethodID(NOCStructStructClass, "<init>"
        , "([B[BLjava/lang/Integer;)V");
    ...
    newElement_0 = env->NewObject(NOCStructStructClass, NOCStructStructCtor
      , newElement_0_noc
      , newElement_0_icac
      , newElement_0_fabricIndex
    );
    chip::JniReferences::GetInstance().AddToList(value, newElement_0);
        ...
        env->SetByteArrayRegion(newElement_0_rootPublicKeyByteArray, 0, static_cast<jsize>(entry_0.rootPublicKey.size()), reinterpret_cast<const jbyte *>(entry_0.rootPublicKey.data()));
      ...
      jobject newElement_0_vendorId;
        ...
        std::string newElement_0_vendorIdCtorSignature = "(I)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint16_t>(newElement_0_vendorIdClassName.c_str(), newElement_0_vendorIdCtorSignature.c_str(), entry_0.vendorId, newElement_0_vendorId);
        ...
        std::string newElement_0_fabricIdCtorSignature = "(J)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint64_t>(newElement_0_fabricIdClassName.c_str(), newElement_0_fabricIdCtorSignature.c_str(), entry_0.fabricId, newElement_0_fabricId);
        ...
        std::string newElement_0_nodeIdCtorSignature = "(J)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint64_t>(newElement_0_nodeIdClassName.c_str(), newElement_0_nodeIdCtorSignature.c_str(), entry_0.nodeId, newElement_0_nodeId);
            jobject newElement_0_label;
              newElement_0_label = env->NewStringUTF(std::string(entry_0.label.data(), entry_0.label.size()).c_str());
      jobject newElement_0_fabricIndex;
              std::string newElement_0_fabricIndexClassName = "java/lang/Integer";
    ...
    jmethodID fabricDescriptorStructCtor = env->GetMethodID(fabricDescriptorStructClass, "<init>"
    ...
    newElement_0 = env->NewObject(fabricDescriptorStructClass, fabricDescriptorStructCtor
      , newElement_0_rootPublicKey
    ...
    chip::JniReferences::GetInstance().AddToList(value, newElement_0);
        ...
        env->SetByteArrayRegion(newElement_0ByteArray, 0, static_cast<jsize>(entry_0.size()), reinterpret_cast<const jbyte *>(entry_0.data()));
    ...
    chip::JniReferences::GetInstance().AddToList(value, newElement_0);
                    ...
                    *aError = app::DataModel::Decode(aReader, cppValue);
                    ...
                    if (cppValue.IsNull()) {
                      value = nullptr;
                              ...
                              std::string valueClassName = "java/lang/Integer";
        std::string valueCtorSignature = "(I)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<int16_t>(valueClassName.c_str(), valueCtorSignature.c_str(), cppValue.Value(), value);
      }
                    return value;
                }
                case Attributes::MinMeasuredValue::Id: {
                    ...
                    *aError = app::DataModel::Decode(aReader, cppValue);
                    ...
                    if (cppValue.IsNull()) {
                      value = nullptr;
                              ...
                              std::string valueClassName = "java/lang/Long";
        std::string valueCtorSignature = "(J)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint32_t>(valueClassName.c_str(), valueCtorSignature.c_str(), cppValue.Value(), value);
      }
                    return value;
                }
      ...
      chip::JniReferences::GetInstance().CreateBoxedObject<uint8_t>(valueClassName.c_str(), valueCtorSignature.c_str(), static_cast<uint8_t>(cppValue), value);
        ...
        std::string newElement_0_idCtorSignature = "(J)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint64_t>(newElement_0_idClassName.c_str(), newElement_0_idCtorSignature.c_str(), entry_0.id, newElement_0_id);
            jobject newElement_0_name;
              newElement_0_name = env->NewStringUTF(std::string(entry_0.name.data(), entry_0.name.size()).c_str());
      jobject newElement_0_stackFreeCurrent;
        ...
        std::string newElement_0_stackFreeCurrentCtorSignature = "(J)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint32_t>(newElement_0_stackFreeCurrentClassName.c_str(), newElement_0_stackFreeCurrentCtorSignature.c_str(), entry_0.stackFreeCurrent, newElement_0_stackFreeCurrent);
        ...
        std::string newElement_0_stackFreeMinimumCtorSignature = "(J)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint32_t>(newElement_0_stackFreeMinimumClassName.c_str(), newElement_0_stackFreeMinimumCtorSignature.c_str(), entry_0.stackFreeMinimum, newElement_0_stackFreeMinimum);
    ...
    jmethodID threadMetricsStructCtor = env->GetMethodID(threadMetricsStructClass, "<init>"
    ...
    newElement_0 = env->NewObject(threadMetricsStructClass, threadMetricsStructCtor
      , newElement_0_id
      , newElement_0_name
    ...
    chip::JniReferences::GetInstance().AddToList(value, newElement_0);
        ...
        std::string newElement_0_identifierCtorSignature = "(I)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint8_t>(newElement_0_identifierClassName.c_str(), newElement_0_identifierCtorSignature.c_str(), entry_0.identifier, newElement_0_identifier);
            jobject newElement_0_name;
              newElement_0_name = env->NewStringUTF(std::string(entry_0.name.data(), entry_0.name.size()).c_str());

    jclass targetInfoStructClass;
    err = chip::JniReferences::GetInstance().GetClassRef(env, "chip/devicecontroller/ChipStructs$TargetNavigatorClusterTargetInfo", targetInfoStructClass);
    if (err != CHIP_NO_ERROR) {
      ChipLogError(Zcl, "Could not find class ChipStructs$TargetNavigatorClusterTargetInfo");
      return nullptr;
    }
    jmethodID targetInfoStructCtor = env->GetMethodID(targetInfoStructClass, "<init>"
        , "(Ljava/lang/Integer;Ljava/lang/String;)V");
    ...
    newElement_0 = env->NewObject(targetInfoStructClass, targetInfoStructCtor
    ...
    chip::JniReferences::GetInstance().AddToList(value, newElement_0);
                ...
                case Attributes::Bitmap8::Id: {
                    ...
                    *aError = app::DataModel::Decode(aReader, cppValue);
                    ...
                    jobject value;
                            std::string valueClassName = "java/lang/Integer";
        std::string valueCtorSignature = "(I)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint8_t>(valueClassName.c_str(), valueCtorSignature.c_str(), cppValue.Raw(), value);
                          return value;
                }
                ...
                case Attributes::Bitmap32::Id: {
                    ...
                    *aError = app::DataModel::Decode(aReader, cppValue);
                    ...
                    jobject value;
                            std::string valueClassName = "java/lang/Long";
        std::string valueCtorSignature = "(J)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint32_t>(valueClassName.c_str(), valueCtorSignature.c_str(), cppValue.Raw(), value);
                          return value;
                }
                case Attributes::Bitmap64::Id: {
                    ...
                    *aError = app::DataModel::Decode(aReader, cppValue);
                    ...
                    jobject value;
                            std::string valueClassName = "java/lang/Long";
        std::string valueCtorSignature = "(J)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint64_t>(valueClassName.c_str(), valueCtorSignature.c_str(), cppValue.Raw(), value);
                          return value;
                }
                ...
                case Attributes::Int8s::Id: {
                    ...
                    *aError = app::DataModel::Decode(aReader, cppValue);
                    ...
                    jobject value;
                            std::string valueClassName = "java/lang/Integer";
        std::string valueCtorSignature = "(I)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<int8_t>(valueClassName.c_str(), valueCtorSignature.c_str(), cppValue, value);
                          return value;
                }
                ...
                case Attributes::Int40s::Id: {
                    ...
                    *aError = app::DataModel::Decode(aReader, cppValue);
                    ...
                    jobject value;
                            std::string valueClassName = "java/lang/Long";
        std::string valueCtorSignature = "(J)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<int64_t>(valueClassName.c_str(), valueCtorSignature.c_str(), cppValue, value);
                          return value;
                }
        ...
        std::string valueCtorSignature = "(D)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<double>(valueClassName.c_str(), valueCtorSignature.c_str(), cppValue, value);
                          return value;
                }
        ...
        env->SetByteArrayRegion(valueByteArray, 0, static_cast<jsize>(cppValue.size()), reinterpret_cast<const jbyte *>(cppValue.data()));
        value = valueByteArray;
                    return value;
                }
    ...
    chip::JniReferences::GetInstance().AddToList(value, newElement_0);
        ...
        std::string newElement_0_fabricIndexCtorSignature = "(J)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint64_t>(newElement_0_fabricIndexClassName.c_str(), newElement_0_fabricIndexCtorSignature.c_str(), entry_0.fabricIndex, newElement_0_fabricIndex);
        ...
        env->SetByteArrayRegion(newElement_0_operationalCertByteArray, 0, static_cast<jsize>(entry_0.operationalCert.size()), reinterpret_cast<const jbyte *>(entry_0.operationalCert.data()));
        newElement_0_operationalCert = newElement_0_operationalCertByteArray;

    jclass testListStructOctetStructClass;
    err = chip::JniReferences::GetInstance().GetClassRef(env, "chip/devicecontroller/ChipStructs$TestClusterClusterTestListStructOctet", testListStructOctetStructClass);
    if (err != CHIP_NO_ERROR) {
      ChipLogError(Zcl, "Could not find class ChipStructs$TestClusterClusterTestListStructOctet");
      return nullptr;
    }
    jmethodID testListStructOctetStructCtor = env->GetMethodID(testListStructOctetStructClass, "<init>"
        , "(Ljava/lang/Long;[B)V");
    ...
    chip::JniReferences::GetInstance().AddToList(value, newElement_0);
      ...
      if (entry_0.nullableInt.IsNull()) {
        ...
        std::string newElement_0_nullableIntCtorSignature = "(I)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint16_t>(newElement_0_nullableIntClassName.c_str(), newElement_0_nullableIntCtorSignature.c_str(), entry_0.nullableInt.Value(), newElement_0_nullableInt);
      }
      ...
      if (!entry_0.optionalInt.HasValue()) {
        ...
        std::string newElement_0_optionalIntInsideOptionalCtorSignature = "(I)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint16_t>(newElement_0_optionalIntInsideOptionalClassName.c_str(), newElement_0_optionalIntInsideOptionalCtorSignature.c_str(), entry_0.optionalInt.Value(), newElement_0_optionalIntInsideOptional);
      ...
      if (!entry_0.nullableOptionalInt.HasValue()) {
        ...
        std::string newElement_0_nullableOptionalIntInsideOptionalCtorSignature = "(I)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint16_t>(newElement_0_nullableOptionalIntInsideOptionalClassName.c_str(), newElement_0_nullableOptionalIntInsideOptionalCtorSignature.c_str(), entry_0.nullableOptionalInt.Value().Value(), newElement_0_nullableOptionalIntInsideOptional);
      }
      ...
      if (entry_0.nullableString.IsNull()) {
        newElement_0_nullableString = nullptr;
                ...
                newElement_0_nullableString = env->NewStringUTF(std::string(entry_0.nullableString.Value().data(), entry_0.nullableString.Value().size()).c_str());
}
      ...
      if (!entry_0.optionalString.HasValue()) {
        ...
        jobject newElement_0_optionalStringInsideOptional;
                newElement_0_optionalStringInsideOptional = env->NewStringUTF(std::string(entry_0.optionalString.Value().data(), entry_0.optionalString.Value().size()).c_str());
  chip::JniReferences::GetInstance().CreateOptional(newElement_0_optionalStringInsideOptional, newElement_0_optionalString);
      }
      ...
      if (!entry_0.nullableOptionalString.HasValue()) {
        ...
        if (entry_0.nullableOptionalString.Value().IsNull()) {
          newElement_0_nullableOptionalStringInsideOptional = nullptr;
                  ...
                  newElement_0_nullableOptionalStringInsideOptional = env->NewStringUTF(std::string(entry_0.nullableOptionalString.Value().Value().data(), entry_0.nullableOptionalString.Value().Value().size()).c_str());
}
        chip::JniReferences::GetInstance().CreateOptional(newElement_0_nullableOptionalStringInsideOptional, newElement_0_nullableOptionalString);
      }
      ...
      if (entry_0.nullableStruct.IsNull()) {
        ...
        std::string newElement_0_nullableStruct_aCtorSignature = "(I)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint8_t>(newElement_0_nullableStruct_aClassName.c_str(), newElement_0_nullableStruct_aCtorSignature.c_str(), entry_0.nullableStruct.Value().a, newElement_0_nullableStruct_a);
        ...
        std::string newElement_0_nullableStruct_bCtorSignature = "(Z)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<bool>(newElement_0_nullableStruct_bClassName.c_str(), newElement_0_nullableStruct_bCtorSignature.c_str(), entry_0.nullableStruct.Value().b, newElement_0_nullableStruct_b);
      ...
      chip::JniReferences::GetInstance().CreateBoxedObject<uint8_t>(newElement_0_nullableStruct_cClassName.c_str(), newElement_0_nullableStruct_cCtorSignature.c_str(), static_cast<uint8_t>(entry_0.nullableStruct.Value().c), newElement_0_nullableStruct_c);
      jobject newElement_0_nullableStruct_d;
              jbyteArray newElement_0_nullableStruct_dByteArray = env->NewByteArray(static_cast<jsize>(entry_0.nullableStruct.Value().d.size()));
        env->SetByteArrayRegion(newElement_0_nullableStruct_dByteArray, 0, static_cast<jsize>(entry_0.nullableStruct.Value().d.size()), reinterpret_cast<const jbyte *>(entry_0.nullableStruct.Value().d.data()));
        newElement_0_nullableStruct_d = newElement_0_nullableStruct_dByteArray;
      jobject newElement_0_nullableStruct_e;
              newElement_0_nullableStruct_e = env->NewStringUTF(std::string(entry_0.nullableStruct.Value().e.data(), entry_0.nullableStruct.Value().e.size()).c_str());
      jobject newElement_0_nullableStruct_f;
        ...
        std::string newElement_0_nullableStruct_fCtorSignature = "(I)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint8_t>(newElement_0_nullableStruct_fClassName.c_str(), newElement_0_nullableStruct_fCtorSignature.c_str(), entry_0.nullableStruct.Value().f.Raw(), newElement_0_nullableStruct_f);
        ...
        std::string newElement_0_nullableStruct_gCtorSignature = "(F)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<float>(newElement_0_nullableStruct_gClassName.c_str(), newElement_0_nullableStruct_gCtorSignature.c_str(), entry_0.nullableStruct.Value().g, newElement_0_nullableStruct_g);
    ...
    newElement_0_nullableStruct = env->NewObject(simpleStructStructClass, simpleStructStructCtor
      , newElement_0_nullableStruct_a
      , newElement_0_nullableStruct_b
      , newElement_0_nullableStruct_c
      , newElement_0_nullableStruct_d
      , newElement_0_nullableStruct_e
      , newElement_0_nullableStruct_f
      , newElement_0_nullableStruct_g
      ...
      if (!entry_0.optionalStruct.HasValue()) {
        ...
        std::string newElement_0_optionalStructInsideOptional_aCtorSignature = "(I)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint8_t>(newElement_0_optionalStructInsideOptional_aClassName.c_str(), newElement_0_optionalStructInsideOptional_aCtorSignature.c_str(), entry_0.optionalStruct.Value().a, newElement_0_optionalStructInsideOptional_a);
        ...
        std::string newElement_0_optionalStructInsideOptional_bCtorSignature = "(Z)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<bool>(newElement_0_optionalStructInsideOptional_bClassName.c_str(), newElement_0_optionalStructInsideOptional_bCtorSignature.c_str(), entry_0.optionalStruct.Value().b, newElement_0_optionalStructInsideOptional_b);
      ...
      chip::JniReferences::GetInstance().CreateBoxedObject<uint8_t>(newElement_0_optionalStructInsideOptional_cClassName.c_str(), newElement_0_optionalStructInsideOptional_cCtorSignature.c_str(), static_cast<uint8_t>(entry_0.optionalStruct.Value().c), newElement_0_optionalStructInsideOptional_c);
      jobject newElement_0_optionalStructInsideOptional_d;
              jbyteArray newElement_0_optionalStructInsideOptional_dByteArray = env->NewByteArray(static_cast<jsize>(entry_0.optionalStruct.Value().d.size()));
        env->SetByteArrayRegion(newElement_0_optionalStructInsideOptional_dByteArray, 0, static_cast<jsize>(entry_0.optionalStruct.Value().d.size()), reinterpret_cast<const jbyte *>(entry_0.optionalStruct.Value().d.data()));
      ...
      jobject newElement_0_optionalStructInsideOptional_e;
              newElement_0_optionalStructInsideOptional_e = env->NewStringUTF(std::string(entry_0.optionalStruct.Value().e.data(), entry_0.optionalStruct.Value().e.size()).c_str());
      jobject newElement_0_optionalStructInsideOptional_f;
        ...
        std::string newElement_0_optionalStructInsideOptional_fCtorSignature = "(I)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint8_t>(newElement_0_optionalStructInsideOptional_fClassName.c_str(), newElement_0_optionalStructInsideOptional_fCtorSignature.c_str(), entry_0.optionalStruct.Value().f.Raw(), newElement_0_optionalStructInsideOptional_f);
        ...
        std::string newElement_0_optionalStructInsideOptional_gCtorSignature = "(F)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<float>(newElement_0_optionalStructInsideOptional_gClassName.c_str(), newElement_0_optionalStructInsideOptional_gCtorSignature.c_str(), entry_0.optionalStruct.Value().g, newElement_0_optionalStructInsideOptional_g);
    ...
    newElement_0_optionalStructInsideOptional = env->NewObject(simpleStructStructClass, simpleStructStructCtor
      ...
      , newElement_0_optionalStructInsideOptional_d
  ...
  chip::JniReferences::GetInstance().CreateOptional(newElement_0_optionalStructInsideOptional, newElement_0_optionalStruct);
      }
      ...
      if (!entry_0.nullableOptionalStruct.HasValue()) {
        ...
        std::string newElement_0_nullableOptionalStructInsideOptional_aCtorSignature = "(I)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint8_t>(newElement_0_nullableOptionalStructInsideOptional_aClassName.c_str(), newElement_0_nullableOptionalStructInsideOptional_aCtorSignature.c_str(), entry_0.nullableOptionalStruct.Value().Value().a, newElement_0_nullableOptionalStructInsideOptional_a);
        ...
        std::string newElement_0_nullableOptionalStructInsideOptional_bCtorSignature = "(Z)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<bool>(newElement_0_nullableOptionalStructInsideOptional_bClassName.c_str(), newElement_0_nullableOptionalStructInsideOptional_bCtorSignature.c_str(), entry_0.nullableOptionalStruct.Value().Value().b, newElement_0_nullableOptionalStructInsideOptional_b);
      ...
      chip::JniReferences::GetInstance().CreateBoxedObject<uint8_t>(newElement_0_nullableOptionalStructInsideOptional_cClassName.c_str(), newElement_0_nullableOptionalStructInsideOptional_cCtorSignature.c_str(), static_cast<uint8_t>(entry_0.nullableOptionalStruct.Value().Value().c), newElement_0_nullableOptionalStructInsideOptional_c);
      jobject newElement_0_nullableOptionalStructInsideOptional_d;
              jbyteArray newElement_0_nullableOptionalStructInsideOptional_dByteArray = env->NewByteArray(static_cast<jsize>(entry_0.nullableOptionalStruct.Value().Value().d.size()));
        env->SetByteArrayRegion(newElement_0_nullableOptionalStructInsideOptional_dByteArray, 0, static_cast<jsize>(entry_0.nullableOptionalStruct.Value().Value().d.size()), reinterpret_cast<const jbyte *>(entry_0.nullableOptionalStruct.Value().Value().d.data()));
      ...
      jobject newElement_0_nullableOptionalStructInsideOptional_e;
              newElement_0_nullableOptionalStructInsideOptional_e = env->NewStringUTF(std::string(entry_0.nullableOptionalStruct.Value().Value().e.data(), entry_0.nullableOptionalStruct.Value().Value().e.size()).c_str());
      jobject newElement_0_nullableOptionalStructInsideOptional_f;
        ...
        std::string newElement_0_nullableOptionalStructInsideOptional_fCtorSignature = "(I)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint8_t>(newElement_0_nullableOptionalStructInsideOptional_fClassName.c_str(), newElement_0_nullableOptionalStructInsideOptional_fCtorSignature.c_str(), entry_0.nullableOptionalStruct.Value().Value().f.Raw(), newElement_0_nullableOptionalStructInsideOptional_f);
        ...
        std::string newElement_0_nullableOptionalStructInsideOptional_gCtorSignature = "(F)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<float>(newElement_0_nullableOptionalStructInsideOptional_gClassName.c_str(), newElement_0_nullableOptionalStructInsideOptional_gCtorSignature.c_str(), entry_0.nullableOptionalStruct.Value().Value().g, newElement_0_nullableOptionalStructInsideOptional_g);
    ...
    newElement_0_nullableOptionalStructInsideOptional = env->NewObject(simpleStructStructClass, simpleStructStructCtor
        ...
        newElement_0_nullableList = nullptr;
          ...
          while (iter_newElement_0_nullableList_NaN.Next())
          {
            ...
            jobject newElement_NaN;
                  std::string newElement_NaNClassName = "java/lang/Integer";
      std::string newElement_NaNCtorSignature = "(I)V";
      chip::JniReferences::GetInstance().CreateBoxedObject<uint8_t>(newElement_NaNClassName.c_str(), newElement_NaNCtorSignature.c_str(), static_cast<uint8_t>(entry_NaN), newElement_NaN);
    ...
    chip::JniReferences::GetInstance().AddToList(newElement_0_nullableOptionalListInsideOptional, newElement_NaN);
        ...
        chip::JniReferences::GetInstance().CreateOptional(newElement_0_nullableOptionalListInsideOptional, newElement_0_nullableOptionalList);
      }

    jclass nullablesAndOptionalsStructStructClass;
    err = chip::JniReferences::GetInstance().GetClassRef(env, "chip/devicecontroller/ChipStructs$TestClusterClusterNullablesAndOptionalsStruct", nullablesAndOptionalsStructStructClass);
    if (err != CHIP_NO_ERROR) {
      ChipLogError(Zcl, "Could not find class ChipStructs$TestClusterClusterNullablesAndOptionalsStruct");
      return nullptr;
    }
    jmethodID nullablesAndOptionalsStructStructCtor = env->GetMethodID(nullablesAndOptionalsStructStructClass, "<init>"
        , "(Ljava/lang/Integer;Ljava/util/Optional;Ljava/util/Optional;Ljava/lang/String;Ljava/util/Optional;Ljava/util/Optional;Lchip/devicecontroller/ChipStructs$TestClusterClusterSimpleStruct;Ljava/util/Optional;Ljava/util/Optional;Ljava/util/ArrayList;Ljava/util/Optional;Ljava/util/Optional;)V");
    ...
    chip::JniReferences::GetInstance().AddToList(value, newElement_0);
      ...
      chip::JniReferences::GetInstance().CreateBoxedObject<uint8_t>(valueClassName.c_str(), valueCtorSignature.c_str(), static_cast<uint8_t>(cppValue), value);
        ...
        std::string value_aCtorSignature = "(I)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint8_t>(value_aClassName.c_str(), value_aCtorSignature.c_str(), cppValue.a, value_a);
            jobject value_b;
              std::string value_bClassName = "java/lang/Boolean";
        std::string value_bCtorSignature = "(Z)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<bool>(value_bClassName.c_str(), value_bCtorSignature.c_str(), cppValue.b, value_b);
            jobject value_c;
            std::string value_cClassName = "java/lang/Integer";
      std::string value_cCtorSignature = "(I)V";
      chip::JniReferences::GetInstance().CreateBoxedObject<uint8_t>(value_cClassName.c_str(), value_cCtorSignature.c_str(), static_cast<uint8_t>(cppValue.c), value_c);
      jobject value_d;
              jbyteArray value_dByteArray = env->NewByteArray(static_cast<jsize>(cppValue.d.size()));
        env->SetByteArrayRegion(value_dByteArray, 0, static_cast<jsize>(cppValue.d.size()), reinterpret_cast<const jbyte *>(cppValue.d.data()));
      ...
      jobject value_f;
        ...
        std::string value_fCtorSignature = "(I)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint8_t>(value_fClassName.c_str(), value_fCtorSignature.c_str(), cppValue.f.Raw(), value_f);
            jobject value_g;
              std::string value_gClassName = "java/lang/Float";
        std::string value_gCtorSignature = "(F)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<float>(value_gClassName.c_str(), value_gCtorSignature.c_str(), cppValue.g, value_g);
            jobject value_h;
    ...
    value = env->NewObject(simpleStructStructClass, simpleStructStructCtor
      , value_a
      , value_b
      , value_c
      , value_d
    ...
    chip::JniReferences::GetInstance().AddToList(value, newElement_0);
        ...
        std::string newElement_0_fabricSensitiveInt8uCtorSignature = "(I)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint8_t>(newElement_0_fabricSensitiveInt8uClassName.c_str(), newElement_0_fabricSensitiveInt8uCtorSignature.c_str(), entry_0.fabricSensitiveInt8u, newElement_0_fabricSensitiveInt8u);
      ...
      if (!entry_0.optionalFabricSensitiveInt8u.HasValue()) {
        ...
        std::string newElement_0_optionalFabricSensitiveInt8uInsideOptionalCtorSignature = "(I)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint8_t>(newElement_0_optionalFabricSensitiveInt8uInsideOptionalClassName.c_str(), newElement_0_optionalFabricSensitiveInt8uInsideOptionalCtorSignature.c_str(), entry_0.optionalFabricSensitiveInt8u.Value(), newElement_0_optionalFabricSensitiveInt8uInsideOptional);
        chip::JniReferences::GetInstance().CreateOptional(newElement_0_optionalFabricSensitiveInt8uInsideOptional, newElement_0_optionalFabricSensitiveInt8u);
      }
      ...
      if (entry_0.nullableFabricSensitiveInt8u.IsNull()) {
        ...
        std::string newElement_0_nullableFabricSensitiveInt8uCtorSignature = "(I)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint8_t>(newElement_0_nullableFabricSensitiveInt8uClassName.c_str(), newElement_0_nullableFabricSensitiveInt8uCtorSignature.c_str(), entry_0.nullableFabricSensitiveInt8u.Value(), newElement_0_nullableFabricSensitiveInt8u);
      }
      ...
      if (!entry_0.nullableOptionalFabricSensitiveInt8u.HasValue()) {
        ...
        std::string newElement_0_nullableOptionalFabricSensitiveInt8uInsideOptionalCtorSignature = "(I)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint8_t>(newElement_0_nullableOptionalFabricSensitiveInt8uInsideOptionalClassName.c_str(), newElement_0_nullableOptionalFabricSensitiveInt8uInsideOptionalCtorSignature.c_str(), entry_0.nullableOptionalFabricSensitiveInt8u.Value().Value(), newElement_0_nullableOptionalFabricSensitiveInt8uInsideOptional);
      }
      ...
      jobject newElement_0_fabricSensitiveCharString;
              newElement_0_fabricSensitiveCharString = env->NewStringUTF(std::string(entry_0.fabricSensitiveCharString.data(), entry_0.fabricSensitiveCharString.size()).c_str());
      jobject newElement_0_fabricSensitiveStruct;
        ...
        std::string newElement_0_fabricSensitiveStruct_aCtorSignature = "(I)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint8_t>(newElement_0_fabricSensitiveStruct_aClassName.c_str(), newElement_0_fabricSensitiveStruct_aCtorSignature.c_str(), entry_0.fabricSensitiveStruct.a, newElement_0_fabricSensitiveStruct_a);
        ...
        std::string newElement_0_fabricSensitiveStruct_bCtorSignature = "(Z)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<bool>(newElement_0_fabricSensitiveStruct_bClassName.c_str(), newElement_0_fabricSensitiveStruct_bCtorSignature.c_str(), entry_0.fabricSensitiveStruct.b, newElement_0_fabricSensitiveStruct_b);
      ...
      chip::JniReferences::GetInstance().CreateBoxedObject<uint8_t>(newElement_0_fabricSensitiveStruct_cClassName.c_str(), newElement_0_fabricSensitiveStruct_cCtorSignature.c_str(), static_cast<uint8_t>(entry_0.fabricSensitiveStruct.c), newElement_0_fabricSensitiveStruct_c);
      jobject newElement_0_fabricSensitiveStruct_d;
              jbyteArray newElement_0_fabricSensitiveStruct_dByteArray = env->NewByteArray(static_cast<jsize>(entry_0.fabricSensitiveStruct.d.size()));
        env->SetByteArrayRegion(newElement_0_fabricSensitiveStruct_dByteArray, 0, static_cast<jsize>(entry_0.fabricSensitiveStruct.d.size()), reinterpret_cast<const jbyte *>(entry_0.fabricSensitiveStruct.d.data()));
      ...
      jobject newElement_0_fabricSensitiveStruct_e;
              newElement_0_fabricSensitiveStruct_e = env->NewStringUTF(std::string(entry_0.fabricSensitiveStruct.e.data(), entry_0.fabricSensitiveStruct.e.size()).c_str());
      jobject newElement_0_fabricSensitiveStruct_f;
        ...
        std::string newElement_0_fabricSensitiveStruct_fCtorSignature = "(I)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint8_t>(newElement_0_fabricSensitiveStruct_fClassName.c_str(), newElement_0_fabricSensitiveStruct_fCtorSignature.c_str(), entry_0.fabricSensitiveStruct.f.Raw(), newElement_0_fabricSensitiveStruct_f);
        ...
        std::string newElement_0_fabricSensitiveStruct_gCtorSignature = "(F)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<float>(newElement_0_fabricSensitiveStruct_gClassName.c_str(), newElement_0_fabricSensitiveStruct_gCtorSignature.c_str(), entry_0.fabricSensitiveStruct.g, newElement_0_fabricSensitiveStruct_g);
    ...
    newElement_0_fabricSensitiveStruct = env->NewObject(simpleStructStructClass, simpleStructStructCtor
      , newElement_0_fabricSensitiveStruct_a
      , newElement_0_fabricSensitiveStruct_b
      , newElement_0_fabricSensitiveStruct_c
      , newElement_0_fabricSensitiveStruct_d
      ...
      jobject newElement_0_fabricSensitiveInt8uList;
        ...
        while (iter_newElement_0_fabricSensitiveInt8uList_NaN.Next())
        {
          ...
          jobject newElement_NaN;
                  std::string newElement_NaNClassName = "java/lang/Integer";
        std::string newElement_NaNCtorSignature = "(I)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint8_t>(newElement_NaNClassName.c_str(), newElement_NaNCtorSignature.c_str(), entry_NaN, newElement_NaN);
    ...
    jmethodID testFabricScopedStructCtor = env->GetMethodID(testFabricScopedStructClass, "<init>"
        , "(Ljava/lang/Integer;Ljava/util/Optional;Ljava/lang/Integer;Ljava/util/Optional;Ljava/lang/String;Lchip/devicecontroller/ChipStructs$TestClusterClusterSimpleStruct;Ljava/util/ArrayList;Ljava/lang/Integer;)V");
    ...
    newElement_0 = env->NewObject(testFabricScopedStructClass, testFabricScopedStructCtor
      , newElement_0_fabricSensitiveInt8u
    ...
    chip::JniReferences::GetInstance().AddToList(value, newElement_0);
                    ...
                    *aError = app::DataModel::Decode(aReader, cppValue);
                    ...
                    if (cppValue.IsNull()) {
                      value = nullptr;
                              ...
                              std::string valueClassName = "java/lang/Integer";
        std::string valueCtorSignature = "(I)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint8_t>(valueClassName.c_str(), valueCtorSignature.c_str(), cppValue.Value().Raw(), value);
      }
                    return value;
                }
                    ...
                    *aError = app::DataModel::Decode(aReader, cppValue);
                    ...
                    if (cppValue.IsNull()) {
                      value = nullptr;
                              ...
                              std::string valueClassName = "java/lang/Integer";
        std::string valueCtorSignature = "(I)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint16_t>(valueClassName.c_str(), valueCtorSignature.c_str(), cppValue.Value().Raw(), value);
      }
                    return value;
                }
                    ...
                    *aError = app::DataModel::Decode(aReader, cppValue);
                    ...
                    if (cppValue.IsNull()) {
                      value = nullptr;
                              ...
                              std::string valueClassName = "java/lang/Long";
        std::string valueCtorSignature = "(J)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint32_t>(valueClassName.c_str(), valueCtorSignature.c_str(), cppValue.Value().Raw(), value);
      }
                    return value;
                }
                    ...
                    *aError = app::DataModel::Decode(aReader, cppValue);
                    ...
                    if (cppValue.IsNull()) {
                      value = nullptr;
                              ...
                              std::string valueClassName = "java/lang/Long";
        std::string valueCtorSignature = "(J)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint64_t>(valueClassName.c_str(), valueCtorSignature.c_str(), cppValue.Value().Raw(), value);
      }
                    return value;
                }
                    ...
                    *aError = app::DataModel::Decode(aReader, cppValue);
                    ...
                    if (cppValue.IsNull()) {
                      value = nullptr;
                              ...
                              std::string valueClassName = "java/lang/Integer";
        std::string valueCtorSignature = "(I)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<int8_t>(valueClassName.c_str(), valueCtorSignature.c_str(), cppValue.Value(), value);
      }
                    return value;
                }
                    ...
                    *aError = app::DataModel::Decode(aReader, cppValue);
                    ...
                    if (cppValue.IsNull()) {
                      value = nullptr;
                              ...
                              std::string valueClassName = "java/lang/Long";
        std::string valueCtorSignature = "(J)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<int64_t>(valueClassName.c_str(), valueCtorSignature.c_str(), cppValue.Value(), value);
      }
                    return value;
                }
                    ...
                    *aError = app::DataModel::Decode(aReader, cppValue);
                    ...
                    if (cppValue.IsNull()) {
                      value = nullptr;
                              ...
                              std::string valueClassName = "java/lang/Float";
        std::string valueCtorSignature = "(F)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<float>(valueClassName.c_str(), valueCtorSignature.c_str(), cppValue.Value(), value);
      }
                    return value;
                }
                    ...
                    *aError = app::DataModel::Decode(aReader, cppValue);
                    ...
                    if (cppValue.IsNull()) {
                      value = nullptr;
                              ...
                              std::string valueClassName = "java/lang/Double";
        std::string valueCtorSignature = "(D)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<double>(valueClassName.c_str(), valueCtorSignature.c_str(), cppValue.Value(), value);
      }
                    return value;
                }
      ...
      chip::JniReferences::GetInstance().CreateBoxedObject<uint8_t>(valueClassName.c_str(), valueCtorSignature.c_str(), static_cast<uint8_t>(cppValue.Value()), value);
              ...
              std::string value_aClassName = "java/lang/Integer";
        std::string value_aCtorSignature = "(I)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint8_t>(value_aClassName.c_str(), value_aCtorSignature.c_str(), cppValue.Value().a, value_a);
            jobject value_b;
              std::string value_bClassName = "java/lang/Boolean";
        std::string value_bCtorSignature = "(Z)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<bool>(value_bClassName.c_str(), value_bCtorSignature.c_str(), cppValue.Value().b, value_b);
            jobject value_c;
            std::string value_cClassName = "java/lang/Integer";
      std::string value_cCtorSignature = "(I)V";
      chip::JniReferences::GetInstance().CreateBoxedObject<uint8_t>(value_cClassName.c_str(), value_cCtorSignature.c_str(), static_cast<uint8_t>(cppValue.Value().c), value_c);
      jobject value_d;
              jbyteArray value_dByteArray = env->NewByteArray(static_cast<jsize>(cppValue.Value().d.size()));
        env->SetByteArrayRegion(value_dByteArray, 0, static_cast<jsize>(cppValue.Value().d.size()), reinterpret_cast<const jbyte *>(cppValue.Value().d.data()));
        value_d = value_dByteArray;
      jobject value_e;
      ...
      jobject value_f;
              std::string value_fClassName = "java/lang/Integer";
        std::string value_fCtorSignature = "(I)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint8_t>(value_fClassName.c_str(), value_fCtorSignature.c_str(), cppValue.Value().f.Raw(), value_f);
            jobject value_g;
              std::string value_gClassName = "java/lang/Float";
        std::string value_gCtorSignature = "(F)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<float>(value_gClassName.c_str(), value_gCtorSignature.c_str(), cppValue.Value().g, value_g);
            jobject value_h;
              std::string value_hClassName = "java/lang/Double";
        std::string value_hCtorSignature = "(D)V";
    ...
    value = env->NewObject(simpleStructStructClass, simpleStructStructCtor
      ...
      chip::JniReferences::GetInstance().CreateBoxedObject<uint8_t>(valueClassName.c_str(), valueCtorSignature.c_str(), static_cast<uint8_t>(cppValue), value);
        ...
        std::string newElement_0_extAddressCtorSignature = "(J)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint64_t>(newElement_0_extAddressClassName.c_str(), newElement_0_extAddressCtorSignature.c_str(), entry_0.extAddress, newElement_0_extAddress);
            jobject newElement_0_age;
              std::string newElement_0_ageClassName = "java/lang/Long";
        std::string newElement_0_ageCtorSignature = "(J)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint32_t>(newElement_0_ageClassName.c_str(), newElement_0_ageCtorSignature.c_str(), entry_0.age, newElement_0_age);
        ...
        std::string newElement_0_rloc16CtorSignature = "(I)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint16_t>(newElement_0_rloc16ClassName.c_str(), newElement_0_rloc16CtorSignature.c_str(), entry_0.rloc16, newElement_0_rloc16);
        ...
        std::string newElement_0_linkFrameCounterCtorSignature = "(J)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint32_t>(newElement_0_linkFrameCounterClassName.c_str(), newElement_0_linkFrameCounterCtorSignature.c_str(), entry_0.linkFrameCounter, newElement_0_linkFrameCounter);
        ...
        std::string newElement_0_mleFrameCounterCtorSignature = "(J)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint32_t>(newElement_0_mleFrameCounterClassName.c_str(), newElement_0_mleFrameCounterCtorSignature.c_str(), entry_0.mleFrameCounter, newElement_0_mleFrameCounter);
        ...
        std::string newElement_0_lqiCtorSignature = "(I)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint8_t>(newElement_0_lqiClassName.c_str(), newElement_0_lqiCtorSignature.c_str(), entry_0.lqi, newElement_0_lqi);
        ...
        std::string newElement_0_averageRssiCtorSignature = "(I)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<int8_t>(newElement_0_averageRssiClassName.c_str(), newElement_0_averageRssiCtorSignature.c_str(), entry_0.averageRssi, newElement_0_averageRssi);
        ...
        std::string newElement_0_lastRssiCtorSignature = "(I)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<int8_t>(newElement_0_lastRssiClassName.c_str(), newElement_0_lastRssiCtorSignature.c_str(), entry_0.lastRssi, newElement_0_lastRssi);
        ...
        std::string newElement_0_frameErrorRateCtorSignature = "(I)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint8_t>(newElement_0_frameErrorRateClassName.c_str(), newElement_0_frameErrorRateCtorSignature.c_str(), entry_0.frameErrorRate, newElement_0_frameErrorRate);
        ...
        std::string newElement_0_messageErrorRateCtorSignature = "(I)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint8_t>(newElement_0_messageErrorRateClassName.c_str(), newElement_0_messageErrorRateCtorSignature.c_str(), entry_0.messageErrorRate, newElement_0_messageErrorRate);
        ...
        std::string newElement_0_rxOnWhenIdleCtorSignature = "(Z)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<bool>(newElement_0_rxOnWhenIdleClassName.c_str(), newElement_0_rxOnWhenIdleCtorSignature.c_str(), entry_0.rxOnWhenIdle, newElement_0_rxOnWhenIdle);
        ...
        std::string newElement_0_fullThreadDeviceCtorSignature = "(Z)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<bool>(newElement_0_fullThreadDeviceClassName.c_str(), newElement_0_fullThreadDeviceCtorSignature.c_str(), entry_0.fullThreadDevice, newElement_0_fullThreadDevice);
        ...
        std::string newElement_0_fullNetworkDataCtorSignature = "(Z)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<bool>(newElement_0_fullNetworkDataClassName.c_str(), newElement_0_fullNetworkDataCtorSignature.c_str(), entry_0.fullNetworkData, newElement_0_fullNetworkData);
    ...
    jmethodID neighborTableStructCtor = env->GetMethodID(neighborTableStructClass, "<init>"
        , "(Ljava/lang/Long;Ljava/lang/Long;Ljava/lang/Integer;Ljava/lang/Long;Ljava/lang/Long;Ljava/lang/Integer;Ljava/lang/Integer;Ljava/lang/Integer;Ljava/lang/Integer;Ljava/lang/Integer;Ljava/lang/Boolean;Ljava/lang/Boolean;Ljava/lang/Boolean;Ljava/lang/Boolean;)V");
    ...
    newElement_0 = env->NewObject(neighborTableStructClass, neighborTableStructCtor
      , newElement_0_extAddress
      , newElement_0_age
      , newElement_0_rloc16
      , newElement_0_linkFrameCounter
      , newElement_0_mleFrameCounter
      , newElement_0_lqi
      , newElement_0_averageRssi
      , newElement_0_lastRssi
      , newElement_0_frameErrorRate
      , newElement_0_messageErrorRate
      , newElement_0_rxOnWhenIdle
      , newElement_0_fullThreadDevice
      , newElement_0_fullNetworkData
    ...
    chip::JniReferences::GetInstance().AddToList(value, newElement_0);
        ...
        std::string newElement_0_routerIdCtorSignature = "(I)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint8_t>(newElement_0_routerIdClassName.c_str(), newElement_0_routerIdCtorSignature.c_str(), entry_0.routerId, newElement_0_routerId);
        ...
        std::string newElement_0_nextHopCtorSignature = "(I)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint8_t>(newElement_0_nextHopClassName.c_str(), newElement_0_nextHopCtorSignature.c_str(), entry_0.nextHop, newElement_0_nextHop);
        ...
        std::string newElement_0_pathCostCtorSignature = "(I)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint8_t>(newElement_0_pathCostClassName.c_str(), newElement_0_pathCostCtorSignature.c_str(), entry_0.pathCost, newElement_0_pathCost);
        ...
        std::string newElement_0_LQIInCtorSignature = "(I)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint8_t>(newElement_0_LQIInClassName.c_str(), newElement_0_LQIInCtorSignature.c_str(), entry_0.LQIIn, newElement_0_LQIIn);
        ...
        std::string newElement_0_LQIOutCtorSignature = "(I)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint8_t>(newElement_0_LQIOutClassName.c_str(), newElement_0_LQIOutCtorSignature.c_str(), entry_0.LQIOut, newElement_0_LQIOut);
            jobject newElement_0_age;
              std::string newElement_0_ageClassName = "java/lang/Integer";
        std::string newElement_0_ageCtorSignature = "(I)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint8_t>(newElement_0_ageClassName.c_str(), newElement_0_ageCtorSignature.c_str(), entry_0.age, newElement_0_age);
        ...
        std::string newElement_0_allocatedCtorSignature = "(Z)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<bool>(newElement_0_allocatedClassName.c_str(), newElement_0_allocatedCtorSignature.c_str(), entry_0.allocated, newElement_0_allocated);
    ...
    jmethodID routeTableStructCtor = env->GetMethodID(routeTableStructClass, "<init>"
        , "(Ljava/lang/Long;Ljava/lang/Integer;Ljava/lang/Integer;Ljava/lang/Integer;Ljava/lang/Integer;Ljava/lang/Integer;Ljava/lang/Integer;Ljava/lang/Integer;Ljava/lang/Boolean;Ljava/lang/Boolean;)V");
    ...
    newElement_0 = env->NewObject(routeTableStructClass, routeTableStructCtor
      , newElement_0_extAddress
      , newElement_0_rloc16
    ...
    chip::JniReferences::GetInstance().AddToList(value, newElement_0);
        ...
        std::string newElement_0_rotationTimeCtorSignature = "(I)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint16_t>(newElement_0_rotationTimeClassName.c_str(), newElement_0_rotationTimeCtorSignature.c_str(), entry_0.rotationTime, newElement_0_rotationTime);
    ...
    jmethodID securityPolicyStructCtor = env->GetMethodID(securityPolicyStructClass, "<init>"
        , "(Ljava/lang/Integer;Ljava/lang/Integer;)V");
    ...
    newElement_0 = env->NewObject(securityPolicyStructClass, securityPolicyStructCtor
      , newElement_0_rotationTime
      , newElement_0_flags
    );
    chip::JniReferences::GetInstance().AddToList(value, newElement_0);
                      }
        ...
        std::string newElement_0_activeTimestampPresentCtorSignature = "(Z)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<bool>(newElement_0_activeTimestampPresentClassName.c_str(), newElement_0_activeTimestampPresentCtorSignature.c_str(), entry_0.activeTimestampPresent, newElement_0_activeTimestampPresent);
        ...
        std::string newElement_0_pendingTimestampPresentCtorSignature = "(Z)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<bool>(newElement_0_pendingTimestampPresentClassName.c_str(), newElement_0_pendingTimestampPresentCtorSignature.c_str(), entry_0.pendingTimestampPresent, newElement_0_pendingTimestampPresent);
        ...
        std::string newElement_0_masterKeyPresentCtorSignature = "(Z)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<bool>(newElement_0_masterKeyPresentClassName.c_str(), newElement_0_masterKeyPresentCtorSignature.c_str(), entry_0.masterKeyPresent, newElement_0_masterKeyPresent);
        ...
        std::string newElement_0_networkNamePresentCtorSignature = "(Z)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<bool>(newElement_0_networkNamePresentClassName.c_str(), newElement_0_networkNamePresentCtorSignature.c_str(), entry_0.networkNamePresent, newElement_0_networkNamePresent);
        ...
        std::string newElement_0_extendedPanIdPresentCtorSignature = "(Z)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<bool>(newElement_0_extendedPanIdPresentClassName.c_str(), newElement_0_extendedPanIdPresentCtorSignature.c_str(), entry_0.extendedPanIdPresent, newElement_0_extendedPanIdPresent);
        ...
        std::string newElement_0_meshLocalPrefixPresentCtorSignature = "(Z)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<bool>(newElement_0_meshLocalPrefixPresentClassName.c_str(), newElement_0_meshLocalPrefixPresentCtorSignature.c_str(), entry_0.meshLocalPrefixPresent, newElement_0_meshLocalPrefixPresent);
        ...
        std::string newElement_0_delayPresentCtorSignature = "(Z)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<bool>(newElement_0_delayPresentClassName.c_str(), newElement_0_delayPresentCtorSignature.c_str(), entry_0.delayPresent, newElement_0_delayPresent);
        ...
        std::string newElement_0_panIdPresentCtorSignature = "(Z)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<bool>(newElement_0_panIdPresentClassName.c_str(), newElement_0_panIdPresentCtorSignature.c_str(), entry_0.panIdPresent, newElement_0_panIdPresent);
        ...
        std::string newElement_0_channelPresentCtorSignature = "(Z)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<bool>(newElement_0_channelPresentClassName.c_str(), newElement_0_channelPresentCtorSignature.c_str(), entry_0.channelPresent, newElement_0_channelPresent);
        ...
        std::string newElement_0_pskcPresentCtorSignature = "(Z)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<bool>(newElement_0_pskcPresentClassName.c_str(), newElement_0_pskcPresentCtorSignature.c_str(), entry_0.pskcPresent, newElement_0_pskcPresent);
        ...
        std::string newElement_0_securityPolicyPresentCtorSignature = "(Z)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<bool>(newElement_0_securityPolicyPresentClassName.c_str(), newElement_0_securityPolicyPresentCtorSignature.c_str(), entry_0.securityPolicyPresent, newElement_0_securityPolicyPresent);
    ...
    jmethodID operationalDatasetComponentsStructCtor = env->GetMethodID(operationalDatasetComponentsStructClass, "<init>"
    ...
    newElement_0 = env->NewObject(operationalDatasetComponentsStructClass, operationalDatasetComponentsStructCtor
      , newElement_0_activeTimestampPresent
      , newElement_0_pendingTimestampPresent
      , newElement_0_masterKeyPresent
      , newElement_0_networkNamePresent
      , newElement_0_extendedPanIdPresent
      , newElement_0_meshLocalPrefixPresent
      , newElement_0_delayPresent
      , newElement_0_panIdPresent
      , newElement_0_channelPresent
      , newElement_0_pskcPresent
      , newElement_0_securityPolicyPresent
      , newElement_0_channelMaskPresent
    );
    chip::JniReferences::GetInstance().AddToList(value, newElement_0);
                      }
                    return value;
    ...
    jclass labelStructStructClass;
    err = chip::JniReferences::GetInstance().GetClassRef(env, "chip/devicecontroller/ChipStructs$UserLabelClusterLabelStruct", labelStructStructClass);
    if (err != CHIP_NO_ERROR) {
