            ...
            *aError = app::DataModel::Decode(aReader, cppValue);
            ...
            while (iter_value_0.Next())
            {
                ...
                else
                {
                    ...
                    err = chip::JniReferences::GetInstance().GetClassRef(
                        env, "chip/devicecontroller/ChipStructs$TestClusterSimpleStruct", simpleStructStructClass_3);
                    if (err != CHIP_NO_ERROR)
                    {
                ...
                jmethodID nullablesAndOptionalsStructStructCtor_1 = env->GetMethodID(
                    ...
                    "Optional;Lchip/devicecontroller/ChipStructs$TestClusterSimpleStruct;Ljava/util/Optional;Ljava/util/"
        ...
        case Attributes::ListFabricScoped::Id: {
            ...
            *aError = app::DataModel::Decode(aReader, cppValue);
            ...
            while (iter_value_0.Next())
            {
                ...
                err = chip::JniReferences::GetInstance().GetClassRef(
                    env, "chip/devicecontroller/ChipStructs$TestClusterSimpleStruct", simpleStructStructClass_2);
                if (err != CHIP_NO_ERROR)
                {
                    ChipLogError(Zcl, "Could not find class ChipStructs$TestClusterSimpleStruct");
                    return nullptr;
                ...
                err = chip::JniReferences::GetInstance().GetClassRef(
                    env, "chip/devicecontroller/ChipStructs$TestClusterTestFabricScoped", testFabricScopedStructClass_1);
                if (err != CHIP_NO_ERROR)
                {
