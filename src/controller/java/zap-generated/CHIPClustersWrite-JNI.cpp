...

    {
        ...
        if (valueSize != 0)
        {
            ...
            for (size_t i_0 = 0; i_0 < static_cast<size_t>(valueSize); ++i_0)
            {
                ...
                listHolder_0->mList[i_0].nodeId = static_cast<std::remove_reference_t<decltype(listHolder_0->mList[i_0].nodeId)>>(
                ...
                listHolder_0->mList[i_0].endpointId =
                    static_cast<std::remove_reference_t<decltype(listHolder_0->mList[i_0].endpointId)>>(
