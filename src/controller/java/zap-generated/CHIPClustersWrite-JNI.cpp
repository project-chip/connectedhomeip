...
JNI_METHOD(void, DishwasherAlarmCluster, writeMaskAttribute)
(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback, jobject value, jobject timedWriteTimeoutMs)
{
    chip::DeviceLayer::StackLock lock;
    ListFreer listFreer;
    using TypeInfo = chip::app::Clusters::DishwasherAlarm::Attributes::Mask::TypeInfo;
    TypeInfo::Type cppValue;
    ...
    CHIP_ERROR err                      = CHIP_NO_ERROR;
    DishwasherAlarmCluster * cppCluster = reinterpret_cast<DishwasherAlarmCluster *>(clusterPtr);
    VerifyOrReturn(cppCluster != nullptr,
                   chip::AndroidClusterExceptions::GetInstance().ReturnIllegalStateException(
                       env, callback, "Could not get native cluster", CHIP_ERROR_INCORRECT_STATE));
