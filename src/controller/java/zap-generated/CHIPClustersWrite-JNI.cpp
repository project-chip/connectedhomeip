...
JNI_METHOD(void, DishwasherControlCluster, writeSteamWashAttribute)
(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback, jobject value, jobject timedWriteTimeoutMs)
{
    chip::DeviceLayer::StackLock lock;
    ListFreer listFreer;
    using TypeInfo = chip::app::Clusters::DishwasherControl::Attributes::SteamWash::TypeInfo;
    TypeInfo::Type cppValue;
    ...
    CHIP_ERROR err                        = CHIP_NO_ERROR;
    DishwasherControlCluster * cppCluster = reinterpret_cast<DishwasherControlCluster *>(clusterPtr);
    VerifyOrReturn(cppCluster != nullptr,
                   chip::AndroidClusterExceptions::GetInstance().ReturnIllegalStateException(
                       env, callback, "Could not get native cluster", CHIP_ERROR_INCORRECT_STATE));
...
JNI_METHOD(void, DishwasherControlCluster, writeHeatedDryAttribute)
(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback, jobject value, jobject timedWriteTimeoutMs)
{
    chip::DeviceLayer::StackLock lock;
    ListFreer listFreer;
    using TypeInfo = chip::app::Clusters::DishwasherControl::Attributes::HeatedDry::TypeInfo;
    TypeInfo::Type cppValue;
...
JNI_METHOD(void, DishwasherControlCluster, writeExtendedDryAttribute)
(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback, jobject value, jobject timedWriteTimeoutMs)
{
    chip::DeviceLayer::StackLock lock;
    ListFreer listFreer;
    using TypeInfo = chip::app::Clusters::DishwasherControl::Attributes::ExtendedDry::TypeInfo;
    TypeInfo::Type cppValue;
