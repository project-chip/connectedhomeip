...
jobject DecodeEventValue(const app::ConcreteEventPath & aPath, TLV::TLVReader & aReader, CHIP_ERROR * aError)
{
    ...
    switch (aPath.mClusterId)
    {
        ...
        std::string value_adminNodeIDCtorSignature = "(J)V";
          ...
          chip::JniReferences::GetInstance().CreateBoxedObject<jlong>(value_adminNodeIDClassName.c_str(), value_adminNodeIDCtorSignature.c_str(), jnivalue_adminNodeID, value_adminNodeID);
      }
        ...
        std::string value_adminPasscodeIDCtorSignature = "(I)V";
          ...
          chip::JniReferences::GetInstance().CreateBoxedObject<jint>(value_adminPasscodeIDClassName.c_str(), value_adminPasscodeIDCtorSignature.c_str(), jnivalue_adminPasscodeID, value_adminPasscodeID);
      }
      ...
      chip::JniReferences::GetInstance().CreateBoxedObject<jint>(value_changeTypeClassName.c_str(), value_changeTypeCtorSignature.c_str(), jnivalue_changeType, value_changeType);
      ...
      chip::JniReferences::GetInstance().CreateBoxedObject<jint>(value_latestValue_privilegeClassName.c_str(), value_latestValue_privilegeCtorSignature.c_str(), jnivalue_latestValue_privilege, value_latestValue_privilege);
      ...
      chip::JniReferences::GetInstance().CreateBoxedObject<jint>(value_latestValue_authModeClassName.c_str(), value_latestValue_authModeCtorSignature.c_str(), jnivalue_latestValue_authMode, value_latestValue_authMode);
      ...
      if (cppValue.latestValue.Value().subjects.IsNull()) {
        ...
        std::string newElement_3CtorSignature = "(J)V";
          ...
          chip::JniReferences::GetInstance().CreateBoxedObject<jlong>(newElement_3ClassName.c_str(), newElement_3CtorSignature.c_str(), jninewElement_3, newElement_3);
      ...
      if (entry_3.cluster.IsNull()) {
        ...
        std::string newElement_3_clusterCtorSignature = "(J)V";
          ...
          chip::JniReferences::GetInstance().CreateBoxedObject<jlong>(newElement_3_clusterClassName.c_str(), newElement_3_clusterCtorSignature.c_str(), jninewElement_3_cluster, newElement_3_cluster);
      }
      ...
      if (entry_3.endpoint.IsNull()) {
        ...
        std::string newElement_3_endpointCtorSignature = "(I)V";
          ...
          chip::JniReferences::GetInstance().CreateBoxedObject<jint>(newElement_3_endpointClassName.c_str(), newElement_3_endpointCtorSignature.c_str(), jninewElement_3_endpoint, newElement_3_endpoint);
      }
      ...
      if (entry_3.deviceType.IsNull()) {
        ...
        std::string newElement_3_deviceTypeCtorSignature = "(J)V";
          ...
          chip::JniReferences::GetInstance().CreateBoxedObject<jlong>(newElement_3_deviceTypeClassName.c_str(), newElement_3_deviceTypeCtorSignature.c_str(), jninewElement_3_deviceType, newElement_3_deviceType);
      }

    jclass accessControlTargetStructStructClass_4;
    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipStructs$AccessControlClusterAccessControlTargetStruct", accessControlTargetStructStructClass_4);
    ...
    newElement_3 = env->NewObject(accessControlTargetStructStructClass_4, accessControlTargetStructStructCtor_4
      , newElement_3_cluster
      , newElement_3_endpoint
    ...
    chip::JniReferences::GetInstance().AddToList(value_latestValue_targets, newElement_3);
      ...
      jobject value_latestValue_fabricIndex;
        ...
        std::string value_latestValue_fabricIndexCtorSignature = "(I)V";
          ...
          chip::JniReferences::GetInstance().CreateBoxedObject<jint>(value_latestValue_fabricIndexClassName.c_str(), value_latestValue_fabricIndexCtorSignature.c_str(), jnivalue_latestValue_fabricIndex, value_latestValue_fabricIndex);
      
    jclass accessControlEntryStructStructClass_1;
    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipStructs$AccessControlClusterAccessControlEntryStruct", accessControlEntryStructStructClass_1);
    if (err != CHIP_NO_ERROR) {
    ...
    value_latestValue = env->NewObject(accessControlEntryStructStructClass_1, accessControlEntryStructStructCtor_1
      , value_latestValue_privilege
      , value_latestValue_authMode
      , value_latestValue_subjects
      , value_latestValue_targets
      , value_latestValue_fabricIndex
        ...
        std::string value_fabricIndexCtorSignature = "(I)V";
          ...
          chip::JniReferences::GetInstance().CreateBoxedObject<jint>(value_fabricIndexClassName.c_str(), value_fabricIndexCtorSignature.c_str(), jnivalue_fabricIndex, value_fabricIndex);
      
                    jclass accessControlEntryChangedStructClass;
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$AccessControlClusterAccessControlEntryChangedEvent", accessControlEntryChangedStructClass);
                    if (err != CHIP_NO_ERROR) {
                    ...
                    err = chip::JniReferences::GetInstance().FindMethod(
                       ...
                       "(Ljava/lang/Long;Ljava/lang/Integer;Ljava/lang/Integer;Lchip/devicecontroller/ChipStructs$AccessControlClusterAccessControlEntryStruct;Ljava/lang/Integer;)V",
                    ...
                    jobject value = env->NewObject(accessControlEntryChangedStructClass, accessControlEntryChangedStructCtor
                    , value_adminNodeID
      ...
      chip::JniReferences::GetInstance().CreateBoxedObject<jint>(value_changeTypeClassName.c_str(), value_changeTypeCtorSignature.c_str(), jnivalue_changeType, value_changeType);
              ...
              jbyteArray value_latestValue_dataByteArray = env->NewByteArray(static_cast<jsize>(cppValue.latestValue.Value().data.size()));
        env->SetByteArrayRegion(value_latestValue_dataByteArray, 0, static_cast<jsize>(cppValue.latestValue.Value().data.size()), reinterpret_cast<const jbyte *>(cppValue.latestValue.Value().data.data()));
    ...
    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipStructs$AccessControlClusterAccessControlExtensionStruct", accessControlExtensionStructStructClass_1);
    if (err != CHIP_NO_ERROR) {
    ...
    err = chip::JniReferences::GetInstance().FindMethod(
        env, accessControlExtensionStructStructClass_1, "<init>",
    ...
    value_latestValue = env->NewObject(accessControlExtensionStructStructClass_1, accessControlExtensionStructStructCtor_1
      , value_latestValue_data
      , value_latestValue_fabricIndex
    );
}
        ...
        std::string value_fabricIndexCtorSignature = "(I)V";
          ...
          chip::JniReferences::GetInstance().CreateBoxedObject<jint>(value_fabricIndexClassName.c_str(), value_fabricIndexCtorSignature.c_str(), jnivalue_fabricIndex, value_fabricIndex);
                    ...
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$AccessControlClusterAccessControlExtensionChangedEvent", accessControlExtensionChangedStructClass);
                    if (err != CHIP_NO_ERROR) {
                    ...
                    err = chip::JniReferences::GetInstance().FindMethod(
                       ...
                       "(Ljava/lang/Long;Ljava/lang/Integer;Ljava/lang/Integer;Lchip/devicecontroller/ChipStructs$AccessControlClusterAccessControlExtensionStruct;Ljava/lang/Integer;)V",
                       &accessControlExtensionChangedStructCtor);
                    if (err != CHIP_NO_ERROR || accessControlExtensionChangedStructCtor == nullptr) {
                        ChipLogError(Zcl, "Could not find ChipEventStructs$AccessControlClusterAccessControlExtensionChangedEvent constructor");
                        return nullptr;
                    }

                    jobject value = env->NewObject(accessControlExtensionChangedStructClass, accessControlExtensionChangedStructCtor
                    , value_adminNodeID
                    , value_adminPasscodeID
                    , value_changeType
                    , value_latestValue
        ...
        std::string value_fabricIndexCtorSignature = "(I)V";
          ...
          chip::JniReferences::GetInstance().CreateBoxedObject<jint>(value_fabricIndexClassName.c_str(), value_fabricIndexCtorSignature.c_str(), jnivalue_fabricIndex, value_fabricIndex);
                    ...
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$AccessControlClusterAccessRestrictionEntryChangedEvent", accessRestrictionEntryChangedStructClass);
                    if (err != CHIP_NO_ERROR) {
                    ...
                    err = chip::JniReferences::GetInstance().FindMethod(
                       env, accessRestrictionEntryChangedStructClass, "<init>",
                       "(Ljava/lang/Integer;)V",
                       &accessRestrictionEntryChangedStructCtor);
                    if (err != CHIP_NO_ERROR || accessRestrictionEntryChangedStructCtor == nullptr) {
                        ChipLogError(Zcl, "Could not find ChipEventStructs$AccessControlClusterAccessRestrictionEntryChangedEvent constructor");
                        return nullptr;
                    }
        ...
        std::string value_tokenCtorSignature = "(J)V";
          ...
          chip::JniReferences::GetInstance().CreateBoxedObject<jlong>(value_tokenClassName.c_str(), value_tokenCtorSignature.c_str(), jnivalue_token, value_token);
      
                    jobject value_instruction;
                    if (cppValue.instruction.IsNull()) {
                      value_instruction = nullptr;
                    } else {
                              LogErrorOnFailure(chip::JniReferences::GetInstance().CharToStringUTF(cppValue.instruction.Value(), value_instruction));
}
                    ...
                    if (cppValue.redirectURL.IsNull()) {
                      value_redirectURL = nullptr;
                              ...
                              LogErrorOnFailure(chip::JniReferences::GetInstance().CharToStringUTF(cppValue.redirectURL.Value(), value_redirectURL));
}
        ...
        std::string value_fabricIndexCtorSignature = "(I)V";
          ...
          chip::JniReferences::GetInstance().CreateBoxedObject<jint>(value_fabricIndexClassName.c_str(), value_fabricIndexCtorSignature.c_str(), jnivalue_fabricIndex, value_fabricIndex);
                    ...
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$AccessControlClusterFabricRestrictionReviewUpdateEvent", fabricRestrictionReviewUpdateStructClass);
                    if (err != CHIP_NO_ERROR) {
                    ...
                    if (err != CHIP_NO_ERROR || fabricRestrictionReviewUpdateStructCtor == nullptr) {
                        ChipLogError(Zcl, "Could not find ChipEventStructs$AccessControlClusterFabricRestrictionReviewUpdateEvent constructor");
                        return nullptr;
                    }
        ...
        std::string value_actionIDCtorSignature = "(I)V";
          ...
          chip::JniReferences::GetInstance().CreateBoxedObject<jint>(value_actionIDClassName.c_str(), value_actionIDCtorSignature.c_str(), jnivalue_actionID, value_actionID);
        ...
        std::string value_invokeIDCtorSignature = "(J)V";
          ...
          chip::JniReferences::GetInstance().CreateBoxedObject<jlong>(value_invokeIDClassName.c_str(), value_invokeIDCtorSignature.c_str(), jnivalue_invokeID, value_invokeID);
      ...
      chip::JniReferences::GetInstance().CreateBoxedObject<jint>(value_newStateClassName.c_str(), value_newStateCtorSignature.c_str(), jnivalue_newState, value_newState);

                    jclass stateChangedStructClass;
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$ActionsClusterStateChangedEvent", stateChangedStructClass);
                    if (err != CHIP_NO_ERROR) {
                    ...
                    jobject value = env->NewObject(stateChangedStructClass, stateChangedStructCtor
                    , value_actionID
                    , value_invokeID
                    , value_newState
                    );
      ...
      chip::JniReferences::GetInstance().CreateBoxedObject<jint>(value_errorClassName.c_str(), value_errorCtorSignature.c_str(), jnivalue_error, value_error);

                    jclass actionFailedStructClass;
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$ActionsClusterActionFailedEvent", actionFailedStructClass);
                    if (err != CHIP_NO_ERROR) {
                    ...
                    err = chip::JniReferences::GetInstance().FindMethod(
                       ...
                       "(Ljava/lang/Integer;Ljava/lang/Long;Ljava/lang/Integer;Ljava/lang/Integer;)V",
                       &actionFailedStructCtor);
                    ...
                    jobject value = env->NewObject(actionFailedStructClass, actionFailedStructCtor
                    , value_actionID
                    , value_invokeID
                    , value_newState
                    , value_error
        ...
        std::string value_softwareVersionCtorSignature = "(J)V";
          ...
          chip::JniReferences::GetInstance().CreateBoxedObject<jlong>(value_softwareVersionClassName.c_str(), value_softwareVersionCtorSignature.c_str(), jnivalue_softwareVersion, value_softwareVersion);
      
                    jclass startUpStructClass;
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$BasicInformationClusterStartUpEvent", startUpStructClass);
                    if (err != CHIP_NO_ERROR) {
                    ...
                    jobject value = env->NewObject(startUpStructClass, startUpStructCtor
                ...
                case Events::ShutDown::Id: {
                    ...
                    *aError = app::DataModel::Decode(aReader, cppValue);
                    ...
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$BasicInformationClusterShutDownEvent", shutDownStructClass);
                    if (err != CHIP_NO_ERROR) {
        ...
        std::string value_fabricIndexCtorSignature = "(I)V";
          ...
          chip::JniReferences::GetInstance().CreateBoxedObject<jint>(value_fabricIndexClassName.c_str(), value_fabricIndexCtorSignature.c_str(), jnivalue_fabricIndex, value_fabricIndex);
                    ...
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$BasicInformationClusterLeaveEvent", leaveStructClass);
                    if (err != CHIP_NO_ERROR) {
        ...
        std::string value_reachableNewValueCtorSignature = "(Z)V";
          ...
          chip::JniReferences::GetInstance().CreateBoxedObject<jboolean>(value_reachableNewValueClassName.c_str(), value_reachableNewValueCtorSignature.c_str(), jnivalue_reachableNewValue, value_reachableNewValue);
      
                    jclass reachableChangedStructClass;
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$BasicInformationClusterReachableChangedEvent", reachableChangedStructClass);
                    if (err != CHIP_NO_ERROR) {
                    ...
                    err = chip::JniReferences::GetInstance().FindMethod(
                       env, reachableChangedStructClass, "<init>",
                       "(Ljava/lang/Boolean;)V",
                       &reachableChangedStructCtor);
                    ...
                    jobject value = env->NewObject(reachableChangedStructClass, reachableChangedStructCtor
      ...
      chip::JniReferences::GetInstance().CreateBoxedObject<jint>(value_previousStateClassName.c_str(), value_previousStateCtorSignature.c_str(), jnivalue_previousState, value_previousState);
      ...
      chip::JniReferences::GetInstance().CreateBoxedObject<jint>(value_reasonClassName.c_str(), value_reasonCtorSignature.c_str(), jnivalue_reason, value_reason);
        ...
        std::string value_targetSoftwareVersionCtorSignature = "(J)V";
          ...
          chip::JniReferences::GetInstance().CreateBoxedObject<jlong>(value_targetSoftwareVersionClassName.c_str(), value_targetSoftwareVersionCtorSignature.c_str(), jnivalue_targetSoftwareVersion, value_targetSoftwareVersion);
      }

                    jclass stateTransitionStructClass;
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$OtaSoftwareUpdateRequestorClusterStateTransitionEvent", stateTransitionStructClass);
                    if (err != CHIP_NO_ERROR) {
                    ...
                    err = chip::JniReferences::GetInstance().FindMethod(
                       ...
                       &stateTransitionStructCtor);
                    if (err != CHIP_NO_ERROR || stateTransitionStructCtor == nullptr) {
                        ChipLogError(Zcl, "Could not find ChipEventStructs$OtaSoftwareUpdateRequestorClusterStateTransitionEvent constructor");
                        return nullptr;
                    }

                    jobject value = env->NewObject(stateTransitionStructClass, stateTransitionStructCtor
                    , value_previousState
                    , value_newState
                    , value_reason
                    , value_targetSoftwareVersion
                    );
        ...
        std::string value_productIDCtorSignature = "(I)V";
          ...
          chip::JniReferences::GetInstance().CreateBoxedObject<jint>(value_productIDClassName.c_str(), value_productIDCtorSignature.c_str(), jnivalue_productID, value_productID);
      
                    jclass versionAppliedStructClass;
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$OtaSoftwareUpdateRequestorClusterVersionAppliedEvent", versionAppliedStructClass);
                    if (err != CHIP_NO_ERROR) {
                    ...
                    err = chip::JniReferences::GetInstance().FindMethod(
                       env, versionAppliedStructClass, "<init>",
                       "(Ljava/lang/Long;Ljava/lang/Integer;)V",
                       &versionAppliedStructCtor);
                    if (err != CHIP_NO_ERROR || versionAppliedStructCtor == nullptr) {
                        ChipLogError(Zcl, "Could not find ChipEventStructs$OtaSoftwareUpdateRequestorClusterVersionAppliedEvent constructor");
                        return nullptr;
                    }

                    jobject value = env->NewObject(versionAppliedStructClass, versionAppliedStructCtor
                    , value_softwareVersion
                    , value_productID
                    );
        ...
        std::string value_bytesDownloadedCtorSignature = "(J)V";
          ...
          chip::JniReferences::GetInstance().CreateBoxedObject<jlong>(value_bytesDownloadedClassName.c_str(), value_bytesDownloadedCtorSignature.c_str(), jnivalue_bytesDownloaded, value_bytesDownloaded);
        ...
        std::string value_progressPercentCtorSignature = "(I)V";
          ...
          chip::JniReferences::GetInstance().CreateBoxedObject<jint>(value_progressPercentClassName.c_str(), value_progressPercentCtorSignature.c_str(), jnivalue_progressPercent, value_progressPercent);
      }
        ...
        std::string value_platformCodeCtorSignature = "(J)V";
          ...
          chip::JniReferences::GetInstance().CreateBoxedObject<jlong>(value_platformCodeClassName.c_str(), value_platformCodeCtorSignature.c_str(), jnivalue_platformCode, value_platformCode);
      }

                    jclass downloadErrorStructClass;
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$OtaSoftwareUpdateRequestorClusterDownloadErrorEvent", downloadErrorStructClass);
                    if (err != CHIP_NO_ERROR) {
                    ...
                    err = chip::JniReferences::GetInstance().FindMethod(
                       env, downloadErrorStructClass, "<init>",
                    ...
                    if (err != CHIP_NO_ERROR || downloadErrorStructCtor == nullptr) {
                        ChipLogError(Zcl, "Could not find ChipEventStructs$OtaSoftwareUpdateRequestorClusterDownloadErrorEvent constructor");
                        return nullptr;
                    }

                    jobject value = env->NewObject(downloadErrorStructClass, downloadErrorStructCtor
                    , value_softwareVersion
      ...
      chip::JniReferences::GetInstance().CreateBoxedObject<jint>(newElement_0ClassName.c_str(), newElement_0CtorSignature.c_str(), jninewElement_0, newElement_0);
    ...
    chip::JniReferences::GetInstance().AddToList(value_previous, newElement_0);
                    ...
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$PowerSourceClusterWiredFaultChangeEvent", wiredFaultChangeStructClass);
                    if (err != CHIP_NO_ERROR) {
                    ...
                    err = chip::JniReferences::GetInstance().FindMethod(
                       env, wiredFaultChangeStructClass, "<init>",
                    ...
                    jobject value = env->NewObject(wiredFaultChangeStructClass, wiredFaultChangeStructCtor
                    , value_current
                    , value_previous
                    );
    ...
    chip::JniReferences::GetInstance().AddToList(value_previous, newElement_0);
                    ...
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$PowerSourceClusterBatFaultChangeEvent", batFaultChangeStructClass);
                    if (err != CHIP_NO_ERROR) {
                    ...
                    err = chip::JniReferences::GetInstance().FindMethod(
                       env, batFaultChangeStructClass, "<init>",
                       "(Ljava/util/ArrayList;Ljava/util/ArrayList;)V",
                    ...
                    jobject value = env->NewObject(batFaultChangeStructClass, batFaultChangeStructCtor
                    , value_current
                    , value_previous
                    );
    ...
    chip::JniReferences::GetInstance().AddToList(value_previous, newElement_0);
                    ...
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$PowerSourceClusterBatChargeFaultChangeEvent", batChargeFaultChangeStructClass);
                    if (err != CHIP_NO_ERROR) {
                    ...
                    err = chip::JniReferences::GetInstance().FindMethod(
                       env, batChargeFaultChangeStructClass, "<init>",
                       "(Ljava/util/ArrayList;Ljava/util/ArrayList;)V",
                    ...
                    jobject value = env->NewObject(batChargeFaultChangeStructClass, batChargeFaultChangeStructCtor
                    , value_current
                    , value_previous
                    );
    ...
    chip::JniReferences::GetInstance().AddToList(value_previous, newElement_0);
                    ...
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$GeneralDiagnosticsClusterHardwareFaultChangeEvent", hardwareFaultChangeStructClass);
                    if (err != CHIP_NO_ERROR) {
                    ...
                    err = chip::JniReferences::GetInstance().FindMethod(
                       env, hardwareFaultChangeStructClass, "<init>",
                       "(Ljava/util/ArrayList;Ljava/util/ArrayList;)V",
                    ...
                    jobject value = env->NewObject(hardwareFaultChangeStructClass, hardwareFaultChangeStructCtor
                    , value_current
                    , value_previous
                    );
    ...
    chip::JniReferences::GetInstance().AddToList(value_previous, newElement_0);
                    ...
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$GeneralDiagnosticsClusterRadioFaultChangeEvent", radioFaultChangeStructClass);
                    if (err != CHIP_NO_ERROR) {
                    ...
                    err = chip::JniReferences::GetInstance().FindMethod(
                       env, radioFaultChangeStructClass, "<init>",
                       "(Ljava/util/ArrayList;Ljava/util/ArrayList;)V",
                    ...
                    jobject value = env->NewObject(radioFaultChangeStructClass, radioFaultChangeStructCtor
                    , value_current
                    , value_previous
                    );
    ...
    chip::JniReferences::GetInstance().AddToList(value_previous, newElement_0);
                    ...
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$GeneralDiagnosticsClusterNetworkFaultChangeEvent", networkFaultChangeStructClass);
                    if (err != CHIP_NO_ERROR) {
                    ...
                    err = chip::JniReferences::GetInstance().FindMethod(
                       env, networkFaultChangeStructClass, "<init>",
                       "(Ljava/util/ArrayList;Ljava/util/ArrayList;)V",
                    ...
                    jobject value = env->NewObject(networkFaultChangeStructClass, networkFaultChangeStructCtor
                    , value_current
                    , value_previous
                    );
      ...
      chip::JniReferences::GetInstance().CreateBoxedObject<jint>(value_bootReasonClassName.c_str(), value_bootReasonCtorSignature.c_str(), jnivalue_bootReason, value_bootReason);

                    jclass bootReasonStructClass;
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$GeneralDiagnosticsClusterBootReasonEvent", bootReasonStructClass);
                    if (err != CHIP_NO_ERROR) {
                    ...
                    err = chip::JniReferences::GetInstance().FindMethod(
                       env, bootReasonStructClass, "<init>",
                       "(Ljava/lang/Integer;)V",
                    ...
                    jobject value = env->NewObject(bootReasonStructClass, bootReasonStructCtor
                    , value_bootReason
                    );
        ...
        std::string value_idCtorSignature = "(J)V";
          ...
          chip::JniReferences::GetInstance().CreateBoxedObject<jlong>(value_idClassName.c_str(), value_idCtorSignature.c_str(), jnivalue_id, value_id);
                    ...
                    if (!cppValue.name.HasValue()) {
                      ...
                      jobject value_nameInsideOptional;
                              LogErrorOnFailure(chip::JniReferences::GetInstance().CharToStringUTF(cppValue.name.Value(), value_nameInsideOptional));
  chip::JniReferences::GetInstance().CreateOptional(value_nameInsideOptional, value_name);
                    ...
                    if (!cppValue.faultRecording.HasValue()) {
                      ...
                      jobject value_faultRecordingInsideOptional;
                              jbyteArray value_faultRecordingInsideOptionalByteArray = env->NewByteArray(static_cast<jsize>(cppValue.faultRecording.Value().size()));
        env->SetByteArrayRegion(value_faultRecordingInsideOptionalByteArray, 0, static_cast<jsize>(cppValue.faultRecording.Value().size()), reinterpret_cast<const jbyte *>(cppValue.faultRecording.Value().data()));
  ...
  chip::JniReferences::GetInstance().CreateOptional(value_faultRecordingInsideOptional, value_faultRecording);
                    ...
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$SoftwareDiagnosticsClusterSoftwareFaultEvent", softwareFaultStructClass);
                    if (err != CHIP_NO_ERROR) {
                    ...
                    err = chip::JniReferences::GetInstance().FindMethod(
                       env, softwareFaultStructClass, "<init>",
                    ...
                    jobject value = env->NewObject(softwareFaultStructClass, softwareFaultStructCtor
                    , value_id
                    , value_name
      ...
      chip::JniReferences::GetInstance().CreateBoxedObject<jint>(value_connectionStatusClassName.c_str(), value_connectionStatusCtorSignature.c_str(), jnivalue_connectionStatus, value_connectionStatus);

                    jclass connectionStatusStructClass;
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$ThreadNetworkDiagnosticsClusterConnectionStatusEvent", connectionStatusStructClass);
                    if (err != CHIP_NO_ERROR) {
                    ...
                    err = chip::JniReferences::GetInstance().FindMethod(
                       env, connectionStatusStructClass, "<init>",
                       "(Ljava/lang/Integer;)V",
                       &connectionStatusStructCtor);
                    if (err != CHIP_NO_ERROR || connectionStatusStructCtor == nullptr) {
                        ChipLogError(Zcl, "Could not find ChipEventStructs$ThreadNetworkDiagnosticsClusterConnectionStatusEvent constructor");
                        return nullptr;
                    }

                    jobject value = env->NewObject(connectionStatusStructClass, connectionStatusStructCtor
    ...
    chip::JniReferences::GetInstance().AddToList(value_previous, newElement_0);
                    ...
                    jclass networkFaultChangeStructClass;
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$ThreadNetworkDiagnosticsClusterNetworkFaultChangeEvent", networkFaultChangeStructClass);
                    if (err != CHIP_NO_ERROR) {
                    ...
                    err = chip::JniReferences::GetInstance().FindMethod(
                       ...
                       &networkFaultChangeStructCtor);
                    if (err != CHIP_NO_ERROR || networkFaultChangeStructCtor == nullptr) {
                        ChipLogError(Zcl, "Could not find ChipEventStructs$ThreadNetworkDiagnosticsClusterNetworkFaultChangeEvent constructor");
                        return nullptr;
                    }
        ...
        std::string value_reasonCodeCtorSignature = "(I)V";
          ...
          chip::JniReferences::GetInstance().CreateBoxedObject<jint>(value_reasonCodeClassName.c_str(), value_reasonCodeCtorSignature.c_str(), jnivalue_reasonCode, value_reasonCode);
      
                    jclass disconnectionStructClass;
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$WiFiNetworkDiagnosticsClusterDisconnectionEvent", disconnectionStructClass);
                    if (err != CHIP_NO_ERROR) {
                    ...
                    err = chip::JniReferences::GetInstance().FindMethod(
                       env, disconnectionStructClass, "<init>",
                       "(Ljava/lang/Integer;)V",
                    ...
                    jobject value = env->NewObject(disconnectionStructClass, disconnectionStructCtor
                    , value_reasonCode
                    );
      ...
      chip::JniReferences::GetInstance().CreateBoxedObject<jint>(value_associationFailureCauseClassName.c_str(), value_associationFailureCauseCtorSignature.c_str(), jnivalue_associationFailureCause, value_associationFailureCause);
        ...
        std::string value_statusCtorSignature = "(I)V";
          ...
          chip::JniReferences::GetInstance().CreateBoxedObject<jint>(value_statusClassName.c_str(), value_statusCtorSignature.c_str(), jnivalue_status, value_status);
      
                    jclass associationFailureStructClass;
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$WiFiNetworkDiagnosticsClusterAssociationFailureEvent", associationFailureStructClass);
                    if (err != CHIP_NO_ERROR) {
                    ...
                    err = chip::JniReferences::GetInstance().FindMethod(
                       env, associationFailureStructClass, "<init>",
                       "(Ljava/lang/Integer;Ljava/lang/Integer;)V",
                       &associationFailureStructCtor);
                    if (err != CHIP_NO_ERROR || associationFailureStructCtor == nullptr) {
                        ChipLogError(Zcl, "Could not find ChipEventStructs$WiFiNetworkDiagnosticsClusterAssociationFailureEvent constructor");
                        return nullptr;
                    }

                    jobject value = env->NewObject(associationFailureStructClass, associationFailureStructCtor
                    , value_associationFailureCause
                    , value_status
                    );
      ...
      chip::JniReferences::GetInstance().CreateBoxedObject<jint>(value_connectionStatusClassName.c_str(), value_connectionStatusCtorSignature.c_str(), jnivalue_connectionStatus, value_connectionStatus);
                    ...
                    jclass connectionStatusStructClass;
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$WiFiNetworkDiagnosticsClusterConnectionStatusEvent", connectionStatusStructClass);
                    if (err != CHIP_NO_ERROR) {
            ...
            switch (aPath.mEventId)
            {
                case Events::DSTTableEmpty::Id: {
                    ...
                    *aError = app::DataModel::Decode(aReader, cppValue);
                    ...
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$TimeSynchronizationClusterDSTTableEmptyEvent", DSTTableEmptyStructClass);
                    if (err != CHIP_NO_ERROR) {
                    ...
                    err = chip::JniReferences::GetInstance().FindMethod(
                       env, DSTTableEmptyStructClass, "<init>",
                       "()V",
        ...
        std::string value_DSTOffsetActiveCtorSignature = "(Z)V";
          ...
          chip::JniReferences::GetInstance().CreateBoxedObject<jboolean>(value_DSTOffsetActiveClassName.c_str(), value_DSTOffsetActiveCtorSignature.c_str(), jnivalue_DSTOffsetActive, value_DSTOffsetActive);
      
                    jclass DSTStatusStructClass;
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$TimeSynchronizationClusterDSTStatusEvent", DSTStatusStructClass);
                    if (err != CHIP_NO_ERROR) {
                    ...
                    jobject value = env->NewObject(DSTStatusStructClass, DSTStatusStructCtor
        ...
        std::string value_offsetCtorSignature = "(J)V";
          ...
          chip::JniReferences::GetInstance().CreateBoxedObject<jlong>(value_offsetClassName.c_str(), value_offsetCtorSignature.c_str(), jnivalue_offset, value_offset);
  ...
  chip::JniReferences::GetInstance().CreateOptional(value_nameInsideOptional, value_name);
                    ...
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$TimeSynchronizationClusterTimeZoneStatusEvent", timeZoneStatusStructClass);
                    if (err != CHIP_NO_ERROR) {
                    ...
                    err = chip::JniReferences::GetInstance().FindMethod(
                       env, timeZoneStatusStructClass, "<init>",
                       "(Ljava/lang/Long;Ljava/util/Optional;)V",
                       &timeZoneStatusStructCtor);
                    ...
                    jobject value = env->NewObject(timeZoneStatusStructClass, timeZoneStatusStructCtor
                    , value_offset
                    , value_name
                    );
                ...
                case Events::TimeFailure::Id: {
                    ...
                    *aError = app::DataModel::Decode(aReader, cppValue);
                    ...
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$TimeSynchronizationClusterTimeFailureEvent", timeFailureStructClass);
                    if (err != CHIP_NO_ERROR) {
                    ...
                    err = chip::JniReferences::GetInstance().FindMethod(
                       env, timeFailureStructClass, "<init>",
                       "()V",
                       &timeFailureStructCtor);
                ...
                case Events::MissingTrustedTimeSource::Id: {
                    ...
                    *aError = app::DataModel::Decode(aReader, cppValue);
                    ...
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$TimeSynchronizationClusterMissingTrustedTimeSourceEvent", missingTrustedTimeSourceStructClass);
                    if (err != CHIP_NO_ERROR) {
                    ...
                    err = chip::JniReferences::GetInstance().FindMethod(
                       env, missingTrustedTimeSourceStructClass, "<init>",
                       "()V",
                       &missingTrustedTimeSourceStructCtor);
                    if (err != CHIP_NO_ERROR || missingTrustedTimeSourceStructCtor == nullptr) {
                        ChipLogError(Zcl, "Could not find ChipEventStructs$TimeSynchronizationClusterMissingTrustedTimeSourceEvent constructor");
                        return nullptr;
                    }
        ...
        std::string value_softwareVersionCtorSignature = "(J)V";
          ...
          chip::JniReferences::GetInstance().CreateBoxedObject<jlong>(value_softwareVersionClassName.c_str(), value_softwareVersionCtorSignature.c_str(), jnivalue_softwareVersion, value_softwareVersion);
                    ...
                    jclass startUpStructClass;
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$BridgedDeviceBasicInformationClusterStartUpEvent", startUpStructClass);
                    if (err != CHIP_NO_ERROR) {
                ...
                case Events::ShutDown::Id: {
                    ...
                    *aError = app::DataModel::Decode(aReader, cppValue);
                    ...
                    jclass shutDownStructClass;
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$BridgedDeviceBasicInformationClusterShutDownEvent", shutDownStructClass);
                    if (err != CHIP_NO_ERROR) {
                ...
                case Events::Leave::Id: {
                    ...
                    *aError = app::DataModel::Decode(aReader, cppValue);
                    ...
                    jclass leaveStructClass;
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$BridgedDeviceBasicInformationClusterLeaveEvent", leaveStructClass);
                    if (err != CHIP_NO_ERROR) {
        ...
        std::string value_reachableNewValueCtorSignature = "(Z)V";
          ...
          chip::JniReferences::GetInstance().CreateBoxedObject<jboolean>(value_reachableNewValueClassName.c_str(), value_reachableNewValueCtorSignature.c_str(), jnivalue_reachableNewValue, value_reachableNewValue);
                    ...
                    jclass reachableChangedStructClass;
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$BridgedDeviceBasicInformationClusterReachableChangedEvent", reachableChangedStructClass);
                    if (err != CHIP_NO_ERROR) {
                        ChipLogError(Zcl, "Could not find class ChipEventStructs$BridgedDeviceBasicInformationClusterReachableChangedEvent");
                        return nullptr;
                    }
                    ...
                    err = chip::JniReferences::GetInstance().FindMethod(
                       ...
                       &reachableChangedStructCtor);
                    if (err != CHIP_NO_ERROR || reachableChangedStructCtor == nullptr) {
                        ChipLogError(Zcl, "Could not find ChipEventStructs$BridgedDeviceBasicInformationClusterReachableChangedEvent constructor");
                        return nullptr;
                    }
        ...
        std::string value_promisedActiveDurationCtorSignature = "(J)V";
          ...
          chip::JniReferences::GetInstance().CreateBoxedObject<jlong>(value_promisedActiveDurationClassName.c_str(), value_promisedActiveDurationCtorSignature.c_str(), jnivalue_promisedActiveDuration, value_promisedActiveDuration);
      
                    jclass activeChangedStructClass;
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$BridgedDeviceBasicInformationClusterActiveChangedEvent", activeChangedStructClass);
                    if (err != CHIP_NO_ERROR) {
                    ...
                    err = chip::JniReferences::GetInstance().FindMethod(
                       env, activeChangedStructClass, "<init>",
                       "(Ljava/lang/Long;)V",
                       &activeChangedStructCtor);
                    if (err != CHIP_NO_ERROR || activeChangedStructCtor == nullptr) {
                        ChipLogError(Zcl, "Could not find ChipEventStructs$BridgedDeviceBasicInformationClusterActiveChangedEvent constructor");
                        return nullptr;
                    }

                    jobject value = env->NewObject(activeChangedStructClass, activeChangedStructCtor
                    , value_promisedActiveDuration
                    );
        ...
        std::string value_newPositionCtorSignature = "(I)V";
          ...
          chip::JniReferences::GetInstance().CreateBoxedObject<jint>(value_newPositionClassName.c_str(), value_newPositionCtorSignature.c_str(), jnivalue_newPosition, value_newPosition);
      
                    jclass switchLatchedStructClass;
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$SwitchClusterSwitchLatchedEvent", switchLatchedStructClass);
                    if (err != CHIP_NO_ERROR) {
                    ...
                    err = chip::JniReferences::GetInstance().FindMethod(
                       env, switchLatchedStructClass, "<init>",
                       "(Ljava/lang/Integer;)V",
                    ...
                    jobject value = env->NewObject(switchLatchedStructClass, switchLatchedStructCtor
                    , value_newPosition
                    );
        ...
        std::string value_newPositionCtorSignature = "(I)V";
          ...
          chip::JniReferences::GetInstance().CreateBoxedObject<jint>(value_newPositionClassName.c_str(), value_newPositionCtorSignature.c_str(), jnivalue_newPosition, value_newPosition);
                    ...
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$SwitchClusterInitialPressEvent", initialPressStructClass);
                    if (err != CHIP_NO_ERROR) {
                    ...
                    err = chip::JniReferences::GetInstance().FindMethod(
                       env, initialPressStructClass, "<init>",
                       "(Ljava/lang/Integer;)V",
                    ...
                    jobject value = env->NewObject(initialPressStructClass, initialPressStructCtor
                    , value_newPosition
                    );
        ...
        std::string value_newPositionCtorSignature = "(I)V";
          ...
          chip::JniReferences::GetInstance().CreateBoxedObject<jint>(value_newPositionClassName.c_str(), value_newPositionCtorSignature.c_str(), jnivalue_newPosition, value_newPosition);
                    ...
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$SwitchClusterLongPressEvent", longPressStructClass);
                    if (err != CHIP_NO_ERROR) {
                    ...
                    jobject value = env->NewObject(longPressStructClass, longPressStructCtor
                    , value_newPosition
                    );
        ...
        std::string value_previousPositionCtorSignature = "(I)V";
          ...
          chip::JniReferences::GetInstance().CreateBoxedObject<jint>(value_previousPositionClassName.c_str(), value_previousPositionCtorSignature.c_str(), jnivalue_previousPosition, value_previousPosition);
      
                    jclass shortReleaseStructClass;
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$SwitchClusterShortReleaseEvent", shortReleaseStructClass);
                    if (err != CHIP_NO_ERROR) {
                    ...
                    err = chip::JniReferences::GetInstance().FindMethod(
                       env, shortReleaseStructClass, "<init>",
                       "(Ljava/lang/Integer;)V",
                    ...
                    jobject value = env->NewObject(shortReleaseStructClass, shortReleaseStructCtor
        ...
        std::string value_previousPositionCtorSignature = "(I)V";
          ...
          chip::JniReferences::GetInstance().CreateBoxedObject<jint>(value_previousPositionClassName.c_str(), value_previousPositionCtorSignature.c_str(), jnivalue_previousPosition, value_previousPosition);
                    ...
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$SwitchClusterLongReleaseEvent", longReleaseStructClass);
                    if (err != CHIP_NO_ERROR) {
                    ...
                    err = chip::JniReferences::GetInstance().FindMethod(
                       env, longReleaseStructClass, "<init>",
                       "(Ljava/lang/Integer;)V",
                    ...
                    jobject value = env->NewObject(longReleaseStructClass, longReleaseStructCtor
                    , value_previousPosition
                    );
        ...
        std::string value_currentNumberOfPressesCountedCtorSignature = "(I)V";
          ...
          chip::JniReferences::GetInstance().CreateBoxedObject<jint>(value_currentNumberOfPressesCountedClassName.c_str(), value_currentNumberOfPressesCountedCtorSignature.c_str(), jnivalue_currentNumberOfPressesCounted, value_currentNumberOfPressesCounted);
      
                    jclass multiPressOngoingStructClass;
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$SwitchClusterMultiPressOngoingEvent", multiPressOngoingStructClass);
                    if (err != CHIP_NO_ERROR) {
                    ...
                    err = chip::JniReferences::GetInstance().FindMethod(
                       env, multiPressOngoingStructClass, "<init>",
                       "(Ljava/lang/Integer;Ljava/lang/Integer;)V",
                    ...
                    jobject value = env->NewObject(multiPressOngoingStructClass, multiPressOngoingStructCtor
                    , value_newPosition
        ...
        std::string value_totalNumberOfPressesCountedCtorSignature = "(I)V";
          ...
          chip::JniReferences::GetInstance().CreateBoxedObject<jint>(value_totalNumberOfPressesCountedClassName.c_str(), value_totalNumberOfPressesCountedCtorSignature.c_str(), jnivalue_totalNumberOfPressesCounted, value_totalNumberOfPressesCounted);
      
                    jclass multiPressCompleteStructClass;
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$SwitchClusterMultiPressCompleteEvent", multiPressCompleteStructClass);
                    if (err != CHIP_NO_ERROR) {
                    ...
                    err = chip::JniReferences::GetInstance().FindMethod(
                       env, multiPressCompleteStructClass, "<init>",
                       "(Ljava/lang/Integer;Ljava/lang/Integer;)V",
                    ...
                    jobject value = env->NewObject(multiPressCompleteStructClass, multiPressCompleteStructCtor
                    , value_previousPosition
        ...
        std::string value_stateValueCtorSignature = "(Z)V";
          ...
          chip::JniReferences::GetInstance().CreateBoxedObject<jboolean>(value_stateValueClassName.c_str(), value_stateValueCtorSignature.c_str(), jnivalue_stateValue, value_stateValue);
      
                    jclass stateChangeStructClass;
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$BooleanStateClusterStateChangeEvent", stateChangeStructClass);
                    if (err != CHIP_NO_ERROR) {
                    ...
                    err = chip::JniReferences::GetInstance().FindMethod(
                       env, stateChangeStructClass, "<init>",
                       "(Ljava/lang/Boolean;)V",
                    ...
                    jobject value = env->NewObject(stateChangeStructClass, stateChangeStructCtor
                    , value_stateValue
                    );
        ...
        std::string value_errorState_errorStateIDCtorSignature = "(I)V";
          ...
          chip::JniReferences::GetInstance().CreateBoxedObject<jint>(value_errorState_errorStateIDClassName.c_str(), value_errorState_errorStateIDCtorSignature.c_str(), jnivalue_errorState_errorStateID, value_errorState_errorStateID);
      ...
      if (!cppValue.errorState.errorStateLabel.HasValue()) {
        ...
        jobject value_errorState_errorStateLabelInsideOptional;
                LogErrorOnFailure(chip::JniReferences::GetInstance().CharToStringUTF(cppValue.errorState.errorStateLabel.Value(), value_errorState_errorStateLabelInsideOptional));
  chip::JniReferences::GetInstance().CreateOptional(value_errorState_errorStateLabelInsideOptional, value_errorState_errorStateLabel);
      }
      ...
      if (!cppValue.errorState.errorStateDetails.HasValue()) {
        ...
        jobject value_errorState_errorStateDetailsInsideOptional;
                LogErrorOnFailure(chip::JniReferences::GetInstance().CharToStringUTF(cppValue.errorState.errorStateDetails.Value(), value_errorState_errorStateDetailsInsideOptional));
  chip::JniReferences::GetInstance().CreateOptional(value_errorState_errorStateDetailsInsideOptional, value_errorState_errorStateDetails);
      }

    jclass errorStateStructStructClass_0;
    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipStructs$OvenCavityOperationalStateClusterErrorStateStruct", errorStateStructStructClass_0);
    if (err != CHIP_NO_ERROR) {
    ...
    err = chip::JniReferences::GetInstance().FindMethod(
        env, errorStateStructStructClass_0, "<init>",
    ...
    value_errorState = env->NewObject(errorStateStructStructClass_0, errorStateStructStructCtor_0
      , value_errorState_errorStateID
      , value_errorState_errorStateLabel
      , value_errorState_errorStateDetails
    );

                    jclass operationalErrorStructClass;
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$OvenCavityOperationalStateClusterOperationalErrorEvent", operationalErrorStructClass);
                    if (err != CHIP_NO_ERROR) {
                    ...
                    if (err != CHIP_NO_ERROR || operationalErrorStructCtor == nullptr) {
                        ChipLogError(Zcl, "Could not find ChipEventStructs$OvenCavityOperationalStateClusterOperationalErrorEvent constructor");
                        return nullptr;
                    }

                    jobject value = env->NewObject(operationalErrorStructClass, operationalErrorStructCtor
                    , value_errorState
                    );
        ...
        std::string value_completionErrorCodeCtorSignature = "(I)V";
          ...
          chip::JniReferences::GetInstance().CreateBoxedObject<jint>(value_completionErrorCodeClassName.c_str(), value_completionErrorCodeCtorSignature.c_str(), jnivalue_completionErrorCode, value_completionErrorCode);
        ...
        std::string value_totalOperationalTimeInsideOptionalCtorSignature = "(J)V";
          jlong jnivalue_totalOperationalTimeInsideOptional = static_cast<jlong>(cppValue.totalOperationalTime.Value().Value());
          chip::JniReferences::GetInstance().CreateBoxedObject<jlong>(value_totalOperationalTimeInsideOptionalClassName.c_str(), value_totalOperationalTimeInsideOptionalCtorSignature.c_str(), jnivalue_totalOperationalTimeInsideOptional, value_totalOperationalTimeInsideOptional);
      }
        ...
        std::string value_pausedTimeInsideOptionalCtorSignature = "(J)V";
          ...
          chip::JniReferences::GetInstance().CreateBoxedObject<jlong>(value_pausedTimeInsideOptionalClassName.c_str(), value_pausedTimeInsideOptionalCtorSignature.c_str(), jnivalue_pausedTimeInsideOptional, value_pausedTimeInsideOptional);
      }
                    ...
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$OvenCavityOperationalStateClusterOperationCompletionEvent", operationCompletionStructClass);
                    if (err != CHIP_NO_ERROR) {
                        ChipLogError(Zcl, "Could not find class ChipEventStructs$OvenCavityOperationalStateClusterOperationCompletionEvent");
                        return nullptr;
                    }

                    jmethodID operationCompletionStructCtor;
                    err = chip::JniReferences::GetInstance().FindMethod(
                       env, operationCompletionStructClass, "<init>",
                       "(Ljava/lang/Integer;Ljava/util/Optional;Ljava/util/Optional;)V",
                       &operationCompletionStructCtor);
                    if (err != CHIP_NO_ERROR || operationCompletionStructCtor == nullptr) {
                        ChipLogError(Zcl, "Could not find ChipEventStructs$OvenCavityOperationalStateClusterOperationCompletionEvent constructor");
                        return nullptr;
                    }

                    jobject value = env->NewObject(operationCompletionStructClass, operationCompletionStructCtor
                    , value_completionErrorCode
        ...
        std::string value_activeCtorSignature = "(J)V";
          ...
          chip::JniReferences::GetInstance().CreateBoxedObject<jlong>(value_activeClassName.c_str(), value_activeCtorSignature.c_str(), jnivalue_active, value_active);
        ...
        std::string value_inactiveCtorSignature = "(J)V";
          ...
          chip::JniReferences::GetInstance().CreateBoxedObject<jlong>(value_inactiveClassName.c_str(), value_inactiveCtorSignature.c_str(), jnivalue_inactive, value_inactive);
        ...
        std::string value_stateCtorSignature = "(J)V";
          ...
          chip::JniReferences::GetInstance().CreateBoxedObject<jlong>(value_stateClassName.c_str(), value_stateCtorSignature.c_str(), jnivalue_state, value_state);
        ...
        std::string value_maskCtorSignature = "(J)V";
          ...
          chip::JniReferences::GetInstance().CreateBoxedObject<jlong>(value_maskClassName.c_str(), value_maskCtorSignature.c_str(), jnivalue_mask, value_mask);
      
                    jclass notifyStructClass;
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$RefrigeratorAlarmClusterNotifyEvent", notifyStructClass);
                    if (err != CHIP_NO_ERROR) {
                    ...
                    jobject value = env->NewObject(notifyStructClass, notifyStructCtor
                    , value_active
                    , value_inactive
                    , value_state
                    , value_mask
      ...
      chip::JniReferences::GetInstance().CreateBoxedObject<jint>(value_alarmSeverityLevelClassName.c_str(), value_alarmSeverityLevelCtorSignature.c_str(), jnivalue_alarmSeverityLevel, value_alarmSeverityLevel);

                    jclass smokeAlarmStructClass;
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$SmokeCoAlarmClusterSmokeAlarmEvent", smokeAlarmStructClass);
                    if (err != CHIP_NO_ERROR) {
                    ...
                    err = chip::JniReferences::GetInstance().FindMethod(
                       env, smokeAlarmStructClass, "<init>",
                       "(Ljava/lang/Integer;)V",
      ...
      chip::JniReferences::GetInstance().CreateBoxedObject<jint>(value_alarmSeverityLevelClassName.c_str(), value_alarmSeverityLevelCtorSignature.c_str(), jnivalue_alarmSeverityLevel, value_alarmSeverityLevel);
                    ...
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$SmokeCoAlarmClusterCOAlarmEvent", COAlarmStructClass);
                    if (err != CHIP_NO_ERROR) {
      ...
      chip::JniReferences::GetInstance().CreateBoxedObject<jint>(value_alarmSeverityLevelClassName.c_str(), value_alarmSeverityLevelCtorSignature.c_str(), jnivalue_alarmSeverityLevel, value_alarmSeverityLevel);
                    ...
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$SmokeCoAlarmClusterLowBatteryEvent", lowBatteryStructClass);
                    if (err != CHIP_NO_ERROR) {
                    ...
                    err = chip::JniReferences::GetInstance().FindMethod(
                       env, lowBatteryStructClass, "<init>",
                       "(Ljava/lang/Integer;)V",
                ...
                case Events::HardwareFault::Id: {
                    ...
                    *aError = app::DataModel::Decode(aReader, cppValue);
                    ...
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$SmokeCoAlarmClusterHardwareFaultEvent", hardwareFaultStructClass);
                    if (err != CHIP_NO_ERROR) {
                    ...
                    err = chip::JniReferences::GetInstance().FindMethod(
                       env, hardwareFaultStructClass, "<init>",
                       "()V",
                ...
                case Events::EndOfService::Id: {
                    ...
                    *aError = app::DataModel::Decode(aReader, cppValue);
                    ...
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$SmokeCoAlarmClusterEndOfServiceEvent", endOfServiceStructClass);
                    if (err != CHIP_NO_ERROR) {
                    ...
                    err = chip::JniReferences::GetInstance().FindMethod(
                       env, endOfServiceStructClass, "<init>",
                       "()V",
                ...
                case Events::SelfTestComplete::Id: {
                    ...
                    *aError = app::DataModel::Decode(aReader, cppValue);
                    ...
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$SmokeCoAlarmClusterSelfTestCompleteEvent", selfTestCompleteStructClass);
                    if (err != CHIP_NO_ERROR) {
                    ...
                    err = chip::JniReferences::GetInstance().FindMethod(
                       env, selfTestCompleteStructClass, "<init>",
                       "()V",
                ...
                case Events::AlarmMuted::Id: {
                    ...
                    *aError = app::DataModel::Decode(aReader, cppValue);
                    ...
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$SmokeCoAlarmClusterAlarmMutedEvent", alarmMutedStructClass);
                    if (err != CHIP_NO_ERROR) {
                    ...
                    err = chip::JniReferences::GetInstance().FindMethod(
                       env, alarmMutedStructClass, "<init>",
                       "()V",
                       &alarmMutedStructCtor);
                ...
                case Events::MuteEnded::Id: {
                    ...
                    *aError = app::DataModel::Decode(aReader, cppValue);
                    ...
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$SmokeCoAlarmClusterMuteEndedEvent", muteEndedStructClass);
                    if (err != CHIP_NO_ERROR) {
      ...
      chip::JniReferences::GetInstance().CreateBoxedObject<jint>(value_alarmSeverityLevelClassName.c_str(), value_alarmSeverityLevelCtorSignature.c_str(), jnivalue_alarmSeverityLevel, value_alarmSeverityLevel);
                    ...
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$SmokeCoAlarmClusterInterconnectSmokeAlarmEvent", interconnectSmokeAlarmStructClass);
                    if (err != CHIP_NO_ERROR) {
                    ...
                    err = chip::JniReferences::GetInstance().FindMethod(
                       env, interconnectSmokeAlarmStructClass, "<init>",
                       "(Ljava/lang/Integer;)V",
                       &interconnectSmokeAlarmStructCtor);
      ...
      chip::JniReferences::GetInstance().CreateBoxedObject<jint>(value_alarmSeverityLevelClassName.c_str(), value_alarmSeverityLevelCtorSignature.c_str(), jnivalue_alarmSeverityLevel, value_alarmSeverityLevel);
                    ...
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$SmokeCoAlarmClusterInterconnectCOAlarmEvent", interconnectCOAlarmStructClass);
                    if (err != CHIP_NO_ERROR) {
                    ...
                    err = chip::JniReferences::GetInstance().FindMethod(
                       env, interconnectCOAlarmStructClass, "<init>",
                       "(Ljava/lang/Integer;)V",
                       &interconnectCOAlarmStructCtor);
                ...
                case Events::AllClear::Id: {
                    ...
                    *aError = app::DataModel::Decode(aReader, cppValue);
                    ...
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$SmokeCoAlarmClusterAllClearEvent", allClearStructClass);
                    if (err != CHIP_NO_ERROR) {
        ...
        std::string value_maskCtorSignature = "(J)V";
          ...
          chip::JniReferences::GetInstance().CreateBoxedObject<jlong>(value_maskClassName.c_str(), value_maskCtorSignature.c_str(), jnivalue_mask, value_mask);
                    ...
                    jclass notifyStructClass;
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$DishwasherAlarmClusterNotifyEvent", notifyStructClass);
                    if (err != CHIP_NO_ERROR) {
  ...
  chip::JniReferences::GetInstance().CreateOptional(value_errorState_errorStateDetailsInsideOptional, value_errorState_errorStateDetails);
    ...
    jclass errorStateStructStructClass_0;
    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipStructs$OperationalStateClusterErrorStateStruct", errorStateStructStructClass_0);
    if (err != CHIP_NO_ERROR) {
    ...
    value_errorState = env->NewObject(errorStateStructStructClass_0, errorStateStructStructCtor_0
      ...
      , value_errorState_errorStateDetails
                    ...
                    jclass operationalErrorStructClass;
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$OperationalStateClusterOperationalErrorEvent", operationalErrorStructClass);
                    if (err != CHIP_NO_ERROR) {
        ...
        std::string value_pausedTimeInsideOptionalCtorSignature = "(J)V";
          ...
          chip::JniReferences::GetInstance().CreateBoxedObject<jlong>(value_pausedTimeInsideOptionalClassName.c_str(), value_pausedTimeInsideOptionalCtorSignature.c_str(), jnivalue_pausedTimeInsideOptional, value_pausedTimeInsideOptional);
                    ...
                    jclass operationCompletionStructClass;
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$OperationalStateClusterOperationCompletionEvent", operationCompletionStructClass);
                    if (err != CHIP_NO_ERROR) {
  ...
  chip::JniReferences::GetInstance().CreateOptional(value_errorState_errorStateDetailsInsideOptional, value_errorState_errorStateDetails);
    ...
    jclass errorStateStructStructClass_0;
    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipStructs$RvcOperationalStateClusterErrorStateStruct", errorStateStructStructClass_0);
    if (err != CHIP_NO_ERROR) {
    ...
    value_errorState = env->NewObject(errorStateStructStructClass_0, errorStateStructStructCtor_0
      ...
      , value_errorState_errorStateDetails
                    ...
                    jclass operationalErrorStructClass;
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$RvcOperationalStateClusterOperationalErrorEvent", operationalErrorStructClass);
                    if (err != CHIP_NO_ERROR) {
        ...
        std::string value_pausedTimeInsideOptionalCtorSignature = "(J)V";
          ...
          chip::JniReferences::GetInstance().CreateBoxedObject<jlong>(value_pausedTimeInsideOptionalClassName.c_str(), value_pausedTimeInsideOptionalCtorSignature.c_str(), jnivalue_pausedTimeInsideOptional, value_pausedTimeInsideOptional);
                    ...
                    jclass operationCompletionStructClass;
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$RvcOperationalStateClusterOperationCompletionEvent", operationCompletionStructClass);
                    if (err != CHIP_NO_ERROR) {
        ...
        std::string value_alarmsActiveCtorSignature = "(I)V";
          ...
          chip::JniReferences::GetInstance().CreateBoxedObject<jint>(value_alarmsActiveClassName.c_str(), value_alarmsActiveCtorSignature.c_str(), jnivalue_alarmsActive, value_alarmsActive);
        ...
        std::string value_alarmsSuppressedInsideOptionalCtorSignature = "(I)V";
          ...
          chip::JniReferences::GetInstance().CreateBoxedObject<jint>(value_alarmsSuppressedInsideOptionalClassName.c_str(), value_alarmsSuppressedInsideOptionalCtorSignature.c_str(), jnivalue_alarmsSuppressedInsideOptional, value_alarmsSuppressedInsideOptional);
        chip::JniReferences::GetInstance().CreateOptional(value_alarmsSuppressedInsideOptional, value_alarmsSuppressed);
                    ...
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$BooleanStateConfigurationClusterAlarmsStateChangedEvent", alarmsStateChangedStructClass);
                    if (err != CHIP_NO_ERROR) {
                    ...
                    err = chip::JniReferences::GetInstance().FindMethod(
                       env, alarmsStateChangedStructClass, "<init>",
                    ...
                    if (err != CHIP_NO_ERROR || alarmsStateChangedStructCtor == nullptr) {
                        ChipLogError(Zcl, "Could not find ChipEventStructs$BooleanStateConfigurationClusterAlarmsStateChangedEvent constructor");
                        return nullptr;
                    }

                    jobject value = env->NewObject(alarmsStateChangedStructClass, alarmsStateChangedStructCtor
                    , value_alarmsActive
        ...
        std::string value_sensorFaultCtorSignature = "(I)V";
          ...
          chip::JniReferences::GetInstance().CreateBoxedObject<jint>(value_sensorFaultClassName.c_str(), value_sensorFaultCtorSignature.c_str(), jnivalue_sensorFault, value_sensorFault);
      
                    jclass sensorFaultStructClass;
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$BooleanStateConfigurationClusterSensorFaultEvent", sensorFaultStructClass);
                    if (err != CHIP_NO_ERROR) {
                    ...
                    err = chip::JniReferences::GetInstance().FindMethod(
                       env, sensorFaultStructClass, "<init>",
                       "(Ljava/lang/Integer;)V",
      ...
      chip::JniReferences::GetInstance().CreateBoxedObject<jint>(value_valveStateClassName.c_str(), value_valveStateCtorSignature.c_str(), jnivalue_valveState, value_valveState);
        ...
        std::string value_valveLevelInsideOptionalCtorSignature = "(I)V";
          ...
          chip::JniReferences::GetInstance().CreateBoxedObject<jint>(value_valveLevelInsideOptionalClassName.c_str(), value_valveLevelInsideOptionalCtorSignature.c_str(), jnivalue_valveLevelInsideOptional, value_valveLevelInsideOptional);
        chip::JniReferences::GetInstance().CreateOptional(value_valveLevelInsideOptional, value_valveLevel);
                    ...
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$ValveConfigurationAndControlClusterValveStateChangedEvent", valveStateChangedStructClass);
                    if (err != CHIP_NO_ERROR) {
                        ChipLogError(Zcl, "Could not find class ChipEventStructs$ValveConfigurationAndControlClusterValveStateChangedEvent");
                        return nullptr;
                    }

                    jmethodID valveStateChangedStructCtor;
                    err = chip::JniReferences::GetInstance().FindMethod(
                       env, valveStateChangedStructClass, "<init>",
                       "(Ljava/lang/Integer;Ljava/util/Optional;)V",
                       &valveStateChangedStructCtor);
                    if (err != CHIP_NO_ERROR || valveStateChangedStructCtor == nullptr) {
                        ChipLogError(Zcl, "Could not find ChipEventStructs$ValveConfigurationAndControlClusterValveStateChangedEvent constructor");
                        return nullptr;
                    }

                    jobject value = env->NewObject(valveStateChangedStructClass, valveStateChangedStructCtor
                    , value_valveState
                    , value_valveLevel
                    );
        ...
        std::string value_valveFaultCtorSignature = "(I)V";
          ...
          chip::JniReferences::GetInstance().CreateBoxedObject<jint>(value_valveFaultClassName.c_str(), value_valveFaultCtorSignature.c_str(), jnivalue_valveFault, value_valveFault);
      
                    jclass valveFaultStructClass;
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$ValveConfigurationAndControlClusterValveFaultEvent", valveFaultStructClass);
                    if (err != CHIP_NO_ERROR) {
                    ...
                    err = chip::JniReferences::GetInstance().FindMethod(
                       env, valveFaultStructClass, "<init>",
                       "(Ljava/lang/Integer;)V",
                    ...
                    jobject value = env->NewObject(valveFaultStructClass, valveFaultStructCtor
                    , value_valveFault
                    );
      ...
      chip::JniReferences::GetInstance().CreateBoxedObject<jint>(newElement_0_measurementTypeClassName.c_str(), newElement_0_measurementTypeCtorSignature.c_str(), jninewElement_0_measurementType, newElement_0_measurementType);
      jobject newElement_0_min;
        ...
        std::string newElement_0_minCtorSignature = "(J)V";
          ...
          chip::JniReferences::GetInstance().CreateBoxedObject<jlong>(newElement_0_minClassName.c_str(), newElement_0_minCtorSignature.c_str(), jninewElement_0_min, newElement_0_min);
        ...
        std::string newElement_0_maxCtorSignature = "(J)V";
          ...
          chip::JniReferences::GetInstance().CreateBoxedObject<jlong>(newElement_0_maxClassName.c_str(), newElement_0_maxCtorSignature.c_str(), jninewElement_0_max, newElement_0_max);
      ...
      if (!entry_0.startTimestamp.HasValue()) {
        ...
        std::string newElement_0_startTimestampInsideOptionalCtorSignature = "(J)V";
          ...
          chip::JniReferences::GetInstance().CreateBoxedObject<jlong>(newElement_0_startTimestampInsideOptionalClassName.c_str(), newElement_0_startTimestampInsideOptionalCtorSignature.c_str(), jninewElement_0_startTimestampInsideOptional, newElement_0_startTimestampInsideOptional);
        chip::JniReferences::GetInstance().CreateOptional(newElement_0_startTimestampInsideOptional, newElement_0_startTimestamp);
      }
      ...
      if (!entry_0.endTimestamp.HasValue()) {
        ...
        std::string newElement_0_endTimestampInsideOptionalCtorSignature = "(J)V";
          ...
          chip::JniReferences::GetInstance().CreateBoxedObject<jlong>(newElement_0_endTimestampInsideOptionalClassName.c_str(), newElement_0_endTimestampInsideOptionalCtorSignature.c_str(), jninewElement_0_endTimestampInsideOptional, newElement_0_endTimestampInsideOptional);
        chip::JniReferences::GetInstance().CreateOptional(newElement_0_endTimestampInsideOptional, newElement_0_endTimestamp);
      }
      ...
      if (!entry_0.minTimestamp.HasValue()) {
        ...
        std::string newElement_0_minTimestampInsideOptionalCtorSignature = "(J)V";
          ...
          chip::JniReferences::GetInstance().CreateBoxedObject<jlong>(newElement_0_minTimestampInsideOptionalClassName.c_str(), newElement_0_minTimestampInsideOptionalCtorSignature.c_str(), jninewElement_0_minTimestampInsideOptional, newElement_0_minTimestampInsideOptional);
        chip::JniReferences::GetInstance().CreateOptional(newElement_0_minTimestampInsideOptional, newElement_0_minTimestamp);
      }
      ...
      if (!entry_0.maxTimestamp.HasValue()) {
        ...
        std::string newElement_0_maxTimestampInsideOptionalCtorSignature = "(J)V";
          ...
          chip::JniReferences::GetInstance().CreateBoxedObject<jlong>(newElement_0_maxTimestampInsideOptionalClassName.c_str(), newElement_0_maxTimestampInsideOptionalCtorSignature.c_str(), jninewElement_0_maxTimestampInsideOptional, newElement_0_maxTimestampInsideOptional);
        chip::JniReferences::GetInstance().CreateOptional(newElement_0_maxTimestampInsideOptional, newElement_0_maxTimestamp);
      }
      ...
      if (!entry_0.startSystime.HasValue()) {
        ...
        std::string newElement_0_startSystimeInsideOptionalCtorSignature = "(J)V";
          ...
          chip::JniReferences::GetInstance().CreateBoxedObject<jlong>(newElement_0_startSystimeInsideOptionalClassName.c_str(), newElement_0_startSystimeInsideOptionalCtorSignature.c_str(), jninewElement_0_startSystimeInsideOptional, newElement_0_startSystimeInsideOptional);
        chip::JniReferences::GetInstance().CreateOptional(newElement_0_startSystimeInsideOptional, newElement_0_startSystime);
      }
      ...
      if (!entry_0.endSystime.HasValue()) {
        ...
        std::string newElement_0_endSystimeInsideOptionalCtorSignature = "(J)V";
          ...
          chip::JniReferences::GetInstance().CreateBoxedObject<jlong>(newElement_0_endSystimeInsideOptionalClassName.c_str(), newElement_0_endSystimeInsideOptionalCtorSignature.c_str(), jninewElement_0_endSystimeInsideOptional, newElement_0_endSystimeInsideOptional);
        chip::JniReferences::GetInstance().CreateOptional(newElement_0_endSystimeInsideOptional, newElement_0_endSystime);
      }
      ...
      if (!entry_0.minSystime.HasValue()) {
        ...
        std::string newElement_0_minSystimeInsideOptionalCtorSignature = "(J)V";
          ...
          chip::JniReferences::GetInstance().CreateBoxedObject<jlong>(newElement_0_minSystimeInsideOptionalClassName.c_str(), newElement_0_minSystimeInsideOptionalCtorSignature.c_str(), jninewElement_0_minSystimeInsideOptional, newElement_0_minSystimeInsideOptional);
        chip::JniReferences::GetInstance().CreateOptional(newElement_0_minSystimeInsideOptional, newElement_0_minSystime);
      }
      ...
      if (!entry_0.maxSystime.HasValue()) {
        ...
        std::string newElement_0_maxSystimeInsideOptionalCtorSignature = "(J)V";
          ...
          chip::JniReferences::GetInstance().CreateBoxedObject<jlong>(newElement_0_maxSystimeInsideOptionalClassName.c_str(), newElement_0_maxSystimeInsideOptionalCtorSignature.c_str(), jninewElement_0_maxSystimeInsideOptional, newElement_0_maxSystimeInsideOptional);
        chip::JniReferences::GetInstance().CreateOptional(newElement_0_maxSystimeInsideOptional, newElement_0_maxSystime);
      }

    jclass measurementRangeStructStructClass_1;
    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipStructs$ElectricalPowerMeasurementClusterMeasurementRangeStruct", measurementRangeStructStructClass_1);
    if (err != CHIP_NO_ERROR) {
    ...
    err = chip::JniReferences::GetInstance().FindMethod(
        ...
        "(Ljava/lang/Integer;Ljava/lang/Long;Ljava/lang/Long;Ljava/util/Optional;Ljava/util/Optional;Ljava/util/Optional;Ljava/util/Optional;Ljava/util/Optional;Ljava/util/Optional;Ljava/util/Optional;Ljava/util/Optional;)V",
        &measurementRangeStructStructCtor_1);
    if (err != CHIP_NO_ERROR || measurementRangeStructStructCtor_1 == nullptr) {
      ChipLogError(Zcl, "Could not find ChipStructs$ElectricalPowerMeasurementClusterMeasurementRangeStruct constructor");
      return nullptr;
    }

    newElement_0 = env->NewObject(measurementRangeStructStructClass_1, measurementRangeStructStructCtor_1
      , newElement_0_measurementType
      , newElement_0_min
      , newElement_0_max
    ...
    chip::JniReferences::GetInstance().AddToList(value_ranges, newElement_0);
                    ...
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$ElectricalPowerMeasurementClusterMeasurementPeriodRangesEvent", measurementPeriodRangesStructClass);
                    if (err != CHIP_NO_ERROR) {
                        ChipLogError(Zcl, "Could not find class ChipEventStructs$ElectricalPowerMeasurementClusterMeasurementPeriodRangesEvent");
                        return nullptr;
                    }

                    jmethodID measurementPeriodRangesStructCtor;
                    err = chip::JniReferences::GetInstance().FindMethod(
                       env, measurementPeriodRangesStructClass, "<init>",
                       "(Ljava/util/ArrayList;)V",
                       &measurementPeriodRangesStructCtor);
                    if (err != CHIP_NO_ERROR || measurementPeriodRangesStructCtor == nullptr) {
                        ChipLogError(Zcl, "Could not find ChipEventStructs$ElectricalPowerMeasurementClusterMeasurementPeriodRangesEvent constructor");
                        return nullptr;
                    }

                    jobject value = env->NewObject(measurementPeriodRangesStructClass, measurementPeriodRangesStructCtor
                    , value_ranges
                    );
        ...
        std::string value_energyImportedInsideOptional_energyCtorSignature = "(J)V";
          ...
          chip::JniReferences::GetInstance().CreateBoxedObject<jlong>(value_energyImportedInsideOptional_energyClassName.c_str(), value_energyImportedInsideOptional_energyCtorSignature.c_str(), jnivalue_energyImportedInsideOptional_energy, value_energyImportedInsideOptional_energy);
      ...
      if (!cppValue.energyImported.Value().startTimestamp.HasValue()) {
        ...
        std::string value_energyImportedInsideOptional_startTimestampInsideOptionalCtorSignature = "(J)V";
          jlong jnivalue_energyImportedInsideOptional_startTimestampInsideOptional = static_cast<jlong>(cppValue.energyImported.Value().startTimestamp.Value());
          chip::JniReferences::GetInstance().CreateBoxedObject<jlong>(value_energyImportedInsideOptional_startTimestampInsideOptionalClassName.c_str(), value_energyImportedInsideOptional_startTimestampInsideOptionalCtorSignature.c_str(), jnivalue_energyImportedInsideOptional_startTimestampInsideOptional, value_energyImportedInsideOptional_startTimestampInsideOptional);
        chip::JniReferences::GetInstance().CreateOptional(value_energyImportedInsideOptional_startTimestampInsideOptional, value_energyImportedInsideOptional_startTimestamp);
      }
      ...
      if (!cppValue.energyImported.Value().endTimestamp.HasValue()) {
        ...
        std::string value_energyImportedInsideOptional_endTimestampInsideOptionalCtorSignature = "(J)V";
          jlong jnivalue_energyImportedInsideOptional_endTimestampInsideOptional = static_cast<jlong>(cppValue.energyImported.Value().endTimestamp.Value());
          chip::JniReferences::GetInstance().CreateBoxedObject<jlong>(value_energyImportedInsideOptional_endTimestampInsideOptionalClassName.c_str(), value_energyImportedInsideOptional_endTimestampInsideOptionalCtorSignature.c_str(), jnivalue_energyImportedInsideOptional_endTimestampInsideOptional, value_energyImportedInsideOptional_endTimestampInsideOptional);
        chip::JniReferences::GetInstance().CreateOptional(value_energyImportedInsideOptional_endTimestampInsideOptional, value_energyImportedInsideOptional_endTimestamp);
      }
      ...
      if (!cppValue.energyImported.Value().startSystime.HasValue()) {
        ...
        std::string value_energyImportedInsideOptional_startSystimeInsideOptionalCtorSignature = "(J)V";
          jlong jnivalue_energyImportedInsideOptional_startSystimeInsideOptional = static_cast<jlong>(cppValue.energyImported.Value().startSystime.Value());
          chip::JniReferences::GetInstance().CreateBoxedObject<jlong>(value_energyImportedInsideOptional_startSystimeInsideOptionalClassName.c_str(), value_energyImportedInsideOptional_startSystimeInsideOptionalCtorSignature.c_str(), jnivalue_energyImportedInsideOptional_startSystimeInsideOptional, value_energyImportedInsideOptional_startSystimeInsideOptional);
        chip::JniReferences::GetInstance().CreateOptional(value_energyImportedInsideOptional_startSystimeInsideOptional, value_energyImportedInsideOptional_startSystime);
      }
      ...
      if (!cppValue.energyImported.Value().endSystime.HasValue()) {
        ...
        std::string value_energyImportedInsideOptional_endSystimeInsideOptionalCtorSignature = "(J)V";
          jlong jnivalue_energyImportedInsideOptional_endSystimeInsideOptional = static_cast<jlong>(cppValue.energyImported.Value().endSystime.Value());
          chip::JniReferences::GetInstance().CreateBoxedObject<jlong>(value_energyImportedInsideOptional_endSystimeInsideOptionalClassName.c_str(), value_energyImportedInsideOptional_endSystimeInsideOptionalCtorSignature.c_str(), jnivalue_energyImportedInsideOptional_endSystimeInsideOptional, value_energyImportedInsideOptional_endSystimeInsideOptional);
        chip::JniReferences::GetInstance().CreateOptional(value_energyImportedInsideOptional_endSystimeInsideOptional, value_energyImportedInsideOptional_endSystime);
      }

    jclass energyMeasurementStructStructClass_1;
    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipStructs$ElectricalEnergyMeasurementClusterEnergyMeasurementStruct", energyMeasurementStructStructClass_1);
    if (err != CHIP_NO_ERROR) {
    ...
    if (err != CHIP_NO_ERROR || energyMeasurementStructStructCtor_1 == nullptr) {
      ChipLogError(Zcl, "Could not find ChipStructs$ElectricalEnergyMeasurementClusterEnergyMeasurementStruct constructor");
      return nullptr;
    }

    value_energyImportedInsideOptional = env->NewObject(energyMeasurementStructStructClass_1, energyMeasurementStructStructCtor_1
  ...
  chip::JniReferences::GetInstance().CreateOptional(value_energyImportedInsideOptional, value_energyImported);
        ...
        std::string value_energyExportedInsideOptional_energyCtorSignature = "(J)V";
          ...
          chip::JniReferences::GetInstance().CreateBoxedObject<jlong>(value_energyExportedInsideOptional_energyClassName.c_str(), value_energyExportedInsideOptional_energyCtorSignature.c_str(), jnivalue_energyExportedInsideOptional_energy, value_energyExportedInsideOptional_energy);
      ...
      if (!cppValue.energyExported.Value().startTimestamp.HasValue()) {
        ...
        std::string value_energyExportedInsideOptional_startTimestampInsideOptionalCtorSignature = "(J)V";
          jlong jnivalue_energyExportedInsideOptional_startTimestampInsideOptional = static_cast<jlong>(cppValue.energyExported.Value().startTimestamp.Value());
          chip::JniReferences::GetInstance().CreateBoxedObject<jlong>(value_energyExportedInsideOptional_startTimestampInsideOptionalClassName.c_str(), value_energyExportedInsideOptional_startTimestampInsideOptionalCtorSignature.c_str(), jnivalue_energyExportedInsideOptional_startTimestampInsideOptional, value_energyExportedInsideOptional_startTimestampInsideOptional);
        chip::JniReferences::GetInstance().CreateOptional(value_energyExportedInsideOptional_startTimestampInsideOptional, value_energyExportedInsideOptional_startTimestamp);
      }
      ...
      if (!cppValue.energyExported.Value().endTimestamp.HasValue()) {
        ...
        std::string value_energyExportedInsideOptional_endTimestampInsideOptionalCtorSignature = "(J)V";
          jlong jnivalue_energyExportedInsideOptional_endTimestampInsideOptional = static_cast<jlong>(cppValue.energyExported.Value().endTimestamp.Value());
          chip::JniReferences::GetInstance().CreateBoxedObject<jlong>(value_energyExportedInsideOptional_endTimestampInsideOptionalClassName.c_str(), value_energyExportedInsideOptional_endTimestampInsideOptionalCtorSignature.c_str(), jnivalue_energyExportedInsideOptional_endTimestampInsideOptional, value_energyExportedInsideOptional_endTimestampInsideOptional);
        chip::JniReferences::GetInstance().CreateOptional(value_energyExportedInsideOptional_endTimestampInsideOptional, value_energyExportedInsideOptional_endTimestamp);
      }
      ...
      if (!cppValue.energyExported.Value().startSystime.HasValue()) {
        ...
        std::string value_energyExportedInsideOptional_startSystimeInsideOptionalCtorSignature = "(J)V";
          jlong jnivalue_energyExportedInsideOptional_startSystimeInsideOptional = static_cast<jlong>(cppValue.energyExported.Value().startSystime.Value());
          chip::JniReferences::GetInstance().CreateBoxedObject<jlong>(value_energyExportedInsideOptional_startSystimeInsideOptionalClassName.c_str(), value_energyExportedInsideOptional_startSystimeInsideOptionalCtorSignature.c_str(), jnivalue_energyExportedInsideOptional_startSystimeInsideOptional, value_energyExportedInsideOptional_startSystimeInsideOptional);
      ...
      if (!cppValue.energyExported.Value().endSystime.HasValue()) {
        ...
        std::string value_energyExportedInsideOptional_endSystimeInsideOptionalCtorSignature = "(J)V";
          jlong jnivalue_energyExportedInsideOptional_endSystimeInsideOptional = static_cast<jlong>(cppValue.energyExported.Value().endSystime.Value());
          chip::JniReferences::GetInstance().CreateBoxedObject<jlong>(value_energyExportedInsideOptional_endSystimeInsideOptionalClassName.c_str(), value_energyExportedInsideOptional_endSystimeInsideOptionalCtorSignature.c_str(), jnivalue_energyExportedInsideOptional_endSystimeInsideOptional, value_energyExportedInsideOptional_endSystimeInsideOptional);
        chip::JniReferences::GetInstance().CreateOptional(value_energyExportedInsideOptional_endSystimeInsideOptional, value_energyExportedInsideOptional_endSystime);
      }
    ...
    value_energyExportedInsideOptional = env->NewObject(energyMeasurementStructStructClass_1, energyMeasurementStructStructCtor_1
  ...
  chip::JniReferences::GetInstance().CreateOptional(value_energyExportedInsideOptional, value_energyExported);
                    ...
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$ElectricalEnergyMeasurementClusterCumulativeEnergyMeasuredEvent", cumulativeEnergyMeasuredStructClass);
                    if (err != CHIP_NO_ERROR) {
                        ChipLogError(Zcl, "Could not find class ChipEventStructs$ElectricalEnergyMeasurementClusterCumulativeEnergyMeasuredEvent");
                        return nullptr;
                    }

                    jmethodID cumulativeEnergyMeasuredStructCtor;
                    err = chip::JniReferences::GetInstance().FindMethod(
                       env, cumulativeEnergyMeasuredStructClass, "<init>",
                    ...
                    if (err != CHIP_NO_ERROR || cumulativeEnergyMeasuredStructCtor == nullptr) {
                        ChipLogError(Zcl, "Could not find ChipEventStructs$ElectricalEnergyMeasurementClusterCumulativeEnergyMeasuredEvent constructor");
                        return nullptr;
                    }
  ...
  chip::JniReferences::GetInstance().CreateOptional(value_energyExportedInsideOptional, value_energyExported);
                    ...
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$ElectricalEnergyMeasurementClusterPeriodicEnergyMeasuredEvent", periodicEnergyMeasuredStructClass);
                    if (err != CHIP_NO_ERROR) {
                        ChipLogError(Zcl, "Could not find class ChipEventStructs$ElectricalEnergyMeasurementClusterPeriodicEnergyMeasuredEvent");
                        return nullptr;
                    }

                    jmethodID periodicEnergyMeasuredStructCtor;
                    err = chip::JniReferences::GetInstance().FindMethod(
                       env, periodicEnergyMeasuredStructClass, "<init>",
                       "(Ljava/util/Optional;Ljava/util/Optional;)V",
                       &periodicEnergyMeasuredStructCtor);
                    if (err != CHIP_NO_ERROR || periodicEnergyMeasuredStructCtor == nullptr) {
                        ChipLogError(Zcl, "Could not find ChipEventStructs$ElectricalEnergyMeasurementClusterPeriodicEnergyMeasuredEvent constructor");
                        return nullptr;
                    }
        ...
        env->SetByteArrayRegion(value_eventIDByteArray, 0, static_cast<jsize>(cppValue.eventID.size()), reinterpret_cast<const jbyte *>(cppValue.eventID.data()));
        ...
        std::string value_transitionIndexCtorSignature = "(I)V";
          ...
          chip::JniReferences::GetInstance().CreateBoxedObject<jint>(value_transitionIndexClassName.c_str(), value_transitionIndexCtorSignature.c_str(), jnivalue_transitionIndex, value_transitionIndex);
      }
      ...
      chip::JniReferences::GetInstance().CreateBoxedObject<jint>(value_criticalityClassName.c_str(), value_criticalityCtorSignature.c_str(), jnivalue_criticality, value_criticality);
        ...
        std::string value_controlCtorSignature = "(I)V";
          ...
          chip::JniReferences::GetInstance().CreateBoxedObject<jint>(value_controlClassName.c_str(), value_controlCtorSignature.c_str(), jnivalue_control, value_control);
      ...
      if (!cppValue.temperatureControl.Value().Value().coolingTempOffset.HasValue()) {
        chip::JniReferences::GetInstance().CreateOptional(nullptr, value_temperatureControlInsideOptional_coolingTempOffset);
      } else {
        ...
        if (cppValue.temperatureControl.Value().Value().coolingTempOffset.Value().IsNull()) {
          value_temperatureControlInsideOptional_coolingTempOffsetInsideOptional = nullptr;
                  ...
                  std::string value_temperatureControlInsideOptional_coolingTempOffsetInsideOptionalClassName = "java/lang/Integer";
        std::string value_temperatureControlInsideOptional_coolingTempOffsetInsideOptionalCtorSignature = "(I)V";
          jint jnivalue_temperatureControlInsideOptional_coolingTempOffsetInsideOptional = static_cast<jint>(cppValue.temperatureControl.Value().Value().coolingTempOffset.Value().Value());
          chip::JniReferences::GetInstance().CreateBoxedObject<jint>(value_temperatureControlInsideOptional_coolingTempOffsetInsideOptionalClassName.c_str(), value_temperatureControlInsideOptional_coolingTempOffsetInsideOptionalCtorSignature.c_str(), jnivalue_temperatureControlInsideOptional_coolingTempOffsetInsideOptional, value_temperatureControlInsideOptional_coolingTempOffsetInsideOptional);
      }
        chip::JniReferences::GetInstance().CreateOptional(value_temperatureControlInsideOptional_coolingTempOffsetInsideOptional, value_temperatureControlInsideOptional_coolingTempOffset);
      }
      ...
      if (!cppValue.temperatureControl.Value().Value().heatingtTempOffset.HasValue()) {
        chip::JniReferences::GetInstance().CreateOptional(nullptr, value_temperatureControlInsideOptional_heatingtTempOffset);
      } else {
        ...
        if (cppValue.temperatureControl.Value().Value().heatingtTempOffset.Value().IsNull()) {
          value_temperatureControlInsideOptional_heatingtTempOffsetInsideOptional = nullptr;
                  ...
                  std::string value_temperatureControlInsideOptional_heatingtTempOffsetInsideOptionalClassName = "java/lang/Integer";
        std::string value_temperatureControlInsideOptional_heatingtTempOffsetInsideOptionalCtorSignature = "(I)V";
          jint jnivalue_temperatureControlInsideOptional_heatingtTempOffsetInsideOptional = static_cast<jint>(cppValue.temperatureControl.Value().Value().heatingtTempOffset.Value().Value());
          chip::JniReferences::GetInstance().CreateBoxedObject<jint>(value_temperatureControlInsideOptional_heatingtTempOffsetInsideOptionalClassName.c_str(), value_temperatureControlInsideOptional_heatingtTempOffsetInsideOptionalCtorSignature.c_str(), jnivalue_temperatureControlInsideOptional_heatingtTempOffsetInsideOptional, value_temperatureControlInsideOptional_heatingtTempOffsetInsideOptional);
      }
        chip::JniReferences::GetInstance().CreateOptional(value_temperatureControlInsideOptional_heatingtTempOffsetInsideOptional, value_temperatureControlInsideOptional_heatingtTempOffset);
      }
      ...
      if (!cppValue.temperatureControl.Value().Value().coolingTempSetpoint.HasValue()) {
        chip::JniReferences::GetInstance().CreateOptional(nullptr, value_temperatureControlInsideOptional_coolingTempSetpoint);
      } else {
        ...
        if (cppValue.temperatureControl.Value().Value().coolingTempSetpoint.Value().IsNull()) {
          value_temperatureControlInsideOptional_coolingTempSetpointInsideOptional = nullptr;
                  ...
                  std::string value_temperatureControlInsideOptional_coolingTempSetpointInsideOptionalClassName = "java/lang/Integer";
        std::string value_temperatureControlInsideOptional_coolingTempSetpointInsideOptionalCtorSignature = "(I)V";
          jint jnivalue_temperatureControlInsideOptional_coolingTempSetpointInsideOptional = static_cast<jint>(cppValue.temperatureControl.Value().Value().coolingTempSetpoint.Value().Value());
          chip::JniReferences::GetInstance().CreateBoxedObject<jint>(value_temperatureControlInsideOptional_coolingTempSetpointInsideOptionalClassName.c_str(), value_temperatureControlInsideOptional_coolingTempSetpointInsideOptionalCtorSignature.c_str(), jnivalue_temperatureControlInsideOptional_coolingTempSetpointInsideOptional, value_temperatureControlInsideOptional_coolingTempSetpointInsideOptional);
      }
        chip::JniReferences::GetInstance().CreateOptional(value_temperatureControlInsideOptional_coolingTempSetpointInsideOptional, value_temperatureControlInsideOptional_coolingTempSetpoint);
      }
      ...
      if (!cppValue.temperatureControl.Value().Value().heatingTempSetpoint.HasValue()) {
        chip::JniReferences::GetInstance().CreateOptional(nullptr, value_temperatureControlInsideOptional_heatingTempSetpoint);
      } else {
        ...
        if (cppValue.temperatureControl.Value().Value().heatingTempSetpoint.Value().IsNull()) {
          value_temperatureControlInsideOptional_heatingTempSetpointInsideOptional = nullptr;
                  ...
                  std::string value_temperatureControlInsideOptional_heatingTempSetpointInsideOptionalClassName = "java/lang/Integer";
        std::string value_temperatureControlInsideOptional_heatingTempSetpointInsideOptionalCtorSignature = "(I)V";
          jint jnivalue_temperatureControlInsideOptional_heatingTempSetpointInsideOptional = static_cast<jint>(cppValue.temperatureControl.Value().Value().heatingTempSetpoint.Value().Value());
          chip::JniReferences::GetInstance().CreateBoxedObject<jint>(value_temperatureControlInsideOptional_heatingTempSetpointInsideOptionalClassName.c_str(), value_temperatureControlInsideOptional_heatingTempSetpointInsideOptionalCtorSignature.c_str(), jnivalue_temperatureControlInsideOptional_heatingTempSetpointInsideOptional, value_temperatureControlInsideOptional_heatingTempSetpointInsideOptional);
      }
        chip::JniReferences::GetInstance().CreateOptional(value_temperatureControlInsideOptional_heatingTempSetpointInsideOptional, value_temperatureControlInsideOptional_heatingTempSetpoint);
      }

    jclass temperatureControlStructStructClass_2;
    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipStructs$DemandResponseLoadControlClusterTemperatureControlStruct", temperatureControlStructStructClass_2);
    if (err != CHIP_NO_ERROR) {
    ...
    if (err != CHIP_NO_ERROR || temperatureControlStructStructCtor_2 == nullptr) {
      ChipLogError(Zcl, "Could not find ChipStructs$DemandResponseLoadControlClusterTemperatureControlStruct constructor");
      return nullptr;
    }

    value_temperatureControlInsideOptional = env->NewObject(temperatureControlStructStructClass_2, temperatureControlStructStructCtor_2
      ...
      , value_temperatureControlInsideOptional_heatingTempSetpoint
        ...
        std::string value_averageLoadControlInsideOptional_loadAdjustmentCtorSignature = "(I)V";
          jint jnivalue_averageLoadControlInsideOptional_loadAdjustment = static_cast<jint>(cppValue.averageLoadControl.Value().Value().loadAdjustment);
          chip::JniReferences::GetInstance().CreateBoxedObject<jint>(value_averageLoadControlInsideOptional_loadAdjustmentClassName.c_str(), value_averageLoadControlInsideOptional_loadAdjustmentCtorSignature.c_str(), jnivalue_averageLoadControlInsideOptional_loadAdjustment, value_averageLoadControlInsideOptional_loadAdjustment);
      
    jclass averageLoadControlStructStructClass_2;
    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipStructs$DemandResponseLoadControlClusterAverageLoadControlStruct", averageLoadControlStructStructClass_2);
    if (err != CHIP_NO_ERROR) {
    ...
    err = chip::JniReferences::GetInstance().FindMethod(
        env, averageLoadControlStructStructClass_2, "<init>",
        "(Ljava/lang/Integer;)V",
        &averageLoadControlStructStructCtor_2);
    if (err != CHIP_NO_ERROR || averageLoadControlStructStructCtor_2 == nullptr) {
      ChipLogError(Zcl, "Could not find ChipStructs$DemandResponseLoadControlClusterAverageLoadControlStruct constructor");
      return nullptr;
    }

    value_averageLoadControlInsideOptional = env->NewObject(averageLoadControlStructStructClass_2, averageLoadControlStructStructCtor_2
      , value_averageLoadControlInsideOptional_loadAdjustment
    );
}
        ...
        std::string value_dutyCycleControlInsideOptional_dutyCycleCtorSignature = "(I)V";
          jint jnivalue_dutyCycleControlInsideOptional_dutyCycle = static_cast<jint>(cppValue.dutyCycleControl.Value().Value().dutyCycle);
          chip::JniReferences::GetInstance().CreateBoxedObject<jint>(value_dutyCycleControlInsideOptional_dutyCycleClassName.c_str(), value_dutyCycleControlInsideOptional_dutyCycleCtorSignature.c_str(), jnivalue_dutyCycleControlInsideOptional_dutyCycle, value_dutyCycleControlInsideOptional_dutyCycle);
      
    jclass dutyCycleControlStructStructClass_2;
    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipStructs$DemandResponseLoadControlClusterDutyCycleControlStruct", dutyCycleControlStructStructClass_2);
    if (err != CHIP_NO_ERROR) {
    ...
    err = chip::JniReferences::GetInstance().FindMethod(
        env, dutyCycleControlStructStructClass_2, "<init>",
        "(Ljava/lang/Integer;)V",
        &dutyCycleControlStructStructCtor_2);
    if (err != CHIP_NO_ERROR || dutyCycleControlStructStructCtor_2 == nullptr) {
      ChipLogError(Zcl, "Could not find ChipStructs$DemandResponseLoadControlClusterDutyCycleControlStruct constructor");
      return nullptr;
    }

    value_dutyCycleControlInsideOptional = env->NewObject(dutyCycleControlStructStructClass_2, dutyCycleControlStructStructCtor_2
      , value_dutyCycleControlInsideOptional_dutyCycle
        ...
        std::string value_powerSavingsControlInsideOptional_powerSavingsCtorSignature = "(I)V";
          jint jnivalue_powerSavingsControlInsideOptional_powerSavings = static_cast<jint>(cppValue.powerSavingsControl.Value().Value().powerSavings);
          chip::JniReferences::GetInstance().CreateBoxedObject<jint>(value_powerSavingsControlInsideOptional_powerSavingsClassName.c_str(), value_powerSavingsControlInsideOptional_powerSavingsCtorSignature.c_str(), jnivalue_powerSavingsControlInsideOptional_powerSavings, value_powerSavingsControlInsideOptional_powerSavings);
      
    jclass powerSavingsControlStructStructClass_2;
    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipStructs$DemandResponseLoadControlClusterPowerSavingsControlStruct", powerSavingsControlStructStructClass_2);
    if (err != CHIP_NO_ERROR) {
    ...
    err = chip::JniReferences::GetInstance().FindMethod(
        env, powerSavingsControlStructStructClass_2, "<init>",
        "(Ljava/lang/Integer;)V",
        &powerSavingsControlStructStructCtor_2);
    if (err != CHIP_NO_ERROR || powerSavingsControlStructStructCtor_2 == nullptr) {
      ChipLogError(Zcl, "Could not find ChipStructs$DemandResponseLoadControlClusterPowerSavingsControlStruct constructor");
      return nullptr;
    }

    value_powerSavingsControlInsideOptional = env->NewObject(powerSavingsControlStructStructClass_2, powerSavingsControlStructStructCtor_2
      , value_powerSavingsControlInsideOptional_powerSavings
    );
}
                      chip::JniReferences::GetInstance().CreateOptional(value_powerSavingsControlInsideOptional, value_powerSavingsControl);
                    }
      ...
      jint jnivalue_heatingSourceControlInsideOptional_heatingSource = static_cast<jint>(cppValue.heatingSourceControl.Value().Value().heatingSource);
      chip::JniReferences::GetInstance().CreateBoxedObject<jint>(value_heatingSourceControlInsideOptional_heatingSourceClassName.c_str(), value_heatingSourceControlInsideOptional_heatingSourceCtorSignature.c_str(), jnivalue_heatingSourceControlInsideOptional_heatingSource, value_heatingSourceControlInsideOptional_heatingSource);

    jclass heatingSourceControlStructStructClass_2;
    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipStructs$DemandResponseLoadControlClusterHeatingSourceControlStruct", heatingSourceControlStructStructClass_2);
    if (err != CHIP_NO_ERROR) {
      ChipLogError(Zcl, "Could not find class ChipStructs$DemandResponseLoadControlClusterHeatingSourceControlStruct");
      return nullptr;
    }

    jmethodID heatingSourceControlStructStructCtor_2;
    err = chip::JniReferences::GetInstance().FindMethod(
        env, heatingSourceControlStructStructClass_2, "<init>",
        "(Ljava/lang/Integer;)V",
        &heatingSourceControlStructStructCtor_2);
    if (err != CHIP_NO_ERROR || heatingSourceControlStructStructCtor_2 == nullptr) {
      ChipLogError(Zcl, "Could not find ChipStructs$DemandResponseLoadControlClusterHeatingSourceControlStruct constructor");
      return nullptr;
    }

    value_heatingSourceControlInsideOptional = env->NewObject(heatingSourceControlStructStructClass_2, heatingSourceControlStructStructCtor_2
      , value_heatingSourceControlInsideOptional_heatingSource
    );
}
                    ...
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$DemandResponseLoadControlClusterLoadControlEventStatusChangeEvent", loadControlEventStatusChangeStructClass);
                    if (err != CHIP_NO_ERROR) {
                        ChipLogError(Zcl, "Could not find class ChipEventStructs$DemandResponseLoadControlClusterLoadControlEventStatusChangeEvent");
                        return nullptr;
                    }
                    ...
                    err = chip::JniReferences::GetInstance().FindMethod(
                       ...
                       "([BLjava/lang/Integer;Ljava/lang/Integer;Ljava/lang/Integer;Ljava/lang/Integer;Ljava/util/Optional;Ljava/util/Optional;Ljava/util/Optional;Ljava/util/Optional;Ljava/util/Optional;)V",
                       &loadControlEventStatusChangeStructCtor);
                    if (err != CHIP_NO_ERROR || loadControlEventStatusChangeStructCtor == nullptr) {
                        ChipLogError(Zcl, "Could not find ChipEventStructs$DemandResponseLoadControlClusterLoadControlEventStatusChangeEvent constructor");
                        return nullptr;
                    }

                    jobject value = env->NewObject(loadControlEventStatusChangeStructClass, loadControlEventStatusChangeStructCtor
                    , value_eventID
                    , value_transitionIndex
                    , value_status
                    , value_criticality
                    , value_control
                    , value_temperatureControl
                    , value_averageLoadControl
                    , value_dutyCycleControl
        ...
        env->SetByteArrayRegion(value_messageIDByteArray, 0, static_cast<jsize>(cppValue.messageID.size()), reinterpret_cast<const jbyte *>(cppValue.messageID.data()));
        value_messageID = value_messageIDByteArray;

                    jclass messageQueuedStructClass;
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$MessagesClusterMessageQueuedEvent", messageQueuedStructClass);
                    if (err != CHIP_NO_ERROR) {
                    ...
                    err = chip::JniReferences::GetInstance().FindMethod(
                       env, messageQueuedStructClass, "<init>",
                       "([B)V",
                    ...
                    jobject value = env->NewObject(messageQueuedStructClass, messageQueuedStructCtor
                    , value_messageID
                    );
        ...
        value_messageID = value_messageIDByteArray;
                    ...
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$MessagesClusterMessagePresentedEvent", messagePresentedStructClass);
                    if (err != CHIP_NO_ERROR) {
                    ...
                    err = chip::JniReferences::GetInstance().FindMethod(
                       env, messagePresentedStructClass, "<init>",
                       "([B)V",
                    ...
                    jobject value = env->NewObject(messagePresentedStructClass, messagePresentedStructCtor
                    , value_messageID
                    );
        ...
        std::string value_responseIDInsideOptionalCtorSignature = "(J)V";
          ...
          chip::JniReferences::GetInstance().CreateBoxedObject<jlong>(value_responseIDInsideOptionalClassName.c_str(), value_responseIDInsideOptionalCtorSignature.c_str(), jnivalue_responseIDInsideOptional, value_responseIDInsideOptional);
      }
                    ...
                    if (!cppValue.reply.HasValue()) {
                      ...
                      if (cppValue.reply.Value().IsNull()) {
                        value_replyInsideOptional = nullptr;
                                ...
                                LogErrorOnFailure(chip::JniReferences::GetInstance().CharToStringUTF(cppValue.reply.Value().Value(), value_replyInsideOptional));
}
      ...
      chip::JniReferences::GetInstance().CreateBoxedObject<jint>(value_futureMessagesPreferenceClassName.c_str(), value_futureMessagesPreferenceCtorSignature.c_str(), jnivalue_futureMessagesPreference, value_futureMessagesPreference);
}

                    jclass messageCompleteStructClass;
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$MessagesClusterMessageCompleteEvent", messageCompleteStructClass);
                    if (err != CHIP_NO_ERROR) {
                    ...
                    jobject value = env->NewObject(messageCompleteStructClass, messageCompleteStructCtor
                    , value_messageID
                    , value_responseID
                    , value_reply
                    , value_futureMessagesPreference
                    );
            ...
            switch (aPath.mEventId)
            {
                case Events::PowerAdjustStart::Id: {
                    ...
                    *aError = app::DataModel::Decode(aReader, cppValue);
                    ...
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$DeviceEnergyManagementClusterPowerAdjustStartEvent", powerAdjustStartStructClass);
                    if (err != CHIP_NO_ERROR) {
                    ...
                    err = chip::JniReferences::GetInstance().FindMethod(
                       env, powerAdjustStartStructClass, "<init>",
                       "()V",
      ...
      chip::JniReferences::GetInstance().CreateBoxedObject<jint>(value_causeClassName.c_str(), value_causeCtorSignature.c_str(), jnivalue_cause, value_cause);
        ...
        std::string value_durationCtorSignature = "(J)V";
          ...
          chip::JniReferences::GetInstance().CreateBoxedObject<jlong>(value_durationClassName.c_str(), value_durationCtorSignature.c_str(), jnivalue_duration, value_duration);
        ...
        std::string value_energyUseCtorSignature = "(J)V";
          ...
          chip::JniReferences::GetInstance().CreateBoxedObject<jlong>(value_energyUseClassName.c_str(), value_energyUseCtorSignature.c_str(), jnivalue_energyUse, value_energyUse);
      
                    jclass powerAdjustEndStructClass;
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$DeviceEnergyManagementClusterPowerAdjustEndEvent", powerAdjustEndStructClass);
                    if (err != CHIP_NO_ERROR) {
                    ...
                    err = chip::JniReferences::GetInstance().FindMethod(
                       env, powerAdjustEndStructClass, "<init>",
                    ...
                    jobject value = env->NewObject(powerAdjustEndStructClass, powerAdjustEndStructCtor
                    , value_cause
                    , value_duration
                    , value_energyUse
                    );
                ...
                case Events::Paused::Id: {
                    ...
                    *aError = app::DataModel::Decode(aReader, cppValue);
                    ...
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$DeviceEnergyManagementClusterPausedEvent", pausedStructClass);
                    if (err != CHIP_NO_ERROR) {
      ...
      chip::JniReferences::GetInstance().CreateBoxedObject<jint>(value_causeClassName.c_str(), value_causeCtorSignature.c_str(), jnivalue_cause, value_cause);
                    ...
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$DeviceEnergyManagementClusterResumedEvent", resumedStructClass);
                    if (err != CHIP_NO_ERROR) {
        ...
        std::string value_sessionIDCtorSignature = "(J)V";
          ...
          chip::JniReferences::GetInstance().CreateBoxedObject<jlong>(value_sessionIDClassName.c_str(), value_sessionIDCtorSignature.c_str(), jnivalue_sessionID, value_sessionID);
      
                    jclass EVConnectedStructClass;
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$EnergyEvseClusterEVConnectedEvent", EVConnectedStructClass);
                    if (err != CHIP_NO_ERROR) {
                    ...
                    err = chip::JniReferences::GetInstance().FindMethod(
                       env, EVConnectedStructClass, "<init>",
                       "(Ljava/lang/Long;)V",
                    ...
                    jobject value = env->NewObject(EVConnectedStructClass, EVConnectedStructCtor
                    , value_sessionID
                    );
      ...
      chip::JniReferences::GetInstance().CreateBoxedObject<jint>(value_stateClassName.c_str(), value_stateCtorSignature.c_str(), jnivalue_state, value_state);
        ...
        std::string value_sessionDurationCtorSignature = "(J)V";
          ...
          chip::JniReferences::GetInstance().CreateBoxedObject<jlong>(value_sessionDurationClassName.c_str(), value_sessionDurationCtorSignature.c_str(), jnivalue_sessionDuration, value_sessionDuration);
        ...
        std::string value_sessionEnergyChargedCtorSignature = "(J)V";
          ...
          chip::JniReferences::GetInstance().CreateBoxedObject<jlong>(value_sessionEnergyChargedClassName.c_str(), value_sessionEnergyChargedCtorSignature.c_str(), jnivalue_sessionEnergyCharged, value_sessionEnergyCharged);
        ...
        std::string value_sessionEnergyDischargedInsideOptionalCtorSignature = "(J)V";
          ...
          chip::JniReferences::GetInstance().CreateBoxedObject<jlong>(value_sessionEnergyDischargedInsideOptionalClassName.c_str(), value_sessionEnergyDischargedInsideOptionalCtorSignature.c_str(), jnivalue_sessionEnergyDischargedInsideOptional, value_sessionEnergyDischargedInsideOptional);
        chip::JniReferences::GetInstance().CreateOptional(value_sessionEnergyDischargedInsideOptional, value_sessionEnergyDischarged);
                    }

                    jclass EVNotDetectedStructClass;
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$EnergyEvseClusterEVNotDetectedEvent", EVNotDetectedStructClass);
                    if (err != CHIP_NO_ERROR) {
                    ...
                    jobject value = env->NewObject(EVNotDetectedStructClass, EVNotDetectedStructCtor
                    , value_sessionID
                    , value_state
                    , value_sessionDuration
                    , value_sessionEnergyCharged
      ...
      chip::JniReferences::GetInstance().CreateBoxedObject<jint>(value_stateClassName.c_str(), value_stateCtorSignature.c_str(), jnivalue_state, value_state);
        ...
        std::string value_maximumCurrentCtorSignature = "(J)V";
          ...
          chip::JniReferences::GetInstance().CreateBoxedObject<jlong>(value_maximumCurrentClassName.c_str(), value_maximumCurrentCtorSignature.c_str(), jnivalue_maximumCurrent, value_maximumCurrent);
        ...
        std::string value_maximumDischargeCurrentInsideOptionalCtorSignature = "(J)V";
          ...
          chip::JniReferences::GetInstance().CreateBoxedObject<jlong>(value_maximumDischargeCurrentInsideOptionalClassName.c_str(), value_maximumDischargeCurrentInsideOptionalCtorSignature.c_str(), jnivalue_maximumDischargeCurrentInsideOptional, value_maximumDischargeCurrentInsideOptional);
        chip::JniReferences::GetInstance().CreateOptional(value_maximumDischargeCurrentInsideOptional, value_maximumDischargeCurrent);
                    }

                    jclass energyTransferStartedStructClass;
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$EnergyEvseClusterEnergyTransferStartedEvent", energyTransferStartedStructClass);
                    if (err != CHIP_NO_ERROR) {
                    ...
                    err = chip::JniReferences::GetInstance().FindMethod(
                       ...
                       "(Ljava/lang/Long;Ljava/lang/Integer;Ljava/lang/Long;Ljava/util/Optional;)V",
                    ...
                    jobject value = env->NewObject(energyTransferStartedStructClass, energyTransferStartedStructCtor
                    , value_sessionID
                    , value_state
      ...
      chip::JniReferences::GetInstance().CreateBoxedObject<jint>(value_reasonClassName.c_str(), value_reasonCtorSignature.c_str(), jnivalue_reason, value_reason);
        ...
        std::string value_energyTransferredCtorSignature = "(J)V";
          ...
          chip::JniReferences::GetInstance().CreateBoxedObject<jlong>(value_energyTransferredClassName.c_str(), value_energyTransferredCtorSignature.c_str(), jnivalue_energyTransferred, value_energyTransferred);
        ...
        std::string value_energyDischargedInsideOptionalCtorSignature = "(J)V";
          ...
          chip::JniReferences::GetInstance().CreateBoxedObject<jlong>(value_energyDischargedInsideOptionalClassName.c_str(), value_energyDischargedInsideOptionalCtorSignature.c_str(), jnivalue_energyDischargedInsideOptional, value_energyDischargedInsideOptional);
        chip::JniReferences::GetInstance().CreateOptional(value_energyDischargedInsideOptional, value_energyDischarged);
                    ...
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$EnergyEvseClusterEnergyTransferStoppedEvent", energyTransferStoppedStructClass);
                    if (err != CHIP_NO_ERROR) {
                    ...
                    jobject value = env->NewObject(energyTransferStoppedStructClass, energyTransferStoppedStructCtor
                    , value_sessionID
                    , value_state
                    , value_reason
      ...
      chip::JniReferences::GetInstance().CreateBoxedObject<jint>(value_faultStatePreviousStateClassName.c_str(), value_faultStatePreviousStateCtorSignature.c_str(), jnivalue_faultStatePreviousState, value_faultStatePreviousState);
      ...
      chip::JniReferences::GetInstance().CreateBoxedObject<jint>(value_faultStateCurrentStateClassName.c_str(), value_faultStateCurrentStateCtorSignature.c_str(), jnivalue_faultStateCurrentState, value_faultStateCurrentState);

                    jclass faultStructClass;
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$EnergyEvseClusterFaultEvent", faultStructClass);
                    if (err != CHIP_NO_ERROR) {
                    ...
                    err = chip::JniReferences::GetInstance().FindMethod(
                       env, faultStructClass, "<init>",
                       "(Ljava/lang/Long;Ljava/lang/Integer;Ljava/lang/Integer;Ljava/lang/Integer;)V",
                       &faultStructCtor);
                    ...
                    jobject value = env->NewObject(faultStructClass, faultStructCtor
                    , value_sessionID
                    , value_state
                    , value_faultStatePreviousState
                    , value_faultStateCurrentState
                    );
        ...
        env->SetByteArrayRegion(value_uidByteArray, 0, static_cast<jsize>(cppValue.uid.size()), reinterpret_cast<const jbyte *>(cppValue.uid.data()));
        value_uid = value_uidByteArray;

                    jclass rfidStructClass;
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$EnergyEvseClusterRfidEvent", rfidStructClass);
                    if (err != CHIP_NO_ERROR) {
                    ...
                    jobject value = env->NewObject(rfidStructClass, rfidStructCtor
                    , value_uid
                    );
      ...
      chip::JniReferences::GetInstance().CreateBoxedObject<jint>(value_alarmCodeClassName.c_str(), value_alarmCodeCtorSignature.c_str(), jnivalue_alarmCode, value_alarmCode);

                    jclass doorLockAlarmStructClass;
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$DoorLockClusterDoorLockAlarmEvent", doorLockAlarmStructClass);
                    if (err != CHIP_NO_ERROR) {
                    ...
                    err = chip::JniReferences::GetInstance().FindMethod(
                       env, doorLockAlarmStructClass, "<init>",
                       "(Ljava/lang/Integer;)V",
                    ...
                    jobject value = env->NewObject(doorLockAlarmStructClass, doorLockAlarmStructCtor
                    , value_alarmCode
                    );
      ...
      chip::JniReferences::GetInstance().CreateBoxedObject<jint>(value_doorStateClassName.c_str(), value_doorStateCtorSignature.c_str(), jnivalue_doorState, value_doorState);

                    jclass doorStateChangeStructClass;
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$DoorLockClusterDoorStateChangeEvent", doorStateChangeStructClass);
                    if (err != CHIP_NO_ERROR) {
                    ...
                    err = chip::JniReferences::GetInstance().FindMethod(
                       env, doorStateChangeStructClass, "<init>",
                       "(Ljava/lang/Integer;)V",
                    ...
                    jobject value = env->NewObject(doorStateChangeStructClass, doorStateChangeStructCtor
                    , value_doorState
                    );
      ...
      chip::JniReferences::GetInstance().CreateBoxedObject<jint>(value_lockOperationTypeClassName.c_str(), value_lockOperationTypeCtorSignature.c_str(), jnivalue_lockOperationType, value_lockOperationType);
      ...
      chip::JniReferences::GetInstance().CreateBoxedObject<jint>(value_operationSourceClassName.c_str(), value_operationSourceCtorSignature.c_str(), jnivalue_operationSource, value_operationSource);
        ...
        std::string value_userIndexCtorSignature = "(I)V";
          ...
          chip::JniReferences::GetInstance().CreateBoxedObject<jint>(value_userIndexClassName.c_str(), value_userIndexCtorSignature.c_str(), jnivalue_userIndex, value_userIndex);
      }
        ...
        std::string value_sourceNodeCtorSignature = "(J)V";
          ...
          chip::JniReferences::GetInstance().CreateBoxedObject<jlong>(value_sourceNodeClassName.c_str(), value_sourceNodeCtorSignature.c_str(), jnivalue_sourceNode, value_sourceNode);
      }
      ...
      chip::JniReferences::GetInstance().CreateBoxedObject<jint>(newElement_2_credentialTypeClassName.c_str(), newElement_2_credentialTypeCtorSignature.c_str(), jninewElement_2_credentialType, newElement_2_credentialType);
      jobject newElement_2_credentialIndex;
        ...
        std::string newElement_2_credentialIndexCtorSignature = "(I)V";
          ...
          chip::JniReferences::GetInstance().CreateBoxedObject<jint>(newElement_2_credentialIndexClassName.c_str(), newElement_2_credentialIndexCtorSignature.c_str(), jninewElement_2_credentialIndex, newElement_2_credentialIndex);
      
    jclass credentialStructStructClass_3;
    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipStructs$DoorLockClusterCredentialStruct", credentialStructStructClass_3);
    if (err != CHIP_NO_ERROR) {
    ...
    err = chip::JniReferences::GetInstance().FindMethod(
        env, credentialStructStructClass_3, "<init>",
        "(Ljava/lang/Integer;Ljava/lang/Integer;)V",
    ...
    newElement_2 = env->NewObject(credentialStructStructClass_3, credentialStructStructCtor_3
      , newElement_2_credentialType
      , newElement_2_credentialIndex
    );
    chip::JniReferences::GetInstance().AddToList(value_credentialsInsideOptional, newElement_2);
                    ...
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$DoorLockClusterLockOperationEvent", lockOperationStructClass);
                    if (err != CHIP_NO_ERROR) {
                    ...
                    err = chip::JniReferences::GetInstance().FindMethod(
                       env, lockOperationStructClass, "<init>",
                       "(Ljava/lang/Integer;Ljava/lang/Integer;Ljava/lang/Integer;Ljava/lang/Integer;Ljava/lang/Long;Ljava/util/Optional;)V",
                    ...
                    jobject value = env->NewObject(lockOperationStructClass, lockOperationStructCtor
      ...
      chip::JniReferences::GetInstance().CreateBoxedObject<jint>(value_operationErrorClassName.c_str(), value_operationErrorCtorSignature.c_str(), jnivalue_operationError, value_operationError);
    ...
    chip::JniReferences::GetInstance().AddToList(value_credentialsInsideOptional, newElement_2);
                    ...
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$DoorLockClusterLockOperationErrorEvent", lockOperationErrorStructClass);
                    if (err != CHIP_NO_ERROR) {
                    ...
                    err = chip::JniReferences::GetInstance().FindMethod(
                       ...
                       "(Ljava/lang/Integer;Ljava/lang/Integer;Ljava/lang/Integer;Ljava/lang/Integer;Ljava/lang/Integer;Ljava/lang/Long;Ljava/util/Optional;)V",
                    ...
                    jobject value = env->NewObject(lockOperationErrorStructClass, lockOperationErrorStructCtor
                    , value_lockOperationType
                    , value_operationSource
      ...
      chip::JniReferences::GetInstance().CreateBoxedObject<jint>(value_lockDataTypeClassName.c_str(), value_lockDataTypeCtorSignature.c_str(), jnivalue_lockDataType, value_lockDataType);
      ...
      chip::JniReferences::GetInstance().CreateBoxedObject<jint>(value_dataOperationTypeClassName.c_str(), value_dataOperationTypeCtorSignature.c_str(), jnivalue_dataOperationType, value_dataOperationType);
      ...
      chip::JniReferences::GetInstance().CreateBoxedObject<jint>(value_operationSourceClassName.c_str(), value_operationSourceCtorSignature.c_str(), jnivalue_operationSource, value_operationSource);
        ...
        std::string value_dataIndexCtorSignature = "(I)V";
          ...
          chip::JniReferences::GetInstance().CreateBoxedObject<jint>(value_dataIndexClassName.c_str(), value_dataIndexCtorSignature.c_str(), jnivalue_dataIndex, value_dataIndex);
      }

                    jclass lockUserChangeStructClass;
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$DoorLockClusterLockUserChangeEvent", lockUserChangeStructClass);
                    if (err != CHIP_NO_ERROR) {
                    ...
                    err = chip::JniReferences::GetInstance().FindMethod(
                       ...
                       "(Ljava/lang/Integer;Ljava/lang/Integer;Ljava/lang/Integer;Ljava/lang/Integer;Ljava/lang/Integer;Ljava/lang/Long;Ljava/lang/Integer;)V",
                    ...
                    jobject value = env->NewObject(lockUserChangeStructClass, lockUserChangeStructCtor
                    , value_lockDataType
            ...
            switch (aPath.mEventId)
            {
                case Events::SupplyVoltageLow::Id: {
                    ...
                    *aError = app::DataModel::Decode(aReader, cppValue);
                    ...
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$PumpConfigurationAndControlClusterSupplyVoltageLowEvent", supplyVoltageLowStructClass);
                    if (err != CHIP_NO_ERROR) {
                    ...
                    err = chip::JniReferences::GetInstance().FindMethod(
                       env, supplyVoltageLowStructClass, "<init>",
                       "()V",
                       &supplyVoltageLowStructCtor);
                    if (err != CHIP_NO_ERROR || supplyVoltageLowStructCtor == nullptr) {
                        ChipLogError(Zcl, "Could not find ChipEventStructs$PumpConfigurationAndControlClusterSupplyVoltageLowEvent constructor");
                        return nullptr;
                    }
                ...
                case Events::SupplyVoltageHigh::Id: {
                    ...
                    *aError = app::DataModel::Decode(aReader, cppValue);
                    ...
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$PumpConfigurationAndControlClusterSupplyVoltageHighEvent", supplyVoltageHighStructClass);
                    if (err != CHIP_NO_ERROR) {
                    ...
                    err = chip::JniReferences::GetInstance().FindMethod(
                       env, supplyVoltageHighStructClass, "<init>",
                       "()V",
                       &supplyVoltageHighStructCtor);
                    if (err != CHIP_NO_ERROR || supplyVoltageHighStructCtor == nullptr) {
                        ChipLogError(Zcl, "Could not find ChipEventStructs$PumpConfigurationAndControlClusterSupplyVoltageHighEvent constructor");
                        return nullptr;
                    }
                ...
                case Events::PowerMissingPhase::Id: {
                    ...
                    *aError = app::DataModel::Decode(aReader, cppValue);
                    ...
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$PumpConfigurationAndControlClusterPowerMissingPhaseEvent", powerMissingPhaseStructClass);
                    if (err != CHIP_NO_ERROR) {
                    ...
                    err = chip::JniReferences::GetInstance().FindMethod(
                       env, powerMissingPhaseStructClass, "<init>",
                       "()V",
                       &powerMissingPhaseStructCtor);
                    if (err != CHIP_NO_ERROR || powerMissingPhaseStructCtor == nullptr) {
                        ChipLogError(Zcl, "Could not find ChipEventStructs$PumpConfigurationAndControlClusterPowerMissingPhaseEvent constructor");
                        return nullptr;
                    }
                ...
                case Events::SystemPressureLow::Id: {
                    ...
                    *aError = app::DataModel::Decode(aReader, cppValue);
                    ...
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$PumpConfigurationAndControlClusterSystemPressureLowEvent", systemPressureLowStructClass);
                    if (err != CHIP_NO_ERROR) {
                    ...
                    err = chip::JniReferences::GetInstance().FindMethod(
                       env, systemPressureLowStructClass, "<init>",
                       "()V",
                       &systemPressureLowStructCtor);
                    if (err != CHIP_NO_ERROR || systemPressureLowStructCtor == nullptr) {
                        ChipLogError(Zcl, "Could not find ChipEventStructs$PumpConfigurationAndControlClusterSystemPressureLowEvent constructor");
                        return nullptr;
                    }
                ...
                case Events::SystemPressureHigh::Id: {
                    ...
                    *aError = app::DataModel::Decode(aReader, cppValue);
                    ...
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$PumpConfigurationAndControlClusterSystemPressureHighEvent", systemPressureHighStructClass);
                    if (err != CHIP_NO_ERROR) {
                        ChipLogError(Zcl, "Could not find class ChipEventStructs$PumpConfigurationAndControlClusterSystemPressureHighEvent");
                        return nullptr;
                    }

                    jmethodID systemPressureHighStructCtor;
                    err = chip::JniReferences::GetInstance().FindMethod(
                       env, systemPressureHighStructClass, "<init>",
                       "()V",
                       &systemPressureHighStructCtor);
                    if (err != CHIP_NO_ERROR || systemPressureHighStructCtor == nullptr) {
                        ChipLogError(Zcl, "Could not find ChipEventStructs$PumpConfigurationAndControlClusterSystemPressureHighEvent constructor");
                        return nullptr;
                    }
                ...
                case Events::DryRunning::Id: {
                    ...
                    *aError = app::DataModel::Decode(aReader, cppValue);
                    ...
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$PumpConfigurationAndControlClusterDryRunningEvent", dryRunningStructClass);
                    if (err != CHIP_NO_ERROR) {
                    ...
                    err = chip::JniReferences::GetInstance().FindMethod(
                       env, dryRunningStructClass, "<init>",
                       "()V",
                       &dryRunningStructCtor);
                ...
                case Events::MotorTemperatureHigh::Id: {
                    ...
                    *aError = app::DataModel::Decode(aReader, cppValue);
                    ...
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$PumpConfigurationAndControlClusterMotorTemperatureHighEvent", motorTemperatureHighStructClass);
                    if (err != CHIP_NO_ERROR) {
                        ChipLogError(Zcl, "Could not find class ChipEventStructs$PumpConfigurationAndControlClusterMotorTemperatureHighEvent");
                        return nullptr;
                    }

                    jmethodID motorTemperatureHighStructCtor;
                    err = chip::JniReferences::GetInstance().FindMethod(
                       env, motorTemperatureHighStructClass, "<init>",
                       "()V",
                       &motorTemperatureHighStructCtor);
                    if (err != CHIP_NO_ERROR || motorTemperatureHighStructCtor == nullptr) {
                        ChipLogError(Zcl, "Could not find ChipEventStructs$PumpConfigurationAndControlClusterMotorTemperatureHighEvent constructor");
                        return nullptr;
                    }
                ...
                case Events::PumpMotorFatalFailure::Id: {
                    ...
                    *aError = app::DataModel::Decode(aReader, cppValue);
                    ...
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$PumpConfigurationAndControlClusterPumpMotorFatalFailureEvent", pumpMotorFatalFailureStructClass);
                    if (err != CHIP_NO_ERROR) {
                        ChipLogError(Zcl, "Could not find class ChipEventStructs$PumpConfigurationAndControlClusterPumpMotorFatalFailureEvent");
                        return nullptr;
                    }

                    jmethodID pumpMotorFatalFailureStructCtor;
                    err = chip::JniReferences::GetInstance().FindMethod(
                       env, pumpMotorFatalFailureStructClass, "<init>",
                       "()V",
                       &pumpMotorFatalFailureStructCtor);
                    if (err != CHIP_NO_ERROR || pumpMotorFatalFailureStructCtor == nullptr) {
                        ChipLogError(Zcl, "Could not find ChipEventStructs$PumpConfigurationAndControlClusterPumpMotorFatalFailureEvent constructor");
                        return nullptr;
                    }
                ...
                case Events::ElectronicTemperatureHigh::Id: {
                    ...
                    *aError = app::DataModel::Decode(aReader, cppValue);
                    ...
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$PumpConfigurationAndControlClusterElectronicTemperatureHighEvent", electronicTemperatureHighStructClass);
                    if (err != CHIP_NO_ERROR) {
                        ChipLogError(Zcl, "Could not find class ChipEventStructs$PumpConfigurationAndControlClusterElectronicTemperatureHighEvent");
                        return nullptr;
                    }

                    jmethodID electronicTemperatureHighStructCtor;
                    err = chip::JniReferences::GetInstance().FindMethod(
                       env, electronicTemperatureHighStructClass, "<init>",
                       "()V",
                       &electronicTemperatureHighStructCtor);
                    if (err != CHIP_NO_ERROR || electronicTemperatureHighStructCtor == nullptr) {
                        ChipLogError(Zcl, "Could not find ChipEventStructs$PumpConfigurationAndControlClusterElectronicTemperatureHighEvent constructor");
                        return nullptr;
                    }
                ...
                case Events::PumpBlocked::Id: {
                    ...
                    *aError = app::DataModel::Decode(aReader, cppValue);
                    ...
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$PumpConfigurationAndControlClusterPumpBlockedEvent", pumpBlockedStructClass);
                    if (err != CHIP_NO_ERROR) {
                    ...
                    err = chip::JniReferences::GetInstance().FindMethod(
                       env, pumpBlockedStructClass, "<init>",
                       "()V",
                       &pumpBlockedStructCtor);
                ...
                case Events::SensorFailure::Id: {
                    ...
                    *aError = app::DataModel::Decode(aReader, cppValue);
                    ...
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$PumpConfigurationAndControlClusterSensorFailureEvent", sensorFailureStructClass);
                    if (err != CHIP_NO_ERROR) {
                    ...
                    err = chip::JniReferences::GetInstance().FindMethod(
                       env, sensorFailureStructClass, "<init>",
                       "()V",
                       &sensorFailureStructCtor);
                    if (err != CHIP_NO_ERROR || sensorFailureStructCtor == nullptr) {
                        ChipLogError(Zcl, "Could not find ChipEventStructs$PumpConfigurationAndControlClusterSensorFailureEvent constructor");
                        return nullptr;
                    }
                ...
                case Events::ElectronicNonFatalFailure::Id: {
                    ...
                    *aError = app::DataModel::Decode(aReader, cppValue);
                    ...
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$PumpConfigurationAndControlClusterElectronicNonFatalFailureEvent", electronicNonFatalFailureStructClass);
                    if (err != CHIP_NO_ERROR) {
                        ChipLogError(Zcl, "Could not find class ChipEventStructs$PumpConfigurationAndControlClusterElectronicNonFatalFailureEvent");
                        return nullptr;
                    }

                    jmethodID electronicNonFatalFailureStructCtor;
                    err = chip::JniReferences::GetInstance().FindMethod(
                       env, electronicNonFatalFailureStructClass, "<init>",
                       "()V",
                       &electronicNonFatalFailureStructCtor);
                    if (err != CHIP_NO_ERROR || electronicNonFatalFailureStructCtor == nullptr) {
                        ChipLogError(Zcl, "Could not find ChipEventStructs$PumpConfigurationAndControlClusterElectronicNonFatalFailureEvent constructor");
                        return nullptr;
                    }
                ...
                case Events::ElectronicFatalFailure::Id: {
                    ...
                    *aError = app::DataModel::Decode(aReader, cppValue);
                    ...
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$PumpConfigurationAndControlClusterElectronicFatalFailureEvent", electronicFatalFailureStructClass);
                    if (err != CHIP_NO_ERROR) {
                        ChipLogError(Zcl, "Could not find class ChipEventStructs$PumpConfigurationAndControlClusterElectronicFatalFailureEvent");
                        return nullptr;
                    }

                    jmethodID electronicFatalFailureStructCtor;
                    err = chip::JniReferences::GetInstance().FindMethod(
                       env, electronicFatalFailureStructClass, "<init>",
                       "()V",
                       &electronicFatalFailureStructCtor);
                    if (err != CHIP_NO_ERROR || electronicFatalFailureStructCtor == nullptr) {
                        ChipLogError(Zcl, "Could not find ChipEventStructs$PumpConfigurationAndControlClusterElectronicFatalFailureEvent constructor");
                        return nullptr;
                    }
                ...
                case Events::GeneralFault::Id: {
                    ...
                    *aError = app::DataModel::Decode(aReader, cppValue);
                    ...
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$PumpConfigurationAndControlClusterGeneralFaultEvent", generalFaultStructClass);
                    if (err != CHIP_NO_ERROR) {
                    ...
                    err = chip::JniReferences::GetInstance().FindMethod(
                       env, generalFaultStructClass, "<init>",
                       "()V",
                       &generalFaultStructCtor);
                    if (err != CHIP_NO_ERROR || generalFaultStructCtor == nullptr) {
                        ChipLogError(Zcl, "Could not find ChipEventStructs$PumpConfigurationAndControlClusterGeneralFaultEvent constructor");
                        return nullptr;
                    }
                ...
                case Events::Leakage::Id: {
                    ...
                    *aError = app::DataModel::Decode(aReader, cppValue);
                    ...
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$PumpConfigurationAndControlClusterLeakageEvent", leakageStructClass);
                    if (err != CHIP_NO_ERROR) {
                ...
                case Events::AirDetection::Id: {
                    ...
                    *aError = app::DataModel::Decode(aReader, cppValue);
                    ...
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$PumpConfigurationAndControlClusterAirDetectionEvent", airDetectionStructClass);
                    if (err != CHIP_NO_ERROR) {
                    ...
                    err = chip::JniReferences::GetInstance().FindMethod(
                       env, airDetectionStructClass, "<init>",
                       "()V",
                       &airDetectionStructCtor);
                    if (err != CHIP_NO_ERROR || airDetectionStructCtor == nullptr) {
                        ChipLogError(Zcl, "Could not find ChipEventStructs$PumpConfigurationAndControlClusterAirDetectionEvent constructor");
                        return nullptr;
                    }
                ...
                case Events::TurbineOperation::Id: {
                    ...
                    *aError = app::DataModel::Decode(aReader, cppValue);
                    ...
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$PumpConfigurationAndControlClusterTurbineOperationEvent", turbineOperationStructClass);
                    if (err != CHIP_NO_ERROR) {
                    ...
                    err = chip::JniReferences::GetInstance().FindMethod(
                       env, turbineOperationStructClass, "<init>",
                       "()V",
                       &turbineOperationStructCtor);
                    if (err != CHIP_NO_ERROR || turbineOperationStructCtor == nullptr) {
                        ChipLogError(Zcl, "Could not find ChipEventStructs$PumpConfigurationAndControlClusterTurbineOperationEvent constructor");
                        return nullptr;
                    }
        ...
        std::string newElement_0_identifierCtorSignature = "(I)V";
          ...
          chip::JniReferences::GetInstance().CreateBoxedObject<jint>(newElement_0_identifierClassName.c_str(), newElement_0_identifierCtorSignature.c_str(), jninewElement_0_identifier, newElement_0_identifier);
    ...
    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipStructs$TargetNavigatorClusterTargetInfoStruct", targetInfoStructStructClass_1);
    if (err != CHIP_NO_ERROR) {
    ...
    err = chip::JniReferences::GetInstance().FindMethod(
        env, targetInfoStructStructClass_1, "<init>",
    ...
    chip::JniReferences::GetInstance().AddToList(value_targetList, newElement_0);
        ...
        std::string value_currentTargetCtorSignature = "(I)V";
          ...
          chip::JniReferences::GetInstance().CreateBoxedObject<jint>(value_currentTargetClassName.c_str(), value_currentTargetCtorSignature.c_str(), jnivalue_currentTarget, value_currentTarget);
      
                    jobject value_data;
                            jbyteArray value_dataByteArray = env->NewByteArray(static_cast<jsize>(cppValue.data.size()));
        env->SetByteArrayRegion(value_dataByteArray, 0, static_cast<jsize>(cppValue.data.size()), reinterpret_cast<const jbyte *>(cppValue.data.data()));
        value_data = value_dataByteArray;

                    jclass targetUpdatedStructClass;
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$TargetNavigatorClusterTargetUpdatedEvent", targetUpdatedStructClass);
                    if (err != CHIP_NO_ERROR) {
                    ...
                    err = chip::JniReferences::GetInstance().FindMethod(
                       env, targetUpdatedStructClass, "<init>",
                       "(Ljava/util/ArrayList;Ljava/lang/Integer;[B)V",
                       &targetUpdatedStructCtor);
                    ...
                    jobject value = env->NewObject(targetUpdatedStructClass, targetUpdatedStructCtor
                    , value_targetList
                    , value_currentTarget
                    , value_data
                    );
      ...
      chip::JniReferences::GetInstance().CreateBoxedObject<jint>(value_currentStateClassName.c_str(), value_currentStateCtorSignature.c_str(), jnivalue_currentState, value_currentState);
        ...
        std::string value_startTimeCtorSignature = "(J)V";
          ...
          chip::JniReferences::GetInstance().CreateBoxedObject<jlong>(value_startTimeClassName.c_str(), value_startTimeCtorSignature.c_str(), jnivalue_startTime, value_startTime);
        ...
        std::string value_sampledPosition_updatedAtCtorSignature = "(J)V";
          ...
          chip::JniReferences::GetInstance().CreateBoxedObject<jlong>(value_sampledPosition_updatedAtClassName.c_str(), value_sampledPosition_updatedAtCtorSignature.c_str(), jnivalue_sampledPosition_updatedAt, value_sampledPosition_updatedAt);
      ...
      if (cppValue.sampledPosition.position.IsNull()) {
        ...
        std::string value_sampledPosition_positionCtorSignature = "(J)V";
          ...
          chip::JniReferences::GetInstance().CreateBoxedObject<jlong>(value_sampledPosition_positionClassName.c_str(), value_sampledPosition_positionCtorSignature.c_str(), jnivalue_sampledPosition_position, value_sampledPosition_position);
      }

    jclass playbackPositionStructStructClass_0;
    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipStructs$MediaPlaybackClusterPlaybackPositionStruct", playbackPositionStructStructClass_0);
    if (err != CHIP_NO_ERROR) {
    ...
    err = chip::JniReferences::GetInstance().FindMethod(
        env, playbackPositionStructStructClass_0, "<init>",
    ...
    value_sampledPosition = env->NewObject(playbackPositionStructStructClass_0, playbackPositionStructStructCtor_0
      ...
      , value_sampledPosition_position
    );
        ...
        std::string value_playbackSpeedCtorSignature = "(F)V";
          ...
          chip::JniReferences::GetInstance().CreateBoxedObject<jfloat>(value_playbackSpeedClassName.c_str(), value_playbackSpeedCtorSignature.c_str(), jnivalue_playbackSpeed, value_playbackSpeed);
        ...
        std::string value_seekRangeEndCtorSignature = "(J)V";
          ...
          chip::JniReferences::GetInstance().CreateBoxedObject<jlong>(value_seekRangeEndClassName.c_str(), value_seekRangeEndCtorSignature.c_str(), jnivalue_seekRangeEnd, value_seekRangeEnd);
        ...
        std::string value_seekRangeStartCtorSignature = "(J)V";
          ...
          chip::JniReferences::GetInstance().CreateBoxedObject<jlong>(value_seekRangeStartClassName.c_str(), value_seekRangeStartCtorSignature.c_str(), jnivalue_seekRangeStart, value_seekRangeStart);
        ...
        env->SetByteArrayRegion(value_dataInsideOptionalByteArray, 0, static_cast<jsize>(cppValue.data.Value().size()), reinterpret_cast<const jbyte *>(cppValue.data.Value().data()));
  ...
  chip::JniReferences::GetInstance().CreateOptional(value_dataInsideOptional, value_data);
        ...
        std::string value_audioAdvanceUnmutedCtorSignature = "(Z)V";
          ...
          chip::JniReferences::GetInstance().CreateBoxedObject<jboolean>(value_audioAdvanceUnmutedClassName.c_str(), value_audioAdvanceUnmutedCtorSignature.c_str(), jnivalue_audioAdvanceUnmuted, value_audioAdvanceUnmuted);
      
                    jclass stateChangedStructClass;
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$MediaPlaybackClusterStateChangedEvent", stateChangedStructClass);
                    if (err != CHIP_NO_ERROR) {
                    ...
                    err = chip::JniReferences::GetInstance().FindMethod(
                       env, stateChangedStructClass, "<init>",
                       "(Ljava/lang/Integer;Ljava/lang/Long;Ljava/lang/Long;Lchip/devicecontroller/ChipStructs$MediaPlaybackClusterPlaybackPositionStruct;Ljava/lang/Float;Ljava/lang/Long;Ljava/lang/Long;Ljava/util/Optional;Ljava/lang/Boolean;)V",
                       &stateChangedStructCtor);
                    if (err != CHIP_NO_ERROR || stateChangedStructCtor == nullptr) {
                    ...
                    , value_startTime
                    , value_duration
                    , value_sampledPosition
                    , value_playbackSpeed
                    , value_seekRangeEnd
                    , value_seekRangeStart
                    , value_data
                    , value_audioAdvanceUnmuted
                    );
        ...
        std::string value_nodeInsideOptionalCtorSignature = "(J)V";
          ...
          chip::JniReferences::GetInstance().CreateBoxedObject<jlong>(value_nodeInsideOptionalClassName.c_str(), value_nodeInsideOptionalCtorSignature.c_str(), jnivalue_nodeInsideOptional, value_nodeInsideOptional);
        chip::JniReferences::GetInstance().CreateOptional(value_nodeInsideOptional, value_node);
                    }

                    jclass loggedOutStructClass;
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$AccountLoginClusterLoggedOutEvent", loggedOutStructClass);
                    if (err != CHIP_NO_ERROR) {
                    ...
                    jobject value = env->NewObject(loggedOutStructClass, loggedOutStructCtor
                    , value_node
                    );
            ...
            switch (aPath.mEventId)
            {
                case Events::RemainingScreenTimeExpired::Id: {
                    ...
                    *aError = app::DataModel::Decode(aReader, cppValue);
                    ...
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$ContentControlClusterRemainingScreenTimeExpiredEvent", remainingScreenTimeExpiredStructClass);
                    if (err != CHIP_NO_ERROR) {
                    ...
                    err = chip::JniReferences::GetInstance().FindMethod(
                       env, remainingScreenTimeExpiredStructClass, "<init>",
                       "()V",
                       &remainingScreenTimeExpiredStructCtor);
                    if (err != CHIP_NO_ERROR || remainingScreenTimeExpiredStructCtor == nullptr) {
                        ChipLogError(Zcl, "Could not find ChipEventStructs$ContentControlClusterRemainingScreenTimeExpiredEvent constructor");
                        return nullptr;
                    }
        ...
        std::string value_requestIdCtorSignature = "(J)V";
          ...
          chip::JniReferences::GetInstance().CreateBoxedObject<jlong>(value_requestIdClassName.c_str(), value_requestIdCtorSignature.c_str(), jnivalue_requestId, value_requestId);
        ...
        std::string value_clientNodeIdCtorSignature = "(J)V";
          ...
          chip::JniReferences::GetInstance().CreateBoxedObject<jlong>(value_clientNodeIdClassName.c_str(), value_clientNodeIdCtorSignature.c_str(), jnivalue_clientNodeId, value_clientNodeId);
        ...
        std::string value_statusCodeCtorSignature = "(I)V";
          ...
          chip::JniReferences::GetInstance().CreateBoxedObject<jint>(value_statusCodeClassName.c_str(), value_statusCodeCtorSignature.c_str(), jnivalue_statusCode, value_statusCode);
        ...
        std::string value_fabricIndexCtorSignature = "(I)V";
          ...
          chip::JniReferences::GetInstance().CreateBoxedObject<jint>(value_fabricIndexClassName.c_str(), value_fabricIndexCtorSignature.c_str(), jnivalue_fabricIndex, value_fabricIndex);
                    ...
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$CommissionerControlClusterCommissioningRequestResultEvent", commissioningRequestResultStructClass);
                    if (err != CHIP_NO_ERROR) {
                        ChipLogError(Zcl, "Could not find class ChipEventStructs$CommissionerControlClusterCommissioningRequestResultEvent");
                        return nullptr;
                    }
                    ...
                    if (err != CHIP_NO_ERROR || commissioningRequestResultStructCtor == nullptr) {
                        ChipLogError(Zcl, "Could not find ChipEventStructs$CommissionerControlClusterCommissioningRequestResultEvent constructor");
                        return nullptr;
                    }
        ...
        std::string value_arg1CtorSignature = "(I)V";
          ...
          chip::JniReferences::GetInstance().CreateBoxedObject<jint>(value_arg1ClassName.c_str(), value_arg1CtorSignature.c_str(), jnivalue_arg1, value_arg1);
      ...
      chip::JniReferences::GetInstance().CreateBoxedObject<jint>(value_arg2ClassName.c_str(), value_arg2CtorSignature.c_str(), jnivalue_arg2, value_arg2);
        ...
        std::string value_arg3CtorSignature = "(Z)V";
          ...
          chip::JniReferences::GetInstance().CreateBoxedObject<jboolean>(value_arg3ClassName.c_str(), value_arg3CtorSignature.c_str(), jnivalue_arg3, value_arg3);
        ...
        std::string value_arg4_aCtorSignature = "(I)V";
          ...
          chip::JniReferences::GetInstance().CreateBoxedObject<jint>(value_arg4_aClassName.c_str(), value_arg4_aCtorSignature.c_str(), jnivalue_arg4_a, value_arg4_a);
        ...
        std::string value_arg4_bCtorSignature = "(Z)V";
          ...
          chip::JniReferences::GetInstance().CreateBoxedObject<jboolean>(value_arg4_bClassName.c_str(), value_arg4_bCtorSignature.c_str(), jnivalue_arg4_b, value_arg4_b);
      ...
      chip::JniReferences::GetInstance().CreateBoxedObject<jint>(value_arg4_cClassName.c_str(), value_arg4_cCtorSignature.c_str(), jnivalue_arg4_c, value_arg4_c);
      jobject value_arg4_d;
              jbyteArray value_arg4_dByteArray = env->NewByteArray(static_cast<jsize>(cppValue.arg4.d.size()));
        env->SetByteArrayRegion(value_arg4_dByteArray, 0, static_cast<jsize>(cppValue.arg4.d.size()), reinterpret_cast<const jbyte *>(cppValue.arg4.d.data()));
      ...
      jobject value_arg4_f;
        ...
        std::string value_arg4_fCtorSignature = "(I)V";
          ...
          chip::JniReferences::GetInstance().CreateBoxedObject<jint>(value_arg4_fClassName.c_str(), value_arg4_fCtorSignature.c_str(), jnivalue_arg4_f, value_arg4_f);
        ...
        std::string value_arg4_gCtorSignature = "(F)V";
          ...
          chip::JniReferences::GetInstance().CreateBoxedObject<jfloat>(value_arg4_gClassName.c_str(), value_arg4_gCtorSignature.c_str(), jnivalue_arg4_g, value_arg4_g);
        ...
        std::string value_arg4_hCtorSignature = "(D)V";
          ...
          chip::JniReferences::GetInstance().CreateBoxedObject<jdouble>(value_arg4_hClassName.c_str(), value_arg4_hCtorSignature.c_str(), jnivalue_arg4_h, value_arg4_h);
      
    jclass simpleStructStructClass_0;
    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipStructs$UnitTestingClusterSimpleStruct", simpleStructStructClass_0);
    if (err != CHIP_NO_ERROR) {
    ...
    err = chip::JniReferences::GetInstance().FindMethod(
        ...
        "(Ljava/lang/Integer;Ljava/lang/Boolean;Ljava/lang/Integer;[BLjava/lang/String;Ljava/lang/Integer;Ljava/lang/Float;Ljava/lang/Double;)V",
    ...
    value_arg4 = env->NewObject(simpleStructStructClass_0, simpleStructStructCtor_0
      , value_arg4_a
      , value_arg4_b
      , value_arg4_c
      , value_arg4_d
      ...
      , value_arg4_h
        ...
        std::string newElement_0_aCtorSignature = "(I)V";
          ...
          chip::JniReferences::GetInstance().CreateBoxedObject<jint>(newElement_0_aClassName.c_str(), newElement_0_aCtorSignature.c_str(), jninewElement_0_a, newElement_0_a);
        ...
        std::string newElement_0_bCtorSignature = "(Z)V";
          ...
          chip::JniReferences::GetInstance().CreateBoxedObject<jboolean>(newElement_0_bClassName.c_str(), newElement_0_bCtorSignature.c_str(), jninewElement_0_b, newElement_0_b);
      ...
      chip::JniReferences::GetInstance().CreateBoxedObject<jint>(newElement_0_cClassName.c_str(), newElement_0_cCtorSignature.c_str(), jninewElement_0_c, newElement_0_c);
      jobject newElement_0_d;
              jbyteArray newElement_0_dByteArray = env->NewByteArray(static_cast<jsize>(entry_0.d.size()));
        env->SetByteArrayRegion(newElement_0_dByteArray, 0, static_cast<jsize>(entry_0.d.size()), reinterpret_cast<const jbyte *>(entry_0.d.data()));
      ...
      jobject newElement_0_f;
        ...
        std::string newElement_0_fCtorSignature = "(I)V";
          ...
          chip::JniReferences::GetInstance().CreateBoxedObject<jint>(newElement_0_fClassName.c_str(), newElement_0_fCtorSignature.c_str(), jninewElement_0_f, newElement_0_f);
        ...
        std::string newElement_0_gCtorSignature = "(F)V";
          ...
          chip::JniReferences::GetInstance().CreateBoxedObject<jfloat>(newElement_0_gClassName.c_str(), newElement_0_gCtorSignature.c_str(), jninewElement_0_g, newElement_0_g);
        ...
        std::string newElement_0_hCtorSignature = "(D)V";
          ...
          chip::JniReferences::GetInstance().CreateBoxedObject<jdouble>(newElement_0_hClassName.c_str(), newElement_0_hCtorSignature.c_str(), jninewElement_0_h, newElement_0_h);
      
    jclass simpleStructStructClass_1;
    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipStructs$UnitTestingClusterSimpleStruct", simpleStructStructClass_1);
    if (err != CHIP_NO_ERROR) {
      ChipLogError(Zcl, "Could not find class ChipStructs$UnitTestingClusterSimpleStruct");
      return nullptr;
    }
    ...
    newElement_0 = env->NewObject(simpleStructStructClass_1, simpleStructStructCtor_1
      , newElement_0_a
      , newElement_0_b
      , newElement_0_c
      , newElement_0_d
    ...
    chip::JniReferences::GetInstance().AddToList(value_arg6, newElement_0);
                    ...
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$UnitTestingClusterTestEventEvent", testEventStructClass);
                    if (err != CHIP_NO_ERROR) {
                    ...
                    err = chip::JniReferences::GetInstance().FindMethod(
                       ...
                       "(Ljava/lang/Integer;Ljava/lang/Integer;Ljava/lang/Boolean;Lchip/devicecontroller/ChipStructs$UnitTestingClusterSimpleStruct;Ljava/util/ArrayList;Ljava/util/ArrayList;)V",
                       &testEventStructCtor);
                    ...
                    jobject value = env->NewObject(testEventStructClass, testEventStructCtor
                    , value_arg1
                    , value_arg2
                    , value_arg3
                    , value_arg4
        ...
        std::string value_fabricIndexCtorSignature = "(I)V";
          ...
          chip::JniReferences::GetInstance().CreateBoxedObject<jint>(value_fabricIndexClassName.c_str(), value_fabricIndexCtorSignature.c_str(), jnivalue_fabricIndex, value_fabricIndex);
                    ...
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$UnitTestingClusterTestFabricScopedEventEvent", testFabricScopedEventStructClass);
                    if (err != CHIP_NO_ERROR) {
                    ...
                    err = chip::JniReferences::GetInstance().FindMethod(
                       env, testFabricScopedEventStructClass, "<init>",
                       "(Ljava/lang/Integer;)V",
                       &testFabricScopedEventStructCtor);
                    ...
                    jobject value = env->NewObject(testFabricScopedEventStructClass, testFabricScopedEventStructCtor
                    , value_fabricIndex
                    );
        ...
        std::string value_arg1CtorSignature = "(I)V";
          ...
          chip::JniReferences::GetInstance().CreateBoxedObject<jint>(value_arg1ClassName.c_str(), value_arg1CtorSignature.c_str(), jnivalue_arg1, value_arg1);
                    ...
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$UnitTestingClusterTestDifferentVendorMeiEventEvent", testDifferentVendorMeiEventStructClass);
                    if (err != CHIP_NO_ERROR) {
                    ...
                    err = chip::JniReferences::GetInstance().FindMethod(
                       env, testDifferentVendorMeiEventStructClass, "<init>",
                       "(Ljava/lang/Integer;)V",
                       &testDifferentVendorMeiEventStructCtor);
                    ...
                    jobject value = env->NewObject(testDifferentVendorMeiEventStructClass, testDifferentVendorMeiEventStructCtor
                    , value_arg1
                    );
        ...
        std::string value_countCtorSignature = "(J)V";
          ...
          chip::JniReferences::GetInstance().CreateBoxedObject<jlong>(value_countClassName.c_str(), value_countCtorSignature.c_str(), jnivalue_count, value_count);
        ...
        std::string value_fabricIndexCtorSignature = "(I)V";
          ...
          chip::JniReferences::GetInstance().CreateBoxedObject<jint>(value_fabricIndexClassName.c_str(), value_fabricIndexCtorSignature.c_str(), jnivalue_fabricIndex, value_fabricIndex);
                    ...
                    err = chip::JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipEventStructs$SampleMeiClusterPingCountEventEvent", pingCountEventStructClass);
                    if (err != CHIP_NO_ERROR) {
                    ...
                    err = chip::JniReferences::GetInstance().FindMethod(
                       env, pingCountEventStructClass, "<init>",
                       "(Ljava/lang/Long;Ljava/lang/Integer;)V",
                       &pingCountEventStructCtor);
                    ...
                    jobject value = env->NewObject(pingCountEventStructClass, pingCountEventStructCtor
                    , value_count
                    , value_fabricIndex
                    );
