        ...
        case Events::SoftwareFault::Id: {
            ...
            *aError = app::DataModel::Decode(aReader, cppValue);
            ...
            else
            {
                ...
                *aError = chip::JniReferences::GetInstance().CharToStringUTF(cppValue.name.Value(), value_nameInsideOptional);
    ...
    case app::Clusters::UnitTesting::Id: {
        ...
        case Events::TestEvent::Id: {
            ...
            *aError = app::DataModel::Decode(aReader, cppValue);
            ...
            chip::JniReferences::GetInstance().CharToStringUTF(cppValue.arg4.e, value_arg4_e);
