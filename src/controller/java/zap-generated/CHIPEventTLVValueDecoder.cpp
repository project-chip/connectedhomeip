...
jobject DecodeEventValue(const app::ConcreteEventPath & aPath, TLV::TLVReader & aReader, CHIP_ERROR * aError)
{
    ...
    switch (aPath.mClusterId)
    {
        ...
        std::string value_adminNodeIDCtorSignature = "(J)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint64_t>(value_adminNodeIDClassName.c_str(), value_adminNodeIDCtorSignature.c_str(), cppValue.adminNodeID.Value(), value_adminNodeID);
      }
        ...
        std::string value_adminPasscodeIDCtorSignature = "(I)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint16_t>(value_adminPasscodeIDClassName.c_str(), value_adminPasscodeIDCtorSignature.c_str(), cppValue.adminPasscodeID.Value(), value_adminPasscodeID);
      }
      ...
      chip::JniReferences::GetInstance().CreateBoxedObject<uint8_t>(value_changeTypeClassName.c_str(), value_changeTypeCtorSignature.c_str(), static_cast<uint8_t>(cppValue.changeType), value_changeType);
      ...
      chip::JniReferences::GetInstance().CreateBoxedObject<uint8_t>(value_latestValue_privilegeClassName.c_str(), value_latestValue_privilegeCtorSignature.c_str(), static_cast<uint8_t>(cppValue.latestValue.Value().privilege), value_latestValue_privilege);
      ...
      chip::JniReferences::GetInstance().CreateBoxedObject<uint8_t>(value_latestValue_authModeClassName.c_str(), value_latestValue_authModeCtorSignature.c_str(), static_cast<uint8_t>(cppValue.latestValue.Value().authMode), value_latestValue_authMode);
      ...
      if (cppValue.latestValue.Value().subjects.IsNull()) {
        ...
        std::string newElement_3CtorSignature = "(J)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint64_t>(newElement_3ClassName.c_str(), newElement_3CtorSignature.c_str(), entry_3, newElement_3);
      ...
      if (entry_3.cluster.IsNull()) {
        ...
        std::string newElement_3_clusterCtorSignature = "(J)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint32_t>(newElement_3_clusterClassName.c_str(), newElement_3_clusterCtorSignature.c_str(), entry_3.cluster.Value(), newElement_3_cluster);
      }
      ...
      if (entry_3.endpoint.IsNull()) {
        ...
        std::string newElement_3_endpointCtorSignature = "(I)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint16_t>(newElement_3_endpointClassName.c_str(), newElement_3_endpointCtorSignature.c_str(), entry_3.endpoint.Value(), newElement_3_endpoint);
      }
      ...
      if (entry_3.deviceType.IsNull()) {
        ...
        std::string newElement_3_deviceTypeCtorSignature = "(J)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint32_t>(newElement_3_deviceTypeClassName.c_str(), newElement_3_deviceTypeCtorSignature.c_str(), entry_3.deviceType.Value(), newElement_3_deviceType);
      }
    ...
    chip::JniReferences::GetInstance().AddToList(value_latestValue_targets, newElement_3);
      ...
      jobject value_latestValue_fabricIndex;
        ...
        std::string value_latestValue_fabricIndexCtorSignature = "(I)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint8_t>(value_latestValue_fabricIndexClassName.c_str(), value_latestValue_fabricIndexCtorSignature.c_str(), cppValue.latestValue.Value().fabricIndex, value_latestValue_fabricIndex);
    ...
    value_latestValue = env->NewObject(accessControlEntryStructStructClass_1, accessControlEntryStructStructCtor_1
      ...
      , value_latestValue_fabricIndex
        ...
        std::string value_fabricIndexCtorSignature = "(I)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint8_t>(value_fabricIndexClassName.c_str(), value_fabricIndexCtorSignature.c_str(), cppValue.fabricIndex, value_fabricIndex);
    ...
    value_latestValue = env->NewObject(accessControlExtensionStructStructClass_1, accessControlExtensionStructStructCtor_1
      ...
      , value_latestValue_fabricIndex
        ...
        std::string value_actionIDCtorSignature = "(I)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint16_t>(value_actionIDClassName.c_str(), value_actionIDCtorSignature.c_str(), cppValue.actionID, value_actionID);
      
                    jobject value_invokeID;
                            std::string value_invokeIDClassName = "java/lang/Long";
        std::string value_invokeIDCtorSignature = "(J)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint32_t>(value_invokeIDClassName.c_str(), value_invokeIDCtorSignature.c_str(), cppValue.invokeID, value_invokeID);
      
                    jobject value_newState;
                          std::string value_newStateClassName = "java/lang/Integer";
      std::string value_newStateCtorSignature = "(I)V";
      chip::JniReferences::GetInstance().CreateBoxedObject<uint8_t>(value_newStateClassName.c_str(), value_newStateCtorSignature.c_str(), static_cast<uint8_t>(cppValue.newState), value_newState);
      ...
      chip::JniReferences::GetInstance().CreateBoxedObject<uint8_t>(value_errorClassName.c_str(), value_errorCtorSignature.c_str(), static_cast<uint8_t>(cppValue.error), value_error);
        ...
        std::string value_softwareVersionCtorSignature = "(J)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint32_t>(value_softwareVersionClassName.c_str(), value_softwareVersionCtorSignature.c_str(), cppValue.softwareVersion, value_softwareVersion);
        ...
        std::string value_reachableNewValueCtorSignature = "(Z)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<bool>(value_reachableNewValueClassName.c_str(), value_reachableNewValueCtorSignature.c_str(), cppValue.reachableNewValue, value_reachableNewValue);
      ...
      chip::JniReferences::GetInstance().CreateBoxedObject<uint8_t>(value_previousStateClassName.c_str(), value_previousStateCtorSignature.c_str(), static_cast<uint8_t>(cppValue.previousState), value_previousState);
      ...
      chip::JniReferences::GetInstance().CreateBoxedObject<uint8_t>(value_reasonClassName.c_str(), value_reasonCtorSignature.c_str(), static_cast<uint8_t>(cppValue.reason), value_reason);
        ...
        std::string value_targetSoftwareVersionCtorSignature = "(J)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint32_t>(value_targetSoftwareVersionClassName.c_str(), value_targetSoftwareVersionCtorSignature.c_str(), cppValue.targetSoftwareVersion.Value(), value_targetSoftwareVersion);
      }
        ...
        std::string value_productIDCtorSignature = "(I)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint16_t>(value_productIDClassName.c_str(), value_productIDCtorSignature.c_str(), cppValue.productID, value_productID);
        ...
        std::string value_bytesDownloadedCtorSignature = "(J)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint64_t>(value_bytesDownloadedClassName.c_str(), value_bytesDownloadedCtorSignature.c_str(), cppValue.bytesDownloaded, value_bytesDownloaded);
        ...
        std::string value_progressPercentCtorSignature = "(I)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint8_t>(value_progressPercentClassName.c_str(), value_progressPercentCtorSignature.c_str(), cppValue.progressPercent.Value(), value_progressPercent);
      }
        ...
        std::string value_platformCodeCtorSignature = "(J)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<int64_t>(value_platformCodeClassName.c_str(), value_platformCodeCtorSignature.c_str(), cppValue.platformCode.Value(), value_platformCode);
      }
      ...
      chip::JniReferences::GetInstance().CreateBoxedObject<uint8_t>(newElement_0ClassName.c_str(), newElement_0CtorSignature.c_str(), static_cast<uint8_t>(entry_0), newElement_0);
    ...
    chip::JniReferences::GetInstance().AddToList(value_previous, newElement_0);
      ...
      chip::JniReferences::GetInstance().CreateBoxedObject<uint8_t>(value_bootReasonClassName.c_str(), value_bootReasonCtorSignature.c_str(), static_cast<uint8_t>(cppValue.bootReason), value_bootReason);
        ...
        std::string value_idCtorSignature = "(J)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint64_t>(value_idClassName.c_str(), value_idCtorSignature.c_str(), cppValue.id, value_id);
  ...
  chip::JniReferences::GetInstance().CreateOptional(value_faultRecordingInsideOptional, value_faultRecording);
      ...
      chip::JniReferences::GetInstance().CreateBoxedObject<uint8_t>(value_connectionStatusClassName.c_str(), value_connectionStatusCtorSignature.c_str(), static_cast<uint8_t>(cppValue.connectionStatus), value_connectionStatus);
    ...
    chip::JniReferences::GetInstance().AddToList(value_previous, newElement_0);
        ...
        std::string value_reasonCodeCtorSignature = "(I)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint16_t>(value_reasonCodeClassName.c_str(), value_reasonCodeCtorSignature.c_str(), cppValue.reasonCode, value_reasonCode);
      ...
      chip::JniReferences::GetInstance().CreateBoxedObject<uint8_t>(value_associationFailureClassName.c_str(), value_associationFailureCtorSignature.c_str(), static_cast<uint8_t>(cppValue.associationFailure), value_associationFailure);

                    jobject value_status;
                            std::string value_statusClassName = "java/lang/Integer";
        std::string value_statusCtorSignature = "(I)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint16_t>(value_statusClassName.c_str(), value_statusCtorSignature.c_str(), cppValue.status, value_status);
      ...
      chip::JniReferences::GetInstance().CreateBoxedObject<uint8_t>(value_connectionStatusClassName.c_str(), value_connectionStatusCtorSignature.c_str(), static_cast<uint8_t>(cppValue.connectionStatus), value_connectionStatus);
        ...
        std::string value_DSTOffsetActiveCtorSignature = "(Z)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<bool>(value_DSTOffsetActiveClassName.c_str(), value_DSTOffsetActiveCtorSignature.c_str(), cppValue.DSTOffsetActive, value_DSTOffsetActive);
        ...
        std::string value_offsetCtorSignature = "(J)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<int32_t>(value_offsetClassName.c_str(), value_offsetCtorSignature.c_str(), cppValue.offset, value_offset);
  ...
  chip::JniReferences::GetInstance().CreateOptional(value_nameInsideOptional, value_name);
        ...
        std::string value_newPositionCtorSignature = "(I)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint8_t>(value_newPositionClassName.c_str(), value_newPositionCtorSignature.c_str(), cppValue.newPosition, value_newPosition);
        ...
        std::string value_previousPositionCtorSignature = "(I)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint8_t>(value_previousPositionClassName.c_str(), value_previousPositionCtorSignature.c_str(), cppValue.previousPosition, value_previousPosition);
        ...
        std::string value_currentNumberOfPressesCountedCtorSignature = "(I)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint8_t>(value_currentNumberOfPressesCountedClassName.c_str(), value_currentNumberOfPressesCountedCtorSignature.c_str(), cppValue.currentNumberOfPressesCounted, value_currentNumberOfPressesCounted);
        ...
        std::string value_totalNumberOfPressesCountedCtorSignature = "(I)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint8_t>(value_totalNumberOfPressesCountedClassName.c_str(), value_totalNumberOfPressesCountedCtorSignature.c_str(), cppValue.totalNumberOfPressesCounted, value_totalNumberOfPressesCounted);
        ...
        std::string value_stateValueCtorSignature = "(Z)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<bool>(value_stateValueClassName.c_str(), value_stateValueCtorSignature.c_str(), cppValue.stateValue, value_stateValue);
        ...
        std::string value_activeCtorSignature = "(J)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint32_t>(value_activeClassName.c_str(), value_activeCtorSignature.c_str(), cppValue.active.Raw(), value_active);
      
                    jobject value_inactive;
                            std::string value_inactiveClassName = "java/lang/Long";
        std::string value_inactiveCtorSignature = "(J)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint32_t>(value_inactiveClassName.c_str(), value_inactiveCtorSignature.c_str(), cppValue.inactive.Raw(), value_inactive);
      
                    jobject value_state;
                            std::string value_stateClassName = "java/lang/Long";
        std::string value_stateCtorSignature = "(J)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint32_t>(value_stateClassName.c_str(), value_stateCtorSignature.c_str(), cppValue.state.Raw(), value_state);
      
                    jobject value_mask;
                            std::string value_maskClassName = "java/lang/Long";
        std::string value_maskCtorSignature = "(J)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint32_t>(value_maskClassName.c_str(), value_maskCtorSignature.c_str(), cppValue.mask.Raw(), value_mask);
        ...
        std::string value_errorState_errorStateIDCtorSignature = "(I)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint8_t>(value_errorState_errorStateIDClassName.c_str(), value_errorState_errorStateIDCtorSignature.c_str(), cppValue.errorState.errorStateID, value_errorState_errorStateID);
    ...
    value_errorState = env->NewObject(errorStateStructStructClass_0, errorStateStructStructCtor_0
      ...
      , value_errorState_errorStateDetails
        ...
        std::string value_completionErrorCodeCtorSignature = "(I)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint8_t>(value_completionErrorCodeClassName.c_str(), value_completionErrorCodeCtorSignature.c_str(), cppValue.completionErrorCode, value_completionErrorCode);
        ...
        std::string value_totalOperationalTimeInsideOptionalCtorSignature = "(J)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint32_t>(value_totalOperationalTimeInsideOptionalClassName.c_str(), value_totalOperationalTimeInsideOptionalCtorSignature.c_str(), cppValue.totalOperationalTime.Value().Value(), value_totalOperationalTimeInsideOptional);
      }
        ...
        std::string value_pausedTimeInsideOptionalCtorSignature = "(J)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint32_t>(value_pausedTimeInsideOptionalClassName.c_str(), value_pausedTimeInsideOptionalCtorSignature.c_str(), cppValue.pausedTime.Value().Value(), value_pausedTimeInsideOptional);
      }
  ...
  chip::JniReferences::GetInstance().CreateOptional(value_errorState_errorStateDetailsInsideOptional, value_errorState_errorStateDetails);
    ...
    value_errorState = env->NewObject(errorStateStructStructClass_0, errorStateStructStructCtor_0
      ...
      chip::JniReferences::GetInstance().CreateBoxedObject<uint8_t>(value_alarmCodeClassName.c_str(), value_alarmCodeCtorSignature.c_str(), static_cast<uint8_t>(cppValue.alarmCode), value_alarmCode);
      ...
      chip::JniReferences::GetInstance().CreateBoxedObject<uint8_t>(value_doorStateClassName.c_str(), value_doorStateCtorSignature.c_str(), static_cast<uint8_t>(cppValue.doorState), value_doorState);
      ...
      chip::JniReferences::GetInstance().CreateBoxedObject<uint8_t>(value_lockOperationTypeClassName.c_str(), value_lockOperationTypeCtorSignature.c_str(), static_cast<uint8_t>(cppValue.lockOperationType), value_lockOperationType);
      ...
      chip::JniReferences::GetInstance().CreateBoxedObject<uint8_t>(value_operationSourceClassName.c_str(), value_operationSourceCtorSignature.c_str(), static_cast<uint8_t>(cppValue.operationSource), value_operationSource);
        ...
        std::string value_userIndexCtorSignature = "(I)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint16_t>(value_userIndexClassName.c_str(), value_userIndexCtorSignature.c_str(), cppValue.userIndex.Value(), value_userIndex);
      }
                    ...
                    if (cppValue.fabricIndex.IsNull()) {
                      value_fabricIndex = nullptr;
                              ...
                              std::string value_fabricIndexClassName = "java/lang/Integer";
        std::string value_fabricIndexCtorSignature = "(I)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint8_t>(value_fabricIndexClassName.c_str(), value_fabricIndexCtorSignature.c_str(), cppValue.fabricIndex.Value(), value_fabricIndex);
      }
        ...
        std::string value_sourceNodeCtorSignature = "(J)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint64_t>(value_sourceNodeClassName.c_str(), value_sourceNodeCtorSignature.c_str(), cppValue.sourceNode.Value(), value_sourceNode);
      }
      ...
      chip::JniReferences::GetInstance().CreateBoxedObject<uint8_t>(newElement_2_credentialTypeClassName.c_str(), newElement_2_credentialTypeCtorSignature.c_str(), static_cast<uint8_t>(entry_2.credentialType), newElement_2_credentialType);
      jobject newElement_2_credentialIndex;
        ...
        std::string newElement_2_credentialIndexCtorSignature = "(I)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint16_t>(newElement_2_credentialIndexClassName.c_str(), newElement_2_credentialIndexCtorSignature.c_str(), entry_2.credentialIndex, newElement_2_credentialIndex);
    ...
    chip::JniReferences::GetInstance().AddToList(value_credentialsInsideOptional, newElement_2);
      ...
      chip::JniReferences::GetInstance().CreateBoxedObject<uint8_t>(value_operationErrorClassName.c_str(), value_operationErrorCtorSignature.c_str(), static_cast<uint8_t>(cppValue.operationError), value_operationError);
    ...
    chip::JniReferences::GetInstance().AddToList(value_credentialsInsideOptional, newElement_2);
      ...
      chip::JniReferences::GetInstance().CreateBoxedObject<uint8_t>(value_lockDataTypeClassName.c_str(), value_lockDataTypeCtorSignature.c_str(), static_cast<uint8_t>(cppValue.lockDataType), value_lockDataType);
      ...
      chip::JniReferences::GetInstance().CreateBoxedObject<uint8_t>(value_dataOperationTypeClassName.c_str(), value_dataOperationTypeCtorSignature.c_str(), static_cast<uint8_t>(cppValue.dataOperationType), value_dataOperationType);
      ...
      chip::JniReferences::GetInstance().CreateBoxedObject<uint8_t>(value_operationSourceClassName.c_str(), value_operationSourceCtorSignature.c_str(), static_cast<uint8_t>(cppValue.operationSource), value_operationSource);
        ...
        std::string value_dataIndexCtorSignature = "(I)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint16_t>(value_dataIndexClassName.c_str(), value_dataIndexCtorSignature.c_str(), cppValue.dataIndex.Value(), value_dataIndex);
      }
        ...
        std::string value_arg1CtorSignature = "(I)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint8_t>(value_arg1ClassName.c_str(), value_arg1CtorSignature.c_str(), cppValue.arg1, value_arg1);
      
                    jobject value_arg2;
                          std::string value_arg2ClassName = "java/lang/Integer";
      std::string value_arg2CtorSignature = "(I)V";
      chip::JniReferences::GetInstance().CreateBoxedObject<uint8_t>(value_arg2ClassName.c_str(), value_arg2CtorSignature.c_str(), static_cast<uint8_t>(cppValue.arg2), value_arg2);

                    jobject value_arg3;
                            std::string value_arg3ClassName = "java/lang/Boolean";
        std::string value_arg3CtorSignature = "(Z)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<bool>(value_arg3ClassName.c_str(), value_arg3CtorSignature.c_str(), cppValue.arg3, value_arg3);
      
                    jobject value_arg4;
                          jobject value_arg4_a;
              std::string value_arg4_aClassName = "java/lang/Integer";
        std::string value_arg4_aCtorSignature = "(I)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint8_t>(value_arg4_aClassName.c_str(), value_arg4_aCtorSignature.c_str(), cppValue.arg4.a, value_arg4_a);
            jobject value_arg4_b;
              std::string value_arg4_bClassName = "java/lang/Boolean";
        std::string value_arg4_bCtorSignature = "(Z)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<bool>(value_arg4_bClassName.c_str(), value_arg4_bCtorSignature.c_str(), cppValue.arg4.b, value_arg4_b);
            jobject value_arg4_c;
            std::string value_arg4_cClassName = "java/lang/Integer";
      std::string value_arg4_cCtorSignature = "(I)V";
      chip::JniReferences::GetInstance().CreateBoxedObject<uint8_t>(value_arg4_cClassName.c_str(), value_arg4_cCtorSignature.c_str(), static_cast<uint8_t>(cppValue.arg4.c), value_arg4_c);
      ...
      jobject value_arg4_f;
        ...
        std::string value_arg4_fCtorSignature = "(I)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint8_t>(value_arg4_fClassName.c_str(), value_arg4_fCtorSignature.c_str(), cppValue.arg4.f.Raw(), value_arg4_f);
            jobject value_arg4_g;
              std::string value_arg4_gClassName = "java/lang/Float";
        std::string value_arg4_gCtorSignature = "(F)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<float>(value_arg4_gClassName.c_str(), value_arg4_gCtorSignature.c_str(), cppValue.arg4.g, value_arg4_g);
            jobject value_arg4_h;
              std::string value_arg4_hClassName = "java/lang/Double";
        std::string value_arg4_hCtorSignature = "(D)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<double>(value_arg4_hClassName.c_str(), value_arg4_hCtorSignature.c_str(), cppValue.arg4.h, value_arg4_h);
    ...
    value_arg4 = env->NewObject(simpleStructStructClass_0, simpleStructStructCtor_0
      ...
      , value_arg4_h
        ...
        std::string newElement_0_aCtorSignature = "(I)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint8_t>(newElement_0_aClassName.c_str(), newElement_0_aCtorSignature.c_str(), entry_0.a, newElement_0_a);
            jobject newElement_0_b;
              std::string newElement_0_bClassName = "java/lang/Boolean";
        std::string newElement_0_bCtorSignature = "(Z)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<bool>(newElement_0_bClassName.c_str(), newElement_0_bCtorSignature.c_str(), entry_0.b, newElement_0_b);
            jobject newElement_0_c;
            std::string newElement_0_cClassName = "java/lang/Integer";
      std::string newElement_0_cCtorSignature = "(I)V";
      chip::JniReferences::GetInstance().CreateBoxedObject<uint8_t>(newElement_0_cClassName.c_str(), newElement_0_cCtorSignature.c_str(), static_cast<uint8_t>(entry_0.c), newElement_0_c);
      ...
      jobject newElement_0_f;
        ...
        std::string newElement_0_fCtorSignature = "(I)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint8_t>(newElement_0_fClassName.c_str(), newElement_0_fCtorSignature.c_str(), entry_0.f.Raw(), newElement_0_f);
            jobject newElement_0_g;
              std::string newElement_0_gClassName = "java/lang/Float";
        std::string newElement_0_gCtorSignature = "(F)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<float>(newElement_0_gClassName.c_str(), newElement_0_gCtorSignature.c_str(), entry_0.g, newElement_0_g);
            jobject newElement_0_h;
              std::string newElement_0_hClassName = "java/lang/Double";
        std::string newElement_0_hCtorSignature = "(D)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<double>(newElement_0_hClassName.c_str(), newElement_0_hCtorSignature.c_str(), entry_0.h, newElement_0_h);
