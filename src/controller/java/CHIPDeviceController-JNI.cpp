...
JNI_METHOD(jlong, newDeviceController)(JNIEnv * env, jobject self, jobject controllerParams)
{
    ...
    err = chip::JniReferences::GetInstance().FindMethod(env, controllerParams, "getControllerVendorId", "()I", &getControllerVendorId);
    SuccessOrExit(err);
...

    {
        ...
        wrapper = AndroidDeviceControllerWrapper::AllocateNew(
            ...
            operationalCertificate, ipk, listenPort, controllerVendorId, &err);
        SuccessOrExit(err);
    }
