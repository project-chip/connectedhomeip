...
public interface OTAProviderDelegate {
    public QueryImageResponse handleQueryImage(int vendorId, int productId, long softwareVersion, @Nullable Integer hardwareVersion, @Nullable String location, @Nullable Boolean requestorCanConsent, @Nullable byte[] metadataForProvider);
    ...
    public class QueryImageResponse {
        ...
        public QueryImageResponse(@Nullable Long softwareVersion, @Nullable String softwareVersionString, String filePath) {
    ...
    public enum ApplyUpdateActionEnum {
        Proceed(0), AwaitNextAction(1), Discontinue(2);
