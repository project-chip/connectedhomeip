...
public class ChipTLVType {
    public enum TLVType {
        UInt, Int, String, ByteArray, Boolean, Float, Double, Null, Struct, Array, Empty;
    }
    ...
    public static class UIntType implements BaseTLVType {
        ...
        @Override
        public TLVType type() { return TLVType.UInt; }
    }
    ...
    public static class IntType implements BaseTLVType {
        ...
        @Override
        public TLVType type() { return TLVType.Int; }
    }
    ...
    public static class StringType implements BaseTLVType {
        ...
        @Override
        public TLVType type() { return TLVType.String; }
    }
    ...
    public static class ByteArrayType implements BaseTLVType {
        ...
        @Override
        public TLVType type() { return TLVType.ByteArray; }
    }
    ...
    public static class BooleanType implements BaseTLVType {
        ...
        @Override
        public TLVType type() { return TLVType.Boolean; }
    }
    ...
    public static class FloatType implements BaseTLVType {
        ...
        @Override
        public TLVType type() { return TLVType.Float; }
    }
    ...
    public static class DoubleType implements BaseTLVType {
        ...
        @Override
        public TLVType type() { return TLVType.Double; }
    }
    ...
    public static class NullType implements BaseTLVType {
        ...
        @Override
        public TLVType type() { return TLVType.Null; }
    }
    ...
    public static class StructElement {
        ...
        public long contextTagNum() { return contextTagNum; }
    ...
    public static class ArrayType implements BaseTLVType {
        ...
        public static <T> ArrayType generateArrayType(ArrayList<T> rawValue, ArrayEncodeMapMethod<T> method) {
        ...
        @Override
        public TLVType type() { return TLVType.Array; }
    }
    ...
    public static class EmptyType implements BaseTLVType {
        ...
        @Override
        public TLVType type() { return TLVType.Empty; }
    }
}
