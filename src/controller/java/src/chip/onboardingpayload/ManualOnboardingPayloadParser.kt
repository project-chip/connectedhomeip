...
class ManualOnboardingPayloadParser(decimalRepresentation: String) {
    ...
    fun populatePayload(outPayload: OnboardingPayload): Unit {
        ...
        val kDiscriminatorMsbitsMask: UInt =
            (1u shl kManualSetupChunk1DiscriminatorMsbitsLength) - 1u
        val kDiscriminatorLsbitsMask: UInt =
            (1u shl kManualSetupChunk2DiscriminatorLsbitsLength) - 1u

        var discriminator =
            ((chunk2 shr kManualSetupChunk2DiscriminatorLsbitsPos) and kDiscriminatorLsbitsMask)
                .toInt()

        discriminator =
            discriminator or
                (((chunk1 shr kManualSetupChunk1DiscriminatorMsbitsPos) and
                        kDiscriminatorMsbitsMask)
        ...
        setUpPINCode =
            setUpPINCode or
                (((chunk3 shr kManualSetupChunk3PINCodeMsbitsPos) and kPincodeMsbitsMask)
