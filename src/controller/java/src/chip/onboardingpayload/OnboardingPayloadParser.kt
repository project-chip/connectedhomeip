...
class OnboardingPayloadParser {
     ...
     * in the QRCode Parse result, OnboardingPayloadException occurs. Refer to [OnboardingPayload]
     * for the description of the invalid element.
     */
     ...
     * @param skipPayloadValidation If this value is true, payload element validation is not
     *   checked. Consider saying that the payload must still parse correctly, but this skips
     *   validation of the content past parsing (i.e. it does not validate ranges for individual
     *   elements). Refer to [OnboardingPayload] for the description of the invalid element.
     */
    @Throws(UnrecognizedQrCodeException::class, OnboardingPayloadException::class)
    ...
    /**
     * Returns [OnboardingPayload] parsed from the Manual Pairing Code string. If an SetupPINCode
     * has invalid value, OnboardingPayloadException occurs. Refer to [OnboardingPayload] for the
