...
class OnboardingPayload(
  ...
  fun isValidQRCodePayload(): Boolean {
    ...
    // commissioning mode. 2: Custom commissioning flow: interaction with a vendor-specified means
    ...
    // If discoveryCapabilities is not empty and discoveryCapabilities contains values outside of
    // allValid
