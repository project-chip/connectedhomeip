...
class QRCodeOnboardingPayloadGenerator(private val onboardingPayload: OnboardingPayload) {
     ...
     * string.
     *
     * If the payload has any optional data that needs to be TLV encoded, this function will
     * allocate a scratch heap buffer to hold the TLV data while encoding.
     *
     * @retval The base38 representation string.
     */
     ...
     * TLV-encoded. If that buffer is not big enough to hold the TLV-encoded part of the payload,
     * the function will fail.
     *
     * @param[in] tlvDataStart The start of the buffer to use as temporary scratch space for
     *   optional data that needs to be TLV-encoded.
     * @param[in] tlvDataStartSize The size of the buffer.
     * @retval The base38 representation string.
     */
    private fun payloadBase38Representation(
        tlvDataStart: ByteArray?,
        tlvDataStartSize: Int
    ): String {
