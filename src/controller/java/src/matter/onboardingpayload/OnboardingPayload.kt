...
class OnboardingPayload(
    ...
    companion object {
        private fun isValidSetupPIN(setupPIN: Long): Boolean {
            ...
            return (
                setupPIN != kSetupPINCodeUndefinedValue &&
        ...
        private fun longToShortValue(longValue: Int): Int = (longValue shr (kDiscriminatorLongBits - kDiscriminatorShortBits))

        private fun shortToLongValue(shortValue: Int): Int = (shortValue shl (kDiscriminatorLongBits - kDiscriminatorShortBits))
    }
}
