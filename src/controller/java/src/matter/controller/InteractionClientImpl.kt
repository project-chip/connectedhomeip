...
class InteractionClientImpl : InteractionClient {
  private var deviceController: ChipDeviceController? = null
  private var deviceControllerPtr: Long? = null
  ...
  companion object {
    private val logger = Logger.getLogger(InteractionClient::class.java.simpleName)
