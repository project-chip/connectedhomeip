...
// TODO(#5098) We should pass the Command Object and EndpointId to the cluster callbacks.
        ...
        Protocols::InteractionModel::ProtocolCode::UnsupportedCommand);
            ChipLogError(Zcl, "Unknown command %" PRIx8 " for cluster %" PRIx16, aCommandId, ZCL_ACCOUNT_LOGIN_CLUSTER_ID);
            return;
        }
        }
    }
...
// TODO(#5098) We should pass the Command Object and EndpointId to the cluster callbacks.
        ...
        default: {
            ...
            chip::app::CommandPathParams returnStatusParam = { aEndpointId,
                                                       0, // GroupId
                                                       ZCL_APPLICATION_LAUNCHER_CLUSTER_ID,
                                                       aCommandId,
                                                       (chip::app::CommandPathFlags::kEndpointIdValid) };
            apCommandObj->AddStatusCode(returnStatusParam, Protocols::SecureChannel::GeneralStatusCode::kNotFound, Protocols::SecureChannel::Id,
        Protocols::InteractionModel::ProtocolCode::UnsupportedCommand);
            ChipLogError(Zcl, "Unknown command %" PRIx8 " for cluster %" PRIx16, aCommandId, ZCL_APPLICATION_LAUNCHER_CLUSTER_ID);
            return;
        }
        }
    }
...
// TODO(#5098) We should pass the Command Object and EndpointId to the cluster callbacks.
        ...
        default: {
            ...
            chip::app::CommandPathParams returnStatusParam = { aEndpointId,
                                                       0, // GroupId
                                                       ZCL_CONTENT_LAUNCH_CLUSTER_ID,
                                                       aCommandId,
                                                       (chip::app::CommandPathFlags::kEndpointIdValid) };
            apCommandObj->AddStatusCode(returnStatusParam, Protocols::SecureChannel::GeneralStatusCode::kNotFound, Protocols::SecureChannel::Id,
        Protocols::InteractionModel::ProtocolCode::UnsupportedCommand);
            ChipLogError(Zcl, "Unknown command %" PRIx8 " for cluster %" PRIx16, aCommandId, ZCL_CONTENT_LAUNCH_CLUSTER_ID);
            return;
        }
        }
    }
...
// TODO(#5098) We should pass the Command Object and EndpointId to the cluster callbacks.
        ...
        default: {
            ...
            apCommandObj->AddStatusCode(returnStatusParam, Protocols::SecureChannel::GeneralStatusCode::kNotFound, Protocols::SecureChannel::Id,
        Protocols::InteractionModel::ProtocolCode::UnsupportedCommand);
            ChipLogError(Zcl, "Unknown command %" PRIx8 " for cluster %" PRIx16, aCommandId, ZCL_KEYPAD_INPUT_CLUSTER_ID);
            return;
        }
        }
    }
...
// TODO(#5098) We should pass the Command Object and EndpointId to the cluster callbacks.
        ...
        default: {
            ...
            chip::app::CommandPathParams returnStatusParam = { aEndpointId,
                                                       0, // GroupId
                                                       ZCL_MEDIA_PLAYBACK_CLUSTER_ID,
                                                       aCommandId,
                                                       (chip::app::CommandPathFlags::kEndpointIdValid) };
            apCommandObj->AddStatusCode(returnStatusParam, Protocols::SecureChannel::GeneralStatusCode::kNotFound, Protocols::SecureChannel::Id,
        Protocols::InteractionModel::ProtocolCode::UnsupportedCommand);
            ChipLogError(Zcl, "Unknown command %" PRIx8 " for cluster %" PRIx16, aCommandId, ZCL_MEDIA_PLAYBACK_CLUSTER_ID);
            return;
        }
        }
    }
...
{
// TODO(#5098) We should pass the Command Object and EndpointId to the cluster callbacks.
        wasHandled = emberAfOtaSoftwareUpdateServerClusterApplyUpdateRequestResponseCallback(apCommandObj, action, delayedActionTime);
        }
            break;
        }
...
{
// TODO(#5098) We should pass the Command Object and EndpointId to the cluster callbacks.
        wasHandled = emberAfOtaSoftwareUpdateServerClusterQueryImageResponseCallback(apCommandObj, status, delayedActionTime, const_cast<uint8_t*>(imageURI), softwareVersion, updateToken, userConsentNeeded, metadataForClient);
        }
            break;
        }
        default: {
...
// TODO(#5098) We should pass the Command Object and EndpointId to the cluster callbacks.
        ...
        default: {
            ...
            chip::app::CommandPathParams returnStatusParam = { aEndpointId,
                                                       0, // GroupId
                                                       ZCL_TV_CHANNEL_CLUSTER_ID,
                                                       aCommandId,
                                                       (chip::app::CommandPathFlags::kEndpointIdValid) };
            apCommandObj->AddStatusCode(returnStatusParam, Protocols::SecureChannel::GeneralStatusCode::kNotFound, Protocols::SecureChannel::Id,
        Protocols::InteractionModel::ProtocolCode::UnsupportedCommand);
            ChipLogError(Zcl, "Unknown command %" PRIx8 " for cluster %" PRIx16, aCommandId, ZCL_TV_CHANNEL_CLUSTER_ID);
            return;
        }
        }
    }
...
// TODO(#5098) We should pass the Command Object and EndpointId to the cluster callbacks.
        ...
        default: {
            ...
            apCommandObj->AddStatusCode(returnStatusParam, Protocols::SecureChannel::GeneralStatusCode::kNotFound, Protocols::SecureChannel::Id,
        Protocols::InteractionModel::ProtocolCode::UnsupportedCommand);
            ChipLogError(Zcl, "Unknown command %" PRIx8 " for cluster %" PRIx16, aCommandId, ZCL_TARGET_NAVIGATOR_CLUSTER_ID);
            return;
        }
        }
    }
