 ...
 */
chip::System::PacketBufferHandle encodeContentLaunchClusterReadAcceptsHeaderListAttribute(uint8_t seqNum, chip::EndpointId destinationEndpoint);
 ...
 */
chip::System::PacketBufferHandle encodeContentLaunchClusterReadSupportedStreamingTypesAttribute(uint8_t seqNum, chip::EndpointId destinationEndpoint);
 ...
 */
chip::System::PacketBufferHandle encodeTrustedRootCertificatesClusterDiscoverAttributes(uint8_t seqNum, chip::EndpointId destinationEndpoint);
 ...
 */
chip::System::PacketBufferHandle encodeTrustedRootCertificatesClusterReadClusterRevisionAttribute(uint8_t seqNum, chip::EndpointId destinationEndpoint);
...
/**
 * @brief
 *    Encode a Window Covering server configure report command for the window covering type attribute into buffer including the APS frame
 */
chip::System::PacketBufferHandle encodeWindowCoveringClusterConfigureWindowCoveringTypeAttribute(uint8_t seqNum, chip::EndpointId destinationEndpoint, uint16_t minInterval, uint16_t maxInterval);
...
/**
 * @brief
 *    Encode a Window Covering server configure report command for the current position - lift attribute into buffer including the APS frame
 */
...
/**
 * @brief
 *    Encode a Window Covering server configure report command for the current position - tilt attribute into buffer including the APS frame
 */
