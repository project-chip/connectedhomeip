...
{
    COMMAND_HEADER("DiscoverOccupancySensingAttributes", OCCUPANCY_SENSING_CLUSTER_ID);
    buf.Put8(kFrameControlGlobalCommand).Put8(seqNum).Put32(ZCL_DISCOVER_ATTRIBUTES_COMMAND_ID).Put32(0x0000).Put8(0xFF);
    COMMAND_FOOTER();
}
...
{
    COMMAND_HEADER("ReadOccupancySensingOccupancy", OCCUPANCY_SENSING_CLUSTER_ID);
    buf.Put8(kFrameControlGlobalCommand).Put8(seqNum).Put32(ZCL_READ_ATTRIBUTES_COMMAND_ID).Put32(0x0000);
    COMMAND_FOOTER();
}
...
PacketBufferHandle encodeOccupancySensingClusterConfigureOccupancyAttribute(uint8_t seqNum, EndpointId destinationEndpoint,
                                                                            uint16_t minInterval, uint16_t maxInterval)
{
    COMMAND_HEADER("ReportOccupancySensingOccupancy", OCCUPANCY_SENSING_CLUSTER_ID);
    buf.Put8(kFrameControlGlobalCommand)
        .Put8(seqNum)
        .Put32(ZCL_CONFIGURE_REPORTING_COMMAND_ID)
        .Put8(EMBER_ZCL_REPORTING_DIRECTION_REPORTED)
...
{
    COMMAND_HEADER("ReadOccupancySensingOccupancySensorType", OCCUPANCY_SENSING_CLUSTER_ID);
    buf.Put8(kFrameControlGlobalCommand).Put8(seqNum).Put32(ZCL_READ_ATTRIBUTES_COMMAND_ID).Put32(0x0001);
    COMMAND_FOOTER();
}
...
PacketBufferHandle encodeOccupancySensingClusterReadOccupancySensorTypeBitmapAttribute(uint8_t seqNum,
                                                                                       EndpointId destinationEndpoint)
{
    COMMAND_HEADER("ReadOccupancySensingOccupancySensorTypeBitmap", OCCUPANCY_SENSING_CLUSTER_ID);
    buf.Put8(kFrameControlGlobalCommand).Put8(seqNum).Put32(ZCL_READ_ATTRIBUTES_COMMAND_ID).Put32(0x0002);
    COMMAND_FOOTER();
}
...
{
    COMMAND_HEADER("ReadOccupancySensingClusterRevision", OCCUPANCY_SENSING_CLUSTER_ID);
    buf.Put8(kFrameControlGlobalCommand).Put8(seqNum).Put32(ZCL_READ_ATTRIBUTES_COMMAND_ID).Put32(0xFFFD);
    COMMAND_FOOTER();
}
