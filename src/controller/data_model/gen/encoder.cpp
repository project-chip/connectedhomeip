 ...
 */
PacketBufferHandle encodeWiFiNetworkDiagnosticsClusterReadBeaconLostCountAttribute(uint8_t seqNum, EndpointId destinationEndpoint)
{
    COMMAND_HEADER("ReadWiFiNetworkDiagnosticsBeaconLostCount", WIFI_NETWORK_DIAGNOSTICS_CLUSTER_ID);
    buf.Put8(kFrameControlGlobalCommand).Put8(seqNum).Put8(ZCL_READ_ATTRIBUTES_COMMAND_ID).Put16(0x0005);
    COMMAND_FOOTER();
}
 ...
 */
PacketBufferHandle encodeWiFiNetworkDiagnosticsClusterReadBeaconRxCountAttribute(uint8_t seqNum, EndpointId destinationEndpoint)
{
    COMMAND_HEADER("ReadWiFiNetworkDiagnosticsBeaconRxCount", WIFI_NETWORK_DIAGNOSTICS_CLUSTER_ID);
    buf.Put8(kFrameControlGlobalCommand).Put8(seqNum).Put8(ZCL_READ_ATTRIBUTES_COMMAND_ID).Put16(0x0006);
    COMMAND_FOOTER();
}
 ...
 */
PacketBufferHandle encodeWiFiNetworkDiagnosticsClusterReadPacketMulticastRxCountAttribute(uint8_t seqNum,
                                                                                          EndpointId destinationEndpoint)
{
    COMMAND_HEADER("ReadWiFiNetworkDiagnosticsPacketMulticastRxCount", WIFI_NETWORK_DIAGNOSTICS_CLUSTER_ID);
    buf.Put8(kFrameControlGlobalCommand).Put8(seqNum).Put8(ZCL_READ_ATTRIBUTES_COMMAND_ID).Put16(0x0007);
    COMMAND_FOOTER();
}
 ...
 */
PacketBufferHandle encodeWiFiNetworkDiagnosticsClusterReadPacketMulticastTxCountAttribute(uint8_t seqNum,
                                                                                          EndpointId destinationEndpoint)
{
    COMMAND_HEADER("ReadWiFiNetworkDiagnosticsPacketMulticastTxCount", WIFI_NETWORK_DIAGNOSTICS_CLUSTER_ID);
    buf.Put8(kFrameControlGlobalCommand).Put8(seqNum).Put8(ZCL_READ_ATTRIBUTES_COMMAND_ID).Put16(0x0008);
    COMMAND_FOOTER();
}
 ...
 */
PacketBufferHandle encodeWiFiNetworkDiagnosticsClusterReadPacketUnicastRxCountAttribute(uint8_t seqNum,
                                                                                        EndpointId destinationEndpoint)
{
    COMMAND_HEADER("ReadWiFiNetworkDiagnosticsPacketUnicastRxCount", WIFI_NETWORK_DIAGNOSTICS_CLUSTER_ID);
    buf.Put8(kFrameControlGlobalCommand).Put8(seqNum).Put8(ZCL_READ_ATTRIBUTES_COMMAND_ID).Put16(0x0009);
    COMMAND_FOOTER();
}
 ...
 */
PacketBufferHandle encodeWiFiNetworkDiagnosticsClusterReadPacketUnicastTxCountAttribute(uint8_t seqNum,
                                                                                        EndpointId destinationEndpoint)
{
    COMMAND_HEADER("ReadWiFiNetworkDiagnosticsPacketUnicastTxCount", WIFI_NETWORK_DIAGNOSTICS_CLUSTER_ID);
    buf.Put8(kFrameControlGlobalCommand).Put8(seqNum).Put8(ZCL_READ_ATTRIBUTES_COMMAND_ID).Put16(0x000A);
    COMMAND_FOOTER();
}
 ...
 * Attribute OverrunCount
 */
PacketBufferHandle encodeWiFiNetworkDiagnosticsClusterReadOverrunCountAttribute(uint8_t seqNum, EndpointId destinationEndpoint)
{
    COMMAND_HEADER("ReadWiFiNetworkDiagnosticsOverrunCount", WIFI_NETWORK_DIAGNOSTICS_CLUSTER_ID);
    buf.Put8(kFrameControlGlobalCommand).Put8(seqNum).Put8(ZCL_READ_ATTRIBUTES_COMMAND_ID).Put16(0x000C);
    COMMAND_FOOTER();
}
