                                                             ...
                                                             chip::ByteSpan attestationNonce)
{
    ...
    app::CommandPathParams cmdParams = { mEndpoint, /* group id */ 0, mClusterId, kAttestationRequestCommandId,
                                         (chip::app::CommandPathFlags::kEndpointIdValid) };
                                                           ...
                                                           Callback::Cancelable * onFailureCallback, uint16_t certChainType)
{
    ...
    app::CommandPathParams cmdParams = { mEndpoint, /* group id */ 0, mClusterId, kCertChainRequestCommandId,
                                         (chip::app::CommandPathFlags::kEndpointIdValid) };
