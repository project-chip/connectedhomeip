...
**Copyright(c) 2021 Project CHIP Authors ** Licensed under the Apache License, Version 2.0(the "License");
 ...
 EmberAfStatus emberAfScenesClusterClientCommandParse(EmberAfClusterCommand * cmd)
 {
     ...
     if (!cmd->mfgSpecific)
     {
         ...
         case ZCL_VIEW_SCENE_RESPONSE_COMMAND_ID: {
             ...
             wasHandled = emberAfScenesClusterViewSceneResponseCallback(nullptr, status, groupId, sceneId, transitionTime,
