...
private:
    ...
    static void OnOperationalCertificateSigningRequest(void * context, ByteSpan CSR, uint32_t CSRLen, ByteSpan CSRNonce,
                                                       ByteSpan VendorReserved1, ByteSpan VendorReserved2, ByteSpan VendorReserved3,
                                                       ByteSpan Signature);
