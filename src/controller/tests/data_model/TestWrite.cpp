                                  ...
                                  TLV::TLVReader & aReader, WriteHandler * aWriteHandler)
{
    ...
    if (aPath.mClusterId == Clusters::Test::Id &&
    ...
    if (aPath.mClusterId == Clusters::Test::Id && aPath.mAttributeId == Attributes::ListFabricScoped::Id)
    {
    ...
    if (aPath.mClusterId == Clusters::Test::Id && aPath.mAttributeId == Attributes::Boolean::TypeInfo::GetAttributeId())
    {
...
void TestWriteInteraction::TestDataResponse(nlTestSuite * apSuite, void * apContext)
{
    ...
    chip::Controller::WriteAttribute<Clusters::Test::Attributes::ListStructOctetString::TypeInfo>(sessionHandle, kTestEndpointId,
...
void TestWriteInteraction::TestDataResponseWithAcceptedDataVersion(nlTestSuite * apSuite, void * apContext)
{
    ...
    chip::Controller::WriteAttribute<Clusters::Test::Attributes::ListStructOctetString::TypeInfo>(
...
void TestWriteInteraction::TestFabricScopedAttributeWithoutFabricIndex(nlTestSuite * apSuite, void * apContext)
{
    ...
    auto sessionHandle      = ctx.GetSessionBobToAlice();
    bool onSuccessCbInvoked = false, onFailureCbInvoked = false;
    Clusters::Test::Structs::TestFabricScoped::Type valueBuf[4];
    Clusters::Test::Attributes::ListFabricScoped::TypeInfo::Type value;
    ...
    chip::Controller::WriteAttribute<Clusters::Test::Attributes::ListFabricScoped::TypeInfo>(sessionHandle, kTestEndpointId, value,
...
void TestWriteInteraction::TestMultipleSuccessResponses(nlTestSuite * apSuite, void * apContext)
{
    ...
    chip::Controller::WriteAttribute<Clusters::Test::Attributes::Boolean::TypeInfo>(sessionHandle, kTestEndpointId, true,
                                                                                    onSuccessCb, onFailureCb);
