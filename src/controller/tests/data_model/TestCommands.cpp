                                  ...
                                  CommandHandler * apCommandObj)
{
    ...
    if (aCommandPath.mClusterId == Clusters::Test::Id &&
        aCommandPath.mCommandId == Clusters::Test::Commands::TestSimpleArgumentRequest::Type::GetCommandId())
    {
        Clusters::Test::Commands::TestSimpleArgumentRequest::DecodableType dataRequest;
...
{
    TestContext & ctx = *static_cast<TestContext *>(apContext);
    Clusters::Test::Commands::TestSimpleArgumentRequest::Type request;
    auto sessionHandle = ctx.GetSessionBobToAlice();
