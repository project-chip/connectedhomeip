...
<<<<<<< HEAD:src/controller/CommandSenderAllocator.h
using CommandSenderHandle = std::unique_ptr<app::CommandSender, CommandSenderPlatformDeleter>;
=======
// DiagnosticLogs Cluster Commands
CHIP_ERROR DiagnosticLogsCluster::RetrieveLogsResponse(Callback::Cancelable * onSuccessCallback,
                                                       ...
                                                       chip::ByteSpan content, uint32_t timeStamp, uint32_t timeSinceBoot)
{
    ...
    app::CommandPathParams cmdParams = { mEndpoint, /* group id */ 0, mClusterId,
                                         DiagnosticLogs::Commands::RetrieveLogsResponse::Id,
    ...
    // content: octetString
    SuccessOrExit(err = writer->Put(TLV::ContextTag(argSeqNumber++), content));
    // timeStamp: epochS
    SuccessOrExit(err = writer->Put(TLV::ContextTag(argSeqNumber++), timeStamp));
    // timeSinceBoot: int32u
    SuccessOrExit(err = writer->Put(TLV::ContextTag(argSeqNumber++), timeSinceBoot));
...
>>>>>>> - Adding changes to the zap templates such that the incoming and outgoing commands are generated with determinism. Using the upto date helpers in the *.zapt templates:zzz_generated/log-source-app/zap-generated/CHIPClusters.cpp
