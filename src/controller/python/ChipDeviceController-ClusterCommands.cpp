                                                                 ...
                                                                 uint32_t fabricSecret_Len, uint64_t breadcrumb, uint32_t timeoutMs)
{
    ...
    (void) ZCLgroupId;
    clusterGeneralCommissioning.Associate(device, ZCLendpointId);
    return clusterGeneralCommissioning.SetFabric(nullptr, nullptr, chip::BytesData(fabricId, fabricId_Len),
                                                 chip::BytesData(fabricSecret, fabricSecret_Len), breadcrumb, timeoutMs);
}
                                                                        ...
                                                                        uint32_t timeoutMs)
{
    ...
    return clusterNetworkCommissioning.AddThreadNetwork(
        nullptr, nullptr, chip::BytesData(operationalDataset, operationalDataset_Len), breadcrumb, timeoutMs);
}
                                                                      ...
                                                                      uint64_t breadcrumb, uint32_t timeoutMs)
{
    ...
    (void) ZCLgroupId;
    clusterNetworkCommissioning.Associate(device, ZCLendpointId);
    return clusterNetworkCommissioning.AddWiFiNetwork(nullptr, nullptr, chip::BytesData(ssid, ssid_Len),
                                                      chip::BytesData(credentials, credentials_Len), breadcrumb, timeoutMs);
}
                                                                      ...
                                                                      uint64_t breadcrumb, uint32_t timeoutMs)
{
    ...
    (void) ZCLgroupId;
    clusterNetworkCommissioning.Associate(device, ZCLendpointId);
    return clusterNetworkCommissioning.DisableNetwork(nullptr, nullptr, chip::BytesData(networkID, networkID_Len), breadcrumb,
                                                      timeoutMs);
}
                                                                     ...
                                                                     uint64_t breadcrumb, uint32_t timeoutMs)
{
    ...
    (void) ZCLgroupId;
    clusterNetworkCommissioning.Associate(device, ZCLendpointId);
    return clusterNetworkCommissioning.EnableNetwork(nullptr, nullptr, chip::BytesData(networkID, networkID_Len), breadcrumb,
                                                     timeoutMs);
}
                                                                     ...
                                                                     uint64_t breadcrumb, uint32_t timeoutMs)
{
    ...
    (void) ZCLgroupId;
    clusterNetworkCommissioning.Associate(device, ZCLendpointId);
    return clusterNetworkCommissioning.RemoveNetwork(nullptr, nullptr, chip::BytesData(networkID, networkID_Len), breadcrumb,
                                                     timeoutMs);
}
                                                                    ...
                                                                    uint32_t timeoutMs)
{
    ...
    (void) ZCLgroupId;
    clusterNetworkCommissioning.Associate(device, ZCLendpointId);
    return clusterNetworkCommissioning.ScanNetworks(nullptr, nullptr, chip::BytesData(ssid, ssid_Len), breadcrumb, timeoutMs);
}
                                                                         ...
                                                                         uint64_t breadcrumb, uint32_t timeoutMs)
{
    ...
    (void) ZCLgroupId;
    clusterNetworkCommissioning.Associate(device, ZCLendpointId);
    return clusterNetworkCommissioning.UpdateWiFiNetwork(nullptr, nullptr, chip::BytesData(ssid, ssid_Len),
                                                         chip::BytesData(credentials, credentials_Len), breadcrumb, timeoutMs);
}
