...
{
    if (gPyOnAnswerCallback == nullptr)
        return CHIP_ERROR_INCORRECT_STATE;
...
{
    if (gPyOnICECandidatesCallback == nullptr)
        return CHIP_ERROR_INCORRECT_STATE;
                                                   ...
                                                   PyOnICECandidatesCallback onICECandidates, PyOnEndCallback onEnd)
{
    ...
    WebRTCTransportRequestorManager::Instance().InitCallbacks(WrapperOnOffer, WrapperOnAnswer, WrapperOnICECandidates,
                                                              WrapperOnEnd);
}
