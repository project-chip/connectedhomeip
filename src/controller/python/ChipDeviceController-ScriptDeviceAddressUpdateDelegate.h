...
<<<<<<< HEAD:src/controller/python/ChipDeviceController-ScriptDeviceAddressUpdateDelegate.h
...
>>>>>>> - Adding changes to the zap templates such that the incoming and outgoing commands are generated with determinism. Using the upto date helpers in the *.zapt templates:zzz_generated/pump-app/zap-generated/CHIPClusters.cpp
