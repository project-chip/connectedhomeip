...
#define emberAfFillCommandTV ChannelClusterChangeChannel( \
  match, \
  ChannelMatch, ChannelMatchLen, \
  ErrorType \
) \
  emberAfFillExternalBuffer( \
    mask, \
     \
    ZCL_CHANGE_CHANNEL_COMMAND_ID, \
    "ubu", \
    match, \
    ChannelMatch, ChannelMatchLen, \
    ErrorType \
...
#define emberAfFillCommandTV ChannelClusterChangeChannelByNumber( \
  ...
  emberAfFillExternalBuffer( \
    mask, \
     \
    ZCL_CHANGE_CHANNEL_BY_NUMBER_COMMAND_ID, \
    "uu", \
    majorNumber, \
    minorNumber \
  );
...
#define emberAfFillCommandTarget NavigatorClusterNavigateTarget( \
  ...
  emberAfFillExternalBuffer( \
    mask, \
     \
    ZCL_NAVIGATE_TARGET_COMMAND_ID, \
    "uuuu", \
    target, \
    status, \
    data, \
 ...
 */
#define emberAfFillCommandMedia PlaybackClusterMediaPlay( \
  mediaPlaybackStatus \
) \
  emberAfFillExternalBuffer( \
    mask, \
 ...
 * @param mediaPlaybackStatus MediaPlaybackStatus 
 */
#define emberAfFillCommandMedia PlaybackClusterMediaPause( \
  mediaPlaybackStatus \
) \
  emberAfFillExternalBuffer( \
    mask, \
 ...
 * @param mediaPlaybackStatus MediaPlaybackStatus 
 */
#define emberAfFillCommandMedia PlaybackClusterMediaStop( \
  mediaPlaybackStatus \
) \
  emberAfFillExternalBuffer( \
    mask, \
 ...
 * @param mediaPlaybackStatus MediaPlaybackStatus 
 */
#define emberAfFillCommandMedia PlaybackClusterMediaStartOver( \
  mediaPlaybackStatus \
) \
  emberAfFillExternalBuffer( \
    mask, \
 ...
 * @param mediaPlaybackStatus MediaPlaybackStatus 
 */
#define emberAfFillCommandMedia PlaybackClusterMediaPrevious( \
  mediaPlaybackStatus \
) \
  emberAfFillExternalBuffer( \
    mask, \
 ...
 * @param mediaPlaybackStatus MediaPlaybackStatus 
 */
#define emberAfFillCommandMedia PlaybackClusterMediaNext( \
  mediaPlaybackStatus \
) \
  emberAfFillExternalBuffer( \
    mask, \
 ...
 * @param mediaPlaybackStatus MediaPlaybackStatus 
 */
#define emberAfFillCommandMedia PlaybackClusterMediaFastForward( \
  mediaPlaybackStatus \
) \
  emberAfFillExternalBuffer( \
    mask, \
 ...
 * @param mediaPlaybackStatus MediaPlaybackStatus 
 */
#define emberAfFillCommandMedia PlaybackClusterMediaSkipForward( \
 ...
 * @param mediaPlaybackStatus MediaPlaybackStatus 
 */
#define emberAfFillCommandMedia PlaybackClusterMediaSkipBackward( \
  deltaPositionMilliseconds, \
  mediaPlaybackStatus \
) \
  emberAfFillExternalBuffer( \
    mask, \
     \
    ZCL_MEDIA_SKIP_BACKWARD_COMMAND_ID, \
    "uu", \
    deltaPositionMilliseconds, \
    mediaPlaybackStatus \
  );
 ...
 * @param mediaPlaybackStatus MediaPlaybackStatus 
 */
#define emberAfFillCommandMedia PlaybackClusterMediaSkipSeek( \
  position, \
  mediaPlaybackStatus \
) \
  emberAfFillExternalBuffer( \
    mask, \
     \
    ZCL_MEDIA_SKIP_SEEK_COMMAND_ID, \
    "uu", \
    position, \
    mediaPlaybackStatus \
  );
 ...
 */
#define emberAfFillCommandMedia InputClusterShowInputStatus( \
) \
  emberAfFillExternalBuffer( \
    mask, \
     \
 ...
 */
#define emberAfFillCommandMedia InputClusterHideInputStatus( \
) \
  emberAfFillExternalBuffer( \
    mask, \
     \
