...
#define emberAfFillCommandOTA Software Update ServerClusterQueryImage( \
  ...
  hardwareVersion, \
  currentVersion, \
  protocolsSupported, protocolsSupportedLen, \
  location, \
  clientCanConsent, \
  metadataForServer \
) \
...
#define emberAfFillCommandOTA Software Update ServerClusterApplyUpdateRequest( \
  ...
  emberAfFillExternalBuffer( \
    mask, \
     \
    ZCL_APPLY_UPDATE_REQUEST_COMMAND_ID, \
    "uu", \
    updateToken, \
    newVersion \
  );
...
#define emberAfFillCommandOTA Software Update ServerClusterNotifyUpdateApplied( \
  ...
  emberAfFillExternalBuffer( \
    mask, \
     \
    ZCL_NOTIFY_UPDATE_APPLIED_COMMAND_ID, \
    "uu", \
    updateToken, \
    currentVersion \
  );
...
#define emberAfFillCommandOTA Software Update ServerClusterQueryImageResponse( \
  ...
  emberAfFillExternalBuffer( \
    mask, \
     \
    ZCL_QUERY_IMAGE_RESPONSE_COMMAND_ID, \
    "uuuuuuu", \
    status, \
    delayedActionTime, \
    imageURI, \
...
#define emberAfFillCommandOTA Software Update ServerClusterApplyUpdateRequestResponse( \
  ...
  emberAfFillExternalBuffer( \
    mask, \
     \
    ZCL_APPLY_UPDATE_REQUEST_RESPONSE_COMMAND_ID, \
    "uu", \
    action, \
    delayedActionTime \
  );
...
#define emberAfFillCommandOTA Software Update ClientClusterAnnounceOtaServer( \
  ...
  emberAfFillExternalBuffer( \
    mask, \
     \
    ZCL_ANNOUNCE_OTA_SERVER_COMMAND_ID, \
    "uuuu", \
    serverLocation, \
    vendorId, \
    announcementReason, \
 ...
 * Command: GetFabricId
 */
#define emberAfFillCommandOperational CredentialsClusterGetFabricId( \
) \
  emberAfFillExternalBuffer( \
    mask, \
     \
 ...
 */
#define emberAfFillCommandOperational CredentialsClusterGetFabricIdResponse( \
  FabricId \
) \
  emberAfFillExternalBuffer( \
    mask, \
     \
    ZCL_GET_FABRIC_ID_RESPONSE_COMMAND_ID, \
    "u", \
    FabricId \
  );
 ...
 */
#define emberAfFillCommandOperational CredentialsClusterUpdateFabricLabel( \
  Label \
) \
  emberAfFillExternalBuffer( \
    mask, \
 ...
 * @param VendorId INT16U 
 */
#define emberAfFillCommandOperational CredentialsClusterRemoveFabric( \
  FabricId, \
  NodeId, \
  VendorId \
) \
