...
#define ZCL_PAN_ID_ATTRIBUTE_ID (0x0003)
#define ZCL_EXTENDED_PAN_ID_ATTRIBUTE_ID (0x0004)
#define ZCL_MESH_LOCAL_PREFIX_ATTRIBUTE_ID (0x0005)
#define ZCL_OVERRUN_COUNT_ATTRIBUTE_ID (0x0006)
...
#define ZCL_CHANNEL_MASK_ATTRIBUTE_ID (0x003C)
#define ZCL_OPERATIONAL_DATASET_COMPONENTS_ATTRIBUTE_ID (0x003D)
#define ZCL_ACTIVE_NETWORK_FAULTS_ATTRIBUTE_ID (0x003E)
