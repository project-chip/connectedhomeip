...
/**
 * @brief Version of a CommissionableDataProvider that can be used for Python
 *        use-cases scalably going forward.
 */
...
public:
    ...
    {
        //
        // We do not let folks set the passcode without also re-generating the Spake2 verifier.
