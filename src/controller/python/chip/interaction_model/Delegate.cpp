...
void PythonInteractionModelDelegate::OnResponse(const app::ReadClient * apReadClient, const app::ConcreteAttributePath & aPath,
                                                TLV::TLVReader * apData, const app::StatusIB & status)
{
    ...
    DeviceControllerInteractionModelDelegate::OnResponse(apReadClient, aPath, apData, status);
}
