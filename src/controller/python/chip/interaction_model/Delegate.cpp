                                                               ...
                                                               uint8_t aCommandIndex)
{
    if (onWriteResponseFunct != nullptr)
    {
        AttributeWriteStatus status{
            apWriteClient->GetSourceNodeId(), apWriteClient->GetAppIdentifier(), aClusterStatus,
    ...
    DeviceControllerInteractionModelDelegate::WriteResponseStatus(apWriteClient, aGeneralCode, aClusterStatus, aAttributePathParams,
                                                                  aCommandIndex);
