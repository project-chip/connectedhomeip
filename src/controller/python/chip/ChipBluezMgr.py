...
from .ChipBleUtility import VoidPtrToUUIDString
...
class BluezManager(ChipBleBase):
    ...
    def scan_bg_implementation(self, **kwargs):
        ...
        while time.time() < timeout:
            self.peripheral_list = self.adapter.find_devices([chip_service, chip_service_short, chromecast_setup_service, chromecast_setup_service_short])
    ...
    def chipServieCharConnect(self):
        gatt_dic={'services': [chip_service, chip_service_short], 'chars': [chip_tx, chip_rx]}
