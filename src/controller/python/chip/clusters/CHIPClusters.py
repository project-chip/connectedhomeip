...
class ChipClusters:
    ...
    def InitLib(self, chipLib):
        ...
        self._chipLib.chip_ime_WriteAttribute_PumpConfigurationAndControl_LifetimeRunningHours.argtypes = [ctypes.c_void_p, ctypes.c_uint8, ctypes.c_uint16, ctypes.c_uint32]
        ...
        self._chipLib.chip_ime_WriteAttribute_PumpConfigurationAndControl_Power.argtypes = [ctypes.c_void_p, ctypes.c_uint8, ctypes.c_uint16, ctypes.c_uint32]
