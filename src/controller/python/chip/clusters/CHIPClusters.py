...
class ChipClusters:
    ...
    _MODE_SELECT_CLUSTER_CLUSTER_INFO = {
        "clusterName": "ModeSelectCluster",
    ...
    _CLUSTER_ID_DICT = {
        ...
        0x00000050: _MODE_SELECT_CLUSTER_CLUSTER_INFO,
    ...
    _CLUSTER_NAME_DICT = {
        ...
        "ModeSelectCluster": _MODE_SELECT_CLUSTER_CLUSTER_INFO,
    ...
    def ClusterModeSelectCluster_CommandChangeToMode(self, device: ctypes.c_void_p, ZCLendpoint: int, ZCLgroupid: int, newMode: int):
        return self._chipLib.chip_ime_AppendCommand_ModeSelectCluster_ChangeToMode(
    ...
    def ClusterModeSelectCluster_ReadAttributeCurrentMode(self, device: ctypes.c_void_p, ZCLendpoint: int, ZCLgroupid: int):
        return self._chipLib.chip_ime_ReadAttribute_ModeSelectCluster_CurrentMode(device, ZCLendpoint, ZCLgroupid)

    def ClusterModeSelectCluster_SubscribeAttributeCurrentMode(self, device: ctypes.c_void_p, ZCLendpoint: int, minInterval: int, maxInterval: int):
        return self._chipLib.chip_ime_SubscribeAttribute_ModeSelectCluster_CurrentMode(device, ZCLendpoint, minInterval, maxInterval)

    def ClusterModeSelectCluster_ReadAttributeSupportedModes(self, device: ctypes.c_void_p, ZCLendpoint: int, ZCLgroupid: int):
        return self._chipLib.chip_ime_ReadAttribute_ModeSelectCluster_SupportedModes(device, ZCLendpoint, ZCLgroupid)

    def ClusterModeSelectCluster_ReadAttributeOnMode(self, device: ctypes.c_void_p, ZCLendpoint: int, ZCLgroupid: int):
        return self._chipLib.chip_ime_ReadAttribute_ModeSelectCluster_OnMode(device, ZCLendpoint, ZCLgroupid)

    def ClusterModeSelectCluster_WriteAttributeOnMode(self, device: ctypes.c_void_p, ZCLendpoint: int, ZCLgroupid: int, value: int):
        return self._chipLib.chip_ime_WriteAttribute_ModeSelectCluster_OnMode(device, ZCLendpoint, ZCLgroupid, value)

    def ClusterModeSelectCluster_ReadAttributeStartUpMode(self, device: ctypes.c_void_p, ZCLendpoint: int, ZCLgroupid: int):
        return self._chipLib.chip_ime_ReadAttribute_ModeSelectCluster_StartUpMode(device, ZCLendpoint, ZCLgroupid)

    def ClusterModeSelectCluster_ReadAttributeDescription(self, device: ctypes.c_void_p, ZCLendpoint: int, ZCLgroupid: int):
        return self._chipLib.chip_ime_ReadAttribute_ModeSelectCluster_Description(device, ZCLendpoint, ZCLgroupid)

    def ClusterModeSelectCluster_ReadAttributeClusterRevision(self, device: ctypes.c_void_p, ZCLendpoint: int, ZCLgroupid: int):
        return self._chipLib.chip_ime_ReadAttribute_ModeSelectCluster_ClusterRevision(device, ZCLendpoint, ZCLgroupid)
    ...
    def InitLib(self, chipLib):
        ...
        # Cluster ModeSelectCluster Command ChangeToMode
        self._chipLib.chip_ime_AppendCommand_ModeSelectCluster_ChangeToMode.argtypes = [
            ctypes.c_void_p, ctypes.c_uint8, ctypes.c_uint16, ctypes.c_uint8]
        self._chipLib.chip_ime_AppendCommand_ModeSelectCluster_ChangeToMode.restype = ctypes.c_uint32
        # Cluster ModeSelectCluster ReadAttribute CurrentMode
        self._chipLib.chip_ime_ReadAttribute_ModeSelectCluster_CurrentMode.argtypes = [
            ctypes.c_void_p, ctypes.c_uint8, ctypes.c_uint16]
        self._chipLib.chip_ime_ReadAttribute_ModeSelectCluster_CurrentMode.restype = ctypes.c_uint32
        # Cluster ModeSelectCluster SubscribeAttribute CurrentMode
        self._chipLib.chip_ime_SubscribeAttribute_ModeSelectCluster_CurrentMode.argtypes = [
            ctypes.c_void_p, ctypes.c_uint8, ctypes.c_uint16, ctypes.c_uint16]
        self._chipLib.chip_ime_SubscribeAttribute_ModeSelectCluster_CurrentMode.restype = ctypes.c_uint32
        # Cluster ModeSelectCluster ReadAttribute SupportedModes
        self._chipLib.chip_ime_ReadAttribute_ModeSelectCluster_SupportedModes.argtypes = [
            ctypes.c_void_p, ctypes.c_uint8, ctypes.c_uint16]
        self._chipLib.chip_ime_ReadAttribute_ModeSelectCluster_SupportedModes.restype = ctypes.c_uint32
        # Cluster ModeSelectCluster ReadAttribute OnMode
        self._chipLib.chip_ime_ReadAttribute_ModeSelectCluster_OnMode.argtypes = [
            ctypes.c_void_p, ctypes.c_uint8, ctypes.c_uint16]
        self._chipLib.chip_ime_ReadAttribute_ModeSelectCluster_OnMode.restype = ctypes.c_uint32
        # Cluster ModeSelectCluster WriteAttribute OnMode
        self._chipLib.chip_ime_WriteAttribute_ModeSelectCluster_OnMode.argtypes = [
            ctypes.c_void_p, ctypes.c_uint8, ctypes.c_uint16, ctypes.c_uint8]
        self._chipLib.chip_ime_WriteAttribute_ModeSelectCluster_OnMode.restype = ctypes.c_uint32
        # Cluster ModeSelectCluster ReadAttribute StartUpMode
        self._chipLib.chip_ime_ReadAttribute_ModeSelectCluster_StartUpMode.argtypes = [
            ctypes.c_void_p, ctypes.c_uint8, ctypes.c_uint16]
        self._chipLib.chip_ime_ReadAttribute_ModeSelectCluster_StartUpMode.restype = ctypes.c_uint32
        # Cluster ModeSelectCluster ReadAttribute Description
        self._chipLib.chip_ime_ReadAttribute_ModeSelectCluster_Description.argtypes = [
            ctypes.c_void_p, ctypes.c_uint8, ctypes.c_uint16]
        self._chipLib.chip_ime_ReadAttribute_ModeSelectCluster_Description.restype = ctypes.c_uint32
        # Cluster ModeSelectCluster ReadAttribute ClusterRevision
        self._chipLib.chip_ime_ReadAttribute_ModeSelectCluster_ClusterRevision.argtypes = [
            ctypes.c_void_p, ctypes.c_uint8, ctypes.c_uint16]
        self._chipLib.chip_ime_ReadAttribute_ModeSelectCluster_ClusterRevision.restype = ctypes.c_uint32
        ...
        self._chipLib.chip_ime_WriteAttribute_PumpConfigurationAndControl_ControlMode.argtypes = [
            ctypes.c_void_p, ctypes.c_uint8, ctypes.c_uint16, ctypes.c_uint8]
        ...
        self._chipLib.chip_ime_AppendCommand_TestCluster_TestEnumsRequest.argtypes = [
            ctypes.c_void_p, ctypes.c_uint8, ctypes.c_uint16, ctypes.c_uint16, ctypes.c_uint8]
