...
class ChipClusters:
    ...
    _OTA_SOFTWARE_UPDATE_REQUESTOR_CLUSTER_CLUSTER_INFO = {
    ...
    0x0000002A: _OTA_SOFTWARE_UPDATE_REQUESTOR_CLUSTER_CLUSTER_INFO,
    ...
    _CLUSTER_NAME_DICT = {
        ...
        "OtaSoftwareUpdateRequestor": _OTA_SOFTWARE_UPDATE_REQUESTOR_CLUSTER_CLUSTER_INFO,
