...
class ChipClusters:
    ...
    def InitLib(self, chipLib):
        ...
        self._chipLib.chip_ime_ReadAttribute_AccessControl_Acl.argtypes = [
        ...
        self._chipLib.chip_ime_ReadAttribute_AccessControl_Extension.argtypes = [
            ctypes.c_void_p, ctypes.c_uint8, ctypes.c_uint16]
        ...
        self._chipLib.chip_ime_ReadAttribute_AccessControl_ClusterRevision.argtypes = [
            ctypes.c_void_p, ctypes.c_uint8, ctypes.c_uint16]
