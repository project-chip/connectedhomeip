...
class AttributeCache:
    ''' A cache that stores data & errors returned in read/subscribe reports, but organizes it topologically
        ...
        cluster objects.
            ...
            E.g Clusters.Test is the literal key for indexing the test cluster.
                Clusters.Test.Attributes.Int16u is the listeral key for indexing an attribute in the test cluster.
