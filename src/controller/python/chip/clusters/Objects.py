    ...
    class Commands:
        ...
        class GetGroupMembership(ClusterCommand):
            ...
            def descriptor(cls) -> ClusterObjectDescriptor:
                return ClusterObjectDescriptor(
                    Fields = [
                            ClusterObjectFieldDescriptor(Label="groupList", Tag=0, Type=uint, IsArray=True),
                    ])
            ...
            def descriptor(cls) -> ClusterObjectDescriptor:
                return ClusterObjectDescriptor(
                    Fields = [
                            ...
                            ClusterObjectFieldDescriptor(Label="protocolsSupported", Tag=3, Type=OtaSoftwareUpdateProvider.Enums.OTADownloadProtocol, IsArray=True),
                            ClusterObjectFieldDescriptor(Label="hardwareVersion", Tag=4, Type=uint),
