                                                                                              ...
                                                                                              uint32_t attestationNonce_Len)
{
    ...
    cluster.Associate(device, ZCLendpointId);
    return chip::ChipError::AsInteger(
        cluster.AttestationRequest(nullptr, nullptr, chip::ByteSpan(attestationNonce, attestationNonce_Len)));
}
                                                                                            ...
                                                                                            chip::GroupId, uint16_t certChainType)
{
    ...
    chip::Controller::OperationalCredentialsCluster cluster;
    cluster.Associate(device, ZCLendpointId);
    return chip::ChipError::AsInteger(cluster.CertChainRequest(nullptr, nullptr, certChainType));
}
