...
chip::ChipError::StorageType
chip_ime_WriteAttribute_PumpConfigurationAndControl_LifetimeRunningHours(chip::DeviceProxy * device, chip::EndpointId ZCLendpointId,
...
chip::ChipError::StorageType chip_ime_WriteAttribute_PumpConfigurationAndControl_Power(chip::DeviceProxy * device,
                                                                                       chip::EndpointId ZCLendpointId,
                                                                                       chip::GroupId, uint32_t value)
{
    VerifyOrReturnError(device != nullptr, CHIP_ERROR_INVALID_ARGUMENT.AsInteger());
