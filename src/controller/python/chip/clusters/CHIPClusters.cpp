...
static void OnBridgedActionsActionListListAttributeResponse(
    void * context,
    const DataModel::DecodableList<chip::app::Clusters::BridgedActions::Structs::ActionStruct::DecodableType> & list)
{
    uint16_t count = 0;
    auto iter      = list.begin();
    while (iter.Next())
...
static void OnBridgedActionsEndpointListListAttributeResponse(
    void * context,
    const DataModel::DecodableList<chip::app::Clusters::BridgedActions::Structs::EndpointListStruct::DecodableType> & list)
{
    uint16_t count = 0;
    auto iter      = list.begin();
    while (iter.Next())
