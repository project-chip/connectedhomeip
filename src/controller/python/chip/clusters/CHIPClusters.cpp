...
CHIP_ERROR chip_ime_AppendCommand_Fabric_GetFabricId(chip::Controller::Device * device, chip::EndpointId ZCLendpointId,
                                                     chip::GroupId)
{
    VerifyOrReturnError(device != nullptr, CHIP_ERROR_INVALID_ARGUMENT);
...
CHIP_ERROR chip_ime_AppendCommand_Fabric_RemoveFabric(chip::Controller::Device * device, chip::EndpointId ZCLendpointId,
                                                      chip::GroupId, chip::FabricId fabricId, chip::NodeId nodeId,
                                                      uint16_t vendorId)
{
    VerifyOrReturnError(device != nullptr, CHIP_ERROR_INVALID_ARGUMENT);
    chip::Controller::FabricCluster cluster;
...
CHIP_ERROR chip_ime_AppendCommand_Fabric_UpdateFabricLabel(chip::Controller::Device * device, chip::EndpointId ZCLendpointId,
                                                           chip::GroupId, const uint8_t * fabricLabel, uint32_t fabricLabel_Len)
{
    VerifyOrReturnError(device != nullptr, CHIP_ERROR_INVALID_ARGUMENT);
    chip::Controller::FabricCluster cluster;
    cluster.Associate(device, ZCLendpointId);
    return cluster.UpdateFabricLabel(gDefaultSuccessCallback.Cancel(), gDefaultFailureCallback.Cancel(),
                                     chip::ByteSpan(fabricLabel, fabricLabel_Len));
}

CHIP_ERROR chip_ime_ReadAttribute_Fabric_ClusterRevision(chip::Controller::Device * device, chip::EndpointId ZCLendpointId,
                                                         chip::GroupId /* ZCLgroupId */)
{
    VerifyOrReturnError(device != nullptr, CHIP_ERROR_INVALID_ARGUMENT);
    chip::Controller::FabricCluster cluster;
