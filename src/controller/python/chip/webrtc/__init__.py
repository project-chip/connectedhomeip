...
lib.pychip_webrtc_client_set_local_description_callback.argtypes = [WebRTCClientHandle, LocalDescriptionCallbackType, c_void_p]
...
class WebRTCClient:
    ...
    def create_peer_connection(self, stun_url):
        return lib.pychip_webrtc_client_create_peer_connection(self._handle, stun_url.encode('utf-8'))

    def create_offer(self):
        lib.pychip_webrtc_client_create_offer(self._handle)

    def create_answer(self):
        lib.pychip_webrtc_client_create_answer(self._handle)

    def set_remote_description(self, sdp, type_):
        lib.pychip_webrtc_client_set_remote_description(self._handle, sdp.encode('utf-8'), type_.encode('utf-8'))

    def add_ice_candidate(self, candidate, mid):
        lib.pychip_webrtc_client_add_ice_candidate(self._handle, candidate.encode('utf-8'), mid.encode('utf-8'))
    ...
    def on_local_description(self, callback):
        ...
        lib.pychip_webrtc_client_set_local_description_callback(self._handle, self._local_desc_cb, None)
    ...
    def on_ice_candidate(self, callback):
        ...
        lib.pychip_webrtc_client_set_ice_candidate_callback(self._handle, self._ice_cand_cb, None)
