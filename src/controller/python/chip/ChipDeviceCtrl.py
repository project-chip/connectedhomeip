...
<<<<<<< HEAD:src/controller/python/chip/ChipDeviceCtrl.py
...
>>>>>>> c25bcb19fd (controller: python: Clean up obsolete subscriptions on keepSubscriptions=False (#72904)):src/controller/python/matter/ChipDeviceCtrl.py
