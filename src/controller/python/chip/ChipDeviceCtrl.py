...
class ChipDeviceController(ChipDeviceControllerBase):
    ...
    def CommissionOnNetwork(self, nodeId: int, setupPinCode: int, filterType: DiscoveryFilterType = DiscoveryFilterType.NONE, filter: typing.Any = None) -> PyChipError:
        '''
