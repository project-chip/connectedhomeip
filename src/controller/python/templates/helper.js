...
function asPythonType(zclType)
{
  ...
  case 'bool':
    return 'bool'
    case 'int8_t': case 'int16_t': case 'int32_t': case 'int64_t': case 'uint8_t': case 'uint16_t': case 'uint32_t': case 'uint64_t': return 'int'
    case 'char *': return 'str'
    case 'uint8_t *': case 'chip::ByteSpan': return 'bytes'
  }
}
...
function asPythonCType(zclType)
{
  ...
  case 'uint64_t':
    ...
    case 'char *': case 'uint8_t *': return 'c_char_p'
  }
}
