...
class BaseTestHelper:
    ...
    async def TestCaseEviction(self, nodeid: int):
        ...
        def OnValueChange(path: Attribute.TypedAttributePath, transaction: Attribute.SubscriptionTransaction) -> None:
            ...
            if (path.AttributeType == Clusters.Test.Attributes.Int8u and path.Path.EndpointId == 1):
                sawValueChange = True

        self.logger.info("Testing CASE defunct logic")

        sub = await self.devCtrl.ReadAttribute(nodeid, [(Clusters.Test.Attributes.Int8u)], reportInterval=(0, 1))
        ...
        # was received.
        #
        await self.devCtrl2.WriteAttribute(nodeid, [(1, Clusters.Test.Attributes.Int8u(4))])
        time.sleep(2)
        ...
        sawValueChange = False
        sub = await self.devCtrl2.ReadAttribute(nodeid, [(Clusters.Test.Attributes.Int8u)], reportInterval=(0, 1))
        sub.SetAttributeUpdateCallback(OnValueChange)
        ...
        await self.devCtrl.WriteAttribute(nodeid, [(1, Clusters.Test.Attributes.Int8u(4))])
        time.sleep(2)
    ...
    async def TestFabricSensitive(self, nodeid: int):
        expectedDataFabric1 = [
            Clusters.Test.Structs.TestFabricScoped(),
            Clusters.Test.Structs.TestFabricScoped()
        ]
        ...
        await self.devCtrl.WriteAttribute(nodeid, [(1, Clusters.Test.Attributes.ListFabricScoped(expectedDataFabric1))])
        ...
        await self.devCtrl2.WriteAttribute(nodeid, [(1, Clusters.Test.Attributes.ListFabricScoped(expectedDataFabric2))])
        ...
        data = await self.devCtrl.ReadAttribute(nodeid, [(1, Clusters.Test.Attributes.ListFabricScoped)])
        readListDataFabric1 = data[1][Clusters.Test][Clusters.Test.Attributes.ListFabricScoped]
        ...
        data = await self.devCtrl2.ReadAttribute(nodeid, [(1, Clusters.Test.Attributes.ListFabricScoped)])
        readListDataFabric2 = data[1][Clusters.Test][Clusters.Test.Attributes.ListFabricScoped]
        ...
        def CompareUnfilteredData(accessingFabric, otherFabric, expectedData):
            ...
            for item in readListDataFabric:
                if (item.fabricIndex == accessingFabric):
                    ...
                    #
                    expectedDefaultData = Clusters.Test.Structs.TestFabricScoped()
                    expectedDefaultData.fabricIndex = otherFabric

                    if (item != expectedDefaultData):
                        raise AssertionError("Got back mismatched data")

        data = await self.devCtrl.ReadAttribute(nodeid, [(1, Clusters.Test.Attributes.ListFabricScoped)], fabricFiltered=False)
        readListDataFabric = data[1][Clusters.Test][Clusters.Test.Attributes.ListFabricScoped]
        CompareUnfilteredData(self.currentFabric1,
                              self.currentFabric2, expectedDataFabric1)

        data = await self.devCtrl2.ReadAttribute(nodeid, [(1, Clusters.Test.Attributes.ListFabricScoped)], fabricFiltered=False)
        readListDataFabric = data[1][Clusters.Test][Clusters.Test.Attributes.ListFabricScoped]
