...
class ClusterObjectTests:
    ...
    async def SendReadRequest(cls, devCtrl):
        res = await devCtrl.ReadAttribute(nodeid=NODE_ID,
                                          attributes=[
                                              Clusters.Attribute.AttributeReadRequest(
                                                  EndpointId=0, Attribute=Clusters.Basic.Attributes.VendorName),
                                              Clusters.Attribute.AttributeReadRequest(
                                                  EndpointId=0, Attribute=Clusters.Basic.Attributes.VendorID),
                                              Clusters.Attribute.AttributeReadRequest(
                                                  EndpointId=0, Attribute=Clusters.Basic.Attributes.ProductName),
                                              Clusters.Attribute.AttributeReadRequest(
                                                  EndpointId=0, Attribute=Clusters.Basic.Attributes.ProductID),
                                              Clusters.Attribute.AttributeReadRequest(
                                                  EndpointId=0, Attribute=Clusters.Basic.Attributes.UserLabel),
                                              Clusters.Attribute.AttributeReadRequest(
                                                  EndpointId=0, Attribute=Clusters.Basic.Attributes.Location),
                                              Clusters.Attribute.AttributeReadRequest(
                                                  EndpointId=0, Attribute=Clusters.Basic.Attributes.HardwareVersion),
                                              Clusters.Attribute.AttributeReadRequest(
                                                  EndpointId=0, Attribute=Clusters.Basic.Attributes.HardwareVersionString),
                                              Clusters.Attribute.AttributeReadRequest(
                                                  EndpointId=0, Attribute=Clusters.Basic.Attributes.SoftwareVersion),
                                              Clusters.Attribute.AttributeReadRequest(
                                                  EndpointId=0, Attribute=Clusters.Basic.Attributes.SoftwareVersionString),
                                          ])
        expectedRes = [
