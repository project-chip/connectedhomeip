...
class ClusterObjectTests:
    ...
    async def TriggerAndWaitForEvents(cls, devCtrl, req):
        ...
        res = await devCtrl.SendCommand(nodeid=NODE_ID, endpoint=1, payload=Clusters.TestCluster.Commands.TestEmitTestNullableFabricScopedEventRequest(arg1=0))
        res = await devCtrl.SendCommand(nodeid=NODE_ID, endpoint=1, payload=Clusters.TestCluster.Commands.TestEmitTestNullableFabricScopedEventRequest(arg1=1))
