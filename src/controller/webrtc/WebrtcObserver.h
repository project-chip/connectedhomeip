...
class DummySetSessionDescriptionObserver
 ...
 public:
  ...
  DummySetSessionDescriptionObserver(int peer_id) {
    callback_id = peer_id;
  }
  virtual void OnSuccess() {
    RTC_LOG(LS_INFO) << "[LIBWEBRTC] SetSessionDescription success, client id: "
                  << callback_id;
  }
  virtual void OnFailure(webrtc::RTCError error) {
    RTC_LOG(LS_INFO) << "[LIBWEBRTC] SetSessionDescription failed, client id: "
                  << callback_id
                  << ", error details: " << ToString(error.type()) << ": "
                  << error.message();
  }
  int callback_id;
};
...
class WebrtcObserver : public webrtc::PeerConnectionObserver,
  ...
  public:
    ...
    void OnRenegotiationNeeded() override {
      RTC_LOG(LS_INFO)<<"[LIBWEBRTC] OnRenegotiationNeeded callback";
    };
