...
CHIP_ERROR DeviceControllerFactory::InitSystemState(FactoryInitParams params)
{
    ...
    stateParams.sessionMgr            = chip::Platform::New<SecureSessionMgr>();
    ...
    if (stateParams.imDelegate == nullptr)
    {
        stateParams.imDelegate = chip::Platform::New<DeviceControllerInteractionModelDelegate>();
    }
...
{
    controllerParams.mDeviceAddressUpdateDelegate   = params.deviceAddressUpdateDelegate;
