...
void DeviceControllerInteractionModelDelegate::OnResponse(const app::CommandSender * apCommandSender,
                                                          const app::CommandPath::Type & aPath,
                                                          const app::StatusElement::Type & aStatus, TLV::TLVReader & aData)
{
    ...
    else
    {
        IMDefaultResponseCallback(apCommandSender,
                                  (aStatus.protocolCode == to_underlying(Protocols::InteractionModel::ProtocolCode::Success) &&
                                   aStatus.generalCode == Protocols::SecureChannel::GeneralStatusCode::kSuccess)
                                      ? EMBER_ZCL_STATUS_SUCCESS
                                      : EMBER_ZCL_STATUS_FAILURE);
    }
}

void DeviceControllerInteractionModelDelegate::OnError(const app::CommandSender * apCommandSender, CHIP_ERROR aError)
{
...
app::CommandSender * DeviceControllerInteractionModelDelegate::NewCommandSender()
{
    return chip::Platform::New<app::CommandSender>(this);
}

void DeviceControllerInteractionModelDelegate::ReleaseCommandSender(app::CommandSender * apCommandSender)
{
