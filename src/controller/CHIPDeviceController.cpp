...
void DeviceControllerInteractionModelDelegate::OnResponse(const app::ReadClient * apReadClient,
...
void DeviceControllerInteractionModelDelegate::OnError(const app::ReadClient * apReadClient, CHIP_ERROR aError)
{
    ...
    IMReadReportAttributesResponseCallback(apReadClient, app::ConcreteAttributePath(0, 0, 0), nullptr,
