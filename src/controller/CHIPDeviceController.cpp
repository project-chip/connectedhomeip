                                                  ...
                                                  Optional<System::Clock::Timeout> timeout)
{
    ...
    case CommissioningStage::kWiFiNetworkEnable: {
        ...
        CHIP_ERROR err = CHIP_NO_ERROR;
        ChipLogProgress(Controller, "SendCommand kWiFiNetworkEnable, supportsConcurrentConnection=%s", params.GetSupportsConcurrentConnection().HasValue() ? (params.GetSupportsConcurrentConnection().Value() ? "true" : "false") : "missing");
