...
CHIP_ERROR GeneralCommissioningCluster::SetFabric(Callback::Cancelable * onSuccessCallback,
                                                  Callback::Cancelable * onFailureCallback, chip::BytesData fabricId,
                                                  chip::BytesData fabricSecret, uint64_t breadcrumb, uint32_t timeoutMs)
{
#ifdef CHIP_APP_USE_INTERACTION_MODEL
    VerifyOrReturnError(mDevice != nullptr, CHIP_ERROR_INCORRECT_STATE);
    (void) onCompletion;
...
CHIP_ERROR NetworkCommissioningCluster::AddThreadNetwork(Callback::Cancelable * onSuccessCallback,
                                                         Callback::Cancelable * onFailureCallback,
                                                         chip::BytesData operationalDataset, uint64_t breadcrumb,
                                                         uint32_t timeoutMs)
{
#ifdef CHIP_APP_USE_INTERACTION_MODEL
    VerifyOrReturnError(mDevice != nullptr, CHIP_ERROR_INCORRECT_STATE);
...
CHIP_ERROR NetworkCommissioningCluster::AddWiFiNetwork(Callback::Cancelable * onSuccessCallback,
                                                       Callback::Cancelable * onFailureCallback, chip::BytesData ssid,
                                                       chip::BytesData credentials, uint64_t breadcrumb, uint32_t timeoutMs)
{
#ifdef CHIP_APP_USE_INTERACTION_MODEL
    VerifyOrReturnError(mDevice != nullptr, CHIP_ERROR_INCORRECT_STATE);
    (void) onCompletion;
...
CHIP_ERROR NetworkCommissioningCluster::DisableNetwork(Callback::Cancelable * onSuccessCallback,
                                                       Callback::Cancelable * onFailureCallback, chip::BytesData networkID,
                                                       uint64_t breadcrumb, uint32_t timeoutMs)
{
#ifdef CHIP_APP_USE_INTERACTION_MODEL
    VerifyOrReturnError(mDevice != nullptr, CHIP_ERROR_INCORRECT_STATE);
