                                            ...
                                            chip::ByteSpan tempAccountIdentifier)
{
    ...
    ReturnErrorOnFailure(writer.PutString(TLV::ContextTag(argSeqNumber++), tempAccountIdentifier));
                                      ...
                                      chip::ByteSpan tempAccountIdentifier, chip::ByteSpan setupPIN)
{
    ...
    ReturnErrorOnFailure(writer.PutString(TLV::ContextTag(argSeqNumber++), tempAccountIdentifier));
    // setupPIN: charString
    ReturnErrorOnFailure(writer.PutString(TLV::ContextTag(argSeqNumber++), setupPIN));
