...
public:
    ...
    Optional<bool> GetNeedsNetworkSetup() const { return mNeedsNetworkSetup; }
    CommissioningParameters & SetNeedsNetworkSetup(bool needsNetworkSetup)
    {
        mNeedsNetworkSetup = MakeOptional(needsNetworkSetup);
        return *this;
    }
...
private:
    ...
    Optional<bool> mNeedsNetworkSetup;
