 ...
 *
 *  @brief
 *    A duration to be added to the backoff interval for sigma1 message retransmission in controller side if the remote device is LIT.
 *    This additional interval is to mitigate the issue that the sigma2 message may not be able to reach the controller in congested network in time.
 */
#ifndef CHIP_CONFIG_ADDITIONAL_LIT_BACKOFF_INTERVAL
#define CHIP_CONFIG_ADDITIONAL_LIT_BACKOFF_INTERVAL (0_ms)
