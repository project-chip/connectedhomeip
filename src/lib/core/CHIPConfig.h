 ...
 *
 *  @brief
 *    A duration to be added to the backoff interval for sigma1 message retransmission in controller side if the remote device is
...
#define CHIP_CONFIG_ADDITIONAL_LIT_BACKOFF_INTERVAL (0_ms32)
