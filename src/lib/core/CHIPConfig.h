...
/**
 * @def CHIP_CONFIG_CAMERA_MAX_ZONES
 *
 * @brief The maximum number of zones in the ZoneManagement cluster
 */
#ifndef CHIP_CONFIG_CAMERA_MAX_ZONES
#define CHIP_CONFIG_CAMERA_MAX_ZONES 10
#endif // CHIP_CONFIG_CAMERA_MAX_ZONES
