...
/**
 * @def CHIP_CONFIG_LIFETIIME_PERSISTED_COUNTER_INCREMENT
 *
 * @brief
 *   Lifetime Counter increment.
 */
#ifndef CHIP_CONFIG_LIFETIIME_PERSISTED_COUNTER_INCREMENT
#define CHIP_CONFIG_LIFETIIME_PERSISTED_COUNTER_INCREMENT 1
#endif
