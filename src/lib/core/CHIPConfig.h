...
/**
 * @def CHIP_CONFIG_MAX_NUM_OTA_REQUESTOR_EVENT_HANDLERS
 *
 * @brief The maximum number of event handlers for the OTA requestor cluster
 */
#ifndef CHIP_CONFIG_MAX_NUM_OTA_REQUESTOR_EVENT_HANDLERS
#define CHIP_CONFIG_MAX_NUM_OTA_REQUESTOR_EVENT_HANDLERS 1
#endif // CHIP_CONFIG_MAX_OTA_REQUESTOR_EVENT_HANDLERS
/**
 * @}
 */
