 ...
 *
 * @note Despite the `constexpr` keywords throughout the class, this class is not a literal type and thus cannot be used in compile-time contexts.
 * This is mainly because of the use of placement new.
 */
template <class T>
class Optional
{
