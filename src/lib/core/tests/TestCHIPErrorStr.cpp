...
static int32_t sContext[] =
{
    ...
    CHIP_ERROR_WDM_SCHEMA_MISMATCH,
    ...
    CHIP_ERROR_WDM_MALFORMED_DATA_ELEMENT,
    ...
    CHIP_ERROR_WDM_MALFORMED_STATUS_ELEMENT,
    CHIP_ERROR_WDM_SUBSCRIPTIONLESS_NOTIFY_PARTIAL,
    CHIP_ERROR_ACCESS_DENIED,
    CHIP_ERROR_UNKNOWN_RESOURCE_ID,
    CHIP_ERROR_WDM_MALFORMED_UPDATE_RESPONSE,
    CHIP_ERROR_WDM_VERSION_MISMATCH,
    CHIP_ERROR_WDM_POTENTIAL_DATA_LOSS,
    CHIP_ERROR_UNSUPPORTED_THREAD_NETWORK_CREATE,
    CHIP_ERROR_WDM_INCONSISTENT_CONDITIONALITY,
    CHIP_ERROR_WDM_LOCAL_DATA_INCONSISTENT,
    CHIP_ERROR_WDM_PATH_STORE_FULL,
    CHIP_EVENT_ID_FOUND
};
// clang-format on
