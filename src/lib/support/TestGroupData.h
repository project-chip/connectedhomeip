                           ...
                           const ByteSpan & compressed_fabric_id)
{
    ...
    const chip::Credentials::GroupDataProvider::GroupInfo group1(kGroup1, "Group #1", 0x01);
    ...
    const chip::Credentials::GroupDataProvider::GroupInfo group2(kGroup2, "Group #2", 0x01);
