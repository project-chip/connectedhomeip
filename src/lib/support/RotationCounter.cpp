...
RotationCounter::RotationCounter() : mId(chip::Platform::PersistedStorage::kEmptyKey), mEpoch(0), mNextEpoch(0) {}

RotationCounter::~RotationCounter() {}

CHIP_ERROR
RotationCounter::Init(const chip::Platform::PersistedStorage::Key aId, uint32_t aEpoch)
{
...
CHIP_ERROR
RotationCounter::PersistNextEpochStart(uint32_t aStartValue)
{
...
CHIP_ERROR
RotationCounter::ReadStartValue(uint32_t & aStartValue)
{
    CHIP_ERROR err = CHIP_NO_ERROR;
