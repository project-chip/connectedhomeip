...
const SamplePayload secure_channel_mrp_ack = {Protocol::Id(0, 0), 16, ByteSpan(payload_0_16)};
const SamplePayload secure_channel_pkbdf_param_request = {Protocol::Id(0, 0), 32, ByteSpan(payload_0_32)};
const SamplePayload secure_channel_pkbdf_param_response = {Protocol::Id(0, 0), 33, ByteSpan(payload_0_33)};
const SamplePayload secure_channel_pase_pake1 = {Protocol::Id(0, 0), 34, ByteSpan(payload_0_34)};
const SamplePayload secure_channel_pase_pake2 = {Protocol::Id(0, 0), 35, ByteSpan(payload_0_35)};
const SamplePayload secure_channel_pase_pake3 = {Protocol::Id(0, 0), 36, ByteSpan(payload_0_36)};
const SamplePayload secure_channel_status_report = {Protocol::Id(0, 0), 64, ByteSpan(payload_0_64)};

const SamplePayload im_protocol_read_request = {Protocol::Id(0, 1), 2, ByteSpan(payload_1_2)};
const SamplePayload im_protocol_report_data = {Protocol::Id(0, 1), 5, ByteSpan(payload_1_5)};
