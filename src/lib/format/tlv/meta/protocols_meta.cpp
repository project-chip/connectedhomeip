...
const Entry<ItemInfo> _SecureChannelProtocol_PBKDFParamResponse[] = {
    ...
    { { ContextTag(5), "responder_icd_params", ItemType::kDefault },
      kInvalidNodeIndex }, // SecureChannelProtocol::IDCParameterStruct
};
...
const Entry<ItemInfo> _UserDirectedCommissioningProtocol[] = {
    { { AttributeTag(0), "identification_declaration", ItemType::kDefault },
      53 }, // UserDirectedCommissioningProtocol::IdentificationDeclarationStruct
};
