...
oids = [
    ...
    ( "AttributeType",  "ChipCAId",                18,      [ iso(1), organization(3), dod(6), internet(1), private(4), enterprise(1), zigbee(37244), chip(1), 4 ] ),
    ( "AttributeType",  "ChipICAId",               19,      [ iso(1), organization(3), dod(6), internet(1), private(4), enterprise(1), zigbee(37244), chip(1), 3 ] ),
    ( "AttributeType",  "ChipFabricId",            20,      [ iso(1), organization(3), dod(6), internet(1), private(4), enterprise(1), zigbee(37244), chip(1), 5 ] ),
