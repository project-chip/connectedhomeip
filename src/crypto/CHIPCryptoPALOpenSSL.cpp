...
int PAL_Openssl::CryptoPAL_nidForCurve(ECName name)
{
    switch (name)
    {
    case ECName::P256v1:
...
void PAL_Openssl::CryptoPAL_logSSLError()
{
...
ECName PAL_Openssl::CryptoPAL_MapECName(SupportedECPKeyTypes keyType)
{
    switch (keyType)
    {
                                                        ...
                                                        const P256ECDSASignature & signature) const
{
    ...
    nid = CryptoPAL_nidForCurve(CryptoPAL_MapECName(Type()));
...
CHIP_ERROR PAL_Openssl::P256PublicKeyFromECKey(EC_KEY * ec_key, P256PublicKey & pubkey)
{
    ERR_clear_error();
    CHIP_ERROR error = CHIP_NO_ERROR;
