...
CHIP_ERROR Spake2p::BeginVerifier(const unsigned char * my_identity, size_t my_identity_len, const unsigned char * peer_identity,
...
CHIP_ERROR Spake2p::BeginProver(const unsigned char * my_identity, size_t my_identity_len, const unsigned char * peer_identity,
...
CHIP_ERROR Spake2p::ComputeRoundTwo(const unsigned char * in, size_t in_len, unsigned char * out, size_t * out_len)
{
    CHIP_ERROR error = CHIP_ERROR_INTERNAL;
...
{
    CHIP_ERROR error                               = CHIP_ERROR_INTERNAL;
    static const unsigned char info_keyconfirm[16] = { 'C', 'o', 'n', 'f', 'i', 'r', 'm', 'a',
                                                       't', 'i', 'o', 'n', 'K', 'e', 'y', 's' };
...
CHIP_ERROR Spake2p_P256_SHA256_HKDF_HMAC::KDF(const unsigned char * ikm, const size_t ikm_len, const unsigned char * salt,
                                              const size_t salt_len, const unsigned char * info, const size_t info_len,
