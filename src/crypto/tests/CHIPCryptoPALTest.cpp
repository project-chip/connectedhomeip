...
static void TestECDSA_Signing_SHA256(nlTestSuite * inSuite, void * inContext)
{
    ...
    uint8_t hex_private_key[] = { 0xc6, 0x1a, 0x2f, 0x89, 0x36, 0x67, 0x2b, 0x26, 0x12, 0x47, 0x4f,
    ...
    CHIP_ERROR signing_error = ECDSA_sign_msg((const uint8_t *) msg, msg_length, hex_private_key, sizeof(hex_private_key),
...
static void TestECDSA_ValidationInvalidParam(nlTestSuite * inSuite, void * inContext)
{
    ...
    validation_error = ECDSA_validate_msg_signature((const uint8_t *) msg, 0, hex_public_key, sizeof(hex_public_key),
                                                    signature, signature_length);
    NL_TEST_ASSERT(inSuite, validation_error == CHIP_ERROR_INVALID_ARGUMENT);
    validation_error = CHIP_NO_ERROR;
    ...
    validation_error = ECDSA_validate_msg_signature((const uint8_t *) msg, msg_length, hex_public_key, sizeof(hex_public_key),
