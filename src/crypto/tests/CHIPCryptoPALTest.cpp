...
static void TestCompressedFabricIdentifier(nlTestSuite * inSuite, void * inContext)
{
    ...
    static_assert(sizeof(kExpectedCompressedFabricIdentifier) == sizeof(uint64_t), "Expected compressed fabric identifier must be 64 bits long");
    ...
    NL_TEST_ASSERT(inSuite, 0 == memcmp(compressed_fabric_id_span.data(), kExpectedCompressedFabricIdentifier, sizeof(kExpectedCompressedFabricIdentifier)));
    ...
    NL_TEST_ASSERT(inSuite, 0 == memcmp(compressed_fabric_id_large_span.data(), kExpectedCompressedFabricIdentifier, sizeof(kExpectedCompressedFabricIdentifier)));
