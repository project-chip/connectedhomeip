...
TEST_F(TestChipCryptoPAL, TestHash_SHA256_Stream)
{
    ...
    for (size_t block1_size = 1; block1_size <= kSHA256_Hash_Length; block1_size++)
    {
        for (size_t block2_size = 1; block2_size <= kSHA256_Hash_Length; block2_size++)
        {
            ...
            EXPECT_EQ(0, memcmp(partial_digest_span2.data(), total_digest_ref, total_digest_span.size()));
...
TEST_F(TestChipCryptoPAL, TestAddEntropySources)
{
    ...
    TEST_F(TestChipCryptoPAL, TestCSR_Verify)
    {
        ...
        // First case: there is trailing garbage in the CSR
        {
            const uint8_t kBadTrailingGarbageCsr[255] = {
                ...
                ,
                ...
                0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, EXPECT_EQ(numOfTestsRan, numOfTestVectors);
        }
    ...
    static SerialNumberTestCase sSerialNumberTestCases[] = {
        ...
        TEST_F(TestChipCryptoPAL, TestSubject_x509Extraction)
        {
            ...
            EXPECT_EQ(subjectDN_Node02_02.AddAttribute_CommonName("TEST CERT COMMON NAME Attr for Node02_02"_span, false),
                      CHIP_NO_ERROR);
    ...
    const TestCase kTestCases[] = {
        ...
        const uint8_t kEpochKeyBuffer1[Crypto::CHIP_CRYPTO_SYMMETRIC_KEY_LENGTH_BYTES]      = { 0xa0, 0xa1, 0xa2, 0xa3, 0xa4, 0xa5,
                                                                                                0xa6, 0xa7, 0xa8, 0xa9, 0xaa, 0xab,
                                                                                                0xac, 0xad, 0xae, 0xaf };
        const uint8_t kEpochKeyBuffer2[Crypto::CHIP_CRYPTO_SYMMETRIC_KEY_LENGTH_BYTES]      = { 0xb0, 0xb1, 0xb2, 0xb3, 0xb4, 0xb5,
        ...
        const uint8_t kEpochKeyBuffer3[Crypto::CHIP_CRYPTO_SYMMETRIC_KEY_LENGTH_BYTES]      = { 0x23, 0x5b, 0xf7, 0xe6, 0x28, 0x23,
                                                                                                0xd3, 0x58, 0xdc, 0xa4, 0xba, 0x50,
                                                                                                0xb1, 0x53, 0x5f, 0x4b };
        ...
        static const uint8_t kGroupPrivacyKey1[Crypto::CHIP_CRYPTO_SYMMETRIC_KEY_LENGTH_BYTES] = {
            0xb8, 0x27, 0x9f, 0x89, 0x62, 0x1e, 0xd3, 0x27, 0xa9, 0xc3, 0x9f, 0x6a, 0x27, 0x24, 0x73, 0x58
        };
        static const uint8_t kGroupPrivacyKey2[Crypto::CHIP_CRYPTO_SYMMETRIC_KEY_LENGTH_BYTES] = {
            0xf7, 0x25, 0x70, 0xc3, 0xc0, 0x89, 0xa0, 0xfe, 0x28, 0x75, 0x83, 0x57, 0xaf, 0xff, 0xb8, 0xd2
        };
        static const uint8_t kGroupPrivacyKey3[Crypto::CHIP_CRYPTO_SYMMETRIC_KEY_LENGTH_BYTES] = {
            0x01, 0xf8, 0xd1, 0x92, 0x71, 0x26, 0xf1, 0x94, 0x08, 0x25, 0x72, 0xd4, 0x9b, 0x1f, 0xdc, 0x73
        };
        ...
        TEST_F(TestChipCryptoPAL, GenerateVendorFabricBindingMessageWorks)
        {
            ...
            // Try with invalid FabricBinding version.
            {
                ...
                EXPECT_EQ(GenerateVendorFabricBindingMessage(static_cast<Crypto::FabricBindingVersion>(123u), rootPublicKey,
                                                             kFabricId, kVendorId, vendorFabricBindingMessage),
            ...
            // Try with buffer too small.
            {
                ...
                EXPECT_EQ(GenerateVendorFabricBindingMessage(Crypto::FabricBindingVersion::kVersion1, rootPublicKey, kFabricId,
                                                             kVendorId, bufferTooSmallSpan),
                          CHIP_ERROR_BUFFER_TOO_SMALL);
            }

            // Try with a correct set of arguments, expect success and matching payload.
            {
                const uint8_t kExpectedFabricBindingMessage[] = { 0x01, 0x04, 0xd5, 0x9f, 0x3e, 0xb0, 0xb9, 0xc2, 0x16, 0xa4, 0x6f,
                                                                  0x04, 0x0a, 0xff, 0xdf, 0xd5, 0x58, 0x17, 0xca, 0x8a, 0x3d, 0xc9,
                                                                  0x21, 0xaa, 0x62, 0x4d, 0xa5, 0x16, 0x8b, 0xa9, 0x07, 0x66, 0xd7,
                                                                  0x3b, 0xf0, 0x8e, 0x48, 0x0c, 0xd0, 0xf5, 0xcc, 0x94, 0x65, 0x3a,
                                                                  0x92, 0xd7, 0x77, 0x19, 0xd9, 0xb0, 0x04, 0x74, 0x7d, 0x5f, 0x7d,
                                                                  0xa3, 0x9d, 0xed, 0xb6, 0x7e, 0xc5, 0x4f, 0x7c, 0xbc, 0x6a, 0xde,
                                                                  0x11, 0x22, 0x33, 0x44, 0x55, 0x66, 0x77, 0x88, 0xff, 0xf1 };
        ...
        TEST_F(TestChipCryptoPAL, GenerateVendorIdVerificationToBeSignedWorks)
        {
            ...
            // Try with buffer too small.
            {
                ...
                EXPECT_EQ(GenerateVendorIdVerificationToBeSigned(
                              kFabricIndex, kClientChallengeSpan1, kAttestationChallengeSpan1, kVendorFabricBindingMessageSpan,
                              kVidVerificationStatementSampleSpan, vendorIdVerificationTbsTooSmall),
                          CHIP_ERROR_BUFFER_TOO_SMALL);
            }
            ...
            // Try with invalid FabricBinding version.
            {
                const uint8_t kVendorFabricBindingMessageBadVersion[76] = {
                    0x55, 0x04, 0xd5, 0x9f, 0x3e, 0xb0, 0xb9, 0xc2, 0x16, 0xa4, 0x6f, 0x04, 0x0a, 0xff, 0xdf, 0xd5,
                    0x58, 0x17, 0xca, 0x8a, 0x3d, 0xc9, 0x21, 0xaa, 0x62, 0x4d, 0xa5, 0x16, 0x8b, 0xa9, 0x07, 0x66,
                    0xd7, 0x3b, 0xf0, 0x8e, 0x48, 0x0c, 0xd0, 0xf5, 0xcc, 0x94, 0x65, 0x3a, 0x92, 0xd7, 0x77, 0x19,
                    0xd9, 0xb0, 0x04, 0x74, 0x7d, 0x5f, 0x7d, 0xa3, 0x9d, 0xed, 0xb6, 0x7e, 0xc5, 0x4f, 0x7c, 0xbc,
                    0x6a, 0xde, 0x11, 0x22, 0x33, 0x44, 0x55, 0x66, 0x77, 0x88, 0xff, 0xf1,
                };
            ...
            // Try with invalid attestation challenge size.
            {
                ...
                EXPECT_EQ(GenerateVendorIdVerificationToBeSigned(kFabricIndex, kClientChallengeSpan1,
                                                                 kAttestationChallengeWrongSize, kVendorFabricBindingMessageSpan,
                                                                 kVidVerificationStatementSampleSpan, vendorIdVerificationTbs),
                          CHIP_ERROR_INVALID_ARGUMENT);
            }
            ...
            // Try with invalid client challenge size.
            {
                ...
                EXPECT_EQ(GenerateVendorIdVerificationToBeSigned(kFabricIndex, kClientChallengeWrongSize,
                                                                 kAttestationChallengeSpan1, kVendorFabricBindingMessageSpan,
                                                                 kVidVerificationStatementSampleSpan, vendorIdVerificationTbs),
                          CHIP_ERROR_INVALID_ARGUMENT);
            }
            ...
            // Try with fabric binding message that is empty (invalid).
            {
                ...
                EXPECT_EQ(GenerateVendorIdVerificationToBeSigned(kFabricIndex, kClientChallengeSpan1, kAttestationChallengeSpan1,
                                                                 kEmptyVendorFabricBindingMessageSpan,
                                                                 kVidVerificationStatementSampleSpan, vendorIdVerificationTbs),
                          CHIP_ERROR_INVALID_ARGUMENT);
            }
            ...
            // Success case without VidVerificationStatement.
            {
                ...
                EXPECT_EQ(GenerateVendorIdVerificationToBeSigned(kFabricIndex, kClientChallengeSpan1, kAttestationChallengeSpan1,
                                                                 ...
                                                                 kEmptyVidVerificationStatementSpan, vendorIdVerificationTbs),
                          CHIP_NO_ERROR);
            ...
            // Success case with VidVerificationStatement.
            {
                const uint8_t kExpectedVendorIdVerificationTbs[211] = {
                    ...
                    ,
                };
                ByteSpan kExpectedVendorIdVerificationTbsSpan{ kExpectedVendorIdVerificationTbs };
        ...
        TEST_F(TestChipCryptoPAL, PemEncodingWorks)
        {
            ...
            // Known cert case, different heading requested: sTestCert_PAA_FFF1_Cert should succeed with "ROBOTO" instead of
            // "CERTIFICATE".
            {
                size_t numLines = 0;
                std::vector<std::string> pemLines;
        ...
        TEST_F(TestChipCryptoPAL, KeyIdStringifierWorks)
        {
            ...
            uint8_t kTooLongKeyId[kAuthorityKeyIdentifierLength + 1] = { 0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06,
        ...
        TEST_F(TestChipCryptoPAL, TestHazardousOperationLoadKeypairFromRaw)
        {
            ...
            if (err == CHIP_NO_ERROR)
            {
                ...
                EXPECT_EQ(pubkey.ECDSA_validate_msg_signature(reinterpret_cast<const uint8_t *>(msg), msg_len, signature),
                          CHIP_NO_ERROR);
            }
