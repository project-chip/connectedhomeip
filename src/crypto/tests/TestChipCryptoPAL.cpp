...
{
    const uint8_t kSomePublicKeyBytes[] = {
      0x04, 0xd5, 0x9f, 0x3e, 0xb0, 0xb9, 0xc2, 0x16 , 0xa4, 0x6f, 0x04, 0x0a, 0xff, 0xdf, 0xd5, 0x58,
      0x17, 0xca, 0x8a, 0x3d, 0xc9, 0x21, 0xaa, 0x62 , 0x4d, 0xa5, 0x16, 0x8b, 0xa9, 0x07, 0x66, 0xd7,
      0x3b, 0xf0, 0x8e, 0x48, 0x0c, 0xd0, 0xf5, 0xcc , 0x94, 0x65, 0x3a, 0x92, 0xd7, 0x77, 0x19, 0xd9,
      0xb0, 0x04, 0x74, 0x7d, 0x5f, 0x7d, 0xa3, 0x9d , 0xed, 0xb6, 0x7e, 0xc5, 0x4f, 0x7c, 0xbc, 0x6a,
      0xde
    };
    ...
    // Try with invalid FabricBinding version.
    {
        ...
        EXPECT_EQ(GenerateVendorFabricBindingMessage(kInvalidFabricBindingVersion, rootPublicKey, kFabricId, kVendorId, vendorFabricBindingMessage), CHIP_ERROR_INVALID_ARGUMENT);
    }
    ...
    // Try with buffer too small.
    {
        ...
        EXPECT_EQ(GenerateVendorFabricBindingMessage(kFabricBindingVersionV1, rootPublicKey, kFabricId, kVendorId, bufferTooSmallSpan), CHIP_ERROR_BUFFER_TOO_SMALL);
    }

    // Try with a correct set of arguments, expect success and matching payload.
    {
        const uint8_t kExpectedFabricBindingMessage[] = {
          0x01, 0x04, 0xd5, 0x9f, 0x3e, 0xb0, 0xb9, 0xc2 , 0x16, 0xa4, 0x6f, 0x04, 0x0a, 0xff, 0xdf, 0xd5,
        ...
        MutableByteSpan vendorFabricBindingMessage{bigEnoughBuffer};
        EXPECT_EQ(GenerateVendorFabricBindingMessage(kFabricBindingVersionV1, rootPublicKey, kFabricId, kVendorId, vendorFabricBindingMessage), CHIP_NO_ERROR);
...
TEST_F(TestChipCryptoPAL, GenerateVendorIdVerificationToBeSignedWorks)
{
    ...
    const uint8_t kVidVerificationStatementSample[85] = {
        0x21, 0xfa, 0xc0, 0xe7, 0xd0, 0x08, 0x94, 0x73, 0xf1, 0x5c, 0x2d, 0xfe, 0xfe, 0x54, 0x6f, 0xff,
        0xa0, 0xb0, 0x0a, 0x8b, 0xb2, 0x32, 0x32, 0x84, 0xaf, 0x77, 0x38, 0xf9, 0xb3, 0x21, 0xd0, 0x0b,
        0xbf, 0x2b, 0xff, 0x94, 0x2c, 0x82, 0x15, 0xc4, 0x98, 0xdf, 0xdd, 0xb1, 0xb6, 0x6b, 0x34, 0xfb,
        0xd7, 0xdb, 0x31, 0x8a, 0xd7, 0x54, 0x82, 0x9c, 0xd5, 0xca, 0x1d, 0x9c, 0xf5, 0x3b, 0xeb, 0x2c,
        0x93, 0x57, 0x1a, 0xf3, 0x52, 0x57, 0xee, 0xad, 0x67, 0x14, 0xf6, 0x8e, 0x91, 0x0f, 0x7b, 0xb7,
        0xac, 0x9a, 0x90, 0x9a, 0x72,
    };
    ...
    // Try with buffer too small.
    {
        ...
        EXPECT_EQ(GenerateVendorIdVerificationToBeSigned(kFabricIndex, kClientChallengeSpan1, kAttestationChallengeSpan1, kVendorFabricBindingMessageSpan, kVidVerificationStatementSampleSpan, vendorIdVerificationTbsTooSmall), CHIP_ERROR_BUFFER_TOO_SMALL);
    }
    ...
    // Try with invalid FabricBinding version.
    {
        ...
        EXPECT_EQ(GenerateVendorIdVerificationToBeSigned(kFabricIndex, kClientChallengeSpan1, kAttestationChallengeSpan1, ByteSpan{kVendorFabricBindingMessageBadVersion}, kVidVerificationStatementSampleSpan, vendorIdVerificationTbs), CHIP_ERROR_INVALID_ARGUMENT);
    }
    ...
    // Try with invalid attestation challenge size.
    {
        ...
        EXPECT_EQ(GenerateVendorIdVerificationToBeSigned(kFabricIndex, kClientChallengeSpan1, kAttestationChallengeWrongSize, kVendorFabricBindingMessageSpan, kVidVerificationStatementSampleSpan, vendorIdVerificationTbs), CHIP_ERROR_INVALID_ARGUMENT);
    }
    ...
    // Try with invalid client challenge size.
    {
        ...
        EXPECT_EQ(GenerateVendorIdVerificationToBeSigned(kFabricIndex, kClientChallengeWrongSize, kAttestationChallengeSpan1, kVendorFabricBindingMessageSpan, kVidVerificationStatementSampleSpan, vendorIdVerificationTbs), CHIP_ERROR_INVALID_ARGUMENT);
    }
    ...
    // Try with fabric binding message that is empty (invalid).
    {
        ...
        EXPECT_EQ(GenerateVendorIdVerificationToBeSigned(kFabricIndex, kClientChallengeSpan1, kAttestationChallengeSpan1, kEmptyVendorFabricBindingMessageSpan, kVidVerificationStatementSampleSpan, vendorIdVerificationTbs), CHIP_ERROR_INVALID_ARGUMENT);
    }
    ...
    // Success case without VidVerificationStatement.
    {
        const uint8_t kExpectedVendorIdVerificationTbs[126] = {
            ...
            0xf3, 0x05, 0x01, 0x04, 0xd5, 0x9f, 0x3e, 0xb0, 0xb9, 0xc2, 0x16, 0xa4, 0x6f, 0x04, 0x0a, 0xff,
            0xdf, 0xd5, 0x58, 0x17, 0xca, 0x8a, 0x3d, 0xc9, 0x21, 0xaa, 0x62, 0x4d, 0xa5, 0x16, 0x8b, 0xa9,
            0x07, 0x66, 0xd7, 0x3b, 0xf0, 0x8e, 0x48, 0x0c, 0xd0, 0xf5, 0xcc, 0x94, 0x65, 0x3a, 0x92, 0xd7,
            0x77, 0x19, 0xd9, 0xb0, 0x04, 0x74, 0x7d, 0x5f, 0x7d, 0xa3, 0x9d, 0xed, 0xb6, 0x7e, 0xc5, 0x4f,
            0x7c, 0xbc, 0x6a, 0xde, 0x11, 0x22, 0x33, 0x44, 0x55, 0x66, 0x77, 0x88, 0xff, 0xf1,
        };
        ...
        EXPECT_EQ(GenerateVendorIdVerificationToBeSigned(kFabricIndex, kClientChallengeSpan1, kAttestationChallengeSpan1, kVendorFabricBindingMessageSpan, kEmptyVidVerificationStatementSpan, vendorIdVerificationTbs), CHIP_NO_ERROR);
    ...
    // Success case with VidVerificationStatement.
    {
        const uint8_t kExpectedVendorIdVerificationTbs[211] = {
            ...
            ,
        };
        ByteSpan kExpectedVendorIdVerificationTbsSpan{kExpectedVendorIdVerificationTbs};
        ...
        EXPECT_EQ(GenerateVendorIdVerificationToBeSigned(kFabricIndex, kClientChallengeSpan2, kAttestationChallengeSpan2, kVendorFabricBindingMessageSpan, kVidVerificationStatementSampleSpan, vendorIdVerificationTbs), CHIP_NO_ERROR);
        EXPECT_TRUE(vendorIdVerificationTbs.data_equal(kExpectedVendorIdVerificationTbsSpan));
    }
}
