...
namespace Inet {
    namespace Darwin {
        ...
        public:
            ...
            CHIP_ERROR Init(dispatch_queue_t workQueue, Inet::IPAddressType addressType, InterfaceId interfaceId)
            {
                return Init(workQueue, addressType, interfaceId.GetPlatformInterface());
            }

            CHIP_ERROR Init(dispatch_queue_t workQueue, Inet::IPAddressType addressType, uint32_t interfaceId);
