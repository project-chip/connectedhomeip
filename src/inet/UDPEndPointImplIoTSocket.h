...
class UDPEndPointImplIoTSocket : public UDPEndPoint, public EndPointStateIoTSocket
{
public:
    UDPEndPointImplIoTSocket(EndPointManager<UDPEndPoint> & endPointManager) :
        UDPEndPoint(endPointManager), mBoundInterface(InterfaceId::Null())
    {}
...
using UDPEndPointImpl = UDPEndPointImplIoTSocket;
