...
static int
do_setup_payload_operation_generate_code(SetupPayloadCodeType type, const char *filePathUTF8String)
{
    int result=0;
...
int
setup_payload_operation_generate_qr_code(int argc, char * const *argv)
{
    int ch;
...
int
setup_payload_operation_generate_manual_code(int argc, char * const *argv)
{
    int ch;
    const char *filePath = NULL;
