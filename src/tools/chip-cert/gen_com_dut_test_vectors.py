...
TEST_CASES_CERT_STRUCT_ERRORS = [
    ...
    {
        "test_folder": 'sig_prime256v1',
        "error_flag": 'no-error',
    },
    # TODO Cases:
    # {
    #     "test_folder": 'sig_curve256k1',
...
def generate_test_case_vector_json(test_case_out_dir: str):
    json_dict = {}
...
def main():
    ...
    for error_cert in ['dac', 'pai']:
        for test_case in TEST_CASES_CERT_STRUCT_ERRORS:
            test_case_out_dir = args.outdir + '/struct_' + error_cert + '_' + test_case["test_folder"]
            if error_cert == 'dac':
            ...
            generate_test_case_vector_json(test_case_out_dir)
