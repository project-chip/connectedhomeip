...
class PacketCaptureBase(ABC):
    ...
    def __init__(self,
        ...
        self.band = band
        self.pcap_command: Optional[str] = None
        self.pcap_proc: Optional[Bash] = None
        self.width = width
    ...
    def start_pcap(self) -> None:
        ...
        if not self.pcap_proc.command_is_running() and "sudo" not in self.pcap_command:
            self.logger.error(
