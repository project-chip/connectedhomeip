...
void TestGetCompressedFabricID(nlTestSuite * inSuite, void * inContext)
{
    ...
    PeerId compressedId;
    NL_TEST_ASSERT(inSuite, fabricInfo.GenerateCompressedId(1234, 4321, &compressedId) == CHIP_NO_ERROR);
    ...
    // If in this test any input to GenerateCompressedId() is changed, this value must be recomputed.
    ...
    NL_TEST_ASSERT(inSuite, fabricInfo.GenerateCompressedId(0xabcd, 0xdeed, &compressedId) == CHIP_NO_ERROR);
