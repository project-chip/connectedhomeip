...
- (id)initWithSetupPayload:(chip::SetupPayload)setupPayload
{
    if (self = [super init]) {
        ...
        _commissioningFlow = [self convertRendezvousFlags:setupPayload.commissioningFlow];
        _rendezvousInformation = [self convertCommissioningFlow:setupPayload.rendezvousInformation];
