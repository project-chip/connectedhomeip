...
#import "MTRNetworkRecoverableBrowserResult.h"

#include <controller/SetUpCodePairer.h>

NS_ASSUME_NONNULL_BEGIN

@interface MTRNetworkRecoverableBrowserResultInterfaces : NSObject
...
@property (nonatomic, readwrite) NSMutableDictionary<NSNumber *, MTRNetworkRecoverableBrowserResultInterfaces *> * interfaces;
