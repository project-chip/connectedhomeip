...
class CHIPContentLaunchAcceptsHeaderListAttributeCallbackBridge : public Callback::Callback<ContentLaunchAcceptsHeaderListListAttributeCallback>
{
public:
    CHIPContentLaunchAcceptsHeaderListAttributeCallbackBridge(ResponseHandler handler, dispatch_queue_t queue): Callback::Callback<ContentLaunchAcceptsHeaderListListAttributeCallback>(CallbackFn, this), mHandler(handler), mQueue(queue) {}
    ...
    {
        CHIPContentLaunchAcceptsHeaderListAttributeCallbackBridge * callback = reinterpret_cast<CHIPContentLaunchAcceptsHeaderListAttributeCallbackBridge *>(context);
        if (callback && callback->mQueue)
        {
            id values[count];
            for (uint16_t i = 0; i < count; i++)
...
class CHIPContentLaunchSupportedStreamingTypesAttributeCallbackBridge : public Callback::Callback<ContentLaunchSupportedStreamingTypesListAttributeCallback>
{
public:
    CHIPContentLaunchSupportedStreamingTypesAttributeCallbackBridge(ResponseHandler handler, dispatch_queue_t queue): Callback::Callback<ContentLaunchSupportedStreamingTypesListAttributeCallback>(CallbackFn, this), mHandler(handler), mQueue(queue) {}
    ...
    {
        CHIPContentLaunchSupportedStreamingTypesAttributeCallbackBridge * callback = reinterpret_cast<CHIPContentLaunchSupportedStreamingTypesAttributeCallbackBridge *>(context);
        if (callback && callback->mQueue)
        {
            id values[count];
            for (uint16_t i = 0; i < count; i++)
        ...
        if (callback && callback->mQueue)
        {
            ...
            for (uint16_t i = 0; i < count; i++)
            {
                values[i] = [[NSDictionary alloc] initWithObjectsAndKeys:
                    ...
                    [NSNumber numberWithUnsignedLongLong:entries[i].HardwareAddress],
                    @"HardwareAddress",
...
{
    CHIPContentLaunchClusterLaunchContentResponseCallbackBridge * onSuccess = new CHIPContentLaunchClusterLaunchContentResponseCallbackBridge(responseHandler, [self callbackQueue]);
    if (!onSuccess) {
        responseHandler([CHIPError errorForCHIPErrorCode:CHIP_ERROR_INCORRECT_STATE], nil);
        return;
    }
...
{
    CHIPContentLaunchClusterLaunchURLResponseCallbackBridge * onSuccess = new CHIPContentLaunchClusterLaunchURLResponseCallbackBridge(responseHandler, [self callbackQueue]);
    if (!onSuccess) {
        responseHandler([CHIPError errorForCHIPErrorCode:CHIP_ERROR_INCORRECT_STATE], nil);
        return;
    }
...
{
    CHIPContentLaunchAcceptsHeaderListAttributeCallbackBridge * onSuccess = new CHIPContentLaunchAcceptsHeaderListAttributeCallbackBridge(responseHandler, [self callbackQueue]);
    if (!onSuccess) {
        responseHandler([CHIPError errorForCHIPErrorCode:CHIP_ERROR_INCORRECT_STATE], nil);
        return;
    }
...
{
    CHIPContentLaunchSupportedStreamingTypesAttributeCallbackBridge * onSuccess = new CHIPContentLaunchSupportedStreamingTypesAttributeCallbackBridge(responseHandler, [self callbackQueue]);
    if (!onSuccess) {
        responseHandler([CHIPError errorForCHIPErrorCode:CHIP_ERROR_INCORRECT_STATE], nil);
        return;
    }
...
- (void)addOpCert:(NSData *)noc iCACertificate:(NSData *)iCACertificate iPKValue:(NSData *)iPKValue caseAdminNode:(uint64_t)caseAdminNode adminVendorId:(uint16_t)adminVendorId responseHandler:(ResponseHandler)responseHandler
{
    ...
    __block CHIP_ERROR err;
    dispatch_sync([self chipWorkQueue], ^{
        err = self.cppCluster.AddOpCert(onSuccess->Cancel(), onFailure->Cancel(), chip::ByteSpan((const uint8_t*)noc.bytes, noc.length), chip::ByteSpan((const uint8_t*)iCACertificate.bytes, iCACertificate.length), chip::ByteSpan((const uint8_t*)iPKValue.bytes, iPKValue.length), caseAdminNode, adminVendorId);
    });
...
- (void) configureAttributeWindowCoveringTypeWithMinInterval:(uint16_t)minInterval  maxInterval:(uint16_t)maxInterval responseHandler:(ResponseHandler)responseHandler
{
    CHIPDefaultSuccessCallbackBridge * onSuccess = new CHIPDefaultSuccessCallbackBridge(responseHandler, [self callbackQueue]);
    if (!onSuccess) {
        responseHandler([CHIPError errorForCHIPErrorCode:CHIP_ERROR_INCORRECT_STATE], nil);
    ...
    __block CHIP_ERROR err;
    dispatch_sync([self chipWorkQueue], ^{
        err = self.cppCluster.ConfigureAttributeWindowCoveringType(onSuccess->Cancel(), onFailure->Cancel(), minInterval, maxInterval);
    });
