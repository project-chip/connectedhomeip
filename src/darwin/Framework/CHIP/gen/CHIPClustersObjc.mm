...
#import "gen/CHIPCallbackBridge_internal.h"
...
- (void)readAttributeFabricIdWithResponseHandler:(ResponseHandler)responseHandler
{
    new CHIPOctetStringAttributeCallbackBridge(self.callbackQueue, responseHandler, ^(Cancelable * success, Cancelable * failure) {
        return self.cppCluster.ReadAttributeFabricId(success, failure);
    });
}
...
{
    new CHIPDefaultSuccessCallbackBridge(self.callbackQueue, responseHandler, ^(Cancelable * success, Cancelable * failure) {
        return self.cppCluster.RemoveAllFabrics(success, failure);
    });
}
     ...
     responseHandler:(ResponseHandler)responseHandler
{
    new CHIPOperationalCredentialsClusterNOCResponseCallbackBridge(
        self.callbackQueue, responseHandler, ^(Cancelable * success, Cancelable * failure) {
            return self.cppCluster.RemoveFabric(success, failure, fabricId, nodeId, vendorId);
        });
}
...
{
    new CHIPOperationalCredentialsClusterSetFabricResponseCallbackBridge(
        self.callbackQueue, responseHandler, ^(Cancelable * success, Cancelable * failure) {
            return self.cppCluster.SetFabric(success, failure, vendorId);
        });
}
