...
class CHIPOperationalCredentialsClusterSetFabricResponseCallbackBridge
    : public CHIPCallbackBridge<OperationalCredentialsClusterSetFabricResponseCallback>
{
public:
    CHIPOperationalCredentialsClusterSetFabricResponseCallbackBridge(dispatch_queue_t queue, ResponseHandler handler,
                                                                     CHIPActionBlock action, bool keepAlive = false) :
        CHIPCallbackBridge<OperationalCredentialsClusterSetFabricResponseCallback>(queue, handler, action, OnSuccessFn,
                                                                                   keepAlive){};

    static void OnSuccessFn(void * context, chip::FabricId FabricId);
};
