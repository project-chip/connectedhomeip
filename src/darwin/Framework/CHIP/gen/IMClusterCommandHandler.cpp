...
{
      ChipLogProgress(Zcl, "Missing command arguments in TLV data, command requires %d, given %" PRIu32, 7, validArgumentCount);
}
            break;
        }
...
{
      ChipLogProgress(Zcl, "Missing command arguments in TLV data, command requires %d, given %" PRIu32, 8, validArgumentCount);
}
            break;
        }
...
{
      ChipLogProgress(Zcl, "Missing command arguments in TLV data, command requires %d, given %" PRIu32, 6, validArgumentCount);
}
            break;
        }
        default: {
