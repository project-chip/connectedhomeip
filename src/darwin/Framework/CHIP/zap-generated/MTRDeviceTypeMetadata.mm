...
static /* constexpr */ const MTRDeviceTypeData knownDeviceTypes[] = {
    ...
    { 0x00000040, MTRDeviceTypeClass::Simple, @"Irrigation System" },
    ...
    { 0x0000007D, MTRDeviceTypeClass::Simple, @"Humidity Conditioner" },
    ...
    { 0x00000515, MTRDeviceTypeClass::Simple, @"Arc Fault Circuit Interrupter" },
