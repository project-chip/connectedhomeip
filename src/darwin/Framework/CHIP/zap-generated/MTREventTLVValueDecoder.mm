...
static id _Nullable DecodeEventPayloadForWasherControlsCluster(EventId aEventId, TLV::TLVReader & aReader, CHIP_ERROR * aError)
{
    ...
    case Events::OperationalError::Id: {
        ...
        *aError = DataModel::Decode(aReader, cppValue);
        ...
        __auto_type * value = [MTRWasherControlsClusterOperationalErrorEvent new];

        do {
            MTRWasherControlsClusterErrorStateStruct * _Nonnull memberValue;
            memberValue = [MTRWasherControlsClusterErrorStateStruct new];
    ...
    case Events::OperationCompletion::Id: {
        ...
        *aError = DataModel::Decode(aReader, cppValue);
        ...
        __auto_type * value = [MTRWasherControlsClusterOperationCompletionEvent new];
