...
@property (nonatomic, copy) NSData * _Nullable key MTR_NEWLY_AVAILABLE;
/**
 * Controls whether the command is a timed command (using Timed Invoke).
 *
 * If nil (the default value), a regular invoke is done for commands that do
...
MTR_NEWLY_AVAILABLE
@interface MTRWasherControlsClusterSetSpinSpeedParams : NSObject <NSCopying>
/**
 * Controls whether the command is a timed command (using Timed Invoke).
 *
 * If nil (the default value), a regular invoke is done for commands that do
...
MTR_NEWLY_AVAILABLE
@interface MTRWasherControlsClusterSetNumberOfRinsesParams : NSObject <NSCopying>
/**
 * Controls whether the command is a timed command (using Timed Invoke).
 *
 * If nil (the default value), a regular invoke is done for commands that do
...
MTR_NEWLY_AVAILABLE
@interface MTRWasherControlsClusterWasherControlCommandResponseParams : NSObject <NSCopying>

@property (nonatomic, copy) MTRWasherControlsClusterErrorStateStruct * _Nonnull commandResponseState MTR_NEWLY_AVAILABLE;
@end
