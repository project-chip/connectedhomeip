...
@property (nonatomic, copy) MTRDataTypeSFrameStruct * _Nullable sFrameConfig MTR_PROVISIONALLY_AVAILABLE;
...
@property (nonatomic, copy) NSNumber * _Nullable originatingEndpointID MTR_PROVISIONALLY_AVAILABLE;
...
MTR_PROVISIONALLY_AVAILABLE
@interface MTRWebRTCTransportProviderClusterUpdateSessionParams : NSObject <NSCopying>

@property (nonatomic, copy) NSNumber * _Nonnull webRTCSessionID MTR_PROVISIONALLY_AVAILABLE;

@property (nonatomic, copy) MTRDataTypeSFrameKeyStruct * _Nullable sFrameSenderKey MTR_PROVISIONALLY_AVAILABLE;

@property (nonatomic, copy) NSArray * _Nullable sFrameReceiveKeysToAdd MTR_PROVISIONALLY_AVAILABLE;

@property (nonatomic, copy) NSArray * _Nullable sFrameReceiveKIDsToRemove MTR_PROVISIONALLY_AVAILABLE;
/**
 * Controls whether the command is a timed command (using Timed Invoke).
 *
 * If nil (the default value), a regular invoke is done for commands that do
