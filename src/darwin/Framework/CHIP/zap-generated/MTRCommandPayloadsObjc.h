...
@property (nonatomic, copy) NSNumber * _Nullable localTemperature MTR_PROVISIONALLY_AVAILABLE;

@property (nonatomic, copy) NSNumber * _Nullable humidityInPercentage MTR_PROVISIONALLY_AVAILABLE;
