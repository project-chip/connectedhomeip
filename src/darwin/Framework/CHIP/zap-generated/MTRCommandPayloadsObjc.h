...
@property (nonatomic, copy) MTRJointFabricDatastoreClusterGroupKeySetStruct * _Nonnull groupKeySet MTR_PROVISIONALLY_AVAILABLE;
/**
 * Controls whether the command is a timed command (using Timed Invoke).
 *
 * If nil (the default value), a regular invoke is done for commands that do
...
@property (nonatomic, copy) MTRJointFabricDatastoreClusterDatastoreAdministratorInformationEntry * _Nullable adminInformationEntry MTR_PROVISIONALLY_AVAILABLE;
/**
 * Controls whether the command is a timed command (using Timed Invoke).
 *
 * If nil (the default value), a regular invoke is done for commands that do
...
@property (nonatomic, copy) MTRJointFabricDatastoreClusterTargetStruct * _Nonnull binding MTR_PROVISIONALLY_AVAILABLE;
/**
 * Controls whether the command is a timed command (using Timed Invoke).
 *
 * If nil (the default value), a regular invoke is done for commands that do
...
@property (nonatomic, copy) MTRJointFabricDatastoreClusterAccessControlEntryStruct * _Nonnull aclEntry MTR_PROVISIONALLY_AVAILABLE;
/**
 * Controls whether the command is a timed command (using Timed Invoke).
 *
 * If nil (the default value), a regular invoke is done for commands that do
