...
MTR_PROVISIONALLY_AVAILABLE
@interface MTRCameraAVStreamManagementClusterSetWatermarkParams : NSObject <NSCopying>
...
MTR_PROVISIONALLY_AVAILABLE
@interface MTRCameraAVStreamManagementClusterSetOSDParams : NSObject <NSCopying>
