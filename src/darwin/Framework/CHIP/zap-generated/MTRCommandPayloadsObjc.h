...
@property (nonatomic, copy) MTRDataTypeGroupKeySetStruct * _Nonnull groupKeySet MTR_AVAILABLE(ios(16.1), macos(13.0), watchos(9.1), tvos(16.1));
/**
 * Controls whether the command is a timed command (using Timed Invoke).
 *
 * If nil (the default value), a regular invoke is done for commands that do
...
@property (nonatomic, copy) MTRDataTypeGroupKeySetStruct * _Nonnull groupKeySet MTR_PROVISIONALLY_AVAILABLE;
/**
 * Controls whether the command is a timed command (using Timed Invoke).
 *
 * If nil (the default value), a regular invoke is done for commands that do
...
@property (nonatomic, copy) MTRJointFabricDatastoreClusterDatastoreAdministratorInformationEntryStruct * _Nullable adminInformationEntry MTR_PROVISIONALLY_AVAILABLE;
/**
 * Controls whether the command is a timed command (using Timed Invoke).
 *
 * If nil (the default value), a regular invoke is done for commands that do
