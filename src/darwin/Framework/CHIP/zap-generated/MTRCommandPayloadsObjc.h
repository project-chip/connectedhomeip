...
MTR_PROVISIONALLY_AVAILABLE
@interface MTRJointFabricPkiClusterJointFabricRequestParams : NSObject <NSCopying>
...
MTR_PROVISIONALLY_AVAILABLE
@interface MTRJointFabricPkiClusterSignNOCIssuerRequestParams : NSObject <NSCopying>

@property (nonatomic, copy) NSData * _Nonnull nocIssuerCSR MTR_PROVISIONALLY_AVAILABLE;

/**
 * Initialize an MTRJointFabricPkiClusterSignNOCIssuerRequestParams with a response-value dictionary
 * of the sort that MTRDeviceResponseHandler would receive.
 *
 * Will return nil and hand out an error if the response-value dictionary is not
 * a command data response or is not the right command response.
...
MTR_PROVISIONALLY_AVAILABLE
@interface MTRJointFabricPkiClusterSignNOCIssuerResponseParams : NSObject <NSCopying>

@property (nonatomic, copy) NSNumber * _Nonnull statusCode MTR_PROVISIONALLY_AVAILABLE;

@property (nonatomic, copy) NSData * _Nonnull nocIssuerCert MTR_PROVISIONALLY_AVAILABLE;

@property (nonatomic, copy) NSNumber * _Nonnull nodeId MTR_PROVISIONALLY_AVAILABLE;

@property (nonatomic, copy) NSNumber * _Nonnull fabricId MTR_PROVISIONALLY_AVAILABLE;

@property (nonatomic, copy) NSNumber * _Nonnull adminVendorId MTR_PROVISIONALLY_AVAILABLE;

@property (nonatomic, copy) NSNumber * _Nonnull caseAdminSubject MTR_PROVISIONALLY_AVAILABLE;
/**
 * Controls whether the command is a timed command (using Timed Invoke).
 *
 * If nil (the default value), a regular invoke is done for commands that do
...
MTR_PROVISIONALLY_AVAILABLE
@interface MTRJointFabricPkiClusterJointFabricResponseParams : NSObject <NSCopying>

@property (nonatomic, copy) NSNumber * _Nonnull statusCode MTR_PROVISIONALLY_AVAILABLE;

@property (nonatomic, copy) NSNumber * _Nullable fabricIndex MTR_PROVISIONALLY_AVAILABLE;

@property (nonatomic, copy) NSString * _Nullable debugText MTR_PROVISIONALLY_AVAILABLE;

/**
 * Initialize an MTRJointFabricPkiClusterJointFabricResponseParams with a response-value dictionary
 * of the sort that MTRDeviceResponseHandler would receive.
 *
 * Will return nil and hand out an error if the response-value dictionary is not
 * a command data response or is not the right command response.
...
@property (nonatomic, copy) NSData * _Nullable ipAddress MTR_PROVISIONALLY_AVAILABLE;

@property (nonatomic, copy) NSNumber * _Nullable port MTR_PROVISIONALLY_AVAILABLE;
/**
 * Controls whether the command is a timed command (using Timed Invoke).
 *
 * If nil (the default value), a regular invoke is done for commands that do
