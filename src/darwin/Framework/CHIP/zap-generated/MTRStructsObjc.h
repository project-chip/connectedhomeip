...
MTR_PROVISIONALLY_AVAILABLE
@interface MTRAmbientSensingUnionClusterSensorListChangeEvent : NSObject <NSCopying>
@property (nonatomic, copy) NSArray * _Nonnull unionSensorList MTR_PROVISIONALLY_AVAILABLE;
@end
