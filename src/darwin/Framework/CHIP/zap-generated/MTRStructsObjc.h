...
MTR_PROVISIONALLY_AVAILABLE
@interface MTRTLSClientManagementClusterEndpointProvisionedEvent : NSObject <NSCopying>
@property (nonatomic, copy) NSNumber * _Nonnull endpointID MTR_PROVISIONALLY_AVAILABLE;
@end

MTR_PROVISIONALLY_AVAILABLE
@interface MTRTLSClientManagementClusterEndpointRemovedEvent : NSObject <NSCopying>
@property (nonatomic, copy) NSNumber * _Nonnull endpointID MTR_PROVISIONALLY_AVAILABLE;
@end
