...
@interface MTRSoftwareDiagnosticsClusterSoftwareFaultStruct : NSObject
...
@property (strong, nonatomic) MTRSoftwareDiagnosticsClusterSoftwareFaultStruct * _Nonnull softwareFault;
@end
