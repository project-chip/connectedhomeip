...
MTR_PROVISIONALLY_AVAILABLE
@interface MTRJointFabricDatastoreClusterDatastoreEndpointGroupIDEntry : NSObject <NSCopying>
@property (nonatomic, copy) NSNumber * _Nonnull nodeID MTR_PROVISIONALLY_AVAILABLE;
@property (nonatomic, copy) NSNumber * _Nonnull endpointID MTR_PROVISIONALLY_AVAILABLE;
...
MTR_PROVISIONALLY_AVAILABLE
@interface MTRJointFabricDatastoreClusterDatastoreEndpointBindingEntry : NSObject <NSCopying>
@property (nonatomic, copy) NSNumber * _Nonnull nodeID MTR_PROVISIONALLY_AVAILABLE;
@property (nonatomic, copy) NSNumber * _Nonnull endpointID MTR_PROVISIONALLY_AVAILABLE;
