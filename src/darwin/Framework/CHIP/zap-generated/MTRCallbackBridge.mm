...
void MTRWasherControlsSpinSpeedsListAttributeCallbackBridge::OnSuccessFn(void * context,
    const chip::app::DataModel::DecodableList<chip::app::Clusters::WasherControls::Structs::SpinSpeedIndex::DecodableType> & value)
{
    NSArray * _Nonnull objCValue;
    { // Scope for our temporary variables
        auto * array_0 = [NSMutableArray new];
    ...
    void * context, const chip::app::Clusters::IcdManagement::Commands::RegisterClientResponse::DecodableType & data)
{
    ...
    {
        response.icdCounter = [NSNumber numberWithUnsignedInt:data.ICDCounter];
    }
    DispatchSuccess(context, response);
};
    ...
    void * context, const chip::app::Clusters::OperationalState::Commands::OperationalCommandResponse::DecodableType & data)
{
    ...
    {
        response.commandResponseState = [MTROperationalStateClusterErrorStateStruct new];
        response.commandResponseState.errorStateID =
            [NSNumber numberWithUnsignedChar:chip::to_underlying(data.commandResponseState.errorStateID)];
        response.commandResponseState.errorStateLabel =
            [[NSString alloc] initWithBytes:data.commandResponseState.errorStateLabel.data()
                                     length:data.commandResponseState.errorStateLabel.size()
                                   encoding:NSUTF8StringEncoding];
        response.commandResponseState.errorStateDetails =
            [[NSString alloc] initWithBytes:data.commandResponseState.errorStateDetails.data()
                                     length:data.commandResponseState.errorStateDetails.size()
                                   encoding:NSUTF8StringEncoding];
    }
    DispatchSuccess(context, response);
};

void MTRWasherControlsClusterWasherControlCommandResponseCallbackBridge::OnSuccessFn(
    void * context, const chip::app::Clusters::WasherControls::Commands::WasherControlCommandResponse::DecodableType & data)
{
    auto * response = [MTRWasherControlsClusterWasherControlCommandResponseParams new];
    {
        response.commandResponseState = [MTRWasherControlsClusterErrorStateStruct new];
        response.commandResponseState.errorStateID =
            [NSNumber numberWithUnsignedChar:chip::to_underlying(data.commandResponseState.errorStateID)];
        response.commandResponseState.errorStateLabel =
            [[NSString alloc] initWithBytes:data.commandResponseState.errorStateLabel.data()
...
void MTRWasherControlsClusterErrorStateEnumAttributeCallbackBridge::OnSuccessFn(
    void * context, chip::app::Clusters::WasherControls::ErrorStateEnum value)
{
    NSNumber * _Nonnull objCValue;
    objCValue = [NSNumber numberWithUnsignedChar:chip::to_underlying(value)];
    DispatchSuccess(context, objCValue);
...
void MTRWasherControlsClusterErrorStateEnumAttributeCallbackSubscriptionBridge::OnSubscriptionEstablished()
{
    if (!mQueue) {
        return;
    }
...
void MTRNullableWasherControlsClusterErrorStateEnumAttributeCallbackBridge::OnSuccessFn(
    void * context, const chip::app::DataModel::Nullable<chip::app::Clusters::WasherControls::ErrorStateEnum> & value)
{
    NSNumber * _Nullable objCValue;
    if (value.IsNull()) {
        objCValue = nil;
...
void MTRNullableWasherControlsClusterErrorStateEnumAttributeCallbackSubscriptionBridge::OnSubscriptionEstablished()
{
    if (!mQueue) {
        return;
    }
...
void MTRWasherControlsClusterWasherControlsEnumAttributeCallbackBridge::OnSuccessFn(
    void * context, chip::app::Clusters::WasherControls::WasherControlsEnum value)
{
    NSNumber * _Nonnull objCValue;
    objCValue = [NSNumber numberWithUnsignedChar:chip::to_underlying(value)];
    DispatchSuccess(context, objCValue);
...
void MTRWasherControlsClusterWasherControlsEnumAttributeCallbackSubscriptionBridge::OnSubscriptionEstablished()
{
    if (!mQueue) {
        return;
    }
...
void MTRNullableWasherControlsClusterWasherControlsEnumAttributeCallbackBridge::OnSuccessFn(
    void * context, const chip::app::DataModel::Nullable<chip::app::Clusters::WasherControls::WasherControlsEnum> & value)
{
    NSNumber * _Nullable objCValue;
    if (value.IsNull()) {
        objCValue = nil;
...
void MTRNullableWasherControlsClusterWasherControlsEnumAttributeCallbackSubscriptionBridge::OnSubscriptionEstablished()
{
    if (!mQueue) {
        return;
    }
