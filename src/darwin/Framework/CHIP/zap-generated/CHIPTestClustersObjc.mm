...
{
    new CHIPDefaultSuccessCallbackBridge(self.callbackQueue,
        ...
        TypeInfo::Type cppValue;
          {
            ...
            if (value.count != 0) {
              ...
              for (size_t i_0 = 0; i_0 < value.count; ++i_0) {
                ...
                auto element_0 = (NSNumber *)value[i_0];
                      listHolder_0->mList[i_0] = static_cast<std::remove_reference_t<decltype(listHolder_0->mList[i_0])>>(element_0.unsignedShortValue);
      }
              cppValue = ListType_0(listHolder_0->mList, value.count);
            } else {
              cppValue = ListType_0();
        ...
        TypeInfo::Type cppValue;
          {
           ...
           listHolder_0->mList[i_0].outputType = static_cast<std::remove_reference_t<decltype(listHolder_0->mList[i_0].outputType)>>(element_0.outputType.unsignedCharValue);
    ...
    new CHIPDefaultSuccessCallbackBridge(self.callbackQueue,
      ...
      ^(Cancelable * success, Cancelable * failure) {
       ...
       listHolder_0->mList[i_0].name = [self asCharSpan:element_0.name];
           ...
           listHolder_0->mList[i_0].status = static_cast<std::remove_reference_t<decltype(listHolder_0->mList[i_0].status)>>(element_0.status.unsignedCharValue);
      }
              cppValue = ListType_0(listHolder_0->mList, value.count);
            } else {
              cppValue = ListType_0();
      ...
      ^(Cancelable * success, Cancelable * failure) {
       ...
       if (value.postalCode != nil) {
         auto & definedValue_2 = nonNullValue_0.postalCode.Emplace();
           ...
           nonNullValue_0.lineupInfoType = static_cast<std::remove_reference_t<decltype(nonNullValue_0.lineupInfoType)>>(value.lineupInfoType.unsignedCharValue);
  }
        auto successFn = Callback<CHIPDefaultSuccessCallbackType>::FromCancelable(success);
        auto failureFn = Callback<CHIPDefaultFailureCallbackType>::FromCancelable(failure);
        return self.cppCluster.WriteAttribute<TypeInfo>(cppValue, successFn->mContext, successFn->mCall, failureFn->mCall);
      ...
      ^(Cancelable * success, Cancelable * failure) {
       ...
       listHolder_0->mList[i_0].hardwareAddress = [self asByteSpan:element_0.hardwareAddress];
       {
         ...
         if (element_0.iPv4Addresses.count != 0) {
           ...
           listHolder_0->mList[i_0].IPv4Addresses = ListType_2(listHolder_2->mList, element_0.iPv4Addresses.count);
         } else {
       ...
       }
       {
         ...
         if (element_0.iPv6Addresses.count != 0) {
           ...
           listHolder_0->mList[i_0].IPv6Addresses = ListType_2(listHolder_2->mList, element_0.iPv6Addresses.count);
         } else {
            ...
            if (value.count != 0) {
              ...
              for (size_t i_0 = 0; i_0 < value.count; ++i_0) {
                ...
                auto element_0 = (CHIPMediaInputClusterInputInfo *)value[i_0];
                             listHolder_0->mList[i_0].index = element_0.index.unsignedCharValue;
           listHolder_0->mList[i_0].inputType = static_cast<std::remove_reference_t<decltype(listHolder_0->mList[i_0].inputType)>>(element_0.inputType.unsignedCharValue);
       listHolder_0->mList[i_0].name = [self asCharSpan:element_0.name];
