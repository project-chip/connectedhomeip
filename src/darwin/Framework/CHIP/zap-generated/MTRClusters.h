...
- (NSDictionary<NSString *, id> * _Nullable)readAttributeUnionSensorListWithParams:(MTRReadParams * _Nullable)params MTR_PROVISIONALLY_AVAILABLE;

- (NSDictionary<NSString *, id> * _Nullable)readAttributeUnionSensorHealthWithParams:(MTRReadParams * _Nullable)params MTR_PROVISIONALLY_AVAILABLE;
...
- (NSDictionary<NSString *, id> * _Nullable)readAttributeZoneSensorListWithParams:(MTRReadParams * _Nullable)params MTR_PROVISIONALLY_AVAILABLE;
