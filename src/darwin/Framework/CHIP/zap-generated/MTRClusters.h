...
- (NSDictionary<NSString *, id> * _Nullable)readAttributeActiveNetworkFaultsWithParams:(MTRReadParams * _Nullable)params MTR_PROVISIONALLY_AVAILABLE;
 ...
 */
MTR_PROVISIONALLY_AVAILABLE
@interface MTRClusterMicrowaveOvenMode : MTRCluster
 ...
 */
MTR_PROVISIONALLY_AVAILABLE
@interface MTRClusterMicrowaveOvenControl : MTRCluster
