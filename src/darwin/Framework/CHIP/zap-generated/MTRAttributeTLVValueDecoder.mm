...
static id _Nullable DecodeAttributeValueForMulticastCluster(AttributeId aAttributeId, TLV::TLVReader & aReader, CHIP_ERROR * aError)
{
    using namespace Clusters::Multicast;
    switch (aAttributeId) {
    case Attributes::Targets::Id: {
        using TypeInfo = Attributes::Targets::TypeInfo;
        TypeInfo::DecodableType cppValue;
        *aError = DataModel::Decode(aReader, cppValue);
        if (*aError != CHIP_NO_ERROR) {
            return nil;
        ...
        { // Scope for our temporary variables
            ...
            while (iter_0.Next()) {
                auto & entry_0 = iter_0.GetValue();
                MTRMulticastClusterMulticastTargetStruct * newElement_0;
                newElement_0 = [MTRMulticastClusterMulticastTargetStruct new];
                newElement_0.groupId = [NSNumber numberWithUnsignedShort:entry_0.groupId];
                { // Scope for our temporary variables
                    auto * array_2 = [NSMutableArray new];
                    auto iter_2 = entry_0.endpoints.begin();
    ...
    default: {
        // Not a known Multicast attribute.
        break;
    }
    }
...
id _Nullable MTRDecodeAttributeValue(const ConcreteAttributePath & aPath, TLV::TLVReader & aReader, CHIP_ERROR * aError)
{
    ...
    case Clusters::Multicast::Id: {
        return DecodeAttributeValueForMulticastCluster(aPath.mAttributeId, aReader, aError);
    }
