        ...
        { // Scope for our temporary variables
            ...
            while (iter_0.Next()) {
                ...
                if (entry_0.transportOptions.HasValue()) {
                    ...
                    if (entry_0.transportOptions.Value().metadataOptions.HasValue()) {
                        newElement_0.transportOptions.metadataOptions = [MTRPushAVStreamTransportClusterMetadataOptionsStruct new];
                        newElement_0.transportOptions.metadataOptions.multiplexing = [NSNumber numberWithUnsignedChar:chip::to_underlying(entry_0.transportOptions.Value().metadataOptions.Value().multiplexing)];
                        newElement_0.transportOptions.metadataOptions.includeMotionZones = [NSNumber numberWithBool:entry_0.transportOptions.Value().metadataOptions.Value().includeMotionZones];
                        newElement_0.transportOptions.metadataOptions.enableMetadataPrivacySensitive = [NSNumber numberWithBool:entry_0.transportOptions.Value().metadataOptions.Value().enableMetadataPrivacySensitive];
                    } else {
                        newElement_0.transportOptions.metadataOptions = nil;
                    }
