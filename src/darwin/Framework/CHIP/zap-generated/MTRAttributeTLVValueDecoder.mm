        ...
        *aError = DataModel::Decode(aReader, cppValue);
        ...
        { // Scope for our temporary variables
            ...
            while (iter_0.Next()) {
                ...
                newElement_0.key = [NSData dataWithBytes:entry_0.key.data() length:entry_0.key.size()];
                newElement_0.fabricIndex = [NSNumber numberWithUnsignedChar:entry_0.fabricIndex];
                [array_0 addObject:newElement_0];
            }
            CHIP_ERROR err = iter_0.GetStatus();
    ...
    case Attributes::SpinSpeeds::Id: {
        ...
        *aError = DataModel::Decode(aReader, cppValue);
        ...
        { // Scope for our temporary variables
            ...
            while (iter_0.Next()) {
                auto & entry_0 = iter_0.GetValue();
                MTRWasherControlsClusterSpinSpeedIndex * newElement_0;
                newElement_0 = [MTRWasherControlsClusterSpinSpeedIndex new];
                newElement_0.washerControlsID = [NSNumber numberWithUnsignedChar:chip::to_underlying(entry_0.washerControlsID)];
                newElement_0.washerControlsLabel = [[NSString alloc] initWithBytes:entry_0.washerControlsLabel.data()
                                                                            length:entry_0.washerControlsLabel.size()
                                                                          encoding:NSUTF8StringEncoding];
                [array_0 addObject:newElement_0];
            }
            CHIP_ERROR err = iter_0.GetStatus();
