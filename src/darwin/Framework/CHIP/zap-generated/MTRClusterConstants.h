...
typedef NS_ENUM(uint32_t, MTRCommandIDType) {
    ...
    MTRCommandIDTypeClusterUnitTestingCommandTestBatchHelperResponseID MTR_NEWLY_AVAILABLE = 0x0000000C,
    ...
    MTRCommandIDTypeClusterUnitTestingCommandTestBatchHelperRequestID MTR_NEWLY_AVAILABLE = 0x00000016,
    MTRCommandIDTypeClusterUnitTestingCommandTestSecondBatchHelperRequestID MTR_NEWLY_AVAILABLE = 0x00000017,
