...
typedef NS_ENUM(uint32_t, MTRAttributeIDType) {
    ...
    MTRAttributeIDTypeClusterCameraAVStreamManagementAttributeMaxPreRollBufferSizeID MTR_PROVISIONALLY_AVAILABLE = 0x00000006,
    ...
    MTRAttributeIDTypeClusterCameraAVStreamManagementAttributeHDRCapableID MTR_PROVISIONALLY_AVAILABLE = 0x0000000B,
    MTRAttributeIDTypeClusterCameraAVStreamManagementAttributeMaxNetworkBandwidthID MTR_PROVISIONALLY_AVAILABLE = 0x0000000C,
    MTRAttributeIDTypeClusterCameraAVStreamManagementAttributeCurrentFrameRateID MTR_PROVISIONALLY_AVAILABLE = 0x0000000D,
    MTRAttributeIDTypeClusterCameraAVStreamManagementAttributeHDRModeID MTR_PROVISIONALLY_AVAILABLE = 0x0000000E,
    MTRAttributeIDTypeClusterCameraAVStreamManagementAttributeCurrentVideoCodecsID MTR_PROVISIONALLY_AVAILABLE = 0x0000000F,
    MTRAttributeIDTypeClusterCameraAVStreamManagementAttributeCurrentSnapshotConfigID MTR_PROVISIONALLY_AVAILABLE = 0x00000010,
    MTRAttributeIDTypeClusterCameraAVStreamManagementAttributeFabricsUsingCameraID MTR_PROVISIONALLY_AVAILABLE = 0x00000011,
    MTRAttributeIDTypeClusterCameraAVStreamManagementAttributeAllocatedVideoStreamsID MTR_PROVISIONALLY_AVAILABLE = 0x00000012,
    MTRAttributeIDTypeClusterCameraAVStreamManagementAttributeAllocatedAudioStreamsID MTR_PROVISIONALLY_AVAILABLE = 0x00000013,
    MTRAttributeIDTypeClusterCameraAVStreamManagementAttributeAllocatedSnapshotStreamsID MTR_PROVISIONALLY_AVAILABLE = 0x00000014,
    MTRAttributeIDTypeClusterCameraAVStreamManagementAttributeRankedVideoStreamPrioritiesListID MTR_PROVISIONALLY_AVAILABLE = 0x00000015,
    MTRAttributeIDTypeClusterCameraAVStreamManagementAttributeSoftRecordingPrivacyModeSettingID MTR_PROVISIONALLY_AVAILABLE = 0x00000016,
    MTRAttributeIDTypeClusterCameraAVStreamManagementAttributeSoftLivestreamPrivacyModeSettingID MTR_PROVISIONALLY_AVAILABLE = 0x00000017,
    MTRAttributeIDTypeClusterCameraAVStreamManagementAttributeHardPrivacyModeID MTR_PROVISIONALLY_AVAILABLE = 0x00000018,
    MTRAttributeIDTypeClusterCameraAVStreamManagementAttributeNightVisionID MTR_PROVISIONALLY_AVAILABLE = 0x00000019,
    MTRAttributeIDTypeClusterCameraAVStreamManagementAttributeNightVisionIllumID MTR_PROVISIONALLY_AVAILABLE = 0x0000001A,
    MTRAttributeIDTypeClusterCameraAVStreamManagementAttributeAWBID MTR_PROVISIONALLY_AVAILABLE = 0x0000001B,
    MTRAttributeIDTypeClusterCameraAVStreamManagementAttributeShutterSpeedID MTR_PROVISIONALLY_AVAILABLE = 0x0000001C,
    MTRAttributeIDTypeClusterCameraAVStreamManagementAttributeISOID MTR_PROVISIONALLY_AVAILABLE = 0x0000001D,
    MTRAttributeIDTypeClusterCameraAVStreamManagementAttributeViewportID MTR_PROVISIONALLY_AVAILABLE = 0x0000001E,
    MTRAttributeIDTypeClusterCameraAVStreamManagementAttributeSpeakerEnabledID MTR_PROVISIONALLY_AVAILABLE = 0x0000001F,
    MTRAttributeIDTypeClusterCameraAVStreamManagementAttributeSpeakerVolumeLevelID MTR_PROVISIONALLY_AVAILABLE = 0x00000020,
    MTRAttributeIDTypeClusterCameraAVStreamManagementAttributeSpeakerMaxLevelID MTR_PROVISIONALLY_AVAILABLE = 0x00000021,
    MTRAttributeIDTypeClusterCameraAVStreamManagementAttributeSpeakerMinLevelID MTR_PROVISIONALLY_AVAILABLE = 0x00000022,
    MTRAttributeIDTypeClusterCameraAVStreamManagementAttributeMicStatusID MTR_PROVISIONALLY_AVAILABLE = 0x00000023,
    MTRAttributeIDTypeClusterCameraAVStreamManagementAttributeMicVolumeLevelID MTR_PROVISIONALLY_AVAILABLE = 0x00000024,
    MTRAttributeIDTypeClusterCameraAVStreamManagementAttributeMicMaxLevelID MTR_PROVISIONALLY_AVAILABLE = 0x00000025,
    MTRAttributeIDTypeClusterCameraAVStreamManagementAttributeMicMinLevelID MTR_PROVISIONALLY_AVAILABLE = 0x00000026,
    MTRAttributeIDTypeClusterCameraAVStreamManagementAttributeMicAGCEnabledID MTR_PROVISIONALLY_AVAILABLE = 0x00000027,
    MTRAttributeIDTypeClusterCameraAVStreamManagementAttributeImageRotationID MTR_PROVISIONALLY_AVAILABLE = 0x00000028,
    MTRAttributeIDTypeClusterCameraAVStreamManagementAttributeImageFlipHorizontalID MTR_PROVISIONALLY_AVAILABLE = 0x00000029,
    MTRAttributeIDTypeClusterCameraAVStreamManagementAttributeImageFlipVerticalID MTR_PROVISIONALLY_AVAILABLE = 0x0000002A,
    MTRAttributeIDTypeClusterCameraAVStreamManagementAttributeLocalVideoRecordingEnabledID MTR_PROVISIONALLY_AVAILABLE = 0x0000002B,
    MTRAttributeIDTypeClusterCameraAVStreamManagementAttributeLocalSnapshotRecordingEnabledID MTR_PROVISIONALLY_AVAILABLE = 0x0000002C,
    MTRAttributeIDTypeClusterCameraAVStreamManagementAttributeStatusLightID MTR_PROVISIONALLY_AVAILABLE = 0x0000002D,
    MTRAttributeIDTypeClusterCameraAVStreamManagementAttributeStatusLightBrightnessID MTR_PROVISIONALLY_AVAILABLE = 0x0000002E,
    MTRAttributeIDTypeClusterCameraAVStreamManagementAttributeDepthSensorStatusID MTR_PROVISIONALLY_AVAILABLE = 0x0000002F,
    MTRAttributeIDTypeClusterCameraAVStreamManagementAttributeWatermarkEnabledID MTR_PROVISIONALLY_AVAILABLE = 0x00000030,
    MTRAttributeIDTypeClusterCameraAVStreamManagementAttributeOSDEnabledID MTR_PROVISIONALLY_AVAILABLE = 0x00000031,
...
typedef NS_ENUM(uint32_t, MTRCommandIDType) {
    ...
    MTRCommandIDTypeClusterCameraAVStreamManagementCommandSetWatermarkID MTR_PROVISIONALLY_AVAILABLE = 0x00000011,
    MTRCommandIDTypeClusterCameraAVStreamManagementCommandSetOSDID MTR_PROVISIONALLY_AVAILABLE = 0x00000012,
