...
typedef NS_ENUM(uint32_t, MTRClusterAttributeIDType) {
    ...
    // Cluster Test attributes
    MTRClusterTestAttributeBooleanID = 0x00000000,
    MTRClusterTestAttributeBitmap8ID = 0x00000001,
    MTRClusterTestAttributeBitmap16ID = 0x00000002,
    MTRClusterTestAttributeBitmap32ID = 0x00000003,
    MTRClusterTestAttributeBitmap64ID = 0x00000004,
    MTRClusterTestAttributeInt8uID = 0x00000005,
    MTRClusterTestAttributeInt16uID = 0x00000006,
    MTRClusterTestAttributeInt24uID = 0x00000007,
    MTRClusterTestAttributeInt32uID = 0x00000008,
    MTRClusterTestAttributeInt40uID = 0x00000009,
    MTRClusterTestAttributeInt48uID = 0x0000000A,
    MTRClusterTestAttributeInt56uID = 0x0000000B,
    MTRClusterTestAttributeInt64uID = 0x0000000C,
    MTRClusterTestAttributeInt8sID = 0x0000000D,
    MTRClusterTestAttributeInt16sID = 0x0000000E,
    MTRClusterTestAttributeInt24sID = 0x0000000F,
    MTRClusterTestAttributeInt32sID = 0x00000010,
    MTRClusterTestAttributeInt40sID = 0x00000011,
    MTRClusterTestAttributeInt48sID = 0x00000012,
    MTRClusterTestAttributeInt56sID = 0x00000013,
    MTRClusterTestAttributeInt64sID = 0x00000014,
    MTRClusterTestAttributeEnum8ID = 0x00000015,
    MTRClusterTestAttributeEnum16ID = 0x00000016,
    MTRClusterTestAttributeFloatSingleID = 0x00000017,
    MTRClusterTestAttributeFloatDoubleID = 0x00000018,
    MTRClusterTestAttributeOctetStringID = 0x00000019,
    MTRClusterTestAttributeListInt8uID = 0x0000001A,
    MTRClusterTestAttributeListOctetStringID = 0x0000001B,
    MTRClusterTestAttributeListStructOctetStringID = 0x0000001C,
    MTRClusterTestAttributeLongOctetStringID = 0x0000001D,
    MTRClusterTestAttributeCharStringID = 0x0000001E,
    MTRClusterTestAttributeLongCharStringID = 0x0000001F,
    MTRClusterTestAttributeEpochUsID = 0x00000020,
    MTRClusterTestAttributeEpochSID = 0x00000021,
    MTRClusterTestAttributeVendorIdID = 0x00000022,
    MTRClusterTestAttributeListNullablesAndOptionalsStructID = 0x00000023,
    MTRClusterTestAttributeEnumAttrID = 0x00000024,
    MTRClusterTestAttributeStructAttrID = 0x00000025,
    MTRClusterTestAttributeRangeRestrictedInt8uID = 0x00000026,
    MTRClusterTestAttributeRangeRestrictedInt8sID = 0x00000027,
    MTRClusterTestAttributeRangeRestrictedInt16uID = 0x00000028,
    MTRClusterTestAttributeRangeRestrictedInt16sID = 0x00000029,
    MTRClusterTestAttributeListLongOctetStringID = 0x0000002A,
    MTRClusterTestAttributeListFabricScopedID = 0x0000002B,
    MTRClusterTestAttributeTimedWriteBooleanID = 0x00000030,
    MTRClusterTestAttributeGeneralErrorBooleanID = 0x00000031,
    MTRClusterTestAttributeClusterErrorBooleanID = 0x00000032,
    MTRClusterTestAttributeUnsupportedID = 0x000000FF,
    MTRClusterTestAttributeNullableBooleanID = 0x00004000,
    MTRClusterTestAttributeNullableBitmap8ID = 0x00004001,
    MTRClusterTestAttributeNullableBitmap16ID = 0x00004002,
    MTRClusterTestAttributeNullableBitmap32ID = 0x00004003,
    MTRClusterTestAttributeNullableBitmap64ID = 0x00004004,
    MTRClusterTestAttributeNullableInt8uID = 0x00004005,
    MTRClusterTestAttributeNullableInt16uID = 0x00004006,
    MTRClusterTestAttributeNullableInt24uID = 0x00004007,
    MTRClusterTestAttributeNullableInt32uID = 0x00004008,
    MTRClusterTestAttributeNullableInt40uID = 0x00004009,
    MTRClusterTestAttributeNullableInt48uID = 0x0000400A,
    MTRClusterTestAttributeNullableInt56uID = 0x0000400B,
    MTRClusterTestAttributeNullableInt64uID = 0x0000400C,
    MTRClusterTestAttributeNullableInt8sID = 0x0000400D,
    MTRClusterTestAttributeNullableInt16sID = 0x0000400E,
    MTRClusterTestAttributeNullableInt24sID = 0x0000400F,
    MTRClusterTestAttributeNullableInt32sID = 0x00004010,
    MTRClusterTestAttributeNullableInt40sID = 0x00004011,
    MTRClusterTestAttributeNullableInt48sID = 0x00004012,
    MTRClusterTestAttributeNullableInt56sID = 0x00004013,
    MTRClusterTestAttributeNullableInt64sID = 0x00004014,
    MTRClusterTestAttributeNullableEnum8ID = 0x00004015,
    MTRClusterTestAttributeNullableEnum16ID = 0x00004016,
    MTRClusterTestAttributeNullableFloatSingleID = 0x00004017,
    MTRClusterTestAttributeNullableFloatDoubleID = 0x00004018,
    MTRClusterTestAttributeNullableOctetStringID = 0x00004019,
    MTRClusterTestAttributeNullableCharStringID = 0x0000401E,
    MTRClusterTestAttributeNullableEnumAttrID = 0x00004024,
    MTRClusterTestAttributeNullableStructID = 0x00004025,
    MTRClusterTestAttributeNullableRangeRestrictedInt8uID = 0x00004026,
    MTRClusterTestAttributeNullableRangeRestrictedInt8sID = 0x00004027,
    MTRClusterTestAttributeNullableRangeRestrictedInt16uID = 0x00004028,
    MTRClusterTestAttributeNullableRangeRestrictedInt16sID = 0x00004029,
    MTRClusterTestAttributeWriteOnlyInt8uID = 0x0000402A,
    MTRClusterTestAttributeGeneratedCommandListID = MTRClusterGlobalAttributeGeneratedCommandListID,
    MTRClusterTestAttributeAcceptedCommandListID = MTRClusterGlobalAttributeAcceptedCommandListID,
    MTRClusterTestAttributeAttributeListID = MTRClusterGlobalAttributeAttributeListID,
    MTRClusterTestAttributeFeatureMapID = MTRClusterGlobalAttributeFeatureMapID,
    MTRClusterTestAttributeClusterRevisionID = MTRClusterGlobalAttributeClusterRevisionID,
...
typedef NS_ENUM(uint32_t, MTRClusterCommandIDType) {
    ...
    MTRClusterTestCommandTestID = 0x00000000,
    MTRClusterTestCommandTestSpecificResponseID = 0x00000000,
    MTRClusterTestCommandTestNotHandledID = 0x00000001,
    MTRClusterTestCommandTestAddArgumentsResponseID = 0x00000001,
    MTRClusterTestCommandTestSpecificID = 0x00000002,
    MTRClusterTestCommandTestSimpleArgumentResponseID = 0x00000002,
    MTRClusterTestCommandTestUnknownCommandID = 0x00000003,
    MTRClusterTestCommandTestStructArrayArgumentResponseID = 0x00000003,
    MTRClusterTestCommandTestAddArgumentsID = 0x00000004,
    MTRClusterTestCommandTestListInt8UReverseResponseID = 0x00000004,
    MTRClusterTestCommandTestSimpleArgumentRequestID = 0x00000005,
    MTRClusterTestCommandTestEnumsResponseID = 0x00000005,
    MTRClusterTestCommandTestStructArrayArgumentRequestID = 0x00000006,
    MTRClusterTestCommandTestNullableOptionalResponseID = 0x00000006,
    MTRClusterTestCommandTestStructArgumentRequestID = 0x00000007,
    MTRClusterTestCommandTestComplexNullableOptionalResponseID = 0x00000007,
    MTRClusterTestCommandTestNestedStructArgumentRequestID = 0x00000008,
    MTRClusterTestCommandBooleanResponseID = 0x00000008,
    MTRClusterTestCommandTestListStructArgumentRequestID = 0x00000009,
    MTRClusterTestCommandSimpleStructResponseID = 0x00000009,
    MTRClusterTestCommandTestListInt8UArgumentRequestID = 0x0000000A,
    MTRClusterTestCommandTestEmitTestEventResponseID = 0x0000000A,
    MTRClusterTestCommandTestNestedStructListArgumentRequestID = 0x0000000B,
    MTRClusterTestCommandTestEmitTestFabricScopedEventResponseID = 0x0000000B,
    MTRClusterTestCommandTestListNestedStructListArgumentRequestID = 0x0000000C,
    MTRClusterTestCommandTestListInt8UReverseRequestID = 0x0000000D,
    MTRClusterTestCommandTestEnumsRequestID = 0x0000000E,
    MTRClusterTestCommandTestNullableOptionalRequestID = 0x0000000F,
    MTRClusterTestCommandTestComplexNullableOptionalRequestID = 0x00000010,
    MTRClusterTestCommandSimpleStructEchoRequestID = 0x00000011,
    MTRClusterTestCommandTimedInvokeRequestID = 0x00000012,
    MTRClusterTestCommandTestSimpleOptionalArgumentRequestID = 0x00000013,
    MTRClusterTestCommandTestEmitTestEventRequestID = 0x00000014,
    MTRClusterTestCommandTestEmitTestFabricScopedEventRequestID = 0x00000015,
...
typedef NS_ENUM(uint32_t, MTRClusterEventIDType) {
    ...
    // Cluster Test events
    MTRClusterTestEventTestEventID = 0x00000001,
    MTRClusterTestEventTestFabricScopedEventID = 0x00000002,
