...
NSString * MTRAttributeNameForID(MTRClusterIDType clusterID, MTRAttributeIDType attributeID)
{
    ...
    case MTRClusterIDTypeMulticastID:
        ...
        case MTRAttributeIDTypeClusterMulticastAttributeTargetsID:
            result = @"Targets";
            break;
...
NSString * MTRRequestCommandNameForID(MTRClusterIDType clusterID, MTRCommandIDType commandID)
{
    ...
    case MTRClusterIDTypeMulticastID:
        ...
        case MTRCommandIDTypeClusterMulticastCommandSetTargetID:
            result = @"SetTarget";
            break;

        case MTRCommandIDTypeClusterMulticastCommandRemoveTargetID:
            result = @"RemoveTarget";
            break;
