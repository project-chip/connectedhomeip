...
- (NSString *)description
{
    NSString * descriptionString = [NSString stringWithFormat:@"<%@: requestId:%@; clientNodeId:%@; statusCode:%@; >", NSStringFromClass([self class]), _requestId, _clientNodeId, _statusCode];
    return descriptionString;
}
