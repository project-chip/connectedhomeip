...
@implementation MTRWasherControlsClusterErrorStateStruct
- (instancetype)init
{
    if (self = [super init]) {
...
- (id)copyWithZone:(NSZone * _Nullable)zone
{
    auto other = [[MTRWasherControlsClusterErrorStateStruct alloc] init];
...
@implementation MTRWasherControlsClusterSpinSpeedIndex
- (instancetype)init
{
    if (self = [super init]) {
...
- (id)copyWithZone:(NSZone * _Nullable)zone
{
    auto other = [[MTRWasherControlsClusterSpinSpeedIndex alloc] init];

    other.washerControlsID = self.washerControlsID;
    other.washerControlsLabel = self.washerControlsLabel;
...
- (NSString *)description
{
    NSString * descriptionString = [NSString stringWithFormat:@"<%@: washerControlsID:%@; washerControlsLabel:%@; >",
                                             NSStringFromClass([self class]), _washerControlsID, _washerControlsLabel];
    return descriptionString;
}

@end

@implementation MTRWasherControlsClusterOperationalErrorEvent
- (instancetype)init
{
    if (self = [super init]) {

        _errorState = [MTRWasherControlsClusterErrorStateStruct new];
    }
    return self;
}
...
- (id)copyWithZone:(NSZone * _Nullable)zone
{
    auto other = [[MTRWasherControlsClusterOperationalErrorEvent alloc] init];
...
@implementation MTRWasherControlsClusterOperationCompletionEvent
- (instancetype)init
{
    if (self = [super init]) {
...
- (id)copyWithZone:(NSZone * _Nullable)zone
{
    auto other = [[MTRWasherControlsClusterOperationCompletionEvent alloc] init];
