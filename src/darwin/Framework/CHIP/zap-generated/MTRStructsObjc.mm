...
@implementation MTRJointFabricDatastoreClusterDatastoreEndpointGroupIDEntry
- (instancetype)init
{
    if (self = [super init]) {
...
- (id)copyWithZone:(NSZone * _Nullable)zone
{
    auto other = [[MTRJointFabricDatastoreClusterDatastoreEndpointGroupIDEntry alloc] init];
...
@implementation MTRJointFabricDatastoreClusterDatastoreEndpointBindingEntry
- (instancetype)init
{
    if (self = [super init]) {
        ...
        _binding = [MTRJointFabricDatastoreClusterTargetStruct new];
...
- (id)copyWithZone:(NSZone * _Nullable)zone
{
    auto other = [[MTRJointFabricDatastoreClusterDatastoreEndpointBindingEntry alloc] init];
...
- (instancetype)init
{
    if (self = [super init]) {
        ...
        _aclEntry = [MTRJointFabricDatastoreClusterAccessControlEntryStruct new];
