...
- (NSString *)description
{
  NSString *descriptionString = [NSString stringWithFormat:@"<%@: mode:%@; groupIdFrom:%@; sceneIdFrom:%@; groupIdTo:%@; sceneIdTo:%@; >", NSStringFromClass([self class]) ,_mode,_groupIdFrom,_sceneIdFrom,_groupIdTo,_sceneIdTo];
  return descriptionString;
}
...
- (NSString *)description
{
  NSString *descriptionString = [NSString stringWithFormat:@"<%@: status:%@; groupIdFrom:%@; sceneIdFrom:%@; >", NSStringFromClass([self class]) ,_status,_groupIdFrom,_sceneIdFrom];
  return descriptionString;
}
...
- (NSString *)description
{
  NSString *descriptionString = [NSString stringWithFormat:@"<%@: effectId:%@; effectVariant:%@; >", NSStringFromClass([self class]) ,_effectId,_effectVariant];
  return descriptionString;
}
...
- (NSString *)description
{
  NSString *descriptionString = [NSString stringWithFormat:@"<%@: level:%@; transitionTime:%@; optionMask:%@; optionOverride:%@; >", NSStringFromClass([self class]) ,_level,_transitionTime,_optionMask,_optionOverride];
  return descriptionString;
}
...
- (NSString *)description
{
  NSString *descriptionString = [NSString stringWithFormat:@"<%@: moveMode:%@; rate:%@; optionMask:%@; optionOverride:%@; >", NSStringFromClass([self class]) ,_moveMode,_rate,_optionMask,_optionOverride];
  return descriptionString;
}
...
- (NSString *)description
{
  NSString *descriptionString = [NSString stringWithFormat:@"<%@: stepMode:%@; stepSize:%@; transitionTime:%@; optionMask:%@; optionOverride:%@; >", NSStringFromClass([self class]) ,_stepMode,_stepSize,_transitionTime,_optionMask,_optionOverride];
  return descriptionString;
}
...
- (NSString *)description
{
  NSString *descriptionString = [NSString stringWithFormat:@"<%@: optionMask:%@; optionOverride:%@; >", NSStringFromClass([self class]) ,_optionMask,_optionOverride];
  return descriptionString;
}
...
- (NSString *)description
{
  NSString *descriptionString = [NSString stringWithFormat:@"<%@: level:%@; transitionTime:%@; >", NSStringFromClass([self class]) ,_level,_transitionTime];
  return descriptionString;
}
...
- (NSString *)description
{
  NSString *descriptionString = [NSString stringWithFormat:@"<%@: moveMode:%@; rate:%@; >", NSStringFromClass([self class]) ,_moveMode,_rate];
  return descriptionString;
}
...
- (NSString *)description
{
  NSString *descriptionString = [NSString stringWithFormat:@"<%@: stepMode:%@; stepSize:%@; transitionTime:%@; >", NSStringFromClass([self class]) ,_stepMode,_stepSize,_transitionTime];
  return descriptionString;
}
...
- (NSString *)description
{
  NSString *descriptionString = [NSString stringWithFormat:@"<%@: alarmCode:%@; clusterId:%@; >", NSStringFromClass([self class]) ,_alarmCode,_clusterId];
  return descriptionString;
}
...
- (NSString *)description
{
  NSString *descriptionString = [NSString stringWithFormat:@"<%@: status:%@; alarmCode:%@; clusterId:%@; timeStamp:%@; >", NSStringFromClass([self class]) ,_status,_alarmCode,_clusterId,_timeStamp];
  return descriptionString;
}
...
- (NSString *)description
{
  NSString *descriptionString = [NSString stringWithFormat:@"<%@: powerProfileId:%@; >", NSStringFromClass([self class]) ,_powerProfileId];
  return descriptionString;
}
...
- (NSString *)description
{
  NSString *descriptionString = [NSString stringWithFormat:@"<%@: totalProfileNum:%@; powerProfileId:%@; numOfTransferredPhases:%@; transferredPhases:%@; >", NSStringFromClass([self class]) ,_totalProfileNum,_powerProfileId,_numOfTransferredPhases,_transferredPhases];
  return descriptionString;
}
...
- (NSString *)description
{
  NSString *descriptionString = [NSString stringWithFormat:@"<%@: powerProfileId:%@; currency:%@; price:%@; priceTrailingDigit:%@; >", NSStringFromClass([self class]) ,_powerProfileId,_currency,_price,_priceTrailingDigit];
  return descriptionString;
}
...
- (NSString *)description
{
  NSString *descriptionString = [NSString stringWithFormat:@"<%@: powerProfileCount:%@; powerProfileRecords:%@; >", NSStringFromClass([self class]) ,_powerProfileCount,_powerProfileRecords];
  return descriptionString;
}
...
- (NSString *)description
{
  NSString *descriptionString = [NSString stringWithFormat:@"<%@: currency:%@; price:%@; priceTrailingDigit:%@; >", NSStringFromClass([self class]) ,_currency,_price,_priceTrailingDigit];
  return descriptionString;
}
...
- (NSString *)description
{
  NSString *descriptionString = [NSString stringWithFormat:@"<%@: powerProfileId:%@; numOfScheduledPhases:%@; scheduledPhases:%@; >", NSStringFromClass([self class]) ,_powerProfileId,_numOfScheduledPhases,_scheduledPhases];
  return descriptionString;
}
...
- (NSString *)description
{
  NSString *descriptionString = [NSString stringWithFormat:@"<%@: powerProfileId:%@; startAfter:%@; stopBefore:%@; >", NSStringFromClass([self class]) ,_powerProfileId,_startAfter,_stopBefore];
  return descriptionString;
}
...
- (NSString *)description
{
  NSString *descriptionString = [NSString stringWithFormat:@"<%@: options:%@; powerProfileId:%@; powerProfileStartTime:%@; >", NSStringFromClass([self class]) ,_options,_powerProfileId,_powerProfileStartTime];
  return descriptionString;
}
...
- (NSString *)description
{
  NSString *descriptionString = [NSString stringWithFormat:@"<%@: applianceStatus:%@; remoteEnableFlagsAndDeviceStatus2:%@; applianceStatus2:%@; >", NSStringFromClass([self class]) ,_applianceStatus,_remoteEnableFlagsAndDeviceStatus2,_applianceStatus2];
  return descriptionString;
}
...
- (NSString *)description
{
  NSString *descriptionString = [NSString stringWithFormat:@"<%@: functionId:%@; functionDataType:%@; functionData:%@; >", NSStringFromClass([self class]) ,_functionId,_functionDataType,_functionData];
  return descriptionString;
}
...
- (NSString *)description
{
  NSString *descriptionString = [NSString stringWithFormat:@"<%@: warningEvent:%@; >", NSStringFromClass([self class]) ,_warningEvent];
  return descriptionString;
}
...
- (NSString *)description
{
  NSString *descriptionString = [NSString stringWithFormat:@"<%@: startFastPolling:%@; fastPollTimeout:%@; >", NSStringFromClass([self class]) ,_startFastPolling,_fastPollTimeout];
  return descriptionString;
}
...
- (NSString *)description
{
  NSString *descriptionString = [NSString stringWithFormat:@"<%@: newLongPollInterval:%@; >", NSStringFromClass([self class]) ,_newLongPollInterval];
  return descriptionString;
}
...
- (NSString *)description
{
  NSString *descriptionString = [NSString stringWithFormat:@"<%@: newShortPollInterval:%@; >", NSStringFromClass([self class]) ,_newShortPollInterval];
  return descriptionString;
}
...
- (NSString *)description
{
  NSString *descriptionString = [NSString stringWithFormat:@"<%@: intent:%@; requestedProtocol:%@; transferFileDesignator:%@; >", NSStringFromClass([self class]) ,_intent,_requestedProtocol,[_transferFileDesignator base64EncodedStringWithOptions:0]];
  return descriptionString;
}
...
- (NSString *)description
{
  NSString *descriptionString = [NSString stringWithFormat:@"<%@: status:%@; content:%@; timeStamp:%@; timeSinceBoot:%@; >", NSStringFromClass([self class]) ,_status,[_content base64EncodedStringWithOptions:0],_timeStamp,_timeSinceBoot];
  return descriptionString;
}
...
- (NSString *)description
{
  NSString *descriptionString = [NSString stringWithFormat:@"<%@: commissioningTimeout:%@; pakeVerifier:%@; discriminator:%@; iterations:%@; salt:%@; >", NSStringFromClass([self class]) ,_commissioningTimeout,[_pakeVerifier base64EncodedStringWithOptions:0],_discriminator,_iterations,[_salt base64EncodedStringWithOptions:0]];
  return descriptionString;
}
...
- (NSString *)description
{
  NSString *descriptionString = [NSString stringWithFormat:@"<%@: attestationElements:%@; signature:%@; >", NSStringFromClass([self class]) ,[_attestationElements base64EncodedStringWithOptions:0],[_signature base64EncodedStringWithOptions:0]];
  return descriptionString;
}
...
- (NSString *)description
{
  NSString *descriptionString = [NSString stringWithFormat:@"<%@: rootCertificate:%@; >", NSStringFromClass([self class]) ,[_rootCertificate base64EncodedStringWithOptions:0]];
  return descriptionString;
}
...
- (NSString *)description
{
  NSString *descriptionString = [NSString stringWithFormat:@"<%@: colorTemperature:%@; transitionTime:%@; optionsMask:%@; optionsOverride:%@; >", NSStringFromClass([self class]) ,_colorTemperature,_transitionTime,_optionsMask,_optionsOverride];
  return descriptionString;
}
...
- (NSString *)description
{
  NSString *descriptionString = [NSString stringWithFormat:@"<%@: messageId:%@; messageControl:%@; startTime:%@; durationInMinutes:%@; message:%@; optionalExtendedMessageControl:%@; >", NSStringFromClass([self class]) ,_messageId,_messageControl,_startTime,_durationInMinutes,_message,_optionalExtendedMessageControl];
  return descriptionString;
}
...
- (NSString *)description
{
  NSString *descriptionString = [NSString stringWithFormat:@"<%@: messageId:%@; messageControl:%@; >", NSStringFromClass([self class]) ,_messageId,_messageControl];
  return descriptionString;
}
...
- (NSString *)description
{
  NSString *descriptionString = [NSString stringWithFormat:@"<%@: messageId:%@; confirmationTime:%@; messageConfirmationControl:%@; messageResponse:%@; >", NSStringFromClass([self class]) ,_messageId,_confirmationTime,_messageConfirmationControl,[_messageResponse base64EncodedStringWithOptions:0]];
  return descriptionString;
}
...
- (NSString *)description
{
  NSString *descriptionString = [NSString stringWithFormat:@"<%@: earliestImplementationTime:%@; >", NSStringFromClass([self class]) ,_earliestImplementationTime];
  return descriptionString;
}
...
- (NSString *)description
{
  NSString *descriptionString = [NSString stringWithFormat:@"<%@: implementationDateTime:%@; >", NSStringFromClass([self class]) ,_implementationDateTime];
  return descriptionString;
}
...
- (NSString *)description
{
  NSString *descriptionString = [NSString stringWithFormat:@"<%@: alertsCount:%@; alertStructures:%@; >", NSStringFromClass([self class]) ,_alertsCount,_alertStructures];
  return descriptionString;
}
...
- (NSString *)description
{
  NSString *descriptionString = [NSString stringWithFormat:@"<%@: eventHeader:%@; eventId:%@; >", NSStringFromClass([self class]) ,_eventHeader,_eventId];
  return descriptionString;
}
...
- (NSString *)description
{
  NSString *descriptionString = [NSString stringWithFormat:@"<%@: timeStamp:%@; logId:%@; logLength:%@; logPayload:%@; >", NSStringFromClass([self class]) ,_timeStamp,_logId,_logLength,_logPayload];
  return descriptionString;
}
...
- (NSString *)description
{
  NSString *descriptionString = [NSString stringWithFormat:@"<%@: logQueueSize:%@; logIds:%@; >", NSStringFromClass([self class]) ,_logQueueSize,_logIds];
  return descriptionString;
}
