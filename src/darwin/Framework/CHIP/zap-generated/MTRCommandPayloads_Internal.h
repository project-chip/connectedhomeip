...
@interface MTRCameraAVStreamManagementClusterSetWatermarkParams (InternalMethods)

- (NSDictionary<NSString *, id> * _Nullable)_encodeAsDataValue:(NSError * __autoreleasing *)error;

@end

@interface MTRCameraAVStreamManagementClusterSetOSDParams (InternalMethods)
