...
void CHIPThreadNetworkDiagnosticsOperationalDatasetComponentsListAttributeCallbackSubscriptionBridge::OnSubscriptionEstablished(void * context)
{
     auto * self = static_cast<CHIPThreadNetworkDiagnosticsOperationalDatasetComponentsListAttributeCallbackSubscriptionBridge *>(context);
     if (!self->mQueue) {
         return;
     }
...
void CHIPIdentifyClusterIdentifyQueryResponseCallbackBridge::OnSuccessFn(void * context
...
)
{
      ...
      {
                response.sceneName = [[NSString alloc] initWithBytes:data.sceneName.data() length:data.sceneName.size() encoding:NSUTF8StringEncoding];
      }
      {
          { // Scope for our temporary variables
            auto * array_0 = [NSMutableArray new];
...
void CHIPThermostatClusterGetRelayStatusLogResponseCallbackBridge::OnSuccessFn(void * context
