...
- (void)test001_StartBrowseAndStopBrowse
{
    ...
    sMockCB.onScanForPeripheralsWithServicesOptions = ^(NSArray<CBUUID *> * _Nullable serviceUUIDs, NSDictionary<NSString *, id> * _Nullable options) {
...
- (void)test005_StartBrowseGetCommissionableOverMdnsAndBle
{
    ...
    [sMockCB addMockCommissionableMatterDeviceWithIdentifier:[NSUUID UUID]
