...
- (void)testSendClusterTestClusterCommandTest_0
{
...
- (void)testSendClusterTestClusterCommandTestNotHandled_1
{
...
- (void)testSendClusterTestClusterCommandTestSpecificCommand_2
{
    ...
    [cluster testSpecificCommand:^(NSError * err, NSDictionary * values) {
...
- (void)testSendClusterOnOffCommandOnOff_0
{
    XCTestExpectation * expectation = [self expectationWithDescription:@"Check on/off attribute value"];
    CHIPDevice * device = GetPairedDevice(kDeviceId);
    dispatch_queue_t queue = dispatch_get_main_queue();
    ...
    [cluster readAttributeOnOffWithResponseHandler:^(NSError * err, NSDictionary * values) {
        NSLog(@"Check on/off attribute value Error: %@", err);
        XCTAssertEqual(err.code, 0);
...
- (void)testSendClusterOnOffCommandOn_1
{
...
- (void)testSendClusterOnOffCommandOnOff_2
{
    XCTestExpectation * expectation = [self expectationWithDescription:@"Check on/off attribute value"];
    CHIPDevice * device = GetPairedDevice(kDeviceId);
    dispatch_queue_t queue = dispatch_get_main_queue();
...
- (void)testSendClusterOnOffCommandOff_3
{
...
- (void)testSendClusterOnOffCommandOnOff_4
{
    XCTestExpectation * expectation = [self expectationWithDescription:@"Check on/off attribute value"];
    CHIPDevice * device = GetPairedDevice(kDeviceId);
    dispatch_queue_t queue = dispatch_get_main_queue();
