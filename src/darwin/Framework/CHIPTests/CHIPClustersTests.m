...
- (void)testSendClusterPumpConfigurationAndControlReadAttributeLifetimeRunningHoursWithResponseHandler
{
    XCTestExpectation * expectation =
        [self expectationWithDescription:@"PumpConfigurationAndControlReadAttributeLifetimeRunningHoursWithResponseHandler"];
    ...
    [cluster readAttributeLifetimeRunningHoursWithResponseHandler:^(NSError * err, NSDictionary * values) {
...
- (void)testSendClusterPumpConfigurationAndControlReadAttributePowerWithResponseHandler
{
    XCTestExpectation * expectation =
        [self expectationWithDescription:@"PumpConfigurationAndControlReadAttributePowerWithResponseHandler"];
    ...
    [cluster readAttributePowerWithResponseHandler:^(NSError * err, NSDictionary * values) {
