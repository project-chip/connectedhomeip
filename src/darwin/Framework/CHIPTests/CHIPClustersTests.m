...
- (void)testSendClusterTestClusterTests_0_Test
{
...
- (void)testSendClusterTestClusterTests_1_TestNotHandled
{
...
- (void)testSendClusterTestClusterTests_2_TestSpecific
{
...
- (void)testSendClusterTestClusterTests_3_WriteAttribute
{
    XCTestExpectation * expectation = [self expectationWithDescription:@"Write attribute BOOLEAN"];
    CHIPDevice * device = GetPairedDevice(kDeviceId);
    dispatch_queue_t queue = dispatch_get_main_queue();
    CHIPTestCluster * cluster = [[CHIPTestCluster alloc] initWithDevice:device endpoint:1 queue:queue];
    XCTAssertNotNil(cluster);

    [cluster writeAttributeBooleanWithValue:1 responseHandler:^(NSError * err, NSDictionary * values) {
            NSLog(@"Write attribute BOOLEAN Error: %@", err);
        XCTAssertEqual(err.code, 0);
        [expectation fulfill];
    }];
...
- (void)testSendClusterTestClusterTests_4_ReadAttribute
{
    XCTestExpectation * expectation = [self expectationWithDescription:@"Read attribute BOOLEAN"];
    CHIPDevice * device = GetPairedDevice(kDeviceId);
    dispatch_queue_t queue = dispatch_get_main_queue();
    CHIPTestCluster * cluster = [[CHIPTestCluster alloc] initWithDevice:device endpoint:1 queue:queue];
    XCTAssertNotNil(cluster);
    ...
    [cluster readAttributeBooleanWithResponseHandler:^(NSError * err, NSDictionary * values) {
        NSLog(@"Read attribute BOOLEAN Error: %@", err);
        XCTAssertEqual(err.code, 0);
        XCTAssertEqual([values[@"value"] intValue], 1);
        [expectation fulfill];
    }];
...
{
    XCTestExpectation * expectation = [self expectationWithDescription:@"Check on/off attribute value is false when starting"];
    CHIPDevice * device = GetPairedDevice(kDeviceId);
    dispatch_queue_t queue = dispatch_get_main_queue();
    ...
    [cluster readAttributeOnOffWithResponseHandler:^(NSError * err, NSDictionary * values) {
        NSLog(@"Check on/off attribute value is false when starting Error: %@", err);
        XCTAssertEqual(err.code, 0);
        XCTAssertEqual([values[@"value"] intValue], 0);
        [expectation fulfill];
    }];

    [self waitForExpectationsWithTimeout:kTimeoutInSeconds handler:nil];
}
- (void)testSendClusterOnOffTests_1_On
{
...
- (void)testSendClusterOnOffTests_2_ReadAttribute
{
...
- (void)testSendClusterOnOffTests_3_Off
{
...
- (void)testSendClusterOnOffTests_4_ReadAttribute
{
...
- (void)testSendClusterBasicWriteAttributeLocationWithValue
{
    ...
    NSString * value = @"Test";
    [cluster writeAttributeLocationWithValue:value responseHandler:^(NSError * err, NSDictionary * values) {
        NSLog(@"Basic Location Error: %@", err);
        XCTAssertEqual(err.code, 0);
        [expectation fulfill];
    }];
...
{
    XCTestExpectation * expectation = [self expectationWithDescription:@"BasicReadAttributeHardwareVersionStringWithResponseHandler"];
...
{
    XCTestExpectation * expectation = [self expectationWithDescription:@"BasicReadAttributeSoftwareVersionStringWithResponseHandler"];
...
- (void)testSendClusterBasicWriteAttributeLocalConfigDisabledWithValue
{
    ...
    uint8_t value = 0x00;
    [cluster writeAttributeLocalConfigDisabledWithValue:value responseHandler:^(NSError * err, NSDictionary * values) {
        NSLog(@"Basic LocalConfigDisabled Error: %@", err);
        XCTAssertEqual(err.code, 0);
        [expectation fulfill];
    }];
...
{
    XCTestExpectation * expectation = [self expectationWithDescription:@"ContentLaunchReadAttributeAcceptsHeaderListWithResponseHandler"];
...
{
    XCTestExpectation * expectation = [self expectationWithDescription:@"ContentLaunchReadAttributeSupportedStreamingTypesWithResponseHandler"];
...
{
    XCTestExpectation * expectation = [self expectationWithDescription:@"ContentLaunchReadAttributeClusterRevisionWithResponseHandler"];
...
- (void)testSendClusterTestClusterWriteAttributeBooleanWithValue
{
    ...
    uint8_t value = 0;
    [cluster writeAttributeBooleanWithValue:value responseHandler:^(NSError * err, NSDictionary * values) {
        NSLog(@"TestCluster Boolean Error: %@", err);
        XCTAssertEqual(err.code, 0);
        [expectation fulfill];
    }];
...
- (void)testSendClusterTestClusterWriteAttributeBitmap8WithValue
{
    ...
    uint8_t value = 0;
    [cluster writeAttributeBitmap8WithValue:value responseHandler:^(NSError * err, NSDictionary * values) {
        NSLog(@"TestCluster Bitmap8 Error: %@", err);
        XCTAssertEqual(err.code, 0);
        [expectation fulfill];
    }];
...
- (void)testSendClusterTestClusterWriteAttributeBitmap16WithValue
{
    ...
    uint16_t value = 0;
    [cluster writeAttributeBitmap16WithValue:value responseHandler:^(NSError * err, NSDictionary * values) {
        NSLog(@"TestCluster Bitmap16 Error: %@", err);
        XCTAssertEqual(err.code, 0);
        [expectation fulfill];
    }];
...
- (void)testSendClusterTestClusterWriteAttributeBitmap32WithValue
{
    ...
    uint32_t value = 0;
    [cluster writeAttributeBitmap32WithValue:value responseHandler:^(NSError * err, NSDictionary * values) {
        NSLog(@"TestCluster Bitmap32 Error: %@", err);
        XCTAssertEqual(err.code, 0);
        [expectation fulfill];
    }];
...
- (void)testSendClusterTestClusterWriteAttributeBitmap64WithValue
{
    ...
    uint64_t value = 0;
    [cluster writeAttributeBitmap64WithValue:value responseHandler:^(NSError * err, NSDictionary * values) {
        NSLog(@"TestCluster Bitmap64 Error: %@", err);
        XCTAssertEqual(err.code, 0);
        [expectation fulfill];
    }];
...
- (void)testSendClusterTestClusterWriteAttributeInt8uWithValue
{
    ...
    uint8_t value = 0;
    [cluster writeAttributeInt8uWithValue:value responseHandler:^(NSError * err, NSDictionary * values) {
        NSLog(@"TestCluster Int8u Error: %@", err);
        XCTAssertEqual(err.code, 0);
        [expectation fulfill];
    }];
...
- (void)testSendClusterTestClusterWriteAttributeInt16uWithValue
{
    ...
    uint16_t value = 0;
    [cluster writeAttributeInt16uWithValue:value responseHandler:^(NSError * err, NSDictionary * values) {
        NSLog(@"TestCluster Int16u Error: %@", err);
        XCTAssertEqual(err.code, 0);
        [expectation fulfill];
    }];
...
- (void)testSendClusterTestClusterWriteAttributeInt32uWithValue
{
    ...
    uint32_t value = 0;
    [cluster writeAttributeInt32uWithValue:value responseHandler:^(NSError * err, NSDictionary * values) {
        NSLog(@"TestCluster Int32u Error: %@", err);
        XCTAssertEqual(err.code, 0);
        [expectation fulfill];
    }];
...
- (void)testSendClusterTestClusterWriteAttributeInt64uWithValue
{
    ...
    uint64_t value = 0;
    [cluster writeAttributeInt64uWithValue:value responseHandler:^(NSError * err, NSDictionary * values) {
        NSLog(@"TestCluster Int64u Error: %@", err);
        XCTAssertEqual(err.code, 0);
        [expectation fulfill];
    }];
...
- (void)testSendClusterTestClusterWriteAttributeInt8sWithValue
{
    ...
    int8_t value = 0;
    [cluster writeAttributeInt8sWithValue:value responseHandler:^(NSError * err, NSDictionary * values) {
        NSLog(@"TestCluster Int8s Error: %@", err);
        XCTAssertEqual(err.code, 0);
        [expectation fulfill];
    }];
...
- (void)testSendClusterTestClusterWriteAttributeInt16sWithValue
{
    ...
    int16_t value = 0;
    [cluster writeAttributeInt16sWithValue:value responseHandler:^(NSError * err, NSDictionary * values) {
        NSLog(@"TestCluster Int16s Error: %@", err);
        XCTAssertEqual(err.code, 0);
        [expectation fulfill];
    }];
...
- (void)testSendClusterTestClusterWriteAttributeInt32sWithValue
{
    ...
    int32_t value = 0;
    [cluster writeAttributeInt32sWithValue:value responseHandler:^(NSError * err, NSDictionary * values) {
        NSLog(@"TestCluster Int32s Error: %@", err);
        XCTAssertEqual(err.code, 0);
        [expectation fulfill];
    }];
...
- (void)testSendClusterTestClusterWriteAttributeInt64sWithValue
{
    ...
    int64_t value = 0;
    [cluster writeAttributeInt64sWithValue:value responseHandler:^(NSError * err, NSDictionary * values) {
        NSLog(@"TestCluster Int64s Error: %@", err);
        XCTAssertEqual(err.code, 0);
        [expectation fulfill];
    }];
...
- (void)testSendClusterTestClusterWriteAttributeEnum8WithValue
{
    ...
    uint8_t value = 0;
    [cluster writeAttributeEnum8WithValue:value responseHandler:^(NSError * err, NSDictionary * values) {
        NSLog(@"TestCluster Enum8 Error: %@", err);
        XCTAssertEqual(err.code, 0);
        [expectation fulfill];
    }];
...
- (void)testSendClusterTestClusterWriteAttributeEnum16WithValue
{
    ...
    uint16_t value = 0;
    [cluster writeAttributeEnum16WithValue:value responseHandler:^(NSError * err, NSDictionary * values) {
        NSLog(@"TestCluster Enum16 Error: %@", err);
        XCTAssertEqual(err.code, 0);
        [expectation fulfill];
    }];
...
- (void)testSendClusterTestClusterWriteAttributeOctetStringWithValue
{
    ...
    [cluster writeAttributeOctetStringWithValue:value responseHandler:^(NSError * err, NSDictionary * values) {
        NSLog(@"TestCluster OctetString Error: %@", err);
        XCTAssertEqual(err.code, 0);
        [expectation fulfill];
    }];
...
{
    XCTestExpectation * expectation = [self expectationWithDescription:@"TestClusterReadAttributeListOctetStringWithResponseHandler"];
...
{
    XCTestExpectation * expectation = [self expectationWithDescription:@"TestClusterReadAttributeListStructOctetStringWithResponseHandler"];
...
{
    XCTestExpectation * expectation = [self expectationWithDescription:@"TestClusterReadAttributeClusterRevisionWithResponseHandler"];
...
{
    XCTestExpectation * expectation = [self expectationWithDescription:@"TrustedRootCertificatesReadAttributeClusterRevisionWithResponseHandler"];
...
{
    XCTestExpectation * expectation = [self expectationWithDescription:@"WindowCoveringReadAttributeWindowCoveringTypeWithResponseHandler"];
