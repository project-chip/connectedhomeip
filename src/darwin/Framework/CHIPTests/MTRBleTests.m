...
- (void)testBleCommissionableBrowserResultAdditionAndRemoval
{
    ...
    [sMockCB addMockCommissionableMatterDeviceWithIdentifier:peripheralID vendorID:@0xfff1 productID:@0x1234 discriminator:@0x444];
    [sMockCB removeMockPeripheralWithIdentifier:peripheralID];
...
- (void)testBleCommissionAfterStopBrowse
{
