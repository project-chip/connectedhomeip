...
#define WEAVE_CONFIG_PERSISTED_STORAGE_KEY_TYPE uint8_t
...
// FIXME: EFR32 set to MBED-TLS (But this is third-party repo in OpenWeave, not SDK)
...
// FIXME: EFR32 currently set to Nest (Does this use Entropy.cpp ?)
