...
#define CHIP_CONFIG_ENABLE_TUNNELING 1
...
#define CHIP_CONFIG_MAX_BINDINGS CONFIG_MAX_BINDINGS
...
#define CHIP_CONFIG_DATA_MANAGEMENT_ENABLE_SCHEMA_CHECK CONFIG_WDM_ENABLE_SCHEMA_CHECK
