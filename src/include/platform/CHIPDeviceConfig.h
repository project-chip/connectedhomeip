...
/**
 * CHIP_DEVICE_CONFIG_NETWORK_RECOVERY_REQUIRED enables the network recovery overy ble.
 */
#ifndef CHIP_DEVICE_CONFIG_NETWORK_RECOVERY_REQUIRED
#define CHIP_DEVICE_CONFIG_NETWORK_RECOVERY_REQUIRED 0
