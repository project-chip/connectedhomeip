...
public:
    ...
    CHIP_ERROR ProvisionThread(DeviceLayer::Internal::ThreadOperationalDataset & threadData) override;
...
template <class ImplClass>
inline CHIP_ERROR GenericDeviceNetworkProvisioningDelegateImpl<ImplClass>::ProvisionThread(
    DeviceLayer::Internal::ThreadOperationalDataset & threadData)
{
