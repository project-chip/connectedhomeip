...
/**
 * A representation of a concrete invoke path, with one additional piece of data
 * added: the command id of the spec-defined response command, if there is one.
 */
struct ConcreteCommandPath
{
    ...
    const Optional<CommandId> mResponseCommand;
};
} // namespace app
} // namespace chip
