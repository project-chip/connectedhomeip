...
public:
    ...
    public:
         ...
         * specify response.
         *  - The ProtocolCode in StatusElement MUST be Success if this function is called.
         *
         ...
         * - CHIP_NO_ERROR: The CommandSender received a legal response from server, but the protocol code indicates a error status
         * presended in aInteractionModelStatus.
         *
         * @param[in] apCommandSender: The command sender object that initialized the command transaction, MUST NOT be freed in this
         * callback.
         * @param[in] aInteractionModel: The interaction model protocol status code, will be Failure if the CommandSender failed to
         * recieve the response (aError != CHIP_NO_ERROR). This argument will never be Success when this function is called.
         ...
         */
        virtual void OnError(const CommandSender * apCommandSender,
                             Protocols::InteractionModel::ProtocolCode aInteractionModelStatus, CHIP_ERROR aProtocolError)
        {}
         ...
         *
         * This function will always be called exactly once for a single command sender.
         *
