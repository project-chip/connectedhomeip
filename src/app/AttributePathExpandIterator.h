...
private:
    ...
    std::unique_ptr<DataModel::MetaDataIterator<EndpointId, DataModel::EndpointInfo>> mEndpointIterator;
    std::unique_ptr<DataModel::ElementIterator<ClusterId>> mClusterIterator;
    std::unique_ptr<DataModel::MetaDataIterator<AttributeId, DataModel::AttributeInfo>> mAttributeIterator;
