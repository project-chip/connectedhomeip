...
ZapStatus_t zapSendClusterBasicServerCommandResetToFactoryDefaultsResponse(
  const ZapCommandContext_t *context,
  const ZapClusterBasicServerCommandResetToFactoryDefaultsResponse_t *response);
...
ZapStatus_t zapSendClusterOnOffServerCommandOffResponse(
  const ZapCommandContext_t *context,
...
ZapStatus_t zapSendClusterOnOffServerCommandOnResponse(
  const ZapCommandContext_t *context,
...
ZapStatus_t zapSendClusterOnOffServerCommandToggleResponse(
  const ZapCommandContext_t *context,
...
ZapStatus_t zapSendClusterLevelControlServerCommandMoveToLevelResponse(
  const ZapCommandContext_t *context,
  const ZapClusterLevelControlServerCommandMoveToLevelResponse_t *response);
...
ZapStatus_t zapSendClusterLevelControlServerCommandMoveResponse(
  const ZapCommandContext_t *context,
...
ZapStatus_t zapSendClusterLevelControlServerCommandStepResponse(
  const ZapCommandContext_t *context,
...
ZapStatus_t zapSendClusterLevelControlServerCommandStopResponse(
  const ZapCommandContext_t *context,
...
ZapStatus_t zapSendClusterLevelControlServerCommandMoveToLevelWithOnOffResponse(
  const ZapCommandContext_t *context,
  const ZapClusterLevelControlServerCommandMoveToLevelWithOnOffResponse_t *response);
...
ZapStatus_t zapSendClusterLevelControlServerCommandMoveWithOnOffResponse(
  const ZapCommandContext_t *context,
  const ZapClusterLevelControlServerCommandMoveWithOnOffResponse_t *response);
...
ZapStatus_t zapSendClusterLevelControlServerCommandStepWithOnOffResponse(
  const ZapCommandContext_t *context,
  const ZapClusterLevelControlServerCommandStepWithOnOffResponse_t *response);
...
ZapStatus_t zapSendClusterLevelControlServerCommandStopWithOnOffResponse(
  const ZapCommandContext_t *context,
  const ZapClusterLevelControlServerCommandStopWithOnOffResponse_t *response);
