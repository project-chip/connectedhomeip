...
public:
     ...
     *
     *  SDK consumer should take the responsibility for read client shutdown,
     *  internally we would not shutdown read client unless the overall InteractionModelEngine is shut down.
     */
    void Shutdown();
