...
namespace app {
    ...
    inline constexpr uint16_t kRequiredEventField = (1 << to_underlying(EventDataIB::Tag::kPriority)) | (1 << to_underlying(EventDataIB::Tag::kPath));
    ...
    struct LogStorageResources {
        ...
        uint8_t * mpBuffer = nullptr; // Buffer to be used as a storage at the particular priority level and shared with more important events.
        ...
        PriorityLevel mPriority = PriorityLevel::Invalid; // Log priority level associated with the resources provided in this structure.
    };
    ...
    public:
        ...
        System::Clock::Microseconds64 GetMonotonicStartupTime() const override;
    ...
    private:
        ...
        public:
            ...
            InternalEventOptions(Timestamp aTimestamp)
