                                                           ...
                                                           const EmberAfAttributeMetadata * aMetadata, const ByteSpan & aValue)
{
    ...
    return mStorage->SyncSetKeyValue(key.AttributeValue(aPath.mEndpointId, aPath.mClusterId, aPath.mAttributeId), aValue.data(), static_cast<uint16_t>(aValue.size()));
}
                                                          ...
                                                          const EmberAfAttributeMetadata * aMetadata, MutableByteSpan & aValue)
{
    ...
    ReturnErrorOnFailure(mStorage->SyncGetKeyValue(key.AttributeValue(aPath.mEndpointId, aPath.mClusterId, aPath.mAttributeId), aValue.data(), size));
