...
// "The value of MATTER_DM_ACTIONS_CLUSTER_SERVER_ENDPOINT_COUNT needs to be at least one for unit testing the cluster.
...
// The value of MATTER_DM_THERMOSTAT_CLUSTER_SERVER_ENDPOINT_COUNT needs to be at least one for unit testing the cluster.
