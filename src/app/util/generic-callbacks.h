 ...
 * value of MATTER_CL_STATUS_SUCCESS. Ensure that the size of the externally
 ...
 * MATTER_CL_STATUS_RESOURCE_EXHAUSTED. Any other return value indicates the
 ...
 * emberAfMainTickCallback.
        If the application was successfully able to
 * write the attribute, it returns a value of MATTER_CL_STATUS_SUCCESS. Any
