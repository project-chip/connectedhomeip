...
enum class MatterClusterShutdownType
{
    ...
    kPermanentRemove, // full "remove", for situations when the endpoint the cluster on is going away permanently (for example, a bridged device that is no longer being bridged).
};
