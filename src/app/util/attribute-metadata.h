...
#define MATTER_ATTRIBUTE_BITMAP_WRITABLE (0x01)
// Attribute that has this mask is saved in non-volatile memory
#define MATTER_ATTRIBUTE_BITMAP_NONVOLATILE (0x02)
// Alias until ZAP gets updated to output MATTER_ATTRIBUTE_BITMAP_NONVOLATILE
#define MATTER_ATTRIBUTE_BITMAP_TOKENIZE MATTER_ATTRIBUTE_BITMAP_NONVOLATILE
// Attribute that has this mask has a min/max values
#define MATTER_ATTRIBUTE_BITMAP_MIN_MAX (0x04)
// Attribute requires a timed interaction to write
#define MATTER_ATTRIBUTE_BITMAP_MUST_USE_TIMED_WRITE (0x08)
// Attribute deferred to external storage
#define MATTER_ATTRIBUTE_BITMAP_EXTERNAL_STORAGE (0x10)
// Attribute is singleton
#define MATTER_ATTRIBUTE_BITMAP_SINGLETON (0x20)
// Attribute is nullable
#define MATTER_ATTRIBUTE_BITMAP_NULLABLE (0x40)
...
struct EmberAfAttributeMetadata
{
     ...
     */
    bool HasMinMax() const { return mask & MATTER_ATTRIBUTE_BITMAP_MIN_MAX; }

    /**
     * Check whether this attribute is nullable.
     */
    bool IsNullable() const { return mask & MATTER_ATTRIBUTE_BITMAP_NULLABLE; }

    /**
     * Check whether this attribute is readonly.
     */
    bool IsReadOnly() const { return !(mask & MATTER_ATTRIBUTE_BITMAP_WRITABLE); }

    /**
     * Check whether this attribute requires a timed write.
     */
    bool MustUseTimedWrite() const { return mask & MATTER_ATTRIBUTE_BITMAP_MUST_USE_TIMED_WRITE; }

    /**
     * Check whether this attibute's storage is managed outside the built-in
     * attribute store.
     */
    bool IsExternal() const { return mask & MATTER_ATTRIBUTE_BITMAP_EXTERNAL_STORAGE; }
     ...
     */
    bool IsSingleton() const { return mask & MATTER_ATTRIBUTE_BITMAP_SINGLETON; }

    /**
     * Check whether this attribute is automatically stored in non-volatile
     * memory.
     */
    bool IsAutomaticallyPersisted() const { return (mask & MATTER_ATTRIBUTE_BITMAP_NONVOLATILE) && !IsExternal(); }
};
