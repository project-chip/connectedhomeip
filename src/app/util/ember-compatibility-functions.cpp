...
CHIP_ERROR ReadSingleClusterData(ClusterInfo & aClusterInfo, TLV::TLVWriter * apWriter, bool * apDataExists)
{
    ...
    case ZCL_STRUCT_ATTRIBUTE_TYPE: {
        ReturnErrorOnFailure(CopyStructAttributeToCHIPTLV(aClusterInfo.mClusterId, aClusterInfo.mFieldId, data, sizeof(data),
                                                          *apWriter, TLV::ContextTag(AttributeDataElement::kCsTag_Data)));
        break;
    }
    default:
