...
CHIP_ERROR WriteHandler::ProcessAttributeDatas(TLV::TLVReader & aAttributeDatasReader)
{
    CHIP_ERROR err = CHIP_NO_ERROR;
    while (CHIP_NO_ERROR == (err = aAttributeDatasReader.Next()))
    {
        chip::TLV::TLVReader dataReader;
        AttributeDataIB::Parser element;
        AttributePathIB::Parser attributePath;
        ClusterInfo clusterInfo;
        TLV::TLVReader reader = aAttributeDatasReader;
...
CHIP_ERROR WriteHandler::ProcessWriteRequest(System::PacketBufferHandle && aPayload)
{
    ...
    TLV::TLVReader AttributeDatasReader;
    ...
    err = writeRequestParser.GetAttributeReports(&AttributeDatasParser);
    SuccessOrExit(err);
    AttributeDatasParser.GetReader(&AttributeDatasReader);
    err = ProcessAttributeDatas(AttributeDatasReader);
