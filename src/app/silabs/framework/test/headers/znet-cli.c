...
#if defined(EMBER_COMMAND_INTEPRETER_HAS_DESCRIPTION_FIELD)
static const char * const pluginBarrierControlServerCloseCommandArguments[] = {
  "The endpoint on which the barrier has been closed",
  NULL
};
#endif
...
static const char * const pluginBarrierControlServerFailedCommunicationCommandArguments[] = {
  ...
  "Whether to set (1) or clear (0) the failed communication state",
  NULL
};
#endif
...
void emAfPluginBarrierControlServerOpenOrCloseCommand(void);
#if defined(EMBER_COMMAND_INTEPRETER_HAS_DESCRIPTION_FIELD)
static const char * const pluginBarrierControlServerOpenCommandArguments[] = {
  "The endpoint on which the barrier has been opened",
  NULL
};
#endif
...
static const char * const pluginBarrierControlServerPositionFailureCommandArguments[] = {
  "The endpoint on which to simulate this position failure event",
  "Whether to set (1) or clear (0) the position failure state",
  NULL
};
#endif
...
static const char * const pluginBarrierControlServerRemoteLockoutCommandArguments[] = {
  "The endpoint on which to simulate this remote lockout event",
  "Whether to set (1) or clear (0) the remove lockout state",
  NULL
};
#endif
...
#if defined(EMBER_COMMAND_INTEPRETER_HAS_DESCRIPTION_FIELD)
static const char * const pluginBarrierControlServerStatusCommandArguments[] = {
  "The endpoint from which to receive status",
  NULL
};
#endif
...
static const char * const pluginBarrierControlServerTamperDetectedCommandArguments[] = {
  "The endpoint on which to simulate this tamper detected event",
  "Whether to set (1) or clear (0) the tamper detected state",
  NULL
};
#endif

static EmberCommandEntry emberCommandPluginBarrierControlServerTable[] = {
  emberCommandEntryActionWithDetails("close", emAfPluginBarrierControlServerOpenOrCloseCommand, "u", "Notify the plugin that the barrier has been closed manually.", pluginBarrierControlServerCloseCommandArguments),
  emberCommandEntryActionWithDetails("failed-communication", emAfPluginBarrierControlServerSafetyStatusCommand, "uu", "Simulate or clear a failed communication event on the barrier (i. ...", pluginBarrierControlServerFailedCommunicationCommandArguments),
  emberCommandEntryActionWithDetails("open", emAfPluginBarrierControlServerOpenOrCloseCommand, "u", "Notify the plugin that the barrier has been opened manually.", pluginBarrierControlServerOpenCommandArguments),
  emberCommandEntryActionWithDetails("position-failure", emAfPluginBarrierControlServerSafetyStatusCommand, "uu", "Simulate or clear a position failure event on the barrier (i. ...", pluginBarrierControlServerPositionFailureCommandArguments),
  emberCommandEntryActionWithDetails("remote-lockout", emAfPluginBarrierControlServerSafetyStatusCommand, "uu", "Simulate or clear a remote lockout event on the barrier (i. ...", pluginBarrierControlServerRemoteLockoutCommandArguments),
  emberCommandEntryActionWithDetails("status", emAfPluginBarrierControlServerStatusCommand, "u", "Prints out the status of the Barrier Control server cluster implementa ...", pluginBarrierControlServerStatusCommandArguments),
  emberCommandEntryActionWithDetails("tamper-detected", emAfPluginBarrierControlServerSafetyStatusCommand, "uu", "Simulate or clear a tamper detected event on the barrier (i. ...", pluginBarrierControlServerTamperDetectedCommandArguments),
  emberCommandEntryTerminator(),
};
...
#if defined(EMBER_COMMAND_INTEPRETER_HAS_DESCRIPTION_FIELD)
static const char * const pluginMacAddressFilteringLongAddressListAddCommandArguments[] = {
  "The long address to add.",
  NULL
};
#endif
...
static const char * const pluginMacAddressFilteringLongAddressListDeleteCommandArguments[] = {
  "The entry in the long address list to delete.",
  NULL
};
#endif
...
static EmberCommandEntry emberCommandPluginMacAddressFilteringLongAddressListTable[] = {
  emberCommandEntryActionWithDetails("add", emberAfPluginMacAddressFilteringAddLongAddressCommand, "b", "Adds a long address to the long address filter.", pluginMacAddressFilteringLongAddressListAddCommandArguments),
  emberCommandEntryActionWithDetails("clear", emberAfPluginMacAddressFilteringClearLongAddressList, "", "Clears the long address list filter.", NULL),
  emberCommandEntryActionWithDetails("delete", emberAfPluginMacAddressFilteringLongAddressDeleteEntry, "u", "Deletes an entry in the long address list filter.", pluginMacAddressFilteringLongAddressListDeleteCommandArguments),
  emberCommandEntryActionWithDetails("set-blacklist", emberAfPluginMacAddressFilteringSetLongAddressListType, "", "Sets the long address list filter to a blacklist.", NULL),
  emberCommandEntryActionWithDetails("set-whitelist", emberAfPluginMacAddressFilteringSetLongAddressListType, "", "Sets the long address list filter to a whitelist.", NULL),
  emberCommandEntryTerminator(),
};
void emberAfPluginMacAddressFilteringAddPanIdCommand(void);
#if defined(EMBER_COMMAND_INTEPRETER_HAS_DESCRIPTION_FIELD)
static const char * const pluginMacAddressFilteringPanIdListAddCommandArguments[] = {
  "The PAN ID to add to the list.",
  NULL
};
#endif
...
#if defined(EMBER_COMMAND_INTEPRETER_HAS_DESCRIPTION_FIELD)
static const char * const pluginMacAddressFilteringPanIdListDeleteCommandArguments[] = {
...
static EmberCommandEntry emberCommandPluginMacAddressFilteringPanIdListTable[] = {
  emberCommandEntryActionWithDetails("add", emberAfPluginMacAddressFilteringAddPanIdCommand, "v", "Adds a PAN ID to the filter.", pluginMacAddressFilteringPanIdListAddCommandArguments),
  emberCommandEntryActionWithDetails("clear", emberAfPluginMacAddressFilteringClearPanIdList, "", "Clears the PAN ID list filter.", NULL),
  emberCommandEntryActionWithDetails("delete", emberAfPluginMacAddressFilteringPanIdDeleteEntry, "u", "Deletes an entry in the PAN ID list filter.", pluginMacAddressFilteringPanIdListDeleteCommandArguments),
  emberCommandEntryActionWithDetails("set-blacklist", emberAfPluginMacAddressFilteringSetPanIdListType, "", "Sets the PAN_ID list filter to a blacklist.", NULL),
  emberCommandEntryActionWithDetails("set-whitelist", emberAfPluginMacAddressFilteringSetPanIdListType, "", "Sets the PAN-ID list filter to a whitelist.", NULL),
  emberCommandEntryTerminator(),
};
...
static const char * const pluginMacAddressFilteringSetConfigNoAddressFilterCommandArguments[] = {
  "True means drop no-address messages, false means allow.",
  NULL
};
#endif

static EmberCommandEntry emberCommandPluginMacAddressFilteringSetConfigTable[] = {
  emberCommandEntryActionWithDetails("no-address-filter", emberAfPluginMacAddressFilteringFilterNoAddressCommand, "u", "Enable/disable filtering of no-address messages.", pluginMacAddressFilteringSetConfigNoAddressFilterCommandArguments),
  emberCommandEntryTerminator(),
};
...
static const char * const pluginMacAddressFilteringShortAddressListAddCommandArguments[] = {
  "The node-id to add to the short list.",
  NULL
};
#endif
...
#if defined(EMBER_COMMAND_INTEPRETER_HAS_DESCRIPTION_FIELD)
static const char * const pluginMacAddressFilteringShortAddressListDeleteCommandArguments[] = {
  "The index of the entry to delete.",
  NULL
};
#endif
...
static EmberCommandEntry emberCommandPluginMacAddressFilteringShortAddressListTable[] = {
  emberCommandEntryActionWithDetails("add", emberAfPluginMacAddressFilteringAddShortAddressCommand, "v", "Adds an address to the short address list.", pluginMacAddressFilteringShortAddressListAddCommandArguments),
  emberCommandEntryActionWithDetails("clear", emberAfPluginMacAddressFilteringClearShortAddressList, "", "Clears the short address list filter.", NULL),
  emberCommandEntryActionWithDetails("delete", emberAfPluginMacAddressFilteringShortAddressDeleteEntry, "u", "Deletes an entry in the short address list filter.", pluginMacAddressFilteringShortAddressListDeleteCommandArguments),
  emberCommandEntryActionWithDetails("set-blacklist", emberAfPluginMacAddressFilteringSetShortAddressListType, "", "Sets the short address list filter to a blacklist.", NULL),
  emberCommandEntryActionWithDetails("set-whitelist", emberAfPluginMacAddressFilteringSetShortAddressListType, "", "Sets the short address list filter to a whitelist.", NULL),
  emberCommandEntryTerminator(),
};
static EmberCommandEntry emberCommandPluginMacAddressFilteringTable[] = {
  emberCommandEntryActionWithDetails("clear-stats", emberAfPluginMacAddressFilteringClearStats, "", "Clears all packet counts for all mode ...", NULL),
  ...
  emberCommandEntryActionWithDetails("print-config", emberAfPluginMacAddressFilteringPrintConfigCommand, "", "Prints the current filtering config and statistics.", NULL),
  emberCommandEntryActionWithDetails("reset", emberAfPluginMacAddressFilteringReset, "", "Resets the state of the plugin to the default of no filtering.", NULL),
...
{
  zclSimpleClientCommand(ZCL_BACNET_PROTOCOL_TUNNEL_CLUSTER_ID,
                         ZCL_TRANSFER_NPDU_COMMAND_ID);
}

#if defined(EMBER_COMMAND_INTEPRETER_HAS_DESCRIPTION_FIELD)
static const char * const zclBacnetTransferNpduRandomCommandArguments[] = {
  "npdu",
  "",
  NULL
};
...
static EmberCommandEntry emberCommandZclBacnetTransferNpduTable[] = {
  emberCommandEntryActionWithDetails("random", zclBacnetTransferNpduRandomCommand, "u*", "This command is generated when a BACnet network layer wishes to transf ...", zclBacnetTransferNpduRandomCommandArguments),
...
#if defined(EMBER_COMMAND_INTEPRETER_HAS_DESCRIPTION_FIELD)
static const char * const zclTunnelMatchCommandArguments[] = {
  "protocol address",
  NULL
};
#endif
...
static EmberCommandEntry emberCommandZclTunnelTable[] = {
  ...
  emberCommandEntryActionWithDetails("match", zclTunnelMatchCommand, "b", "This command is generated when an application wishes to find the ZigBe ...", zclTunnelMatchCommandArguments),
