...
/** @addtogroup plugin-mac-address-filtering Plugin Commands: Mac address filtering
 * @ingroup cli
...
/** @brief <b>plugin mac-address-filtering clear-stats </b>
 *   - <i>Clears all packet counts for all modes.  Leaves config and lists intact.</i>
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_PLUGIN_MAC_ADDRESS_FILTERING_PLUGIN_MAC_ADDRESS_FILTERING_CLEAR_STATS

/** @brief <b>plugin mac-address-filtering long-address-list add [eui64:8] </b>
 *   - <i>Adds a long address to the long address filter.</i>
...
/** @brief <b>plugin mac-address-filtering long-address-list clear </b>
 *   - <i>Clears the long address list filter.</i>
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_PLUGIN_MAC_ADDRESS_FILTERING_PLUGIN_MAC_ADDRESS_FILTERING_LONG_ADDRESS_LIST_CLEAR

/** @brief <b>plugin mac-address-filtering long-address-list delete [index:1] </b>
 *   - <i>Deletes an entry in the long address list filter.</i>
...
/** @brief <b>plugin mac-address-filtering long-address-list set-blacklist </b>
 *   - <i>Sets the long address list filter to a blacklist.</i>
 */
...
/** @brief <b>plugin mac-address-filtering long-address-list set-whitelist </b>
 *   - <i>Sets the long address list filter to a whitelist.</i>
 */
...
/** @brief <b>plugin mac-address-filtering pan-id-list add [pan-id:2] </b>
 *   - <i>Adds a PAN ID to the filter.</i>
...
/** @brief <b>plugin mac-address-filtering pan-id-list clear </b>
 *   - <i>Clears the PAN ID list filter.</i>
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_PLUGIN_MAC_ADDRESS_FILTERING_PLUGIN_MAC_ADDRESS_FILTERING_PAN_ID_LIST_CLEAR

/** @brief <b>plugin mac-address-filtering pan-id-list delete [index:1] </b>
 *   - <i>Deletes an entry in the PAN ID list filter.</i>
...
/** @brief <b>plugin mac-address-filtering pan-id-list set-blacklist </b>
 *   - <i>Sets the PAN_ID list filter to a blacklist.</i>
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_PLUGIN_MAC_ADDRESS_FILTERING_PLUGIN_MAC_ADDRESS_FILTERING_PAN_ID_LIST_SET_BLACKLIST

/** @brief <b>plugin mac-address-filtering pan-id-list set-whitelist </b>
 *   - <i>Sets the PAN-ID list filter to a whitelist.</i>
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_PLUGIN_MAC_ADDRESS_FILTERING_PLUGIN_MAC_ADDRESS_FILTERING_PAN_ID_LIST_SET_WHITELIST

/** @brief <b>plugin mac-address-filtering print-config </b>
 *   - <i>Prints the current filtering config and statistics.</i>
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_PLUGIN_MAC_ADDRESS_FILTERING_PLUGIN_MAC_ADDRESS_FILTERING_PRINT_CONFIG

/** @brief <b>plugin mac-address-filtering reset </b>
 *   - <i>Resets the state of the plugin to the default of no filtering.</i>
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_PLUGIN_MAC_ADDRESS_FILTERING_PLUGIN_MAC_ADDRESS_FILTERING_RESET

/** @brief <b>plugin mac-address-filtering set-config no-address-filter [enable:1] </b>
 *   - <i>Enable/disable filtering of no-address messages.</i>
...
/** @brief <b>plugin mac-address-filtering short-address-list add [node-id:2] </b>
 *   - <i>Adds an address to the short address list.</i>
...
/** @brief <b>plugin mac-address-filtering short-address-list clear </b>
 *   - <i>Clears the short address list filter.</i>
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_PLUGIN_MAC_ADDRESS_FILTERING_PLUGIN_MAC_ADDRESS_FILTERING_SHORT_ADDRESS_LIST_CLEAR

/** @brief <b>plugin mac-address-filtering short-address-list delete [index:1] </b>
 *   - <i>Deletes an entry in the short address list filter.</i>
 *     - index - INT8U - The index of the entry to delete.
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_PLUGIN_MAC_ADDRESS_FILTERING_PLUGIN_MAC_ADDRESS_FILTERING_SHORT_ADDRESS_LIST_DELETE

/** @brief <b>plugin mac-address-filtering short-address-list set-blacklist </b>
 *   - <i>Sets the short address list filter to a blacklist.</i>
 */
...
/** @brief <b>plugin mac-address-filtering short-address-list set-whitelist </b>
 *   - <i>Sets the short address list filter to a whitelist.</i>
 */
...
/** @} */ // end group plugin-mac-address-filtering
