...
/***************************************************************************/ /**
                                                                               * @file
                                                                               * @brief Common test code and stubs for unit tests of
                                                                               *the Afv2 code.
                                                                               *******************************************************************************
                                                                               ******************************************************************************/
...
void verifyDataWithFileInfo(const char * name, uint16_t expectedLength, uint8_t * expectedData, uint16_t actualLength,
                            uint8_t * actualData, const char * file, int lineNumber);
...
#define expect(test) expectFunction((test), __FILE__, __LINE__, __PRETTY_FUNCTION__, NULL)

#define expectMessage(test, ...) expectFunction((test), __FILE__, __LINE__, __PRETTY_FUNCTION__, __VA_ARGS__)
...
#define setCheckpoint(string) setCheckpointFunction(string, __FILE__, __LINE__, __PRETTY_FUNCTION__)

void expectCheckpointFunction(const char * file, int lineNumber, const char * string, ...);

#define expectCheckpoint(...) expectCheckpointFunction(__FILE__, __LINE__, __VA_ARGS__)
