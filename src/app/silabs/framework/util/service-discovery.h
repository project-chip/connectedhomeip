...
/***************************************************************************/ /**
                                                                               * @file
                                                                               * @brief Interface for initiating and processing ZDO
                                                                               *service discovery (match descriptor) requests and
                                                                               *response.
                                                                               *******************************************************************************
                                                                               ******************************************************************************/
...
// Internal Functions
void emAfServiceDiscoveryMatched(EmberNodeId nodeId, uint8_t endpointListLength, uint8_t * endpointList);
...
extern EmberEventControl emAfServiceDiscoveryEventControls[EMBER_SUPPORTED_SERVICE_DISCOVERY_STATES_PER_NETWORK]
...
#define EM_AF_SERVICE_DISCOVERY_EVENT_STRINGS                                                                                      \
    "Svc Disc Request State 0 NWK 0", "Svc Disc Request State 1 NWK 0", "Svc Disc Request State 2 NWK 0",                          \
...
#define EM_AF_SERVICE_DISCOVERY_EVENT_STRINGS                                                                                      \
    "Svc Disc Request State 0 NWK 0", "Svc Disc Request State 1 NWK 0", "Svc Disc Request State 2 NWK 0",                          \
        "Svc Disc Request State 3 NWK 0", "Svc Disc Request State 0 NWK 1", "Svc Disc Request State 1 NWK 1",                      \
        "Svc Disc Request State 2 NWK 1", "Svc Disc Request State 3 NWK 1",
#define EM_AF_SERVICE_DISCOVERY_EVENTS                                                                                             \
    { &emAfServiceDiscoveryEventControls[0][0], (void (*)(void)) emAfServiceDiscoveryTimeoutHandler },                             \
        { &emAfServiceDiscoveryEventControls[1][0], (void (*)(void)) emAfServiceDiscoveryTimeoutHandler },                         \
        { &emAfServiceDiscoveryEventControls[2][0], (void (*)(void)) emAfServiceDiscoveryTimeoutHandler },                         \
...
#define EM_AF_SERVICE_DISCOVERY_EVENT_STRINGS                                                                                      \
    "Svc Disc Request State 0 NWK 0", "Svc Disc Request State 1 NWK 0", "Svc Disc Request State 2 NWK 0",                          \
        "Svc Disc Request State 3 NWK 0", "Svc Disc Request State 0 NWK 1", "Svc Disc Request State 1 NWK 1",                      \
        "Svc Disc Request State 2 NWK 1", "Svc Disc Request State 3 NWK 1", "Svc Disc Request State 0 NWK 2",                      \
        "Svc Disc Request State 1 NWK 2", "Svc Disc Request State 2 NWK 2", "Svc Disc Request State 3 NWK 2",
#define EM_AF_SERVICE_DISCOVERY_EVENTS                                                                                             \
    { &emAfServiceDiscoveryEventControls[0][0], (void (*)(void)) emAfServiceDiscoveryTimeoutHandler },                             \
        { &emAfServiceDiscoveryEventControls[1][0], (void (*)(void)) emAfServiceDiscoveryTimeoutHandler },                         \
        { &emAfServiceDiscoveryEventControls[2][0], (void (*)(void)) emAfServiceDiscoveryTimeoutHandler },                         \
...
#define EM_AF_SERVICE_DISCOVERY_EVENT_STRINGS                                                                                      \
    "Svc Disc Request State 0 NWK 0", "Svc Disc Request State 1 NWK 0", "Svc Disc Request State 2 NWK 0",                          \
        ...
        "Svc Disc Request State 2 NWK 1", "Svc Disc Request State 3 NWK 1", "Svc Disc Request State 0 NWK 2",                      \
        "Svc Disc Request State 1 NWK 2", "Svc Disc Request State 2 NWK 2", "Svc Disc Request State 3 NWK 2",                      \
        "Svc Disc Request State 0 NWK 3", "Svc Disc Request State 1 NWK 3", "Svc Disc Request State 2 NWK 3",                      \
