...
/***************************************************************************/ /**
                                                                               * @file
                                                                               * @brief SOC specific routines for performing service
                                                                               *discovery.
                                                                               *******************************************************************************
                                                                               ******************************************************************************/
...
EmberStatus emAfSendMatchDescriptor(EmberNodeId target, EmberAfProfileId profileId, EmberAfClusterId clusterId, bool serverCluster)
{
    ...
    if (clusterList != EMBER_NULL_MESSAGE_BUFFER)
    {
        ...
        status = emberMatchDescriptorsRequest(target, profileId, inClusters, outClusters, EMBER_AF_DEFAULT_APS_OPTIONS);
