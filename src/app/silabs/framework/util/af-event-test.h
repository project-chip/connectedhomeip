...
#define EMBER_AF_GENERATED_EVENT_CODE                                                                                              \
    extern void testEventControlServerCallback(uint8_t endpoint);                                                                  \
...
#define EMBER_AF_GENERATED_EVENTS                                                                                                  \
    { &testEventControl1, testEventControlFunction1 }, { &testEventControl2, testEventControlFunction2 },

#define EMBER_AF_GENERATED_EVENT_STRINGS "Test 1", "Test 2",

#define EMBER_AF_EVENT_CONTEXT_LENGTH 2

#define EMBER_AF_GENERATED_EVENT_CONTEXT                                                                                           \
    { 0x01, 0xabba, false, EMBER_AF_LONG_POLL, EMBER_AF_OK_TO_SLEEP, &testEventControl1 },                                         \
    {                                                                                                                              \
