...
#if defined(EMBER_COMMAND_INTEPRETER_HAS_DESCRIPTION_FIELD)
static const char * const pluginSecureEzspSetSecurityKeyCommandArguments[] = {
...
#if defined(EMBER_COMMAND_INTEPRETER_HAS_DESCRIPTION_FIELD)
static const char * const pluginSecureEzspSetSecurityParametersCommandArguments[] = {
  "The security level to be used for the Secure EZSP communication.",
  NULL
};
#endif

static EmberCommandEntry emberCommandPluginSecureEzspTable[] = {
  emberCommandEntryActionWithDetails("reset_to_factory_defaults", emberAfPluginSecureEzspResetToFactoryDefaultsCommand, "", "Reset the NCP to factory default.", NULL),
  emberCommandEntryActionWithDetails("set_security_key", emberAfPluginSecureEzspSetSecurityKeyCommand, "w", "Set the Security Key of the Secure EZSP Protocol.", pluginSecureEzspSetSecurityKeyCommandArguments),
  emberCommandEntryActionWithDetails("set_security_parameters", emberAfPluginSecureEzspSetSecurityParametersCommand, "w", "Set the Host-side Security Parameters of the Secure EZSP Protocol.", pluginSecureEzspSetSecurityParametersCommandArguments),
  emberCommandEntryTerminator(),
};
static EmberCommandEntry emberCommandPluginTable[] = {
  ...
  emberCommandEntrySubMenu("secure-ezsp", emberCommandPluginSecureEzspTable, ""),
  emberCommandEntryTerminator(),
};
