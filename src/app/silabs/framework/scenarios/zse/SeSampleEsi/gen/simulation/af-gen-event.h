...
#define EMBER_AF_GENERATED_EVENT_CODE                                                                                              \
    ...
    void emberAfPluginSmartEnergyRegistrationTickNetworkEventWrapper0(void)                                                        \
    {                                                                                                                              \
        networkEventWrapper(&emberAfPluginSmartEnergyRegistrationTickNetworkEventControls[0],                                      \
                            emberAfPluginSmartEnergyRegistrationTickNetworkEventHandler, 0);                                       \
    }                                                                                                                              \
...
#define EMBER_AF_GENERATED_EVENTS                                                                                                  \
    { &emberAfTimeClusterServerTickCallbackControl1, emberAfTimeClusterServerTickCallbackWrapperFunction1 },                       \
        ...
        { &emberAfPluginSmartEnergyRegistrationTickNetworkEventControls[0],                                                        \
          emberAfPluginSmartEnergyRegistrationTickNetworkEventWrapper0 },

#define EMBER_AF_GENERATED_EVENT_STRINGS                                                                                           \
    "Time Cluster Server EP 1", "Price Cluster Server EP 1", "Key Establishment Cluster Server EP 1",                              \
        "Button Form/Join Code Plugin Button0", "Button Form/Join Code Plugin Button1", "Form and Join Library Plugin Cleanup",    \
        "Key Establishment Plugin ApsDuplicateDetection", "Network Find Plugin Tick", "Price event",                               \
        "Partner Link Key Exchange Plugin Timeout NWK 0", "Smart Energy Registration Plugin Tick NWK 0",
