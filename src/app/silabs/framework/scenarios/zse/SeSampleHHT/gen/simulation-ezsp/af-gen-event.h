...
#define EMBER_AF_GENERATED_EVENT_STRINGS                                                                                           \
    "Over the Air Bootloading Cluster Server EP 1", "Tunneling Cluster Client EP 1", "Tunneling Cluster Server EP 1",              \
        "Events Cluster Server EP 1", "Key Establishment Cluster Server EP 1", "Form and Join Library Plugin Cleanup",             \
        "Interpan Plugin FragmentReceive", "Interpan Plugin FragmentTransmit", "Key Establishment Plugin ApsDuplicateDetection",   \
        "Network Find Plugin Tick", "Sleepy Message Queue Plugin Timeout", "Partner Link Key Exchange Plugin Timeout NWK 0",
