...
#define EMBER_AF_GENERATED_EVENT_CODE                                                                                              \
    ...
    extern EmberEventControl priceQueryControl;                                                                                    \
...
#define EMBER_AF_GENERATED_EVENT_STRINGS                                                                                           \
    "Price Cluster Client EP 1", "Demand Response and Load Control Cluster Client EP 1", "Key Establishment Cluster Server EP 1",  \
        "Button Form/Join Code Plugin Button0", "Button Form/Join Code Plugin Button1", "Form and Join Library Plugin Cleanup",    \
        "Key Establishment Plugin ApsDuplicateDetection", "Network Find Plugin Tick", "Price query control",                       \
