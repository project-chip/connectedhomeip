...
#define EMBER_AF_GENERATED_EVENT_STRINGS                                                                                           \
    "Over the Air Bootloading Cluster Client EP 1", "Price Cluster Client EP 1", "Key Establishment Cluster Server EP 1",          \
        "Button Form/Join Code Plugin Button0", "Button Form/Join Code Plugin Button1", "Form and Join Library Plugin Cleanup",    \
        "Key Establishment Plugin ApsDuplicateDetection", "Network Find Plugin Tick",                                              \
        "OTA Simple Storage EEPROM Driver Plugin PageErase", "Simple Clock Plugin Update",                                         \
