...
#define GENERATED_MIN_MAX_DEFAULTS                                                                                                 \
    {                                                                                                                              \
        { (uint8_t *) 0x02, (uint8_t *) 0x00, (uint8_t *) 0xFF }, { (uint8_t *) 0x00, (uint8_t *) 0x00, (uint8_t *) 0xFF },        \
...
#define GENERATED_CLUSTERS                                                                                                         \
    {                                                                                                                              \
        {                                                                                                                          \
            ...
            {                                                                                                                      \
                0x0700, (EmberAfAttributeMetadata *) &(generatedAttributes[16]), 0,                                                \
                0,      (CLUSTER_MASK_CLIENT | CLUSTER_MASK_INIT_FUNCTION),      emberAfFuncArrayPriceClusterClient,               \
            },                                                                                                                     \
            {                                                                                                                      \
                0x0800,                                                                                                            \
...
#define EMBER_AF_GENERATED_EVENT_CODE                                                                                              \
    ...
    void emberAfPluginSimpleClockUpdateNetworkEventWrapper0(void)                                                                  \
    {                                                                                                                              \
        networkEventWrapper(&emberAfPluginSimpleClockUpdateNetworkEventControls[0],                                                \
                            emberAfPluginSimpleClockUpdateNetworkEventHandler, 0);                                                 \
    }                                                                                                                              \
...
#define EMBER_AF_GENERATED_EVENT_STRINGS                                                                                           \
    "Over the Air Bootloading Cluster Client EP 1", "Price Cluster Client EP 1", "Key Establishment Cluster Server EP 1",          \
        ...
        "Network Find Plugin Tick", "OTA Simple Storage EEPROM Driver Plugin PageErase",                                           \
        "Partner Link Key Exchange Plugin Timeout NWK 0", "Simple Clock Plugin Update NWK 0",                                      \
