...
/***************************************************************************/ /**
                                                                               ...
                                                                               * @brief Example callbacks file for Zigbee Alliance
                                                                               *TIS/TRP Application
                                                                               * @author Silicon Labs
                                                                               * @version 4.8
                                                                               *******************************************************************************
...
static EmberCommandEntry customSilabsMenu[] = { emberCommandEntryAction("test", customSilabsTest, "", ""),
...
void customLgetchannel(void)
{
    ...
    emberAfCorePrintln("channel 0x%x%x%x%x\r\n", globalChannelMaskByte0, globalChannelMaskByte1, globalChannelMaskByte2,
                       globalChannelMaskByte3);
}
...
{
    /* Print report */
    emberAfCorePrintln("Local Report: [total]0x%4x [protocol]0x%4x [totalLqi]0x%4x [totalRssiMgnitude]0x%4x", numPackets,
                       numProtocolPackets, totalLqi, totalRssi);
