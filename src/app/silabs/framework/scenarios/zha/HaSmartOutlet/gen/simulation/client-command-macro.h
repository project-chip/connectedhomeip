...
#define emberAfFillCommandScenesClusterRecallScene(groupId, sceneId)                                                               \
    emberAfFillExternalBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER), ZCL_SCENES_CLUSTER_ID,          \
                              ZCL_RECALL_SCENE_COMMAND_ID, "vu", groupId, sceneId);
...
#define emberAfFillCommandLevelControlClusterMoveToLevel(level, transitionTime)                                                    \
    emberAfFillExternalBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER), ZCL_LEVEL_CONTROL_CLUSTER_ID,   \
                              ZCL_MOVE_TO_LEVEL_COMMAND_ID, "uv", level, transitionTime);
...
#define emberAfFillCommandLevelControlClusterMove(moveMode, rate)                                                                  \
    emberAfFillExternalBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER), ZCL_LEVEL_CONTROL_CLUSTER_ID,   \
                              ZCL_MOVE_COMMAND_ID, "uu", moveMode, rate);
...
#define emberAfFillCommandLevelControlClusterStep(stepMode, stepSize, transitionTime)                                              \
    emberAfFillExternalBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER), ZCL_LEVEL_CONTROL_CLUSTER_ID,   \
                              ZCL_STEP_COMMAND_ID, "uuv", stepMode, stepSize, transitionTime);
...
#define emberAfFillCommandGreenPowerClusterGpPairingConfiguration(                                                                 \
    ...
    forwardingRadius, securityOptions, gpdSecurityFrameCounter, gpdSecurityKey, numberOfPairedEndpoints, pairedEndpoints,          \
    ...
    emberAfFillExternalBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER), ZCL_GREEN_POWER_CLUSTER_ID,     \
                              ZCL_GP_PAIRING_CONFIGURATION_COMMAND_ID, "uvw8uuubvuuwGubuvvububb", actions, options, gpdSrcId,      \
                              gpdIeee, endpoint, deviceId, groupListCount, groupList, groupListLen, gpdAssignedAlias,              \
                              forwardingRadius, securityOptions, gpdSecurityFrameCounter, gpdSecurityKey, numberOfPairedEndpoints, \
                              ...
                              clusterListServerLen, clusterListClient, clusterListClientLen);
...
#define emberAfFillCommandGreenPowerClusterGpNotificationResponse(options, gpdSrcId, gpdIeee, gpdSecurityFrameCounter)             \
    emberAfFillExternalBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT), ZCL_GREEN_POWER_CLUSTER_ID,     \
                              ZCL_GP_NOTIFICATION_RESPONSE_COMMAND_ID, "uw8w", options, gpdSrcId, gpdIeee,                         \
...
#define emberAfFillCommandGreenPowerClusterGpResponse(options, tempMasterShortAddress, tempMasterTxChannel, gpdSrcId, gpdIeee,     \
                                                      endpoint, gpdCommandId, gpdCommandPayload, gpdCommandPayloadLen)             \
    emberAfFillExternalBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT), ZCL_GREEN_POWER_CLUSTER_ID,     \
                              ZCL_GP_RESPONSE_COMMAND_ID, "uvuw8uub", options, tempMasterShortAddress, tempMasterTxChannel,        \
                              gpdSrcId, gpdIeee, endpoint, gpdCommandId, gpdCommandPayload, gpdCommandPayloadLen);
...
#define emberAfFillCommandColorControlClusterMoveToHue(hue, direction, transitionTime)                                             \
    emberAfFillExternalBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER), ZCL_COLOR_CONTROL_CLUSTER_ID,   \
                              ZCL_MOVE_TO_HUE_COMMAND_ID, "uuv", hue, direction, transitionTime);
...
#define emberAfFillCommandColorControlClusterMoveHue(moveMode, rate)                                                               \
    emberAfFillExternalBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER), ZCL_COLOR_CONTROL_CLUSTER_ID,   \
                              ZCL_MOVE_HUE_COMMAND_ID, "uu", moveMode, rate);
...
#define emberAfFillCommandColorControlClusterStepHue(stepMode, stepSize, transitionTime)                                           \
    emberAfFillExternalBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER), ZCL_COLOR_CONTROL_CLUSTER_ID,   \
                              ZCL_STEP_HUE_COMMAND_ID, "uuu", stepMode, stepSize, transitionTime);
...
#define emberAfFillCommandColorControlClusterMoveToSaturation(saturation, transitionTime)                                          \
    emberAfFillExternalBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER), ZCL_COLOR_CONTROL_CLUSTER_ID,   \
                              ZCL_MOVE_TO_SATURATION_COMMAND_ID, "uv", saturation, transitionTime);
...
#define emberAfFillCommandColorControlClusterMoveSaturation(moveMode, rate)                                                        \
    emberAfFillExternalBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER), ZCL_COLOR_CONTROL_CLUSTER_ID,   \
                              ZCL_MOVE_SATURATION_COMMAND_ID, "uu", moveMode, rate);
...
#define emberAfFillCommandColorControlClusterStepSaturation(stepMode, stepSize, transitionTime)                                    \
    emberAfFillExternalBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER), ZCL_COLOR_CONTROL_CLUSTER_ID,   \
                              ZCL_STEP_SATURATION_COMMAND_ID, "uuu", stepMode, stepSize, transitionTime);
...
#define emberAfFillCommandColorControlClusterMoveToHueAndSaturation(hue, saturation, transitionTime)                               \
    emberAfFillExternalBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER), ZCL_COLOR_CONTROL_CLUSTER_ID,   \
                              ZCL_MOVE_TO_HUE_AND_SATURATION_COMMAND_ID, "uuv", hue, saturation, transitionTime);
...
#define emberAfFillCommandColorControlClusterMoveToColor(colorX, colorY, transitionTime)                                           \
    emberAfFillExternalBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER), ZCL_COLOR_CONTROL_CLUSTER_ID,   \
                              ZCL_MOVE_TO_COLOR_COMMAND_ID, "vvv", colorX, colorY, transitionTime);
...
#define emberAfFillCommandColorControlClusterMoveColor(rateX, rateY)                                                               \
    emberAfFillExternalBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER), ZCL_COLOR_CONTROL_CLUSTER_ID,   \
                              ZCL_MOVE_COLOR_COMMAND_ID, "vv", rateX, rateY);
...
#define emberAfFillCommandColorControlClusterStepColor(stepX, stepY, transitionTime)                                               \
    emberAfFillExternalBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER), ZCL_COLOR_CONTROL_CLUSTER_ID,   \
                              ZCL_STEP_COLOR_COMMAND_ID, "vvv", stepX, stepY, transitionTime);
...
#define emberAfFillCommandColorControlClusterMoveToColorTemperature(colorTemperature, transitionTime)                              \
    emberAfFillExternalBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER), ZCL_COLOR_CONTROL_CLUSTER_ID,   \
                              ZCL_MOVE_TO_COLOR_TEMPERATURE_COMMAND_ID, "vv", colorTemperature, transitionTime);
...
#define emberAfFillCommandColorControlClusterMoveColorTemperature(moveMode, rate, colorTemperatureMinimum,                         \
    ...
    emberAfFillExternalBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER), ZCL_COLOR_CONTROL_CLUSTER_ID,   \
                              ZCL_MOVE_COLOR_TEMPERATURE_COMMAND_ID, "uvvv", moveMode, rate, colorTemperatureMinimum,              \
                              colorTemperatureMaximum);
 ...
 * @param colorTemperatureMaximum uint16_t
 */
#define emberAfFillCommandColorControlClusterStepColorTemperatue(stepMode, stepSize, transitionTime, colorTemperatureMinimum,      \
                                                                 colorTemperatureMaximum)                                          \
    emberAfFillExternalBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER), ZCL_COLOR_CONTROL_CLUSTER_ID,   \
                              ZCL_STEP_COLOR_TEMPERATUE_COMMAND_ID, "uvvvv", stepMode, stepSize, transitionTime,                   \
