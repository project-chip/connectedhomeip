...
#define EMBER_AF_GENERATED_EVENT_STRINGS                                                                                           \
    "Identify Cluster Server EP 1", "Level Control Cluster Server EP 1", "Time Cluster Server EP 1",                               \
        ...
        "Device Query Service Plugin My", "EZ-Mode Commissioning Plugin State", "Green Power Client Plugin Channel",               \
        "Green Power Client Plugin ExitCommissioning", "IAS Zone Client Plugin StateMachine",                                      \
        "Identify Feedback Plugin ProvideFeedback", "Network Creator Security Plugin OpenNetwork",                                 \
