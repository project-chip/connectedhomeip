...
/** @brief <b>plugin green-power-server extend-comm [commissioningWindow:2] </b>
 *   - <i>Extends commissioning window.</i>
...
/** @addtogroup plugin-green-power-translation-table Plugin Commands: Green Power Translation Table
 * @ingroup cli
 * The Green Power Server plugin contributes CLI commands to the application
 * framework to be used for getting, setting, and displaying information
 * relevant to the Green Power Server cluster.
...
/** @brief <b>plugin green-power-server additionalInfoTable-setEntry [index:1] [gpdCommandId:1] [additionalInfoLength:1]
 * [additionalInfoBlockIn:-1] </b>
...
/** @brief <b>plugin green-power-server customizedTable-setEntry [index:1] [gpdCommandId:1] [zbEndpoint:1] [zigbeeProfile:2]
 * [zigbeeCluster:2] [ServerOrClient:1] [zigbeeCommandId:2] [payloadLength:1] [zclPayloadsrc:1] [zclPayload:-1] </b>
...
/** @brief <b>plugin green-power-server table-remove-endpoint [applicationId:1] [sourceId:4] [gpdIeeeAddr:8] [gpdEndpoint:1]
 * [zbEndpoint:1] </b>
...
/** @brief <b>plugin green-power-server table-set [index:1] [options:2] [gpdIeeeAddr:8] [gpdEndpoint:1] [sourceId:4]
 * [gpdCommandId:1] [zbEndpoint:1] [zigbeeProfile:2] [zigbeeCluster:2] [zigbeeCommandId:2] [payloadLength:1] [zclPayload:-1]
 * [additionalInfoLength:1] [additionalInfoBlockIn:-1] </b>
...
/** @} */ // end group plugin-green-power-translation-table
