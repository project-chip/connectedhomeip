 ...
 */
bool emberAfGreenPowerClusterGpNotificationForwardCallback(uint16_t options, EmberGpAddress * addr,
                                                           uint32_t gpdSecurityFrameCounter, uint8_t gpdCommandId,
                                                           uint8_t * gpdCommandPayload, uint16_t gppShortAddress,
                                                           uint8_t gppDistance)
{
    return false;
}
 ...
 */
bool emberAfGreenPowerClusterGpUpdateTranslationTableCallback(uint16_t options, uint32_t gpdSrcId, uint8_t * gpdIeee,
                                                              uint8_t gpdEndpoint, uint8_t * translations)
{
    return false;
}
 ...
 */
void emberAfGreenPowerClusterPassFrameWithoutTranslationCallback(EmberGpAddress * addr, uint8_t gpdCommandId,
...
bool emberAfPluginGreenPowerServerGpdCommissioningNotificationCallback(uint8_t commandId, uint16_t commNotificationOptions,
                                                                       ...
                                                                       uint16_t gppShortAddress, int8_t rssi, uint8_t linkQuality,
