...
bool emAfPluginGreenPowerServerRetrieveAttributeAndCraftResponse(uint8_t endpoint, EmberAfClusterId clusterId,
                                                                 EmberAfAttributeId attrId, uint8_t mask, uint16_t maunfacturerCode,
                                                                 uint16_t readLength); // Plugin: green-power-server
                                           ...
                                           uint16_t maunfacturerCode, uint16_t readLength)
{
    return (emAfPluginGreenPowerClientRetrieveAttributeAndCraftResponse(endpoint, clusterId, attrId, mask, maunfacturerCode,
            ...
            || emAfPluginGreenPowerServerRetrieveAttributeAndCraftResponse(endpoint, clusterId, attrId, mask, maunfacturerCode,
                                                                           readLength) /* Plugin: green-power-server */);
}
