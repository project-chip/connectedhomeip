  ...
  if (!cmd->mfgSpecific) {
    switch (cmd->commandId) {
      case ZCL_GP_NOTIFICATION_COMMAND_ID:
      {
        ...
        wasHandled = emberAfGreenPowerClusterGpNotificationCallback(options,
                                                                    gpdSrcId,
                                                                    gpdIeee,
                                                                    gpdEndpoint,
                                                                    gpdSecurityFrameCounter,
      ...
      case ZCL_GP_COMMISSIONING_NOTIFICATION_COMMAND_ID:
      {
        ...
        wasHandled = emberAfGreenPowerClusterGpCommissioningNotificationCallback(options,
                                                                                 gpdSrcId,
                                                                                 gpdIeee,
                                                                                 endpoint,
                                                                                 gpdSecurityFrameCounter,
      ...
      case ZCL_GP_SINK_COMMISSIONING_MODE_COMMAND_ID:
      {
        ...
        wasHandled = emberAfGreenPowerClusterGpSinkCommissioningModeCallback(options,
                                                                             gpmAddrForSecurity,
                                                                             gpmAddrForPairing,
                                                                             sinkEndpoint);
        break;
      ...
      case ZCL_GP_TRANSLATION_TABLE_UPDATE_COMMAND_ID:
      {
        ...
        wasHandled = emberAfGreenPowerClusterGpTranslationTableUpdateCallback(options,
                                                                              gpdSrcId,
                                                                              gpdIeee,
                                                                              endpoint,
                                                                              translations);
      ...
      case ZCL_GP_PAIRING_CONFIGURATION_COMMAND_ID:
      {
        ...
        if ( (options & 0x0400) && (applicationInformation & 0x08) && ((clusterIdListCount & 0x0F) > 0) ) {
          // Array is conditionally present based on expression: (options & 0x0400) && (applicationInformation & 0x08) && ((clusterIdListCount & 0x0F) > 0)
        ...
        if ( (options & 0x0400) && (applicationInformation & 0x08) && ((clusterIdListCount >> 4) > 0) ) {
          // Array is conditionally present based on expression: (options & 0x0400) && (applicationInformation & 0x08) && ((clusterIdListCount >> 4) > 0)
        ...
        wasHandled = emberAfGreenPowerClusterGpPairingConfigurationCallback(actions,
                                                                            options,
                                                                            gpdSrcId,
                                                                            gpdIeee,
                                                                            endpoint,
      ...
      case ZCL_GP_SINK_TABLE_REQUEST_COMMAND_ID:
      {
        ...
        wasHandled = emberAfGreenPowerClusterGpSinkTableRequestCallback(options,
                                                                        gpdSrcId,
                                                                        gpdIeee,
                                                                        endpoint,
                                                                        index);
