...
#define EMBER_AF_GENERATED_EVENTS                                                                                                  \
    { &emberAfIdentifyClusterServerTickCallbackControl1, emberAfIdentifyClusterServerTickCallbackWrapperFunction1 },               \
        ...
        { &emberAfPluginGreenPowerServerCommissioningWindowTimeoutEventControl,                                                    \
          emberAfPluginGreenPowerServerCommissioningWindowTimeoutEventHandler },                                                   \
        { &emberAfPluginGreenPowerServerGenericSwitchCommissioningTimeoutEventControl,                                             \
          emberAfPluginGreenPowerServerGenericSwitchCommissioningTimeoutEventHandler },                                            \
        { &emberAfPluginGreenPowerServerMultiSensorCommissioningTimeoutEventControl,                                               \
...
#define EMBER_AF_GENERATED_EVENT_STRINGS                                                                                           \
    "Identify Cluster Server EP 1", "On/off Cluster Server EP 1", "Level Control Cluster Server EP 1",                             \
        ...
        "Commissioning led event control", "Green Power Client Plugin Channel", "Green Power Client Plugin ExitCommissioning",     \
        "Green Power Server Plugin CommissioningWindowTimeout", "Green Power Server Plugin GenericSwitchCommissioningTimeout",     \
        "Green Power Server Plugin MultiSensorCommissioningTimeout", "Interpan Plugin FragmentReceive",                            \
