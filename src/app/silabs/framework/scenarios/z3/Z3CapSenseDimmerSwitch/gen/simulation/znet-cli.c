...
#if defined(EMBER_COMMAND_INTEPRETER_HAS_DESCRIPTION_FIELD)
static const char * const pluginSb1GestureSensorSendGestCommandArguments[] = {
  "Gesture to simulate.",
  "Button to simulate gesture on.",
  NULL
};
#endif

static EmberCommandEntry emberCommandPluginSb1GestureSensorTable[] = {
  emberCommandEntryActionWithDetails("msg-ready", emAfPluginSb1MessageReady, "", "Will print \"msg ready\" or \"no msg ready\" based on the state of the ...", NULL),
  emberCommandEntryActionWithDetails("read-msg", emAfPluginSb1ReadMessage, "", "Will generate an i2c read of the sb1 gesture sensor, printing the resu ...", NULL),
  emberCommandEntryActionWithDetails("send-gest", emAfPluginSb1SendGesture, "uu", "Will simulate receiving a gesture of type specified by the argument", pluginSb1GestureSensorSendGestCommandArguments),
  emberCommandEntryTerminator(),
};
