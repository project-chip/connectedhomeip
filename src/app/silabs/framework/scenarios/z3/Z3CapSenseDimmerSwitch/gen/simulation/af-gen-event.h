...
#define EMBER_AF_GENERATED_EVENT_CODE                                                                                              \
    ...
    extern EmberEventControl emberAfPluginSb1GestureSensorMessageReadyEventControl;                                                \
    ...
    extern EmberEventControl frameTimeoutControl;                                                                                  \
    extern EmberEventControl sendMatchDescriptorEventControl;                                                                      \
    ...
    extern void emberAfPluginSb1GestureSensorMessageReadyEventHandler(void);                                                       \
    ...
    extern void frameTimeoutHandler(void);                                                                                         \
    extern void sendMatchDescriptorEventHandler(void);                                                                             \
...
#define EMBER_AF_GENERATED_EVENTS                                                                                                  \
    { &emberAfIdentifyClusterServerTickCallbackControl1, emberAfIdentifyClusterServerTickCallbackWrapperFunction1 },               \
        ...
        { &frameTimeoutControl, frameTimeoutHandler }, { &sendMatchDescriptorEventControl, sendMatchDescriptorEventHandler },      \
...
#define EMBER_AF_GENERATED_EVENT_STRINGS                                                                                           \
    "Identify Cluster Server EP 1", "Over the Air Bootloading Cluster Client EP 1", "Poll Control Cluster Server EP 1",            \
        "Battery Monitor Plugin ReadADC", "Button Interface Plugin Button0Pressed", "Button Interface Plugin Button0Released",     \
        "Button Interface Plugin Button1Pressed", "Button Interface Plugin Button1Released",                                       \
        "Button Interface Plugin ButtonTimeout", "Connection Manager Plugin Poll", "Connection Manager Plugin Reboot",             \
        "Connection Manager Plugin Rejoin", "Find and Bind Initiator Plugin CheckTargetResponses",                                 \
        "LED Blinking Plugin Led0EventFunction", "LED Blinking Plugin Led1EventFunction",                                          \
        ...
        "OTA Simple Storage EEPROM Driver Plugin PageErase", "SB1 Gesture Sensor Plugin MessageReady",                             \
        "Scan Dispatch Plugin Scan", "Silicon Labs Device UI Plugin ButtonPressCount", "Silicon Labs Device UI Plugin Init",       \
        "Silicon Labs Device UI Plugin LedBlink", "Update TC Link Key Plugin BeginTcLinkKeyUpdate", "Frame timeout control",       \
        "Send match descriptor event control", "End Device Support Plugin Move NWK 0", "End Device Support Plugin Polling NWK 0",  \
