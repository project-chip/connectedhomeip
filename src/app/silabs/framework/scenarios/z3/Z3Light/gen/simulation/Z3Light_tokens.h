...
#define GENERATED_TOKEN_LOADER(endpoint)                                                                                           \
    ...
    {                                                                                                                              \
        ...
        {                                                                                                                          \
            ...
            emberAfWriteServerAttribute(2, ZCL_ON_OFF_CLUSTER_ID, ZCL_ON_OFF_ATTRIBUTE_ID, (uint8_t *) ptr,                        \
                                        ZCL_BOOLEAN_ATTRIBUTE_TYPE);                                                               \
            halCommonGetToken((tokType_start_up_on_off *) ptr, TOKEN_START_UP_ON_OFF_2);                                           \
            emberAfWriteServerAttribute(2, ZCL_ON_OFF_CLUSTER_ID, ZCL_START_UP_ON_OFF_ATTRIBUTE_ID, (uint8_t *) ptr,               \
                                        ZCL_ENUM8_ATTRIBUTE_TYPE);                                                                 \
            halCommonGetToken((tokType_current_level *) ptr, TOKEN_CURRENT_LEVEL_2);                                               \
            emberAfWriteServerAttribute(2, ZCL_LEVEL_CONTROL_CLUSTER_ID, ZCL_CURRENT_LEVEL_ATTRIBUTE_ID, (uint8_t *) ptr,          \
                                        ZCL_INT8U_ATTRIBUTE_TYPE);                                                                 \
            halCommonGetToken((tokType_start_up_current_level *) ptr, TOKEN_START_UP_CURRENT_LEVEL_2);                             \
            emberAfWriteServerAttribute(2, ZCL_LEVEL_CONTROL_CLUSTER_ID, ZCL_START_UP_CURRENT_LEVEL_ATTRIBUTE_ID, (uint8_t *) ptr, \
                                        ZCL_INT8U_ATTRIBUTE_TYPE);                                                                 \
            halCommonGetToken((tokType_color_control_color_temperature *) ptr, TOKEN_COLOR_CONTROL_COLOR_TEMPERATURE_2);           \
            emberAfWriteServerAttribute(2, ZCL_COLOR_CONTROL_CLUSTER_ID, ZCL_COLOR_CONTROL_COLOR_TEMPERATURE_ATTRIBUTE_ID,         \
            ...
            emberAfWriteServerAttribute(2, ZCL_COLOR_CONTROL_CLUSTER_ID, ZCL_START_UP_COLOR_TEMPERATURE_MIREDS_ATTRIBUTE_ID,       \
                                        (uint8_t *) ptr, ZCL_INT16U_ATTRIBUTE_TYPE);                                               \
        }                                                                                                                          \
    } while (false)
