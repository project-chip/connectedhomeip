...
#define EMBER_AF_GENERATED_EVENT_CODE                                                                                              \
    ...
    void emberAfOnOffClusterServerTickCallbackWrapperFunction1(void)                                                               \
    {                                                                                                                              \
        clusterTickWrapper(&emberAfOnOffClusterServerTickCallbackControl1, emberAfOnOffClusterServerTickCallback, 1);              \
    }                                                                                                                              \
    ...
    void emberAfIdentifyClusterServerTickCallbackWrapperFunction2(void)                                                            \
    {                                                                                                                              \
        clusterTickWrapper(&emberAfIdentifyClusterServerTickCallbackControl2, emberAfIdentifyClusterServerTickCallback, 2);        \
    }                                                                                                                              \
    void emberAfOnOffClusterServerTickCallbackWrapperFunction2(void)                                                               \
    {                                                                                                                              \
        clusterTickWrapper(&emberAfOnOffClusterServerTickCallbackControl2, emberAfOnOffClusterServerTickCallback, 2);              \
    }                                                                                                                              \
    void emberAfLevelControlClusterServerTickCallbackWrapperFunction2(void)                                                        \
    {                                                                                                                              \
        clusterTickWrapper(&emberAfLevelControlClusterServerTickCallbackControl2, emberAfLevelControlClusterServerTickCallback,    \
                           2);                                                                                                     \
    }                                                                                                                              \
    ...
    void emberAfPluginZllIdentifyServerTriggerEffectEndpointEventWrapper2(void)                                                    \
    {                                                                                                                              \
        clusterTickWrapper(&emberAfPluginZllIdentifyServerTriggerEffectEndpointEventControls[1],                                   \
                           emberAfPluginZllIdentifyServerTriggerEffectEndpointEventHandler, 2);                                    \
    }                                                                                                                              \
    void emberAfPluginZllIdentifyServerTriggerEffectEndpointEventWrapper242(void)                                                  \
    {                                                                                                                              \
        clusterTickWrapper(&emberAfPluginZllIdentifyServerTriggerEffectEndpointEventControls[2],                                   \
                           emberAfPluginZllIdentifyServerTriggerEffectEndpointEventHandler, 242);                                  \
    }
...
#define EMBER_AF_GENERATED_EVENTS                                                                                                  \
    { &emberAfIdentifyClusterServerTickCallbackControl1, emberAfIdentifyClusterServerTickCallbackWrapperFunction1 },               \
        ...
        { &emberAfPluginNetworkCreatorSecurityOpenNetworkEventControl,                                                             \
          emberAfPluginNetworkCreatorSecurityOpenNetworkEventHandler },                                                            \
        ...
        { &emberAfPluginZllIdentifyServerTriggerEffectEndpointEventControls[1],                                                    \
          emberAfPluginZllIdentifyServerTriggerEffectEndpointEventWrapper2 },                                                      \
        { &emberAfPluginZllIdentifyServerTriggerEffectEndpointEventControls[2],                                                    \
          emberAfPluginZllIdentifyServerTriggerEffectEndpointEventWrapper242 },

#define EMBER_AF_GENERATED_EVENT_STRINGS                                                                                           \
    "Identify Cluster Server EP 1", "On/off Cluster Server EP 1", "Level Control Cluster Server EP 1",                             \
        "Identify Cluster Server EP 2", "On/off Cluster Server EP 2", "Level Control Cluster Server EP 2",                         \
        "Commissioning led event control", "Color Control Cluster Server Plugin HueSatTransition",                                 \
        "Color Control Cluster Server Plugin TempTransition", "Color Control Cluster Server Plugin XyTransition",                  \
        "Green Power Client Plugin Channel", "Green Power Client Plugin ExitCommissioning", "Interpan Plugin FragmentReceive",     \
        "Interpan Plugin FragmentTransmit", "Network Creator Security Plugin OpenNetwork",                                         \
        "Network Steering Plugin FinishSteering", "Reporting Plugin Tick", "Scan Dispatch Plugin Scan",                            \
        "Update TC Link Key Plugin BeginTcLinkKeyUpdate", "Finding and binding event control",                                     \
        "ZLL Identify Server Plugin TriggerEffect EP 1", "ZLL Identify Server Plugin TriggerEffect EP 2",                          \
