 ...
 */
bool emberAfPluginZllCommissioningServerEndpointInformationCallback(uint8_t endpoint, uint8_t index,
 ...
 */
bool emberAfPluginZllCommissioningServerGroupIdentifierCallback(uint8_t endpoint, uint8_t index,
