...
#define EMBER_AF_GENERATED_EVENT_CODE                                                                                              \
    ...
    void emberAfPluginWwahEndDeviceExtensionUnenforceFastPollNetworkEventWrapper0(void)                                            \
    {                                                                                                                              \
        networkEventWrapper(&emberAfPluginWwahEndDeviceExtensionUnenforceFastPollNetworkEventControls[0],                          \
                            emberAfPluginWwahEndDeviceExtensionUnenforceFastPollNetworkEventHandler, 0);                           \
    }                                                                                                                              \
    ...
    void emberAfPluginWwahServerSilabsTriggerSurveyBeaconsNetworkEventWrapper0(void)                                               \
    {                                                                                                                              \
        networkEventWrapper(&emberAfPluginWwahServerSilabsTriggerSurveyBeaconsNetworkEventControls[0],                             \
                            emberAfPluginWwahServerSilabsTriggerSurveyBeaconsNetworkEventHandler, 0);                              \
    }                                                                                                                              \
    ...
    void emberAfSlWwahClusterServerTickCallbackWrapperFunction1(void)                                                              \
    {                                                                                                                              \
        clusterTickWrapper(&emberAfSlWwahClusterServerTickCallbackControl1, emberAfSlWwahClusterServerTickCallback, 1);            \
    }                                                                                                                              \
...
#define EMBER_AF_GENERATED_EVENTS                                                                                                  \
    { &emberAfIdentifyClusterServerTickCallbackControl1, emberAfIdentifyClusterServerTickCallbackWrapperFunction1 },               \
        ...
        { &emberAfPluginWwahConnectivityManagerBadParentRecoveryEventControl,                                                      \
          emberAfPluginWwahConnectivityManagerBadParentRecoveryEventHandler },                                                     \
        { &emberAfPluginWwahConnectivityManagerFastRejoinEventControl,                                                             \
          emberAfPluginWwahConnectivityManagerFastRejoinEventHandler },                                                            \
        { &emberAfPluginWwahConnectivityManagerLongUptimeEventControl,                                                             \
          emberAfPluginWwahConnectivityManagerLongUptimeEventHandler },                                                            \
        { &emberAfPluginWwahConnectivityManagerStateMachineEventControl,                                                           \
          emberAfPluginWwahConnectivityManagerStateMachineEventHandler },                                                          \
        { &emberAfPluginWwahConnectivityManagerStateTransitionEventControl,                                                        \
          emberAfPluginWwahConnectivityManagerStateTransitionEventHandler },                                                       \
        ...
        { &emberAfPluginWwahEndDeviceExtensionUnenforceFastPollNetworkEventControls[0],                                            \
          emberAfPluginWwahEndDeviceExtensionUnenforceFastPollNetworkEventWrapper0 },                                              \
        { &emberAfPluginWwahServerSilabsTriggerSurveyBeaconsNetworkEventControls[0],                                               \
          emberAfPluginWwahServerSilabsTriggerSurveyBeaconsNetworkEventWrapper0 },                                                 \
...
#define EMBER_AF_GENERATED_EVENT_STRINGS                                                                                           \
    "Identify Cluster Server EP 1", "Over the Air Bootloading Cluster Client EP 1", "Poll Control Cluster Server EP 1",            \
        "SL Works With All Hubs Cluster Server EP 1", "Commissioning event control", "Critical Message Queue Plugin Retry",        \
        "Door Lock Server Cluster Plugin Lockout", "Door Lock Server Cluster Plugin Relock",                                       \
        "Find and Bind Initiator Plugin CheckTargetResponses", "Identify Feedback Plugin ProvideFeedback",                         \
        "Network Steering Plugin FinishSteering", "OTA Simple Storage EEPROM Driver Plugin PageErase",                             \
        "Scan Dispatch Plugin Scan", "Simple Clock Plugin Update", "Update TC Link Key Plugin BeginTcLinkKeyUpdate",               \
        ...
        "SL Works With All Hubs Connectivity Manager Plugin StateTransition", "Finding and binding event control",                 \
        "Led event control", "End Device Support Plugin Move NWK 0", "End Device Support Plugin Polling NWK 0",                    \
