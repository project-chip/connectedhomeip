...
#if defined(EMBER_COMMAND_INTEPRETER_HAS_DESCRIPTION_FIELD)
static const char * const pluginOccupancyPyd1698CliNewStateCommandArguments[] = {
  "new state",
  NULL
};
#endif
...
#if defined(EMBER_COMMAND_INTEPRETER_HAS_DESCRIPTION_FIELD)
static const char * const pluginOccupancyPyd1698CliSetBlindTimeCommandArguments[] = {
  "value",
  NULL
};
#endif
...
#if defined(EMBER_COMMAND_INTEPRETER_HAS_DESCRIPTION_FIELD)
static const char * const pluginOccupancyPyd1698CliSetFilterSourceCommandArguments[] = {
  "value",
  NULL
};
#endif
...
#if defined(EMBER_COMMAND_INTEPRETER_HAS_DESCRIPTION_FIELD)
static const char * const pluginOccupancyPyd1698CliSetOperationModeCommandArguments[] = {
  "value",
  NULL
};
#endif
...
#if defined(EMBER_COMMAND_INTEPRETER_HAS_DESCRIPTION_FIELD)
static const char * const pluginOccupancyPyd1698CliSetPulseCounterCommandArguments[] = {
  "value",
  NULL
};
#endif
...
#if defined(EMBER_COMMAND_INTEPRETER_HAS_DESCRIPTION_FIELD)
static const char * const pluginOccupancyPyd1698CliSetThresholdCommandArguments[] = {
  "value",
  NULL
};
#endif
...
#if defined(EMBER_COMMAND_INTEPRETER_HAS_DESCRIPTION_FIELD)
static const char * const pluginOccupancyPyd1698CliSetWindowTimeCommandArguments[] = {
  "value",
  NULL
};
#endif
...
static EmberCommandEntry emberCommandPluginOccupancyPyd1698CliTable[] = {
  emberCommandEntryActionWithDetails("newState", emberAfPluginOccupancyPyd1698CliGenerateOccupancyCallback, "u", "Simulate a transition to a new occupancy state", pluginOccupancyPyd1698CliNewStateCommandArguments),
  emberCommandEntryActionWithDetails("read", emberAfPluginOccupancyPyd1698CliReadCommand, "", "Read and print the configuration status of the occupancy sensor.", NULL),
  emberCommandEntryActionWithDetails("set-blind-time", emberAfPluginOccupancyPyd1698CliSetBlindTimeCommand, "u", "Set the blind time configuration bits to the given value", pluginOccupancyPyd1698CliSetBlindTimeCommandArguments),
  emberCommandEntryActionWithDetails("set-filter-source", emberAfPluginOccupancyPyd1698CliSetFilterSourceCommand, "u", "Set the filter source configuration bits to the given value", pluginOccupancyPyd1698CliSetFilterSourceCommandArguments),
  emberCommandEntryActionWithDetails("set-operation-mode", emberAfPluginOccupancyPyd1698CliSetOperationModeCommand, "u", "Set the operation mode configuration bits to the given value", pluginOccupancyPyd1698CliSetOperationModeCommandArguments),
  emberCommandEntryActionWithDetails("set-pulse-counter", emberAfPluginOccupancyPyd1698CliSetPulseCounterCommand, "u", "Set the pulse counter configuration bits to the given value", pluginOccupancyPyd1698CliSetPulseCounterCommandArguments),
  emberCommandEntryActionWithDetails("set-threshold", emberAfPluginOccupancyPyd1698CliSetThresholdCommand, "u", "Set the threshold configuration bits to the given value", pluginOccupancyPyd1698CliSetThresholdCommandArguments),
  emberCommandEntryActionWithDetails("set-window-time", emberAfPluginOccupancyPyd1698CliSetWindowTimeCommand, "u", "Set the window time configuration bits to the given value", pluginOccupancyPyd1698CliSetWindowTimeCommandArguments),
  emberCommandEntryTerminator(),
};
