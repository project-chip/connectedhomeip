...
/** @addtogroup plugin-occupancy-pyd1698-cli Plugin Commands: PYD-1698 Occupancy Sensor CLI
 * @ingroup cli
 * Command line interface for changing operational parameters of the PYD-1698
 * occupancy sensor at runtime.
 *
 * @{
 */

/** @brief <b>plugin occupancy-pyd1698-cli newState [newState:1] </b>
 *   - <i>Simulate a transition to a new occupancy state</i>
 *     - newState - INT8U
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_PLUGIN_OCCUPANCY_PYD1698_CLI_PLUGIN_OCCUPANCY_PYD1698_CLI_NEW_STATE

/** @brief <b>plugin occupancy-pyd1698-cli read </b>
 *   - <i>Read and print the configuration status of the occupancy sensor.</i>
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_PLUGIN_OCCUPANCY_PYD1698_CLI_PLUGIN_OCCUPANCY_PYD1698_CLI_READ

/** @brief <b>plugin occupancy-pyd1698-cli set-blind-time [value:1] </b>
 *   - <i>Set the blind time configuration bits to the given value</i>
 *     - value - INT8U
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_PLUGIN_OCCUPANCY_PYD1698_CLI_PLUGIN_OCCUPANCY_PYD1698_CLI_SET_BLIND_TIME

/** @brief <b>plugin occupancy-pyd1698-cli set-filter-source [value:1] </b>
 *   - <i>Set the filter source configuration bits to the given value</i>
 *     - value - INT8U
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_PLUGIN_OCCUPANCY_PYD1698_CLI_PLUGIN_OCCUPANCY_PYD1698_CLI_SET_FILTER_SOURCE

/** @brief <b>plugin occupancy-pyd1698-cli set-operation-mode [value:1] </b>
 *   - <i>Set the operation mode configuration bits to the given value</i>
 *     - value - INT8U
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_PLUGIN_OCCUPANCY_PYD1698_CLI_PLUGIN_OCCUPANCY_PYD1698_CLI_SET_OPERATION_MODE

/** @brief <b>plugin occupancy-pyd1698-cli set-pulse-counter [value:1] </b>
 *   - <i>Set the pulse counter configuration bits to the given value</i>
 *     - value - INT8U
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_PLUGIN_OCCUPANCY_PYD1698_CLI_PLUGIN_OCCUPANCY_PYD1698_CLI_SET_PULSE_COUNTER

/** @brief <b>plugin occupancy-pyd1698-cli set-threshold [value:1] </b>
 *   - <i>Set the threshold configuration bits to the given value</i>
 *     - value - INT8U
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_PLUGIN_OCCUPANCY_PYD1698_CLI_PLUGIN_OCCUPANCY_PYD1698_CLI_SET_THRESHOLD

/** @brief <b>plugin occupancy-pyd1698-cli set-window-time [value:1] </b>
 *   - <i>Set the window time configuration bits to the given value</i>
 *     - value - INT8U
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_PLUGIN_OCCUPANCY_PYD1698_CLI_PLUGIN_OCCUPANCY_PYD1698_CLI_SET_WINDOW_TIME

/** @} */ // end group plugin-occupancy-pyd1698-cli
