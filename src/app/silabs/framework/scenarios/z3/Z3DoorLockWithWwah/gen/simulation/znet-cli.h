...
/** @addtogroup plugin-aps-link-key-authorization Plugin Commands: APS Link Key Authorization
 * @ingroup cli
 * This plugin provides a set of APIs and CLI commands for managing APS link key
 * authorization
 *
 * @{
 */

/** @brief <b>plugin aps-link-key-auth add-cluster-exempted [cluster:2] </b>
 *   - <i>Adds an entry to the cluster exempt list.</i>
...
/** @brief <b>plugin aps-link-key-auth clear-exempt-list </b>
 *   - <i>Clears the exempt list.</i>
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_PLUGIN_APS_LINK_KEY_AUTHORIZATION_PLUGIN_APS_LINK_KEY_AUTH_CLEAR_EXEMPT_LIST

/** @brief <b>plugin aps-link-key-auth enable [enable:1] </b>
 *   - <i>Enable or disable APS link key authorization for all clusters.</i>
...
/** @brief <b>plugin aps-link-key-auth enable-with-exempt-list [enable:1] [exemptClusterList:2] </b>
 *   - <i>Enables or disables APS link key authorization and setup the exempt list.</i>
 *     - enable - INT8U - Set the enable state of the APS link key security.
...
/** @brief <b>plugin aps-link-key-auth info </b>
 *   - <i>List information on the current state of APS link key authorization.</i>
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_PLUGIN_APS_LINK_KEY_AUTHORIZATION_PLUGIN_APS_LINK_KEY_AUTH_INFO

/** @} */ // end group plugin-aps-link-key-authorization
...
/** @addtogroup plugin critical-message-queue Plugin Commands: Critical Message Queue
 * @ingroup cli
 * This plugin provides commands for the CMQ
 *
 * @{
 */

/** @brief <b>plugin critical-message-queue print-config </b>
 *   - <i>Prints the config</i>
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_PLUGIN_CRITICAL_MESSAGE_QUEUE_PLUGIN_CRITICAL_MESSAGE_QUEUE_PRINT_CONFIG

/** @brief <b>plugin critical-message-queue print-queue </b>
 *   - <i>Prints the CMQ</i>
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_PLUGIN_CRITICAL_MESSAGE_QUEUE_PLUGIN_CRITICAL_MESSAGE_QUEUE_PRINT_QUEUE

/** @} */ // end group plugin critical-message-queue
...
/** @addtogroup plugin-wwah-connectivity-manager Plugin Commands: Wwah Connectivity Manager
 * @ingroup cli
 * The wwah-connectivity-manager plugin CLI contains commands to interact with
 * the connectivity manager.
 *
 * @{
 */

/** @brief <b>plugin wwah-connectivity-manager disable [endpoint:1] </b>
 *   - <i>Disable the WWAH Connectivity Manager rejoin algorithm.</i>
...
/** @brief <b>plugin wwah-connectivity-manager enable [endpoint:1] </b>
 *   - <i>Enable the WWAH Connectivity Manager rejoin algorithm.</i>
 *     - endpoint - INT8U - The endpoint which contains WWAH cluster
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_PLUGIN_WWAH_CONNECTIVITY_MANAGER_PLUGIN_WWAH_CONNECTIVITY_MANAGER_ENABLE

/** @brief <b>plugin wwah-connectivity-manager info </b>
 *   - <i>Print information about the WWAH Connectivity Manager state.</i>
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_PLUGIN_WWAH_CONNECTIVITY_MANAGER_PLUGIN_WWAH_CONNECTIVITY_MANAGER_INFO

/** @brief <b>plugin wwah-connectivity-manager min-rssi [rssi:1] </b>
 *   - <i>Sets minimum acceptable RSSI for receiving packets on a SoC WWAH-enabled device</i>
...
/** @brief <b>plugin wwah-connectivity-manager parent-recovery [enabled:1] [badParentRejoinPeriod:2] </b>
 *   - <i>Disable/enable the WWAH bad parent recovery. And set the bad parent check and rejoin period (min), if enabled.</i>
...
/** @brief <b>plugin wwah-connectivity-manager show </b>
 *   - <i>Shows the WWAH Connectivity Manager rejoin algorithm's parameters.</i>
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_PLUGIN_WWAH_CONNECTIVITY_MANAGER_PLUGIN_WWAH_CONNECTIVITY_MANAGER_SHOW

/** @} */ // end group plugin-wwah-connectivity-manager
