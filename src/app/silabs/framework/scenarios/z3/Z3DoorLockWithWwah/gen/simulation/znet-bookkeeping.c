...
void emberAfPluginZigbeeEventLoggerZigbeeKeyEstablishmentCallback(EmberEUI64 partner, EmberKeyStatus status);  // Plugin: zigbee-event-logger
...
void emAfZigbeeKeyEstablishment(EmberEUI64 partner, EmberKeyStatus status)
{
  ...
  emberAfPluginZigbeeEventLoggerZigbeeKeyEstablishmentCallback(partner, status);  // Plugin: zigbee-event-logger
}
