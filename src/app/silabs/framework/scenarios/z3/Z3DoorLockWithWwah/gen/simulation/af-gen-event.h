...
#define EMBER_AF_GENERATED_EVENT_STRINGS                                                                                           \
    "Identify Cluster Server EP 1", "Over the Air Bootloading Cluster Client EP 1", "SL Works With All Hubs Cluster Server EP 1",  \
        "Commissioning event control", "Critical Message Queue Plugin Retry", "Door Lock Server Cluster Plugin Lockout",           \
        "Door Lock Server Cluster Plugin Relock", "Find and Bind Initiator Plugin CheckTargetResponses",                           \
        "Identify Feedback Plugin ProvideFeedback", "Network Steering Plugin FinishSteering",                                      \
        "OTA Simple Storage EEPROM Driver Plugin PageErase", "Scan Dispatch Plugin Scan", "Simple Clock Plugin Update",            \
        "Update TC Link Key Plugin BeginTcLinkKeyUpdate", "SL Works With All Hubs Connectivity Manager Plugin BadParentRecovery",  \
        ...
        "Trust Center Keepalive Plugin Tick NWK 0", "SL Works With All Hubs End Device Extension Plugin UnenforceFastPoll NWK 0",  \
