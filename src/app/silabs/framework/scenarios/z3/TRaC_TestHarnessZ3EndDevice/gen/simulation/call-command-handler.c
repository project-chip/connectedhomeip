...
EmberAfStatus emberAfAlarmClusterClientCommandParse(EmberAfClusterCommand * cmd)
{
    ...
    if (!cmd->mfgSpecific)
    {
        ...
        case ZCL_ALARM_COMMAND_ID: {
            ...
            wasHandled = emberAfAlarmClusterAlarmCallback(alarmCode, clusterId);
            break;
        }
        default: {
            // Unrecognized command ID, error status will apply.
...
EmberAfStatus emberAfAlarmClusterServerCommandParse(EmberAfClusterCommand * cmd)
{
    ...
    if (!cmd->mfgSpecific)
    {
        ...
        case ZCL_RESET_ALARM_COMMAND_ID: {
            ...
            payloadOffset += 1u;
            clusterId  = emberAfGetInt16u(cmd->buffer, payloadOffset, cmd->bufLen);
            wasHandled = emberAfAlarmClusterResetAlarmCallback(alarmCode, clusterId);
            break;
        }
...
EmberAfStatus emberAfCommissioningClusterServerCommandParse(EmberAfClusterCommand * cmd)
{
    ...
    if (!cmd->mfgSpecific)
    {
        ...
        case ZCL_RESTART_DEVICE_COMMAND_ID: {
            ...
            wasHandled = emberAfCommissioningClusterRestartDeviceCallback(options, delay, jitter);
            break;
        }
        case ZCL_RESET_STARTUP_PARAMETERS_COMMAND_ID: {
            ...
            wasHandled = emberAfCommissioningClusterResetStartupParametersCallback(options, index);
            break;
        }
        default: {
            // Unrecognized command ID, error status will apply.
...
EmberAfStatus emberAfThermostatClusterServerCommandParse(EmberAfClusterCommand * cmd)
{
    ...
    if (!cmd->mfgSpecific)
    {
        ...
        case ZCL_SET_WEEKLY_SCHEDULE_COMMAND_ID: {
            ...
            payloadOffset += 1u;
            payload    = cmd->buffer + payloadOffset;
            wasHandled = emberAfThermostatClusterSetWeeklyScheduleCallback(numberOfTransitionsForSequence, dayOfWeekForSequence,
                                                                           modeForSequence, payload);
            break;
        }
