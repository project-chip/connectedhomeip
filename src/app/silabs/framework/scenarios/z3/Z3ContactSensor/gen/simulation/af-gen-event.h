...
#define EMBER_AF_GENERATED_EVENT_STRINGS                                                                                           \
    "Identify Cluster Server EP 1", "Over the Air Bootloading Cluster Client EP 1", "Poll Control Cluster Server EP 1",            \
        "IAS Zone Cluster Server EP 1", "Battery Monitor Plugin ReadADC", "Button Interface Plugin Button0Pressed",                \
        "Button Interface Plugin Button0Released", "Button Interface Plugin Button1Pressed",                                       \
        "Button Interface Plugin Button1Released", "Button Interface Plugin ButtonTimeout", "Connection Manager Plugin Poll",      \
        "Connection Manager Plugin Reboot", "Connection Manager Plugin Rejoin",                                                    \
        "Find and Bind Initiator Plugin CheckTargetResponses", "GPIO Sensor Interface Plugin Debounce",                            \
        "GPIO Sensor Interface Plugin Interrupt", "IAS Zone Server Plugin ManageQueue", "LED Blinking Plugin Led0EventFunction",   \
        "LED Blinking Plugin Led1EventFunction", "Manufacturing Library CLI Plugin CheckSendComplete",                             \
        "Manufacturing Library Ota Plugin Kickoff", "Manufacturing Library Ota Plugin Timeout",                                    \
        "Network Steering Plugin FinishSteering", "OTA Simple Storage EEPROM Driver Plugin PageErase", "Reporting Plugin Tick",    \
        "Scan Dispatch Plugin Scan", "Security Sensor Interface Plugin Init", "Security Sensor Interface Plugin InitialReport",    \
        "Silicon Labs Device UI Plugin ButtonPressCount", "Silicon Labs Device UI Plugin Init",                                    \
        "Silicon Labs Device UI Plugin LedBlink", "Temperature Measurement Server Cluster Plugin Read",                            \
        "Temperature Si7053 Plugin Init", "Temperature Si7053 Plugin Read", "Update TC Link Key Plugin BeginTcLinkKeyUpdate",      \
