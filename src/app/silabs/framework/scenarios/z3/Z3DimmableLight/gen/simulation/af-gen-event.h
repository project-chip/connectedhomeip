...
#define EMBER_AF_GENERATED_EVENT_STRINGS                                                                                           \
    "Identify Cluster Server EP 1", "Level Control Cluster Server EP 1", "Over the Air Bootloading Cluster Client EP 1",           \
        ...
        "Bulb user interface Plugin Rejoin", "Manufacturing Library CLI Plugin CheckSendComplete",                                 \
        ...
        "Scan Dispatch Plugin Scan", "Update TC Link Key Plugin BeginTcLinkKeyUpdate", "End Device Support Plugin Move NWK 0",     \
