...
const char * ezspMfgTokenNames[] = { "EZSP_MFG_CUSTOM_VERSION...", "EZSP_MFG_STRING...........", "EZSP_MFG_BOARD_NAME.......",
                                     "EZSP_MFG_MANUF_ID.........", "EZSP_MFG_PHY_CONFIG.......", "EZSP_MFG_BOOTLOAD_AES_KEY.",
                                     "EZSP_MFG_ASH_CONFIG.......", "EZSP_MFG_EZSP_STORAGE.....", "EZSP_STACK_CAL_DATA.......",
                                     "EZSP_MFG_CBKE_DATA........", "EZSP_MFG_INSTALLATION_CODE" };
...
bool emberAfIasAceClusterBypassCallback(uint8_t numberOfZones, uint8_t * zoneIds, uint8_t * armDisarmCode)
{
    ...
    emberAfFillCommandIasAceClusterBypassResponse(numberOfZones, zoneIds, numberOfZones);
    emberAfSendCommandUnicast(EMBER_OUTGOING_DIRECT, sender);
...
static void mfgappTokenDump(void)
{
    ...
    for (index = 0; index < MFGSAMP_NUM_EZSP_MFG_TOKENS; index++)
    {
        ...
        emberAfCorePrintln("[%x] %p: 0x%x:", index, ezspMfgTokenNames[index], tokenLength);
 ...
 */
bool emberAfSlWorksWithAllHubsClusterAPSLinkKeyAuthorizationQueryResponseCallback(uint16_t clusterId, uint8_t apsLinkKeyAuthStatus)
{
    return true;
}
