...
#define EMBER_AF_GENERATED_EVENT_CODE                                                                                              \
    ...
    void emberAfOtaBootloadClusterServerTickCallbackWrapperFunction1(void)                                                         \
    {                                                                                                                              \
        clusterTickWrapper(&emberAfOtaBootloadClusterServerTickCallbackControl1, emberAfOtaBootloadClusterServerTickCallback, 1);  \
    }
...
#define EMBER_AF_GENERATED_EVENTS                                                                                                  \
    { &emberAfIdentifyClusterServerTickCallbackControl1, emberAfIdentifyClusterServerTickCallbackWrapperFunction1 },               \
        ...
        { &emberAfPluginTestHarnessReadWriteAttributesTimeoutEventControl,                                                         \
          emberAfPluginTestHarnessReadWriteAttributesTimeoutEventHandler },                                                        \
        { &emberAfPluginTrustCenterNwkKeyUpdateBroadcastMyEventControl,                                                            \
          emberAfPluginTrustCenterNwkKeyUpdateBroadcastMyEventHandler },                                                           \
        { &emberAfPluginTrustCenterNwkKeyUpdatePeriodicMyEventControl,                                                             \
...
#define EMBER_AF_GENERATED_EVENT_STRINGS                                                                                           \
    "Identify Cluster Server EP 1", "Level Control Cluster Server EP 1", "Time Cluster Server EP 1",                               \
        "Over the Air Bootloading Cluster Server EP 1", "Color Control Cluster Server Plugin HueSatTransition",                    \
        "Color Control Cluster Server Plugin TempTransition", "Color Control Cluster Server Plugin XyTransition",                  \
        "EZ-Mode Commissioning Plugin State", "Green Power Client Plugin Channel", "Green Power Client Plugin ExitCommissioning",  \
        "IAS Zone Client Plugin StateMachine", "Identify Feedback Plugin ProvideFeedback",                                         \
        "Network Creator Security Plugin OpenNetwork", "Network Steering Plugin FinishSteering",                                   \
        "OTA Simple Storage EEPROM Driver Plugin PageErase", "Reporting Plugin Tick", "Scan Dispatch Plugin Scan",                 \
        "Simple Clock Plugin Update", "Test Harness Plugin FlashPageHash", "Test Harness Plugin ReadWriteAttributesTimeout",       \
        "Trust Center Network Key Update Broadcast Plugin My", "Trust Center Network Key Update Periodic Plugin My",               \
        "Trust Center Network Key Update Unicast Plugin My", "Update TC Link Key Plugin BeginTcLinkKeyUpdate",
