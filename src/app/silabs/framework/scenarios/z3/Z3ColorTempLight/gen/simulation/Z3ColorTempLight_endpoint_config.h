...
#define GENERATED_ATTRIBUTES {                                                                                                                                                       \
    ...
    { 0x0008, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (ATTRIBUTE_MASK_CLIENT), { (uint8_t*)0xA003 } }, /* 32 / Over the Air Bootloading / Image Type ID*/                                      \
    ...
    { 0x0007, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (ATTRIBUTE_MASK_TOKENIZE), { (uint8_t*)278 } }, /* 39 / Color Control / color temperature*/                                              \
    { 0x0008, ZCL_ENUM8_ATTRIBUTE_TYPE, 1, (0x00), { (uint8_t*)0x02 } }, /* 40 / Color Control / color mode*/                                                                        \
    ...
    { 0x4001, ZCL_ENUM8_ATTRIBUTE_TYPE, 1, (0x00), { (uint8_t*)2 } }, /* 43 / Color Control / enhanced color mode*/                                                                  \
    { 0x400A, ZCL_BITMAP16_ATTRIBUTE_TYPE, 2, (0x00), { (uint8_t*)0x0010 } }, /* 44 / Color Control / color capabilities*/                                                           \
    { 0x400B, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (0x00), { (uint8_t*)200 } }, /* 45 / Color Control / color temp physical min*/                                                           \
    { 0x400C, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (0x00), { (uint8_t*)454 } }, /* 46 / Color Control / color temp physical max*/                                                           \
    { 0x400D, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (0x00), { (uint8_t*)0x0000UL } }, /* 47 / Color Control / couple color temp to level min-mireds*/                                        \
    { 0x4010, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (ATTRIBUTE_MASK_WRITABLE | ATTRIBUTE_MASK_TOKENIZE), { (uint8_t*)0xFFFF } }, /* 48 / Color Control / start up color temperature mireds*/ \
    { 0xFFFD, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (0x00), { (uint8_t*)0x0001 } }, /* 49 / Color Control / cluster revision*/                                                               \
    { 0x011B, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (0x00), { (uint8_t*)0x0000 } }, /* 50 / Diagnostics / average mac retry per aps message sent*/                                           \
    { 0x011C, ZCL_INT8U_ATTRIBUTE_TYPE, 1, (0x00), { (uint8_t*)0x00 } }, /* 51 / Diagnostics / last message lqi*/                                                                    \
    { 0x011D, ZCL_INT8S_ATTRIBUTE_TYPE, 1, (0x00), { (uint8_t*)0x00 } }, /* 52 / Diagnostics / last message rssi*/                                                                   \
    { 0xFFFD, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (0x00), { (uint8_t*)0x0001 } }, /* 53 / Diagnostics / cluster revision*/                                                                 \
    { 0x0000, ZCL_BOOLEAN_ATTRIBUTE_TYPE, 1, (0x00), { (uint8_t*)0x00 } }, /* 54 / Configuration Cluster / Prevents OTA writing of tokens.*/                                         \
    { 0xFFFD, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (0x00), { (uint8_t*)0x0001 } }, /* 55 / Configuration Cluster / cluster revision*/                                                       \
    { 0x0000, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (0x00), { (uint8_t*)0x0000 } }, /* 56 / MFGLIB Cluster / Number of packets received while in MFGLIB mode.*/                              \
    { 0x0001, ZCL_INT8S_ATTRIBUTE_TYPE, 1, (0x00), { (uint8_t*)0x00 } }, /* 57 / MFGLIB Cluster / RSSI of the first received packet.*/                                               \
    { 0x0002, ZCL_INT8U_ATTRIBUTE_TYPE, 1, (0x00), { (uint8_t*)0x00 } }, /* 58 / MFGLIB Cluster / LQI of the first received packet.*/                                                \
    { 0xFFFD, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (0x00), { (uint8_t*)0x0001 } }, /* 59 / MFGLIB Cluster / cluster revision*/                                                              \
}
...
#define GENERATED_CLUSTERS {                                                                                                                                                                                             \
    ...
    { 0x0300, (EmberAfAttributeMetadata*)&(generatedAttributes[36]), 14, 24, (CLUSTER_MASK_SERVER | CLUSTER_MASK_INIT_FUNCTION | CLUSTER_MASK_ATTRIBUTE_CHANGED_FUNCTION), emberAfFuncArrayColorControlClusterServer, }, \
    { 0x0B05, (EmberAfAttributeMetadata*)&(generatedAttributes[50]), 4, 6, (CLUSTER_MASK_SERVER), NULL, },                                                                                                               \
    { 0xFC01, (EmberAfAttributeMetadata*)&(generatedAttributes[54]), 2, 3, (CLUSTER_MASK_SERVER | CLUSTER_MASK_INIT_FUNCTION), emberAfFuncArrayOtaConfigurationClusterServer, },                                         \
    { 0xFC02, (EmberAfAttributeMetadata*)&(generatedAttributes[56]), 4, 6, (CLUSTER_MASK_SERVER), NULL, },                                                                                                               \
}

// Endpoint types
#define GENERATED_ENDPOINT_TYPES {                        \
    { (EmberAfCluster*)&(generatedClusters[0]), 11, 97 }, \
}
