 ...
 *     - badParentRejoinPeriod - INT16U - the Period of time after which, we check if a parent is bad and try rejoin if so. 0 means
 * use the default value of 24 * 60 mins.
 */
