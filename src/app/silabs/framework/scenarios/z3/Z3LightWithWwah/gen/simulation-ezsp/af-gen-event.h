...
#define EMBER_AF_GENERATED_EVENT_STRINGS                                                                                           \
    "Identify Cluster Server EP 1", "On/off Cluster Server EP 1", "Over the Air Bootloading Cluster Client EP 1",                  \
        "IAS Zone Cluster Server EP 1", "SL Works With All Hubs Cluster Server EP 1", "Identify Cluster Server EP 2",              \
        "On/off Cluster Server EP 2", "Level Control Cluster Server EP 2", "Commissioning led event control",                      \
        "Color Control Cluster Server Plugin HueSatTransition", "Color Control Cluster Server Plugin TempTransition",              \
        "Color Control Cluster Server Plugin XyTransition", "Green Power Client Plugin Channel",                                   \
        "Green Power Client Plugin ExitCommissioning", "IAS Zone Server Plugin ManageQueue", "Interpan Plugin FragmentReceive",    \
        ...
        "Trust Center Keepalive Plugin Tick NWK 0", "SL Works With All Hubs Server Cluster Plugin TriggerSurveyBeacons NWK 0",     \
