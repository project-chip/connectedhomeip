...
// Creator for attribute: current hue, endpoint: 1
#define CREATOR_COLOR_CONTROL_CURRENT_HUE_1 0xB006
#define NVM3KEY_COLOR_CONTROL_CURRENT_HUE_1 (NVM3KEY_DOMAIN_ZIGBEE | 0xB006)
// Creator for attribute: current saturation, endpoint: 1
#define CREATOR_COLOR_CONTROL_CURRENT_SATURATION_1 0xB007
#define NVM3KEY_COLOR_CONTROL_CURRENT_SATURATION_1 (NVM3KEY_DOMAIN_ZIGBEE | 0xB007)
// Creator for attribute: current x, endpoint: 1
#define CREATOR_COLOR_CONTROL_CURRENT_X_1 0xB008
#define NVM3KEY_COLOR_CONTROL_CURRENT_X_1 (NVM3KEY_DOMAIN_ZIGBEE | 0xB008)
// Creator for attribute: current y, endpoint: 1
#define CREATOR_COLOR_CONTROL_CURRENT_Y_1 0xB009
#define NVM3KEY_COLOR_CONTROL_CURRENT_Y_1 (NVM3KEY_DOMAIN_ZIGBEE | 0xB009)
// Creator for attribute: color temperature, endpoint: 1
#define CREATOR_COLOR_CONTROL_COLOR_TEMPERATURE_1 0xB00A
#define NVM3KEY_COLOR_CONTROL_COLOR_TEMPERATURE_1 (NVM3KEY_DOMAIN_ZIGBEE | 0xB00A)
// Creator for attribute: color mode, endpoint: 1
#define CREATOR_COLOR_CONTROL_COLOR_MODE_1 0xB00B
#define NVM3KEY_COLOR_CONTROL_COLOR_MODE_1 (NVM3KEY_DOMAIN_ZIGBEE | 0xB00B)
// Creator for attribute: start up color temperature mireds, endpoint: 1
#define CREATOR_START_UP_COLOR_TEMPERATURE_MIREDS_1 0xB00C
#define NVM3KEY_START_UP_COLOR_TEMPERATURE_MIREDS_1 (NVM3KEY_DOMAIN_ZIGBEE | 0xB00C)
...
DEFINE_BASIC_TOKEN(COLOR_CONTROL_CURRENT_HUE_1, tokType_color_control_current_hue, 0x00)
DEFINE_BASIC_TOKEN(COLOR_CONTROL_CURRENT_SATURATION_1, tokType_color_control_current_saturation, 254)
DEFINE_BASIC_TOKEN(COLOR_CONTROL_CURRENT_X_1, tokType_color_control_current_x, 0x616B)
DEFINE_BASIC_TOKEN(COLOR_CONTROL_CURRENT_Y_1, tokType_color_control_current_y, 0x607D)
DEFINE_BASIC_TOKEN(COLOR_CONTROL_COLOR_TEMPERATURE_1, tokType_color_control_color_temperature, 278)
DEFINE_BASIC_TOKEN(COLOR_CONTROL_COLOR_MODE_1, tokType_color_control_color_mode, 0x01)
