...
/** @addtogroup plugin-custom-ezsp Plugin Commands:  Custom Ezsp
 * @ingroup cli
 * This plugin provides a set of CLI commands for sending custom EZSP c
 *
 * @{
 */

/** @brief <b>plugin custom-ezsp add_cluster [clusterId:2] </b>
 *   - <i>Add a cluster to the list that will be filtered by the XNCP.</i>
 *     - clusterId - INT16U - The cluster id.
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_PLUGIN_CUSTOM_EZSP_PLUGIN_CUSTOM_EZSP_ADD_CLUSTER

/** @brief <b>plugin custom-ezsp get_info </b>
 *   - <i>Print the current info about the XNCP.</i>
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_PLUGIN_CUSTOM_EZSP_PLUGIN_CUSTOM_EZSP_GET_INFO

/** @brief <b>plugin custom-ezsp get_mode </b>
 *   - <i>Print the XNCP's current power mode.</i>
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_PLUGIN_CUSTOM_EZSP_PLUGIN_CUSTOM_EZSP_GET_MODE

/** @brief <b>plugin custom-ezsp get_token </b>
 *   - <i></i>
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_PLUGIN_CUSTOM_EZSP_PLUGIN_CUSTOM_EZSP_GET_TOKEN

/** @brief <b>plugin custom-ezsp print_list </b>
 *   - <i>Print the list of clusters filtered by the XNCP.</i>
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_PLUGIN_CUSTOM_EZSP_PLUGIN_CUSTOM_EZSP_PRINT_LIST

/** @brief <b>plugin custom-ezsp rem_cluster [clusterId:2] </b>
 *   - <i>Remove a cluster from the list that is be filtered by the XNCP.</i>
 *     - clusterId - INT16U - The cluster id.
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_PLUGIN_CUSTOM_EZSP_PLUGIN_CUSTOM_EZSP_REM_CLUSTER

/** @brief <b>plugin custom-ezsp reports_off </b>
 *   - <i></i>
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_PLUGIN_CUSTOM_EZSP_PLUGIN_CUSTOM_EZSP_REPORTS_OFF

/** @brief <b>plugin custom-ezsp reports_on [time:2] </b>
 *   - <i></i>
 *     - time - INT16U - The time.
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_PLUGIN_CUSTOM_EZSP_PLUGIN_CUSTOM_EZSP_REPORTS_ON

/** @brief <b>plugin custom-ezsp set_mode [mode:1] </b>
 *   - <i>Modify the entry in the clients load control event table to opt in for a scheduled load control event.</i>
 *     - mode - INT8U - The power mode.
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_PLUGIN_CUSTOM_EZSP_PLUGIN_CUSTOM_EZSP_SET_MODE

/** @brief <b>plugin custom-ezsp set_token [nodeType:1] [nodeId:2] [panId:2] </b>
 *   - <i></i>
 *     - nodeType - INT8U - The node type.
 *     - nodeId - INT16U - The node id.
 *     - panId - INT16U - The pan id.
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_PLUGIN_CUSTOM_EZSP_PLUGIN_CUSTOM_EZSP_SET_TOKEN

/** @} */ // end group plugin-custom-ezsp
