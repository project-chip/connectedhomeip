...
#if defined(EMBER_COMMAND_INTEPRETER_HAS_DESCRIPTION_FIELD)
static const char * const pluginCustomEzspAddClusterCommandArguments[] = {
  "The cluster id.",
  NULL
};
#endif
...
#if defined(EMBER_COMMAND_INTEPRETER_HAS_DESCRIPTION_FIELD)
static const char * const pluginCustomEzspRemClusterCommandArguments[] = {
  "The cluster id.",
  NULL
};
#endif
...
#if defined(EMBER_COMMAND_INTEPRETER_HAS_DESCRIPTION_FIELD)
static const char * const pluginCustomEzspReportsOnCommandArguments[] = {
  "The time.",
  NULL
};
#endif
...
#if defined(EMBER_COMMAND_INTEPRETER_HAS_DESCRIPTION_FIELD)
static const char * const pluginCustomEzspSetModeCommandArguments[] = {
  "The power mode.",
  NULL
};
#endif
...
#if defined(EMBER_COMMAND_INTEPRETER_HAS_DESCRIPTION_FIELD)
static const char * const pluginCustomEzspSetTokenCommandArguments[] = {
  "The node type.",
  "The node id.",
  "The pan id.",
  NULL
...
static EmberCommandEntry emberCommandPluginCustomEzspTable[] = {
  emberCommandEntryActionWithDetails("add_cluster", emberAfPluginCustomEzspAddClusterToFilteringListCommand, "v", "Add a cluster to the list that will be filtered by the XNCP.", pluginCustomEzspAddClusterCommandArguments),
  emberCommandEntryActionWithDetails("get_info", emberAfPluginCustomEzspGetXNcpInfoCommand, "", "Print the current info about the XNCP.", NULL),
  emberCommandEntryActionWithDetails("get_mode", emberAfPluginCustomEzspGetPowerModeCommand, "", "Print the XNCP's current power mode.", NULL),
  emberCommandEntryActionWithDetails("get_token", emberAfPluginCustomEzspGetCustomTokenCommand, "", "", NULL),
  emberCommandEntryActionWithDetails("print_list", emberAfPluginCustomEzspPrintClusterFilteringListCommand, "", "Print the list of clusters filtered by the XNCP.", NULL),
  emberCommandEntryActionWithDetails("rem_cluster", emberAfPluginCustomEzspRemoveClusterToFilteringListCommand, "v", "Remove a cluster from the list that is be filtered by the XNCP.", pluginCustomEzspRemClusterCommandArguments),
  emberCommandEntryActionWithDetails("reports_off", emberAfPluginCustomEzspDisableReportsCommand, "", "", NULL),
  emberCommandEntryActionWithDetails("reports_on", emberAfPluginCustomEzspEnableReportsCommand, "v", "", pluginCustomEzspReportsOnCommandArguments),
  emberCommandEntryActionWithDetails("set_mode", emberAfPluginCustomEzspSetPowerModeCommand, "u", "Modify the entry in the clients load control event table to opt in for ...", pluginCustomEzspSetModeCommandArguments),
  emberCommandEntryActionWithDetails("set_token", emberAfPluginCustomEzspSetCustomTokenCommand, "uvv", "", pluginCustomEzspSetTokenCommandArguments),
  emberCommandEntryTerminator(),
};
...
static EmberCommandEntry emberCommandPluginTable[] = {
  ...
  emberCommandEntrySubMenu("custom-ezsp", emberCommandPluginCustomEzspTable, ""),
