...
/***************************************************************************/ /**
                                                                               * @file
                                                                               * @brief Routines for the Identify Feedback plugin,
                                                                               *which implements the feedback component of the
                                                                               *Identify cluster.
                                                                               *******************************************************************************
                                                                               ******************************************************************************/
...
void emberAfPluginIdentifyFeedbackProvideFeedbackEventHandler(void)
{
    ...
    emberEventControlSetDelayMS(emberAfPluginIdentifyFeedbackProvideFeedbackEventControl, MILLISECOND_TICKS_PER_SECOND);
}
...
void emberAfPluginIdentifyStartFeedbackCallback(uint8_t endpoint, uint16_t identifyTime)
{
    ...
    emberAfIdentifyClusterPrintln("Starting identifying on endpoint 0x%x, identify time is %d sec", endpoint, identifyTime);
