...
/***************************************************************************/ /**
                                                                               * @file
                                                                               * @brief CLI commands related to the fragmentation
                                                                               *code.
                                                                               *******************************************************************************
                                                                               ******************************************************************************/
...
#ifdef EMBER_TEST
    emberCommandEntryAction("set-rx-window-size", emAfPluginFragmentationSetWindowSizeCommand, "u",
                            "Sets the window size for fragmented transmissions."),
    emberCommandEntryAction("artificial-block-drop", emAfPluginFragmentationArtificialBlockDropCommand,
...
void emAfPluginFragmentationSetWindowSizeCommand(void)
{
    ...
    emberAfAppPrintln("Fragmentation RX window size set to %d", emberFragmentWindowSize);
