...
/***************************************************************************/ /**
                                                                               * @file
                                                                               * @brief CLI for the Smart Energy Registration
                                                                               *plugin.
                                                                               *******************************************************************************
                                                                               ******************************************************************************/
...
{
#ifdef EMBER_AF_PLUGIN_SMART_ENERGY_REGISTRATION_DELAY_PERIOD
    emAfPluginSmartEnergyRegistrationDiscoveryPeriod = (uint32_t) emberUnsignedCommandArgument(0) * MILLISECOND_TICKS_PER_SECOND;

    emberAfAppPrintln("Smart energy registration discovery period set to 0x%4x", emAfPluginSmartEnergyRegistrationDiscoveryPeriod);
#else
