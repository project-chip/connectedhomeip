...
/***************************************************************************/ /**
                                                                               * @file
                                                                               * @brief APIs and defines for the Key Establishment
                                                                               *plugin, which handles establishment of link keys per
                                                                               *the Smart Energy Key Establishment cluster.
                                                                               *******************************************************************************
                                                                               ******************************************************************************/
...
#define TERMINATE_STATUS_STRINGS                                                                                                   \
    {                                                                                                                              \
        "Success", "Unknown Issuer", "Bad Key Confirm", "Bad Message", "No resources", "Unsupported suite", "Invalid certificate", \
            "???",                                                                                                                 \
    }
...
#define isCbkeKeyEstablishmentSuiteValid() (emAfCurrentCbkeSuite <= EMBER_AF_CBKE_KEY_ESTABLISHMENT_SUITE_283K1)

#define isCbkeKeyEstablishmentSuite163k1() (emAfCurrentCbkeSuite == EMBER_AF_CBKE_KEY_ESTABLISHMENT_SUITE_163K1)

#define isCbkeKeyEstablishmentSuite283k1() (emAfCurrentCbkeSuite == EMBER_AF_CBKE_KEY_ESTABLISHMENT_SUITE_283K1)
