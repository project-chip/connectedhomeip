...
extern void emAfPluginKeyEstablishmentCalculateSmacsHandler283k1(EmberStatus status, EmberSmacData * initiatorSmac,
...
uint8_t responderCertificateStatic[] = {
    ...
    0x03, 0x03, 0xB4, 0xE9, 0xDC, 0x54, 0x3A, 0x64, 0x33, 0x3C, 0x98, 0x23, 0x08, 0x02, 0x2B, 0x54, 0xE6, 0x7E, 0x2F, 0x15, 0xF5,
    0x32, 0x55, 0x1B, 0x0A, 0x11, 0xE2, 0xE2, 0xC1, 0xC1, 0xD3, 0x09, 0x7A, 0x43, 0x24, 0xE7, 0xED
};

// The contents of this don't matter
EmberPublicKey283k1Data ephemeralPublicKey = { 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0a, 0x0b, 0x0c, 0x0d,
                                               0x0e, 0x0f, 0x10, 0x11, 0x12, 0x13, 0x14, 0x15, 0x16, 0x17, 0x18, 0x19, 0x1a,
                                               0x1b, 0x1c, 0x1d, 0x1e, 0x1f, 0x20, 0x21, 0x22, 0x23, 0x24, 0x25 };

EmberSmacData smacData = { 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0a, 0x0b, 0x0c, 0x0d, 0x0e, 0x0f, 0x10 };
...
EmberEventData keyEstablishmentEvents[] = { { &emberAfPluginKeyEstablishmentApsDuplicateDetectionEventControl,
...
static void cbkeApsDuplicationTest(void)
{
    ...
    addSimpleAction("emberAfInitiateKeyEstablishmentCallback(%d,%d)", emberAfInitiateKeyEstablishmentCallback, 2, 0x0000,
                    CBKE_ENDPOINT);
    ...
    addSimpleAction("emberAfPluginKeyEstablishmentReadAttributesCallback(%d)", emberAfPluginKeyEstablishmentReadAttributesCallback,
                    1, EMBER_AF_CBKE_KEY_ESTABLISHMENT_SUITE_283K1);
    ...
    addSimpleAction("emberAfKeyEstablishmentClusterInitiateKeyEstablishmentResponseCallback(%d,%d,%d,%p)",
                    emberAfKeyEstablishmentClusterInitiateKeyEstablishmentResponseCallback, 4,
                    EMBER_AF_CBKE_KEY_ESTABLISHMENT_SUITE_283K1, CBKE_GENERATE_TIME, CBKE_GENERATE_TIME,
    ...
    addSimpleAction("emAfPluginKeyEstablishmentGenerateCbkeKeysHandler283k1(%d,%p)",
                    emAfPluginKeyEstablishmentGenerateCbkeKeysHandler283k1, 2, EMBER_SUCCESS, &ephemeralPublicKey);
    ...
    addSimpleAction("emberAfKeyEstablishmentClusterEphemeralDataResponseCallback(%p)",
                    emberAfKeyEstablishmentClusterEphemeralDataResponseCallback, 1, buffer);
    ...
    addSimpleAction("emAfPluginKeyEstablishmentCalculateSmacsHandler283k1(%d,%p,%p)",
                    emAfPluginKeyEstablishmentCalculateSmacsHandler283k1, 3, EMBER_SUCCESS, &smacData, &smacData);
    ...
    addSimpleAction("emberAfKeyEstablishmentClusterConfirmKeyDataResponseCallback(%p)",
                    emberAfKeyEstablishmentClusterConfirmKeyDataResponseCallback, 1, (uint8_t *) &smacData);
    ...
    addRunAction((KEY_ESTABLISHMENT_APS_DUPLICATE_DETECTION_TIMEOUT_SEC / 2 * MILLISECOND_TICKS_PER_SECOND) +
