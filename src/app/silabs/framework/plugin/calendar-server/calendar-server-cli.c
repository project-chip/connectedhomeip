...
void emAfCalendarServerCliPublishCalendar(void)
{
    ...
    emberAfCalendarServerPublishCalendarMessage(nodeId, srcEndpoint, dstEndpoint, calendarIndex);
}
...
void emAfCalendarServerCliPublishDayProfiles(void)
{
    ...
    emberAfCalendarServerPublishDayProfilesMessage(nodeId, srcEndpoint, dstEndpoint, calendarIndex, dayIndex);
}
...
void emAfCalendarServerCliPublishWeekProfile(void)
{
    ...
    emberAfCalendarServerPublishDayProfilesMessage(nodeId, srcEndpoint, dstEndpoint, calendarIndex, weekIndex);
}
...
void emAfCalendarServerCliPublishSeasons(void)
{
    ...
    uint8_t dstEndpoint   = (uint8_t) emberUnsignedCommandArgument(2);
    uint8_t calendarIndex = (uint8_t) emberUnsignedCommandArgument(3);
    emberAfCalendarServerPublishSeasonsMessage(nodeId, srcEndpoint, dstEndpoint, calendarIndex);
}
...
void emAfCalendarServerCliPublishSpecialDays(void)
{
    ...
    uint8_t dstEndpoint   = (uint8_t) emberUnsignedCommandArgument(2);
    uint8_t calendarIndex = (uint8_t) emberUnsignedCommandArgument(3);
    emberAfCalendarServerPublishSpecialDaysMessage(nodeId, srcEndpoint, dstEndpoint, calendarIndex);
}
...
void emberAfCalendarServerCliCancelCalendar(void)
{
    ...
    uint8_t dstEndpoint   = (uint8_t) emberUnsignedCommandArgument(2);
    uint8_t calendarIndex = (uint8_t) emberUnsignedCommandArgument(3);
    emberAfCalendarServerCancelCalendarMessage(nodeId, srcEndpoint, dstEndpoint, calendarIndex);
