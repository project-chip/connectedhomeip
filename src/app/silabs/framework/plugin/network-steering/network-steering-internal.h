...
/***************************************************************************/ /**
                                                                               * @file
                                                                               * @brief Internal APIs and defines for the Network
                                                                               *Steering plugin.
                                                                               *******************************************************************************
                                                                               ******************************************************************************/
...
#define TRYING_ALL_KEYS                                                                                                            \
    (((emAfPluginNetworkSteeringState) == EMBER_AF_PLUGIN_NETWORK_STEERING_STATE_SCAN_PRIMARY_USE_ALL_KEYS) ||                     \
...
#define emAfPluginNetworkSteeringStateUsesInstallCodes()                                                                           \
    (((emAfPluginNetworkSteeringState) == EMBER_AF_PLUGIN_NETWORK_STEERING_STATE_SCAN_PRIMARY_INSTALL_CODE) ||                     \
     ((emAfPluginNetworkSteeringState) == EMBER_AF_PLUGIN_NETWORK_STEERING_STATE_SCAN_SECONDARY_INSTALL_CODE) || TRYING_ALL_KEYS)

#define emAfPluginNetworkSteeringStateUsesCentralizedKey()                                                                         \
    (((emAfPluginNetworkSteeringState) == EMBER_AF_PLUGIN_NETWORK_STEERING_STATE_SCAN_PRIMARY_CENTRALIZED) ||                      \
...
#define emAfPluginNetworkSteeringStateUsesDistributedKey()                                                                         \
    (((emAfPluginNetworkSteeringState) == EMBER_AF_PLUGIN_NETWORK_STEERING_STATE_SCAN_PRIMARY_DISTRIBUTED) ||                      \
...
#define emAfPluginNetworkSteeringStateSetUpdateTclk()                                                                              \
    ((emAfPluginNetworkSteeringState) |= EMBER_AF_PLUGIN_NETWORK_STEERING_STATE_UPDATE_TCLK)
...
#define emAfPluginNetworkSteeringStateSetVerifyTclk()                                                                              \
    ((emAfPluginNetworkSteeringState) |= EMBER_AF_PLUGIN_NETWORK_STEERING_STATE_VERIFY_TCLK)
