...
/***************************************************************************/ /**
                                                                               * @file
                                                                               * @brief CLI for the Comms Hub Function Sub Ghz
                                                                               *plugin.
                                                                               *******************************************************************************
                                                                               ******************************************************************************/
...
void emAfPluginCommsHubFunctionSubGhzCliChannelChangeComplete(void)
{
    ...
    const uint32_t pageChannelMask =
        (page << 27 |
         BIT32(channel)); // note replace as soon as possible with EMBER_PAGE_CHANNEL_MASK_FROM_CHANNEL_NUMBER(page, channel);
