...
void emAfDeviceManagementServerCliTenancy(void)
{
    ...
    emberAfPluginDeviceManagementSetTenancy(&tenancy, false);
}
...
void emAfDeviceManagementServerCliSupplier(void)
{
    ...
    length                                     = emberCopyStringArgument(4, supplier.proposedProviderName + 1,
                                     EMBER_AF_DEVICE_MANAGEMENT_MAXIMUM_PROPOSED_PROVIDER_NAME_LENGTH, false);
    supplier.proposedProviderName[0]           = length;
    length                                     = emberCopyStringArgument(5, supplier.proposedProviderContactDetails + 1,
...
void emAfDeviceManagementServerCliSiteId(void)
{
    ...
    length           = emberCopyStringArgument(0, siteId.siteId + 1, EMBER_AF_DEVICE_MANAGEMENT_MAXIMUM_SITE_ID_LENGTH, false);
...
void emAfDeviceManagementServerCliCIN(void)
{
    ...
    length                     = emberCopyStringArgument(0, cin.cin + 1, EMBER_AF_DEVICE_MANAGEMENT_MAXIMUM_CIN_LENGTH, false);
    cin.cin[0]                 = length;
...
void emAfDeviceManagementServerCliPassword(void)
{
    ...
    length = emberCopyStringArgument(0, password.password + 1, EMBER_AF_DEVICE_MANAGEMENT_MAXIMUM_PASSWORD_LENGTH, false);
...
void emAfDeviceManagementServerCliSendRequestNewPasswordResponse(void)
{
    ...
    emberAfDeviceManagementClusterSendRequestNewPasswordResponse(passwordType, dstAddr, srcEndpoint, dstEndpoint);
}
