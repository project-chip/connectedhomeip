...
/***************************************************************************/ /**
                                                                               * @file
                                                                               * @brief This file declares an interface to send and
...
#define EM_AF_ZCL_IP_CONFIGURE_REMOTE_CLUSTERS_RECORD_LENGTH                                                                       \
    (EM_AF_ZCL_IP_CONFIGURE_REMOTE_CLUSTERS_RECORD_TYPE_OFFSET + EM_AF_ZCL_IP_CONFIGURE_REMOTE_CLUSTERS_RECORD_TYPE_OFFSET_LENGTH)
...
#define EM_AF_ZCL_IP_DEVICE_DISCOVERY_UPDATE_COMMAND_MIN_LENGTH EM_AF_ZCL_IP_DEVICE_DISCOVERY_UPDATE_COMMAND_ENDPOINT_INFO_INDEX
...
EmberStatus emberAfPluginZclIpGenerateOutgoingConfigureRemoteBinding(EmberEUI64 targetEUI64, uint8_t sourceEndpoint,
                                                                     uint8_t destEndpoint, uint16_t clusterId, EmberEUI64 destEUI64,
...
#define emAfGetLittleEndianInt16uFromBuffer(pointer) HIGH_LOW_TO_INT((pointer)[1], (pointer)[0])

#define emAfGetLittleEndianInt32uFromBuffer(pointer)                                                                               \
    (emAfGetLittleEndianInt16uFromBuffer(pointer) + (((uint32_t) emAfGetLittleEndianInt16uFromBuffer((pointer) + 2)) << 16))
