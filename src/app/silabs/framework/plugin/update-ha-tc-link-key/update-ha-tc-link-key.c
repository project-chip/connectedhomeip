...
/***************************************************************************/ /**
                                                                               * @file
                                                                               * @brief Routines for the Update HA TC Link Key
                                                                               *plugin, which provides a way for trust centers to
                                                                               *preemptively update the link key for HA devices.
                                                                               *******************************************************************************
                                                                               ******************************************************************************/
...
void emberAfPluginDeviceDatabaseDiscoveryCompleteCallback(const EmberAfDeviceInfo * info)
{
    if (info->stackRevision < R21_STACK_REVISION)
    {
        ...
        EmberStatus status =
            (nodeId == EMBER_NULL_NODE_ID ? EMBER_ERR_FATAL
