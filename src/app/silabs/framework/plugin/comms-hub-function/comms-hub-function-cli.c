...
void emAfPluginCommsHubFunctionCliPrintSupportedUseCases(void)
{
    ...
    for (index = 0; index < GBCS_NUM_USE_CASES; index++)
    {
        emberAfPluginCommsHubFunctionPrintln("Message Code: 0x%2x, GBCS Use Case: %p", useCaseDescriptions[index].messageCode,
...
void emAfPluginCommsHubFunctionCliSend(void)
{
    ...
    length = emberCopyStringArgument(1, message, 255, false);
