...
/***************************************************************************/ /**
                                                                               * @file
                                                                               * @brief Test harness code for validating the
                                                                               *behavior of the key establishment cluster and
                                                                               *modifying the normal behavior of App. Framework.
                                                                               *******************************************************************************
                                                                               ******************************************************************************/
...
static const char * modeText[] = { "Normal",        "Cert Mangle",          "Out of Sequence",  "No Resources",
                                   "Cause Timeout", "Delay CBKE operation", "Default Response", "Key Mangle" };
...
static const char * certMangleText[] = {
    "None", "Mangle Length", "Rewrite Issuer", "Corrupt Cert", "Change byte",
};
...
static uint8_t invalidEui64[] = { 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08 };
...
extern EmberStatus emberAddChild(EmberNodeId shortId, EmberEUI64 longId, uint8_t childType);
...
static EmberCommandEntry certMangleCommands[] = {
    ...
    emberCommandEntryAction("change-byte", emberAfPluginTestHarnessCertMangleCommand, "uu",
                            "Changes the value of a single byte of the cert"),
...
static EmberCommandEntry apsSecurityForClusterCommands[] = {
    emberCommandEntryAction("on", emberAfPluginTestHarnessSetApsSecurityForClusterCommand, "v",
                            "Turns on automatic APS security based on cluster."),
    emberCommandEntryAction("off", emberAfPluginTestHarnessSetApsSecurityForClusterCommand, "",
                            "Turns off automatic APS security based on cluster."),
    emberCommandEntryTerminator(),
};

static EmberCommandEntry keyEstablishmentCommands[] = {
    emberCommandEntryAction("normal-mode", emberAfPluginTestHarnessKeyEstablishmentSetModeCommand, "",
                            "Sets key establishment to normal, compliant mode."),
    emberCommandEntryAction("no-resources", emberAfPluginTestHarnessKeyEstablishmentSetModeCommand, "",
                            "All received KE requests will be responded with 'no resources'"),
    emberCommandEntryAction("out-of-sequence", emberAfPluginTestHarnessKeyEstablishmentSetModeCommand, "u",
                            "Sends an out-of-sequence KE message based on the passed command ID."),
    emberCommandEntryAction("timeout", emberAfPluginTestHarnessKeyEstablishmentSetModeCommand, "",
                            "Artificially creates a timeout by delaying an outgoing message."),
    emberCommandEntryAction("delay-cbke", emberAfPluginTestHarnessKeyEstablishmentSetModeCommand, "vv",
    ...
    emberCommandEntryAction("default-resp", emberAfPluginTestHarnessKeyEstablishmentSetModeCommand, "",
                            "Sends a default response error message in response to initate KE."),
    emberCommandEntryAction("new-key-policy", emberAfPluginTestHarnessKeyEstablishmentSetModeCommand, "u",
                            "Sets the policy of whether the TC allows new KE requests."),
    emberCommandEntryAction("reset-aps-fc", emberAfPluginTestHarnessKeyEstablishmentSetModeCommand, "",
                            "Forces the local device to reset its outgoing APS FC."),
    emberCommandEntryAction("adv-aps-fc", emberAfPluginTestHarnessKeyEstablishmentSetModeCommand, "",
                            "Advances the local device's outgoing APS FC by 4096."),
    emberCommandEntryTerminator(),
};

static EmberCommandEntry priceCommands[] = {
    emberCommandEntryAction("send-new-fields", emberAfPluginTestHarnessPriceSendNewFieldsCommand, "u",
...
static EmberCommandEntry tcKeepaliveCommands[] = {
    ...
    emberCommandEntryAction("start", emberAfPluginTestHarnessTcKeepaliveStartStopCommand, "",
                            "Starts the TC keepalive state machine."),
    emberCommandEntryAction("stop", emberAfPluginTestHarnessTcKeepaliveStartStopCommand, "",
                            "Stops the TC keepalive state machine."),
    emberCommandEntryTerminator(),
};

static EmberCommandEntry otaCommands[] = {
    emberCommandEntryAction("image-mangle", emberAfPluginTestHarnessOtaImageMangleCommand, "v",
...
static EmberCommandEntry keyUpdateCommands[] = {
    emberCommandEntryAction("unicast", emberAfPluginTestHarnessKeyUpdateCommand, "",
                            "Changes TC NWK key update mechanism to unicast with APS security."),
    emberCommandEntryAction("broadcast", emberAfPluginTestHarnessKeyUpdateCommand, "",
...
static EmberCommandEntry concentratorCommands[] = {
    emberCommandEntryAction("start", emberAfPluginTestHarnessConcentratorStartStopCommand, "",
                            "Starts the concentrator's periodic broadcasts."),
    emberCommandEntryAction("stop", emberAfPluginTestHarnessConcentratorStartStopCommand, "",
...
static EmberCommandEntry limitBeaconsCommands[] = {
    emberCommandEntryAction("on", emberAfPluginTestHarnessLimitBeaconsOnOffCommand, "",
                            "Enables a limit to the max number of outgoing beacons."),
    emberCommandEntryAction("off", emberAfPluginTestHarnessLimitBeaconsOnOffCommand, "",
...
static EmberCommandEntry channelMaskCommands[] = {
    emberCommandEntryAction("clear", emberAfPluginTestHarnessChannelMaskResetClearAllCommand, "",
                            "Clears the channel mask used by network find."),

    emberCommandEntryAction("reset", emberAfPluginTestHarnessChannelMaskResetClearAllCommand, "",
                            "Resets the channel mask back to the app default"),

    emberCommandEntryAction("all", emberAfPluginTestHarnessChannelMaskResetClearAllCommand, "",
                            "Sets the channel mask to all channels"),

    emberCommandEntryAction("add", emberAfPluginTestHarnessChannelMaskAddOrRemoveCommand, "u", "Add a channel to the mask"),

    emberCommandEntryAction("remove", emberAfPluginTestHarnessChannelMaskAddOrRemoveCommand, "u",
...
static EmberCommandEntry endpointCommands[] = {
    emberCommandEntryAction("enable", emberAfPluginTestHarnessEnableDisableEndpointCommand, "u",
                            "Enables the endpont to receive messages and be discovered"),

    emberCommandEntryAction("disable", emberAfPluginTestHarnessEnableDisableEndpointCommand, "u",
                            "Disables the endpont to receive messages and be discovered"),

    emberCommandEntryAction("status", emberAfPluginTestHarnessEndpointStatusCommand, "", "Prints the status of all endpoints"),

    emberCommandEntryAction("cluster-endpoint-index", emberAfPluginTestHarnessClusterEndpointIndexCommand, "uvu",
...
EmberCommandEntry emberAfPluginTestHarnessCommands[] = {
    emberCommandEntryAction("status", emberAfPluginTestHarnessStatusCommand, "", "Prints the status of the test harness plugin"),
    ...
    emberCommandEntrySubMenu("attributes", emAfReadWriteAttributeTestCommands, "Commands to test attributes"),

    emberCommandEntryAction("hash-the-flash", emAfTestHarnessStartImageStampCalculation, "",
...
static void testHarnessPrintVarArgs(const char * format, va_list vargs)
{
    emberAfCoreFlush();
...
void emberAfPluginTestHarnessKeyEstablishmentSetModeCommand(void)
{
    ...
    else if (commandChar0 == 'n')
    {
        ...
        {
            testHarnessMode                            = MODE_NORMAL;
            emKeyEstablishmentPolicyAllowNewKeyEntries = (uint8_t) emberUnsignedCommandArgument(0);
        }
    }
...
bool emAfKeyEstablishmentTestHarnessMessageSendCallback(uint8_t message)
{
#if defined(EMBER_AF_PLUGIN_KEY_ESTABLISHMENT)
    uint8_t i;
    uint8_t * ptr     = (appResponseData + CERT_OFFSET_IN_INITIATE_KEY_ESTABLISHMENT_MESSAGE);
    ...
    if (testHarnessMode == MODE_CERT_MANGLE)
    {
        if (message == ZCL_INITIATE_KEY_ESTABLISHMENT_REQUEST_COMMAND_ID)
        {
            if (certMangleType == CERT_MANGLE_LENGTH)
            {
                ...
                testHarnessPrintln("Mangling certificate length by %p%d bytes", (certLengthMod > 0 ? "+" : ""), certLengthMod);
            }
            else if (certMangleType == CERT_MANGLE_ISSUER || certMangleType == CERT_MANGLE_SUBJECT)
            {
                ptr += (certMangleType == CERT_MANGLE_ISSUER ? ISSUER_OFFSET_IN_CERT : SUBJECT_OFFSET_IN_CERT);

                MEMMOVE(ptr, invalidEui64, EUI64_SIZE);
                testHarnessPrintln("Mangling certificate %p to be (>)%X%X%X%X%X%X%X%X",
                                   (certMangleType == CERT_MANGLE_ISSUER ? "issuer" : "subject"), invalidEui64[0], invalidEui64[1],
                                   invalidEui64[2], invalidEui64[3], invalidEui64[4], invalidEui64[5], invalidEui64[6],
                                   invalidEui64[7]);
            }
            else if (certMangleType == CERT_MANGLE_CORRUPT)
            {
                ...
                *ptr = ~(*ptr);
                testHarnessPrintln("Mangling byte at index %d in certificate.", certIndexToCorrupt);
            }
            else if (certMangleType == CERT_MANGLE_VALUE)
            {
                ptr += certIndexToChange;
                *ptr = certNewByteValue;
                testHarnessPrintln("Changing byte at index %u to %u in certificate.", certIndexToChange, certNewByteValue);
            }
        }
        else if (message == ZCL_TERMINATE_KEY_ESTABLISHMENT_COMMAND_ID)
        {
            if (certMangleType == CERT_MANGLE_CORRUPT || certMangleType == CERT_MANGLE_VALUE)
            {
                ...
                *ptr++ = ZCL_CONFIRM_KEY_DATA_RESPONSE_COMMAND_ID;
                ...
                appResponseLength = (EMBER_AF_ZCL_OVERHEAD + EMBER_SMAC_SIZE);
    ...
    else if (testHarnessMode == MODE_OUT_OF_SEQUENCE)
    {
        if (message == respondToCommandWithOutOfSequence)
        {
            ...
            ptr[0] = (message == ZCL_CONFIRM_KEY_DATA_REQUEST_COMMAND_ID ? ZCL_INITIATE_KEY_ESTABLISHMENT_REQUEST_COMMAND_ID
                                                                         : (message + 1));
    ...
    else if (testHarnessMode == MODE_NO_RESOURCES)
    {
        ...
        if (!(direction == ZCL_FRAME_CONTROL_CLIENT_TO_SERVER && message == ZCL_INITIATE_KEY_ESTABLISHMENT_REQUEST_COMMAND_ID))
        {
            uint8_t * ptr = appResponseData + 2; // ZCL Frame control and sequence number
    ...
    else if (testHarnessMode == MODE_DEFAULT_RESPONSE)
    {
        ...
        if (!(direction == ZCL_FRAME_CONTROL_CLIENT_TO_SERVER && message == ZCL_INITIATE_KEY_ESTABLISHMENT_REQUEST_COMMAND_ID))
        {
            ...
            *ptr++ = (direction == ZCL_FRAME_CONTROL_CLIENT_TO_SERVER ? oldCommandId - 1 : oldCommandId);
    ...
    else if (testHarnessMode == MODE_KEY_MANGLE)
    {
        ...
        if (message == ZCL_EPHEMERAL_DATA_REQUEST_COMMAND_ID)
        {
            ...
            testHarnessPrintln("Mangling key length by %p%d bytes", (keyLengthMod > 0 ? "+" : ""), keyLengthMod);
        }
    }
...
void emAfKeyEstablishementTestHarnessEventHandler(void)
{
    ...
    testHarnessPrintln("Test Harness Event Handler fired, Tick: 0x%4X", halCommonGetInt32uMillisecondTick());

    stopRecursion = true;
#if defined(EMBER_AF_PLUGIN_KEY_ESTABLISHMENT)
    testHarnessPrintln("Generating %p callback.",
                       ((delayedCbkeOperation == CBKE_OPERATION_GENERATE_KEYS) ? "emberGenerateCbkeKeysHandler()"
                                                                               : "emberCalculateSmacsHandler()"));

    if (delayedCbkeOperation == CBKE_OPERATION_GENERATE_KEYS)
    {
        emAfPluginKeyEstablishmentGenerateCbkeKeysHandler(EMBER_SUCCESS, (EmberPublicKeyData *) delayedData);
    }
    else
    {
        emAfPluginKeyEstablishmentCalculateSmacsHandler(EMBER_SUCCESS, (EmberSmacData *) delayedData,
...
bool emAfKeyEstablishmentTestHarnessCbkeCallback(uint8_t cbkeOperation, uint8_t * data1, uint8_t * data2)
{
    ...
    testHarnessPrintln("Delaying %p key callback for %d seconds",
                       (cbkeOperation == CBKE_OPERATION_GENERATE_KEYS ? "ephemeral" : "confirm"), cbkeDelaySeconds);

    MEMMOVE(delayedData, data1,
            (cbkeOperation == CBKE_OPERATION_GENERATE_KEYS ? sizeof(EmberPublicKeyData) : sizeof(EmberSmacData)));

    if (data2 != NULL)
    {
        MEMMOVE(delayedData + sizeof(EmberSmacData), data2, sizeof(EmberSmacData));
    }

    delayedCbkeOperation = cbkeOperation;

    testHarnessPrintln("Test Harness Tick: 0x%4X", halCommonGetInt32uMillisecondTick());
    emberAfEventControlSetDelayMS(&emAfKeyEstablishmentTestHarnessEventControl,
                                  (((uint32_t)(cbkeDelaySeconds)) * MILLISECOND_TICKS_PER_SECOND)); // convert to MS
    return true;
}
...
void emberAfPluginTestHarnessStatusCommand(void)
{
    ...
    if (testHarnessMode == MODE_CERT_MANGLE)
    {
        ...
        if (certMangleType == CERT_MANGLE_LENGTH)
        {
            emberAfKeyEstablishmentClusterPrint(" (%p%d bytes)", ((certLengthMod > 0) ? "+" : ""), certLengthMod);
        }
        else if (certMangleType == CERT_MANGLE_CORRUPT)
        {
            emberAfKeyEstablishmentClusterPrint(" (index: %d)", certIndexToCorrupt);
        }
    }
    else if (testHarnessMode == MODE_DELAY_CBKE)
    {
        emberAfKeyEstablishmentClusterPrint(" (by %d seconds", cbkeDelaySeconds);
    }
    emberAfKeyEstablishmentClusterPrintln("");

    emberAfKeyEstablishmentClusterPrintln("Auto SE Registration: %p", (emAfTestHarnessAllowRegistration ? "On" : "Off"));
    ...
    {
        emberAfKeyEstablishmentClusterPrintln("0x%2X", clusterIdRequiringApsSecurity);
    }

    emberAfKeyEstablishmentClusterPrintln("Publish Price includes SE 1.1 fields: %p",
                                          (emAfTestHarnessSupportForNewPriceFields ? "yes" : "no"));
    emberAfKeyEstablishmentClusterFlush();

#if defined(STACK_TEST_HARNESS)
    {
        uint8_t beaconsLeft = emTestHarnessBeaconSuppressGet();
        emberAfKeyEstablishmentClusterPrint("Beacon Suppress: %p", (beaconsLeft == 255 ? "Disabled " : "Enabled "));
        if (beaconsLeft != 255)
        {
            emberAfKeyEstablishmentClusterPrint(" (%d left to be sent)", beaconsLeft);
        }
        emberAfKeyEstablishmentClusterFlush();
        emberAfKeyEstablishmentClusterPrintln("");
    }
...
{
    return (clusterIdRequiringApsSecurity != NULL_CLUSTER_ID && clusterId == clusterIdRequiringApsSecurity);
}
...
void emberAfPluginTestHarnessOtaImageMangleCommand(void)
{
    ...
    {
        testHarnessPrintln("Error: Index %d > image size of %d", index, emAfOtaStorageDriveGetImageSize());
    }
    else
    {
...
{
    testHarnessPrintln("Using %p key update method", (unicastKeyUpdate ? "unicast" : "broadcast"));
    return (unicastKeyUpdate ? emberAfTrustCenterStartUnicastNetworkKeyUpdate()
...
void emberAfPluginTestHarnessEnableDisableEndpointCommand(void)
{
    ...
    ezspSetEndpointFlags(endpoint, (disable ? EZSP_ENDPOINT_DISABLED : EZSP_ENDPOINT_ENABLED));
#else
...
void emberAfPluginTestHarnessEndpointStatusCommand(void)
{
    ...
    for (i = 0; i < emberAfEndpointCount(); i++)
    {
        ...
        testHarnessPrintln("EP %d, Flags 0x%2X [%p]", endpoint, flags, ((flags & EZSP_ENDPOINT_ENABLED) ? "Enabled" : "Disabled"));
    }
...
void emberAfPluginTestHarnessClusterEndpointIndexCommand(void)
{
    ...
    clusterEndpointIndex = (uint8_t)(mask == 0 ? emberAfFindClusterClientEndpointIndex(endpoint, clusterId)
                                               : emberAfFindClusterServerEndpointIndex(endpoint, clusterId));

    testHarnessPrintln("endpoint: 0x%2x cluster: 0x%2x clusterEndpointIndex: 0x%2x %p", endpoint, clusterId, clusterEndpointIndex,
                       ((mask == 0) ? "(client)" : "(server)"));
}
...
void emberAfPluginTestHarnessRadioOnOffCommand(void)
{
    ...
    emberAfCorePrintln("Radio %p status: 0x%X", (radioOff ? "OFF" : "ON"), status);
}
...
#ifdef EZSP_HOST
    EzspStatus status;
    status = emberAfSetEzspConfigValue(EZSP_CONFIG_MAX_END_DEVICE_CHILDREN, maxChildren, "max end device children");
    if (status != EZSP_SUCCESS)
    {
        return;
    }
