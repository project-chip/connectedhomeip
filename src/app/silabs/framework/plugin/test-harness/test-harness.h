...
#define EMBER_AF_CUSTOM_KE_EPHEMERAL_DATA_GENERATE_TIME_SECONDS emAfKeyEstablishmentTestHarnessGenerateKeyTime
#define EMBER_AF_CUSTOM_KE_GENERATE_SHARED_SECRET_TIME_SECONDS emAfKeyEstablishmentTestHarnessConfirmKeyTime

#define EM_AF_ADVERTISED_EPHEMERAL_DATA_GEN_TIME_SECONDS emAfKeyEstablishmentTestHarnessAdvertisedGenerateKeyTime
