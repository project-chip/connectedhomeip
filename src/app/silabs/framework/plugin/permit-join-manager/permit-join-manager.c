...
/***************************************************************************/ /**
                                                                               * @file
                                                                               * @brief This plugin unicasts a permit joins message
                                                                               *to joining devices.
                                                                               *******************************************************************************
                                                                               ******************************************************************************/
...
static EmberStatus sendPermitJoinsRequest(EmberNodeId emberNodeId)
{
    ...
    status   = emberPermitJoiningRequest(emberNodeId, duration,
                                                           ...
                                                           EmberJoinDecision decision)
{
    ...
    else if (decision == EMBER_USE_PRECONFIGURED_KEY || decision == EMBER_SEND_KEY_IN_THE_CLEAR)
    {
