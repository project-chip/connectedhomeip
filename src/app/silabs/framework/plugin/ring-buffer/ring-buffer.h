...
#define EMBER_AF_PLUGIN_RING_BUFFER_MAX_LENGTH_ENTRY_OVERHEAD EMBER_AF_PLUGIN_RING_BUFFER_WIDE_LENGTH_ENTRY_OVERHEAD

typedef void(EmberAfPluginRingBufferDeleteFunction)(uint16_t entryNumber, uint16_t entrySize);
...
EmberStatus emberAfPluginRingBufferInitStruct(EmberRingBuffer * ringBufferStruct, bool wideLengthField,
                                              EmberAfPluginRingBufferDeleteFunction * deleteCallback, uint8_t * dataPtr);
...
EmberStatus emberAfPluginRingBufferGetEntryByEntryNumber(EmberRingBuffer * ring, uint16_t entryNumber, uint16_t dataIndexInEntry,
                                                         uint16_t * returnEntryTotalSize, uint16_t maxReturnSize,
                                                         uint16_t * returnDataSize, uint8_t * returnData);

EmberStatus emberAfPluginRingBufferGetLastEntry(EmberRingBuffer * ring, uint16_t dataIndexInEntry, uint16_t * returnEntryTotalSize,
                                                uint16_t maxReturnSize, uint16_t * returnDataSize, uint8_t * returnData);
...
EmberStatus emberAfPluginRingBufferGetEntryByIterator(EmberRingBuffer * ring, uint16_t dataIndexInEntry,
                                                      uint16_t * returnEntryTotalSize, uint16_t maxReturnSize,
                                                      uint16_t * returnDataSize, uint8_t * returnData);

EmberStatus emberAfPluginRingBufferUpdateEntryByIterator(EmberRingBuffer * ring, uint16_t dataIndexInEntry, uint8_t * updatedData,
