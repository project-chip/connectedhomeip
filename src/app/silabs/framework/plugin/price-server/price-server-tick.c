...
/***************************************************************************/ /**
                                                                               * @file
                                                                               * @brief Implemented routines for managing price
                                                                               *tick.
                                                                               *******************************************************************************
                                                                               ******************************************************************************/
...
void emberAfPriceClusterServerTickCallback(uint8_t endpoint)
{
    ...
    if ((PendingPriceEvents & EMBER_AF_PRICE_SERVER_GET_SCHEDULED_PRICES_EVENT_MASK) != 0U)
    {
        ...
        { // This should preempt any other events.
    ...
    {
        emberAfPriceClusterPrintln("Scheduling Tick Callback in %d sec, eventBitFlag=%d, pendingEvents=%d", minEventDelaySec,
                                   minTimeEventMask, PendingPriceEvents);
    }
    else
    {
