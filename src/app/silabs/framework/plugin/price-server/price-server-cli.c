...
void emAfPriceServerCliWho(void)
{
    ...
    length              = emberCopyStringArgument(1, price.rateLabel + 1, ZCL_PRICE_CLUSTER_MAXIMUM_RATE_LABEL_LENGTH, false);
...
void emAfPriceServerCliValid(void)
{
    ...
    {
        if (!emberAfPriceSetTariffTableEntry(endpoint, index, NULL, NULL))
        {
    ...
    if (!emberAfPriceSetPriceTableEntry(endpoint, index, (emberCurrentCommand->name[0] == 'v' ? &price : NULL)))
    {
...
void emAfPriceServerCliPublish(void)
{
    emberAfPluginPriceServerPublishPriceMessage(
        (EmberNodeId) emberUnsignedCommandArgument(0), (uint8_t) emberUnsignedCommandArgument(1),
        (uint8_t) emberUnsignedCommandArgument(2), (uint8_t) emberUnsignedCommandArgument(3));
}
...
// plugin price-server block-period add <endpoint:1> <providerId:4> <issuerEventId:4> <blockPeriodStartTime:4>
// <blockPeriodDuration:4> <blockPeriodControl:1> <blockPeriodDurationType:1> <tariffType:1> <tariffResolutionPeriod:1>
void emAfPriceServerCliBlockPeriodAdd(void)
{
    emberAfPluginPriceServerBlockPeriodAdd((uint8_t) emberUnsignedCommandArgument(0), (uint32_t) emberUnsignedCommandArgument(1),
                                           (uint32_t) emberUnsignedCommandArgument(2), (uint32_t) emberUnsignedCommandArgument(3),
                                           (uint32_t) emberUnsignedCommandArgument(4), (uint8_t) emberUnsignedCommandArgument(5),
                                           (uint8_t) emberUnsignedCommandArgument(6), (uint32_t) emberUnsignedCommandArgument(7),
                                           (uint32_t) emberUnsignedCommandArgument(8), (uint8_t) emberUnsignedCommandArgument(9),
...
void emAfPriceServerCliBlockPeriodPrint(void)
{
    emberAfPluginPriceServerBlockPeriodPrint((uint8_t) emberUnsignedCommandArgument(0), (uint8_t) emberUnsignedCommandArgument(1));
}

// plugin price-server block-period pub <nodeId:2> <srcEndpoint:1> <dstEndpoint:1> <index:1>
void emAfPriceServerCliBlockPeriodPub(void)
{
    emberAfPluginPriceServerBlockPeriodPub((uint16_t) emberUnsignedCommandArgument(0), (uint8_t) emberUnsignedCommandArgument(1),
                                           (uint8_t) emberUnsignedCommandArgument(2), (uint8_t) emberUnsignedCommandArgument(3));
}
...
// plugin price-server conversion-factor add <endpoint:1> <issuerEventId:4> <startTime:4> <conversionFactor:4>
// <conversionFactorTrailingDigit:1>
void emAfPriceServerCliConversionFactorAdd(void)
{
    emberAfPluginPriceServerConversionFactorAdd(
        (uint8_t) emberUnsignedCommandArgument(0), (uint32_t) emberUnsignedCommandArgument(1),
        (uint32_t) emberUnsignedCommandArgument(2), (uint32_t) emberUnsignedCommandArgument(3),
...
// plugin price-server calorific-value add <endpoint:1> <issuerEventId:4> <startTime:4> <calorificValue:4> <calorificValueUnit:1>
// <calorificValueTrailingDigit:1>
void emAfPriceServerCliCalorificValueAdd(void)
{
    emberAfPluginPriceServerCalorificValueAdd((uint8_t) emberUnsignedCommandArgument(0), (uint32_t) emberUnsignedCommandArgument(1),
                                              (uint32_t) emberUnsignedCommandArgument(2),
                                              (uint32_t) emberUnsignedCommandArgument(3), (uint8_t) emberUnsignedCommandArgument(4),
...
// plugin price-server co2-val add <endpoint:1> <issuerEventId:4> <startTime:4> <providerId:4> <tariffType:1> <co2Value:4>
// <co2ValueUnit:1> <co2ValueTrailingDigit:1>
void emAfPriceServerCliCo2ValueAdd(void)
{
    emberAfPluginPriceServerCo2ValueAdd((uint8_t) emberUnsignedCommandArgument(0), (uint32_t) emberUnsignedCommandArgument(1),
                                        (uint32_t) emberUnsignedCommandArgument(2), (uint32_t) emberUnsignedCommandArgument(3),
                                        (uint8_t) emberUnsignedCommandArgument(4), (uint32_t) emberUnsignedCommandArgument(5),
                                        (uint8_t) emberUnsignedCommandArgument(6), (uint8_t) emberUnsignedCommandArgument(7));
}
...
void emAfPriceServerCliTierLabelSet(void)
{
    ...
    tierLabel[0] = len;
    emberAfPluginPriceServerTierLabelSet((uint8_t) emberUnsignedCommandArgument(0), (uint8_t) emberUnsignedCommandArgument(1),
                                         (uint8_t) emberUnsignedCommandArgument(2), (uint32_t) emberUnsignedCommandArgument(3),
                                         (uint32_t) emberUnsignedCommandArgument(4), (uint32_t) emberUnsignedCommandArgument(5),
                                         (uint8_t) emberUnsignedCommandArgument(6), tierLabel);
}
...
void emAfPriceServerCliTierLabelAddLabel(void)
{
    ...
    emberAfPluginPriceServerTierLabelAddLabel((uint8_t) emberUnsignedCommandArgument(0), tariffId,
                                              (uint8_t) emberUnsignedCommandArgument(2), tierLabel);
}
...
{
    emberAfPluginPriceServerTierLabelPub((uint16_t) emberUnsignedCommandArgument(0), (uint8_t) emberUnsignedCommandArgument(1),
                                         (uint8_t) emberUnsignedCommandArgument(2), (uint8_t) emberUnsignedCommandArgument(3));
}
...
{
    emberAfPluginPriceServerCo2LabelPub((uint16_t) emberUnsignedCommandArgument(0), (uint8_t) emberUnsignedCommandArgument(1),
                                        (uint8_t) emberUnsignedCommandArgument(2), (uint8_t) emberUnsignedCommandArgument(3));
}
...
{
    emberAfPluginPriceServerBillingPeriodAdd((uint8_t) emberUnsignedCommandArgument(0), (uint32_t) emberUnsignedCommandArgument(1),
                                             (uint32_t) emberUnsignedCommandArgument(2), (uint32_t) emberUnsignedCommandArgument(3),
                                             (uint32_t) emberUnsignedCommandArgument(4), (uint8_t) emberUnsignedCommandArgument(5),
...
{
    emberAfPluginPriceServerBillingPeriodPub((uint16_t) emberUnsignedCommandArgument(0), (uint8_t) emberUnsignedCommandArgument(1),
                                             (uint8_t) emberUnsignedCommandArgument(2), (uint8_t) emberUnsignedCommandArgument(3));
}
...
void emAfPriceServerCliConsolidatedBillAdd(void)
{
    emberAfPluginPriceServerConsolidatedBillAdd(
        ...
        (uint32_t) emberUnsignedCommandArgument(4), (uint8_t) emberUnsignedCommandArgument(5),
        (uint8_t) emberUnsignedCommandArgument(6), (uint32_t) emberUnsignedCommandArgument(7),
        (uint16_t) emberUnsignedCommandArgument(8), (uint8_t) emberUnsignedCommandArgument(9));
}

// plugin price-server consol-bill print <endpoint:1> <index:1>
void emAfPriceServerCliConsolidatedBillPrint(void)
{
    emberAfPrintConsolidatedBillTableEntry((uint8_t) emberUnsignedCommandArgument(0), (uint8_t) emberUnsignedCommandArgument(1));
}
...
void emAfPriceServerCliConsolidatedBillPub(void)
{
    emberAfPluginPriceServerConsolidatedBillPub(
        (uint16_t) emberUnsignedCommandArgument(0), (uint8_t) emberUnsignedCommandArgument(1),
        (uint8_t) emberUnsignedCommandArgument(2), (uint8_t) emberUnsignedCommandArgument(3));
}
...
void emAfPriceServerCliCppEventSet(void)
{
    emberAfPluginPriceServerCppEventSet((uint8_t) emberUnsignedCommandArgument(0), (uint8_t) emberUnsignedCommandArgument(1),
                                        (uint32_t) emberUnsignedCommandArgument(2), (uint32_t) emberUnsignedCommandArgument(3),
                                        (uint32_t) emberUnsignedCommandArgument(4), (uint16_t) emberUnsignedCommandArgument(5),
                                        (uint8_t) emberUnsignedCommandArgument(6), (uint8_t) emberUnsignedCommandArgument(7),
...
void emAfPriceServerCliCppEventPub(void)
{
    emberAfPluginPriceServerCppEventPub((uint16_t) emberUnsignedCommandArgument(0), (uint8_t) emberUnsignedCommandArgument(1),
...
void emAfPriceServerCliCreditPaymentPub(void)
{
    emberAfPluginPriceServerCreditPaymentPub((uint16_t) emberUnsignedCommandArgument(0), (uint8_t) emberUnsignedCommandArgument(1),
                                             (uint8_t) emberUnsignedCommandArgument(2), (uint8_t) emberUnsignedCommandArgument(3));
}
...
void emAfPriceServerCliCreditPaymentSet(void)
{
    ...
    emberAfPluginPriceServerCreditPaymentSet((uint8_t) emberUnsignedCommandArgument(0), (uint8_t) emberUnsignedCommandArgument(1),
                                             (uint8_t) emberUnsignedCommandArgument(2), (uint32_t) emberUnsignedCommandArgument(3),
                                             (uint32_t) emberUnsignedCommandArgument(4), (uint32_t) emberUnsignedCommandArgument(5),
                                             (uint32_t) emberUnsignedCommandArgument(6), (uint8_t) emberUnsignedCommandArgument(7),
                                             (uint32_t) emberUnsignedCommandArgument(8), (uint32_t) emberUnsignedCommandArgument(9),
                                             creditPaymentRef);
}
...
void emAfPriceServerCliCurrencyConversionSet(void)
{
    emberAfPluginPriceServerCurrencyConversionSet(
        (uint8_t) emberUnsignedCommandArgument(0), (uint8_t) emberUnsignedCommandArgument(1),
        (uint32_t) emberUnsignedCommandArgument(2), (uint32_t) emberUnsignedCommandArgument(3),
        (uint32_t) emberUnsignedCommandArgument(4), (uint16_t) emberUnsignedCommandArgument(5),
        (uint16_t) emberUnsignedCommandArgument(6), (uint32_t) emberUnsignedCommandArgument(7),
        (uint8_t) emberUnsignedCommandArgument(8), (uint32_t) emberUnsignedCommandArgument(9));
}
