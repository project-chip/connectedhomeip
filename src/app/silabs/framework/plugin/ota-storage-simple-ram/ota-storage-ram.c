...
/***************************************************************************/ /**
                                                                               ...
                                                                               *
                                                                               * THIS IS A TEST IMPLEMENTATION.  It defines a single
                                                                               *static, NULL, upgrade file that contains the upgrade
                                                                               *information for a single manufacturer and device ID.
                                                                               *The payload is a real OTA file but dummy data.
                                                                               *
                                                                               * This can serve as both the storage for the OTA
                                                                               *client and the server. The data is stored in RAM and
                                                                               *thus is limited by the size of available memory.
                                                                               *******************************************************************************
                                                                               ******************************************************************************/
