...
/***************************************************************************/ /**
                                                                               * @file
                                                                               * @brief This file defines the SOC specific client
                                                                               *behavior for the Ember proprietary bootloader
                                                                               *protocol.
                                                                               *******************************************************************************
                                                                               ******************************************************************************/
...
bool emAfPluginStandaloneBootloaderClientCheckBootloader(void)
{
    ...
    if (blExtendedType != BL_EXT_TYPE_SERIAL_UART_OTA)
    {
        ...
        bootloadPrintln("Error:  Loaded bootloader type 0x%X != required type 0x%X (serial-uart-ota)", blExtendedType,
