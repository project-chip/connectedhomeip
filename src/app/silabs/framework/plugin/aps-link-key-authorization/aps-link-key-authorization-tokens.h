...
/***************************************************************************/ /**
                                                                               ...
                                                                               *feature, which sets APS encryption requirement when
                                                                               *interfacing defined clusters.
                                                                               *******************************************************************************
                                                                               ******************************************************************************/
...
DEFINE_INDEXED_TOKEN(APS_LINK_KEY_AUTH_EXEMPT_LIST, uint16_t, EMBER_AF_PLUGIN_APS_LINK_KEY_AUTHORIZATION_MAX_EXEMPT_CLUSTERS,
                     { 0x00 })
#endif // DEFINETOKENS
