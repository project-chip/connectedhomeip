...
{
    emberAfAppPrintln(" APS link key authorization is %s.", (emberAfApsLinkKeyAuthorizationIsEnabled()) ? "enabled" : "disabled");
}
...
{
    emberAfApsLinkKeyAuthorizationEnable((bool) emberUnsignedCommandArgument(0));
    printEnabledState();
}
