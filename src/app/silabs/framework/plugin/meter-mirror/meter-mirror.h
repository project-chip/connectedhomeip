...
/***************************************************************************/ /**
                                                                               * @file
                                                                               * @brief APIs and defines for the Meter Mirror
                                                                               *plugin, which handles mirroring attributes of a
                                                                               *sleepy end device.
                                                                               *******************************************************************************
                                                                               ******************************************************************************/
...
#define EM_AF_MIRROR_ENDPOINT_END (EMBER_AF_PLUGIN_METER_MIRROR_ENDPOINT_START + EMBER_AF_PLUGIN_METER_MIRROR_MAX_MIRRORS)
