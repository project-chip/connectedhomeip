...
/***************************************************************************/ /**
                                                                               ...
                                                                               *These routines are command to the client and server.
                                                                               *******************************************************************************
                                                                               ******************************************************************************/
...
static uint8_t printPercentage(const char * prefixString, uint8_t updateFrequency, uint32_t offsetStart, uint32_t currentOffset,
                               uint32_t endOffset)
{
    ...
    if (oldPercentageComplete == 255 ||
        (percentageComplete >= updateFrequency && (percentageComplete >= (oldPercentageComplete + updateFrequency))))
    {
...
{
    return printPercentage(prefixString, updateFrequency,
