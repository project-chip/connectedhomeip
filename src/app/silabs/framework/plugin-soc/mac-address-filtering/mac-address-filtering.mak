...
PLUGIN_NAME := mac-address-filtering
...
$(PLUGIN_TEST_NAME)_FILES := \
  app/framework/plugin-soc/mac-address-filtering/mac-address-filtering.c \
  app/framework/plugin-soc/mac-address-filtering/mac-address-filtering-test.c \
