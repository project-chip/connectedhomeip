...
#define EMBER_AF_GENERATED_EVENTS                                                                                                  \
    { &emberAfIdentifyClusterServerTickCallbackControl1, emberAfIdentifyClusterServerTickCallbackWrapperFunction1 },               \
        ...
        { &emberAfPluginStandaloneBootloaderServerMyEventEventControl,                                                             \
...
#define EMBER_AF_GENERATED_EVENT_STRINGS                                                                                           \
    "Identify Cluster Server EP 1", "Time Cluster Server EP 1", "Over the Air Bootloading Cluster Server EP 1",                    \
        "Identify Cluster Server EP 2", "Time Cluster Server EP 2", "Button Form/Join Code Plugin Button0",                        \
        "Button Form/Join Code Plugin Button1", "Device Query Service Plugin My", "Form and Join Library Plugin Cleanup",          \
        "IAS Zone Client Plugin StateMachine", "Identify Feedback Plugin ProvideFeedback", "Network Find Plugin Tick",             \
        "Standalone Bootloader Server Plugin MyEvent", "Xmodem Sender Plugin MyEvent",
