...
bool emAfPluginDeviceQueryPreZDOMessageReceived(EmberNodeId emberNodeId, EmberApsFrame * apsFrame, uint8_t * message,
                                                uint16_t length); // Plugin: device-query-service
