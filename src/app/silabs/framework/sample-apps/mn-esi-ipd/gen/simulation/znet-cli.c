...
#if defined(EMBER_COMMAND_INTEPRETER_HAS_DESCRIPTION_FIELD)
static const char * const pluginMnPricePassthroughSetRoutingCommandArguments[] = {
  "The node id of the forwarding endpoint.",
  "The forwarding endpoint.",
  "The endpoint of the proxy ESI.",
  NULL
};
#endif
...
void start(void);
void stop(void);
static EmberCommandEntry emberCommandPluginMnPricePassthroughTable[] = {
  emberCommandEntryActionWithDetails("print", print, "", "Print the current price known to the proxy esi.", NULL),
  emberCommandEntryActionWithDetails("set-routing", setRouting, "vuu", "Set the routing parameters.", pluginMnPricePassthroughSetRoutingCommandArguments),
  emberCommandEntryActionWithDetails("start", start, "", "Starts polling and forwarding.", NULL),
  emberCommandEntryActionWithDetails("stop", stop, "", "Stops polling and forwarding.", NULL),
  emberCommandEntryTerminator(),
};
...
static EmberCommandEntry emberCommandPluginTable[] = {
  ...
  emberCommandEntrySubMenu("mn-price-passthrough", emberCommandPluginMnPricePassthroughTable, ""),
