...
#define EMBER_AF_GENERATED_EVENTS                                                                                                  \
    { &button0EventControl, button0EventHandler }, { &button1EventControl, button1EventHandler },                                  \
...
#define EMBER_AF_GENERATED_EVENT_STRINGS                                                                                           \
    "Button0 event control", "Button1 event control", "Form and Join Library Plugin Cleanup", "Interpan Plugin FragmentReceive",   \
        "Interpan Plugin FragmentTransmit", "ZLL Commissioning Client Plugin TouchLink",                                           \
        "ZLL Commissioning Network Plugin Network", "Identify event control", "End Device Support Plugin Move NWK 0",              \
