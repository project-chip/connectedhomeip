...
#define GENERATED_DEFAULTS                                                                                                         \
    {                                                                                                                              \
        0xFF, 0xFF, 0xFF, 0xFE /* 0,Maximum value: Time,time */, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,                         \
            0xFF /* 4,Default value: Over the Air Bootloading,OTA Upgrade Server ID */, 0xFF, 0xFF, 0xFF,                          \
            0xFF /* 12,Default value: Over the Air Bootloading,Offset (address) into the file */, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,    \
            0xFF /* 16,Maximum value: Simple Metering,current summation delivered */,                                              \
    }
#else // ! BIGENDIAN_CPU
#define GENERATED_DEFAULTS                                                                                                         \
    {                                                                                                                              \
        0xFE, 0xFF, 0xFF, 0xFF /* 0,Maximum value: Time,time */, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,                         \
            0xFF /* 4,Default value: Over the Air Bootloading,OTA Upgrade Server ID */, 0xFF, 0xFF, 0xFF,                          \
            0xFF /* 12,Default value: Over the Air Bootloading,Offset (address) into the file */, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,    \
            0xFF /* 16,Maximum value: Simple Metering,current summation delivered */,                                              \
    }
...
#define GENERATED_MIN_MAX_DEFAULTS                                                                                                 \
    {                                                                                                                              \
        {                                                                                                                          \
            ...
            { (uint8_t *) 0x00, (uint8_t *) 0x00, (uint8_t *) 0x0F }, { (uint8_t *) 0x00, (uint8_t *) 0x00, (uint8_t *) 0xFF },    \
            { (uint8_t *) 0x1E, (uint8_t *) 0x00, (uint8_t *) 0x3C }, { (uint8_t *) 0x00, (uint8_t *) 0x00, (uint8_t *) 0x3C },    \
    ...
    {                                                                                                                              \
        { 0x0000, ZCL_INT8U_ATTRIBUTE_TYPE, 1, (ATTRIBUTE_MASK_SINGLETON), { (uint8_t *) 0x03 } }, /* 0 / Basic / ZCL version*/    \
            ...
            { 0x0000,                                                                                                              \
              ...
              { (uint8_t *) &(minMaxDefaults[0]) } }, /* 3 / Time / time*/                                                         \
            { 0x0001,                                                                                                              \
              ZCL_BITMAP8_ATTRIBUTE_TYPE,                                                                                          \
              1,                                                                                                                   \
              (ATTRIBUTE_MASK_WRITABLE | ATTRIBUTE_MASK_MIN_MAX | ATTRIBUTE_MASK_SINGLETON),                                       \
              { (uint8_t *) &(minMaxDefaults[1]) } }, /* 4 / Time / time status*/                                                  \
            {                                                                                                                      \
                0xFFFD, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (ATTRIBUTE_MASK_SINGLETON), { (uint8_t *) 0x0001 }                           \
            }, /* 5 / Time / cluster revision*/                                                                                    \
            {                                                                                                                      \
                0x0000, ZCL_IEEE_ADDRESS_ATTRIBUTE_TYPE, 8, (ATTRIBUTE_MASK_CLIENT), { (uint8_t *) &(generatedDefaults[4]) }       \
            }, /* 6 / Over the Air Bootloading / OTA Upgrade Server ID*/                                                           \
            {                                                                                                                      \
                0x0001, ZCL_INT32U_ATTRIBUTE_TYPE, 4, (ATTRIBUTE_MASK_CLIENT), { (uint8_t *) &(generatedDefaults[12]) }            \
            }, /* 7 / Over the Air Bootloading / Offset (address) into the file*/                                                  \
            {                                                                                                                      \
                0x0006, ZCL_ENUM8_ATTRIBUTE_TYPE, 1, (ATTRIBUTE_MASK_CLIENT), { (uint8_t *) 0x00 }                                 \
            }, /* 8 / Over the Air Bootloading / OTA Upgrade Status*/                                                              \
            {                                                                                                                      \
                0x0009, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (ATTRIBUTE_MASK_CLIENT), { (uint8_t *) 0x0000UL }                            \
            }, /* 9 / Over the Air Bootloading / Minimum Block Request Period*/                                                    \
            {                                                                                                                      \
                0xFFFD, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (ATTRIBUTE_MASK_CLIENT), { (uint8_t *) 0x0001 }                              \
            }, /* 10 / Over the Air Bootloading / cluster revision*/                                                               \
            {                                                                                                                      \
                0xFFFD, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (0x00), { (uint8_t *) 0x0001 }                                               \
            }, /* 11 / Over the Air Bootloading / cluster revision*/                                                               \
            {                                                                                                                      \
                0x0000, ZCL_INT8U_ATTRIBUTE_TYPE, 1, (ATTRIBUTE_MASK_SINGLETON), { (uint8_t *) 1 }                                 \
            }, /* 12 / Keep-Alive / Keep-Alive Base*/                                                                              \
            {                                                                                                                      \
                0x0001, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (ATTRIBUTE_MASK_SINGLETON), { (uint8_t *) 60 }                               \
            }, /* 13 / Keep-Alive / Keep-Alive Jitter*/                                                                            \
            {                                                                                                                      \
                0xFFFD, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (ATTRIBUTE_MASK_SINGLETON), { (uint8_t *) 0x0001 }                           \
            }, /* 14 / Keep-Alive / cluster revision*/                                                                             \
            {                                                                                                                      \
                0xFFFD, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (ATTRIBUTE_MASK_CLIENT), { (uint8_t *) 0x0001 }                              \
            },                                                                        /* 15 / Price / cluster revision*/           \
            ...
            { 0x0000,                                                                                                              \
              ...
              { (uint8_t *) &(minMaxDefaults[2]) } }, /* 17 / Demand Response and Load Control / utility enrollment group*/        \
            { 0x0001,                                                                                                              \
              ZCL_INT8U_ATTRIBUTE_TYPE,                                                                                            \
              1,                                                                                                                   \
              (ATTRIBUTE_MASK_WRITABLE | ATTRIBUTE_MASK_MIN_MAX | ATTRIBUTE_MASK_CLIENT),                                          \
              { (uint8_t *) &(minMaxDefaults[3]) } }, /* 18 / Demand Response and Load Control / start randomization minutes*/     \
            { 0x0002,                                                                                                              \
              ZCL_INT8U_ATTRIBUTE_TYPE,                                                                                            \
              1,                                                                                                                   \
              (ATTRIBUTE_MASK_WRITABLE | ATTRIBUTE_MASK_MIN_MAX | ATTRIBUTE_MASK_CLIENT),                                          \
              { (uint8_t *) &(minMaxDefaults[4]) } }, /* 19 / Demand Response and Load Control / duration randomization minutes*/  \
            { 0x0003,                                                                                                              \
              ZCL_INT16U_ATTRIBUTE_TYPE,                                                                                           \
              2,                                                                                                                   \
              (ATTRIBUTE_MASK_WRITABLE | ATTRIBUTE_MASK_MIN_MAX | ATTRIBUTE_MASK_CLIENT),                                          \
              { (uint8_t *) &(minMaxDefaults[5]) } }, /* 20 / Demand Response and Load Control / device class value*/              \
            {                                                                                                                      \
                0xFFFD, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (ATTRIBUTE_MASK_CLIENT), { (uint8_t *) 0x0001 }                              \
            }, /* 21 / Demand Response and Load Control / cluster revision*/                                                       \
            {                                                                                                                      \
                0xFFFD, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (0x00), { (uint8_t *) 0x0001 }                                               \
            }, /* 22 / Demand Response and Load Control / cluster revision*/                                                       \
            {                                                                                                                      \
                0xFFFD, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (ATTRIBUTE_MASK_CLIENT), { (uint8_t *) 0x0001 }                              \
            }, /* 23 / Simple Metering / cluster revision*/                                                                        \
            {                                                                                                                      \
                0x0000, ZCL_INT48U_ATTRIBUTE_TYPE, 6, (ATTRIBUTE_MASK_MIN_MAX), { (uint8_t *) &(minMaxDefaults[6]) }               \
            }, /* 24 / Simple Metering / current summation delivered*/                                                             \
            {                                                                                                                      \
                0x0200, ZCL_BITMAP8_ATTRIBUTE_TYPE, 1, (ATTRIBUTE_MASK_MIN_MAX), { (uint8_t *) &(minMaxDefaults[7]) }              \
            }, /* 25 / Simple Metering / status*/                                                                                  \
            {                                                                                                                      \
                0x0300, ZCL_ENUM8_ATTRIBUTE_TYPE, 1, (ATTRIBUTE_MASK_MIN_MAX), { (uint8_t *) &(minMaxDefaults[8]) }                \
            }, /* 26 / Simple Metering / unit of measure*/                                                                         \
            {                                                                                                                      \
                0x0303, ZCL_BITMAP8_ATTRIBUTE_TYPE, 1, (ATTRIBUTE_MASK_MIN_MAX), { (uint8_t *) &(minMaxDefaults[9]) }              \
            }, /* 27 / Simple Metering / summation formatting*/                                                                    \
            {                                                                                                                      \
                0x0306, ZCL_BITMAP8_ATTRIBUTE_TYPE, 1, (ATTRIBUTE_MASK_MIN_MAX), { (uint8_t *) &(minMaxDefaults[10]) }             \
            }, /* 28 / Simple Metering / metering device type*/                                                                    \
            { 0xFFFD, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (0x00), { (uint8_t *) 0x0001 } }, /* 29 / Simple Metering / cluster revision*/ \
            {                                                                                                                      \
                0xFFFD, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (ATTRIBUTE_MASK_CLIENT), { (uint8_t *) 0x0001 }                              \
            },                                                                        /* 30 / Messaging / cluster revision*/       \
            ...
            { 0x0000,                                                                                                              \
              ...
              { (uint8_t *) &(minMaxDefaults[11]) } }, /* 32 / Key Establishment / key establishment suite (client)*/              \
            {                                                                                                                      \
            ...
            { 0x0000,                                                                                                              \
              ...
              { (uint8_t *) &(minMaxDefaults[12]) } }, /* 34 / Key Establishment / key establishment suite (server)*/              \
            {                                                                                                                      \
                0xFFFD, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (ATTRIBUTE_MASK_SINGLETON), { (uint8_t *) 0x0001 }                           \
...
#define GENERATED_CLUSTERS                                                                                                           \
    {                                                                                                                                \
        {                                                                                                                            \
            ...
            {                                                                                                                        \
                0x0019,                                                                                                              \
                (EmberAfAttributeMetadata *) &(generatedAttributes[6]),                                                              \
                5,                                                                                                                   \
                17,                                                                                                                  \
            ...
            {                                                                                                                        \
                0x0700, (EmberAfAttributeMetadata *) &(generatedAttributes[15]), 1,                                                  \
                2,      (CLUSTER_MASK_CLIENT | CLUSTER_MASK_INIT_FUNCTION),      emberAfFuncArrayPriceClusterClient,                 \
            },                                                                                                                       \
            {                                                                                                                        \
                0x0700, (EmberAfAttributeMetadata *) &(generatedAttributes[16]), 1,                                                  \
            ...
            {                                                                                                                        \
                0x0702, (EmberAfAttributeMetadata *) &(generatedAttributes[23]),        1,                                           \
            ...
            {                                                                                                                        \
                0x0703, (EmberAfAttributeMetadata *) &(generatedAttributes[30]), 1,                                                  \
                2,      (CLUSTER_MASK_CLIENT | CLUSTER_MASK_INIT_FUNCTION),      emberAfFuncArrayMessagingClusterClient,             \
            },                                                                                                                       \
            {                                                                                                                        \
                0x0703, (EmberAfAttributeMetadata *) &(generatedAttributes[31]), 1,                                                  \
...
#define GENERATED_ENDPOINT_TYPES                                                                                                   \
    {                                                                                                                              \
        { (EmberAfCluster *) &(generatedClusters[0]), 14, 50 }, { (EmberAfCluster *) &(generatedClusters[14]), 4, 12 },            \
            { (EmberAfCluster *) &(generatedClusters[18]), 3, 0 }, { (EmberAfCluster *) &(generatedClusters[21]), 4, 12 },         \
    }
