...
#if defined(EMBER_COMMAND_INTEPRETER_HAS_DESCRIPTION_FIELD)
static const char * const pluginGreenPowerTestDeviceSendChannelRequestCommandArguments[] = {
  "Channel to set",
  NULL
};
#endif
...
#if defined(EMBER_COMMAND_INTEPRETER_HAS_DESCRIPTION_FIELD)
static const char * const pluginGreenPowerTestDeviceSendCommCommandArguments[] = {
  "0 for tx only, 1 for bidir",
  NULL
};
#endif
...
#if defined(EMBER_COMMAND_INTEPRETER_HAS_DESCRIPTION_FIELD)
static const char * const pluginGreenPowerTestDeviceSendIeeeTestCommandArguments[] = {
  "gpd command ID",
  "gpd command payload",
  NULL
};
...
#if defined(EMBER_COMMAND_INTEPRETER_HAS_DESCRIPTION_FIELD)
static const char * const pluginGreenPowerTestDeviceSendTestCommandArguments[] = {
  "gpd command ID",
  "gpd command payload",
  NULL
};
...
#if defined(EMBER_COMMAND_INTEPRETER_HAS_DESCRIPTION_FIELD)
static const char * const pluginGreenPowerTestDeviceSetPhyChannelCommandArguments[] = {
  "Channel to set",
  NULL
};
#endif
...
#if defined(EMBER_COMMAND_INTEPRETER_HAS_DESCRIPTION_FIELD)
static const char * const pluginGreenPowerTestDeviceSetupGpdCommandArguments[] = {
  "gpd src ID",
  "the key",
  NULL
};
...
#if defined(EMBER_COMMAND_INTEPRETER_HAS_DESCRIPTION_FIELD)
static const char * const pluginGreenPowerTestDeviceSetupIeeeGpdCommandArguments[] = {
  "gpd Ieee ID",
  "the key",
  NULL
};
...
static EmberCommandEntry emberCommandPluginGreenPowerTestDeviceTable[] = {
  emberCommandEntryActionWithDetails("send-channel-request", emberAfPluginGreenPowerTestDeviceSendChannelRequest, "u", "Send a test GPD command", pluginGreenPowerTestDeviceSendChannelRequestCommandArguments),
  emberCommandEntryActionWithDetails("send-comm", emberAfPluginGreenPowerTestDeviceSendCommission, "u", "Send a test GPD command", pluginGreenPowerTestDeviceSendCommCommandArguments),
  emberCommandEntryActionWithDetails("send-ieee-test", emberAfPluginGreenPowerTestDeviceSendTestIeee, "ub", "Send a test GPD command", pluginGreenPowerTestDeviceSendIeeeTestCommandArguments),
  emberCommandEntryActionWithDetails("send-test", emberAfPluginGreenPowerTestDeviceSendTest, "ub", "Send a test GPD command", pluginGreenPowerTestDeviceSendTestCommandArguments),
  emberCommandEntryActionWithDetails("set-phy-channel", emberAfPluginGreenPowerTestDeviceSetRadioChannel, "u", "set the phy channel", pluginGreenPowerTestDeviceSetPhyChannelCommandArguments),
  emberCommandEntryActionWithDetails("setup-gpd", emberAfPluginGreenPowerTestDeviceSetupGpd, "wb", "init a GPD", pluginGreenPowerTestDeviceSetupGpdCommandArguments),
  emberCommandEntryActionWithDetails("setup-ieee-gpd", emberAfPluginGreenPowerTestDeviceSetupGpdIeee, "bb", "init a Ieee GPD", pluginGreenPowerTestDeviceSetupIeeeGpdCommandArguments),
  emberCommandEntryTerminator(),
};
...
static EmberCommandEntry emberCommandPluginTable[] = {
  ...
  emberCommandEntrySubMenu("green-power-test-device", emberCommandPluginGreenPowerTestDeviceTable, ""),
