...
#if defined(EMBER_COMMAND_INTEPRETER_HAS_DESCRIPTION_FIELD)
static const char * const pluginDrlcServerCslceCommandArguments[] = {
...
#if defined(EMBER_COMMAND_INTEPRETER_HAS_DESCRIPTION_FIELD)
static const char * const pluginDrlcServerPrintCommandArguments[] = {
  "The relevant endpoint.",
  NULL
};
#endif
...
static const char * const pluginDrlcServerSlceCommandArguments[] = {
  "The relevant endpoint.",
  "Location in the load control event table for the event to be scheduled",
  "The length in the number of bytes",
  "Byte array value for the load control event",
  NULL
};
#endif
...
static const char * const pluginDrlcServerSslceCommandArguments[] = {
  "The destination node ide.",
  "The source endpoint.",
  "The destination endpoint.",
  "index of the load control event in the server's load control event tab ...",
  NULL
};
#endif

static EmberCommandEntry emberCommandPluginDrlcServerTable[] = {
  emberCommandEntryActionWithDetails("cslce", emberAfPluginDrlcServerCslceCommand, "u", "Clear the scheduled load control events table.", pluginDrlcServerCslceCommandArguments),
  emberCommandEntryActionWithDetails("lce-schedule-mand", emberAfPluginDrlcServerScheduleMandatoryLce, "uuwvuwvuu", "Schedules a load control event on the server.", pluginDrlcServerLceScheduleMandCommandArguments),
  emberCommandEntryActionWithDetails("print", emberAfPluginDrlcServerPrintCommand, "u", "Print the Demand Response Load Control Table.", pluginDrlcServerPrintCommandArguments),
  emberCommandEntryActionWithDetails("slce", emberAfPluginDrlcServerSlceCommand, "uuub", "Schedule a load control event in the load control event table on a loa ...", pluginDrlcServerSlceCommandArguments),
  emberCommandEntryActionWithDetails("sslce", emberAfPluginDrlcServerSslceCommand, "vuuu", "Command used on a DRLC server to send a scheduled load control event o ...", pluginDrlcServerSslceCommandArguments),
  emberCommandEntryTerminator(),
};
