        ...
        { 0x0000,                                                                                                                  \
          ...
          { (uint8_t *) &(minMaxDefaults[0]) } }, /* 0 / Basic / ZCL version*/                                                     \
            ...
            { 0x0000,                                                                                                              \
              ...
              { (uint8_t *) &(minMaxDefaults[2]) } }, /* 3 / Key Establishment / key establishment suite (client)*/                \
            {                                                                                                                      \
                0xFFFD, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (ATTRIBUTE_MASK_CLIENT | ATTRIBUTE_MASK_SINGLETON), { (uint8_t *) 0x0001 }   \
            }, /* 4 / Key Establishment / cluster revision*/                                                                       \
            { 0x0000,                                                                                                              \
              ZCL_ENUM16_ATTRIBUTE_TYPE,                                                                                           \
              2,                                                                                                                   \
              (ATTRIBUTE_MASK_MIN_MAX | ATTRIBUTE_MASK_SINGLETON),                                                                 \
              { (uint8_t *) &(minMaxDefaults[3]) } }, /* 5 / Key Establishment / key establishment suite (server)*/                \
            {                                                                                                                      \
                0xFFFD, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (ATTRIBUTE_MASK_SINGLETON), { (uint8_t *) 0x0001 }                           \
            }, /* 6 / Key Establishment / cluster revision*/                                                                       \
    }
...
#define GENERATED_COMMANDS                                                                                                         \
    {                                                                                                                              \
        { 0x0800, 0x00,                                                                                                            \
          COMMAND_MASK_OUTGOING_CLIENT | COMMAND_MASK_INCOMING_SERVER }, /* Key Establishment / InitiateKeyEstablishmentRequest */ \
            {                                                                                                                      \
