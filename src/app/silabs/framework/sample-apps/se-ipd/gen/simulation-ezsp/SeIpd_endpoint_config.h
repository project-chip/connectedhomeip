...
#define GENERATED_MIN_MAX_DEFAULTS                                                                                                 \
    {                                                                                                                              \
        { (uint8_t *) 0x03, (uint8_t *) 0x00, (uint8_t *) 0xFF }, { (uint8_t *) 0x00, (uint8_t *) 0x00, (uint8_t *) 0xFF },        \
            { (uint8_t *) 0x00, (uint8_t *) 0x00, (uint8_t *) 0xFF }, { (uint8_t *) 0x1E, (uint8_t *) 0x00, (uint8_t *) 0x3C },    \
            { (uint8_t *) 0x00, (uint8_t *) 0x00, (uint8_t *) 0x3C },                                                              \
            { (uint8_t *) 0x0000UL, (uint8_t *) 0x0000, (uint8_t *) 0xFFFF },                                                      \
        ...
        { 0x0000,                                                                                                                  \
          ...
          { (uint8_t *) &(minMaxDefaults[0]) } }, /* 0 / Basic / ZCL version*/                                                     \
            ...
            { 0x0000,                                                                                                              \
              ZCL_INT8U_ATTRIBUTE_TYPE,                                                                                            \
              1,                                                                                                                   \
              (ATTRIBUTE_MASK_WRITABLE | ATTRIBUTE_MASK_MIN_MAX | ATTRIBUTE_MASK_CLIENT),                                          \
              { (uint8_t *) &(minMaxDefaults[2]) } }, /* 5 / Demand Response and Load Control / utility enrollment group*/         \
            { 0x0001,                                                                                                              \
              ZCL_INT8U_ATTRIBUTE_TYPE,                                                                                            \
              1,                                                                                                                   \
              (ATTRIBUTE_MASK_WRITABLE | ATTRIBUTE_MASK_MIN_MAX | ATTRIBUTE_MASK_CLIENT),                                          \
              { (uint8_t *) &(minMaxDefaults[3]) } }, /* 6 / Demand Response and Load Control / start randomization minutes*/      \
            { 0x0002,                                                                                                              \
              ZCL_INT8U_ATTRIBUTE_TYPE,                                                                                            \
              1,                                                                                                                   \
              (ATTRIBUTE_MASK_WRITABLE | ATTRIBUTE_MASK_MIN_MAX | ATTRIBUTE_MASK_CLIENT),                                          \
              { (uint8_t *) &(minMaxDefaults[4]) } }, /* 7 / Demand Response and Load Control / duration randomization minutes*/   \
            { 0x0003,                                                                                                              \
              ZCL_INT16U_ATTRIBUTE_TYPE,                                                                                           \
              2,                                                                                                                   \
              (ATTRIBUTE_MASK_WRITABLE | ATTRIBUTE_MASK_MIN_MAX | ATTRIBUTE_MASK_CLIENT),                                          \
              { (uint8_t *) &(minMaxDefaults[5]) } }, /* 8 / Demand Response and Load Control / device class value*/               \
            {                                                                                                                      \
                0xFFFD, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (ATTRIBUTE_MASK_CLIENT), { (uint8_t *) 0x0001 }                              \
            }, /* 9 / Demand Response and Load Control / cluster revision*/                                                        \
            {                                                                                                                      \
                0xFFFD, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (ATTRIBUTE_MASK_CLIENT), { (uint8_t *) 0x0001 }                              \
            }, /* 10 / Simple Metering / cluster revision*/                                                                        \
            {                                                                                                                      \
                0xFFFD, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (ATTRIBUTE_MASK_CLIENT), { (uint8_t *) 0x0001 }                              \
            }, /* 11 / Messaging / cluster revision*/                                                                              \
            { 0x0000,                                                                                                              \
              ZCL_ENUM16_ATTRIBUTE_TYPE,                                                                                           \
              2,                                                                                                                   \
              (ATTRIBUTE_MASK_MIN_MAX | ATTRIBUTE_MASK_CLIENT | ATTRIBUTE_MASK_SINGLETON),                                         \
              { (uint8_t *) &(minMaxDefaults[6]) } }, /* 12 / Key Establishment / key establishment suite (client)*/               \
            {                                                                                                                      \
                0xFFFD, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (ATTRIBUTE_MASK_CLIENT | ATTRIBUTE_MASK_SINGLETON), { (uint8_t *) 0x0001 }   \
            ...
            { 0x0000,                                                                                                              \
              ...
              2,                                                                                                                   \
              (ATTRIBUTE_MASK_MIN_MAX | ATTRIBUTE_MASK_SINGLETON),                                                                 \
              { (uint8_t *) &(minMaxDefaults[7]) } }, /* 14 / Key Establishment / key establishment suite (server)*/               \
            {                                                                                                                      \
                0xFFFD, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (ATTRIBUTE_MASK_SINGLETON), { (uint8_t *) 0x0001 }                           \
...
#define GENERATED_CLUSTERS                                                                                                           \
    {                                                                                                                                \
        {                                                                                                                            \
            ...
            {                                                                                                                        \
                0x0702, (EmberAfAttributeMetadata *) &(generatedAttributes[10]),        1,                                           \
                2,      (CLUSTER_MASK_CLIENT | CLUSTER_MASK_DEFAULT_RESPONSE_FUNCTION), emberAfFuncArraySimpleMeteringClusterClient, \
            },                                                                                                                       \
            {                                                                                                                        \
                0x0703, (EmberAfAttributeMetadata *) &(generatedAttributes[11]), 1,                                                  \
