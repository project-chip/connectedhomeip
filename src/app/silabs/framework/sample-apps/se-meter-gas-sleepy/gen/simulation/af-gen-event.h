...
#define EMBER_AF_GENERATED_EVENT_CODE                                                                                              \
    ...
    void emberAfSimpleMeteringClusterServerTickCallbackWrapperFunction1(void)                                                      \
    {                                                                                                                              \
        clusterTickWrapper(&emberAfSimpleMeteringClusterServerTickCallbackControl1,                                                \
...
#define EMBER_AF_GENERATED_EVENT_STRINGS                                                                                           \
    "Simple Metering Cluster Server EP 1", "Key Establishment Cluster Server EP 1", "Form and Join Library Plugin Cleanup",        \
        "Key Establishment Plugin ApsDuplicateDetection", "Network Find Plugin Tick", "Simple Metering Server Plugin Sampling",    \
        "Simple Metering Server Plugin Supply", "Sleepy meter event control", "End Device Support Plugin Move NWK 0",              \
        "End Device Support Plugin Polling NWK 0", "Partner Link Key Exchange Plugin Timeout NWK 0",                               \
