...
#define EMBER_AF_GENERATED_EVENT_STRINGS                                                                                           \
    "Identify Cluster Server EP 1", "Poll Control Cluster Server EP 1", "IAS Zone Cluster Server EP 1",                            \
        "Door Lock Server Cluster Plugin Lockout", "Door Lock Server Cluster Plugin Relock",                                       \
        "Form and Join Library Plugin Cleanup", "IAS Zone Server Plugin ManageQueue", "Identify Feedback Plugin ProvideFeedback",  \
        "Network Find Plugin Tick", "End Device Support Plugin Move NWK 0", "End Device Support Plugin Polling NWK 0",             \
