...
/** @brief <b>plugin ias-zone-server change-backoff-config [firstBackoff:1] [commonRatio:1] [maxBackoff:4] [unlimitedRetries:1]
 * [maxRetryAttempts:2] </b>
...
/** @addtogroup plugin-em4 Plugin Commands: em4
 * @ingroup cli
 * The EM4 plugin contributes a command to the application framework's CLI.
 * This commands is used to show EM4 plugin status.
 *
 * @{
 */

/** @brief <b>plugin em4 status </b>
 *   - <i>Display the status of EM4 activation mode.</i>
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_PLUGIN_EM4_PLUGIN_EM4_STATUS

/** @} */ // end group plugin-em4
