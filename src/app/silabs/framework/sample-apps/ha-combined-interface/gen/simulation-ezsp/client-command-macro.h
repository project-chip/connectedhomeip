...
#define emberAfFillCommandGlobalServerToClientReadAttributesResponse(clusterId, readAttributeStatusRecords,                        \
    ...
    emberAfFillExternalBuffer((ZCL_GLOBAL_COMMAND | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),       \
                              clusterId, ZCL_READ_ATTRIBUTES_RESPONSE_COMMAND_ID, "b", readAttributeStatusRecords,                 \
                              readAttributeStatusRecordsLen);
...
#define emberAfFillCommandGlobalClientToServerReadAttributesResponse(clusterId, readAttributeStatusRecords,                        \
                                                                     readAttributeStatusRecordsLen)                                \
    emberAfFillExternalBuffer((ZCL_GLOBAL_COMMAND | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),       \
                              clusterId, ZCL_READ_ATTRIBUTES_RESPONSE_COMMAND_ID, "b", readAttributeStatusRecords,                 \
                              readAttributeStatusRecordsLen);
...
#define emberAfFillCommandGlobalServerToClientWriteAttributesResponse(clusterId, writeAttributeStatusRecords,                      \
    ...
    emberAfFillExternalBuffer((ZCL_GLOBAL_COMMAND | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),       \
                              clusterId, ZCL_WRITE_ATTRIBUTES_RESPONSE_COMMAND_ID, "b", writeAttributeStatusRecords,               \
                              writeAttributeStatusRecordsLen);
...
#define emberAfFillCommandGlobalServerToClientWriteAttributesNoResponse(clusterId, writeAttributeRecords,                          \
    ...
    emberAfFillExternalBuffer((ZCL_GLOBAL_COMMAND | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),       \
                              clusterId, ZCL_WRITE_ATTRIBUTES_NO_RESPONSE_COMMAND_ID, "b", writeAttributeRecords,                  \
                              writeAttributeRecordsLen);
...
#define emberAfFillCommandGlobalServerToClientConfigureReportingResponse(clusterId, configureReportingStatusRecords,               \
    ...
    emberAfFillExternalBuffer((ZCL_GLOBAL_COMMAND | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),       \
                              clusterId, ZCL_CONFIGURE_REPORTING_RESPONSE_COMMAND_ID, "b", configureReportingStatusRecords,        \
                              configureReportingStatusRecordsLen);
...
#define emberAfFillCommandGlobalServerToClientReadReportingConfigurationResponse(clusterId, readReportingConfigurationRecords,     \
    ...
    emberAfFillExternalBuffer((ZCL_GLOBAL_COMMAND | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),       \
                              clusterId, ZCL_READ_REPORTING_CONFIGURATION_RESPONSE_COMMAND_ID, "b",                                \
...
#define emberAfFillCommandGlobalServerToClientDefaultResponse(clusterId, commandId, status)                                        \
    emberAfFillExternalBuffer((ZCL_GLOBAL_COMMAND | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),       \
                              clusterId, ZCL_DEFAULT_RESPONSE_COMMAND_ID, "uu", commandId, status);
...
#define emberAfFillCommandGlobalServerToClientDiscoverAttributesResponse(                                                          \
    ...
    emberAfFillExternalBuffer((ZCL_GLOBAL_COMMAND | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),       \
                              clusterId, ZCL_DISCOVER_ATTRIBUTES_RESPONSE_COMMAND_ID, "ub", discoveryComplete,                     \
...
#define emberAfFillCommandGlobalServerToClientWriteAttributesStructuredResponse(clusterId, writeStructuredAttributeStatusRecords,  \
    ...
    emberAfFillExternalBuffer((ZCL_GLOBAL_COMMAND | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),       \
                              clusterId, ZCL_WRITE_ATTRIBUTES_STRUCTURED_RESPONSE_COMMAND_ID, "b",                                 \
...
#define emberAfFillCommandGlobalServerToClientDiscoverCommandsReceivedResponse(clusterId, discoveryComplete, commandIds,           \
                                                                               commandIdsLen)                                      \
    emberAfFillExternalBuffer((ZCL_GLOBAL_COMMAND | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),       \
                              clusterId, ZCL_DISCOVER_COMMANDS_RECEIVED_RESPONSE_COMMAND_ID, "ub", discoveryComplete, commandIds,  \
                              commandIdsLen);
...
#define emberAfFillCommandGlobalServerToClientDiscoverCommandsGeneratedResponse(clusterId, discoveryComplete, commandIds,          \
                                                                                commandIdsLen)                                     \
    emberAfFillExternalBuffer((ZCL_GLOBAL_COMMAND | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),       \
                              clusterId, ZCL_DISCOVER_COMMANDS_GENERATED_RESPONSE_COMMAND_ID, "ub", discoveryComplete, commandIds, \
                              commandIdsLen);
...
#define emberAfFillCommandGlobalServerToClientDiscoverAttributesExtendedResponse(                                                  \
    ...
    emberAfFillExternalBuffer((ZCL_GLOBAL_COMMAND | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),       \
                              clusterId, ZCL_DISCOVER_ATTRIBUTES_EXTENDED_RESPONSE_COMMAND_ID, "ub", discoveryComplete,            \
...
#define emberAfFillCommandIdentifyClusterIdentifyQueryResponse(timeout)                                                            \
    emberAfFillExternalBuffer(                                                                                                     \
        ...
        ZCL_IDENTIFY_CLUSTER_ID, ZCL_IDENTIFY_QUERY_RESPONSE_COMMAND_ID, "v", timeout);
...
#define emberAfFillCommandGroupsClusterAddGroupResponse(status, groupId)                                                           \
    emberAfFillExternalBuffer(                                                                                                     \
        (ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),                   \
        ZCL_GROUPS_CLUSTER_ID, ZCL_ADD_GROUP_RESPONSE_COMMAND_ID, "uv", status, groupId);
...
#define emberAfFillCommandGroupsClusterViewGroupResponse(status, groupId, groupName)                                               \
    emberAfFillExternalBuffer(                                                                                                     \
        (ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),                   \
        ZCL_GROUPS_CLUSTER_ID, ZCL_VIEW_GROUP_RESPONSE_COMMAND_ID, "uvs", status, groupId, groupName);
...
#define emberAfFillCommandGroupsClusterGetGroupMembershipResponse(capacity, groupCount, groupList, groupListLen)                   \
    emberAfFillExternalBuffer(                                                                                                     \
        (ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),                   \
        ZCL_GROUPS_CLUSTER_ID, ZCL_GET_GROUP_MEMBERSHIP_RESPONSE_COMMAND_ID, "uub", capacity, groupCount, groupList,               \
        groupListLen);
...
#define emberAfFillCommandGroupsClusterRemoveGroupResponse(status, groupId)                                                        \
    emberAfFillExternalBuffer(                                                                                                     \
        (ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),                   \
        ZCL_GROUPS_CLUSTER_ID, ZCL_REMOVE_GROUP_RESPONSE_COMMAND_ID, "uv", status, groupId);
...
#define emberAfFillCommandScenesClusterAddSceneResponse(status, groupId, sceneId)                                                  \
    emberAfFillExternalBuffer(                                                                                                     \
        (ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),                   \
        ZCL_SCENES_CLUSTER_ID, ZCL_ADD_SCENE_RESPONSE_COMMAND_ID, "uvu", status, groupId, sceneId);
...
#define emberAfFillCommandScenesClusterViewSceneResponse(status, groupId, sceneId, transitionTime, sceneName, extensionFieldSets,  \
    ...
    emberAfFillExternalBuffer(                                                                                                     \
        (ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),                   \
        ZCL_SCENES_CLUSTER_ID, ZCL_VIEW_SCENE_RESPONSE_COMMAND_ID, "uvuvsb", status, groupId, sceneId, transitionTime, sceneName,  \
...
#define emberAfFillCommandScenesClusterRemoveSceneResponse(status, groupId, sceneId)                                               \
    emberAfFillExternalBuffer(                                                                                                     \
        (ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),                   \
        ZCL_SCENES_CLUSTER_ID, ZCL_REMOVE_SCENE_RESPONSE_COMMAND_ID, "uvu", status, groupId, sceneId);
...
#define emberAfFillCommandScenesClusterRemoveAllScenesResponse(status, groupId)                                                    \
    emberAfFillExternalBuffer(                                                                                                     \
        (ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),                   \
        ZCL_SCENES_CLUSTER_ID, ZCL_REMOVE_ALL_SCENES_RESPONSE_COMMAND_ID, "uv", status, groupId);
...
#define emberAfFillCommandScenesClusterStoreSceneResponse(status, groupId, sceneId)                                                \
    emberAfFillExternalBuffer(                                                                                                     \
        (ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),                   \
        ZCL_SCENES_CLUSTER_ID, ZCL_STORE_SCENE_RESPONSE_COMMAND_ID, "uvu", status, groupId, sceneId);
...
#define emberAfFillCommandScenesClusterGetSceneMembershipResponse(status, capacity, groupId, sceneCount, sceneList, sceneListLen)  \
    emberAfFillExternalBuffer(                                                                                                     \
        (ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),                   \
        ZCL_SCENES_CLUSTER_ID, ZCL_GET_SCENE_MEMBERSHIP_RESPONSE_COMMAND_ID, "uuvub", status, capacity, groupId, sceneCount,       \
...
#define emberAfFillCommandScenesClusterEnhancedAddSceneResponse(status, groupId, sceneId)                                          \
    emberAfFillExternalBuffer(                                                                                                     \
        (ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),                   \
        ZCL_SCENES_CLUSTER_ID, ZCL_ENHANCED_ADD_SCENE_RESPONSE_COMMAND_ID, "uvu", status, groupId, sceneId);
...
#define emberAfFillCommandScenesClusterEnhancedViewSceneResponse(status, groupId, sceneId, transitionTime, sceneName,              \
    ...
    emberAfFillExternalBuffer(                                                                                                     \
        (ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),                   \
        ZCL_SCENES_CLUSTER_ID, ZCL_ENHANCED_VIEW_SCENE_RESPONSE_COMMAND_ID, "uvuvsb", status, groupId, sceneId, transitionTime,    \
...
#define emberAfFillCommandScenesClusterCopySceneResponse(status, groupIdFrom, sceneIdFrom)                                         \
    emberAfFillExternalBuffer(                                                                                                     \
        (ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),                   \
        ZCL_SCENES_CLUSTER_ID, ZCL_COPY_SCENE_RESPONSE_COMMAND_ID, "uvu", status, groupIdFrom, sceneIdFrom);
...
#define emberAfFillCommandAlarmClusterGetAlarmResponse(status, alarmCode, clusterId, timeStamp)                                    \
    emberAfFillExternalBuffer(                                                                                                     \
        (ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),                   \
        ZCL_ALARM_CLUSTER_ID, ZCL_GET_ALARM_RESPONSE_COMMAND_ID, "uuvw", status, alarmCode, clusterId, timeStamp);
...
#define emberAfFillCommandRssiLocationClusterRssiResponse(replyingDevice, coordinate1, coordinate2, coordinate3, rssi,             \
    ...
    emberAfFillExternalBuffer(                                                                                                     \
        ...
        ZCL_RSSI_LOCATION_CLUSTER_ID, ZCL_RSSI_RESPONSE_COMMAND_ID, "8vvvuu", replyingDevice, coordinate1, coordinate2,            \
...
#define emberAfFillCommandRssiLocationClusterDeviceConfigurationResponse(status, power, pathLossExponent, calculationPeriod,       \
    ...
    emberAfFillExternalBuffer(                                                                                                     \
        (ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),                   \
        ZCL_RSSI_LOCATION_CLUSTER_ID, ZCL_DEVICE_CONFIGURATION_RESPONSE_COMMAND_ID, "uvvvuv", status, power, pathLossExponent,     \
...
#define emberAfFillCommandRssiLocationClusterLocationDataResponse(status, locationType, coordinate1, coordinate2, coordinate3,     \
    ...
    emberAfFillExternalBuffer(                                                                                                     \
        (ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),                   \
        ZCL_RSSI_LOCATION_CLUSTER_ID, ZCL_LOCATION_DATA_RESPONSE_COMMAND_ID, "uuvvvvvuuv", status, locationType, coordinate1,      \
...
#define emberAfFillCommandCommissioningClusterRestartDeviceResponse(status)                                                        \
    emberAfFillExternalBuffer(                                                                                                     \
        (ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),                   \
        ZCL_COMMISSIONING_CLUSTER_ID, ZCL_RESTART_DEVICE_RESPONSE_COMMAND_ID, "u", status);
...
#define emberAfFillCommandCommissioningClusterSaveStartupParametersResponse(status)                                                \
    emberAfFillExternalBuffer(                                                                                                     \
        (ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),                   \
        ZCL_COMMISSIONING_CLUSTER_ID, ZCL_SAVE_STARTUP_PARAMETERS_RESPONSE_COMMAND_ID, "u", status);
...
#define emberAfFillCommandCommissioningClusterRestoreStartupParametersResponse(status)                                             \
    emberAfFillExternalBuffer(                                                                                                     \
        (ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),                   \
        ZCL_COMMISSIONING_CLUSTER_ID, ZCL_RESTORE_STARTUP_PARAMETERS_RESPONSE_COMMAND_ID, "u", status);
...
#define emberAfFillCommandCommissioningClusterResetStartupParametersResponse(status)                                               \
    emberAfFillExternalBuffer(                                                                                                     \
        (ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),                   \
        ZCL_COMMISSIONING_CLUSTER_ID, ZCL_RESET_STARTUP_PARAMETERS_RESPONSE_COMMAND_ID, "u", status);
...
#define emberAfFillCommandPartitionClusterReadHandshakeParamResponse(partitionedClusterId, readAttributeStatusRecords,             \
    ...
    emberAfFillExternalBuffer(                                                                                                     \
        (ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),                   \
        ZCL_PARTITION_CLUSTER_ID, ZCL_READ_HANDSHAKE_PARAM_RESPONSE_COMMAND_ID, "vb", partitionedClusterId,                        \
...
#define emberAfFillCommandOtaBootloadClusterQueryNextImageResponse(status, manufacturerId, imageType, fileVersion, imageSize)      \
    emberAfFillExternalBuffer(                                                                                                     \
        (ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),                   \
        ZCL_OTA_BOOTLOAD_CLUSTER_ID, ZCL_QUERY_NEXT_IMAGE_RESPONSE_COMMAND_ID, "uvvww", status, manufacturerId, imageType,         \
...
#define emberAfFillCommandOtaBootloadClusterImageBlockResponse(status, manufacturerId, imageType, fileVersion, fileOffset,         \
    ...
    emberAfFillExternalBuffer(                                                                                                     \
        (ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),                   \
        ZCL_OTA_BOOTLOAD_CLUSTER_ID, ZCL_IMAGE_BLOCK_RESPONSE_COMMAND_ID, "uvvwwub", status, manufacturerId, imageType,            \
        fileVersion, fileOffset, dataSize, imageData, imageDataLen);
...
#define emberAfFillCommandOtaBootloadClusterUpgradeEndResponse(manufacturerId, imageType, fileVersion, currentTime, upgradeTime)   \
    emberAfFillExternalBuffer(                                                                                                     \
        (ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),                   \
        ZCL_OTA_BOOTLOAD_CLUSTER_ID, ZCL_UPGRADE_END_RESPONSE_COMMAND_ID, "vvwww", manufacturerId, imageType, fileVersion,         \
...
#define emberAfFillCommandOtaBootloadClusterQuerySpecificFileResponse(status, manufacturerId, imageType, fileVersion, imageSize)   \
    emberAfFillExternalBuffer(                                                                                                     \
        (ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),                   \
        ZCL_OTA_BOOTLOAD_CLUSTER_ID, ZCL_QUERY_SPECIFIC_FILE_RESPONSE_COMMAND_ID, "uvvww", status, manufacturerId, imageType,      \
        fileVersion, imageSize);
...
#define emberAfFillCommandPowerProfileClusterGetPowerProfilePriceResponse(powerProfileId, currency, price, priceTrailingDigit)     \
    emberAfFillExternalBuffer(                                                                                                     \
        (ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),                   \
        ZCL_POWER_PROFILE_CLUSTER_ID, ZCL_GET_POWER_PROFILE_PRICE_RESPONSE_COMMAND_ID, "uvwu", powerProfileId, currency, price,    \
        priceTrailingDigit);
...
#define emberAfFillCommandPowerProfileClusterGetOverallSchedulePriceResponse(currency, price, priceTrailingDigit)                  \
    emberAfFillExternalBuffer(                                                                                                     \
        (ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),                   \
        ZCL_POWER_PROFILE_CLUSTER_ID, ZCL_GET_OVERALL_SCHEDULE_PRICE_RESPONSE_COMMAND_ID, "vwu", currency, price,                  \
        priceTrailingDigit);
...
#define emberAfFillCommandPowerProfileClusterEnergyPhasesScheduleResponse(powerProfileId, numOfScheduledPhases, scheduledPhases,   \
    ...
    emberAfFillExternalBuffer(                                                                                                     \
        (ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),                   \
        ZCL_POWER_PROFILE_CLUSTER_ID, ZCL_ENERGY_PHASES_SCHEDULE_RESPONSE_COMMAND_ID, "uub", powerProfileId, numOfScheduledPhases, \
        scheduledPhases, scheduledPhasesLen);
...
#define emberAfFillCommandPowerProfileClusterGetPowerProfilePriceExtendedResponse(powerProfileId, currency, price,                 \
    ...
    emberAfFillExternalBuffer(                                                                                                     \
        (ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),                   \
        ZCL_POWER_PROFILE_CLUSTER_ID, ZCL_GET_POWER_PROFILE_PRICE_EXTENDED_RESPONSE_COMMAND_ID, "uvwu", powerProfileId, currency,  \
        price, priceTrailingDigit);
...
#define emberAfFillCommandPowerProfileClusterPowerProfileResponse(totalProfileNum, powerProfileId, numOfTransferredPhases,         \
    ...
    emberAfFillExternalBuffer(                                                                                                     \
        (ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),                   \
        ZCL_POWER_PROFILE_CLUSTER_ID, ZCL_POWER_PROFILE_RESPONSE_COMMAND_ID, "uuub", totalProfileNum, powerProfileId,              \
        numOfTransferredPhases, transferredPhases, transferredPhasesLen);
...
#define emberAfFillCommandPowerProfileClusterPowerProfileStateResponse(powerProfileCount, powerProfileRecords,                     \
    ...
    emberAfFillExternalBuffer(                                                                                                     \
        (ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),                   \
        ZCL_POWER_PROFILE_CLUSTER_ID, ZCL_POWER_PROFILE_STATE_RESPONSE_COMMAND_ID, "ub", powerProfileCount, powerProfileRecords,   \
        powerProfileRecordsLen);
...
#define emberAfFillCommandPowerProfileClusterEnergyPhasesScheduleStateResponse(powerProfileId, numOfScheduledPhases,               \
    ...
    emberAfFillExternalBuffer(                                                                                                     \
        (ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),                   \
        ZCL_POWER_PROFILE_CLUSTER_ID, ZCL_ENERGY_PHASES_SCHEDULE_STATE_RESPONSE_COMMAND_ID, "uub", powerProfileId,                 \
...
#define emberAfFillCommandPowerProfileClusterPowerProfileScheduleConstraintsResponse(powerProfileId, startAfter, stopBefore)       \
    emberAfFillExternalBuffer(                                                                                                     \
        (ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),                   \
        ZCL_POWER_PROFILE_CLUSTER_ID, ZCL_POWER_PROFILE_SCHEDULE_CONSTRAINTS_RESPONSE_COMMAND_ID, "uvv", powerProfileId,           \
        startAfter, stopBefore);
...
#define emberAfFillCommandPollControlClusterCheckInResponse(startFastPolling, fastPollTimeout)                                     \
    emberAfFillExternalBuffer(                                                                                                     \
        (ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),                   \
        ZCL_POLL_CONTROL_CLUSTER_ID, ZCL_CHECK_IN_RESPONSE_COMMAND_ID, "uv", startFastPolling, fastPollTimeout);
...
#define emberAfFillCommandDoorLockClusterLockDoorResponse(status)                                                                  \
    emberAfFillExternalBuffer(                                                                                                     \
        (ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),                   \
        ZCL_DOOR_LOCK_CLUSTER_ID, ZCL_LOCK_DOOR_RESPONSE_COMMAND_ID, "u", status);
...
#define emberAfFillCommandDoorLockClusterUnlockDoorResponse(status)                                                                \
    emberAfFillExternalBuffer(                                                                                                     \
        (ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),                   \
        ZCL_DOOR_LOCK_CLUSTER_ID, ZCL_UNLOCK_DOOR_RESPONSE_COMMAND_ID, "u", status);
...
#define emberAfFillCommandDoorLockClusterToggleResponse(status)                                                                    \
    emberAfFillExternalBuffer(                                                                                                     \
        (ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),                   \
        ZCL_DOOR_LOCK_CLUSTER_ID, ZCL_TOGGLE_RESPONSE_COMMAND_ID, "u", status);
...
#define emberAfFillCommandDoorLockClusterUnlockWithTimeoutResponse(status)                                                         \
    emberAfFillExternalBuffer(                                                                                                     \
        (ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),                   \
        ZCL_DOOR_LOCK_CLUSTER_ID, ZCL_UNLOCK_WITH_TIMEOUT_RESPONSE_COMMAND_ID, "u", status);
...
#define emberAfFillCommandDoorLockClusterGetLogRecordResponse(logEntryId, timestamp, eventType, source, eventIdOrAlarmCode,        \
    ...
    emberAfFillExternalBuffer(                                                                                                     \
        (ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),                   \
        ZCL_DOOR_LOCK_CLUSTER_ID, ZCL_GET_LOG_RECORD_RESPONSE_COMMAND_ID, "vwuuuvs", logEntryId, timestamp, eventType, source,     \
...
#define emberAfFillCommandDoorLockClusterSetPinResponse(status)                                                                    \
    emberAfFillExternalBuffer(                                                                                                     \
        (ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),                   \
        ZCL_DOOR_LOCK_CLUSTER_ID, ZCL_SET_PIN_RESPONSE_COMMAND_ID, "u", status);
...
#define emberAfFillCommandDoorLockClusterGetPinResponse(userId, userStatus, userType, pin)                                         \
    emberAfFillExternalBuffer(                                                                                                     \
        (ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),                   \
        ZCL_DOOR_LOCK_CLUSTER_ID, ZCL_GET_PIN_RESPONSE_COMMAND_ID, "vuus", userId, userStatus, userType, pin);
...
#define emberAfFillCommandDoorLockClusterClearPinResponse(status)                                                                  \
    emberAfFillExternalBuffer(                                                                                                     \
        (ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),                   \
        ZCL_DOOR_LOCK_CLUSTER_ID, ZCL_CLEAR_PIN_RESPONSE_COMMAND_ID, "u", status);
...
#define emberAfFillCommandDoorLockClusterClearAllPinsResponse(status)                                                              \
    emberAfFillExternalBuffer(                                                                                                     \
        (ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),                   \
        ZCL_DOOR_LOCK_CLUSTER_ID, ZCL_CLEAR_ALL_PINS_RESPONSE_COMMAND_ID, "u", status);
...
#define emberAfFillCommandDoorLockClusterSetUserStatusResponse(status)                                                             \
    emberAfFillExternalBuffer(                                                                                                     \
        (ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),                   \
        ZCL_DOOR_LOCK_CLUSTER_ID, ZCL_SET_USER_STATUS_RESPONSE_COMMAND_ID, "u", status);
...
#define emberAfFillCommandDoorLockClusterGetUserStatusResponse(userId, status)                                                     \
    emberAfFillExternalBuffer(                                                                                                     \
        (ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),                   \
        ZCL_DOOR_LOCK_CLUSTER_ID, ZCL_GET_USER_STATUS_RESPONSE_COMMAND_ID, "vu", userId, status);
...
#define emberAfFillCommandDoorLockClusterSetWeekdayScheduleResponse(status)                                                        \
    emberAfFillExternalBuffer(                                                                                                     \
        (ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),                   \
        ZCL_DOOR_LOCK_CLUSTER_ID, ZCL_SET_WEEKDAY_SCHEDULE_RESPONSE_COMMAND_ID, "u", status);
...
#define emberAfFillCommandDoorLockClusterGetWeekdayScheduleResponse(scheduleId, userId, status, daysMask, startHour, startMinute,  \
    ...
    emberAfFillExternalBuffer(                                                                                                     \
        (ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),                   \
        ZCL_DOOR_LOCK_CLUSTER_ID, ZCL_GET_WEEKDAY_SCHEDULE_RESPONSE_COMMAND_ID, "uvuuuuuu", scheduleId, userId, status, daysMask,  \
...
#define emberAfFillCommandDoorLockClusterClearWeekdayScheduleResponse(status)                                                      \
    emberAfFillExternalBuffer(                                                                                                     \
        (ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),                   \
        ZCL_DOOR_LOCK_CLUSTER_ID, ZCL_CLEAR_WEEKDAY_SCHEDULE_RESPONSE_COMMAND_ID, "u", status);
...
#define emberAfFillCommandDoorLockClusterSetYeardayScheduleResponse(status)                                                        \
    emberAfFillExternalBuffer(                                                                                                     \
        (ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),                   \
        ZCL_DOOR_LOCK_CLUSTER_ID, ZCL_SET_YEARDAY_SCHEDULE_RESPONSE_COMMAND_ID, "u", status);
...
#define emberAfFillCommandDoorLockClusterGetYeardayScheduleResponse(scheduleId, userId, status, localStartTime, localEndTime)      \
    emberAfFillExternalBuffer(                                                                                                     \
        (ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),                   \
        ZCL_DOOR_LOCK_CLUSTER_ID, ZCL_GET_YEARDAY_SCHEDULE_RESPONSE_COMMAND_ID, "uvuww", scheduleId, userId, status,               \
...
#define emberAfFillCommandDoorLockClusterClearYeardayScheduleResponse(status)                                                      \
    emberAfFillExternalBuffer(                                                                                                     \
        (ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),                   \
        ZCL_DOOR_LOCK_CLUSTER_ID, ZCL_CLEAR_YEARDAY_SCHEDULE_RESPONSE_COMMAND_ID, "u", status);
...
#define emberAfFillCommandDoorLockClusterSetHolidayScheduleResponse(status)                                                        \
    emberAfFillExternalBuffer(                                                                                                     \
        (ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),                   \
        ZCL_DOOR_LOCK_CLUSTER_ID, ZCL_SET_HOLIDAY_SCHEDULE_RESPONSE_COMMAND_ID, "u", status);
...
#define emberAfFillCommandDoorLockClusterGetHolidayScheduleResponse(scheduleId, status, localStartTime, localEndTime,              \
    ...
    emberAfFillExternalBuffer(                                                                                                     \
        (ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),                   \
        ZCL_DOOR_LOCK_CLUSTER_ID, ZCL_GET_HOLIDAY_SCHEDULE_RESPONSE_COMMAND_ID, "uuwwu", scheduleId, status, localStartTime,       \
...
#define emberAfFillCommandDoorLockClusterClearHolidayScheduleResponse(status)                                                      \
    emberAfFillExternalBuffer(                                                                                                     \
        (ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),                   \
        ZCL_DOOR_LOCK_CLUSTER_ID, ZCL_CLEAR_HOLIDAY_SCHEDULE_RESPONSE_COMMAND_ID, "u", status);
...
#define emberAfFillCommandDoorLockClusterSetUserTypeResponse(status)                                                               \
    emberAfFillExternalBuffer(                                                                                                     \
        (ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),                   \
        ZCL_DOOR_LOCK_CLUSTER_ID, ZCL_SET_USER_TYPE_RESPONSE_COMMAND_ID, "u", status);
...
#define emberAfFillCommandDoorLockClusterGetUserTypeResponse(userId, userType)                                                     \
    emberAfFillExternalBuffer(                                                                                                     \
        (ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),                   \
        ZCL_DOOR_LOCK_CLUSTER_ID, ZCL_GET_USER_TYPE_RESPONSE_COMMAND_ID, "vu", userId, userType);
...
#define emberAfFillCommandDoorLockClusterSetRfidResponse(status)                                                                   \
    emberAfFillExternalBuffer(                                                                                                     \
        (ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),                   \
        ZCL_DOOR_LOCK_CLUSTER_ID, ZCL_SET_RFID_RESPONSE_COMMAND_ID, "u", status);
...
#define emberAfFillCommandDoorLockClusterGetRfidResponse(userId, userStatus, userType, rfid)                                       \
    emberAfFillExternalBuffer(                                                                                                     \
        (ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),                   \
        ZCL_DOOR_LOCK_CLUSTER_ID, ZCL_GET_RFID_RESPONSE_COMMAND_ID, "vuus", userId, userStatus, userType, rfid);
...
#define emberAfFillCommandDoorLockClusterClearRfidResponse(status)                                                                 \
    emberAfFillExternalBuffer(                                                                                                     \
        (ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),                   \
        ZCL_DOOR_LOCK_CLUSTER_ID, ZCL_CLEAR_RFID_RESPONSE_COMMAND_ID, "u", status);
...
#define emberAfFillCommandDoorLockClusterClearAllRfidsResponse(status)                                                             \
    emberAfFillExternalBuffer(                                                                                                     \
        (ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),                   \
        ZCL_DOOR_LOCK_CLUSTER_ID, ZCL_CLEAR_ALL_RFIDS_RESPONSE_COMMAND_ID, "u", status);
...
#define emberAfFillCommandIasZoneClusterZoneEnrollResponse(enrollResponseCode, zoneId)                                             \
    emberAfFillExternalBuffer(                                                                                                     \
        (ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),                   \
        ZCL_IAS_ZONE_CLUSTER_ID, ZCL_ZONE_ENROLL_RESPONSE_COMMAND_ID, "uu", enrollResponseCode, zoneId);
...
#define emberAfFillCommandIasZoneClusterInitiateNormalOperationModeResponse()                                                      \
    emberAfFillExternalBuffer(                                                                                                     \
        (ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),                   \
        ZCL_IAS_ZONE_CLUSTER_ID, ZCL_INITIATE_NORMAL_OPERATION_MODE_RESPONSE_COMMAND_ID, "");
...
#define emberAfFillCommandIasZoneClusterInitiateTestModeResponse()                                                                 \
    emberAfFillExternalBuffer(                                                                                                     \
        (ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),                   \
        ZCL_IAS_ZONE_CLUSTER_ID, ZCL_INITIATE_TEST_MODE_RESPONSE_COMMAND_ID, "");
...
#define emberAfFillCommandIasAceClusterArmResponse(armNotification)                                                                \
    emberAfFillExternalBuffer(                                                                                                     \
        (ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),                   \
        ZCL_IAS_ACE_CLUSTER_ID, ZCL_ARM_RESPONSE_COMMAND_ID, "u", armNotification);
...
#define emberAfFillCommandIasAceClusterGetZoneIdMapResponse(section0, section1, section2, section3, section4, section5, section6,  \
    ...
    emberAfFillExternalBuffer(                                                                                                     \
        (ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),                   \
        ZCL_IAS_ACE_CLUSTER_ID, ZCL_GET_ZONE_ID_MAP_RESPONSE_COMMAND_ID, "vvvvvvvvvvvvvvvv", section0, section1, section2,         \
        section3, section4, section5, section6, section7, section8, section9, section10, section11, section12, section13,          \
        section14, section15);
...
#define emberAfFillCommandIasAceClusterGetZoneInformationResponse(zoneId, zoneType, ieeeAddress, zoneLabel)                        \
    emberAfFillExternalBuffer(                                                                                                     \
        (ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),                   \
        ZCL_IAS_ACE_CLUSTER_ID, ZCL_GET_ZONE_INFORMATION_RESPONSE_COMMAND_ID, "uv8s", zoneId, zoneType, ieeeAddress, zoneLabel);
...
#define emberAfFillCommandIasAceClusterGetPanelStatusResponse(panelStatus, secondsRemaining, audibleNotification, alarmStatus)     \
    emberAfFillExternalBuffer(                                                                                                     \
        (ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),                   \
        ZCL_IAS_ACE_CLUSTER_ID, ZCL_GET_PANEL_STATUS_RESPONSE_COMMAND_ID, "uuuu", panelStatus, secondsRemaining,                   \
...
#define emberAfFillCommandIasAceClusterBypassResponse(numberOfZones, bypassResult, bypassResultLen)                                \
    emberAfFillExternalBuffer(                                                                                                     \
        (ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),                   \
        ZCL_IAS_ACE_CLUSTER_ID, ZCL_BYPASS_RESPONSE_COMMAND_ID, "ub", numberOfZones, bypassResult, bypassResultLen);
...
#define emberAfFillCommandIasAceClusterGetZoneStatusResponse(zoneStatusComplete, numberOfZones, zoneStatusResult,                  \
    ...
    emberAfFillExternalBuffer(                                                                                                     \
        (ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),                   \
        ZCL_IAS_ACE_CLUSTER_ID, ZCL_GET_ZONE_STATUS_RESPONSE_COMMAND_ID, "uub", zoneStatusComplete, numberOfZones,                 \
...
#define emberAfFillCommandGenericTunnelClusterMatchProtocolAddressResponse(deviceIeeeAddress, protocolAddress)                     \
    emberAfFillExternalBuffer(                                                                                                     \
        (ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),                   \
        ZCL_GENERIC_TUNNEL_CLUSTER_ID, ZCL_MATCH_PROTOCOL_ADDRESS_RESPONSE_COMMAND_ID, "8s", deviceIeeeAddress, protocolAddress);
...
#define emberAfFillCommandPriceClusterCppEventResponse(issuerEventId, cppAuth)                                                     \
    emberAfFillExternalBuffer(                                                                                                     \
        (ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),                   \
        ZCL_PRICE_CLUSTER_ID, ZCL_CPP_EVENT_RESPONSE_COMMAND_ID, "wu", issuerEventId, cppAuth);
...
#define emberAfFillCommandSimpleMeteringClusterGetProfileResponse(endTime, status, profileIntervalPeriod,                          \
    ...
    emberAfFillExternalBuffer(                                                                                                     \
        (ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),                   \
        ZCL_SIMPLE_METERING_CLUSTER_ID, ZCL_GET_PROFILE_RESPONSE_COMMAND_ID, "wuuub", endTime, status, profileIntervalPeriod,      \
        numberOfPeriodsDelivered, intervals, intervalsLen);
...
#define emberAfFillCommandSimpleMeteringClusterRequestFastPollModeResponse(appliedUpdatePeriod, fastPollModeEndtime)               \
    emberAfFillExternalBuffer(                                                                                                     \
        (ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),                   \
        ZCL_SIMPLE_METERING_CLUSTER_ID, ZCL_REQUEST_FAST_POLL_MODE_RESPONSE_COMMAND_ID, "uw", appliedUpdatePeriod,                 \
        fastPollModeEndtime);
...
#define emberAfFillCommandSimpleMeteringClusterScheduleSnapshotResponse(issuerEventId, snapshotResponsePayload,                    \
    ...
    emberAfFillExternalBuffer(                                                                                                     \
        (ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),                   \
        ZCL_SIMPLE_METERING_CLUSTER_ID, ZCL_SCHEDULE_SNAPSHOT_RESPONSE_COMMAND_ID, "wb", issuerEventId, snapshotResponsePayload,   \
        snapshotResponsePayloadLen);
...
#define emberAfFillCommandSimpleMeteringClusterTakeSnapshotResponse(snapshotId, snapshotConfirmation)                              \
    emberAfFillExternalBuffer(                                                                                                     \
        (ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),                   \
        ZCL_SIMPLE_METERING_CLUSTER_ID, ZCL_TAKE_SNAPSHOT_RESPONSE_COMMAND_ID, "wu", snapshotId, snapshotConfirmation);
...
#define emberAfFillCommandSimpleMeteringClusterGetSampledDataResponse(sampleId, sampleStartTime, sampleType,                       \
    ...
    emberAfFillExternalBuffer(                                                                                                     \
        (ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),                   \
        ZCL_SIMPLE_METERING_CLUSTER_ID, ZCL_GET_SAMPLED_DATA_RESPONSE_COMMAND_ID, "vwuvvb", sampleId, sampleStartTime, sampleType, \
        sampleRequestInterval, numberOfSamples, samples, samplesLen);
...
#define emberAfFillCommandSimpleMeteringClusterSupplyStatusResponse(providerId, issuerEventId, implementationDateTime,             \
    ...
    emberAfFillExternalBuffer(                                                                                                     \
        (ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),                   \
        ZCL_SIMPLE_METERING_CLUSTER_ID, ZCL_SUPPLY_STATUS_RESPONSE_COMMAND_ID, "wwwu", providerId, issuerEventId,                  \
...
#define emberAfFillCommandSimpleMeteringClusterStartSamplingResponse(sampleId)                                                     \
    emberAfFillExternalBuffer(                                                                                                     \
        (ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),                   \
        ZCL_SIMPLE_METERING_CLUSTER_ID, ZCL_START_SAMPLING_RESPONSE_COMMAND_ID, "v", sampleId);
...
#define emberAfFillCommandSimpleMeteringClusterRequestMirrorResponse(endpointId)                                                   \
    emberAfFillExternalBuffer(                                                                                                     \
        (ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),                   \
        ZCL_SIMPLE_METERING_CLUSTER_ID, ZCL_REQUEST_MIRROR_RESPONSE_COMMAND_ID, "v", endpointId);
...
#define emberAfFillCommandSimpleMeteringClusterMirrorReportAttributeResponse(notificationScheme, notificationFlags,                \
    ...
    emberAfFillExternalBuffer(                                                                                                     \
        (ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),                   \
        ZCL_SIMPLE_METERING_CLUSTER_ID, ZCL_MIRROR_REPORT_ATTRIBUTE_RESPONSE_COMMAND_ID, "ub", notificationScheme,                 \
...
#define emberAfFillCommandTunnelingClusterRequestTunnelResponse(tunnelId, tunnelStatus, maximumIncomingTransferSize)               \
    emberAfFillExternalBuffer(                                                                                                     \
        (ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),                   \
        ZCL_TUNNELING_CLUSTER_ID, ZCL_REQUEST_TUNNEL_RESPONSE_COMMAND_ID, "vuv", tunnelId, tunnelStatus,                           \
        maximumIncomingTransferSize);
...
#define emberAfFillCommandTunnelingClusterSupportedTunnelProtocolsResponse(protocolListComplete, protocolCount, protocolList,      \
    ...
    emberAfFillExternalBuffer(                                                                                                     \
        (ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),                   \
        ZCL_TUNNELING_CLUSTER_ID, ZCL_SUPPORTED_TUNNEL_PROTOCOLS_RESPONSE_COMMAND_ID, "uub", protocolListComplete, protocolCount,  \
...
#define emberAfFillCommandPrepaymentClusterChangePaymentModeResponse(friendlyCredit, friendlyCreditCalendarId,                     \
    ...
    emberAfFillExternalBuffer(                                                                                                     \
        (ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),                   \
        ZCL_PREPAYMENT_CLUSTER_ID, ZCL_CHANGE_PAYMENT_MODE_RESPONSE_COMMAND_ID, "uwww", friendlyCredit, friendlyCreditCalendarId,  \
        emergencyCreditLimit, emergencyCreditThreshold);
...
#define emberAfFillCommandPrepaymentClusterConsumerTopUpResponse(resultType, topUpValue, sourceOfTopUp, creditRemaining)           \
    emberAfFillExternalBuffer(                                                                                                     \
        (ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),                   \
        ZCL_PREPAYMENT_CLUSTER_ID, ZCL_CONSUMER_TOP_UP_RESPONSE_COMMAND_ID, "uwuw", resultType, topUpValue, sourceOfTopUp,         \
        creditRemaining);
...
#define emberAfFillCommandDeviceManagementClusterRequestNewPasswordResponse(issuerEventId, implementationDateTime,                 \
    ...
    emberAfFillExternalBuffer(                                                                                                     \
        (ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),                   \
        ZCL_DEVICE_MANAGEMENT_CLUSTER_ID, ZCL_REQUEST_NEW_PASSWORD_RESPONSE_COMMAND_ID, "wwvus", issuerEventId,                    \
...
#define emberAfFillCommandEventsClusterClearEventLogResponse(clearedEventsLogs)                                                    \
    emberAfFillExternalBuffer(                                                                                                     \
        (ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),                   \
        ZCL_EVENTS_CLUSTER_ID, ZCL_CLEAR_EVENT_LOG_RESPONSE_COMMAND_ID, "u", clearedEventsLogs);
...
#define emberAfFillCommandMduPairingClusterPairingResponse(pairingInformationVersion, totalNumberOfDevices, commandIndex,          \
    ...
    emberAfFillExternalBuffer(                                                                                                     \
        (ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),                   \
        ZCL_MDU_PAIRING_CLUSTER_ID, ZCL_PAIRING_RESPONSE_COMMAND_ID, "wuuub", pairingInformationVersion, totalNumberOfDevices,     \
...
#define emberAfFillCommandKeyEstablishmentClusterConfirmKeyDataResponse(secureMessageAuthenticationCode)                           \
    emberAfFillExternalBuffer(                                                                                                     \
        (ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),                   \
        ZCL_KEY_ESTABLISHMENT_CLUSTER_ID, ZCL_CONFIRM_KEY_DATA_RESPONSE_COMMAND_ID, "G", secureMessageAuthenticationCode);
...
#define emberAfFillCommandInformationClusterPushInformationResponse(notificationList, notificationListLen)                         \
    emberAfFillExternalBuffer(                                                                                                     \
        (ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),                   \
        ZCL_INFORMATION_CLUSTER_ID, ZCL_PUSH_INFORMATION_RESPONSE_COMMAND_ID, "b", notificationList, notificationListLen);
...
#define emberAfFillCommandInformationClusterRequestPreferenceResponse(statusFeedback, preferenceType, preferencePayload,           \
    ...
    emberAfFillExternalBuffer(                                                                                                     \
        (ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),                   \
        ZCL_INFORMATION_CLUSTER_ID, ZCL_REQUEST_PREFERENCE_RESPONSE_COMMAND_ID, "uvb", statusFeedback, preferenceType,             \
...
#define emberAfFillCommandInformationClusterRequestInformationResponse(number, buffer, bufferLen)                                  \
    emberAfFillExternalBuffer(                                                                                                     \
        (ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),                   \
        ZCL_INFORMATION_CLUSTER_ID, ZCL_REQUEST_INFORMATION_RESPONSE_COMMAND_ID, "ub", number, buffer, bufferLen);
...
#define emberAfFillCommandInformationClusterSendPreferenceResponse(statusFeedbackList, statusFeedbackListLen)                      \
    emberAfFillExternalBuffer(                                                                                                     \
        (ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),                   \
        ZCL_INFORMATION_CLUSTER_ID, ZCL_SEND_PREFERENCE_RESPONSE_COMMAND_ID, "b", statusFeedbackList, statusFeedbackListLen);
...
#define emberAfFillCommandInformationClusterUpdateResponse(notificationList, notificationListLen)                                  \
    emberAfFillExternalBuffer(                                                                                                     \
        (ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),                   \
        ZCL_INFORMATION_CLUSTER_ID, ZCL_UPDATE_RESPONSE_COMMAND_ID, "b", notificationList, notificationListLen);
...
#define emberAfFillCommandInformationClusterDeleteResponse(notificationList, notificationListLen)                                  \
    emberAfFillExternalBuffer(                                                                                                     \
        (ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),                   \
        ZCL_INFORMATION_CLUSTER_ID, ZCL_DELETE_RESPONSE_COMMAND_ID, "b", notificationList, notificationListLen);
...
#define emberAfFillCommandDataSharingClusterWriteFileResponse(status, fileIndex, fileIndexLen)                                     \
    emberAfFillExternalBuffer(                                                                                                     \
        (ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),                   \
        ZCL_DATA_SHARING_CLUSTER_ID, ZCL_WRITE_FILE_RESPONSE_COMMAND_ID, "ub", status, fileIndex, fileIndexLen);
...
#define emberAfFillCommandGamingClusterGeneralResponse(commandId, status, message)                                                 \
    emberAfFillExternalBuffer(                                                                                                     \
        (ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),                   \
        ZCL_GAMING_CLUSTER_ID, ZCL_GENERAL_RESPONSE_COMMAND_ID, "uus", commandId, status, message);
...
#define emberAfFillCommandVoiceOverZigbeeClusterVoiceTransmissionResponse(sequenceNumber, errorFlag)                               \
    emberAfFillExternalBuffer(                                                                                                     \
        (ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),                   \
        ZCL_VOICE_OVER_ZIGBEE_CLUSTER_ID, ZCL_VOICE_TRANSMISSION_RESPONSE_COMMAND_ID, "uu", sequenceNumber, errorFlag);
...
#define emberAfFillCommandChattingClusterSwitchChairmanResponse(cid, uid)                                                          \
    emberAfFillExternalBuffer(                                                                                                     \
        (ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),                   \
        ZCL_CHATTING_CLUSTER_ID, ZCL_SWITCH_CHAIRMAN_RESPONSE_COMMAND_ID, "vv", cid, uid);
...
#define emberAfFillCommandChattingClusterStartChatResponse(status, cid)                                                            \
    emberAfFillExternalBuffer(                                                                                                     \
        (ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),                   \
        ZCL_CHATTING_CLUSTER_ID, ZCL_START_CHAT_RESPONSE_COMMAND_ID, "uv", status, cid);
...
#define emberAfFillCommandChattingClusterJoinChatResponse(status, cid, chatParticipantList, chatParticipantListLen)                \
    emberAfFillExternalBuffer(                                                                                                     \
        (ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),                   \
        ZCL_CHATTING_CLUSTER_ID, ZCL_JOIN_CHAT_RESPONSE_COMMAND_ID, "uvb", status, cid, chatParticipantList,                       \
...
#define emberAfFillCommandChattingClusterSearchChatResponse(options, chatRoomList, chatRoomListLen)                                \
    emberAfFillExternalBuffer(                                                                                                     \
        (ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),                   \
        ZCL_CHATTING_CLUSTER_ID, ZCL_SEARCH_CHAT_RESPONSE_COMMAND_ID, "ub", options, chatRoomList, chatRoomListLen);
...
#define emberAfFillCommandChattingClusterGetNodeInformationResponse(status, cid, uid, addressEndpointAndNickname,                  \
    ...
    emberAfFillExternalBuffer(                                                                                                     \
        (ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),                   \
        ZCL_CHATTING_CLUSTER_ID, ZCL_GET_NODE_INFORMATION_RESPONSE_COMMAND_ID, "uvvb", status, cid, uid,                           \
...
#define emberAfFillCommandApplianceEventsAndAlertClusterGetAlertsResponse(alertsCount, alertStructures, alertStructuresLen)        \
    emberAfFillExternalBuffer(                                                                                                     \
        (ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),                   \
        ZCL_APPLIANCE_EVENTS_AND_ALERT_CLUSTER_ID, ZCL_GET_ALERTS_RESPONSE_COMMAND_ID, "ub", alertsCount, alertStructures,         \
        alertStructuresLen);
...
#define emberAfFillCommandApplianceStatisticsClusterLogResponse(timeStamp, logId, logLength, logPayload, logPayloadLen)            \
    emberAfFillExternalBuffer(                                                                                                     \
        (ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),                   \
        ZCL_APPLIANCE_STATISTICS_CLUSTER_ID, ZCL_LOG_RESPONSE_COMMAND_ID, "wwwb", timeStamp, logId, logLength, logPayload,         \
        logPayloadLen);
...
#define emberAfFillCommandApplianceStatisticsClusterLogQueueResponse(logQueueSize, logIds, logIdsLen)                              \
    emberAfFillExternalBuffer(                                                                                                     \
        (ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),                   \
        ZCL_APPLIANCE_STATISTICS_CLUSTER_ID, ZCL_LOG_QUEUE_RESPONSE_COMMAND_ID, "ub", logQueueSize, logIds, logIdsLen);
...
#define emberAfFillCommandElectricalMeasurementClusterGetProfileInfoResponseCommand(                                               \
    ...
    emberAfFillExternalBuffer(                                                                                                     \
        (ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),                   \
        ZCL_ELECTRICAL_MEASUREMENT_CLUSTER_ID, ZCL_GET_PROFILE_INFO_RESPONSE_COMMAND_COMMAND_ID, "uuub", profileCount,             \
        profileIntervalPeriod, maxNumberOfIntervals, listOfAttributes, listOfAttributesLen);
...
#define emberAfFillCommandElectricalMeasurementClusterGetMeasurementProfileResponseCommand(                                        \
    ...
    emberAfFillExternalBuffer(                                                                                                     \
        (ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),                   \
        ZCL_ELECTRICAL_MEASUREMENT_CLUSTER_ID, ZCL_GET_MEASUREMENT_PROFILE_RESPONSE_COMMAND_COMMAND_ID, "wuuuvb", startTime,       \
        status, profileIntervalPeriod, numberOfIntervalsDelivered, attributeId, intervals, intervalsLen);
...
#define emberAfFillCommandZllCommissioningClusterScanResponse(                                                                     \
    ...
    emberAfFillExternalBuffer(                                                                                                     \
        (ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),                   \
        ZCL_ZLL_COMMISSIONING_CLUSTER_ID, ZCL_SCAN_RESPONSE_COMMAND_ID, "wuuuvw8uuvvuuuvvuu", transaction, rssiCorrection,         \
        zigbeeInformation, zllInformation, keyBitmask, responseId, extendedPanId, networkUpdateId, logicalChannel, panId,          \
        networkAddress, numberOfSubDevices, totalGroupIds, endpointId, profileId, deviceId, version, groupIdCount);
...
#define emberAfFillCommandZllCommissioningClusterDeviceInformationResponse(                                                        \
    ...
    emberAfFillExternalBuffer(                                                                                                     \
        (ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),                   \
        ZCL_ZLL_COMMISSIONING_CLUSTER_ID, ZCL_DEVICE_INFORMATION_RESPONSE_COMMAND_ID, "wuuub", transaction, numberOfSubDevices,    \
        startIndex, deviceInformationRecordCount, deviceInformationRecordList, deviceInformationRecordListLen);
...
#define emberAfFillCommandZllCommissioningClusterNetworkStartResponse(transaction, status, extendedPanId, networkUpdateId,         \
    ...
    emberAfFillExternalBuffer(                                                                                                     \
        (ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),                   \
        ZCL_ZLL_COMMISSIONING_CLUSTER_ID, ZCL_NETWORK_START_RESPONSE_COMMAND_ID, "wu8uuv", transaction, status, extendedPanId,     \
...
#define emberAfFillCommandZllCommissioningClusterNetworkJoinRouterResponse(transaction, status)                                    \
    emberAfFillExternalBuffer(                                                                                                     \
        (ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),                   \
        ZCL_ZLL_COMMISSIONING_CLUSTER_ID, ZCL_NETWORK_JOIN_ROUTER_RESPONSE_COMMAND_ID, "wu", transaction, status);
...
#define emberAfFillCommandZllCommissioningClusterNetworkJoinEndDeviceResponse(transaction, status)                                 \
    emberAfFillExternalBuffer(                                                                                                     \
        (ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),                   \
        ZCL_ZLL_COMMISSIONING_CLUSTER_ID, ZCL_NETWORK_JOIN_END_DEVICE_RESPONSE_COMMAND_ID, "wu", transaction, status);
...
#define emberAfFillCommandZllCommissioningClusterGetGroupIdentifiersResponse(total, startIndex, count, groupInformationRecordList, \
    ...
    emberAfFillExternalBuffer(                                                                                                     \
        (ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),                   \
        ZCL_ZLL_COMMISSIONING_CLUSTER_ID, ZCL_GET_GROUP_IDENTIFIERS_RESPONSE_COMMAND_ID, "uuub", total, startIndex, count,         \
...
#define emberAfFillCommandZllCommissioningClusterGetEndpointListResponse(total, startIndex, count, endpointInformationRecordList,  \
    ...
    emberAfFillExternalBuffer(                                                                                                     \
        (ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT | ZCL_DISABLE_DEFAULT_RESPONSE_MASK),                   \
        ZCL_ZLL_COMMISSIONING_CLUSTER_ID, ZCL_GET_ENDPOINT_LIST_RESPONSE_COMMAND_ID, "uuub", total, startIndex, count,             \
