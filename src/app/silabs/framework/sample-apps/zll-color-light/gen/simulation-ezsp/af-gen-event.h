...
#define EMBER_AF_GENERATED_EVENT_CODE                                                                                              \
    ...
    void emberAfColorControlClusterServerTickCallbackWrapperFunction1(void)                                                        \
    {                                                                                                                              \
        clusterTickWrapper(&emberAfColorControlClusterServerTickCallbackControl1, emberAfColorControlClusterServerTickCallback,    \
                           1);                                                                                                     \
    }                                                                                                                              \
...
#define EMBER_AF_GENERATED_EVENT_STRINGS                                                                                           \
    "Identify Cluster Server EP 1", "On/off Cluster Server EP 1", "Level Control Cluster Server EP 1",                             \
        "Color Control Cluster Server EP 1", "Form and Join Library Plugin Cleanup", "Identify Feedback Plugin ProvideFeedback",   \
        "Interpan Plugin FragmentReceive", "Interpan Plugin FragmentTransmit", "ZLL Commissioning Network Plugin Network",         \
        "Identify event control", "ZLL Identify Server Plugin TriggerEffect EP 1",
