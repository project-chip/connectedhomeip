  ...
  if (!cmd->mfgSpecific) {
    switch (cmd->commandId) {
      ...
      case ZCL_SCHEDULE_SNAPSHOT_RESPONSE_COMMAND_ID:
      {
        ...
        wasHandled = emberAfSimpleMeteringClusterScheduleSnapshotResponseCallback(issuerEventId,
      ...
      case ZCL_TAKE_SNAPSHOT_RESPONSE_COMMAND_ID:
      {
        ...
        wasHandled = emberAfSimpleMeteringClusterTakeSnapshotResponseCallback(snapshotId,
  ...
  if (!cmd->mfgSpecific) {
    switch (cmd->commandId) {
      ...
      case ZCL_CHANGE_PAYMENT_MODE_RESPONSE_COMMAND_ID:
      {
        ...
        wasHandled = emberAfPrepaymentClusterChangePaymentModeResponseCallback(friendlyCredit,
