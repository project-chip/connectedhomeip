        ...
        { 0x0000,                                                                                                                  \
          ...
          { (uint8_t *) &(minMaxDefaults[0]) } }, /* 0 / Basic / ZCL version*/                                                     \
            ...
            { 0x0000,                                                                                                              \
              ...
              { (uint8_t *) &(minMaxDefaults[2]) } }, /* 4 / Demand Response and Load Control / utility enrollment group*/         \
            { 0x0001,                                                                                                              \
              ZCL_INT8U_ATTRIBUTE_TYPE,                                                                                            \
              1,                                                                                                                   \
              (ATTRIBUTE_MASK_WRITABLE | ATTRIBUTE_MASK_MIN_MAX | ATTRIBUTE_MASK_CLIENT),                                          \
              { (uint8_t *) &(minMaxDefaults[3]) } }, /* 5 / Demand Response and Load Control / start randomization minutes*/      \
            { 0x0002,                                                                                                              \
              ZCL_INT8U_ATTRIBUTE_TYPE,                                                                                            \
              1,                                                                                                                   \
              (ATTRIBUTE_MASK_WRITABLE | ATTRIBUTE_MASK_MIN_MAX | ATTRIBUTE_MASK_CLIENT),                                          \
              { (uint8_t *) &(minMaxDefaults[4]) } }, /* 6 / Demand Response and Load Control / duration randomization minutes*/   \
            { 0x0003,                                                                                                              \
              ZCL_INT16U_ATTRIBUTE_TYPE,                                                                                           \
              2,                                                                                                                   \
              (ATTRIBUTE_MASK_WRITABLE | ATTRIBUTE_MASK_MIN_MAX | ATTRIBUTE_MASK_CLIENT),                                          \
              { (uint8_t *) &(minMaxDefaults[5]) } }, /* 7 / Demand Response and Load Control / device class value*/               \
            {                                                                                                                      \
            ...
            { 0x0000,                                                                                                              \
              ...
              { (uint8_t *) &(minMaxDefaults[6]) } }, /* 9 / Key Establishment / key establishment suite (client)*/                \
            {                                                                                                                      \
                0xFFFD, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (ATTRIBUTE_MASK_CLIENT | ATTRIBUTE_MASK_SINGLETON), { (uint8_t *) 0x0001 }   \
            ...
            { 0x0000,                                                                                                              \
              ...
              2,                                                                                                                   \
              (ATTRIBUTE_MASK_MIN_MAX | ATTRIBUTE_MASK_SINGLETON),                                                                 \
              { (uint8_t *) &(minMaxDefaults[7]) } }, /* 11 / Key Establishment / key establishment suite (server)*/               \
            {                                                                                                                      \
                0xFFFD, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (ATTRIBUTE_MASK_SINGLETON), { (uint8_t *) 0x0001 }                           \
