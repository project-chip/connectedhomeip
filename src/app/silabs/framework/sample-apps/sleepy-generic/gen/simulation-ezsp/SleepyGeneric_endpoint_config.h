...
#define GENERATED_ATTRIBUTES {                                                                                                                                                                                                 \
    ...
    { 0x0000, ZCL_ENUM16_ATTRIBUTE_TYPE, 2, (ATTRIBUTE_MASK_MIN_MAX | ATTRIBUTE_MASK_CLIENT | ATTRIBUTE_MASK_SINGLETON), { (uint8_t*)&(minMaxDefaults[25]) } }, /* 34 / Key Establishment / key establishment suite (client)*/ \
    ...
    { 0x0000, ZCL_ENUM16_ATTRIBUTE_TYPE, 2, (ATTRIBUTE_MASK_MIN_MAX | ATTRIBUTE_MASK_SINGLETON), { (uint8_t*)&(minMaxDefaults[26]) } }, /* 36 / Key Establishment / key establishment suite (server)*/                         \
...
#define GENERATED_ENDPOINT_TYPES {                       \
    { (EmberAfCluster*)&(generatedClusters[0]), 6, 93 }, \
}
