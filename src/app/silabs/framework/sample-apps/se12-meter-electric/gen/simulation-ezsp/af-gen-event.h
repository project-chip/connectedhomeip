...
#define EMBER_AF_GENERATED_EVENT_STRINGS                                                                                           \
    "Price Cluster Client EP 1", "Simple Metering Cluster Server EP 1", "Tunneling Cluster Server EP 1",                           \
        "Device Management Cluster Client EP 1", "Events Cluster Server EP 1", "Key Establishment Cluster Server EP 1",            \
        "Button Form/Join Code Plugin Button0", "Button Form/Join Code Plugin Button1", "Form and Join Library Plugin Cleanup",    \
        "Key Establishment Plugin ApsDuplicateDetection", "Manufacturing Library CLI Plugin CheckSendComplete",                    \
