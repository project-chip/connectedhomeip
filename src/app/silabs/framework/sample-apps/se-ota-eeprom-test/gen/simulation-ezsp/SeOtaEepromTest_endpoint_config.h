...
#define GENERATED_DEFAULTS                                                                                                         \
    {                                                                                                                              \
        0xFF, 0xFF, 0xFF, 0xFE /* 0,Maximum value: Time,time */, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,                         \
            ...
            0xFF /* 12,Default value: Over the Air Bootloading,Offset (address) into the file */,                                  \
    }
#else // ! BIGENDIAN_CPU
#define GENERATED_DEFAULTS                                                                                                         \
    {                                                                                                                              \
    ...
    {                                                                                                                              \
        { 0x0000,                                                                                                                  \
          ...
          { (uint8_t *) &(minMaxDefaults[0]) } }, /* 0 / Basic / ZCL version*/                                                     \
            ...
            }, /* 9 / Over the Air Bootloading / cluster revision*/                                                                \
            {                                                                                                                      \
            ...
            {                                                                                                                      \
                0xFFFD, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (0x00), { (uint8_t *) 0x0001 }                                               \
            }, /* 12 / Demand Response and Load Control / cluster revision*/                                                       \
            ...
            { 0x0000,                                                                                                              \
              ...
              { (uint8_t *) &(minMaxDefaults[4]) } }, /* 14 / Key Establishment / key establishment suite (client)*/               \
            {                                                                                                                      \
            ...
            { 0x0000,                                                                                                              \
              ...
              2,                                                                                                                   \
              (ATTRIBUTE_MASK_MIN_MAX | ATTRIBUTE_MASK_SINGLETON),                                                                 \
              { (uint8_t *) &(minMaxDefaults[5]) } }, /* 16 / Key Establishment / key establishment suite (server)*/               \
            {                                                                                                                      \
                0xFFFD, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (ATTRIBUTE_MASK_SINGLETON), { (uint8_t *) 0x0001 }                           \
            }, /* 17 / Key Establishment / cluster revision*/                                                                      \
    }
...
#define GENERATED_CLUSTERS                                                                                                         \
    {                                                                                                                              \
        {                                                                                                                          \
            ...
            {                                                                                                                      \
                0x0019, (EmberAfAttributeMetadata *) &(generatedAttributes[10]), 1,                                                \
                2,      (CLUSTER_MASK_SERVER | CLUSTER_MASK_INIT_FUNCTION),      emberAfFuncArrayOtaBootloadClusterServer,         \
            },                                                                                                                     \
            {                                                                                                                      \
                0x0700, (EmberAfAttributeMetadata *) &(generatedAttributes[11]), 1,                                                \
            ...
            {                                                                                                                      \
                0x0703, (EmberAfAttributeMetadata *) &(generatedAttributes[13]), 1,                                                \
            ...
            {                                                                                                                      \
                0x0800,                                                                                                            \
                (EmberAfAttributeMetadata *) &(generatedAttributes[16]),                                                           \
                2,                                                                                                                 \
                0,                                                                                                                 \
