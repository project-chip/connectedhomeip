...
#define EMBER_AF_GENERATED_EVENT_STRINGS                                                                                           \
    "Time Cluster Server EP 1", "Over the Air Bootloading Cluster Client EP 1", "Over the Air Bootloading Cluster Server EP 1",    \
        "Price Cluster Server EP 1", "Key Establishment Cluster Server EP 1", "Button Form/Join Code Plugin Button0",              \
        ...
        "OTA Simple Storage EEPROM Driver Plugin PageErase", "Test Harness Plugin FlashPageHash",                                  \
