...
#define EMBER_CALLBACK_INCOMING_NETWORK_STATUS_HANDLER
#define EMBER_APPLICATION_HAS_INCOMING_NETWORK_STATUS_HANDLER
#define EMBER_CALLBACK_EZSP_INCOMING_NETWORK_STATUS_HANDLER
#define EZSP_APPLICATION_HAS_INCOMING_NETWORK_STATUS_HANDLER
...
#define EMBER_CALLBACK_EZSP_INCOMING_BOOTLOAD_MESSAGE_HANDLER
#define EZSP_APPLICATION_HAS_BOOTLOADER_HANDLER
#define EMBER_CALLBACK_EZSP_BOOTLOAD_TRANSMIT_COMPLETE_HANDLER
#define EZSP_APPLICATION_HAS_BOOTLOADER_HANDLER
#define EMBER_CALLBACK_INCOMING_BOOTLOAD_MESSAGE_HANDLER
#define EMBER_APPLICATION_HAS_BOOTLOAD_HANDLERS
#define EMBER_CALLBACK_BOOTLOAD_TRANSMIT_COMPLETE_HANDLER
#define EMBER_APPLICATION_HAS_BOOTLOAD_HANDLERS
...
#define EMBER_AF_PRINT_BITS                                                                                                        \
    {                                                                                                                              \
        0x35, 0x00, 0x04, 0x40, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00                             \
    }
...
#define EMBER_AF_PLUGIN_REPORTING_TABLE_SIZE 32
...
// Use this macro to check if Standalone Bootloader Client plugin is included
#define EMBER_AF_PLUGIN_STANDALONE_BOOTLOADER_CLIENT
// User options for plugin Standalone Bootloader Client
#define EMBER_AF_PLUGIN_STANDALONE_BOOTLOADER_CLIENT_COUNTDOWN_TIME_SECONDS 1

// Use this macro to check if Standalone Bootloader Common plugin is included
#define EMBER_AF_PLUGIN_STANDALONE_BOOTLOADER_COMMON
