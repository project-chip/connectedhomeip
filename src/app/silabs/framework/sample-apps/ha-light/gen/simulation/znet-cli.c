...
static EmberCommandEntry emberCommandPluginStandaloneBootloaderClientTable[] = {
  emberCommandEntryActionWithDetails("status", emAfStandaloneBootloaderClientPrintStatus, "", "Print the standalone bootload client's current status.", NULL),
  emberCommandEntryTerminator(),
};
static EmberCommandEntry emberCommandPluginTable[] = {
  ...
  emberCommandEntrySubMenu("standalone-bootloader-client", emberCommandPluginStandaloneBootloaderClientTable, ""),
  emberCommandEntryTerminator(),
};
