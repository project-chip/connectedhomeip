...
#define EMBER_AF_GENERATED_EVENT_CODE                                                                                              \
    ...
    void emberAfIdentifyClusterServerTickCallbackWrapperFunction6(void)                                                            \
    {                                                                                                                              \
        clusterTickWrapper(&emberAfIdentifyClusterServerTickCallbackControl6, emberAfIdentifyClusterServerTickCallback, 6);        \
    }                                                                                                                              \
    void emberAfLevelControlClusterServerTickCallbackWrapperFunction6(void)                                                        \
    {                                                                                                                              \
        clusterTickWrapper(&emberAfLevelControlClusterServerTickCallbackControl6, emberAfLevelControlClusterServerTickCallback,    \
                           6);                                                                                                     \
    }                                                                                                                              \
    void emberAfTimeClusterServerTickCallbackWrapperFunction12(void)                                                               \
    {                                                                                                                              \
        clusterTickWrapper(&emberAfTimeClusterServerTickCallbackControl12, emberAfTimeClusterServerTickCallback, 12);              \
    }
...
#define EMBER_AF_GENERATED_EVENTS                                                                                                  \
    { &emberAfIdentifyClusterServerTickCallbackControl6, emberAfIdentifyClusterServerTickCallbackWrapperFunction6 },               \
        ...
        { &emberAfPluginStandaloneBootloaderClientMyEventEventControl,                                                             \
          emberAfPluginStandaloneBootloaderClientMyEventEventHandler },

#define EMBER_AF_GENERATED_EVENT_STRINGS                                                                                           \
    "Identify Cluster Server EP 6", "Level Control Cluster Server EP 6", "Time Cluster Server EP 12",                              \
        "Button Form/Join Code Plugin Button0", "Button Form/Join Code Plugin Button1", "EZ-Mode Commissioning Plugin State",      \
        "Form and Join Library Plugin Cleanup", "Identify Feedback Plugin ProvideFeedback", "Network Find Plugin Tick",            \
        "Reporting Plugin Tick", "Standalone Bootloader Client Plugin MyEvent",
