...
EmberAfStatus emberAfPrepaymentClusterServerCommandParse(EmberAfClusterCommand * cmd)
{
    ...
    if (!cmd->mfgSpecific)
    {
        ...
        case ZCL_SELECT_AVAILABLE_EMERGENCY_CREDIT_COMMAND_ID: {
            ...
            wasHandled = emberAfPrepaymentClusterSelectAvailableEmergencyCreditCallback(commandIssueDateTime, originatingDevice);
            break;
        }
        case ZCL_CHANGE_DEBT_COMMAND_ID: {
            ...
            wasHandled                    = emberAfPrepaymentClusterChangeDebtCallback(
                issuerEventId, debtLabel, debtAmount, debtRecoveryMethod, debtAmountType, debtRecoveryStartTime,
                debtRecoveryCollectionTime, debtRecoveryFrequency, debtRecoveryAmount, debtRecoveryBalancePercentage);
            break;
        }
        case ZCL_EMERGENCY_CREDIT_SETUP_COMMAND_ID: {
            ...
            wasHandled = emberAfPrepaymentClusterEmergencyCreditSetupCallback(issuerEventId, startTime, emergencyCreditLimit,
        ...
        case ZCL_CONSUMER_TOP_UP_COMMAND_ID: {
            ...
            wasHandled = emberAfPrepaymentClusterConsumerTopUpCallback(originatingDevice, topUpCode);
            break;
        }
        case ZCL_CREDIT_ADJUSTMENT_COMMAND_ID: {
            ...
            wasHandled            = emberAfPrepaymentClusterCreditAdjustmentCallback(issuerEventId, startTime, creditAdjustmentType,
        ...
        case ZCL_CHANGE_PAYMENT_MODE_COMMAND_ID: {
            ...
            wasHandled  = emberAfPrepaymentClusterChangePaymentModeCallback(providerId, issuerEventId, implementationDateTime,
