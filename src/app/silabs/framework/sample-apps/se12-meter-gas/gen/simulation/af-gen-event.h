...
#define EMBER_AF_GENERATED_EVENT_CODE                                                                                                                                                                                                      \
  ...
  EmberEventControl emberAfPrepaymentClusterServerTickCallbackControl1;                                                                                                                                                                    \
  ...
  extern EmberEventControl emberAfPluginGbcsGasMeterSleepyMeterEventControl;                                                                                                                                                               \
  ...
  extern void emberAfPluginGbcsGasMeterSleepyMeterEventHandler(void);                                                                                                                                                                      \
  ...
  void emberAfPrepaymentClusterServerTickCallbackWrapperFunction1(void) { clusterTickWrapper(&emberAfPrepaymentClusterServerTickCallbackControl1, emberAfPrepaymentClusterServerTickCallback, 1); }                                        \
...
#define EMBER_AF_GENERATED_EVENTS                                                                                                         \
  ...
  { &emberAfPrepaymentClusterServerTickCallbackControl1, emberAfPrepaymentClusterServerTickCallbackWrapperFunction1 },                    \
  ...
  { &emberAfPluginGbcsGasMeterSleepyMeterEventControl, emberAfPluginGbcsGasMeterSleepyMeterEventHandler },                                \
...
#define EMBER_AF_GENERATED_EVENT_STRINGS                         \
  ...
  "Prepayment Cluster Server EP 1",                              \
  ...
  "GBCS Gas Smart Metering Equipment (GSME) Plugin SleepyMeter", \
...
#define EMBER_AF_GENERATED_EVENT_CONTEXT { 0x1, 0x700, true, EMBER_AF_LONG_POLL, EMBER_AF_OK_TO_SLEEP, &emberAfPriceClusterClientTickCallbackControl1 }, \
  ...
  { 0x1, 0x705, false, EMBER_AF_LONG_POLL, EMBER_AF_OK_TO_SLEEP, &emberAfPrepaymentClusterServerTickCallbackControl1 },                                  \
