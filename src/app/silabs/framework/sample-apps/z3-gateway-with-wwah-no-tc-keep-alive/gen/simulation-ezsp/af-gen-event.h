...
#define EMBER_AF_GENERATED_EVENT_STRINGS                                                                                           \
    "Identify Cluster Server EP 1", "Level Control Cluster Server EP 1", "Time Cluster Server EP 1",                               \
        ...
        "Network Creator Security Plugin OpenNetwork", "Network Steering Plugin FinishSteering", "Reporting Plugin Tick",          \
        "Scan Dispatch Plugin Scan", "Simple Clock Plugin Update", "Test Harness Plugin FlashPageHash",                            \
        "Test Harness Plugin ReadWriteAttributesTimeout", "Trust Center Network Key Update Broadcast Plugin My",                   \
        "Trust Center Network Key Update Periodic Plugin My", "Trust Center Network Key Update Unicast Plugin My",                 \
