...
bool emAfPluginGasProxyFunctionPreCommandReceivedCallback(EmberAfClusterCommand* cmd);  // Plugin: gas-proxy-function

bool emAfPreCommandReceived(EmberAfClusterCommand* cmd)
{
  return (emberAfPreCommandReceivedCallback(cmd)  /* Global */
          || emAfPluginGasProxyFunctionPreCommandReceivedCallback(cmd) /* Plugin: gas-proxy-function */);
}
