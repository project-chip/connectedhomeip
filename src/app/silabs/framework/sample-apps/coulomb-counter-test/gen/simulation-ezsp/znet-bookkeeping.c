...
void emberAfPluginCoulombCounterInit(void);  // Plugin: coulomb-counter

void emAfInit(void)
{
  emberAfMainInitCallback();  // Global
  emberAfInit();  // Global
  emberAfPluginCoulombCounterInit();  // Plugin: coulomb-counter
}

// Tick function declarations.
void emberAfMainTickCallback(void);  // Global
void emberAfTick(void);  // Global
void emberAfPluginCoulombCounterTick(void);  // Plugin: coulomb-counter

void emAfTick(void)
{
  emberAfMainTickCallback();  // Global
  emberAfTick();  // Global
  emberAfPluginCoulombCounterTick();  // Plugin: coulomb-counter
}
