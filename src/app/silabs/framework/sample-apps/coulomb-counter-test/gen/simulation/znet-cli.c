...
static EmberCommandEntry emberCommandPluginCoulombCounterTable[] = {
#if !defined(DOXYGEN_SHOULD_SKIP_THIS)
  emberCommandEntryActionWithDetails("additive-modes", emberAfPluginCoulombCounterAdditiveModesCommand, "", "Displays the current status of all additive modes.", NULL),
#endif //!defined(DOXYGEN_SHOULD_SKIP_THIS)
#if !defined(DOXYGEN_SHOULD_SKIP_THIS)
  emberCommandEntryActionWithDetails("current-core-mode", emberAfPluginCoulombCounterCurrentCoreModeCommand, "", "Displays the current core mode.", NULL),
#endif //!defined(DOXYGEN_SHOULD_SKIP_THIS)
#if !defined(DOXYGEN_SHOULD_SKIP_THIS)
  emberCommandEntryActionWithDetails("energy-usage", emberAfPluginCoulombCounterEnergyUsageCommand, "", "Displays the currently stored energy usage value.", NULL),
#endif //!defined(DOXYGEN_SHOULD_SKIP_THIS)
#if !defined(DOXYGEN_SHOULD_SKIP_THIS)
  emberCommandEntryActionWithDetails("reset-energy-usage", emberAfPluginCoulombCounterResetEnergyUsageCommand, "", "Resets the currently stored energy usage value.", NULL),
#endif //!defined(DOXYGEN_SHOULD_SKIP_THIS)
  emberCommandEntryTerminator(),
};
...
static EmberCommandEntry emberCommandPluginTable[] = {
  emberCommandEntrySubMenu("coulomb-counter", emberCommandPluginCoulombCounterTable, ""),
