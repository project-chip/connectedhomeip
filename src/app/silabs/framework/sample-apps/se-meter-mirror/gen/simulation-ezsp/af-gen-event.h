...
#define EMBER_AF_GENERATED_EVENT_CODE                                                                                              \
    ...
    void emberAfPriceClusterServerTickCallbackWrapperFunction1(void)                                                               \
    {                                                                                                                              \
        clusterTickWrapper(&emberAfPriceClusterServerTickCallbackControl1, emberAfPriceClusterServerTickCallback, 1);              \
    }                                                                                                                              \
    ...
    void emberAfSimpleMeteringClusterServerTickCallbackWrapperFunction3(void)                                                      \
    {                                                                                                                              \
        clusterTickWrapper(&emberAfSimpleMeteringClusterServerTickCallbackControl3,                                                \
                           emberAfSimpleMeteringClusterServerTickCallback, 3);                                                     \
    }                                                                                                                              \
...
#define EMBER_AF_GENERATED_EVENTS                                                                                                  \
    { &emberAfTimeClusterServerTickCallbackControl1, emberAfTimeClusterServerTickCallbackWrapperFunction1 },                       \
        ...
        { &emberAfSimpleMeteringClusterServerTickCallbackControl3,                                                                 \
          emberAfSimpleMeteringClusterServerTickCallbackWrapperFunction3 },                                                        \
...
#define EMBER_AF_GENERATED_EVENT_STRINGS                                                                                           \
    "Time Cluster Server EP 1", "Price Cluster Server EP 1", "Key Establishment Cluster Server EP 1",                              \
        "Simple Metering Cluster Server EP 3", "Key Establishment Cluster Server EP 3", "Button Form/Join Code Plugin Button0",    \
        "Button Form/Join Code Plugin Button1", "Form and Join Library Plugin Cleanup",                                            \
        "Key Establishment Plugin ApsDuplicateDetection", "Network Find Plugin Tick", "Simple Metering Server Plugin Sampling",    \
