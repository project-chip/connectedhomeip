...
#define EMBER_AF_GENERATED_EVENT_CODE                                                                                              \
    ...
    void emberAfPluginTrustCenterKeepaliveTickNetworkEventWrapper0(void)                                                           \
    {                                                                                                                              \
        networkEventWrapper(&emberAfPluginTrustCenterKeepaliveTickNetworkEventControls[0],                                         \
                            emberAfPluginTrustCenterKeepaliveTickNetworkEventHandler, 0);                                          \
    }                                                                                                                              \
    ...
    void emberAfPriceClusterClientTickCallbackWrapperFunction1(void)                                                               \
    {                                                                                                                              \
        clusterTickWrapper(&emberAfPriceClusterClientTickCallbackControl1, emberAfPriceClusterClientTickCallback, 1);              \
    }                                                                                                                              \
    ...
    void emberAfDemandResponseLoadControlClusterClientTickCallbackWrapperFunction1(void)                                           \
    {                                                                                                                              \
        clusterTickWrapper(&emberAfDemandResponseLoadControlClusterClientTickCallbackControl1,                                     \
                           emberAfDemandResponseLoadControlClusterClientTickCallback, 1);                                          \
    }                                                                                                                              \
    ...
    void emberAfMessagingClusterClientTickCallbackWrapperFunction1(void)                                                           \
    {                                                                                                                              \
        clusterTickWrapper(&emberAfMessagingClusterClientTickCallbackControl1, emberAfMessagingClusterClientTickCallback, 1);      \
    }                                                                                                                              \
    ...
    void emberAfSimpleMeteringClusterServerTickCallbackWrapperFunction2(void)                                                      \
    {                                                                                                                              \
        clusterTickWrapper(&emberAfSimpleMeteringClusterServerTickCallbackControl2,                                                \
                           emberAfSimpleMeteringClusterServerTickCallback, 2);                                                     \
    }                                                                                                                              \
    ...
    void emberAfSimpleMeteringClusterServerTickCallbackWrapperFunction4(void)                                                      \
    {                                                                                                                              \
        clusterTickWrapper(&emberAfSimpleMeteringClusterServerTickCallbackControl4,                                                \
                           emberAfSimpleMeteringClusterServerTickCallback, 4);                                                     \
    }                                                                                                                              \
    void emberAfKeyEstablishmentClusterServerTickCallbackWrapperFunction4(void)                                                    \
    {                                                                                                                              \
        clusterTickWrapper(&emberAfKeyEstablishmentClusterServerTickCallbackControl4,                                              \
                           emberAfKeyEstablishmentClusterServerTickCallback, 4);                                                   \
    }
...
#define EMBER_AF_GENERATED_EVENTS                                                                                                  \
    { &emberAfTimeClusterServerTickCallbackControl1, emberAfTimeClusterServerTickCallbackWrapperFunction1 },                       \
        ...
        { &emberAfDemandResponseLoadControlClusterClientTickCallbackControl1,                                                      \
          emberAfDemandResponseLoadControlClusterClientTickCallbackWrapperFunction1 },                                             \
        { &emberAfSimpleMeteringClusterServerTickCallbackControl1,                                                                 \
          emberAfSimpleMeteringClusterServerTickCallbackWrapperFunction1 },                                                        \
        ...
        { &emberAfSimpleMeteringClusterServerTickCallbackControl2,                                                                 \
          emberAfSimpleMeteringClusterServerTickCallbackWrapperFunction2 },                                                        \
        ...
        { &emberAfSimpleMeteringClusterServerTickCallbackControl4,                                                                 \
          emberAfSimpleMeteringClusterServerTickCallbackWrapperFunction4 },                                                        \
        { &emberAfKeyEstablishmentClusterServerTickCallbackControl4,                                                               \
          emberAfKeyEstablishmentClusterServerTickCallbackWrapperFunction4 },                                                      \
        ...
        { &emberAfPluginTrustCenterKeepaliveTickNetworkEventControls[0],                                                           \
          emberAfPluginTrustCenterKeepaliveTickNetworkEventWrapper0 },

#define EMBER_AF_GENERATED_EVENT_STRINGS                                                                                           \
    "Time Cluster Server EP 1", "Over the Air Bootloading Cluster Client EP 1", "Over the Air Bootloading Cluster Server EP 1",    \
        "Price Cluster Client EP 1", "Price Cluster Server EP 1", "Demand Response and Load Control Cluster Client EP 1",          \
        "Simple Metering Cluster Server EP 1", "Messaging Cluster Client EP 1", "Key Establishment Cluster Server EP 1",           \
        "Simple Metering Cluster Server EP 2", "Key Establishment Cluster Server EP 2", "Key Establishment Cluster Server EP 3",   \
        "Simple Metering Cluster Server EP 4", "Key Establishment Cluster Server EP 4", "Button Form/Join Code Plugin Button0",    \
        "Button Form/Join Code Plugin Button1", "Form and Join Library Plugin Cleanup", "Interpan Plugin FragmentReceive",         \
        "Interpan Plugin FragmentTransmit", "Key Establishment Plugin ApsDuplicateDetection", "Network Find Plugin Tick",          \
        "Simple Clock Plugin Update", "Simple Metering Server Plugin Sampling", "Simple Metering Server Plugin Supply",            \
        "Test Harness Plugin FlashPageHash", "Test Harness Plugin ReadWriteAttributesTimeout",                                     \
        "Trust Center Network Key Update Broadcast Plugin My", "Trust Center Network Key Update Periodic Plugin My",               \
        "Trust Center Network Key Update Unicast Plugin My", "Partner Link Key Exchange Plugin Timeout NWK 0",                     \
        "Smart Energy Registration Plugin Tick NWK 0", "Trust Center Keepalive Plugin Tick NWK 0",
