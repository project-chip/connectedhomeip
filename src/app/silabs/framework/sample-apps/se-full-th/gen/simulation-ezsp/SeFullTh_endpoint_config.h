    ...
    {                                                                                                                              \
        { 0x0000, ZCL_INT8U_ATTRIBUTE_TYPE, 1, (ATTRIBUTE_MASK_SINGLETON), { (uint8_t *) 0x03 } }, /* 0 / Basic / ZCL version*/    \
            ...
            { 0x0000,                                                                                                              \
              ...
              { (uint8_t *) &(minMaxDefaults[2]) } }, /* 19 / Demand Response and Load Control / utility enrollment group*/        \
            { 0x0001,                                                                                                              \
              ZCL_INT8U_ATTRIBUTE_TYPE,                                                                                            \
              1,                                                                                                                   \
              (ATTRIBUTE_MASK_WRITABLE | ATTRIBUTE_MASK_MIN_MAX | ATTRIBUTE_MASK_CLIENT),                                          \
              { (uint8_t *) &(minMaxDefaults[3]) } }, /* 20 / Demand Response and Load Control / start randomization minutes*/     \
            { 0x0002,                                                                                                              \
              ZCL_INT8U_ATTRIBUTE_TYPE,                                                                                            \
              1,                                                                                                                   \
              (ATTRIBUTE_MASK_WRITABLE | ATTRIBUTE_MASK_MIN_MAX | ATTRIBUTE_MASK_CLIENT),                                          \
              { (uint8_t *) &(minMaxDefaults[4]) } }, /* 21 / Demand Response and Load Control / duration randomization minutes*/  \
            { 0x0003,                                                                                                              \
              ZCL_INT16U_ATTRIBUTE_TYPE,                                                                                           \
              2,                                                                                                                   \
              (ATTRIBUTE_MASK_WRITABLE | ATTRIBUTE_MASK_MIN_MAX | ATTRIBUTE_MASK_CLIENT),                                          \
              { (uint8_t *) &(minMaxDefaults[5]) } }, /* 22 / Demand Response and Load Control / device class value*/              \
            {                                                                                                                      \
                0xFFFD, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (ATTRIBUTE_MASK_CLIENT), { (uint8_t *) 0x0001 }                              \
            }, /* 23 / Demand Response and Load Control / cluster revision*/                                                       \
            {                                                                                                                      \
                0xFFFD, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (0x00), { (uint8_t *) 0x0001 }                                               \
            }, /* 24 / Demand Response and Load Control / cluster revision*/                                                       \
            {                                                                                                                      \
                0xFFFD, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (ATTRIBUTE_MASK_CLIENT), { (uint8_t *) 0x0001 }                              \
            }, /* 25 / Simple Metering / cluster revision*/                                                                        \
            {                                                                                                                      \
                0x0000, ZCL_INT48U_ATTRIBUTE_TYPE, 6, (ATTRIBUTE_MASK_MIN_MAX), { (uint8_t *) &(minMaxDefaults[6]) }               \
            }, /* 26 / Simple Metering / current summation delivered*/                                                             \
            {                                                                                                                      \
                0x0200, ZCL_BITMAP8_ATTRIBUTE_TYPE, 1, (ATTRIBUTE_MASK_MIN_MAX), { (uint8_t *) &(minMaxDefaults[7]) }              \
            }, /* 27 / Simple Metering / status*/                                                                                  \
            {                                                                                                                      \
                0x0300, ZCL_ENUM8_ATTRIBUTE_TYPE, 1, (ATTRIBUTE_MASK_MIN_MAX), { (uint8_t *) &(minMaxDefaults[8]) }                \
            }, /* 28 / Simple Metering / unit of measure*/                                                                         \
            {                                                                                                                      \
                0x0303, ZCL_BITMAP8_ATTRIBUTE_TYPE, 1, (ATTRIBUTE_MASK_MIN_MAX), { (uint8_t *) &(minMaxDefaults[9]) }              \
            }, /* 29 / Simple Metering / summation formatting*/                                                                    \
            {                                                                                                                      \
                0x0306, ZCL_BITMAP8_ATTRIBUTE_TYPE, 1, (ATTRIBUTE_MASK_MIN_MAX), { (uint8_t *) &(minMaxDefaults[10]) }             \
            }, /* 30 / Simple Metering / metering device type*/                                                                    \
            ...
            { 0x0000,                                                                                                              \
              ...
              { (uint8_t *) &(minMaxDefaults[11]) } }, /* 34 / Key Establishment / key establishment suite (client)*/              \
            {                                                                                                                      \
            ...
            { 0x0000,                                                                                                              \
              ...
              { (uint8_t *) &(minMaxDefaults[12]) } }, /* 36 / Key Establishment / key establishment suite (server)*/              \
            {                                                                                                                      \
                0xFFFD, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (ATTRIBUTE_MASK_SINGLETON), { (uint8_t *) 0x0001 }                           \
...
#define GENERATED_CLUSTERS                                                                                                           \
    {                                                                                                                                \
        {                                                                                                                            \
            ...
            {                                                                                                                        \
                0x0019, (EmberAfAttributeMetadata *) &(generatedAttributes[13]), 1,                                                  \
            ...
            {                                                                                                                        \
                0x0700, (EmberAfAttributeMetadata *) &(generatedAttributes[17]), 1,                                                  \
            ...
            {                                                                                                                        \
                0x0702, (EmberAfAttributeMetadata *) &(generatedAttributes[25]),        1,                                           \
...
#define GENERATED_ENDPOINT_TYPES                                                                                                   \
    {                                                                                                                              \
        { (EmberAfCluster *) &(generatedClusters[0]), 14, 54 }, { (EmberAfCluster *) &(generatedClusters[14]), 4, 12 },            \
