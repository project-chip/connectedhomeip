...
#define EMBER_AF_NETWORK_INDEX_SLEEPY_END_DEVICE (0)
#define EMBER_AF_NETWORK_INDEX_COORDINATOR (1)
#define EMBER_AF_DEFAULT_NETWORK_INDEX EMBER_AF_NETWORK_INDEX_SLEEPY_END_DEVICE
