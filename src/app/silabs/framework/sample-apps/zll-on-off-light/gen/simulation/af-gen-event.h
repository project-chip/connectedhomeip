...
#define EMBER_AF_GENERATED_EVENT_STRINGS                                                                                           \
    "Identify Cluster Server EP 1", "On/off Cluster Server EP 1", "Level Control Cluster Server EP 1",                             \
        "Form and Join Library Plugin Cleanup", "Identify Feedback Plugin ProvideFeedback", "Interpan Plugin FragmentReceive",     \
        "Interpan Plugin FragmentTransmit", "ZLL Commissioning Network Plugin Network", "Identify event control",                  \
