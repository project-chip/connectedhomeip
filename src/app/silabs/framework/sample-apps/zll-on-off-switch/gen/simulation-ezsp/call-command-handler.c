...
EmberAfStatus emberAfZllCommissioningClusterClientCommandParse(EmberAfClusterCommand * cmd)
{
    ...
    if (!cmd->mfgSpecific)
    {
        ...
        case ZCL_ENDPOINT_INFORMATION_COMMAND_ID: {
            ...
            wasHandled = emberAfZllCommissioningClusterEndpointInformationCallback(ieeeAddress, networkAddress, endpointId,
        ...
        case ZCL_GET_GROUP_IDENTIFIERS_RESPONSE_COMMAND_ID: {
            ...
            wasHandled                 = emberAfZllCommissioningClusterGetGroupIdentifiersResponseCallback(total, startIndex, count,
        ...
        case ZCL_GET_ENDPOINT_LIST_RESPONSE_COMMAND_ID: {
            ...
            wasHandled                    = emberAfZllCommissioningClusterGetEndpointListResponseCallback(total, startIndex, count,
