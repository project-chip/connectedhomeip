...
#define EMBER_AF_GENERATED_EVENT_STRINGS                                                                                           \
    "Form and Join Library Plugin Cleanup", "Interpan Plugin FragmentReceive", "Interpan Plugin FragmentTransmit",                 \
        "Network Creator Security Plugin OpenNetwork", "Network Steering Plugin FinishSteering", "Scan Dispatch Plugin Scan",      \
        "Update TC Link Key Plugin BeginTcLinkKeyUpdate", "ZLL Commissioning Client Plugin TouchLink",                             \
        "ZLL Commissioning Network Plugin Network", "Identify event control",
