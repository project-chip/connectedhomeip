...
#define EMBER_AF_GENERATED_EVENT_STRINGS                                                                                           \
    "Identify Cluster Server EP 1", "Button Form/Join Code Plugin Button0", "Button Form/Join Code Plugin Button1",                \
        "EZ-Mode Commissioning Plugin State", "Form and Join Library Plugin Cleanup", "Identify Feedback Plugin ProvideFeedback",  \
