...
public:
    /**
     *  @brief Initialize the parser object with TLVReader and ContainerType
     *
     *  @param [in] aReader A pointer to a TLVReader, which should be on the element of the array element
     ...
     *  @return #CHIP_NO_ERROR on success
     */
    CHIP_ERROR Init(chip::TLV::TLVWriter * const apWriter, chip::TLV::TLVType aOuterContainerType);
