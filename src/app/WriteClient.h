 ...
 *  Consumer can allocate one write client, then call PrepareAttribute followed by FinishAttribute for every attribute
 *  it want to insert in write request, then call SendWriteRequest
 *
 */
