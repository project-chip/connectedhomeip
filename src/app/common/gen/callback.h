 ...
 */
bool emberAfIdentifyClusterUpdateCommissionStateCallback(
       chip::app::CommandHandler * commandObj
 ...
 */
bool emberAfGroupsClusterAddGroupResponseCallback(
       chip::app::CommandSender * commandObj
 ...
 */
bool emberAfScenesClusterAddSceneCallback(
       chip::app::CommandHandler * commandObj
 ...
 */
bool emberAfScenesClusterRemoveSceneCallback(
       chip::app::CommandHandler * commandObj
       , uint16_t groupId, uint8_t sceneId);
/**
 ...
 */
bool emberAfScenesClusterStoreSceneCallback(
       chip::app::CommandHandler * commandObj
       , uint16_t groupId, uint8_t sceneId);
/**
 ...
 */
bool emberAfScenesClusterRecallSceneCallback(
       chip::app::CommandHandler * commandObj
 ...
 */
bool emberAfAlarmsClusterGetAlarmResponseCallback(
       chip::app::CommandSender * commandObj
 ...
 */
bool emberAfAlarmsClusterGetAlarmCallback(
       chip::app::CommandHandler * commandObj
       );
/**
 ...
 */
bool emberAfPollControlClusterCheckInCallback(
       chip::app::CommandSender * commandObj
       );
/**
 ...
 */
bool emberAfBasicClusterStartUpCallback(
       chip::app::CommandSender * commandObj
       );
/**
 ...
 */
bool emberAfBasicClusterShutDownCallback(
       chip::app::CommandSender * commandObj
       );
/**
 * @brief  Cluster Leave Command callback (from server)
 */
bool emberAfBasicClusterLeaveCallback(
       chip::app::CommandSender * commandObj
       );
/**
...
bool emberAfOtaSoftwareUpdateProviderClusterQueryImageCallback(
       chip::app::CommandHandler * commandObj
       , uint16_t vendorId, uint16_t productId, uint16_t imageType, uint16_t hardwareVersion, uint32_t currentVersion, /* TYPE WARNING: array array defaults to */ uint8_t *  protocolsSupported, uint8_t * location, uint8_t requestorCanConsent, chip::ByteSpan metadataForProvider);
/**
...
bool emberAfOtaSoftwareUpdateProviderClusterQueryImageResponseCallback(
       chip::app::CommandSender * commandObj
       , uint8_t status, uint32_t delayedActionTime, uint8_t * imageURI, uint32_t softwareVersion, chip::ByteSpan updateToken, uint8_t userConsentNeeded, chip::ByteSpan metadataForRequestor);
/**
 ...
 */
bool emberAfOperationalCredentialsClusterSetFabricCallback(
       chip::app::CommandHandler * commandObj
       , uint16_t VendorId);
/**
 * @brief  Cluster SetFabricResponse Command callback (from server)
 */
bool emberAfOperationalCredentialsClusterSetFabricResponseCallback(
       chip::app::CommandSender * commandObj
...
bool emberAfOperationalCredentialsClusterOpCSRResponseCallback(
       chip::app::CommandSender * commandObj
       , chip::ByteSpan CSR, chip::ByteSpan CSRNonce, chip::ByteSpan VendorReserved1, chip::ByteSpan VendorReserved2, chip::ByteSpan VendorReserved3, chip::ByteSpan Signature);
/**
 * @brief  Cluster AddOpCert Command callback (from client)
 */
bool emberAfOperationalCredentialsClusterAddOpCertCallback(
       chip::app::CommandHandler * commandObj
 ...
 * @brief  Cluster Toggle Command callback (from client)
 */
bool emberAfDoorLockClusterToggleCallback(
       chip::app::CommandHandler * commandObj
       , uint8_t * pin);
/**
 * @brief  Cluster ToggleResponse Command callback (from server)
 */
bool emberAfDoorLockClusterToggleResponseCallback(
       chip::app::CommandSender * commandObj
       , uint8_t status);
/**
 ...
 */
bool emberAfDoorLockClusterSetPinResponseCallback(
       chip::app::CommandSender * commandObj
       , uint8_t status);
/**
 ...
 */
bool emberAfDoorLockClusterGetPinResponseCallback(
       chip::app::CommandSender * commandObj
       , uint16_t userId, uint8_t userStatus, uint8_t userType, uint8_t * pin);
/**
 * @brief  Cluster ClearPin Command callback (from client)
 */
bool emberAfDoorLockClusterClearPinCallback(
       chip::app::CommandHandler * commandObj
       , uint16_t userId);
/**
 ...
 */
bool emberAfDoorLockClusterSetRfidCallback(
       chip::app::CommandHandler * commandObj
 ...
 */
bool emberAfDoorLockClusterClearRfidCallback(
       chip::app::CommandHandler * commandObj
       , uint16_t userId);
/**
 ...
 */
bool emberAfIasAceClusterEmergencyCallback(
       chip::app::CommandHandler * commandObj
       );
/**
 ...
 */
bool emberAfIasAceClusterFireCallback(
       chip::app::CommandHandler * commandObj
       );
/**
 ...
 */
bool emberAfIasAceClusterPanicCallback(
       chip::app::CommandHandler * commandObj
       );
/**
...
bool emberAfIasAceClusterGetZoneStatusResponseCallback(
       chip::app::CommandSender * commandObj
       , uint8_t zoneStatusComplete, uint8_t numberOfZones, /* TYPE WARNING: array array defaults to */ uint8_t *  zoneStatusResult);
/**
 * @brief  Cluster GetZoneStatus Command callback (from client)
 */
bool emberAfIasAceClusterGetZoneStatusCallback(
       chip::app::CommandHandler * commandObj
       , uint8_t startingZoneId, uint8_t maxNumberOfZoneIds, uint8_t zoneStatusMaskFlag, uint16_t zoneStatusMask);
/**
 * @brief  Cluster StartWarning Command callback (from client)
 */
bool emberAfIasWdClusterStartWarningCallback(
       chip::app::CommandHandler * commandObj
 ...
 */
bool emberAfIasWdClusterSquawkCallback(
       chip::app::CommandHandler * commandObj
       , uint8_t squawkInfo);
/**
 ...
 */
bool emberAfTestClusterClusterTestCallback(
       chip::app::CommandHandler * commandObj
       );
/**
 ...
 */
bool emberAfMessagingClusterCancelMessageCallback(
       chip::app::CommandSender * commandObj
 ...
 */
bool emberAfBindingClusterBindCallback(
       chip::app::CommandHandler * commandObj
 ...
 */
bool emberAfBindingClusterUnbindCallback(
       chip::app::CommandHandler * commandObj
       , chip::NodeId nodeId, chip::GroupId groupId, chip::EndpointId endpointId, chip::ClusterId clusterId);
/**
