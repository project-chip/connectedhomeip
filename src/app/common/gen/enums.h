...
// Enum for NOCResponseStatus
enum EmberAfNOCResponseStatus : uint8_t
{
    EMBER_ZCL_NOC_RESPONSE_STATUS_SUCCESS                = 0,
    EMBER_ZCL_NOC_RESPONSE_STATUS_INVALID_PUBLIC_KEY     = 1,
    EMBER_ZCL_NOC_RESPONSE_STATUS_INVALID_NODE_OP_ID     = 2,
    EMBER_ZCL_NOC_RESPONSE_STATUS_INVALID_NOC            = 3,
    EMBER_ZCL_NOC_RESPONSE_STATUS_MISSING_CSR            = 4,
    EMBER_ZCL_NOC_RESPONSE_STATUS_TABLE_FULL             = 5,
    EMBER_ZCL_NOC_RESPONSE_STATUS_MISSING_ACL            = 6,
    EMBER_ZCL_NOC_RESPONSE_STATUS_MISSING_IPK            = 7,
    EMBER_ZCL_NOC_RESPONSE_STATUS_INSUFFICIENT_PRIVILEGE = 8,
    EMBER_ZCL_NOC_RESPONSE_STATUS_FABRIC_CONFLICT        = 9,
    EMBER_ZCL_NOC_RESPONSE_STATUS_LABEL_CONFLICT         = 10,
    EMBER_ZCL_NOC_RESPONSE_STATUS_INVALID_FABRIC_INDEX   = 11,
};
