...
// Enum for MediaPlaybackRequest
enum EmberAfMediaPlaybackRequest : uint8_t
{
    EMBER_ZCL_MEDIA_PLAYBACK_REQUEST_PLAY          = 0,
    EMBER_ZCL_MEDIA_PLAYBACK_REQUEST_PAUSE         = 1,
    EMBER_ZCL_MEDIA_PLAYBACK_REQUEST_STOP          = 2,
    EMBER_ZCL_MEDIA_PLAYBACK_REQUEST_START_OVER    = 3,
    EMBER_ZCL_MEDIA_PLAYBACK_REQUEST_PREVIOUS      = 4,
    EMBER_ZCL_MEDIA_PLAYBACK_REQUEST_NEXT          = 5,
    EMBER_ZCL_MEDIA_PLAYBACK_REQUEST_REWIND        = 6,
    EMBER_ZCL_MEDIA_PLAYBACK_REQUEST_FAST_FORWARD  = 7,
    EMBER_ZCL_MEDIA_PLAYBACK_REQUEST_SKIP_FORWARD  = 8,
    EMBER_ZCL_MEDIA_PLAYBACK_REQUEST_SKIP_BACKWARD = 9,
    EMBER_ZCL_MEDIA_PLAYBACK_REQUEST_SEEK          = 10,
};
