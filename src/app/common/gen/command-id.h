...
#define ZCL_CERT_CHAIN_REQUEST_COMMAND_ID (0x02)
#define ZCL_CERT_CHAIN_RESPONSE_COMMAND_ID (0x03)
...
#define ZCL_ATTESTATION_REQUEST_COMMAND_ID (0x0C)
#define ZCL_ATTESTATION_RESPONSE_COMMAND_ID (0x0D)
