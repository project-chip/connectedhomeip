 ...
 */
#define emberAfFillCommandAdministratorCommissioningClusterOpenCommissioningWindow( \
  ...
  emberAfFillExternalBuffer( \
    mask, \
     \
    ZCL_OPEN_COMMISSIONING_WINDOW_COMMAND_ID, \
    "uuuuuu", \
    CommissioningTimeout, \
    PAKEVerifier, \
    Discriminator, \
 ...
 * @param CommissioningTimeout INT16U 
 */
#define emberAfFillCommandAdministratorCommissioningClusterOpenBasicCommissioningWindow( \
  CommissioningTimeout \
) \
  emberAfFillExternalBuffer( \
    mask, \
     \
    ZCL_OPEN_BASIC_COMMISSIONING_WINDOW_COMMAND_ID, \
    "u", \
    CommissioningTimeout \
  );
 ...
 */
#define emberAfFillCommandOperational CredentialsClusterAddNOC( \
  NOCArray, \
  IPKValue, \
  CaseAdminNode, \
  AdminVendorId \
 ...
 * @param NOCArray OCTET_STRING 
 */
#define emberAfFillCommandOperational CredentialsClusterUpdateNOC( \
  NOCArray \
) \
  emberAfFillExternalBuffer( \
    mask, \
     \
    ZCL_UPDATE_NOC_COMMAND_ID, \
    "u", \
    NOCArray \
  );
 ...
 */
#define emberAfFillCommandOperational CredentialsClusterNOCResponse( \
  StatusCode, \
  FabricIndex, \
  DebugText \
) \
 ...
 * @param returnValue INT8U 
 */
#define emberAfFillCommandTest ClusterClusterTestAddArgumentsResponse( \
  returnValue \
) \
  emberAfFillExternalBuffer( \
    mask, \
     \
    ZCL_TEST_ADD_ARGUMENTS_RESPONSE_COMMAND_ID, \
    "u", \
    returnValue \
  );
 ...
 * @param arg2 INT8U 
 */
#define emberAfFillCommandTest ClusterClusterTestAddArguments( \
  arg1, \
  arg2 \
) \
  emberAfFillExternalBuffer( \
    mask, \
     \
    ZCL_TEST_ADD_ARGUMENTS_COMMAND_ID, \
    "uu", \
    arg1, \
    arg2 \
  );
