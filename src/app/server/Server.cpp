...
#if CHIP_DEVICE_CONFIG_ENABLE_DNSSD && !CHIP_DEVICE_LAYER_TARGET_ESP32 && !CHIP_DEVICE_LAYER_TARGET_MBED && (!CHIP_DEVICE_LAYER_TARGET_AMBD || !CHIP_DEVICE_CONFIG_ENABLE_CHIPOBLE)
