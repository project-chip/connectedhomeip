...
CHIP_ERROR JointFabricDatastorage::AddGroupKeySetEntry(uint16_t groupKeySetId)
{
    ...
    Clusters::JointFabricDatastore::Structs::DatastoreGroupKeySetStruct::Type entry;
...
CHIP_ERROR
JointFabricDatastorage::AddGroupKeySetEntry(Clusters::JointFabricDatastore::Structs::DatastoreGroupKeySetStruct::Type & groupKeySet)
{
...
CHIP_ERROR
JointFabricDatastorage::UpdateGroupKeySetEntry(
    Clusters::JointFabricDatastore::Structs::DatastoreGroupKeySetStruct::Type & groupKeySet)
{
    for (auto & entry : mGroupKeySetList)
    {
        ...
        {
            bool field_updated = memcmp(&entry, &groupKeySet,
                                        sizeof(Clusters::JointFabricDatastore::Structs::DatastoreGroupKeySetStruct::Type)) == 0;
            entry              = groupKeySet;
...
CHIP_ERROR
JointFabricDatastorage::AddAdmin(
