...
#include <app/util/attribute-storage.h> // Needed for AttributeAccessInterfaceRegistry::Instance().RegisterAttributeAccessOverride
...
{
    AttributeAccessInterfaceRegistry::Instance().RegisterAttributeAccessOverride(&gEnergyPrefAttrAccess);
}
