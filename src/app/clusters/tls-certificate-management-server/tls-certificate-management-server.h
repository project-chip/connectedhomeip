...
private:
    ...
    CHIP_ERROR EncodeProvisionedRootCertificates(EndpointId matterEndpoint, FabricIndex fabric,
                                                 ...
                                                 Tls::CertificateTable::BufferedRootCert & buffer);
    ...
    CHIP_ERROR EncodeProvisionedClientCertificates(EndpointId matterEndpoint, FabricIndex fabric,
                                                   const AttributeValueEncoder::ListEncodeHelper & encoder,
                                                   Tls::CertificateTable::BufferedClientCert & buffer);
};
...
public:
    ...
    using LoadedRootCertificateType   = std::function<CHIP_ERROR(Tls::CertificateTable::BufferedRootCert & certBuffer)>;
    using LoadedClientCertificateType = std::function<CHIP_ERROR(Tls::CertificateTable::BufferedClientCert & certBuffer)>;
    ...
    /**
     * @brief Allocates memory for a root certificate to be loaded into, then executes loadedCallback
     *
     * @param[in] loadedCallback lambda to execute with allocated memory for root certificate loading
     */
    virtual CHIP_ERROR LoadedRootCert(LoadedRootCertificateType loadedCallback) const = 0;
    ...
    virtual Protocols::InteractionModel::Status LookupRootCert(EndpointId matterEndpoint, FabricIndex fabric,
                                                               ...
                                                               LoadedRootCertificateType & loadedCallback) const = 0;
    ...
    /**
     * @brief Allocates memory for a client certificate to be loaded into, then executes loadedCallback
     *
     * @param[in] loadedCallback lambda to execute with allocated memory for client certificate loading
     */
    virtual CHIP_ERROR LoadedClientCert(LoadedClientCertificateType loadedCallback) const = 0;
    ...
    virtual Protocols::InteractionModel::Status LookupClientCert(EndpointId matterEndpoint, FabricIndex fabric,
                                                                 const ByteSpan fingerprint,
                                                                 LoadedClientCertificateType & loadedCallback) const = 0;
