...
CHIP_ERROR TlsCertificateManagementServer::Read(const ConcreteReadAttributePath & aPath, AttributeValueEncoder & aEncoder)
{
    ...
    case ProvisionedRootCertificates::Id: {
        ...
        return aEncoder.EncodeList([this, matterEndpoint, fabric](const auto & encoder) -> CHIP_ERROR {
            return mDelegate.LoadedRootCert([this, matterEndpoint, fabric, &encoder](auto & certBuffer) -> CHIP_ERROR {
                return EncodeProvisionedRootCertificates(matterEndpoint, fabric, encoder, certBuffer);
            });
        });
    }
    ...
    case ProvisionedClientCertificates::Id: {
        ...
        auto fabric         = aEncoder.AccessingFabricIndex();
        return aEncoder.EncodeList([this, matterEndpoint, fabric](const auto & encoder) -> CHIP_ERROR {
            return mDelegate.LoadedClientCert([this, matterEndpoint, fabric, &encoder](auto & certBuffer) -> CHIP_ERROR {
                return EncodeProvisionedClientCertificates(matterEndpoint, fabric, encoder, certBuffer);
            });
        });
    }
...
TlsCertificateManagementServer::EncodeProvisionedRootCertificates(EndpointId matterEndpoint, FabricIndex fabric,
                                                                  ...
                                                                  CertificateTable::BufferedRootCert & buffer)
{
    mCertificateTable.SetEndpoint(matterEndpoint);
    return mCertificateTable.IterateRootEntries(fabric, buffer, [&encoder, &buffer](auto & iterator) -> CHIP_ERROR {
        while (iterator.Next(buffer.mCert))
        {
            ReturnErrorOnFailure(encoder.Encode(buffer.mCert));
        }
        return CHIP_NO_ERROR;
    });
}
...
TlsCertificateManagementServer::EncodeProvisionedClientCertificates(EndpointId matterEndpoint, FabricIndex fabric,
                                                                    const AttributeValueEncoder::ListEncodeHelper & encoder,
                                                                    CertificateTable::BufferedClientCert & buffer)
{
    mCertificateTable.SetEndpoint(matterEndpoint);
    return mCertificateTable.IterateClientEntries(fabric, buffer, [&encoder, &buffer](auto & iterator) -> CHIP_ERROR {
        while (iterator.Next(buffer.mCert))
        {
            ReturnErrorOnFailure(encoder.Encode(buffer.mCert));
        }
...
void TlsCertificateManagementServer::InvokeCommand(HandlerContext & ctx)
{
    ...
    case Commands::ProvisionRootCertificate::Id:
        CommandHandlerInterface::HandleCommand<Commands::ProvisionRootCertificate::DecodableType>(
    ...
    case Commands::FindRootCertificate::Id:
        CommandHandlerInterface::HandleCommand<Commands::FindRootCertificate::DecodableType>(
    ...
    case Commands::LookupRootCertificate::Id:
        CommandHandlerInterface::HandleCommand<Commands::LookupRootCertificate::DecodableType>(
    ...
    case Commands::RemoveRootCertificate::Id:
        CommandHandlerInterface::HandleCommand<Commands::RemoveRootCertificate::DecodableType>(
    ...
    case Commands::ProvisionClientCertificate::Id:
        CommandHandlerInterface::HandleCommand<Commands::ProvisionClientCertificate::DecodableType>(
    ...
    case Commands::FindClientCertificate::Id:
        CommandHandlerInterface::HandleCommand<Commands::FindClientCertificate::DecodableType>(
    ...
    case Commands::LookupClientCertificate::Id:
        CommandHandlerInterface::HandleCommand<Commands::LookupClientCertificate::DecodableType>(
    ...
    case Commands::RemoveClientCertificate::Id:
        CommandHandlerInterface::HandleCommand<Commands::RemoveClientCertificate::DecodableType>(
...
void TlsCertificateManagementServer::HandleProvisionRootCertificate(HandlerContext & ctx,
                                                                    const Commands::ProvisionRootCertificate::DecodableType & req)
{
    ...
    Commands::ProvisionRootCertificateResponse::Type response;
...
void TlsCertificateManagementServer::HandleFindRootCertificate(HandlerContext & ctx,
                                                               const Commands::FindRootCertificate::DecodableType & req)
{
...
void TlsCertificateManagementServer::HandleLookupRootCertificate(HandlerContext & ctx,
                                                                 const Commands::LookupRootCertificate::DecodableType & req)
{
...
void TlsCertificateManagementServer::HandleRemoveRootCertificate(HandlerContext & ctx,
                                                                 const Commands::RemoveRootCertificate::DecodableType & req)
{
    ChipLogDetail(Zcl, "TlsCertificateManagement: RemoveRootCertificate");
}

void TlsCertificateManagementServer::HandleProvisionClientCertificate(
    HandlerContext & ctx, const Commands::ProvisionClientCertificate::DecodableType & req)
{
...
void TlsCertificateManagementServer::HandleFindClientCertificate(HandlerContext & ctx,
                                                                 const Commands::FindClientCertificate::DecodableType & req)
{
...
void TlsCertificateManagementServer::HandleLookupClientCertificate(HandlerContext & ctx,
                                                                   const Commands::LookupClientCertificate::DecodableType & req)
{
...
void TlsCertificateManagementServer::HandleRemoveClientCertificate(HandlerContext & ctx,
                                                                   const Commands::RemoveClientCertificate::DecodableType & req)
{
    ChipLogDetail(Zcl, "TlsCertificateManagement: RemoveRootCertificate");
}
