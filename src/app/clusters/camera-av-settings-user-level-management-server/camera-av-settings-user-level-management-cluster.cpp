...
CHIP_ERROR CameraAvSettingsUserLevelMgmtServer::AcceptedCommands(const ConcreteClusterPath & path,
...
CHIP_ERROR CameraAvSettingsUserLevelMgmtServer::Startup(ServerClusterContext & context)
{
...
CHIP_ERROR CameraAvSettingsUserLevelMgmtServer::ReadAndEncodeMPTZPresets(AttributeValueEncoder & aEncoder)
{
    return aEncoder.EncodeList([this](const auto & encoder) -> CHIP_ERROR {
        for (const auto & mptzPresets : mLogic.mMptzPresetHelpers)
        {
            ...
            ChipLogDetail(Zcl, "CameraAVSettingsUserLevelMgmt[ep=%d]: Encoding an instance of MPTZPresetStruct. Name = %s",
                                                                                                ...
                                                                                                CommandHandler * handler)
{
     ...
     * Management cluster.
     */
    void CameraAvSettingsUserLevelMgmtServer::AddMoveCapableVideoStream(uint16_t aVideoStreamID, Globals::Structs::ViewportStruct::Type aViewport)
    {
     ...
     */
    void CameraAvSettingsUserLevelMgmtServer::UpdateMoveCapableVideoStream(uint16_t aVideoStreamID, Globals::Structs::ViewportStruct::Type aViewport)
    {
