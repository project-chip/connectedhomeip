...
CHIP_ERROR CodegenCameraAvSettingsUserLevelManagementCluster::Startup(ServerClusterContext & context)
{
    ...
    {
        LogErrorOnFailure(CameraAvSettingsUserLevelManagement::MigrateCameraAvSettingsUserLevelManagementServerStorage(
            mPath.mEndpointId, *srcProvider, context.attributeStorage));
    }

    return CameraAvSettingsUserLevelManagementCluster::Startup(context);
}
