...
public:
     ...
     * @param zoom The validated value of the zoom that is to be set
     */
    virtual Status MPTZRelativeMove(Optional<int16_t> aPan, Optional<int16_t> aTilt, Optional<int8_t> aZoom) = 0;

    virtual Status MPTZMoveToPreset(uint8_t aPreset, Optional<int16_t> aPan, Optional<int16_t> aTilt, Optional<int8_t> aZoom) = 0;
    virtual Status MPTZSavePreset(uint8_t aPreset)                                                                            = 0;
    virtual Status MPTZRemovePreset(uint8_t aPreset)                                                                          = 0;
    virtual Status DPTZSetViewport(uint16_t aVideoStreamID, Structs::ViewportStruct::Type aViewport)                          = 0;
    virtual Status DPTZRelativeMove(uint16_t aVideoStreamID, Optional<int16_t> aDeltaX, Optional<int16_t> aDeltaY,
