...
bool IsWithinRange(const int64_t power, const uint32_t duration,
                   const CommissioningProxy::Structs::PowerAdjustCapabilityStruct::Type & powerAdjustmentCapability)
{
...
DataModel::ActionReturnStatus ValidateESAState(const DataModel::InvokeRequest & request, CommandHandler * handler,
                                               ...
                                               CommissioningProxy::ESAStateEnum expectedState)
{
    CommissioningProxy::ESAStateEnum currentState = delegate.GetESAState();
...
using namespace CommissioningProxy;
                                                                                      ...
                                                                                      CommandHandler * handler)
{
    ...
    // ConcreteCommandPath path = request.path;
...
CommissioningProxyCluster::CheckOptOutAllowsRequest(CommissioningProxy::AdjustmentCauseEnum adjustmentCause)
{
...
DataModel::ActionReturnStatus CommissioningProxyCluster::HandlePowerAdjustRequest(const DataModel::InvokeRequest & request,
                                                                                      TLV::TLVReader & input_arguments,
                                                                                      CommandHandler * handler)
{
    using namespace Commands;
...
DataModel::ActionReturnStatus
CommissioningProxyCluster::HandleCancelPowerAdjustRequest(const DataModel::InvokeRequest & request,
...
DataModel::ActionReturnStatus CommissioningProxyCluster::HandleStartTimeAdjustRequest(const DataModel::InvokeRequest & request,
                                                                                          TLV::TLVReader & input_arguments,
                                                                                          CommandHandler * handler)
{
    using namespace Commands;
...
DataModel::ActionReturnStatus CommissioningProxyCluster::HandlePauseRequest(const DataModel::InvokeRequest & request,
                                                                                TLV::TLVReader & input_arguments,
                                                                                CommandHandler * handler)
{
    using namespace Commands;
...
DataModel::ActionReturnStatus CommissioningProxyCluster::HandleResumeRequest(const DataModel::InvokeRequest & request,
                                                                                 TLV::TLVReader & input_arguments,
                                                                                 CommandHandler * handler)
{
    using namespace Commands;
...
DataModel::ActionReturnStatus CommissioningProxyCluster::HandleModifyForecastRequest(const DataModel::InvokeRequest & request,
                                                                                         TLV::TLVReader & input_arguments,
                                                                                         CommandHandler * handler)
{
    using namespace Commands;
...
DataModel::ActionReturnStatus
CommissioningProxyCluster::HandleRequestConstraintBasedForecast(const DataModel::InvokeRequest & request,
                                                                    TLV::TLVReader & input_arguments, CommandHandler * handler)
{
    using namespace Commands;
...
DataModel::ActionReturnStatus CommissioningProxyCluster::HandleCancelRequest(const DataModel::InvokeRequest & request,
                                                                                 TLV::TLVReader & input_arguments,
                                                                                 CommandHandler * handler)
{
    using namespace Commands;
