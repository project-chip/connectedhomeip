...
// that reason we use std contains to simplify implementation of the cluster.
#include <map>
#include <memory>
#include <string>
#include <utility>
...
private:
    EcosystemLocationStruct(HomeLocationStruct aHomeLocation, uint64_t aHomeLocationLastEditEpochUs) :
