...
static void startColorLoop(EndpointId endpoint, uint8_t startFromStartHue)
{
    ...
    {
        colorHueTransitionState.finalEnhancedHue = startHue - 1;
    }
    else
    {
        colorHueTransitionState.finalEnhancedHue = startHue + 1;
    ...
    colorHueTransitionState.stepsRemaining = time * TRANSITION_TIME_1S;
    colorHueTransitionState.stepsTotal     = time * TRANSITION_TIME_1S;
    colorHueTransitionState.endpoint       = endpoint;
    ...
    if (updateFlags & EMBER_AF_COLOR_LOOP_UPDATE_FLAGS_UPDATE_DIRECTION)
    {
        ...
        if (isColorLoopActive && !deactiveColorLoop)
        {
            ...
            if (direction == COLOR_LOOP_DIRECTION_INCREMENT)
            {
                ...
                colorHueTransitionState.finalEnhancedHue = colorHueTransitionState.initialEnhancedHue - 1;
            }
            else
            {
