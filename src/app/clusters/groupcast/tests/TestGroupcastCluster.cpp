...
struct GroupcastClusterTest : public ::testing::Test
{
...
TEST_F(GroupcastClusterTest, TestAttributes)
{
    // Attributes
    {
...
TEST_F(GroupcastClusterTest, TestAcceptedCommands)
{
...
TEST_F(GroupcastClusterTest, TestReadUsedMcastAddrCount)
{
    const uint8_t key[] = { 0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0A, 0x0B, 0x0C, 0x0D, 0x0E, 0x0F };
...
TEST_F(GroupcastClusterTest, TestJoinGroupCommand)
{
    const uint8_t key[] = { 0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0A, 0x0B, 0x0C, 0x0D, 0x0E, 0x0F };
...
TEST_F(GroupcastClusterTest, TestUpdateGroupKey)
{
...
TEST_F(GroupcastClusterTest, TestConfigureAuxiliaryACL)
{
    const uint8_t key[] = { 0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0A, 0x0B, 0x0C, 0x0D, 0x0E, 0x0F };
    const EndpointId kEndpoints[] = { 1 };
