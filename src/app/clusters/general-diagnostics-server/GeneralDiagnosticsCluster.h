    ...
    namespace Clusters {
        ...
        public:
            ...
            GeneralDiagnosticsCluster(OptionalAttributeSet optionalAttributeSet, BitFlags<GeneralDiagnostics::Feature> featureFlags,
                DeviceLoadStatusProvider * deviceLoadStatusProvider, TestEventTriggerDelegate * testEventTriggerDelegate)
        ...
        public:
            GeneralDiagnosticsClusterFullConfigurable(const GeneralDiagnosticsCluster::OptionalAttributeSet & optionalAttributeSet,
                ...
                : GeneralDiagnosticsCluster(optionalAttributeSet, featureFlags, deviceLoadStatusProvider, testEventTriggerDelegate)
