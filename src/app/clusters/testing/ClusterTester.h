...
namespace Test {
    ...
    public:
        ...
        void InvokeOperation(EndpointId endpoint, ClusterId cluster, CommandId command, std::unique_ptr<chip::app::Testing::MockCommandHandler> handler)
        {
        ...
        std::optional<app::DataModel::ActionReturnStatus> Invoke(ClusterType & cluster, const RequestType & request)
        {
