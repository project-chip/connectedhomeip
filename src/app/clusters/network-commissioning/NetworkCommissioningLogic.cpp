...
CHIP_ERROR NetworkCommissioningLogic::EnumerateAcceptedCommands(const ConcreteClusterPath & cluster, CommandIdCallback callback, void * context)
{
...
CHIP_ERROR NetworkCommissioningLogic::EnumerateGeneratedCommands(const ConcreteClusterPath & cluster, CommandIdCallback callback, void * context)
{
    using namespace Clusters::NetworkCommissioning::Commands;
...
void NetworkCommissioningLogic::InvokeCommand(HandlerContext & ctxt)
{
...
CHIP_ERROR NetworkCommissioningLogic::Read(const ConcreteReadAttributePath & aPath, AttributeValueEncoder & aEncoder)
{
...
CHIP_ERROR NetworkCommissioningLogic::Write(const ConcreteDataAttributePath & aPath, AttributeValueDecoder & aDecoder)
{
    switch (aPath.mAttributeId)
    {
    case Attributes::InterfaceEnabled::Id:
