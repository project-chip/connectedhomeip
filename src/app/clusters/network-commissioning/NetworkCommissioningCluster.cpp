...
NetworkCommissioningCluster::NetworkInstanceList NetworkCommissioningCluster::sInstances;
#endif
...
#if !CHIP_DEVICE_CONFIG_SUPPORTS_CONCURRENT_CONNECTION
void NetworkCommissioningCluster::SendNonConcurrentConnectNetworkResponse()
{
...
void NetworkCommissioningCluster::SetLastConnectErrorValue(Attributes::LastConnectErrorValue::TypeInfo::Type connectErrorValue)
{
...
void NetworkCommissioningCluster::SetLastNetworkId(ByteSpan lastNetworkId)
{
...
std::optional<ActionReturnStatus> NetworkCommissioningCluster::HandleScanNetworks(CommandHandler & handler,
...
NetworkCommissioningCluster::HandleAddOrUpdateWiFiNetwork(CommandHandler & handler, const ConcreteCommandPath & commandPath,
...
std::optional<ActionReturnStatus>
NetworkCommissioningCluster::HandleAddOrUpdateThreadNetwork(CommandHandler & handler, const ConcreteCommandPath & commandPath,
...
std::optional<ActionReturnStatus>
NetworkCommissioningCluster::HandleRemoveNetwork(CommandHandler & handler, const ConcreteCommandPath & commandPath,
...
std::optional<ActionReturnStatus>
NetworkCommissioningCluster::HandleConnectNetwork(CommandHandler & handler, const ConcreteCommandPath & commandPath,
...
#if CHIP_DEVICE_CONFIG_ENABLE_WIFI_PDC
std::optional<ActionReturnStatus>
NetworkCommissioningCluster::HandleQueryIdentity(CommandHandler & handler, const ConcreteCommandPath & commandPath,
...
#if CHIP_DEVICE_CONFIG_SUPPORTS_CONCURRENT_CONNECTION
void NetworkCommissioningCluster::DisconnectLingeringConnection()
{
...
void NetworkCommissioningCluster::OnFinished(Status status, CharSpan debugText, ThreadScanResponseIterator * networks)
{
...
void NetworkCommissioningCluster::OnFinished(Status status, CharSpan debugText, WiFiScanResponseIterator * networks)
{
    DEFER_AUTO_RELEASE(networks);
...
void NetworkCommissioningCluster::OnPlatformEventHandler(const DeviceLayer::ChipDeviceEvent * event, intptr_t arg)
{
    auto this_ = reinterpret_cast<NetworkCommissioningCluster *>(arg);
...
CHIP_ERROR NetworkCommissioningCluster::EncodeNetworks(AttributeValueEncoder & listEncoder) const
{
...
CHIP_ERROR NetworkCommissioningCluster::EncodeSupportedWiFiBands(AttributeValueEncoder & listEncoder) const
{
#if (CHIP_DEVICE_CONFIG_ENABLE_WIFI_STATION || CHIP_DEVICE_CONFIG_ENABLE_WIFI_AP)
    if (mFeatureFlags.Has(Feature::kWiFiNetworkInterface))
    {
                                                                         ...
                                                                         AttributeValueEncoder & encoder)
{
    ...
    case MaxNetworks::Id:
        return encoder.Encode(GetMaxNetworks());
    case ScanMaxTimeSeconds::Id:
        return encoder.Encode(GetScanNetworkTimeoutSeconds());
    case ConnectMaxTimeSeconds::Id:
        return encoder.Encode(GetConnectNetworkTimeoutSeconds());
    case InterfaceEnabled::Id:
        return encoder.Encode(GetInterfaceEnabled());
    case LastNetworkingStatus::Id:
        return encoder.Encode(GetLastNetworkingStatus());
    case LastNetworkID::Id:
        if (GetLastNetworkID().empty())
        {
            return encoder.EncodeNull();
        }
        return encoder.Encode(GetLastNetworkID());
    case LastConnectErrorValue::Id:
        return encoder.Encode(GetLastConnectErrorValue());
    case Networks::Id:
        return EncodeNetworks(encoder);
#if (CHIP_DEVICE_CONFIG_ENABLE_WIFI_STATION || CHIP_DEVICE_CONFIG_ENABLE_WIFI_AP)
    case SupportedWiFiBands::Id:
        return EncodeSupportedWiFiBands(encoder);
#endif // (CHIP_DEVICE_CONFIG_ENABLE_WIFI_STATION || CHIP_DEVICE_CONFIG_ENABLE_WIFI_AP)
#if CHIP_DEVICE_CONFIG_ENABLE_THREAD
    case SupportedThreadFeatures::Id:
        return encoder.Encode(GetThreadCapabilities());
    case ThreadVersion::Id:
        VerifyOrReturnError(Features().Has(NetworkCommissioning::Feature::kThreadNetworkInterface),
                            Protocols::InteractionModel::Status::UnsupportedAttribute);
        return encoder.Encode(GetThreadVersion());
                                                                                        ...
                                                                                        CommandHandler * handler)
{
    ...
    VerifyOrReturnError(!IsProcessingAsyncCommand(), Protocols::InteractionModel::Status::Busy);
    ...
    case ScanNetworks::Id: {
        ...
        return HandleScanNetworks(*handler, request.path, request_data);
    }
    case RemoveNetwork::Id: {
        RemoveNetwork::DecodableType request_data;
        ReturnErrorOnFailure(request_data.Decode(input_arguments));
        return HandleRemoveNetwork(*handler, request.path, request_data);
    }
    case ConnectNetwork::Id: {
        ConnectNetwork::DecodableType request_data;
        ReturnErrorOnFailure(request_data.Decode(input_arguments));
        return HandleConnectNetwork(*handler, request.path, request_data);
    }
    case ReorderNetwork::Id: {
        ReorderNetwork::DecodableType request_data;
        ReturnErrorOnFailure(request_data.Decode(input_arguments));
        return HandleReorderNetwork(*handler, request.path, request_data);
    }
    ...
    case AddOrUpdateWiFiNetwork::Id: {
        ...
        ReturnErrorOnFailure(request_data.Decode(input_arguments));
        return HandleAddOrUpdateWiFiNetwork(*handler, request.path, request_data);
    }
#endif // (CHIP_DEVICE_CONFIG_ENABLE_WIFI_STATION || CHIP_DEVICE_CONFIG_ENABLE_WIFI_AP)
#if CHIP_DEVICE_CONFIG_ENABLE_THREAD
    case AddOrUpdateThreadNetwork::Id: {
        ...
        ReturnErrorOnFailure(request_data.Decode(input_arguments));
        return HandleAddOrUpdateThreadNetwork(*handler, request.path, request_data);
    }
#endif // CHIP_DEVICE_CONFIG_ENABLE_THREAD
#if CHIP_DEVICE_CONFIG_ENABLE_WIFI_PDC
    case QueryIdentity::Id: {
        ...
        ReturnErrorOnFailure(request_data.Decode(input_arguments));
        return HandleQueryIdentity(*handler, request.path, request_data);
    }
#endif
    default:
        return Protocols::InteractionModel::Status::UnsupportedCommand;
...
#if CHIP_DEVICE_CONFIG_ENABLE_THREAD
    if (Features().Has(Feature::kThreadNetworkInterface))
    {
                                                          ...
                                                          ReadOnlyBufferBuilder<CommandId> & builder)
{
    ...
    if (Features().HasAny(Feature::kWiFiNetworkInterface, Feature::kThreadNetworkInterface))
    {
        ReturnErrorOnFailure(builder.AppendElements({
