...
/**
 * ServiceArea::MemoryDelegate Defines methods for implementing target/application-specific
 * logic for managing the memory of some Service Area cluster attributes.
 */
class MemoryDelegate
{
public:
    MemoryDelegate()          = default;
    virtual ~MemoryDelegate() = default;
