...
public:
    ...
    virtual void HandleStateTransition(OTAUpdateStateEnum currentUpdateState, OTAUpdateStateEnum newState,
                                       OTAChangeReasonEnum reason, CHIP_ERROR error = CHIP_NO_ERROR) = 0;
