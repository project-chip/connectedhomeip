...
public:
    ...
    CHIP_ERROR virtual OnPreparedForDownload() = 0;
    ...
    void SetImageProcessorDelegate(OTAImageProcessorDriver * delegate) { mImageProcessor = delegate; }
...
protected:
    OTAImageProcessorDriver * mImageProcessor;
    State mState;
};
