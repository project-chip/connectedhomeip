...
public:
    ...
    CHIP_ERROR RemoveEndpoint(FabricIndex, GroupId, EndpointId, bool) override { return CHIP_NO_ERROR; }
    CHIP_ERROR RemoveEndpointAllGroups(FabricIndex, EndpointId, bool) override { return CHIP_NO_ERROR; }
