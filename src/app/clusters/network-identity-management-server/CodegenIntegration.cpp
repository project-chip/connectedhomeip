...
#include <app/clusters/network-identity-management-server/CodegenIntegration.h>
#include <app/util/af-types.h>

using namespace chip;

void MatterNetworkIdentityManagementClusterInitCallback(EndpointId endpointId) {}
void MatterNetworkIdentityManagementClusterShutdownCallback(EndpointId endpointId, MatterClusterShutdownType shutdownType) {}
