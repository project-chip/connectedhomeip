...
struct TestNIMCluster : public ::testing::Test
{
    ...
    TestNIMCluster() : cluster(kTestEndpointId, storage, keystore, authenticatorDriver), tester(cluster) {}
...
TEST_F(TestNIMCluster, AttributeListTest)
{
...
TEST_F(TestNIMCluster, ReadGlobalAttributes)
{
    uint16_t revision{};
...
TEST_F(TestNIMCluster, InitialState)
{
...
TEST_F(TestNIMCluster, ImportAndExportAdminSecret)
{
...
TEST_F(TestNIMCluster, ImportAdminSecretRequiresCASE)
{
...
TEST_F(TestNIMCluster, ImportAdminSecretTimestampValidation)
{
...
TEST_F(TestNIMCluster, ImportAdminSecretInvalidNASS)
{
...
TEST_F(TestNIMCluster, ImportAdminSecretRetiringAndCapacity)
{
...
TEST_F(TestNIMCluster, ImportAdminSecretHandleCleanupOnRetirementFailure)
{
...
TEST_F(TestNIMCluster, ExportAdminSecretRequiresCASE)
{
    // Set auth mode to PASE — should return UNSUPPORTED_ACCESS
    Access::SubjectDescriptor paseDescriptor{
        .fabricIndex = 1,
...
TEST_F(TestNIMCluster, ExportAdminSecretNoSecret)
{
...
TEST_F(TestNIMCluster, QueryIdentityByIndex)
{
...
TEST_F(TestNIMCluster, QueryIdentityByIndexNotFound)
{
...
TEST_F(TestNIMCluster, QueryIdentityByType)
{
...
TEST_F(TestNIMCluster, QueryIdentityClientByIdentifier)
{
    auto identity = GenerateClientIdentity();
...
TEST_F(TestNIMCluster, QueryIdentityByNIIdentifier)
{
    auto importResult = ImportNASS(kRawSecretA, System::Clock::Seconds32(100));
    ASSERT_TRUE(importResult.IsSuccess());
...
TEST_F(TestNIMCluster, QueryIdentityMultipleFieldsRejected)
{
...
TEST_F(TestNIMCluster, QueryIdentityNoFieldsRejected)
{
...
TEST_F(TestNIMCluster, AddClientBasic)
{
    auto identity = GenerateClientIdentity();
...
TEST_F(TestNIMCluster, AddClientIdempotent)
{
    auto identity = GenerateClientIdentity();
...
TEST_F(TestNIMCluster, AddMultipleClients)
{
...
TEST_F(TestNIMCluster, AddClientInvalidIdentity)
{
    const uint8_t garbage[] = { 0xFF, 0xFF, 0xFF };
    Commands::AddClient::Type request;
...
TEST_F(TestNIMCluster, AddClientResourceExhausted)
{
...
TEST_F(TestNIMCluster, RemoveClientByIndex)
{
    auto identity = GenerateClientIdentity();
...
TEST_F(TestNIMCluster, RemoveClientByIdentifier)
{
    auto identity = GenerateClientIdentity();
...
TEST_F(TestNIMCluster, RemoveClientNotFound)
{
    Commands::RemoveClient::Type removeRequest;
...
TEST_F(TestNIMCluster, RemoveClientByIdentifierNotFound)
{
...
TEST_F(TestNIMCluster, RemoveClientInvalidCommand)
{
...
TEST_F(TestNIMCluster, RemoveClientIdentifierWrongSize)
{
...
TEST_F(TestNIMCluster, ClientNIReferenceAndNotifications)
{
...
TEST_F(TestNIMCluster, ReadClientsMultiple)
{
    auto identity1 = GenerateClientIdentity();
    auto identity2 = GenerateClientIdentity();
...
TEST_F(TestNIMCluster, AuthenticatorDriverStartupAndShutdown)
{
...
TEST_F(TestNIMCluster, ImportAdminSecretNotifiesAD)
{
...
TEST_F(TestNIMCluster, ImportAdminSecretRetirementNotifiesAD)
{
    // Import 2 NIs so the first becomes non-current and retirable
    ASSERT_TRUE(ImportNASS(kRawSecretA, System::Clock::Seconds32(1000)).IsSuccess());
    ASSERT_TRUE(ImportNASS(kRawSecretB, System::Clock::Seconds32(2000)).IsSuccess());
...
TEST_F(TestNIMCluster, AddClientNotifiesAD)
{
    auto identity = GenerateClientIdentity();
...
TEST_F(TestNIMCluster, AddClientIdempotentDoesNotNotifyAD)
{
    auto identity = GenerateClientIdentity();
...
TEST_F(TestNIMCluster, RemoveClientNotifiesAD)
{
    auto identity = GenerateClientIdentity();
...
TEST_F(TestNIMCluster, OnClientAuthenticatedUpdatesNIReference)
{
...
TEST_F(TestNIMCluster, OnClientAuthenticatedNonCurrentNINotifies)
{
...
TEST_F(TestNIMCluster, PrepareNetworkIdentityAdditionRejectsImport)
{
...
TEST_F(TestNIMCluster, PrepareNetworkIdentityAdditionRejectsImportAfterExistingNASS)
{
...
TEST_F(TestNIMCluster, PrepareClientAdditionRejectsAddClient)
{
