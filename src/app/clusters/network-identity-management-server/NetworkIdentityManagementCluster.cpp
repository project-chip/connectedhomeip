...
#include <app/clusters/network-identity-management-server/LoggingUtils.h>
                                                      ...
                                                      CommandHandler * handler)
{
    ...
    ByteSpan identity; // will point into identityBuf (not entry)
    ...
    if (commandData.networkIdentityIndex.HasValue())
    {
        ...
        identity = entry.compactIdentity;
    }
