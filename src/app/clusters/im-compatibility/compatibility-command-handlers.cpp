...
{
    Compatibility::SetupEmberAfObjects(command, ZCL_BARRIER_CONTROL_CLUSTER_ID, ZCL_BARRIER_CONTROL_GO_TO_PERCENT_COMMAND_ID, ZCLEndpointId);
...
void OnBindCommandCallback(app::Command* command, EndpointId ZCLEndpointId, chip::NodeId nodeId, chip::GroupId groupId, chip::EndpointId endpointId, chip::ClusterId clusterId)
{
...
void OnUnbindCommandCallback(app::Command* command, EndpointId ZCLEndpointId, chip::NodeId nodeId, chip::GroupId groupId, chip::EndpointId endpointId, chip::ClusterId clusterId)
{
...
void OnMoveColorCommandCallback(app::Command* command, EndpointId ZCLEndpointId, int16_t rateX, int16_t rateY, uint8_t optionsMask, uint8_t optionsOverride)
{
...
void OnMoveColorTemperatureCommandCallback(app::Command* command, EndpointId ZCLEndpointId, uint8_t moveMode, uint16_t rate, uint16_t colorTemperatureMinimum, uint16_t colorTemperatureMaximum, uint8_t optionsMask, uint8_t optionsOverride)
{
...
void OnMoveHueCommandCallback(app::Command* command, EndpointId ZCLEndpointId, uint8_t moveMode, uint8_t rate, uint8_t optionsMask, uint8_t optionsOverride)
{
...
void OnMoveSaturationCommandCallback(app::Command* command, EndpointId ZCLEndpointId, uint8_t moveMode, uint8_t rate, uint8_t optionsMask, uint8_t optionsOverride)
{
...
void OnMoveToColorCommandCallback(app::Command* command, EndpointId ZCLEndpointId, uint16_t colorX, uint16_t colorY, uint16_t transitionTime, uint8_t optionsMask, uint8_t optionsOverride)
{
...
void OnMoveToColorTemperatureCommandCallback(app::Command* command, EndpointId ZCLEndpointId, uint16_t colorTemperature, uint16_t transitionTime, uint8_t optionsMask, uint8_t optionsOverride)
{
    Compatibility::SetupEmberAfObjects(command, ZCL_COLOR_CONTROL_CLUSTER_ID, ZCL_MOVE_TO_COLOR_TEMPERATURE_COMMAND_ID, ZCLEndpointId);
...
void OnMoveToHueCommandCallback(app::Command* command, EndpointId ZCLEndpointId, uint8_t hue, uint8_t direction, uint16_t transitionTime, uint8_t optionsMask, uint8_t optionsOverride)
{
...
void OnMoveToHueAndSaturationCommandCallback(app::Command* command, EndpointId ZCLEndpointId, uint8_t hue, uint8_t saturation, uint16_t transitionTime, uint8_t optionsMask, uint8_t optionsOverride)
{
    Compatibility::SetupEmberAfObjects(command, ZCL_COLOR_CONTROL_CLUSTER_ID, ZCL_MOVE_TO_HUE_AND_SATURATION_COMMAND_ID, ZCLEndpointId);
...
void OnMoveToSaturationCommandCallback(app::Command* command, EndpointId ZCLEndpointId, uint8_t saturation, uint16_t transitionTime, uint8_t optionsMask, uint8_t optionsOverride)
{
...
void OnStepColorCommandCallback(app::Command* command, EndpointId ZCLEndpointId, int16_t stepX, int16_t stepY, uint16_t transitionTime, uint8_t optionsMask, uint8_t optionsOverride)
{
...
void OnStepColorTemperatureCommandCallback(app::Command* command, EndpointId ZCLEndpointId, uint8_t stepMode, uint16_t stepSize, uint16_t transitionTime, uint16_t colorTemperatureMinimum, uint16_t colorTemperatureMaximum, uint8_t optionsMask, uint8_t optionsOverride)
{
...
void OnStepHueCommandCallback(app::Command* command, EndpointId ZCLEndpointId, uint8_t stepMode, uint8_t stepSize, uint8_t transitionTime, uint8_t optionsMask, uint8_t optionsOverride)
{
...
void OnStepSaturationCommandCallback(app::Command* command, EndpointId ZCLEndpointId, uint8_t stepMode, uint8_t stepSize, uint8_t transitionTime, uint8_t optionsMask, uint8_t optionsOverride)
{
...
void OnSetHolidayScheduleCommandCallback(app::Command* command, EndpointId ZCLEndpointId, uint8_t scheduleId, uint32_t localStartTime, uint32_t localEndTime, uint8_t operatingModeDuringHoliday)
{
...
void OnSetPinCommandCallback(app::Command* command, EndpointId ZCLEndpointId, uint16_t userId, uint8_t userStatus, uint8_t userType, const uint8_t * pin)
{
...
void OnSetRfidCommandCallback(app::Command* command, EndpointId ZCLEndpointId, uint16_t userId, uint8_t userStatus, uint8_t userType, const uint8_t * id)
{
...
void OnSetWeekdayScheduleCommandCallback(app::Command* command, EndpointId ZCLEndpointId, uint8_t scheduleId, uint16_t userId, uint8_t daysMask, uint8_t startHour, uint8_t startMinute, uint8_t endHour, uint8_t endMinute)
{
...
void OnSetYeardayScheduleCommandCallback(app::Command* command, EndpointId ZCLEndpointId, uint8_t scheduleId, uint16_t userId, uint32_t localStartTime, uint32_t localEndTime)
{
...
void OnUnlockWithTimeoutCommandCallback(app::Command* command, EndpointId ZCLEndpointId, uint16_t timeoutInSeconds, const uint8_t * pin)
{
...
void OnAddGroupIfIdentifyingCommandCallback(app::Command* command, EndpointId ZCLEndpointId, uint16_t groupId, const uint8_t * groupName)
{
...
void OnGetGroupMembershipCommandCallback(app::Command* command, EndpointId ZCLEndpointId, uint8_t groupCount, /* TYPE WARNING: array array defaults to */ uint8_t *  groupList)
{
...
void OnZoneEnrollResponseCommandCallback(app::Command* command, EndpointId ZCLEndpointId, uint8_t enrollResponseCode, uint8_t zoneId)
{
...
void OnMoveCommandCallback(app::Command* command, EndpointId ZCLEndpointId, uint8_t moveMode, uint8_t rate, uint8_t optionMask, uint8_t optionOverride)
{
...
void OnMoveToLevelCommandCallback(app::Command* command, EndpointId ZCLEndpointId, uint8_t level, uint16_t transitionTime, uint8_t optionMask, uint8_t optionOverride)
{
...
{
    Compatibility::SetupEmberAfObjects(command, ZCL_LEVEL_CONTROL_CLUSTER_ID, ZCL_MOVE_TO_LEVEL_WITH_ON_OFF_COMMAND_ID, ZCLEndpointId);
...
void OnStepCommandCallback(app::Command* command, EndpointId ZCLEndpointId, uint8_t stepMode, uint8_t stepSize, uint16_t transitionTime, uint8_t optionMask, uint8_t optionOverride)
{
...
void OnStepWithOnOffCommandCallback(app::Command* command, EndpointId ZCLEndpointId, uint8_t stepMode, uint8_t stepSize, uint16_t transitionTime)
{
...
void OnAddSceneCommandCallback(app::Command* command, EndpointId ZCLEndpointId, uint16_t groupId, uint8_t sceneId, uint16_t transitionTime, const uint8_t * sceneName, /* TYPE WARNING: array array defaults to */ uint8_t *  extensionFieldSets)
{
...
void OnRecallSceneCommandCallback(app::Command* command, EndpointId ZCLEndpointId, uint16_t groupId, uint8_t sceneId, uint16_t transitionTime)
{
