...
bool emberAfIasZoneClusterZoneStatusChangeNotificationCallback(chip::app::Command * apCommandObj, uint16_t zoneStatus,
...
bool emberAfIasZoneClusterZoneEnrollRequestCallback(chip::app::Command * apCommandObj, uint16_t zoneType, uint16_t manufacturerCode)
{
