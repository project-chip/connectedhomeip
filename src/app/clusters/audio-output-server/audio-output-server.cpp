...
bool emberAfAudioOutputClusterRenameOutputCallback(chip::app::Command * command, uint8_t index, uint8_t * name)
{
...
bool emberAfAudioOutputClusterSelectOutputCallback(chip::app::Command * command, uint8_t index)
{
