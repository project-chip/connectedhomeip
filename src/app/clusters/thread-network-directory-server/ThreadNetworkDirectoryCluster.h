...
public:
    ...
    // entry, the same set AddNetwork checks, and must be newer than a stored
    // entry for that network by Active Timestamp, the same rule AddNetwork
    // enforces; recording the stored dataset again is a no-op.
