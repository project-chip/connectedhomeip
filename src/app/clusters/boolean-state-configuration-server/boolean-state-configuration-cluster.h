...
public:
    ...
    CHIP_ERROR SetAlarmsActive(chip::BitMask<BooleanStateConfiguration::AlarmModeBitmap> alarms)
    {
        return CHIP_ERROR_NOT_IMPLEMENTED;
    }
    CHIP_ERROR SetAllEnabledAlarmsActive() { return CHIP_ERROR_NOT_IMPLEMENTED; }
    CHIP_ERROR ClearAllAlarms() { return CHIP_ERROR_NOT_IMPLEMENTED; }
    CHIP_ERROR SuppressAlarms(chip::BitMask<BooleanStateConfiguration::AlarmModeBitmap> alarms)
    {
        return CHIP_ERROR_NOT_IMPLEMENTED;
    }
    CHIP_ERROR SetCurrentSensitivityLevel(uint8_t level) { return CHIP_ERROR_NOT_IMPLEMENTED; }
    CHIP_ERROR EmitSensorFault(chip::BitMask<BooleanStateConfiguration::SensorFaultBitmap> fault)
    {
        return CHIP_ERROR_NOT_IMPLEMENTED;
    }
