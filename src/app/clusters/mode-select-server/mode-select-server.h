...
const uint32_t AliasedClusters[6] = {0x50, 0x51, 0x52, 0x54, 0x55, 0x59};

class Instance : public CommandHandlerInterface, public AttributeAccessInterface
{

public:
    static std::map<uint32_t, Instance*> OnOffEnabledInstanceMap;
...
public:
    ...
    ~Instance() override
    {
        OnOffEnabledInstanceMap.erase(clusterId);
    }
