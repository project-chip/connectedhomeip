...
static constexpr std::array<ClusterId, 12> AliasedClusters = { HEPA_FILTER_CLUSTER_ID, ACTIVATED_CARBON_FILTER_CLUSTER_ID };
...
{
    using Type =
        chip::app::DataModel::List<const ReplacementProductStruct::Type>;
