...
public:
    ...
    {
        TLV::TLVType outer;
        ReturnErrorOnFailure(writer.StartContainer(TLV::ContextTag(to_underlying(chip::app::CommandDataIB::Tag::kData)),
                                                   TLV::kTLVType_Structure, outer));
        ReturnErrorOnFailure(chip::app::DataModel::Encode(
            writer, TLV::ContextTag(to_underlying(Groups::Commands::GetGroupMembershipResponse::Fields::kCapacity)), 0xff));
        {
            TLV::TLVType type;
            ReturnErrorOnFailure(writer.StartContainer(
                TLV::ContextTag(to_underlying(Groups::Commands::GetGroupMembershipResponse::Fields::kGroupList)),
