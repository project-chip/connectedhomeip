...
CHIP_ERROR ScheduleStructWithOwnedMembers::SetTransitions(const DataModel::List<const Structs::ScheduleTransitionStruct::Type> & newTransitions)
{
    ...
    else
    {
        ...
        transitions = DataModel::List<const Structs::ScheduleTransitionStruct::Type>(scheduleTransitionData, scheduleTransitionSize);
    }
