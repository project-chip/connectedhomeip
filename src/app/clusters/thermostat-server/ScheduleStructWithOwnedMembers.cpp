...
ScheduleStructWithOwnedMembers::ScheduleStructWithOwnedMembers(ScheduleStructWithOwnedMembers && other) :
    ScheduleStructWithOwnedMembers(static_cast<const ScheduleStruct::Type &>(other))
{}
...
ScheduleStructWithOwnedMembers & ScheduleStructWithOwnedMembers::operator=(ScheduleStructWithOwnedMembers && other)
{
    if (this == &other)
    {
        return *this;
