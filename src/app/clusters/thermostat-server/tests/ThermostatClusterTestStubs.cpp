...
/**
 * @file
 * Stub implementations of ZAP-generated Thermostat attribute accessors used by ThermostatCluster.cpp
 * and Setpoints.cpp but absent from the generic unit test environment.
 */
