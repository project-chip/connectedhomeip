...
using ICECandidateDecodableStruct = chip::app::Clusters::detail::Structs::ICECandidateStruct::DecodableType;
namespace {
                                                               ...
                                                               const Commands::ProvideICECandidates::DecodableType & req)
{
    ...
    std::vector<ICECandidateDecodableStruct> candidates;
    auto iter = req.ICECandidates.begin();
    while (iter.Next())
    {
        // Get current candidate.
        const ICECandidateDecodableStruct & candidate = iter.GetValue();
