...
public:
     ...
     *
     */
    CameraAVStreamMgmtServer(CameraAVStreamMgmtDelegate & aDelegate, EndpointId aEndpointId, BitFlags<Feature> aFeature,
                             BitFlags<OptionalAttribute> aOptionalAttr, PersistentStorageDelegate & aPersistentStorage,
...
private:
    ...
    BitFlags<Feature> mFeature;
    BitFlags<OptionalAttribute> mOptionalAttrs;
