...
function isWeaklyTypedEnum(label)
{
  return [
    ...
    "ActionTypeEnum",
    "AlertCountType",
    "AlertStructureCategory",
    "AlertStructurePresenceRecovery",
    ...
    "MessagingControlEnhancedConfirmation",
    "MessagingControlImportance",
    "MessagingControlTransmission",
    "MeterTypeId",
    "MoveMode",
    "NavigateTargetStatus",
