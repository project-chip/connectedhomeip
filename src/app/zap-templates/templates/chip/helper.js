...
/**
 * Returns whether a given command argument chip type has configurable change (i.e. can support reporting triggered from a "big
 * enough" change in the value).
 *
 ...
 * @param {*} options
 */
function hasConfigurableChange()
{
  checkIsChipType(this, 'hasConfigurableChange');
  return this.isDiscrete === false && this.isString === false;
}
...
exports.hasConfigurableChange                 = hasConfigurableChange;
