 ...
 */
PacketBufferHandle encodeBasicClusterReadHardwareRevisionAttribute(uint8_t seqNum, EndpointId destinationEndpoint)
{
    COMMAND_HEADER("ReadBasicHardwareRevision", BASIC_CLUSTER_ID);
