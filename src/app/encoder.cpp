 ...
 * Command GetSetupPIN
 */
PacketBufferHandle encodeAccountLoginClusterGetSetupPINCommand(uint8_t seqNum, EndpointId destinationEndpoint, chip::ByteSpan tempAccountIdentifier)
{
 ...
 * Command Login
 */
PacketBufferHandle encodeAccountLoginClusterLoginCommand(uint8_t seqNum, EndpointId destinationEndpoint, chip::ByteSpan tempAccountIdentifier, chip::ByteSpan setupPIN)
{
 ...
 * Command LaunchApp
 */
PacketBufferHandle encodeApplicationLauncherClusterLaunchAppCommand(uint8_t seqNum, EndpointId destinationEndpoint, chip::ByteSpan data, uint16_t catalogVendorId, chip::ByteSpan applicationId)
{
 ...
 */
PacketBufferHandle encodeAudioOutputClusterRenameOutputCommand(uint8_t seqNum, EndpointId destinationEndpoint, uint8_t index, chip::ByteSpan name)
{
...
PacketBufferHandle encodeAudioOutputClusterSelectOutputCommand(uint8_t seqNum, EndpointId destinationEndpoint, uint8_t index)
{
    COMMAND_HEADER("SelectOutput", AUDIO_OUTPUT_CLUSTER_ID);
      ...
      buf
        .Put8(kFrameControlClusterSpecificCommand)
       .Put8(seqNum)
       .Put8(ZCL_SELECT_OUTPUT_COMMAND_ID)
       .Put8(index)
        ;
    COMMAND_FOOTER();
}
 ...
 */
PacketBufferHandle encodeContentLaunchClusterLaunchContentCommand(uint8_t seqNum, EndpointId destinationEndpoint, uint8_t autoPlay, chip::ByteSpan data)
{
 ...
 * Command LaunchURL
 */
PacketBufferHandle encodeContentLaunchClusterLaunchURLCommand(uint8_t seqNum, EndpointId destinationEndpoint, chip::ByteSpan contentURL, chip::ByteSpan displayString)
{
...
PacketBufferHandle encodeMediaInputClusterHideInputStatusCommand(uint8_t seqNum, EndpointId destinationEndpoint)
{
    COMMAND_HEADER("HideInputStatus", MEDIA_INPUT_CLUSTER_ID);
      buf
        .Put8(kFrameControlClusterSpecificCommand)
       .Put8(seqNum)
       .Put8(ZCL_HIDE_INPUT_STATUS_COMMAND_ID)
    ;
    COMMAND_FOOTER();
}
 ...
 * Command RenameInput
 */
PacketBufferHandle encodeMediaInputClusterRenameInputCommand(uint8_t seqNum, EndpointId destinationEndpoint, uint8_t index, chip::ByteSpan name)
{
...
PacketBufferHandle encodeMediaInputClusterSelectInputCommand(uint8_t seqNum, EndpointId destinationEndpoint, uint8_t index)
{
    COMMAND_HEADER("SelectInput", MEDIA_INPUT_CLUSTER_ID);
      ...
      buf
        .Put8(kFrameControlClusterSpecificCommand)
       .Put8(seqNum)
       .Put8(ZCL_SELECT_INPUT_COMMAND_ID)
       .Put8(index)
        ;
    COMMAND_FOOTER();
}
...
PacketBufferHandle encodeMediaInputClusterShowInputStatusCommand(uint8_t seqNum, EndpointId destinationEndpoint)
{
    COMMAND_HEADER("ShowInputStatus", MEDIA_INPUT_CLUSTER_ID);
      buf
        .Put8(kFrameControlClusterSpecificCommand)
       .Put8(seqNum)
       .Put8(ZCL_SHOW_INPUT_STATUS_COMMAND_ID)
    ;
    COMMAND_FOOTER();
}
...
PacketBufferHandle encodeMediaPlaybackClusterMediaFastForwardCommand(uint8_t seqNum, EndpointId destinationEndpoint)
{
    COMMAND_HEADER("MediaFastForward", MEDIA_PLAYBACK_CLUSTER_ID);
      buf
        .Put8(kFrameControlClusterSpecificCommand)
       .Put8(seqNum)
       .Put8(ZCL_MEDIA_FAST_FORWARD_COMMAND_ID)
    ;
    COMMAND_FOOTER();
}
...
PacketBufferHandle encodeMediaPlaybackClusterMediaNextCommand(uint8_t seqNum, EndpointId destinationEndpoint)
{
    COMMAND_HEADER("MediaNext", MEDIA_PLAYBACK_CLUSTER_ID);
      buf
        .Put8(kFrameControlClusterSpecificCommand)
       .Put8(seqNum)
       .Put8(ZCL_MEDIA_NEXT_COMMAND_ID)
    ;
    COMMAND_FOOTER();
}
...
PacketBufferHandle encodeMediaPlaybackClusterMediaPauseCommand(uint8_t seqNum, EndpointId destinationEndpoint)
{
    COMMAND_HEADER("MediaPause", MEDIA_PLAYBACK_CLUSTER_ID);
      buf
        .Put8(kFrameControlClusterSpecificCommand)
       .Put8(seqNum)
       .Put8(ZCL_MEDIA_PAUSE_COMMAND_ID)
    ;
    COMMAND_FOOTER();
}
...
PacketBufferHandle encodeMediaPlaybackClusterMediaPlayCommand(uint8_t seqNum, EndpointId destinationEndpoint)
{
    COMMAND_HEADER("MediaPlay", MEDIA_PLAYBACK_CLUSTER_ID);
      buf
        .Put8(kFrameControlClusterSpecificCommand)
       .Put8(seqNum)
       .Put8(ZCL_MEDIA_PLAY_COMMAND_ID)
    ;
    COMMAND_FOOTER();
}
...
PacketBufferHandle encodeMediaPlaybackClusterMediaPreviousCommand(uint8_t seqNum, EndpointId destinationEndpoint)
{
    COMMAND_HEADER("MediaPrevious", MEDIA_PLAYBACK_CLUSTER_ID);
      buf
        .Put8(kFrameControlClusterSpecificCommand)
       .Put8(seqNum)
       .Put8(ZCL_MEDIA_PREVIOUS_COMMAND_ID)
    ;
    COMMAND_FOOTER();
}
...
PacketBufferHandle encodeMediaPlaybackClusterMediaRewindCommand(uint8_t seqNum, EndpointId destinationEndpoint)
{
    COMMAND_HEADER("MediaRewind", MEDIA_PLAYBACK_CLUSTER_ID);
      buf
        .Put8(kFrameControlClusterSpecificCommand)
       .Put8(seqNum)
       .Put8(ZCL_MEDIA_REWIND_COMMAND_ID)
    ;
    COMMAND_FOOTER();
}
 ...
 */
PacketBufferHandle encodeMediaPlaybackClusterMediaSkipBackwardCommand(uint8_t seqNum, EndpointId destinationEndpoint, uint64_t deltaPositionMilliseconds)
{
 ...
 */
PacketBufferHandle encodeMediaPlaybackClusterMediaSkipForwardCommand(uint8_t seqNum, EndpointId destinationEndpoint, uint64_t deltaPositionMilliseconds)
{
...
PacketBufferHandle encodeMediaPlaybackClusterMediaSkipSeekCommand(uint8_t seqNum, EndpointId destinationEndpoint, uint64_t position)
{
    COMMAND_HEADER("MediaSkipSeek", MEDIA_PLAYBACK_CLUSTER_ID);
      ...
      buf
        .Put8(kFrameControlClusterSpecificCommand)
       .Put8(seqNum)
       .Put8(ZCL_MEDIA_SKIP_SEEK_COMMAND_ID)
       .Put64(position)
        ;
    COMMAND_FOOTER();
}
...
PacketBufferHandle encodeMediaPlaybackClusterMediaStartOverCommand(uint8_t seqNum, EndpointId destinationEndpoint)
{
    COMMAND_HEADER("MediaStartOver", MEDIA_PLAYBACK_CLUSTER_ID);
      buf
        .Put8(kFrameControlClusterSpecificCommand)
       .Put8(seqNum)
       .Put8(ZCL_MEDIA_START_OVER_COMMAND_ID)
    ;
    COMMAND_FOOTER();
}
...
PacketBufferHandle encodeMediaPlaybackClusterMediaStopCommand(uint8_t seqNum, EndpointId destinationEndpoint)
{
    COMMAND_HEADER("MediaStop", MEDIA_PLAYBACK_CLUSTER_ID);
      buf
        .Put8(kFrameControlClusterSpecificCommand)
       .Put8(seqNum)
       .Put8(ZCL_MEDIA_STOP_COMMAND_ID)
    ;
    COMMAND_FOOTER();
}
 ...
 */
PacketBufferHandle encodeTvChannelClusterChangeChannelByNumberCommand(uint8_t seqNum, EndpointId destinationEndpoint, uint16_t majorNumber, uint16_t minorNumber)
{
...
PacketBufferHandle encodeTvChannelClusterSkipChannelCommand(uint8_t seqNum, EndpointId destinationEndpoint, uint16_t count)
{
    COMMAND_HEADER("SkipChannel", TV_CHANNEL_CLUSTER_ID);
      ...
      buf
        .Put8(kFrameControlClusterSpecificCommand)
       .Put8(seqNum)
       .Put8(ZCL_SKIP_CHANNEL_COMMAND_ID)
       .Put16(count)
        ;
    COMMAND_FOOTER();
}
 ...
 */
PacketBufferHandle encodeTargetNavigatorClusterNavigateTargetCommand(uint8_t seqNum, EndpointId destinationEndpoint, uint8_t target, chip::ByteSpan data)
{
