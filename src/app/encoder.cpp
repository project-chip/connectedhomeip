 ...
 * Command LaunchApp
 */
PacketBufferHandle encodeApplicationLauncherClusterLaunchAppCommand(uint8_t seqNum, EndpointId destinationEndpoint, uint16_t catalogVendorId, chip::ByteSpan applicationId, chip::ByteSpan data)
{
 ...
 * Command SendKey
 */
PacketBufferHandle encodeKeypadInputClusterSendKeyCommand(uint8_t seqNum, EndpointId destinationEndpoint, uint8_t keyAction, uint8_t keyCode)
{
