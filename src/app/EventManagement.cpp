...
System::Clock::Microseconds64 EventManagement::GetMonotonicStartupTime() const
{
    return std::chrono::duration_cast<System::Clock::Microseconds64>(mMonotonicStartupTime);
}
