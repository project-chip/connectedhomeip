...
public:
     ...
     * @param [in] aMetadata the attribute metadata, as a convenience.
     * @param [in] aValue where to place the data.  The size of the buffer will
     *             be equal to `size` member of aMetadata.
     *
     *             The data is expected to be in native endianness for integers
     *             and floats.  For strings, see the string representation
     *             description in the WriteValue documentation.
     */
