...
public:
    /**
     * Given a AttributePath Parser and return the matching handle to the cluster.
     */
    virtual CHIP_ERROR c(const AttributePath::Parser & aParser, ClusterDataHandle & aClusterDataHandle) const = 0;
    /**
