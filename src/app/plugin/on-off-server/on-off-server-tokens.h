...
/**
 *    @file
 *      This provides token management for the CHIP ZCL Application
...
DEFINE_INDEXED_TOKEN(ZCL_CORE_ON_OFF_SCENE_SUBTABLE, ChipZclOnOffSceneSubTableEntry_t, CHIP_AF_PLUGIN_SCENES_SERVER_TABLE_SIZE,
                     {
                         CHIP_SCENE_NULL,
                     })
#endif // DEFINETOKENS
