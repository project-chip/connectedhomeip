                            ...
                            const ConcreteAttributePath & aPath)
{
    ...
    err = ReadSingleClusterData(aSubjectDescriptor, aPath, attributeReport);
                                                           ...
                                                           ReadHandler * apReadHandler, bool * apHasMoreChunks)
{
...

    {
             ...
             apReadHandler->GetAttributePathExpandIterator()->Next())
        {
            ...
            err = RetrieveClusterData(apReadHandler->GetSubjectDescriptor(), attributeReportIBs, readPath);
            if (err != CHIP_NO_ERROR)
            {
