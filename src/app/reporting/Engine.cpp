...
CHIP_ERROR
Engine::RetrieveClusterData(const SubjectDescriptor & aSubjectDescriptor, FabricIndex aFabricIndex,
                            ...
                            AttributeValueEncoder::AttributeEncodeState * aEncoderState)
{
    ...
    ReturnErrorOnFailure(ReadSingleClusterData(aSubjectDescriptor, aFabricIndex, aPath, aAttributeReportIBs, aEncoderState));
                                                           ...
                                                           bool * apHasEncodedData)
{
...

    {
             ...
             apReadHandler->GetAttributePathExpandIterator()->Next())
        {
            ...
            err = RetrieveClusterData(apReadHandler->GetSubjectDescriptor(), apReadHandler->GetAccessingFabricIndex(),
