...
EventOptions::EventOptions(void) : timestamp(), eventSource(NULL), timestampType(TimestampType::Invalid), urgent(false) {}

EventOptions::EventOptions(bool aUrgent) : timestamp(), eventSource(NULL), timestampType(TimestampType::Invalid), urgent(aUrgent) {}

EventOptions::EventOptions(timestamp_t aSystemTimestamp) :
    timestamp(aSystemTimestamp), eventSource(NULL), timestampType(TimestampType::System), urgent(false)
{}

EventOptions::EventOptions(utc_timestamp_t aUtcTimestamp) :
    timestamp(aUtcTimestamp), eventSource(NULL), timestampType(TimestampType::UTC), urgent(false)
{}

EventOptions::EventOptions(timestamp_t aSystemTimestamp, bool aUrgent) :
    timestamp(aSystemTimestamp), eventSource(NULL), timestampType(TimestampType::System), urgent(aUrgent)
{}

EventOptions::EventOptions(utc_timestamp_t aUtcTimestamp, bool aUrgent) :
    timestamp(aUtcTimestamp), eventSource(NULL), timestampType(TimestampType::UTC), urgent(aUrgent)
{}
