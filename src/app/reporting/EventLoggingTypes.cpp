...
EventLoadOutContext::EventLoadOutContext(chip::TLV::TLVWriter & aWriter, PriorityLevel aPriority, uint32_t aStartingEventID) :
    mWriter(aWriter), mPriority(aPriority), mStartingEventID(aStartingEventID), mCurrentTime(0), mCurrentEventID(0),
