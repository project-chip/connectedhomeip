 ...
 *                         log, 0 otherwise.
 */
chip::EventId LogEvent(const EventSchema & aSchema, chip::TLV::TLVReader & aData);
 ...
 *                         log, 0 otherwise.
 */
chip::EventId LogEvent(const EventSchema & aSchema, chip::TLV::TLVReader & aData, const EventOptions * apOptions);
