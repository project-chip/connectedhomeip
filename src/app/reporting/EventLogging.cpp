...
chip::EventId LogEvent(const EventSchema & aSchema, TLVReader & aData)
{
    return LogEvent(aSchema, aData, NULL);
}

chip::EventId LogEvent(const EventSchema & aSchema, TLVReader & aData, const EventOptions * apOptions)
{
...
chip::EventId LogEvent(const EventSchema & aSchema, EventWriterFunct aEventWriter, void * apAppData, const EventOptions * apOptions)
{
