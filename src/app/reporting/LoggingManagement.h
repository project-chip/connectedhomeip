...
public:
    ...
    chip::EventId mFirstEventID; ///< First event ID stored in the logging subsystem for this priority
    chip::EventId mLastEventID;  ///< Last event ID vended for this priority
