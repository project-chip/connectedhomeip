...
public:
    static int Initialize(void * context)
    {
        ...
        chip::app::EventManagement::CreateEventManagement(ArraySize(logStorageResources), gCircularEventBuffer, logStorageResources,
                                                          &ctx->mEventCounter, &ctx->GetFabricTable());
