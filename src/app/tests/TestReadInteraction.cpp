...
void TestReadInteraction::TestSubscribeRoundtrip(nlTestSuite * apSuite, void * apContext)
{
...

    {
        ...
        delegate.mpReadHandler->SetStateFlagAndScheduleReport(ReadHandler::ReadHandlerFlags::HoldMinInterval, false);
        delegate.mGotReport            = false;
        delegate.mGotEventResponse     = false;
        delegate.mNumAttributeResponse = 0;
        ...
        // Test empty report
        delegate.mpReadHandler->SetStateFlagAndScheduleReport(ReadHandler::ReadHandlerFlags::HoldMinInterval, false);
        delegate.mpReadHandler->SetStateFlagAndScheduleReport(ReadHandler::ReadHandlerFlags::HoldMaxInterval, false);
...
void TestReadInteraction::TestSubscribeUrgentWildcardEvent(nlTestSuite * apSuite, void * apContext)
{
...

    {
        ...
        NL_TEST_ASSERT(apSuite, delegate.mpReadHandler->mFlags.Has(ReadHandler::ReadHandlerFlags::HoldMinInterval));
        NL_TEST_ASSERT(apSuite, delegate.mpReadHandler->IsDirty());
        delegate.mGotEventResponse = false;
        delegate.mGotReport        = false;

        NL_TEST_ASSERT(apSuite, nonUrgentDelegate.mpReadHandler->mFlags.Has(ReadHandler::ReadHandlerFlags::HoldMinInterval));
...
void TestReadInteraction::TestSubscriptionReportWithDefunctSession(nlTestSuite * apSuite, void * apContext)
{
...

    {
        ...
        readHandler->SetStateFlagAndScheduleReport(ReadHandler::ReadHandlerFlags::HoldMinInterval, false);
        delegate.mGotReport            = false;
        delegate.mNumAttributeResponse = 0;
