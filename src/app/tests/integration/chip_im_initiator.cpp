...
public:
    ...
    void OnResponse(const chip::app::WriteClient * apWriteClient, const chip::app::ConcreteAttributePath & path) override
    {
        auto respTime    = chip::System::SystemClock().GetMonotonicMilliseconds();
        auto transitTime = respTime - gLastMessageTime;
    ...
    void OnError(const chip::app::WriteClient * apCommandSender, chip::Protocols::InteractionModel::Status aProtocolCode,
                 CHIP_ERROR aError) override
    {
