...
chip::app::CommandSender gCommandSender;
...
CHIP_ERROR SendCommandRequest(void)
{
    ...
    chip::TLV::TLVWriter writer = gCommandSender.CreateCommandDataElementTLVWriter();
    ...
    err = gCommandSender.AddCommand(CommandParams);
    SuccessOrExit(err);
...
int main(int argc, char * argv[])
{
    ...
    err = gCommandSender.Init(&gExchangeManager);
    SuccessOrExit(err);
