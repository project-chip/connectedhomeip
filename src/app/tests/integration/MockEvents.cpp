...
CHIP_ERROR __attribute__((weak)) WriteLivenessStatusEvent(chip::TLV::TLVWriter & aWriter, void * apAppState)
{
...
chip::EventId LivenessEventGenerator::LogLiveness(chip::NodeId aNodeId, chip::EndpointId aEndpointId, LivenessDeviceStatus aStatus)
{
    ...
    root.mNodeId     = aNodeId;
    root.mEndpointId = aEndpointId;
...
MockEventGeneratorImpl::MockEventGeneratorImpl(void) :
    mpExchangeMgr(NULL), mTimeBetweenEvents(0), mEventWraparound(false), mpEventGenerator(nullptr), mEventsLeft(0)
{}
