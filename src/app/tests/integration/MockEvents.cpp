...
void LivenessEventGenerator::Generate(void)
{
    ...
    {
    case 0:
        LogLiveness(kTestNodeId, kTestEndpointId, LIVENESS_DEVICE_STATUS_ONLINE, kTestChangeEvent1, chip::app::PriorityLevel::Critical);
        break;

    case 1:
        LogLiveness(kTestNodeId, kTestEndpointId, LIVENESS_DEVICE_STATUS_ONLINE, kTestChangeEvent2, chip::app::PriorityLevel::Debug);
        break;
    ...
    case 3:
        LogLiveness(kTestNodeId, kTestEndpointId, LIVENESS_DEVICE_STATUS_UNREACHABLE, kTestChangeEvent2, chip::app::PriorityLevel::Debug);
        break;
    ...
    case 5:
        LogLiveness(kTestNodeId, kTestEndpointId, LIVENESS_DEVICE_STATUS_REBOOTING, kTestChangeEvent2, chip::app::PriorityLevel::Debug);
        break;
...
chip::EventNumber LivenessEventGenerator::LogLiveness(chip::NodeId aNodeId, chip::EndpointId aEndpointId,
                                                      LivenessDeviceStatus aStatus, chip::EventId aEventId, chip::app::PriorityLevel aPriorityLevel)
{
    ...
    chip::app::EventSchema schema           = {
        aNodeId, aEndpointId, kTestClusterId, aEventId, aPriorityLevel
    };
