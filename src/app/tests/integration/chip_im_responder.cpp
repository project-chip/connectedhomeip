...
chip::app::reporting::CircularEventBuffer gCircularEventBuffer[3];
...
void InitializeEventLogging(chip::Messaging::ExchangeManager * apMgr)
{
    ...
    chip::app::reporting::LoggingManagement::CreateLoggingManagement(
        apMgr, sizeof(logStorageResources) / sizeof(logStorageResources[0]), gCircularEventBuffer, logStorageResources);
