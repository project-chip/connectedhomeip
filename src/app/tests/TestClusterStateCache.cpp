...
struct AttributeInstruction
{
    ...
    AttributeId GetAttributeId() const
    {
        ...
        {
        case kAttributeA:
            return Clusters::Test::Attributes::Int16u::Id;
            break;

        case kAttributeB:
            return Clusters::Test::Attributes::OctetString::Id;
            break;

        case kAttributeC:
            return Clusters::Test::Attributes::StructAttr::Id;
            break;

        default:
            return Clusters::Test::Attributes::ListStructOctetString::Id;
            break;
        }
    }
...
void DataSeriesGenerator::Generate(ForwardedDataCallbackValidator & dataCallbackValidator)
{
    ...
    {
        ConcreteDataAttributePath path(instruction.mEndpointId, Clusters::Test::Id, 0);
        ...
        if (instruction.mValueType == AttributeInstruction::kData)
        {
            ...
            case AttributeInstruction::kAttributeA: {
                ...
                Clusters::Test::Attributes::Int16u::TypeInfo::Type value = instruction.mInstructionId;
            ...
            case AttributeInstruction::kAttributeB: {
                ...
                Clusters::Test::Attributes::OctetString::TypeInfo::Type value;
            ...
            case AttributeInstruction::kAttributeC: {
                ...
                Clusters::Test::Attributes::StructAttr::TypeInfo::Type value;
            ...
            case AttributeInstruction::kAttributeD: {
                ...
                // buf[200] is 1.6k
                Clusters::Test::Structs::TestListStructOctet::Type buf[200];
...
public:
    ...
    Clusters::Test::Attributes::TypeInfo::DecodableType clusterValue;
...
private:
    ...
    void DecodeAttribute(const AttributeInstruction & instruction, const ConcreteAttributePath & path, ClusterStateCache * cache)
    {
        ...
        case AttributeInstruction::kAttributeA: {
            ...
            Clusters::Test::Attributes::Int16u::TypeInfo::DecodableType v = 0;
            err = cache->Get<Clusters::Test::Attributes::Int16u::TypeInfo>(path, v);
        ...
        case AttributeInstruction::kAttributeB: {
            ...
            Clusters::Test::Attributes::OctetString::TypeInfo::DecodableType v;
            err = cache->Get<Clusters::Test::Attributes::OctetString::TypeInfo>(path, v);
            if (err == CHIP_ERROR_IM_STATUS_CODE_RECEIVED)
            {
                gotStatus = true;
                err       = CHIP_NO_ERROR;
        ...
        case AttributeInstruction::kAttributeC: {
            ...
            Clusters::Test::Attributes::StructAttr::TypeInfo::DecodableType v;
            err = cache->Get<Clusters::Test::Attributes::StructAttr::TypeInfo>(path, v);
            if (err == CHIP_ERROR_IM_STATUS_CODE_RECEIVED)
            {
                gotStatus = true;
                err       = CHIP_NO_ERROR;
        ...
        case AttributeInstruction::kAttributeD: {
            ...
            Clusters::Test::Attributes::ListStructOctetString::TypeInfo::DecodableType v;
            err = cache->Get<Clusters::Test::Attributes::ListStructOctetString::TypeInfo>(path, v);
            if (err == CHIP_ERROR_IM_STATUS_CODE_RECEIVED)
            {
                gotStatus = true;
                err       = CHIP_NO_ERROR;
                             ...
                             ClusterStateCache * cache)
    {
        ...
        else
        {
            ...
            NL_TEST_ASSERT(gSuite, status.mPath.mClusterId == Clusters::Test::Id);
    ...
    mDataCallbackValidator(dataCallbackValidator)
{
    for (auto & instruction : instructionList)
    {
        ...
        mExpectedAttributes.insert(
            ConcreteAttributePath(instruction.mEndpointId, Clusters::Test::Id, instruction.GetAttributeId()));
        mExpectedClusters.insert(std::make_tuple(instruction.mEndpointId, Clusters::Test::Id));
