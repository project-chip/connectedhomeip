...
void TestWriteInteraction::GenerateWriteRequest(nlTestSuite * apSuite, void * apContext, System::PacketBufferHandle & aPayload)
{
    ...
    NL_TEST_ASSERT(apSuite, err == CHIP_NO_ERROR);
    AttributeDatas::Builder attributeDatasBuilder = writeRequestBuilder.CreateAttributeDatasBuilder();
    NL_TEST_ASSERT(apSuite, writeRequestBuilder.GetError() == CHIP_NO_ERROR);
    AttributeDataIB::Builder attributeDataIBBuilder = attributeDatasBuilder.CreateAttributeDataIBBuilder();
    NL_TEST_ASSERT(apSuite, attributeDatasBuilder.GetError() == CHIP_NO_ERROR);
    ...
    attributeDatasBuilder.EndOfAttributeDatas();
    NL_TEST_ASSERT(apSuite, attributeDatasBuilder.GetError() == CHIP_NO_ERROR);
