...
void TestAttributePathIncludedSameFieldId(nlTestSuite * apSuite, void * apContext)
{
    ...
    NL_TEST_ASSERT(apSuite, clusterInfo1.IsAttributePathIBsupersetOf(clusterInfo2));
    clusterInfo2.mListIndex = 1;
    NL_TEST_ASSERT(apSuite, clusterInfo1.IsAttributePathIBsupersetOf(clusterInfo2));
    clusterInfo1.mListIndex = 0;
    NL_TEST_ASSERT(apSuite, !clusterInfo1.IsAttributePathIBsupersetOf(clusterInfo3));
