...
public:
    ...
    static CHIP_ERROR HandleCommandARequest(void * context, InvokeResponder & responder, CommandParams & commandParams,
                                            chip::app::Cluster::TestCluster::CommandA::Type * req, SchemaAllocator && allocator);
...
TestServerCluster::TestServerCluster() : DeviceClusterServer(chip::app::Cluster::TestCluster::kClusterId) {}
...
CHIP_ERROR
TestServerCluster::HandleCommandARequest(void * context, InvokeResponder & responder, CommandParams & commandParams,
                                         chip::app::Cluster::TestCluster::CommandA::Type * req, SchemaAllocator && allocator)
{
...
{
    ReturnErrorOnFailure(DispatchCommand<chip::app::Cluster::TestCluster::CommandA::Type>(
        commandParams, *payload, invokeInteraction, HandleCommandARequest));
