...
def main():
    ...
    parser = argparse.ArgumentParser(description='Extract informations from the set of certifications tests')
    parser.add_argument('-s', '--show', default=default_options, choices=default_choices, help='The informations that needs to be returned from the test set')
