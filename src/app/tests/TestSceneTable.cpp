...
static EmberAfAttributeMetadata mockMetadataBool = {
    ...
    .mask          = MATTER_ATTRIBUTE_BITMAP_WRITABLE,
};
...
static EmberAfAttributeMetadata mockMetadataUint8 = {
    ...
    .mask          = MATTER_ATTRIBUTE_BITMAP_WRITABLE | MATTER_ATTRIBUTE_BITMAP_NULLABLE,
};
...
static EmberAfAttributeMetadata mockMetadataUint8Max = {
    ...
    .size          = 1,
    .attributeType = ZCL_INT8U_ATTRIBUTE_TYPE,
    .mask          = MATTER_ATTRIBUTE_BITMAP_WRITABLE | MATTER_ATTRIBUTE_BITMAP_NULLABLE | MATTER_ATTRIBUTE_BITMAP_MIN_MAX,
};
...
static EmberAfAttributeMetadata mockMetadataInt8 = {
    ...
    .mask          = MATTER_ATTRIBUTE_BITMAP_WRITABLE | MATTER_ATTRIBUTE_BITMAP_MIN_MAX,
};
