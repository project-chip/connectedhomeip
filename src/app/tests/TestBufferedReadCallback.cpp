                                          ...
                                          const StatusIB & aStatus)
{
    ...
    case ValidationInstruction::kSimpleAttributeA: {
        ...
        Clusters::Test::Attributes::Int8u::TypeInfo::Type value;
        NL_TEST_ASSERT(gSuite,
                       aPath.mEndpointId == 0 && aPath.mClusterId == Clusters::Test::Id &&
                           aPath.mAttributeId == Clusters::Test::Attributes::Int8u::Id &&
    ...
    case ValidationInstruction::kSimpleAttributeB: {
        ...
        Clusters::Test::Attributes::Int32u::TypeInfo::Type value;
        NL_TEST_ASSERT(gSuite,
                       aPath.mEndpointId == 0 && aPath.mClusterId == Clusters::Test::Id &&
                           aPath.mAttributeId == Clusters::Test::Attributes::Int32u::Id &&
                           aPath.mListOp == ConcreteDataAttributePath::ListOperation::NotList);
        NL_TEST_ASSERT(gSuite, DataModel::Decode(*apData, value) == CHIP_NO_ERROR);
        NL_TEST_ASSERT(gSuite, value == mCurrentInstruction);
        break;
    ...
    case ValidationInstruction::kListAttributeC_Empty: {
        ...
        Clusters::Test::Attributes::ListStructOctetString::TypeInfo::DecodableType value;
        size_t len;

        NL_TEST_ASSERT(gSuite,
                       aPath.mEndpointId == 0 && aPath.mClusterId == Clusters::Test::Id &&
                           aPath.mAttributeId == Clusters::Test::Attributes::ListStructOctetString::Id &&
    ...
    case ValidationInstruction::kListAttributeD_Empty: {
        ...
        Clusters::Test::Attributes::ListInt8u::TypeInfo::DecodableType value;
        size_t len;

        NL_TEST_ASSERT(gSuite,
                       aPath.mEndpointId == 0 && aPath.mClusterId == Clusters::Test::Id &&
                           aPath.mAttributeId == Clusters::Test::Attributes::ListInt8u::Id &&
                           aPath.mListOp == ConcreteDataAttributePath::ListOperation::ReplaceAll);
        NL_TEST_ASSERT(gSuite, DataModel::Decode(*apData, value) == CHIP_NO_ERROR);
        NL_TEST_ASSERT(gSuite, value.ComputeSize(&len) == CHIP_NO_ERROR);
        NL_TEST_ASSERT(gSuite, len == 0);
...
void DataSeriesGenerator::Generate()
{
    ...
    ConcreteDataAttributePath path(0, Clusters::Test::Id, 0);
    ...
    for (auto & instruction : mInstructionList)
    {
        ...
        case ValidationInstruction::kListAttributeC_Empty: {
            ...
            path.mAttributeId = Clusters::Test::Attributes::ListStructOctetString::Id;
        ...
        case ValidationInstruction::kListAttributeC_NotEmpty: {
            ...
            Clusters::Test::Structs::TestListStructOctet::Type listData[2];
            Clusters::Test::Attributes::ListStructOctetString::TypeInfo::Type value(listData);
        ...
        case ValidationInstruction::kListAttributeD_Empty: {
            ...
            Clusters::Test::Attributes::ListInt8u::TypeInfo::Type value;
            path.mAttributeId = Clusters::Test::Attributes::ListInt8u::Id;
            path.mListOp      = ConcreteDataAttributePath::ListOperation::ReplaceAll;
            NL_TEST_ASSERT(gSuite, DataModel::Encode(writer, TLV::AnonymousTag(), value) == CHIP_NO_ERROR);
            break;
        }
        ...
        case ValidationInstruction::kListAttributeD_NotEmpty: {
            ...
            uint8_t listData[2];
            Clusters::Test::Attributes::ListInt8u::TypeInfo::Type value(listData);
        ...
        case ValidationInstruction::kListAttributeC_NotEmpty_Chunked: {
            ...
            for (int i = 0; i < 512; i++)
            {
                Clusters::Test::Structs::TestListStructOctet::Type listItem;
