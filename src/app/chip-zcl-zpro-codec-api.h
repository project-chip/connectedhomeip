...
/**
 * @brief
 *    Encode an GetSetupPIN command for Account Login server into buffer including the APS frame
 */
chip::System::PacketBufferHandle encodeAccountLoginClusterGetSetupPINCommand(uint8_t seqNum, chip::EndpointId destinationEndpoint, chip::ByteSpan tempAccountIdentifier);

/**
 * @brief
 *    Encode an Login command for Account Login server into buffer including the APS frame
 */
chip::System::PacketBufferHandle encodeAccountLoginClusterLoginCommand(uint8_t seqNum, chip::EndpointId destinationEndpoint, chip::ByteSpan tempAccountIdentifier, chip::ByteSpan setupPIN);
...
/**
 * @brief
 *    Encode an LaunchApp command for Application Launcher server into buffer including the APS frame
 */
chip::System::PacketBufferHandle encodeApplicationLauncherClusterLaunchAppCommand(uint8_t seqNum, chip::EndpointId destinationEndpoint, chip::ByteSpan data, uint16_t catalogVendorId, chip::ByteSpan applicationId);
...
/**
 * @brief
 *    Encode an RenameOutput command for Audio Output server into buffer including the APS frame
 */
chip::System::PacketBufferHandle encodeAudioOutputClusterRenameOutputCommand(uint8_t seqNum, chip::EndpointId destinationEndpoint, uint8_t index, chip::ByteSpan name);

/**
 * @brief
 *    Encode an SelectOutput command for Audio Output server into buffer including the APS frame
 */
chip::System::PacketBufferHandle encodeAudioOutputClusterSelectOutputCommand(uint8_t seqNum, chip::EndpointId destinationEndpoint, uint8_t index);
 ...
 */
chip::System::PacketBufferHandle encodeContentLaunchClusterLaunchContentCommand(uint8_t seqNum, chip::EndpointId destinationEndpoint, uint8_t autoPlay, chip::ByteSpan data);

/**
 * @brief
 *    Encode an LaunchURL command for Content Launch server into buffer including the APS frame
 */
chip::System::PacketBufferHandle encodeContentLaunchClusterLaunchURLCommand(uint8_t seqNum, chip::EndpointId destinationEndpoint, chip::ByteSpan contentURL, chip::ByteSpan displayString);
 ...
 */
chip::System::PacketBufferHandle encodeGeneralCommissioningClusterArmFailSafeCommand(uint8_t seqNum, chip::EndpointId destinationEndpoint, uint16_t expiryLengthSeconds, uint64_t breadcrumb, uint32_t timeoutMs);

/**
 * @brief
 *    Encode an CommissioningComplete command for General Commissioning server into buffer including the APS frame
 */
chip::System::PacketBufferHandle encodeGeneralCommissioningClusterCommissioningCompleteCommand(uint8_t seqNum, chip::EndpointId destinationEndpoint);

/**
 * @brief
 *    Encode an SetFabric command for General Commissioning server into buffer including the APS frame
 */
chip::System::PacketBufferHandle encodeGeneralCommissioningClusterSetFabricCommand(uint8_t seqNum, chip::EndpointId destinationEndpoint, chip::ByteSpan fabricId, chip::ByteSpan fabricSecret, uint64_t breadcrumb, uint32_t timeoutMs);
...
/**
 * @brief
 *    Encode an SendKey command for Keypad Input server into buffer including the APS frame
 */
chip::System::PacketBufferHandle encodeKeypadInputClusterSendKeyCommand(uint8_t seqNum, chip::EndpointId destinationEndpoint, uint8_t keyCode);
...
/**
 * @brief
 *    Encode an HideInputStatus command for Media Input server into buffer including the APS frame
 */
chip::System::PacketBufferHandle encodeMediaInputClusterHideInputStatusCommand(uint8_t seqNum, chip::EndpointId destinationEndpoint);

/**
 * @brief
 *    Encode an RenameInput command for Media Input server into buffer including the APS frame
 */
chip::System::PacketBufferHandle encodeMediaInputClusterRenameInputCommand(uint8_t seqNum, chip::EndpointId destinationEndpoint, uint8_t index, chip::ByteSpan name);

/**
 * @brief
 *    Encode an SelectInput command for Media Input server into buffer including the APS frame
 */
chip::System::PacketBufferHandle encodeMediaInputClusterSelectInputCommand(uint8_t seqNum, chip::EndpointId destinationEndpoint, uint8_t index);

/**
 * @brief
 *    Encode an ShowInputStatus command for Media Input server into buffer including the APS frame
 */
chip::System::PacketBufferHandle encodeMediaInputClusterShowInputStatusCommand(uint8_t seqNum, chip::EndpointId destinationEndpoint);
...
/**
 * @brief
 *    Encode an MediaFastForward command for Media Playback server into buffer including the APS frame
 */
chip::System::PacketBufferHandle encodeMediaPlaybackClusterMediaFastForwardCommand(uint8_t seqNum, chip::EndpointId destinationEndpoint);

/**
 * @brief
 *    Encode an MediaNext command for Media Playback server into buffer including the APS frame
 */
chip::System::PacketBufferHandle encodeMediaPlaybackClusterMediaNextCommand(uint8_t seqNum, chip::EndpointId destinationEndpoint);

/**
 * @brief
 *    Encode an MediaPause command for Media Playback server into buffer including the APS frame
 */
chip::System::PacketBufferHandle encodeMediaPlaybackClusterMediaPauseCommand(uint8_t seqNum, chip::EndpointId destinationEndpoint);

/**
 * @brief
 *    Encode an MediaPlay command for Media Playback server into buffer including the APS frame
 */
chip::System::PacketBufferHandle encodeMediaPlaybackClusterMediaPlayCommand(uint8_t seqNum, chip::EndpointId destinationEndpoint);

/**
 * @brief
 *    Encode an MediaPrevious command for Media Playback server into buffer including the APS frame
 */
chip::System::PacketBufferHandle encodeMediaPlaybackClusterMediaPreviousCommand(uint8_t seqNum, chip::EndpointId destinationEndpoint);

/**
 * @brief
 *    Encode an MediaRewind command for Media Playback server into buffer including the APS frame
 */
chip::System::PacketBufferHandle encodeMediaPlaybackClusterMediaRewindCommand(uint8_t seqNum, chip::EndpointId destinationEndpoint);

/**
 * @brief
 *    Encode an MediaSkipBackward command for Media Playback server into buffer including the APS frame
 */
chip::System::PacketBufferHandle encodeMediaPlaybackClusterMediaSkipBackwardCommand(uint8_t seqNum, chip::EndpointId destinationEndpoint, uint64_t deltaPositionMilliseconds);

/**
 * @brief
 *    Encode an MediaSkipForward command for Media Playback server into buffer including the APS frame
 */
chip::System::PacketBufferHandle encodeMediaPlaybackClusterMediaSkipForwardCommand(uint8_t seqNum, chip::EndpointId destinationEndpoint, uint64_t deltaPositionMilliseconds);

/**
 * @brief
 *    Encode an MediaSkipSeek command for Media Playback server into buffer including the APS frame
 */
chip::System::PacketBufferHandle encodeMediaPlaybackClusterMediaSkipSeekCommand(uint8_t seqNum, chip::EndpointId destinationEndpoint, uint64_t position);

/**
 * @brief
 *    Encode an MediaStartOver command for Media Playback server into buffer including the APS frame
 */
chip::System::PacketBufferHandle encodeMediaPlaybackClusterMediaStartOverCommand(uint8_t seqNum, chip::EndpointId destinationEndpoint);

/**
 * @brief
 *    Encode an MediaStop command for Media Playback server into buffer including the APS frame
 */
chip::System::PacketBufferHandle encodeMediaPlaybackClusterMediaStopCommand(uint8_t seqNum, chip::EndpointId destinationEndpoint);
 ...
 */
chip::System::PacketBufferHandle encodeNetworkCommissioningClusterAddThreadNetworkCommand(uint8_t seqNum, chip::EndpointId destinationEndpoint, chip::ByteSpan operationalDataset, uint64_t breadcrumb, uint32_t timeoutMs);

/**
 * @brief
 *    Encode an AddWiFiNetwork command for Network Commissioning server into buffer including the APS frame
 */
chip::System::PacketBufferHandle encodeNetworkCommissioningClusterAddWiFiNetworkCommand(uint8_t seqNum, chip::EndpointId destinationEndpoint, chip::ByteSpan ssid, chip::ByteSpan credentials, uint64_t breadcrumb, uint32_t timeoutMs);

/**
 * @brief
 *    Encode an DisableNetwork command for Network Commissioning server into buffer including the APS frame
 */
chip::System::PacketBufferHandle encodeNetworkCommissioningClusterDisableNetworkCommand(uint8_t seqNum, chip::EndpointId destinationEndpoint, chip::ByteSpan networkID, uint64_t breadcrumb, uint32_t timeoutMs);

/**
 * @brief
 *    Encode an EnableNetwork command for Network Commissioning server into buffer including the APS frame
 */
chip::System::PacketBufferHandle encodeNetworkCommissioningClusterEnableNetworkCommand(uint8_t seqNum, chip::EndpointId destinationEndpoint, chip::ByteSpan networkID, uint64_t breadcrumb, uint32_t timeoutMs);

/**
 * @brief
 *    Encode an GetLastNetworkCommissioningResult command for Network Commissioning server into buffer including the APS frame
 */
chip::System::PacketBufferHandle encodeNetworkCommissioningClusterGetLastNetworkCommissioningResultCommand(uint8_t seqNum, chip::EndpointId destinationEndpoint, uint32_t timeoutMs);

/**
 * @brief
 *    Encode an RemoveNetwork command for Network Commissioning server into buffer including the APS frame
 */
chip::System::PacketBufferHandle encodeNetworkCommissioningClusterRemoveNetworkCommand(uint8_t seqNum, chip::EndpointId destinationEndpoint, chip::ByteSpan networkID, uint64_t breadcrumb, uint32_t timeoutMs);

/**
 * @brief
 *    Encode an ScanNetworks command for Network Commissioning server into buffer including the APS frame
 */
chip::System::PacketBufferHandle encodeNetworkCommissioningClusterScanNetworksCommand(uint8_t seqNum, chip::EndpointId destinationEndpoint, chip::ByteSpan ssid, uint64_t breadcrumb, uint32_t timeoutMs);

/**
 * @brief
 *    Encode an UpdateThreadNetwork command for Network Commissioning server into buffer including the APS frame
 */
chip::System::PacketBufferHandle encodeNetworkCommissioningClusterUpdateThreadNetworkCommand(uint8_t seqNum, chip::EndpointId destinationEndpoint, chip::ByteSpan operationalDataset, uint64_t breadcrumb, uint32_t timeoutMs);

/**
 * @brief
 *    Encode an UpdateWiFiNetwork command for Network Commissioning server into buffer including the APS frame
 */
chip::System::PacketBufferHandle encodeNetworkCommissioningClusterUpdateWiFiNetworkCommand(uint8_t seqNum, chip::EndpointId destinationEndpoint, chip::ByteSpan ssid, chip::ByteSpan credentials, uint64_t breadcrumb, uint32_t timeoutMs);
...
/**
 * @brief
 *    Encode an ChangeChannel command for TV Channel server into buffer including the APS frame
 */
chip::System::PacketBufferHandle encodeTvChannelClusterChangeChannelCommand(uint8_t seqNum, chip::EndpointId destinationEndpoint, chip::ByteSpan match);

/**
 * @brief
 *    Encode an ChangeChannelByNumber command for TV Channel server into buffer including the APS frame
 */
chip::System::PacketBufferHandle encodeTvChannelClusterChangeChannelByNumberCommand(uint8_t seqNum, chip::EndpointId destinationEndpoint, uint16_t majorNumber, uint16_t minorNumber);

/**
 * @brief
 *    Encode an SkipChannel command for TV Channel server into buffer including the APS frame
 */
chip::System::PacketBufferHandle encodeTvChannelClusterSkipChannelCommand(uint8_t seqNum, chip::EndpointId destinationEndpoint, uint16_t count);
...
/**
 * @brief
 *    Encode an NavigateTarget command for Target Navigator server into buffer including the APS frame
 */
chip::System::PacketBufferHandle encodeTargetNavigatorClusterNavigateTargetCommand(uint8_t seqNum, chip::EndpointId destinationEndpoint, uint8_t target, chip::ByteSpan data);
 ...
 */
chip::System::PacketBufferHandle encodeThermostatClusterClearWeeklyScheduleCommand(uint8_t seqNum, chip::EndpointId destinationEndpoint);

/**
 * @brief
 *    Encode an GetRelayStatusLog command for Thermostat server into buffer including the APS frame
 */
chip::System::PacketBufferHandle encodeThermostatClusterGetRelayStatusLogCommand(uint8_t seqNum, chip::EndpointId destinationEndpoint);

/**
 * @brief
 *    Encode an GetWeeklySchedule command for Thermostat server into buffer including the APS frame
 */
chip::System::PacketBufferHandle encodeThermostatClusterGetWeeklyScheduleCommand(uint8_t seqNum, chip::EndpointId destinationEndpoint, uint8_t daysToReturn, uint8_t modeToReturn);

/**
 * @brief
 *    Encode an SetWeeklySchedule command for Thermostat server into buffer including the APS frame
 */
chip::System::PacketBufferHandle encodeThermostatClusterSetWeeklyScheduleCommand(uint8_t seqNum, chip::EndpointId destinationEndpoint, uint8_t numberOfTransitionsForSequence, uint8_t dayOfWeekForSequence, uint8_t modeForSequence, uint8_t payload);

/**
 * @brief
 *    Encode an SetpointRaiseLower command for Thermostat server into buffer including the APS frame
 */
chip::System::PacketBufferHandle encodeThermostatClusterSetpointRaiseLowerCommand(uint8_t seqNum, chip::EndpointId destinationEndpoint, uint8_t mode, int8_t amount);
 ...
 */
chip::System::PacketBufferHandle encodeWindowCoveringClusterWindowCoveringGoToLiftPercentageCommand(uint8_t seqNum, chip::EndpointId destinationEndpoint, uint8_t percentageLiftValue);

/**
 * @brief
 *    Encode an WindowCoveringGoToLiftValue command for Window Covering server into buffer including the APS frame
 */
chip::System::PacketBufferHandle encodeWindowCoveringClusterWindowCoveringGoToLiftValueCommand(uint8_t seqNum, chip::EndpointId destinationEndpoint, uint16_t liftValue);

/**
 * @brief
 *    Encode an WindowCoveringGoToTiltPercentage command for Window Covering server into buffer including the APS frame
 */
chip::System::PacketBufferHandle encodeWindowCoveringClusterWindowCoveringGoToTiltPercentageCommand(uint8_t seqNum, chip::EndpointId destinationEndpoint, uint8_t percentageTiltValue);

/**
 * @brief
 *    Encode an WindowCoveringGoToTiltValue command for Window Covering server into buffer including the APS frame
 */
chip::System::PacketBufferHandle encodeWindowCoveringClusterWindowCoveringGoToTiltValueCommand(uint8_t seqNum, chip::EndpointId destinationEndpoint, uint16_t tiltValue);
