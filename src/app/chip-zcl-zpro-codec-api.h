 ...
 */
chip::System::PacketBufferHandle encodeNetworkProvisioningClusterAddThreadNetworkCommand(uint8_t seqNum, chip::EndpointId destinationEndpoint, uint8_t * operationalDataset, uint64_t breadcrumb, uint32_t timeoutMs);

/**
 * @brief
 *    Encode an AddWiFiNetwork command for Network Provisioning server into buffer including the APS frame
 */
chip::System::PacketBufferHandle encodeNetworkProvisioningClusterAddWiFiNetworkCommand(uint8_t seqNum, chip::EndpointId destinationEndpoint, uint8_t * ssid, uint8_t * credentials, uint64_t breadcrumb, uint32_t timeoutMs);

/**
 * @brief
 *    Encode an DisableNetwork command for Network Provisioning server into buffer including the APS frame
 */
chip::System::PacketBufferHandle encodeNetworkProvisioningClusterDisableNetworkCommand(uint8_t seqNum, chip::EndpointId destinationEndpoint, uint8_t * networkID, uint64_t breadcrumb, uint32_t timeoutMs);

/**
 * @brief
 *    Encode an EnableNetwork command for Network Provisioning server into buffer including the APS frame
 */
chip::System::PacketBufferHandle encodeNetworkProvisioningClusterEnableNetworkCommand(uint8_t seqNum, chip::EndpointId destinationEndpoint, uint8_t * networkID, uint64_t breadcrumb, uint32_t timeoutMs);

/**
 * @brief
 *    Encode an GetLastNetworkProvisioningResult command for Network Provisioning server into buffer including the APS frame
 */
chip::System::PacketBufferHandle encodeNetworkProvisioningClusterGetLastNetworkProvisioningResultCommand(uint8_t seqNum, chip::EndpointId destinationEndpoint, uint32_t timeoutMs);

/**
 * @brief
 *    Encode an RemoveNetwork command for Network Provisioning server into buffer including the APS frame
 */
chip::System::PacketBufferHandle encodeNetworkProvisioningClusterRemoveNetworkCommand(uint8_t seqNum, chip::EndpointId destinationEndpoint, uint8_t * networkID, uint64_t breadcrumb, uint32_t timeoutMs);

/**
 * @brief
 *    Encode an ScanNetworks command for Network Provisioning server into buffer including the APS frame
 */
chip::System::PacketBufferHandle encodeNetworkProvisioningClusterScanNetworksCommand(uint8_t seqNum, chip::EndpointId destinationEndpoint, uint8_t * ssid, uint64_t breadcrumb, uint32_t timeoutMs);

/**
 * @brief
 *    Encode an UpdateThreadNetwork command for Network Provisioning server into buffer including the APS frame
 */
chip::System::PacketBufferHandle encodeNetworkProvisioningClusterUpdateThreadNetworkCommand(uint8_t seqNum, chip::EndpointId destinationEndpoint, uint8_t * operationalDataset, uint64_t breadcrumb, uint32_t timeoutMs);

/**
 * @brief
 *    Encode an UpdateWiFiNetwork command for Network Provisioning server into buffer including the APS frame
 */
chip::System::PacketBufferHandle encodeNetworkProvisioningClusterUpdateWiFiNetworkCommand(uint8_t seqNum, chip::EndpointId destinationEndpoint, uint8_t * ssid, uint8_t * credentials, uint64_t breadcrumb, uint32_t timeoutMs);

/**
 * @brief
 *    Encode a Network Provisioning server discover command into buffer including the APS frame
 */
chip::System::PacketBufferHandle encodeNetworkProvisioningClusterDiscoverAttributes(uint8_t seqNum, chip::EndpointId destinationEndpoint);

/**
 * @brief
 *    Encode a Network Provisioning server read command for the cluster revision attribute into buffer including the APS frame
 */
chip::System::PacketBufferHandle encodeNetworkProvisioningClusterReadClusterRevisionAttribute(uint8_t seqNum, chip::EndpointId destinationEndpoint);
