...
/*----------------------------------------------------------------------------*\
| Cluster OperationalCredentials                                      | 0xFC03 |
|------------------------------------------------------------------------------|
| Commands:                                                           |        |
| * GetFabricId                                                       |   0x00 |
| * RemoveFabric                                                      |   0x0A |
 ...
 */
chip::System::PacketBufferHandle encodeOperationalCredentialsClusterGetFabricIdCommand(uint8_t seqNum, chip::EndpointId destinationEndpoint);

/**
 * @brief
 *    Encode an RemoveFabric command for Operational Credentials server into buffer including the APS frame
 */
chip::System::PacketBufferHandle encodeOperationalCredentialsClusterRemoveFabricCommand(uint8_t seqNum, chip::EndpointId destinationEndpoint, chip::FabricId fabricId, chip::NodeId nodeId, uint16_t vendorId);

/**
 * @brief
 *    Encode an UpdateFabricLabel command for Operational Credentials server into buffer including the APS frame
 */
chip::System::PacketBufferHandle encodeOperationalCredentialsClusterUpdateFabricLabelCommand(uint8_t seqNum, chip::EndpointId destinationEndpoint, chip::ByteSpan label);
