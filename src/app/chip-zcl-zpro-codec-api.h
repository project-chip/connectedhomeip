...
encodeApplicationLauncherClusterLaunchAppCommand(uint8_t seqNum, chip::EndpointId destinationEndpoint, uint16_t catalogVendorId,
                                                 chip::ByteSpan applicationId, chip::ByteSpan data);
