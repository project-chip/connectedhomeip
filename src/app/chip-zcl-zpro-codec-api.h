...
/**
 * @brief
 *    Encode an GetFabricId command for Fabric server into buffer including the APS frame
 */
chip::System::PacketBufferHandle encodeFabricClusterGetFabricIdCommand(uint8_t seqNum, chip::EndpointId destinationEndpoint);

/**
 * @brief
 *    Encode an RemoveFabric command for Fabric server into buffer including the APS frame
 */
chip::System::PacketBufferHandle encodeFabricClusterRemoveFabricCommand(uint8_t seqNum, chip::EndpointId destinationEndpoint, chip::FabricId fabricId, chip::NodeId nodeId, uint16_t vendorId);
...
/**
 * @brief
 *    Encode a Fabric server discover command into buffer including the APS frame
 */
chip::System::PacketBufferHandle encodeFabricClusterDiscoverAttributes(uint8_t seqNum, chip::EndpointId destinationEndpoint);

/**
 * @brief
 *    Encode a Fabric server read command for the fabrics list attribute into buffer including the APS frame
 */
chip::System::PacketBufferHandle encodeFabricClusterReadFabricsListAttribute(uint8_t seqNum, chip::EndpointId destinationEndpoint);

/**
 * @brief
 *    Encode a Fabric server read command for the cluster revision attribute into buffer including the APS frame
 */
chip::System::PacketBufferHandle encodeFabricClusterReadClusterRevisionAttribute(uint8_t seqNum, chip::EndpointId destinationEndpoint);
