 ...
 */
chip::System::PacketBufferHandle encodeApplicationLauncherClusterLaunchAppCommand(uint8_t seqNum, chip::EndpointId destinationEndpoint, uint16_t catalogVendorId, chip::ByteSpan applicationId, chip::ByteSpan data);
 ...
 */
chip::System::PacketBufferHandle encodeKeypadInputClusterSendKeyCommand(uint8_t seqNum, chip::EndpointId destinationEndpoint, uint8_t keyAction, uint8_t keyCode);
