...
/**
 *    @file
 *      This file defines InvokeRequestMessage parser and builder in CHIP interaction model
 *
 */
...
namespace chip {
namespace app {
CHIP_ERROR InvokeRequestMessage::Parser::Init(const chip::TLV::TLVReader & aReader)
{
    ...
    while (CHIP_NO_ERROR == (err = reader.Next()))
    {
        ...
        case to_underlying(Tag::kSuppressResponse):
...
#if CHIP_DETAIL_LOGGING
            {
                ...
                ReturnLogErrorOnFailure(reader.Get(suppressResponse));
        ...
        case to_underlying(Tag::kTimedRequest):
            ...
            {
                bool timedRequest;
                ReturnLogErrorOnFailure(reader.Get(timedRequest));
...
CHIP_ERROR InvokeRequestMessage::Builder::Init(chip::TLV::TLVWriter * const apWriter)
{
