...
enum
{
    ...
    kCsTag_DeltaUTCTimeStampstamp = 5,
...
public:
    ...
    /**
     *  @brief Inject PriorityLevel into the TLV stream to indicate the importance level associated with
     *  the cluster that is referenced by the path.
     *
     *  @param [in] aPriorityLevel This is an integer representation of the importance level.
     *
