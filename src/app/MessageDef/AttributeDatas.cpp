...
CHIP_ERROR AttributeDatas::Parser::CheckSchemaValidity() const
{
    CHIP_ERROR err        = CHIP_NO_ERROR;
    size_t NumDataElement = 0;
    chip::TLV::TLVReader reader;

    PRETTY_PRINT("AttributeDatas =");
    PRETTY_PRINT("[");
...
AttributeDataIB::Builder & AttributeDatas::Builder::CreateAttributeDataIBBuilder()
{
...
AttributeDataIB::Builder & AttributeDatas::Builder::GetAttributeDataIBBuilder()
{
    return mAttributeDataIBBuilder;
}

AttributeDatas::Builder & AttributeDatas::Builder::EndOfAttributeDatas()
{
    EndOfContainer();
