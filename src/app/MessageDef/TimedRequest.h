...
public:
     ...
     */
    CHIP_ERROR GetTimeoutMilliseconds(uint16_t * const apTimeoutMilliseconds) const;
};
...
public:
     ...
     */
    TimedRequest::Builder & TimeoutMilliseconds(const uint16_t aTimeoutMilliseconds);
};
} // namespace TimedRequest
} // namespace app
} // namespace chip
