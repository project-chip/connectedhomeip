...
/**
 *    @file
 *      This file defines InvokeResponseMessage parser and builder in CHIP interaction model
 *
 */
...
namespace chip {
namespace app {
CHIP_ERROR InvokeResponseMessage::Parser::Init(const chip::TLV::TLVReader & aReader)
{
...
CHIP_ERROR InvokeResponseMessage::Builder::Init(chip::TLV::TLVWriter * const apWriter)
{
