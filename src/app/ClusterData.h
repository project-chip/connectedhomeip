...
/**
 * A AttributePathHandle is a unique 16-bit numerical hash of a IM path relative to the root of a Cluster instance. It has two parts
 * to it:
 *
 ...
 *  - AttributePathHandles can be auto-generated by a Cluster compiler from IDL and is represented as an enumerant
 *    list in the corresponding Cluster's header file.
...
typedef uint16_t AttributePathHandle;
 ...
 *         translate that into a form usable by the IM machinery. This includes converting from PathHandles to IM paths (and vice
...
public:
    ...
    public:
         ...
         * @retval other           Was unable to read out data from the reader.
         */
        virtual CHIP_ERROR SetData(AttributePathHandle aHandle, chip::TLV::TLVReader & aReader, bool aIsNull) = 0;
    ...
    public:
         ...
         * notify. If the path handle is not a leaf node, IM will handle writing values to
         ...
         * ephemeral, or leafs. The expectation is that any Clusters with handles that
         ...
         *
         * @param[out] aIsNull      Is aHandle nullified? If yes, IM will write
         *                          a null element. If aHandle is not a leaf,
         *                          IM will skip over its children.
         *
     ...
     * @retval bool
     */
    bool MatchesClusterId(uint32_t aClusterId) const;
...
protected: // ISetDataDelegate
     ...
     */
    virtual CHIP_ERROR SetData(AttributePathHandle aHandle, chip::TLV::TLVReader & aReader, bool aIsNull) __OVERRIDE;
