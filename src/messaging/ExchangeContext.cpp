...
CHIP_ERROR ExchangeContext::OnAttestedDevice(OperationalCredentialSet * opCredSet, const CertificateKeyId & trustedRootId)
{
    if (mDelegate != nullptr)
    {
        mDelegate->OnReceiveCredentials(this, opCredSet, trustedRootId);
    }
