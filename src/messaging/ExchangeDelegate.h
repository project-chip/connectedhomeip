...
public:
    ...
    /**
     * @brief
     *   This function returns the message dispatch that the exchange context should use
     *   to transmit messages generated by the exchange.
     *
     *  @param[in]    rmMgr         Reliable message manager object pointer
     *  @param[in]    sessionMgr    Secure Session manager object pointer
     *
     *  The objects are expected to be valid for the lifetime of ExchangeMessageDispatch.
     */
