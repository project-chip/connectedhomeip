...
void CheckNewContextTest(nlTestSuite * inSuite, void * inContext)
{
    ...
    NL_TEST_ASSERT(inSuite, ec1->GetSessionHandle()->AsSecureSession()->GetPeerSessionId() == ctx.kBobKeyId);
    ...
    NL_TEST_ASSERT(inSuite, ec2->GetSessionHandle()->AsSecureSession()->GetPeerSessionId() == ctx.kAliceKeyId);
