...
public:
    ...
    ReliableMessageContext(ReliableMessageDelegate & delegate);
...
private:
    ...
    static constexpr const uint16_t kFlagDropAckDebug =
    ...
    CHIP_ERROR HandleNeedsAck(uint32_t MessageId, uint32_t Flags);
