                                                ...
                                                Protocols::Id protocol, uint8_t type, System::PacketBufferHandle && message)
{
        ...
        isReliableTransmission)
    {
        ...
        ReturnErrorOnFailure(mReliableMessageMgr->AddToRetransTable(exchangeContext, &entry));
                                                      ...
                                                      ExchangeHandle exchangeContext)
{
    ...
    if (IsReliableTransmissionAllowed())
    {
        ...
        {
            ReturnErrorOnFailure(reliableMessageContext.HandleRcvdAck(exchangeContext, payloadHeader.GetAckId().Value()));
        }
        ...
        if (payloadHeader.NeedsAck())
        {
            ...
            ReturnErrorOnFailure(reliableMessageContext.HandleNeedsAck(exchangeContext, messageId, msgFlags));
        }
    }
