...
#   run4:
#     app: ${ALL_DEVICES_APP}
#     app-args: --device color-temperature-light:1 --discriminator 1234 --groupcast
#     script-args: >
#       --storage-path admin_storage.json
#       --commissioning-method on-network
#       --discriminator 1234
...
#   run5:
#     app: ${ALL_DEVICES_APP}
#     app-args: --device extended-color-light:1 --discriminator 1234 --groupcast
#     script-args: >
#       --storage-path admin_storage.json
#       --commissioning-method on-network
#       --discriminator 1234
...
from support_modules.TC_S_common import (build_extension_fields, is_writable, read_scenable_value, select_scenable_attribute,
                                         value_other_than)
