...
#     app-args: --discriminator 1234 --KVS kvs1 --trace-to json:${TRACE_APP}.json --app-pipe /tmp/opstate_2_4_fifo
#     script-args: >
#       --endpoint 1
...
class TC_OPSTATE_2_4(MatterTestCommissionedDevice, TC_OPSTATE_BASE):
