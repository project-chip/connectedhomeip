...
class TC_DISHALM_3_5(MatterBaseTest):
    ...
    async def test_TC_DISHALM_3_5(self):
        ...
        if not latch_response & Clusters.DishwasherAlarm.Bitmaps.AlarmMap.kTempTooHigh:
        ...
        if latch_response & Clusters.DishwasherAlarm.Bitmaps.AlarmMap.kTempTooHigh:
            asserts.assert_true(state & Clusters.DishwasherAlarm.Bitmaps.AlarmMap.kTempTooHigh, "Bit 4 of State is not set to 1 while bit 4 of Latch is 1")
        else:
            asserts.assert_false(state & Clusters.DishwasherAlarm.Bitmaps.AlarmMap.kTempTooHigh, "Bit 4 of State is not set to 0 while bit 4 of Latch is 0")
