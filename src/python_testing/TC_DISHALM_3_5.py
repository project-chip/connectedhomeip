...
class TC_DISHALM_3_5(MatterBaseTest):
    ...
    async def test_TC_DISHALM_3_5(self):
        ...
        self.print_step(3, "2a. Operate Device to set the condition to raise the TempTooHigh alarm and wait a few seconds")
        ...
        self.print_step(5, "2c. Operate Device to set the condition to lower the TempTooHigh alarm and wait a few seconds")
        input("Press Enter when done.\n")
        ...
        if latch == 0:
            asserts.assert_false(notify_state & Clusters.DishwasherAlarm.Bitmaps.AlarmMap.kTempTooHigh, "State bit 4 is not set to FALSE")
        ...
        self.print_step(7, "3a. Send to the DUT the Reset Command with bit 4 of Alarms set to 1")
