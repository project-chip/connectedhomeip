...
#     app-args: --discriminator 1234 --KVS /tmp/kvs1 --trace-to json:${TRACE_APP}.json --enable-key 000102030405060708090a0b0c0d0e0f --app-pipe /tmp/smokeco_2_2_fifo
#     script-args: >
...
#       --hex-arg PIXIT.SMOKECO.TEST_EVENT_TRIGGER.WARNING:005c000000000090
#       --hex-arg PIXIT.SMOKECO.TEST_EVENT_TRIGGER.CRITICAL:005c00000000009c
...
class TC_SMOKECO_2_2(SmokeCoBaseTest):
    ...
    async def test_TC_SMOKECO_2_2(self):
        ...
        await self.alarm_primary_functionality_base_test(
            state_attribute=self.smokeco_cluster.Attributes.SmokeState,
            alarm_event=self.smokeco_cluster.Events.SmokeAlarm,
            expressed_state_enum_value=self.smokeco_cluster.Enums.ExpressedStateEnum.kSmokeAlarm,
            pixit_warning=self.pixit_test_event_warning_smoke_alarm,
            pixit_critical=self.pixit_test_event_critical_smoke_alarm,
            pixit_clear=self.pixit_test_event_clear_smoke_alarm
        )
