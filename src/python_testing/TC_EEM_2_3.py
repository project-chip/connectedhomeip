...
class TC_EEM_2_3(MatterBaseTest, EnergyReportingBaseTestHelper):
    ...
    def desc_TC_EEM_2_3(self) -> str:
        ...
        return "5.1.3. [TC-EEM-2.3] Optional periodic imported energy attributes with DUT as Server"
    ...
    def steps_TC_EEM_2_3(self) -> list[TestStep]:
        steps = [
            ...
            TestStep("5a", "TH reads from the DUT the PeriodicEnergyImported attribute. Verify the read is successful and that the value is greater than the value measured in step 2."),
