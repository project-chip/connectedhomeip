...
class TC_EWATERHTR_2_1(MatterBaseTest, EWATERHTRBase):
    ...
    async def test_TC_EWATERHTR_2_1(self):
        ...
        if em_supported:
            ...
            logger.info("Skipping step 5 as PICS.EWATERHTR.F00(EnergyManagement) not supported")
        ...
        if em_supported:
            ...
            logger.info("Skipping step 6 as PICS.EWATERHTR.F00(EnergyManagement) not supported")
        ...
        if tp_supported:
            ...
            logger.info("Skipping step 7 as PICS.EWATERHTR.F01(TankPercenage) not supported")
