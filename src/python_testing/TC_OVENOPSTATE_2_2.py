...
#     app-args: --discriminator 1234 --KVS kvs1 --trace-to json:${TRACE_APP}.json --app-pipe /tmp/ovenopstate_2_2_fifo
#     script-args: >
#       --endpoint 1
...
#       --app-pipe /tmp/ovenopstate_2_2_fifo
#     factory-reset: true
#     quiet: true
...
class TC_OVENOPSTATE_2_2(MatterTestCommissionedDevice, TC_OPSTATE_BASE):
    ...
    def steps_TC_OVENOPSTATE_2_2(self) -> list[TestStep]:
