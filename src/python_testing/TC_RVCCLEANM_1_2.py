...
class TC_RVCCLEANM_1_2(MatterBaseTest):
    ...
    async def read_mod_attribute_expect_success(self, endpoint, attribute):
        cluster = Clusters.Objects.RvcCleanMmode
            ...
            if self.check_pics("RVCCLEANM.S.A0000"):
                ...
                for m in supported_modes:
                    for t in m.modeTags:
                        ...
                        asserts.assert_true(t in commonTags.keys() or t in cleanTags.keys() or is_mfg, "Found a SupportedModes entry with invalid mode tag value!")
