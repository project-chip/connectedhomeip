...
from matter_testing_infrastructure.chip.testing.matter_testing import MatterBaseTest, TestStep, async_test_body, default_matter_test_main, type_matches
from matter_testing_infrastructure.chip.testing.pixit import PIXIT
...
class TC_CNET_4_4(MatterBaseTest):
    ...
    async def test_TC_CNET_4_15(self):
        ...
        # Verify that DUT sends RemoveNetworkResponse command to the TH
        await self.expect_command(Clusters.GeneralCommissioning.Commands.RemoveNetworkResponse, send_remove)
