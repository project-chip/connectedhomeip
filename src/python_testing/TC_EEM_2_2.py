...
class TC_EEM_2_2(MatterBaseTest, EnergyReportingBaseTestHelper):
    ...
    def desc_TC_EEM_2_2(self) -> str:
        ...
        return "5.1.3. [TC-EPM-2.2] Optional cumulative imported energy attributes with DUT as Server"

    def pics_TC_EEM_2_2(self):
        """ This function returns a list of PICS for this test case that must be True for the test to be run"""
        # In this case - there is no feature flags needed to run this test case
        return ["EPM.S", "EPM.S.F02(CUME)", "EPM.S.F00(IMPE)"]
    ...
    def steps_TC_EEM_2_2(self) -> list[TestStep]:
        steps = [
            ...
            TestStep("5a", "TH reads from the DUT the CumulativeEnergyImported attribute. Verify the read is successful and that the value is greater than the value measured in step 2."),
