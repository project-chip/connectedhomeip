...
from chip.testing.matter_testing import (AttributeMatcher, AttributeValue, TestStep,
                                         async_test_body, default_matter_test_main, MatterBaseTest)
        ...
        if is_lt_feature_supported:
            ...
            if not CurrentLatch:
                ...
                if (int(bin(LatchControlModes), 2) & (1 << 1)) == 2:
                    logging.info("RemoteUnlatching is True, proceeding to step 5f")
