...
class TC_VALCC_2_1(MatterBaseTest):
    ...
    async def test_TC_VALCC_2_1(self):
        ...
        if attributes.DefaultOpenDuration.attribute_id in attribute_list:
            default_open_duration_dut = await self.read_single_attribute_check_success(endpoint=endpoint, attribute=attributes.DefaultOpenDuration)
        ...
        if attributes.DefaultOpenLevel.attribute_id in attribute_list:
            default_open_level_dut = await self.read_single_attribute_check_success(endpoint=endpoint, attribute=attributes.DefaultOpenLevel)
        ...
        if attributes.ValveFault.attribute_id in attribute_list:
            valve_fault_dut = await self.read_single_attribute_check_success(endpoint=endpoint, attribute=attributes.ValveFault)
        ...
        if attributes.LevelStep.attribute_id in attribute_list:
            level_step_dut = await self.read_single_attribute_check_success(endpoint=endpoint, attribute=attributes.LevelStep)
