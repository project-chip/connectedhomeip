...
#     app-args: --discriminator 1234 --KVS kvs1 --trace-to json:${TRACE_APP}.json --app-pipe /tmp/opstate_2_1_fifo
#     script-args: >
#       --endpoint 1
...
class TC_OPSTATE_2_1(MatterTestCommissionedDevice, TC_OPSTATE_BASE):
