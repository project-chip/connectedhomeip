...
class TC_SMOKECO_2_4(SmokeCoBaseTest):
    ...
    async def setup_test(self):
        ...
        self.pixit_test_event_battery_clear = self.user_params.get("PIXIT.SMOKECO.TEST_EVENT_TRIGGER.BATTERY.CLEAR", 0x005c0000000000a5)
        self.pixit_test_event_hardware_alert = self.user_params.get("PIXIT.SMOKECO.TEST_EVENT_TRIGGER.HARDWARE.ALERT", 0x005c000000000093)
        self.pixit_test_event_hardware_clear = self.user_params.get("PIXIT.SMOKECO.TEST_EVENT_TRIGGER.HARDWARE.CLEAR", 0x005c0000000000a3)
    ...
    def steps_TC_SMOKECO_2_4(self) -> list[TestStep]:
        return [
            ...
            TestStep(2, "TH subscribes to BatteryAlert attribute from DUT", "Verify that BatteryAlert attribute has a value of 0 (Normal)"),
            ...
            TestStep(6, "TH waits for a report of BatteryAlert attribute from DUT with a timeout of 300 seconds", "Verify that BatteryAlert attribute has a value of 1 (Warning)"),
            TestStep(7, "TH reads ExpressedState attribute from DUT", "Verify that ExpressedState attribute has a value of 3 (BatteryAlert)"),
            TestStep(8, "TH reads LowBattery event from DUT", "Verify that LowBattery event has a new event record and alarmSeverityLevel field indicates the BatteryAlert attribute current value of 1"),
            ...
            TestStep(10, "TH waits for a report of BatteryAlert attribute from DUT with a timeout of 300 seconds", "Verify that BatteryAlert attribute has a value of 2 (Critical)"),
            TestStep(11, "TH reads ExpressedState attribute from DUT", "Verify that ExpressedState attribute has a value of 3 (BatteryAlert)"),
            TestStep(12, "TH reads LowBattery event from DUT", "Verify that LowBattery event has a new event record and alarmSeverityLevel field indicates the BatteryAlert attribute current value of 2"),
            ...
            TestStep(14, "TH waits for a report of BatteryAlert attribute from DUT with a timeout of 300 seconds", "Verify that BatteryAlert attribute has a value of 0 (Normal)"),
            TestStep(15, "TH reads ExpressedState attribute from DUT", "Verify that ExpressedState attribute has a value of 0 (Normal)"),
            TestStep(16, "TH reads AllClear event from DUT", "Verify that AllClear event has a new event record"),
            TestStep(17, "TH subscribes to HardwareFaultAlert attribute from DUT", "Verify that HardwareFaultAlert attribute has a value of 0 (False)"),
            ...
            TestStep(19, "TH waits for a report of HardwareFaultAlert attribute from DUT with a timeout of 300 seconds", "Verify that HardwareFaultAlert attribute has a value of 1 (True)"),
            TestStep(20, "TH reads ExpressedState attribute from DUT", "Verify that ExpressedState attribute has a value of 5 (HardwareFault)"),
            ...
            TestStep(23, "TH waits for a report of HardwareFaultAlert attribute from DUT with a timeout of 300 seconds", "Verify that HardwareFaultAlert attribute has a value of 0 (False)"),
            TestStep(24, "TH reads ExpressedState attribute from DUT", "Verify that ExpressedState attribute has a value of 0 (Normal)"),
            TestStep(25, "TH reads AllClear event from DUT", "Verify that AllClear event has a new event record"),
            TestStep(26, "TH subscribes to EndOfServiceAlert attribute from DUT", "Verify that EndOfServiceAlert attribute has a value of 0 (Normal)"),
            ...
            TestStep(28, "TH waits for a report of EndOfServiceAlert attribute from DUT with a timeout of 300 seconds", "Verify that EndOfServiceAlert attribute has a value of 1 (Expired)"),
            TestStep(29, "TH reads ExpressedState attribute from DUT", "Verify that ExpressedState attribute has a value of 6 (EndOfService)"),
            ...
            TestStep(32, "TH waits for a report of EndOfServiceAlert attribute from DUT with a timeout of 300 seconds", "Verify that EndOfServiceAlert attribute has a value of 0 (Normal)"),
            TestStep(33, "TH reads ExpressedState attribute from DUT", "Verify that ExpressedState attribute has a value of 0 (Normal)"),
            TestStep(34, "TH reads AllClear event from DUT", "Verify that AllClear event has a new event record"),
            TestStep(35, "TH subscribes to TestInProgress attribute from DUT", "Verify that TestInProgress attribute has a value of 0 (False)"),
            TestStep(36, "TH reads ExpressedState attribute from DUT", "Verify that ExpressedState attribute has a value of 0 (Normal)"),
            TestStep(37, "Start manually DUT self-test"),
            TestStep(38, "TH waits for a report of TestInProgress attribute from DUT with a timeout of 180 seconds", "Verify that TestInProgress attribute has a value of 1 (True)"),
            TestStep(39, "TH reads ExpressedState attribute from DUT", "Verify that ExpressedState attribute has a value of 4 (Testing)"),
            TestStep(40, "TH waits for a report of TestInProgress attribute from DUT with a timeout of 180 seconds", "Verify that TestInProgress attribute has a value of 0 (False)"),
            TestStep(41, "TH reads SelfTestComplete event from DUT", "Verify that SelfTestComplete event has a new event record"),
            TestStep(42, "TH reads ExpressedState attribute from DUT", "Verify that ExpressedState attribute has a value of 0 (Normal)"),
            ...
            TestStep(45, "TH waits for a report of TestInProgress attribute from DUT with a timeout of 180 seconds", "Verify that TestInProgress attribute has a value of 1 (True)"),
            TestStep(46, "TH reads ExpressedState attribute from DUT", "Verify that ExpressedState attribute has a value of 4 (Testing)"),
            TestStep(47, "TH waits for a report of TestInProgress attribute from DUT with a timeout of 180 seconds", "Verify that TestInProgress attribute has a value of 0 (False)"),
            TestStep(48, "TH reads SelfTestComplete event from DUT", "Verify that SelfTestComplete event has a new event record"),
            TestStep(49, "TH reads ExpressedState attribute from DUT", "Verify that ExpressedState attribute has a value of 0 (Normal)"),
