...
class TC_OCC_2_3(MatterBaseTest):
    ...
    async def test_TC_OCC_2_3(self):
        ...
        if occupancy_sensor_type_dut is 0:
            ...
            if occupancy_pir_otou_delay_dut is not NullValue:
            ...
            if occupancy_us_otou_delay_dut is not NullValue:
            ...
            if occupancy_pirus_otou_delay_dut is not NullValue:
            ...
            if occupancy_phy_otou_delay_dut is not NullValue:
