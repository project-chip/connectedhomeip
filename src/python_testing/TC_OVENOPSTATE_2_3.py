...
# test-runner-run/run1/script-args: --endpoint 1 --int-arg PIXIT.WAITTIME.COUNTDOWN:5 --storage-path admin_storage.json --commissioning-method on-network --discriminator 1234 --passcode 20202021 --PICS src/app/tests/suites/certification/ci-pics-values --trace-to json:${TRACE_TEST_JSON}.json --trace-to perfetto:${TRACE_TEST_PERFETTO}.perfetto
...
class TC_OVENOPSTATE_2_3(MatterBaseTest, TC_OPSTATE_BASE):
    ...
    def steps_TC_OVENOPSTATE_2_3(self) -> list[TestStep]:
        return self.STEPS_TC_OPSTATE_BASE_2_3()

    def pics_TC_OVENOPSTATE_2_3(self) -> list[str]:
