...
class TC_ACS_3_3(MatterBaseTest):
    ...
    async def test_TC_ACS_3_3(self):
        ...
        self.step(3, "If DUT supports HumanActivity feature, prepare DUT with an undetected HumanActivityDetect attribute state.")
        ...
        self.step(4d, "TH receives AmbientContextDetectStarted event and reads AmbientContextDetected field.",
                  "Verify that the AmbientContextSensed struct data of AmbientContextDetected field contains the namespace ID and tag ID of the step 3b triggering event.",
                  "Store the event time generated by this AmbientContextDetectStarted event."),
        self.step(4e, "Wait until HoldTime seconds expires represented by PIXIT.ACS.Holdtime from the step 4b.")
        ...
        self.step(6b, "Change ObjectCountThreshold with 2 and the DUT counting object type represented by PIXIT.ACS.Event2_NSID and PIXIT.ACS.Event2_TAGID.")
        self.step(6c,
