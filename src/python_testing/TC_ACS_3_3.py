...
class TC_ACS_3_3(MatterBaseTest):
    ...
    def steps_TC_ACS_3_3(self) -> list[TestStep]:
        return [
            ...
            TestStep("3e", "Wait until PIXIT.ACS.HoldTimeTest seconds are passed."),
            ...
            TestStep("4d", "TH receives AmbientContextDetectStarted event and reads AmbientContextType field.",
                     ...
                     "Store the event number generated by this AmbientContextDetectStarted event."),
            TestStep("4e", "Wait until PIXIT.ACS.HoldTimeTest seconds are passed."),
            ...
            TestStep("5d", "TH receives AmbientContextDetectStarted event and reads AmbientContextType field.",
                     ...
                     "Store the event number generated by this AmbientContextDetectStarted event."),
            TestStep("5e", "Wait until PIXIT.ACS.HoldTimeTest seconds are passed."),
            ...
            TestStep("6a",
                     ...
                     "Set ObjectCountThreshold with PIXIT.ACS.ObjectCountThreshold_OC."),
            ...
            TestStep("6c",
                     ...
                     "Verify that the CountingObject field of ObjectCountConfig attribute contains the namespace ID ant tag of PIXIT.ACS.AmbientContextSensed_2 and the ObjectCountThreshold field of ObjectCountConfig attribute contains PIXIT.ACS.ObjectCountThreshold_OC"),
            TestStep("6d", "TH receives AmbientContextDetectStarted event.",
                     "Verify that if DUT supports ObjectCount, ObjectCount event field is greater than equal to PIXIT.ACS.ObjectCountThreshold_OC.",
                     "Store the event number generated by this AmbientContextDetectStarted event."),
