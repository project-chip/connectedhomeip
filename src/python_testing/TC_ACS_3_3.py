...
# --app-args "--KVS kvs1 --discriminator 1234 --app-pipe /tmp/acs_fifo_3_3" --script src/python_testing/TC_ACS_3_3.py
...
class TC_ACS_3_3(MatterBaseTest):
    ...
    def steps_TC_ACS_3_3(self) -> list[TestStep]:
        return [
            ...
            TestStep("3b", "DUT is triggered with a human activity ambient sensing event represented by PIXIT.ACS.Event1_NSID and PIXIT.ACS.Event1_TAGID."),
            ...
            TestStep("3e", "Wait until HoldTime seconds represented by PIXIT.ACS.Holdtime expires from the step 3b."),
            ...
            TestStep("4b", "DUT is triggered with object identification sensing event represented by PIXIT.ACS.Event2_NSID and PIXIT.ACS.Event2_TAGID."),
            TestStep("4c",
            ...
            TestStep("4d", "TH receives AmbientContextDetectStarted event and reads AmbientContextDetected field.",
                     "Verify that the AmbientContextSensed struct data of AmbientContextDetected field contains the namespace ID and tag ID of the step 3b triggering event.",
                     "Store the event time generated by this AmbientContextDetectStarted event."),
            TestStep("4e", "Wait until HoldTime seconds expires represented by PIXIT.ACS.Holdtime from the step 4b."),
            ...
            TestStep("5b", "DUT is triggered with audio context sensing event represented by PIXIT.ACS.Event3_NSID and PIXIT.ACS.Event3_TAGID."),
            TestStep("5c",
            ...
            TestStep("5d", "TH receives AmbientContextDetectStarted event and reads AmbientContextDetected field.",
                     ...
                     "Store the event time generated by this AmbientContextDetectStarted event."),
            TestStep("5e", "Wait until HoldTime seconds represented by PIXIT.ACS.Holdtime expires from the step 5b."),
            ...
            TestStep("6b", "Change ObjectCountThreshold with 2 and the DUT counting object type represented by PIXIT.ACS.Event2_NSID and PIXIT.ACS.Event2_TAGID."),
            TestStep("6c",
            ...
            TestStep("6d", "DUT is triggered with object counting event with the number of the object greater than equal to 2."),
            TestStep("6e",
            ...
            TestStep("6f", "TH receives AmbientContextDetectStarted event.",
                     ...
                     "Store the event time generated by this AmbientContextDetectStarted event."),
            TestStep("6g", "Wait until HoldTime seconds represented by PIXIT.ACS.Holdtime are passed since step 6d."),
