...
class TC_EEVSE_2_3(MatterBaseTest, EEVSEBaseTestHelper):
    ...
    def steps_TC_EEVSE_2_3(self) -> list[TestStep]:
        steps = [
            ...
            TestStep("4", "TH sends TestEventTrigger command to General Diagnostics Cluster on Endpoint 0 with EnableKey field set to PIXIT.EEVSE.TEST_EVENT_TRIGGER_KEY and EventTrigger field set to PIXIT.EEVSE.TEST_EVENT_TRIGGER for EVSE TimeOfUse Mode Test Event. Verify Command response is Success"),
            TestStep("5", "TH sends TestEventTrigger command to General Diagnostics Cluster on Endpoint 0 with EnableKey field set to PIXIT.EEVSE.TEST_EVENT_TRIGGER_KEY and EventTrigger field set to PIXIT.EEVSE.TEST_EVENT_TRIGGER for EV Plugged-in Test Event. Verify Command response is Success and event DEM.S.E00(EVConnected) sent"),
            TestStep("6", "TH sends ClearTargets. Verify Command response is Success"),
            TestStep("6a", "TH reads NextChargeStartTime attribute. Verify value is null."),
            TestStep("6b", "TH reads NextChargeTargetTime attribute. Verify value is null."),
            TestStep("6c", "TH reads NextChargeRequiredEnergy attribute. Verify value is null."),
            TestStep("6d", "TH reads NextChargeTargetSoC attribute. Verify value is null."),
            TestStep("7", "TH sends GetTargets. Response DEM.S.C00.Tx(GetTargetsResponse) sent with no targets defined."),
            TestStep("8", "TH sends SetTargets with DayOfTheWeekforSequence=0x7F (i.e. having all days set) and a single ChargingTargets={TargetTime=1439, TargetSoC=null, AddedEnergy=25000000}. Verify Command response is Success"),
            TestStep("8a", "TH reads NextChargeStartTime attribute. Verify value is null."),
            TestStep("8b", "TH reads NextChargeTargetTime attribute. Verify value is null."),
            ...
            TestStep("9", "TH sends EnableCharging with ChargingEnabledUntil=null, minimumChargeCurrent=6000, maximumChargeCurrent=60000. Verify Command response is Success"),
            TestStep("9a", "TH reads NextChargeStartTime attribute. Verify value is before the next TargetTime above."),
            TestStep("9b", "TH reads NextChargeTargetTime attribute. Verify value is TargetTime above."),
            TestStep("9c", "TH reads NextChargeRequiredEnergy attribute. Verify value is AddedEnergy above."),
            TestStep("9d", "TH reads NextChargeTargetSoC attribute. Verify value is null."),
            TestStep("10", "TH sends GetTargets. Response DEM.S.C00.Tx(GetTargetsResponse) sent with targets equivalent to the above (Note 1)."),
            TestStep("11", "TH sends SetTargets with DayOfTheWeekforSequence=0x7F (i.e. having all days set) and a single ChargingTargets={TargetTime=1, TargetSoC=100, AddedEnergy=null}. Verify Command response is Success"),
            TestStep("11a", "TH reads NextChargeStartTime attribute. Verify value is before the next TargetTime above."),
            TestStep("11b", "TH reads NextChargeTargetTime attribute. Verify value is TargetTime above."),
            TestStep("11c", "TH reads NextChargeRequiredEnergy attribute. Verify value is null."),
            TestStep("11d", "TH reads NextChargeTargetSoC attribute. Verify value is 100."),
            TestStep("12", "TH sends GetTargets. Response DEM.S.C00.Tx(GetTargetsResponse) sent with targets equivalent to the above (Note 1)."),
            TestStep("13", "TH sends SetTargets with DayOfTheWeekforSequence=0x40 (i.e. having Saturday set) and 10 ChargingTargets with TargetTimes=60,180,300,420,540,660,780,900,1020,1140 and all with TargetSoC=null, AddedEnergy=2500000. Verify Command response is Success"),
            TestStep("14", "TH sends SetTargets with DayOfTheWeekforSequence=0x01 (i.e. having Sunday set) and no ChargingTargets. Verify Command response is Success"),
            TestStep("15", "TH sends GetTargets. Response DEM.S.C00.Tx(GetTargetsResponse) sent with 1 target for each day Monday to Friday equivalent to step 9 (Note 1), 10 targets for Saturday as step 11, and no targets for Sunday."),
            TestStep("16", "TH sends ClearTargets. Verify Command response is Success"),
            TestStep("16a", "TH reads NextChargeStartTime attribute. Verify value is null."),
            TestStep("16b", "TH reads NextChargeTargetTime attribute. Verify value is null."),
            TestStep("16c", "TH reads NextChargeRequiredEnergy attribute. Verify value is null."),
            TestStep("16d", "TH reads NextChargeTargetSoC attribute. Verify value is null."),
            TestStep("17", "TH sends GetTargets. Response DEM.S.C00.Tx(GetTargetsResponse) sent with no targets defined."),
            TestStep("18", "TH sends SetTargets with two identical ChargingTargetSchedules={DayOfTheWeekforSequence=0x01,ChargingTarget[0]={TargetTime=60,TargetSoC=null,AddedEnergy=2500000}}. Verify Command response is ConstraintError"),
            TestStep("19", "TH sends SetTargets with DayOfTheWeekforSequence=0x40 and 11 ChargingTargets with TargetTimes=60,180,300,420,540,660,780,900,1020,1140,1260 and all with TargetSoC=null, AddedEnergy=2500000. Verify Command response is ResourceExhausted"),
            ...
            TestStep("21", "TH sends TestEventTrigger command to General Diagnostics Cluster on Endpoint 0 with EnableKey field set to PIXIT.EEVSE.TEST_EVENT_TRIGGER_KEY and EventTrigger field set to PIXIT.EEVSE.TEST_EVENT_TRIGGER for Basic Functionality Test Event Clear. Verify Command response is Success"),
        ]
