...
class TC_MCORE_FS_1_1(MatterBaseTest):
    ...
    async def test_TC_MCORE_FS_1_1(self):
        ...
        self.step(2)
        self.step(3)
        th_fsa_server_fabrics = await self.read_single_attribute_check_success(attribute=Clusters.OperationalCredentials.Attributes.Fabrics, dev_ctrl=self.TH_server_controller, node_id=self.server_nodeid, endpoint=0)
        th_fsa_server_vid = await self.read_single_attribute_check_success(attribute=Clusters.BasicInformation.Attributes.VendorID, dev_ctrl=self.TH_server_controller, node_id=self.server_nodeid, endpoint=0)
        th_fsa_server_pid = await self.read_single_attribute_check_success(attribute=Clusters.BasicInformation.Attributes.ProductID, dev_ctrl=self.TH_server_controller, node_id=self.server_nodeid, endpoint=0)
        ...
        th_fsa_server_fabrics_new = await self.read_single_attribute_check_success(attribute=Clusters.OperationalCredentials.Attributes.Fabrics, dev_ctrl=self.TH_server_controller, node_id=self.server_nodeid, endpoint=0)
