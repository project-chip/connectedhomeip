...
class MatterBaseTest(base_test.BaseTestClass):
    ...
    async def read_single_attribute_check_success(
            ...
            dev_ctrl: ChipDeviceCtrl = None, node_id: int = None, endpoint: int = 0, assert_on_error: bool = True, test_name: str = "") -> object:
        if dev_ctrl is None:
    ...
    async def read_single_attribute_expect_error(
            ...
            error: Status, dev_ctrl: ChipDeviceCtrl = None, node_id: int = None, endpoint: int = 0,
