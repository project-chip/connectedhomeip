...
#       --hex-arg PIXIT.SMOKECO.TEST_EVENT_TRIGGER.INTERCONNECTSMOKEALARM:0x005c000000000092
#       --hex-arg PIXIT.SMOKECO.TEST_EVENT_TRIGGER.INTERCONNECTSMOKEALARM.CLEAR:0x005c0000000000a2
#       --hex-arg PIXIT.SMOKECO.TEST_EVENT_TRIGGER.INTERCONNECTCOALARM:0x005c000000000094
#       --hex-arg PIXIT.SMOKECO.TEST_EVENT_TRIGGER.INTERCONNECTCOALARM.CLEAR:0x005c0000000000a4
#       --hex-arg PIXIT.SMOKECO.TEST_EVENT_TRIGGER.CONTAMINATIONSTATE.HIGH:0x005c000000000096
#       --hex-arg PIXIT.SMOKECO.TEST_EVENT_TRIGGER.CONTAMINATIONSTATE.LOW:0x005c000000000097
#       --hex-arg PIXIT.SMOKECO.TEST_EVENT_TRIGGER.CONTAMINATIONSTATE.CLEAR:0x005c0000000000a6
#       --hex-arg PIXIT.SMOKECO.TEST_EVENT_TRIGGER.SMOKESENSITIVITY.HIGH:0x005c000000000098
#       --hex-arg PIXIT.SMOKECO.TEST_EVENT_TRIGGER.SMOKESENSITIVITY.LOW:0x005c000000000099
#       --hex-arg PIXIT.SMOKECO.TEST_EVENT_TRIGGER.SMOKESENSITIVITY.CLEAR:0x005c0000000000a8
#       --hex-arg PIXIT.SMOKECO.TEST_EVENT_TRIGGER.SMOKEALARM.WARNING:0x005c000000000090
#       --hex-arg PIXIT.SMOKECO.TEST_EVENT_TRIGGER.SMOKEALARM.CRITICAL:0x005c00000000009c
#       --hex-arg PIXIT.SMOKECO.TEST_EVENT_TRIGGER.SMOKEALARM.CLEAR:0x005c0000000000a0
#       --hex-arg PIXIT.SMOKECO.TEST_EVENT_TRIGGER.COALARM.WARNING:0x005c000000000091
#       --hex-arg PIXIT.SMOKECO.TEST_EVENT_TRIGGER.COALARM.CRITICAL:0x005c00000000009d
#       --hex-arg PIXIT.SMOKECO.TEST_EVENT_TRIGGER.COALARM.CLEAR:0x005c0000000000a1
...
class TC_SMOKECO_2_5(SmokeCoBaseTest):
    ...
    async def setup_test(self):
        ...
        # Process pixit arguments and convert to bytes if needed
