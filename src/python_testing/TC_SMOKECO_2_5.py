...
class TC_SMOKECO_2_5(SmokeCoBaseTest):
    ...
    async def test_TC_SMOKECO_2_5(self):
        ...
        self.step(23)
        if await self.attribute_guard(endpoint=self.get_endpoint(), cluster=self.smokeco_cluster, feature_int=self.smokeco_cluster.Bitmaps.Feature.kSmokeAlarm):
        ...
        if await self.attribute_guard(endpoint=self.get_endpoint(), cluster=self.smokeco_cluster, feature_int=self.smokeco_cluster.Bitmaps.Feature.kCoAlarm):
            self.step(59)
