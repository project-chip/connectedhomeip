...
class TC_CGEN_2_9(MatterTestCommissioner):
    ...
    async def remove_commissioner_fabric(self):
        ...
        log.info("Commissioner's fabricIndex on DUT: %s", commissioner_fabric_index_on_dut)
        ...
        log.info("Fabrics table on DUT: %s", fabrics)
