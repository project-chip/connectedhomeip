...
class TC_DGGEN_2_5(MatterTestCommissionedDevice):
    ...
    async def test_TC_DGGEN_2_5(self):
        ...
        th2FabricIndex = await self.read_single_attribute(dev_ctrl=self.th2, node_id=self.dut_node_id, endpoint=endpoint, attribute=Clusters.OperationalCredentials.Attributes.CurrentFabricIndex)
