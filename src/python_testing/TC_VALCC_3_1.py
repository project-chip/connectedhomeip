...
class TC_VCC_3_1(MatterBaseTest):
    ...
    def desc_TC_VCC_3_1(self) -> str:
        return "[TC-VCC-3.1] Basic state functionality with DUT as Server"
    ...
    def pics_TC_VCC_3_1(self) -> list[str]:
        pics = [
            "VCC.S",
        ]
        return pics
    ...
    @async_test_body
    async def test_TC_VCC_3_1(self):
