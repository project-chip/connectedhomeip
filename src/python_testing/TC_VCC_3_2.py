...
class TC_VCC_3_2(MatterBaseTest):
    ...
    def desc_TC_VCC_3_2(self) -> str:
        return "[TC-VCC-3.2] Basic level functionality with DUT as Server"

    def steps_TC_VCC_3_2(self) -> list[TestStep]:
        steps = [
    ...
    def pics_TC_VCC_3_2(self) -> list[str]:
        pics = [
            "VCC.S",
        ]
        return pics
    ...
    @async_test_body
    async def test_TC_VCC_3_2(self):
