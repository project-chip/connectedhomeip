...
class TC_RVCRUNM_1_2(MatterBaseTest):
    ...
    async def read_mod_attribute_expect_success(self, endpoint, attribute):
        cluster = Clusters.Objects.RvcRunMmode
            ...
            if self.check_pics("RVCRUNM.S.A0000"):
                ...
                for m in supported_modes:
                    for t in m.modeTags:
                        ...
                        asserts.assert_true(t in commonTags.keys() or t in runTags.keys() or is_mfg, "Found a SupportedModes entry with invalid mode tag value!")
