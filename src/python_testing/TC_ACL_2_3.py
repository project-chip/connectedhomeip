...
class TC_ACL_2_3(MatterBaseTest):
    ...
    async def internal_test_TC_ACL_2_3(self, force_legacy_encoding: bool):
        ...
        log.info("AccessControlExtension: %s", ac_extension_value0)
        ...
        log.info("Write result: %s", result1)
        ...
        log.info("AccessControlExtension: %s", ac_extension_value1)
        ...
        log.info("Write result: %s", result2)
        asserts.assert_equal(
        ...
        log.info("AccessControlExtension: %s", ac_extension_value2)
        ...
        log.info("Write result: %s", result3)
        asserts.assert_equal(
        ...
        log.info("AccessControlExtension: %s", ac_extension_value3)
        ...
        log.info("Write result: %s", result4)
        asserts.assert_equal(
        ...
        log.info("Write result: %s", result5)
        asserts.assert_equal(
        ...
        log.info("Write result: %s", result6)
        asserts.assert_equal(
        ...
        log.info("Write result: %s", result7)
        asserts.assert_equal(
        ...
        log.info("Write result: %s", result8)
        asserts.assert_equal(
        ...
        log.info("Write result: %s", result9)
        asserts.assert_equal(
        ...
        log.info("Write result: %s", result10)
        asserts.assert_equal(
        ...
        log.info("Write result: %s", result11)
        asserts.assert_equal(
            result11[0].Status,
        ...
        log.info("AccessControlExtension: %s", ac_extension_value4)
        ...
        log.info("Write result: %s", result12)
        asserts.assert_equal(
        ...
        log.info("AccessControlExtension: %s", ac_extension_value5)
