...
D_BAD_LIST = bytes.fromhex('3701D00000F1FF01003D48656C6C6F20576F726C642E205468697320697320612073696E676C6520656C656D656E74206C6976696E6720617320612063686172737472696E670018')
D_BAD_ELEM = bytes.fromhex('17103D48656C6C6F20576F726C642E205468697320697320612073696E676C6520656C656D656E74206C6976696E6720617320612063686172737472696E670018')
D_BAD_OVERFLOW = bytes.fromhex('17D00000F1FF01003D48656C6C6F20576F726C642E205468697320697320612073696E676C6520656C656D656E74206C6976696E6720617320612063686172737472696E670018FF')
D_BAD_UNDERFLOW = bytes.fromhex('17D00000F1FF01003D48656C6C6F20576F726C642E205468697320697320612073696E676C6520656C656D656E74206C6976696E6720617320612063686172737472696E6700')
...
class TC_ACL_2_3(MatterBaseTest):
    ...
    async def test_TC_ACL_2_3(self):
        ...
        asserts.assert_equal(
            result11[0].Status, Status.ConstraintError, f"Write should have returned a SUCCESS for struct 1, CONSTRAINT_ERROR for struct 2")
        ...
        asserts.assert_equal(ac_extension_value4[0].data, D_OK_FULL, "AccessControlExtension is D_OK_FULL from test step 8 as last successfully written extension")
