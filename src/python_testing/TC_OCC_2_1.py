...
class TC_OCC_2_1(MatterBaseTest):
    ...
    async def test_TC_OCC_2_1(self):
        ...
        if attributes.Occupancy.attribute_id in attribute_list:
            ...
            logging.info("Occupancy attribute is a mandatory attribute. Test step fails.")logging.info()
        ...
        if attributes.OccupancySensorType.attribute_id in attribute_list:
            ...
            logging.info("This attribute is a mandatory attribute. Test step fails")
        ...
        if attributes.HoldTimeLimits.attribute_id in attribute_list:
            if attributes.HoldTime.attribute_id in attribute_list: # check HoldTime conformance
                ...
                loggin.info("HoldTime conformance violation.  Test step skipped")
        else:
        ...
        self.step(7)
        if (attributes.PIROccupiedToUnoccupiedDelay.attribute_id in attribute_list) & ((occupancy_sensor_type_bitmap_dut == 0b00000001) | ((occupancy_sensor_type_bitmap_dut != 0b00000001)&(occupancy_sensor_type_bitmap_dut != 0b00000010)&(occupancy_sensor_type_bitmap_dut != 0b00000100))):
        ...
        self.step(8)
        if (attributes.PIRUnoccupiedToOccupiedDelay.attribute_id in attribute_list) & (attributes.PIRUnoccupiedToOccupiedThreshold.attribute_id in attribute_list):
        ...
        self.step(9)
        if (attributes.PIRUnoccupiedToOccupiedThreshold.attribute_id in attribute_list) & (attributes.PIRUnoccupiedToOccupiedDelay.attribute_id in attribute_list):
        ...
        self.step(10)
        if attributes.UltrasonicOccupiedToUnoccupiedDelay.attribute_id in attribute_list & (occupancy_sensor_type_bitmap_dut == 0b00000010):
        ...
        self.step(11)
        if attributes.UltrasonicUnoccupiedToOccupiedDelay.attribute_id in attribute_list & attributes.UltrasonicUnoccupiedToOccupiedThreshold.attribute_id in attribute_list:
        ...
        self.step(12)
        if attributes.UltrasonicUnoccupiedToOccupiedThreshold.attribute_id in attribute_list & attributes.UltrasonicUnoccupiedToOccupiedDelay.attribute_id in attribute_list:
        ...
        self.step(13)
        if attributes.PhysicalContactOccupiedToUnoccupiedDelay.attribute_id in attribute_list & (occupancy_sensor_type_bitmap_dut == 0b00000100):
        ...
        self.step(14)
        if attributes.PhysicalContactUnoccupiedToOccupiedDelay.attribute_id in attribute_list & attributes.PhysicalContactUnoccupiedToOccupiedThreshold.attribute_id in attribute_list:
        ...
        self.step(15)
        if attributes.PhysicalContactUnoccupiedToOccupiedThreshold.attribute_id in attribute_list & attributes.PhysicalContactUnoccupiedToOccupiedDelay.attribute_id in attribute_list:
