...
class TC_DISHALM_3_1(MatterBaseTest):
    ...
    async def test_TC_DISHALM_3_1(self):
        ...
        self.print_step("2a", "Operate Device to set the condition to raise the Inflow alarm and wait a few seconds")
        ...
        if not latch_response & Clusters.DishwasherAlarm.Bitmaps.AlarmMap.kInflowError:
