...
#   run1:
#     app: ${CHIP_RVC_APP}
#     app-args: --discriminator 1234 --KVS kvs1 --trace-to json:${TRACE_APP}.json --app-pipe /tmp/rvccleanm_2_1_fifo
#     script-args: >
...
#       --endpoint 1
#       --app-pipe /tmp/rvccleanm_2_1_fifo
...
#   run2:
#     app: ${ALL_DEVICES_APP}
#     app-args: --discriminator 1234 --KVS kvs1 --device robotic-vacuum-cleaner --trace-to json:${TRACE_APP}.json --app-pipe /tmp/rvccleanm_2_1_fifo
#     script-args: >
#       --PICS examples/rvc-app/rvc-common/pics/rvc-app-pics-values
#       --storage-path admin_storage.json
#       --commissioning-method on-network
