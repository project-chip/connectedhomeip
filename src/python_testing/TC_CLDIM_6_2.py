...
class TC_CLDIM_6_2(MatterBaseTest):
    ...
    def desc_TC_CLDIM_6_2(self) -> str:
        return "[TC-CLDIM-6.2] GroupedStep Command Input Sanity Check with DUT as Server"
    ...
    def pics_TC_CLDIM_6_2(self) -> list[str]:
        return [
    ...
    @async_test_body
    async def test_TC_CLDIM_6_2(self):
        ...
        # STEP 3: Send GroupedStep command with invalid Direction
        self.step(3)
        try:
            await self.send_single_cmd(
        ...
        # STEP 4: Send GroupedStep command with invalid Speed
        self.step(4)
