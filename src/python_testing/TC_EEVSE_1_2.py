...
class TC_EEVSE_1_2(MatterBaseTest, ModeBaseClusterChecks):
    ...
    def desc_TC_EEVSE_1_2(self) -> str:
        return "[TC-EEVSE-1.2] Cluster attributes with DUT as Server"

    def steps_TC_EEVSE_1_2(self) -> list[TestStep]:
        steps = [
    ...
    def pics_TC_EEVSE_1_2(self) -> list[str]:
        pics = [
            "EEVSE.S"
        ]
        return pics
    ...
    @async_test_body
    async def test_TC_EEVSE_1_2(self):
        ...
        self.step(2)
        # Verify common checks for Mode Base as described in the TC-EEVSE-1.2
