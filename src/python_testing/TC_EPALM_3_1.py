...
class TC_EPALM_3_1(ElectricalProtectionAlarmTestBaseHelper):
    ...
    async def test_TC_EPALM_3_1(self):
        ...
        self.step("1c", "TH reads the Supported attribute",
                  expectation="Bit 0 of the response SHALL be 1.")
        ...
        try:
            ...
            self.step("2b", "TH reads the State attribute", expectation="Bit 0 of the response SHALL be 1.")
            ...
            self.step("3b", "TH reads the State attribute", expectation="Bit 0 of the response SHALL be 0.")
            asserts.assert_false(await self.read_state(endpoint) & ALARM_MASK,
