    ...
    async def test_TC_PAVSTI_1_2(self):
        ...
        if not self.check_pics("PICS_SDK_CI_ONLY"):
            skipped = self.user_verify_push_av_stream(
                prompt_msg=(
                    "Verify the video stream is being transmitted by playing the live video and viewing the uploaded contents.\n"
