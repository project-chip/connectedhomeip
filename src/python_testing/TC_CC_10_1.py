...
class TC_CC_10_1(MatterBaseTest):
    ...
    def steps_TC_CC_10_1(self) -> list[TestStep]:
        steps = [
            ...
            TestStep("10b", "TH sends a _RecallScene_ command to DUT with the _GroupID_ field set to _G~1~_, the _SceneID_ field set to 0x05 and the _TransitionTime_ omitted."),
