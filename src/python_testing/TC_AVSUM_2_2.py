...
from matter.testing.matter_testing import AttributeMatcher, MatterBaseTest, TestStep, default_matter_test_main, has_cluster, run_if_endpoint_matches
...
class TC_AVSUM_2_2(MatterBaseTest, AVSUMTestBase):
    ...
    def steps_TC_AVSUM_2_2(self) -> list[TestStep]:
        steps = [
            ...
            TestStep(5, "If Pan is supported, read and verify the PanMin attribute. If not skip to step 8"),
            ...
            TestStep(9, "Wait on the subscription report showing movement complete, then read MPTZPosition. Verify the Pan value is that set in Step 4."),
            TestStep(10, "If PIXIT.CANBEMADEBUSY is set, place the DUT into a state where it cannot accept a command. Else jump to step 11."),
            ...
            TestStep(14, "Read MPTZPosition. Verify the Pan value is that set in Step 4."),
            TestStep(15, "If Tilt is supported, read and verify the TiltMin and TiltMax attributes. If not skip to step 13"),
            ...
            TestStep(19, "Wait on the subscription report showing movement complete, then read MPTZPosition. Verify the Tilt value is that set in Step 9."),
            ...
            TestStep(22, "Read MPTZPosition. Verify the Tilt value is that set in Step 9."),
            ...
            TestStep(26, "Wait on the subscription report showing movement complete, then read MPTZPosition. Verify the Zoom value is that set in Step 14."),
            ...
            TestStep(29, "Read MPTZPosition. Verify the Tilt value is that set in Step 14."),
        ]
        return steps
