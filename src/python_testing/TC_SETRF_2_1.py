...
class SETRF_2_1(MatterBaseTest):
    ...
    async def test_SETRF_2_1(self):
        ...
        if val is not NullValue:
            ...
            matter_asserts.assert_list_element_type(
                val, "DayEntries attribute must contain DayEntryStruct elements", cluster.Structs.DayEntryStruct)
            for item in val:
        ...
        if val is not NullValue:
            ...
            matter_asserts.assert_list_element_type(
                val, "DayPatterns attribute must contain DayPatternStruct elements", cluster.Structs.DayPatternStruct)
            for item in val:
        ...
        if val is not NullValue:
            ...
            matter_asserts.assert_list_element_type(
                val, "CalendarPeriods attribute must contain CalendarPeriodStruct elements", cluster.Structs.CalendarPeriodStruct)
            for item in val:
        ...
        if val is not NullValue:
            ...
            matter_asserts.assert_list_element_type(
                val, "IndividualDays attribute must contain DayStruct elements", cluster.Structs.DayStruct)
            for item in val:
        ...
        if val is not NullValue:
            ...
            matter_asserts.assert_list_element_type(
                val, "TariffComponents attribute must contain TariffComponentStruct elements", cluster.Structs.TariffComponentStruct)
            for item in val:
        ...
        if val is not NullValue:
            ...
            matter_asserts.assert_list_element_type(
                val, "TariffPeriods attribute must contain TariffPeriodStruct elements", cluster.Structs.TariffPeriodStruct)
            for item in val:
        ...
        if val is not NullValue:
            ...
            matter_asserts.assert_list_element_type(
                val, "CurrentTariffComponents attribute must contain TariffComponentStruct elements", cluster.Structs.TariffComponentStruct)
            for item in val:
                await self.test_checkTariffComponentStruct(endpoint=endpoint, cluster=cluster, struct=item)
        ...
        if val is not NullValue:
            ...
            matter_asserts.assert_list_element_type(
                val, "NextTariffComponents attribute must contain TariffComponentStruct elements", cluster.Structs.TariffComponentStruct)
            for item in val:
                await self.test_checkTariffComponentStruct(endpoint=endpoint, cluster=cluster, struct=item)
    ...
    async def test_checkCalendarPeriodStruct(self,
        ...
        matter_asserts.assert_list_element_type(
            struct.dayPatternIDs, "DayPatternIDs attribute must contain int elements", int)
    ...
    async def test_checkDayPatternStruct(self,
        ...
        matter_asserts.assert_list_element_type(
            struct.dayEntryIDs, "DayEntryIDs attribute must contain int elements", int)
