...
class TC_OCC_2_2(MatterBaseTest):
    ...
    async def test_TC_OCC_2_2(self):
        ...
        if attributes.OccupancySensorType.attribute_id in attribute_list:
            ...
            if occupancy_sensor_type_dut is not NullValue:
        ...
        if attributes.OccupancySensorTypeBitmap.attribute_id in attribute_list:
            ...
            if occupancy_sensor_type_bitmap_dut is not NullValue:
                if occupancy_sensor_type_bitmap_dut is 1:
        ...
        if attributes.OccupancySensorType.attribute_id in attribute_list:
            ...
            if (occupancy_sensor_type_dut is not NullValue) & (occupancy_sensor_type_bitmap_dut is not NullValue):
                if occupancy_sensor_type_dut is 0:
                    asserts.assert_equal(occupancy_sensor_type_bitmap_dut, 1, "OccupancySensorType PIR is not aligned with OccupancySensorTypeBitmap.")
                elif occupancy_sensor_type_dut is 1:
                    asserts.assert_equal(occupancy_sensor_type_bitmap_dut, 2, "OccupancySensorType Ultrasonic is not aligned with OccupancySensorTypeBitmap.")
                elif occupancy_sensor_type_dut is 2:
                    asserts.assert_equal(occupancy_sensor_type_bitmap_dut, 3, "OccupancySensorType PIRandUltrasonic is not aligned with OccupancySensorTypeBitmap.")
                elif occupancy_sensor_type_dut is 3:
                    asserts.assert_equal(occupancy_sensor_type_bitmap_dut, 4, "OccupancySensorType PhysicalContact is not aligned with OccupancySensorTypeBitmap.")                    
        else:
            logging.info("Test step skipped")