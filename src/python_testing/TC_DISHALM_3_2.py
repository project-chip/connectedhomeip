...
class TC_DISHALM_3_2(MatterBaseTest):
    ...
    async def test_TC_DISHALM_3_2(self):
        ...
        self.print_step(3, "2a. Operate Device to set the condition to raise the Drain alarm and wait a few seconds")
        ...
        self.print_step(5, "2c. Operate Device to set the condition to lower the Drain alarm and wait a few seconds")
        input("Press Enter when done.\n")
        ...
        if latch == 0:
            asserts.assert_false(notify_state & Clusters.DishwasherAlarm.Bitmaps.AlarmMap.kDrainError, "State bit 1 is not set to FALSE")
        ...
        self.print_step(7, "3a. Send to the DUT the Reset Command with bit 1 of Alarms set to 1")
