...
class CNETPDCBaseTest(MatterBaseTest):
    ...
    def assert_nullable_identifier(self, value, context: str):
    ...
    def assert_valid_identity(self, identity, context: str) -> None:
    ...
    def assert_valid_possession_signature(self, identity, nonce, signature, context: str) -> None:
    ...
    def assert_network_config_success(self, response, context: str) -> None:
    ...
    def find_network(self, networks, network_id: bytes):
    ...
    def network_at(self, networks, index: int):
    ...
    async def expect_status(self, cmd, endpoint: int, expected_status: Status, context: str) -> None:
        try:
    ...
    async def read_networks(self, endpoint: int):
        return await self.read_single_attribute_check_success(
            endpoint=endpoint, cluster=cnet, attribute=cnet.Attributes.Networks)

    async def query_identity(self, endpoint: int, key_identifier: bytes, nonce: bytes | None = None):
