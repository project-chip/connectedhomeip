...
class TC_SETRF_2_3(MatterBaseTest, CommodityTariffTestBaseHelper):
    ...
    def steps_TC_SETRF_2_3(self) -> list[TestStep]:
        ...
        steps = [
            ...
            TestStep("4", "TH reads TariffInfo attribute."),
            TestStep("5", "TH sends TestEventTrigger command for Full Tariff Test Event."),
            ...
            TestStep("13", "TH sends TestEventTrigger command for Full Tariff Test Event."),
