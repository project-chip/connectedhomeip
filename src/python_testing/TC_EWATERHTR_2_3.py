...
class TC_EWATERHTR_2_3(MatterBaseTest, EWATERHTRBase):
    ...
    def steps_TC_EWATERHTR_2_3(self) -> list[TestStep]:
        steps = [
            ...
            TestStep("7b", "TH reads BoostState attribute. Verify value is 0 (Inactive)"),
            TestStep("7c", "TH reads TankPercentage attribute. Verify value is 75%"),
            TestStep("8", "TH sends Boost with Duration=600s,TargetPercentage=100%,TargetReheat=65%. Verify Command response is Success"),
            ...
            TestStep("8c", "TH reads TankPercentage attribute. Verify value is 75%"),
            TestStep("9", "TH sends TestEventTrigger command to General Diagnostics Cluster on Endpoint 0 with EnableKey field set to PIXIT.EWATERHTR.TEST_EVENT_TRIGGER_KEY and EventTrigger field set to PIXIT.EWATERHTR.TEST_EVENT_TRIGGER for Water Temperature 61C Test Event. Verify Command response is Success"),
            TestStep("9a", "TH reads HeatDemand attribute. Verify value is 0x00 (no demand on any source)"),
            TestStep("9b", "TH reads BoostState attribute. Verify value is 1 (Active)"),
            TestStep("9c", "TH reads TankPercentage attribute. Verify value is 100%"),
            TestStep("10", "TH sends TestEventTrigger command to General Diagnostics Cluster on Endpoint 0 with EnableKey field set to PIXIT.EWATERHTR.TEST_EVENT_TRIGGER_KEY and EventTrigger field set to PIXIT.EWATERHTR.TEST_EVENT_TRIGGER for Draw off hot water Test Event. Verify Command response is Success"),
            TestStep("10a", "TH reads HeatDemand attribute. Verify value is 0x00 (no demand on any source)"),
            TestStep("10b", "TH reads BoostState attribute. Verify value is 1 (Active)"),
            TestStep("10c", "TH reads TankPercentage attribute. Verify value is 75%"),
            TestStep("11", "TH sends TestEventTrigger command to General Diagnostics Cluster on Endpoint 0 with EnableKey field set to PIXIT.EWATERHTR.TEST_EVENT_TRIGGER_KEY and EventTrigger field set to PIXIT.EWATERHTR.TEST_EVENT_TRIGGER for Draw off hot water Test Event. Verify Command response is Success"),
            TestStep("11a", "TH reads HeatDemand attribute. Verify value is greater than 0x00 (demand on at least one source) and (HeaterDemand & (!HeaterTypes)) is zero (demand is only from declared supported types)"),
            TestStep("11b", "TH reads BoostState attribute. Verify value is 1 (Active)"),
            TestStep("11c", "TH reads TankPercentage attribute. Verify value is 50%"),
            TestStep("12", "TH sends CancelBoost. Verify Command response is Success"),
            TestStep("12a", "TH reads HeatDemand attribute. Verify value is 0x00 (no demand on any source)"),
            TestStep("12b", "TH reads BoostState attribute. Verify value is 0 (Inactive)"),
            TestStep("12c", "TH reads TankPercentage attribute. Verify value is 50%"),
            TestStep("13", "TH sends TestEventTrigger command to General Diagnostics Cluster on Endpoint 0 with EnableKey field set to PIXIT.EWATERHTR.TEST_EVENT_TRIGGER_KEY and EventTrigger field set to PIXIT.EWATERHTR.TEST_EVENT_TRIGGER for Basic installation Test Event Clear. Verify Command response is Success"),
        ]
