...
class TC_RVCRUNM_2_1(MatterBaseTest):
    ...
    async def test_TC_RVCRUNM_2_1(self):
        ...
        asserts.assert_true(ret.status == Clusters.Objects.RvcRunMode.Enums.ChangeToModeStatus.kSuccess,
        ...
        if can_test_mode_failure and can_manually_control:
            ...
            is_err_code = (st == Clusters.Objects.RvcRunMode.Enums.ChangeToModeStatus.kGenericFailure) or (
                st == Clusters.Objects.RvcRunMode.Enums.ChangeToModeStatus.kInvalidInMode) or (st in rvcRunCodes) or is_mfg_code
            asserts.assert_true(
        ...
        asserts.assert_true(ret.status == Clusters.Objects.RvcRunMode.Enums.ChangeToModeStatus.kUnsupportedMode,
