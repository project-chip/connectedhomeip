...
#
# TC-CNET-4.23: implements the PASE commissioning path through CommissioningComplete
# (steps 0–16). Operational CASE / steps 17+ are deferred to a follow-up change.
#
