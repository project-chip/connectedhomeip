...
class TC_DISHALM_3_3(MatterBaseTest):
    ...
    @async_test_body
    async def test_TC_DISHALM_3_3(self):
        ...
        self.print_step(3, "2a. Operate Device to set the condition to raise the Door alarm and wait a few seconds")
        ...
        self.print_step(5, "2c. Operate Device to set the condition to lower the Door alarm and wait a few seconds")
        input("Press Enter when done.\n")
        ...
        if latch == 0:
            asserts.assert_false(notify_state & Clusters.DishwasherAlarm.Bitmaps.AlarmMap.kDoorError, "State bit 2 is not set to FALSE")
        ...
        self.print_step(7, "3a. Send to the DUT the Reset Command with bit 2 of Alarms set to 1")
