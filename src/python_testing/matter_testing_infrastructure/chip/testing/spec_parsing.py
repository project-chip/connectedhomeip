...
def build_xml_device_types(data_model_directory: typing.Union[PrebuiltDataModelDirectory, Traversable], cluster_definitions_xml: dict[uint, XmlCluster] = None) -> tuple[dict[int, XmlDeviceType], list[ProblemNotice]]:
