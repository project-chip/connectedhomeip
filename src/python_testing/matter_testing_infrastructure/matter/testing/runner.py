...
def convert_args_to_matter_config(args: argparse.Namespace):
    ...
    if getattr(args, 'enable_spec_errata', False):
        config.spec_errata_path = "errata_future.yaml"
    else:
...
def parse_matter_test_args(argv: Optional[list[str]] = None):
    ...
    basic_group.add_argument('--enable-spec-errata', action='store_true', default=False,
