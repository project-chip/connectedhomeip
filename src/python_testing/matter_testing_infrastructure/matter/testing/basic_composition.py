...
from matter.testing.commissioning import PaseParams, establish_pase_or_case_session
...
class BasicCompositionTests(MatterBaseTest):
    ...
    async def setup_class_helper(self, allow_pase: bool = True):
        ...
        pase_params = PaseParams(setup_code=self.first_setup_code) if allow_pase and self.first_setup_code else None
