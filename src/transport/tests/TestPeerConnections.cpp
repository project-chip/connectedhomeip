...
const SessionType kPeer1SessionType = SessionType::kCASE;
const SessionType kPeer2SessionType = SessionType::kCASE;
const SessionType kPeer3SessionType = SessionType::kPASE;
...
void TestBasicFunctionality(nlTestSuite * inSuite, void * inContext)
{
    ...
    NL_TEST_ASSERT(inSuite, statePtr->GetSessionType() == kPeer1SessionType);
    ...
    NL_TEST_ASSERT(inSuite, statePtr != nullptr);
    NL_TEST_ASSERT(inSuite, statePtr->GetSessionType() == kPeer2SessionType);
