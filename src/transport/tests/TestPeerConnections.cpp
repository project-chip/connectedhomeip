...
void TestBasicFunctionality(nlTestSuite * inSuite, void * inContext)
{
    ...
    statePtr = connections.CreateNewSecureSession(2, kPeer1NodeId, 1, 0 /* fabricIndex */, gMRPConfig);
    NL_TEST_ASSERT(inSuite, statePtr != nullptr);

    // Node ID 2, peer key 3, local key 4
    statePtr = connections.CreateNewSecureSession(4, kPeer2NodeId, 3, 0 /* fabricIndex */, gMRPConfig);
    NL_TEST_ASSERT(inSuite, statePtr != nullptr);
    ...
    statePtr = connections.CreateNewSecureSession(6, kPeer3NodeId, 5, 0 /* fabricIndex */, gMRPConfig);
    NL_TEST_ASSERT(inSuite, statePtr == nullptr);
}
