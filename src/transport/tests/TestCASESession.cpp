...
uint8_t intermediateCertificateCHIP[] = {
    
};
...
uint8_t rootCertificateCHIP[] = {
    
};
...
int TestSecurePairing_Setup(void * inContext)
{
    ...
    if (error != CHIP_NO_ERROR) return FAILURE;
    ...
    error = ConvertX509CertToChipCert(rootCertificateBinary, sizeof(rootCertificateBinary),
                                        chip_cert_root, sizeof(chip_cert_root), chip_cert_root_len);
    if (error != CHIP_NO_ERROR) return FAILURE;

    // Add the trusted root certificate to the certificate set.
    error = commissionerCertificateSet.LoadCert(
        chip_cert_root, chip_cert_root_len,
        BitFlags<uint8_t, CertDecodeFlags>(CertDecodeFlags::kIsTrustAnchor));
    if (error != CHIP_NO_ERROR) return FAILURE;

    error = accessoryCertificateSet.LoadCert(
        chip_cert_root, chip_cert_root_len,
        BitFlags<uint8_t, CertDecodeFlags>(CertDecodeFlags::kIsTrustAnchor));
    if (error != CHIP_NO_ERROR) return FAILURE;

    // Add the intermediate certificate to the certificate set.
    error = ConvertX509CertToChipCert(intermediateCertificateBinary, sizeof(intermediateCertificateBinary),
                                        chip_cert_int, sizeof(chip_cert_int), chip_cert_int_len);
    if (error != CHIP_NO_ERROR) return FAILURE;

    error = commissionerCertificateSet.LoadCert(
        chip_cert_int, chip_cert_int_len,
        BitFlags<uint8_t, CertDecodeFlags>(CertDecodeFlags::kIsTrustAnchor));
    if (error != CHIP_NO_ERROR) return FAILURE;
