...
public:
    ...
    // Called by the loopback transport when it drops a configurable number of messages(mDroppedMessageCount) after a configurable
    // allowed number of message(mNumMessagesToAllowBeforeDropping)
