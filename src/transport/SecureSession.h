 ...
 */
class SecureSession : public Session, public ReferenceCounted<SecureSession, SecureSessionDeleter, 0>
{
public:
    /**
     *  @brief
    ...
    void Retain() override { ReferenceCounted<SecureSession, SecureSessionDeleter, 0>::Retain(); }
    void Release() override { ReferenceCounted<SecureSession, SecureSessionDeleter, 0>::Release(); }

    bool IsPendingRemoval() const override { return mState == State::kPendingRemoval; }
    ...
    bool IsActiveSession() const { return mState == State::kActive; }
