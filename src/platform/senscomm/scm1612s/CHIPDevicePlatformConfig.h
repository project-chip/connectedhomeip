 ...
 *          on scm1612s platforms using the wise-sdk.
 */
...
// These are configuration options that are unique to the scm1612s platform.
...
#define CHIP_DEVICE_CONFIG_MAX_EVENT_QUEUE_SIZE 40

#define CHIP_DEVICE_CONFIG_WIFI_AP_CHANNEL 6
