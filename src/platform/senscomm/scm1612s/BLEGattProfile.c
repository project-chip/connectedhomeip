 ...
 *          for the Senscomm scm1612s platforms.
 */
...
CHIPoBLECharCallback CHIPoBLEProfile_read_callback  = 0;
CHIPoBLECharCallback CHIPoBLEProfile_write_callback = 0;
CHIPoBLECharCallback CHIPoBLEProfile_ccc_callback   = 0;
