...
#define LOG_SCM1612S "<scm1612s > "
// If a new category string LOG_* is created, add it in the MaxStringLength arguments below
static constexpr size_t kMaxCategoryStrLen = chip::MaxStringLength(LOG_ERROR, LOG_WARN, LOG_INFO, LOG_DETAIL, LOG_LWIP, LOG_SCM1612S);

#if SCM1612S_LOG_ENABLED
...
{
#if SCM1612S_LOG_ENABLED && _CHIP_USE_LOGGING
