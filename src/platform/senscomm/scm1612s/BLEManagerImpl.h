...
/**
 * Concrete implementation of the BLEManager singleton object for the scm1612s platform.
 */
...
private:
    ...
    enum class Flags : uint16_t
    {
        ...
        kSCMBLELayerInitialized   = 0x0002, /**< The SCM BLE layer has been initialized. */
        kAppRegistered            = 0x0004, /**< The CHIPoBLE application has been registered with the SCM BLE layer. */
        kAttrsRegistered          = 0x0008, /**< The CHIPoBLE GATT attributes have been registered with the SCM BLE layer. */
        kGATTServiceStarted       = 0x0010, /**< The CHIPoBLE GATT service has been started. */
        kAdvertisingConfigured    = 0x0020, /**< CHIPoBLE advertising has been configured in the SCM BLE layer. */
        kAdvertising              = 0x0040, /**< The system is currently CHIPoBLE advertising. */
        kControlOpInProgress      = 0x0080, /**< An async control operation has been issued to the SCM BLE layer. */
        ...
        kAdvertisingRefreshNeeded = 0x0800, /**< The advertising configuration/state in SCM BLE layer needs to be updated. */
    ...
    CHIP_ERROR InitSCMBleLayer(void);
    void DeinitSCMBleLayer(void);
