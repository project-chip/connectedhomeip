...
namespace Internal {
extern int GetEntropy_BL602(uint8_t * buf, size_t bufSize);
}

/**
 * Concrete implementation of the ThreadStackManager singleton object for BL602 platforms
 * using the Bouffalolab SDK.
 */
...
private:
    ...
    friend int Internal::GetEntropy_BL602(uint8_t * buf, size_t bufSize);
 ...
 * that are specific to BL602 platforms.
 */
