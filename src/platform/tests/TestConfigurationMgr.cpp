...
static void TestConfigurationMgr_ServiceProvisioningData(nlTestSuite * inSuite, void * inContext)
{
    ...
    err = ConfigurationMgr().StoreServiceProvisioningData(7212064004600625234, serviceConfig, sizeof(serviceConfig), accountId, strlen(accountId));
    NL_TEST_ASSERT(inSuite, err == CHIP_NO_ERROR);
...
static const nlTest sTests[] = {
    ...
    NL_TEST_DEF("Test ConfigurationMgr::ManufacturerDeviceIntermediateCACerts", TestConfigurationMgr_ManufacturerDeviceIntermediateCACerts),
