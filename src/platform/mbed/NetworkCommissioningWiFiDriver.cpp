...
void WiFiDriverImpl::ConnectNetwork(ByteSpan networkId, ConnectCallback * callback)
{
    ...
    ChipLogProgress(NetworkProvisioning, "Mbed WiFi driver connect network: SSID: %s", ChipLogFormat(100, "%.*s", static_cast<int>(networkId.size()),
                    networkId.data()));
...
void WiFiDriverImpl::DisconnectNetwork(ByteSpan networkId)
{
    ...
    ChipLogProgress(NetworkProvisioning, "Mbed WiFi driver disconnect network: SSID: %s", ChipLogFormat(100, "%.*s", static_cast<int>(networkId.size()),
                    networkId.data()));
