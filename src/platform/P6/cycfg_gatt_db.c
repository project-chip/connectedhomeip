...
const uint8_t gatt_database[] =
{
    ...
    /* Characteristic: C1 */
    CHARACTERISTIC_UUID128_WRITABLE(HDLC_CHIP_SERVICE_CHAR_C1,
                                    HDLC_CHIP_SERVICE_CHAR_C1_VALUE,
                                    __UUID128_CHIPoBLEChar_C1,
                                    LEGATTDB_CHAR_PROP_WRITE,
                                    LEGATTDB_PERM_VARIABLE_LENGTH | LEGATTDB_PERM_READABLE | LEGATTDB_PERM_WRITE_REQ),
    /* Characteristic: C2 */
    CHARACTERISTIC_UUID128_WRITABLE(HDLC_CHIP_SERVICE_CHAR_C2,
                                    HDLC_CHIP_SERVICE_CHAR_C2_VALUE,
                                    __UUID128_CHIPoBLEChar_C2,
    ...
    CHAR_DESCRIPTOR_UUID16_WRITABLE(HDLD_CHIP_SERVICE_RX_CLIENT_CHAR_CONFIG,
...
uint8_t app_chip_service_char_tx_client_char_config[]   = {0x00, 0x00, };
...
gatt_db_lookup_table_t app_gatt_db_ext_attr_tbl[] =
{
    ...
    { HDLD_CHIP_SERVICE_RX_CLIENT_CHAR_CONFIG, sizeof(app_chip_service_char_tx_client_char_config), sizeof(app_chip_service_char_tx_client_char_config), app_chip_service_char_tx_client_char_config },
};
