...
private:
    ...
    CHIP_ERROR GetConfigurationVersion(uint32_t & configurationVersion) override { return CHIP_ERROR_NOT_IMPLEMENTED; }
    CHIP_ERROR StoreConfigurationVersion(uint32_t configurationVersion) override { return CHIP_ERROR_NOT_IMPLEMENTED; }
