...
private:
    ...
    CHIP_ERROR ShutdownInner() override { return CHIP_ERROR_NOT_IMPLEMENTED; }
    ...
    CHIP_ERROR StopEventLoopTask() override { return CHIP_ERROR_NOT_IMPLEMENTED; }
    CHIP_ERROR PostEvent(const ChipDeviceEvent * event) override { return CHIP_NO_ERROR; }
