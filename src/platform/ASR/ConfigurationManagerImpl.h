...
/**
 * Concrete implementation of the ConfigurationManager singleton object for the ASR platform.
 */
class ConfigurationManagerImpl : public Internal::GenericConfigurationManagerImpl<Internal::ASRConfig>
{
public:
