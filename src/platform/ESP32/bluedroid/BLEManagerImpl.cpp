...
#if defined(CONFIG_ENABLE_ESP32_BLE_CONTROLLER) && CHIP_DEVICE_CONFIG_CHIPOBLE_SINGLE_CONNECTION
...
#if defined(CONFIG_ENABLE_ESP32_BLE_CONTROLLER) && CHIP_DEVICE_CONFIG_ENABLE_THREAD
