...
#ifdef CONFIG_CHIP_NETWORK_RECOVERY_REQUIRED
#define CHIP_DEVICE_CONFIG_NETWORK_RECOVERY_REQUIRED 1
    #ifdef CONFIG_USE_BLE_ONLY_FOR_COMMISSIONING
        #undef CONFIG_USE_BLE_ONLY_FOR_COMMISSIONING //currently network recovery need to use the BLE advertising
    #endif
#else
#define CHIP_DEVICE_CONFIG_NETWORK_RECOVERY_REQUIRED 0
#endif // CONFIG_CHIP_NETWORK_RECOVERY_REQUIRED
