...
#if defined(CONFIG_ENABLE_MATTER_OVER_THREAD) && CONFIG_ENABLE_MATTER_OVER_THREAD
...
#if defined(CONFIG_ENABLE_ETHERNET_TELEMETRY) && CONFIG_ENABLE_ETHERNET_TELEMETRY
#define CHIP_DEVICE_CONFIG_ENABLE_WIFI 0
#define CHIP_DEVICE_CONFIG_ENABLE_ETHERNET 1
#elif defined(CONFIG_IDF_TARGET_ESP32H2) && CONFIG_IDF_TARGET_ESP32H2
#define CHIP_DEVICE_CONFIG_ENABLE_WIFI 0
#else
...
#if defined(CHIP_DEVICE_CONFIG_ENABLE_WIFI_AP) && CHIP_DEVICE_CONFIG_ENABLE_WIFI_AP
...
#if defined(CONFIG_ENABLE_CHIPOBLE) && CONFIG_ENABLE_CHIPOBLE
#define CHIP_DEVICE_CONFIG_ENABLE_CHIPOBLE CONFIG_ENABLE_CHIPOBLE
#endif

#if defined(CONFIG_ENABLE_EXTENDED_DISCOVERY) && CONFIG_ENABLE_EXTENDED_DISCOVERY
#define CHIP_DEVICE_CONFIG_ENABLE_EXTENDED_DISCOVERY CONFIG_ENABLE_EXTENDED_DISCOVERY
#endif

#if defined(CONFIG_ENABLE_COMMISSIONABLE_DEVICE_TYPE) && CONFIG_ENABLE_COMMISSIONABLE_DEVICE_TYPE
...
#if defined(CONFIG_ENABLE_THREAD_TELEMETRY) && CONFIG_ENABLE_THREAD_TELEMETRY
#define CHIP_DEVICE_CONFIG_ENABLE_THREAD_TELEMETRY CONFIG_ENABLE_THREAD_TELEMETRY
#endif

#if defined(CONFIG_ENABLE_THREAD_TELEMETRY_FULL) && CONFIG_ENABLE_THREAD_TELEMETRY_FULL
...
#if defined(CONFIG_ENABLE_BG_EVENT_PROCESSING) && CONFIG_ENABLE_BG_EVENT_PROCESSING
