...
#define CHIP_DEVICE_CONFIG_CHIP_DEVICE_ATTESTATION_PARTITION CONFIG_CHIP_DEVICE_ATTESTATION_PARTITION_LABEL
#define CHIP_DEVICE_CONFIG_CHIP_CERTIFICATION_DECLARATION_PARTITION CONFIG_CHIP_CERTIFICATION_DECLARATION_PARTITION_LABEL
#define CHIP_DEVICE_CONFIG_ENABLE_DEVICE_INSTANCE_INFO_PROVIDER CONFIG_ENABLE_ESP32_DEVICE_INSTANCE_INFO_PROVIDER
#define CHIP_DEVICE_CONFIG_CHIP_DAC_PRIV_KEY_PARTITION CONFIG_CHIP_DAC_PRIVATE_KEY_PARTITION_LABEL
