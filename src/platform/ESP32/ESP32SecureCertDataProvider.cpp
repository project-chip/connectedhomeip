...
private:
    ...
    {
        // Note: 201 is the Matter-specific TLV type defined in esp_secure_cert_tlv_config.h
        // TODO: start using ESP_SECURE_CERT_MATTER_TLV_1 once available in esp_secure_cert_mgr
        return { .type    = static_cast<esp_secure_cert_tlv_type_t>(201),
                 .subtype = static_cast<esp_secure_cert_tlv_subtype_t>(subType) };
    }
