...
#ifndef CHIP_DEVICE_CONFIG_ENABLE_PERSISTENT_STORAGE
#define CHIP_DEVICE_CONFIG_ENABLE_PERSISTENT_STORAGE 1
#endif // CHIP_DEVICE_CONFIG_ENABLE_PERSISTENT_STORAGE
