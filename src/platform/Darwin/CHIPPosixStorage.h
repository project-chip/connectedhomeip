 ...
 *
 *         CHIPPosixStorage wraps the storage class CHIPPosixStorageIni with mutex.
 *
 */
...
#include <mutex>
#include <platform/Darwin/CHIPPosixStorageIni.h>
...
class CHIPPosixStorage : private CHIPPosixStorageIni
{
public:
    CHIPPosixStorage();
    ~CHIPPosixStorage();
