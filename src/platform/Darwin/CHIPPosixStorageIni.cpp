 ...
 *          using IniPP on Darwin platform.
 *
 */
...
CHIP_ERROR CHIPPosixStorageIni::Init()
{
    return RemoveAll();
}

CHIP_ERROR CHIPPosixStorageIni::GetDefaultSection(std::map<std::string, std::string> & section)
{
...
CHIP_ERROR CHIPPosixStorageIni::AddConfig(const std::string & configFile)
{
    CHIP_ERROR retval = CHIP_NO_ERROR;
    std::ifstream ifs;
...
CHIP_ERROR CHIPPosixStorageIni::CommitConfig(const std::string & configFile)
{
    CHIP_ERROR retval   = CHIP_NO_ERROR;
...
CHIP_ERROR CHIPPosixStorageIni::GetUIntValue(const char * key, uint32_t & val)
{
    CHIP_ERROR retval = CHIP_NO_ERROR;
...
CHIP_ERROR CHIPPosixStorageIni::GetUInt64Value(const char * key, uint64_t & val)
{
    CHIP_ERROR retval = CHIP_NO_ERROR;
    std::map<std::string, std::string> section;
...
CHIP_ERROR CHIPPosixStorageIni::GetStringValue(const char * key, char * buf, size_t bufSize, size_t & outLen)
{
    CHIP_ERROR retval = CHIP_NO_ERROR;
    std::map<std::string, std::string> section;
...
CHIP_ERROR CHIPPosixStorageIni::GetBinaryBlobDataAndLengths(const char * key,
...
CHIP_ERROR CHIPPosixStorageIni::GetBinaryBlobValue(const char * key, uint8_t * decodedData, size_t bufSize, size_t & decodedDataLen)
{
    CHIP_ERROR retval = CHIP_NO_ERROR;
    chip::Platform::ScopedMemoryBuffer<char> encodedData;
...
bool CHIPPosixStorageIni::HasValue(const char * key)
{
    std::map<std::string, std::string> section;
...
CHIP_ERROR CHIPPosixStorageIni::AddEntry(const char * key, const char * value)
{
    CHIP_ERROR retval = CHIP_NO_ERROR;
...
CHIP_ERROR CHIPPosixStorageIni::RemoveEntry(const char * key)
{
    CHIP_ERROR retval = CHIP_NO_ERROR;
...
CHIP_ERROR CHIPPosixStorageIni::RemoveAll()
{
    mConfigStore.clear();
