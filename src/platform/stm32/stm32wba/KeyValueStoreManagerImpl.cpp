                                          ...
                                          size_t offset)
{
    ...
    {
        return this->_PrintError(NVM_GetKeyValue(value, key, (uint32_t) value_size, read_bytes_size, SECTOR_MATTER));
    }
    else
    {
...
CHIP_ERROR KeyValueStoreManagerImpl::_Put(const char * key, const void * value, size_t value_size)
{
    ...
    if ((value_size != 0) && (key != NULL) && (value != NULL))
    {
        ...
        return this->_PrintError(NVM_SetKeyValue((char *) value, (char *) key, (uint32_t) value_size, SECTOR_MATTER));
    }
