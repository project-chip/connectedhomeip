...
public:
    ...
    static constexpr Key kConfigKey_ProductRevision     = ConfigKey(kFileId_ChipFactory, 0x07);
    ...
    static constexpr Key kMaxConfigKey_ChipFactory = ConfigKey(kFileId_ChipFactory, 0x08);
