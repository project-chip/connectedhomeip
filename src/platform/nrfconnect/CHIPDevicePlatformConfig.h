...
#define CHIP_DEVICE_CONFIG_DISABLE_ACCOUNT_PAIRING CONFIG_CHIP_DISABLE_ACCOUNT_PAIRING
#define CHIP_DEVICE_CONFIG_DISABLE_FABRIC_MEMBER CONFIG_CHIP_DISABLE_FABRIC_MEMBER
