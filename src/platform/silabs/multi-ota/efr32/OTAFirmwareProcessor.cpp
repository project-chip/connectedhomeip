...
{
    return OTAUtilityFirmwareProcessor::getInstance()->ProcessInternalEFR32(block);
}
...
{
    return OTAUtilityFirmwareProcessor::getInstance()->ApplyActionEFR32();
}

CHIP_ERROR OTAFirmwareProcessor::FinalizeAction()
{
    return OTAUtilityFirmwareProcessor::getInstance()->FinalizeActionEFR32();
}
