...
class OTAUtilityFirmwareProcessor
{
...
public:
    ...
    CHIP_ERROR Clear();
#ifndef SL_WIFI
    CHIP_ERROR ApplyActionEFR32();
    CHIP_ERROR FinalizeActionEFR32();
    CHIP_ERROR ProcessInternalEFR32(ByteSpan & block);
#endif
#ifdef SLI_SI91X_MCU_INTERFACE 
    CHIP_ERROR ApplyAction917();
    CHIP_ERROR FinalizeAction917();
    CHIP_ERROR ProcessInternal917(ByteSpan & block);
#endif
    static OTAUtilityFirmwareProcessor* getInstance();
