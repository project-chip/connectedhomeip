...
{
    // Return the size of the hardcoded labelList on all endpoints.
    return 4;
}
...
{
    // Return the size of the hardcoded list of Strings that are valid values for the ActiveLocale.
    // {("en-US"), ("de-DE"), ("fr-FR"), ("en-GB"), ("es-ES"), ("zh-CN"), ("it-IT"), ("ja-JP"), ("zh-TW")}
...
{
    // Return the size of the hardcoded list of Strings that are valid values for the Calendar Types.
...
bool DeviceInfoProviderImpl::SupportedCalendarTypesIteratorImpl::Next(CalendarType & output)
{
    ...
    // Return following hardcoded list of Strings that are valid values for the Calendar Types.
    CHIP_ERROR err = CHIP_NO_ERROR;
