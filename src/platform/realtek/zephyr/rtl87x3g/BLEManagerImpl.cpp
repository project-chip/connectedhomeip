...
CHIP_ERROR BLEManagerImpl::HandleGAPConnect()
{
...
CHIP_ERROR BLEManagerImpl::HandleGapMsg(T_IO_MSG * p_gap_msg)
{
    ...
    case GAP_MSG_LE_CONN_STATE_CHANGE:
        /* A new connection was established or a connection attempt failed */
        {
            ...
            if (new_state == GAP_CONN_STATE_CONNECTED)
            {
                ...
                err = sInstance.HandleGAPConnect();
                SuccessOrExit(err);
            }
    ...
    case GAP_MSG_LE_DEV_STATE_CHANGE: {
        ...
        {
            ChipLogProgress(DeviceLayer, "GAP adv stopped");
        }
        else if (new_state.gap_adv_state == GAP_ADV_STATE_ADVERTISING)
        {
            ChipLogProgress(DeviceLayer, "GAP adv started");
        }
    }
    break;
