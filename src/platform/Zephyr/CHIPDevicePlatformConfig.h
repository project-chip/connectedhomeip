...
// WiFi PAF uses a single radio - NAN channel is unavailable while connected to AP.
// Use non-concurrent commissioning mode so ConnectNetworkResponse is sent over PAF
// before the AP connection is established.
