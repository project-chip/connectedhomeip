...
#if defined(CONFIG_SOC_RISCV_TELINK_TL721X) || defined(CONFIG_SOC_SERIES_RISCV_TELINK_B9X_RETENTION) ||                            \
...
#if defined(CONFIG_PM) || defined(CONFIG_SOC_RISCV_TELINK_TL721X) || defined(CONFIG_SOC_RISCV_TELINK_W91)
