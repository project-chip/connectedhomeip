...
#define CHIP_CONFIG_ENABLE_ACL_EXTENSIONS CONFIG_CHIP_ENABLE_ACL_EXTENSIONS
#endif // CONFIG_CHIP_ENABLE_ACL_EXTENSIONS
...
#ifndef CONFIG_CHIP_ENABLE_ICD_SUPPORT
#define CONFIG_CHIP_ENABLE_ICD_SUPPORT 0
