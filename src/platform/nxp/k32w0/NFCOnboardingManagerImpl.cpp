...
bool NFCOnboardingManagerImpl::IsNtagConfigured(eAppNtagError * pNtagError, const char * payload)
{
...
NFCOnboardingManagerImpl::eAppNtagError NFCOnboardingManagerImpl::AppNtagWrite(const char * payload)
{
...
bool NFCOnboardingManagerImpl::AppNtagEepromWrite(uint8_t originalSize)
{
...
NFCOnboardingManagerImpl::eAppNtagError NFCOnboardingManagerImpl::AppNtagEepromUnlockThenWrite(uint8_t originalSize)
{
    eAppNtagError ntagErr = E_APP_NTAG_NO_ERROR;
...
uint8_t NFCOnboardingManagerImpl::AppNdefUriRecordGetSize(NdefUriRecord_t ndefUriRecord)
{
...
NFCOnboardingManagerImpl::eAppNtagError NFCOnboardingManagerImpl::AppNtagLockWriteAccess(void)
{
    eAppNtagError ntagErr = E_APP_NTAG_NO_ERROR;
...
NFCOnboardingManagerImpl::eAppNtagError NFCOnboardingManagerImpl::AppNtagUnlockWriteAccess(void)
{
    eAppNtagError ntagErr = E_APP_NTAG_NO_ERROR;
