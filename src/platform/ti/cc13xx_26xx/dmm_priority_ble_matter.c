...
StackActivity activityThread_bleLthreadH[ACTIVITY_NUM_THREAD*PRIORITY_NUM] =
{
     ...
     DMM_GLOBAL_PRIORITY(DMM_THREAD_TX_POLL, DMM_StackPNormal, 90),
     DMM_GLOBAL_PRIORITY(DMM_THREAD_TX_POLL, DMM_StackPHigh, 190),
     DMM_GLOBAL_PRIORITY(DMM_THREAD_TX_POLL, DMM_StackPUrgent, 215),

     DMM_GLOBAL_PRIORITY(DMM_THREAD_RX_POLL, DMM_StackPNormal, 90),
     DMM_GLOBAL_PRIORITY(DMM_THREAD_RX_POLL, DMM_StackPHigh, 190),
