...
public:
    ...
    static const uint16_t kCC35XXMatter_SysID = kNvinf_sysid_chip;

    static const uint16_t kCC35XXMatter_ItemID_ChipConfig    = kNVinf_itemid_chipConfig;
    static const uint16_t kCC35XXMatter_ItemID_ChipFactory   = kNVinf_itemid_chipFactory;
    static const uint16_t kCC35XXMatter_ItemID_ChipCounters  = kNVinf_itemid_chipCounters;
    static const uint16_t kCC35XXMatter_ItemID_ChipKVS_key   = kNVinf_itemid_chipKVS_key;
    static const uint16_t kCC35XXMatter_ItemID_ChipKVS_value = kNVinf_itemid_chipKVS_value;
...
inline bool CC35XXConfig::Key::operator==(const Key & other) const
{
