 ...
 *
 */
class ConnectivityManagerImpl_NetworkManagementConnMan final :
   public Internal::NetworkManagementBasis,
...
public:
    ...
    CHIP_ERROR ConnectWiFiNetworkAsync(const ByteSpan & inSsid, const ByteSpan & inCredentials,
                                       NetworkCommissioning::Internal::WirelessDriver::ConnectCallback * inConnectCallback) override final;
    CHIP_ERROR ConnectWiFiNetworkWithPDCAsync(const ByteSpan & inSsid, const ByteSpan & inNetworkIdentity,
                                              const ByteSpan & inClientIdentity,
                                              const Crypto::P256Keypair & inClientIdentityKeypair,
                                              NetworkCommissioning::Internal::WirelessDriver::ConnectCallback * inConnectCallback) override final;
    CHIP_ERROR StartWiFiScan(const ByteSpan & inSsid, NetworkCommissioning::WiFiDriver::ScanCallback * inScanCallback) override final;
 ...
 private:
    ...
    static CHIP_ERROR InitAgentOnGLib(ConnectivityManagerImpl_NetworkManagementConnMan * inSelf,
                                      GDBusConnection * inConnection,
                                      const char * inPath,
                                      ConnManAgent *& outSkeleton,
                                      GError ** outError) noexcept;
           void ShutdownAgentLocked(std::unique_lock<std::mutex> & inOutLock,
                                                             const char * inPath) noexcept;
    static void ShutdownAgentOnGLib(ConnectivityManagerImpl_NetworkManagementConnMan * inSelf,
                                    GDBusConnection * inConnection,
                                    const char * inPath,
    ...
    using ManagerAgentOpFunc =
        gboolean (*)(ConnManManager * inManager,
                     const gchar * inPath,
                     GCancellable * inCancellable,
                     GError ** inOutError);
    using ManagerGetObjectsFinishFunc =
        gboolean (*)(ConnManManager * inManager,
                     GVariant ** outObjects,
                     GAsyncResult * inAsyncResult,
                     GError ** outError);
    using ObjectActionFinishFunc =
        gboolean (*)(GObject * inObject,
                     GAsyncResult * inAsyncResult,
                     GError ** outError);

    using HandleManagerGetObjectsMethod =
        void (ConnectivityManagerImpl_NetworkManagementConnMan::*)(ConnManManager * inManager,
                                                                   GVariant * inObjects,
                                                                   const GError * inError) noexcept;
    using HandleObjectActionCompleteMethod =
        void (ConnectivityManagerImpl_NetworkManagementConnMan::*)(GDBusProxy * inProxy,
                                                                   const GError * inError) noexcept;
    using ObjectPropertiesChangedAnyLockedMethod =
        CHIP_ERROR (ConnectivityManagerImpl_NetworkManagementConnMan::*)(GDBusProxy * inProxy,
                                                                         const char * inKey,
                                                                         GVariant *   inMaybeVariant) noexcept;
    using ObjectPropertiesChangedLockedMethod =
        CHIP_ERROR (ConnectivityManagerImpl_NetworkManagementConnMan::*)(GDBusProxy * inProxy,
                                                                         const char * inKey,
                                                                         GVariant *   inValule) noexcept;
    using TypedObjectPropertiesChangedAnyLockedMethod =
        CHIP_ERROR (ConnectivityManagerImpl_NetworkManagementConnMan::*)(GDBusProxy * inProxy,
                                                                         const char * inPath,
                                                                         const char * inType,
                                                                         const char * inKey,
                                                                         GVariant *   inMaybeVariant) noexcept;
    using TypedObjectPropertyChangedLockedMethod =
        CHIP_ERROR (ConnectivityManagerImpl_NetworkManagementConnMan::*)(GDBusProxy * inProxy,
                                                                         const char * inPath,
                                                                         const char * inType,
                                                                         const char * inKey,
    ...
    CHIP_ERROR HandleManagerPropertyChangedAnyLocked(GDBusProxy * inManager, const char * inKey, GVariant * inMaybeVariant) noexcept;
    void HandleManagerServicesChanged(ConnManManager * inManager, GVariant * inServicesChanged, const char * const * inServicesRemoved) noexcept;
    void HandleManagerServicesChangedLocked(std::unique_lock<std::mutex> & inOutLock,
                                                                            ConnManManager * inManager, GVariant * inServicesChanged) noexcept;
    void HandleManagerServicesRemovedLocked(std::unique_lock<std::mutex> & inOutLock,
                                                                            ConnManManager * inManager, const char * const * inServicesRemoved) noexcept;
    ...
    CHIP_ERROR HandleObjectPropertiesChangedLocked(const char * inDescription, GDBusProxy * inProxy,
                                                                             GVariant * inProperties,
                                                                             ObjectPropertiesChangedAnyLockedMethod inObjectPropertiesChangedAnyLockedMethod) noexcept;
    CHIP_ERROR HandleObjectPropertiesChangedLocked(const char * inDescription, GDBusProxy * inProxy,
                                                                             const char * inPath, const char * inType,
                                                                             GVariant * inProperties,
                                                                             TypedObjectPropertiesChangedAnyLockedMethod inTypedObjectPropertiesChangedAnyLockedMethod) noexcept;
    CHIP_ERROR HandleObjectPropertyChangedAnyLocked(GDBusProxy * inProxy, const char * inPath,
                                                                              const char * inType, const char * inKey,
    ...
    CHIP_ERROR HandleServiceConnectRequestLocked(std::unique_lock<std::mutex> & inOutLock,
                                                                           ConnManService * inService) noexcept;
    CHIP_ERROR HandleServicePropertiesChangedLocked(GDBusProxy * inProxy, const char * inPath, const char * inType, GVariant * inProperties) noexcept;
    void HandleServicePropertyChanged(ConnManService * inService, const char * inKey, GVariant * inValue) noexcept;
    CHIP_ERROR HandleServicePropertyChangedLocked(GDBusProxy * inProxy, const char * inPath, const char * inType, const char * inKey, GVariant * inValue) noexcept;
    CHIP_ERROR HandleServicePropertyChangedAnyLocked(GDBusProxy * inService, const char * inPath,
                                                                               const char * inType, const char * inKey,
                                                                               GVariant * inMaybeVariant) noexcept;
    CHIP_ERROR HandleTechnologyPropertiesChangedLocked(GDBusProxy * inProxy, const char * inPath, const char * inType, GVariant * inProperties) noexcept;
    void HandleTechnologyPropertyChanged(ConnManTechnology * inTechnology, const char * inKey, GVariant * inValue) noexcept;
    CHIP_ERROR HandleTechnologyPropertyChangedLocked(GDBusProxy * inProxy, const char * inPath, const char * inType, const char * inKey, GVariant * inValue) noexcept;
    CHIP_ERROR HandleTechnologyPropertyChangedAnyLocked(GDBusProxy * inTechnology,
                                                                                  const char * inPath, const char * inType,
                                                                                  const char * inKey,
                                                                                  GVariant * inMaybeVariant) noexcept;
    void HandleTechnologyScanComplete(GDBusProxy * inTechnology, const GError * inError) noexcept;
    CHIP_ERROR HandleWiFiPendingConnectLocked(std::unique_lock<std::mutex> & inOutLock,
                                                                        ConnManTechnology * inTechnology,
                                                                        size_t & inOutScanCount,
                                                                        Internal::WiFiSSIDFixedBuffer & inOutSsid) noexcept;
    CHIP_ERROR HandleWiFiPendingScanLocked(std::unique_lock<std::mutex> & inOutLock,
                                                                     ConnManTechnology * inTechnology,
                                                                     size_t & inOutScanCount,
                                                                     Internal::WiFiSSIDFixedBuffer & inOutSsid) noexcept;
    CHIP_ERROR HandleWiFiScanCompleteLocked(std::unique_lock<std::mutex> & inOutLock,
                                                                      ConnManTechnology * inTechnology) noexcept;
    CHIP_ERROR HandleWiFiScanRetryLocked(std::unique_lock<std::mutex> & inOutLock,
                                                                   ConnManTechnology * inTechnology,
                                                                   const char * inReason,
                                                                   size_t & inOutScanCount,
                                                                   const Internal::WiFiSSIDFixedBuffer & inSsid) noexcept;
    CHIP_ERROR ManagerAgentOpLocked(std::unique_lock<std::mutex> & inOutLock,
                                                              const char * inPath,
    ...
    CHIP_ERROR UpdateServiceProxyLocked(std::unique_lock<std::mutex> & inOutLock,
                                        const char * inPath,
                                        ConnManService *& outService) noexcept;
    CHIP_ERROR UpdateTechnologiesLocked(GVariant * inTechnologies) noexcept;
    CHIP_ERROR UpdateTechnologyProxyLocked(std::unique_lock<std::mutex> & inOutLock,
                                           const char * inPath,
    ...
    CHIP_ERROR ManagerRegisterAgentLocked(std::unique_lock<std::mutex> & inOutLock,
                                          const char * inPath) noexcept;
    CHIP_ERROR ManagerUnregisterAgent(const char * inPath) noexcept;
    CHIP_ERROR ManagerUnregisterAgentLocked(std::unique_lock<std::mutex> & inOutLock,
                                            const char * inPath) noexcept;
    CHIP_ERROR ServiceConnectLocked(std::unique_lock<std::mutex> & inOutLock,
                                    ConnManService * inService) noexcept;
    ...
    CHIP_ERROR TechnologyScanLocked(std::unique_lock<std::mutex> & inOutLock,
                                    ConnManTechnology * inTechnology) noexcept;
    CHIP_ERROR TechnologySetPropertyLocked(std::unique_lock<std::mutex> & inOutLock,
                                           ConnManTechnology * inTechnology,
                                           const char * inKey,
                                           GVariant * inValue) noexcept;
    CHIP_ERROR TechnologySetPoweredLocked(std::unique_lock<std::mutex> & inOutLock,
                                          ConnManTechnology * inTechnology,
    ...
    void OnObjectActionReady(GObject * inObject, GAsyncResult * inResult,
    ...
    gboolean OnAgentRequestInput(ConnManAgent * inAgent, GDBusMethodInvocation * inInvocation,
                                 const gchar * inPath,
                                 GVariant * inProperties) noexcept;
    gboolean OnAgentReportError(ConnManAgent * inAgent, GDBusMethodInvocation * inInvocation,
                                const gchar * inPath,
