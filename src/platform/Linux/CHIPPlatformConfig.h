...
#ifndef CHIP_CONFIG_GLOBAL_MESSAGE_COUNTER_STORAGE_KEY
#define CHIP_CONFIG_GLOBAL_MESSAGE_COUNTER_STORAGE_KEY "GlobalMCTR"
#endif // CHIP_CONFIG_GLOBAL_MESSAGE_COUNTER_STORAGE_KEY
