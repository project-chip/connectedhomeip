...
class ThreadStackManagerImpl final : public ThreadStackManager,
                                     public System::LayerImplSelect::Source,
...
public:
    ...
    void PrepareEvents(int * aMaxFd, fd_set * aReadFdSet, fd_set * aWriteFdSet, fd_set * aErrorFdSet,
                       struct timeval * aTimeout) override;
    void ProcessEvents(const fd_set * aReadFdSet, const fd_set * aWriteFdSet, const fd_set * aErrorFdSet) override;
