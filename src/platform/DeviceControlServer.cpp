...
CHIP_ERROR DeviceControlServer::PostCloseAllBLEConnectionsToOperationalNetworkEvent(void)
{
    ChipDeviceEvent event;
...
CHIP_ERROR DeviceControlServer::PostWiFiDeviceAvailableNetworkEvent(void)
{
    ChipDeviceEvent event;
