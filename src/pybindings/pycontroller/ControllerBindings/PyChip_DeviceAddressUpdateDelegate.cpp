...
struct PyCallBack_chip_Controller_OperationalCredentialsDelegate : public chip::Controller::OperationalCredentialsDelegate
{
    ...
    CHIP_ERROR GetIntermediateCACertificate(chip::FabricId a0, chip::MutableByteSpan & a1) override
    {
        pybind11::gil_scoped_acquire gil;
        pybind11::function overload = pybind11::get_overload(
    ...
    CHIP_ERROR GetRootCACertificate(chip::FabricId a0, chip::MutableByteSpan & a1) override
    {
        pybind11::gil_scoped_acquire gil;
        pybind11::function overload = pybind11::get_overload(
...
struct PyCallBack_chip_PersistentStorageDelegate : public chip::PersistentStorageDelegate
{
    ...
    CHIP_ERROR SyncGetKeyValue(const char * a0, void * a1, uint16_t & a2) override
    {
        pybind11::gil_scoped_acquire gil;
    ...
    CHIP_ERROR SyncSetKeyValue(const char * a0, const void * a1, uint16_t a2) override
    {
        pybind11::gil_scoped_acquire gil;
        pybind11::function overload =
    ...
    CHIP_ERROR SyncDeleteKeyValue(const char * a0) override
    {
        pybind11::gil_scoped_acquire gil;
        pybind11::function overload =
