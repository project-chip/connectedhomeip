...
void bind_PyChip_SetupPayload(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	...
	{ // chip::OptionalQRCodeInfo file:setup_payload/SetupPayload.h line:119
		pybind11::class_<chip::OptionalQRCodeInfo, std::shared_ptr<chip::OptionalQRCodeInfo>> cl(M("chip"), "OptionalQRCodeInfo", "A structure to hold optional QR Code info");
	...
	{ // chip::OptionalQRCodeInfoExtension file:setup_payload/SetupPayload.h line:131
		pybind11::class_<chip::OptionalQRCodeInfoExtension, std::shared_ptr<chip::OptionalQRCodeInfoExtension>, chip::OptionalQRCodeInfo> cl(M("chip"), "OptionalQRCodeInfoExtension", "");
	...
	{
		pybind11::enum_<chip::RendezvousInformationFlag>(M("chip"), "RendezvousInformationFlag", "The rendezvous type this device supports.")
	...
	{ // chip::SetupPayload file:setup_payload/SetupPayload.h line:149
		...
		cl.def("getAllOptionalVendorData", &chip::SetupPayload::getAllOptionalVendorData, "A function to retrieve the vector of OptionalQRCodeInfo infos\n \n\n Returns a vector of optionalQRCodeInfos\n\nC++: chip::SetupPayload::getAllOptionalVendorData() const --> int");
		cl.def("addSerialNumber", pybind11::overload_cast<std::string>(&chip::SetupPayload::addSerialNumber), "A function to add a string serial number\n \n\n string serial number\n \n\n Returns a CHIP_ERROR on error, CHIP_NO_ERROR otherwise\n\nC++: chip::SetupPayload::addSerialNumber(int) --> int", pybind11::arg("serialNumber"));
		cl.def("addSerialNumber", pybind11::overload_cast<uint32_t>(&chip::SetupPayload::addSerialNumber), "A function to add a uint32_t serial number\n \n\n uint32_t serial number\n \n\n Returns a CHIP_ERROR on error, CHIP_NO_ERROR otherwise\n\nC++: chip::SetupPayload::addSerialNumber(unsigned int) --> int", pybind11::arg("serialNumber"));
	...
	{ // chip::ManualSetupPayloadParser file:setup_payload/ManualSetupPayloadParser.h line:36
		pybind11::class_<chip::ManualSetupPayloadParser, std::shared_ptr<chip::ManualSetupPayloadParser>> cl(M("chip"), "ManualSetupPayloadParser", "A class that can be used to convert a decimal encoded payload to a SetupPayload object");
		cl.def(pybind11::init<const std::string &>());
		cl.def("populatePayload", (int (chip::ManualSetupPayloadParser::*)(class chip::SetupPayload &)) &chip::ManualSetupPayloadParser::populatePayload, "C++: chip::ManualSetupPayloadParser::populatePayload(class chip::SetupPayload &) --> int", pybind11::arg("outPayload"));
	}
	{
