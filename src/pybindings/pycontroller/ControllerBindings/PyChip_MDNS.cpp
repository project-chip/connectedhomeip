...
struct PyCallBack_chip_Mdns_ResolverDelegate : public chip::Mdns::ResolverDelegate
{
    ...
    void OnNodeIdResolutionFailed(const class chip::PeerId & a0, CHIP_ERROR a1) override
    {
        pybind11::gil_scoped_acquire gil;
        pybind11::function overload =
...
struct PyCallBack_chip_Mdns_Resolver : public chip::Mdns::Resolver
{
    ...
    CHIP_ERROR StartResolver(class chip::Inet::InetLayer * a0, unsigned short a1) override
    {
        pybind11::gil_scoped_acquire gil;
    ...
    CHIP_ERROR SetResolverDelegate(class chip::Mdns::ResolverDelegate * a0) override
    {
        pybind11::gil_scoped_acquire gil;
        pybind11::function overload =
    ...
    CHIP_ERROR ResolveNodeId(const class chip::PeerId & a0, chip::Inet::IPAddressType a1) override
    {
        pybind11::gil_scoped_acquire gil;
    ...
    CHIP_ERROR FindCommissionableNodes(struct chip::Mdns::DiscoveryFilter a0) override
    {
        pybind11::gil_scoped_acquire gil;
        pybind11::function overload =
    ...
    CHIP_ERROR FindCommissioners(struct chip::Mdns::DiscoveryFilter a0) override
    {
        pybind11::gil_scoped_acquire gil;
