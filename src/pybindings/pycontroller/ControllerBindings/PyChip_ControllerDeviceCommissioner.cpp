...
struct PyCallBack_chip_app_InteractionModelDelegate : public chip::app::InteractionModelDelegate
{
    ...
    CHIP_ERROR EventStreamReceived(const class chip::Messaging::ExchangeContext * a0, class chip::TLV::TLVReader * a1) override
    {
    ...
    CHIP_ERROR ReportProcessed(const class chip::app::ReadClient * a0) override
    {
        pybind11::gil_scoped_acquire gil;
        pybind11::function overload =
    ...
    CHIP_ERROR ReportError(const class chip::app::ReadClient * a0, CHIP_ERROR a1) override
    {
        pybind11::gil_scoped_acquire gil;
        pybind11::function overload =
    ...
    CHIP_ERROR CommandResponseProcessed(const class chip::app::CommandSender * a0) override
    {
        pybind11::gil_scoped_acquire gil;
        pybind11::function overload =
    ...
    CHIP_ERROR CommandResponseProtocolError(const class chip::app::CommandSender * a0, unsigned char a1) override
    {
        pybind11::gil_scoped_acquire gil;
        pybind11::function overload =
    ...
    CHIP_ERROR CommandResponseError(const class chip::app::CommandSender * a0, CHIP_ERROR a1) override
    {
        pybind11::gil_scoped_acquire gil;
        pybind11::function overload =
    ...
    CHIP_ERROR WriteResponseProcessed(const class chip::app::WriteClient * a0) override
    {
        pybind11::gil_scoped_acquire gil;
        pybind11::function overload =
    ...
    CHIP_ERROR WriteResponseProtocolError(const class chip::app::WriteClient * a0, unsigned char a1) override
    {
        pybind11::gil_scoped_acquire gil;
        pybind11::function overload =
    ...
    CHIP_ERROR WriteResponseError(const class chip::app::WriteClient * a0, CHIP_ERROR a1) override
    {
        pybind11::gil_scoped_acquire gil;
        pybind11::function overload =
...
struct PyCallBack_chip_Controller_DevicePairingDelegate : public chip::Controller::DevicePairingDelegate
{
    ...
    void OnPairingComplete(CHIP_ERROR a0) override
    {
        pybind11::gil_scoped_acquire gil;
        pybind11::function overload =
    ...
    void OnPairingDeleted(CHIP_ERROR a0) override
    {
        pybind11::gil_scoped_acquire gil;
        pybind11::function overload =
