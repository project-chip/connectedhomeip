...
CHIP_ERROR CASESession::SendSigma2Resume()
{
    ...
    ReturnErrorOnFailure(EncodeSessionParameters(TLV::ContextTag(4), mLocalMRPConfig.ValueOr(GetLocalMRPConfig()), tlvWriter));
...
CHIP_ERROR CASESession::SendSigma2()
{
    ...
    ReturnErrorOnFailure(EncodeSessionParameters(TLV::ContextTag(5), mLocalMRPConfig.ValueOr(GetLocalMRPConfig()), tlvWriterMsg2));
