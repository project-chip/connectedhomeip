...
{
    CHIP_TRACE_EVENT_SCOPE("EstablishSession", "CASESession");
...
{
    CHIP_TRACE_EVENT_SCOPE("SendSigma1", "CASESession");
...
{
    CHIP_TRACE_EVENT_SCOPE("HandleSigma1_and_SendSigma2", "CASESession");
...
{
    CHIP_TRACE_EVENT_SCOPE("HandleSigma1", "CASESession");
    CHIP_ERROR err = CHIP_NO_ERROR;
...
{
    CHIP_TRACE_EVENT_SCOPE("SendSigma2Resume", "CASESession");
    const size_t mrpParamsSize = mLocalMRPConfig.HasValue() ? TLV::EstimateStructOverhead(sizeof(uint16_t), sizeof(uint16_t)) : 0;
...
{
    CHIP_TRACE_EVENT_SCOPE("SendSigma2", "CASESession");
...
{
    CHIP_TRACE_EVENT_SCOPE("HandleSigma2Resume", "CASESession");
    CHIP_ERROR err = CHIP_NO_ERROR;
    System::PacketBufferTLVReader tlvReader;
...
{
    CHIP_TRACE_EVENT_SCOPE("HandleSigma2_and_SendSigma3", "CASESession");
...
{
    CHIP_TRACE_EVENT_SCOPE("HandleSigma2", "CASESession");
    CHIP_ERROR err = CHIP_NO_ERROR;
    System::PacketBufferTLVReader tlvReader;
...
{
    CHIP_TRACE_EVENT_SCOPE("SendSigma3", "CASESession");
    CHIP_ERROR err = CHIP_NO_ERROR;
...
{
    CHIP_TRACE_EVENT_SCOPE("HandleSigma3", "CASESession");
    CHIP_ERROR err = CHIP_NO_ERROR;
    MutableByteSpan messageDigestSpan(mMessageDigest);
    System::PacketBufferTLVReader tlvReader;
    TLV::TLVReader decryptedDataTlvReader;
