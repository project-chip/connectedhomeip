...
CHIP_ERROR InitCredentialSets()
{
    ...
    {
        P256PlaintextKeypair opKeys;

        // TODO: Rename gCommissioner* to gInitiator*
        memcpy((uint8_t *) (opKeys), sTestCert_Node01_02_PublicKey, sTestCert_Node01_02_PublicKey_Len);
        memcpy((uint8_t *) (opKeys) + sTestCert_Node01_02_PublicKey_Len, sTestCert_Node01_02_PrivateKey,
               sTestCert_Node01_02_PrivateKey_Len);

        ReturnErrorOnFailure(opKeys.SetLength(sTestCert_Node01_02_PublicKey_Len + sTestCert_Node01_02_PrivateKey_Len));
        ...
        chip::ByteSpan opKeySpan(opKeys.ConstBytes(), opKeys.Length());
...

    {
        ...
        memcpy((uint8_t *) (opKeys), sTestCert_Node01_01_PublicKey, sTestCert_Node01_01_PublicKey_Len);
        memcpy((uint8_t *) (opKeys) + sTestCert_Node01_01_PublicKey_Len, sTestCert_Node01_01_PrivateKey,
               sTestCert_Node01_01_PrivateKey_Len);

        ReturnErrorOnFailure(opKeys.SetLength(sTestCert_Node01_01_PublicKey_Len + sTestCert_Node01_01_PrivateKey_Len));

        ReturnErrorOnFailure(deviceOpKey->Initialize(opKeys));
