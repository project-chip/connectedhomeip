...
{
    CHIP_TRACE_EVENT_SCOPE("GeneratePASEVerifier", "PASESession");
...
{
    CHIP_TRACE_EVENT_SCOPE("SetupSpake2p", "PASESession");
...
CHIP_ERROR PASESession::Pair(const Transport::PeerAddress peerAddress, uint32_t peerSetUpPINCode, uint16_t mySessionId,
                             ...
                             SessionEstablishmentDelegate * delegate)
{
    CHIP_TRACE_EVENT_SCOPE("Pair", "PASESession");
...
{
    CHIP_TRACE_EVENT_SCOPE("SendPBKDFParamRequest", "PASESession");
...
{
    CHIP_TRACE_EVENT_SCOPE("HandlePBKDFParamRequest", "PASESession");
...
{
    CHIP_TRACE_EVENT_SCOPE("SendPBKDFParamResponse", "PASESession");
    ReturnErrorOnFailure(DRBG_get_bytes(mPBKDFLocalRandomData, sizeof(mPBKDFLocalRandomData)));
...
{
    CHIP_TRACE_EVENT_SCOPE("HandlePBKDFParamResponse", "PASESession");
    CHIP_ERROR err = CHIP_NO_ERROR;
...
{
    CHIP_TRACE_EVENT_SCOPE("SendMsg1", "PASESession");
...
{
    CHIP_TRACE_EVENT_SCOPE("HandleMsg1_and_SendMsg2", "PASESession");
    CHIP_ERROR err = CHIP_NO_ERROR;
...
{
    CHIP_TRACE_EVENT_SCOPE("HandleMsg2_and_SendMsg3", "PASESession");
    CHIP_ERROR err = CHIP_NO_ERROR;
...
{
    CHIP_TRACE_EVENT_SCOPE("HandleMsg3", "PASESession");
    CHIP_ERROR err = CHIP_NO_ERROR;
