...
void TransferInit::LogMessage() const
{
    ...
    ChipLogDetail(BDX, "  Proposed Max Block Size: %d", MaxBlockSize);
    ...
    ChipLogDetail(BDX, "  File Designator Length: %d", FileDesLength);
...
void SendAccept::LogMessage() const
{
    ...
    ChipLogDetail(BDX, "  Max Block Size: %d", MaxBlockSize);
}
