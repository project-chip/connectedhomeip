...
CHIP_IM_STATUS_CODE(UnsupportedNode          , UNSUPPORTED_NODE            , 0x9b)
...
CHIP_IM_STATUS_CODE(TermsAndConditionsChanged, TERMS_AND_CONDITIONS_CHANGED, 0xcd)
CHIP_IM_STATUS_CODE(MaintenanceRequired      , MAINTENANCE_REQUIRED        , 0xce)
CHIP_IM_STATUS_CODE(DynamicConstraintError   , DYNAMIC_CONSTRAINT_ERROR    , 0xcf)
CHIP_IM_STATUS_CODE(AlreadyExists            , ALREADY_EXISTS              , 0xd0)
CHIP_IM_STATUS_CODE(InvalidTransportType     , INVALID_TRANSPORT_TYPE      , 0xd1)
