...
TEST_SCRIPT_ESC = shlex.quote(str(CONTROLLER_TEST_SCRIPTS_DIR / "commissioning_failure_test.py"))
...
class TestCommissioningFailure(CHIPVirtualHome):
...
if __name__ == "__main__":
    sys.exit(TestCommissioningFailure(DEVICE_CONFIG).run_test())
