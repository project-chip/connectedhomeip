...
def run_self_test() -> int:
    ...
    simulated_server_log = (
        b"Thread interface: wpan0\n[SVR] Server Listening...\notbr-agent[30]:"
        b" MeshForwarder-: Received IPv6 UDP msg, radio:15.4\n[SC] CASE Server"
        b" detected Sigma1 MRP retry. Resending Sigma2/ACK.\n[SC] Preemption"
        b" deferred: Sigma2 in transit (grace window 700 ms).\n[SC] CASE Server"
        b" passed Quadruple Guard Preemption. Preempting stale session.\n[SC]"
        b" Preempting stale CASE session for superseding retry\n[SC] CASE Session"
        b" established to peer\n"
    )
