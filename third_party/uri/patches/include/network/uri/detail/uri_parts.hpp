...
public:
    ...
    uri_part(const_iterator first_arg, const_iterator last_arg) noexcept : first(first_arg), last(last_arg) {}
    ...
    string_view to_string_view() const noexcept { return string_view(ptr(), static_cast<size_type>(length())); }
