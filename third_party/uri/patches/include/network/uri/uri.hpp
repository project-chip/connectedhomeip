...
public:
    ...
    public:
        ...
        inline bool operator!=(const query_iterator & other) const noexcept { return !(*this == other); }
     ...
     */
    template <typename InputIter, typename OutputIter>
    static OutputIter encode_query_component(InputIter first, InputIter last, OutputIter out)
    {
     ...
     */
    template <typename InputIter, typename OutputIter>
    static OutputIter encode_query_key_value_pair(InputIter key_first, InputIter key_last, InputIter value_first,
                                                  InputIter value_last, OutputIter out)
    {
...
private:
    ...
    void initialize(optional<string_type> scheme, optional<string_type> user_info, optional<string_type> host,
...
struct hash<network::uri>
{
    ...
    {
        std::size_t seed = 0;
        std::for_each(std::begin(uri_), std::end(uri_), [&seed](network::uri::value_type v) {
