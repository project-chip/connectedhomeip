...
#define GENERATED_ATTRIBUTES {                                                                                                                                                                                               \
    ...
    { 0x0000, ZCL_ENUM16_ATTRIBUTE_TYPE, 2, (ATTRIBUTE_MASK_MIN_MAX | ATTRIBUTE_MASK_CLIENT | ATTRIBUTE_MASK_SINGLETON), { (uint8_t*)&(minMaxDefaults[4]) } }, /* 9 / Key Establishment / key establishment suite (client)*/ \
    ...
    { 0x0000, ZCL_ENUM16_ATTRIBUTE_TYPE, 2, (ATTRIBUTE_MASK_MIN_MAX | ATTRIBUTE_MASK_SINGLETON), { (uint8_t*)&(minMaxDefaults[5]) } }, /* 11 / Key Establishment / key establishment suite (server)*/                        \
...
#define GENERATED_CLUSTERS {                                                                                                                                                                                                                                                                                                                           \
    ...
    { 0x0703, (EmberAfAttributeMetadata*)&(generatedAttributes[8]), 1, 2, (CLUSTER_MASK_SERVER | CLUSTER_MASK_INIT_FUNCTION), emberAfFuncArrayMessagingClusterServer, },                                                                                                                                                                               \
