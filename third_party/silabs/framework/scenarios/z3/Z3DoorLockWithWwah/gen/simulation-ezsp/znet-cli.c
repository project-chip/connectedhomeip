...
static EmberCommandEntry emberCommandPluginCriticalMessageQueueTable[] = {
  emberCommandEntryActionWithDetails("print-config", printConfig, "", "Prints the config", NULL),
  emberCommandEntryActionWithDetails("print-queue", printQueue, "", "Prints the CMQ", NULL),
  emberCommandEntryTerminator(),
};
void emAfPluginDoorLockServerApplyCodeCommand(void);
#if defined(EMBER_COMMAND_INTEPRETER_HAS_DESCRIPTION_FIELD)
static const char * const pluginDoorLockServerApplyPinCommandArguments[] = {
  "The PIN to enter into the door lock.",
  NULL
};
#endif
...
void emAfPluginDoorLockServerApplyCodeCommand(void);
#if defined(EMBER_COMMAND_INTEPRETER_HAS_DESCRIPTION_FIELD)
static const char * const pluginDoorLockServerApplyRfidCommandArguments[] = {
...
#if defined(EMBER_COMMAND_INTEPRETER_HAS_DESCRIPTION_FIELD)
static const char * const pluginDoorLockServerLockCommandArguments[] = {
  "The user ID for whoever is locking the door.",
  NULL
};
#endif
...
void emAfPluginDoorLockServerLockOrUnlockCommand(void);
#if defined(EMBER_COMMAND_INTEPRETER_HAS_DESCRIPTION_FIELD)
static const char * const pluginDoorLockServerUnlockCommandArguments[] = {
  "The user ID for whoever is unlocking the door.",
  NULL
};
#endif

static EmberCommandEntry emberCommandPluginDoorLockServerTable[] = {
  emberCommandEntryActionWithDetails("apply-pin", emAfPluginDoorLockServerApplyCodeCommand, "b", "Simulate a PIN being entered into the door lock.", pluginDoorLockServerApplyPinCommandArguments),
  emberCommandEntryActionWithDetails("apply-rfid", emAfPluginDoorLockServerApplyCodeCommand, "b", "Simulate an RFID device being brought within range of the door lock.", pluginDoorLockServerApplyRfidCommandArguments),
  emberCommandEntryActionWithDetails("close", emAfPluginDoorLockServerOpenOrCloseCommand, "", "Close the door (on currently hardcoded endpoint 1).", NULL),
  emberCommandEntryActionWithDetails("lock", emAfPluginDoorLockServerLockOrUnlockCommand, "v", "Lock the door (on currently hardcoded endpoint 1).", pluginDoorLockServerLockCommandArguments),
  emberCommandEntryActionWithDetails("open", emAfPluginDoorLockServerOpenOrCloseCommand, "", "Open the door (on currently hardcoded endpoint 1).", NULL),
  emberCommandEntryActionWithDetails("status", emAfPluginDoorLockServerStatusCommand, "", "Print out the current status of the door lock.", NULL),
  emberCommandEntryActionWithDetails("unlock", emAfPluginDoorLockServerLockOrUnlockCommand, "v", "Unlock the door (on currently hardcoded endpoint 1).", pluginDoorLockServerUnlockCommandArguments),
  emberCommandEntryTerminator(),
};
...
static EmberCommandEntry emberCommandPluginTable[] = {
  ...
  emberCommandEntrySubMenu("critical-message-queue", emberCommandPluginCriticalMessageQueueTable, ""),
  emberCommandEntrySubMenu("door-lock-server", emberCommandPluginDoorLockServerTable, ""),
