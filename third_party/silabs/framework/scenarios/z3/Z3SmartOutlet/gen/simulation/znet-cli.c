...
#if defined(EMBER_COMMAND_INTEPRETER_HAS_DESCRIPTION_FIELD)
static const char * const pluginElectricalMeasurementServerCalibrateCommandArguments[] = {
...
static EmberCommandEntry emberCommandPluginElectricalMeasurementServerTable[] = {
  emberCommandEntryActionWithDetails("calibrate", emAfElectricalMeasurementServerCalibrate, "s", "Perform Power Meter calibration.", pluginElectricalMeasurementServerCalibrateCommandArguments),
  emberCommandEntryActionWithDetails("read-active-power", emAfElectricalMeasurementServerReadActivePower, "", "Read Active Power.", NULL),
  emberCommandEntryActionWithDetails("read-irms", emAfElectricalMeasurementServerReadIrms, "", "Read RMS Current.", NULL),
  emberCommandEntryActionWithDetails("read-power-factor", emAfElectricalMeasurementServerReadPowerFactor, "", "Read Power Factor.", NULL),
  emberCommandEntryActionWithDetails("read-vrms", emAfElectricalMeasurementServerReadVrms, "", "Read RMS Voltage.", NULL),
  emberCommandEntryTerminator(),
};
...
#if defined(EMBER_COMMAND_INTEPRETER_HAS_DESCRIPTION_FIELD)
static const char * const pluginIlluminanceMeasurementServerCalibrateCommandArguments[] = {
  "reading from reference external Lux meter",
  NULL
};
#endif

void emberAfPluginIlluminanceMeasurementServerReadEventHandler(void);
static EmberCommandEntry emberCommandPluginIlluminanceMeasurementServerTable[] = {
  emberCommandEntryActionWithDetails("calibrate", emAfIlluminanceMeasurementServerCalibrateCommand, "w", "Calibrate the gain multipier of the illuminance sensor.", pluginIlluminanceMeasurementServerCalibrateCommandArguments),
  emberCommandEntryActionWithDetails("read", emberAfPluginIlluminanceMeasurementServerReadEventHandler, "", "Read the illuminance sensor.", NULL),
  emberCommandEntryTerminator(),
};
...
static const char * const pluginMeteringServerProfilesCommandArguments[] = {
  "The profile to set",
  NULL
};
#endif
...
#if defined(EMBER_COMMAND_INTEPRETER_HAS_DESCRIPTION_FIELD)
static const char * const pluginMeteringServerToggleFastPollModeCommandArguments[] = {
  "0 to disable fast polling mode and any other value to enable it",
  NULL
};
#endif

static EmberCommandEntry emberCommandPluginMeteringServerTable[] = {
#if defined(EMBER_AF_PLUGIN_SIMPLE_METERING_SERVER_TEST_METER_ENABLE)
  emberCommandEntryActionWithDetails("profiles", emberAfPluginMeteringServerCliProfiles, "u", "Turn on and off profiles on the test meter server.", pluginMeteringServerProfilesCommandArguments),
#endif //defined(EMBER_AF_PLUGIN_SIMPLE_METERING_SERVER_TEST_METER_ENABLE)
  emberCommandEntryActionWithDetails("toggle-fast-poll-mode", emberAfPluginMeteringServerCliDisableFastPolling, "u", "Disable fast polling mode for testing.", pluginMeteringServerToggleFastPollModeCommandArguments),
  emberCommandEntryTerminator(),
};
...
static EmberCommandEntry emberCommandPluginRelativeHumidityMeasurementServerTable[] = {
  emberCommandEntryActionWithDetails("read", emAfRelativeHumidityMeasurementServerReadCommand, "", "Read the humidity sensor.", NULL),
  emberCommandEntryTerminator(),
};
...
static EmberCommandEntry emberCommandPluginTable[] = {
  ...
  emberCommandEntrySubMenu("electrical-measurement-server", emberCommandPluginElectricalMeasurementServerTable, ""),
  ...
  emberCommandEntrySubMenu("illuminance-measurement-server", emberCommandPluginIlluminanceMeasurementServerTable, ""),
  emberCommandEntrySubMenu("metering-server", emberCommandPluginMeteringServerTable, ""),
  ...
  emberCommandEntrySubMenu("relative-humidity-measurement-server", emberCommandPluginRelativeHumidityMeasurementServerTable, ""),
