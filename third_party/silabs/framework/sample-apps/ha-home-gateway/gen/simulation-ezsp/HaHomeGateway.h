...
#define EM_AF_GENERATED_NETWORK_STRINGS \
  "Primary (pro)",                      \
/**** ZCL Section ****/
#define ZA_PROMPT "HaHomeGateway"
...
#define EMBER_AF_POLL_CONTROL_CLUSTER_CLIENT_ENDPOINT_COUNT (2)
...
#define EMBER_AF_11073_PROTOCOL_TUNNEL_CLUSTER_SERVER_ENDPOINT_COUNT (1)
...
#define EMBER_AF_PRINT_BITS { 0x17, 0x00, 0x00, 0x40, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00 }
...
// Use this macro to check if Standalone Bootloader Server plugin is included
#define EMBER_AF_PLUGIN_STANDALONE_BOOTLOADER_SERVER
// User options for plugin Standalone Bootloader Server
#define EMBER_AF_PLUGIN_STANDALONE_BOOTLOADER_SERVER_ENCRYPTION_KEY { 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11 }
