...
/** @addtogroup plugin-coexistence Plugin Commands: Coexistence
 * @ingroup cli
...
/** @brief <b>plugin coexistence set-gpio-input [gpioIndex:1] [enabled:1] </b>
 *   - <i>Override the input value of a coexistence GPIO.</i>
...
/** @brief <b>plugin coexistence set-phy-state [timeout:1] </b>
 *   - <i>Set the PTA PHY Select state</i>
...
/** @brief <b>plugin coexistence set-pta-options [state:4] </b>
 *   - <i>Set the PTA Options</i>
...
/** @brief <b>plugin coexistence set-pta-state [state:1] </b>
 *   - <i>Set the PTA enable/disable state</i>
...
/** @brief <b>plugin coexistence set-pwm-state [pwmPeriod_halfms:1] [pwmPulse_DC:1] [pwmPriority:1] </b>
 *   - <i>Set the PTA PWM state</i>
...
/** @} */ // end group plugin-coexistence

/** @addtogroup plugin-coulomb-counter Plugin Commands: Coulomb Counter
 * @ingroup cli
 * The Coulomb Counter plugin contributes several commands to the application
 * framework's CLI.  These commands are used to control the plugin's behavior.
 *
 * @{
 */

/** @brief <b>plugin coulomb-counter additive-modes </b>
 *   - <i>Displays the current status of all additive modes.</i>
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_PLUGIN_COULOMB_COUNTER_PLUGIN_COULOMB_COUNTER_ADDITIVE_MODES

/** @brief <b>plugin coulomb-counter current-core-mode </b>
 *   - <i>Displays the current core mode.</i>
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_PLUGIN_COULOMB_COUNTER_PLUGIN_COULOMB_COUNTER_CURRENT_CORE_MODE

/** @brief <b>plugin coulomb-counter energy-usage </b>
 *   - <i>Displays the currently stored energy usage value.</i>
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_PLUGIN_COULOMB_COUNTER_PLUGIN_COULOMB_COUNTER_ENERGY_USAGE

/** @brief <b>plugin coulomb-counter reset-energy-usage </b>
 *   - <i>Resets the currently stored energy usage value.</i>
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_PLUGIN_COULOMB_COUNTER_PLUGIN_COULOMB_COUNTER_RESET_ENERGY_USAGE

/** @} */ // end group plugin-coulomb-counter
