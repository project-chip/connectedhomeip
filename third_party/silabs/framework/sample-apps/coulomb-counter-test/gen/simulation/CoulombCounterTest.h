...
#define EM_AF_GENERATED_NETWORK_STRINGS \
  "Primary (pro)",                      \
/**** ZCL Section ****/
#define ZA_PROMPT "CoulombCounterTest"
...
// Use this macro to check if Coulomb Counter plugin is included
#define EMBER_AF_PLUGIN_COULOMB_COUNTER
// User options for plugin Coulomb Counter
#define EMBER_AF_PLUGIN_COULOMB_COUNTER_ENERGY_CONSUMPTION_WHILE_ASLEEP 131072
#define EMBER_AF_PLUGIN_COULOMB_COUNTER_ENERGY_CONSUMPTION_WHILE_IDLE 262144
#define EMBER_AF_PLUGIN_COULOMB_COUNTER_ENERGY_CONSUMPTION_WHILE_AWAKE 524288
#define EMBER_AF_PLUGIN_COULOMB_COUNTER_ENERGY_CONSUMPTION_WHILE_TX 1024
#define EMBER_AF_PLUGIN_COULOMB_COUNTER_ENERGY_CONSUMPTION_WHILE_RX 1024
#define EMBER_AF_PLUGIN_COULOMB_COUNTER_EEPROM_UNINITIALIZED 0
#define EMBER_AF_PLUGIN_COULOMB_COUNTER_EEPROM_SHUTDOWN 0
#define EMBER_AF_PLUGIN_COULOMB_COUNTER_EEPROM_INITIALIZED 0
#define EMBER_AF_PLUGIN_COULOMB_COUNTER_EEPROM_WRITING 0
#define EMBER_AF_PLUGIN_COULOMB_COUNTER_EEPROM_READING 0
#define EMBER_AF_PLUGIN_COULOMB_COUNTER_EEPROM_ERASING 0
#define EMBER_AF_PLUGIN_COULOMB_COUNTER_TRIGGER_THRESHOLD 5096
#define EMBER_AF_PLUGIN_COULOMB_COUNTER_TOKEN_SAVE_INTERVAL 3600
...
// API coulomb-counter from Coulomb Counter plugin
#define EMBER_AF_API_COULOMB_COUNTER "../../../../plugin/coulomb-counter/coulomb-counter.h"
