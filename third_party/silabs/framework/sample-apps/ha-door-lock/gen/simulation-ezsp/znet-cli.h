...
/** @addtogroup plugin-ias-zone-server Plugin Commands: IAS Zone Server
 * @ingroup cli
 * This plugin provides a set of CLI commands for managing the local IAS Zone
 * server.
 *
 * @{
 */

/** @brief <b>plugin ias-zone-server change-backoff-config [firstBackoff:1] [commonRatio:1] [maxBackoff:4] [unlimitedRetries:1] [maxRetryAttempts:2] </b>
 *   - <i>Update the IAS Zone server's backoff configuration parameters.</i>
...
/** @brief <b>plugin ias-zone-server changeStatus [newStatus:2] [timeSinceOccurredSeconds:1] [endpoint:1] </b>
 *   - <i>Update the zone status attribute of a given endpoint's IAS Zone cluster to the given value</i>
...
/** @brief <b>plugin ias-zone-server info [endpoint:1] </b>
 *   - <i>Print current value of the following cluster attributes: zone type, zone state, zone status, zone id</i>
...
/** @brief <b>plugin ias-zone-server print-queue </b>
 *   - <i>Prints information on the status queue.</i>
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_PLUGIN_IAS_ZONE_SERVER_PLUGIN_IAS_ZONE_SERVER_PRINT_QUEUE

/** @brief <b>plugin ias-zone-server print-queue-config </b>
 *   - <i>Prints the status queue config.</i>
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_PLUGIN_IAS_ZONE_SERVER_PLUGIN_IAS_ZONE_SERVER_PRINT_QUEUE_CONFIG

/** @brief <b>plugin ias-zone-server set-enrollment-mode [endpoint:1] [enrollmentMode:1] </b>
 *   - <i>Update the IAS Zone server's enrollment method to the specified value</i>
...
/** @} */ // end group plugin-ias-zone-server
