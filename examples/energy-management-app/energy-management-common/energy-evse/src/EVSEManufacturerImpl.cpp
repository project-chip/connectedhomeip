                                                         ...
                                                         int64_t aCumulativeEnergyExported)
{
    ...
    {
        ChipLogError(AppServer, "GetClock_EpochTS returned error getting timestamp %" CHIP_ERROR_FORMAT, err.Format());
                                                       ...
                                                       int64_t aPeriodicEnergyExported)
{
    ...
    {
        ChipLogError(AppServer, "GetClock_EpochTS returned error getting timestamp");
