...
{
    VerifyOrDieWithMsg(gPTInstance.get() != nullptr, AppServer, "PowerTopology instance is null");
...
{
    VerifyOrDieWithMsg(gEPMInstance.get() != nullptr, AppServer, "ElectricalPowerMeasurement instance is null");
