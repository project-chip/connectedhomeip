...
After commissioning is complete, press SW2 to start charging simulation, LED turns on,
press SW2 again to stop the simulation, or it will stop automatically once the total energy imported reaches 66kWH.