      ...
      "clusters": [
        ...
        },
        {
          ...
          "attributes": [
            ...
            "    0x0004 |         | server |           Ext |           |         |                      |          1 |                   1 |               65534 |                     => ICDCounter [int32u]",
            "    0x0005 |         | server |           Ext |           |         |                    1 |          1 |                   1 |               65534 |                     => ClientsSupportedPerFabric [int16u]",
      ...
      "clusters": [
        ...
        },
        {
          ...
          "attributes": [
            ...
            "    0x0001 |         | server |           RAM |           |         |                    2 |          1 |                   1 |               65534 |                     => Order [int8u]",
            "    0x0002 |         | server |           RAM |           |         |                   B2 |          1 |                   1 |               65534 |                     => Description [char_string]",
