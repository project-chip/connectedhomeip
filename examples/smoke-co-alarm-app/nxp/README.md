# CHIP NXP Smoke CO Alarm Application

## Overview

The NXP Smoke CO Alarm example is based on
[Project CHIP](https://github.com/project-chip/connectedhomeip) and NXP SDK, and
provides a prototype of a smoke CO alarm device that demonstrates device commissioning and
different cluster control.

### Supported platforms

The Smoke CO Alarm example is supported on the following platforms :
