...
Refer to the [Matter Casting APIs documentation](https://project-chip.github.io/connectedhomeip-doc/examples/tv-casting-app/APIs.html) to build the Matter "Casting Client" into your consumer-facing mobile app.
...
This example Matter TV Casting Darwin app can be tested with the [example Matter tv-app](https://github.com/project-chip/connectedhomeip/tree/master/examples/tv-app) running on a Raspberry Pi or other supported platform.
