...
void MediaFileManagementBdxServer::HandleTransferSessionOutput(TransferSession::OutputEvent & event)
{
    ...
    case TransferSession::OutputEventType::kQueryWithSkipReceived: {
        ...
        {
            ChipLogError(BDX, "MediaFileManagementBdxServer: seek offset %llu past end (%llu)",
    ...
    case TransferSession::OutputEventType::kAckEOFReceived:
        ...
        // The grant is single-use: a file offered/added to the Media Device is
        // pulled exactly once. Drop it so it cannot be re-pulled and mGrants does
        // not grow without bound across successive offers.
        mGrants.erase(mFileDesignator);
        Reset();
        break;
