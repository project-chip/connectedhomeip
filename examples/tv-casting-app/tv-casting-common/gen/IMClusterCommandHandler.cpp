...
if (CHIP_END_OF_TLV == TLVError)
{
  ...
  TLVError = CHIP_NO_ERROR;
        ...
        if (CHIP_NO_ERROR == TLVError && CHIP_NO_ERROR == TLVUnpackError && 2 == validArgumentCount)
{
wasHandled = emberAfOtaSoftwareUpdateProviderClusterApplyUpdateRequestCallback(aEndpointId, apCommandObj, updateToken, newVersion);
        }
            break;
        }
...
if (CHIP_END_OF_TLV == TLVError)
{
  ...
  TLVError = CHIP_NO_ERROR;
        ...
        if (CHIP_NO_ERROR == TLVError && CHIP_NO_ERROR == TLVUnpackError && 2 == validArgumentCount)
{
wasHandled = emberAfOtaSoftwareUpdateProviderClusterNotifyUpdateAppliedCallback(aEndpointId, apCommandObj, updateToken, currentVersion);
        }
            break;
        }
...
{
wasHandled = emberAfOtaSoftwareUpdateProviderClusterQueryImageCallback(aEndpointId, apCommandObj, vendorId, productId, imageType, hardwareVersion, currentVersion, protocolsSupported, const_cast<uint8_t*>(location), requestorCanConsent, metadataForProvider);
        }
            break;
        }
        default: {
...
if (CHIP_END_OF_TLV == TLVError)
{
  ...
  TLVError = CHIP_NO_ERROR;
        ...
        if (CHIP_NO_ERROR == TLVError && CHIP_NO_ERROR == TLVUnpackError && 3 == validArgumentCount)
{
wasHandled = emberAfOperationalCredentialsClusterRemoveFabricCallback(aEndpointId, apCommandObj, FabricId, NodeId, VendorId);
        }
            break;
        }
