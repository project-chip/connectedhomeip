...
#define GENERATED_ENDPOINT_TYPES                                                                                                   \
    {                                                                                                                              \
        { ZAP_CLUSTER_INDEX(0), 15, 3527 }, { ZAP_CLUSTER_INDEX(15), 1, 3 }, { ZAP_CLUSTER_INDEX(16), 2, 6 },                      \
            { ZAP_CLUSTER_INDEX(18), 0, 0 }, { ZAP_CLUSTER_INDEX(18), 0, 0 }, { ZAP_CLUSTER_INDEX(18), 0, 0 },                     \
    }
=======
#define GENERATED_ATTRIBUTES                                                   \
  {                                                                            \
    ...
    {0x0000, ZAP_TYPE(ARRAY), 254, 0,                                          \
     ZAP_LONG_DEFAULTS_INDEX(0)}, /* device list */                            \
        ...
        {0x0003, ZAP_TYPE(CHAR_STRING), 32, ZAP_ATTRIBUTE_MASK(SINGLETON),     \
         ZAP_LONG_DEFAULTS_INDEX(1048)}, /* ProductName */                     \
        ...
        {0x0009, ZAP_TYPE(INT32U), 4, ZAP_ATTRIBUTE_MASK(SINGLETON),           \
         ZAP_LONG_DEFAULTS_INDEX(1176)}, /* SoftwareVersion */                 \
        {0x000A, ZAP_TYPE(CHAR_STRING), 64, ZAP_ATTRIBUTE_MASK(SINGLETON),     \
         ZAP_LONG_DEFAULTS_INDEX(1180)}, /* SoftwareVersionString */           \
        {0x000B, ZAP_TYPE(CHAR_STRING), 16, ZAP_ATTRIBUTE_MASK(SINGLETON),     \
         ZAP_LONG_DEFAULTS_INDEX(1244)}, /* ManufacturingDate */               \
        {0x000C, ZAP_TYPE(CHAR_STRING), 32, ZAP_ATTRIBUTE_MASK(SINGLETON),     \
         ZAP_LONG_DEFAULTS_INDEX(1260)}, /* PartNumber */                      \
        {0x000D, ZAP_TYPE(CHAR_STRING), 256, ZAP_ATTRIBUTE_MASK(SINGLETON),    \
         ZAP_LONG_DEFAULTS_INDEX(1292)}, /* ProductURL */                      \
        {0x000E, ZAP_TYPE(CHAR_STRING), 64, ZAP_ATTRIBUTE_MASK(SINGLETON),     \
         ZAP_LONG_DEFAULTS_INDEX(1548)}, /* ProductLabel */                    \
        {0x000F, ZAP_TYPE(CHAR_STRING), 32, ZAP_ATTRIBUTE_MASK(SINGLETON),     \
         ZAP_LONG_DEFAULTS_INDEX(1612)}, /* SerialNumber */                    \
        {0x0010, ZAP_TYPE(BOOLEAN), 1,                                         \
         ZAP_ATTRIBUTE_MASK(SINGLETON) | ZAP_ATTRIBUTE_MASK(WRITABLE),         \
         ZAP_SIMPLE_DEFAULT(0x00)}, /* LocalConfigDisabled */                  \
        ...
        {0x0000, ZAP_TYPE(OCTET_STRING), 8, 0,                                 \
         ZAP_LONG_DEFAULTS_INDEX(1644)}, /* FabricId */                        \
        {0x0001, ZAP_TYPE(INT64U), 8, ZAP_ATTRIBUTE_MASK(WRITABLE),            \
         ZAP_LONG_DEFAULTS_INDEX(1652)}, /* Breadcrumb */                      \
        {0xFFFD, ZAP_TYPE(INT16U), 2, 0,                                       \
         ZAP_SIMPLE_DEFAULT(0x0001)}, /* ClusterRevision */                    \
                                                                               \
        /* Endpoint: 0, Cluster: Network Commissioning (server) */             \
        ...
        /* Endpoint: 0, Cluster: General Diagnostics (server) */               \
        {0x0000, ZAP_TYPE(ARRAY), 254, 0,                                      \
         ZAP_LONG_DEFAULTS_INDEX(1660)}, /* NetworkInterfaces */               \
        ...
        {0x0003, ZAP_TYPE(INT64U), 8, 0,                                       \
         ZAP_LONG_DEFAULTS_INDEX(1914)}, /* CurrentHeapHighWatermark */        \
        {0xFFFD, ZAP_TYPE(INT16U), 2, 0,                                       \
         ZAP_SIMPLE_DEFAULT(0x0001)}, /* ClusterRevision */                    \
                                                                               \
        /* Endpoint: 0, Cluster: Thread Network Diagnostics (server) */        \
        ...
        {0x0002, ZAP_TYPE(OCTET_STRING), 16, 0,                                \
         ZAP_LONG_DEFAULTS_INDEX(1922)}, /* NetworkName */                     \
        {0x0003, ZAP_TYPE(INT16U), 2, 0,                                       \
         ZAP_SIMPLE_DEFAULT(0x0000)}, /* PanId */                              \
        {0x0004, ZAP_TYPE(INT64U), 8, 0,                                       \
         ZAP_LONG_DEFAULTS_INDEX(1938)}, /* ExtendedPanId */                   \
        {0x0005, ZAP_TYPE(OCTET_STRING), 17, 0,                                \
         ZAP_LONG_DEFAULTS_INDEX(1946)}, /* MeshLocalPrefix */                 \
        {0x0006, ZAP_TYPE(INT64U), 8, 0,                                       \
         ZAP_LONG_DEFAULTS_INDEX(1963)}, /* OverrunCount */                    \
        {0x0007, ZAP_TYPE(ARRAY), 254, 0,                                      \
         ZAP_LONG_DEFAULTS_INDEX(1971)}, /* NeighborTableList */               \
        {0x0008, ZAP_TYPE(ARRAY), 254, 0,                                      \
         ZAP_LONG_DEFAULTS_INDEX(2225)}, /* RouteTableList */                  \
        {0x0009, ZAP_TYPE(INT32U), 4, 0,                                       \
         ZAP_LONG_DEFAULTS_INDEX(2479)}, /* PartitionId */                     \
        {0x000A, ZAP_TYPE(INT8U), 1, 0, ZAP_EMPTY_DEFAULT()}, /* weighting */  \
        {0x000B, ZAP_TYPE(INT8U), 1, 0,                                        \
        ...
        {0x0016, ZAP_TYPE(INT32U), 4, 0,                                       \
         ZAP_LONG_DEFAULTS_INDEX(2483)}, /* TxTotalCount */                    \
        {0x0017, ZAP_TYPE(INT32U), 4, 0,                                       \
         ZAP_LONG_DEFAULTS_INDEX(2487)}, /* TxUnicastCount */                  \
        {0x0018, ZAP_TYPE(INT32U), 4, 0,                                       \
         ZAP_LONG_DEFAULTS_INDEX(2491)}, /* TxBroadcastCount */                \
        {0x0019, ZAP_TYPE(INT32U), 4, 0,                                       \
         ZAP_LONG_DEFAULTS_INDEX(2495)}, /* TxAckRequestedCount */             \
        {0x001A, ZAP_TYPE(INT32U), 4, 0,                                       \
         ZAP_LONG_DEFAULTS_INDEX(2499)}, /* TxAckedCount */                    \
        {0x001B, ZAP_TYPE(INT32U), 4, 0,                                       \
         ZAP_LONG_DEFAULTS_INDEX(2503)}, /* TxNoAckRequestedCount */           \
        {0x001C, ZAP_TYPE(INT32U), 4, 0,                                       \
         ZAP_LONG_DEFAULTS_INDEX(2507)}, /* TxDataCount */                     \
        {0x001D, ZAP_TYPE(INT32U), 4, 0,                                       \
         ZAP_LONG_DEFAULTS_INDEX(2511)}, /* TxDataPollCount */                 \
        {0x001E, ZAP_TYPE(INT32U), 4, 0,                                       \
         ZAP_LONG_DEFAULTS_INDEX(2515)}, /* TxBeaconCount */                   \
        {0x001F, ZAP_TYPE(INT32U), 4, 0,                                       \
         ZAP_LONG_DEFAULTS_INDEX(2519)}, /* TxBeaconRequestCount */            \
        {0x0020, ZAP_TYPE(INT32U), 4, 0,                                       \
         ZAP_LONG_DEFAULTS_INDEX(2523)}, /* TxOtherCount */                    \
        {0x0021, ZAP_TYPE(INT32U), 4, 0,                                       \
         ZAP_LONG_DEFAULTS_INDEX(2527)}, /* TxRetryCount */                    \
        {0x0022, ZAP_TYPE(INT32U), 4, 0,                                       \
         ZAP_LONG_DEFAULTS_INDEX(2531)}, /* TxDirectMaxRetryExpiryCount */     \
        {0x0023, ZAP_TYPE(INT32U), 4, 0,                                       \
         ZAP_LONG_DEFAULTS_INDEX(2535)}, /* TxIndirectMaxRetryExpiryCount */   \
        {0x0024, ZAP_TYPE(INT32U), 4, 0,                                       \
         ZAP_LONG_DEFAULTS_INDEX(2539)}, /* TxErrCcaCount */                   \
        {0x0025, ZAP_TYPE(INT32U), 4, 0,                                       \
         ZAP_LONG_DEFAULTS_INDEX(2543)}, /* TxErrAbortCount */                 \
        {0x0026, ZAP_TYPE(INT32U), 4, 0,                                       \
         ZAP_LONG_DEFAULTS_INDEX(2547)}, /* TxErrBusyChannelCount */           \
        {0x0027, ZAP_TYPE(INT32U), 4, 0,                                       \
         ZAP_LONG_DEFAULTS_INDEX(2551)}, /* RxTotalCount */                    \
        {0x0028, ZAP_TYPE(INT32U), 4, 0,                                       \
         ZAP_LONG_DEFAULTS_INDEX(2555)}, /* RxUnicastCount */                  \
        {0x0029, ZAP_TYPE(INT32U), 4, 0,                                       \
         ZAP_LONG_DEFAULTS_INDEX(2559)}, /* RxBroadcastCount */                \
        {0x002A, ZAP_TYPE(INT32U), 4, 0,                                       \
         ZAP_LONG_DEFAULTS_INDEX(2563)}, /* RxDataCount */                     \
        {0x002B, ZAP_TYPE(INT32U), 4, 0,                                       \
         ZAP_LONG_DEFAULTS_INDEX(2567)}, /* RxDataPollCount */                 \
        {0x002C, ZAP_TYPE(INT32U), 4, 0,                                       \
         ZAP_LONG_DEFAULTS_INDEX(2571)}, /* RxBeaconCount */                   \
        {0x002D, ZAP_TYPE(INT32U), 4, 0,                                       \
         ZAP_LONG_DEFAULTS_INDEX(2575)}, /* RxBeaconRequestCount */            \
        {0x002E, ZAP_TYPE(INT32U), 4, 0,                                       \
         ZAP_LONG_DEFAULTS_INDEX(2579)}, /* RxOtherCount */                    \
        {0x002F, ZAP_TYPE(INT32U), 4, 0,                                       \
         ZAP_LONG_DEFAULTS_INDEX(2583)}, /* RxAddressFilteredCount */          \
        {0x0030, ZAP_TYPE(INT32U), 4, 0,                                       \
         ZAP_LONG_DEFAULTS_INDEX(2587)}, /* RxDestAddrFilteredCount */         \
        {0x0031, ZAP_TYPE(INT32U), 4, 0,                                       \
         ZAP_LONG_DEFAULTS_INDEX(2591)}, /* RxDuplicatedCount */               \
        {0x0032, ZAP_TYPE(INT32U), 4, 0,                                       \
         ZAP_LONG_DEFAULTS_INDEX(2595)}, /* RxErrNoFrameCount */               \
        {0x0033, ZAP_TYPE(INT32U), 4, 0,                                       \
         ZAP_LONG_DEFAULTS_INDEX(2599)}, /* RxErrUnknownNeighborCount */       \
        {0x0034, ZAP_TYPE(INT32U), 4, 0,                                       \
         ZAP_LONG_DEFAULTS_INDEX(2603)}, /* RxErrInvalidSrcAddrCount */        \
        {0x0035, ZAP_TYPE(INT32U), 4, 0,                                       \
         ZAP_LONG_DEFAULTS_INDEX(2607)}, /* RxErrSecCount */                   \
        {0x0036, ZAP_TYPE(INT32U), 4, 0,                                       \
         ZAP_LONG_DEFAULTS_INDEX(2611)}, /* RxErrFcsCount */                   \
        {0x0037, ZAP_TYPE(INT32U), 4, 0,                                       \
         ZAP_LONG_DEFAULTS_INDEX(2615)}, /* RxErrOtherCount */                 \
        {0x003B, ZAP_TYPE(ARRAY), 5, 0,                                        \
         ZAP_LONG_DEFAULTS_INDEX(2619)}, /* SecurityPolicy */                  \
        {0x003C, ZAP_TYPE(INT8U), 1, 0,                                        \
         ZAP_SIMPLE_DEFAULT(0x0000)}, /* ChannelMask */                        \
        {0x003D, ZAP_TYPE(ARRAY), 14, 0,                                       \
         ZAP_LONG_DEFAULTS_INDEX(2624)}, /* OperationalDatasetComponents */    \
        {0x003E, ZAP_TYPE(ARRAY), 4, 0,                                        \
         ZAP_LONG_DEFAULTS_INDEX(2638)}, /* ActiveNetworkFaultsList */         \
        {0xFFFD, ZAP_TYPE(INT16U), 2, 0,                                       \
         ZAP_SIMPLE_DEFAULT(0x0001)}, /* ClusterRevision */                    \
                                                                               \
        /* Endpoint: 0, Cluster: WiFi Network Diagnostics (server) */          \
        {0x0000, ZAP_TYPE(OCTET_STRING), 6, 0,                                 \
         ZAP_LONG_DEFAULTS_INDEX(2642)}, /* bssid */                           \
        {0x0001, ZAP_TYPE(ENUM8), 1, 0,                                        \
        ...
        {0x0002, ZAP_TYPE(INT64U), 8, 0,                                       \
         ZAP_LONG_DEFAULTS_INDEX(2648)}, /* PacketRxCount */                   \
        {0x0003, ZAP_TYPE(INT64U), 8, 0,                                       \
         ZAP_LONG_DEFAULTS_INDEX(2656)}, /* PacketTxCount */                   \
        {0x0004, ZAP_TYPE(INT64U), 8, 0,                                       \
         ZAP_LONG_DEFAULTS_INDEX(2664)}, /* TxErrCount */                      \
        {0x0005, ZAP_TYPE(INT64U), 8, 0,                                       \
         ZAP_LONG_DEFAULTS_INDEX(2672)}, /* CollisionCount */                  \
        {0x0006, ZAP_TYPE(INT64U), 8, 0,                                       \
         ZAP_LONG_DEFAULTS_INDEX(2680)}, /* OverrunCount */                    \
        {0xFFFD, ZAP_TYPE(INT16U), 2, 0,                                       \
         ZAP_SIMPLE_DEFAULT(0x0001)}, /* ClusterRevision */                    \
                                                                               \
        /* Endpoint: 0, Cluster: Operational Credentials (server) */           \
        {0x0001, ZAP_TYPE(ARRAY), 254, 0,                                      \
         ZAP_LONG_DEFAULTS_INDEX(2688)}, /* fabrics list */                    \
        {0xFFFD, ZAP_TYPE(INT16U), 2, 0,                                       \
         ZAP_SIMPLE_DEFAULT(0x0001)}, /* ClusterRevision */                    \
                                                                               \
        /* Endpoint: 0, Cluster: Relative Humidity Measurement (server) */     \
        ...
        /* Endpoint: 0, Cluster: Group Key Management (server) */              \
        {0x0000, ZAP_TYPE(ARRAY), 254, 0,                                      \
         ZAP_LONG_DEFAULTS_INDEX(2942)}, /* groups */                          \
        {0x0001, ZAP_TYPE(ARRAY), 254, 0,                                      \
         ZAP_LONG_DEFAULTS_INDEX(3196)}, /* group keys */                      \
        {0xFFFD, ZAP_TYPE(INT16U), 2, 0,                                       \
         ZAP_SIMPLE_DEFAULT(0x0001)}, /* ClusterRevision */                    \
                                                                               \
        /* Endpoint: 1, Cluster: On/Off (server) */                            \
        {0x0000, ZAP_TYPE(BOOLEAN), 1, 0,                                      \
    ...
    {0x001D, ZAP_ATTRIBUTE_INDEX(0), 5, 1018, ZAP_CLUSTER_MASK(SERVER),        \
     NULL}, /* Endpoint: 0, Cluster: Descriptor (server) */                    \
        {0x0028,                                                               \
         ...
         ZAP_CLUSTER_MASK(SERVER) | ZAP_CLUSTER_MASK(INIT_FUNCTION),           \
         chipFuncArrayBasicServer}, /* Endpoint: 0, Cluster: Basic (server) */ \
        {0x0029, ZAP_ATTRIBUTE_INDEX(23), 1, 2, ZAP_CLUSTER_MASK(SERVER),      \
         NULL}, /* Endpoint: 0, Cluster: OTA Software Update Provider (server) \
                 */                                                            \
        {0x0030, ZAP_ATTRIBUTE_INDEX(24), 3, 18, ZAP_CLUSTER_MASK(SERVER),     \
         NULL}, /* Endpoint: 0, Cluster: General Commissioning (server) */     \
        {0x0031, ZAP_ATTRIBUTE_INDEX(27), 1, 2, ZAP_CLUSTER_MASK(SERVER),      \
         NULL}, /* Endpoint: 0, Cluster: Network Commissioning (server) */     \
        {0x0032, ZAP_ATTRIBUTE_INDEX(28), 0, 0, ZAP_CLUSTER_MASK(SERVER),      \
         NULL}, /* Endpoint: 0, Cluster: Diagnostic Logs (server) */           \
        {0x0033, ZAP_ATTRIBUTE_INDEX(28), 3, 258, ZAP_CLUSTER_MASK(SERVER),    \
         NULL}, /* Endpoint: 0, Cluster: General Diagnostics (server) */       \
        {0x0034, ZAP_ATTRIBUTE_INDEX(31), 2, 10, ZAP_CLUSTER_MASK(SERVER),     \
         NULL}, /* Endpoint: 0, Cluster: Software Diagnostics (server) */      \
        {0x0035, ZAP_ATTRIBUTE_INDEX(33), 61, 747, ZAP_CLUSTER_MASK(SERVER),   \
         NULL}, /* Endpoint: 0, Cluster: Thread Network Diagnostics (server)   \
                 */                                                            \
        {0x0036, ZAP_ATTRIBUTE_INDEX(94), 6, 13, ZAP_CLUSTER_MASK(SERVER),     \
         NULL}, /* Endpoint: 0, Cluster: WiFi Network Diagnostics (server) */  \
        {0x0037, ZAP_ATTRIBUTE_INDEX(100), 6, 42, ZAP_CLUSTER_MASK(SERVER),    \
         NULL}, /* Endpoint: 0, Cluster: Ethernet Network Diagnostics (server) \
                 */                                                            \
        {0x003E, ZAP_ATTRIBUTE_INDEX(106), 2, 256, ZAP_CLUSTER_MASK(SERVER),   \
         NULL}, /* Endpoint: 0, Cluster: Operational Credentials (server) */   \
        {0x0405, ZAP_ATTRIBUTE_INDEX(108), 4, 8, ZAP_CLUSTER_MASK(SERVER),     \
         NULL}, /* Endpoint: 0, Cluster: Relative Humidity Measurement         \
                   (server) */                                                 \
        {0xF000, ZAP_ATTRIBUTE_INDEX(112), 1, 2, ZAP_CLUSTER_MASK(SERVER),     \
         NULL}, /* Endpoint: 0, Cluster: Binding (server) */                   \
        {0xF004, ZAP_ATTRIBUTE_INDEX(113), 3, 510, ZAP_CLUSTER_MASK(SERVER),   \
        ...
        {0x0008,                                                               \
         ...
         3,                                                                    \
         ZAP_CLUSTER_MASK(SERVER) | ZAP_CLUSTER_MASK(INIT_FUNCTION),           \
         chipFuncArrayLevelControlServer}, /* Endpoint: 2, Cluster: Level      \
                                              Control (server) */              \
  }
...
#define GENERATED_ENDPOINT_TYPES                                               \
  {                                                                            \
    {ZAP_CLUSTER_INDEX(0), 15, 3527}, {ZAP_CLUSTER_INDEX(15), 1, 3},           \
        {ZAP_CLUSTER_INDEX(16), 2, 6}, {ZAP_CLUSTER_INDEX(18), 0, 0},          \
        {ZAP_CLUSTER_INDEX(18), 0, 0}, {ZAP_CLUSTER_INDEX(18), 0, 0},          \
  }
>>>>>>> ZAP regen tv-casting-app
    ...
    {0x0028, 0x00, ZAP_COMMAND_MASK(INCOMING_CLIENT)},     /* StartUp */       \
        ...
        {0x0028, 0x00,                                                         \
         ZAP_COMMAND_MASK(INCOMING_SERVER) |                                   \
             ZAP_COMMAND_MASK(OUTGOING_SERVER)}, /* MfgSpecificPing */         \
                                                                               \
        /* Endpoint: 0, Cluster: OTA Software Update Provider (server) */      \
        {0x0029, 0x00, ZAP_COMMAND_MASK(INCOMING_SERVER)}, /* QueryImage */    \
        {0x0029, 0x01,                                                         \
         ZAP_COMMAND_MASK(INCOMING_SERVER)}, /* ApplyUpdateRequest */          \
        {0x0029, 0x02,                                                         \
         ZAP_COMMAND_MASK(INCOMING_SERVER)}, /* NotifyUpdateApplied */         \
        {0x0029, 0x03,                                                         \
         ZAP_COMMAND_MASK(INCOMING_CLIENT)}, /* QueryImageResponse */          \
        {0x0029, 0x04,                                                         \
         ZAP_COMMAND_MASK(INCOMING_CLIENT)}, /* ApplyUpdateRequestResponse */  \
                                                                               \
        /* Endpoint: 0, Cluster: General Commissioning (server) */             \
        {0x0030, 0x00, ZAP_COMMAND_MASK(INCOMING_SERVER)}, /* ArmFailSafe */   \
        {0x0030, 0x01,                                                         \
        ...
        {0x0030, 0x02,                                                         \
         ZAP_COMMAND_MASK(INCOMING_SERVER) |                                   \
             ZAP_COMMAND_MASK(OUTGOING_SERVER)}, /* SetRegulatoryConfig */     \
        {0x0030, 0x03,                                                         \
         ZAP_COMMAND_MASK(INCOMING_SERVER) |                                   \
             ZAP_COMMAND_MASK(                                                 \
                 OUTGOING_SERVER)}, /* SetRegulatoryConfigResponse */          \
        {0x0030, 0x04,                                                         \
         ZAP_COMMAND_MASK(INCOMING_SERVER)}, /* CommissioningComplete */       \
        {0x0030, 0x05,                                                         \
         ZAP_COMMAND_MASK(                                                     \
             INCOMING_CLIENT)}, /* CommissioningCompleteResponse */            \
                                                                               \
        /* Endpoint: 0, Cluster: Network Commissioning (server) */             \
        {0x0031, 0x00, ZAP_COMMAND_MASK(INCOMING_SERVER)}, /* ScanNetworks */  \
        {0x0031, 0x01,                                                         \
        ...
        {0x0031, 0x02,                                                         \
         ZAP_COMMAND_MASK(INCOMING_SERVER)}, /* AddWiFiNetwork */              \
        {0x0031, 0x03,                                                         \
         ZAP_COMMAND_MASK(OUTGOING_SERVER)}, /* AddWiFiNetworkResponse */      \
        {0x0031, 0x04,                                                         \
         ZAP_COMMAND_MASK(INCOMING_SERVER)}, /* UpdateWiFiNetwork */           \
        {0x0031, 0x05,                                                         \
         ZAP_COMMAND_MASK(OUTGOING_SERVER)}, /* UpdateWiFiNetworkResponse */   \
        {0x0031, 0x06,                                                         \
        ...
        {0x0031, 0x0E,                                                         \
         ZAP_COMMAND_MASK(INCOMING_SERVER)}, /* DisableNetwork */              \
        {0x0031, 0x0F,                                                         \
         ZAP_COMMAND_MASK(INCOMING_CLIENT)}, /* DisableNetworkResponse */      \
        {0x0031, 0x10,                                                         \
         ZAP_COMMAND_MASK(                                                     \
             INCOMING_SERVER)}, /* GetLastNetworkCommissioningResult */        \
                                                                               \
        /* Endpoint: 0, Cluster: Diagnostic Logs (server) */                   \
        {0x0032, 0x00,                                                         \
         ZAP_COMMAND_MASK(INCOMING_SERVER)}, /* RetrieveLogsRequest */         \
                                                                               \
        /* Endpoint: 0, Cluster: Software Diagnostics (server) */              \
        {0x0034, 0x00,                                                         \
         ZAP_COMMAND_MASK(INCOMING_SERVER)}, /* ResetWatermarks */             \
                                                                               \
        /* Endpoint: 0, Cluster: Ethernet Network Diagnostics (server) */      \
        {0x0037, 0x00, ZAP_COMMAND_MASK(INCOMING_SERVER)}, /* ResetCounts */   \
                                                                               \
        ...
        {0x0008, 0x03, ZAP_COMMAND_MASK(INCOMING_SERVER)}, /* Stop */          \
        {0x0008, 0x04,                                                         \
         ZAP_COMMAND_MASK(INCOMING_SERVER)}, /* MoveToLevelWithOnOff */        \
        {0x0008, 0x05, ZAP_COMMAND_MASK(INCOMING_SERVER)}, /* MoveWithOnOff */ \
        {0x0008, 0x06, ZAP_COMMAND_MASK(INCOMING_SERVER)}, /* StepWithOnOff */ \
        {0x0008, 0x07, ZAP_COMMAND_MASK(INCOMING_SERVER)}, /* StopWithOnOff */ \
  }
...
#define EMBER_AF_GENERATED_REPORTING_CONFIG_DEFAULTS                              \
  {                                                                               \
                                                                                  \
    /* Endpoint: 0, Cluster: OTA Software Update Provider (server) */             \
    {ZAP_REPORT_DIRECTION(REPORTED), 0x0000, 0x0029,         0xFFFD,              \
     ZAP_CLUSTER_MASK(SERVER),       0x0000, {{0, 65344, 0}}}, /* ClusterRevision \
                                                                */                \
                                                                                  \
        /* Endpoint: 0, Cluster: Relative Humidity Measurement (server) */        \
        {ZAP_REPORT_DIRECTION(REPORTED), 0x0000, 0x0405,         0x0000,          \
         ZAP_CLUSTER_MASK(SERVER),       0x0000, {{0, 65344, 0}}}, /* measured    \
                                                                      value */    \
                                                                                  \
        /* Endpoint: 1, Cluster: On/Off (server) */                               \
        {ZAP_REPORT_DIRECTION(REPORTED), 0x0001, 0x0006,         0x0000,          \
         ZAP_CLUSTER_MASK(SERVER),       0x0000, {{0, 65344, 0}}}, /* OnOff */    \
                                                                                  \
        /* Endpoint: 2, Cluster: On/Off (server) */                               \
        {ZAP_REPORT_DIRECTION(REPORTED), 0x0002, 0x0006,         0x0000,          \
         ZAP_CLUSTER_MASK(SERVER),       0x0000, {{0, 65344, 0}}}, /* OnOff */    \
                                                                                  \
        /* Endpoint: 2, Cluster: Level Control (server) */                        \
        {ZAP_REPORT_DIRECTION(REPORTED), 0x0002, 0x0008,         0x0000,          \
         ZAP_CLUSTER_MASK(SERVER),       0x0000, {{0, 65344, 0}}}, /* current     \
                                                                      level */    \
  }
>>>>>>> ZAP regen tv-casting-app
