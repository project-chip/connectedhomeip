...
#define GENERATED_CLUSTERS { \
  ...
  { 0x0006, ZAP_ATTRIBUTE_INDEX(118), 2, 3, ZAP_CLUSTER_MASK(SERVER) | ZAP_CLUSTER_MASK(INIT_FUNCTION), chipFuncArrayOnOffServer }, /* Endpoint: 2, Cluster: On/Off (server) */ \
  { 0x0008, ZAP_ATTRIBUTE_INDEX(120), 2, 3, ZAP_CLUSTER_MASK(SERVER) | ZAP_CLUSTER_MASK(INIT_FUNCTION), chipFuncArrayLevelControlServer }, /* Endpoint: 2, Cluster: Level Control (server) */ \
}
...
#define GENERATED_ENDPOINT_TYPES { \
  ...
  { ZAP_CLUSTER_INDEX(15), 1, 3 }, \
  { ZAP_CLUSTER_INDEX(16), 2, 6 }, \
  { ZAP_CLUSTER_INDEX(18), 0, 0 }, \
  { ZAP_CLUSTER_INDEX(18), 0, 0 }, \
  { ZAP_CLUSTER_INDEX(18), 0, 0 }, \
}
