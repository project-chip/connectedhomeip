...
public:
    ...
    CHIP_ERROR OpenBasicCommissioningWindow(std::function<CHIP_ERROR(bool)> commissioningCompleteCallback);
    ...
    CHIP_ERROR ContentLauncherLaunchURL(const char * contentUrl, const char * contentDisplayStr,
                                        std::function<CHIP_ERROR(bool)> launchURLResponseCallback);
...
private:
    ...
    std::function<CHIP_ERROR(bool)> mLaunchURLResponseCallback;
    std::function<CHIP_ERROR(bool)> mCommissioningCompleteCallback;
};
