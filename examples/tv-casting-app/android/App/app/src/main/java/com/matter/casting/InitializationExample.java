...
public class InitializationExample {
   ...
   */
  public static DataProvider<CommissionableData> commissionableDataProvider =
      new DataProvider<CommissionableData>() {
         ...
         * passcode commissioning flow is going to be used. In this flow, the setup passcode is
         * generated by the CastingPlayer and entered by the user in the tv-casting-app CX. Once it
         * is obtained, this function should be called with the Commissioner-Generated passcode to
         * update the CommissionableData DataProvider in AppParameters. The client is also
         * responsible for calling CastingApp::updateAndroidChipPlatformWithCommissionableData() to
         * update the data provider set which was previously set in the AppParameters and
         * AndroidChipPlatform at initialization time.
         */
        @Override
