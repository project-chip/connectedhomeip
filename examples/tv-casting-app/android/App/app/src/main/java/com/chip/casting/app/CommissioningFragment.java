...
public class CommissioningFragment extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        boolean status = tvCastingApp.openBasicCommissioningWindow(GlobalCastingConstants.CommissioningWindowDurationSecs);
        Log.d(TAG,"CommissioningFragment.onViewCreated tvCastingApp.openBasicCommissioningWindow returned " + status);
