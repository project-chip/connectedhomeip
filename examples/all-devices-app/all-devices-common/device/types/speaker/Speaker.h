...
class Speaker : public SingleEndpoint
{
public:
    // Takes delegates for the clusters.
    Speaker(Clusters::LevelControlDelegate & levelDelegate, Clusters::OnOffDelegate & onOffDelegate, TimerDelegate & timerDelegate);
