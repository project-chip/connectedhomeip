                                          ...
                                          EndpointComposition composition)
{
    ...
    mServiceAreaDelegate.emplace(mOperationalStateCluster.Cluster());
    ...
    mRunModeDelegate.emplace(mOperationalStateCluster.Cluster(), *mServiceAreaDelegate);
