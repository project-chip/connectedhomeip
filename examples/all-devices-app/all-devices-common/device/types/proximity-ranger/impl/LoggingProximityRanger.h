...
#include <device/types/proximity-ranger/impl/LoggingRangingAdapter.h>
...
/**
 * Default implementation of ProximityRanger for platforms without real
...
public:
    ...
    // ProximityRanger holds into our LoggingRangingAdapter members.
    LoggingProximityRanger(const LoggingProximityRanger &)             = delete;
    LoggingProximityRanger & operator=(const LoggingProximityRanger &) = delete;
