...
TemperatureSensorDevice::TemperatureSensorDevice(TimerDelegate & timerDelegate,
                                                 TemperatureMeasurementCluster::StartupConfiguration tempConfig) :
    SingleEndpointDevice(Span<const DataModel::DeviceTypeEntry>(&Device::Type::kTemperatureSensor, 1)),
