...
DishwasherDevice::DishwasherDevice() : SingleEndpointDevice(Span<const DataModel::DeviceTypeEntry>(&Device::Type::kDishwasher, 1))
{}

CHIP_ERROR DishwasherDevice::Register(EndpointId endpoint, CodeDrivenDataModelProvider & provider, EndpointComposition composition)
{
...
void DishwasherDevice::Unregister(CodeDrivenDataModelProvider & provider)
{
