...
#include "LoggingRefrigeratorDevice.h"

namespace chip::app {

LoggingRefrigeratorDevice::LoggingRefrigeratorDevice(TimerDelegate & timerDelegate) :
    LoggingRefrigeratorDevice(timerDelegate, Config::Default())
{}
