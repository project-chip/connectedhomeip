...
LaundryWasherDevice::LaundryWasherDevice() :
    SingleEndpointDevice(Span<const DataModel::DeviceTypeEntry>(&Device::Type::kLaundryWasher, 1))
{}

CHIP_ERROR LaundryWasherDevice::Register(EndpointId endpoint, CodeDrivenDataModelProvider & provider,
...
void LaundryWasherDevice::Unregister(CodeDrivenDataModelProvider & provider)
{
