...
LaundryDryerDevice::LaundryDryerDevice() :
    SingleEndpointDevice(Span<const DataModel::DeviceTypeEntry>(&Device::Type::kLaundryDryer, 1))
{}

CHIP_ERROR LaundryDryerDevice::Register(EndpointId endpoint, CodeDrivenDataModelProvider & provider,
...
void LaundryDryerDevice::Unregister(CodeDrivenDataModelProvider & provider)
{
