...
#include "LoggingCooktopDevice.h"
...
// LoggingCooktopDevice

LoggingCooktopDevice::LoggingCooktopDevice(TimerDelegate & timerDelegate) :
    CooktopDevice(timerDelegate, mLoggingSurface1, mLoggingSurface2, mLoggingSurface1, mLoggingSurface2),
