...
public:
    ...
    Clusters::ThreadBorderRouterManagementCluster & ThreadBorderRouterManagementCluster() { return mThreadBorderRouterManagementCluster.Cluster(); }
    ...
    Clusters::ThreadNetworkDiagnosticsCluster & ThreadNetworkDiagnosticsCluster() { return mThreadNetworkDiagnosticsCluster.Cluster(); }
