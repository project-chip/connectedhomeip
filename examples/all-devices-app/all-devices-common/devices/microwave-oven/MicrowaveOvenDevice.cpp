...
MicrowaveOvenDevice::MicrowaveOvenDevice() :
    SingleEndpointDevice(Span<const DataModel::DeviceTypeEntry>(&Device::Type::kMicrowaveOven, 1))
{}

CHIP_ERROR MicrowaveOvenDevice::Register(EndpointId endpoint, CodeDrivenDataModelProvider & provider,
...
void MicrowaveOvenDevice::Unregister(CodeDrivenDataModelProvider & provider)
{
