...
RoboticVacuumCleanerDevice::RoboticVacuumCleanerDevice() :
    SingleEndpointDevice(Span<const DataModel::DeviceTypeEntry>(&Device::Type::kRoboticVacuumCleaner, 1))
{}

CHIP_ERROR RoboticVacuumCleanerDevice::Register(EndpointId endpoint, CodeDrivenDataModelProvider & provider,
...
void RoboticVacuumCleanerDevice::Unregister(CodeDrivenDataModelProvider & provider)
{
