...
class ThreadRootNodeDevice : public RootNodeDevice
{
public:
    ...
    ThreadRootNodeDevice(const Context & context, const ThreadContext & threadContext) :
        RootNodeDevice(context), mThreadContext(threadContext)
    {}
