...
// Platform-specific implementation of Chime for POSIX systems.
...
public:
    ...
    {
    public:
        static std::unique_ptr<SoundResource> Create(ma_engine * engine, const Chime::Sound & soundInfo);
    ...
    PosixChime(TimerDelegate & timerDelegate, Span<const Sound> sounds);
    ~PosixChime() override;
