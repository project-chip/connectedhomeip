...
#if defined(__linux__) && (CONFIG_NETWORK_LAYER_BLE || CHIP_DEVICE_CONFIG_ENABLE_WIFIPAF)
...
#endif
#if defined(__linux__) && CHIP_DEVICE_CONFIG_ENABLE_WIFIPAF
...
#endif // defined(__linux__) && CHIP_DEVICE_CONFIG_ENABLE_WIFIPAF
