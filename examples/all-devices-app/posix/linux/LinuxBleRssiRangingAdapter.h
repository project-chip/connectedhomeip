...
/**
 * Linux-specific BLE RSSI ranging adapter.
 * Platform-specific BLE logic will be added here.
 */
class LinuxBleRssiRangingAdapter : public PosixBleRssiRangingAdapter
{
public:
    ...
    {
        // TODO: Start Linux BLE advertising/scanning
        AddSession(sessionId);
        ChipLogProgress(AppServer, "LinuxBleRssiRangingAdapter: StartSession %u", sessionId);
    ...
    CHIP_ERROR StopSession(uint8_t sessionId) override
    {
        ...
        // TODO: Stop Linux BLE advertising/scanning if no sessions remain
        ChipLogProgress(AppServer, "LinuxBleRssiRangingAdapter: StopSession %u", sessionId);
