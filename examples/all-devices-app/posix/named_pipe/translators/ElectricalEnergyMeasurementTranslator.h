...
class ElectricalEnergyMeasurementTranslator : public NamedPipeCommandTranslator
{
public:
    static Span<const CharSpan> GetActionNames()
    {
        static constexpr CharSpan kNames[] = { "GenerateElectricalEnergyMeasurementSnapshots"_span };
