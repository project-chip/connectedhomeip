...
#include "FanLoadScreen.h"
#include "DeviceHeader.h"
#include "clusters/FanControlClusterWidget.h"
#include "clusters/OnOffClusterWidget.h"

namespace chip::app {

void ShowFanLoadScreen(lv_obj_t * parent, const char * title, FanLoad & device)
{
    ...
    if (device.OnOffCluster() != nullptr)
    {
        CreateOnOffClusterWidget(parent, *device.OnOffCluster());
    }
    CreateFanControlClusterWidget(parent, device.FanControlCluster());
}
