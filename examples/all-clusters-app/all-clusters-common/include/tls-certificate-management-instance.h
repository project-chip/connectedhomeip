...
public:
    ...
    CHIP_ERROR LoadedRootCert(LoadedRootCertificateType loadedCallback) const override;

    Protocols::InteractionModel::Status LookupRootCert(EndpointId matterEndpoint, FabricIndex fabric, const ByteSpan fingerprint,
                                                       LoadedRootCertificateType & loadedCallback) const override;
    ...
    CHIP_ERROR LoadedClientCert(LoadedClientCertificateType loadedCallback) const override;

    Protocols::InteractionModel::Status LookupClientCert(EndpointId matterEndpoint, FabricIndex fabric, const ByteSpan fingerprint,
                                                         LoadedClientCertificateType & loadedCallback) const override;
