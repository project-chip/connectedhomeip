...
class StaticSupportedTemperatureLevelsManager : public chip::app::Clusters::TemperatureControl::SupportedTemperatureLevelsManager
{
...
public:
    ...
    SupportedTemperatureLevelsManager::TemperatureLevelOptionsProvider getTemperatureLevelOptionsProvider(EndpointId endpointId) const override;

    Protocols::InteractionModel::Status getTemperatureLevelOptionByTemperatureLevel(EndpointId endpointId, uint8_t temperatureLevel,
    ...
    static inline const StaticSupportedTemperatureLevelsManager & getStaticSupportedTemperatureLevelsManagerInstance() { return instance; }
};
