...
#define EMBER_AF_AIR_PRESSURE_MEASUREMENT_CLUSTER_SERVER_ENDPOINT_COUNT (1)
...
// Use this macro to check if the server side of the Air Pressure Measurement cluster is included
#define ZCL_USING_AIR_PRESSURE_MEASUREMENT_CLUSTER_SERVER
#define EMBER_AF_PLUGIN_AIR_PRESSURE_MEASUREMENT_SERVER
#define EMBER_AF_PLUGIN_AIR_PRESSURE_MEASUREMENT
