...
{
    {
        ...
        // TODO(#5098) We should pass the Command Object and EndpointId to the cluster callbacks.
        emberAfFabricClusterGetFabricIdCallback();
                    break;
        }
...
{
// TODO(#5098) We should pass the Command Object and EndpointId to the cluster callbacks.
        emberAfFabricClusterRemoveFabricCallback(fabricId, nodeId, vendorId);
        }
else
{
      apCommandObj->AddStatusCode(nullptr, Protocols::SecureChannel::GeneralStatusCode::kBadRequest, Protocols::SecureChannel::Id,
...
{
// TODO(#5098) We should pass the Command Object and EndpointId to the cluster callbacks.
        emberAfOtaSoftwareUpdateServerClusterQueryImageCallback(vendorId, productId, imageType, hardwareVersion, currentVersion, protocolsSupported, const_cast<uint8_t*>(location), clientCanConsent, metadataForServer);
        }
else
{
      apCommandObj->AddStatusCode(nullptr, Protocols::SecureChannel::GeneralStatusCode::kBadRequest, Protocols::SecureChannel::Id,
                      Protocols::SecureChannel::kProtocolCodeGeneralFailure);
      ChipLogProgress(Zcl, "Failed to dispatch command, %d/%" PRIu32 " arguments parsed, TLVError=%" PRIu32 ", UnpackError=%" PRIu32, 9, validArgumentCount, TLVError, TLVUnpackError);
}
            break;
        }
        default: {
                             ...
                             chip::TLV::TLVReader & aReader, Command * apCommandObj)
{
    ...
    case ZCL_FABRIC_CLUSTER_ID :
        clusters::Fabric::DispatchServerCommand(apCommandObj, aCommandId, aEndPointId, aReader);
        break;
