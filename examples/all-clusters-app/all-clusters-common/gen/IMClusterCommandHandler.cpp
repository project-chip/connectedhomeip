...
{
// TODO(#5098) We should pass the Command Object and EndpointId to the cluster callbacks.
        wasHandled = emberAfDoorLockClusterSetHolidayScheduleCallback(apCommandObj, scheduleId, localStartTime, localEndTime, operatingModeDuringHoliday);
        }
            break;
        }
...
{
// TODO(#5098) We should pass the Command Object and EndpointId to the cluster callbacks.
        wasHandled = emberAfDoorLockClusterSetPinCallback(apCommandObj, userId, userStatus, userType, const_cast<uint8_t*>(pin));
        }
            break;
        }
...
{
// TODO(#5098) We should pass the Command Object and EndpointId to the cluster callbacks.
        wasHandled = emberAfDoorLockClusterSetRfidCallback(apCommandObj, userId, userStatus, userType, const_cast<uint8_t*>(id));
        }
            break;
        }
...
{
// TODO(#5098) We should pass the Command Object and EndpointId to the cluster callbacks.
        wasHandled = emberAfDoorLockClusterSetWeekdayScheduleCallback(apCommandObj, scheduleId, userId, daysMask, startHour, startMinute, endHour, endMinute);
        }
            break;
        }
...
{
// TODO(#5098) We should pass the Command Object and EndpointId to the cluster callbacks.
        wasHandled = emberAfDoorLockClusterSetYeardayScheduleCallback(apCommandObj, scheduleId, userId, localStartTime, localEndTime);
        }
            break;
        }
...
{
// TODO(#5098) We should pass the Command Object and EndpointId to the cluster callbacks.
        wasHandled = emberAfDoorLockClusterUnlockWithTimeoutCallback(apCommandObj, timeoutInSeconds, const_cast<uint8_t*>(pin));
        }
            break;
        }
        default: {
...
{
// TODO(#5098) We should pass the Command Object and EndpointId to the cluster callbacks.
        wasHandled = emberAfGroupsClusterAddGroupIfIdentifyingCallback(apCommandObj, groupId, const_cast<uint8_t*>(groupName));
        }
            break;
        }
...
{
// TODO(#5098) We should pass the Command Object and EndpointId to the cluster callbacks.
        wasHandled = emberAfOtaSoftwareUpdateProviderClusterApplyUpdateRequestCallback(apCommandObj, updateToken, newVersion);
        }
            break;
        }
...
{
// TODO(#5098) We should pass the Command Object and EndpointId to the cluster callbacks.
        wasHandled = emberAfOtaSoftwareUpdateProviderClusterNotifyUpdateAppliedCallback(apCommandObj, updateToken, currentVersion);
        }
            break;
        }
...
{
// TODO(#5098) We should pass the Command Object and EndpointId to the cluster callbacks.
        wasHandled = emberAfOtaSoftwareUpdateProviderClusterQueryImageCallback(apCommandObj, vendorId, productId, imageType, hardwareVersion, currentVersion, protocolsSupported, const_cast<uint8_t*>(location), requestorCanConsent, metadataForProvider);
        }
            break;
        }
        default: {
            ...
            apCommandObj->AddStatusCode(returnStatusParam, Protocols::SecureChannel::GeneralStatusCode::kNotFound, Protocols::SecureChannel::Id,
        Protocols::InteractionModel::ProtocolCode::UnsupportedCommand);
            ChipLogError(Zcl, "Unknown command %" PRIx32 " for cluster %" PRIx32, aCommandId, Clusters::OtaSoftwareUpdateProvider::Id);
            return;
        }
        }
    }
...
{
// TODO(#5098) We should pass the Command Object and EndpointId to the cluster callbacks.
        wasHandled = emberAfScenesClusterAddSceneCallback(apCommandObj, groupId, sceneId, transitionTime, const_cast<uint8_t*>(sceneName), extensionFieldSets);
        }
            break;
        }
