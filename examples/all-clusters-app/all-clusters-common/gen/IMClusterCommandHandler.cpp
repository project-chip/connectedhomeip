...
if (CHIP_END_OF_TLV == TLVError)
{
  ...
  TLVError = CHIP_NO_ERROR;
        ...
        if (CHIP_NO_ERROR == TLVError && CHIP_NO_ERROR == TLVUnpackError && 4 == validArgumentCount)
{
wasHandled = emberAfDoorLockClusterSetHolidayScheduleCallback(aEndpointId, apCommandObj, scheduleId, localStartTime, localEndTime, operatingModeDuringHoliday);
        }
            break;
        }
...
if (CHIP_END_OF_TLV == TLVError)
{
  ...
  TLVError = CHIP_NO_ERROR;
        ...
        if (CHIP_NO_ERROR == TLVError && CHIP_NO_ERROR == TLVUnpackError && 4 == validArgumentCount)
{
wasHandled = emberAfDoorLockClusterSetPinCallback(aEndpointId, apCommandObj, userId, userStatus, userType, const_cast<uint8_t*>(pin));
        }
            break;
        }
...
if (CHIP_END_OF_TLV == TLVError)
{
  ...
  TLVError = CHIP_NO_ERROR;
        ...
        if (CHIP_NO_ERROR == TLVError && CHIP_NO_ERROR == TLVUnpackError && 4 == validArgumentCount)
{
wasHandled = emberAfDoorLockClusterSetRfidCallback(aEndpointId, apCommandObj, userId, userStatus, userType, const_cast<uint8_t*>(id));
        }
            break;
        }
...
if (CHIP_END_OF_TLV == TLVError)
{
  ...
  TLVError = CHIP_NO_ERROR;
        ...
        if (CHIP_NO_ERROR == TLVError && CHIP_NO_ERROR == TLVUnpackError && 7 == validArgumentCount)
{
wasHandled = emberAfDoorLockClusterSetWeekdayScheduleCallback(aEndpointId, apCommandObj, scheduleId, userId, daysMask, startHour, startMinute, endHour, endMinute);
        }
            break;
        }
...
if (CHIP_END_OF_TLV == TLVError)
{
  ...
  TLVError = CHIP_NO_ERROR;
        ...
        if (CHIP_NO_ERROR == TLVError && CHIP_NO_ERROR == TLVUnpackError && 4 == validArgumentCount)
{
wasHandled = emberAfDoorLockClusterSetYeardayScheduleCallback(aEndpointId, apCommandObj, scheduleId, userId, localStartTime, localEndTime);
        }
            break;
        }
...
if (CHIP_END_OF_TLV == TLVError)
{
  ...
  TLVError = CHIP_NO_ERROR;
        ...
        if (CHIP_NO_ERROR == TLVError && CHIP_NO_ERROR == TLVUnpackError && 2 == validArgumentCount)
{
wasHandled = emberAfDoorLockClusterUnlockWithTimeoutCallback(aEndpointId, apCommandObj, timeoutInSeconds, const_cast<uint8_t*>(pin));
        }
            break;
        }
        default: {
...
if (CHIP_END_OF_TLV == TLVError)
{
  ...
  TLVError = CHIP_NO_ERROR;
        ...
        if (CHIP_NO_ERROR == TLVError && CHIP_NO_ERROR == TLVUnpackError && 2 == validArgumentCount)
{
wasHandled = emberAfGroupsClusterAddGroupCallback(aEndpointId, apCommandObj, groupId, const_cast<uint8_t*>(groupName));
        }
            break;
        }
...
if (CHIP_END_OF_TLV == TLVError)
{
  ...
  TLVError = CHIP_NO_ERROR;
        ...
        if (CHIP_NO_ERROR == TLVError && CHIP_NO_ERROR == TLVUnpackError && 2 == validArgumentCount)
{
wasHandled = emberAfGroupsClusterAddGroupIfIdentifyingCallback(aEndpointId, apCommandObj, groupId, const_cast<uint8_t*>(groupName));
        }
            break;
        }
...
if (CHIP_END_OF_TLV == TLVError)
{
  ...
  TLVError = CHIP_NO_ERROR;
        ...
        if (CHIP_NO_ERROR == TLVError && CHIP_NO_ERROR == TLVUnpackError && 5 == validArgumentCount)
{
wasHandled = emberAfScenesClusterAddSceneCallback(aEndpointId, apCommandObj, groupId, sceneId, transitionTime, const_cast<uint8_t*>(sceneName), extensionFieldSets);
        }
            break;
        }
