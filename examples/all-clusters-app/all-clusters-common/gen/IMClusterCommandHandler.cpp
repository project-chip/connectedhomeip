...
{
    {
        ...
        case ZCL_BIND_COMMAND_ID: {
            ...
            OnBindCommandCallback(command, endpointId, nodeId, groupId, endpointId, clusterId);
            break;
        }
        case ZCL_UNBIND_COMMAND_ID: {
            ...
            OnUnbindCommandCallback(command, endpointId, nodeId, groupId, endpointId, clusterId);
            break;
        }
        default: {
            // Unrecognized command ID, error status will apply.
