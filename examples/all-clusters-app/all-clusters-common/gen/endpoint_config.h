...
const EmberAfGenericClusterFunction chipFuncArrayIdentifyServer[] = {\
  ...
  (EmberAfGenericClusterFunction) emberAfIdentifyAttributeChangedCallback,\
};\
...
const EmberAfGenericClusterFunction chipFuncArrayDoorLockServer[] = {\
  (EmberAfGenericClusterFunction) emberAfDoorLockAttributeChangedCallback,\
};\
...
const EmberAfGenericClusterFunction chipFuncArrayIasZoneServer[] = {\
  ...
  (EmberAfGenericClusterFunction) emberAfIasZonePreAttributeChangedCallback,\
  (EmberAfGenericClusterFunction) emberAfIasZonePreAttributeChangedCallback,\
};\
const EmberAfGenericClusterFunction chipFuncArrayOnOffServer[] = {\
  (EmberAfGenericClusterFunction) emberAfOnOffClusterServerInitCallback,\
...
#define GENERATED_CLUSTERS { \
  ...
  { 0x0006, ZAP_ATTRIBUTE_INDEX(99), 2, 3, ZAP_CLUSTER_MASK(SERVER) | ZAP_CLUSTER_MASK(INIT_FUNCTION), chipFuncArrayOnOffServer }, /* Endpoint: 2, Cluster: On/off (server) */ \
}
