...
#define GENERATED_ATTRIBUTES { \
  ...
  { 0x0001, ZAP_TYPE(ARRAY), 254, 0, ZAP_LONG_DEFAULTS_INDEX(1784) }, /* Operational Credentials (server): fabrics list */  \
...
#define GENERATED_CLUSTERS { \
  ...
  { 0xFC03, ZAP_ATTRIBUTE_INDEX(25), 2, 256, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 0, Cluster: Operational Credentials (server) */ \
  ...
  { 0xFC03, ZAP_ATTRIBUTE_INDEX(133), 1, 2, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: Operational Credentials (server) */ \
  { 0x0006, ZAP_ATTRIBUTE_INDEX(134), 2, 3, ZAP_CLUSTER_MASK(SERVER) | ZAP_CLUSTER_MASK(INIT_FUNCTION), chipFuncArrayOnOffServer }, /* Endpoint: 2, Cluster: On/off (server) */ \
}
...
#define GENERATED_ENDPOINT_TYPES { \
  ...
  { ZAP_CLUSTER_INDEX(7), 17, 1534 }, \
  { ZAP_CLUSTER_INDEX(24), 1, 3 }, \
}
