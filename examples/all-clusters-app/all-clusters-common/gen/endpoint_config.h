...
#define GENERATED_CLUSTERS                                                                                                         \
    {                                                                                                                              \
        { 0x0000, ZAP_ATTRIBUTE_INDEX(0), 3, 6, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: Basic (server) */       \
            ...
            {                                                                                                                      \
                0x050D, ZAP_ATTRIBUTE_INDEX(87), 8, 105, ZAP_CLUSTER_MASK(SERVER), NULL                                            \
            ...
            { 0x0000, ZAP_ATTRIBUTE_INDEX(99), 3, 6, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 2, Cluster: Basic (server) */  \
            { 0x0006,                                                                                                              \
...
#define GENERATED_ENDPOINT_TYPES                                                                                                   \
    {                                                                                                                              \
        { ZAP_CLUSTER_INDEX(0), 15, 512 }, { ZAP_CLUSTER_INDEX(15), 2, 9 },                                                        \
    }
