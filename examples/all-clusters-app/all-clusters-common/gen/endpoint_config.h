...
\
  ...
  { 0x0005, ZAP_TYPE(CHAR_STRING), 32, ZAP_ATTRIBUTE_MASK(SINGLETON) | ZAP_ATTRIBUTE_MASK(WRITABLE), ZAP_LONG_DEFAULTS_INDEX(4816) }, /* UserLabel */  \
  { 0x0007, ZAP_TYPE(INT16U), 2, ZAP_ATTRIBUTE_MASK(SINGLETON), ZAP_SIMPLE_DEFAULT(0x00) }, /* HardwareVersion */  \
  { 0x0008, ZAP_TYPE(CHAR_STRING), 64, ZAP_ATTRIBUTE_MASK(SINGLETON), ZAP_LONG_DEFAULTS_INDEX(4848) }, /* HardwareVersionString */  \
  { 0x0009, ZAP_TYPE(INT32U), 4, ZAP_ATTRIBUTE_MASK(SINGLETON), ZAP_LONG_DEFAULTS_INDEX(4912) }, /* SoftwareVersion */  \
  { 0x000A, ZAP_TYPE(CHAR_STRING), 64, ZAP_ATTRIBUTE_MASK(SINGLETON), ZAP_LONG_DEFAULTS_INDEX(4916) }, /* SoftwareVersionString */  \
  { 0x000B, ZAP_TYPE(CHAR_STRING), 16, ZAP_ATTRIBUTE_MASK(SINGLETON), ZAP_LONG_DEFAULTS_INDEX(4980) }, /* ManufacturingDate */  \
  ...
  { 0x000E, ZAP_TYPE(CHAR_STRING), 64, ZAP_ATTRIBUTE_MASK(SINGLETON), ZAP_LONG_DEFAULTS_INDEX(5504) }, /* ProductLabel */  \
  { 0x000F, ZAP_TYPE(CHAR_STRING), 32, ZAP_ATTRIBUTE_MASK(SINGLETON), ZAP_LONG_DEFAULTS_INDEX(5568) }, /* SerialNumber */  \
...
\
  ...
  { 0x0002, ZAP_TYPE(ENUM8), 1, ZAP_ATTRIBUTE_MASK(WRITABLE), ZAP_EMPTY_DEFAULT() }, /* schedule programming visibility */  \
  { 0xFFFD, ZAP_TYPE(INT16U), 2, 0, ZAP_SIMPLE_DEFAULT(0x0001) }, /* ClusterRevision */  \
\
...
\
  ...
  { 0x0019, ZAP_TYPE(OCTET_STRING), 10, ZAP_ATTRIBUTE_MASK(WRITABLE), ZAP_LONG_DEFAULTS_INDEX(8126) }, /* octet_string */  \
  ...
  { 0x001D, ZAP_TYPE(LONG_OCTET_STRING), 1000, ZAP_ATTRIBUTE_MASK(WRITABLE), ZAP_LONG_DEFAULTS_INDEX(8654) }, /* long_octet_string */  \
  { 0x001E, ZAP_TYPE(CHAR_STRING), 10, ZAP_ATTRIBUTE_MASK(WRITABLE), ZAP_LONG_DEFAULTS_INDEX(9654) }, /* char_string */  \
  { 0x001F, ZAP_TYPE(LONG_CHAR_STRING), 1000, ZAP_ATTRIBUTE_MASK(WRITABLE), ZAP_LONG_DEFAULTS_INDEX(9664) }, /* long_char_string */  \
  { 0xFFFD, ZAP_TYPE(INT16U), 2, 0, ZAP_SIMPLE_DEFAULT(0x0001) }, /* ClusterRevision */  \
\
...
#define GENERATED_CLUSTERS { \
  ...
  { 0x0031, ZAP_ATTRIBUTE_INDEX(28), 2, 6, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 0, Cluster: Network Commissioning (server) */ \
  { 0x0032, ZAP_ATTRIBUTE_INDEX(30), 0, 0, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 0, Cluster: Diagnostic Logs (server) */ \
  { 0x0033, ZAP_ATTRIBUTE_INDEX(30), 3, 258, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 0, Cluster: General Diagnostics (server) */ \
  { 0x0034, ZAP_ATTRIBUTE_INDEX(33), 2, 10, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 0, Cluster: Software Diagnostics (server) */ \
  { 0x0035, ZAP_ATTRIBUTE_INDEX(35), 61, 747, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 0, Cluster: Thread Network Diagnostics (server) */ \
  { 0x0036, ZAP_ATTRIBUTE_INDEX(96), 13, 45, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 0, Cluster: WiFi Network Diagnostics (server) */ \
  { 0x0037, ZAP_ATTRIBUTE_INDEX(109), 6, 42, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 0, Cluster: Ethernet Network Diagnostics (server) */ \
  { 0x003C, ZAP_ATTRIBUTE_INDEX(115), 1, 2, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 0, Cluster: AdministratorCommissioning (server) */ \
  { 0x003E, ZAP_ATTRIBUTE_INDEX(116), 4, 258, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 0, Cluster: Operational Credentials (server) */ \
  { 0x0405, ZAP_ATTRIBUTE_INDEX(120), 4, 8, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 0, Cluster: Relative Humidity Measurement (server) */ \
  { 0xF000, ZAP_ATTRIBUTE_INDEX(124), 1, 2, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 0, Cluster: Binding (server) */ \
  { 0xF004, ZAP_ATTRIBUTE_INDEX(125), 3, 510, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 0, Cluster: Group Key Management (server) */ \
  { 0x0003, ZAP_ATTRIBUTE_INDEX(128), 2, 4, ZAP_CLUSTER_MASK(SERVER) | ZAP_CLUSTER_MASK(INIT_FUNCTION) | ZAP_CLUSTER_MASK(ATTRIBUTE_CHANGED_FUNCTION), chipFuncArrayIdentifyServer }, /* Endpoint: 1, Cluster: Identify (server) */ \
  { 0x0004, ZAP_ATTRIBUTE_INDEX(130), 2, 3, ZAP_CLUSTER_MASK(SERVER) | ZAP_CLUSTER_MASK(INIT_FUNCTION), chipFuncArrayGroupsServer }, /* Endpoint: 1, Cluster: Groups (server) */ \
  { 0x0005, ZAP_ATTRIBUTE_INDEX(132), 6, 8, ZAP_CLUSTER_MASK(SERVER) | ZAP_CLUSTER_MASK(INIT_FUNCTION), chipFuncArrayScenesServer }, /* Endpoint: 1, Cluster: Scenes (server) */ \
  { 0x0006, ZAP_ATTRIBUTE_INDEX(138), 7, 13, ZAP_CLUSTER_MASK(SERVER) | ZAP_CLUSTER_MASK(INIT_FUNCTION), chipFuncArrayOnOffServer }, /* Endpoint: 1, Cluster: On/Off (server) */ \
  { 0x0008, ZAP_ATTRIBUTE_INDEX(145), 5, 7, ZAP_CLUSTER_MASK(SERVER) | ZAP_CLUSTER_MASK(INIT_FUNCTION), chipFuncArrayLevelControlServer }, /* Endpoint: 1, Cluster: Level Control (server) */ \
  { 0x000F, ZAP_ATTRIBUTE_INDEX(150), 4, 5, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: Binary Input (Basic) (server) */ \
  { 0x001D, ZAP_ATTRIBUTE_INDEX(154), 5, 1018, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: Descriptor (server) */ \
  { 0x0039, ZAP_ATTRIBUTE_INDEX(159), 15, 855, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: Bridged Device Basic (server) */ \
  { 0x003B, ZAP_ATTRIBUTE_INDEX(174), 3, 4, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: Switch (server) */ \
  { 0x0040, ZAP_ATTRIBUTE_INDEX(177), 2, 256, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: Fixed Label (server) */ \
  { 0x0101, ZAP_ATTRIBUTE_INDEX(179), 4, 5, ZAP_CLUSTER_MASK(SERVER) | ZAP_CLUSTER_MASK(ATTRIBUTE_CHANGED_FUNCTION), chipFuncArrayDoorLockServer }, /* Endpoint: 1, Cluster: Door Lock (server) */ \
  { 0x0102, ZAP_ATTRIBUTE_INDEX(183), 19, 31, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: Window Covering (server) */ \
  { 0x0103, ZAP_ATTRIBUTE_INDEX(202), 5, 7, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: Barrier Control (server) */ \
  { 0x0200, ZAP_ATTRIBUTE_INDEX(207), 8, 13, ZAP_CLUSTER_MASK(SERVER) | ZAP_CLUSTER_MASK(INIT_FUNCTION) | ZAP_CLUSTER_MASK(ATTRIBUTE_CHANGED_FUNCTION), chipFuncArrayPumpConfigurationAndControlServer }, /* Endpoint: 1, Cluster: Pump Configuration and Control (server) */ \
  { 0x0201, ZAP_ATTRIBUTE_INDEX(215), 10, 17, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: Thermostat (server) */ \
  { 0x0204, ZAP_ATTRIBUTE_INDEX(225), 4, 5, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: Thermostat User Interface Configuration (server) */ \
  { 0x0300, ZAP_ATTRIBUTE_INDEX(229), 53, 340, ZAP_CLUSTER_MASK(SERVER) | ZAP_CLUSTER_MASK(INIT_FUNCTION), chipFuncArrayColorControlServer }, /* Endpoint: 1, Cluster: Color Control (server) */ \
  { 0x0402, ZAP_ATTRIBUTE_INDEX(282), 4, 8, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: Temperature Measurement (server) */ \
  { 0x0403, ZAP_ATTRIBUTE_INDEX(286), 4, 8, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: Pressure Measurement (server) */ \
  { 0x0404, ZAP_ATTRIBUTE_INDEX(290), 4, 8, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: Flow Measurement (server) */ \
  { 0x0405, ZAP_ATTRIBUTE_INDEX(294), 4, 8, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: Relative Humidity Measurement (server) */ \
  { 0x0406, ZAP_ATTRIBUTE_INDEX(298), 4, 5, ZAP_CLUSTER_MASK(SERVER) | ZAP_CLUSTER_MASK(INIT_FUNCTION), chipFuncArrayOccupancySensingServer }, /* Endpoint: 1, Cluster: Occupancy Sensing (server) */ \
  { 0x0500, ZAP_ATTRIBUTE_INDEX(302), 6, 16, ZAP_CLUSTER_MASK(SERVER) | ZAP_CLUSTER_MASK(INIT_FUNCTION) | ZAP_CLUSTER_MASK(PRE_ATTRIBUTE_CHANGED_FUNCTION) | ZAP_CLUSTER_MASK(MESSAGE_SENT_FUNCTION), chipFuncArrayIasZoneServer }, /* Endpoint: 1, Cluster: IAS Zone (server) */ \
  { 0x0503, ZAP_ATTRIBUTE_INDEX(308), 2, 34, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: Wake on LAN (server) */ \
  { 0x0504, ZAP_ATTRIBUTE_INDEX(310), 4, 320, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: TV Channel (server) */ \
  { 0x0505, ZAP_ATTRIBUTE_INDEX(314), 2, 256, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: Target Navigator (server) */ \
  { 0x0506, ZAP_ATTRIBUTE_INDEX(316), 1, 2, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: Media Playback (server) */ \
  { 0x0507, ZAP_ATTRIBUTE_INDEX(317), 3, 257, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: Media Input (server) */ \
  { 0x0508, ZAP_ATTRIBUTE_INDEX(320), 1, 2, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: Low Power (server) */ \
  { 0x0509, ZAP_ATTRIBUTE_INDEX(321), 1, 2, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: Keypad Input (server) */ \
  { 0x050A, ZAP_ATTRIBUTE_INDEX(322), 3, 510, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: Content Launcher (server) */ \
  { 0x050B, ZAP_ATTRIBUTE_INDEX(325), 3, 257, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: Audio Output (server) */ \
  { 0x050C, ZAP_ATTRIBUTE_INDEX(328), 4, 258, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: Application Launcher (server) */ \
  { 0x050D, ZAP_ATTRIBUTE_INDEX(332), 8, 105, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: Application Basic (server) */ \
  { 0x050E, ZAP_ATTRIBUTE_INDEX(340), 1, 2, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: Account Login (server) */ \
  { 0x050F, ZAP_ATTRIBUTE_INDEX(341), 23, 2589, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: Test Cluster (server) */ \
  { 0x0B04, ZAP_ATTRIBUTE_INDEX(364), 12, 28, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: Electrical Measurement (server) */ \
  { 0xF000, ZAP_ATTRIBUTE_INDEX(376), 1, 2, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: Binding (server) */ \
  { 0x0006, ZAP_ATTRIBUTE_INDEX(377), 7, 13, ZAP_CLUSTER_MASK(SERVER) | ZAP_CLUSTER_MASK(INIT_FUNCTION), chipFuncArrayOnOffServer }, /* Endpoint: 2, Cluster: On/Off (server) */ \
  { 0x0406, ZAP_ATTRIBUTE_INDEX(384), 4, 5, ZAP_CLUSTER_MASK(SERVER) | ZAP_CLUSTER_MASK(INIT_FUNCTION), chipFuncArrayOccupancySensingServer }, /* Endpoint: 2, Cluster: Occupancy Sensing (server) */ \
}
...
#define GENERATED_ENDPOINT_TYPES { \
  { ZAP_CLUSTER_INDEX(0), 16, 3814 }, \
  { ZAP_CLUSTER_INDEX(16), 38, 7268 }, \
  { ZAP_CLUSTER_INDEX(54), 2, 18 }, \
}
...
\
  ...
  { ZAP_REPORT_DIRECTION(REPORTED), 0x0001, 0x0300, 0x0002, ZAP_CLUSTER_MASK(SERVER), 0x0000, {{ 0, 65344, 0 }} }, /* remaining time */ \
  ...
  { ZAP_REPORT_DIRECTION(REPORTED), 0x0001, 0x0300, 0x0008, ZAP_CLUSTER_MASK(SERVER), 0x0000, {{ 0, 65344, 0 }} }, /* color mode */ \
  { ZAP_REPORT_DIRECTION(REPORTED), 0x0001, 0x0300, 0x000F, ZAP_CLUSTER_MASK(SERVER), 0x0000, {{ 0, 65344, 0 }} }, /* color control options */ \
  { ZAP_REPORT_DIRECTION(REPORTED), 0x0001, 0x0300, 0x4000, ZAP_CLUSTER_MASK(SERVER), 0x0000, {{ 0, 65344, 0 }} }, /* enhanced current hue */ \
  { ZAP_REPORT_DIRECTION(REPORTED), 0x0001, 0x0300, 0x4001, ZAP_CLUSTER_MASK(SERVER), 0x0000, {{ 0, 65344, 0 }} }, /* enhanced color mode */ \
  { ZAP_REPORT_DIRECTION(REPORTED), 0x0001, 0x0300, 0x4002, ZAP_CLUSTER_MASK(SERVER), 0x0000, {{ 0, 65344, 0 }} }, /* color loop active */ \
  { ZAP_REPORT_DIRECTION(REPORTED), 0x0001, 0x0300, 0x4003, ZAP_CLUSTER_MASK(SERVER), 0x0000, {{ 0, 65344, 0 }} }, /* color loop direction */ \
  { ZAP_REPORT_DIRECTION(REPORTED), 0x0001, 0x0300, 0x4004, ZAP_CLUSTER_MASK(SERVER), 0x0000, {{ 0, 65344, 0 }} }, /* color loop time */ \
  { ZAP_REPORT_DIRECTION(REPORTED), 0x0001, 0x0300, 0x4005, ZAP_CLUSTER_MASK(SERVER), 0x0000, {{ 0, 65344, 0 }} }, /* color loop start enhanced hue */ \
  { ZAP_REPORT_DIRECTION(REPORTED), 0x0001, 0x0300, 0x4006, ZAP_CLUSTER_MASK(SERVER), 0x0000, {{ 0, 65344, 0 }} }, /* color loop stored enhanced hue */ \
  { ZAP_REPORT_DIRECTION(REPORTED), 0x0001, 0x0300, 0x400A, ZAP_CLUSTER_MASK(SERVER), 0x0000, {{ 0, 65344, 0 }} }, /* color capabilities */ \
  { ZAP_REPORT_DIRECTION(REPORTED), 0x0001, 0x0300, 0x400B, ZAP_CLUSTER_MASK(SERVER), 0x0000, {{ 0, 65344, 0 }} }, /* color temp physical min */ \
  { ZAP_REPORT_DIRECTION(REPORTED), 0x0001, 0x0300, 0x400C, ZAP_CLUSTER_MASK(SERVER), 0x0000, {{ 0, 65344, 0 }} }, /* color temp physical max */ \
  { ZAP_REPORT_DIRECTION(REPORTED), 0x0001, 0x0300, 0x400D, ZAP_CLUSTER_MASK(SERVER), 0x0000, {{ 0, 65344, 0 }} }, /* couple color temp to level min-mireds */ \
  { ZAP_REPORT_DIRECTION(REPORTED), 0x0001, 0x0300, 0x4010, ZAP_CLUSTER_MASK(SERVER), 0x0000, {{ 0, 65344, 0 }} }, /* start up color temperature mireds */ \
\
  /* Endpoint: 1, Cluster: Temperature Measurement (server) */ \
...
\
  /* Endpoint: 1, Cluster: Occupancy Sensing (server) */ \
  { ZAP_REPORT_DIRECTION(REPORTED), 0x0001, 0x0406, 0x0000, ZAP_CLUSTER_MASK(SERVER), 0x0000, {{ 0, 65344, 0 }} }, /* occupancy */ \
\
  /* Endpoint: 2, Cluster: On/Off (server) */ \
