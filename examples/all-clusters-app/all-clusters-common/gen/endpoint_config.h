...
#define GENERATED_ATTRIBUTES                                                                                                       \
    {                                                                                                                              \
        { 0xFFFD, ZAP_TYPE(INT16U), 2, ZAP_ATTRIBUTE_MASK(CLIENT), { (uint8_t *) 3 } }, /* Basic (client): cluster revision */     \
            ...
            {                                                                                                                      \
                0x0020, ZAP_TYPE(BOOLEAN), 1, ZAP_ATTRIBUTE_MASK(WRITABLE), { (uint8_t *) 0x00 }                                   \
            }, /* Door Lock (server): enable logging */                                                                            \
            {                                                                                                                      \
                0x0021, ZAP_TYPE(CHAR_STRING), 2, ZAP_ATTRIBUTE_MASK(WRITABLE), { (uint8_t *) 0x00 }                               \
            }, /* Door Lock (server): language */                                                                                  \
            {                                                                                                                      \
                0x0022, ZAP_TYPE(INT8U), 1, ZAP_ATTRIBUTE_MASK(WRITABLE), { (uint8_t *) 0x00 }                                     \
            }, /* Door Lock (server): led settings */                                                                              \
            {                                                                                                                      \
                0x0023, ZAP_TYPE(INT32U), 4, ZAP_ATTRIBUTE_MASK(WRITABLE), { (uint8_t *) ZAP_LONG_DEFAULTS_INDEX(0) }              \
            }, /* Door Lock (server): auto relock time */                                                                          \
            {                                                                                                                      \
                0x0024, ZAP_TYPE(INT8U), 1, ZAP_ATTRIBUTE_MASK(WRITABLE), { (uint8_t *) 0x00 }                                     \
            }, /* Door Lock (server): sound volume */                                                                              \
            {                                                                                                                      \
                0x0025, ZAP_TYPE(ENUM8), 1, ZAP_ATTRIBUTE_MASK(WRITABLE), { (uint8_t *) 0x00 }                                     \
            },                                                          /* Door Lock (server): operating mode */                   \
            { 0x0027, ZAP_TYPE(BITMAP16), 2, 0, { (uint8_t *) 0x00 } }, /* Door Lock (server): default configuration register */   \
            {                                                                                                                      \
                0x0028, ZAP_TYPE(BOOLEAN), 1, ZAP_ATTRIBUTE_MASK(WRITABLE), { (uint8_t *) 0x01 }                                   \
            }, /* Door Lock (server): enable local programming */                                                                  \
            {                                                                                                                      \
                0x0029, ZAP_TYPE(BOOLEAN), 1, ZAP_ATTRIBUTE_MASK(WRITABLE), { (uint8_t *) 0x00 }                                   \
            }, /* Door Lock (server): enable one touch locking */                                                                  \
            {                                                                                                                      \
                0x002A, ZAP_TYPE(BOOLEAN), 1, ZAP_ATTRIBUTE_MASK(WRITABLE), { (uint8_t *) 0x00 }                                   \
            }, /* Door Lock (server): enable inside status led */                                                                  \
            {                                                                                                                      \
                0x002B, ZAP_TYPE(BOOLEAN), 1, ZAP_ATTRIBUTE_MASK(WRITABLE), { (uint8_t *) 0x00 }                                   \
            }, /* Door Lock (server): enable privacy mode button */                                                                \
            {                                                                                                                      \
                0x0030, ZAP_TYPE(INT8U), 1, ZAP_ATTRIBUTE_MASK(WRITABLE), { (uint8_t *) 0x00 }                                     \
            }, /* Door Lock (server): wrong code entry limit */                                                                    \
            {                                                                                                                      \
                0x0031, ZAP_TYPE(INT8U), 1, ZAP_ATTRIBUTE_MASK(WRITABLE), { (uint8_t *) 0x00 }                                     \
            }, /* Door Lock (server): user code temporary disable time */                                                          \
            {                                                                                                                      \
                0x0032, ZAP_TYPE(BOOLEAN), 1, ZAP_ATTRIBUTE_MASK(WRITABLE), { (uint8_t *) 0x00 }                                   \
            }, /* Door Lock (server): send pin over the air */                                                                     \
            {                                                                                                                      \
                0x0033, ZAP_TYPE(BOOLEAN), 1, ZAP_ATTRIBUTE_MASK(WRITABLE), { (uint8_t *) 0x00 }                                   \
            },                                                       /* Door Lock (server): require pin for rf operation */        \
            { 0x0034, ZAP_TYPE(ENUM8), 1, 0, { (uint8_t *) 0x00 } }, /* Door Lock (server): zigbee security level */               \
            {                                                                                                                      \
                0x0040, ZAP_TYPE(BITMAP16), 2, ZAP_ATTRIBUTE_MASK(WRITABLE), { (uint8_t *) 0x0000 }                                \
            }, /* Door Lock (server): alarm mask */                                                                                \
            {                                                                                                                      \
                0x0041, ZAP_TYPE(BITMAP16), 2, ZAP_ATTRIBUTE_MASK(WRITABLE), { (uint8_t *) 0x0000 }                                \
            }, /* Door Lock (server): keypad operation event mask */                                                               \
            {                                                                                                                      \
                0x0042, ZAP_TYPE(BITMAP16), 2, ZAP_ATTRIBUTE_MASK(WRITABLE), { (uint8_t *) 0x0000 }                                \
            }, /* Door Lock (server): RF operation event mask */                                                                   \
            {                                                                                                                      \
                0x0043, ZAP_TYPE(BITMAP16), 2, ZAP_ATTRIBUTE_MASK(WRITABLE), { (uint8_t *) 0x0000 }                                \
            }, /* Door Lock (server): manual operation event mask */                                                               \
            {                                                                                                                      \
                0x0044, ZAP_TYPE(BITMAP16), 2, ZAP_ATTRIBUTE_MASK(WRITABLE), { (uint8_t *) 0x0000 }                                \
            }, /* Door Lock (server): rfid operation event mask */                                                                 \
            {                                                                                                                      \
                0x0045, ZAP_TYPE(BITMAP16), 2, ZAP_ATTRIBUTE_MASK(WRITABLE), { (uint8_t *) 0x0000 }                                \
            }, /* Door Lock (server): keypad programming event mask */                                                             \
            {                                                                                                                      \
                0x0046, ZAP_TYPE(BITMAP16), 2, ZAP_ATTRIBUTE_MASK(WRITABLE), { (uint8_t *) 0x0000 }                                \
            }, /* Door Lock (server): rf programming event mask */                                                                 \
            {                                                                                                                      \
                0x0047, ZAP_TYPE(BITMAP16), 2, ZAP_ATTRIBUTE_MASK(WRITABLE), { (uint8_t *) 0x0000 }                                \
            }, /* Door Lock (server): rfid programming event mask */                                                               \
            {                                                                                                                      \
            ...
            {                                                                                                                      \
                0x0006, ZAP_TYPE(CHAR_STRING), 254, 0, { (uint8_t *) ZAP_LONG_DEFAULTS_INDEX(4) }                                  \
            ...
            {                                                                                                                      \
                0x0010, ZAP_TYPE(IEEE_ADDRESS), 8, ZAP_ATTRIBUTE_MASK(WRITABLE), { (uint8_t *) ZAP_LONG_DEFAULTS_INDEX(258) }      \
...
#define GENERATED_CLUSTERS                                                                                                         \
    {                                                                                                                              \
        { 0x0000, ZAP_ATTRIBUTE_INDEX(0), 1, 2, ZAP_CLUSTER_MASK(CLIENT), NULL },     /* Endpoint: 1, Cluster: Basic (client) */   \
            ...
            {                                                                                                                      \
                0x0003, ZAP_ATTRIBUTE_INDEX(5), 2, 4, ZAP_CLUSTER_MASK(SERVER), NULL                                               \
            ...
            {                                                                                                                      \
                0x0008, ZAP_ATTRIBUTE_INDEX(21), 2, 3, ZAP_CLUSTER_MASK(SERVER), NULL                                              \
            }, /* Endpoint: 1, Cluster: Level Control (server) */                                                                  \
            {                                                                                                                      \
                0x0101, ZAP_ATTRIBUTE_INDEX(23), 1, 2, ZAP_CLUSTER_MASK(CLIENT), NULL                                              \
            }, /* Endpoint: 1, Cluster: Door Lock (client) */                                                                      \
            {                                                                                                                      \
                0x0101, ZAP_ATTRIBUTE_INDEX(24), 29, 43, ZAP_CLUSTER_MASK(SERVER), NULL                                            \
            }, /* Endpoint: 1, Cluster: Door Lock (server) */                                                                      \
            {                                                                                                                      \
                0x0103, ZAP_ATTRIBUTE_INDEX(53), 1, 2, ZAP_CLUSTER_MASK(CLIENT), NULL                                              \
            }, /* Endpoint: 1, Cluster: Barrier Control (client) */                                                                \
            {                                                                                                                      \
                0x0103, ZAP_ATTRIBUTE_INDEX(54), 5, 7, ZAP_CLUSTER_MASK(SERVER), NULL                                              \
            }, /* Endpoint: 1, Cluster: Barrier Control (server) */                                                                \
            {                                                                                                                      \
                0x0300, ZAP_ATTRIBUTE_INDEX(59), 1, 2, ZAP_CLUSTER_MASK(CLIENT), NULL                                              \
            }, /* Endpoint: 1, Cluster: Color Control (client) */                                                                  \
            {                                                                                                                      \
                0x0300, ZAP_ATTRIBUTE_INDEX(60), 51, 336, ZAP_CLUSTER_MASK(SERVER), NULL                                           \
            }, /* Endpoint: 1, Cluster: Color Control (server) */                                                                  \
            {                                                                                                                      \
                0x0402, ZAP_ATTRIBUTE_INDEX(111), 5, 10, ZAP_CLUSTER_MASK(SERVER), NULL                                            \
            }, /* Endpoint: 1, Cluster: Temperature Measurement (server) */                                                        \
            {                                                                                                                      \
                0x0500, ZAP_ATTRIBUTE_INDEX(116), 6, 16, ZAP_CLUSTER_MASK(SERVER), NULL                                            \
...
#define GENERATED_ENDPOINT_TYPES                                                                                                   \
    {                                                                                                                              \
        { ZAP_CLUSTER_INDEX(0), 20, 455 }, { ZAP_CLUSTER_INDEX(20), 2, 7 },                                                        \
    }
...
#define EMBER_AF_GENERATED_REPORTING_CONFIG_DEFAULTS                                                                               \
    {                                                                                                                              \
        {                                                                                                                          \
            ...
            {                                                                                                                      \
                ZAP_REPORT_DIRECTION(REPORTED), 0x0001, 0x0101, 0x0003, ZAP_CLUSTER_MASK(SERVER), 0x0000, { { 0, 65344, 0 } }      \
            }, /* Reporting for cluster: "Door Lock", attribute: "door state". side: server */                                     \
            {                                                                                                                      \
                ZAP_REPORT_DIRECTION(REPORTED), 0x0001, 0x0101, 0x0020, ZAP_CLUSTER_MASK(SERVER), 0x0000, { { 0, 65344, 0 } }      \
            }, /* Reporting for cluster: "Door Lock", attribute: "enable logging". side: server */                                 \
            {                                                                                                                      \
                ZAP_REPORT_DIRECTION(REPORTED), 0x0001, 0x0101, 0x0021, ZAP_CLUSTER_MASK(SERVER), 0x0000, { { 0, 65344, 0 } }      \
            }, /* Reporting for cluster: "Door Lock", attribute: "language". side: server */                                       \
            {                                                                                                                      \
                ZAP_REPORT_DIRECTION(REPORTED), 0x0001, 0x0101, 0x0022, ZAP_CLUSTER_MASK(SERVER), 0x0000, { { 0, 65344, 0 } }      \
            }, /* Reporting for cluster: "Door Lock", attribute: "led settings". side: server */                                   \
            {                                                                                                                      \
                ZAP_REPORT_DIRECTION(REPORTED), 0x0001, 0x0101, 0x0023, ZAP_CLUSTER_MASK(SERVER), 0x0000, { { 0, 65344, 0 } }      \
            }, /* Reporting for cluster: "Door Lock", attribute: "auto relock time". side: server */                               \
            {                                                                                                                      \
                ZAP_REPORT_DIRECTION(REPORTED), 0x0001, 0x0101, 0x0024, ZAP_CLUSTER_MASK(SERVER), 0x0000, { { 0, 65344, 0 } }      \
            }, /* Reporting for cluster: "Door Lock", attribute: "sound volume". side: server */                                   \
            {                                                                                                                      \
                ZAP_REPORT_DIRECTION(REPORTED), 0x0001, 0x0101, 0x0025, ZAP_CLUSTER_MASK(SERVER), 0x0000, { { 0, 65344, 0 } }      \
            }, /* Reporting for cluster: "Door Lock", attribute: "operating mode". side: server */                                 \
            {                                                                                                                      \
                ZAP_REPORT_DIRECTION(REPORTED), 0x0001, 0x0101, 0x0027, ZAP_CLUSTER_MASK(SERVER), 0x0000, { { 0, 65344, 0 } }      \
            }, /* Reporting for cluster: "Door Lock", attribute: "default configuration register". side: server */                 \
            {                                                                                                                      \
                ZAP_REPORT_DIRECTION(REPORTED), 0x0001, 0x0101, 0x0028, ZAP_CLUSTER_MASK(SERVER), 0x0000, { { 0, 65344, 0 } }      \
            }, /* Reporting for cluster: "Door Lock", attribute: "enable local programming". side: server */                       \
            {                                                                                                                      \
                ZAP_REPORT_DIRECTION(REPORTED), 0x0001, 0x0101, 0x0029, ZAP_CLUSTER_MASK(SERVER), 0x0000, { { 0, 65344, 0 } }      \
            }, /* Reporting for cluster: "Door Lock", attribute: "enable one touch locking". side: server */                       \
            {                                                                                                                      \
                ZAP_REPORT_DIRECTION(REPORTED), 0x0001, 0x0101, 0x002A, ZAP_CLUSTER_MASK(SERVER), 0x0000, { { 0, 65344, 0 } }      \
            }, /* Reporting for cluster: "Door Lock", attribute: "enable inside status led". side: server */                       \
            {                                                                                                                      \
                ZAP_REPORT_DIRECTION(REPORTED), 0x0001, 0x0101, 0x002B, ZAP_CLUSTER_MASK(SERVER), 0x0000, { { 0, 65344, 0 } }      \
            }, /* Reporting for cluster: "Door Lock", attribute: "enable privacy mode button". side: server */                     \
            {                                                                                                                      \
                ZAP_REPORT_DIRECTION(REPORTED), 0x0001, 0x0101, 0x0030, ZAP_CLUSTER_MASK(SERVER), 0x0000, { { 0, 65344, 0 } }      \
            }, /* Reporting for cluster: "Door Lock", attribute: "wrong code entry limit". side: server */                         \
            {                                                                                                                      \
                ZAP_REPORT_DIRECTION(REPORTED), 0x0001, 0x0101, 0x0031, ZAP_CLUSTER_MASK(SERVER), 0x0000, { { 0, 65344, 0 } }      \
            }, /* Reporting for cluster: "Door Lock", attribute: "user code temporary disable time". side: server */               \
            {                                                                                                                      \
                ZAP_REPORT_DIRECTION(REPORTED), 0x0001, 0x0101, 0x0032, ZAP_CLUSTER_MASK(SERVER), 0x0000, { { 0, 65344, 0 } }      \
            }, /* Reporting for cluster: "Door Lock", attribute: "send pin over the air". side: server */                          \
            {                                                                                                                      \
                ZAP_REPORT_DIRECTION(REPORTED), 0x0001, 0x0101, 0x0033, ZAP_CLUSTER_MASK(SERVER), 0x0000, { { 0, 65344, 0 } }      \
            }, /* Reporting for cluster: "Door Lock", attribute: "require pin for rf operation". side: server */                   \
            {                                                                                                                      \
                ZAP_REPORT_DIRECTION(REPORTED), 0x0001, 0x0101, 0x0034, ZAP_CLUSTER_MASK(SERVER), 0x0000, { { 0, 65344, 0 } }      \
            }, /* Reporting for cluster: "Door Lock", attribute: "zigbee security level". side: server */                          \
            {                                                                                                                      \
                ZAP_REPORT_DIRECTION(REPORTED), 0x0001, 0x0101, 0x0040, ZAP_CLUSTER_MASK(SERVER), 0x0000, { { 0, 65344, 0 } }      \
            }, /* Reporting for cluster: "Door Lock", attribute: "alarm mask". side: server */                                     \
            {                                                                                                                      \
                ZAP_REPORT_DIRECTION(REPORTED), 0x0001, 0x0101, 0x0041, ZAP_CLUSTER_MASK(SERVER), 0x0000, { { 0, 65344, 0 } }      \
            }, /* Reporting for cluster: "Door Lock", attribute: "keypad operation event mask". side: server */                    \
            {                                                                                                                      \
                ZAP_REPORT_DIRECTION(REPORTED), 0x0001, 0x0101, 0x0042, ZAP_CLUSTER_MASK(SERVER), 0x0000, { { 0, 65344, 0 } }      \
            }, /* Reporting for cluster: "Door Lock", attribute: "RF operation event mask". side: server */                        \
            {                                                                                                                      \
                ZAP_REPORT_DIRECTION(REPORTED), 0x0001, 0x0101, 0x0043, ZAP_CLUSTER_MASK(SERVER), 0x0000, { { 0, 65344, 0 } }      \
            }, /* Reporting for cluster: "Door Lock", attribute: "manual operation event mask". side: server */                    \
            {                                                                                                                      \
                ZAP_REPORT_DIRECTION(REPORTED), 0x0001, 0x0101, 0x0044, ZAP_CLUSTER_MASK(SERVER), 0x0000, { { 0, 65344, 0 } }      \
            }, /* Reporting for cluster: "Door Lock", attribute: "rfid operation event mask". side: server */                      \
            {                                                                                                                      \
                ZAP_REPORT_DIRECTION(REPORTED), 0x0001, 0x0101, 0x0045, ZAP_CLUSTER_MASK(SERVER), 0x0000, { { 0, 65344, 0 } }      \
            }, /* Reporting for cluster: "Door Lock", attribute: "keypad programming event mask". side: server */                  \
            {                                                                                                                      \
                ZAP_REPORT_DIRECTION(REPORTED), 0x0001, 0x0101, 0x0046, ZAP_CLUSTER_MASK(SERVER), 0x0000, { { 0, 65344, 0 } }      \
            }, /* Reporting for cluster: "Door Lock", attribute: "rf programming event mask". side: server */                      \
            {                                                                                                                      \
                ZAP_REPORT_DIRECTION(REPORTED), 0x0001, 0x0101, 0x0047, ZAP_CLUSTER_MASK(SERVER), 0x0000, { { 0, 65344, 0 } }      \
            }, /* Reporting for cluster: "Door Lock", attribute: "rfid programming event mask". side: server */                    \
            {                                                                                                                      \
