...
#define GENERATED_CLUSTERS { \
  ...
  { 0x0101, ZAP_ATTRIBUTE_INDEX(24), 4, 5, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: Door Lock (server) */ \
  ...
  { 0x0300, ZAP_ATTRIBUTE_INDEX(35), 51, 336, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: Color Control (server) */ \
  { 0x0402, ZAP_ATTRIBUTE_INDEX(86), 4, 8, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: Temperature Measurement (server) */ \
  { 0x0500, ZAP_ATTRIBUTE_INDEX(90), 6, 16, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: IAS Zone (server) */ \
  { 0x0000, ZAP_ATTRIBUTE_INDEX(96), 3, 4, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 2, Cluster: Basic (server) */ \
  { 0x0006, ZAP_ATTRIBUTE_INDEX(99), 2, 3, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 2, Cluster: On/off (server) */ \
}
