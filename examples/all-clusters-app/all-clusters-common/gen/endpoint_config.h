...
#define GENERATED_CLUSTERS { \
  ...
  { 0x0029, ZAP_ATTRIBUTE_INDEX(24), 1, 2, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 0, Cluster: OTA Software Update Server (server) */ \
  ...
  { 0x0102, ZAP_ATTRIBUTE_INDEX(176), 10, 17, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: Window Covering (server) */ \
  { 0x0103, ZAP_ATTRIBUTE_INDEX(186), 5, 7, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: Barrier Control (server) */ \
  { 0x0200, ZAP_ATTRIBUTE_INDEX(191), 8, 13, ZAP_CLUSTER_MASK(SERVER) | ZAP_CLUSTER_MASK(INIT_FUNCTION) | ZAP_CLUSTER_MASK(ATTRIBUTE_CHANGED_FUNCTION), chipFuncArrayPumpConfigurationAndControlServer }, /* Endpoint: 1, Cluster: Pump Configuration and Control (server) */ \
  { 0x0201, ZAP_ATTRIBUTE_INDEX(199), 6, 10, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: Thermostat (server) */ \
  { 0x0300, ZAP_ATTRIBUTE_INDEX(205), 51, 336, ZAP_CLUSTER_MASK(SERVER) | ZAP_CLUSTER_MASK(INIT_FUNCTION), chipFuncArrayColorControlServer }, /* Endpoint: 1, Cluster: Color Control (server) */ \
  { 0x0402, ZAP_ATTRIBUTE_INDEX(256), 4, 8, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: Temperature Measurement (server) */ \
  { 0x0403, ZAP_ATTRIBUTE_INDEX(260), 4, 8, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: Pressure Measurement (server) */ \
  { 0x0404, ZAP_ATTRIBUTE_INDEX(264), 4, 8, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: Flow Measurement (server) */ \
  { 0x0405, ZAP_ATTRIBUTE_INDEX(268), 4, 8, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: Relative Humidity Measurement (server) */ \
  { 0x0500, ZAP_ATTRIBUTE_INDEX(272), 6, 16, ZAP_CLUSTER_MASK(SERVER) | ZAP_CLUSTER_MASK(INIT_FUNCTION) | ZAP_CLUSTER_MASK(PRE_ATTRIBUTE_CHANGED_FUNCTION) | ZAP_CLUSTER_MASK(MESSAGE_SENT_FUNCTION), chipFuncArrayIasZoneServer }, /* Endpoint: 1, Cluster: IAS Zone (server) */ \
  { 0x0503, ZAP_ATTRIBUTE_INDEX(278), 2, 34, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: Wake on LAN (server) */ \
  { 0x0504, ZAP_ATTRIBUTE_INDEX(280), 4, 320, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: TV Channel (server) */ \
  { 0x0505, ZAP_ATTRIBUTE_INDEX(284), 2, 256, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: Target Navigator (server) */ \
  { 0x0506, ZAP_ATTRIBUTE_INDEX(286), 1, 2, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: Media Playback (server) */ \
  { 0x0507, ZAP_ATTRIBUTE_INDEX(287), 2, 256, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: Media Input (server) */ \
  { 0x0508, ZAP_ATTRIBUTE_INDEX(289), 1, 2, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: Low Power (server) */ \
  { 0x0509, ZAP_ATTRIBUTE_INDEX(290), 1, 2, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: Keypad Input (server) */ \
  { 0x050A, ZAP_ATTRIBUTE_INDEX(291), 3, 510, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: Content Launcher (server) */ \
  { 0x050B, ZAP_ATTRIBUTE_INDEX(294), 2, 256, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: Audio Output (server) */ \
  { 0x050C, ZAP_ATTRIBUTE_INDEX(296), 2, 256, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: Application Launcher (server) */ \
  { 0x050D, ZAP_ATTRIBUTE_INDEX(298), 8, 105, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: Application Basic (server) */ \
  { 0x050E, ZAP_ATTRIBUTE_INDEX(306), 1, 2, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: Account Login (server) */ \
  { 0x050F, ZAP_ATTRIBUTE_INDEX(307), 21, 1579, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: Test Cluster (server) */ \
  { 0xF000, ZAP_ATTRIBUTE_INDEX(328), 1, 2, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: Binding (server) */ \
  { 0x0006, ZAP_ATTRIBUTE_INDEX(329), 2, 3, ZAP_CLUSTER_MASK(SERVER) | ZAP_CLUSTER_MASK(INIT_FUNCTION), chipFuncArrayOnOffServer }, /* Endpoint: 2, Cluster: On/off (server) */ \
  { 0x0406, ZAP_ATTRIBUTE_INDEX(331), 4, 5, ZAP_CLUSTER_MASK(SERVER) | ZAP_CLUSTER_MASK(INIT_FUNCTION), chipFuncArrayOccupancySensingServer }, /* Endpoint: 2, Cluster: Occupancy Sensing (server) */ \
}
...
#define ATTRIBUTE_MAX_SIZE (9755)
...
#define EMBER_AF_GENERATED_REPORTING_CONFIG_DEFAULTS_TABLE_SIZE (20)
