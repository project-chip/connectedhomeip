...
#define GENERATED_ATTRIBUTES                                                                                                       \
    {                                                                                                                              \
        { 0xFFFD, ZAP_TYPE(INT16U), 2, 0, ZAP_SIMPLE_DEFAULT(2) }, /* Identify (server): cluster revision */                       \
            ...
            { 0x0002, ZAP_TYPE(BITMAP8), 1, 0,                                                                                     \
              ZAP_EMPTY_DEFAULT() }, /* Occupancy Sensing (server): occupancy sensor type bitmap */                                \
    ...
    {                                                                                                                              \
        { 0x0003,                                                                                                                  \
          ...
          chipFuncArrayIdentifyServer }, /* Endpoint: 1, Cluster: Identify (server) */                                             \
            ...
            {                                                                                                                      \
                0x0508, ZAP_ATTRIBUTE_INDEX(104), 1, 2, ZAP_CLUSTER_MASK(SERVER), NULL                                             \
            }, /* Endpoint: 1, Cluster: Low Power (server) */                                                                      \
            {                                                                                                                      \
                0x050D, ZAP_ATTRIBUTE_INDEX(105), 8, 105, ZAP_CLUSTER_MASK(SERVER), NULL                                           \
            ...
            {                                                                                                                      \
                0x0028, ZAP_ATTRIBUTE_INDEX(119), 12, 254, ZAP_CLUSTER_MASK(SERVER), NULL                                          \
...
#define GENERATED_ENDPOINT_TYPES                                                                                                   \
    {                                                                                                                              \
        { ZAP_CLUSTER_INDEX(0), 18, 1291 }, { ZAP_CLUSTER_INDEX(18), 2, 257 },                                                     \
    }
...
#define EMBER_AF_GENERATED_REPORTING_CONFIG_DEFAULTS                                                                               \
    {                                                                                                                              \
        {                                                                                                                          \
            ...
            }, /* Reporting for cluster: "Occupancy Sensing", attribute: "occupancy". side: server */                              \
            {                                                                                                                      \
