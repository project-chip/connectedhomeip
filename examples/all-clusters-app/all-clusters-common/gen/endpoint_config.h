    ...
    {                                                                                                                              \
        { 0x0003,                                                                                                                  \
          ...
          chipFuncArrayIdentifyServer }, /* Endpoint: 1, Cluster: Identify (server) */                                             \
            ...
            {                                                                                                                      \
                0x0406, ZAP_ATTRIBUTE_INDEX(94), 4, 5, ZAP_CLUSTER_MASK(SERVER), NULL                                              \
            ...
            {                                                                                                                      \
                0x050D, ZAP_ATTRIBUTE_INDEX(104), 8, 105, ZAP_CLUSTER_MASK(SERVER), NULL                                           \
...
#define GENERATED_ENDPOINT_TYPES                                                                                                   \
    {                                                                                                                              \
        { ZAP_CLUSTER_INDEX(0), 17, 1289 }, { ZAP_CLUSTER_INDEX(17), 2, 257 },                                                     \
    }
