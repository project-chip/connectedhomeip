...
#define GENERATED_DEFAULTS                                                                                                         \
    {                                                                                                                              \
        ...
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,    \
            ...
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,                                          \
                                                                                                                                   \
            /* 746 - Default for cluster: "Application Launcher", attribute: "application launcher list". side: server,            \
               little-endian */                                                                                                    \
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,      \
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,                                          \
                                                                                                                                   \
    ...
    {                                                                                                                              \
        { 0xFFFD, ZAP_TYPE(INT16U), 2, 0, ZAP_SIMPLE_DEFAULT(2) }, /* Identify (server): cluster revision */                       \
            ...
            { 0x0006, ZAP_TYPE(CHAR_STRING), 254, 0,                                                                               \
              ZAP_LONG_DEFAULTS_INDEX(260) },                               /* Color Control (server): compensation text */        \
            ...
            { 0x0000, ZAP_TYPE(CHAR_STRING), 32, 0,                                                                                \
              ZAP_LONG_DEFAULTS_INDEX(522) },                               /* Wake on LAN (server): wake on lan mac address */    \
            ...
            { 0x0000, ZAP_TYPE(OCTET_STRING), 32, 0,                                                                               \
              ZAP_LONG_DEFAULTS_INDEX(650) },                               /* Target Navigator (server): target navigator list */ \
            ...
            { 0x0000, ZAP_TYPE(OCTET_STRING), 32, 0,                                                                               \
              ZAP_LONG_DEFAULTS_INDEX(714) },                               /* Audio Output (server): audio output list */         \
            { 0xFFFD, ZAP_TYPE(INT16U), 2, 0, ZAP_SIMPLE_DEFAULT(0x0001) }, /* Audio Output (server): cluster revision */          \
            { 0x0000, ZAP_TYPE(OCTET_STRING), 32, 0,                                                                               \
              ZAP_LONG_DEFAULTS_INDEX(746) }, /* Application Launcher (server): application launcher list */                       \
            ...
            { 0x0002, ZAP_TYPE(OCTET_STRING), 32, 0,                                                                               \
              ZAP_LONG_DEFAULTS_INDEX(810) },                               /* Application Basic (server): application name */     \
            ...
            { 0x0005, ZAP_TYPE(OCTET_STRING), 32, 0,                                                                               \
              ZAP_LONG_DEFAULTS_INDEX(842) },                                  /* Application Basic (server): application id */    \
            ...
            { 0x0000, ZAP_TYPE(INT16U), 2, ZAP_ATTRIBUTE_MASK(SINGLETON),                                                          \
              ZAP_EMPTY_DEFAULT() }, /* Basic (server): InteractionModelVersion */                                                 \
            { 0x0001, ZAP_TYPE(CHAR_STRING), 32, ZAP_ATTRIBUTE_MASK(SINGLETON),                                                    \
              ZAP_LONG_DEFAULTS_INDEX(1382) },                                                   /* Basic (server): VendorName */  \
            { 0x0002, ZAP_TYPE(INT16U), 2, ZAP_ATTRIBUTE_MASK(SINGLETON), ZAP_EMPTY_DEFAULT() }, /* Basic (server): VendorID */    \
            { 0x0003, ZAP_TYPE(CHAR_STRING), 32, ZAP_ATTRIBUTE_MASK(SINGLETON),                                                    \
              ZAP_LONG_DEFAULTS_INDEX(1414) },                                                   /* Basic (server): ProductName */ \
            { 0x0004, ZAP_TYPE(INT16U), 2, ZAP_ATTRIBUTE_MASK(SINGLETON), ZAP_EMPTY_DEFAULT() }, /* Basic (server): ProductID */   \
            { 0x0005, ZAP_TYPE(CHAR_STRING), 32, ZAP_ATTRIBUTE_MASK(SINGLETON) | ZAP_ATTRIBUTE_MASK(WRITABLE),                     \
              ZAP_LONG_DEFAULTS_INDEX(1446) }, /* Basic (server): UserLabel */                                                     \
            { 0x0006, ZAP_TYPE(CHAR_STRING), 16, ZAP_ATTRIBUTE_MASK(SINGLETON) | ZAP_ATTRIBUTE_MASK(WRITABLE),                     \
              ZAP_LONG_DEFAULTS_INDEX(1478) }, /* Basic (server): Location */                                                      \
            { 0x0007, ZAP_TYPE(INT16U), 2, ZAP_ATTRIBUTE_MASK(SINGLETON),                                                          \
              ZAP_SIMPLE_DEFAULT(0x00) }, /* Basic (server): HardwareVersion */                                                    \
            { 0x0008, ZAP_TYPE(CHAR_STRING), 64, ZAP_ATTRIBUTE_MASK(SINGLETON),                                                    \
              ZAP_LONG_DEFAULTS_INDEX(1494) }, /* Basic (server): HardwareVersionString */                                         \
            { 0x0009, ZAP_TYPE(INT32U), 4, ZAP_ATTRIBUTE_MASK(SINGLETON),                                                          \
              ZAP_LONG_DEFAULTS_INDEX(1558) }, /* Basic (server): SoftwareVersion */                                               \
            { 0x000A, ZAP_TYPE(CHAR_STRING), 64, ZAP_ATTRIBUTE_MASK(SINGLETON),                                                    \
              ZAP_LONG_DEFAULTS_INDEX(1562) }, /* Basic (server): SoftwareVersionString */                                         \
    }
    ...
    {                                                                                                                              \
        { 0x0003,                                                                                                                  \
          ...
          chipFuncArrayIdentifyServer }, /* Endpoint: 1, Cluster: Identify (server) */                                             \
            ...
            {                                                                                                                      \
                0xF001, ZAP_ATTRIBUTE_INDEX(125), 2, 4, ZAP_CLUSTER_MASK(SERVER), NULL                                             \
            }, /* Endpoint: 1, Cluster: Media Playback (server) */                                                                 \
            {                                                                                                                      \
                0xF002, ZAP_ATTRIBUTE_INDEX(127), 1, 2, ZAP_CLUSTER_MASK(SERVER), NULL                                             \
            ...
            {                                                                                                                      \
                0x0028, ZAP_ATTRIBUTE_INDEX(133), 12, 254, ZAP_CLUSTER_MASK(SERVER), NULL                                          \
...
#define GENERATED_ENDPOINT_TYPES                                                                                                   \
    {                                                                                                                              \
        { ZAP_CLUSTER_INDEX(0), 26, 1562 }, { ZAP_CLUSTER_INDEX(26), 2, 257 },                                                     \
    }
