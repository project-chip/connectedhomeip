...
EmberAfStatus emberAfFabricClusterServerCommandParse(EmberAfClusterCommand * cmd);
...
EmberAfStatus emberAfClusterSpecificCommandParse(EmberAfClusterCommand * cmd)
{
             ...
             emberAfContainsServerWithMfgCode(cmd->apsFrame->destinationEndpoint, cmd->apsFrame->clusterId, cmd->mfgCode))
    {
        ...
        case ZCL_FABRIC_CLUSTER_ID :
            result = emberAfFabricClusterServerCommandParse(cmd);
            break;
...
EmberAfStatus emberAfFabricClusterServerCommandParse(EmberAfClusterCommand * cmd)
{
    ...
    if (!cmd->mfgSpecific)
    {
        ...
        wasHandled = emberAfFabricClusterGetFabricIdCallback();
            break;
        }
...
wasHandled = emberAfOtaSoftwareUpdateServerClusterQueryImageCallback(vendorId, productId, imageType, hardwareVersion, currentVersion, protocolsSupported, location, clientCanConsent, metadataForServer);
            break;
        }
        default: {
            // Unrecognized command ID, error status will apply.
