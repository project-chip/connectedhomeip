...
bool emberAfBasicClusterMfgSpecificPingCallback(chip::app::Command * apCommandObj);
...
bool emberAfBindingClusterBindCallback(chip::app::Command * apCommandObj, chip::NodeId nodeId, chip::GroupId groupId,
...
bool emberAfBindingClusterUnbindCallback(chip::app::Command * apCommandObj, chip::NodeId nodeId, chip::GroupId groupId,
                                         chip::EndpointId endpointId, chip::ClusterId clusterId);
...
bool emberAfGeneralCommissioningClusterSetFabricCallback(chip::app::Command * apCommandObj, chip::ByteSpan fabricId,
