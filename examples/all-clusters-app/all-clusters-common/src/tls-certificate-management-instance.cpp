...
CHIP_ERROR TlsCertificateManagementCommandDelegate::LoadedRootCert(LoadedRootCertificateType loadedCallback) const
{
    ...
    return loadedCallback(*certBuffer);
}
...
Status TlsCertificateManagementCommandDelegate::LookupRootCert(EndpointId matterEndpoint, FabricIndex fabric,
                                                               ...
                                                               LoadedRootCertificateType & loadedCallback) const
{
...
CHIP_ERROR TlsCertificateManagementCommandDelegate::LoadedClientCert(LoadedClientCertificateType loadedCallback) const
{
...
Status TlsCertificateManagementCommandDelegate::LookupClientCert(EndpointId matterEndpoint, FabricIndex fabric,
                                                                 const ByteSpan fingerprint,
                                                                 LoadedClientCertificateType & loadedCallback) const
{
    return Status::Failure;
}

static CertificateTableImpl gCertificateTableInstance;
TlsCertificateManagementCommandDelegate TlsCertificateManagementCommandDelegate::instance;
