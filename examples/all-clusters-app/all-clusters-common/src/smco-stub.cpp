...
constexpr const uint16_t kSelfTestingTimeout = 10;
...
void EndSelfTestingEventHandler(System::Layer * systemLayer, void * appState)
{
    ...
    SmokeCoAlarmServer::Instance().AutoSetExpressedState(1, sPriorityOrder);
...
void SelfTestingEventHandler()
{
    ...
    DeviceLayer::SystemLayer().StartTimer(System::Clock::Seconds32(kSelfTestingTimeout), EndSelfTestingEventHandler, nullptr);
}
