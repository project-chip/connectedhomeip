...
{
    const int16_t heatingOnThreshold  = mOccupiedHeatingSetpoint - (int16_t) mOccupiedSetback * 10;
    const int16_t heatingOffThreshold = mOccupiedHeatingSetpoint + (int16_t) mOccupiedSetback * 10;
