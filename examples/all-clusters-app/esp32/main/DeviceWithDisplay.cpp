    ...
    void DoAction(int i) override
    {
        ...
        else
        {
            ...
            else if (name == "Charge level" && cluster == "Power Source")
            {
                ...
                app::Clusters::PowerSource::Attributes::BatChargeLevel::Set(1, static_cast<uint8_t>(attributeValue));
            }
            else
            {
                value = (value == "Closed") ? "Open" : "Closed";
...
void SetupPretendDevices()
{
    ...
    app::Clusters::PowerSource::Attributes::BatChargeLevel::Set(1, static_cast<uint8_t>(0));
}
