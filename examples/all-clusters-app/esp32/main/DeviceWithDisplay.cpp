    ...
    void DoAction(int i) override
    {
        ...
        if (sscanf(value.c_str(), "%d", &n) == 1)
        {
            ...
            else if (name == "Opr Status")
            {
                ...
                chip::BitFlags<app::Clusters::WindowCovering::OperationalStatus> opStatus = static_cast<chip::BitFlags<app::Clusters::WindowCovering::OperationalStatus>>(n);
...
void SetupPretendDevices()
{
    ...
    chip::BitFlags<app::Clusters::WindowCovering::OperationalStatus> opStatus = static_cast<chip::BitFlags<app::Clusters::WindowCovering::OperationalStatus>>(0);
    app::Clusters::WindowCovering::Attributes::OperationalStatus::Set(1, opStatus);
