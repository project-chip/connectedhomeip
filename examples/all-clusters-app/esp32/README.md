...
are both enabled, the NetworkCommissioning cluster in Enpoint 0 will be used for Thread network
...
are both enabled, the NetworkCommissioning cluster in Enpoint 0 will be used for Ethernet network
driver and the same cluster on Endpoint 65534 will be used for Wi-Fi network driver.
