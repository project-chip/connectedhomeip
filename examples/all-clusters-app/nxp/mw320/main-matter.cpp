...
void BOARD_SW1_IRQ_HANDLER(void)
{
    ...
    GPIO_PortClearInterruptFlags(BOARD_SW1_GPIO, GPIO_PORT(BOARD_SW1_GPIO_PIN), 1UL << GPIO_PORT_PIN(BOARD_SW1_GPIO_PIN));
    /* Change state of button. */
    g_ButtonPress++;
    SDK_ISR_EXIT_BARRIER;
    PRINTF("SW1 count %d\r\n", g_ButtonPress);
    //if (g_ButtonPress % 2)
    //    GPIO_PortToggle(BOARD_LED_YELLOW_GPIO, GPIO_PORT(BOARD_LED_YELLOW_GPIO_PIN), 1UL << GPIO_PORT_PIN(BOARD_LED_YELLOW_GPIO_PIN));
}
#if defined(__cplusplus)
}
#endif /* __cplusplus */
...
void gpio_init(void)
{
    ...
    //GPIO_PinInit(BOARD_LED_YELLOW_GPIO, BOARD_LED_YELLOW_GPIO_PIN, &led_config);
}
// JL_DBG
