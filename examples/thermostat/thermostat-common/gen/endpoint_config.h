...
\
  ...
  { 0x0005, ZAP_TYPE(CHAR_STRING), 32, ZAP_ATTRIBUTE_MASK(SINGLETON) | ZAP_ATTRIBUTE_MASK(WRITABLE), ZAP_LONG_DEFAULTS_INDEX(4812) }, /* UserLabel */  \
  { 0x0007, ZAP_TYPE(INT16U), 2, ZAP_ATTRIBUTE_MASK(SINGLETON), ZAP_SIMPLE_DEFAULT(0x00) }, /* HardwareVersion */  \
  { 0x0008, ZAP_TYPE(CHAR_STRING), 64, ZAP_ATTRIBUTE_MASK(SINGLETON), ZAP_LONG_DEFAULTS_INDEX(4844) }, /* HardwareVersionString */  \
  { 0x0009, ZAP_TYPE(INT32U), 4, ZAP_ATTRIBUTE_MASK(SINGLETON), ZAP_LONG_DEFAULTS_INDEX(4908) }, /* SoftwareVersion */  \
  { 0x000A, ZAP_TYPE(CHAR_STRING), 64, ZAP_ATTRIBUTE_MASK(SINGLETON), ZAP_LONG_DEFAULTS_INDEX(4912) }, /* SoftwareVersionString */  \
  { 0x000B, ZAP_TYPE(CHAR_STRING), 16, ZAP_ATTRIBUTE_MASK(SINGLETON), ZAP_LONG_DEFAULTS_INDEX(4976) }, /* ManufacturingDate */  \
  ...
  { 0x000E, ZAP_TYPE(CHAR_STRING), 64, ZAP_ATTRIBUTE_MASK(SINGLETON), ZAP_LONG_DEFAULTS_INDEX(5500) }, /* ProductLabel */  \
  { 0x000F, ZAP_TYPE(CHAR_STRING), 32, ZAP_ATTRIBUTE_MASK(SINGLETON), ZAP_LONG_DEFAULTS_INDEX(5564) }, /* SerialNumber */  \
...
\
  ...
  { 0x0019, ZAP_TYPE(OCTET_STRING), 10, ZAP_ATTRIBUTE_MASK(WRITABLE), ZAP_LONG_DEFAULTS_INDEX(8122) }, /* octet_string */  \
  ...
  { 0x001D, ZAP_TYPE(LONG_OCTET_STRING), 1000, ZAP_ATTRIBUTE_MASK(WRITABLE), ZAP_LONG_DEFAULTS_INDEX(8650) }, /* long_octet_string */  \
  { 0xFFFD, ZAP_TYPE(INT16U), 2, 0, ZAP_SIMPLE_DEFAULT(0x0001) }, /* ClusterRevision */  \
\
...
#define GENERATED_CLUSTERS { \
  ...
  { 0x0030, ZAP_ATTRIBUTE_INDEX(25), 3, 264, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 0, Cluster: General Commissioning (server) */ \
  ...
  { 0x003C, ZAP_ATTRIBUTE_INDEX(114), 1, 2, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 0, Cluster: AdministratorCommissioning (server) */ \
  { 0x003E, ZAP_ATTRIBUTE_INDEX(115), 4, 258, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 0, Cluster: Operational Credentials (server) */ \
  { 0x0405, ZAP_ATTRIBUTE_INDEX(119), 4, 8, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 0, Cluster: Relative Humidity Measurement (server) */ \
  { 0xF000, ZAP_ATTRIBUTE_INDEX(123), 1, 2, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 0, Cluster: Binding (server) */ \
  { 0xF004, ZAP_ATTRIBUTE_INDEX(124), 3, 510, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 0, Cluster: Group Key Management (server) */ \
  { 0x0003, ZAP_ATTRIBUTE_INDEX(127), 2, 4, ZAP_CLUSTER_MASK(SERVER) | ZAP_CLUSTER_MASK(INIT_FUNCTION) | ZAP_CLUSTER_MASK(ATTRIBUTE_CHANGED_FUNCTION), chipFuncArrayIdentifyServer }, /* Endpoint: 1, Cluster: Identify (server) */ \
  { 0x0004, ZAP_ATTRIBUTE_INDEX(129), 2, 3, ZAP_CLUSTER_MASK(SERVER) | ZAP_CLUSTER_MASK(INIT_FUNCTION), chipFuncArrayGroupsServer }, /* Endpoint: 1, Cluster: Groups (server) */ \
  { 0x0005, ZAP_ATTRIBUTE_INDEX(131), 6, 8, ZAP_CLUSTER_MASK(SERVER) | ZAP_CLUSTER_MASK(INIT_FUNCTION), chipFuncArrayScenesServer }, /* Endpoint: 1, Cluster: Scenes (server) */ \
  { 0x0006, ZAP_ATTRIBUTE_INDEX(137), 7, 13, ZAP_CLUSTER_MASK(SERVER) | ZAP_CLUSTER_MASK(INIT_FUNCTION), chipFuncArrayOnOffServer }, /* Endpoint: 1, Cluster: On/Off (server) */ \
  { 0x0008, ZAP_ATTRIBUTE_INDEX(144), 2, 3, ZAP_CLUSTER_MASK(SERVER) | ZAP_CLUSTER_MASK(INIT_FUNCTION), chipFuncArrayLevelControlServer }, /* Endpoint: 1, Cluster: Level Control (server) */ \
  { 0x000F, ZAP_ATTRIBUTE_INDEX(146), 4, 5, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: Binary Input (Basic) (server) */ \
  { 0x001D, ZAP_ATTRIBUTE_INDEX(150), 5, 1018, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: Descriptor (server) */ \
  { 0x0039, ZAP_ATTRIBUTE_INDEX(155), 15, 855, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: Bridged Device Basic (server) */ \
  { 0x003B, ZAP_ATTRIBUTE_INDEX(170), 3, 4, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: Switch (server) */ \
  { 0x0040, ZAP_ATTRIBUTE_INDEX(173), 2, 256, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: Fixed Label (server) */ \
  { 0x0101, ZAP_ATTRIBUTE_INDEX(175), 4, 5, ZAP_CLUSTER_MASK(SERVER) | ZAP_CLUSTER_MASK(ATTRIBUTE_CHANGED_FUNCTION), chipFuncArrayDoorLockServer }, /* Endpoint: 1, Cluster: Door Lock (server) */ \
  { 0x0102, ZAP_ATTRIBUTE_INDEX(179), 19, 31, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: Window Covering (server) */ \
  { 0x0103, ZAP_ATTRIBUTE_INDEX(198), 5, 7, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: Barrier Control (server) */ \
  { 0x0201, ZAP_ATTRIBUTE_INDEX(203), 10, 17, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: Thermostat (server) */ \
  { 0x0300, ZAP_ATTRIBUTE_INDEX(213), 51, 336, ZAP_CLUSTER_MASK(SERVER) | ZAP_CLUSTER_MASK(INIT_FUNCTION), chipFuncArrayColorControlServer }, /* Endpoint: 1, Cluster: Color Control (server) */ \
  { 0x0402, ZAP_ATTRIBUTE_INDEX(264), 4, 8, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: Temperature Measurement (server) */ \
  { 0x0403, ZAP_ATTRIBUTE_INDEX(268), 4, 8, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: Pressure Measurement (server) */ \
  { 0x0404, ZAP_ATTRIBUTE_INDEX(272), 4, 8, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: Flow Measurement (server) */ \
  { 0x0405, ZAP_ATTRIBUTE_INDEX(276), 4, 8, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: Relative Humidity Measurement (server) */ \
  { 0x0500, ZAP_ATTRIBUTE_INDEX(280), 6, 16, ZAP_CLUSTER_MASK(SERVER) | ZAP_CLUSTER_MASK(INIT_FUNCTION) | ZAP_CLUSTER_MASK(PRE_ATTRIBUTE_CHANGED_FUNCTION) | ZAP_CLUSTER_MASK(MESSAGE_SENT_FUNCTION), chipFuncArrayIasZoneServer }, /* Endpoint: 1, Cluster: IAS Zone (server) */ \
  { 0x0503, ZAP_ATTRIBUTE_INDEX(286), 2, 34, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: Wake on LAN (server) */ \
  { 0x0504, ZAP_ATTRIBUTE_INDEX(288), 4, 320, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: TV Channel (server) */ \
  { 0x0505, ZAP_ATTRIBUTE_INDEX(292), 2, 256, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: Target Navigator (server) */ \
  { 0x0506, ZAP_ATTRIBUTE_INDEX(294), 1, 2, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: Media Playback (server) */ \
  { 0x0507, ZAP_ATTRIBUTE_INDEX(295), 2, 256, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: Media Input (server) */ \
  { 0x0508, ZAP_ATTRIBUTE_INDEX(297), 1, 2, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: Low Power (server) */ \
  { 0x0509, ZAP_ATTRIBUTE_INDEX(298), 1, 2, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: Keypad Input (server) */ \
  { 0x050A, ZAP_ATTRIBUTE_INDEX(299), 3, 510, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: Content Launcher (server) */ \
  { 0x050B, ZAP_ATTRIBUTE_INDEX(302), 2, 256, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: Audio Output (server) */ \
  { 0x050C, ZAP_ATTRIBUTE_INDEX(304), 2, 256, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: Application Launcher (server) */ \
  { 0x050D, ZAP_ATTRIBUTE_INDEX(306), 8, 105, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: Application Basic (server) */ \
  { 0x050E, ZAP_ATTRIBUTE_INDEX(314), 1, 2, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: Account Login (server) */ \
  { 0x050F, ZAP_ATTRIBUTE_INDEX(315), 21, 1579, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: Test Cluster (server) */ \
  { 0xF000, ZAP_ATTRIBUTE_INDEX(336), 1, 2, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: Binding (server) */ \
  { 0x0006, ZAP_ATTRIBUTE_INDEX(337), 2, 3, ZAP_CLUSTER_MASK(SERVER) | ZAP_CLUSTER_MASK(INIT_FUNCTION), chipFuncArrayOnOffServer }, /* Endpoint: 2, Cluster: On/Off (server) */ \
  { 0x0406, ZAP_ATTRIBUTE_INDEX(339), 4, 5, ZAP_CLUSTER_MASK(SERVER) | ZAP_CLUSTER_MASK(INIT_FUNCTION), chipFuncArrayOccupancySensingServer }, /* Endpoint: 2, Cluster: Occupancy Sensing (server) */ \
}
...
#define GENERATED_ENDPOINT_TYPES { \
  { ZAP_CLUSTER_INDEX(0), 16, 3810 }, \
  { ZAP_CLUSTER_INDEX(16), 34, 6195 }, \
  { ZAP_CLUSTER_INDEX(50), 2, 8 }, \
}
...
\
  /* Endpoint: 0, Cluster: OTA Software Update Provider (server) */ \
  { ZAP_REPORT_DIRECTION(REPORTED), 0x0000, 0x0029, 0xFFFD, ZAP_CLUSTER_MASK(SERVER), 0x0000, {{ 0, 65344, 0 }} }, /* ClusterRevision */ \
\
  /* Endpoint: 0, Cluster: Relative Humidity Measurement (server) */ \
