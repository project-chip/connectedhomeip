      ...
      "clusters": [
        ...
        },
        {
          ...
          "commands": [
            ...
            "0x0004 |         | client |        1 |       1 => NotifyUpdateApplied"
          ],
          "attributes": [
            "   code    | mfgCode |  side  | storageOption | singleton | bounded |     defaultValue     | reportable |     minInterval     |     maxInterval     |   reportableChange",
      ...
      "clusters": [
        ...
        },
        {
          ...
          "attributes": [
            ...
            "    0x0003 |         | server |           RAM |           |         |                  700 |          1 |                     |               65344 |                     => AbsMinHeatSetpointLimit [int16s]",
            "    0x0004 |         | server |           RAM |           |         |                 3000 |          1 |                     |               65344 |                     => AbsMaxHeatSetpointLimit [int16s]",
            "    0x0005 |         | server |           RAM |           |         |                 1600 |          1 |                     |               65344 |                     => AbsMinCoolSetpointLimit [int16s]",
            "    0x0006 |         | server |           RAM |           |         |                 3200 |          1 |                     |               65344 |                     => AbsMaxCoolSetpointLimit [int16s]",
            "    0x0011 |         | server |           NVM |           |         |               0x0A28 |          1 |                     |               65344 |                     => OccupiedCoolingSetpoint [int16s]",
            "    0x0012 |         | server |           NVM |           |         |               0x07D0 |          1 |                     |               65344 |                     => OccupiedHeatingSetpoint [int16s]",
            "    0x0015 |         | server |           RAM |           |         |                  700 |          1 |                     |               65344 |                     => MinHeatSetpointLimit [int16s]",
            "    0x0016 |         | server |           RAM |           |         |                 3000 |          1 |                     |               65344 |                     => MaxHeatSetpointLimit [int16s]",
            "    0x0017 |         | server |           RAM |           |         |                 1600 |          1 |                     |               65344 |                     => MinCoolSetpointLimit [int16s]",
            "    0x0018 |         | server |           RAM |           |         |                 3200 |          1 |                     |               65344 |                     => MaxCoolSetpointLimit [int16s]",
