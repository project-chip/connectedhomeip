...
This reference application implements a thermostat device type. You can use this
...
The application showcases a thermostat device that communicates with clients
