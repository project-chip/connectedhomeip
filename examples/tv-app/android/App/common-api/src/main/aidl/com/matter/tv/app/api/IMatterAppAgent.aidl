...
import com.matter.tv.app.api.SetClustersRequest;
import com.matter.tv.app.api.ReportAttributeChangeResult;
...
interface IMatterAppAgent {
     ...
     */
    boolean setClusters(in SetClustersRequest request);
     ...
     */
    ReportAttributeChangeResult reportAttributeChange(in ReportAttributeChangeRequest request);
}