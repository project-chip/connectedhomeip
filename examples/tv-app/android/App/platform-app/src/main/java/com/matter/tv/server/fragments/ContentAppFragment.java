 ...
 * Use the {@link ContentAppFragment#newInstance} factory method to
...
public class ContentAppFragment extends Fragment {
    ...
    public void onResume() {
        ...
        ContentAppListAdapter adapter = new ContentAppListAdapter(getContext(), R.layout.applist_item, lst);
