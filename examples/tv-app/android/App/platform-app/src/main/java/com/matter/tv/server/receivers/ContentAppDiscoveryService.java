...
public class ContentAppDiscoveryService extends BroadcastReceiver {
    ...
    static final String CLUSTERS_RESOURCE_METADATA_KEY =
            "com.matter.app_agent_api.clusters";
    ...
    private static final String FTV_PACKAGE_REMOVED_ACTION = "com.amazon.alexa.android.intent.action.PACKAGE_REMOVED";
    private static final String FTV_PACKAGE_ADDED_ACTION = "com.amazon.alexa.android.intent.action.PACKAGE_ADDED";
...
//                discoveryAgent.init();
            ...
            case FTV_PACKAGE_REMOVED_ACTION:
                ...
                break;
            default:
                Log.e(TAG, new StringBuilder().append("Received unknown Intent: ").append(intent.getAction()).toString());
        }
