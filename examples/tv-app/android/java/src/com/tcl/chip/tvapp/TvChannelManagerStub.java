...
public class TvChannelManagerStub implements TvChannelManager {
    ...
    public TvChannelInfo[] getChannelList() {
        TvChannelInfo tvChannelInfo1 = new TvChannelInfo(1, 1, "HDMI1", "callSign1", "affiliateCallSign1");
        TvChannelInfo tvChannelInfo2 = new TvChannelInfo(2, 2, "HDMI2", "callSign2", "affiliateCallSign2");
