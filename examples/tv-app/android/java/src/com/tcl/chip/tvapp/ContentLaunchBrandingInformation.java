...
public class ContentLaunchBrandingInformation {
    ...
    public class StyleInformation {
        ...
        /**
         * The color, in RGB or RGBA, used for styling different Video Player sections like Logo, Watermark, etc.
         * The value SHALL conform to the 6-digit or 8-digit format defined for CSS sRGB hexadecimal color notation. Examples:
         * <p>
    ...
    /**
     * The background of the Video Player while content launch request is being processed by it. This background information MAY also be used by the Video Player when it is in idle state.
     */
    ...
    /**
     * The screen shown when the Video Player is in an idle state. If this property is not populated, the Video Player SHALL default to logo or the provider name.
     */
