...
public class ContentLaunchSearchParameter {
    ...
    /**
     * An event is a reference to a type of event; examples would include sports, music,
     * or other types of events. For example, searching for "Football games" would search
     * for a 'game' event entity and a 'football' sport entity.
     */
