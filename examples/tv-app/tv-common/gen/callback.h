...
bool emberAfApplicationLauncherClusterLaunchAppCallback(/* TYPE WARNING: array array defaults to */ uint8_t * application,
                                                        uint8_t * data);
...
bool emberAfKeypadInputClusterSendKeyCallback(uint8_t keyCode);
