 ...
 * @param status             The status of the sent message
 */
void emberAfBarrierControlClusterClientMessageSentCallback(EmberOutgoingMessageType type, uint64_t indexOrDestination, EmberApsFrame * apsFrame, uint16_t msgLen, uint8_t * message, EmberStatus status);
 ...
 * @param value         Attribute value
 */
EmberAfStatus emberAfBarrierControlClusterClientPreAttributeChangedCallback(chip::EndpointId endpoint, chip::AttributeId attributeId, EmberAfAttributeType attributeType, uint8_t size, uint8_t * value);
 ...
 * @param status             The status of the sent message
 */
void emberAfDoorLockClusterClientMessageSentCallback(EmberOutgoingMessageType type, uint64_t indexOrDestination, EmberApsFrame * apsFrame, uint16_t msgLen, uint8_t * message, EmberStatus status);
 ...
 * @param value         Attribute value
 */
EmberAfStatus emberAfDoorLockClusterClientPreAttributeChangedCallback(chip::EndpointId endpoint, chip::AttributeId attributeId, EmberAfAttributeType attributeType, uint8_t size, uint8_t * value);
...
bool emberAfApplicationLauncherClusterLaunchAppCallback(/* TYPE WARNING: array array defaults to */ uint8_t *  application, uint8_t * data);
...
bool emberAfAudioOutputClusterRenameOutputCallback(uint8_t index, uint8_t * name);
...
bool emberAfAudioOutputClusterSelectOutputCallback(uint8_t index);
...
bool emberAfKeypadInputClusterSendKeyCallback(uint8_t keyAction, uint8_t keyCode);
...
bool emberAfMediaInputClusterRenameInputCallback(uint8_t index, uint8_t * name);
...
bool emberAfMediaInputClusterSelectInputCallback(uint8_t index);
...
bool emberAfNetworkCommissioningClusterAddThreadNetworkCallback(chip::ByteSpan operationalDataset, uint64_t breadcrumb, uint32_t timeoutMs);
...
bool emberAfNetworkCommissioningClusterAddWiFiNetworkCallback(chip::ByteSpan ssid, chip::ByteSpan credentials, uint64_t breadcrumb, uint32_t timeoutMs);
...
bool emberAfNetworkCommissioningClusterUpdateThreadNetworkCallback(chip::ByteSpan operationalDataset, uint64_t breadcrumb, uint32_t timeoutMs);
...
bool emberAfNetworkCommissioningClusterUpdateWiFiNetworkCallback(chip::ByteSpan ssid, chip::ByteSpan credentials, uint64_t breadcrumb, uint32_t timeoutMs);
...
bool emberAfTvChannelClusterChangeChannelCallback(uint8_t * match);
...
bool emberAfTvChannelClusterChangeChannelByNumberCallback(uint16_t majorNumber, uint16_t minorNumber);
...
bool emberAfTvChannelClusterSkipChannelCallback(uint16_t Count);
...
bool emberAfTargetNavigatorClusterNavigateTargetCallback(uint8_t target, uint8_t * data);
