...
#define GENERATED_CLUSTERS { \
  ...
  { 0x0507, ZAP_ATTRIBUTE_INDEX(126), 3, 257, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: Media Input (server) */ \
  { 0x0508, ZAP_ATTRIBUTE_INDEX(129), 1, 2, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: Low Power (server) */ \
  { 0x0509, ZAP_ATTRIBUTE_INDEX(130), 1, 2, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: Keypad Input (server) */ \
  { 0x050A, ZAP_ATTRIBUTE_INDEX(131), 3, 510, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: Content Launcher (server) */ \
  { 0x050C, ZAP_ATTRIBUTE_INDEX(134), 4, 258, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: Application Launcher (server) */ \
  { 0x0006, ZAP_ATTRIBUTE_INDEX(138), 2, 3, ZAP_CLUSTER_MASK(SERVER) | ZAP_CLUSTER_MASK(INIT_FUNCTION), chipFuncArrayOnOffServer }, /* Endpoint: 2, Cluster: On/off (server) */ \
  { 0x0008, ZAP_ATTRIBUTE_INDEX(140), 2, 3, ZAP_CLUSTER_MASK(SERVER) | ZAP_CLUSTER_MASK(INIT_FUNCTION), chipFuncArrayLevelControlServer }, /* Endpoint: 2, Cluster: Level Control (server) */ \
  { 0x050B, ZAP_ATTRIBUTE_INDEX(142), 3, 257, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 2, Cluster: Audio Output (server) */ \
  { 0x0506, ZAP_ATTRIBUTE_INDEX(145), 9, 59, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 3, Cluster: Media Playback (server) */ \
  { 0x050A, ZAP_ATTRIBUTE_INDEX(154), 3, 510, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 3, Cluster: Content Launcher (server) */ \
  { 0x050D, ZAP_ATTRIBUTE_INDEX(157), 8, 105, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 3, Cluster: Application Basic (server) */ \
  { 0x050E, ZAP_ATTRIBUTE_INDEX(165), 1, 2, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 3, Cluster: Account Login (server) */ \
  { 0x050A, ZAP_ATTRIBUTE_INDEX(166), 3, 510, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 4, Cluster: Content Launcher (server) */ \
  { 0x050D, ZAP_ATTRIBUTE_INDEX(169), 8, 105, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 4, Cluster: Application Basic (server) */ \
  { 0x050D, ZAP_ATTRIBUTE_INDEX(177), 8, 105, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 5, Cluster: Application Basic (server) */ \
}
