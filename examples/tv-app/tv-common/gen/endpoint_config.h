...
#define GENERATED_CLUSTERS { \
  ...
  { 0x0029, ZAP_ATTRIBUTE_INDEX(23), 1, 2, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 0, Cluster: OTA Software Update Provider (server) */ \
  { 0x0030, ZAP_ATTRIBUTE_INDEX(24), 3, 264, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 0, Cluster: General Commissioning (server) */ \
  ...
  { 0x003C, ZAP_ATTRIBUTE_INDEX(106), 1, 2, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 0, Cluster: AdministratorCommissioning (server) */ \
  { 0x003E, ZAP_ATTRIBUTE_INDEX(107), 4, 258, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 0, Cluster: Operational Credentials (server) */ \
  { 0x0405, ZAP_ATTRIBUTE_INDEX(111), 4, 8, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 0, Cluster: Relative Humidity Measurement (server) */ \
  { 0xF000, ZAP_ATTRIBUTE_INDEX(115), 1, 2, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 0, Cluster: Binding (server) */ \
  { 0xF004, ZAP_ATTRIBUTE_INDEX(116), 3, 510, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 0, Cluster: Group Key Management (server) */ \
  { 0x0006, ZAP_ATTRIBUTE_INDEX(119), 2, 3, ZAP_CLUSTER_MASK(SERVER) | ZAP_CLUSTER_MASK(INIT_FUNCTION), chipFuncArrayOnOffServer }, /* Endpoint: 1, Cluster: On/Off (server) */ \
  { 0x0503, ZAP_ATTRIBUTE_INDEX(121), 2, 34, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: Wake on LAN (server) */ \
  { 0x0504, ZAP_ATTRIBUTE_INDEX(123), 4, 320, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: TV Channel (server) */ \
  { 0x0505, ZAP_ATTRIBUTE_INDEX(127), 2, 256, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: Target Navigator (server) */ \
  { 0x0507, ZAP_ATTRIBUTE_INDEX(129), 3, 257, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: Media Input (server) */ \
  { 0x0508, ZAP_ATTRIBUTE_INDEX(132), 1, 2, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: Low Power (server) */ \
  { 0x0509, ZAP_ATTRIBUTE_INDEX(133), 1, 2, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: Keypad Input (server) */ \
  { 0x050A, ZAP_ATTRIBUTE_INDEX(134), 3, 510, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: Content Launcher (server) */ \
  { 0x050C, ZAP_ATTRIBUTE_INDEX(137), 4, 258, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: Application Launcher (server) */ \
  { 0x0006, ZAP_ATTRIBUTE_INDEX(141), 2, 3, ZAP_CLUSTER_MASK(SERVER) | ZAP_CLUSTER_MASK(INIT_FUNCTION), chipFuncArrayOnOffServer }, /* Endpoint: 2, Cluster: On/Off (server) */ \
  { 0x0008, ZAP_ATTRIBUTE_INDEX(143), 2, 3, ZAP_CLUSTER_MASK(SERVER) | ZAP_CLUSTER_MASK(INIT_FUNCTION), chipFuncArrayLevelControlServer }, /* Endpoint: 2, Cluster: Level Control (server) */ \
  { 0x050B, ZAP_ATTRIBUTE_INDEX(145), 3, 257, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 2, Cluster: Audio Output (server) */ \
  { 0x0506, ZAP_ATTRIBUTE_INDEX(148), 9, 59, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 3, Cluster: Media Playback (server) */ \
  { 0x050A, ZAP_ATTRIBUTE_INDEX(157), 3, 510, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 3, Cluster: Content Launcher (server) */ \
  { 0x050D, ZAP_ATTRIBUTE_INDEX(160), 8, 105, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 3, Cluster: Application Basic (server) */ \
  { 0x050E, ZAP_ATTRIBUTE_INDEX(168), 1, 2, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 3, Cluster: Account Login (server) */ \
  { 0x050A, ZAP_ATTRIBUTE_INDEX(169), 3, 510, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 4, Cluster: Content Launcher (server) */ \
  { 0x050D, ZAP_ATTRIBUTE_INDEX(172), 8, 105, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 4, Cluster: Application Basic (server) */ \
  { 0x050D, ZAP_ATTRIBUTE_INDEX(180), 8, 105, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 5, Cluster: Application Basic (server) */ \
}
...
#define GENERATED_ENDPOINT_TYPES { \
  { ZAP_CLUSTER_INDEX(0), 16, 3777 }, \
  { ZAP_CLUSTER_INDEX(16), 9, 1642 }, \
  { ZAP_CLUSTER_INDEX(25), 3, 263 }, \
  { ZAP_CLUSTER_INDEX(28), 4, 676 }, \
  { ZAP_CLUSTER_INDEX(32), 2, 615 }, \
  { ZAP_CLUSTER_INDEX(34), 1, 105 }, \
}
