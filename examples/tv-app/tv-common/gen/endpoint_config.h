...
#define GENERATED_CLUSTERS                                                                                                         \
    {                                                                                                                              \
        {                                                                                                                          \
            ...
            {                                                                                                                      \
                0x0028, ZAP_ATTRIBUTE_INDEX(50), 12, 254, ZAP_CLUSTER_MASK(SERVER), NULL                                           \
...
#define EMBER_AF_GENERATED_REPORTING_CONFIG_DEFAULTS                                                                               \
    {                                                                                                                              \
        {                                                                                                                          \
            ...
            {                                                                                                                      \
                ZAP_REPORT_DIRECTION(REPORTED), 0x0006, 0x0006, 0x0000, ZAP_CLUSTER_MASK(SERVER), 0x0000, { { 0, 65344, 0 } }      \
            }, /* Reporting for cluster: "On/off", attribute: "on/off". side: server */                                            \
            {                                                                                                                      \
                ZAP_REPORT_DIRECTION(REPORTED), 0x0006, 0x0008, 0x0000, ZAP_CLUSTER_MASK(SERVER), 0x0000, { { 0, 65344, 0 } }      \
            }, /* Reporting for cluster: "Level Control", attribute: "current level". side: server */                              \
            {                                                                                                                      \
            ...
            {                                                                                                                      \
                ZAP_REPORT_DIRECTION(REPORTED), 0x0006, 0x0300, 0x0000, ZAP_CLUSTER_MASK(SERVER), 0x0000, { { 0, 65344, 0 } }      \
            }, /* Reporting for cluster: "Color Control", attribute: "current hue". side: server */                                \
            {                                                                                                                      \
                ZAP_REPORT_DIRECTION(REPORTED), 0x0006, 0x0300, 0x0001, ZAP_CLUSTER_MASK(SERVER), 0x0000, { { 0, 65344, 0 } }      \
            }, /* Reporting for cluster: "Color Control", attribute: "current saturation". side: server */                         \
            {                                                                                                                      \
                ZAP_REPORT_DIRECTION(REPORTED), 0x0006, 0x0300, 0x0003, ZAP_CLUSTER_MASK(SERVER), 0x0000, { { 0, 65344, 0 } }      \
            }, /* Reporting for cluster: "Color Control", attribute: "current x". side: server */                                  \
            {                                                                                                                      \
                ZAP_REPORT_DIRECTION(REPORTED), 0x0006, 0x0300, 0x0004, ZAP_CLUSTER_MASK(SERVER), 0x0000, { { 0, 65344, 0 } }      \
            }, /* Reporting for cluster: "Color Control", attribute: "current y". side: server */                                  \
            {                                                                                                                      \
                ZAP_REPORT_DIRECTION(REPORTED), 0x0006, 0x0300, 0x0007, ZAP_CLUSTER_MASK(SERVER), 0x0000, { { 0, 65344, 0 } }      \
