...
#define GENERATED_DEFAULTS                                                                                                         \
    {                                                                                                                              \
        ...
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,    \
            ...
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,                                          \
                                                                                                                                   \
            /* 730 - Default for cluster: "Application Launcher", attribute: "application launcher list". side: server,            \
               little-endian */                                                                                                    \
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,      \
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,                                          \
                                                                                                                                   \
    ...
    {                                                                                                                              \
        { 0xFFFD, ZAP_TYPE(INT16U), 2, 0, ZAP_SIMPLE_DEFAULT(2) }, /* Identify (server): cluster revision */                       \
            ...
            { 0x0006, ZAP_TYPE(CHAR_STRING), 254, 0,                                                                               \
              ZAP_LONG_DEFAULTS_INDEX(244) },                               /* Color Control (server): compensation text */        \
            ...
            { 0x0000, ZAP_TYPE(CHAR_STRING), 32, 0,                                                                                \
              ZAP_LONG_DEFAULTS_INDEX(506) },                               /* Wake on LAN (server): wake on lan mac address */    \
            ...
            { 0x0000, ZAP_TYPE(OCTET_STRING), 32, 0,                                                                               \
              ZAP_LONG_DEFAULTS_INDEX(634) },                               /* Target Navigator (server): target navigator list */ \
            ...
            { 0x0000, ZAP_TYPE(OCTET_STRING), 32, 0,                                                                               \
              ZAP_LONG_DEFAULTS_INDEX(698) },                               /* Audio Output (server): audio output list */         \
            { 0xFFFD, ZAP_TYPE(INT16U), 2, 0, ZAP_SIMPLE_DEFAULT(0x0001) }, /* Audio Output (server): cluster revision */          \
            { 0x0000, ZAP_TYPE(OCTET_STRING), 32, 0,                                                                               \
              ZAP_LONG_DEFAULTS_INDEX(730) }, /* Application Launcher (server): application launcher list */                       \
            ...
            { 0x0002, ZAP_TYPE(OCTET_STRING), 32, 0,                                                                               \
              ZAP_LONG_DEFAULTS_INDEX(794) },                               /* Application Basic (server): application name */     \
            ...
            { 0x0005, ZAP_TYPE(OCTET_STRING), 32, 0,                                                                               \
              ZAP_LONG_DEFAULTS_INDEX(826) },                               /* Application Basic (server): application id */       \
    ...
    {                                                                                                                              \
        { 0x0003,                                                                                                                  \
          ...
          chipFuncArrayIdentifyServer }, /* Endpoint: 1, Cluster: Identify (server) */                                             \
            ...
            {                                                                                                                      \
                0x0503, ZAP_ATTRIBUTE_INDEX(100), 2, 34, ZAP_CLUSTER_MASK(SERVER), NULL                                            \
            }, /* Endpoint: 1, Cluster: Wake on LAN (server) */                                                                    \
            {                                                                                                                      \
                0x0504, ZAP_ATTRIBUTE_INDEX(102), 4, 98, ZAP_CLUSTER_MASK(SERVER), NULL                                            \
            }, /* Endpoint: 1, Cluster: TV Channel (server) */                                                                     \
            {                                                                                                                      \
                0x0505, ZAP_ATTRIBUTE_INDEX(106), 2, 34, ZAP_CLUSTER_MASK(SERVER), NULL                                            \
            }, /* Endpoint: 1, Cluster: Target Navigator (server) */                                                               \
            {                                                                                                                      \
                0x0507, ZAP_ATTRIBUTE_INDEX(108), 2, 34, ZAP_CLUSTER_MASK(SERVER), NULL                                            \
            }, /* Endpoint: 1, Cluster: Media Input (server) */                                                                    \
            {                                                                                                                      \
                0x0508, ZAP_ATTRIBUTE_INDEX(110), 1, 2, ZAP_CLUSTER_MASK(SERVER), NULL                                             \
            }, /* Endpoint: 1, Cluster: Low Power (server) */                                                                      \
            {                                                                                                                      \
                0x0509, ZAP_ATTRIBUTE_INDEX(111), 1, 2, ZAP_CLUSTER_MASK(SERVER), NULL                                             \
            }, /* Endpoint: 1, Cluster: Keypad Input (server) */                                                                   \
            {                                                                                                                      \
                0x050B, ZAP_ATTRIBUTE_INDEX(112), 2, 34, ZAP_CLUSTER_MASK(SERVER), NULL                                            \
            }, /* Endpoint: 1, Cluster: Audio Output (server) */                                                                   \
            {                                                                                                                      \
                0x050C, ZAP_ATTRIBUTE_INDEX(114), 2, 34, ZAP_CLUSTER_MASK(SERVER), NULL                                            \
            ...
            {                                                                                                                      \
                0xF001, ZAP_ATTRIBUTE_INDEX(124), 2, 4, ZAP_CLUSTER_MASK(SERVER), NULL                                             \
            }, /* Endpoint: 1, Cluster: Media Playback (server) */                                                                 \
            {                                                                                                                      \
                0xF002, ZAP_ATTRIBUTE_INDEX(126), 1, 2, ZAP_CLUSTER_MASK(SERVER), NULL                                             \
