...
#define EMBER_AF_APPLICATION_BASIC_CLUSTER_SERVER_ENDPOINT_COUNT (4)
...
#define EMBER_AF_GENERAL_COMMISSIONING_CLUSTER_SERVER_ENDPOINT_COUNT (2)
...
#define EMBER_AF_LOW_POWER_CLUSTER_SERVER_ENDPOINT_COUNT (2)
