                         ...
                         int32_t index)
{
    ...
    case 0x0507: // Media Input Cluster
    {
        ...
        case 0x0000: // media input list
        {
            ...
            entryOffset                      = static_cast<uint16_t>(entryOffset + 34);
            chip::ByteSpan * descriptionSpan = &entry->description; // CHAR_STRING
            if (CHIP_NO_ERROR !=
    ...
    case 0x0504: // TV Channel Cluster
    {
        ...
        case 0x0000: // tv channel list
        {
            ...
            entryOffset                   = static_cast<uint16_t>(entryOffset + 34);
            chip::ByteSpan * callSignSpan = &entry->callSign; // CHAR_STRING
            if (CHIP_NO_ERROR !=
            ...
            entryOffset                            = static_cast<uint16_t>(entryOffset + 34);
            chip::ByteSpan * affiliateCallSignSpan = &entry->affiliateCallSign; // CHAR_STRING
            if (CHIP_NO_ERROR !=
