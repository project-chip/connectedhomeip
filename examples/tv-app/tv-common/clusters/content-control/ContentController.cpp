...
// Command Delegates
void ContentControlManager::HandleUpdatePIN(chip::CharSpan oldPIN, chip::CharSpan newPIN) {}
...
void ContentControlManager::HandleAddBonusTime(chip::Optional<chip::CharSpan> PINCode, uint32_t bonusTime) {}
