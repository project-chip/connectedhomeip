...
public:
    ...
    chip::app::Clusters::ApplicationLauncher::Commands::LauncherResponse::Type LaunchApp(Application application, std::string data) override;
...
public:
    ...
    chip::app::Clusters::ContentLauncher::Commands::LaunchResponse::Type LaunchContent(std::list<Parameter> parameterList, bool autoplay, std::string data) override;
