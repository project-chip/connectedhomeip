...
private:
    ...
    uint16_t mRelativeHumidityValue     = 0xffff;
    uint16_t mRelativeHumidityMin       = 0xffff;
    uint16_t mRelativeHumidityMax       = 0xffff;
    uint16_t mRelativeHumidityTolerance = 0xffff;
