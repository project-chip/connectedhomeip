...
commissioning and cluster control. It adds the non-chip device as an endpoints
...
-   After successful commissioning, use the OnOff cluster commands to control
    ...
    ```
    V (184945) chip[ZCL]: Received Cluster Command: Endpoint=2 Cluster=0x0000_0006 Command=0x0000_0001
    I (184955) chip[ZCL]: On/Off set value: 2 1
    I (184955) chip[DL]: HandleReadOnOffAttribute: attrId=0, maxReadLength=1
    I (184965) chip[ZCL]: Toggle on/off from 0 to 1
    I (184965) chip[DL]: HandleWriteOnOffAttribute: attrId=0
    I (184975) chip[DL]: Device[Light 1]: ON
    ```

    `chip-device-ctrl > zcl OnOff On 135246 6 0`

    ```
    V (211775) chip[ZCL]: Received Cluster Command: Endpoint=6 Cluster=0x0000_0006 Command=0x0000_0001
    I (211775) chip[ZCL]: On/Off set value: 6 1
    I (211785) chip[DL]: HandleReadOnOffAttribute: attrId=0, maxReadLength=1
    I (211795) chip[ZCL]: Toggle on/off from 0 to 1
    I (211795) chip[DL]: HandleWriteOnOffAttribute: attrId=0
    I (211805) chip[DL]: Device[Light 2]: ON
