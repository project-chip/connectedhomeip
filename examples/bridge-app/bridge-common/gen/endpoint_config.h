...
#define GENERATED_CLUSTERS { \
  ...
  { 0x0006, ZAP_ATTRIBUTE_INDEX(4), 3, 4, ZAP_CLUSTER_MASK(SERVER) | ZAP_CLUSTER_MASK(INIT_FUNCTION), chipFuncArrayOnOffServer }, /* Endpoint: 2, Cluster: On/off (server) */ \
  { 0x0008, ZAP_ATTRIBUTE_INDEX(7), 5, 7, ZAP_CLUSTER_MASK(SERVER) | ZAP_CLUSTER_MASK(INIT_FUNCTION), chipFuncArrayLevelControlServer }, /* Endpoint: 2, Cluster: Level Control (server) */ \
  { 0x0006, ZAP_ATTRIBUTE_INDEX(12), 3, 4, ZAP_CLUSTER_MASK(SERVER) | ZAP_CLUSTER_MASK(INIT_FUNCTION), chipFuncArrayOnOffServer }, /* Endpoint: 3, Cluster: On/off (server) */ \
  { 0x0008, ZAP_ATTRIBUTE_INDEX(15), 5, 7, ZAP_CLUSTER_MASK(SERVER) | ZAP_CLUSTER_MASK(INIT_FUNCTION), chipFuncArrayLevelControlServer }, /* Endpoint: 3, Cluster: Level Control (server) */ \
}
...
#define GENERATED_ENDPOINT_TYPES { \
  ...
  { ZAP_CLUSTER_INDEX(2), 2, 11 }, \
  { ZAP_CLUSTER_INDEX(4), 2, 11 }, \
}
