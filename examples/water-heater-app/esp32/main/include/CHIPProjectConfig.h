...
/**
 *  @def CHIP_CONFIG_EVENT_LOGGING_NUM_EXTERNAL_CALLBACKS
 *
 *  @brief
 *    This is the number of external callbacks that can be registered for event notification.
 *
 */
#define CHIP_CONFIG_EVENT_LOGGING_NUM_EXTERNAL_CALLBACKS 3
