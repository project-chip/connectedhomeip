...
void OccupancySensorApp::DeviceCallbacks::PostAttributeChangeCallback(EndpointId endpointId, ClusterId clusterId,
...
OccupancySensorApp::DeviceCallbacks & OccupancySensorApp::DeviceCallbacks::GetDefaultInstance()
{
...
{
    return OccupancySensorApp::DeviceCallbacks::GetDefaultInstance();
}
