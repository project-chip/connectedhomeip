...
//-- Electrostatic filter Monitoring instance functions
CHIP_ERROR ElectrostaticFilterMonitoringInstance::AppInit()
{
    ChipLogDetail(Zcl, "ElectrostaticFilterMonitoringInstance::Init()");
    return CHIP_NO_ERROR;
}

Status ElectrostaticFilterMonitoringInstance::OnResetCondition()
{
    ChipLogDetail(Zcl, "ElectrostaticFilterMonitoringInstance::OnResetCondition()");
    ...
    if (emberAfContainsAttribute(0x1, Clusters::ElectrostaticFilterMonitoring::Id, Attributes::LastChangedTime::Id))
    {
