...
//-- Water Tank Monitoring instance functions
CHIP_ERROR WaterTankMonitoringInstance::AppInit()
{
    ChipLogDetail(Zcl, "WaterTankMonitoringInstance::Init()");
    return CHIP_NO_ERROR;
}

Status WaterTankMonitoringInstance::OnResetCondition()
{
    ChipLogDetail(Zcl, "WaterTankMonitoringInstance::OnResetCondition()");
    ...
    if (emberAfContainsAttribute(0x1, Clusters::WaterTankMonitoring::Id, Attributes::LastChangedTime::Id))
    {
