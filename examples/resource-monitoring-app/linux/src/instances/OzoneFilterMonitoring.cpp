...
//-- Ozone filter Monitoring instance functions
CHIP_ERROR OzoneFilterMonitoringInstance::AppInit()
{
    ChipLogDetail(Zcl, "OzoneFilterMonitoringInstance::Init()");
    return CHIP_NO_ERROR;
}

Status OzoneFilterMonitoringInstance::OnResetCondition()
{
    ChipLogDetail(Zcl, "OzoneFilterMonitoringInstance::OnResetCondition()");
    ...
    if (emberAfContainsAttribute(0x1, Clusters::OzoneFilterMonitoring::Id, Attributes::LastChangedTime::Id))
    {
