...
//-- Ceramic filter Monitoring instance functions
CHIP_ERROR CeramicFilterMonitoringInstance::AppInit()
{
    ChipLogDetail(Zcl, "CeramicFilterMonitoringInstance::Init()");
    return CHIP_NO_ERROR;
}

Status CeramicFilterMonitoringInstance::OnResetCondition()
{
    ChipLogDetail(Zcl, "CeramicFilterMonitoringInstance::OnResetCondition()");
    ...
    if (emberAfContainsAttribute(0x1, Clusters::CeramicFilterMonitoring::Id, Attributes::LastChangedTime::Id))
    {
