...
HepaFilterMonitoringInstance HepafilterInstance(0x1, HepaFilterMonitoring::Id,
                                                static_cast<uint32_t>(gHepaFilterFeatureMap.to_ulong()),
                                                DegradationDirectionEnum::kDown, true);
ActivatedCarbonFilterMonitoringInstance ActivatedCarbonFilterInstance(0x1, ActivatedCarbonFilterMonitoring::Id,
