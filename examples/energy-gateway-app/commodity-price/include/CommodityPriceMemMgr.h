 ...
 */
  ...
  *
  *    PriceForecastMemMgr::AllocAndCopy(const DataModel::DecodableList<Structs::ChargingTargetStruct::DecodableType> & chargingTargets)
  *
  ...
  * follows:
  *
  * chargingTargetsList = DataModel::List<Structs::ChargingTargetStruct::Type>(PriceForecastMemMgr::GetChargingTargets(), PriceForecastMemMgr::GetNumDailyChargingTargets());
  *
