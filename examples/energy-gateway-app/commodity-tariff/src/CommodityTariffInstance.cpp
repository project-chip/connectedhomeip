...
namespace JSON_Utilities {
    ...
    template <>
    CHIP_ERROR JsonParser<TariffInformationStruct::Type, TariffInfoDataClass, false>::ParseFromJson(
        const Json::Value& json, TariffInformationStruct::Type& output)
    {
    ...
    template <>
    CHIP_ERROR JsonParser<TariffPeriodStructType, TariffPeriodsDataClass>::ParseFromJson(
    ...
    // DayEntriesDataClass
    template <>
    CHIP_ERROR JsonParser<DayEntryStructType, DayEntriesDataClass>::ParseFromJson(
        const Json::Value& json, DayEntryStructType& output)
    {
    ...
    template <>
    CHIP_ERROR JsonParser<TariffComponentStructType, TariffComponentsDataClass>::ParseFromJson(
        const Json::Value& json, TariffComponentStructType& output)
    {
    ...
    CHIP_ERROR TariffComponents_LoadFromJson(const Json::Value& json, TariffComponentsDataClass & MgmtObj) {
        return JsonParser<TariffComponentStructType, TariffComponentsDataClass>::LoadFromJson(json, MgmtObj, kTariffComponentsAttrMaxLength);
    }

    //DayPatternsDataClass
    template <>
    CHIP_ERROR JsonParser<DayPatternStructType, DayPatternsDataClass>::ParseFromJson(
        const Json::Value& json, DayPatternStructType& output)
    {
        CHIP_ERROR err = CHIP_NO_ERROR;
        ...
        err = checkRequired("DaysOfWeek", output.daysOfWeek, [](auto v) {
            return chip::BitMask<DayPatternDayOfWeekBitmap>(
                static_cast<std::underlying_type_t<DayPatternDayOfWeekBitmap>>(v)
            );
        });
        SuccessOrExit(err);
...
CHIP_ERROR CommodityTariffDelegate::LoadTariffData(const Json::Value& root)
{
    const std::map<std::string, std::function<CHIP_ERROR(const Json::Value&)>> required_tariff_items = {
        {"TariffUnit",          [this](const Json::Value& v){ return JSON_Utilities::TariffUnit_LoadFromJson(v, this->GetTariffUnit_MgmtObj()); }},
        {"StartDate",           [this](const Json::Value& v){ return JSON_Utilities::StartDate_LoadFromJson(v, this->GetStartDate_MgmtObj()); }},
        {"TariffInfo",          [this](const Json::Value& v){ return JSON_Utilities::TariffInfo_LoadFromJson(v, this->GetTariffInfo_MgmtObj()); }},
        {"DayEntries",          [this](const Json::Value& v){ return JSON_Utilities::DayEntries_LoadFromJson(v, this->GetDayEntries_MgmtObj()); }},
        {"TariffComponents",    [this](const Json::Value& v){ return JSON_Utilities::TariffComponents_LoadFromJson(v, this->GetTariffComponents_MgmtObj()); }},
        {"TariffPeriods",       [this](const Json::Value& v){ return JSON_Utilities::TariffPeriods_LoadFromJson(v, this->GetTariffPeriods_MgmtObj()); }}
    };

    const std::map<std::string, std::function<CHIP_ERROR(const Json::Value&)>> generic_tariff_items = {
        {"DefaultRandomizationOffset", [this](const Json::Value& v){ return JSON_Utilities::DefaultRandomizationOffset_LoadFromJson(v, this->GetDefaultRandomizationOffset_MgmtObj()); }},
        {"DefaultRandomizationType",   [this](const Json::Value& v){ return JSON_Utilities::DefaultRandomizationType_LoadFromJson(v, this->GetDefaultRandomizationType_MgmtObj()); }},
        {"DayPatterns",                [this](const Json::Value& v){ return JSON_Utilities::DayPatterns_LoadFromJson(v, this->GetDayPatterns_MgmtObj()); }},
        {"IndividualDays",             [this](const Json::Value& v){ return JSON_Utilities::IndividualDays_LoadFromJson(v, this->GetIndividualDays_MgmtObj()); }},
        {"CalendarPeriods",            [this](const Json::Value& v){ return JSON_Utilities::CalendarPeriods_LoadFromJson(v, this->GetCalendarPeriods_MgmtObj()); }},
    };
