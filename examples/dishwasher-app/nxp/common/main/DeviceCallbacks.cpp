...
void DishwasherApp::DeviceCallbacks::PostAttributeChangeCallback(EndpointId endpointId, ClusterId clusterId,
...
DishwasherApp::DeviceCallbacks & DishwasherApp::DeviceCallbacks::GetDefaultInstance()
{
...
{
    return DishwasherApp::DeviceCallbacks::GetDefaultInstance();
}
