      ...
      "clusters": [
        ...
        },
        {
          ...
          "attributes": [
            ...
            "    0x0004 |         | server |           Ext |           |         |                    3 |          1 |                   1 |               65534 |                     => AccessControlEntriesPerFabric [int16u]",
            "    0xfff8 |         | server |           Ext |           |         |                    0 |          1 |                   1 |               65534 |                     => GeneratedCommandList [array]",
            "    0xfff9 |         | server |           Ext |           |         |                    0 |          1 |                   1 |               65534 |                     => AcceptedCommandList [array]",
        ...
        },
        {
          ...
          "attributes": [
            ...
            "    0xfff8 |         | server |           Ext | singleton |         |                    0 |          1 |                   1 |               65534 |                     => GeneratedCommandList [array]",
            "    0xfff9 |         | server |           Ext | singleton |         |                    0 |          1 |                   1 |               65534 |                     => AcceptedCommandList [array]",
            "    0xfffb |         | server |           Ext | singleton |         |                    0 |          1 |                   1 |               65534 |                     => AttributeList [array]",
            "    0xfffc |         | server |           RAM |           |         |                    0 |          1 |                   1 |               65534 |                     => FeatureMap [bitmap32]",
        ...
        },
        {
          ...
          "attributes": [
            ...
            "    0x0001 |         | server |           Ext |           |         |                    7 |          1 |                   1 |               65534 |                     => SupportedLocales [array]",
            "    0xfff8 |         | server |           Ext |           |         |                    0 |          1 |                   1 |               65534 |                     => GeneratedCommandList [array]",
            "    0xfff9 |         | server |           Ext |           |         |                    0 |          1 |                   1 |               65534 |                     => AcceptedCommandList [array]",
            "    0xfffb |         | server |           Ext |           |         |                    0 |          1 |                   1 |               65534 |                     => AttributeList [array]",
            "    0xfffc |         | server |           RAM |           |         |                    0 |          1 |                   1 |               65534 |                     => FeatureMap [bitmap32]",
    ...
    },
    {
      ...
      "clusters": [
        ...
        },
        {
          ...
          "commands": [
            " code  | mfgCode | source | incoming | outgoing",
            "0x0004 |         | server |        1 |       1 => OperationalCommandResponse"
          ],
          "attributes": [
            "   code    | mfgCode |  side  | storageOption | singleton | bounded |     defaultValue     | reportable |     minInterval     |     maxInterval     |   reportableChange",
            ...
            "    0x0004 |         | server |           Ext |           |         |                    0 |          1 |                   1 |               65534 |                     => OperationalState [OperationalStateEnum]",
