...
// FreeRTOS Silabs apps need silabs_utils.h (SILABS_LOG, etc.). Zephyr lighting never
// includes AppConfig.h; dishwasher Zephyr still compiles managers that do, and
// silabs_utils.h is FreeRTOS-only — so skip it under Zephyr.
#ifndef __ZEPHYR__
...
#ifndef __ZEPHYR__
// APP Logo, boolean only. must be 64x64 (FreeRTOS LCD UI)
