# CHIP NXP Cooktop Application

## Overview

The NXP Cooktop example is based on
[Project CHIP](https://github.com/project-chip/connectedhomeip) and NXP SDK, and
provides a prototype of a cooktop device that demonstrates device commissioning and
different cluster control.

### Supported platforms

The Cooktop example is supported on the following platforms :
