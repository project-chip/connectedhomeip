...
#include <commands/webrtc/AnswerCommand.h>
#include <commands/webrtc/ProviderCommand.h>
...
void registerCommandsWebRTC(Commands & commands, CredentialIssuerCommands * credsIssuerConfig)
{
    ...
    commands_list clusterCommands = {
        make_unique<webrtc::ProviderCommand>(credsIssuerConfig),
        make_unique<webrtc::AnswerCommand>(credsIssuerConfig),
    };
