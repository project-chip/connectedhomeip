...
```
docker pull ghcr.io/project-chip/chip-build-crosscompile:166
```
...
```
docker run -it -v ~/connectedhomeip:/var/connectedhomeip ghcr.io/project-chip/chip-build-crosscompile:166 /bin/bash
```
