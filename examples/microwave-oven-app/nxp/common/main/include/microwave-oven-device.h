...
public:
    ...
    void HandleErrorStateCallback(OperationalState::Structs::ErrorStateStruct::Type errState, OperationalState::GenericOperationalError & err);

    uint8_t GetCurrentOpState();
...
void onCliErrorStateChanged(chip::app::Clusters::OperationalState::Structs::ErrorStateStruct::Type errState);
