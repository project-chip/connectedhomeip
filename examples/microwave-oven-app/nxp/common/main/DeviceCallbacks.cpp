...
void MicrowaveOvenApp::DeviceCallbacks::PostAttributeChangeCallback(EndpointId endpointId, ClusterId clusterId,
...
MicrowaveOvenApp::DeviceCallbacks & MicrowaveOvenApp::DeviceCallbacks::GetDefaultInstance()
{
...
{
    return MicrowaveOvenApp::DeviceCallbacks::GetDefaultInstance();
}
