    ...
    },
    {
      ...
      "clusters": [
        ...
        },
        {
          ...
          "attributes": [
            "   code    | mfgCode |  side  | storageOption | singleton | bounded |     defaultValue     | reportable |     minInterval     |     maxInterval     |   reportableChange",
            "    0x0000 |         | server |           RAM |           |         |                      |          1 |                   1 |               65534 |                     => LockState [DlLockState]",
            "    0x0001 |         | server |           RAM |           |         |                      |          1 |                   1 |               65534 |                     => LockType [DlLockType]",
            "    0x0002 |         | server |           RAM |           |         |                      |          1 |                   1 |               65534 |                     => ActuatorEnabled [boolean]",
            "    0x0011 |         | server |           RAM |           |         |                    0 |          1 |                   1 |               65534 |                     => NumberOfTotalUsersSupported [int16u]",
            "    0x001b |         | server |           RAM |           |         |                    1 |          1 |                   1 |               65534 |                     => CredentialRulesSupport [DlCredentialRuleMask]",
            "    0x0023 |         | server |           RAM |           |         |                      |          1 |                   1 |               65534 |                     => AutoRelockTime [int32u]",
            "    0x0025 |         | server |           RAM |           |         |                      |          1 |                   1 |               65534 |                     => OperatingMode [OperatingModeEnum]",
            "    0x0026 |         | server |           RAM |           |         |               0xFFF6 |          1 |                   1 |               65534 |                     => SupportedOperatingModes [DlSupportedOperatingModes]",
            "    0x0035 |         | server |           RAM |           |         |                 1440 |          1 |                   1 |               65534 |                     => ExpiringUserTimeout [int16u]",
            "    0xfff8 |         | server |           Ext |           |         |                      |          1 |                   1 |               65534 |                     => GeneratedCommandList [array]",
            "    0xfff9 |         | server |           Ext |           |         |                      |          1 |                   1 |               65534 |                     => AcceptedCommandList [array]",
            "    0xfffb |         | server |           Ext |           |         |                      |          1 |                   1 |               65534 |                     => AttributeList [array]",
            "    0xfffc |         | server |           RAM |           |         |               0x1000 |          1 |                   1 |               65534 |                     => FeatureMap [bitmap32]",
