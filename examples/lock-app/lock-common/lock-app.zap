  ...
  "endpointTypes": [
    {
      ...
      "clusters": [
        ...
        },
        {
          ...
          "attributes": [
            "   code    | mfgCode |  side  | storageOption | singleton | bounded |     defaultValue     | reportable |     minInterval     |     maxInterval     |   reportableChange",
            "    0x0000 |         | server |           RAM |           |         |                    1 |          1 |                   1 |               65534 |                     => Status [PowerSourceStatusEnum]",
            "    0x0001 |         | server |           RAM |           |         |                    0 |          1 |                   1 |               65534 |                     => Order [int8u]",
            "    0x0002 |         | server |           RAM |           |         |                  USB |          1 |                   1 |               65534 |                     => Description [char_string]",
            "    0x0006 |         | server |           RAM |           |         |                      |          1 |                   1 |               65534 |                     => WiredAssessedCurrent [int32u]",
          ...
          "events": [
            " code  | mfgCode | side",
            "0x0000 |         | server => WiredFaultChange"
          ]
        },
        {
        ...
        },
        {
          ...
          "commands": [
            " code  | mfgCode | source | incoming | outgoing",
            "0x0001 |         | server |        1 |       0 => RegisterClientResponse"
          ],
          "attributes": [
            "   code    | mfgCode |  side  | storageOption | singleton | bounded |     defaultValue     | reportable |     minInterval     |     maxInterval     |   reportableChange",
            ...
            "    0xfffc |         | server |           RAM |           |         |               0x0000 |          1 |                   1 |               65534 |                     => FeatureMap [bitmap32]",
            "    0xfffd |         | server |           RAM |           |         |                    1 |          1 |                   1 |               65534 |                     => ClusterRevision [int16u]"
          ]
        }
      ]
      ...
      "clusters": [
        ...
        },
        {
          ...
          "attributes": [
            ...
            "    0x4000 |         | server |           RAM |           |         |                    1 |          1 |                   1 |               65534 |                     => GlobalSceneControl [boolean]",
            "    0x4001 |         | server |           RAM |           |         |                    0 |          1 |                   1 |               65534 |                     => OnTime [int16u]",
            "    0x4002 |         | server |           RAM |           |         |                    0 |          1 |                   1 |               65534 |                     => OffWaitTime [int16u]",
            "    0x4003 |         | server |           RAM |           |         |                      |          1 |                   1 |               65534 |                     => StartUpOnOff [OnOffStartUpOnOff]",
            "    0xfffc |         | server |           RAM |           |         |                    0 |          1 |                   1 |               65534 |                     => FeatureMap [bitmap32]",
        ...
        },
        {
          ...
          "attributes": [
            ...
            "    0x0002 |         | server |           RAM |           |         |              Battery |          1 |                   1 |               65534 |                     => Description [char_string]",
            "    0x000e |         | server |           RAM |           |         |                      |          1 |                   1 |               65534 |                     => BatChargeLevel [BatChargeLevelEnum]",
            ...
            "    0x0013 |         | server |           RAM |           |         |                      |          1 |                   1 |               65534 |                     => BatReplacementDescription [char_string]",
            "    0x001f |         | server |           Ext |           |         |                      |          1 |                   1 |               65534 |                     => EndpointList [array]",
            "    0xfff8 |         | server |           Ext |           |         |                      |          1 |                   1 |               65534 |                     => GeneratedCommandList [array]",
            "    0xfff9 |         | server |           Ext |           |         |                      |          1 |                   1 |               65534 |                     => AcceptedCommandList [array]",
            "    0xfffa |         | server |           Ext |           |         |                      |          1 |                   1 |               65534 |                     => EventList [array]",
            "    0xfffb |         | server |           Ext |           |         |                      |          1 |                   1 |               65534 |                     => AttributeList [array]",
            "    0xfffc |         | server |           RAM |           |         |                 0x0A |          1 |                   1 |               65534 |                     => FeatureMap [bitmap32]",
            "    0xfffd |         | server |           RAM |           |         |                    2 |          1 |                   1 |               65534 |                     => ClusterRevision [int16u]"
          ]
        },
        {
          ...
          "commands": [
            " code  | mfgCode | source | incoming | outgoing",
            "0x000c |         | server |        0 |       1 => GetWeekDayScheduleResponse",
            "0x000f |         | server |        0 |       1 => GetYearDayScheduleResponse",
            "0x0012 |         | server |        0 |       1 => GetHolidayScheduleResponse",
          ...
          "attributes": [
            ...
            "    0x0016 |         | server |           RAM |           |         |                   10 |          1 |                   1 |               65534 |                     => NumberOfHolidaySchedulesSupported [int8u]",
            ...
            "    0xfffa |         | server |           Ext |           |         |                      |          1 |                   1 |               65534 |                     => EventList [array]",
            "    0xfffb |         | server |           Ext |           |         |                      |          1 |                   1 |               65534 |                     => AttributeList [array]",
            "    0xfffc |         | server |           RAM |           |         |               0x1DB3 |          1 |                   1 |               65534 |                     => FeatureMap [bitmap32]",
            "    0xfffd |         | server |           RAM |           |         |                    7 |          1 |                     |               65344 |                     => ClusterRevision [int16u]"
          ],
          "events": [
            " code  | mfgCode | side",
