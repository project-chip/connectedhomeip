...
#define GENERATED_CLUSTERS { \
  ...
  { 0x0006, ZAP_ATTRIBUTE_INDEX(96), 2, 3, ZAP_CLUSTER_MASK(SERVER) | ZAP_CLUSTER_MASK(INIT_FUNCTION), chipFuncArrayOnOffServer }, /* Endpoint: 1, Cluster: On/off (server) */ \
}
