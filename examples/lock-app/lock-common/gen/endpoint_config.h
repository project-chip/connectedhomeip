...
#define GENERATED_CLUSTERS { \
  ...
  { 0x0006, ZAP_ATTRIBUTE_INDEX(99), 2, 3, ZAP_CLUSTER_MASK(SERVER) | ZAP_CLUSTER_MASK(INIT_FUNCTION), chipFuncArrayOnOffServer }, /* Endpoint: 1, Cluster: On/Off (server) */ \
}
...
#define GENERATED_ENDPOINT_TYPES { \
  { ZAP_CLUSTER_INDEX(0), 11, 1836 }, \
  { ZAP_CLUSTER_INDEX(11), 1, 3 }, \
}
