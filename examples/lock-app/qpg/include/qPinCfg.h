...
#define APP_LOCK_BUTTON PB2_BUTTON_GPIO_PIN
#define APP_LOCK_JAMMED_BUTTON PB3_BUTTON_GPIO_PIN

// Mapping of LEDs
#define SYSTEM_STATE_LED WHITE_COOL_LED_GPIO_PIN
#define LOCK_STATE_LED WHITE_WARM_LED_GPIO_PIN
...
#define QPINCFG_BUTTONS QPINCFG_GPIO_LIST(APP_FUNCTION_BUTTON, APP_LOCK_BUTTON, APP_LOCK_JAMMED_BUTTON)

// --- Mapping GPIOs to LEDs
#define QPINCFG_STATUS_LED QPINCFG_GPIO_LIST(SYSTEM_STATE_LED, LOCK_STATE_LED)

// --- Unused pins
#define QPINCFG_UNUSED                                                                                                             \
    QPINCFG_GPIO_LIST(PB1_BUTTON_GPIO_PIN, PB4_BUTTON_GPIO_PIN, ANIO0_GPIO_PIN, ANIO1_GPIO_PIN, EXT_32KXTAL_P, EXT_32KXTAL_N,      \
