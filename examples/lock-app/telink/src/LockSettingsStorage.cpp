...
const char * LockSettingsStorage::kConfigKey_LockUser[APP_MAX_USERS] =
                { LISTIFY(APP_MAX_USERS, CONFIG_KEY_USER, (,)) };
const char * LockSettingsStorage::kConfigKey_LockUserName[APP_MAX_USERS] =
                { LISTIFY(APP_MAX_USERS, CONFIG_KEY_USER_NAMES, (,)) };
const char * LockSettingsStorage::kConfigKey_UserCredentials[APP_MAX_CREDENTIAL] =
                { LISTIFY(APP_MAX_CREDENTIAL, CONFIG_KEY_USER_CREDENTIALS, (,)) };
const char * LockSettingsStorage::kConfigKey_WeekDaySchedules[APP_MAX_USERS][APP_MAX_WEEKDAY_SCHEDULE_PER_USER] =
                { LISTIFY(APP_MAX_SCHEDULES_TOTAL, CONFIG_KEY_WEEK_DAY_SCH, (,)) };
const char * LockSettingsStorage::kConfigKey_YearDaySchedules[APP_MAX_USERS][APP_MAX_YEARDAY_SCHEDULE_PER_USER] =
                { LISTIFY(APP_MAX_SCHEDULES_TOTAL, CONFIG_KEY_YEAR_DAY_SCH, (,)) };
const char * LockSettingsStorage::kConfigKey_HolidaySchedules[APP_MAX_HOLYDAY_SCHEDULE_PER_USER] =
...
const char * LockSettingsStorage::kConfigKey_CredentialDataPin[APP_MAX_CREDENTIAL] =
    { LISTIFY(APP_MAX_CREDENTIAL, CONFIG_KEY_USER_CREDENTIALS_DATA_PIN, (,)) };

const char * LockSettingsStorage::kConfigKey_CredentialDataFace[APP_MAX_CREDENTIAL] =
    { LISTIFY(APP_MAX_CREDENTIAL, CONFIG_KEY_USER_CREDENTIALS_DATA_FACE, (,)) };

const char * LockSettingsStorage::kConfigKey_CredentialDataFingerprint[APP_MAX_CREDENTIAL] =
    { LISTIFY(APP_MAX_CREDENTIAL, CONFIG_KEY_USER_CREDENTIALS_DATA_FINGERPTRINT, (,)) };

const char * LockSettingsStorage::kConfigKey_CredentialDataFingerVein[APP_MAX_CREDENTIAL] =
    { LISTIFY(APP_MAX_CREDENTIAL, CONFIG_KEY_USER_CREDENTIALS_DATA_FINGERVEIN, (,)) };

const char * LockSettingsStorage::kConfigKey_CredentialDataRfid[APP_MAX_CREDENTIAL] =
    { LISTIFY(APP_MAX_CREDENTIAL, CONFIG_KEY_USER_CREDENTIALS_DATA_RFID, (,)) };
