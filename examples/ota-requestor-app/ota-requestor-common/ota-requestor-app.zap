      ...
      "clusters": [
        {
          ...
          "attributes": [
            ...
            "    0x0000 |         | server |           Ext |           |         |                      |          1 |                     |               65534 |                     => DeviceTypeList [array]",
            "    0x0001 |         | server |           Ext |           |         |                      |          1 |                     |               65534 |                     => ServerList [array]",
            "    0x0002 |         | server |           Ext |           |         |                      |          1 |                     |               65534 |                     => ClientList [array]",
            "    0x0003 |         | server |           Ext |           |         |                      |          1 |                     |               65534 |                     => PartsList [array]",
            "    0xfffc |         | server |           RAM |           |         |                    0 |          1 |                   1 |               65534 |                     => FeatureMap [bitmap32]",
            "    0xfffd |         | server |           Ext |           |         |                    1 |          1 |                     |               65534 |                     => ClusterRevision [int16u]"
          ]
        },
        {
          "name": "Access Control",
        ...
        },
        {
          ...
          "attributes": [
            ...
            "    0x0001 |         | server |           RAM |           |         |                    1 |          1 |                   1 |               65534 |                     => UpdatePossible [boolean]",
      ...
      "clusters": [
        {
          ...
          "attributes": [
            "   code    | mfgCode |  side  | storageOption | singleton | bounded |     defaultValue     | reportable |     minInterval     |     maxInterval     |   reportableChange",
            "    0x0000 |         | server |           RAM |           |         |                  0x0 |          1 |                     |               65534 |                     => IdentifyTime [int16u]",
            "    0x0001 |         | server |           RAM |           |         |                  0x0 |          1 |                   1 |               65534 |                     => IdentifyType [IdentifyTypeEnum]",
            "    0xfffc |         | server |           RAM |           |         |                    0 |          1 |                   1 |               65534 |                     => FeatureMap [bitmap32]",
            "    0xfffd |         | server |           RAM |           |         |                    4 |          1 |                     |               65534 |                     => ClusterRevision [int16u]"
          ]
        },
        {
          "name": "Groups",
          ...
          "attributes": [
            "   code    | mfgCode |  side  | storageOption | singleton | bounded |     defaultValue     | reportable |     minInterval     |     maxInterval     |   reportableChange",
            "    0x0000 |         | server |           RAM |           |         |                      |          1 |                     |               65534 |                     => NameSupport [NameSupportBitmap]",
            "    0xfffc |         | server |           RAM |           |         |                    0 |          1 |                   1 |               65534 |                     => FeatureMap [bitmap32]",
            "    0xfffd |         | server |           RAM |           |         |                    4 |          1 |                     |               65534 |                     => ClusterRevision [int16u]"
          ]
        },
        {
          ...
          "attributes": [
            "   code    | mfgCode |  side  | storageOption | singleton | bounded |     defaultValue     | reportable |     minInterval     |     maxInterval     |   reportableChange",
            "    0x0000 |         | server |           NVM |           |         |                    0 |          1 |                     |               65534 |                     => OnOff [boolean]",
            "    0x4000 |         | server |           RAM |           |         |                    1 |          1 |                     |               65534 |                     => GlobalSceneControl [boolean]",
            "    0x4001 |         | server |           RAM |           |         |                    0 |          1 |                     |               65534 |                     => OnTime [int16u]",
            "    0x4002 |         | server |           RAM |           |         |                    0 |          1 |                     |               65534 |                     => OffWaitTime [int16u]",
            "    0x4003 |         | server |           NVM |           |         |                 0xFF |          1 |                     |               65534 |                     => StartUpOnOff [OnOffStartUpOnOff]",
