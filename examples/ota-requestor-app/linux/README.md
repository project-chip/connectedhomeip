...
| -x, --vendorId \<16-bit number\>                         | Value for the VendorID field in the QueryImage command. If none or zero is supplied, the default device config value is used.                                                                                                                                                                                                                                                                                                                                                                                     |
| -y, --productId \<16-bit number\>                        | Value for the ProductID field in the QueryImage command. If none or zero is supplied, the default device config value is used.                                                                                                                                                                                                                                                                                                                                                                                    |
| -z, --hwVersion \<16-bit number\>                        | Value for the HardwareVersion field in the QueryImage command. If none or zero is supplied, the default device config value is used.                                                                                                                                                                                                                                                                                                                                                                              |
