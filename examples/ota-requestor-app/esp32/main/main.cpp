...
static const char * TAG = "ota-requestor-app";

static DeviceCallbacks EchoCallbacks;
static ExampleRequestorDelegate requestorDelegate;
...
extern "C" void app_main()
{
    ...
    ESP_LOGI(TAG, "==================================================");
    ESP_LOGI(TAG, "chip-esp32-ota-requestor-example starting");
    ESP_LOGI(TAG, "==================================================");
    ...
    chip::app::clusters::OTARequestor::SetDelegate(&requestorDelegate);
