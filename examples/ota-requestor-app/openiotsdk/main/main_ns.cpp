...
int main()
{
    ChipLogProgress(NotSpecified, "Open IoT SDK ota-requestor-app example application start");
    ...
    ChipLogProgress(NotSpecified, "Open IoT SDK ota-requestor-app example application run");
