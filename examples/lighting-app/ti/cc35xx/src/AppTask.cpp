...
void InitializeOTARequestor(void)
{
    ...
    LogErrorOnFailure(sRequestorCore.Init(Server::GetInstance(), sRequestorStorage, sRequestorUser, sDownloader));
...
int AppTask::Init()
{
    ...
    LogErrorOnFailure(Server::GetInstance().Init(initParams));

    LogErrorOnFailure(PlatformMgr().AddEventHandler(DeviceEventCallback, reinterpret_cast<intptr_t>(nullptr)));
