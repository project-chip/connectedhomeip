...
emberAfIdentifyClusterTriggerEffectCallback(EmberAfIdentifyEffectIdentifier effectId, EmberAfIdentifyEffectVariant effectVariant)
{
    // To prevent warning
    (void) effectId;
    (void) effectVariant;
...
bool __attribute__((weak)) emberAfScenesClusterCopySceneCallback(uint8_t mode, uint16_t groupIdFrom, uint8_t sceneIdFrom,
...
bool __attribute__((weak))
emberAfScenesClusterEnhancedAddSceneCallback(uint16_t groupId, uint8_t sceneId, uint16_t transitionTime, uint8_t * sceneName,
                                             EmberAfSceneExtensionFieldSet extensionFieldSets)
{
    // To prevent warning
    (void) groupId;
...
bool __attribute__((weak)) emberAfZLLCommissioningClusterNetworkStartRequestCallback(
    uint32_t transaction, uint8_t * extendedPanId, EmberAfKeyIndex keyIndex,
...
bool __attribute__((weak))
emberAfZLLCommissioningClusterNetworkUpdateRequestCallback(uint32_t transaction, uint8_t * extendedPanId, uint8_t networkUpdateId,
                                                           uint8_t logicalChannel, uint16_t panId, uint16_t networkAddress)
{
    // To prevent warning
    (void) transaction;
    (void) extendedPanId;
...
bool __attribute__((weak))
emberAfZLLCommissioningClusterScanRequestCallback(uint32_t transaction, uint8_t zigbeeInformation, uint8_t zllInformation)
{
    // To prevent warning
    (void) transaction;
