    ...
    },
    {
      ...
      "clusters": [
        ...
        },
        {
          ...
          "attributes": [
            "   code    | mfgCode |  side  | storageOption | singleton | bounded |     defaultValue     | reportable |     minInterval     |     maxInterval     |   reportableChange",
            "    0x0000 |         | server |           NVM |           |         |                 0x01 |          1 |                     |               65344 |                     => OnOff [boolean]",
            ...
            "    0x4003 |         | server |           NVM |           |         |                      |          1 |                     |               65344 |                     => StartUpOnOff [OnOffStartUpOnOff]",
            "    0xfffc |         | server |           RAM |           |         |                    1 |          1 |                   1 |               65534 |                     => FeatureMap [bitmap32]",
        ...
        },
        {
          ...
          "attributes": [
            "   code    | mfgCode |  side  | storageOption | singleton | bounded |     defaultValue     | reportable |     minInterval     |     maxInterval     |   reportableChange",
            "    0x0000 |         | server |           NVM |           |         |                0x254 |          1 |                     |               65344 |                     => CurrentLevel [int8u]",
            ...
            "    0x4000 |         | server |           NVM |           |         |                      |          1 |                     |               65344 |                     => StartUpCurrentLevel [int8u]",
