...
```bash
build_tl7218x_concurrent_ota_lzma_v1/zephyr/merged.bin          -> flash this
build_tl7218x_concurrent_ota_lzma_v2/zephyr/merged_dfu.lzma.bin -> DFU over BLE SMP
build_tl7218x_concurrent_ota_lzma_v2/zephyr/matter.ota          -> OTA upgrade
```
...
```bash
build_tl7218x_concurrent_cs_ota_lzma_v1/zephyr/merged.bin          -> flash this
build_tl7218x_concurrent_cs_ota_lzma_v2/zephyr/merged_dfu.lzma.bin -> DFU over BLE SMP
build_tl7218x_concurrent_cs_ota_lzma_v2/zephyr/matter.ota          -> OTA upgrade
```
