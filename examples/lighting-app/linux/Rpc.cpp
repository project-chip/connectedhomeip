...
#include "device_common_service/device_common_service.rpc.pb.h"
...
class DeviceCommon : public generated::DeviceCommon<DeviceCommon>
{
public:
    ...
    pw::Status Reboot(ServerContext &, const chip_rpc_Empty & request, chip_rpc_Empty & response)
    {
        return pw::Status::Unimplemented();
    }

    pw::Status TriggerOta(ServerContext &, const chip_rpc_Empty & request, chip_rpc_Empty & response)
    {
        return pw::Status::Unimplemented();
    }
