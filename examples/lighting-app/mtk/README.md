#CHIP MT793X Lighting Example

An example showing the use of CHIP on the Silicon Labs MT793X MG12.
...
procedure. Thread Network credentials are then provided to the MT793X device
...
*   Build the example application:
          ...
          cd ~/connectedhomeip
          ./scripts/examples/gn_mt793x_example.sh ./examples/lighting-app/mt793x/ ./out/lighting-app BRD4161A
...
-   To delete generated executable, libraries and object files use:
    ...
    OR use GN/Ninja directly
          ...
          $ cd ~/connectedhomeip/examples/lighting-app/mt793x
          $ git submodule update --init
          $ source third_party/connectedhomeip/scripts/activate.sh
          $ export MT793X_BOARD=BRD4161A
          $ gn gen out/debug
          $ ninja -C out/debug
...
*   Build the example as Sleepy End Device (SED)
          ...
          $ ./scripts/examples/gn_mt793x_example.sh ./examples/lighting-app/mt793x/ ./out/lighting-app_SED BRD4161A --sed

    or use gn as previously mentioned but adding the following arguments:

          $ gn gen out/debug '--args=mt793x_board="BRD4161A" enable_sleepy_device=true chip_openthread_ftd=false'

*   Build the example with pigweed RCP

          $ ./scripts/examples/gn_mt793x_example.sh examples/lighting-app/mt793x/ out/lighting_app_rpc BRD4161A 'import("//with_pw_rpc.gni")'
...
arguments
         ...
         ./scripts/examples/gn_mt793x_example.sh
...
-   On the command line:
          ...
          $ cd ~/connectedhomeip/examples/lighting-app/mt793x
          $ python3 out/debug/chip-mt793x-lighting-example.flash.py
