      ...
      "clusters": [
        ...
        },
        {
          ...
          "attributes": [
            ...
            "    0x0003 |         | server |           RAM |           |         |                      |          1 |                   1 |               65534 |                     => WiredAssessedInputVoltage [int32u]",
            "    0x0004 |         | server |           RAM |           |         |                      |          1 |                   1 |               65534 |                     => WiredAssessedInputFrequency [int16u]",
            "    0x0005 |         | server |           RAM |           |         |                    1 |          1 |                   1 |               65534 |                     => WiredCurrentType [WiredCurrentTypeEnum]",
            "    0x0006 |         | server |           RAM |           |         |                      |          1 |                   1 |               65534 |                     => WiredAssessedCurrent [int32u]",
            "    0x0007 |         | server |           RAM |           |         |                 5000 |          1 |                   1 |               65534 |                     => WiredNominalVoltage [int32u]",
            "    0x0008 |         | server |           RAM |           |         |                 1000 |          1 |                   1 |               65534 |                     => WiredMaximumCurrent [int32u]",
            "    0x0009 |         | server |           RAM |           |         |                    1 |          1 |                   1 |               65534 |                     => WiredPresent [boolean]",
