...
#define APP_SWITCH_BUTTON PB2_BUTTON_GPIO_PIN

// Mapping of LEDs
#define SYSTEM_STATE_LED WHITE_COOL_LED_GPIO_PIN

#define COLOR_LED_CHANNEL_RED RED_LED_GPIO_PIN
#define COLOR_LED_CHANNEL_GREEN GREEN_LED_GPIO_PIN
#define COLOR_LED_CHANNEL_BLUE BLUE_LED_GPIO_PIN
...
#define QPINCFG_BUTTONS QPINCFG_GPIO_LIST(APP_FUNCTION_BUTTON, APP_LEVEL_BUTTON, APP_SWITCH_BUTTON)

// --- Mapping GPIOs to LEDs
#define QPINCFG_STATUS_LED QPINCFG_GPIO_LIST(SYSTEM_STATE_LED)

// --- ColorLED (R, G, B) using PWMXL module
#define QPINCFG_COLOR_LED                                                                                                          \
    QPINCFG_ALT_LIST(GPIO_AS_PWMXL(COLOR_LED_CHANNEL_RED), GPIO_AS_PWMXL(COLOR_LED_CHANNEL_GREEN),                                 \
                     GPIO_AS_PWMXL(COLOR_LED_CHANNEL_BLUE))

// --- Unused pins
#define QPINCFG_UNUSED                                                                                                             \
    QPINCFG_GPIO_LIST(PB1_BUTTON_GPIO_PIN, PB4_BUTTON_GPIO_PIN, WHITE_WARM_LED_GPIO_PIN, ANIO0_GPIO_PIN, ANIO1_GPIO_PIN,           \
