...
#define GENERATED_CLUSTERS { \
  ...
  { 0x0008, ZAP_ATTRIBUTE_INDEX(99), 2, 3, ZAP_CLUSTER_MASK(SERVER) | ZAP_CLUSTER_MASK(INIT_FUNCTION), chipFuncArrayLevelControlServer }, /* Endpoint: 1, Cluster: Level Control (server) */ \
}
