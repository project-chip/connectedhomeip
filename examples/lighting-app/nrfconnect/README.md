...
The nRF Connect Lighting Example demonstrates how to remotely control a white non-dimmable
light bulb. It uses buttons to test changing the lighting and device states and LEDs
...
**LED 2** simulates the light bulb and shows the state of the lighting.
The following states are possible:
...
**Button 2** &mdash; Pressing the button once changes the lighting state to the opposite one.
