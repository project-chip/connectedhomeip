...
{
    auto it =
        std::find_if(videoStreams.begin(), videoStreams.end(), [streamID](const VideoStream & s) { return s.videoStreamParams.videoStreamID == streamID; });
    ...
    std::string pipelineString = "v4l2src device=/dev/video0 ! "
                                 "video/x-raw,width=" +
        std::to_string(it->videoStreamParams.minResolution.width) + ",height=" + std::to_string(it->videoStreamParams.minResolution.height) +
...
CameraError CameraDevice::StartSnapshotStream(uint16_t streamID)
{
    ...
    GstElement * snapshotPipeline =
        CreateSnapshotPipeline("/dev/video0", it->snapshotStreamParams.minResolution.width, it->snapshotStreamParams.minResolution.height,
...
void CameraDevice::InitializeVideoStreams()
{
    ...
    VideoStream videoStream = {{ 1 /* Id */, StreamUsageEnum::kLiveView /* StreamUsage */, VideoCodecEnum::kH264, 30 /* MinFrameRate */, 120 /* MaxFrameRate */,
                                 { 640, 480 } /* MinResolution */, {640, 480} /* MaxResolution */, 500000 /* MinBitRate */, 2000000 /* MaxBitRate */,
                                 1000 /* MinFragmentLen */, 10000 /* MaxFragmentLen */, chip::MakeOptional(static_cast<bool>(false)) /* WMark */,
                                 chip::MakeOptional(static_cast<bool>(false)) /* OSD */, 0 /* RefCount */}, false, nullptr };
...
void CameraDevice::InitializeAudioStreams()
{
    ...
    AudioStream audioStream = {{ 1 /* Id */, StreamUsageEnum::kLiveView /* StreamUsage */, AudioCodecEnum::kOpus, 2 /* ChannelCount */,
                                 48000 /* SampleRate */, 20000 /* BitRate*/, 24 /* BitDepth */, 0 /* RefCount */}, false, nullptr };
...
void CameraDevice::InitializeSnapshotStreams()
{
    ...
    SnapshotStream snapshotStream = {{ 1 /* Id */, ImageCodecEnum::kJpeg, 30 /* FrameRate */, 512000 /* BitRate*/, { 320, 240 } /* MinResolution*/,
                                       { 320, 240 } /* MaxResolution */, 90 /* Quality */, 0 /* RefCount */}, false, nullptr };
