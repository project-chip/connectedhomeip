...
#define GENERATED_CLUSTERS { \
  { 0x0028, ZAP_ATTRIBUTE_INDEX(0), 12, 254, ZAP_CLUSTER_MASK(SERVER) | ZAP_CLUSTER_MASK(INIT_FUNCTION), chipFuncArrayBasicServer }, /* Endpoint: 1, Cluster: Basic (server) */ \
  { 0x0030, ZAP_ATTRIBUTE_INDEX(12), 3, 18, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: General Commissioning (server) */ \
  { 0x0031, ZAP_ATTRIBUTE_INDEX(15), 1, 2, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: Network Commissioning (server) */ \
  { 0x0033, ZAP_ATTRIBUTE_INDEX(16), 3, 258, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: General Diagnostics (server) */ \
  { 0x0034, ZAP_ATTRIBUTE_INDEX(19), 2, 10, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: Software Diagnostics (server) */ \
  { 0x0036, ZAP_ATTRIBUTE_INDEX(21), 6, 13, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: WiFi Network Diagnostics (server) */ \
  { 0x0037, ZAP_ATTRIBUTE_INDEX(27), 6, 42, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: Ethernet Network Diagnostics (server) */ \
  { 0x003E, ZAP_ATTRIBUTE_INDEX(33), 2, 256, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: Operational Credentials (server) */ \
  { 0x003F, ZAP_ATTRIBUTE_INDEX(35), 1, 2, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: Trusted Root Certificates (server) */ \
  { 0x0402, ZAP_ATTRIBUTE_INDEX(36), 4, 8, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: Temperature Measurement (server) */ \
}
