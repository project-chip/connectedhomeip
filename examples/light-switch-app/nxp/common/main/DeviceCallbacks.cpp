...
void LightSwitchApp::DeviceCallbacks::PostAttributeChangeCallback(EndpointId endpointId, ClusterId clusterId, AttributeId attributeId,
...
LightSwitchApp::DeviceCallbacks & LightSwitchApp::DeviceCallbacks::GetDefaultInstance()
{
...
{
    return LightSwitchApp::DeviceCallbacks::GetDefaultInstance();
}
