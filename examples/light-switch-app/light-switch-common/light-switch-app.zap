  ...
  "endpointTypes": [
    {
      ...
      "clusters": [
        ...
        },
        {
          ...
          "attributes": [
            "   code    | mfgCode |  side  | storageOption | singleton | bounded |     defaultValue     | reportable |     minInterval     |     maxInterval     |   reportableChange",
            "    0x0000 |         | server |           NVM |           |         |                      |          1 |                   1 |               65534 |                     => HourFormat [HourFormatEnum]",
            "    0x0001 |         | server |           NVM |           |         |                      |          1 |                   1 |               65534 |                     => ActiveCalendarType [CalendarTypeEnum]",
        ...
        },
        {
          ...
          "attributes": [
            ...
            "    0x0007 |         | server |           Ext |           |         |                      |          1 |                   1 |               65534 |                     => LocalTime [epoch_us]",
      ...
      "clusters": [
        ...
        },
        {
          ...
          "commands": [
            ...
            "0x0047 |         | client |        1 |       0 => StopMoveStep",
            "0x004b |         | client |        1 |       0 => MoveColorTemperature",
            "0x004c |         | client |        1 |       0 => StepColorTemperature"
          ],
          "attributes": [
            "   code    | mfgCode |  side  | storageOption | singleton | bounded |     defaultValue     | reportable |     minInterval     |     maxInterval     |   reportableChange",
      ...
      "clusters": [
        ...
        },
        {
          ...
          "attributes": [
            ...
            "    0x0001 |         | server |           RAM |           |         |                    0 |          1 |                   1 |               65534 |                     => CurrentPosition [int8u]",
            "    0xfff8 |         | server |           Ext |           |         |                      |          1 |                   1 |               65534 |                     => GeneratedCommandList [array]",
            "    0xfff9 |         | server |           Ext |           |         |                      |          1 |                   1 |               65534 |                     => AcceptedCommandList [array]",
            "    0xfffb |         | server |           Ext |           |         |                      |          1 |                   1 |               65534 |                     => AttributeList [array]",
            "    0xfffc |         | server |           RAM |           |         |                    2 |          1 |                   1 |               65534 |                     => FeatureMap [bitmap32]",
