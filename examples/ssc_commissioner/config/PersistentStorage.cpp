...
#ifdef BUILD_RELEASE
#if BUILD_RELEASE == 1
constexpr chip::Logging::LogCategory kDefaultLoggingLevel = chip::Logging::kLogCategory_Progress;
#else
constexpr chip::Logging::LogCategory kDefaultLoggingLevel = chip::Logging::kLogCategory_Max;
#endif
#else
constexpr chip::Logging::LogCategory kDefaultLoggingLevel = chip::Logging::kLogCategory_Max;
#endif
