...
/*
 * Enable laundry dryer delegate of laundry dryer cluster
 */
...
CHIP_ERROR cliOpState(int argc, char * argv[])
{
    ...
    else if (!strcmp(argv[0], "error"))
    {
        ...
        TEMPORARY_RETURN_IGNORED OperationalState::GetOperationalStateInstance()->OnOperationalErrorDetected(err);
        TEMPORARY_RETURN_IGNORED OperationalState::GetOperationalStateInstance()->SetOperationalState(
...
void LaundryDryerApp::AppTask::PreInitMatterStack()
{
    ChipLogProgress(DeviceLayer, "Welcome to NXP Laundry Dryer Demo App");
}

void LaundryDryerApp::AppTask::PostInitMatterStack()
{
...
LaundryDryerApp::AppTask & LaundryDryerApp::AppTask::GetDefaultInstance()
{
    static LaundryDryerApp::AppTask sAppTask;
    return sAppTask;
}

chip::NXP::App::AppTaskBase & chip::NXP::App::GetAppTask()
{
    return LaundryDryerApp::AppTask::GetDefaultInstance();
}
