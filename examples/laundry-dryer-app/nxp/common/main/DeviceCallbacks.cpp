...
void LaundryDryerApp::DeviceCallbacks::PostAttributeChangeCallback(EndpointId endpointId, ClusterId clusterId, AttributeId attributeId,
...
void LaundryDryerApp::DeviceCallbacks::OnOnOffPostAttributeChangeCallback(chip::EndpointId endpointId, chip::AttributeId attributeId,
                                                                 uint8_t * value)
{
    switch (attributeId)
    {
...
LaundryDryerApp::DeviceCallbacks & LaundryDryerApp::DeviceCallbacks::GetDefaultInstance()
{
    static LaundryDryerApp::DeviceCallbacks sDeviceCallbacks;
    return sDeviceCallbacks;
}

chip::DeviceManager::CHIPDeviceManagerCallbacks & chip::NXP::App::GetDeviceCallbacks()
{
    return LaundryDryerApp::DeviceCallbacks::GetDefaultInstance();
}
