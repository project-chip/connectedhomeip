      ...
      "clusters": [
        ...
        },
        {
          ...
          "attributes": [
            ...
            "    0xfffc |         | server |           RAM |           |         |                    4 |          1 |                   1 |               65534 |                     => FeatureMap [bitmap32]",
            "    0xfffd |         | server |           RAM |           |         |                    1 |          1 |                     |               65344 |                     => ClusterRevision [int16u]"
          ]
        },
        {
        ...
        },
        {
          ...
          "events": [
            " code  | mfgCode | side",
            "0x0000 |         | server => ConnectionStatus",
            "0x0001 |         | server => NetworkFaultChange"
          ]
        },
        {
    ...
    },
    {
      ...
      "clusters": [
        ...
        },
        {
          ...
          "attributes": [
            "   code    | mfgCode |  side  | storageOption | singleton | bounded |     defaultValue     | reportable |     minInterval     |     maxInterval     |   reportableChange",
            "    0x0000 |         | server |           RAM |           |         |                 0x00 |            |                     |               65344 |                     => OnOff [boolean]",
        ...
        },
        {
          ...
          "attributes": [
            "   code    | mfgCode |  side  | storageOption | singleton | bounded |     defaultValue     | reportable |     minInterval     |     maxInterval     |   reportableChange",
            "    0x0000 |         | server |           RAM |           |         |                      |          1 |                   1 |               65534 |                     => Status [PowerSourceStatusEnum]",
            "    0x0001 |         | server |           RAM |           |         |                      |          1 |                   1 |               65534 |                     => Order [int8u]",
            "    0x0002 |         | server |           RAM |           |         |                      |          1 |                   1 |               65534 |                     => Description [char_string]",
            "    0x000c |         | server |           RAM |           |         |                    0 |          1 |                   1 |               65534 |                     => BatPercentRemaining [int8u]",
        ...
        },
        {
          ...
          "attributes": [
            "   code    | mfgCode |  side  | storageOption | singleton | bounded |     defaultValue     | reportable |     minInterval     |     maxInterval     |   reportableChange",
            "    0x0000 |         | server |           RAM |           |         |                    2 |          1 |                   1 |               65534 |                     => LockState [DlLockState]",
            "    0x0001 |         | server |           RAM |           |         |                      |          1 |                   1 |               65534 |                     => LockType [DlLockType]",
            "    0x0002 |         | server |           RAM |           |         |                      |          1 |                   1 |               65534 |                     => ActuatorEnabled [boolean]",
            "    0x0003 |         | server |           RAM |           |         |                      |          1 |                   1 |               65534 |                     => DoorState [DoorStateEnum]",
            ...
            "    0x0021 |         | server |           RAM |           |         |                   en |          1 |                   1 |               65534 |                     => Language [char_string]",
            "    0x0023 |         | server |           RAM |           |         |                   60 |          1 |                   1 |               65534 |                     => AutoRelockTime [int32u]",
            "    0x0024 |         | server |           RAM |           |         |                    0 |          1 |                   1 |               65534 |                     => SoundVolume [int8u]",
            ...
            "    0x0029 |         | server |           RAM |           |         |                    0 |          1 |                   1 |               65534 |                     => EnableOneTouchLocking [boolean]",
            "    0x002b |         | server |           RAM |           |         |                    0 |          1 |                   1 |               65534 |                     => EnablePrivacyModeButton [boolean]",
            ...
            "    0xfffc |         | server |           RAM |           |         |                0x193 |          1 |                   1 |               65534 |                     => FeatureMap [bitmap32]",
        ...
        },
        {
          ...
          "attributes": [
            ...
            "    0x0008 |         | server |           RAM |           |         |                 0x01 |          1 |                   1 |               65534 |                     => ColorMode [enum8]",
