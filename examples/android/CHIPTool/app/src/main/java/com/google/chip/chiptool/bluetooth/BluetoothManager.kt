...
class BluetoothManager : BleCallback {
                    ...
                    val scanCallback =
                        object : ScanCallback() {
                            override fun onScanResult(callbackType: Int, result: ScanResult) {
                                ...
                                Log.i(
                                    TAG,
                                    "Bluetooth Device Scanned Addr: ${device.address}, Name ${device.name}"
                                )

                                val producerScope: ProducerScope<BluetoothDevice> =
                                    this@callbackFlow
    ...
    /**
     * Connects to a [BluetoothDevice] and suspends until
