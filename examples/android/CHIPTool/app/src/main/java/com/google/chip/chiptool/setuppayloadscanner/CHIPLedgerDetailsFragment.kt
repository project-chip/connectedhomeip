        ...
        val jsonObjectRequest =
            JsonObjectRequest(
                ...
                { response ->
                    ...
                    // parse redirect Url
                    val responseJson =
                        response.getJSONObject(context!!.getString(R.string.dcl_response_key))
                    val redirectUrl =
                        responseJson.getString(
                            context!!.getString(R.string.dcl_custom_flow_url_key)
                        )
                    ...
                    val payloadBase64 =
                        Base64.encodeToString(payloadJson.toByteArray(), Base64.DEFAULT)
                ...
                { error ->
                    ...
                    binding.commissioningFlowUrlTv.text =
                        context!!.getString(
                            R.string.chip_ledger_info_commissioning_flow_url_not_available
                        )
                }
            )
