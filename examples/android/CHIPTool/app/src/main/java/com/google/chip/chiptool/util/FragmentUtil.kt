...
object FragmentUtil {
    /**
     * Resolves a host of this Fragment as an instance of the specified class. The first of either
     * the parent Fragment or the host Activity which implements this interface will be returned.
     *
