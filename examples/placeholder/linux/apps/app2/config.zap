      ...
      "clusters": [
        ...
        },
        {
          ...
          "attributes": [
            ...
            "    0x0003 |         | server |           RAM |           |         |                  0x0 |          1 |                     |               65344 |                     => Tolerance [int16u]",
            "    0xfffc |         | server |           RAM |           |         |                    0 |          1 |                   1 |               65534 |                     => FeatureMap [bitmap32]",
        ...
        },
        {
          ...
          "commands": [
            " code  | mfgCode | source | incoming | outgoing",
            "0x0000 |         | client |        1 |       1 => LaunchContent",
      ...
      "clusters": [
        ...
        },
        {
          ...
          "attributes": [
            ...
            "    0xfff9 |         | server |           Ext |           |         |                      |          1 |                   1 |               65534 |                     => AcceptedCommandList [array]",
            "    0xfffb |         | server |           Ext |           |         |                      |          1 |                   1 |               65534 |                     => AttributeList [array]",
            "    0xfffc |         | server |           RAM |           |         |               0x0001 |          1 |                     |               65534 |                     => FeatureMap [bitmap32]",
        ...
        },
        {
          ...
          "attributes": [
            ...
            "    0x4006 |         | server |           RAM |           |         |                 0x00 |          1 |                   1 |               65534 |                     => ColorLoopStoredEnhancedHue [int16u]",
