...
object DeepLink {
  fun getDeepLinkRequestForQrcodeFragment(setting: String): NavDeepLinkRequest {
    return NavDeepLinkRequest.Builder.fromUri(
        "android-app://com.samsung.matter.chipstdeviceapp.feature.qrcode/qrcodeFragment/${setting}"
          .toUri()
      )
      .build()
  }
  ...
  fun getDeepLinkRequestForSetupFragment(setting: String): NavDeepLinkRequest {
    return NavDeepLinkRequest.Builder.fromUri(
        "android-app://com.samsung.matter.chipstdeviceapp.feature.setup/setupFragment/${setting}"
          .toUri()
      )
      .build()
  }
