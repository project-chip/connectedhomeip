...
```
docker pull ghcr.io/project-chip/chip-build-crosscompile:129
```

### Run docker

```
docker run -it -v ~/connectedhomeip:/var/connectedhomeip ghcr.io/project-chip/chip-build-crosscompile:129 /bin/bash
```
