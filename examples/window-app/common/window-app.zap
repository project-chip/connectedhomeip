      ...
      "clusters": [
        {
          ...
          "attributes": [
            ...
            "    0x0001 |         | server |           RAM |           |         |                 0x05 |          1 |                   1 |               65534 |                     => IdentifyType [IdentifyTypeEnum]",
            "    0xfff8 |         | server |           Ext |           |         |                      |          1 |                   1 |               65534 |                     => GeneratedCommandList [array]",
            "    0xfff9 |         | server |           Ext |           |         |                      |          1 |                   1 |               65534 |                     => AcceptedCommandList [array]",
            "    0xfffb |         | server |           Ext |           |         |                      |          1 |                   1 |               65534 |                     => AttributeList [array]",
            "    0xfffc |         | server |           RAM |           |         |                    0 |          1 |                   1 |               65534 |                     => FeatureMap [bitmap32]",
        ...
        },
        {
          ...
          "attributes": [
            ...
            "    0x0001 |         | server |           RAM |           |         |               0xFFFF |          1 |                     |               65535 |                     => PhysicalClosedLimitLift [int16u]",
            "    0x0002 |         | server |           RAM |           |         |               0xFFFF |          1 |                     |               65535 |                     => PhysicalClosedLimitTilt [int16u]",
            "    0x0003 |         | server |           NVM |           |         |                    0 |          1 |                     |               65344 |                     => CurrentPositionLift [int16u]",
            "    0x0004 |         | server |           NVM |           |         |                    0 |          1 |                     |               65344 |                     => CurrentPositionTilt [int16u]",
            "    0x0005 |         | server |           NVM |           |         |               0x0000 |          1 |                     |               65535 |                     => NumberOfActuationsLift [int16u]",
            "    0x0006 |         | server |           NVM |           |         |               0x0000 |          1 |                     |               65535 |                     => NumberOfActuationsTilt [int16u]",
            "    0x0007 |         | server |           NVM |           |         |                 0x03 |          1 |                     |               65344 |                     => ConfigStatus [ConfigStatus]",
            "    0x0008 |         | server |           NVM |           |         |                    0 |          1 |                     |               65344 |                     => CurrentPositionLiftPercentage [Percent]",
            "    0x0009 |         | server |           NVM |           |         |                    0 |          1 |                     |               65344 |                     => CurrentPositionTiltPercentage [Percent]",
            "    0x000a |         | server |           RAM |           |         |                 0x00 |          1 |                     |               65344 |                     => OperationalStatus [OperationalStatus]",
            "    0x000b |         | server |           RAM |           |         |                      |          1 |                     |               65344 |                     => TargetPositionLiftPercent100ths [Percent100ths]",
            "    0x000c |         | server |           RAM |           |         |                      |          1 |                     |               65344 |                     => TargetPositionTiltPercent100ths [Percent100ths]",
            "    0x000d |         | server |           RAM |           |         |                 0x00 |          1 |                     |               65344 |                     => EndProductType [EndProductType]",
            "    0x000e |         | server |           NVM |           |         |                    0 |          1 |                     |               65344 |                     => CurrentPositionLiftPercent100ths [Percent100ths]",
            "    0x000f |         | server |           NVM |           |         |                    0 |          1 |                     |               65344 |                     => CurrentPositionTiltPercent100ths [Percent100ths]",
            ...
            "    0x0017 |         | server |           NVM |           |         |                  0x0 |          1 |                     |               65344 |                     => Mode [Mode]",
            "    0x001a |         | server |           RAM |           |         |               0x0000 |          1 |                     |               65344 |                     => SafetyStatus [SafetyStatus]",
            "    0xfff8 |         | server |           Ext |           |         |                      |          1 |                   1 |               65534 |                     => GeneratedCommandList [array]",
            "    0xfff9 |         | server |           Ext |           |         |                      |          1 |                   1 |               65534 |                     => AcceptedCommandList [array]",
            "    0xfffb |         | server |           Ext |           |         |                      |          1 |                   1 |               65534 |                     => AttributeList [array]",
            "    0xfffc |         | server |           RAM |           |         |               0x001F |          1 |                     |               65344 |                     => FeatureMap [bitmap32]",
      ...
      "clusters": [
        ...
        },
        {
          ...
          "attributes": [
            ...
            "    0x0012 |         | server |           NVM |           |         |               0x0000 |          1 |                     |               65344 |                     => InstalledOpenLimitTilt [int16u]",
            "    0x0013 |         | server |           NVM |           |         |               0xFFFF |          1 |                     |               65344 |                     => InstalledClosedLimitTilt [int16u]",
            "    0x0017 |         | server |           NVM |           |         |                 0x00 |          1 |                     |               65344 |                     => Mode [Mode]",
            "    0x001a |         | server |           RAM |           |         |               0x0000 |          1 |                     |               65344 |                     => SafetyStatus [SafetyStatus]",
            "    0xfff8 |         | server |           Ext |           |         |                      |          1 |                   1 |               65534 |                     => GeneratedCommandList [array]",
            "    0xfff9 |         | server |           Ext |           |         |                      |          1 |                   1 |               65534 |                     => AcceptedCommandList [array]",
            "    0xfffb |         | server |           Ext |           |         |                      |          1 |                   1 |               65534 |                     => AttributeList [array]",
            "    0xfffc |         | server |           RAM |           |         |               0x0017 |          1 |                     |               65344 |                     => FeatureMap [bitmap32]",
            "    0xfffd |         | server |           RAM |           |         |                    5 |          1 |                     |               65344 |                     => ClusterRevision [int16u]"
          ]
        }
      ]
