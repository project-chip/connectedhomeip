...
{
// TODO(#5098) We should pass the Command Object and EndpointId to the cluster callbacks.
        wasHandled = emberAfWindowCoveringClusterGoToLiftPercentageCallback(apCommandObj, liftPercentageValue, liftPercent100thsValue);
        }
            break;
        }
...
{
// TODO(#5098) We should pass the Command Object and EndpointId to the cluster callbacks.
        wasHandled = emberAfWindowCoveringClusterGoToTiltPercentageCallback(apCommandObj, tiltPercentageValue, tiltPercent100thsValue);
        }
            break;
        }
...
// TODO(#5098) We should pass the Command Object and EndpointId to the cluster callbacks.
        ...
        default: {
            ...
            apCommandObj->AddStatusCode(returnStatusParam, Protocols::SecureChannel::GeneralStatusCode::kNotFound, Protocols::SecureChannel::Id,
        Protocols::InteractionModel::ProtocolCode::UnsupportedCommand);
            ChipLogError(Zcl, "Unknown command %" PRIx8 " for cluster %" PRIx16, aCommandId, ZCL_WINDOW_COVERING_CLUSTER_ID);
            return;
        }
        }
    }
