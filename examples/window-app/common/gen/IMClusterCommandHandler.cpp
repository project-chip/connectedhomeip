...
{
wasHandled = emberAfWindowCoveringClusterGoToLiftPercentageCallback(aEndpointId, apCommandObj, liftPercentageValue, liftPercent100thsValue);
        }
            break;
        }
...
if (CHIP_END_OF_TLV == TLVError)
{
  ...
  TLVError = CHIP_NO_ERROR;
        ...
        if (CHIP_NO_ERROR == TLVError && CHIP_NO_ERROR == TLVUnpackError && 1 == validArgumentCount)
{
wasHandled = emberAfWindowCoveringClusterGoToLiftValueCallback(aEndpointId, apCommandObj, liftValue);
        }
            break;
        }
...
if (CHIP_END_OF_TLV == TLVError)
{
  ...
  TLVError = CHIP_NO_ERROR;
        ...
        if (CHIP_NO_ERROR == TLVError && CHIP_NO_ERROR == TLVUnpackError && 2 == validArgumentCount)
{
wasHandled = emberAfWindowCoveringClusterGoToTiltPercentageCallback(aEndpointId, apCommandObj, tiltPercentageValue, tiltPercent100thsValue);
        }
            break;
        }
...
if (CHIP_END_OF_TLV == TLVError)
{
  ...
  TLVError = CHIP_NO_ERROR;
        ...
        if (CHIP_NO_ERROR == TLVError && CHIP_NO_ERROR == TLVUnpackError && 1 == validArgumentCount)
{
wasHandled = emberAfWindowCoveringClusterGoToTiltValueCallback(aEndpointId, apCommandObj, tiltValue);
        }
            break;
        }
