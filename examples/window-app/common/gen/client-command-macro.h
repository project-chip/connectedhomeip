 ...
 */
#define emberAfFillCommandFabricClusterUpdateFabricLabel(fabricLabel)                                                              \
    emberAfFillExternalBuffer(mask,                                                                                                \
                                                                                                                                   \
                              ZCL_UPDATE_FABRIC_LABEL_COMMAND_ID, "u", fabricLabel);
 ...
 * @param vendorId INT16U
 */
#define emberAfFillCommandFabricClusterRemoveFabric(fabricId, nodeId, vendorId)                                                    \
    emberAfFillExternalBuffer(mask,                                                                                                \
                                                                                                                                   \
 ...
 * @param fabricId FABRIC_ID
 */
#define emberAfFillCommandFabricClusterGetFabricIdResponse(fabricId)                                                               \
    emberAfFillExternalBuffer(mask,                                                                                                \
                                                                                                                                   \
