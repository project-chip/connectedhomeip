...
#define GENERATED_CLUSTERS { \
  ...
  { 0x0102, ZAP_ATTRIBUTE_INDEX(96), 19, 31, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: Window Covering (server) */ \
}
...
#define GENERATED_ENDPOINT_TYPES { \
  { ZAP_CLUSTER_INDEX(0), 9, 1586 }, \
  { ZAP_CLUSTER_INDEX(9), 1, 31 }, \
}
