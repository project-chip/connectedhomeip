...
#define GENERATED_CLUSTERS { \
  ...
  { 0x0035, ZAP_ATTRIBUTE_INDEX(13), 61, 730, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: Thread Network Diagnostics (server) */ \
  { 0x0102, ZAP_ATTRIBUTE_INDEX(74), 10, 17, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: Window Covering (server) */ \
}
...
\
  /* Endpoint: 1, Cluster: Window Covering (server) */ \
  { ZAP_REPORT_DIRECTION(REPORTED), 0x0001, 0x0102, 0x0000, ZAP_CLUSTER_MASK(SERVER), 0x0000, {{ 0, 65344, 0 }} }, /* window covering type */ \
  { ZAP_REPORT_DIRECTION(REPORTED), 0x0001, 0x0102, 0x0003, ZAP_CLUSTER_MASK(SERVER), 0x0000, {{ 0, 65344, 0 }} }, /* current position - lift */ \
  { ZAP_REPORT_DIRECTION(REPORTED), 0x0001, 0x0102, 0x0004, ZAP_CLUSTER_MASK(SERVER), 0x0000, {{ 0, 65344, 0 }} }, /* current position - tilt */ \
  { ZAP_REPORT_DIRECTION(REPORTED), 0x0001, 0x0102, 0x0007, ZAP_CLUSTER_MASK(SERVER), 0x0000, {{ 0, 65344, 0 }} }, /* config status */ \
  { ZAP_REPORT_DIRECTION(REPORTED), 0x0001, 0x0102, 0x0010, ZAP_CLUSTER_MASK(SERVER), 0x0000, {{ 0, 65344, 0 }} }, /* installed open limit - lift */ \
  { ZAP_REPORT_DIRECTION(REPORTED), 0x0001, 0x0102, 0x0011, ZAP_CLUSTER_MASK(SERVER), 0x0000, {{ 0, 65344, 0 }} }, /* installed closed limit - lift */ \
