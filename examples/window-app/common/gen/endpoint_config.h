...
#define GENERATED_ENDPOINT_TYPES                                                                                                   \
    {                                                                                                                              \
        { ZAP_CLUSTER_INDEX(0), 10, 1631 }, { ZAP_CLUSTER_INDEX(10), 0, 0 },                                                       \
    }
...
#define ATTRIBUTE_MAX_SIZE (1631)
...
#define EMBER_AF_GENERATED_REPORTING_CONFIG_DEFAULTS                                                                               \
    {                                                                                                                              \
        ...
        /* Endpoint: 0, Cluster: Window Covering (server) */                                                                       \
        {                                                                                                                          \
            ZAP_REPORT_DIRECTION(REPORTED), 0x0000, 0x0102, 0x0008, ZAP_CLUSTER_MASK(SERVER), 0x0000, { { 0, 100, 0 } }            \
        }, /* CurrentPositionLiftPercentage */                                                                                     \
            {                                                                                                                      \
                ZAP_REPORT_DIRECTION(REPORTED), 0x0000, 0x0102, 0x0009, ZAP_CLUSTER_MASK(SERVER), 0x0000, { { 0, 100, 0 } }        \
            }, /* CurrentPositionTiltPercentage */                                                                                 \
            {                                                                                                                      \
                ZAP_REPORT_DIRECTION(REPORTED), 0x0000, 0x0102, 0x000A, ZAP_CLUSTER_MASK(SERVER), 0x0000, { { 0, 127, 0 } }        \
            }, /* OperationalStatus */                                                                                             \
            {                                                                                                                      \
                ZAP_REPORT_DIRECTION(REPORTED), 0x0000, 0x0102, 0x000B, ZAP_CLUSTER_MASK(SERVER), 0x0000, { { 0, 10000, 0 } }      \
            }, /* TargetPositionLiftPercent100ths */                                                                               \
            {                                                                                                                      \
                ZAP_REPORT_DIRECTION(REPORTED), 0x0000, 0x0102, 0x000C, ZAP_CLUSTER_MASK(SERVER), 0x0000, { { 0, 10000, 0 } }      \
            }, /* TargetPositionTiltPercent100ths */                                                                               \
            {                                                                                                                      \
                ZAP_REPORT_DIRECTION(REPORTED), 0x0000, 0x0102, 0x000E, ZAP_CLUSTER_MASK(SERVER), 0x0000, { { 0, 10000, 0 } }      \
            }, /* CurrentPositionLiftPercent100ths */                                                                              \
            {                                                                                                                      \
                ZAP_REPORT_DIRECTION(REPORTED), 0x0000, 0x0102, 0x000F, ZAP_CLUSTER_MASK(SERVER), 0x0000, { { 0, 10000, 0 } }      \
            }, /* CurrentPositionTiltPercent100ths */                                                                              \
            {                                                                                                                      \
                ZAP_REPORT_DIRECTION(REPORTED), 0x0000, 0x0102, 0x001A, ZAP_CLUSTER_MASK(SERVER), 0x0000, { { 0, 65344, 0 } }      \
            }, /* SafetyStatus */                                                                                                  \
    }
