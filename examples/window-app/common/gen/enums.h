...
// Enum for ControlMode
typedef enum
{
    EMBER_ZCL_CONTROL_MODE_CONSTANT_SPEED        = 0,
    EMBER_ZCL_CONTROL_MODE_CONSTANT_PRESSURE     = 1,
    EMBER_ZCL_CONTROL_MODE_PROPORTIONAL_PRESSURE = 2,
    EMBER_ZCL_CONTROL_MODE_CONSTANT_FLOW         = 3,
    EMBER_ZCL_CONTROL_MODE_CONSTANT_TEMPERATURE  = 5,
    EMBER_ZCL_CONTROL_MODE_AUTOMATIC             = 7,
} EmberAfControlMode;
...
// Enum for OperationMode
typedef enum
{
    EMBER_ZCL_OPERATION_MODE_NORMAL  = 0,
    EMBER_ZCL_OPERATION_MODE_MINIMUM = 1,
    EMBER_ZCL_OPERATION_MODE_MAXIMUM = 2,
    EMBER_ZCL_OPERATION_MODE_LOCAL   = 3,
} EmberAfOperationMode;
...
#define EMBER_AF_ALARM_MASK_SUPPLY_VOLTAGE_LOW (1)
#define EMBER_AF_ALARM_MASK_SUPPLY_VOLTAGE_LOW_OFFSET (0)
#define EMBER_AF_ALARM_MASK_SUPPLY_VOLTAGE_HIGH (2)
#define EMBER_AF_ALARM_MASK_SUPPLY_VOLTAGE_HIGH_OFFSET (1)
#define EMBER_AF_ALARM_MASK_POWER_MISSING_PHASE (4)
#define EMBER_AF_ALARM_MASK_POWER_MISSING_PHASE_OFFSET (2)
#define EMBER_AF_ALARM_MASK_SYSTEM_PRESSURE_LOW (8)
#define EMBER_AF_ALARM_MASK_SYSTEM_PRESSURE_LOW_OFFSET (3)
#define EMBER_AF_ALARM_MASK_SYSTEM_PRESSURE_HIGH (16)
#define EMBER_AF_ALARM_MASK_SYSTEM_PRESSURE_HIGH_OFFSET (4)
#define EMBER_AF_ALARM_MASK_DRY_RUNNING (32)
#define EMBER_AF_ALARM_MASK_DRY_RUNNING_OFFSET (5)
#define EMBER_AF_ALARM_MASK_MOTOR_TEMPERATURE_HIGH (64)
#define EMBER_AF_ALARM_MASK_MOTOR_TEMPERATURE_HIGH_OFFSET (6)
#define EMBER_AF_ALARM_MASK_PUMP_MOTOR_FATAL_FAILURE (128)
#define EMBER_AF_ALARM_MASK_PUMP_MOTOR_FATAL_FAILURE_OFFSET (7)
#define EMBER_AF_ALARM_MASK_ELECTRONIC_TEMPERATURE_HIGH (256)
#define EMBER_AF_ALARM_MASK_ELECTRONIC_TEMPERATURE_HIGH_OFFSET (8)
#define EMBER_AF_ALARM_MASK_PUMP_BLOCKED (512)
#define EMBER_AF_ALARM_MASK_PUMP_BLOCKED_OFFSET (9)
#define EMBER_AF_ALARM_MASK_SENSOR_FAILURE (1024)
#define EMBER_AF_ALARM_MASK_SENSOR_FAILURE_OFFSET (10)
#define EMBER_AF_ALARM_MASK_ELECTRONIC_NON_FATAL_FAILURE (2048)
#define EMBER_AF_ALARM_MASK_ELECTRONIC_NON_FATAL_FAILURE_OFFSET (11)
#define EMBER_AF_ALARM_MASK_ELECTRONIC_FATAL_FAILURE (4096)
#define EMBER_AF_ALARM_MASK_ELECTRONIC_FATAL_FAILURE_OFFSET (12)
#define EMBER_AF_ALARM_MASK_GENERAL_FAULT (8192)
#define EMBER_AF_ALARM_MASK_GENERAL_FAULT_OFFSET (13)
#define EMBER_AF_ALARM_MASK_LEAKAGE (16384)
#define EMBER_AF_ALARM_MASK_LEAKAGE_OFFSET (14)
#define EMBER_AF_ALARM_MASK_AIR_DETECTION (32768)
#define EMBER_AF_ALARM_MASK_AIR_DETECTION_OFFSET (15)
#define EMBER_AF_ALARM_MASK_TURBINE_OPERATION (65536)
#define EMBER_AF_ALARM_MASK_TURBINE_OPERATION_OFFSET (16)
