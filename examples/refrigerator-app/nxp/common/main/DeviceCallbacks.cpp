...
void RefrigeratorApp::DeviceCallbacks::PostAttributeChangeCallback(EndpointId endpointId, ClusterId clusterId,
...
RefrigeratorApp::DeviceCallbacks & RefrigeratorApp::DeviceCallbacks::GetDefaultInstance()
{
...
{
    return RefrigeratorApp::DeviceCallbacks::GetDefaultInstance();
}
