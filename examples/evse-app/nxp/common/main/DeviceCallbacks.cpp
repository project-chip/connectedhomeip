...
void EVSEApp::DeviceCallbacks::PostAttributeChangeCallback(EndpointId endpointId, ClusterId clusterId,
...
EVSEApp::DeviceCallbacks & EVSEApp::DeviceCallbacks::GetDefaultInstance()
{
...
{
    return EVSEApp::DeviceCallbacks::GetDefaultInstance();
}
