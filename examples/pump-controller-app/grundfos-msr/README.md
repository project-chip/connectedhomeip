# CHIP Grundfos (CC2552R7) Lock Example Application

An example application showing the use [CHIP][chip] on the Texas Instruments
CC13X2_26X2 family of Wireless MCUs, mounted on the Grundfos MSR module.

---

- [CHIP Grundfos (CC2552R7) Lock Example Application](#chip-grundfos-cc2552r7-lock-example-application)
