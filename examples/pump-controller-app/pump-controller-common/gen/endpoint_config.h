...
#define GENERATED_ATTRIBUTES { \
  ...
  { 0xFFFD, ZAP_TYPE(INT16U), 2, ZAP_ATTRIBUTE_MASK(CLIENT), { (uint8_t *) 2 } }, /* On/off (client): cluster revision */  \
  { 0xFFFD, ZAP_TYPE(INT16U), 2, ZAP_ATTRIBUTE_MASK(CLIENT), { (uint8_t *) 0x0001 } }, /* Pump Configuration and Control (client): cluster revision */  \
}
...
#define GENERATED_CLUSTERS { \
  ...
  { 0x0200, ZAP_ATTRIBUTE_INDEX(4), 1, 2, ZAP_CLUSTER_MASK(CLIENT), NULL }, /* Endpoint: 1, Cluster: Pump Configuration and Control (client) */ \
}
