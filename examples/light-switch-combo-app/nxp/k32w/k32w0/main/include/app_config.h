...
#define SW3_BUTTON 3
#define BLE_BUTTON 4
#define RESET_BUTTON BLE_BUTTON /* long press*/
#define LIGHT_BUTTON SW2_BUTTON /* long press */

#define SW1_BUTTON_PUSH 1
#define SW2_BUTTON_PUSH 2
#define SW3_BUTTON_PUSH 3
#define BLE_BUTTON_PUSH 4
#define RESET_BUTTON_PUSH 5
#define LIGHT_BUTTON_PUSH 6
