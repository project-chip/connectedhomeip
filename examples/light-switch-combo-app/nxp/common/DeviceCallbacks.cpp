...
void LightSwitchComboApp::DeviceCallbacks::PostAttributeChangeCallback(chip::EndpointId endpoint, chip::ClusterId clusterId, chip::AttributeId attributeId, uint8_t type, uint16_t size, uint8_t * value)
{
...
{
    static LightSwitchComboApp::DeviceCallbacks sDeviceCallbacks;
