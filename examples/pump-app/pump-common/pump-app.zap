    ...
    },
    {
      ...
      "clusters": [
        ...
        },
        {
          ...
          "attributes": [
            "   code    | mfgCode |  side  | storageOption | singleton | bounded |     defaultValue     | reportable |     minInterval     |     maxInterval     |   reportableChange",
            "    0x0000 |         | server |           RAM |           |         |                 0x00 |          1 |                     |               65344 |                     => CurrentLevel [int8u]",
            "    0x0002 |         | server |           RAM |           |         |                 0x00 |          1 |                   1 |               65534 |                     => MinLevel [int8u]",
            "    0x0003 |         | server |           RAM |           |         |                 0xC8 |          1 |                   1 |               65534 |                     => MaxLevel [int8u]",
        ...
        },
        {
          ...
          "attributes": [
            ...
            "    0x0010 |         | server |           RAM |           |         |                    0 |          1 |                     |               65344 |                     => PumpStatus [PumpStatusBitmap]",
            "    0x0011 |         | server |           RAM |           |         |                    0 |          1 |                     |               65344 |                     => EffectiveOperationMode [OperationModeEnum]",
            "    0x0012 |         | server |           RAM |           |         |                    0 |          1 |                     |               65344 |                     => EffectiveControlMode [ControlModeEnum]",
            ...
            "    0xfff9 |         | server |           Ext |           |         |                      |          1 |                   1 |               65534 |                     => AcceptedCommandList [array]",
            "    0xfffb |         | server |           Ext |           |         |                      |          1 |                   1 |               65534 |                     => AttributeList [array]",
            "    0xfffc |         | server |           RAM |           |         |                   31 |          1 |                   1 |               65534 |                     => FeatureMap [bitmap32]",
        ...
        },
        {
          ...
          "attributes": [
            ...
            "    0x0003 |         | server |           RAM |           |         |                    0 |          1 |                     |               65344 |                     => Tolerance [int16u]",
            "    0xfff8 |         | server |           Ext |           |         |                      |          1 |                   1 |               65534 |                     => GeneratedCommandList [array]",
            "    0xfff9 |         | server |           Ext |           |         |                      |          1 |                   1 |               65534 |                     => AcceptedCommandList [array]",
            "    0xfffb |         | server |           Ext |           |         |                      |          1 |                   1 |               65534 |                     => AttributeList [array]",
            "    0xfffc |         | server |           RAM |           |         |                    0 |          1 |                   1 |               65534 |                     => FeatureMap [bitmap32]",
        ...
        },
        {
          ...
          "attributes": [
            ...
            "    0x0011 |         | server |           RAM |           |         |                    0 |          1 |                   1 |               65534 |                     => MinScaledValue [int16s]",
            "    0x0012 |         | server |           RAM |           |         |                    0 |          1 |                   1 |               65534 |                     => MaxScaledValue [int16s]",
            "    0x0013 |         | server |           RAM |           |         |                    0 |          1 |                     |               65344 |                     => ScaledTolerance [int16u]",
            "    0x0014 |         | server |           RAM |           |         |                    0 |          1 |                   1 |               65534 |                     => Scale [int8s]",
            "    0xfff8 |         | server |           Ext |           |         |                      |          1 |                   1 |               65534 |                     => GeneratedCommandList [array]",
            "    0xfff9 |         | server |           Ext |           |         |                      |          1 |                   1 |               65534 |                     => AcceptedCommandList [array]",
            "    0xfffb |         | server |           Ext |           |         |                      |          1 |                   1 |               65534 |                     => AttributeList [array]",
            "    0xfffc |         | server |           RAM |           |         |                    0 |          1 |                   1 |               65534 |                     => FeatureMap [bitmap32]",
        ...
        },
        {
          ...
          "attributes": [
            "   code    | mfgCode |  side  | storageOption | singleton | bounded |     defaultValue     | reportable |     minInterval     |     maxInterval     |   reportableChange",
            "    0x0000 |         | server |           RAM |           |         |               0x0000 |          1 |                     |               65344 |                     => MeasuredValue [int16u]",
