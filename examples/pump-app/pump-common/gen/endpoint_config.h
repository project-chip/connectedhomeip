...
#define GENERATED_CLUSTERS { \
  ...
  { 0x0404, ZAP_ATTRIBUTE_INDEX(113), 1, 2, ZAP_CLUSTER_MASK(CLIENT), NULL }, /* Endpoint: 1, Cluster: Flow Measurement (client) */ \
  { 0x0404, ZAP_ATTRIBUTE_INDEX(114), 4, 8, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: Flow Measurement (server) */ \
}
...
#define ATTRIBUTE_MAX_SIZE (1625)
