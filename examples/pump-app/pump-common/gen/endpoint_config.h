...
#define GENERATED_CLUSTERS                                                                                                         \
    {                                                                                                                              \
        {                                                                                                                          \
            ...
            {                                                                                                                      \
                0x0035, ZAP_ATTRIBUTE_INDEX(25), 61, 730, ZAP_CLUSTER_MASK(SERVER), NULL                                           \
            }, /* Endpoint: 0, Cluster: Thread Network Diagnostics (server) */                                                     \
            {                                                                                                                      \
...
#define EMBER_AF_GENERATED_REPORTING_CONFIG_DEFAULTS                                                                               \
    {                                                                                                                              \
        ...
        {                                                                                                                          \
            ...
            /* Endpoint: 0, Cluster: Pump Configuration and Control (server) */                                                    \
            {                                                                                                                      \
                ZAP_REPORT_DIRECTION(REPORTED), 0x0000, 0x0200, 0x0013, ZAP_CLUSTER_MASK(SERVER), 0x0000, { { 0, 65344, 0 } }      \
            }, /* capacity */                                                                                                      \
                                                                                                                                   \
            /* Endpoint: 0, Cluster: Temperature Measurement (server) */                                                           \
            {                                                                                                                      \
