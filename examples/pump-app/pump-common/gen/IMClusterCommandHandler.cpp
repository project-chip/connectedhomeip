...
// TODO(#5098) We should pass the Command Object and EndpointId to the cluster callbacks.
        ...
        default: {
            ...
            chip::app::CommandPathParams returnStatusParam = { aEndpointId,
                                                       0, // GroupId
                                                       ZCL_DIAGNOSTIC_LOGS_CLUSTER_ID,
                                                       aCommandId,
                                                       (chip::app::CommandPathFlags::kEndpointIdValid) };
            apCommandObj->AddStatusCode(returnStatusParam, Protocols::SecureChannel::GeneralStatusCode::kNotFound, Protocols::SecureChannel::Id,
        Protocols::InteractionModel::ProtocolCode::UnsupportedCommand);
...
{
// TODO(#5098) We should pass the Command Object and EndpointId to the cluster callbacks.
        wasHandled = emberAfOperationalCredentialsClusterAddOpCertCallback(apCommandObj, OperationalCert, IPKValue, CaseAdminNode, AdminVendorId);
        }
            break;
        }
...
// TODO(#5098) We should pass the Command Object and EndpointId to the cluster callbacks.
        ...
        default: {
            ...
            apCommandObj->AddStatusCode(returnStatusParam, Protocols::SecureChannel::GeneralStatusCode::kNotFound, Protocols::SecureChannel::Id,
        Protocols::InteractionModel::ProtocolCode::UnsupportedCommand);
            ChipLogError(Zcl, "Unknown command %" PRIx8 " for cluster %" PRIx16, aCommandId, ZCL_OPERATIONAL_CREDENTIALS_CLUSTER_ID);
            return;
        }
        }
    }
