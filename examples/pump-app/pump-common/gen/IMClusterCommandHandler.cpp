...
{
wasHandled = emberAfAdministratorCommissioningClusterOpenBasicCommissioningWindowCallback(aEndpointId, apCommandObj, CommissioningTimeout);
        }
            break;
        }
...
{
wasHandled = emberAfAdministratorCommissioningClusterOpenCommissioningWindowCallback(aEndpointId, apCommandObj, CommissioningTimeout, PAKEVerifier, Discriminator, Iterations, Salt, PasscodeID);
        }
            break;
        }
...
{
wasHandled = emberAfDiagnosticLogsClusterRetrieveLogsRequestCallback(aEndpointId, apCommandObj, intent, requestedProtocol, transferFileDesignator);
        }
            break;
        }
        default: {
...
if (CHIP_END_OF_TLV == TLVError)
{
  ...
  TLVError = CHIP_NO_ERROR;
        ...
        if (CHIP_NO_ERROR == TLVError && CHIP_NO_ERROR == TLVUnpackError && 3 == validArgumentCount)
{
wasHandled = emberAfGeneralCommissioningClusterArmFailSafeCallback(aEndpointId, apCommandObj, expiryLengthSeconds, breadcrumb, timeoutMs);
        }
            break;
        }
...
{
wasHandled = emberAfGeneralCommissioningClusterSetRegulatoryConfigCallback(aEndpointId, apCommandObj, location, const_cast<uint8_t*>(countryCode), breadcrumb, timeoutMs);
        }
            break;
        }
        default: {
...
if (CHIP_END_OF_TLV == TLVError)
{
  ...
  TLVError = CHIP_NO_ERROR;
        ...
        if (CHIP_NO_ERROR == TLVError && CHIP_NO_ERROR == TLVUnpackError && 4 == validArgumentCount)
{
wasHandled = emberAfLevelControlClusterMoveCallback(aEndpointId, apCommandObj, moveMode, rate, optionMask, optionOverride);
        }
            break;
        }
...
if (CHIP_END_OF_TLV == TLVError)
{
  ...
  TLVError = CHIP_NO_ERROR;
        ...
        if (CHIP_NO_ERROR == TLVError && CHIP_NO_ERROR == TLVUnpackError && 4 == validArgumentCount)
{
wasHandled = emberAfLevelControlClusterMoveToLevelCallback(aEndpointId, apCommandObj, level, transitionTime, optionMask, optionOverride);
        }
            break;
        }
...
{
wasHandled = emberAfLevelControlClusterMoveToLevelWithOnOffCallback(aEndpointId, apCommandObj, level, transitionTime);
        }
            break;
        }
...
{
wasHandled = emberAfLevelControlClusterStepCallback(aEndpointId, apCommandObj, stepMode, stepSize, transitionTime, optionMask, optionOverride);
        }
            break;
        }
...
if (CHIP_END_OF_TLV == TLVError)
{
  ...
  TLVError = CHIP_NO_ERROR;
        ...
        if (CHIP_NO_ERROR == TLVError && CHIP_NO_ERROR == TLVUnpackError && 3 == validArgumentCount)
{
wasHandled = emberAfLevelControlClusterStepWithOnOffCallback(aEndpointId, apCommandObj, stepMode, stepSize, transitionTime);
        }
            break;
        }
...
if (CHIP_END_OF_TLV == TLVError)
{
  ...
  TLVError = CHIP_NO_ERROR;
        ...
        if (CHIP_NO_ERROR == TLVError && CHIP_NO_ERROR == TLVUnpackError && 3 == validArgumentCount)
{
wasHandled = emberAfNetworkCommissioningClusterAddThreadNetworkCallback(aEndpointId, apCommandObj, operationalDataset, breadcrumb, timeoutMs);
        }
            break;
        }
...
if (CHIP_END_OF_TLV == TLVError)
{
  ...
  TLVError = CHIP_NO_ERROR;
        ...
        if (CHIP_NO_ERROR == TLVError && CHIP_NO_ERROR == TLVUnpackError && 4 == validArgumentCount)
{
wasHandled = emberAfNetworkCommissioningClusterAddWiFiNetworkCallback(aEndpointId, apCommandObj, ssid, credentials, breadcrumb, timeoutMs);
        }
            break;
        }
...
if (CHIP_END_OF_TLV == TLVError)
{
  ...
  TLVError = CHIP_NO_ERROR;
        ...
        if (CHIP_NO_ERROR == TLVError && CHIP_NO_ERROR == TLVUnpackError && 3 == validArgumentCount)
{
wasHandled = emberAfNetworkCommissioningClusterDisableNetworkCallback(aEndpointId, apCommandObj, networkID, breadcrumb, timeoutMs);
        }
            break;
        }
...
if (CHIP_END_OF_TLV == TLVError)
{
  ...
  TLVError = CHIP_NO_ERROR;
        ...
        if (CHIP_NO_ERROR == TLVError && CHIP_NO_ERROR == TLVUnpackError && 3 == validArgumentCount)
{
wasHandled = emberAfNetworkCommissioningClusterEnableNetworkCallback(aEndpointId, apCommandObj, networkID, breadcrumb, timeoutMs);
        }
            break;
        }
...
if (CHIP_END_OF_TLV == TLVError)
{
  ...
  TLVError = CHIP_NO_ERROR;
        ...
        if (CHIP_NO_ERROR == TLVError && CHIP_NO_ERROR == TLVUnpackError && 3 == validArgumentCount)
{
wasHandled = emberAfNetworkCommissioningClusterRemoveNetworkCallback(aEndpointId, apCommandObj, NetworkID, Breadcrumb, TimeoutMs);
        }
            break;
        }
...
if (CHIP_END_OF_TLV == TLVError)
{
  ...
  TLVError = CHIP_NO_ERROR;
        ...
        if (CHIP_NO_ERROR == TLVError && CHIP_NO_ERROR == TLVUnpackError && 3 == validArgumentCount)
{
wasHandled = emberAfNetworkCommissioningClusterScanNetworksCallback(aEndpointId, apCommandObj, ssid, breadcrumb, timeoutMs);
        }
            break;
        }
...
if (CHIP_END_OF_TLV == TLVError)
{
  ...
  TLVError = CHIP_NO_ERROR;
        ...
        if (CHIP_NO_ERROR == TLVError && CHIP_NO_ERROR == TLVUnpackError && 3 == validArgumentCount)
{
wasHandled = emberAfNetworkCommissioningClusterUpdateThreadNetworkCallback(aEndpointId, apCommandObj, operationalDataset, breadcrumb, timeoutMs);
        }
            break;
        }
...
if (CHIP_END_OF_TLV == TLVError)
{
  ...
  TLVError = CHIP_NO_ERROR;
        ...
        if (CHIP_NO_ERROR == TLVError && CHIP_NO_ERROR == TLVUnpackError && 4 == validArgumentCount)
{
wasHandled = emberAfNetworkCommissioningClusterUpdateWiFiNetworkCallback(aEndpointId, apCommandObj, ssid, credentials, breadcrumb, timeoutMs);
        }
            break;
        }
        default: {
...
if (CHIP_END_OF_TLV == TLVError)
{
  ...
  TLVError = CHIP_NO_ERROR;
        ...
        if (CHIP_NO_ERROR == TLVError && CHIP_NO_ERROR == TLVUnpackError && 4 == validArgumentCount)
{
wasHandled = emberAfOperationalCredentialsClusterAddNOCCallback(aEndpointId, apCommandObj, NOCArray, IPKValue, CaseAdminNode, AdminVendorId);
        }
            break;
        }
...
if (CHIP_END_OF_TLV == TLVError)
{
  ...
  TLVError = CHIP_NO_ERROR;
        ...
        if (CHIP_NO_ERROR == TLVError && CHIP_NO_ERROR == TLVUnpackError && 1 == validArgumentCount)
{
wasHandled = emberAfOperationalCredentialsClusterAddTrustedRootCertificateCallback(aEndpointId, apCommandObj, RootCertificate);
        }
            break;
        }
...
if (CHIP_END_OF_TLV == TLVError)
{
  ...
  TLVError = CHIP_NO_ERROR;
        ...
        if (CHIP_NO_ERROR == TLVError && CHIP_NO_ERROR == TLVUnpackError && 1 == validArgumentCount)
{
wasHandled = emberAfOperationalCredentialsClusterRemoveTrustedRootCertificateCallback(aEndpointId, apCommandObj, TrustedRootIdentifier);
        }
            break;
        }
...
if (CHIP_END_OF_TLV == TLVError)
{
  ...
  TLVError = CHIP_NO_ERROR;
        ...
        if (CHIP_NO_ERROR == TLVError && CHIP_NO_ERROR == TLVUnpackError && 1 == validArgumentCount)
{
wasHandled = emberAfOperationalCredentialsClusterUpdateFabricLabelCallback(aEndpointId, apCommandObj, const_cast<uint8_t*>(Label));
        }
            break;
        }
