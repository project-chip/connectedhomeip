...
#define GENERATED_DEFAULTS                                                                                                         \
    {                                                                                                                              \
        0x00, 0x00, 0x38, 0x40 /* 0,Default value: Poll Control,check-in interval */, 0x00, 0x00, 0x00,                            \
            0x14 /* 4,Default value: Poll Control,long poll interval */,                                                           \
    }
#else // ! BIGENDIAN_CPU
#define GENERATED_DEFAULTS                                                                                                         \
    {                                                                                                                              \
        0x40, 0x38, 0x00, 0x00 /* 0,Default value: Poll Control,check-in interval */, 0x14, 0x00, 0x00,                            \
            0x00 /* 4,Default value: Poll Control,long poll interval */,                                                           \
    }
#endif // BIGENDIAN_CPU
...
#define GENERATED_ATTRIBUTES                                                                                                       \
    {                                                                                                                              \
        {                                                                                                                          \
            ...
            {                                                                                                                      \
                0xFFFD, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (ATTRIBUTE_MASK_CLIENT), { (uint8_t *) 0x0001 }                              \
            }, /* 27 / Poll Control / cluster revision*/                                                                           \
            {                                                                                                                      \
                0x0000, ZCL_INT32U_ATTRIBUTE_TYPE, 4, (ATTRIBUTE_MASK_WRITABLE), { (uint8_t *) &(generatedDefaults[0]) }           \
            }, /* 28 / Poll Control / check-in interval*/                                                                          \
            {                                                                                                                      \
                0x0001, ZCL_INT32U_ATTRIBUTE_TYPE, 4, (0x00), { (uint8_t *) &(generatedDefaults[4]) }                              \
            },                                                                        /* 29 / Poll Control / long poll interval*/  \
            ...
            },                                                                        /* 31 / Poll Control / fast poll timeout*/   \
...
#define GENERATED_CLUSTERS                                                                                                         \
    {                                                                                                                              \
        {                                                                                                                          \
            ...
            {                                                                                                                      \
                0x0020,                                                                                                            \
                (EmberAfAttributeMetadata *) &(generatedAttributes[28]),                                                           \
                5,                                                                                                                 \
                14,                                                                                                                \
                (CLUSTER_MASK_SERVER | CLUSTER_MASK_INIT_FUNCTION | CLUSTER_MASK_ATTRIBUTE_CHANGED_FUNCTION |                      \
...
#define GENERATED_COMMANDS                                                                                                         \
    {                                                                                                                              \
        { 0x0000, 0x00, COMMAND_MASK_OUTGOING_CLIENT | COMMAND_MASK_INCOMING_SERVER },     /* Basic / ResetToFactoryDefaults */    \
            ...
            { 0x0020, 0x02,                                                                                                        \
              COMMAND_MASK_OUTGOING_CLIENT | COMMAND_MASK_INCOMING_SERVER }, /* Poll Control / SetLongPollInterval */              \
            { 0x0020, 0x03,                                                                                                        \
              COMMAND_MASK_OUTGOING_CLIENT | COMMAND_MASK_INCOMING_SERVER }, /* Poll Control / SetShortPollInterval */             \
