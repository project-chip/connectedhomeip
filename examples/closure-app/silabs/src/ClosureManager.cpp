...
void ClosureManager::Init()
{
    ...
    SuccessOrDie(mClosurePanelEndpoint2.Init(conformance2, clusterInitParameters2));
    ...
    SuccessOrDie(mClosurePanelEndpoint3.Init(conformance3, clusterInitParameters3));
