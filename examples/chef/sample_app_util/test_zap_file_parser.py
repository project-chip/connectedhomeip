...
class TestZapFileParser(unittest.TestCase):
    ...
    def test_generate_hash(self):
        ...
        self.assertEqual(hash_string, "qylN80BBnO", "Hash is incorrectly generated.")
    ...
    def test_generate_metadata_file(self):
        ...
        zap_file_parser.generate_hash_metadata_file(_TEST_FILE)
    ...
    def test_generate_name(self):
        ...
        self.assertEqual(name, "rootnode_dimmablelight_qylN80BBnO", "Name incorrectly generated.")
