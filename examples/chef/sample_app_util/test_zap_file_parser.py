...
class TestZapFileParser(unittest.TestCase):
    ...
    def test_generate_hash(self):
        ...
        self.assertEqual(hash_string, "iKZjTaJhIY", "Hash is incorrectly generated.")
    ...
    def test_generate_name(self):
        ...
        self.assertEqual(name, "rootnode_dimmablelight_iKZjTaJhIY", "Name incorrectly generated.")
