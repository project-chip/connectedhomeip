...
[^hash_note]:
    ...
    have other uses in the naming. 3) Platform specific attributes are omitted
    from the hash. E.g. networking_commissioning feature map. This is to make
    the hashes platform agnostic
