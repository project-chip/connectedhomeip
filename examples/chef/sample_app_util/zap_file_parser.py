...
def generate_metadata(
    ...
    for endpoint in app_data["endpointTypes"]:
        ...
        for cluster in endpoint["clusters"]:
            ...
            # Remove platform specific cluster/feature maps
            if not include_platform_specific_info:
                if str(cluster["code"]) == _NETWORK_COMMISSIONING_CODE:
                    for attribute in list(cluster_obj["attributes"].keys()):
                        if _get_id(attribute) == _FEATURE_MAP_CODE:
                            del cluster_obj["attributes"][attribute]
