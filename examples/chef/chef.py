    ...
    if options.do_build:
        ...
        if options.build_target == "esp32":
            ...
            if config['ameba']['MODEL'] == 'D':
                ...
                with open(
                        f"{config['ameba']['AMEBA_SDK']}/project/realtek_amebaz2_v0_example/GCC-RELEASE/project_include.mk",
                        "w") as f:
                    f.write(textwrap.dedent(f"""\
        ...
        if options.build_target == "esp32":
            ...
            if config['ameba']['MODEL'] == 'D':
                ...
                shell.run_cmd(
                    ...
                    f"/project/realtek_amebaD_va0_example/GCC-RELEASE/out", raise_on_returncode=False)
            else:
                shell.run_cmd(f"cd {_CHEF_SCRIPT_PATH}/ameba")
                shell.run_cmd(
                ...
                shell.run_cmd(
                    ...
                    f"{config['ameba']['TTY']} {config['ameba']['AMEBA_SDK']}"
                    f"/project/realtek_amebaz2_v0_example/GCC-RELEASE/application_is/Debug/bin", raise_on_returncode=False)
