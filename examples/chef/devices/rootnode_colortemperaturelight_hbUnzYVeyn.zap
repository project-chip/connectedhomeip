    ...
    },
    {
      ...
      "clusters": [
        ...
        },
        {
          ...
          "attributes": [
            "   code    | mfgCode |  side  | storageOption | singleton | bounded |     defaultValue     | reportable |     minInterval     |     maxInterval     |   reportableChange",
            "    0x0002 |         | server |           RAM |           |         |               0x0000 |          1 |                   1 |               65534 |                     => RemainingTime [int16u]",
            "    0x0007 |         | server |           RAM |           |         |               0x00FA |          1 |                   1 |               65534 |                     => ColorTemperatureMireds [int16u]",
            "    0x0008 |         | server |           RAM |           |         |                 0x02 |          1 |                   1 |               65534 |                     => ColorMode [enum8]",
            ...
            "    0x4000 |         | server |           RAM |           |         |               0x0000 |          1 |                   1 |               65534 |                     => EnhancedCurrentHue [int16u]",
            "    0x4001 |         | server |           RAM |           |         |                 0x02 |          1 |                   1 |               65534 |                     => EnhancedColorMode [enum8]",
            "    0x400a |         | server |           RAM |           |         |               0x0000 |          1 |                   1 |               65534 |                     => ColorCapabilities [bitmap16]",
            "    0x400b |         | server |           RAM |           |         |               0x0000 |          1 |                   1 |               65534 |                     => ColorTempPhysicalMinMireds [int16u]",
            ...
            "    0xfff9 |         | server |           Ext |           |         |                      |          1 |                   1 |               65534 |                     => AcceptedCommandList [array]",
            "    0xfffb |         | server |           Ext |           |         |                      |          1 |                   1 |               65534 |                     => AttributeList [array]",
            "    0xfffc |         | server |           RAM |           |         |               0x0010 |          1 |                   1 |               65534 |                     => FeatureMap [bitmap32]",
