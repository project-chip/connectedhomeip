      ...
      "clusters": [
        ...
        },
        {
          ...
          "attributes": [
            ...
            "    0x0006 |         | server |           RAM |           |         |                 3000 |          1 |                   1 |               65534 |                     => AbsMaxCoolSetpointLimit [int16s]",
            "    0x0011 |         | server |           RAM |           |         |                 2600 |          1 |                   1 |               65534 |                     => OccupiedCoolingSetpoint [int16s]",
            "    0x0017 |         | server |           RAM |           |         |                 1600 |          1 |                   1 |               65534 |                     => MinCoolSetpointLimit [int16s]",
            "    0x0018 |         | server |           RAM |           |         |                 3000 |          1 |                   1 |               65534 |                     => MaxCoolSetpointLimit [int16s]",
            "    0x001b |         | server |           RAM |           |         |                 0x00 |          1 |                   1 |               65534 |                     => ControlSequenceOfOperation [ThermostatControlSequence]",
            "    0x001c |         | server |           RAM |           |         |                 0x03 |          1 |                   1 |               65534 |                     => SystemMode [enum8]",
            "    0xfff8 |         | server |           Ext |           |         |                      |          1 |                   1 |               65534 |                     => GeneratedCommandList [array]",
            "    0xfff9 |         | server |           Ext |           |         |                      |          1 |                   1 |               65534 |                     => AcceptedCommandList [array]",
            "    0xfffa |         | server |           Ext |           |         |                      |          1 |                   1 |               65534 |                     => EventList [array]",
            "    0xfffb |         | server |           Ext |           |         |                      |          1 |                   1 |               65534 |                     => AttributeList [array]",
        ...
        },
        {
          ...
          "attributes": [
            "   code    | mfgCode |  side  | storageOption | singleton | bounded |     defaultValue     | reportable |     minInterval     |     maxInterval     |   reportableChange",
            "    0x0000 |         | server |           RAM |           |         |                 0x01 |          1 |                   1 |               65534 |                     => TemperatureDisplayMode [enum8]",
