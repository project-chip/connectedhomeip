      ...
      "clusters": [
        ...
        },
        {
          ...
          "attributes": [
            ...
            "    0x0010 |         | server |           RAM |           |         |                    0 |          1 |                   1 |               65534 |                     => NumberOfPrimaries [int8u]",
            "    0x4000 |         | server |           RAM |           |         |               0x0000 |          1 |                   1 |               65534 |                     => EnhancedCurrentHue [int16u]",
            "    0x4001 |         | server |           RAM |           |         |                 0x01 |          1 |                   1 |               65534 |                     => EnhancedColorMode [enum8]",
            "    0x4002 |         | server |           RAM |           |         |                 0x00 |          1 |                   1 |               65534 |                     => ColorLoopActive [int8u]",
            "    0x4003 |         | server |           RAM |           |         |                 0x00 |          1 |                   1 |               65534 |                     => ColorLoopDirection [int8u]",
            "    0x4004 |         | server |           RAM |           |         |               0x0019 |          1 |                   1 |               65534 |                     => ColorLoopTime [int16u]",
            "    0x4005 |         | server |           RAM |           |         |               0x2300 |          1 |                   1 |               65534 |                     => ColorLoopStartEnhancedHue [int16u]",
            "    0x4006 |         | server |           RAM |           |         |               0x0000 |          1 |                   1 |               65534 |                     => ColorLoopStoredEnhancedHue [int16u]",
            ...
            "    0x400d |         | server |           RAM |           |         |               0x0000 |          1 |                   1 |               65534 |                     => CoupleColorTempToLevelMinMireds [int16u]",
            "    0x4010 |         | server |           RAM |           |         |                    0 |          1 |                   1 |               65534 |                     => StartUpColorTemperatureMireds [int16u]",
            "    0xfff8 |         | server |           Ext |           |         |                    0 |          1 |                   1 |               65534 |                     => GeneratedCommandList [array]",
            "    0xfff9 |         | server |           Ext |           |         |                    0 |          1 |                   1 |               65534 |                     => AcceptedCommandList [array]",
            "    0xfffb |         | server |           Ext |           |         |                    0 |          1 |                   1 |               65534 |                     => AttributeList [array]",
