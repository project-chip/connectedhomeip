    ...
    },
    {
      ...
      "clusters": [
        ...
        },
        {
          ...
          "attributes": [
            "   code    | mfgCode |  side  | storageOption | singleton | bounded |     defaultValue     | reportable |     minInterval     |     maxInterval     |   reportableChange",
            "    0x0000 |         | server |           RAM |           |         |                 2000 |          1 |                   1 |               65534 |                     => LocalTemperature [int16s]",
            "    0x0001 |         | server |           RAM |           |         |                 2000 |          1 |                   1 |               65534 |                     => OutdoorTemperature [int16s]",
            "    0x0002 |         | server |           RAM |           |         |                 0x01 |          1 |                   1 |               65534 |                     => Occupancy [bitmap8]",
            "    0x0003 |         | server |           RAM |           |         |                  700 |          1 |                   1 |               65534 |                     => AbsMinHeatSetpointLimit [int16s]",
            "    0x0004 |         | server |           RAM |           |         |                 3000 |          1 |                   1 |               65534 |                     => AbsMaxHeatSetpointLimit [int16s]",
            "    0x0005 |         | server |           RAM |           |         |                 1600 |          1 |                   1 |               65534 |                     => AbsMinCoolSetpointLimit [int16s]",
            "    0x0006 |         | server |           RAM |           |         |                 3200 |          1 |                   1 |               65534 |                     => AbsMaxCoolSetpointLimit [int16s]",
            "    0x0007 |         | server |           RAM |           |         |                    0 |          1 |                   1 |               65534 |                     => PICoolingDemand [int8u]",
            "    0x0008 |         | server |           RAM |           |         |                    0 |          1 |                   1 |               65534 |                     => PIHeatingDemand [int8u]",
            "    0x0009 |         | server |           RAM |           |         |                 0x00 |          1 |                   1 |               65534 |                     => HVACSystemTypeConfiguration [bitmap8]",
            "    0x0010 |         | server |           RAM |           |         |                    0 |          1 |                   1 |               65534 |                     => LocalTemperatureCalibration [int8s]",
            "    0x0011 |         | server |           RAM |           |         |               0x0A28 |          1 |                   1 |               65534 |                     => OccupiedCoolingSetpoint [int16s]",
            "    0x0012 |         | server |           RAM |           |         |               0x07D0 |          1 |                   1 |               65534 |                     => OccupiedHeatingSetpoint [int16s]",
            "    0x0013 |         | server |           RAM |           |         |               0x0A28 |          1 |                   1 |               65534 |                     => UnoccupiedCoolingSetpoint [int16s]",
            "    0x0014 |         | server |           RAM |           |         |               0x07D0 |          1 |                   1 |               65534 |                     => UnoccupiedHeatingSetpoint [int16s]",
            "    0x0015 |         | server |           RAM |           |         |                  700 |          1 |                   1 |               65534 |                     => MinHeatSetpointLimit [int16s]",
            "    0x0016 |         | server |           RAM |           |         |                 3000 |          1 |                   1 |               65534 |                     => MaxHeatSetpointLimit [int16s]",
            "    0x0017 |         | server |           RAM |           |         |                 1600 |          1 |                   1 |               65534 |                     => MinCoolSetpointLimit [int16s]",
            "    0x0018 |         | server |           RAM |           |         |                 3200 |          1 |                   1 |               65534 |                     => MaxCoolSetpointLimit [int16s]",
            "    0x0019 |         | server |           RAM |           |         |                 0x19 |          1 |                   1 |               65534 |                     => MinSetpointDeadBand [int8s]",
            "    0x001a |         | server |           RAM |           |         |                 0x00 |          1 |                   1 |               65534 |                     => RemoteSensing [bitmap8]",
            "    0x001b |         | server |           RAM |           |         |                 0x04 |          1 |                   1 |               65534 |                     => ControlSequenceOfOperation [ThermostatControlSequence]",
            "    0x001c |         | server |           RAM |           |         |                 0x01 |          1 |                   1 |               65534 |                     => SystemMode [enum8]",
            "    0x001e |         | server |           RAM |           |         |                    0 |          1 |                   1 |               65534 |                     => ThermostatRunningMode [enum8]",
            "    0x0020 |         | server |           RAM |           |         |                    0 |          1 |                   1 |               65534 |                     => StartOfWeek [enum8]",
            "    0x0021 |         | server |           RAM |           |         |                    0 |          1 |                   1 |               65534 |                     => NumberOfWeeklyTransitions [int8u]",
            "    0x0022 |         | server |           RAM |           |         |                    0 |          1 |                   1 |               65534 |                     => NumberOfDailyTransitions [int8u]",
            "    0xfff8 |         | server |           Ext |           |         |                    0 |          1 |                   1 |               65534 |                     => GeneratedCommandList [array]",
            "    0xfff9 |         | server |           Ext |           |         |                    0 |          1 |                   1 |               65534 |                     => AcceptedCommandList [array]",
            "    0xfffb |         | server |           Ext |           |         |                    0 |          1 |                   1 |               65534 |                     => AttributeList [array]",
        ...
        },
        {
          ...
          "attributes": [
            "   code    | mfgCode |  side  | storageOption | singleton | bounded |     defaultValue     | reportable |     minInterval     |     maxInterval     |   reportableChange",
            "    0xfffc |         | client |           RAM |           |         |                    f |          1 |                   1 |               65534 |                     => FeatureMap [bitmap32]",
            "    0xfffd |         | client |           RAM |           |         |                    1 |          1 |                   1 |               65534 |                     => ClusterRevision [int16u]"
          ]
        },
        {
