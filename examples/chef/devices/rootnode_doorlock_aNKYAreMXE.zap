  ...
  "endpointTypes": [
    {
      ...
      "clusters": [
        ...
        },
        {
          ...
          "attributes": [
            "   code    | mfgCode |  side  | storageOption | singleton | bounded |     defaultValue     | reportable |     minInterval     |     maxInterval     |   reportableChange",
            "    0xfffd |         | client |           RAM |           |         |               0x0001 |          1 |                     |               65344 |                     => ClusterRevision [int16u]"
          ]
        },
        {
          ...
          "attributes": [
            "   code    | mfgCode |  side  | storageOption | singleton | bounded |     defaultValue     | reportable |     minInterval     |     maxInterval     |   reportableChange",
            "    0x0000 |         | server |           Ext |           |         |                      |          1 |                   1 |               65534 |                     => DefaultOTAProviders [array]",
        ...
        },
        {
          ...
          "attributes": [
            ...
            "    0xfffc |         | server |           RAM |           |         |                    6 |          1 |                   1 |               65534 |                     => FeatureMap [bitmap32]",
    ...
    },
    {
      ...
      "clusters": [
        ...
        },
        {
          ...
          "attributes": [
            "   code    | mfgCode |  side  | storageOption | singleton | bounded |     defaultValue     | reportable |     minInterval     |     maxInterval     |   reportableChange",
            "    0x0000 |         | server |           RAM |           |         |                    0 |          1 |                   1 |               65534 |                     => NameSupport [NameSupportBitmap]",
            "    0xfff8 |         | server |           Ext |           |         |                    0 |          1 |                   1 |               65534 |                     => GeneratedCommandList [array]",
            "    0xfff9 |         | server |           Ext |           |         |                    0 |          1 |                   1 |               65534 |                     => AcceptedCommandList [array]",
            "    0xfffb |         | server |           Ext |           |         |                    0 |          1 |                   1 |               65534 |                     => AttributeList [array]",
            "    0xfffc |         | server |           RAM |           |         |                    0 |          1 |                   1 |               65534 |                     => FeatureMap [bitmap32]",
        ...
        },
        {
          ...
          "attributes": [
            "   code    | mfgCode |  side  | storageOption | singleton | bounded |     defaultValue     | reportable |     minInterval     |     maxInterval     |   reportableChange",
            "    0x0000 |         | server |           RAM |           |         |                    1 |          1 |                   1 |               65534 |                     => LockState [DlLockState]",
            "    0x0001 |         | server |           RAM |           |         |                    0 |          1 |                   1 |               65534 |                     => LockType [DlLockType]",
            "    0x0002 |         | server |           RAM |           |         |                    0 |          1 |                   1 |               65534 |                     => ActuatorEnabled [boolean]",
            "    0x0011 |         | server |           RAM |           |         |                    2 |          1 |                   1 |               65534 |                     => NumberOfTotalUsersSupported [int16u]",
            "    0x0012 |         | server |           RAM |           |         |                    2 |          1 |                   1 |               65534 |                     => NumberOfPINUsersSupported [int16u]",
            "    0x0017 |         | server |           RAM |           |         |                   10 |          1 |                   1 |               65534 |                     => MaxPINCodeLength [int8u]",
            "    0x0018 |         | server |           RAM |           |         |                    5 |          1 |                   1 |               65534 |                     => MinPINCodeLength [int8u]",
            "    0x001c |         | server |           RAM |           |         |                    5 |          1 |                   1 |               65534 |                     => NumberOfCredentialsSupportedPerUser [int8u]",
            "    0x0023 |         | server |           RAM |           |         |                    0 |          1 |                   1 |               65534 |                     => AutoRelockTime [int32u]",
            "    0x0025 |         | server |           RAM |           |         |                    0 |          1 |                   1 |               65534 |                     => OperatingMode [OperatingModeEnum]",
            "    0x0026 |         | server |           RAM |           |         |               0xFFF6 |          1 |                   1 |               65534 |                     => SupportedOperatingModes [DlSupportedOperatingModes]",
            "    0x0030 |         | server |           RAM |           |         |                    3 |          1 |                   1 |               65534 |                     => WrongCodeEntryLimit [int8u]",
            "    0x0031 |         | server |           RAM |           |         |                   10 |          1 |                   1 |               65534 |                     => UserCodeTemporaryDisableTime [int8u]",
            "    0x0032 |         | server |           RAM |           |         |                    0 |          1 |                   1 |               65534 |                     => SendPINOverTheAir [boolean]",
            "    0x0033 |         | server |           RAM |           |         |                    1 |          1 |                   1 |               65534 |                     => RequirePINforRemoteOperation [boolean]",
            "    0xfff8 |         | server |           Ext |           |         |                    0 |          1 |                   1 |               65534 |                     => GeneratedCommandList [array]",
            "    0xfff9 |         | server |           Ext |           |         |                    0 |          1 |                   1 |               65534 |                     => AcceptedCommandList [array]",
            "    0xfffb |         | server |           Ext |           |         |                    0 |          1 |                   1 |               65534 |                     => AttributeList [array]",
            "    0xfffc |         | server |           RAM |           |         |               0x0181 |          1 |                   1 |               65534 |                     => FeatureMap [bitmap32]",
