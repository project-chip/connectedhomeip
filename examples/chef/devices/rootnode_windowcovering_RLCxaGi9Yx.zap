    ...
    },
    {
      ...
      "clusters": [
        ...
        },
        {
          ...
          "attributes": [
            "   code    | mfgCode |  side  | storageOption | singleton | bounded |     defaultValue     | reportable |     minInterval     |     maxInterval     |   reportableChange",
            "    0x0000 |         | server |           RAM |           |         |                    8 |          1 |                   1 |               65534 |                     => Type [Type]",
            "    0x0001 |         | server |           RAM |           |         |               0x0000 |          1 |                   1 |               65534 |                     => PhysicalClosedLimitLift [int16u]",
            "    0x0002 |         | server |           RAM |           |         |               0x0000 |          1 |                   1 |               65534 |                     => PhysicalClosedLimitTilt [int16u]",
            "    0x0003 |         | server |           RAM |           |         |                    0 |          1 |                   1 |               65534 |                     => CurrentPositionLift [int16u]",
            "    0x0004 |         | server |           RAM |           |         |                    0 |          1 |                   1 |               65534 |                     => CurrentPositionTilt [int16u]",
            "    0x0005 |         | server |           RAM |           |         |               0x0000 |          1 |                   1 |               65534 |                     => NumberOfActuationsLift [int16u]",
            "    0x0006 |         | server |           RAM |           |         |               0x0000 |          1 |                   1 |               65534 |                     => NumberOfActuationsTilt [int16u]",
            "    0x0007 |         | server |           RAM |           |         |                 0x19 |          1 |                   1 |               65534 |                     => ConfigStatus [ConfigStatus]",
            "    0x0008 |         | server |           RAM |           |         |                    0 |          1 |                   1 |               65534 |                     => CurrentPositionLiftPercentage [Percent]",
            "    0x0009 |         | server |           RAM |           |         |                    0 |          1 |                   1 |               65534 |                     => CurrentPositionTiltPercentage [Percent]",
            "    0x000a |         | server |           RAM |           |         |                 0x00 |          1 |                   1 |               65534 |                     => OperationalStatus [OperationalStatus]",
            "    0x000b |         | server |           RAM |           |         |                    0 |          1 |                   1 |               65534 |                     => TargetPositionLiftPercent100ths [Percent100ths]",
            "    0x000c |         | server |           RAM |           |         |                    0 |          1 |                   1 |               65534 |                     => TargetPositionTiltPercent100ths [Percent100ths]",
            "    0x000d |         | server |           RAM |           |         |                    8 |          1 |                   1 |               65534 |                     => EndProductType [EndProductType]",
            "    0x000e |         | server |           RAM |           |         |                    0 |          1 |                   1 |               65534 |                     => CurrentPositionLiftPercent100ths [Percent100ths]",
            "    0x000f |         | server |           RAM |           |         |                    0 |          1 |                   1 |               65534 |                     => CurrentPositionTiltPercent100ths [Percent100ths]",
            "    0x0010 |         | server |           RAM |           |         |                    0 |          1 |                   1 |               65534 |                     => InstalledOpenLimitLift [int16u]",
            "    0x0011 |         | server |           RAM |           |         |                65534 |          1 |                   1 |               65534 |                     => InstalledClosedLimitLift [int16u]",
            "    0x0012 |         | server |           RAM |           |         |                    0 |          1 |                   1 |               65534 |                     => InstalledOpenLimitTilt [int16u]",
            "    0x0013 |         | server |           RAM |           |         |                 1800 |          1 |                   1 |               65534 |                     => InstalledClosedLimitTilt [int16u]",
            "    0x0017 |         | server |           RAM |           |         |                 0x00 |          1 |                   1 |               65534 |                     => Mode [Mode]",
            "    0x001a |         | server |           RAM |           |         |               0x0000 |          1 |                   1 |               65534 |                     => SafetyStatus [SafetyStatus]",
            "    0xfff8 |         | server |           Ext |           |         |                    0 |          1 |                   1 |               65534 |                     => GeneratedCommandList [array]",
            "    0xfff9 |         | server |           Ext |           |         |                    0 |          1 |                   1 |               65534 |                     => AcceptedCommandList [array]",
            "    0xfffb |         | server |           Ext |           |         |                    0 |          1 |                   1 |               65534 |                     => AttributeList [array]",
