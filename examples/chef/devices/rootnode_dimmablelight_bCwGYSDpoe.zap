      ...
      "clusters": [
        ...
        },
        {
          ...
          "attributes": [
            ...
            "    0x4003 |         | server |           RAM |           |         |                    0 |          1 |                   1 |               65534 |                     => StartUpOnOff [OnOffStartUpOnOff]",
            "    0xfff8 |         | server |           Ext |           |         |                    0 |          1 |                   1 |               65534 |                     => GeneratedCommandList [array]",
            "    0xfff9 |         | server |           Ext |           |         |                    0 |          1 |                   1 |               65534 |                     => AcceptedCommandList [array]",
            "    0xfffb |         | server |           Ext |           |         |                    0 |          1 |                   1 |               65534 |                     => AttributeList [array]",
        ...
        },
        {
          ...
          "attributes": [
            "   code    | mfgCode |  side  | storageOption | singleton | bounded |     defaultValue     | reportable |     minInterval     |     maxInterval     |   reportableChange",
            "    0x0000 |         | server |           RAM |           |         |                 0x01 |          1 |                   1 |               65534 |                     => CurrentLevel [int8u]",
            ...
            "    0x000f |         | server |           RAM |           |         |                 0x03 |          1 |                   1 |               65534 |                     => Options [LevelControlOptions]",
            "    0x0011 |         | server |           RAM |           |         |                 0xFE |          1 |                   1 |               65534 |                     => OnLevel [int8u]",
            "    0x4000 |         | server |           RAM |           |         |                 0x00 |          1 |                   1 |               65534 |                     => StartUpCurrentLevel [int8u]",
            "    0xfff8 |         | server |           Ext |           |         |                    0 |          1 |                   1 |               65534 |                     => GeneratedCommandList [array]",
            "    0xfff9 |         | server |           Ext |           |         |                    0 |          1 |                   1 |               65534 |                     => AcceptedCommandList [array]",
            "    0xfffb |         | server |           Ext |           |         |                    0 |          1 |                   1 |               65534 |                     => AttributeList [array]",
            "    0xfffc |         | server |           RAM |           |         |                 0x03 |          1 |                   1 |               65534 |                     => FeatureMap [bitmap32]",
            "    0xfffd |         | server |           RAM |           |         |                    5 |          1 |                   1 |               65534 |                     => ClusterRevision [int16u]"
          ]
        },
        {
