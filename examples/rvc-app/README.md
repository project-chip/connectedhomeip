...
todo once the [test plan issue](https://github.com/CHIP-Specifications/chip-test-plans/issues/4454) is resolved, 
add the required PIXIT and set the PICS`SEAR.S.M.VALID_STATE_FOR_SELECT_AREAS=1`.
PIXIT: ``
Example command:
