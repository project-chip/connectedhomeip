...
void RVCApp::DeviceCallbacks::PostAttributeChangeCallback(EndpointId endpointId, ClusterId clusterId, AttributeId attributeId,
...
RVCApp::DeviceCallbacks & RVCApp::DeviceCallbacks::GetDefaultInstance()
{
...
{
    return RVCApp::DeviceCallbacks::GetDefaultInstance();
}
