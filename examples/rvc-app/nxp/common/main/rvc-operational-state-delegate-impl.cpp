...
{
    // placeholder implementation
    switch (GetInstance()->GetCurrentOperationalState())
    {
    ...
    case to_underlying(RvcOperationalState::OperationalStateEnum::kDocked): {
        if (RvcRunMode::Instance()->GetCurrentMode() != RvcRunMode::ModeCleaning &&
            RvcRunMode::Instance()->GetCurrentMode() != RvcRunMode::ModeMapping)
        {
...
void RvcOperationalStateDelegate::HandleGoHomeCommandCallback(OperationalState::GenericOperationalError & err)
{
    ...
    case to_underlying(RvcOperationalState::OperationalStateEnum::kCharging):
    case to_underlying(RvcOperationalState::OperationalStateEnum::kDocked):
    case to_underlying(RvcOperationalState::OperationalStateEnum::kError): {
        err.Set(to_underlying(OperationalState::ErrorStateEnum::kCommandInvalidInState));
        return;
    }
    break;
