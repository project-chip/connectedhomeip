...
void LightingApp::DeviceCallbacks::PostAttributeChangeCallback(EndpointId endpointId, ClusterId clusterId, AttributeId attributeId,
...
LightingApp::DeviceCallbacks & LightingApp::DeviceCallbacks::GetDefaultInstance()
{
...
{
    return LightingApp::DeviceCallbacks::GetDefaultInstance();
}
