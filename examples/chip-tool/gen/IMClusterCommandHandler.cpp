...
{
    {
        ...
        case ZCL_GET_SETUP_PIN_RESPONSE_COMMAND_ID: {
            ...
            while ((TLVError = dataTlv.Next()) == CHIP_NO_ERROR)
            {
                ...
                {
                case 0:
                    TLVError = dataTlv.GetDataPtr(setupPIN);
                    break;
                default:
        ...
        default: {
            ...
            ChipLogError(Zcl, "Unknown command %" PRIx16 " for cluster %" PRIx16, commandId, ZCL_ACCOUNT_LOGIN_CLUSTER_ID);
            break;
        }
        }
    }
...
{
    {
        ...
        case ZCL_CHANGE_CHANNEL_RESPONSE_COMMAND_ID: {
            ...
            while ((TLVError = dataTlv.Next()) == CHIP_NO_ERROR)
            {
                ...
                case 0:
                    // Just for compatibility, we will add array type support in IM later.
                    TLVError = dataTlv.GetDataPtr(const_cast<const uint8_t *&>(ChannelMatch));
                    break;
                case 1:
                    TLVError = dataTlv.Get(ErrorType);
                    break;
                default:
                    // Unsupported tag, ignore it.
                    ChipLogProgress(Zcl, "Unknown TLV tag during processing.");
