            ...
            case 0x48: // array / Array
            {
                ...
                case 0xFC03:
                    ...
                    case 0x0000: // FabricDescriptor
                    {
                        ...
                        Callback::Callback<FabricFabricsListListAttributeCallback> * cb =
                            Callback::Callback<FabricFabricsListListAttributeCallback>::FromCancelable(onSuccessCallback);
                        cb->mCall(cb->mContext, count, data);
                        break;
                    }
                    }
...
bool emberAfFabricClusterGetFabricIdResponseCallback(chip::FabricId fabricId)
{
    ...
    Callback::Callback<FabricClusterGetFabricIdResponseCallback> * cb =
        Callback::Callback<FabricClusterGetFabricIdResponseCallback>::FromCancelable(onSuccessCallback);
