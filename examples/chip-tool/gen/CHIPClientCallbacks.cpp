...
bool emberAfOperationalCredentialsClusterGetFabricIdResponseCallback(chip::FabricId FabricId)
{
    ...
    Callback::Callback<OperationalCredentialsClusterGetFabricIdResponseCallback> * cb = Callback::Callback<OperationalCredentialsClusterGetFabricIdResponseCallback>::FromCancelable(onSuccessCallback);
