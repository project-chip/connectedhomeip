...
EmberAfStatus emberAfAccountLoginClusterClientCommandParse(EmberAfClusterCommand * cmd)
{
    ...
    if (!cmd->mfgSpecific)
    {
        ...
        case ZCL_GET_SETUP_PIN_RESPONSE_COMMAND_ID: {
            ...
            wasHandled = emberAfAccountLoginClusterGetSetupPINResponseCallback(setupPIN);
            break;
        }
        default: {
...
EmberAfStatus emberAfApplicationLauncherClusterClientCommandParse(EmberAfClusterCommand * cmd)
{
    ...
    if (!cmd->mfgSpecific)
    {
        ...
        case ZCL_LAUNCH_APP_RESPONSE_COMMAND_ID: {
            ...
            wasHandled = emberAfApplicationLauncherClusterLaunchAppResponseCallback(status, data);
            break;
        }
        default: {
            // Unrecognized command ID, error status will apply.
...
EmberAfStatus emberAfContentLaunchClusterClientCommandParse(EmberAfClusterCommand * cmd)
{
    ...
    if (!cmd->mfgSpecific)
    {
        ...
        case ZCL_LAUNCH_CONTENT_RESPONSE_COMMAND_ID: {
            ...
            wasHandled = emberAfContentLaunchClusterLaunchContentResponseCallback(data, contentLaunchStatus);
            break;
        }
        case ZCL_LAUNCH_URL_RESPONSE_COMMAND_ID: {
            ...
            wasHandled = emberAfContentLaunchClusterLaunchURLResponseCallback(data, contentLaunchStatus);
            break;
        }
        default: {
            // Unrecognized command ID, error status will apply.
...
EmberAfStatus emberAfKeypadInputClusterClientCommandParse(EmberAfClusterCommand * cmd)
{
    ...
    if (!cmd->mfgSpecific)
    {
        ...
        case ZCL_SEND_KEY_RESPONSE_COMMAND_ID: {
            ...
            wasHandled = emberAfKeypadInputClusterSendKeyResponseCallback(status);
            break;
        }
        default: {
            // Unrecognized command ID, error status will apply.
...
EmberAfStatus emberAfMediaPlaybackClusterClientCommandParse(EmberAfClusterCommand * cmd)
{
    ...
    if (!cmd->mfgSpecific)
    {
        ...
        case ZCL_MEDIA_FAST_FORWARD_RESPONSE_COMMAND_ID: {
            ...
            wasHandled = emberAfMediaPlaybackClusterMediaFastForwardResponseCallback(mediaPlaybackStatus);
            break;
        }
        case ZCL_MEDIA_NEXT_RESPONSE_COMMAND_ID: {
            ...
            wasHandled = emberAfMediaPlaybackClusterMediaNextResponseCallback(mediaPlaybackStatus);
            break;
        }
        case ZCL_MEDIA_PAUSE_RESPONSE_COMMAND_ID: {
            ...
            wasHandled = emberAfMediaPlaybackClusterMediaPauseResponseCallback(mediaPlaybackStatus);
            break;
        }
        case ZCL_MEDIA_PLAY_RESPONSE_COMMAND_ID: {
            ...
            wasHandled = emberAfMediaPlaybackClusterMediaPlayResponseCallback(mediaPlaybackStatus);
            break;
        }
        case ZCL_MEDIA_PREVIOUS_RESPONSE_COMMAND_ID: {
            ...
            wasHandled = emberAfMediaPlaybackClusterMediaPreviousResponseCallback(mediaPlaybackStatus);
            break;
        }
        case ZCL_MEDIA_REWIND_RESPONSE_COMMAND_ID: {
            ...
            wasHandled = emberAfMediaPlaybackClusterMediaRewindResponseCallback(mediaPlaybackStatus);
            break;
        }
        case ZCL_MEDIA_SKIP_BACKWARD_RESPONSE_COMMAND_ID: {
            ...
            wasHandled = emberAfMediaPlaybackClusterMediaSkipBackwardResponseCallback(mediaPlaybackStatus);
            break;
        }
        case ZCL_MEDIA_SKIP_FORWARD_RESPONSE_COMMAND_ID: {
            ...
            wasHandled = emberAfMediaPlaybackClusterMediaSkipForwardResponseCallback(mediaPlaybackStatus);
            break;
        }
        case ZCL_MEDIA_SKIP_SEEK_RESPONSE_COMMAND_ID: {
            ...
            wasHandled = emberAfMediaPlaybackClusterMediaSkipSeekResponseCallback(mediaPlaybackStatus);
            break;
        }
        case ZCL_MEDIA_START_OVER_RESPONSE_COMMAND_ID: {
            ...
            wasHandled = emberAfMediaPlaybackClusterMediaStartOverResponseCallback(mediaPlaybackStatus);
            break;
        }
        case ZCL_MEDIA_STOP_RESPONSE_COMMAND_ID: {
            ...
            wasHandled = emberAfMediaPlaybackClusterMediaStopResponseCallback(mediaPlaybackStatus);
            break;
        }
        default: {
            // Unrecognized command ID, error status will apply.
...
EmberAfStatus emberAfTvChannelClusterClientCommandParse(EmberAfClusterCommand * cmd)
{
    ...
    if (!cmd->mfgSpecific)
    {
        ...
        case ZCL_CHANGE_CHANNEL_RESPONSE_COMMAND_ID: {
            ...
            wasHandled = emberAfTvChannelClusterChangeChannelResponseCallback(ChannelMatch, ErrorType);
            break;
        }
        default: {
            // Unrecognized command ID, error status will apply.
...
EmberAfStatus emberAfTargetNavigatorClusterClientCommandParse(EmberAfClusterCommand * cmd)
{
    ...
    if (!cmd->mfgSpecific)
    {
        ...
        case ZCL_NAVIGATE_TARGET_RESPONSE_COMMAND_ID: {
            ...
            wasHandled = emberAfTargetNavigatorClusterNavigateTargetResponseCallback(status, data);
            break;
        }
        default: {
            // Unrecognized command ID, error status will apply.
...
EmberAfStatus emberAfThermostatClusterClientCommandParse(EmberAfClusterCommand * cmd)
{
    ...
    if (!cmd->mfgSpecific)
    {
        ...
        case ZCL_CURRENT_WEEKLY_SCHEDULE_COMMAND_ID: {
            ...
            wasHandled = emberAfThermostatClusterCurrentWeeklyScheduleCallback(numberOfTransitionsForSequence, dayOfWeekForSequence,
        ...
        case ZCL_RELAY_STATUS_LOG_COMMAND_ID: {
            ...
            wasHandled = emberAfThermostatClusterRelayStatusLogCallback(timeOfDay, relayStatus, localTemperature,
