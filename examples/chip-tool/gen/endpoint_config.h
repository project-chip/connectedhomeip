...
#define GENERATED_ATTRIBUTES { \
  ...
  { 0xFFFD, ZAP_TYPE(INT16U), 2, ZAP_ATTRIBUTE_MASK(CLIENT), { (uint8_t *) 0x0001 } }, /* Low Power (client): cluster revision */  \
...
#define GENERATED_CLUSTERS { \
  ...
  { 0x0200, ZAP_ATTRIBUTE_INDEX(9), 1, 2, ZAP_CLUSTER_MASK(CLIENT), NULL }, /* Endpoint: 1, Cluster: Pump Configuration and Control (client) */ \
  ...
  { 0xF001, ZAP_ATTRIBUTE_INDEX(15), 1, 2, ZAP_CLUSTER_MASK(CLIENT), NULL }, /* Endpoint: 1, Cluster: Media Playback (client) */ \
  { 0xF002, ZAP_ATTRIBUTE_INDEX(16), 1, 2, ZAP_CLUSTER_MASK(CLIENT), NULL }, /* Endpoint: 1, Cluster: Content Launch (client) */ \
}
