...
#define GENERATED_ATTRIBUTES { \
  ...
  { 0xFFFD, ZAP_TYPE(INT16U), 2, ZAP_ATTRIBUTE_MASK(CLIENT), ZAP_SIMPLE_DEFAULT(0x0001) }, /* Wake on LAN (client): cluster revision */  \
  { 0xFFFD, ZAP_TYPE(INT16U), 2, ZAP_ATTRIBUTE_MASK(CLIENT), ZAP_SIMPLE_DEFAULT(0x0001) }, /* TV Channel (client): cluster revision */  \
  { 0xFFFD, ZAP_TYPE(INT16U), 2, ZAP_ATTRIBUTE_MASK(CLIENT), ZAP_SIMPLE_DEFAULT(0x0001) }, /* Target Navigator (client): cluster revision */  \
  { 0xFFFD, ZAP_TYPE(INT16U), 2, ZAP_ATTRIBUTE_MASK(CLIENT), ZAP_SIMPLE_DEFAULT(0x0001) }, /* Media Playback (client): cluster revision */  \
  { 0xFFFD, ZAP_TYPE(INT16U), 2, ZAP_ATTRIBUTE_MASK(CLIENT), ZAP_SIMPLE_DEFAULT(0x0001) }, /* Media Input (client): cluster revision */  \
  { 0xFFFD, ZAP_TYPE(INT16U), 2, ZAP_ATTRIBUTE_MASK(CLIENT), ZAP_SIMPLE_DEFAULT(0x0001) }, /* Low Power (client): cluster revision */  \
  { 0xFFFD, ZAP_TYPE(INT16U), 2, ZAP_ATTRIBUTE_MASK(CLIENT), ZAP_SIMPLE_DEFAULT(0x0001) }, /* Keypad Input (client): cluster revision */  \
  { 0xFFFD, ZAP_TYPE(INT16U), 2, ZAP_ATTRIBUTE_MASK(CLIENT), ZAP_SIMPLE_DEFAULT(0x0001) }, /* Content Launch (client): cluster revision */  \
  { 0xFFFD, ZAP_TYPE(INT16U), 2, ZAP_ATTRIBUTE_MASK(CLIENT), ZAP_SIMPLE_DEFAULT(0x0001) }, /* Audio Output (client): cluster revision */  \
  { 0xFFFD, ZAP_TYPE(INT16U), 2, ZAP_ATTRIBUTE_MASK(CLIENT), ZAP_SIMPLE_DEFAULT(0x0001) }, /* Application Launcher (client): cluster revision */  \
  { 0xFFFD, ZAP_TYPE(INT16U), 2, ZAP_ATTRIBUTE_MASK(CLIENT), ZAP_SIMPLE_DEFAULT(0x0001) }, /* Application Basic (client): cluster revision */  \
  { 0xFFFD, ZAP_TYPE(INT16U), 2, ZAP_ATTRIBUTE_MASK(CLIENT), ZAP_SIMPLE_DEFAULT(0x0001) }, /* Account Login (client): cluster revision */  \
...
#define GENERATED_CLUSTERS { \
  ...
  { 0x0503, ZAP_ATTRIBUTE_INDEX(13), 1, 2, ZAP_CLUSTER_MASK(CLIENT), NULL }, /* Endpoint: 1, Cluster: Wake on LAN (client) */ \
  { 0x0504, ZAP_ATTRIBUTE_INDEX(14), 1, 2, ZAP_CLUSTER_MASK(CLIENT), NULL }, /* Endpoint: 1, Cluster: TV Channel (client) */ \
  { 0x0505, ZAP_ATTRIBUTE_INDEX(15), 1, 2, ZAP_CLUSTER_MASK(CLIENT), NULL }, /* Endpoint: 1, Cluster: Target Navigator (client) */ \
  { 0x0506, ZAP_ATTRIBUTE_INDEX(16), 1, 2, ZAP_CLUSTER_MASK(CLIENT), NULL }, /* Endpoint: 1, Cluster: Media Playback (client) */ \
  { 0x0507, ZAP_ATTRIBUTE_INDEX(17), 1, 2, ZAP_CLUSTER_MASK(CLIENT), NULL }, /* Endpoint: 1, Cluster: Media Input (client) */ \
  { 0x0508, ZAP_ATTRIBUTE_INDEX(18), 1, 2, ZAP_CLUSTER_MASK(CLIENT), NULL }, /* Endpoint: 1, Cluster: Low Power (client) */ \
  { 0x0509, ZAP_ATTRIBUTE_INDEX(19), 1, 2, ZAP_CLUSTER_MASK(CLIENT), NULL }, /* Endpoint: 1, Cluster: Keypad Input (client) */ \
  { 0x050A, ZAP_ATTRIBUTE_INDEX(20), 1, 2, ZAP_CLUSTER_MASK(CLIENT), NULL }, /* Endpoint: 1, Cluster: Content Launch (client) */ \
  { 0x050B, ZAP_ATTRIBUTE_INDEX(21), 1, 2, ZAP_CLUSTER_MASK(CLIENT), NULL }, /* Endpoint: 1, Cluster: Audio Output (client) */ \
  { 0x050C, ZAP_ATTRIBUTE_INDEX(22), 1, 2, ZAP_CLUSTER_MASK(CLIENT), NULL }, /* Endpoint: 1, Cluster: Application Launcher (client) */ \
  { 0x050D, ZAP_ATTRIBUTE_INDEX(23), 1, 2, ZAP_CLUSTER_MASK(CLIENT), NULL }, /* Endpoint: 1, Cluster: Application Basic (client) */ \
  { 0x050E, ZAP_ATTRIBUTE_INDEX(24), 1, 2, ZAP_CLUSTER_MASK(CLIENT), NULL }, /* Endpoint: 1, Cluster: Account Login (client) */ \
  { 0xF004, ZAP_ATTRIBUTE_INDEX(25), 1, 2, ZAP_CLUSTER_MASK(CLIENT), NULL }, /* Endpoint: 1, Cluster: Group Key Management (client) */ \
}
...
#define GENERATED_COMMANDS { \
  ...
  { 0x0506, 0x00, ZAP_COMMAND_MASK(INCOMING_SERVER) }, /* Media Playback (client): MediaPlay */ \
  { 0x0506, 0x00, ZAP_COMMAND_MASK(INCOMING_CLIENT) }, /* Media Playback (client): MediaPlayResponse */ \
  { 0x0506, 0x01, ZAP_COMMAND_MASK(INCOMING_SERVER) }, /* Media Playback (client): MediaPause */ \
  { 0x0506, 0x01, ZAP_COMMAND_MASK(INCOMING_CLIENT) }, /* Media Playback (client): MediaPauseResponse */ \
  { 0x0506, 0x02, ZAP_COMMAND_MASK(INCOMING_SERVER) }, /* Media Playback (client): MediaStop */ \
  { 0x0506, 0x02, ZAP_COMMAND_MASK(INCOMING_CLIENT) }, /* Media Playback (client): MediaStopResponse */ \
  { 0x0506, 0x03, ZAP_COMMAND_MASK(INCOMING_SERVER) }, /* Media Playback (client): MediaStartOver */ \
  { 0x0506, 0x03, ZAP_COMMAND_MASK(INCOMING_CLIENT) }, /* Media Playback (client): MediaStartOverResponse */ \
  { 0x0506, 0x04, ZAP_COMMAND_MASK(INCOMING_SERVER) }, /* Media Playback (client): MediaPrevious */ \
  { 0x0506, 0x04, ZAP_COMMAND_MASK(INCOMING_CLIENT) }, /* Media Playback (client): MediaPreviousResponse */ \
  { 0x0506, 0x05, ZAP_COMMAND_MASK(INCOMING_SERVER) }, /* Media Playback (client): MediaNext */ \
  { 0x0506, 0x05, ZAP_COMMAND_MASK(INCOMING_CLIENT) }, /* Media Playback (client): MediaNextResponse */ \
  { 0x0506, 0x06, ZAP_COMMAND_MASK(INCOMING_SERVER) }, /* Media Playback (client): MediaRewind */ \
  { 0x0506, 0x06, ZAP_COMMAND_MASK(INCOMING_CLIENT) }, /* Media Playback (client): MediaRewindResponse */ \
  { 0x0506, 0x07, ZAP_COMMAND_MASK(INCOMING_SERVER) }, /* Media Playback (client): MediaFastForward */ \
  { 0x0506, 0x07, ZAP_COMMAND_MASK(INCOMING_CLIENT) }, /* Media Playback (client): MediaFastForwardResponse */ \
  { 0x0506, 0x08, ZAP_COMMAND_MASK(INCOMING_SERVER) }, /* Media Playback (client): MediaSkipForward */ \
  { 0x0506, 0x08, ZAP_COMMAND_MASK(INCOMING_CLIENT) }, /* Media Playback (client): MediaSkipForwardResponse */ \
  { 0x0506, 0x09, ZAP_COMMAND_MASK(INCOMING_SERVER) }, /* Media Playback (client): MediaSkipBackward */ \
  { 0x0506, 0x09, ZAP_COMMAND_MASK(INCOMING_CLIENT) }, /* Media Playback (client): MediaSkipBackwardResponse */ \
  ...
  { 0x050A, 0x00, ZAP_COMMAND_MASK(INCOMING_SERVER) }, /* Content Launch (client): LaunchContent */ \
  { 0x050A, 0x00, ZAP_COMMAND_MASK(INCOMING_CLIENT) }, /* Content Launch (client): LaunchContentResponse */ \
  { 0x050A, 0x01, ZAP_COMMAND_MASK(INCOMING_SERVER) }, /* Content Launch (client): LaunchURL */ \
  { 0x050A, 0x01, ZAP_COMMAND_MASK(INCOMING_CLIENT) }, /* Content Launch (client): LaunchURLResponse */ \
  ...
  { 0x050E, 0x00, ZAP_COMMAND_MASK(INCOMING_SERVER) }, /* Account Login (client): GetSetupPIN */ \
  { 0x050E, 0x00, ZAP_COMMAND_MASK(INCOMING_CLIENT) }, /* Account Login (client): GetSetupPINResponse */ \
  { 0x050E, 0x01, ZAP_COMMAND_MASK(INCOMING_SERVER) }, /* Account Login (client): Login */ \
}
