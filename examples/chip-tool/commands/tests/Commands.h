...
class TestGlobalCommands : public TestCommand
{
public:
    TestGlobalCommands() : TestCommand("TestGlobalCommands"), mTestIndex(0) {}
    ...
    void NextTest() override
    {
        ...
        if (mTestCount == mTestIndex)
        {
            ChipLogProgress(chipTool, "TestGlobalCommands: Test complete");
            SetCommandExitStatus(CHIP_NO_ERROR);
        }
        ...
        {
        case 0:
            err = TestSendClusterGlobalCommandsCommandWaitForMs_0();
            break;
        }

        if (CHIP_NO_ERROR != err)
        {
            ChipLogProgress(chipTool, "TestGlobalCommands: %s", chip::ErrorStr(err));
            SetCommandExitStatus(err);
        }
    }
...
private:
    ...
    CHIP_ERROR TestSendClusterGlobalCommandsCommandWaitForMs_0()
    {
        ChipLogProgress(chipTool, "GlobalCommands - Wait 100ms");
...
void registerCommandsTests(Commands & commands)
{
    ...
    commands_list clusterCommands = {
        ...
        make_unique<TestGlobalCommands>(),
