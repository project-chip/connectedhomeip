...
CHIP_ERROR ManualCodeCommand::Run(ChipDeviceController * dc, NodeId remoteId)
{
    CHIP_ERROR err = CHIP_NO_ERROR;
    SetupPayload payload;

    err = ManualSetupPayloadParser(mDecimalRepresentation.c_str()).populatePayload(payload);
