...
public:
    ...
    void AddReportCallbacks(uint8_t endpointId) override
    {
        ...
        callbacksMgr.AddReportCallback(chip::kTestDeviceNodeId, endpointId, 0x0403, 0x0000, onReportPressureMeasurementMeasuredValueCallback->Cancel());
        ...
        callbacksMgr.AddReportCallback(chip::kTestDeviceNodeId, endpointId, 0x0102, 0x0000, onReportWindowCoveringTypeCallback->Cancel());
...
private:
    ...
    chip::Callback::Callback<Int8uAttributeCallback> * onReportWindowCoveringTypeCallback = new chip::Callback::Callback<Int8uAttributeCallback>(OnInt8uAttributeResponse, this);
