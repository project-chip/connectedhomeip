...
static void OnFabricClusterGetFabricIdResponse(void * context, chip::FabricId fabricId)
{
    ChipLogProgress(chipTool, "FabricClusterGetFabricIdResponse");
...
static void OnFabricFabricsListListAttributeResponse(void * context, uint16_t count, _FabricDescriptor * entries)
{
    ChipLogProgress(chipTool, "OnFabricFabricsListListAttributeResponse: %lu entries", count);
...
static void OnGroupKeyManagementGroupKeysListAttributeResponse(void * context, uint16_t count, _GroupKey * entries)
{
    ...
    for (uint16_t i = 0; i < count; i++)
    {
        ...
        ChipLogProgress(chipTool, "  GroupKeyRoot: %s", entries[i].GroupKeyRoot);
...
constexpr chip::ClusterId kFabricClusterId = 0xFC03;
 ...
 * Command GetFabricId
 */
class FabricGetFabricId: public ModelCommand
{
public:
    FabricGetFabricId(): ModelCommand("get-fabric-id")
    {
        ModelCommand::AddArguments();
    }
    ~FabricGetFabricId()
    ...
    CHIP_ERROR SendCommand(ChipDevice * device, uint8_t endpointId) override
    {
        ChipLogProgress(chipTool, "Sending cluster (0xFC03) command (0x02) on endpoint %" PRIu16, endpointId);
...
private:
    chip::Callback::Callback<FabricClusterGetFabricIdResponseCallback> * onSuccessCallback = new chip::Callback::Callback<FabricClusterGetFabricIdResponseCallback>(OnFabricClusterGetFabricIdResponse, this);
    chip::Callback::Callback<DefaultFailureCallback> * onFailureCallback = new chip::Callback::Callback<DefaultFailureCallback>(OnDefaultFailureResponse, this);
};
 ...
 */
class FabricRemoveFabric: public ModelCommand
{
public:
    FabricRemoveFabric(): ModelCommand("remove-fabric")
    {
    ...
    CHIP_ERROR SendCommand(ChipDevice * device, uint8_t endpointId) override
    {
        ChipLogProgress(chipTool, "Sending cluster (0xFC03) command (0x01) on endpoint %" PRIu16, endpointId);
...
public:
    ...
    CHIP_ERROR SendCommand(ChipDevice * device, uint8_t endpointId) override
    {
        ChipLogProgress(chipTool, "Sending cluster (0xFC03) command (0x00) on endpoint %" PRIu16, endpointId);
 ...
 * Discover Attributes
 */
class DiscoverFabricAttributes: public ModelCommand
{
public:
    DiscoverFabricAttributes(): ModelCommand("discover")
    {
        ModelCommand::AddArguments();
    }

    ~DiscoverFabricAttributes()
    {
      delete onSuccessCallback;
      delete onFailureCallback;
    }
 ...
 */
class ReadFabricFabricsList: public ModelCommand
{
public:
    ReadFabricFabricsList(): ModelCommand("read")
    {
        AddArgument("attr-name", "fabrics-list");
        ModelCommand::AddArguments();
    }

    ~ReadFabricFabricsList()
    {
      delete onSuccessCallback;
      delete onFailureCallback;
    }
...
private:
    chip::Callback::Callback<FabricFabricsListListAttributeCallback> * onSuccessCallback = new chip::Callback::Callback<FabricFabricsListListAttributeCallback>(OnFabricFabricsListListAttributeResponse, this);
    chip::Callback::Callback<DefaultFailureCallback> * onFailureCallback = new chip::Callback::Callback<DefaultFailureCallback>(OnDefaultFailureResponse, this);
};
 ...
 * Attribute ClusterRevision
 */
class ReadFabricClusterRevision: public ModelCommand
{
public:
    ReadFabricClusterRevision(): ModelCommand("read")
    {
        AddArgument("attr-name", "cluster-revision");
        ModelCommand::AddArguments();
    }

    ~ReadFabricClusterRevision()
    {
      delete onSuccessCallback;
      delete onFailureCallback;
    }
...
public:
    ...
    CHIP_ERROR SendCommand(ChipDevice * device, uint8_t endpointId) override
    {
        ...
        cluster.Associate(device, endpointId);
        return cluster.AddThreadNetwork(onSuccessCallback->Cancel(), onFailureCallback->Cancel(),  chip::ByteSpan(chip::Uint8::from_char(mOperationalDataset), strlen(mOperationalDataset)), mBreadcrumb, mTimeoutMs);
    }
...
public:
    ...
    CHIP_ERROR SendCommand(ChipDevice * device, uint8_t endpointId) override
    {
        ...
        chip::Controller::NetworkCommissioningCluster cluster;
        cluster.Associate(device, endpointId);
        return cluster.AddWiFiNetwork(onSuccessCallback->Cancel(), onFailureCallback->Cancel(),  chip::ByteSpan(chip::Uint8::from_char(mSsid), strlen(mSsid)),  chip::ByteSpan(chip::Uint8::from_char(mCredentials), strlen(mCredentials)), mBreadcrumb, mTimeoutMs);
    }
...
public:
    ...
    CHIP_ERROR SendCommand(ChipDevice * device, uint8_t endpointId) override
    {
        ...
        chip::Controller::NetworkCommissioningCluster cluster;
        cluster.Associate(device, endpointId);
        return cluster.DisableNetwork(onSuccessCallback->Cancel(), onFailureCallback->Cancel(),  chip::ByteSpan(chip::Uint8::from_char(mNetworkID), strlen(mNetworkID)), mBreadcrumb, mTimeoutMs);
    }
...
public:
    ...
    CHIP_ERROR SendCommand(ChipDevice * device, uint8_t endpointId) override
    {
        ...
        chip::Controller::NetworkCommissioningCluster cluster;
        cluster.Associate(device, endpointId);
        return cluster.EnableNetwork(onSuccessCallback->Cancel(), onFailureCallback->Cancel(),  chip::ByteSpan(chip::Uint8::from_char(mNetworkID), strlen(mNetworkID)), mBreadcrumb, mTimeoutMs);
    }
...
public:
    ...
    CHIP_ERROR SendCommand(ChipDevice * device, uint8_t endpointId) override
    {
        ...
        chip::Controller::NetworkCommissioningCluster cluster;
        cluster.Associate(device, endpointId);
        return cluster.RemoveNetwork(onSuccessCallback->Cancel(), onFailureCallback->Cancel(),  chip::ByteSpan(chip::Uint8::from_char(mNetworkID), strlen(mNetworkID)), mBreadcrumb, mTimeoutMs);
    }
...
public:
    ...
    CHIP_ERROR SendCommand(ChipDevice * device, uint8_t endpointId) override
    {
        ...
        chip::Controller::NetworkCommissioningCluster cluster;
        cluster.Associate(device, endpointId);
        return cluster.ScanNetworks(onSuccessCallback->Cancel(), onFailureCallback->Cancel(),  chip::ByteSpan(chip::Uint8::from_char(mSsid), strlen(mSsid)), mBreadcrumb, mTimeoutMs);
    }
...
public:
    ...
    CHIP_ERROR SendCommand(ChipDevice * device, uint8_t endpointId) override
    {
        ...
        chip::Controller::NetworkCommissioningCluster cluster;
        cluster.Associate(device, endpointId);
        return cluster.UpdateThreadNetwork(onSuccessCallback->Cancel(), onFailureCallback->Cancel(),  chip::ByteSpan(chip::Uint8::from_char(mOperationalDataset), strlen(mOperationalDataset)), mBreadcrumb, mTimeoutMs);
    }
...
public:
    ...
    CHIP_ERROR SendCommand(ChipDevice * device, uint8_t endpointId) override
    {
        ...
        chip::Controller::NetworkCommissioningCluster cluster;
        cluster.Associate(device, endpointId);
        return cluster.UpdateWiFiNetwork(onSuccessCallback->Cancel(), onFailureCallback->Cancel(),  chip::ByteSpan(chip::Uint8::from_char(mSsid), strlen(mSsid)),  chip::ByteSpan(chip::Uint8::from_char(mCredentials), strlen(mCredentials)), mBreadcrumb, mTimeoutMs);
    }
...
void registerClusterFabric(Commands & commands)
{
    const char * clusterName = "Fabric";
...
void registerClusterGeneralCommissioning(Commands & commands)
{
    ...
    commands_list clusterCommands = {
        ...
        make_unique<GeneralCommissioningSetFabric>(),
...
void registerClusters(Commands & commands)
{
    ...
    registerClusterFabric(commands);
