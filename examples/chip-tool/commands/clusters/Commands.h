...
constexpr chip::ClusterId kOperationalCredentialsClusterId = 0xFC03;
...
{
public:
    OperationalCredentialsGetFabricId(): ModelCommand("get-fabric-id")
    {
        ModelCommand::AddArguments();
    }
...
private:
    chip::Callback::Callback<OperationalCredentialsClusterGetFabricIdResponseCallback> * onSuccessCallback = new chip::Callback::Callback<OperationalCredentialsClusterGetFabricIdResponseCallback>(OnOperationalCredentialsClusterGetFabricIdResponse, this);
    chip::Callback::Callback<DefaultFailureCallback> * onFailureCallback = new chip::Callback::Callback<DefaultFailureCallback>(OnDefaultFailureResponse, this);
};
...
public:
    ...
    CHIP_ERROR SendCommand(ChipDevice * device, uint8_t endpointId) override
    {
        ChipLogProgress(chipTool, "Sending cluster (0xFC03) command (0x0A) on endpoint %" PRIu16, endpointId);
...
public:
    ...
    CHIP_ERROR SendCommand(ChipDevice * device, uint8_t endpointId) override
    {
        ChipLogProgress(chipTool, "Sending cluster (0xFC03) command (0x09) on endpoint %" PRIu16, endpointId);
...
void registerClusterOperationalCredentials(Commands & commands)
{
    ...
    commands_list clusterCommands = {
        make_unique<OperationalCredentialsGetFabricId>(),
