...
{
public:
    DoorLockClearAllPins() : ModelCommand("clear-all-pincodes", kDoorLockClusterId, 0x08) { ModelCommand::AddArguments(); }
...
{
public:
    DoorLockClearAllRfids() : ModelCommand("clear-all-rfidcodes", kDoorLockClusterId, 0x19) { ModelCommand::AddArguments(); }
...
{
public:
    DoorLockClearPin() : ModelCommand("clear-pincode", kDoorLockClusterId, 0x07)
    {
...
{
public:
    DoorLockClearRfid() : ModelCommand("clear-rfidcode", kDoorLockClusterId, 0x18)
    {
        AddArgument("userID", 0, UINT16_MAX, &mUserID);
        ModelCommand::AddArguments();
    }
...
{
public:
    DoorLockGetPin() : ModelCommand("get-pincode", kDoorLockClusterId, 0x06)
    {
        AddArgument("userID", 0, UINT16_MAX, &mUserID);
        ModelCommand::AddArguments();
    }
...
{
public:
    DoorLockGetRfid() : ModelCommand("get-rfidcode", kDoorLockClusterId, 0x17)
    {
        AddArgument("userID", 0, UINT16_MAX, &mUserID);
        ModelCommand::AddArguments();
    }
...
{
public:
    DoorLockSetPin() : ModelCommand("set-pincode", kDoorLockClusterId, 0x05)
    {
        AddArgument("userID", 0, UINT16_MAX, &mUserID);
...
{
public:
    DoorLockSetRfid() : ModelCommand("set-rfidcode", kDoorLockClusterId, 0x16)
    {
        AddArgument("userID", 0, UINT16_MAX, &mUserID);
        AddArgument("userStatus", 0, UINT8_MAX, &mUserStatus);
        AddArgument("userType", 0, UINT8_MAX, &mUserType);
    ...
    uint16_t EncodeCommand(const PacketBufferHandle & buffer, uint16_t bufferSize, uint8_t endPointId) override
    {
        return encodeDoorLockClusterSetRfidCommand(buffer->Start(), bufferSize, endPointId, mUserID, mUserStatus, mUserType,
                                                   mRFIDCode);
    }
...
public:
    ScenesAddScene() : ModelCommand("add-scene", kScenesClusterId, 0x00)
    {
        ...
        AddArgument("value", 0, UINT8_MAX, &mLength);
        ModelCommand::AddArguments();
    }
