...
static void OnKeypadInputClusterSendKeyResponse(void * context, uint8_t keypadInputStatus)
{
...
public:
    ...
    CHIP_ERROR SendCommand(ChipDevice * device, uint8_t endpointId) override
    {
        ...
        cluster.Associate(device, endpointId);
        return cluster.LaunchApp(onSuccessCallback->Cancel(), onFailureCallback->Cancel(), mCatalogVendorId,  chip::ByteSpan(chip::Uint8::from_char(mApplicationId), strlen(mApplicationId)),  chip::ByteSpan(chip::Uint8::from_char(mData), strlen(mData)));
    }
...
public:
    ...
    {
        AddArgument("keyAction", 0, UINT8_MAX, &mKeyAction);
    ...
    CHIP_ERROR SendCommand(ChipDevice * device, uint8_t endpointId) override
    {
        ...
        cluster.Associate(device, endpointId);
        return cluster.SendKey(onSuccessCallback->Cancel(), onFailureCallback->Cancel(), mKeyAction, mKeyCode);
    }
