...
void registerClusterMediaPlayback(Commands & commands)
{
    ...
    commands_list clusterCommands = {
        ...
        make_unique<MediaPlaybackMediaStartOver>(),     make_unique<MediaPlaybackMediaStop>(),
        make_unique<DiscoverMediaPlaybackAttributes>(), make_unique<ReadMediaPlaybackClusterRevision>(),
    };
