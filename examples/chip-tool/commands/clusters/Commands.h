 ...
 * Command Altitude
 */
class AirPressureMeasurementAltitude : public ModelCommand
{
public:
    AirPressureMeasurementAltitude() : ModelCommand("altitude")
    {
        AddArgument("altitude", INT16_MIN, INT16_MAX, &mAltitude);
        ModelCommand::AddArguments();
    }
    ~AirPressureMeasurementAltitude()
    {
        delete onSuccessCallback;
        delete onFailureCallback;
    }
    ...
    CHIP_ERROR SendCommand(ChipDevice * device, uint8_t endpointId) override
    {
        ...
        cluster.Associate(device, endpointId);
        return cluster.Altitude(onSuccessCallback->Cancel(), onFailureCallback->Cancel(), mAltitude);
    }
...
void registerClusterAirPressureMeasurement(Commands & commands)
{
    ...
    commands_list clusterCommands = {
        make_unique<AirPressureMeasurementAltitude>(),          make_unique<DiscoverAirPressureMeasurementAttributes>(),
        make_unique<ReadAirPressureMeasurementMeasuredValue>(), make_unique<ReadAirPressureMeasurementAltitude>(),
        make_unique<WriteAirPressureMeasurementAltitude>(),     make_unique<ReadAirPressureMeasurementClusterRevision>(),
    };
