...
static void OnApplicationLauncherClusterLaunchAppResponse(void * context, chip::ByteSpan data)
{
...
static void OnGroupsClusterViewGroupResponse(void * context, uint16_t groupId, chip::ByteSpan groupName)
{
...
static void OnOtaSoftwareUpdateServerClusterQueryImageResponse(void * context, uint32_t delayedActionTime, chip::ByteSpan imageURI,
...
static void OnTargetNavigatorClusterNavigateTargetResponse(void * context, chip::ByteSpan data)
{
...
public:
    ...
    CHIP_ERROR SendCommand(ChipDevice * device, uint8_t endpointId) override
    {
        ChipLogProgress(chipTool, "Sending cluster (0x0403) command (0x00) on endpoint %" PRIu16, endpointId);
...
public:
    ...
    CHIP_ERROR SendCommand(ChipDevice * device, uint8_t endpointId) override
    {
        ChipLogProgress(chipTool, "Sending cluster (0x0403) command (0x06) on endpoint %" PRIu16, endpointId);
