...
{
public:
    FabricGetFabricId() : ModelCommand("get-fabric-id") { ModelCommand::AddArguments(); }
    ~FabricGetFabricId()
    {
        delete onSuccessCallback;
        delete onFailureCallback;
...
private:
    chip::Callback::Callback<FabricClusterGetFabricIdResponseCallback> * onSuccessCallback =
        new chip::Callback::Callback<FabricClusterGetFabricIdResponseCallback>(OnFabricClusterGetFabricIdResponse, this);
    chip::Callback::Callback<DefaultFailureCallback> * onFailureCallback =
        new chip::Callback::Callback<DefaultFailureCallback>(OnDefaultFailureResponse, this);
};
...
public:
    ...
    CHIP_ERROR SendCommand(ChipDevice * device, uint8_t endpointId) override
    {
        ...
        return cluster.UpdateFabricLabel(onSuccessCallback->Cancel(), onFailureCallback->Cancel(),
                                         chip::ByteSpan(chip::Uint8::from_char(mFabricLabel), strlen(mFabricLabel)));
    }
...
{
public:
    DiscoverFabricAttributes() : ModelCommand("discover") { ModelCommand::AddArguments(); }
...
private:
    chip::Callback::Callback<FabricFabricsListListAttributeCallback> * onSuccessCallback =
        new chip::Callback::Callback<FabricFabricsListListAttributeCallback>(OnFabricFabricsListListAttributeResponse, this);
    chip::Callback::Callback<DefaultFailureCallback> * onFailureCallback =
        new chip::Callback::Callback<DefaultFailureCallback>(OnDefaultFailureResponse, this);
};
...
void registerClusterFabric(Commands & commands)
{
    ...
    commands_list clusterCommands = {
        make_unique<FabricGetFabricId>(),        make_unique<FabricRemoveFabric>(),    make_unique<FabricUpdateFabricLabel>(),
        make_unique<DiscoverFabricAttributes>(), make_unique<ReadFabricFabricsList>(), make_unique<ReadFabricClusterRevision>(),
    };
