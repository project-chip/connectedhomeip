...
static void onMessage(ChipDeviceController * dc, void * appReqState, System::PacketBuffer * buffer)
{
...
CHIP_ERROR NetworkCommand::Run(ChipDeviceController * dc, Optional<NodeId> remoteId)
{
