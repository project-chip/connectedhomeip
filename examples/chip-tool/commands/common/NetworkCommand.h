...
public:
    ...
    virtual void OnMessage(ChipDeviceController * dc, System::PacketBuffer * buffer) = 0;

    CHIP_ERROR Run(ChipDeviceController * dc, Optional<NodeId> remoteId) override;
