...
public:
    ...
    size_t GetArgumentsCount(void) const { return argsCount; };
    ...
    size_t AddArgument(const char * name, Inet::IPAddress * out);

    virtual CHIP_ERROR Run(ChipDeviceController * dc, Optional<NodeId> remoteId) = 0;
