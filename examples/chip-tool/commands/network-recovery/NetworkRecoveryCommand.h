...
{
public:
    NetworkRecoveryRecoverCommand(const char * commandName, RecoveryNetworkType networkType, CredentialIssuerCommands * credsIssuerConfig) :
    ...
    CHIP_ERROR RunCommand() override;
    chip::System::Clock::Timeout GetWaitDuration() const override { return chip::System::Clock::Seconds16(mTimeout.ValueOr(60)); }
private:
    chip::NodeId mNodeId;
