 ...
 */
#include "TIDeviceAttestationCreds.h"
...
class DeviceAttestationCredsTI : public DeviceAttestationCredentialsProvider
{
...
CHIP_ERROR DeviceAttestationCredsTI::GetCertificationDeclaration(MutableByteSpan & out_buffer)
{
    //-> format_version = 1
    //-> vendor_id = 0xFFF1
...
CHIP_ERROR DeviceAttestationCredsTI::GetFirmwareInformation(MutableByteSpan & out_firmware_info_buffer)
{
...
CHIP_ERROR DeviceAttestationCredsTI::GetDeviceAttestationCert(MutableByteSpan & out_buffer)
{
...
CHIP_ERROR DeviceAttestationCredsTI::GetProductAttestationIntermediateCert(MutableByteSpan & out_buffer)
{
...
CHIP_ERROR DeviceAttestationCredsTI::SignWithDeviceAttestationKey(const ByteSpan & message_to_sign, MutableByteSpan & out_buffer)
{
    ...
    ReturnErrorOnFailure(keypair.LoadKeypairFromRaw(ByteSpan(mFactoryData->dac_priv_key.data, mFactoryData->dac_priv_key.len),
...
DeviceAttestationCredentialsProvider * GetTIDacProvider()
{
    static DeviceAttestationCredsTI dac_provider;
    return &dac_provider;
}
