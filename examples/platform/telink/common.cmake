...
if(${CONFIG_COMPRESS_LZMA} MATCHES y)
  set(BOOT_COMPRESS_LZMA_CONF_OVERLAY_FILE "${CHIP_ROOT}/config/telink/app/bootloader_compress_lzma.conf")
  if(NOT EXISTS "${BOOT_COMPRESS_LZMA_CONF_OVERLAY_FILE}")
    message(FATAL_ERROR "${BOOT_COMPRESS_LZMA_CONF_OVERLAY_FILE} doesn't exist")
  endif()
else()
  unset(BOOT_COMPRESS_LZMA_CONF_OVERLAY_FILE)
endif()
...
set(GLOBAL_BOOT_CONF_OVERLAY_FILE "${BOOT_CONF_OVERLAY_FILE} ${BOOT_COMPRESS_LZMA_CONF_OVERLAY_FILE} ${BOOT_USB_CONF_OVERLAY_FILE}")
