...
if(${TLNK_7218X_ML7G_BOARD} MATCHES y)
  set(ML_DTC_OVERLAY_FILE "${CHIP_ROOT}/src/platform/telink/${BOARD}_ml7g.overlay")
  if(NOT EXISTS "${ML_DTC_OVERLAY_FILE}")
    message(FATAL_ERROR "${ML_DTC_OVERLAY_FILE} doesn't exist")
  endif()
  set(ML_CONF_OVERLAY_FILE "${CHIP_ROOT}/src/platform/telink/${BOARD}_ml7g.conf")
...
elseif(${TLNK_3218X_ML3M_BOARD} MATCHES y)
  ...
  set(ML_CONF_OVERLAY_FILE "${CHIP_ROOT}/src/platform/telink/${BOARD}_ml3m.conf")
  if(NOT EXISTS "${ML_CONF_OVERLAY_FILE}")
    message(FATAL_ERROR "${ML_CONF_OVERLAY_FILE} doesn't exist")
  endif() 
else()
  unset(ML_DTC_OVERLAY_FILE)
...
if(DTC_OVERLAY_FILE)
  set(DTC_OVERLAY_FILE
    "${DTC_OVERLAY_FILE} ${GLOBAL_DTC_OVERLAY_FILE} ${USB_DTC_OVERLAY_FILE} ${MARS_DTC_OVERLAY_FILE} ${FLASH_DTC_OVERLAY_FILE} ${LOCAL_DTC_OVERLAY_FILE} ${ML_DTC_OVERLAY_FILE}"
    CACHE STRING "" FORCE
  )
else()
  set(DTC_OVERLAY_FILE ${GLOBAL_DTC_OVERLAY_FILE} ${USB_DTC_OVERLAY_FILE} ${MARS_DTC_OVERLAY_FILE} ${FLASH_DTC_OVERLAY_FILE} ${LOCAL_DTC_OVERLAY_FILE} ${ML_DTC_OVERLAY_FILE})
endif()

if(NOT CONF_FILE)
  set(CONF_FILE ${USB_CONF_OVERLAY_FILE} ${MARS_CONF_OVERLAY_FILE} prj.conf ${ML_CONF_OVERLAY_FILE})
endif()
