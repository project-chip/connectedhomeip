...
public:
    ...
    static inline StorageKeyName GetKeyDiagUserSupport() { return StorageKeyName::FromConst("qpg/diag/usr"); }

    static inline StorageKeyName GetKeyDiagNetwork() { return StorageKeyName::FromConst("qpg/diag/nwk"); }

    static inline StorageKeyName GetKeyDiagCrashLog() { return StorageKeyName::FromConst("qpg/diag/crash"); }
