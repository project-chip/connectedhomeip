...
// Hardcoded UDP BroadcastPort. Temporary use for demo with OTBR
...
void PublishService()
{
    ...
    if (error != OT_ERROR_NONE && message != nullptr)
    {
        ...
        ChipLogError(NotSpecified, "Failed to otUdpSend: %d", error);
    }
...
void StartDefaultThreadNetwork(void)
{
    ...
    uint8_t meshLocalPrefix[] = { 0xfd, 0xde, 0xad, 0x00, 0xbe, 0xef, 0x00, 0x00 };
    const uint8_t xpanid[]    = { 0xDE, 0xAD, 0x00, 0xBE, 0xEF, 0x00, 0xCA, 0xFE };
