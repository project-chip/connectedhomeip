...
#define RSI_EXT_CUSTOM_FEATURE_BIT_MAP                                                                                             \
    (EXT_FEAT_448K_M4SS_256K | EXT_FEAT_IEEE_80211W | EXT_FEAT_LOW_POWER_MODE | EXT_FEAT_XTAL_CLK_ENABLE | EXT_FEAT_UART_SEL_FOR_DEBUG_PRINTS)
#else
#define RSI_EXT_CUSTOM_FEATURE_BIT_MAP (EXT_FEAT_384K_MODE | EXT_FEAT_IEEE_80211W)
#endif /* CHIP_9117 */
#else
#ifdef CHIP_9117 
#define RSI_EXT_CUSTOM_FEATURE_BIT_MAP (EXT_FEAT_448K_M4SS_256K | EXT_FEAT_LOW_POWER_MODE | EXT_FEAT_XTAL_CLK_ENABLE | EXT_FEAT_IEEE_80211W | EXT_FEAT_UART_SEL_FOR_DEBUG_PRINTS )
#else
#define RSI_EXT_CUSTOM_FEATURE_BIT_MAP (EXT_FEAT_384K_MODE | EXT_FEAT_UART_SEL_FOR_DEBUG_PRINTS)
#endif /* CHIP_9117 */
...
#if WIFI_ENABLE_SECURITY_MODE_WPA3_TRANSITION
//#define RSI_JOIN_FEAT_BIT_MAP 96//RSI_JOIN_FEAT_MFP_CAPABLE_ONLY
    #define RSI_JOIN_FEAT_BIT_MAP ( RSI_JOIN_FEAT_MFP_CAPABLE_ONLY | RSI_JOIN_FEAT_MFP_CAPABLE_REQUIRED )
//#elif
