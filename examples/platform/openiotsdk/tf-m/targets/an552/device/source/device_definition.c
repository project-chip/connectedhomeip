...
static const struct systimer_armv8_m_dev_cfg_t
    SYSTIMER0_ARMV8_M_DEV_CFG_S TFM_LINK_SET_RO_IN_PARTITION_SECTION("TFM_SP_FPU_SERVICE_TEST", "APP-ROT") = {
...
static struct systimer_armv8_m_dev_data_t SYSTIMER0_ARMV8_M_DEV_DATA_S
    TFM_LINK_SET_RW_IN_PARTITION_SECTION("TFM_SP_FPU_SERVICE_TEST", "APP-ROT") = { .is_initialized = false };
struct systimer_armv8_m_dev_t SYSTIMER0_ARMV8_M_DEV_S TFM_LINK_SET_RW_IN_PARTITION_SECTION("TFM_SP_FPU_SERVICE_TEST", "APP-ROT") = {
...
#ifdef TEST_NS_FPU
static const struct systimer_armv8_m_dev_cfg_t
    SYSTIMER1_ARMV8_M_DEV_CFG_NS TFM_LINK_SET_RO_IN_PARTITION_SECTION("TFM_SP_FPU_SERVICE_TEST", "APP-ROT") = {
...
static struct systimer_armv8_m_dev_data_t SYSTIMER1_ARMV8_M_DEV_DATA_NS
    TFM_LINK_SET_RW_IN_PARTITION_SECTION("TFM_SP_FPU_SERVICE_TEST", "APP-ROT") = { .is_initialized = false };
struct systimer_armv8_m_dev_t SYSTIMER1_ARMV8_M_DEV_NS TFM_LINK_SET_RW_IN_PARTITION_SECTION(
    "TFM_SP_FPU_SERVICE_TEST", "APP-ROT") = { &(SYSTIMER1_ARMV8_M_DEV_CFG_NS), &(SYSTIMER1_ARMV8_M_DEV_DATA_NS) };
#else
