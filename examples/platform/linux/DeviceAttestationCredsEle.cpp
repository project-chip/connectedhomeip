...
/* Keystore ID inside the ELE */
constexpr int KEY_STORE_ID = 0xBBBB
    /* Authentication nonce */
    constexpr int AUTHEN_NONCE = 0x2222

    /* IDs to identify the PAI/DAC/CD/DAC private key inside the ELE */
    constexpr int PAI_DATA_ID = 0x1111 constexpr int DAC_DATA_ID = 0x1112 constexpr int CD_DATA_ID =
        0x1113 constexpr int DAC_PRIVATE_KEY_ID                  = 0x1114
