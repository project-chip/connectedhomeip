...
void otPlatPkaP256StartEccScalarMul(const uint32_t * k, const uint32_t * p_x, const uint32_t * p_y)
{
...
void otPlatPkaP256ReadEccScalarMul(uint32_t * p_x, uint32_t * p_y)
{
