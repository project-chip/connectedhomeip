...
void SVCCTL_InitCustomSvc(void)
{
    ...
    aci_gatt_add_char(aCustomContext.CustomSvcHdle, UUID_TYPE_128, &uuid16, 247, CHAR_PROP_WRITE, ATTR_PERMISSION_NONE,
    ...
    aci_gatt_add_char(aCustomContext.CustomSvcHdle, UUID_TYPE_128, &uuid16, 247, CHAR_PROP_INDICATE, ATTR_PERMISSION_NONE,
