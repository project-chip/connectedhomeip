...
const osThreadAttr_t stAlarmTaskAttributes = { .name       = "Alarm Task",
                                               .priority   = CFG_TASK_PRIO_ALARM,
                                               .stack_size = TASK_ALARM_STACK_SIZE };

const osThreadAttr_t stUsAlarmTaskAttributes = { .name       = "UsAlarm Task",
                                                 .priority   = CFG_TASK_PRIO_US_ALARM,
                                                 .stack_size = TASK_ALARM_US_STACK_SIZE };

const osThreadAttr_t stTaskletsTaskAttributes = { .name       = "Tasklets Task",
                                                  .priority   = CFG_TASK_PRIO_TASKLETS,
                                                  .stack_size = TASK_TASKLETS_STACK_SIZE };

const osThreadAttr_t stCliUartTaskAttributes = { .name       = "CliUart Task",
...
void Alarm_Task(void * argument)
{
    ...
    while (1)
    {
        ...
        {
            APP_DBG("\x1b[34m"
                    "AlarmTask_stack_HighWaterMark %lu \n"
                    "\x1b[0m",
                    uxHighWaterMark);
...
void Us_Alarm_Task(void * argument)
{
    ...
    while (1)
    {
        ...
        {
            APP_DBG("\x1b[34m"
                    "UsAlarmTask_stack_HighWaterMark %lu \n"
                    "\x1b[0m",
                    uxHighWaterMark);
            lastHighWaterMark = uxHighWaterMark;
        }
...
void Cli_Uart_Task(void * argument)
{
        ...
        while (1)
    {
        ...
        {
            APP_DBG("\x1b[34m"
                    "CliUartTask_stack_HighWaterMark %lu \n"
                    "\x1b[0m",
                    uxHighWaterMark);
            lastHighWaterMark = uxHighWaterMark;
        }
...
void Tasklets_Task(void * argument)
{
    ...
    while (1)
    {
        ...
        {
            APP_DBG("\x1b[34m"
                    "TaskletsTask_stack_HighWaterMark %lu \n"
                    "\x1b[0m",
                    uxHighWaterMark);
            lastHighWaterMark = uxHighWaterMark;
        }
