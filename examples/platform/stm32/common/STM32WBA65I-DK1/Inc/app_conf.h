 ...
 * TFM support
 ******************************************************************************/
#define USE_TFM_PSA (0) // this flag should be in a .h file, ideally linked to TFM_COMPATIBILITY flag defined in flash_layout.h (OEMiROT_Boot project)
