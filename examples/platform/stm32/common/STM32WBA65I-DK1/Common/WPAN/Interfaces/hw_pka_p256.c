...
static const uint32_t HW_PKA_P256_gfp[8] = {
    0xFFFFFFFF, /* LSB */
    0xFFFFFFFF, 0xFFFFFFFF, 0x00000000, 0x00000000, 0x00000000, 0x00000001, 0xFFFFFFFF,
};

static const uint32_t HW_PKA_P256_r2[8] = {
    0x00000002, /* LSB */
    0x00000005, 0x00000003, 0xFFFFFFFE, 0xFFFFFFF9, 0xFFFFFFFB, 0xFFFFFFFC, 0xFFFFFFFC,
};

static const uint32_t HW_PKA_P256_p_x[8] = {
    0xD898C296, /* LSB */
    0xF4A13945, 0x2DEB33A0, 0x77037D81, 0x63A440F2, 0xF8BCE6E5, 0xE12C4247, 0x6B17D1F2,
};
...
static const uint32_t HW_PKA_P256_b[8] = {
    0x27D2604B, /* LSB */
    0x3BCE3C3E, 0xCC53B0F6, 0x651D06B0, 0x769886BC, 0xB3EBBD55, 0xAA3A93E7, 0x5AC635D8,
};

static const uint32_t HW_PKA_P256_n[8] = { 0XFC632551, /* LSB */
                                           0XF3B9CAC2, 0XA7179E84, 0XBCE6FAAD, 0XFFFFFFFF, 0XFFFFFFFF, 0X00000000, 0XFFFFFFFF };
...
void HW_PKA_P256_StartPointCheck(const uint32_t * x, const uint32_t * y)
{
    ...
    HW_PKA_WriteOperand(PKA_POINT_CHECK_IN_MONTGOMERY_PARAM, 8, HW_PKA_P256_r2);
...
void HW_PKA_P256_StartEccScalarMul(const uint32_t * k, const uint32_t * p_x, const uint32_t * p_y)
{
    ...
    HW_PKA_WriteOperand(PKA_ECC_SCALAR_MUL_IN_INITIAL_POINT_X, 8, p_x ? p_x : HW_PKA_P256_p_x);

    /* Set the point P coordinate y */
    HW_PKA_WriteOperand(PKA_ECC_SCALAR_MUL_IN_INITIAL_POINT_Y, 8, p_y ? p_y : HW_PKA_P256_p_y);

    /* Set the prime order n */
    HW_PKA_WriteOperand(PKA_ECC_SCALAR_MUL_IN_N_PRIME_ORDER, 8, HW_PKA_P256_n);
...
void HW_PKA_P256_ReadEccScalarMul(uint32_t * p_x, uint32_t * p_y)
{
