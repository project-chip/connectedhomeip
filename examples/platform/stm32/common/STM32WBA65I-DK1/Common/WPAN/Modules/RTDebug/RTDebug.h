...
#define GENERIC_DEBUG_GPIO_SET(signal, table)                                                                                      \
    do                                                                                                                             \
    {                                                                                                                              \
        ...
        {                                                                                                                          \
            LL_GPIO_SetOutputPin(general_debug_table[debug_table_idx].GPIO_port, general_debug_table[debug_table_idx].GPIO_pin);   \
        }                                                                                                                          \
    } while (0)

#define GENERIC_DEBUG_GPIO_RESET(signal, table)                                                                                    \
    do                                                                                                                             \
    {                                                                                                                              \
        uint32_t debug_table_idx = 0;                                                                                              \
        if (signal >= sizeof(table))                                                                                               \
        ...
        if (debug_table_idx != RT_DEBUG_SIGNAL_UNUSED)                                                                             \
        {                                                                                                                          \
            LL_GPIO_ResetOutputPin(general_debug_table[debug_table_idx].GPIO_port, general_debug_table[debug_table_idx].GPIO_pin); \
        }                                                                                                                          \
    } while (0)

#define GENERIC_DEBUG_GPIO_TOGGLE(signal, table)                                                                                   \
    do                                                                                                                             \
    {                                                                                                                              \
        uint32_t debug_table_idx = 0;                                                                                              \
        if (signal >= sizeof(table))                                                                                               \
        ...
        if (debug_table_idx != RT_DEBUG_SIGNAL_UNUSED)                                                                             \
        {                                                                                                                          \
            LL_GPIO_TogglePin(general_debug_table[debug_table_idx].GPIO_port, general_debug_table[debug_table_idx].GPIO_pin);      \
        }                                                                                                                          \
    } while (0)
