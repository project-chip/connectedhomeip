...
#define RF_ANTSW0                                                                                                                  \
    {                                                                                                                              \
        GPIOA, GPIO_PIN_12, GPIO_AF11_RF_ANTSW0                                                                                    \
    }
#define RF_ANTSW1                                                                                                                  \
    {                                                                                                                              \
        GPIOA, GPIO_PIN_11, GPIO_AF11_RF_ANTSW1                                                                                    \
    }
#define RF_ANTSW2                                                                                                                  \
    {                                                                                                                              \
        GPIOB, GPIO_PIN_2, GPIO_AF11_RF_ANTSW2                                                                                     \
    }
...
static const st_gpio_antsw_t rt_antenna_switch_gpio_table[] = { RF_ANTSW0, RF_ANTSW1, RF_ANTSW2 };
