...
/* Board selection for each STM32WBA device. By default, discovery board is selected for the device. User can change this
 * configuration. */
#if defined(STM32WBA65xx)
#ifndef USE_STM32WBA65I_DK1
#define USE_STM32WBA65I_DK1
#endif
/* #define USE_NUCLEO_64 */
#elif defined(STM32WBA55xx)
#ifndef USE_STM32WBA55G_DK1
