...
void SVCCTL_InitCustomSvc(void)
{
    ...
    aci_gatt_add_service(UUID_TYPE_16, (Service_UUID_t *) &uuid, PRIMARY_SERVICE, max_attr_record, &(aCustomContext.CustomSvcHdle));
    ...
    aci_gatt_add_char(aCustomContext.CustomSvcHdle, UUID_TYPE_128, (Char_UUID_t *) &uuid, CharValueSize, CHAR_PROP_WRITE,
    ...
    aci_gatt_add_char(aCustomContext.CustomSvcHdle, UUID_TYPE_128, &uuid, CharValueSize, CHAR_PROP_INDICATE, ATTR_PERMISSION_NONE,
...
tBleStatus CUSTOM_STM_App_Update_Char(uint16_t UUID, uint8_t * pPayload, uint16_t Length)
{
    ...
    case P2P_NOTIFY_CHAR_UUID:
        ...
        result = aci_gatt_update_char_value(aCustomContext.CustomSvcHdle, aCustomContext.NotifyServerToClientCharHdle,
                                            0,      /* charValOffset */
                                            Length, /* charValueLen */
                                            (uint8_t *) pPayload);
    ...
    case HCI_VENDOR_SPECIFIC_DEBUG_EVT_CODE: {
        ...
        case ACI_GATT_ATTRIBUTE_MODIFIED_VSEVT_CODE: {
            ...
            if (p_attribute_modified->Attr_Handle == (aCustomContext.NotifyServerToClientCharHdle + 2))
            {
                 ...
                 */
                if (p_attribute_modified->Attr_Data[0] & (1 << 1))
                { // COMSVC_Indication) {
