...
static uint32_t GPIO_PORT_TO_PWR_NUM(GPIO_TypeDef * gpio_port)
{
    ...
    if (gpio_port == GPIOA)
    {
        pwr_gpio_port = LL_PWR_GPIO_STATE_RETENTION_ENABLE_PORTA;
    }
    else if (gpio_port == GPIOB)
    {
        pwr_gpio_port = LL_PWR_GPIO_STATE_RETENTION_ENABLE_PORTB;
    }
    else if (gpio_port == GPIOC)
    {
        pwr_gpio_port = LL_PWR_GPIO_STATE_RETENTION_ENABLE_PORTC;
    }
    else if (gpio_port == GPIOH)
    {
        pwr_gpio_port = LL_PWR_GPIO_STATE_RETENTION_ENABLE_PORTH;
    }
