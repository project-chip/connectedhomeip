...
#define GPIO_DEBUG_LOW_POWER_STOP_MODE_ACTIVE                                                                                      \
    {                                                                                                                              \
        GPIOB, LL_PWR_GPIO_PIN_3                                                                                                   \
    }

#define USE_RT_DEBUG_LOW_POWER_STOP2_MODE_ENTER (0)
#define GPIO_DEBUG_LOW_POWER_STOP2_MODE_ENTER                                                                                      \
    {                                                                                                                              \
        GPIOA, LL_PWR_GPIO_PIN_0                                                                                                   \
    }

#define USE_RT_DEBUG_LOW_POWER_STOP2_MODE_EXIT (0)
#define GPIO_DEBUG_LOW_POWER_STOP2_MODE_EXIT                                                                                       \
    {                                                                                                                              \
        GPIOA, LL_PWR_GPIO_PIN_0                                                                                                   \
    }

#define USE_RT_DEBUG_LOW_POWER_STOP2_MODE_ACTIVE (0)
#define GPIO_DEBUG_LOW_POWER_STOP2_MODE_ACTIVE                                                                                     \
    {                                                                                                                              \
        GPIOA, LL_PWR_GPIO_PIN_0                                                                                                   \
    }
...
#define GPIO_DEBUG_BACK_FROM_DEEP_SLEEP                                                                                            \
    {                                                                                                                              \
        GPIOA, LL_PWR_GPIO_PIN_0                                                                                                   \
    }
