...
/**
 * @brief
 *   A base class that manages an on-off LED on a board.
 */
class LedOnOff : public LedWidgetInterface
{
public:
    void Init(uint8_t index = 0, bool inverted = 0) override;
