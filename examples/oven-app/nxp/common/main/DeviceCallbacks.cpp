...
void OvenApp::DeviceCallbacks::DeviceEventCallback(const chip::DeviceLayer::ChipDeviceEvent * event, intptr_t arg)
{
...
void OvenApp::DeviceCallbacks::PostAttributeChangeCallback(EndpointId endpointId, ClusterId clusterId,
...
OvenApp::DeviceCallbacks & OvenApp::DeviceCallbacks::GetDefaultInstance()
{
...
{
    return OvenApp::DeviceCallbacks::GetDefaultInstance();
}
