...
void RoomACApp::DeviceCallbacks::PostAttributeChangeCallback(EndpointId endpointId, ClusterId clusterId, AttributeId attributeId,
...
RoomACApp::DeviceCallbacks & RoomACApp::DeviceCallbacks::GetDefaultInstance()
{
...
{
    return RoomACApp::DeviceCallbacks::GetDefaultInstance();
}
