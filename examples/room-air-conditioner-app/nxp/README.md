# CHIP NXP Room Air Conditioner Application

## Overview

The NXP Room Air Conditioner example is based on
[Project CHIP](https://github.com/project-chip/connectedhomeip) and NXP SDK, and
provides a prototype of a room-ac device that demonstrates device commissioning and
different cluster control.

### Supported platforms

The Room Air Conditioner example is supported on the following platforms :
