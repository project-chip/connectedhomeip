...
#define MATTER_CRITICAL(msgid, kvcount, ...) PmLogCritical(logContext, msgid, kvcount, ##__VA_ARGS__)

#define MATTER_ERROR(msgid, kvcount, ...) PmLogError(logContext, msgid, kvcount, ##__VA_ARGS__)

#define MATTER_WARNING(msgid, kvcount, ...) PmLogWarning(logContext, msgid, kvcount, ##__VA_ARGS__)

#define MATTER_INFO(msgid, kvcount, ...) PmLogInfo(logContext, msgid, kvcount, ##__VA_ARGS__)

#define MATTER_DEBUG(fmt, ...) PmLogDebug(logContext, "%s:%s() " fmt, __FILE__, __FUNCTION__, ##__VA_ARGS__)
