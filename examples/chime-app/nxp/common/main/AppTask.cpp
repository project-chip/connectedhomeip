...
{
    ChipLogProgress(DeviceLayer, "Welcome to NXP Chime Demo App");
}
...
ChimeApp::AppTask & ChimeApp::AppTask::GetDefaultInstance()
{
    static ChimeApp::AppTask sAppTask;
    return sAppTask;
}

chip::NXP::App::AppTaskBase & chip::NXP::App::GetAppTask()
{
    return ChimeApp::AppTask::GetDefaultInstance();
}
