...
void ChimeApp::DeviceCallbacks::PostAttributeChangeCallback(EndpointId endpointId, ClusterId clusterId,
...
ChimeApp::DeviceCallbacks & ChimeApp::DeviceCallbacks::GetDefaultInstance()
{
...
{
    return ChimeApp::DeviceCallbacks::GetDefaultInstance();
}
