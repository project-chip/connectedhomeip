...
CURRENT_IN_PROGRESS_DEFINES = [
    ...
    "audio-messages",
    "camera-av-analytics",
    "cameras-remote-zones",
    "CurrentHue-scenable",
    "deprecate-im-revision-field",
    "device-location",
    "electrical-sensor-alarm",
    "energy-auxswitch-device-type",
    "energy-electrical-protection",
    "groups-soft-deprecation",
    "hrap-pdc",
    "hrap-proxy",
    "humidistat",
    ...
    "remove-nonvolatile-PS",
    "resource-medium",
    "scenes-fixes",
    "smoke-concentration-tcr",
    "streaming-casting-speakers",
    "tariff-externalid",
    "thermostat-min-setpoint-duration",
    "thermostat-sensors",
    "tstatmode",
    "uwb-ranging",
...
def dump_ids_from_data_model_dirs():
    ...
    def print_out_ids(filename: Path,
                      ...
                      pics_codes: IdToPICSCodeDict | None = None):
