...
class ThreadBorderRouter:
    ...
    # The Thread radio simulation node id
    THREAD_NODE_ID = 9
    ...
    def __init__(self, ns: IsolatedNetworkNamespace):
        ...
        radio_url = f'spinel+hdlc+forkpty:///usr/bin/env?forkpty-arg=ot-rcp&forkpty-arg={self.THREAD_NODE_ID}'
        args = [
        ...
        self.join_network('0e08000000000001000000030000104a0300001635060004001fffe0020884fa18779329ac770708fd269658e44aa21a030f4f70656e5468726561642d32386335010228c50c0402a0f7f8051000112233445566778899aabbccddeeff041000112233445566778899aabbccddeeff')
