...
stdbuf -o0 ./out/ota_requestor_debug/chip-ota-requestor-app --discriminator "$DISCRIMINATOR" --secured-device-port "$UDP_PORT" --KVS /tmp/ota/chip_kvs_requestor | tee /tmp/ota/requestor-log.txt &
