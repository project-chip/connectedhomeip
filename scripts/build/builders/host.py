...
class HostBuilder(GnBuilder):
    ...
    def __init__(self, root, runner, app: HostApp, board=HostBoard.NATIVE,
                 ...
                 enable_thread=True, enable_tcp=True, use_tsan=False, use_asan=False, use_ubsan=False,
        ...
        if not enable_tcp:
            self.extra_gn_options.append('chip_inet_config_enable_tcp_endpoint=false')
