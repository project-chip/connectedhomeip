...
./out/chip-tool pairing onnetwork-long 2 "$ARG1" "$ARG2"  > /tmp/ota/chip-tool-commission-requestor.txt 
...
./out/chip-tool otasoftwareupdaterequestor announce-ota-provider 1 0 0 0 2 0  > /tmp/ota/chip-tool-announce-ota.txt 
