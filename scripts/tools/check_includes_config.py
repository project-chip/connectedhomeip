...
ALLOW: Dict[str, Set[str]] = {
    ...
    'src/app/clusters/camera-av-stream-management-server/camera-av-stream-management-cluster.h': {'vector'},
    'src/app/clusters/camera-av-stream-management-server/camera-av-stream-management-cluster.cpp': {'set'},
