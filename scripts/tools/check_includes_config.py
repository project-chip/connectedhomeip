...
ALLOW: Dict[str, Set[str]] = {
    ...
    'src/app/clusters/push-av-stream-transport-server/PushAVStreamTransportCluster.cpp': {'set'},
    'src/app/clusters/push-av-stream-transport-server/PushAVStreamTransportCluster.h': {'vector'},
