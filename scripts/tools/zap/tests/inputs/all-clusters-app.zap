      ...
      "clusters": [
        ...
        },
        {
          ...
          "attributes": [
            ...
            "    0xfffc |         | server |           RAM |           |         |                0xD13 |          1 |                   1 |               65534 |                     => FeatureMap [bitmap32]",
        ...
        },
        {
          ...
          "attributes": [
            ...
            "    0x0007 |         | server |           RAM |           |         |                 0x00 |          1 |                   1 |               65534 |                     => RockSupport [RockBitmap]",
            "    0x0008 |         | server |           RAM |           |         |                 0x00 |          1 |                   1 |               65534 |                     => RockSetting [RockBitmap]",
            "    0x0009 |         | server |           RAM |           |         |                 0x00 |          1 |                   1 |               65534 |                     => WindSupport [WindBitmap]",
            "    0x000a |         | server |           RAM |           |         |                 0x00 |          1 |                   1 |               65534 |                     => WindSetting [WindBitmap]",
            "    0xfffc |         | server |           RAM |           |         |                 0x0F |          1 |                   1 |               65534 |                     => FeatureMap [bitmap32]",
            "    0xfffd |         | server |           RAM |           |         |                    2 |          1 |                   1 |               65534 |                     => ClusterRevision [int16u]"
          ]
        },
        {
        ...
        },
        {
          ...
          "attributes": [
            "   code    | mfgCode |  side  | storageOption | singleton | bounded |     defaultValue     | reportable |     minInterval     |     maxInterval     |   reportableChange",
            "    0x0000 |         | server |           RAM |           |         |                 0x00 |          1 |                     |               65344 |                     => CurrentHue [int8u]",
            "    0x0001 |         | server |           RAM |           |         |                 0x00 |          1 |                     |               65344 |                     => CurrentSaturation [int8u]",
            "    0x0002 |         | server |           RAM |           |         |               0x0000 |          1 |                     |               65344 |                     => RemainingTime [int16u]",
            "    0x0003 |         | server |           RAM |           |         |               0x616B |          1 |                     |               65344 |                     => CurrentX [int16u]",
            "    0x0004 |         | server |           RAM |           |         |               0x607D |          1 |                     |               65344 |                     => CurrentY [int16u]",
            "    0x0005 |         | server |           RAM |           |         |                      |          1 |                     |               65344 |                     => DriftCompensation [enum8]",
            "    0x0006 |         | server |           RAM |           |         |                      |          1 |                     |               65344 |                     => CompensationText [char_string]",
            "    0x0007 |         | server |           RAM |           |         |               0x00FA |          1 |                     |               65344 |                     => ColorTemperatureMireds [int16u]",
            ...
            "    0x4000 |         | server |           RAM |           |         |               0x0000 |          1 |                     |               65344 |                     => EnhancedCurrentHue [int16u]",
            "    0x4001 |         | server |           RAM |           |         |                 0x01 |          1 |                     |               65344 |                     => EnhancedColorMode [enum8]",
            "    0x4002 |         | server |           RAM |           |         |                 0x00 |          1 |                     |               65344 |                     => ColorLoopActive [int8u]",
            "    0x4003 |         | server |           RAM |           |         |                 0x00 |          1 |                     |               65344 |                     => ColorLoopDirection [int8u]",
            "    0x4004 |         | server |           RAM |           |         |               0x0019 |          1 |                     |               65344 |                     => ColorLoopTime [int16u]",
            ...
            "    0x4010 |         | server |           RAM |           |         |                      |          1 |                     |               65344 |                     => StartUpColorTemperatureMireds [int16u]",
