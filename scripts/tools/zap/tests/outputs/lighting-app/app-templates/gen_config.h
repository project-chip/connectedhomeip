...
#define MATTER_DM_THERMOSTAT_MODE_CLUSTER_SERVER_ENDPOINT_COUNT (0)
...
#define MATTER_DM_THREAD_BORDER_ROUTER_DIAGNOSTICS_CLUSTER_SERVER_ENDPOINT_COUNT (0)
...
#define MATTER_DM_MEDIA_FILE_MANAGEMENT_CLUSTER_SERVER_ENDPOINT_COUNT (0)
#define MATTER_DM_AUDIO_CONTROL_CLUSTER_SERVER_ENDPOINT_COUNT (0)
...
#define MATTER_DM_TEST_HIDDEN_MANUFACTURER_SPECIFIC_SERVER_ENDPOINT_COUNT (0)
...
#define MATTER_DM_THERMOSTAT_MODE_CLUSTER_CLIENT_ENDPOINT_COUNT (0)
...
#define MATTER_DM_THREAD_BORDER_ROUTER_DIAGNOSTICS_CLUSTER_CLIENT_ENDPOINT_COUNT (0)
...
#define MATTER_DM_MEDIA_FILE_MANAGEMENT_CLUSTER_CLIENT_ENDPOINT_COUNT (0)
#define MATTER_DM_AUDIO_CONTROL_CLUSTER_CLIENT_ENDPOINT_COUNT (0)
...
#define MATTER_DM_TEST_HIDDEN_MANUFACTURER_SPECIFIC_CLIENT_ENDPOINT_COUNT (0)
