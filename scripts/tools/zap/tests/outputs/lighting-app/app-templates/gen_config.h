...
// Use this macro to check if the server side of the User Label cluster is
// included
...
#define MATTER_CLUSTER_SCENE_NAME_SUPPORT                                      \
  (0x0001 & MATTER_CLUSTER_SCENE_NAME_SUPPORT_MASK)
...
#define MATTER_CLUSTER_TABLE_SIZE_SUPPORT                                      \
  (0x0001 & MATTER_CLUSTER_TABLE_SIZE_SUPPORT_MASK)
...
// Use this macro to check if the server side of the Occupancy Sensing cluster
// is included
