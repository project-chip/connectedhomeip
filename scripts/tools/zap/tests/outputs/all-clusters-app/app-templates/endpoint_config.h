...
#define GENERATED_MIN_MAX_DEFAULTS                                             \
  {                                                                            \
    ...
    {(uint16_t)0x0, (uint16_t)0x0, (uint16_t)0x1}, /* HourFormat */            \
        ...
        {(uint16_t)0x3, (uint16_t)0x1,                                         \
         (uint16_t)0xFF}, /* WrongCodeEntryLimit */                            \
        {(uint16_t)0xA, (uint16_t)0x1,                                         \
         (uint16_t)0xFF}, /* UserCodeTemporaryDisableTime */                   \
                                                                               \
        ...
        {(uint16_t)0xA28, (uint16_t)-0x6AB3,                                   \
         (uint16_t)0x7FFF}, /* OccupiedCoolingSetpoint */                      \
        {(uint16_t)0x7D0, (uint16_t)-0x6AB3,                                   \
        ...
        {(uint16_t)0x19, (uint16_t)0x0,                                        \
         (uint16_t)0x19}, /* MinSetpointDeadBand */                            \
        ...
        {(uint16_t)0x0, (uint16_t)0x0, (uint16_t)0x64}, /* speed setting */    \
                                                                               \
        /* Endpoint: 1, Cluster: Thermostat User Interface Configuration       \
           (server) */                                                         \
        {(uint16_t)0x0, (uint16_t)0x0,                                         \
         (uint16_t)0x1}, /* temperature display mode */                        \
        {(uint16_t)0x0, (uint16_t)0x0, (uint16_t)0x5}, /* keypad lockout */    \
        {(uint16_t)0x0, (uint16_t)0x0,                                         \
         (uint16_t)0x1}, /* schedule programming visibility */                 \
                                                                               \
        ...
        {(uint16_t)0x46, (uint16_t)0x14,                                       \
         (uint16_t)0x64}, /* range_restricted_int8u */                         \
        {(uint16_t)-0x14, (uint16_t)-0x28,                                     \
         (uint16_t)0x32}, /* range_restricted_int8s */                         \
        {(uint16_t)0xC8, (uint16_t)0x64,                                       \
         (uint16_t)0x3E8}, /* range_restricted_int16u */                       \
        {(uint16_t)-0x64, (uint16_t)-0x96,                                     \
         (uint16_t)0xC8}, /* range_restricted_int16s */                        \
        {(uint16_t)0x46, (uint16_t)0x14,                                       \
         (uint16_t)0x64}, /* nullable_range_restricted_int8u */                \
        {(uint16_t)-0x14, (uint16_t)-0x28,                                     \
         (uint16_t)0x32}, /* nullable_range_restricted_int8s */                \
        {(uint16_t)0xC8, (uint16_t)0x64,                                       \
         (uint16_t)0x3E8}, /* nullable_range_restricted_int16u */              \
        {(uint16_t)-0x64, (uint16_t)-0x96,                                     \
         (uint16_t)0xC8}, /* nullable_range_restricted_int16s */               \
                                                                               \
...
#define GENERATED_ATTRIBUTES                                                   \
  {                                                                            \
    ...
    {0x00000000, ZAP_TYPE(INT16U), 2, ZAP_ATTRIBUTE_MASK(WRITABLE),            \
     ZAP_SIMPLE_DEFAULT(0x0000)}, /* IdentifyTime */                           \
        {0x00000001, ZAP_TYPE(ENUM8), 1, 0,                                    \
         ZAP_SIMPLE_DEFAULT(0x0)}, /* IdentifyType */                          \
        ...
        {0x0000000C, ZAP_TYPE(CHAR_STRING), 33,                                \
         ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) | ZAP_ATTRIBUTE_MASK(SINGLETON), \
         ZAP_EMPTY_DEFAULT()}, /* PartNumber */                                \
        {0x0000000D, ZAP_TYPE(LONG_CHAR_STRING), 258,                          \
         ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) | ZAP_ATTRIBUTE_MASK(SINGLETON), \
         ZAP_EMPTY_DEFAULT()}, /* ProductURL */                                \
        {0x0000000E, ZAP_TYPE(CHAR_STRING), 65,                                \
         ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) | ZAP_ATTRIBUTE_MASK(SINGLETON), \
        ...
        {0x00000003, ZAP_TYPE(INT8U), 1, ZAP_ATTRIBUTE_MASK(NULLABLE),         \
         ZAP_SIMPLE_DEFAULT(0)}, /* UpdateStateProgress */                     \
        {0x0000FFFC, ZAP_TYPE(BITMAP32), 4, 0,                                 \
         ZAP_SIMPLE_DEFAULT(0)}, /* FeatureMap */                              \
        {0x0000FFFD, ZAP_TYPE(INT16U), 2, 0,                                   \
         ZAP_SIMPLE_DEFAULT(1)}, /* ClusterRevision */                         \
                                                                               \
        /* Endpoint: 0, Cluster: Localization Configuration (server) */        \
        {0x00000000, ZAP_TYPE(CHAR_STRING), 36,                                \
        ...
        {0x0000FFFC, ZAP_TYPE(BITMAP32), 4, 0,                                 \
         ZAP_SIMPLE_DEFAULT(0x1)}, /* FeatureMap */                            \
        {0x0000FFFD, ZAP_TYPE(INT16U), 2, 0,                                   \
         ZAP_SIMPLE_DEFAULT(1)}, /* ClusterRevision */                         \
                                                                               \
        /* Endpoint: 0, Cluster: Power Source Configuration (server) */        \
        {0x00000000, ZAP_TYPE(ARRAY), 0, ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE), \
         ZAP_EMPTY_DEFAULT()}, /* Sources */                                   \
        {0x0000FFFC, ZAP_TYPE(BITMAP32), 4, 0,                                 \
         ZAP_SIMPLE_DEFAULT(0)}, /* FeatureMap */                              \
        {0x0000FFFD, ZAP_TYPE(INT16U), 2, 0,                                   \
         ZAP_SIMPLE_DEFAULT(1)}, /* ClusterRevision */                         \
        ...
        {0x00000000, ZAP_TYPE(ENUM8), 1, 0,                                    \
         ZAP_SIMPLE_DEFAULT(0)}, /* Status */                                  \
        {0x00000001, ZAP_TYPE(INT8U), 1, 0,                                    \
         ZAP_SIMPLE_DEFAULT(3)}, /* Order */                                   \
        {0x00000002, ZAP_TYPE(CHAR_STRING), 61, 0,                             \
         ZAP_LONG_DEFAULTS_INDEX(6)}, /* Description */                        \
        {0x0000000E, ZAP_TYPE(ENUM8), 1, 0,                                    \
         ZAP_SIMPLE_DEFAULT(0)}, /* BatChargeLevel */                          \
        {0x0000000F, ZAP_TYPE(BOOLEAN), 1, 0,                                  \
         ZAP_EMPTY_DEFAULT()}, /* BatReplacementNeeded */                      \
        {0x00000010, ZAP_TYPE(ENUM8), 1, 0,                                    \
         ZAP_EMPTY_DEFAULT()}, /* BatReplaceability */                         \
        {0x0000FFFC, ZAP_TYPE(BITMAP32), 4, 0,                                 \
         ZAP_SIMPLE_DEFAULT(2)}, /* FeatureMap */                              \
        {0x0000FFFD, ZAP_TYPE(INT16U), 2, 0,                                   \
         ZAP_SIMPLE_DEFAULT(1)}, /* ClusterRevision */                         \
                                                                               \
        /* Endpoint: 0, Cluster: General Commissioning (server) */             \
        {0x00000000, ZAP_TYPE(INT64U), 8, ZAP_ATTRIBUTE_MASK(WRITABLE),        \
         ZAP_LONG_DEFAULTS_INDEX(9)}, /* Breadcrumb */                         \
        ...
        {0x0000FFFC, ZAP_TYPE(BITMAP32), 4, 0,                                 \
         ZAP_SIMPLE_DEFAULT(0x000F)}, /* FeatureMap */                         \
        {0x0000FFFD, ZAP_TYPE(INT16U), 2, 0,                                   \
         ZAP_SIMPLE_DEFAULT(1)}, /* ClusterRevision */                         \
                                                                               \
        ...
        {0x00000001, ZAP_TYPE(BOOLEAN), 1,                                     \
         ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) | ZAP_ATTRIBUTE_MASK(NULLABLE),  \
         ZAP_EMPTY_DEFAULT()}, /* FullDuplex */                                \
        {0x00000002, ZAP_TYPE(INT64U), 8,                                      \
         ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE),                                 \
         ZAP_EMPTY_DEFAULT()}, /* PacketRxCount */                             \
        {0x00000003, ZAP_TYPE(INT64U), 8,                                      \
         ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE),                                 \
         ZAP_EMPTY_DEFAULT()}, /* PacketTxCount */                             \
        {0x00000004, ZAP_TYPE(INT64U), 8,                                      \
         ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE),                                 \
         ZAP_EMPTY_DEFAULT()}, /* TxErrCount */                                \
        {0x00000005, ZAP_TYPE(INT64U), 8,                                      \
         ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE),                                 \
         ZAP_EMPTY_DEFAULT()}, /* CollisionCount */                            \
        {0x00000006, ZAP_TYPE(INT64U), 8,                                      \
         ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE),                                 \
         ZAP_EMPTY_DEFAULT()}, /* OverrunCount */                              \
        {0x00000007, ZAP_TYPE(BOOLEAN), 1,                                     \
         ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) | ZAP_ATTRIBUTE_MASK(NULLABLE),  \
         ZAP_EMPTY_DEFAULT()}, /* CarrierDetect */                             \
        {0x00000008, ZAP_TYPE(INT64U), 8,                                      \
         ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE),                                 \
         ZAP_EMPTY_DEFAULT()}, /* TimeSinceReset */                            \
        {0x0000FFFC, ZAP_TYPE(BITMAP32), 4, 0,                                 \
         ZAP_SIMPLE_DEFAULT(3)}, /* FeatureMap */                              \
        {0x0000FFFD, ZAP_TYPE(INT16U), 2, 0,                                   \
         ZAP_SIMPLE_DEFAULT(1)}, /* ClusterRevision */                         \
        ...
        {0x0000FFFD, ZAP_TYPE(INT16U), 2, 0,                                   \
         ZAP_SIMPLE_DEFAULT(4)}, /* ClusterRevision */                         \
                                                                               \
        /* Endpoint: 1, Cluster: On/Off (server) */                            \
        {0x00000000, ZAP_TYPE(BOOLEAN), 1, ZAP_ATTRIBUTE_MASK(TOKENIZE),       \
         ZAP_SIMPLE_DEFAULT(0x00)}, /* OnOff */                                \
        {0x00004000, ZAP_TYPE(BOOLEAN), 1, 0,                                  \
         ZAP_SIMPLE_DEFAULT(0x01)}, /* GlobalSceneControl */                   \
        ...
        {0x0000FFFC, ZAP_TYPE(BITMAP32), 4, 0,                                 \
         ZAP_SIMPLE_DEFAULT(0x0001)}, /* FeatureMap */                         \
        {0x0000FFFD, ZAP_TYPE(INT16U), 2, 0,                                   \
         ZAP_SIMPLE_DEFAULT(4)}, /* ClusterRevision */                         \
                                                                               \
        /* Endpoint: 1, Cluster: On/off Switch Configuration (server) */       \
        {0x00000000, ZAP_TYPE(ENUM8), 1, 0,                                    \
         ZAP_EMPTY_DEFAULT()}, /* switch type */                               \
        {0x00000010, ZAP_TYPE(ENUM8), 1,                                       \
        ...
        {0x0000FFFD, ZAP_TYPE(INT16U), 2, 0,                                   \
         ZAP_SIMPLE_DEFAULT(1)}, /* ClusterRevision */                         \
                                                                               \
        /* Endpoint: 1, Cluster: Level Control (server) */                     \
        {0x00000000, ZAP_TYPE(INT8U), 1,                                       \
         ZAP_ATTRIBUTE_MASK(TOKENIZE) | ZAP_ATTRIBUTE_MASK(NULLABLE),          \
         ZAP_SIMPLE_DEFAULT(0xFE)}, /* CurrentLevel */                         \
        {0x00000001, ZAP_TYPE(INT16U), 2, 0,                                   \
         ZAP_SIMPLE_DEFAULT(0x0000)}, /* RemainingTime */                      \
        {0x00000002, ZAP_TYPE(INT8U), 1, 0,                                    \
         ZAP_SIMPLE_DEFAULT(0x01)}, /* MinLevel */                             \
        {0x00000003, ZAP_TYPE(INT8U), 1, 0,                                    \
         ZAP_SIMPLE_DEFAULT(0xFE)}, /* MaxLevel */                             \
        {0x00000004, ZAP_TYPE(INT16U), 2, 0,                                   \
         ZAP_SIMPLE_DEFAULT(0x0000)}, /* CurrentFrequency */                   \
        {0x00000005, ZAP_TYPE(INT16U), 2, 0,                                   \
         ZAP_SIMPLE_DEFAULT(0x0000)}, /* MinFrequency */                       \
        {0x00000006, ZAP_TYPE(INT16U), 2, 0,                                   \
         ZAP_SIMPLE_DEFAULT(0x0000)}, /* MaxFrequency */                       \
        ...
        {0x0000FFFD, ZAP_TYPE(INT16U), 2, 0,                                   \
         ZAP_SIMPLE_DEFAULT(5)}, /* ClusterRevision */                         \
                                                                               \
        /* Endpoint: 1, Cluster: Binary Input (Basic) (server) */              \
        {0x00000051, ZAP_TYPE(BOOLEAN), 1,                                     \
         ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE),           \
         ZAP_MIN_MAX_DEFAULTS_INDEX(5)}, /* out of service */                  \
        {0x00000055, ZAP_TYPE(BOOLEAN), 1, ZAP_ATTRIBUTE_MASK(WRITABLE),       \
         ZAP_EMPTY_DEFAULT()}, /* present value */                             \
        {0x0000006F, ZAP_TYPE(BITMAP8), 1, 0,                                  \
         ZAP_SIMPLE_DEFAULT(0x00)}, /* status flags */                         \
        {0x0000FFFC, ZAP_TYPE(BITMAP32), 4, 0,                                 \
         ZAP_SIMPLE_DEFAULT(0)}, /* FeatureMap */                              \
        {0x0000FFFD, ZAP_TYPE(INT16U), 2, 0,                                   \
         ZAP_SIMPLE_DEFAULT(1)}, /* ClusterRevision */                         \
        ...
        {0x00000000, ZAP_TYPE(ARRAY), 0, ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE), \
         ZAP_EMPTY_DEFAULT()}, /* ActionList */                                \
        {0x00000001, ZAP_TYPE(ARRAY), 0, ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE), \
         ZAP_EMPTY_DEFAULT()}, /* EndpointLists */                             \
        {0x00000002, ZAP_TYPE(LONG_CHAR_STRING), 514,                          \
         ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE),                                 \
        ...
        {0x00000000, ZAP_TYPE(ENUM8), 1, 0,                                    \
         ZAP_SIMPLE_DEFAULT(0)}, /* Status */                                  \
        {0x00000001, ZAP_TYPE(INT8U), 1, 0,                                    \
         ZAP_SIMPLE_DEFAULT(2)}, /* Order */                                   \
        {0x00000002, ZAP_TYPE(CHAR_STRING), 61, 0,                             \
         ZAP_LONG_DEFAULTS_INDEX(17)}, /* Description */                       \
        {0x0000000E, ZAP_TYPE(ENUM8), 1, 0,                                    \
         ZAP_SIMPLE_DEFAULT(0)}, /* BatChargeLevel */                          \
        {0x0000000F, ZAP_TYPE(BOOLEAN), 1, 0,                                  \
         ZAP_EMPTY_DEFAULT()}, /* BatReplacementNeeded */                      \
        ...
        {0x00000000, ZAP_TYPE(INT8U), 1, 0,                                    \
         ZAP_SIMPLE_DEFAULT(2)}, /* NumberOfPositions */                       \
        {0x00000001, ZAP_TYPE(INT8U), 1, 0,                                    \
         ZAP_EMPTY_DEFAULT()}, /* CurrentPosition */                           \
        {0x00000002, ZAP_TYPE(INT8U), 1, 0,                                    \
         ZAP_SIMPLE_DEFAULT(2)}, /* MultiPressMax */                           \
        {0x0000FFFC, ZAP_TYPE(BITMAP32), 4, 0,                                 \
         ZAP_SIMPLE_DEFAULT(1)}, /* FeatureMap */                              \
        {0x0000FFFD, ZAP_TYPE(INT16U), 2, 0,                                   \
         ZAP_SIMPLE_DEFAULT(1)}, /* ClusterRevision */                         \
        ...
        {0x00000000, ZAP_TYPE(BOOLEAN), 1, 0,                                  \
         ZAP_SIMPLE_DEFAULT(0)}, /* StateValue */                              \
        {0x0000FFFC, ZAP_TYPE(BITMAP32), 4, 0,                                 \
         ZAP_SIMPLE_DEFAULT(0)}, /* FeatureMap */                              \
        {0x0000FFFD, ZAP_TYPE(INT16U), 2, 0,                                   \
         ZAP_SIMPLE_DEFAULT(1)}, /* ClusterRevision */                         \
        ...
        {0x00000000, ZAP_TYPE(CHAR_STRING), 33, 0,                             \
         ZAP_LONG_DEFAULTS_INDEX(20)}, /* Description */                       \
        {0x00000001, ZAP_TYPE(ENUM16), 2, ZAP_ATTRIBUTE_MASK(NULLABLE),        \
         ZAP_SIMPLE_DEFAULT(0)}, /* StandardNamespace */                       \
        {0xFFF10001, ZAP_TYPE(INT8U), 1, 0,                                    \
         ZAP_SIMPLE_DEFAULT(255)}, /* ManufacturerExtension */                 \
        {0x00000002, ZAP_TYPE(ARRAY), 0, ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE), \
         ZAP_EMPTY_DEFAULT()}, /* SupportedModes */                            \
        {0x00000003, ZAP_TYPE(INT8U), 1, ZAP_ATTRIBUTE_MASK(TOKENIZE),         \
         ZAP_SIMPLE_DEFAULT(0)}, /* CurrentMode */                             \
        ...
        {0x0000FFFD, ZAP_TYPE(INT16U), 2, 0,                                   \
         ZAP_SIMPLE_DEFAULT(1)}, /* ClusterRevision */                         \
                                                                               \
        /* Endpoint: 1, Cluster: Door Lock (server) */                         \
        {0x00000000, ZAP_TYPE(ENUM8), 1, ZAP_ATTRIBUTE_MASK(NULLABLE),         \
         ZAP_SIMPLE_DEFAULT(2)}, /* LockState */                               \
        {0x00000001, ZAP_TYPE(ENUM8), 1, 0,                                    \
         ZAP_EMPTY_DEFAULT()}, /* LockType */                                  \
        {0x00000002, ZAP_TYPE(BOOLEAN), 1, 0,                                  \
         ZAP_EMPTY_DEFAULT()}, /* ActuatorEnabled */                           \
        {0x00000003, ZAP_TYPE(ENUM8), 1, ZAP_ATTRIBUTE_MASK(NULLABLE),         \
         ZAP_EMPTY_DEFAULT()}, /* DoorState */                                 \
        {0x00000004, ZAP_TYPE(INT32U), 4, ZAP_ATTRIBUTE_MASK(WRITABLE),        \
         ZAP_EMPTY_DEFAULT()}, /* DoorOpenEvents */                            \
        {0x00000005, ZAP_TYPE(INT32U), 4, ZAP_ATTRIBUTE_MASK(WRITABLE),        \
         ZAP_EMPTY_DEFAULT()}, /* DoorClosedEvents */                          \
        {0x00000006, ZAP_TYPE(INT16U), 2, ZAP_ATTRIBUTE_MASK(WRITABLE),        \
         ZAP_EMPTY_DEFAULT()}, /* OpenPeriod */                                \
        {0x00000011, ZAP_TYPE(INT16U), 2, 0,                                   \
         ZAP_SIMPLE_DEFAULT(10)}, /* NumberOfTotalUsersSupported */            \
        {0x00000012, ZAP_TYPE(INT16U), 2, 0,                                   \
         ZAP_SIMPLE_DEFAULT(10)}, /* NumberOfPINUsersSupported */              \
        {0x00000013, ZAP_TYPE(INT16U), 2, 0,                                   \
         ZAP_SIMPLE_DEFAULT(10)}, /* NumberOfRFIDUsersSupported */             \
        {0x00000014, ZAP_TYPE(INT8U), 1, 0,                                    \
         ZAP_SIMPLE_DEFAULT(                                                   \
             10)}, /* NumberOfWeekDaySchedulesSupportedPerUser */              \
        {0x00000015, ZAP_TYPE(INT8U), 1, 0,                                    \
         ZAP_SIMPLE_DEFAULT(                                                   \
             10)}, /* NumberOfYearDaySchedulesSupportedPerUser */              \
        {0x00000016, ZAP_TYPE(INT8U), 1, 0,                                    \
         ZAP_SIMPLE_DEFAULT(0)}, /* NumberOfHolidaySchedulesSupported */       \
        {0x00000017, ZAP_TYPE(INT8U), 1, 0,                                    \
         ZAP_SIMPLE_DEFAULT(6)}, /* MaxPINCodeLength */                        \
        {0x00000018, ZAP_TYPE(INT8U), 1, 0,                                    \
         ZAP_SIMPLE_DEFAULT(6)}, /* MinPINCodeLength */                        \
        {0x00000019, ZAP_TYPE(INT8U), 1, 0,                                    \
         ZAP_SIMPLE_DEFAULT(20)}, /* MaxRFIDCodeLength */                      \
        {0x0000001A, ZAP_TYPE(INT8U), 1, 0,                                    \
         ZAP_SIMPLE_DEFAULT(10)}, /* MinRFIDCodeLength */                      \
        {0x0000001B, ZAP_TYPE(BITMAP8), 1, 0,                                  \
         ZAP_SIMPLE_DEFAULT(1)}, /* CredentialRulesSupport */                  \
        {0x0000001C, ZAP_TYPE(INT8U), 1, 0,                                    \
         ZAP_SIMPLE_DEFAULT(5)}, /* NumberOfCredentialsSupportedPerUser */     \
        {0x00000021, ZAP_TYPE(CHAR_STRING), 4, ZAP_ATTRIBUTE_MASK(WRITABLE),   \
         ZAP_LONG_DEFAULTS_INDEX(27)}, /* Language */                          \
        {0x00000023, ZAP_TYPE(INT32U), 4, ZAP_ATTRIBUTE_MASK(WRITABLE),        \
         ZAP_SIMPLE_DEFAULT(60)}, /* AutoRelockTime */                         \
        {0x00000024, ZAP_TYPE(INT8U), 1,                                       \
         ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE),           \
         ZAP_MIN_MAX_DEFAULTS_INDEX(6)}, /* SoundVolume */                     \
        {0x00000025, ZAP_TYPE(ENUM8), 1,                                       \
         ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE),           \
         ZAP_MIN_MAX_DEFAULTS_INDEX(7)}, /* OperatingMode */                   \
        {0x00000026, ZAP_TYPE(BITMAP16), 2, 0,                                 \
         ZAP_SIMPLE_DEFAULT(0xFFF6)}, /* SupportedOperatingModes */            \
        {0x00000027, ZAP_TYPE(BITMAP16), 2, 0,                                 \
         ZAP_SIMPLE_DEFAULT(0)}, /* DefaultConfigurationRegister */            \
        {0x00000029, ZAP_TYPE(BOOLEAN), 1, ZAP_ATTRIBUTE_MASK(WRITABLE),       \
         ZAP_SIMPLE_DEFAULT(0x00)}, /* EnableOneTouchLocking */                \
        {0x0000002A, ZAP_TYPE(BOOLEAN), 1, ZAP_ATTRIBUTE_MASK(WRITABLE),       \
         ZAP_SIMPLE_DEFAULT(0)}, /* EnableInsideStatusLED */                   \
        {0x0000002B, ZAP_TYPE(BOOLEAN), 1, ZAP_ATTRIBUTE_MASK(WRITABLE),       \
         ZAP_SIMPLE_DEFAULT(0x00)}, /* EnablePrivacyModeButton */              \
        {0x00000030, ZAP_TYPE(INT8U), 1,                                       \
         ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE),           \
         ZAP_MIN_MAX_DEFAULTS_INDEX(8)}, /* WrongCodeEntryLimit */             \
        {0x00000031, ZAP_TYPE(INT8U), 1,                                       \
         ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE),           \
        ...
        {0x0000FFFC, ZAP_TYPE(BITMAP32), 4, 0,                                 \
         ZAP_SIMPLE_DEFAULT(0xD13)}, /* FeatureMap */                          \
        {0x0000FFFD, ZAP_TYPE(INT16U), 2, 0,                                   \
         ZAP_SIMPLE_DEFAULT(6)}, /* ClusterRevision */                         \
                                                                               \
        /* Endpoint: 1, Cluster: Window Covering (server) */                   \
        {0x00000000, ZAP_TYPE(ENUM8), 1, 0,                                    \
         ZAP_SIMPLE_DEFAULT(0x08)}, /* Type */                                 \
        {0x00000001, ZAP_TYPE(INT16U), 2, 0,                                   \
         ZAP_SIMPLE_DEFAULT(0xFFFF)}, /* PhysicalClosedLimitLift */            \
        {0x00000002, ZAP_TYPE(INT16U), 2, 0,                                   \
         ZAP_SIMPLE_DEFAULT(0xFFFF)}, /* PhysicalClosedLimitTilt */            \
        {0x00000003, ZAP_TYPE(INT16U), 2,                                      \
         ZAP_ATTRIBUTE_MASK(TOKENIZE) | ZAP_ATTRIBUTE_MASK(NULLABLE),          \
        ...
        {0x00000007, ZAP_TYPE(BITMAP8), 1, ZAP_ATTRIBUTE_MASK(TOKENIZE),       \
         ZAP_SIMPLE_DEFAULT(0x03)}, /* ConfigStatus */                         \
        {0x00000008, ZAP_TYPE(PERCENT), 1,                                     \
         ZAP_ATTRIBUTE_MASK(TOKENIZE) | ZAP_ATTRIBUTE_MASK(NULLABLE),          \
         ZAP_SIMPLE_DEFAULT(50)}, /* CurrentPositionLiftPercentage */          \
        {0x00000009, ZAP_TYPE(PERCENT), 1,                                     \
         ZAP_ATTRIBUTE_MASK(TOKENIZE) | ZAP_ATTRIBUTE_MASK(NULLABLE),          \
         ZAP_SIMPLE_DEFAULT(50)}, /* CurrentPositionTiltPercentage */          \
        {0x0000000A, ZAP_TYPE(BITMAP8), 1, 0,                                  \
         ZAP_SIMPLE_DEFAULT(0x00)}, /* OperationalStatus */                    \
        ...
        {0x0000000D, ZAP_TYPE(ENUM8), 1, 0,                                    \
         ZAP_SIMPLE_DEFAULT(0x00)}, /* EndProductType */                       \
        {0x0000000E, ZAP_TYPE(PERCENT100THS), 2,                               \
         ZAP_ATTRIBUTE_MASK(TOKENIZE) | ZAP_ATTRIBUTE_MASK(NULLABLE),          \
         ZAP_SIMPLE_DEFAULT(5000)}, /* CurrentPositionLiftPercent100ths */     \
        {0x0000000F, ZAP_TYPE(PERCENT100THS), 2,                               \
         ZAP_ATTRIBUTE_MASK(TOKENIZE) | ZAP_ATTRIBUTE_MASK(NULLABLE),          \
        ...
        {0x0000001A, ZAP_TYPE(BITMAP16), 2, 0,                                 \
         ZAP_SIMPLE_DEFAULT(0x00)}, /* SafetyStatus */                         \
        {0x0000FFFC, ZAP_TYPE(BITMAP32), 4, 0,                                 \
         ZAP_SIMPLE_DEFAULT(0x17)}, /* FeatureMap */                           \
        {0x0000FFFD, ZAP_TYPE(INT16U), 2, 0,                                   \
         ZAP_SIMPLE_DEFAULT(5)}, /* ClusterRevision */                         \
                                                                               \
        /* Endpoint: 1, Cluster: Barrier Control (server) */                   \
        {0x00000001, ZAP_TYPE(ENUM8), 1, 0,                                    \
         ZAP_EMPTY_DEFAULT()}, /* barrier moving state */                      \
        {0x00000002, ZAP_TYPE(BITMAP16), 2, 0,                                 \
         ZAP_EMPTY_DEFAULT()}, /* barrier safety status */                     \
        {0x00000003, ZAP_TYPE(BITMAP8), 1, 0,                                  \
         ZAP_EMPTY_DEFAULT()}, /* barrier capabilities */                      \
        {0x0000000A, ZAP_TYPE(INT8U), 1, 0,                                    \
         ZAP_EMPTY_DEFAULT()}, /* barrier position */                          \
        {0x0000FFFC, ZAP_TYPE(BITMAP32), 4, 0,                                 \
         ZAP_SIMPLE_DEFAULT(0)}, /* FeatureMap */                              \
        {0x0000FFFD, ZAP_TYPE(INT16U), 2, 0,                                   \
         ZAP_SIMPLE_DEFAULT(1)}, /* ClusterRevision */                         \
        ...
        {0x00000000, ZAP_TYPE(INT16S), 2, ZAP_ATTRIBUTE_MASK(NULLABLE),        \
         ZAP_EMPTY_DEFAULT()}, /* MaxPressure */                               \
        {0x00000001, ZAP_TYPE(INT16U), 2, ZAP_ATTRIBUTE_MASK(NULLABLE),        \
         ZAP_EMPTY_DEFAULT()}, /* MaxSpeed */                                  \
        {0x00000002, ZAP_TYPE(INT16U), 2, ZAP_ATTRIBUTE_MASK(NULLABLE),        \
         ZAP_EMPTY_DEFAULT()}, /* MaxFlow */                                   \
        {0x00000003, ZAP_TYPE(INT16S), 2, ZAP_ATTRIBUTE_MASK(NULLABLE),        \
         ZAP_EMPTY_DEFAULT()}, /* MinConstPressure */                          \
        {0x00000004, ZAP_TYPE(INT16S), 2, ZAP_ATTRIBUTE_MASK(NULLABLE),        \
         ZAP_EMPTY_DEFAULT()}, /* MaxConstPressure */                          \
        {0x00000005, ZAP_TYPE(INT16S), 2, ZAP_ATTRIBUTE_MASK(NULLABLE),        \
         ZAP_EMPTY_DEFAULT()}, /* MinCompPressure */                           \
        {0x00000006, ZAP_TYPE(INT16S), 2, ZAP_ATTRIBUTE_MASK(NULLABLE),        \
         ZAP_EMPTY_DEFAULT()}, /* MaxCompPressure */                           \
        {0x00000007, ZAP_TYPE(INT16U), 2, ZAP_ATTRIBUTE_MASK(NULLABLE),        \
         ZAP_EMPTY_DEFAULT()}, /* MinConstSpeed */                             \
        {0x00000008, ZAP_TYPE(INT16U), 2, ZAP_ATTRIBUTE_MASK(NULLABLE),        \
         ZAP_EMPTY_DEFAULT()}, /* MaxConstSpeed */                             \
        {0x00000009, ZAP_TYPE(INT16U), 2, ZAP_ATTRIBUTE_MASK(NULLABLE),        \
         ZAP_EMPTY_DEFAULT()}, /* MinConstFlow */                              \
        {0x0000000A, ZAP_TYPE(INT16U), 2, ZAP_ATTRIBUTE_MASK(NULLABLE),        \
         ZAP_EMPTY_DEFAULT()}, /* MaxConstFlow */                              \
        {0x0000000B, ZAP_TYPE(INT16S), 2, ZAP_ATTRIBUTE_MASK(NULLABLE),        \
         ZAP_EMPTY_DEFAULT()}, /* MinConstTemp */                              \
        {0x0000000C, ZAP_TYPE(INT16S), 2, ZAP_ATTRIBUTE_MASK(NULLABLE),        \
         ZAP_EMPTY_DEFAULT()}, /* MaxConstTemp */                              \
        {0x00000010, ZAP_TYPE(BITMAP16), 2, 0,                                 \
         ZAP_EMPTY_DEFAULT()}, /* PumpStatus */                                \
        {0x00000011, ZAP_TYPE(ENUM8), 1, 0,                                    \
         ZAP_EMPTY_DEFAULT()}, /* EffectiveOperationMode */                    \
        {0x00000012, ZAP_TYPE(ENUM8), 1, 0,                                    \
         ZAP_EMPTY_DEFAULT()}, /* EffectiveControlMode */                      \
        {0x00000013, ZAP_TYPE(INT16S), 2, ZAP_ATTRIBUTE_MASK(NULLABLE),        \
         ZAP_EMPTY_DEFAULT()}, /* Capacity */                                  \
        {0x00000014, ZAP_TYPE(INT16U), 2, ZAP_ATTRIBUTE_MASK(NULLABLE),        \
         ZAP_EMPTY_DEFAULT()}, /* Speed */                                     \
        {0x00000015, ZAP_TYPE(INT24U), 3,                                      \
         ZAP_ATTRIBUTE_MASK(WRITABLE) | ZAP_ATTRIBUTE_MASK(NULLABLE),          \
         ZAP_SIMPLE_DEFAULT(0x000000)}, /* LifetimeRunningHours */             \
        {0x00000016, ZAP_TYPE(INT24U), 3, ZAP_ATTRIBUTE_MASK(NULLABLE),        \
         ZAP_EMPTY_DEFAULT()}, /* Power */                                     \
        {0x00000017, ZAP_TYPE(INT32U), 4,                                      \
         ZAP_ATTRIBUTE_MASK(WRITABLE) | ZAP_ATTRIBUTE_MASK(NULLABLE),          \
         ZAP_SIMPLE_DEFAULT(0x00000000)}, /* LifetimeEnergyConsumed */         \
        {0x00000020, ZAP_TYPE(ENUM8), 1,                                       \
         ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE),           \
         ZAP_MIN_MAX_DEFAULTS_INDEX(11)}, /* OperationMode */                  \
        {0x00000021, ZAP_TYPE(ENUM8), 1,                                       \
         ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE),           \
        ...
        /* Endpoint: 1, Cluster: Thermostat (server) */                        \
        {0x00000000, ZAP_TYPE(INT16S), 2, ZAP_ATTRIBUTE_MASK(NULLABLE),        \
         ZAP_EMPTY_DEFAULT()}, /* LocalTemperature */                          \
        {0x00000003, ZAP_TYPE(INT16S), 2, 0,                                   \
         ZAP_SIMPLE_DEFAULT(0x02BC)}, /* AbsMinHeatSetpointLimit */            \
        {0x00000004, ZAP_TYPE(INT16S), 2, 0,                                   \
         ZAP_SIMPLE_DEFAULT(0x0BB8)}, /* AbsMaxHeatSetpointLimit */            \
        {0x00000005, ZAP_TYPE(INT16S), 2, 0,                                   \
         ZAP_SIMPLE_DEFAULT(0x0640)}, /* AbsMinCoolSetpointLimit */            \
        {0x00000006, ZAP_TYPE(INT16S), 2, 0,                                   \
         ZAP_SIMPLE_DEFAULT(0x0C80)}, /* AbsMaxCoolSetpointLimit */            \
        ...
        {0x0000FFFC, ZAP_TYPE(BITMAP32), 4, 0,                                 \
         ZAP_SIMPLE_DEFAULT(0x0023)}, /* FeatureMap */                         \
        {0x0000FFFD, ZAP_TYPE(INT16U), 2, 0,                                   \
         ZAP_SIMPLE_DEFAULT(5)}, /* ClusterRevision */                         \
                                                                               \
        /* Endpoint: 1, Cluster: Fan Control (server) */                       \
        ...
        {0x00000003, ZAP_TYPE(INT8U), 1, 0,                                    \
         ZAP_SIMPLE_DEFAULT(0x00)}, /* percent current */                      \
        {0x00000004, ZAP_TYPE(INT8U), 1, 0,                                    \
         ZAP_SIMPLE_DEFAULT(100)}, /* speed max */                             \
        {0x00000005, ZAP_TYPE(INT8U), 1,                                       \
         ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE) |          \
             ZAP_ATTRIBUTE_MASK(NULLABLE),                                     \
         ZAP_MIN_MAX_DEFAULTS_INDEX(25)}, /* speed setting */                  \
        {0x00000006, ZAP_TYPE(INT8U), 1, 0,                                    \
         ZAP_SIMPLE_DEFAULT(0x00)}, /* speed current */                        \
        {0x00000007, ZAP_TYPE(BITMAP8), 1, 0,                                  \
         ZAP_SIMPLE_DEFAULT(0x00)}, /* rock support */                         \
        {0x00000008, ZAP_TYPE(BITMAP8), 1, ZAP_ATTRIBUTE_MASK(WRITABLE),       \
         ZAP_SIMPLE_DEFAULT(0x00)}, /* rock setting */                         \
        {0x00000009, ZAP_TYPE(BITMAP8), 1, 0,                                  \
         ZAP_SIMPLE_DEFAULT(0x00)}, /* wind support */                         \
        {0x0000000A, ZAP_TYPE(BITMAP8), 1, ZAP_ATTRIBUTE_MASK(WRITABLE),       \
         ZAP_SIMPLE_DEFAULT(0x00)}, /* wind setting */                         \
        {0x0000FFFC, ZAP_TYPE(BITMAP32), 4, 0,                                 \
         ZAP_SIMPLE_DEFAULT(0x0F)}, /* FeatureMap */                           \
        {0x0000FFFD, ZAP_TYPE(INT16U), 2, 0,                                   \
        ...
        {0x00000002, ZAP_TYPE(ENUM8), 1,                                       \
         ...
         ZAP_MIN_MAX_DEFAULTS_INDEX(                                           \
             28)}, /* schedule programming visibility */                       \
        {0x0000FFFC, ZAP_TYPE(BITMAP32), 4, 0,                                 \
         ZAP_SIMPLE_DEFAULT(0)}, /* FeatureMap */                              \
        {0x0000FFFD, ZAP_TYPE(INT16U), 2, 0,                                   \
         ZAP_SIMPLE_DEFAULT(2)}, /* ClusterRevision */                         \
        ...
        /* Endpoint: 1, Cluster: Color Control (server) */                     \
        {0x00000000, ZAP_TYPE(INT8U), 1, 0,                                    \
         ZAP_SIMPLE_DEFAULT(0x00)}, /* CurrentHue */                           \
        {0x00000001, ZAP_TYPE(INT8U), 1, 0,                                    \
         ZAP_SIMPLE_DEFAULT(0x00)}, /* CurrentSaturation */                    \
        {0x00000002, ZAP_TYPE(INT16U), 2, 0,                                   \
         ZAP_SIMPLE_DEFAULT(0x0000)}, /* RemainingTime */                      \
        {0x00000003, ZAP_TYPE(INT16U), 2, 0,                                   \
         ZAP_SIMPLE_DEFAULT(0x616B)}, /* CurrentX */                           \
        {0x00000004, ZAP_TYPE(INT16U), 2, 0,                                   \
         ZAP_SIMPLE_DEFAULT(0x607D)}, /* CurrentY */                           \
        {0x00000005, ZAP_TYPE(ENUM8), 1, 0,                                    \
         ZAP_EMPTY_DEFAULT()}, /* DriftCompensation */                         \
        {0x00000006, ZAP_TYPE(CHAR_STRING), 255, 0,                            \
         ZAP_EMPTY_DEFAULT()}, /* CompensationText */                          \
        {0x00000007, ZAP_TYPE(INT16U), 2, 0,                                   \
         ZAP_SIMPLE_DEFAULT(0x00FA)}, /* ColorTemperatureMireds */             \
        {0x00000008, ZAP_TYPE(ENUM8), 1, 0,                                    \
         ZAP_SIMPLE_DEFAULT(0x01)}, /* ColorMode */                            \
        {0x0000000F, ZAP_TYPE(BITMAP8), 1, ZAP_ATTRIBUTE_MASK(WRITABLE),       \
         ZAP_SIMPLE_DEFAULT(0x00)}, /* Options */                              \
        {0x00000010, ZAP_TYPE(INT8U), 1, ZAP_ATTRIBUTE_MASK(NULLABLE),         \
         ZAP_EMPTY_DEFAULT()}, /* NumberOfPrimaries */                         \
        {0x00000011, ZAP_TYPE(INT16U), 2, 0,                                   \
         ZAP_EMPTY_DEFAULT()}, /* Primary1X */                                 \
        {0x00000012, ZAP_TYPE(INT16U), 2, 0,                                   \
         ZAP_EMPTY_DEFAULT()}, /* Primary1Y */                                 \
        {0x00000013, ZAP_TYPE(INT8U), 1, ZAP_ATTRIBUTE_MASK(NULLABLE),         \
         ZAP_EMPTY_DEFAULT()}, /* Primary1Intensity */                         \
        {0x00000015, ZAP_TYPE(INT16U), 2, 0,                                   \
         ZAP_EMPTY_DEFAULT()}, /* Primary2X */                                 \
        {0x00000016, ZAP_TYPE(INT16U), 2, 0,                                   \
         ZAP_EMPTY_DEFAULT()}, /* Primary2Y */                                 \
        {0x00000017, ZAP_TYPE(INT8U), 1, ZAP_ATTRIBUTE_MASK(NULLABLE),         \
         ZAP_EMPTY_DEFAULT()}, /* Primary2Intensity */                         \
        {0x00000019, ZAP_TYPE(INT16U), 2, 0,                                   \
         ZAP_EMPTY_DEFAULT()}, /* Primary3X */                                 \
        {0x0000001A, ZAP_TYPE(INT16U), 2, 0,                                   \
         ZAP_EMPTY_DEFAULT()}, /* Primary3Y */                                 \
        {0x0000001B, ZAP_TYPE(INT8U), 1, ZAP_ATTRIBUTE_MASK(NULLABLE),         \
         ZAP_EMPTY_DEFAULT()}, /* Primary3Intensity */                         \
        {0x00000020, ZAP_TYPE(INT16U), 2, 0,                                   \
         ZAP_EMPTY_DEFAULT()}, /* Primary4X */                                 \
        {0x00000021, ZAP_TYPE(INT16U), 2, 0,                                   \
         ZAP_EMPTY_DEFAULT()}, /* Primary4Y */                                 \
        {0x00000022, ZAP_TYPE(INT8U), 1, ZAP_ATTRIBUTE_MASK(NULLABLE),         \
         ZAP_EMPTY_DEFAULT()}, /* Primary4Intensity */                         \
        {0x00000024, ZAP_TYPE(INT16U), 2, 0,                                   \
         ZAP_EMPTY_DEFAULT()}, /* Primary5X */                                 \
        {0x00000025, ZAP_TYPE(INT16U), 2, 0,                                   \
         ZAP_EMPTY_DEFAULT()}, /* Primary5Y */                                 \
        {0x00000026, ZAP_TYPE(INT8U), 1, ZAP_ATTRIBUTE_MASK(NULLABLE),         \
         ZAP_EMPTY_DEFAULT()}, /* Primary5Intensity */                         \
        {0x00000028, ZAP_TYPE(INT16U), 2, 0,                                   \
         ZAP_EMPTY_DEFAULT()}, /* Primary6X */                                 \
        {0x00000029, ZAP_TYPE(INT16U), 2, 0,                                   \
         ZAP_EMPTY_DEFAULT()}, /* Primary6Y */                                 \
        {0x0000002A, ZAP_TYPE(INT8U), 1, ZAP_ATTRIBUTE_MASK(NULLABLE),         \
         ZAP_EMPTY_DEFAULT()}, /* Primary6Intensity */                         \
        {0x00000030, ZAP_TYPE(INT16U), 2,                                      \
         ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE),           \
         ZAP_MIN_MAX_DEFAULTS_INDEX(29)}, /* WhitePointX */                    \
        {0x00000031, ZAP_TYPE(INT16U), 2,                                      \
         ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE),           \
         ZAP_MIN_MAX_DEFAULTS_INDEX(30)}, /* WhitePointY */                    \
        {0x00000032, ZAP_TYPE(INT16U), 2,                                      \
         ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE),           \
         ZAP_MIN_MAX_DEFAULTS_INDEX(31)}, /* ColorPointRX */                   \
        {0x00000033, ZAP_TYPE(INT16U), 2,                                      \
         ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE),           \
         ZAP_MIN_MAX_DEFAULTS_INDEX(32)}, /* ColorPointRY */                   \
        {0x00000034, ZAP_TYPE(INT8U), 1,                                       \
         ZAP_ATTRIBUTE_MASK(WRITABLE) | ZAP_ATTRIBUTE_MASK(NULLABLE),          \
         ZAP_EMPTY_DEFAULT()}, /* ColorPointRIntensity */                      \
        {0x00000036, ZAP_TYPE(INT16U), 2,                                      \
         ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE),           \
         ZAP_MIN_MAX_DEFAULTS_INDEX(33)}, /* ColorPointGX */                   \
        {0x00000037, ZAP_TYPE(INT16U), 2,                                      \
         ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE),           \
         ZAP_MIN_MAX_DEFAULTS_INDEX(34)}, /* ColorPointGY */                   \
        {0x00000038, ZAP_TYPE(INT8U), 1,                                       \
         ZAP_ATTRIBUTE_MASK(WRITABLE) | ZAP_ATTRIBUTE_MASK(NULLABLE),          \
         ZAP_EMPTY_DEFAULT()}, /* ColorPointGIntensity */                      \
        {0x0000003A, ZAP_TYPE(INT16U), 2,                                      \
         ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE),           \
         ZAP_MIN_MAX_DEFAULTS_INDEX(35)}, /* ColorPointBX */                   \
        {0x0000003B, ZAP_TYPE(INT16U), 2,                                      \
         ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE),           \
         ZAP_MIN_MAX_DEFAULTS_INDEX(36)}, /* ColorPointBY */                   \
        {0x0000003C, ZAP_TYPE(INT8U), 1,                                       \
         ZAP_ATTRIBUTE_MASK(WRITABLE) | ZAP_ATTRIBUTE_MASK(NULLABLE),          \
         ZAP_EMPTY_DEFAULT()}, /* ColorPointBIntensity */                      \
        {0x00004000, ZAP_TYPE(INT16U), 2, 0,                                   \
         ZAP_SIMPLE_DEFAULT(0x0000)}, /* EnhancedCurrentHue */                 \
        {0x00004001, ZAP_TYPE(ENUM8), 1, 0,                                    \
         ZAP_SIMPLE_DEFAULT(0x01)}, /* EnhancedColorMode */                    \
        {0x00004002, ZAP_TYPE(INT8U), 1, 0,                                    \
         ZAP_SIMPLE_DEFAULT(0x00)}, /* ColorLoopActive */                      \
        {0x00004003, ZAP_TYPE(INT8U), 1, 0,                                    \
         ZAP_SIMPLE_DEFAULT(0x00)}, /* ColorLoopDirection */                   \
        {0x00004004, ZAP_TYPE(INT16U), 2, 0,                                   \
         ZAP_SIMPLE_DEFAULT(0x0019)}, /* ColorLoopTime */                      \
        {0x00004005, ZAP_TYPE(INT16U), 2, 0,                                   \
         ZAP_SIMPLE_DEFAULT(0x2300)}, /* ColorLoopStartEnhancedHue */          \
        {0x00004006, ZAP_TYPE(INT16U), 2, 0,                                   \
         ZAP_SIMPLE_DEFAULT(0x0000)}, /* ColorLoopStoredEnhancedHue */         \
        {0x0000400A, ZAP_TYPE(BITMAP16), 2, 0,                                 \
         ZAP_SIMPLE_DEFAULT(0x1F)}, /* ColorCapabilities */                    \
        {0x0000400B, ZAP_TYPE(INT16U), 2, 0,                                   \
         ZAP_SIMPLE_DEFAULT(0x0000)}, /* ColorTempPhysicalMinMireds */         \
        {0x0000400C, ZAP_TYPE(INT16U), 2, 0,                                   \
         ZAP_SIMPLE_DEFAULT(0xFEFF)}, /* ColorTempPhysicalMaxMireds */         \
        {0x0000400D, ZAP_TYPE(INT16U), 2, 0,                                   \
         ZAP_EMPTY_DEFAULT()}, /* CoupleColorTempToLevelMinMireds */           \
        {0x00004010, ZAP_TYPE(INT16U), 2,                                      \
         ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE) |          \
             ZAP_ATTRIBUTE_MASK(NULLABLE),                                     \
         ZAP_MIN_MAX_DEFAULTS_INDEX(37)}, /* StartUpColorTemperatureMireds */  \
        {0x0000FFFC, ZAP_TYPE(BITMAP32), 4, 0,                                 \
         ZAP_SIMPLE_DEFAULT(0x1F)}, /* FeatureMap */                           \
        {0x0000FFFD, ZAP_TYPE(INT16U), 2, 0,                                   \
         ZAP_SIMPLE_DEFAULT(5)}, /* ClusterRevision */                         \
                                                                               \
        ...
        {0x00000001, ZAP_TYPE(INT16U), 2, ZAP_ATTRIBUTE_MASK(NULLABLE),        \
         ZAP_SIMPLE_DEFAULT(0x01)}, /* MinMeasuredValue */                     \
        {0x00000002, ZAP_TYPE(INT16U), 2, ZAP_ATTRIBUTE_MASK(NULLABLE),        \
         ZAP_SIMPLE_DEFAULT(0xFFFE)}, /* MaxMeasuredValue */                   \
        {0x00000003, ZAP_TYPE(INT16U), 2, 0,                                   \
         ZAP_EMPTY_DEFAULT()}, /* Tolerance */                                 \
        {0x00000004, ZAP_TYPE(ENUM8), 1, ZAP_ATTRIBUTE_MASK(NULLABLE),         \
         ZAP_SIMPLE_DEFAULT(0xFF)}, /* LightSensorType */                      \
        {0x0000FFFC, ZAP_TYPE(BITMAP32), 4, 0,                                 \
         ZAP_SIMPLE_DEFAULT(0)}, /* FeatureMap */                              \
        {0x0000FFFD, ZAP_TYPE(INT16U), 2, 0,                                   \
         ZAP_SIMPLE_DEFAULT(3)}, /* ClusterRevision */                         \
        ...
        {0x00000002, ZAP_TYPE(INT16U), 2, ZAP_ATTRIBUTE_MASK(NULLABLE),        \
         ZAP_EMPTY_DEFAULT()}, /* MaxMeasuredValue */                          \
        {0x00000003, ZAP_TYPE(INT16U), 2, 0,                                   \
         ZAP_SIMPLE_DEFAULT(0)}, /* Tolerance */                               \
        {0x0000FFFC, ZAP_TYPE(BITMAP32), 4, 0,                                 \
         ZAP_SIMPLE_DEFAULT(0)}, /* FeatureMap */                              \
        {0x0000FFFD, ZAP_TYPE(INT16U), 2, 0,                                   \
         ZAP_SIMPLE_DEFAULT(3)}, /* ClusterRevision */                         \
        ...
        {0x00000000, ZAP_TYPE(BITMAP8), 1, 0,                                  \
         ZAP_EMPTY_DEFAULT()}, /* occupancy */                                 \
        {0x00000001, ZAP_TYPE(ENUM8), 1, 0,                                    \
         ZAP_EMPTY_DEFAULT()}, /* occupancy sensor type */                     \
        {0x00000002, ZAP_TYPE(BITMAP8), 1, 0,                                  \
         ZAP_EMPTY_DEFAULT()}, /* occupancy sensor type bitmap */              \
        {0x0000FFFC, ZAP_TYPE(BITMAP32), 4, 0,                                 \
         ZAP_SIMPLE_DEFAULT(0)}, /* FeatureMap */                              \
        {0x0000FFFD, ZAP_TYPE(INT16U), 2, 0,                                   \
         ZAP_SIMPLE_DEFAULT(3)}, /* ClusterRevision */                         \
        ...
        {0x00000000, ZAP_TYPE(ARRAY), 0, ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE), \
         ZAP_EMPTY_DEFAULT()}, /* TargetList */                                \
        {0x00000001, ZAP_TYPE(INT8U), 1, 0,                                    \
         ZAP_SIMPLE_DEFAULT(0x00)}, /* CurrentTarget */                        \
        {0x0000FFFC, ZAP_TYPE(BITMAP32), 4, 0,                                 \
         ZAP_SIMPLE_DEFAULT(0)}, /* FeatureMap */                              \
        {0x0000FFFD, ZAP_TYPE(INT16U), 2, 0,                                   \
         ZAP_SIMPLE_DEFAULT(1)}, /* ClusterRevision */                         \
        ...
        {0x00000000, ZAP_TYPE(ENUM8), 1, 0,                                    \
         ZAP_SIMPLE_DEFAULT(0x00)}, /* CurrentState */                         \
        {0x00000001, ZAP_TYPE(EPOCH_US), 8, ZAP_ATTRIBUTE_MASK(NULLABLE),      \
         ZAP_LONG_DEFAULTS_INDEX(30)}, /* StartTime */                         \
        {0x00000002, ZAP_TYPE(INT64U), 8, ZAP_ATTRIBUTE_MASK(NULLABLE),        \
         ZAP_LONG_DEFAULTS_INDEX(38)}, /* Duration */                          \
        {0x00000004, ZAP_TYPE(SINGLE), 4, 0,                                   \
         ZAP_EMPTY_DEFAULT()}, /* PlaybackSpeed */                             \
        {0x00000005, ZAP_TYPE(INT64U), 8, ZAP_ATTRIBUTE_MASK(NULLABLE),        \
         ZAP_LONG_DEFAULTS_INDEX(46)}, /* SeekRangeEnd */                      \
        {0x00000006, ZAP_TYPE(INT64U), 8, ZAP_ATTRIBUTE_MASK(NULLABLE),        \
         ZAP_LONG_DEFAULTS_INDEX(54)}, /* SeekRangeStart */                    \
        {0x0000FFFC, ZAP_TYPE(BITMAP32), 4, 0,                                 \
         ZAP_SIMPLE_DEFAULT(0)}, /* FeatureMap */                              \
        {0x0000FFFD, ZAP_TYPE(INT16U), 2, 0,                                   \
         ZAP_SIMPLE_DEFAULT(1)}, /* ClusterRevision */                         \
        ...
        {0x00000000, ZAP_TYPE(ARRAY), 0, ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE), \
         ZAP_EMPTY_DEFAULT()}, /* InputList */                                 \
        {0x00000001, ZAP_TYPE(INT8U), 1, 0,                                    \
         ZAP_SIMPLE_DEFAULT(0x00)}, /* CurrentInput */                         \
        {0x0000FFFC, ZAP_TYPE(BITMAP32), 4, 0,                                 \
         ZAP_SIMPLE_DEFAULT(0)}, /* FeatureMap */                              \
        {0x0000FFFD, ZAP_TYPE(INT16U), 2, 0,                                   \
         ZAP_SIMPLE_DEFAULT(1)}, /* ClusterRevision */                         \
        ...
        {0x00000000, ZAP_TYPE(ARRAY), 0, ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE), \
         ZAP_EMPTY_DEFAULT()}, /* AcceptHeader */                              \
        ...
        {0x00000000, ZAP_TYPE(ARRAY), 0, ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE), \
         ZAP_EMPTY_DEFAULT()}, /* OutputList */                                \
        {0x00000001, ZAP_TYPE(INT8U), 1, 0,                                    \
         ZAP_SIMPLE_DEFAULT(0x00)}, /* CurrentOutput */                        \
        {0x0000FFFC, ZAP_TYPE(BITMAP32), 4, 0,                                 \
         ZAP_SIMPLE_DEFAULT(0)}, /* FeatureMap */                              \
        {0x0000FFFD, ZAP_TYPE(INT16U), 2, 0,                                   \
         ZAP_SIMPLE_DEFAULT(1)}, /* ClusterRevision */                         \
        ...
        {0x00000000, ZAP_TYPE(CHAR_STRING), 33, 0,                             \
         ZAP_EMPTY_DEFAULT()}, /* VendorName */                                \
        {0x00000001, ZAP_TYPE(VENDOR_ID), 2, 0,                                \
         ZAP_EMPTY_DEFAULT()}, /* VendorID */                                  \
        {0x00000002, ZAP_TYPE(CHAR_STRING), 33, 0,                             \
         ZAP_EMPTY_DEFAULT()}, /* ApplicationName */                           \
        {0x00000003, ZAP_TYPE(INT16U), 2, 0,                                   \
         ZAP_EMPTY_DEFAULT()}, /* ProductID */                                 \
        {0x00000005, ZAP_TYPE(ENUM8), 1, 0, ZAP_EMPTY_DEFAULT()}, /* Status */ \
        {0x00000006, ZAP_TYPE(CHAR_STRING), 33, 0,                             \
         ZAP_EMPTY_DEFAULT()}, /* ApplicationVersion */                        \
        {0x00000007, ZAP_TYPE(ARRAY), 0, ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE), \
         ZAP_EMPTY_DEFAULT()}, /* AllowedVendorList */                         \
        {0x0000FFFC, ZAP_TYPE(BITMAP32), 4, 0,                                 \
         ZAP_SIMPLE_DEFAULT(0)}, /* FeatureMap */                              \
        {0x0000FFFD, ZAP_TYPE(INT16U), 2, 0,                                   \
         ZAP_SIMPLE_DEFAULT(1)}, /* ClusterRevision */                         \
        ...
        {0x00000000, ZAP_TYPE(BITMAP32), 4, 0,                                 \
         ZAP_SIMPLE_DEFAULT(0x000000)}, /* measurement type */                 \
        {0x00000304, ZAP_TYPE(INT32S), 4, 0,                                   \
         ZAP_SIMPLE_DEFAULT(0x000000)}, /* total active power */               \
        {0x00000505, ZAP_TYPE(INT16U), 2, 0,                                   \
         ZAP_SIMPLE_DEFAULT(0xffff)}, /* rms voltage */                        \
        {0x00000506, ZAP_TYPE(INT16U), 2, 0,                                   \
         ZAP_SIMPLE_DEFAULT(0x8000)}, /* rms voltage min */                    \
        {0x00000507, ZAP_TYPE(INT16U), 2, 0,                                   \
         ZAP_SIMPLE_DEFAULT(0x8000)}, /* rms voltage max */                    \
        {0x00000508, ZAP_TYPE(INT16U), 2, 0,                                   \
         ZAP_SIMPLE_DEFAULT(0xffff)}, /* rms current */                        \
        {0x00000509, ZAP_TYPE(INT16U), 2, 0,                                   \
         ZAP_SIMPLE_DEFAULT(0xffff)}, /* rms current min */                    \
        {0x0000050A, ZAP_TYPE(INT16U), 2, 0,                                   \
         ZAP_SIMPLE_DEFAULT(0xffff)}, /* rms current max */                    \
        {0x0000050B, ZAP_TYPE(INT16S), 2, 0,                                   \
         ZAP_SIMPLE_DEFAULT(0xffff)}, /* active power */                       \
        {0x0000050C, ZAP_TYPE(INT16S), 2, 0,                                   \
         ZAP_SIMPLE_DEFAULT(0xffff)}, /* active power min */                   \
        {0x0000050D, ZAP_TYPE(INT16S), 2, 0,                                   \
         ZAP_SIMPLE_DEFAULT(0xffff)}, /* active power max */                   \
        {0x0000FFFC, ZAP_TYPE(BITMAP32), 4, 0,                                 \
         ZAP_SIMPLE_DEFAULT(0)}, /* FeatureMap */                              \
        {0x0000FFFD, ZAP_TYPE(INT16U), 2, 0,                                   \
         ZAP_SIMPLE_DEFAULT(3)}, /* ClusterRevision */                         \
                                                                               \
        /* Endpoint: 1, Cluster: Unit Testing (server) */                      \
        {0x00000000, ZAP_TYPE(BOOLEAN), 1, ZAP_ATTRIBUTE_MASK(WRITABLE),       \
         ZAP_SIMPLE_DEFAULT(false)}, /* boolean */                             \
        {0x00000001, ZAP_TYPE(BITMAP8), 1, ZAP_ATTRIBUTE_MASK(WRITABLE),       \
         ZAP_SIMPLE_DEFAULT(0)}, /* bitmap8 */                                 \
        {0x00000002, ZAP_TYPE(BITMAP16), 2, ZAP_ATTRIBUTE_MASK(WRITABLE),      \
         ZAP_SIMPLE_DEFAULT(0)}, /* bitmap16 */                                \
        {0x00000003, ZAP_TYPE(BITMAP32), 4, ZAP_ATTRIBUTE_MASK(WRITABLE),      \
         ZAP_SIMPLE_DEFAULT(0)}, /* bitmap32 */                                \
        {0x00000004, ZAP_TYPE(BITMAP64), 8, ZAP_ATTRIBUTE_MASK(WRITABLE),      \
         ZAP_LONG_DEFAULTS_INDEX(62)}, /* bitmap64 */                          \
        {0x00000005, ZAP_TYPE(INT8U), 1, ZAP_ATTRIBUTE_MASK(WRITABLE),         \
         ZAP_SIMPLE_DEFAULT(0)}, /* int8u */                                   \
        {0x00000006, ZAP_TYPE(INT16U), 2, ZAP_ATTRIBUTE_MASK(WRITABLE),        \
         ZAP_SIMPLE_DEFAULT(0)}, /* int16u */                                  \
        {0x00000007, ZAP_TYPE(INT24U), 3, ZAP_ATTRIBUTE_MASK(WRITABLE),        \
         ZAP_SIMPLE_DEFAULT(0)}, /* int24u */                                  \
        {0x00000008, ZAP_TYPE(INT32U), 4, ZAP_ATTRIBUTE_MASK(WRITABLE),        \
         ZAP_SIMPLE_DEFAULT(0)}, /* int32u */                                  \
        {0x00000009, ZAP_TYPE(INT40U), 5, ZAP_ATTRIBUTE_MASK(WRITABLE),        \
         ZAP_LONG_DEFAULTS_INDEX(70)}, /* int40u */                            \
        {0x0000000A, ZAP_TYPE(INT48U), 6, ZAP_ATTRIBUTE_MASK(WRITABLE),        \
         ZAP_LONG_DEFAULTS_INDEX(75)}, /* int48u */                            \
        {0x0000000B, ZAP_TYPE(INT56U), 7, ZAP_ATTRIBUTE_MASK(WRITABLE),        \
         ZAP_LONG_DEFAULTS_INDEX(81)}, /* int56u */                            \
        {0x0000000C, ZAP_TYPE(INT64U), 8, ZAP_ATTRIBUTE_MASK(WRITABLE),        \
         ZAP_LONG_DEFAULTS_INDEX(88)}, /* int64u */                            \
        {0x0000000D, ZAP_TYPE(INT8S), 1, ZAP_ATTRIBUTE_MASK(WRITABLE),         \
         ZAP_SIMPLE_DEFAULT(0)}, /* int8s */                                   \
        {0x0000000E, ZAP_TYPE(INT16S), 2, ZAP_ATTRIBUTE_MASK(WRITABLE),        \
         ZAP_SIMPLE_DEFAULT(0)}, /* int16s */                                  \
        {0x0000000F, ZAP_TYPE(INT24S), 3, ZAP_ATTRIBUTE_MASK(WRITABLE),        \
         ZAP_SIMPLE_DEFAULT(0)}, /* int24s */                                  \
        {0x00000010, ZAP_TYPE(INT32S), 4, ZAP_ATTRIBUTE_MASK(WRITABLE),        \
         ZAP_SIMPLE_DEFAULT(0)}, /* int32s */                                  \
        {0x00000011, ZAP_TYPE(INT40S), 5, ZAP_ATTRIBUTE_MASK(WRITABLE),        \
         ZAP_LONG_DEFAULTS_INDEX(96)}, /* int40s */                            \
        {0x00000012, ZAP_TYPE(INT48S), 6, ZAP_ATTRIBUTE_MASK(WRITABLE),        \
         ZAP_LONG_DEFAULTS_INDEX(101)}, /* int48s */                           \
        {0x00000013, ZAP_TYPE(INT56S), 7, ZAP_ATTRIBUTE_MASK(WRITABLE),        \
         ZAP_LONG_DEFAULTS_INDEX(107)}, /* int56s */                           \
        {0x00000014, ZAP_TYPE(INT64S), 8, ZAP_ATTRIBUTE_MASK(WRITABLE),        \
         ZAP_LONG_DEFAULTS_INDEX(114)}, /* int64s */                           \
        {0x00000015, ZAP_TYPE(ENUM8), 1, ZAP_ATTRIBUTE_MASK(WRITABLE),         \
         ZAP_SIMPLE_DEFAULT(0)}, /* enum8 */                                   \
        {0x00000016, ZAP_TYPE(ENUM16), 2, ZAP_ATTRIBUTE_MASK(WRITABLE),        \
         ZAP_SIMPLE_DEFAULT(0)}, /* enum16 */                                  \
        {0x00000017, ZAP_TYPE(SINGLE), 4, ZAP_ATTRIBUTE_MASK(WRITABLE),        \
         ZAP_SIMPLE_DEFAULT(0)}, /* float_single */                            \
        {0x00000018, ZAP_TYPE(DOUBLE), 8, ZAP_ATTRIBUTE_MASK(WRITABLE),        \
         ZAP_LONG_DEFAULTS_INDEX(122)}, /* float_double */                     \
        {0x00000019, ZAP_TYPE(OCTET_STRING), 11, ZAP_ATTRIBUTE_MASK(WRITABLE), \
         ZAP_EMPTY_DEFAULT()}, /* octet_string */                              \
        {0x0000001A, ZAP_TYPE(ARRAY), 0,                                       \
         ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) | ZAP_ATTRIBUTE_MASK(WRITABLE),  \
         ZAP_EMPTY_DEFAULT()}, /* list_int8u */                                \
        {0x0000001B, ZAP_TYPE(ARRAY), 0,                                       \
         ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) | ZAP_ATTRIBUTE_MASK(WRITABLE),  \
         ZAP_EMPTY_DEFAULT()}, /* list_octet_string */                         \
        {0x0000001C, ZAP_TYPE(ARRAY), 0,                                       \
         ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) | ZAP_ATTRIBUTE_MASK(WRITABLE),  \
         ZAP_EMPTY_DEFAULT()}, /* list_struct_octet_string */                  \
        {0x0000001D, ZAP_TYPE(LONG_OCTET_STRING), 1002,                        \
         ZAP_ATTRIBUTE_MASK(WRITABLE),                                         \
         ZAP_EMPTY_DEFAULT()}, /* long_octet_string */                         \
        {0x0000001E, ZAP_TYPE(CHAR_STRING), 11, ZAP_ATTRIBUTE_MASK(WRITABLE),  \
         ZAP_EMPTY_DEFAULT()}, /* char_string */                               \
        {0x0000001F, ZAP_TYPE(LONG_CHAR_STRING), 1002,                         \
         ZAP_ATTRIBUTE_MASK(WRITABLE),                                         \
         ZAP_EMPTY_DEFAULT()}, /* long_char_string */                          \
        {0x00000020, ZAP_TYPE(EPOCH_US), 8, ZAP_ATTRIBUTE_MASK(WRITABLE),      \
         ZAP_LONG_DEFAULTS_INDEX(130)}, /* epoch_us */                         \
        {0x00000021, ZAP_TYPE(EPOCH_S), 4, ZAP_ATTRIBUTE_MASK(WRITABLE),       \
         ZAP_EMPTY_DEFAULT()}, /* epoch_s */                                   \
        {0x00000022, ZAP_TYPE(VENDOR_ID), 2, ZAP_ATTRIBUTE_MASK(WRITABLE),     \
         ZAP_EMPTY_DEFAULT()}, /* vendor_id */                                 \
        {0x00000023, ZAP_TYPE(ARRAY), 0,                                       \
         ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) | ZAP_ATTRIBUTE_MASK(WRITABLE),  \
         ZAP_EMPTY_DEFAULT()}, /* list_nullables_and_optionals_struct */       \
        {0x00000024, ZAP_TYPE(ENUM8), 1, ZAP_ATTRIBUTE_MASK(WRITABLE),         \
         ZAP_EMPTY_DEFAULT()}, /* enum_attr */                                 \
        {0x00000025, ZAP_TYPE(STRUCT), 0,                                      \
         ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) | ZAP_ATTRIBUTE_MASK(WRITABLE),  \
         ZAP_EMPTY_DEFAULT()}, /* struct_attr */                               \
        {0x00000026, ZAP_TYPE(INT8U), 1,                                       \
         ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE),           \
         ZAP_MIN_MAX_DEFAULTS_INDEX(38)}, /* range_restricted_int8u */         \
        {0x00000027, ZAP_TYPE(INT8S), 1,                                       \
         ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE),           \
         ZAP_MIN_MAX_DEFAULTS_INDEX(39)}, /* range_restricted_int8s */         \
        {0x00000028, ZAP_TYPE(INT16U), 2,                                      \
         ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE),           \
         ZAP_MIN_MAX_DEFAULTS_INDEX(40)}, /* range_restricted_int16u */        \
        {0x00000029, ZAP_TYPE(INT16S), 2,                                      \
         ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE),           \
         ZAP_MIN_MAX_DEFAULTS_INDEX(41)}, /* range_restricted_int16s */        \
        {0x0000002A, ZAP_TYPE(ARRAY), 0,                                       \
         ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) | ZAP_ATTRIBUTE_MASK(WRITABLE),  \
         ZAP_EMPTY_DEFAULT()}, /* list_long_octet_string */                    \
        {0x0000002B, ZAP_TYPE(ARRAY), 0,                                       \
         ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) | ZAP_ATTRIBUTE_MASK(WRITABLE),  \
         ZAP_EMPTY_DEFAULT()}, /* list_fabric_scoped */                        \
        {0x00000030, ZAP_TYPE(BOOLEAN), 1,                                     \
         ZAP_ATTRIBUTE_MASK(WRITABLE) |                                        \
             ZAP_ATTRIBUTE_MASK(MUST_USE_TIMED_WRITE),                         \
         ZAP_EMPTY_DEFAULT()}, /* timed_write_boolean */                       \
        {0x00000031, ZAP_TYPE(BOOLEAN), 1,                                     \
         ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) | ZAP_ATTRIBUTE_MASK(WRITABLE),  \
         ZAP_EMPTY_DEFAULT()}, /* general_error_boolean */                     \
        {0x00000032, ZAP_TYPE(BOOLEAN), 1,                                     \
         ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) | ZAP_ATTRIBUTE_MASK(WRITABLE),  \
         ZAP_EMPTY_DEFAULT()}, /* cluster_error_boolean */                     \
        {0x00004000, ZAP_TYPE(BOOLEAN), 1,                                     \
         ZAP_ATTRIBUTE_MASK(WRITABLE) | ZAP_ATTRIBUTE_MASK(NULLABLE),          \
         ZAP_SIMPLE_DEFAULT(false)}, /* nullable_boolean */                    \
        {0x00004001, ZAP_TYPE(BITMAP8), 1,                                     \
         ZAP_ATTRIBUTE_MASK(WRITABLE) | ZAP_ATTRIBUTE_MASK(NULLABLE),          \
         ZAP_SIMPLE_DEFAULT(0)}, /* nullable_bitmap8 */                        \
        {0x00004002, ZAP_TYPE(BITMAP16), 2,                                    \
         ZAP_ATTRIBUTE_MASK(WRITABLE) | ZAP_ATTRIBUTE_MASK(NULLABLE),          \
         ZAP_SIMPLE_DEFAULT(0)}, /* nullable_bitmap16 */                       \
        {0x00004003, ZAP_TYPE(BITMAP32), 4,                                    \
         ZAP_ATTRIBUTE_MASK(WRITABLE) | ZAP_ATTRIBUTE_MASK(NULLABLE),          \
         ZAP_SIMPLE_DEFAULT(0)}, /* nullable_bitmap32 */                       \
        {0x00004004, ZAP_TYPE(BITMAP64), 8,                                    \
         ZAP_ATTRIBUTE_MASK(WRITABLE) | ZAP_ATTRIBUTE_MASK(NULLABLE),          \
         ZAP_LONG_DEFAULTS_INDEX(138)}, /* nullable_bitmap64 */                \
        {0x00004005, ZAP_TYPE(INT8U), 1,                                       \
         ZAP_ATTRIBUTE_MASK(WRITABLE) | ZAP_ATTRIBUTE_MASK(NULLABLE),          \
         ZAP_SIMPLE_DEFAULT(0)}, /* nullable_int8u */                          \
        {0x00004006, ZAP_TYPE(INT16U), 2,                                      \
         ZAP_ATTRIBUTE_MASK(WRITABLE) | ZAP_ATTRIBUTE_MASK(NULLABLE),          \
         ZAP_SIMPLE_DEFAULT(0)}, /* nullable_int16u */                         \
        {0x00004007, ZAP_TYPE(INT24U), 3,                                      \
         ZAP_ATTRIBUTE_MASK(WRITABLE) | ZAP_ATTRIBUTE_MASK(NULLABLE),          \
         ZAP_SIMPLE_DEFAULT(0)}, /* nullable_int24u */                         \
        {0x00004008, ZAP_TYPE(INT32U), 4,                                      \
         ZAP_ATTRIBUTE_MASK(WRITABLE) | ZAP_ATTRIBUTE_MASK(NULLABLE),          \
         ZAP_SIMPLE_DEFAULT(0)}, /* nullable_int32u */                         \
        {0x00004009, ZAP_TYPE(INT40U), 5,                                      \
         ZAP_ATTRIBUTE_MASK(WRITABLE) | ZAP_ATTRIBUTE_MASK(NULLABLE),          \
         ZAP_LONG_DEFAULTS_INDEX(146)}, /* nullable_int40u */                  \
        {0x0000400A, ZAP_TYPE(INT48U), 6,                                      \
         ZAP_ATTRIBUTE_MASK(WRITABLE) | ZAP_ATTRIBUTE_MASK(NULLABLE),          \
         ZAP_LONG_DEFAULTS_INDEX(151)}, /* nullable_int48u */                  \
        {0x0000400B, ZAP_TYPE(INT56U), 7,                                      \
         ZAP_ATTRIBUTE_MASK(WRITABLE) | ZAP_ATTRIBUTE_MASK(NULLABLE),          \
         ZAP_LONG_DEFAULTS_INDEX(157)}, /* nullable_int56u */                  \
        {0x0000400C, ZAP_TYPE(INT64U), 8,                                      \
         ZAP_ATTRIBUTE_MASK(WRITABLE) | ZAP_ATTRIBUTE_MASK(NULLABLE),          \
         ZAP_LONG_DEFAULTS_INDEX(164)}, /* nullable_int64u */                  \
        {0x0000400D, ZAP_TYPE(INT8S), 1,                                       \
         ZAP_ATTRIBUTE_MASK(WRITABLE) | ZAP_ATTRIBUTE_MASK(NULLABLE),          \
         ZAP_SIMPLE_DEFAULT(0)}, /* nullable_int8s */                          \
        {0x0000400E, ZAP_TYPE(INT16S), 2,                                      \
         ZAP_ATTRIBUTE_MASK(WRITABLE) | ZAP_ATTRIBUTE_MASK(NULLABLE),          \
         ZAP_SIMPLE_DEFAULT(0)}, /* nullable_int16s */                         \
        {0x0000400F, ZAP_TYPE(INT24S), 3,                                      \
         ZAP_ATTRIBUTE_MASK(WRITABLE) | ZAP_ATTRIBUTE_MASK(NULLABLE),          \
         ZAP_SIMPLE_DEFAULT(0)}, /* nullable_int24s */                         \
        {0x00004010, ZAP_TYPE(INT32S), 4,                                      \
         ZAP_ATTRIBUTE_MASK(WRITABLE) | ZAP_ATTRIBUTE_MASK(NULLABLE),          \
         ZAP_SIMPLE_DEFAULT(0)}, /* nullable_int32s */                         \
        {0x00004011, ZAP_TYPE(INT40S), 5,                                      \
         ZAP_ATTRIBUTE_MASK(WRITABLE) | ZAP_ATTRIBUTE_MASK(NULLABLE),          \
         ZAP_LONG_DEFAULTS_INDEX(172)}, /* nullable_int40s */                  \
        {0x00004012, ZAP_TYPE(INT48S), 6,                                      \
         ZAP_ATTRIBUTE_MASK(WRITABLE) | ZAP_ATTRIBUTE_MASK(NULLABLE),          \
         ZAP_LONG_DEFAULTS_INDEX(177)}, /* nullable_int48s */                  \
        {0x00004013, ZAP_TYPE(INT56S), 7,                                      \
         ZAP_ATTRIBUTE_MASK(WRITABLE) | ZAP_ATTRIBUTE_MASK(NULLABLE),          \
         ZAP_LONG_DEFAULTS_INDEX(183)}, /* nullable_int56s */                  \
        {0x00004014, ZAP_TYPE(INT64S), 8,                                      \
         ZAP_ATTRIBUTE_MASK(WRITABLE) | ZAP_ATTRIBUTE_MASK(NULLABLE),          \
         ZAP_LONG_DEFAULTS_INDEX(190)}, /* nullable_int64s */                  \
        {0x00004015, ZAP_TYPE(ENUM8), 1,                                       \
         ZAP_ATTRIBUTE_MASK(WRITABLE) | ZAP_ATTRIBUTE_MASK(NULLABLE),          \
         ZAP_SIMPLE_DEFAULT(0)}, /* nullable_enum8 */                          \
        {0x00004016, ZAP_TYPE(ENUM16), 2,                                      \
         ZAP_ATTRIBUTE_MASK(WRITABLE) | ZAP_ATTRIBUTE_MASK(NULLABLE),          \
         ZAP_SIMPLE_DEFAULT(0)}, /* nullable_enum16 */                         \
        {0x00004017, ZAP_TYPE(SINGLE), 4,                                      \
         ZAP_ATTRIBUTE_MASK(WRITABLE) | ZAP_ATTRIBUTE_MASK(NULLABLE),          \
         ZAP_SIMPLE_DEFAULT(0)}, /* nullable_float_single */                   \
        {0x00004018, ZAP_TYPE(DOUBLE), 8,                                      \
         ZAP_ATTRIBUTE_MASK(WRITABLE) | ZAP_ATTRIBUTE_MASK(NULLABLE),          \
         ZAP_LONG_DEFAULTS_INDEX(198)}, /* nullable_float_double */            \
        {0x00004019, ZAP_TYPE(OCTET_STRING), 11,                               \
         ZAP_ATTRIBUTE_MASK(WRITABLE) | ZAP_ATTRIBUTE_MASK(NULLABLE),          \
         ZAP_EMPTY_DEFAULT()}, /* nullable_octet_string */                     \
        {0x0000401E, ZAP_TYPE(CHAR_STRING), 11,                                \
         ZAP_ATTRIBUTE_MASK(WRITABLE) | ZAP_ATTRIBUTE_MASK(NULLABLE),          \
         ZAP_EMPTY_DEFAULT()}, /* nullable_char_string */                      \
        {0x00004024, ZAP_TYPE(ENUM8), 1,                                       \
         ZAP_ATTRIBUTE_MASK(WRITABLE) | ZAP_ATTRIBUTE_MASK(NULLABLE),          \
        ...
        {0x00004026, ZAP_TYPE(INT8U), 1,                                       \
         ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE) |          \
             ZAP_ATTRIBUTE_MASK(NULLABLE),                                     \
         ZAP_MIN_MAX_DEFAULTS_INDEX(                                           \
             42)}, /* nullable_range_restricted_int8u */                       \
        {0x00004027, ZAP_TYPE(INT8S), 1,                                       \
         ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE) |          \
             ZAP_ATTRIBUTE_MASK(NULLABLE),                                     \
         ZAP_MIN_MAX_DEFAULTS_INDEX(                                           \
             43)}, /* nullable_range_restricted_int8s */                       \
        {0x00004028, ZAP_TYPE(INT16U), 2,                                      \
         ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE) |          \
             ZAP_ATTRIBUTE_MASK(NULLABLE),                                     \
         ZAP_MIN_MAX_DEFAULTS_INDEX(                                           \
             44)}, /* nullable_range_restricted_int16u */                      \
        {0x00004029, ZAP_TYPE(INT16S), 2,                                      \
         ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE) |          \
             ZAP_ATTRIBUTE_MASK(NULLABLE),                                     \
         ZAP_MIN_MAX_DEFAULTS_INDEX(                                           \
             45)}, /* nullable_range_restricted_int16s */                      \
        {0x0000402A, ZAP_TYPE(INT8U), 1,                                       \
         ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) | ZAP_ATTRIBUTE_MASK(WRITABLE),  \
        ...
        {0x0000FFFC, ZAP_TYPE(BITMAP32), 4, 0,                                 \
         ZAP_SIMPLE_DEFAULT(0x0000)}, /* FeatureMap */                         \
        {0x0000FFFD, ZAP_TYPE(INT16U), 2, 0,                                   \
         ZAP_SIMPLE_DEFAULT(4)}, /* ClusterRevision */                         \
                                                                               \
        ...
        {0x00000000, ZAP_TYPE(ENUM8), 1, 0,                                    \
         ZAP_SIMPLE_DEFAULT(0)}, /* Status */                                  \
        {0x00000001, ZAP_TYPE(INT8U), 1, 0,                                    \
         ZAP_SIMPLE_DEFAULT(1)}, /* Order */                                   \
        {0x00000002, ZAP_TYPE(CHAR_STRING), 61, 0,                             \
         ZAP_LONG_DEFAULTS_INDEX(206)}, /* Description */                      \
        {0x0000000E, ZAP_TYPE(ENUM8), 1, 0,                                    \
         ZAP_SIMPLE_DEFAULT(0)}, /* BatChargeLevel */                          \
        {0x0000000F, ZAP_TYPE(BOOLEAN), 1, 0,                                  \
         ZAP_EMPTY_DEFAULT()}, /* BatReplacementNeeded */                      \
        ...
        {0x00000007, ZAP_TYPE(INT32S), 4,                                      \
         ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) | ZAP_ATTRIBUTE_MASK(NULLABLE),  \
         ZAP_EMPTY_DEFAULT()}, /* LastConnectErrorValue */                     \
        {0x0000FFFC, ZAP_TYPE(BITMAP32), 4,                                    \
         ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE),                                 \
...
#define GENERATED_ENDPOINT_TYPES                                               \
  {                                                                            \
    {ZAP_CLUSTER_INDEX(0), 28, 361}, {ZAP_CLUSTER_INDEX(28), 44, 3459},        \
        {ZAP_CLUSTER_INDEX(72), 5, 105}, {ZAP_CLUSTER_INDEX(77), 1, 0},        \
  }
