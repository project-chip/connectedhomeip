...
#define GENERATED_MIN_MAX_DEFAULT_COUNT 55
...
#define GENERATED_ATTRIBUTES                                                                                                       \
    {                                                                                                                              \
        ...
        { ZAP_MIN_MAX_DEFAULTS_INDEX(6), 0x00000002, 1, ZAP_TYPE(ENUM8),                                                           \
        ...
        { ZAP_MIN_MAX_DEFAULTS_INDEX(50), 0x00004026, 1, ZAP_TYPE(INT8U),                                                          \
          ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE) |                                                             \
              ZAP_ATTRIBUTE_MASK(NULLABLE) }, /* nullable_range_restricted_int8u */                                                \
        { ZAP_MIN_MAX_DEFAULTS_INDEX(51), 0x00004027, 1, ZAP_TYPE(INT8S),                                                          \
          ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE) |                                                             \
              ZAP_ATTRIBUTE_MASK(NULLABLE) }, /* nullable_range_restricted_int8s */                                                \
        { ZAP_MIN_MAX_DEFAULTS_INDEX(52), 0x00004028, 2, ZAP_TYPE(INT16U),                                                         \
          ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE) |                                                             \
              ZAP_ATTRIBUTE_MASK(NULLABLE) }, /* nullable_range_restricted_int16u */                                               \
        { ZAP_MIN_MAX_DEFAULTS_INDEX(53), 0x00004029, 2, ZAP_TYPE(INT16S),                                                         \
          ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE) |                                                             \
        ...
        { ZAP_MIN_MAX_DEFAULTS_INDEX(54), 0x00004003, 1, ZAP_TYPE(ENUM8),                                                          \
