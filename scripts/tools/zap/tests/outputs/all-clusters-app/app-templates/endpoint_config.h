...
#define GENERATED_ATTRIBUTES                                                                                                       \
    {                                                                                                                              \
        ...
        { ZAP_LONG_DEFAULTS_INDEX(12), 0x00000004, 8, ZAP_TYPE(BITMAP64),                                                          \
        ...
        { ZAP_LONG_DEFAULTS_INDEX(20), 0x00000009, 5, ZAP_TYPE(INT40U),                                                            \
          ZAP_ATTRIBUTE_MASK(WRITABLE) | ZAP_ATTRIBUTE_MASK(READABLE) }, /* int40u */                                              \
        { ZAP_LONG_DEFAULTS_INDEX(25), 0x0000000A, 6, ZAP_TYPE(INT48U),                                                            \
          ZAP_ATTRIBUTE_MASK(WRITABLE) | ZAP_ATTRIBUTE_MASK(READABLE) }, /* int48u */                                              \
        { ZAP_LONG_DEFAULTS_INDEX(31), 0x0000000B, 7, ZAP_TYPE(INT56U),                                                            \
          ZAP_ATTRIBUTE_MASK(WRITABLE) | ZAP_ATTRIBUTE_MASK(READABLE) }, /* int56u */                                              \
        { ZAP_LONG_DEFAULTS_INDEX(38), 0x0000000C, 8, ZAP_TYPE(INT64U),                                                            \
        ...
        { ZAP_LONG_DEFAULTS_INDEX(46), 0x00000011, 5, ZAP_TYPE(INT40S),                                                            \
          ZAP_ATTRIBUTE_MASK(WRITABLE) | ZAP_ATTRIBUTE_MASK(READABLE) }, /* int40s */                                              \
        { ZAP_LONG_DEFAULTS_INDEX(51), 0x00000012, 6, ZAP_TYPE(INT48S),                                                            \
          ZAP_ATTRIBUTE_MASK(WRITABLE) | ZAP_ATTRIBUTE_MASK(READABLE) }, /* int48s */                                              \
        { ZAP_LONG_DEFAULTS_INDEX(57), 0x00000013, 7, ZAP_TYPE(INT56S),                                                            \
          ZAP_ATTRIBUTE_MASK(WRITABLE) | ZAP_ATTRIBUTE_MASK(READABLE) }, /* int56s */                                              \
        { ZAP_LONG_DEFAULTS_INDEX(64), 0x00000014, 8, ZAP_TYPE(INT64S),                                                            \
        ...
        { ZAP_LONG_DEFAULTS_INDEX(72), 0x00000018, 8, ZAP_TYPE(DOUBLE),                                                            \
        ...
        { ZAP_LONG_DEFAULTS_INDEX(80), 0x00000020, 8, ZAP_TYPE(EPOCH_US),                                                          \
        ...
        { ZAP_LONG_DEFAULTS_INDEX(88), 0x00004004, 8, ZAP_TYPE(BITMAP64),                                                          \
        ...
        { ZAP_LONG_DEFAULTS_INDEX(148), 0x00004018, 8, ZAP_TYPE(DOUBLE),                                                           \
          ZAP_ATTRIBUTE_MASK(WRITABLE) | ZAP_ATTRIBUTE_MASK(READABLE) |                                                            \
        ...
        { ZAP_LONG_DEFAULTS_INDEX(156), 0x00000002, 61, ZAP_TYPE(CHAR_STRING), ZAP_ATTRIBUTE_MASK(READABLE) }, /* Description */   \
        { ZAP_SIMPLE_DEFAULT(0), 0x0000000E, 1, ZAP_TYPE(ENUM8), ZAP_ATTRIBUTE_MASK(READABLE) }, /* BatChargeLevel */              \
        { ZAP_EMPTY_DEFAULT(), 0x0000000F, 1, ZAP_TYPE(BOOLEAN), ZAP_ATTRIBUTE_MASK(READABLE) }, /* BatReplacementNeeded */        \
        { ZAP_EMPTY_DEFAULT(), 0x00000010, 1, ZAP_TYPE(ENUM8), ZAP_ATTRIBUTE_MASK(READABLE) },   /* BatReplaceability */           \
        { ZAP_EMPTY_DEFAULT(), 0x0000001F, 0, ZAP_TYPE(ARRAY),                                                                     \
...
#define ATTRIBUTE_MAX_SIZE (3516)
    >>>>>>> 7094eb9d5e0(Mode Select : ZAP regen, CodegenIntegration wiring, and cmake build fixes)
