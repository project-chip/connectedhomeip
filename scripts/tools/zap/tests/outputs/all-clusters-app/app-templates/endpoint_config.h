...
#define GENERATED_ATTRIBUTE_COUNT 1026
...
#define GENERATED_CLUSTERS { \
  ...
  { \
      ...
      .attributes = ZAP_ATTRIBUTE_INDEX(646), \
      .attributeCount = 54, \
      .clusterSize = 345, \
      .mask = ZAP_CLUSTER_MASK(SERVER) | ZAP_CLUSTER_MASK(INIT_FUNCTION) | ZAP_CLUSTER_MASK(SHUTDOWN_FUNCTION), \
...
#define GENERATED_ENDPOINT_TYPES                                                                                                   \
    {                                                                                                                              \
        { ZAP_CLUSTER_INDEX(0), 29, 349 }, { ZAP_CLUSTER_INDEX(29), 70, 3457 }, { ZAP_CLUSTER_INDEX(99), 7, 122 },                 \
...
#define ATTRIBUTE_MAX_SIZE (3928)
