...
#define GENERATED_ATTRIBUTES                                                                                                       \
    {                                                                                                                              \
        ...
        { ZAP_SIMPLE_DEFAULT(0x0000), 0x00000000, 2, ZAP_TYPE(INT16U), ZAP_ATTRIBUTE_MASK(WRITABLE) }, /* IdentifyTime */          \
            ...
            { ZAP_MIN_MAX_DEFAULTS_INDEX(15), 0x00000019, 1, ZAP_TYPE(INT8S),                                                      \
              ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE) }, /* MinSetpointDeadBand */                              \
            { ZAP_MIN_MAX_DEFAULTS_INDEX(16), 0x0000001B, 1, ZAP_TYPE(ENUM8),                                                      \
              ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE) }, /* ControlSequenceOfOperation */                       \
            { ZAP_MIN_MAX_DEFAULTS_INDEX(17), 0x0000001C, 1, ZAP_TYPE(ENUM8),                                                      \
            ...
            { ZAP_MIN_MAX_DEFAULTS_INDEX(19), 0x00000002, 1, ZAP_TYPE(PERCENT),                                                    \
            ...
            { ZAP_MIN_MAX_DEFAULTS_INDEX(20), 0x00000005, 1, ZAP_TYPE(INT8U),                                                      \
            ...
            { ZAP_MIN_MAX_DEFAULTS_INDEX(22), 0x00000001, 1, ZAP_TYPE(ENUM8),                                                      \
              ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE) }, /* KeypadLockout */                                    \
            { ZAP_MIN_MAX_DEFAULTS_INDEX(23), 0x00000002, 1, ZAP_TYPE(ENUM8),                                                      \
            ...
            { ZAP_MIN_MAX_DEFAULTS_INDEX(26), 0x00000032, 2, ZAP_TYPE(INT16U),                                                     \
              ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE) }, /* ColorPointRX */                                     \
            { ZAP_MIN_MAX_DEFAULTS_INDEX(27), 0x00000033, 2, ZAP_TYPE(INT16U),                                                     \
            ...
            { ZAP_MIN_MAX_DEFAULTS_INDEX(28), 0x00000036, 2, ZAP_TYPE(INT16U),                                                     \
              ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE) }, /* ColorPointGX */                                     \
            { ZAP_MIN_MAX_DEFAULTS_INDEX(29), 0x00000037, 2, ZAP_TYPE(INT16U),                                                     \
            ...
            { ZAP_MIN_MAX_DEFAULTS_INDEX(30), 0x0000003A, 2, ZAP_TYPE(INT16U),                                                     \
              ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE) }, /* ColorPointBX */                                     \
            { ZAP_MIN_MAX_DEFAULTS_INDEX(31), 0x0000003B, 2, ZAP_TYPE(INT16U),                                                     \
            ...
            { ZAP_MIN_MAX_DEFAULTS_INDEX(37), 0x00004026, 1, ZAP_TYPE(INT8U),                                                      \
              ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE) |                                                         \
                  ZAP_ATTRIBUTE_MASK(NULLABLE) }, /* nullable_range_restricted_int8u */                                            \
            { ZAP_MIN_MAX_DEFAULTS_INDEX(38), 0x00004027, 1, ZAP_TYPE(INT8S),                                                      \
              ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE) |                                                         \
                  ZAP_ATTRIBUTE_MASK(NULLABLE) }, /* nullable_range_restricted_int8s */                                            \
            { ZAP_MIN_MAX_DEFAULTS_INDEX(39), 0x00004028, 2, ZAP_TYPE(INT16U),                                                     \
              ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE) |                                                         \
                  ZAP_ATTRIBUTE_MASK(NULLABLE) }, /* nullable_range_restricted_int16u */                                           \
            { ZAP_MIN_MAX_DEFAULTS_INDEX(40), 0x00004029, 2, ZAP_TYPE(INT16S),                                                     \
              ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE) |                                                         \
            ...
            { ZAP_MIN_MAX_DEFAULTS_INDEX(41), 0x00004003, 1, ZAP_TYPE(ENUM8),                                                      \
