...
#define EMBER_AF_PUMP_CONFIGURATION_AND_CONTROL_CLUSTER_SERVER_ENDPOINT_COUNT  \
  (1)
#define EMBER_AF_THERMOSTAT_CLUSTER_SERVER_ENDPOINT_COUNT (1)
#define EMBER_AF_FAN_CONTROL_CLUSTER_SERVER_ENDPOINT_COUNT (1)
#define EMBER_AF_THERMOSTAT_USER_INTERFACE_CONFIGURATION_CLUSTER_SERVER_ENDPOINT_COUNT \
  (1)
...
// Use this macro to check if the server side of the Target Navigator cluster is
// included
...
// Use this macro to check if the server side of the Media Playback cluster is
// included
...
// Use this macro to check if the server side of the Media Input cluster is
// included
...
// Use this macro to check if the server side of the Keypad Input cluster is
// included
...
// Use this macro to check if the server side of the Content Launcher cluster is
// included
...
// Use this macro to check if the server side of the Audio Output cluster is
// included
...
// Use this macro to check if the server side of the Application Launcher
// cluster is included
...
// Use this macro to check if the server side of the Application Basic cluster
// is included
...
// Use this macro to check if the server side of the Account Login cluster is
// included
