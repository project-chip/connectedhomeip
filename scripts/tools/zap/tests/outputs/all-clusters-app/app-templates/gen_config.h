...
// Use this macro to check if the server side of the On/off Switch Configuration
// cluster is included
...
// Use this macro to check if the server side of the Binary Input (Basic)
// cluster is included
...
// Use this macro to check if the server side of the Power Source Configuration
// cluster is included
...
// Use this macro to check if the server side of the Oven Cavity Operational
...
// Use this macro to check if the server side of the Oven Mode cluster is
// included
#define ZCL_USING_OVEN_MODE_CLUSTER_SERVER
#define MATTER_DM_PLUGIN_OVEN_MODE_SERVER
#define MATTER_DM_PLUGIN_OVEN_MODE

// Use this macro to check if the server side of the Laundry Dryer Controls
// cluster is included
...
// Use this macro to check if the server side of the Mode Select cluster is
// included
#define ZCL_USING_MODE_SELECT_CLUSTER_SERVER
#define MATTER_DM_PLUGIN_MODE_SELECT_SERVER
#define MATTER_DM_PLUGIN_MODE_SELECT

// Use this macro to check if the server side of the Laundry Washer Mode cluster
// is included
...
// Use this macro to check if the server side of the Refrigerator And
...
// Use this macro to check if the server side of the Laundry Washer Controls
// cluster is included
...
// Use this macro to check if the server side of the RVC Run Mode cluster is
// included
...
// Use this macro to check if the server side of the RVC Clean Mode cluster is
// included
...
// Use this macro to check if the server side of the Temperature Control cluster
// is included
...
// Use this macro to check if the server side of the Refrigerator Alarm cluster
// is included
...
// Use this macro to check if the server side of the Dishwasher Mode cluster is
// included
...
// Use this macro to check if the server side of the Smoke CO Alarm cluster is
// included
...
// Use this macro to check if the server side of the Dishwasher Alarm cluster is
// included
...
// Use this macro to check if the server side of the Microwave Oven Mode cluster
// is included
...
// Use this macro to check if the server side of the Operational State cluster
// is included
...
// Use this macro to check if the server side of the RVC Operational State
// cluster is included
...
// Use this macro to check if the server side of the HEPA Filter Monitoring
// cluster is included
...
// Use this macro to check if the server side of the Activated Carbon Filter
...
// Use this macro to check if the server side of the Boolean State Configuration
// cluster is included
...
// Use this macro to check if the server side of the Valve Configuration and
...
// Use this macro to check if the server side of the Electrical Energy
// Measurement cluster is included
...
// Use this macro to check if the server side of the Device Energy Management
// cluster is included
...
// Use this macro to check if the server side of the Energy EVSE cluster is
// included
#define ZCL_USING_ENERGY_EVSE_CLUSTER_SERVER
#define MATTER_DM_PLUGIN_ENERGY_EVSE_SERVER
#define MATTER_DM_PLUGIN_ENERGY_EVSE

// Use this macro to check if the server side of the Energy Preference cluster
// is included
...
// Use this macro to check if the server side of the Power Topology cluster is
// included
...
// Use this macro to check if the server side of the Energy EVSE Mode cluster is
// included
...
// Use this macro to check if the server side of the Window Covering cluster is
// included
...
// Use this macro to check if the server side of the Barrier Control cluster is
// included
...
// Use this macro to check if the server side of the Pump Configuration and
// Control cluster is included
...
// Use this macro to check if the server side of the Thermostat User Interface
...
// Use this macro to check if the server side of the Ballast Configuration
// cluster is included
...
// Use this macro to check if the server side of the Flow Measurement cluster is
// included
...
// Use this macro to check if the server side of the Carbon Monoxide
...
// Use this macro to check if the server side of the Nitrogen Dioxide
// Concentration Measurement cluster is included
...
// Use this macro to check if the server side of the Formaldehyde Concentration
// Measurement cluster is included
...
// Use this macro to check if the server side of the PM1 Concentration
// Measurement cluster is included
...
// Use this macro to check if the server side of the PM10 Concentration
// Measurement cluster is included
...
// Use this macro to check if the server side of the Total Volatile Organic
...
// Use this macro to check if the server side of the Radon Concentration
// Measurement cluster is included
...
// Use this macro to check if the server side of the Unit Testing cluster is
// included
...
// Use this macro to check if the server side of the Fault Injection cluster is
// included
