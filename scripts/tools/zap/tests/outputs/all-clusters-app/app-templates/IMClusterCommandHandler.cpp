                                                          ...
                                                          TLV::TLVReader & aDataTlv)
{
    ...
    bool wasHandled     = false;
    {
        ...
        case Commands::ResetCondition::Id: {
            Commands::ResetCondition::DecodableType commandData;
            TLVError = DataModel::Decode(aDataTlv, commandData);
            if (TLVError == CHIP_NO_ERROR)
            {
                wasHandled =
                    emberAfActivatedCarbonFilterMonitoringClusterResetConditionCallback(apCommandObj, aCommandPath, commandData);
            }
            break;
        }
        default: {
...
void DispatchSingleClusterCommand(const ConcreteCommandPath & aCommandPath, TLV::TLVReader & aReader, CommandHandler * apCommandObj)
{
    ...
    case Clusters::ActivatedCarbonFilterMonitoring::Id:
        errorStatus = Clusters::ActivatedCarbonFilterMonitoring::DispatchServerCommand(apCommandObj, aCommandPath, aReader);
        break;
