...
void DispatchServerCommand(CommandHandler *apCommandObj,
  ...
  bool wasHandled = false;
  {
    ...
    case Commands::SendKey::Id: {
      ...
      TLVError = DataModel::Decode(aDataTlv, commandData);
      if (TLVError == CHIP_NO_ERROR) {
        wasHandled = emberAfKeypadInputClusterSendKeyCallback(
            apCommandObj, aCommandPath, commandData);
      }
      break;
    }
...
void DispatchServerCommand(CommandHandler *apCommandObj,
  ...
  bool wasHandled = false;
  {
    ...
    case Commands::SelectInput::Id: {
      ...
      TLVError = DataModel::Decode(aDataTlv, commandData);
      if (TLVError == CHIP_NO_ERROR) {
        wasHandled = emberAfMediaInputClusterSelectInputCallback(
            apCommandObj, aCommandPath, commandData);
      }
      break;
    }
...
void DispatchSingleClusterCommand(const ConcreteCommandPath &aCommandPath,
  ...
  case Clusters::KeypadInput::Id:
    Clusters::KeypadInput::DispatchServerCommand(apCommandObj, aCommandPath,
                                                 aReader);
    break;
  ...
  case Clusters::MediaInput::Id:
    Clusters::MediaInput::DispatchServerCommand(apCommandObj, aCommandPath,
                                                aReader);
    break;
  ...
  case Clusters::TargetNavigator::Id:
    Clusters::TargetNavigator::DispatchServerCommand(apCommandObj, aCommandPath,
                                                     aReader);
    break;
