...
class FactoryDataGenerator:
    ...
    def _validate_args(self):
        ...
        assert (self._args.chip_cert_path or
                (self._args.dac_cert and self._args.pai_cert and self._args.dac_key)), "Cannot find paths to DAC or PAI "
        "certificates .der files. To generate a new ones please provide a path to chip-cert executable (--chip_cert_path)"
