...
function applyFilters() {
    ...
    state.filteredTests = state.allTests.filter((t) => {
        ...
        const matchesStatus =
            statusFilter === "all" || t.lastStatus === statusFilter;
        ...
        if (bucketFilter === "nonpassing") {
            ...
            matchesBucket =
                (t.last7d && t.last7d.flaky) ||
                (t.last30d && t.last30d.flaky);
        }
    ...
    if (!state.selectedTest && state.filteredTests.length > 0) {
        ...
        state.selectedTest &&
        !state.filteredTests.some((t) => t.fullName === state.selectedTest.fullName)
    ) {
...
function renderDetail() {
    ...
    stats.innerHTML = `
        <div class="detail-stat"><div class="detail-stat-label">Runs</div><div class="detail-stat-value">${fmtNumber(t.totalRuns)}</div></div>
        <div class="detail-stat"><div class="detail-stat-label">Failed</div><div class="detail-stat-value">${fmtNumber(t.failedRuns)}</div></div>
        <div class="detail-stat"><div class="detail-stat-label">Broken</div><div class="detail-stat-value">${fmtNumber(t.brokenRuns)}</div></div>
        <div class="detail-stat"><div class="detail-stat-label">Non-passing</div><div class="detail-stat-value">${fmtNumber(t.nonPassingRuns)}</div></div>
        <div class="detail-stat"><div class="detail-stat-label">Pass rate</div><div class="detail-stat-value">${fmtPercent(t.passRate)}</div></div>
        <div class="detail-stat"><div class="detail-stat-label">Avg duration</div><div class="detail-stat-value">${fmtDuration(t.avgDurationMs)}</div></div>
