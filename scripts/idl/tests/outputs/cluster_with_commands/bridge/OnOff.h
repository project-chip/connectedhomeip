...
struct OnOffCluster : public GeneratedCluster
{
    ...
    OnOffCluster() :
        ...
        mClusterRevision(chip::CharSpan("clusterRevision"), 65533, 0 | ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE),
                         ZCL_INT16U_ATTRIBUTE_TYPE, 2, ZCL_ON_OFF_CLUSTER_REVISION)
    {}
    ...
    const chip::CommandId * GetIncomingCommandList() override { return mIncomingCommandList; }
};
#ifndef ON_OFF_CLUSTER_INCOMING_COMMANDS
#define ON_OFF_CLUSTER_INCOMING_COMMANDS
const chip::CommandId OnOffCluster::mIncomingCommandList[] = { 0, 1, 2, chip::kInvalidCommandId };
#endif
