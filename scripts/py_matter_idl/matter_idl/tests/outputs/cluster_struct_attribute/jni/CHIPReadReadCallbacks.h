...
class CHIPDemoClusterSingleFailSafeAttributeCallback : public chip::Callback::Callback<CHIPDemoClusterClusterSingleFailSafeAttributeCallbackType>
{
public:
    CHIPDemoClusterSingleFailSafeAttributeCallback(jobject javaCallback, bool keepAlive = false);

    ~CHIPDemoClusterSingleFailSafeAttributeCallback();

    static void maybeDestroy(CHIPDemoClusterSingleFailSafeAttributeCallback * callback) {
        if (!callback->keepAlive) {
            callback->Cancel();
            chip::Platform::Delete<CHIPDemoClusterSingleFailSafeAttributeCallback>(callback);
        }
    }

    static void CallbackFn(void * context, chip::app::Clusters::DemoCluster::Structs::ArmFailSafeRequest::DecodableType value);
    static void OnSubscriptionEstablished(void * context, chip::SubscriptionId subscriptionId) {
        CHIP_ERROR err = chip::JniReferences::GetInstance().CallSubscriptionEstablished(reinterpret_cast<CHIPDemoClusterSingleFailSafeAttributeCallback *>(context)->javaCallbackRef, subscriptionId);
        VerifyOrReturn(err == CHIP_NO_ERROR, ChipLogError(Zcl, "Error calling onSubscriptionEstablished: %s", ErrorStr(err)));
    };
...
class CHIPDemoClusterArmFailsafesAttributeCallback : public chip::Callback::Callback<CHIPDemoClusterClusterArmFailsafesAttributeCallbackType>
{
public:
    CHIPDemoClusterArmFailsafesAttributeCallback(jobject javaCallback, bool keepAlive = false);

    ~CHIPDemoClusterArmFailsafesAttributeCallback();

    static void maybeDestroy(CHIPDemoClusterArmFailsafesAttributeCallback * callback) {
        if (!callback->keepAlive) {
            callback->Cancel();
            chip::Platform::Delete<CHIPDemoClusterArmFailsafesAttributeCallback>(callback);
        }
    }

    static void CallbackFn(void * context, const chip::app::DataModel::DecodableList<chip::app::Clusters::DemoCluster::Structs::ArmFailSafeRequest::DecodableType> & list);
    static void OnSubscriptionEstablished(void * context, chip::SubscriptionId subscriptionId) {
        CHIP_ERROR err = chip::JniReferences::GetInstance().CallSubscriptionEstablished(reinterpret_cast<CHIPDemoClusterArmFailsafesAttributeCallback *>(context)->javaCallbackRef, subscriptionId);
        VerifyOrReturn(err == CHIP_NO_ERROR, ChipLogError(Zcl, "Error calling onSubscriptionEstablished: %s", ErrorStr(err)));
    };
