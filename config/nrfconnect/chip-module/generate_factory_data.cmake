...
elseif(CONFIG_CHIP_FACTORY_DATA_USE_HDD_CERTS)
    string(APPEND script_args "--dac_cert \"${CONFIG_CHIP_FACTORY_DATA_HDD_CERTS_DAC_CERT}\"\n")
    string(APPEND script_args "--dac_key \"${CONFIG_CHIP_FACTORY_DATA_HDD_CERTS_DAC_KEY}\"\n")
    string(APPEND script_args "--pai_cert \"${CONFIG_CHIP_FACTORY_DATA_HDD_CERTS_PAI_CERT}\"\n")
else()
