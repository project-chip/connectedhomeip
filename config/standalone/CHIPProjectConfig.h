...
// set in CHIPProjectAppConfig to override CHIP_DEVICE_CONFIG_DYNAMIC_ENDPOINT_COUNT
#ifdef OVERRIDE_CHIP_DEVICE_CONFIG_DYNAMIC_ENDPOINT_COUNT
#define CHIP_DEVICE_CONFIG_DYNAMIC_ENDPOINT_COUNT OVERRIDE_CHIP_DEVICE_CONFIG_DYNAMIC_ENDPOINT_COUNT
#else
