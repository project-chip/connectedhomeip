...
#
#   @file
#         Component makefile for incorporating CHIP into an QPG6100
#         application.
#

#
#   This makefile is intended to work in conjunction with the qpg6100-app.mk
#   makefile to build the CHIP example applications on Qorvo platforms.
#   QPG6100 applications should include this file in their top level Makefile
#   after including qpg6100-app.mk.  E.g.:
#
...
#       include $(BUILD_SUPPORT_DIR)/qpg6100-chip.mk
#
#       PROJECT_ROOT := $(realpath .)
#       
...
CHIP_CONFIGURE_OPTIONS = \
    ...
    --with-device-layer=qpg6100 \
    --with-network-layer=all \
    --with-target-network=lwip \
    --with-lwip=internal \
    --with-lwip-target=qpg6100 \
...
STD_INC_DIRS += \
    ...
    $(CHIP_ROOT)/src \
    $(CHIP_ROOT)/src/include/temp \
    $(CHIP_ROOT)/third_party/lwip/repo/lwip/src/include \
    $(CHIP_ROOT)/src/lwip \
    $(CHIP_ROOT)/src/lwip/qpg6100 \
