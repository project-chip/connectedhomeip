...
constexpr FullFieldDescriptor _Schema[] = {
    ...
    { kFieldIdD, BitFlags<Type>(Type::TYPE_ARRAY).Set(Type::TYPE_UINT8), 0, FieldD, {} },
    { kFieldIdE,
      BitFlags<Type>(Type::TYPE_ARRAY).Set(Type::TYPE_STRUCT),
      0,
      FieldE,
      { StructA::_Schema, ArraySize(StructA::_Schema) } },
};
} // namespace StructC
