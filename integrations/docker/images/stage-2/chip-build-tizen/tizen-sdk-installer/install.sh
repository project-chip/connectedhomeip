...
DEPENDENCIES_CMDS=('7z' 'cpio' 'java' 'unzip' 'wget')
...
TIZEN_STUDIO_COMMON_ZIPS=(
    ...
    'new-native-cli_2.5.93_ubuntu-64.zip'
    'sdb_4.2.36_ubuntu-64.zip'
