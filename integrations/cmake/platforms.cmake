...
function(CHIP_get_platforms arg_platforms)
    ...
    set(platforms_dir "${PROJECT_SOURCE_DIR}/integrations/cmake/platforms")
...
set(CHIP_PLATFORM_CMAKE 
    "${PROJECT_SOURCE_DIR}/integrations/cmake/platforms/${CHIP_PLATFORM}"
)
include("${CHIP_PLATFORM_CMAKE}/platform.cmake")

#if(NOT CHIP_PLATFORM MATCHES "standalone")
    #list(APPEND CHIP_PRIVATE_INCLUDES ${PROJECT_SOURCE_DIR}/config/cmake/${CHIP_PLATFORM})
    # add_subdirectory("${PROJECT_SOURCE_DIR}/src/platform/${CHIP_PLATFORM}")
#endif()
