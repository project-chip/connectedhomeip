...
> [!CAUTION]
> Running `podman system reset` will delete all existing Podman containers, images, and volumes.
...
The correct tag for `ghcr.io/project-chip/chip-build-vscode` changes as dependencies are updated.
To find the tag currently used in CI:
