...
2.  Define `ServerInstance` (or equivalent legacy wrapper) to maintain backward
    compatibility for legacy apps.
3.  Bridge ZAP defaults to the new cluster if needed (using `BreadCrumbTracker`
    or reading ZAP defaults).
