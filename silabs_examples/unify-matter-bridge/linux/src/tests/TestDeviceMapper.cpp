...
std::vector<const char *> colordimmablelight_clusters = { "Basic", "Identify", "Groups", "Scenes", "OnOff", "Level", "ColorControl" };
...
static const nlTest sTests[] = { NL_TEST_DEF("TestDeviceMapper", TestDeviceMapper),
                                 NL_TEST_SENTINEL() };
