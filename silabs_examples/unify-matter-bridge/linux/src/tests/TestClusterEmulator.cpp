...
static void TestClusterEmulatorEmulationClusterRevisionAndFeatureMap(nlTestSuite * inSuite, void * aContext)
{
    ...
    auto attribute_id_path = chip::app::ConcreteAttributePath(
        0, chip::app::Clusters::OnOff::Id, ZCL_FEATURE_MAP_SERVER_ATTRIBUTE_ID);
    ...
    auto revision_attribute_id_path = chip::app::ConcreteAttributePath(
        0, chip::app::Clusters::OnOff::Id, ZCL_CLUSTER_REVISION_SERVER_ATTRIBUTE_ID);
...
static void TestClusterEmulatorIdentify(nlTestSuite * inSuite, void * aContext)
{
    ...
    auto attribute_id_path = chip::app::ConcreteAttributePath(
        0, chip::app::Clusters::Identify::Id, chip::app::Clusters::Identify::Attributes::IdentifyType::Id);
    chip::DataVersion dataVersion            = 0;
    chip::app::AttributeValueEncoder encoder = setupEncoder(1, attribute_id_path, dataVersion);
    ...
    auto invalid_attribute_id_path = chip::app::ConcreteAttributePath(
        1, chip::app::Clusters::Identify::Id, chip::app::Clusters::OnOff::Attributes::OnOff::Id);
