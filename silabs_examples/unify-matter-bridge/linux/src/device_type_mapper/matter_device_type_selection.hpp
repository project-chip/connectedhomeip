...
struct cluster_score
{
    ...
    cluster_score(unsigned int _extra_matter_clusters_count, unsigned int _matter_miss_count,
                  unsigned int _required_matter_clusters_count, chip::DeviceTypeId _device_type_id) :
        extra_matter_clusters_count(_extra_matter_clusters_count),
        matter_miss_count(_matter_miss_count), required_matter_clusters_count(_required_matter_clusters_count),
...
select_possible_device_types_on_score(std::vector<EmberAfCluster> translated_matter_clusters,
                                      const unify::matter_bridge::device_translator & device_translator);
