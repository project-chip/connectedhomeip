...
constexpr uint8_t ZCL_KEYPAD_LOCKOUT_ENUM_ATTRIBUTE_TYPES = ZCL_ENUM8_ATTRIBUTE_TYPES;
constexpr uint8_t ZCL_KEYPAD_LOCKOUT_ENUM_ATTRIBUTE_TYPES_SIZE = ZCL_ENUM8_ATTRIBUTE_TYPES_SIZE;
constexpr uint8_t ZCL_SCHEDULE_PROGRAMMING_VISIBILITY_ENUM_ATTRIBUTE_TYPES = ZCL_ENUM8_ATTRIBUTE_TYPES;
constexpr uint8_t ZCL_SCHEDULE_PROGRAMMING_VISIBILITY_ENUM_ATTRIBUTE_TYPES_SIZE = ZCL_ENUM8_ATTRIBUTE_TYPES_SIZE;
constexpr uint8_t ZCL_TEMPERATURE_DISPLAY_MODE_ENUM_ATTRIBUTE_TYPES = ZCL_ENUM8_ATTRIBUTE_TYPES;
constexpr uint8_t ZCL_TEMPERATURE_DISPLAY_MODE_ENUM_ATTRIBUTE_TYPES_SIZE = ZCL_ENUM8_ATTRIBUTE_TYPES_SIZE;
...
attr_type_size get_attribute_type_size(uint16_t cluster_id, uint16_t attribute_id)
{
    ...
    case chip::app::Clusters::ThermostatUserInterfaceConfiguration::Id: {
        ...
        case ThermostatUserInterfaceConfiguration::Attributes::TemperatureDisplayMode::Id: {
            return { ZCL_TEMPERATURE_DISPLAY_MODE_ENUM_ATTRIBUTE_TYPES, ZCL_TEMPERATURE_DISPLAY_MODE_ENUM_ATTRIBUTE_TYPES_SIZE };
        }
        case ThermostatUserInterfaceConfiguration::Attributes::KeypadLockout::Id: {
            return { ZCL_KEYPAD_LOCKOUT_ENUM_ATTRIBUTE_TYPES, ZCL_KEYPAD_LOCKOUT_ENUM_ATTRIBUTE_TYPES_SIZE };
        }
        case ThermostatUserInterfaceConfiguration::Attributes::ScheduleProgrammingVisibility::Id: {
            return { ZCL_SCHEDULE_PROGRAMMING_VISIBILITY_ENUM_ATTRIBUTE_TYPES,
                ZCL_SCHEDULE_PROGRAMMING_VISIBILITY_ENUM_ATTRIBUTE_TYPES_SIZE };
        }
