# Matter SiWx917 Onoff-plug Example

An example showing the use of Matter on the Silicon Labs SiWx917.

<hr>

- [Matter SiWx917 Onoff-plug Example](#matter-siwx917-onoff-plug-example)
...
The SiWx917 onoff-plug example provides a baseline demonstration of a Light
...
*   Build the example application:
          ...
          cd ~/connectedhomeip
          ./scripts/examples/gn_efr32_example.sh silabs_examples/onoff-plug-app/silabs/SiWx917/ out/test BRD4325B
...
-   To delete generated executable, libraries and object files use:
    ...
    OR use GN/Ninja directly
          ...
          $ cd ~/matter/silabs_examples/onoff-plug-app/efr32
          $ git submodule update --init
          $ source third_party/matter/scripts/activate.sh
          $ export SILABS_BOARD=BRD4325B
          $ gn gen out/debug
          $ ninja -C out/debug

-   To delete generated executable, libraries and object files use:

          $ cd ~/matter/silabs_examples/onoff-plug-app/siwx917
          $ rm -rf out/
...
*   Build the example as Sleepy End Device (SED)
    ...
    or use gn as previously mentioned but adding the following arguments:
          ...
          $ gn gen out/debug '--args=silabs_board="BRD4325B" enable_sleepy_device=true'
...
-   On the command line:
          ...
          $ cd ~/matter/silabs_examples/onoff-plug-app/siwx917
          $ python3 out/debug/chip-efr32-onoff-plug-example.flash.py
...
With this Onoff-plug example you can also use group communication to send Onoff-plug
...
`chip_progress_logging, chip_detail_logging, chip_automation_logging`
    ...
    $ ./scripts/examples/gn_efr32_example.sh ./silabs_examples/onoff-plug-app/SiWx917 ./out/onoff-plug-app BRD4325B "chip_detail_logging=false chip_automation_logging=false chip_progress_logging=false"

### Debug build / release build

`is_debug`

    $ ./scripts/examples/gn_efr32_example.sh ./silabs_examples/onoff-plug-app/SiWx917 ./out/onoff-plug-app BRD4325B "is_debug=false"

### Disabling LCD

`show_qr_code`

    $ ./scripts/examples/gn_efr32_example.sh ./silabs_examples/onoff-plug-app/SiWx917 ./out/onoff-plug-app BRD4325B "show_qr_code=false"
...
`kvs_max_entries`
    ...
    $ ./scripts/examples/gn_efr32_example.sh ./silabs_examples/onoff-plug-app/SiWx917 ./out/onoff-plug-app BRD4325B kvs_max_entries=50
