...
#define MBEDTLS_OID_MATTER_VID                         "\x2B\x06\x01\x04\x01\x82\xA2\x7C\x02\x01" /** id-domainComponent AttributeType:= {itu-t(0) data(9) pss(2342) ucl(19200300) pilot(100) pilotAttributeType(1) uid(1)} */
#define MBEDTLS_OID_MATTER_PID                         "\x2B\x06\x01\x04\x01\x82\xA2\x7C\x02\x02" /** id-domainComponent AttributeType:= {itu-t(0) data(9) pss(2342) ucl(19200300) pilot(100) pilotAttributeType(1) uid(1)} */
