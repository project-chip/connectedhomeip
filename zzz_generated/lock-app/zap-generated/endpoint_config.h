...
#define GENERATED_CLUSTERS                                                                                                         \
    {                                                                                                                              \
        {                                                                                                                          \
            ...
            {                                                                                                                      \
                0x0000002E, ZAP_ATTRIBUTE_INDEX(24), 2, 2, ZAP_CLUSTER_MASK(SERVER), NULL                                          \
            }, /* Endpoint: 0, Cluster: Power Source Configuration (server) */                                                     \
            {                                                                                                                      \
                0x0000002F, ZAP_ATTRIBUTE_INDEX(26), 6, 73, ZAP_CLUSTER_MASK(SERVER), NULL                                         \
            }, /* Endpoint: 0, Cluster: Power Source (server) */                                                                   \
            {                                                                                                                      \
            ...
            {                                                                                                                      \
                0x0000001D, ZAP_ATTRIBUTE_INDEX(176), 5, 0, ZAP_CLUSTER_MASK(SERVER), NULL                                         \
            }, /* Endpoint: 1, Cluster: Descriptor (server) */                                                                     \
            {                                                                                                                      \
                0x0000002F, ZAP_ATTRIBUTE_INDEX(181), 9, 133, ZAP_CLUSTER_MASK(SERVER), NULL                                       \
            }, /* Endpoint: 1, Cluster: Power Source (server) */                                                                   \
    }
...
#define GENERATED_ENDPOINT_TYPES                                                                                                   \
    {                                                                                                                              \
        { ZAP_CLUSTER_INDEX(0), 18, 842 }, { ZAP_CLUSTER_INDEX(18), 3, 146 },                                                      \
    }
