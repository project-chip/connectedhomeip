...
#define GENERATED_DEFAULTS                                                                                                         \
    {                                                                                                                              \
        ...
        0x00, 0x00, 0x00, 0x00,                                                                                                    \
            ...
            0x00, 0x00, 0x00, 0x00,                                                                                                \
                                                                                                                                   \
            /* Endpoint: 1, Cluster: Alarms (server), big-endian */                                                                \
                                                                                                                                   \
            /* 375 - FeatureMap, */                                                                                                \
            0x00, 0x00, 0x00, 0x00,                                                                                                \
                                                                                                                                   \
            ...
            0x00, 0x00, 0x00, 0x3F,                                                                                                \
                                                                                                                                   \
            /* Endpoint: 1, Cluster: Thermostat User Interface Configuration (server), big-endian */                               \
                                                                                                                                   \
            /* 387 - FeatureMap, */                                                                                                \
            0x00, 0x00, 0x00, 0x00,                                                                                                \
    }
...
#define GENERATED_DEFAULTS                                                                                                         \
    {                                                                                                                              \
        ...
        0x00, 0x00, 0x00, 0x00,                                                                                                    \
            ...
            0x00, 0x00, 0x00, 0x00,                                                                                                \
                                                                                                                                   \
            /* Endpoint: 1, Cluster: Alarms (server), little-endian */                                                             \
                                                                                                                                   \
            /* 375 - FeatureMap, */                                                                                                \
            0x00, 0x00, 0x00, 0x00,                                                                                                \
                                                                                                                                   \
            ...
            0x3F, 0x00, 0x00, 0x00,                                                                                                \
                                                                                                                                   \
            /* Endpoint: 1, Cluster: Thermostat User Interface Configuration (server), little-endian */                            \
                                                                                                                                   \
            /* 387 - FeatureMap, */                                                                                                \
            0x00, 0x00, 0x00, 0x00,                                                                                                \
    }
...
#define GENERATED_MIN_MAX_DEFAULTS                                                                                                 \
    {                                                                                                                              \
        ...
        { (uint16_t) 0x0, (uint16_t) 0x0, (uint16_t) 0x1 }, /* HourFormat */                                                       \
            ...
            { (uint16_t) 0x0, (uint16_t) 0x0, (uint16_t) 0xFF },        /* HVAC system type configuration */                       \
            { (uint16_t) 0x0, (uint16_t) 0xE7, (uint16_t) 0x19 },       /* local temperature calibration */                        \
            ...
            { (uint16_t) 0x0, (uint16_t) 0x0, (uint16_t) 0x7 },         /* remote sensing */                                       \
    ...
    {                                                                                                                              \
        ...
        { 0x00000000, ZAP_TYPE(BITMAP8), 1, 0, ZAP_EMPTY_DEFAULT() },             /* name support */                               \
            ...
            { 0x0000FFFD, ZAP_TYPE(INT16U), 2, 0, ZAP_SIMPLE_DEFAULT(1) },                                 /* ClusterRevision */   \
                                                                                                                                   \
            /* Endpoint: 1, Cluster: Thermostat (server) */                                                                        \
            { 0x00000000, ZAP_TYPE(INT16S), 2, 0, ZAP_SIMPLE_DEFAULT(2000) },  /* local temperature */                             \
            { 0x00000001, ZAP_TYPE(INT16S), 2, 0, ZAP_SIMPLE_DEFAULT(2000) },  /* outdoor temperature */                           \
            ...
            { 0x00000007, ZAP_TYPE(INT8U), 1, 0, ZAP_SIMPLE_DEFAULT(0) },      /* pi cooling demand */                             \
            { 0x00000008, ZAP_TYPE(INT8U), 1, 0, ZAP_SIMPLE_DEFAULT(0) },      /* pi heating demand */                             \
            { 0x00000009, ZAP_TYPE(BITMAP8), 1, ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE),                        \
              ZAP_MIN_MAX_DEFAULTS_INDEX(1) }, /* HVAC system type configuration */                                                \
            { 0x00000010, ZAP_TYPE(INT8S), 1, ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE),                          \
              ZAP_MIN_MAX_DEFAULTS_INDEX(2) }, /* local temperature calibration */                                                 \
            ...
            { 0x00000013, ZAP_TYPE(INT16S), 2, ZAP_ATTRIBUTE_MASK(WRITABLE),                                                       \
              ZAP_SIMPLE_DEFAULT(0x0A28) }, /* unoccupied cooling setpoint */                                                      \
            { 0x00000014, ZAP_TYPE(INT16S), 2, ZAP_ATTRIBUTE_MASK(WRITABLE),                                                       \
              ZAP_SIMPLE_DEFAULT(0x07D0) }, /* unoccupied heating setpoint */                                                      \
            ...
            { 0x0000001A, ZAP_TYPE(BITMAP8), 1, ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE),                        \
              ZAP_MIN_MAX_DEFAULTS_INDEX(8) }, /* remote sensing */                                                                \
            ...
            { 0x0000001E, ZAP_TYPE(ENUM8), 1, 0, ZAP_SIMPLE_DEFAULT(0) },           /* thermostat running mode */                  \
            { 0x00000020, ZAP_TYPE(ENUM8), 1, 0, ZAP_SIMPLE_DEFAULT(0) },           /* start of week */                            \
            { 0x00000021, ZAP_TYPE(INT8U), 1, 0, ZAP_SIMPLE_DEFAULT(0) },           /* number of weekly transitions */             \
            { 0x00000022, ZAP_TYPE(INT8U), 1, 0, ZAP_SIMPLE_DEFAULT(0) },           /* number of daily transitions */              \
...
#define GENERATED_ENDPOINT_TYPES                                                                                                   \
    {                                                                                                                              \
        { ZAP_CLUSTER_INDEX(0), 22, 587 }, { ZAP_CLUSTER_INDEX(22), 12, 95 },                                                      \
    }
