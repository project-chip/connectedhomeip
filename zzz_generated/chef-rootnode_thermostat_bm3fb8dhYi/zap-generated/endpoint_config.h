    ...
    {                                                                                                                              \
        ...
        { ZAP_EMPTY_DEFAULT(), 0x00000000, 1, ZAP_TYPE(BITMAP8), 0 },        /* NameSupport */                                     \
            ...
            { ZAP_SIMPLE_DEFAULT(1), 0x0000FFFD, 2, ZAP_TYPE(INT16U), 0 },                                 /* ClusterRevision */   \
                                                                                                                                   \
            /* Endpoint: 1, Cluster: Thermostat (server) */                                                                        \
            { ZAP_SIMPLE_DEFAULT(2000), 0x00000000, 2, ZAP_TYPE(INT16S), ZAP_ATTRIBUTE_MASK(NULLABLE) }, /* LocalTemperature */    \
            { ZAP_SIMPLE_DEFAULT(2000), 0x00000001, 2, ZAP_TYPE(INT16S), ZAP_ATTRIBUTE_MASK(NULLABLE) }, /* OutdoorTemperature */  \
            ...
            { ZAP_MIN_MAX_DEFAULTS_INDEX(1), 0x00000009, 1, ZAP_TYPE(BITMAP8),                                                     \
              ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE) }, /* HVACSystemTypeConfiguration */                      \
            { ZAP_MIN_MAX_DEFAULTS_INDEX(2), 0x00000010, 1, ZAP_TYPE(INT8S),                                                       \
              ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE) }, /* LocalTemperatureCalibration */                      \
            { ZAP_MIN_MAX_DEFAULTS_INDEX(3), 0x00000011, 2, ZAP_TYPE(INT16S),                                                      \
              ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE) }, /* OccupiedCoolingSetpoint */                          \
            { ZAP_MIN_MAX_DEFAULTS_INDEX(4), 0x00000012, 2, ZAP_TYPE(INT16S),                                                      \
              ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE) }, /* OccupiedHeatingSetpoint */                          \
            { ZAP_MIN_MAX_DEFAULTS_INDEX(5), 0x00000013, 2, ZAP_TYPE(INT16S),                                                      \
              ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE) }, /* UnoccupiedCoolingSetpoint */                        \
            { ZAP_MIN_MAX_DEFAULTS_INDEX(6), 0x00000014, 2, ZAP_TYPE(INT16S),                                                      \
              ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE) }, /* UnoccupiedHeatingSetpoint */                        \
            { ZAP_MIN_MAX_DEFAULTS_INDEX(7), 0x00000015, 2, ZAP_TYPE(INT16S),                                                      \
              ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE) }, /* MinHeatSetpointLimit */                             \
            { ZAP_MIN_MAX_DEFAULTS_INDEX(8), 0x00000016, 2, ZAP_TYPE(INT16S),                                                      \
              ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE) }, /* MaxHeatSetpointLimit */                             \
            { ZAP_MIN_MAX_DEFAULTS_INDEX(9), 0x00000017, 2, ZAP_TYPE(INT16S),                                                      \
              ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE) }, /* MinCoolSetpointLimit */                             \
            { ZAP_MIN_MAX_DEFAULTS_INDEX(10), 0x00000018, 2, ZAP_TYPE(INT16S),                                                     \
              ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE) }, /* MaxCoolSetpointLimit */                             \
            { ZAP_MIN_MAX_DEFAULTS_INDEX(11), 0x00000019, 1, ZAP_TYPE(INT8S),                                                      \
              ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE) }, /* MinSetpointDeadBand */                              \
            { ZAP_MIN_MAX_DEFAULTS_INDEX(12), 0x0000001A, 1, ZAP_TYPE(BITMAP8),                                                    \
              ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE) }, /* RemoteSensing */                                    \
            ...
            { ZAP_MIN_MAX_DEFAULTS_INDEX(16), 0x00000001, 1, ZAP_TYPE(ENUM8),                                                      \
