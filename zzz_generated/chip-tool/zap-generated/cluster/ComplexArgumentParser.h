...
static CHIP_ERROR Setup(const char * label, chip::app::Clusters::AmbientSensingUnion::Structs::UnionMemberStruct::Type & request,
                        Json::Value & value);

static void Finalize(chip::app::Clusters::AmbientSensingUnion::Structs::UnionMemberStruct::Type & request);
