...
static CHIP_ERROR Setup(const char * label, chip::app::Clusters::detail::Structs::SemanticTagStruct::Type & request,
                        Json::Value & value);

static void Finalize(chip::app::Clusters::detail::Structs::SemanticTagStruct::Type & request);
