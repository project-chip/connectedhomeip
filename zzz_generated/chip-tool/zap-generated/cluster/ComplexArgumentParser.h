...
static CHIP_ERROR Setup(const char * label, chip::app::Clusters::detail::Structs::SFrameKeyStruct::Type & request,
                        Json::Value & value);

static void Finalize(chip::app::Clusters::detail::Structs::SFrameKeyStruct::Type & request);

static CHIP_ERROR Setup(const char * label, chip::app::Clusters::detail::Structs::SFrameStruct::Type & request,
                        Json::Value & value);

static void Finalize(chip::app::Clusters::detail::Structs::SFrameStruct::Type & request);
