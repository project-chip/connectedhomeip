...
static CHIP_ERROR LogValue(const char * label, size_t indent,
                           const chip::app::Clusters::MicrowaveOvenMode::Structs::ModeTagStruct::DecodableType & value);

static CHIP_ERROR LogValue(const char * label, size_t indent,
                           const chip::app::Clusters::MicrowaveOvenMode::Structs::ModeOptionStruct::DecodableType & value);
