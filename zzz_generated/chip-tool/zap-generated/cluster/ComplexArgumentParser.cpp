...
CHIP_ERROR
ComplexArgumentParser::Setup(const char * label,
                             chip::app::Clusters::RoboticVacuumOperationalState::Structs::ErrorStateStruct::Type & request,
                             Json::Value & value)
{
    VerifyOrReturnError(value.isObject(), CHIP_ERROR_INVALID_ARGUMENT);
...
void ComplexArgumentParser::Finalize(chip::app::Clusters::RoboticVacuumOperationalState::Structs::ErrorStateStruct::Type & request)
{
    ComplexArgumentParser::Finalize(request.errorStateID);
    ComplexArgumentParser::Finalize(request.errorStateLabel);
    ComplexArgumentParser::Finalize(request.errorStateDetails);
...
CHIP_ERROR
ComplexArgumentParser::Setup(const char * label,
                             chip::app::Clusters::RoboticVacuumOperationalState::Structs::OperationalStateStruct::Type & request,
                             Json::Value & value)
{
    VerifyOrReturnError(value.isObject(), CHIP_ERROR_INVALID_ARGUMENT);
