                                        ...
                                        Json::Value & value)
{
    ...
    ReturnErrorOnFailure(
        ComplexArgumentParser::EnsureMemberExist("DatastoreNodeKeyEntry.nodeID", "nodeID", value.isMember("nodeID")));
                             ...
                             Json::Value & value)
{
    ...
    ReturnErrorOnFailure(
        ComplexArgumentParser::EnsureMemberExist("DatastoreEndpointGroupIDEntry.nodeID", "nodeID", value.isMember("nodeID")));
    ReturnErrorOnFailure(ComplexArgumentParser::EnsureMemberExist("DatastoreEndpointGroupIDEntry.endpointID", "endpointID",
                                                                  value.isMember("endpointID")));
    ReturnErrorOnFailure(
        ComplexArgumentParser::EnsureMemberExist("DatastoreEndpointGroupIDEntry.groupID", "groupID", value.isMember("groupID")));
    ReturnErrorOnFailure(ComplexArgumentParser::EnsureMemberExist("DatastoreEndpointGroupIDEntry.statusEntry", "statusEntry",
                                                                  value.isMember("statusEntry")));
                             ...
                             Json::Value & value)
{
    ...
    ReturnErrorOnFailure(
        ComplexArgumentParser::EnsureMemberExist("DatastoreEndpointBindingEntry.nodeID", "nodeID", value.isMember("nodeID")));
    ReturnErrorOnFailure(ComplexArgumentParser::EnsureMemberExist("DatastoreEndpointBindingEntry.endpointID", "endpointID",
                                                                  value.isMember("endpointID")));
    ReturnErrorOnFailure(
        ComplexArgumentParser::EnsureMemberExist("DatastoreEndpointBindingEntry.listID", "listID", value.isMember("listID")));
    ReturnErrorOnFailure(
        ComplexArgumentParser::EnsureMemberExist("DatastoreEndpointBindingEntry.binding", "binding", value.isMember("binding")));
    ReturnErrorOnFailure(ComplexArgumentParser::EnsureMemberExist("DatastoreEndpointBindingEntry.statusEntry", "statusEntry",
                                                                  value.isMember("statusEntry")));
                                        ...
                                        Json::Value & value)
{
    ...
    ReturnErrorOnFailure(ComplexArgumentParser::EnsureMemberExist("DatastoreACLEntry.nodeID", "nodeID", value.isMember("nodeID")));
