                             ...
                             Json::Value & value)
{
    ...
    ReturnErrorOnFailure(ComplexArgumentParser::EnsureMemberExist("ChildTableStruct.rloc16", "rloc16", value.isMember("rloc16")));
    ReturnErrorOnFailure(
        ComplexArgumentParser::EnsureMemberExist("ChildTableStruct.linkQuality", "linkQuality", value.isMember("linkQuality")));
    ReturnErrorOnFailure(
        ComplexArgumentParser::EnsureMemberExist("ChildTableStruct.routingRole", "routingRole", value.isMember("routingRole")));
    ...
    snprintf(labelWithMember, sizeof(labelWithMember), "%s.%s", label, "linkQuality");
    ReturnErrorOnFailure(ComplexArgumentParser::Setup(labelWithMember, request.linkQuality, value["linkQuality"]));
    valueCopy.removeMember("linkQuality");

    snprintf(labelWithMember, sizeof(labelWithMember), "%s.%s", label, "routingRole");
    ReturnErrorOnFailure(ComplexArgumentParser::Setup(labelWithMember, request.routingRole, value["routingRole"]));
    valueCopy.removeMember("routingRole");

    return ComplexArgumentParser::EnsureNoMembersRemaining(label, valueCopy);
}

void ComplexArgumentParser::Finalize(chip::app::Clusters::ThreadBorderRouterManagement::Structs::ChildTableStruct::Type & request)
{
    ComplexArgumentParser::Finalize(request.rloc16);
    ComplexArgumentParser::Finalize(request.linkQuality);
    ComplexArgumentParser::Finalize(request.routingRole);
}
...
void ComplexArgumentParser::Finalize(chip::app::Clusters::ThreadBorderRouterManagement::Structs::RouteTableStruct::Type & request)
{
    ComplexArgumentParser::Finalize(request.routerId);
    ComplexArgumentParser::Finalize(request.pathCost);
    ComplexArgumentParser::Finalize(request.LQIIn);
                             ...
                             Json::Value & value)
{
    ...
    ReturnErrorOnFailure(
        ComplexArgumentParser::EnsureMemberExist("ThreadNodeStruct.extAddress", "extAddress", value.isMember("extAddress")));
    ReturnErrorOnFailure(ComplexArgumentParser::EnsureMemberExist("ThreadNodeStruct.rloc16", "rloc16", value.isMember("rloc16")));
    ReturnErrorOnFailure(ComplexArgumentParser::EnsureMemberExist("ThreadNodeStruct.IPv6s", "IPv6s", value.isMember("IPv6s")));
    ReturnErrorOnFailure(
        ComplexArgumentParser::EnsureMemberExist("ThreadNodeStruct.routingRole", "routingRole", value.isMember("routingRole")));
    ReturnErrorOnFailure(
        ComplexArgumentParser::EnsureMemberExist("ThreadNodeStruct.routeTable", "routeTable", value.isMember("routeTable")));
    ReturnErrorOnFailure(
        ComplexArgumentParser::EnsureMemberExist("ThreadNodeStruct.childTable", "childTable", value.isMember("childTable")));
    ...
    snprintf(labelWithMember, sizeof(labelWithMember), "%s.%s", label, "IPv6s");
    ReturnErrorOnFailure(ComplexArgumentParser::Setup(labelWithMember, request.IPv6s, value["IPv6s"]));
    valueCopy.removeMember("IPv6s");

    snprintf(labelWithMember, sizeof(labelWithMember), "%s.%s", label, "routingRole");
    ReturnErrorOnFailure(ComplexArgumentParser::Setup(labelWithMember, request.routingRole, value["routingRole"]));
    valueCopy.removeMember("routingRole");

    snprintf(labelWithMember, sizeof(labelWithMember), "%s.%s", label, "routeTable");
    ReturnErrorOnFailure(ComplexArgumentParser::Setup(labelWithMember, request.routeTable, value["routeTable"]));
    valueCopy.removeMember("routeTable");

    snprintf(labelWithMember, sizeof(labelWithMember), "%s.%s", label, "childTable");
    ReturnErrorOnFailure(ComplexArgumentParser::Setup(labelWithMember, request.childTable, value["childTable"]));
    valueCopy.removeMember("childTable");

    return ComplexArgumentParser::EnsureNoMembersRemaining(label, valueCopy);
}

void ComplexArgumentParser::Finalize(chip::app::Clusters::ThreadBorderRouterManagement::Structs::ThreadNodeStruct::Type & request)
{
    ComplexArgumentParser::Finalize(request.extAddress);
    ComplexArgumentParser::Finalize(request.rloc16);
    ComplexArgumentParser::Finalize(request.IPv6s);
    ComplexArgumentParser::Finalize(request.routingRole);
    ComplexArgumentParser::Finalize(request.routeTable);
    ComplexArgumentParser::Finalize(request.childTable);
}
                             ...
                             Json::Value & value)
{
    ...
    ReturnErrorOnFailure(
        ComplexArgumentParser::EnsureMemberExist("NeiborTableStruct.extAddress", "extAddress", value.isMember("extAddress")));
    ReturnErrorOnFailure(ComplexArgumentParser::EnsureMemberExist("NeiborTableStruct.age", "age", value.isMember("age")));
    ReturnErrorOnFailure(ComplexArgumentParser::EnsureMemberExist("NeiborTableStruct.rloc16", "rloc16", value.isMember("rloc16")));
    ReturnErrorOnFailure(
        ComplexArgumentParser::EnsureMemberExist("NeiborTableStruct.averageRssi", "averageRssi", value.isMember("averageRssi")));
    ReturnErrorOnFailure(
        ComplexArgumentParser::EnsureMemberExist("NeiborTableStruct.lastRssi", "lastRssi", value.isMember("lastRssi")));
    ReturnErrorOnFailure(
        ComplexArgumentParser::EnsureMemberExist("NeiborTableStruct.routingRole", "routingRole", value.isMember("routingRole")));
...
void ComplexArgumentParser::Finalize(chip::app::Clusters::ThreadBorderRouterManagement::Structs::NeiborTableStruct::Type & request)
{
    ComplexArgumentParser::Finalize(request.extAddress);
    ComplexArgumentParser::Finalize(request.age);
    ComplexArgumentParser::Finalize(request.rloc16);
