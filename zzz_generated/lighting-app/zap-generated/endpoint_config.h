...
#define GENERATED_ATTRIBUTES                                                                                                       \
    {                                                                                                                              \
        ...
        { 0x0000, ZAP_TYPE(INT16U), 2, ZAP_ATTRIBUTE_MASK(SINGLETON), ZAP_EMPTY_DEFAULT() }, /* InteractionModelVersion */         \
            ...
            { 0x0001, ZAP_TYPE(ARRAY), 254, 0, ZAP_LONG_DEFAULTS_INDEX(1931) }, /* fabrics list */                                 \
    ...
    {                                                                                                                              \
        { 0x0028,                                                                                                                  \
          ...
          chipFuncArrayBasicServer }, /* Endpoint: 0, Cluster: Basic (server) */                                                   \
            ...
            {                                                                                                                      \
                0x003E, ZAP_ATTRIBUTE_INDEX(102), 4, 258, ZAP_CLUSTER_MASK(SERVER), NULL                                           \
            }, /* Endpoint: 0, Cluster: Operational Credentials (server) */                                                        \
            { 0x0006,                                                                                                              \
            ...
            {                                                                                                                      \
                0x0006, ZAP_ATTRIBUTE_INDEX(143), 1, 2, ZAP_CLUSTER_MASK(CLIENT), NULL                                             \
            }, /* Endpoint: 2, Cluster: On/Off (client) */                                                                         \
            {                                                                                                                      \
                0x0007, ZAP_ATTRIBUTE_INDEX(144), 3, 4, ZAP_CLUSTER_MASK(SERVER), NULL                                             \
            }, /* Endpoint: 2, Cluster: On/off Switch Configuration (server) */                                                    \
    }
...
#define GENERATED_ENDPOINT_TYPES                                                                                                   \
    {                                                                                                                              \
        { ZAP_CLUSTER_INDEX(0), 11, 2251 }, { ZAP_CLUSTER_INDEX(11), 4, 57 }, { ZAP_CLUSTER_INDEX(15), 2, 6 },                     \
    }

// Largest attribute size is needed for various buffers
#define ATTRIBUTE_LARGEST (258)
