...
#define GENERATED_CLUSTERS                                                                                                         \
    {                                                                                                                              \
        {                                                                                                                          \
            ...
            {                                                                                                                      \
                0x0000002B, ZAP_ATTRIBUTE_INDEX(31), 2, 36, ZAP_CLUSTER_MASK(SERVER), NULL                                         \
            }, /* Endpoint: 0, Cluster: Localization Configuration (server) */                                                     \
            { 0x0000002C,                                                                                                          \
            ...
            {                                                                                                                      \
                0x0000003B, ZAP_ATTRIBUTE_INDEX(159), 0, 0, ZAP_CLUSTER_MASK(SERVER), NULL                                         \
            ...
            {                                                                                                                      \
                0x0000001D, ZAP_ATTRIBUTE_INDEX(200), 5, 0, ZAP_CLUSTER_MASK(SERVER), NULL                                         \
            }, /* Endpoint: 1, Cluster: Descriptor (server) */                                                                     \
            { 0x00000300,                                                                                                          \
            ...
            {                                                                                                                      \
                0x00000006, ZAP_ATTRIBUTE_INDEX(231), 1, 2, ZAP_CLUSTER_MASK(CLIENT), NULL                                         \
            }, /* Endpoint: 2, Cluster: On/Off (client) */                                                                         \
            {                                                                                                                      \
                0x00000007, ZAP_ATTRIBUTE_INDEX(232), 3, 4, ZAP_CLUSTER_MASK(SERVER), NULL                                         \
            }, /* Endpoint: 2, Cluster: On/off Switch Configuration (server) */                                                    \
    }
...
#define GENERATED_ENDPOINT_TYPES                                                                                                   \
    {                                                                                                                              \
        { ZAP_CLUSTER_INDEX(0), 19, 1483 }, { ZAP_CLUSTER_INDEX(19), 6, 86 }, { ZAP_CLUSTER_INDEX(25), 2, 6 },                     \
    }
