...
#define GENERATED_ATTRIBUTES                                                                                                       \
    {                                                                                                                              \
        ...
        { 0x0000, ZAP_TYPE(ARRAY), 254, ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE), ZAP_LONG_DEFAULTS_INDEX(0) }, /* device list */      \
            ...
            { 0xFFFC, ZAP_TYPE(BITMAP32), 4, 0, ZAP_LONG_DEFAULTS_INDEX(3769) },                       /* FeatureMap */            \
            ...
            { 0x0000, ZAP_TYPE(ARRAY), 254, ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE),                                                  \
              ZAP_LONG_DEFAULTS_INDEX(3773) }, /* device list */                                                                   \
            { 0x0001, ZAP_TYPE(ARRAY), 254, ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE),                                                  \
              ZAP_LONG_DEFAULTS_INDEX(4027) }, /* server list */                                                                   \
            { 0x0002, ZAP_TYPE(ARRAY), 254, ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE),                                                  \
              ZAP_LONG_DEFAULTS_INDEX(4281) }, /* client list */                                                                   \
            { 0x0003, ZAP_TYPE(ARRAY), 254, ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE),                                                  \
              ZAP_LONG_DEFAULTS_INDEX(4535) },                         /* parts list */                                            \
            { 0xFFFD, ZAP_TYPE(INT16U), 2, 0, ZAP_SIMPLE_DEFAULT(1) }, /* ClusterRevision */                                       \
                                                                                                                                   \
...
#define GENERATED_CLUSTERS                                                                                                         \
    {                                                                                                                              \
        {                                                                                                                          \
            ...
            {                                                                                                                      \
                0x0006, ZAP_ATTRIBUTE_INDEX(185), 1, 2, ZAP_CLUSTER_MASK(CLIENT), NULL                                             \
            }, /* Endpoint: 2, Cluster: On/Off (client) */                                                                         \
            {                                                                                                                      \
                0x0007, ZAP_ATTRIBUTE_INDEX(186), 3, 4, ZAP_CLUSTER_MASK(SERVER), NULL                                             \
            }, /* Endpoint: 2, Cluster: On/off Switch Configuration (server) */                                                    \
    }
...
#define GENERATED_ENDPOINT_TYPES                                                                                                   \
    {                                                                                                                              \
        { ZAP_CLUSTER_INDEX(0), 12, 3840 }, { ZAP_CLUSTER_INDEX(12), 5, 1095 }, { ZAP_CLUSTER_INDEX(17), 2, 6 },                   \
    }
...
#define ATTRIBUTE_MAX_SIZE (4941)
