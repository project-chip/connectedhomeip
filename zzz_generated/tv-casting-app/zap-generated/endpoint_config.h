...
\
  ...
  { 0x00000010, ZAP_TYPE(NODE_ID), 8, ZAP_ATTRIBUTE_MASK(WRITABLE), ZAP_LONG_DEFAULTS_INDEX(235) }, /* IAS CIE address */  \
...
\
  ...
  { 0x00000003, ZAP_TYPE(BITMAP32), 4, ZAP_ATTRIBUTE_MASK(WRITABLE), ZAP_LONG_DEFAULTS_INDEX(243) }, /* bitmap32 */  \
  { 0x00000004, ZAP_TYPE(BITMAP64), 8, ZAP_ATTRIBUTE_MASK(WRITABLE), ZAP_LONG_DEFAULTS_INDEX(247) }, /* bitmap64 */  \
  ...
  { 0x00000008, ZAP_TYPE(INT32U), 4, ZAP_ATTRIBUTE_MASK(WRITABLE), ZAP_LONG_DEFAULTS_INDEX(255) }, /* int32u */  \
  { 0x0000000C, ZAP_TYPE(INT64U), 8, ZAP_ATTRIBUTE_MASK(WRITABLE), ZAP_LONG_DEFAULTS_INDEX(259) }, /* int64u */  \
  ...
  { 0x00000010, ZAP_TYPE(INT32S), 4, ZAP_ATTRIBUTE_MASK(WRITABLE), ZAP_LONG_DEFAULTS_INDEX(267) }, /* int32s */  \
  { 0x00000014, ZAP_TYPE(INT64S), 8, ZAP_ATTRIBUTE_MASK(WRITABLE), ZAP_LONG_DEFAULTS_INDEX(271) }, /* int64s */  \
...
#define GENERATED_ENDPOINT_TYPES { \
  { ZAP_CLUSTER_INDEX(0), 21, 443 }, \
  { ZAP_CLUSTER_INDEX(21), 27, 1186 }, \
  { ZAP_CLUSTER_INDEX(48), 2, 3 }, \
}
...
#define ATTRIBUTE_MAX_SIZE (1632)
...
#define FIXED_DEVICE_TYPES {{0x0016,1},{0x0023,1},{0x0107,1}}
