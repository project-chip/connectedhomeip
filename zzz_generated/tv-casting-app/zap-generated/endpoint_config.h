...
\
  /* Endpoint: 1, Cluster: Binary Input (Basic) (server) */ \
  { 0x00000051, ZAP_TYPE(BOOLEAN), 1, ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE), ZAP_MIN_MAX_DEFAULTS_INDEX(2) }, /* out of service */  \
...
#define GENERATED_ENDPOINT_TYPES { \
  { ZAP_CLUSTER_INDEX(0), 15, 212 }, \
  { ZAP_CLUSTER_INDEX(15), 22, 80 }, \
}
...
#define FIXED_DEVICE_TYPES {{0x0016,1},{0x0029,1}}
