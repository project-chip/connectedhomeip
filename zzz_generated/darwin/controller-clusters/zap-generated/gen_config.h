...
#define EMBER_AF_DISHWASHER_CONTROL_CLUSTER_CLIENT_ENDPOINT_COUNT (1)
...
// Use this macro to check if the client side of the Dishwasher Control cluster is included
#define ZCL_USING_DISHWASHER_CONTROL_CLUSTER_CLIENT
#define EMBER_AF_PLUGIN_DISHWASHER_CONTROL_CLIENT
