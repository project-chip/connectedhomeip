...
#define EMBER_AF_WASHER_CONTROLS_CLUSTER_CLIENT_ENDPOINT_COUNT (1)
...
// Use this macro to check if the client side of the Washer Controls cluster is included
#define ZCL_USING_WASHER_CONTROLS_CLUSTER_CLIENT
#define EMBER_AF_PLUGIN_WASHER_CONTROLS_CLIENT
