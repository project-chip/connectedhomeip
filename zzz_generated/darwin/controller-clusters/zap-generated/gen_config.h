...
#define EMBER_AF_LAUNDRY_WASHER_CLUSTER_CLIENT_ENDPOINT_COUNT (1)
...
// Use this macro to check if the client side of the Laundry Washer cluster is included
#define ZCL_USING_LAUNDRY_WASHER_CLUSTER_CLIENT
#define EMBER_AF_PLUGIN_LAUNDRY_WASHER_CLIENT
