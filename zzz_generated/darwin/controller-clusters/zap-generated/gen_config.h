...
#define EMBER_AF_REFRIGERATOR_AND_TEMPERATURE_CONTROLLED_CABINET_CLUSTER_CLIENT_ENDPOINT_COUNT (1)
#define EMBER_AF_RVC_RUN_CLUSTER_CLIENT_ENDPOINT_COUNT (1)
#define EMBER_AF_RVC_CLEAN_CLUSTER_CLIENT_ENDPOINT_COUNT (1)
...
// Use this macro to check if the client side of the Refrigerator And Temperature Controlled Cabinet cluster is included
#define ZCL_USING_REFRIGERATOR_AND_TEMPERATURE_CONTROLLED_CABINET_CLUSTER_CLIENT
#define EMBER_AF_PLUGIN_REFRIGERATOR_AND_TEMPERATURE_CONTROLLED_CABINET_CLIENT

// Use this macro to check if the client side of the RVC Run cluster is included
#define ZCL_USING_RVC_RUN_CLUSTER_CLIENT
#define EMBER_AF_PLUGIN_RVC_RUN_CLIENT

// Use this macro to check if the client side of the RVC Clean cluster is included
#define ZCL_USING_RVC_CLEAN_CLUSTER_CLIENT
#define EMBER_AF_PLUGIN_RVC_CLEAN_CLIENT
