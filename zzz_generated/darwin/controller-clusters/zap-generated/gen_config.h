...
#define EMBER_AF_ETHYLENE_CONCENTRATION_MEASUREMENT_CLUSTER_CLIENT_ENDPOINT_COUNT (1)
#define EMBER_AF_ETHYLENE_OXIDE_CONCENTRATION_MEASUREMENT_CLUSTER_CLIENT_ENDPOINT_COUNT (1)
#define EMBER_AF_HYDROGEN_CONCENTRATION_MEASUREMENT_CLUSTER_CLIENT_ENDPOINT_COUNT (1)
#define EMBER_AF_HYDROGEN_SULFIDE_CONCENTRATION_MEASUREMENT_CLUSTER_CLIENT_ENDPOINT_COUNT (1)
#define EMBER_AF_NITRIC_OXIDE_CONCENTRATION_MEASUREMENT_CLUSTER_CLIENT_ENDPOINT_COUNT (1)
#define EMBER_AF_NITROGEN_DIOXIDE_CONCENTRATION_MEASUREMENT_CLUSTER_CLIENT_ENDPOINT_COUNT (1)
...
#define EMBER_AF_SULFUR_DIOXIDE_CONCENTRATION_MEASUREMENT_CLUSTER_CLIENT_ENDPOINT_COUNT (1)
#define EMBER_AF_DISSOLVED_OXYGEN_CONCENTRATION_MEASUREMENT_CLUSTER_CLIENT_ENDPOINT_COUNT (1)
#define EMBER_AF_BROMATE_CONCENTRATION_MEASUREMENT_CLUSTER_CLIENT_ENDPOINT_COUNT (1)
#define EMBER_AF_CHLORAMINES_CONCENTRATION_MEASUREMENT_CLUSTER_CLIENT_ENDPOINT_COUNT (1)
#define EMBER_AF_CHLORINE_CONCENTRATION_MEASUREMENT_CLUSTER_CLIENT_ENDPOINT_COUNT (1)
#define EMBER_AF_FECAL_COLIFORM_CONCENTRATION_MEASUREMENT_CLUSTER_CLIENT_ENDPOINT_COUNT (1)
#define EMBER_AF_FLUORIDE_CONCENTRATION_MEASUREMENT_CLUSTER_CLIENT_ENDPOINT_COUNT (1)
#define EMBER_AF_HALOACETIC_ACIDS_CONCENTRATION_MEASUREMENT_CLUSTER_CLIENT_ENDPOINT_COUNT (1)
#define EMBER_AF_TOTAL_TRIHALOMETHANES_CONCENTRATION_MEASUREMENT_CLUSTER_CLIENT_ENDPOINT_COUNT (1)
#define EMBER_AF_TOTAL_COLIFORM_BACTERIA_CONCENTRATION_MEASUREMENT_CLUSTER_CLIENT_ENDPOINT_COUNT (1)
#define EMBER_AF_TURBIDITY_CONCENTRATION_MEASUREMENT_CLUSTER_CLIENT_ENDPOINT_COUNT (1)
#define EMBER_AF_COPPER_CONCENTRATION_MEASUREMENT_CLUSTER_CLIENT_ENDPOINT_COUNT (1)
#define EMBER_AF_LEAD_CONCENTRATION_MEASUREMENT_CLUSTER_CLIENT_ENDPOINT_COUNT (1)
#define EMBER_AF_MANGANESE_CONCENTRATION_MEASUREMENT_CLUSTER_CLIENT_ENDPOINT_COUNT (1)
#define EMBER_AF_SULFATE_CONCENTRATION_MEASUREMENT_CLUSTER_CLIENT_ENDPOINT_COUNT (1)
#define EMBER_AF_BROMODICHLOROMETHANE_CONCENTRATION_MEASUREMENT_CLUSTER_CLIENT_ENDPOINT_COUNT (1)
#define EMBER_AF_BROMOFORM_CONCENTRATION_MEASUREMENT_CLUSTER_CLIENT_ENDPOINT_COUNT (1)
#define EMBER_AF_CHLORODIBROMOMETHANE_CONCENTRATION_MEASUREMENT_CLUSTER_CLIENT_ENDPOINT_COUNT (1)
#define EMBER_AF_CHLOROFORM_CONCENTRATION_MEASUREMENT_CLUSTER_CLIENT_ENDPOINT_COUNT (1)
#define EMBER_AF_SODIUM_CONCENTRATION_MEASUREMENT_CLUSTER_CLIENT_ENDPOINT_COUNT (1)
#define EMBER_AF_PM2_5_CONCENTRATION_MEASUREMENT_CLUSTER_CLIENT_ENDPOINT_COUNT (1)
#define EMBER_AF_FORMALDEHYDE_CONCENTRATION_MEASUREMENT_CLUSTER_CLIENT_ENDPOINT_COUNT (1)
#define EMBER_AF_PM1_CONCENTRATION_MEASUREMENT_CLUSTER_CLIENT_ENDPOINT_COUNT (1)
#define EMBER_AF_PM10_CONCENTRATION_MEASUREMENT_CLUSTER_CLIENT_ENDPOINT_COUNT (1)
#define EMBER_AF_VOC_CONCENTRATION_MEASUREMENT_CLUSTER_CLIENT_ENDPOINT_COUNT (1)
#define EMBER_AF_RADON_CONCENTRATION_MEASUREMENT_CLUSTER_CLIENT_ENDPOINT_COUNT (1)
...
#define EMBER_AF_PLUGIN_CARBON_MONOXIDE_CONCENTRATION_MEASUREMENT_CLIENT
...
#define EMBER_AF_PLUGIN_CARBON_DIOXIDE_CONCENTRATION_MEASUREMENT_CLIENT

// Use this macro to check if the client side of the Ethylene Concentration Measurement cluster is included
#define ZCL_USING_ETHYLENE_CONCENTRATION_MEASUREMENT_CLUSTER_CLIENT
#define EMBER_AF_PLUGIN_ETHYLENE_CONCENTRATION_MEASUREMENT_CLIENT

// Use this macro to check if the client side of the Ethylene Oxide Concentration Measurement cluster is included
#define ZCL_USING_ETHYLENE_OXIDE_CONCENTRATION_MEASUREMENT_CLUSTER_CLIENT
#define EMBER_AF_PLUGIN_ETHYLENE_OXIDE_CONCENTRATION_MEASUREMENT_CLIENT

// Use this macro to check if the client side of the Hydrogen Concentration Measurement cluster is included
#define ZCL_USING_HYDROGEN_CONCENTRATION_MEASUREMENT_CLUSTER_CLIENT
#define EMBER_AF_PLUGIN_HYDROGEN_CONCENTRATION_MEASUREMENT_CLIENT

// Use this macro to check if the client side of the Hydrogen Sulfide Concentration Measurement cluster is included
#define ZCL_USING_HYDROGEN_SULFIDE_CONCENTRATION_MEASUREMENT_CLUSTER_CLIENT
#define EMBER_AF_PLUGIN_HYDROGEN_SULFIDE_CONCENTRATION_MEASUREMENT_CLIENT

// Use this macro to check if the client side of the Nitric Oxide Concentration Measurement cluster is included
#define ZCL_USING_NITRIC_OXIDE_CONCENTRATION_MEASUREMENT_CLUSTER_CLIENT
#define EMBER_AF_PLUGIN_NITRIC_OXIDE_CONCENTRATION_MEASUREMENT_CLIENT
...
#define EMBER_AF_PLUGIN_NITROGEN_DIOXIDE_CONCENTRATION_MEASUREMENT_CLIENT

// Use this macro to check if the client side of the Oxygen Concentration Measurement cluster is included
#define ZCL_USING_OXYGEN_CONCENTRATION_MEASUREMENT_CLUSTER_CLIENT
#define EMBER_AF_PLUGIN_OXYGEN_CONCENTRATION_MEASUREMENT_CLIENT
...
#define EMBER_AF_PLUGIN_OZONE_CONCENTRATION_MEASUREMENT_CLIENT

// Use this macro to check if the client side of the Sulfur Dioxide Concentration Measurement cluster is included
#define ZCL_USING_SULFUR_DIOXIDE_CONCENTRATION_MEASUREMENT_CLUSTER_CLIENT
#define EMBER_AF_PLUGIN_SULFUR_DIOXIDE_CONCENTRATION_MEASUREMENT_CLIENT

// Use this macro to check if the client side of the Dissolved Oxygen Concentration Measurement cluster is included
#define ZCL_USING_DISSOLVED_OXYGEN_CONCENTRATION_MEASUREMENT_CLUSTER_CLIENT
#define EMBER_AF_PLUGIN_DISSOLVED_OXYGEN_CONCENTRATION_MEASUREMENT_CLIENT

// Use this macro to check if the client side of the Bromate Concentration Measurement cluster is included
#define ZCL_USING_BROMATE_CONCENTRATION_MEASUREMENT_CLUSTER_CLIENT
#define EMBER_AF_PLUGIN_BROMATE_CONCENTRATION_MEASUREMENT_CLIENT

// Use this macro to check if the client side of the Chloramines Concentration Measurement cluster is included
#define ZCL_USING_CHLORAMINES_CONCENTRATION_MEASUREMENT_CLUSTER_CLIENT
#define EMBER_AF_PLUGIN_CHLORAMINES_CONCENTRATION_MEASUREMENT_CLIENT

// Use this macro to check if the client side of the Chlorine Concentration Measurement cluster is included
#define ZCL_USING_CHLORINE_CONCENTRATION_MEASUREMENT_CLUSTER_CLIENT
#define EMBER_AF_PLUGIN_CHLORINE_CONCENTRATION_MEASUREMENT_CLIENT

// Use this macro to check if the client side of the Fecal coliform & E. Coli Concentration Measurement cluster is included
#define ZCL_USING_FECAL_COLIFORM_CONCENTRATION_MEASUREMENT_CLUSTER_CLIENT
#define EMBER_AF_PLUGIN_FECAL_COLIFORM_E_COLI_CONCENTRATION_MEASUREMENT_CLIENT

// Use this macro to check if the client side of the Fluoride Concentration Measurement cluster is included
#define ZCL_USING_FLUORIDE_CONCENTRATION_MEASUREMENT_CLUSTER_CLIENT
#define EMBER_AF_PLUGIN_FLUORIDE_CONCENTRATION_MEASUREMENT_CLIENT

// Use this macro to check if the client side of the Haloacetic Acids Concentration Measurement cluster is included
#define ZCL_USING_HALOACETIC_ACIDS_CONCENTRATION_MEASUREMENT_CLUSTER_CLIENT
#define EMBER_AF_PLUGIN_HALOACETIC_ACIDS_CONCENTRATION_MEASUREMENT_CLIENT

// Use this macro to check if the client side of the Total Trihalomethanes Concentration Measurement cluster is included
#define ZCL_USING_TOTAL_TRIHALOMETHANES_CONCENTRATION_MEASUREMENT_CLUSTER_CLIENT
#define EMBER_AF_PLUGIN_TOTAL_TRIHALOMETHANES_CONCENTRATION_MEASUREMENT_CLIENT

// Use this macro to check if the client side of the Total Coliform Bacteria Concentration Measurement cluster is included
#define ZCL_USING_TOTAL_COLIFORM_BACTERIA_CONCENTRATION_MEASUREMENT_CLUSTER_CLIENT
#define EMBER_AF_PLUGIN_TOTAL_COLIFORM_BACTERIA_CONCENTRATION_MEASUREMENT_CLIENT

// Use this macro to check if the client side of the Turbidity Concentration Measurement cluster is included
#define ZCL_USING_TURBIDITY_CONCENTRATION_MEASUREMENT_CLUSTER_CLIENT
#define EMBER_AF_PLUGIN_TURBIDITY_CONCENTRATION_MEASUREMENT_CLIENT

// Use this macro to check if the client side of the Copper Concentration Measurement cluster is included
#define ZCL_USING_COPPER_CONCENTRATION_MEASUREMENT_CLUSTER_CLIENT
#define EMBER_AF_PLUGIN_COPPER_CONCENTRATION_MEASUREMENT_CLIENT

// Use this macro to check if the client side of the Lead Concentration Measurement cluster is included
#define ZCL_USING_LEAD_CONCENTRATION_MEASUREMENT_CLUSTER_CLIENT
#define EMBER_AF_PLUGIN_LEAD_CONCENTRATION_MEASUREMENT_CLIENT

// Use this macro to check if the client side of the Manganese Concentration Measurement cluster is included
#define ZCL_USING_MANGANESE_CONCENTRATION_MEASUREMENT_CLUSTER_CLIENT
#define EMBER_AF_PLUGIN_MANGANESE_CONCENTRATION_MEASUREMENT_CLIENT

// Use this macro to check if the client side of the Sulfate Concentration Measurement cluster is included
#define ZCL_USING_SULFATE_CONCENTRATION_MEASUREMENT_CLUSTER_CLIENT
#define EMBER_AF_PLUGIN_SULFATE_CONCENTRATION_MEASUREMENT_CLIENT

// Use this macro to check if the client side of the Bromodichloromethane Concentration Measurement cluster is included
#define ZCL_USING_BROMODICHLOROMETHANE_CONCENTRATION_MEASUREMENT_CLUSTER_CLIENT
#define EMBER_AF_PLUGIN_BROMODICHLOROMETHANE_CONCENTRATION_MEASUREMENT_CLIENT

// Use this macro to check if the client side of the Bromoform Concentration Measurement cluster is included
#define ZCL_USING_BROMOFORM_CONCENTRATION_MEASUREMENT_CLUSTER_CLIENT
#define EMBER_AF_PLUGIN_BROMOFORM_CONCENTRATION_MEASUREMENT_CLIENT

// Use this macro to check if the client side of the Chlorodibromomethane Concentration Measurement cluster is included
#define ZCL_USING_CHLORODIBROMOMETHANE_CONCENTRATION_MEASUREMENT_CLUSTER_CLIENT
#define EMBER_AF_PLUGIN_CHLORODIBROMOMETHANE_CONCENTRATION_MEASUREMENT_CLIENT

// Use this macro to check if the client side of the Chloroform Concentration Measurement cluster is included
#define ZCL_USING_CHLOROFORM_CONCENTRATION_MEASUREMENT_CLUSTER_CLIENT
#define EMBER_AF_PLUGIN_CHLOROFORM_CONCENTRATION_MEASUREMENT_CLIENT

// Use this macro to check if the client side of the Sodium Concentration Measurement cluster is included
#define ZCL_USING_SODIUM_CONCENTRATION_MEASUREMENT_CLUSTER_CLIENT
#define EMBER_AF_PLUGIN_SODIUM_CONCENTRATION_MEASUREMENT_CLIENT
...
#define EMBER_AF_PLUGIN_PM2__5_CONCENTRATION_MEASUREMENT_CLIENT
...
#define EMBER_AF_PLUGIN_FORMALDEHYDE_CONCENTRATION_MEASUREMENT_CLIENT
...
#define EMBER_AF_PLUGIN_PM1_CONCENTRATION_MEASUREMENT_CLIENT
...
#define EMBER_AF_PLUGIN_PM10_CONCENTRATION_MEASUREMENT_CLIENT
...
#define ZCL_USING_VOC_CONCENTRATION_MEASUREMENT_CLUSTER_CLIENT
#define EMBER_AF_PLUGIN_TOTAL_VOLATILE_ORGANIC_COMPOUNDS_CONCENTRATION_MEASUREMENT_CLIENT
...
#define EMBER_AF_PLUGIN_RADON_CONCENTRATION_MEASUREMENT_CLIENT
