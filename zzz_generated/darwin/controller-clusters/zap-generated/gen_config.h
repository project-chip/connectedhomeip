...
#define EMBER_AF_TEMPERATURE_CONTROL_CLUSTER_CLIENT_ENDPOINT_COUNT (1)
#define EMBER_AF_REFRIGERATOR_ALARM_CLUSTER_CLIENT_ENDPOINT_COUNT (1)
#define EMBER_AF_OPERATIONAL_STATE_DISHWASHER_CLUSTER_CLIENT_ENDPOINT_COUNT (1)
#define EMBER_AF_OPERATIONAL_STATE_CLUSTER_CLIENT_ENDPOINT_COUNT (1)
#define EMBER_AF_OPERATIONAL_STATE_RVC_CLUSTER_CLIENT_ENDPOINT_COUNT (1)
...
#define EMBER_AF_PLUGIN_TEMPERATURE_CONTROL_CLIENT
...
// Use this macro to check if the client side of the Dishwasher Operational State cluster is included
#define ZCL_USING_OPERATIONAL_STATE_DISHWASHER_CLUSTER_CLIENT
#define EMBER_AF_PLUGIN_DISHWASHER_OPERATIONAL_STATE_CLIENT
...
#define EMBER_AF_PLUGIN_OPERATIONAL_STATE_CLIENT

// Use this macro to check if the client side of the Robotic Vacuum Operational State cluster is included
#define ZCL_USING_OPERATIONAL_STATE_RVC_CLUSTER_CLIENT
#define EMBER_AF_PLUGIN_ROBOTIC_VACUUM_OPERATIONAL_STATE_CLIENT
