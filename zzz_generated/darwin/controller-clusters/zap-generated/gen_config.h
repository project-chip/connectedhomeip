...
#define EMBER_AF_LAUNDRY_WASHER_MODE_SELECT_CLUSTER_CLIENT_ENDPOINT_COUNT (1)
#define EMBER_AF_REFRIGERATOR_AND_TEMPERATURE_CONTROLLED_CABINET_MODE_SELECT_CLUSTER_CLIENT_ENDPOINT_COUNT (1)
#define EMBER_AF_RVC_RUN_MODE_SELECT_CLUSTER_CLIENT_ENDPOINT_COUNT (1)
#define EMBER_AF_RVC_CLEAN_MODE_SELECT_CLUSTER_CLIENT_ENDPOINT_COUNT (1)
#define EMBER_AF_DISHWASHER_MODE_SELECT_CLUSTER_CLIENT_ENDPOINT_COUNT (1)
...
// Use this macro to check if the client side of the Laundry Washer Mode Select cluster is included
#define ZCL_USING_LAUNDRY_WASHER_MODE_SELECT_CLUSTER_CLIENT
#define EMBER_AF_PLUGIN_LAUNDRY_WASHER_MODE_SELECT_CLIENT

// Use this macro to check if the client side of the Refrigerator And Temperature Controlled Cabinet Mode Select cluster is included
#define ZCL_USING_REFRIGERATOR_AND_TEMPERATURE_CONTROLLED_CABINET_MODE_SELECT_CLUSTER_CLIENT
#define EMBER_AF_PLUGIN_REFRIGERATOR_AND_TEMPERATURE_CONTROLLED_CABINET_MODE_SELECT_CLIENT

// Use this macro to check if the client side of the RVC Run Mode Select cluster is included
#define ZCL_USING_RVC_RUN_MODE_SELECT_CLUSTER_CLIENT
#define EMBER_AF_PLUGIN_RVC_RUN_MODE_SELECT_CLIENT

// Use this macro to check if the client side of the RVC Clean Mode Select cluster is included
#define ZCL_USING_RVC_CLEAN_MODE_SELECT_CLUSTER_CLIENT
#define EMBER_AF_PLUGIN_RVC_CLEAN_MODE_SELECT_CLIENT

// Use this macro to check if the client side of the Dishwasher Mode Select cluster is included
#define ZCL_USING_DISHWASHER_MODE_SELECT_CLUSTER_CLIENT
#define EMBER_AF_PLUGIN_DISHWASHER_MODE_SELECT_CLIENT
