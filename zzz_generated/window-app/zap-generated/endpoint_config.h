    ...
    {                                                                                                                              \
        { 0x0028,                                                                                                                  \
          ...
          chipFuncArrayBasicServer }, /* Endpoint: 0, Cluster: Basic (server) */                                                   \
            ...
            {                                                                                                                      \
                0x0102, ZAP_ATTRIBUTE_INDEX(120), 19, 31, ZAP_CLUSTER_MASK(SERVER), NULL                                           \
            }, /* Endpoint: 1, Cluster: Window Covering (server) */                                                                \
            {                                                                                                                      \
                0x0102, ZAP_ATTRIBUTE_INDEX(139), 19, 31, ZAP_CLUSTER_MASK(SERVER), NULL                                           \
            }, /* Endpoint: 2, Cluster: Window Covering (server) */                                                                \
    }
...
#define GENERATED_ENDPOINT_TYPES                                                                                                   \
    {                                                                                                                              \
        { ZAP_CLUSTER_INDEX(0), 10, 2415 }, { ZAP_CLUSTER_INDEX(10), 1, 31 }, { ZAP_CLUSTER_INDEX(11), 1, 31 },                    \
    }
...
#define ATTRIBUTE_MAX_SIZE (2477)
