...
void DispatchServerCommand(CommandHandler * apCommandObj, CommandId aCommandId, EndpointId aEndpointId, TLV::TLVReader & aDataTlv)
{
    ...
    bool wasHandled              = false;
    {
        ...
        case Commands::DownOrClose::Id: {
            ...
            ConcreteCommandPath path(aEndpointId, WindowCovering::Id, Commands::DownOrClose::Id);
            wasHandled = emberAfWindowCoveringClusterDownOrCloseCallback(apCommandObj, path, aEndpointId, fieldStruct);
            break;
        }
        case Commands::GoToLiftPercentage::Id: {
            Commands::GoToLiftPercentage::DecodableType fieldStruct;
            expectArgumentCount = 2;
            ...
            if (CHIP_NO_ERROR == TLVError && CHIP_NO_ERROR == TLVUnpackError && 2 == validArgumentCount)
            {
                ConcreteCommandPath path(aEndpointId, WindowCovering::Id, Commands::GoToLiftPercentage::Id);
                wasHandled = emberAfWindowCoveringClusterGoToLiftPercentageCallback(
                    apCommandObj, path, aEndpointId, liftPercentageValue, liftPercent100thsValue, fieldStruct);
            }
            break;
        }
        case Commands::GoToLiftValue::Id: {
            Commands::GoToLiftValue::DecodableType fieldStruct;
            expectArgumentCount = 1;
            uint16_t liftValue;
            bool argExists[1];
            ...
            if (CHIP_NO_ERROR == TLVError && CHIP_NO_ERROR == TLVUnpackError && 1 == validArgumentCount)
            {
                ConcreteCommandPath path(aEndpointId, WindowCovering::Id, Commands::GoToLiftValue::Id);
                wasHandled =
                    emberAfWindowCoveringClusterGoToLiftValueCallback(apCommandObj, path, aEndpointId, liftValue, fieldStruct);
            }
            break;
        }
        case Commands::GoToTiltPercentage::Id: {
            Commands::GoToTiltPercentage::DecodableType fieldStruct;
            expectArgumentCount = 2;
            ...
            if (CHIP_NO_ERROR == TLVError && CHIP_NO_ERROR == TLVUnpackError && 2 == validArgumentCount)
            {
                ConcreteCommandPath path(aEndpointId, WindowCovering::Id, Commands::GoToTiltPercentage::Id);
                wasHandled = emberAfWindowCoveringClusterGoToTiltPercentageCallback(
                    apCommandObj, path, aEndpointId, tiltPercentageValue, tiltPercent100thsValue, fieldStruct);
            }
            break;
        }
        case Commands::GoToTiltValue::Id: {
            Commands::GoToTiltValue::DecodableType fieldStruct;
            expectArgumentCount = 1;
            uint16_t tiltValue;
            bool argExists[1];
            ...
            if (CHIP_NO_ERROR == TLVError && CHIP_NO_ERROR == TLVUnpackError && 1 == validArgumentCount)
            {
                ConcreteCommandPath path(aEndpointId, WindowCovering::Id, Commands::GoToTiltValue::Id);
                wasHandled =
                    emberAfWindowCoveringClusterGoToTiltValueCallback(apCommandObj, path, aEndpointId, tiltValue, fieldStruct);
            }
            break;
        }
        case Commands::StopMotion::Id: {
            ...
            ConcreteCommandPath path(aEndpointId, WindowCovering::Id, Commands::StopMotion::Id);
            wasHandled = emberAfWindowCoveringClusterStopMotionCallback(apCommandObj, path, aEndpointId, fieldStruct);
            break;
        }
        case Commands::UpOrOpen::Id: {
            Commands::UpOrOpen::DecodableType fieldStruct;

            ConcreteCommandPath path(aEndpointId, WindowCovering::Id, Commands::UpOrOpen::Id);
            wasHandled = emberAfWindowCoveringClusterUpOrOpenCallback(apCommandObj, path, aEndpointId, fieldStruct);
            break;
        }
        default: {
            // Unrecognized command ID, error status will apply.
