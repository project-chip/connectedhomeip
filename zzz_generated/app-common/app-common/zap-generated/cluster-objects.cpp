...
CHIP_ERROR TypeInfo::DecodableType::Decode(TLV::TLVReader & reader, const ConcreteAttributePath & path)
{
    switch (path.mAttributeId)
    {
    case Attributes::AvailableOptionsForCurrentMode::TypeInfo::GetAttributeId():
        ReturnErrorOnFailure(DataModel::Decode(reader, availableOptionsForCurrentMode));
        break;
    case Attributes::SteamWash::TypeInfo::GetAttributeId():
        ReturnErrorOnFailure(DataModel::Decode(reader, steamWash));
        break;
    case Attributes::HeatedDry::TypeInfo::GetAttributeId():
        ReturnErrorOnFailure(DataModel::Decode(reader, heatedDry));
        break;
    case Attributes::ExtendedDry::TypeInfo::GetAttributeId():
        ReturnErrorOnFailure(DataModel::Decode(reader, extendedDry));
        break;
    case Attributes::GeneratedCommandList::TypeInfo::GetAttributeId():
        ReturnErrorOnFailure(DataModel::Decode(reader, generatedCommandList));
        break;
