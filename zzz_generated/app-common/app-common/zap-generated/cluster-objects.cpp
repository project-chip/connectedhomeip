...
namespace SpinSpeedIndex {
CHIP_ERROR Type::Encode(TLV::TLVWriter & writer, TLV::Tag tag) const
{
    TLV::TLVType outer;
    ReturnErrorOnFailure(writer.StartContainer(tag, TLV::kTLVType_Structure, outer));
    ReturnErrorOnFailure(DataModel::Encode(writer, TLV::ContextTag(Fields::kWasherControlsID), washerControlsID));
    ReturnErrorOnFailure(DataModel::Encode(writer, TLV::ContextTag(Fields::kWasherControlsLabel), washerControlsLabel));
    ReturnErrorOnFailure(writer.EndContainer(outer));
    return CHIP_NO_ERROR;
}
...
CHIP_ERROR DecodableType::Decode(TLV::TLVReader & reader)
{
    ...
    while ((err = reader.Next()) == CHIP_NO_ERROR)
    {
        ...
        switch (TLV::TagNumFromTag(reader.GetTag()))
        {
        case to_underlying(Fields::kWasherControlsID):
            ReturnErrorOnFailure(DataModel::Decode(reader, washerControlsID));
            break;
        case to_underlying(Fields::kWasherControlsLabel):
            ReturnErrorOnFailure(DataModel::Decode(reader, washerControlsLabel));
            break;
        default:
            break;
        }
...
namespace WasherControlCommandResponse {
CHIP_ERROR Type::Encode(TLV::TLVWriter & writer, TLV::Tag tag) const
{
    TLV::TLVType outer;
    ReturnErrorOnFailure(writer.StartContainer(tag, TLV::kTLVType_Structure, outer));
