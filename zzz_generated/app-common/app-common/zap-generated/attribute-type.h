...
enum
{
    ...
    ZCL_POWER_MVA_ATTRIBUTE_TYPE         = 0xD6, // Apparent Power
    ZCL_POWER_MVAR_ATTRIBUTE_TYPE        = 0xD7, // Reactive Power
    ZCL_TEMPERATURE_ATTRIBUTE_TYPE       = 0xD8, // Temperature
    ZCL_POWER_MW_ATTRIBUTE_TYPE          = 0xD9, // Power
    ZCL_AMPERAGE_MA_ATTRIBUTE_TYPE       = 0xDA, // Amperage
    ZCL_VOLTAGE_MV_ATTRIBUTE_TYPE        = 0xDB, // Voltage
    ZCL_ENERGY_MWH_ATTRIBUTE_TYPE        = 0xDC, // Energy
    ZCL_ENERGY_MVAH_ATTRIBUTE_TYPE       = 0xDD, // Apparent Energy
    ZCL_ENERGY_MVARH_ATTRIBUTE_TYPE      = 0xDE, // Reactive Energy
