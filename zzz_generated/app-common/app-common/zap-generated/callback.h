...
#define MATTER_DM_IDENTIFY_CLUSTER_LABEL Identify
#define MATTER_DM_GROUPS_CLUSTER_LABEL Groups
#define MATTER_DM_ON_OFF_CLUSTER_LABEL OnOff
#define MATTER_DM_ON_OFF_SWITCH_CONFIGURATION_CLUSTER_LABEL OnOffSwitchConfiguration
#define MATTER_DM_LEVEL_CONTROL_CLUSTER_LABEL LevelControl
#define MATTER_DM_BINARY_INPUT_BASIC_CLUSTER_LABEL BinaryInputBasic
#define MATTER_DM_PWM_CLUSTER_LABEL PulseWidthModulation
#define MATTER_DM_DESCRIPTOR_CLUSTER_LABEL Descriptor
#define MATTER_DM_BINDING_CLUSTER_LABEL Binding
#define MATTER_DM_ACCESS_CONTROL_CLUSTER_LABEL AccessControl
#define MATTER_DM_ACTIONS_CLUSTER_LABEL Actions
#define MATTER_DM_BASIC_INFORMATION_CLUSTER_LABEL BasicInformation
#define MATTER_DM_OTA_SOFTWARE_UPDATE_PROVIDER_CLUSTER_LABEL OtaSoftwareUpdateProvider
#define MATTER_DM_OTA_SOFTWARE_UPDATE_REQUESTOR_CLUSTER_LABEL OtaSoftwareUpdateRequestor
#define MATTER_DM_LOCALIZATION_CONFIGURATION_CLUSTER_LABEL LocalizationConfiguration
#define MATTER_DM_TIME_FORMAT_LOCALIZATION_CLUSTER_LABEL TimeFormatLocalization
#define MATTER_DM_UNIT_LOCALIZATION_CLUSTER_LABEL UnitLocalization
#define MATTER_DM_POWER_SOURCE_CONFIGURATION_CLUSTER_LABEL PowerSourceConfiguration
#define MATTER_DM_POWER_SOURCE_CLUSTER_LABEL PowerSource
#define MATTER_DM_GENERAL_COMMISSIONING_CLUSTER_LABEL GeneralCommissioning
#define MATTER_DM_NETWORK_COMMISSIONING_CLUSTER_LABEL NetworkCommissioning
#define MATTER_DM_DIAGNOSTIC_LOGS_CLUSTER_LABEL DiagnosticLogs
#define MATTER_DM_GENERAL_DIAGNOSTICS_CLUSTER_LABEL GeneralDiagnostics
#define MATTER_DM_SOFTWARE_DIAGNOSTICS_CLUSTER_LABEL SoftwareDiagnostics
#define MATTER_DM_THREAD_NETWORK_DIAGNOSTICS_CLUSTER_LABEL ThreadNetworkDiagnostics
#define MATTER_DM_WIFI_NETWORK_DIAGNOSTICS_CLUSTER_LABEL WiFiNetworkDiagnostics
#define MATTER_DM_ETHERNET_NETWORK_DIAGNOSTICS_CLUSTER_LABEL EthernetNetworkDiagnostics
#define MATTER_DM_TIME_SYNCHRONIZATION_CLUSTER_LABEL TimeSynchronization
#define MATTER_DM_BRIDGED_DEVICE_BASIC_INFORMATION_CLUSTER_LABEL BridgedDeviceBasicInformation
#define MATTER_DM_SWITCH_CLUSTER_LABEL Switch
#define MATTER_DM_ADMINISTRATOR_COMMISSIONING_CLUSTER_LABEL AdministratorCommissioning
#define MATTER_DM_OPERATIONAL_CREDENTIALS_CLUSTER_LABEL OperationalCredentials
#define MATTER_DM_GROUP_KEY_MANAGEMENT_CLUSTER_LABEL GroupKeyManagement
#define MATTER_DM_FIXED_LABEL_CLUSTER_LABEL FixedLabel
#define MATTER_DM_USER_LABEL_CLUSTER_LABEL UserLabel
#define MATTER_DM_PROXY_CONFIGURATION_CLUSTER_LABEL ProxyConfiguration
#define MATTER_DM_PROXY_DISCOVERY_CLUSTER_LABEL ProxyDiscovery
#define MATTER_DM_PROXY_VALID_CLUSTER_LABEL ProxyValid
#define MATTER_DM_BOOLEAN_STATE_CLUSTER_LABEL BooleanState
#define MATTER_DM_ICD_MANAGEMENT_CLUSTER_LABEL IcdManagement
#define MATTER_DM_TIMER_CLUSTER_LABEL Timer
#define MATTER_DM_OPERATIONAL_STATE_OVEN_CLUSTER_LABEL OvenCavityOperationalState
#define MATTER_DM_OVEN_MODE_CLUSTER_LABEL OvenMode
#define MATTER_DM_LAUNDRY_DRYER_CONTROLS_CLUSTER_LABEL LaundryDryerControls
#define MATTER_DM_MODE_SELECT_CLUSTER_LABEL ModeSelect
#define MATTER_DM_LAUNDRY_WASHER_MODE_CLUSTER_LABEL LaundryWasherMode
#define MATTER_DM_REFRIGERATOR_AND_TEMPERATURE_CONTROLLED_CABINET_MODE_CLUSTER_LABEL RefrigeratorAndTemperatureControlledCabinetMode
#define MATTER_DM_LAUNDRY_WASHER_CONTROLS_CLUSTER_LABEL LaundryWasherControls
#define MATTER_DM_RVC_RUN_MODE_CLUSTER_LABEL RvcRunMode
#define MATTER_DM_RVC_CLEAN_MODE_CLUSTER_LABEL RvcCleanMode
#define MATTER_DM_TEMPERATURE_CONTROL_CLUSTER_LABEL TemperatureControl
#define MATTER_DM_REFRIGERATOR_ALARM_CLUSTER_LABEL RefrigeratorAlarm
#define MATTER_DM_DISHWASHER_MODE_CLUSTER_LABEL DishwasherMode
#define MATTER_DM_AIR_QUALITY_CLUSTER_LABEL AirQuality
#define MATTER_DM_SMOKE_CO_ALARM_CLUSTER_LABEL SmokeCoAlarm
#define MATTER_DM_DISHWASHER_ALARM_CLUSTER_LABEL DishwasherAlarm
#define MATTER_DM_MICROWAVE_OVEN_MODE_CLUSTER_LABEL MicrowaveOvenMode
#define MATTER_DM_MICROWAVE_OVEN_CONTROL_CLUSTER_LABEL MicrowaveOvenControl
#define MATTER_DM_OPERATIONAL_STATE_CLUSTER_LABEL OperationalState
#define MATTER_DM_OPERATIONAL_STATE_RVC_CLUSTER_LABEL RvcOperationalState
#define MATTER_DM_SCENES_CLUSTER_LABEL ScenesManagement
#define MATTER_DM_HEPA_FILTER_MONITORING_CLUSTER_LABEL HepaFilterMonitoring
#define MATTER_DM_ACTIVATED_CARBON_FILTER_MONITORING_CLUSTER_LABEL ActivatedCarbonFilterMonitoring
#define MATTER_DM_BOOLEAN_STATE_CONFIGURATION_CLUSTER_LABEL BooleanStateConfiguration
#define MATTER_DM_VALVE_CONFIGURATION_AND_CONTROL_CLUSTER_LABEL ValveConfigurationAndControl
#define MATTER_DM_ELECTRICAL_POWER_MEASUREMENT_CLUSTER_LABEL ElectricalPowerMeasurement
#define MATTER_DM_ELECTRICAL_ENERGY_MEASUREMENT_CLUSTER_LABEL ElectricalEnergyMeasurement
#define MATTER_DM_DEMAND_RESPONSE_LOAD_CONTROL_CLUSTER_LABEL DemandResponseLoadControl
#define MATTER_DM_MESSAGES_CLUSTER_LABEL Messages
#define MATTER_DM_DEVICE_ENERGY_MANAGEMENT_CLUSTER_LABEL DeviceEnergyManagement
#define MATTER_DM_ENERGY_EVSE_CLUSTER_LABEL EnergyEvse
#define MATTER_DM_ENERGY_PREFERENCE_CLUSTER_LABEL EnergyPreference
#define MATTER_DM_POWER_TOPOLOGY_CLUSTER_LABEL PowerTopology
#define MATTER_DM_ENERGY_EVSE_MODE_CLUSTER_LABEL EnergyEvseMode
#define MATTER_DM_DEVICE_ENERGY_MANAGEMENT_MODE_CLUSTER_LABEL DeviceEnergyManagementMode
#define MATTER_DM_DOOR_LOCK_CLUSTER_LABEL DoorLock
#define MATTER_DM_WINDOW_COVERING_CLUSTER_LABEL WindowCovering
#define MATTER_DM_BARRIER_CONTROL_CLUSTER_LABEL BarrierControl
#define MATTER_DM_PUMP_CONFIGURATION_AND_CONTROL_CLUSTER_LABEL PumpConfigurationAndControl
#define MATTER_DM_THERMOSTAT_CLUSTER_LABEL Thermostat
#define MATTER_DM_FAN_CONTROL_CLUSTER_LABEL FanControl
#define MATTER_DM_THERMOSTAT_USER_INTERFACE_CONFIGURATION_CLUSTER_LABEL ThermostatUserInterfaceConfiguration
#define MATTER_DM_COLOR_CONTROL_CLUSTER_LABEL ColorControl
#define MATTER_DM_BALLAST_CONFIGURATION_CLUSTER_LABEL BallastConfiguration
#define MATTER_DM_ILLUMINANCE_MEASUREMENT_CLUSTER_LABEL IlluminanceMeasurement
#define MATTER_DM_TEMPERATURE_MEASUREMENT_CLUSTER_LABEL TemperatureMeasurement
#define MATTER_DM_PRESSURE_MEASUREMENT_CLUSTER_LABEL PressureMeasurement
#define MATTER_DM_FLOW_MEASUREMENT_CLUSTER_LABEL FlowMeasurement
#define MATTER_DM_RELATIVE_HUMIDITY_MEASUREMENT_CLUSTER_LABEL RelativeHumidityMeasurement
#define MATTER_DM_OCCUPANCY_SENSING_CLUSTER_LABEL OccupancySensing
#define MATTER_DM_CARBON_MONOXIDE_CONCENTRATION_MEASUREMENT_CLUSTER_LABEL CarbonMonoxideConcentrationMeasurement
#define MATTER_DM_CARBON_DIOXIDE_CONCENTRATION_MEASUREMENT_CLUSTER_LABEL CarbonDioxideConcentrationMeasurement
#define MATTER_DM_NITROGEN_DIOXIDE_CONCENTRATION_MEASUREMENT_CLUSTER_LABEL NitrogenDioxideConcentrationMeasurement
#define MATTER_DM_OZONE_CONCENTRATION_MEASUREMENT_CLUSTER_LABEL OzoneConcentrationMeasurement
#define MATTER_DM_PM2_5_CONCENTRATION_MEASUREMENT_CLUSTER_LABEL Pm25ConcentrationMeasurement
#define MATTER_DM_FORMALDEHYDE_CONCENTRATION_MEASUREMENT_CLUSTER_LABEL FormaldehydeConcentrationMeasurement
#define MATTER_DM_PM1_CONCENTRATION_MEASUREMENT_CLUSTER_LABEL Pm1ConcentrationMeasurement
#define MATTER_DM_PM10_CONCENTRATION_MEASUREMENT_CLUSTER_LABEL Pm10ConcentrationMeasurement
#define MATTER_DM_TVOC_CONCENTRATION_MEASUREMENT_CLUSTER_LABEL TotalVolatileOrganicCompoundsConcentrationMeasurement
#define MATTER_DM_RADON_CONCENTRATION_MEASUREMENT_CLUSTER_LABEL RadonConcentrationMeasurement
#define MATTER_DM_WAKE_ON_LAN_CLUSTER_LABEL WakeOnLan
#define MATTER_DM_CHANNEL_CLUSTER_LABEL Channel
#define MATTER_DM_TARGET_NAVIGATOR_CLUSTER_LABEL TargetNavigator
#define MATTER_DM_MEDIA_PLAYBACK_CLUSTER_LABEL MediaPlayback
#define MATTER_DM_MEDIA_INPUT_CLUSTER_LABEL MediaInput
#define MATTER_DM_LOW_POWER_CLUSTER_LABEL LowPower
#define MATTER_DM_KEYPAD_INPUT_CLUSTER_LABEL KeypadInput
#define MATTER_DM_CONTENT_LAUNCHER_CLUSTER_LABEL ContentLauncher
#define MATTER_DM_AUDIO_OUTPUT_CLUSTER_LABEL AudioOutput
#define MATTER_DM_APPLICATION_LAUNCHER_CLUSTER_LABEL ApplicationLauncher
#define MATTER_DM_APPLICATION_BASIC_CLUSTER_LABEL ApplicationBasic
#define MATTER_DM_ACCOUNT_LOGIN_CLUSTER_LABEL AccountLogin
#define MATTER_DM_CONTENT_CONTROL_CLUSTER_LABEL ContentControl
#define MATTER_DM_CONTENT_APP_OBSERVER_CLUSTER_LABEL ContentAppObserver
#define MATTER_DM_ELECTRICAL_MEASUREMENT_CLUSTER_LABEL ElectricalMeasurement
#define MATTER_DM_UNIT_TESTING_CLUSTER_LABEL UnitTesting
#define MATTER_DM_FAULT_INJECTION_CLUSTER_LABEL FaultInjection
#define MATTER_DM_SAMPLE_MEI_CLUSTER_LABEL SampleMei
