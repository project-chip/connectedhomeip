...
{
    return emberAfReadServerAttribute(endpoint, ModeSelectCluster::Id, CurrentMode::Id, (uint8_t *) currentMode,
                                      sizeof(*currentMode));
}
EmberAfStatus Set(chip::EndpointId endpoint, uint8_t currentMode)
{
    return emberAfWriteServerAttribute(endpoint, ModeSelectCluster::Id, CurrentMode::Id, (uint8_t *) &currentMode,
                                       ZCL_INT8U_ATTRIBUTE_TYPE);
}
...
{
    return emberAfReadServerAttribute(endpoint, ModeSelectCluster::Id, OnMode::Id, (uint8_t *) onMode, sizeof(*onMode));
}
EmberAfStatus Set(chip::EndpointId endpoint, uint8_t onMode)
{
    return emberAfWriteServerAttribute(endpoint, ModeSelectCluster::Id, OnMode::Id, (uint8_t *) &onMode, ZCL_INT8U_ATTRIBUTE_TYPE);
}
...
{
    return emberAfReadServerAttribute(endpoint, ModeSelectCluster::Id, StartUpMode::Id, (uint8_t *) startUpMode,
                                      sizeof(*startUpMode));
}
EmberAfStatus Set(chip::EndpointId endpoint, uint8_t startUpMode)
{
    return emberAfWriteServerAttribute(endpoint, ModeSelectCluster::Id, StartUpMode::Id, (uint8_t *) &startUpMode,
                                       ZCL_INT8U_ATTRIBUTE_TYPE);
}
