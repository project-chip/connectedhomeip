...
// Enum for TimeSyncGranularity
enum EmberAfTimeSyncGranularity : uint8_t
{
    EMBER_ZCL_TIME_SYNC_GRANULARITY_NO_TIME_GRANULARITY      = 0,
    EMBER_ZCL_TIME_SYNC_GRANULARITY_MINUTES_GRANULARITY      = 1,
    EMBER_ZCL_TIME_SYNC_GRANULARITY_SECONDS_GRANULARITY      = 2,
    EMBER_ZCL_TIME_SYNC_GRANULARITY_MILLISECONDS_GRANULARITY = 3,
    EMBER_ZCL_TIME_SYNC_GRANULARITY_MICROSECONDS_GRANULARITY = 4,
};

// Enum for TimeSyncTimeSource
enum EmberAfTimeSyncTimeSource : uint8_t
{
    EMBER_ZCL_TIME_SYNC_TIME_SOURCE_NONE                = 0,
    EMBER_ZCL_TIME_SYNC_TIME_SOURCE_UNKNOWN             = 1,
    EMBER_ZCL_TIME_SYNC_TIME_SOURCE_ADMIN               = 2,
    EMBER_ZCL_TIME_SYNC_TIME_SOURCE_NODE_TIME_CLUSTER   = 3,
    EMBER_ZCL_TIME_SYNC_TIME_SOURCE_NON_FABRIC_SNTP     = 4,
    EMBER_ZCL_TIME_SYNC_TIME_SOURCE_NON_FABRIC_NTP      = 5,
    EMBER_ZCL_TIME_SYNC_TIME_SOURCE_FABRIC_SNTP         = 6,
    EMBER_ZCL_TIME_SYNC_TIME_SOURCE_FABRIC_NTP          = 7,
    EMBER_ZCL_TIME_SYNC_TIME_SOURCE_MIXED_NTP           = 8,
    EMBER_ZCL_TIME_SYNC_TIME_SOURCE_NON_FABRIC_SNTP_NTS = 9,
    EMBER_ZCL_TIME_SYNC_TIME_SOURCE_NON_FABRIC_NTP_NTS  = 10,
    EMBER_ZCL_TIME_SYNC_TIME_SOURCE_FABRIC_SNTP_NTS     = 11,
    EMBER_ZCL_TIME_SYNC_TIME_SOURCE_FABRIC_NTP_NTS      = 12,
    EMBER_ZCL_TIME_SYNC_TIME_SOURCE_MIXED_NTP_NTS       = 13,
    EMBER_ZCL_TIME_SYNC_TIME_SOURCE_CLOUD_SOURCE        = 14,
    EMBER_ZCL_TIME_SYNC_TIME_SOURCE_PTP                 = 15,
    EMBER_ZCL_TIME_SYNC_TIME_SOURCE_GNSS                = 16,
};
