...
static auto __attribute__((unused)) EnsureKnownEnumValue(ApplianceControl::ApplianceStatus val)
{
...
static auto __attribute__((unused)) EnsureKnownEnumValue(ApplianceControl::CommandIdentification val)
{
...
static auto __attribute__((unused)) EnsureKnownEnumValue(ApplianceControl::WarningEvent val)
{
...
static auto __attribute__((unused)) EnsureKnownEnumValue(Messaging::EventId val)
{
    ...
    case EnumType::kManufacturerSpecificI:
        return val;
    default:
        return static_cast<EnumType>(49);
    }
}
static auto __attribute__((unused)) EnsureKnownEnumValue(Messaging::MessagingControlConfirmation val)
{
...
static auto __attribute__((unused)) EnsureKnownEnumValue(Messaging::MessagingControlEnhancedConfirmation val)
{
...
static auto __attribute__((unused)) EnsureKnownEnumValue(Messaging::MessagingControlImportance val)
{
...
static auto __attribute__((unused)) EnsureKnownEnumValue(Messaging::MessagingControlTransmission val)
{
...
static auto __attribute__((unused)) EnsureKnownEnumValue(ApplianceEventsAndAlert::EventIdentification val)
{
