...
static auto __attribute__((unused)) EnsureKnownEnumValue(WasherControls::WasherControlsEnum val)
{
    using EnumType = WasherControls::WasherControlsEnum;
    switch (val)
    {
    case EnumType::kSpin:
    case EnumType::kRinse:
    case EnumType::kError:
        return val;
    default:
        return static_cast<EnumType>(2);
