...
namespace app {
namespace Clusters {
static auto __attribute__((unused)) EnsureKnownEnumValue(Humidistat::ModeEnum val)
{
...
static auto __attribute__((unused)) EnsureKnownEnumValue(Humidistat::SystemStateEnum val)
{
