...
{
    constexpr uint32_t kRequiredFieldsBitmap = 0 | (1 << to_underlying(Fields::kExtendedPanID)) |
        (1 << to_underlying(Fields::kNetworkName)) | (1 << to_underlying(Fields::kChannel)) |
        (1 << to_underlying(Fields::kActiveTimestamp));
    ...
    static_assert(to_underlying(Fields::kActiveTimestamp) < sizeof(kRequiredFieldsBitmap) * 8);
