...
inline constexpr DataModel::AttributeEntry kMetadataEntry(EnergyBalances::Id,
...
inline constexpr DataModel::AttributeEntry kMetadataEntry(EnergyPriorities::Id,
                                                          BitFlags<DataModel::AttributeQualityFlags>{
                                                              DataModel::AttributeQualityFlags::kListAttribute },
                                                          Access::Privilege::kView, std::nullopt);
} // namespace EnergyPriorities
namespace LowPowerModeSensitivities {
inline constexpr DataModel::AttributeEntry kMetadataEntry(LowPowerModeSensitivities::Id,
                                                          BitFlags<DataModel::AttributeQualityFlags>{
                                                              DataModel::AttributeQualityFlags::kListAttribute },
                                                          Access::Privilege::kView, std::nullopt);
} // namespace LowPowerModeSensitivities
