...
inline constexpr DataModel::AttributeEntry kMetadataEntry(TrustedRootCertificates::Id,
...
inline constexpr DataModel::AcceptedCommandEntry kMetadataEntry(SetVIDVerificationStatement::Id,
