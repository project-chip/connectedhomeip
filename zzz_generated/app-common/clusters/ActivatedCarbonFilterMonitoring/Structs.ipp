...
CHIP_ERROR DecodableType::Decode(TLV::TLVReader & reader)
{
    constexpr uint32_t kRequiredFieldsBitmap =
        0 | (1 << to_underlying(Fields::kProductIdentifierType)) | (1 << to_underlying(Fields::kProductIdentifierValue));
    static_assert(to_underlying(Fields::kProductIdentifierType) < sizeof(kRequiredFieldsBitmap) * 8);
    static_assert(to_underlying(Fields::kProductIdentifierValue) < sizeof(kRequiredFieldsBitmap) * 8);
