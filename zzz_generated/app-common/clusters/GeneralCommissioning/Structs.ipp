...
{
    constexpr uint32_t kRequiredFieldsBitmap = 0 | (1 << to_underlying(Fields::kFailSafeExpiryLengthSeconds)) |
        (1 << to_underlying(Fields::kMaxCumulativeFailsafeSeconds));
    static_assert(to_underlying(Fields::kFailSafeExpiryLengthSeconds) < sizeof(kRequiredFieldsBitmap) * 8);
    static_assert(to_underlying(Fields::kMaxCumulativeFailsafeSeconds) < sizeof(kRequiredFieldsBitmap) * 8);
