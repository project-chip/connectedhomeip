...
public:
    ...
    static constexpr ClusterId GetClusterId() { return Clusters::ThermostatMode::Id; }

    uint8_t newMode = static_cast<uint8_t>(0);

    CHIP_ERROR Encode(TLV::TLVWriter & aWriter, TLV::Tag aTag) const;

    using ResponseType = Clusters::ThermostatMode::Commands::ChangeToModeResponse::DecodableType;
