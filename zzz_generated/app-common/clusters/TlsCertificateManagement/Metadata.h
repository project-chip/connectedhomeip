...
inline constexpr DataModel::AttributeEntry kMetadataEntry(ProvisionedRootCertificates::Id,
...
inline constexpr DataModel::AcceptedCommandEntry kMetadataEntry(ProvisionRootCertificate::Id,
                                                                BitFlags<DataModel::CommandQualityFlags>{
                                                                    DataModel::CommandQualityFlags::kFabricScoped },
                                                                Access::Privilege::kAdminister);
} // namespace ProvisionRootCertificate
namespace FindRootCertificate {
inline constexpr DataModel::AcceptedCommandEntry kMetadataEntry(FindRootCertificate::Id,
                                                                BitFlags<DataModel::CommandQualityFlags>{
                                                                    DataModel::CommandQualityFlags::kFabricScoped },
                                                                Access::Privilege::kOperate);
} // namespace FindRootCertificate
namespace LookupRootCertificate {
inline constexpr DataModel::AcceptedCommandEntry kMetadataEntry(LookupRootCertificate::Id,
                                                                BitFlags<DataModel::CommandQualityFlags>{
                                                                    DataModel::CommandQualityFlags::kFabricScoped },
                                                                Access::Privilege::kOperate);
} // namespace LookupRootCertificate
namespace RemoveRootCertificate {
inline constexpr DataModel::AcceptedCommandEntry kMetadataEntry(RemoveRootCertificate::Id,
                                                                BitFlags<DataModel::CommandQualityFlags>{
                                                                    DataModel::CommandQualityFlags::kFabricScoped },
                                                                Access::Privilege::kAdminister);
} // namespace RemoveRootCertificate
...
inline constexpr DataModel::AcceptedCommandEntry kMetadataEntry(FindClientCertificate::Id,
                                                                BitFlags<DataModel::CommandQualityFlags>{
                                                                    DataModel::CommandQualityFlags::kFabricScoped },
                                                                Access::Privilege::kOperate);
} // namespace FindClientCertificate
namespace LookupClientCertificate {
inline constexpr DataModel::AcceptedCommandEntry kMetadataEntry(LookupClientCertificate::Id,
                                                                BitFlags<DataModel::CommandQualityFlags>{
                                                                    DataModel::CommandQualityFlags::kFabricScoped },
                                                                Access::Privilege::kOperate);
} // namespace LookupClientCertificate
namespace RemoveClientCertificate {
inline constexpr DataModel::AcceptedCommandEntry kMetadataEntry(RemoveClientCertificate::Id,
                                                                BitFlags<DataModel::CommandQualityFlags>{
                                                                    DataModel::CommandQualityFlags::kFabricScoped },
                                                                Access::Privilege::kAdminister);
} // namespace RemoveClientCertificate
