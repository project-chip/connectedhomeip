...
{
    constexpr uint32_t kRequiredFieldsBitmap = 0 | (1 << to_underlying(Fields::kRequestID)) |
        (1 << to_underlying(Fields::kVendorID)) | (1 << to_underlying(Fields::kProductID));
    static_assert(to_underlying(Fields::kRequestID) < sizeof(kRequiredFieldsBitmap) * 8);
...
CHIP_ERROR DecodableType::Decode(TLV::TLVReader & reader)
{
    constexpr uint32_t kRequiredFieldsBitmap =
        0 | (1 << to_underlying(Fields::kRequestID)) | (1 << to_underlying(Fields::kResponseTimeoutSeconds));
    static_assert(to_underlying(Fields::kRequestID) < sizeof(kRequiredFieldsBitmap) * 8);
    static_assert(to_underlying(Fields::kResponseTimeoutSeconds) < sizeof(kRequiredFieldsBitmap) * 8);
    detail::StructDecodeIterator __iterator(reader, kRequiredFieldsBitmap);
    while (true)
    {
        uint8_t __context_tag = 0;
