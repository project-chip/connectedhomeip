...
//
// Cluster metadata information for cluster SmokeConcentrationMeasurement (cluster code: 1076/0x434)
...
template <>
struct ClusterMetadataProvider<DataModel::AttributeEntry, Clusters::SmokeConcentrationMeasurement::Id>
{
    static constexpr std::optional<DataModel::AttributeEntry> EntryFor(AttributeId attributeId)
    {
        using namespace Clusters::SmokeConcentrationMeasurement::Attributes;
        switch (attributeId)
        {
...
template <>
struct ClusterMetadataProvider<DataModel::AcceptedCommandEntry, Clusters::SmokeConcentrationMeasurement::Id>
{
    static constexpr std::optional<DataModel::AcceptedCommandEntry> EntryFor(CommandId commandId)
    {
        using namespace Clusters::SmokeConcentrationMeasurement::Commands;
        switch (commandId)
        {
