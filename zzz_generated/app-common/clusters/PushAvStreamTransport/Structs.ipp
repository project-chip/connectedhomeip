...
CHIP_ERROR Type::Encode(TLV::TLVWriter & aWriter, TLV::Tag aTag) const
{
    ...
    encoder.Encode(to_underlying(Fields::kSchemeURI), schemeURI);
...
CHIP_ERROR DecodableType::Decode(TLV::TLVReader & reader)
{
    ...
    while (true)
    {
        ...
        else if (__context_tag == to_underlying(Fields::kSchemeURI))
        {
            err = DataModel::Decode(reader, schemeURI);
        }
...
CHIP_ERROR Type::Encode(TLV::TLVWriter & aWriter, TLV::Tag aTag) const
{
    ...
    encoder.Encode(to_underlying(Fields::kHLSEncryption), HLSEncryption);
    return encoder.Finalize();
}
...
CHIP_ERROR DecodableType::Decode(TLV::TLVReader & reader)
{
    ...
    while (true)
    {
        ...
        else if (__context_tag == to_underlying(Fields::kHLSEncryption))
        {
            err = DataModel::Decode(reader, HLSEncryption);
        }
