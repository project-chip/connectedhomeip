...
inline constexpr DataModel::AttributeEntry kMetadataEntry(ActiveMessageIDs::Id,
...
inline constexpr DataModel::AcceptedCommandEntry kMetadataEntry(PresentMessagesRequest::Id,
                                                                BitFlags<DataModel::CommandQualityFlags>{
                                                                    DataModel::CommandQualityFlags::kFabricScoped },
                                                                Access::Privilege::kOperate);
} // namespace PresentMessagesRequest
namespace CancelMessagesRequest {
inline constexpr DataModel::AcceptedCommandEntry kMetadataEntry(CancelMessagesRequest::Id,
                                                                BitFlags<DataModel::CommandQualityFlags>{
                                                                    DataModel::CommandQualityFlags::kFabricScoped },
                                                                Access::Privilege::kOperate);
} // namespace CancelMessagesRequest
