...
{
    constexpr uint32_t kRequiredFieldsBitmap = 0 | (1 << to_underlying(Fields::kIdentifyTime));
    static_assert(to_underlying(Fields::kIdentifyTime) < sizeof(kRequiredFieldsBitmap) * 8);
