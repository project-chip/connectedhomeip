...
{
    constexpr uint32_t kRequiredFieldsBitmap = 0 | (1 << to_underlying(Fields::kChimeID)) | (1 << to_underlying(Fields::kName));
    static_assert(to_underlying(Fields::kChimeID) < sizeof(kRequiredFieldsBitmap) * 8);
