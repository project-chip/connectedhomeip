...
{
    constexpr uint32_t kRequiredFieldsBitmap = 0 | (1 << to_underlying(Fields::kActionID));
...
CHIP_ERROR DecodableType::Decode(TLV::TLVReader & reader)
{
    constexpr uint32_t kRequiredFieldsBitmap =
        0 | (1 << to_underlying(Fields::kActionID)) | (1 << to_underlying(Fields::kTransitionTime));
    static_assert(to_underlying(Fields::kActionID) < sizeof(kRequiredFieldsBitmap) * 8);
...
{
    constexpr uint32_t kRequiredFieldsBitmap =
        0 | (1 << to_underlying(Fields::kActionID)) | (1 << to_underlying(Fields::kDuration));
    static_assert(to_underlying(Fields::kActionID) < sizeof(kRequiredFieldsBitmap) * 8);
