...
inline constexpr DataModel::AttributeEntry kMetadataEntry(FabricSceneInfo::Id,
...
inline constexpr DataModel::AcceptedCommandEntry kMetadataEntry(GetSceneMembership::Id,
