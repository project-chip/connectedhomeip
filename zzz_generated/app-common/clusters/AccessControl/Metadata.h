...
inline constexpr DataModel::AttributeEntry kMetadataEntry(CommissioningARL::Id,
...
inline constexpr DataModel::AcceptedCommandEntry kMetadataEntry(ReviewFabricRestrictions::Id,
