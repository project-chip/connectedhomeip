...
inline constexpr DataModel::AttributeEntry kMetadataEntry(ListOctetString::Id,
                                                          BitFlags<DataModel::AttributeQualityFlags>{
                                                              DataModel::AttributeQualityFlags::kListAttribute },
                                                          Access::Privilege::kView, Access::Privilege::kOperate);
} // namespace ListOctetString
namespace ListStructOctetString {
inline constexpr DataModel::AttributeEntry kMetadataEntry(ListStructOctetString::Id,
                                                          BitFlags<DataModel::AttributeQualityFlags>{
                                                              DataModel::AttributeQualityFlags::kListAttribute },
                                                          Access::Privilege::kView, Access::Privilege::kOperate);
} // namespace ListStructOctetString
...
inline constexpr DataModel::AttributeEntry kMetadataEntry(ListLongOctetString::Id,
                                                          BitFlags<DataModel::AttributeQualityFlags>{
                                                              DataModel::AttributeQualityFlags::kListAttribute },
                                                          Access::Privilege::kView, Access::Privilege::kOperate);
} // namespace ListLongOctetString
namespace ListFabricScoped {
inline constexpr DataModel::AttributeEntry kMetadataEntry(ListFabricScoped::Id,
                                                          BitFlags<DataModel::AttributeQualityFlags>{
                                                              DataModel::AttributeQualityFlags::kListAttribute },
                                                          Access::Privilege::kView, Access::Privilege::kOperate);
} // namespace ListFabricScoped
