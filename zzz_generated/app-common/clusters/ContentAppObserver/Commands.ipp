...
{
    constexpr uint32_t kRequiredFieldsBitmap = 0 | (1 << to_underlying(Fields::kEncodingHint));
    static_assert(to_underlying(Fields::kEncodingHint) < sizeof(kRequiredFieldsBitmap) * 8);
