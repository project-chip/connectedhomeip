...
struct TypeInfo
{
    ...
    static constexpr ClusterId GetClusterId() { return Clusters::WaterTankLevelMonitoring::Id; }
...
struct TypeInfo
{
    using Type             = chip::app::Clusters::WaterTankLevelMonitoring::DegradationDirectionEnum;
    using DecodableType    = chip::app::Clusters::WaterTankLevelMonitoring::DegradationDirectionEnum;
    using DecodableArgType = chip::app::Clusters::WaterTankLevelMonitoring::DegradationDirectionEnum;
...
struct TypeInfo
{
    using Type             = chip::app::Clusters::WaterTankLevelMonitoring::ChangeIndicationEnum;
    using DecodableType    = chip::app::Clusters::WaterTankLevelMonitoring::ChangeIndicationEnum;
    using DecodableArgType = chip::app::Clusters::WaterTankLevelMonitoring::ChangeIndicationEnum;
...
{
    using Type =
        chip::app::DataModel::List<const chip::app::Clusters::WaterTankLevelMonitoring::Structs::ReplacementProductStruct::Type>;
    using DecodableType = chip::app::DataModel::DecodableList<
        chip::app::Clusters::WaterTankLevelMonitoring::Structs::ReplacementProductStruct::DecodableType>;
...
struct TypeInfo
{
    struct DecodableType
    {
        ...
        Attributes::DegradationDirection::TypeInfo::DecodableType degradationDirection =
            static_cast<chip::app::Clusters::WaterTankLevelMonitoring::DegradationDirectionEnum>(0);
        Attributes::ChangeIndication::TypeInfo::DecodableType changeIndication =
            static_cast<chip::app::Clusters::WaterTankLevelMonitoring::ChangeIndicationEnum>(0);
