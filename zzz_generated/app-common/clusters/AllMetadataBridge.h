...
#include <clusters/AccountLogin/MetadataBridge.h>
#include <clusters/Actions/Ids.h>
#include <clusters/Actions/MetadataBridge.h>
#include <clusters/ActivatedCarbonFilterMonitoring/Ids.h>
#include <clusters/ActivatedCarbonFilterMonitoring/MetadataBridge.h>
#include <clusters/AdministratorCommissioning/Ids.h>
#include <clusters/AdministratorCommissioning/MetadataBridge.h>
#include <clusters/AirQuality/Ids.h>
#include <clusters/AirQuality/MetadataBridge.h>
#include <clusters/ApplicationBasic/Ids.h>
#include <clusters/ApplicationBasic/MetadataBridge.h>
#include <clusters/ApplicationLauncher/Ids.h>
#include <clusters/ApplicationLauncher/MetadataBridge.h>
#include <clusters/AudioOutput/Ids.h>
#include <clusters/AudioOutput/MetadataBridge.h>
#include <clusters/BallastConfiguration/Ids.h>
#include <clusters/BallastConfiguration/MetadataBridge.h>
#include <clusters/BasicInformation/Ids.h>
#include <clusters/BasicInformation/MetadataBridge.h>
#include <clusters/Binding/Ids.h>
#include <clusters/Binding/MetadataBridge.h>
#include <clusters/BooleanState/Ids.h>
#include <clusters/BooleanState/MetadataBridge.h>
#include <clusters/BooleanStateConfiguration/Ids.h>
#include <clusters/BooleanStateConfiguration/MetadataBridge.h>
#include <clusters/BridgedDeviceBasicInformation/Ids.h>
#include <clusters/BridgedDeviceBasicInformation/MetadataBridge.h>
#include <clusters/CameraAvSettingsUserLevelManagement/Ids.h>
#include <clusters/CameraAvSettingsUserLevelManagement/MetadataBridge.h>
#include <clusters/CameraAvStreamManagement/Ids.h>
#include <clusters/CameraAvStreamManagement/MetadataBridge.h>
#include <clusters/CarbonDioxideConcentrationMeasurement/Ids.h>
#include <clusters/CarbonDioxideConcentrationMeasurement/MetadataBridge.h>
#include <clusters/CarbonMonoxideConcentrationMeasurement/Ids.h>
#include <clusters/CarbonMonoxideConcentrationMeasurement/MetadataBridge.h>
#include <clusters/Channel/Ids.h>
#include <clusters/Channel/MetadataBridge.h>
#include <clusters/Chime/Ids.h>
#include <clusters/Chime/MetadataBridge.h>
#include <clusters/ClosureControl/Ids.h>
#include <clusters/ClosureControl/MetadataBridge.h>
#include <clusters/ClosureDimension/Ids.h>
#include <clusters/ClosureDimension/MetadataBridge.h>
#include <clusters/ColorControl/Ids.h>
#include <clusters/ColorControl/MetadataBridge.h>
#include <clusters/CommissionerControl/Ids.h>
#include <clusters/CommissionerControl/MetadataBridge.h>
#include <clusters/CommodityMetering/Ids.h>
#include <clusters/CommodityMetering/MetadataBridge.h>
#include <clusters/CommodityPrice/Ids.h>
#include <clusters/CommodityPrice/MetadataBridge.h>
#include <clusters/CommodityTariff/Ids.h>
#include <clusters/CommodityTariff/MetadataBridge.h>
#include <clusters/ContentAppObserver/Ids.h>
#include <clusters/ContentAppObserver/MetadataBridge.h>
#include <clusters/ContentControl/Ids.h>
#include <clusters/ContentControl/MetadataBridge.h>
#include <clusters/ContentLauncher/Ids.h>
#include <clusters/ContentLauncher/MetadataBridge.h>
#include <clusters/Descriptor/Ids.h>
#include <clusters/Descriptor/MetadataBridge.h>
#include <clusters/DeviceEnergyManagement/Ids.h>
#include <clusters/DeviceEnergyManagement/MetadataBridge.h>
#include <clusters/DeviceEnergyManagementMode/Ids.h>
#include <clusters/DeviceEnergyManagementMode/MetadataBridge.h>
#include <clusters/DiagnosticLogs/Ids.h>
#include <clusters/DiagnosticLogs/MetadataBridge.h>
#include <clusters/DishwasherAlarm/Ids.h>
#include <clusters/DishwasherAlarm/MetadataBridge.h>
#include <clusters/DishwasherMode/Ids.h>
#include <clusters/DishwasherMode/MetadataBridge.h>
#include <clusters/DoorLock/Ids.h>
#include <clusters/DoorLock/MetadataBridge.h>
...
#include <clusters/EnergyEvse/MetadataBridge.h>
#include <clusters/EnergyEvseMode/Ids.h>
#include <clusters/EnergyEvseMode/MetadataBridge.h>
#include <clusters/EnergyPreference/Ids.h>
#include <clusters/EnergyPreference/MetadataBridge.h>
#include <clusters/EthernetNetworkDiagnostics/Ids.h>
#include <clusters/EthernetNetworkDiagnostics/MetadataBridge.h>
#include <clusters/FanControl/Ids.h>
#include <clusters/FanControl/MetadataBridge.h>
#include <clusters/FaultInjection/Ids.h>
#include <clusters/FaultInjection/MetadataBridge.h>
#include <clusters/FixedLabel/Ids.h>
#include <clusters/FixedLabel/MetadataBridge.h>
#include <clusters/FlowMeasurement/Ids.h>
#include <clusters/FlowMeasurement/MetadataBridge.h>
#include <clusters/FormaldehydeConcentrationMeasurement/Ids.h>
#include <clusters/FormaldehydeConcentrationMeasurement/MetadataBridge.h>
#include <clusters/GeneralCommissioning/Ids.h>
#include <clusters/GeneralCommissioning/MetadataBridge.h>
#include <clusters/GeneralDiagnostics/Ids.h>
#include <clusters/GeneralDiagnostics/MetadataBridge.h>
#include <clusters/GroupKeyManagement/Ids.h>
#include <clusters/GroupKeyManagement/MetadataBridge.h>
#include <clusters/Groups/Ids.h>
#include <clusters/Groups/MetadataBridge.h>
#include <clusters/HepaFilterMonitoring/Ids.h>
#include <clusters/HepaFilterMonitoring/MetadataBridge.h>
#include <clusters/IcdManagement/Ids.h>
#include <clusters/IcdManagement/MetadataBridge.h>
#include <clusters/Identify/Ids.h>
#include <clusters/Identify/MetadataBridge.h>
#include <clusters/IlluminanceMeasurement/Ids.h>
#include <clusters/IlluminanceMeasurement/MetadataBridge.h>
#include <clusters/JointFabricAdministrator/Ids.h>
#include <clusters/JointFabricAdministrator/MetadataBridge.h>
#include <clusters/JointFabricDatastore/Ids.h>
#include <clusters/JointFabricDatastore/MetadataBridge.h>
#include <clusters/KeypadInput/Ids.h>
#include <clusters/KeypadInput/MetadataBridge.h>
#include <clusters/LaundryDryerControls/Ids.h>
#include <clusters/LaundryDryerControls/MetadataBridge.h>
#include <clusters/LaundryWasherControls/Ids.h>
#include <clusters/LaundryWasherControls/MetadataBridge.h>
#include <clusters/LaundryWasherMode/Ids.h>
#include <clusters/LaundryWasherMode/MetadataBridge.h>
#include <clusters/LevelControl/Ids.h>
#include <clusters/LevelControl/MetadataBridge.h>
#include <clusters/LocalizationConfiguration/Ids.h>
#include <clusters/LocalizationConfiguration/MetadataBridge.h>
#include <clusters/LowPower/Ids.h>
#include <clusters/LowPower/MetadataBridge.h>
#include <clusters/MediaInput/Ids.h>
#include <clusters/MediaInput/MetadataBridge.h>
#include <clusters/MediaPlayback/Ids.h>
#include <clusters/MediaPlayback/MetadataBridge.h>
#include <clusters/Messages/Ids.h>
#include <clusters/Messages/MetadataBridge.h>
#include <clusters/MeterIdentification/Ids.h>
#include <clusters/MeterIdentification/MetadataBridge.h>
#include <clusters/MicrowaveOvenControl/Ids.h>
#include <clusters/MicrowaveOvenControl/MetadataBridge.h>
#include <clusters/MicrowaveOvenMode/Ids.h>
#include <clusters/MicrowaveOvenMode/MetadataBridge.h>
#include <clusters/ModeSelect/Ids.h>
#include <clusters/ModeSelect/MetadataBridge.h>
#include <clusters/NetworkCommissioning/Ids.h>
#include <clusters/NetworkCommissioning/MetadataBridge.h>
#include <clusters/NitrogenDioxideConcentrationMeasurement/Ids.h>
#include <clusters/NitrogenDioxideConcentrationMeasurement/MetadataBridge.h>
#include <clusters/OccupancySensing/Ids.h>
#include <clusters/OccupancySensing/MetadataBridge.h>
#include <clusters/OnOff/Ids.h>
#include <clusters/OnOff/MetadataBridge.h>
#include <clusters/OperationalCredentials/Ids.h>
#include <clusters/OperationalCredentials/MetadataBridge.h>
#include <clusters/OperationalState/Ids.h>
#include <clusters/OperationalState/MetadataBridge.h>
#include <clusters/OtaSoftwareUpdateProvider/Ids.h>
#include <clusters/OtaSoftwareUpdateProvider/MetadataBridge.h>
#include <clusters/OtaSoftwareUpdateRequestor/Ids.h>
#include <clusters/OtaSoftwareUpdateRequestor/MetadataBridge.h>
#include <clusters/OvenCavityOperationalState/Ids.h>
#include <clusters/OvenCavityOperationalState/MetadataBridge.h>
#include <clusters/OvenMode/Ids.h>
#include <clusters/OvenMode/MetadataBridge.h>
#include <clusters/OzoneConcentrationMeasurement/Ids.h>
#include <clusters/OzoneConcentrationMeasurement/MetadataBridge.h>
#include <clusters/Pm10ConcentrationMeasurement/Ids.h>
#include <clusters/Pm10ConcentrationMeasurement/MetadataBridge.h>
#include <clusters/Pm1ConcentrationMeasurement/Ids.h>
#include <clusters/Pm1ConcentrationMeasurement/MetadataBridge.h>
#include <clusters/Pm25ConcentrationMeasurement/Ids.h>
#include <clusters/Pm25ConcentrationMeasurement/MetadataBridge.h>
#include <clusters/PowerSource/Ids.h>
#include <clusters/PowerSource/MetadataBridge.h>
#include <clusters/PowerSourceConfiguration/Ids.h>
#include <clusters/PowerSourceConfiguration/MetadataBridge.h>
#include <clusters/PowerTopology/Ids.h>
#include <clusters/PowerTopology/MetadataBridge.h>
#include <clusters/PressureMeasurement/Ids.h>
#include <clusters/PressureMeasurement/MetadataBridge.h>
#include <clusters/ProxyConfiguration/Ids.h>
#include <clusters/ProxyConfiguration/MetadataBridge.h>
#include <clusters/ProxyDiscovery/Ids.h>
#include <clusters/ProxyDiscovery/MetadataBridge.h>
#include <clusters/ProxyValid/Ids.h>
#include <clusters/ProxyValid/MetadataBridge.h>
#include <clusters/PulseWidthModulation/Ids.h>
#include <clusters/PulseWidthModulation/MetadataBridge.h>
#include <clusters/PumpConfigurationAndControl/Ids.h>
#include <clusters/PumpConfigurationAndControl/MetadataBridge.h>
#include <clusters/PushAvStreamTransport/Ids.h>
#include <clusters/PushAvStreamTransport/MetadataBridge.h>
#include <clusters/RadonConcentrationMeasurement/Ids.h>
#include <clusters/RadonConcentrationMeasurement/MetadataBridge.h>
#include <clusters/RefrigeratorAlarm/Ids.h>
#include <clusters/RefrigeratorAlarm/MetadataBridge.h>
#include <clusters/RefrigeratorAndTemperatureControlledCabinetMode/Ids.h>
#include <clusters/RefrigeratorAndTemperatureControlledCabinetMode/MetadataBridge.h>
#include <clusters/RelativeHumidityMeasurement/Ids.h>
#include <clusters/RelativeHumidityMeasurement/MetadataBridge.h>
#include <clusters/RvcCleanMode/Ids.h>
#include <clusters/RvcCleanMode/MetadataBridge.h>
#include <clusters/RvcOperationalState/Ids.h>
#include <clusters/RvcOperationalState/MetadataBridge.h>
#include <clusters/RvcRunMode/Ids.h>
#include <clusters/RvcRunMode/MetadataBridge.h>
#include <clusters/SampleMei/Ids.h>
#include <clusters/SampleMei/MetadataBridge.h>
#include <clusters/ScenesManagement/Ids.h>
#include <clusters/ScenesManagement/MetadataBridge.h>
#include <clusters/ServiceArea/Ids.h>
#include <clusters/ServiceArea/MetadataBridge.h>
#include <clusters/SmokeCoAlarm/Ids.h>
#include <clusters/SmokeCoAlarm/MetadataBridge.h>
#include <clusters/SoftwareDiagnostics/Ids.h>
#include <clusters/SoftwareDiagnostics/MetadataBridge.h>
#include <clusters/SoilMeasurement/Ids.h>
#include <clusters/SoilMeasurement/MetadataBridge.h>
#include <clusters/Switch/Ids.h>
#include <clusters/Switch/MetadataBridge.h>
#include <clusters/TargetNavigator/Ids.h>
#include <clusters/TargetNavigator/MetadataBridge.h>
#include <clusters/TemperatureControl/Ids.h>
#include <clusters/TemperatureControl/MetadataBridge.h>
#include <clusters/TemperatureMeasurement/Ids.h>
#include <clusters/TemperatureMeasurement/MetadataBridge.h>
#include <clusters/Thermostat/Ids.h>
#include <clusters/Thermostat/MetadataBridge.h>
#include <clusters/ThermostatUserInterfaceConfiguration/Ids.h>
#include <clusters/ThermostatUserInterfaceConfiguration/MetadataBridge.h>
#include <clusters/ThreadBorderRouterManagement/Ids.h>
#include <clusters/ThreadBorderRouterManagement/MetadataBridge.h>
#include <clusters/ThreadNetworkDiagnostics/Ids.h>
#include <clusters/ThreadNetworkDiagnostics/MetadataBridge.h>
#include <clusters/ThreadNetworkDirectory/Ids.h>
#include <clusters/ThreadNetworkDirectory/MetadataBridge.h>
#include <clusters/TimeFormatLocalization/Ids.h>
#include <clusters/TimeFormatLocalization/MetadataBridge.h>
#include <clusters/TimeSynchronization/Ids.h>
#include <clusters/TimeSynchronization/MetadataBridge.h>
#include <clusters/Timer/Ids.h>
#include <clusters/Timer/MetadataBridge.h>
#include <clusters/TlsCertificateManagement/Ids.h>
#include <clusters/TlsCertificateManagement/MetadataBridge.h>
#include <clusters/TlsClientManagement/Ids.h>
#include <clusters/TlsClientManagement/MetadataBridge.h>
#include <clusters/TotalVolatileOrganicCompoundsConcentrationMeasurement/Ids.h>
#include <clusters/TotalVolatileOrganicCompoundsConcentrationMeasurement/MetadataBridge.h>
#include <clusters/UnitLocalization/Ids.h>
#include <clusters/UnitLocalization/MetadataBridge.h>
#include <clusters/UnitTesting/Ids.h>
#include <clusters/UnitTesting/MetadataBridge.h>
#include <clusters/UserLabel/Ids.h>
#include <clusters/UserLabel/MetadataBridge.h>
#include <clusters/ValveConfigurationAndControl/Ids.h>
#include <clusters/ValveConfigurationAndControl/MetadataBridge.h>
#include <clusters/WakeOnLan/Ids.h>
#include <clusters/WakeOnLan/MetadataBridge.h>
#include <clusters/WaterHeaterManagement/Ids.h>
#include <clusters/WaterHeaterManagement/MetadataBridge.h>
#include <clusters/WaterHeaterMode/Ids.h>
#include <clusters/WaterHeaterMode/MetadataBridge.h>
#include <clusters/WebRTCTransportProvider/Ids.h>
#include <clusters/WebRTCTransportProvider/MetadataBridge.h>
#include <clusters/WebRTCTransportRequestor/Ids.h>
#include <clusters/WebRTCTransportRequestor/MetadataBridge.h>
#include <clusters/WiFiNetworkDiagnostics/Ids.h>
#include <clusters/WiFiNetworkDiagnostics/MetadataBridge.h>
#include <clusters/WiFiNetworkManagement/Ids.h>
#include <clusters/WiFiNetworkManagement/MetadataBridge.h>
