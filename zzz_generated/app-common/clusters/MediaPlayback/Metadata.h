...
inline constexpr DataModel::AttributeEntry kMetadataEntry(AvailableAudioTracks::Id,
...
inline constexpr DataModel::AttributeEntry kMetadataEntry(AvailableTextTracks::Id,
                                                          BitFlags<DataModel::AttributeQualityFlags>{
                                                              DataModel::AttributeQualityFlags::kListAttribute },
                                                          Access::Privilege::kView, std::nullopt);
} // namespace AvailableTextTracks
