...
inline constexpr DataModel::AttributeEntry kMetadataEntry{
    SupportedAreas::Id, BitFlags<DataModel::AttributeQualityFlags>{ DataModel::AttributeQualityFlags::kListAttribute },
    Access::Privilege::kView, std::nullopt
};
} // namespace SupportedAreas
namespace SupportedMaps {
inline constexpr DataModel::AttributeEntry kMetadataEntry{
    SupportedMaps::Id, BitFlags<DataModel::AttributeQualityFlags>{ DataModel::AttributeQualityFlags::kListAttribute },
    Access::Privilege::kView, std::nullopt
};
} // namespace SupportedMaps
namespace SelectedAreas {
inline constexpr DataModel::AttributeEntry kMetadataEntry{
    SelectedAreas::Id, BitFlags<DataModel::AttributeQualityFlags>{ DataModel::AttributeQualityFlags::kListAttribute },
    Access::Privilege::kView, std::nullopt
};
} // namespace SelectedAreas
...
namespace Progress {
inline constexpr DataModel::AttributeEntry kMetadataEntry{
    Progress::Id, BitFlags<DataModel::AttributeQualityFlags>{ DataModel::AttributeQualityFlags::kListAttribute },
    Access::Privilege::kView, std::nullopt
};
} // namespace Progress
