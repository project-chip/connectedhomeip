...
{
    constexpr uint32_t kRequiredFieldsBitmap = 0 | (1 << to_underlying(Fields::kTempAccountIdentifier));
    static_assert(to_underlying(Fields::kTempAccountIdentifier) < sizeof(kRequiredFieldsBitmap) * 8);
...
{
    constexpr uint32_t kRequiredFieldsBitmap = 0 | (1 << to_underlying(Fields::kSetupPIN));
    static_assert(to_underlying(Fields::kSetupPIN) < sizeof(kRequiredFieldsBitmap) * 8);
    detail::StructDecodeIterator __iterator(reader, kRequiredFieldsBitmap);
    while (true)
    {
        uint8_t __context_tag = 0;
...
CHIP_ERROR DecodableType::Decode(TLV::TLVReader & reader, FabricIndex aAccessingFabricIndex)
{
    constexpr uint32_t kRequiredFieldsBitmap =
        0 | (1 << to_underlying(Fields::kTempAccountIdentifier)) | (1 << to_underlying(Fields::kSetupPIN));
    static_assert(to_underlying(Fields::kTempAccountIdentifier) < sizeof(kRequiredFieldsBitmap) * 8);
    static_assert(to_underlying(Fields::kSetupPIN) < sizeof(kRequiredFieldsBitmap) * 8);
    detail::StructDecodeIterator __iterator(reader, kRequiredFieldsBitmap);
    while (true)
