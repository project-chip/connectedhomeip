...
{
    constexpr uint32_t kRequiredFieldsBitmap = 0 | (1 << to_underlying(Fields::kIndex));
...
CHIP_ERROR DecodableType::Decode(TLV::TLVReader & reader)
{
    constexpr uint32_t kRequiredFieldsBitmap = 0 | (1 << to_underlying(Fields::kIndex)) | (1 << to_underlying(Fields::kName));
    static_assert(to_underlying(Fields::kIndex) < sizeof(kRequiredFieldsBitmap) * 8);
