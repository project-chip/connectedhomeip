...
CHIP_ERROR DecodableType::Decode(TLV::TLVReader & reader)
{
    constexpr uint32_t kRequiredFieldsBitmap =
        0 | (1 << to_underlying(Fields::kIntent)) | (1 << to_underlying(Fields::kRequestedProtocol));
    static_assert(to_underlying(Fields::kIntent) < sizeof(kRequiredFieldsBitmap) * 8);
    static_assert(to_underlying(Fields::kRequestedProtocol) < sizeof(kRequiredFieldsBitmap) * 8);
...
{
    constexpr uint32_t kRequiredFieldsBitmap =
        0 | (1 << to_underlying(Fields::kStatus)) | (1 << to_underlying(Fields::kLogContent));
    static_assert(to_underlying(Fields::kStatus) < sizeof(kRequiredFieldsBitmap) * 8);
    static_assert(to_underlying(Fields::kLogContent) < sizeof(kRequiredFieldsBitmap) * 8);
    detail::StructDecodeIterator __iterator(reader, kRequiredFieldsBitmap);
    while (true)
    {
        uint8_t __context_tag = 0;
