...
inline constexpr DataModel::AttributeEntry kMetadataEntry{
    TimeZone::Id, BitFlags<DataModel::AttributeQualityFlags>{ DataModel::AttributeQualityFlags::kListAttribute },
    Access::Privilege::kView, std::nullopt
};
} // namespace TimeZone
namespace DSTOffset {
inline constexpr DataModel::AttributeEntry kMetadataEntry{
    DSTOffset::Id, BitFlags<DataModel::AttributeQualityFlags>{ DataModel::AttributeQualityFlags::kListAttribute },
    Access::Privilege::kView, std::nullopt
};
} // namespace DSTOffset
namespace LocalTime {
