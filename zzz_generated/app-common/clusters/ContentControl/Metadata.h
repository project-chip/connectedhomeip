...
inline constexpr DataModel::AttributeEntry kMetadataEntry(OnDemandRatings::Id,
...
inline constexpr DataModel::AttributeEntry kMetadataEntry(ScheduledContentRatings::Id,
                                                          BitFlags<DataModel::AttributeQualityFlags>{
                                                              DataModel::AttributeQualityFlags::kListAttribute },
                                                          Access::Privilege::kView, std::nullopt);
} // namespace ScheduledContentRatings
