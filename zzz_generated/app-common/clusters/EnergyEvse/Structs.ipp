...
{
    constexpr uint32_t kRequiredFieldsBitmap = 0 | (1 << to_underlying(Fields::kTargetTimeMinutesPastMidnight));
    static_assert(to_underlying(Fields::kTargetTimeMinutesPastMidnight) < sizeof(kRequiredFieldsBitmap) * 8);
...
CHIP_ERROR DecodableType::Decode(TLV::TLVReader & reader)
{
    constexpr uint32_t kRequiredFieldsBitmap =
        0 | (1 << to_underlying(Fields::kDayOfWeekForSequence)) | (1 << to_underlying(Fields::kChargingTargets));
    static_assert(to_underlying(Fields::kDayOfWeekForSequence) < sizeof(kRequiredFieldsBitmap) * 8);
    static_assert(to_underlying(Fields::kChargingTargets) < sizeof(kRequiredFieldsBitmap) * 8);
    detail::StructDecodeIterator __iterator(reader, kRequiredFieldsBitmap);
    while (true)
    {
        uint8_t __context_tag = 0;
