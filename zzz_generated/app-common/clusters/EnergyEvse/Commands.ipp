...
{
    constexpr uint32_t kRequiredFieldsBitmap = 0 | (1 << to_underlying(Fields::kChargingTargetSchedules));
    static_assert(to_underlying(Fields::kChargingTargetSchedules) < sizeof(kRequiredFieldsBitmap) * 8);
...
CHIP_ERROR DecodableType::Decode(TLV::TLVReader & reader)
{
    constexpr uint32_t kRequiredFieldsBitmap = 0 | (1 << to_underlying(Fields::kChargingEnabledUntil)) |
        (1 << to_underlying(Fields::kMinimumChargeCurrent)) | (1 << to_underlying(Fields::kMaximumChargeCurrent));
    static_assert(to_underlying(Fields::kChargingEnabledUntil) < sizeof(kRequiredFieldsBitmap) * 8);
    static_assert(to_underlying(Fields::kMinimumChargeCurrent) < sizeof(kRequiredFieldsBitmap) * 8);
    static_assert(to_underlying(Fields::kMaximumChargeCurrent) < sizeof(kRequiredFieldsBitmap) * 8);
    detail::StructDecodeIterator __iterator(reader, kRequiredFieldsBitmap);
    while (true)
    {
        uint8_t __context_tag = 0;
...
CHIP_ERROR DecodableType::Decode(TLV::TLVReader & reader)
{
    constexpr uint32_t kRequiredFieldsBitmap =
        0 | (1 << to_underlying(Fields::kDischargingEnabledUntil)) | (1 << to_underlying(Fields::kMaximumDischargeCurrent));
    static_assert(to_underlying(Fields::kDischargingEnabledUntil) < sizeof(kRequiredFieldsBitmap) * 8);
    static_assert(to_underlying(Fields::kMaximumDischargeCurrent) < sizeof(kRequiredFieldsBitmap) * 8);
    detail::StructDecodeIterator __iterator(reader, kRequiredFieldsBitmap);
    while (true)
    {
        uint8_t __context_tag = 0;
