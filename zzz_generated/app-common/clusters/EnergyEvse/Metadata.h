...
inline constexpr DataModel::AttributeEntry kMetadataEntry{ DischargingEnabledUntil::Id,
...
inline constexpr DataModel::AttributeEntry kMetadataEntry{ MaximumDischargeCurrent::Id,
                                                           BitFlags<DataModel::AttributeQualityFlags>{}, Access::Privilege::kView,
                                                           std::nullopt };
} // namespace MaximumDischargeCurrent
...
inline constexpr DataModel::AttributeEntry kMetadataEntry{ ApproximateEVEfficiency::Id,
                                                           BitFlags<DataModel::AttributeQualityFlags>{}, Access::Privilege::kView,
                                                           Access::Privilege::kManage };
} // namespace ApproximateEVEfficiency
...
inline constexpr DataModel::AttributeEntry kMetadataEntry{ SessionEnergyDischarged::Id,
                                                           BitFlags<DataModel::AttributeQualityFlags>{}, Access::Privilege::kView,
                                                           std::nullopt };
} // namespace SessionEnergyDischarged
