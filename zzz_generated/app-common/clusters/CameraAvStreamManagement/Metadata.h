...
inline constexpr DataModel::AttributeEntry kMetadataEntry(SnapshotCapabilities::Id,
                                                          BitFlags<DataModel::AttributeQualityFlags>{
                                                              DataModel::AttributeQualityFlags::kListAttribute },
                                                          Access::Privilege::kView, std::nullopt);
} // namespace SnapshotCapabilities
...
inline constexpr DataModel::AttributeEntry kMetadataEntry(SupportedStreamUsages::Id,
                                                          BitFlags<DataModel::AttributeQualityFlags>{
                                                              DataModel::AttributeQualityFlags::kListAttribute },
                                                          Access::Privilege::kView, std::nullopt);
} // namespace SupportedStreamUsages
namespace AllocatedVideoStreams {
inline constexpr DataModel::AttributeEntry kMetadataEntry(AllocatedVideoStreams::Id,
                                                          BitFlags<DataModel::AttributeQualityFlags>{
                                                              DataModel::AttributeQualityFlags::kListAttribute },
                                                          Access::Privilege::kView, std::nullopt);
} // namespace AllocatedVideoStreams
namespace AllocatedAudioStreams {
inline constexpr DataModel::AttributeEntry kMetadataEntry(AllocatedAudioStreams::Id,
                                                          BitFlags<DataModel::AttributeQualityFlags>{
                                                              DataModel::AttributeQualityFlags::kListAttribute },
                                                          Access::Privilege::kView, std::nullopt);
} // namespace AllocatedAudioStreams
namespace AllocatedSnapshotStreams {
inline constexpr DataModel::AttributeEntry kMetadataEntry(AllocatedSnapshotStreams::Id,
                                                          BitFlags<DataModel::AttributeQualityFlags>{
                                                              DataModel::AttributeQualityFlags::kListAttribute },
                                                          Access::Privilege::kView, std::nullopt);
} // namespace AllocatedSnapshotStreams
