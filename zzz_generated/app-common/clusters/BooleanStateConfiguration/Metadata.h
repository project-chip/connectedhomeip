...
inline constexpr DataModel::AttributeEntry kMetadataEntry{ CurrentSensitivityLevel::Id,
...
inline constexpr DataModel::AttributeEntry kMetadataEntry{ DefaultSensitivityLevel::Id,
                                                           BitFlags<DataModel::AttributeQualityFlags>{}, Access::Privilege::kView,
                                                           std::nullopt };
} // namespace DefaultSensitivityLevel
