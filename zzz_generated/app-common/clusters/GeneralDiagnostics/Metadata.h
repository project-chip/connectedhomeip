...
inline constexpr DataModel::AttributeEntry kMetadataEntry(NetworkInterfaces::Id,
...
inline constexpr DataModel::AttributeEntry kMetadataEntry(ActiveHardwareFaults::Id,
                                                          BitFlags<DataModel::AttributeQualityFlags>{
                                                              DataModel::AttributeQualityFlags::kListAttribute },
                                                          Access::Privilege::kView, std::nullopt);
} // namespace ActiveHardwareFaults
namespace ActiveRadioFaults {
inline constexpr DataModel::AttributeEntry kMetadataEntry(ActiveRadioFaults::Id,
                                                          BitFlags<DataModel::AttributeQualityFlags>{
                                                              DataModel::AttributeQualityFlags::kListAttribute },
                                                          Access::Privilege::kView, std::nullopt);
} // namespace ActiveRadioFaults
namespace ActiveNetworkFaults {
inline constexpr DataModel::AttributeEntry kMetadataEntry(ActiveNetworkFaults::Id,
                                                          BitFlags<DataModel::AttributeQualityFlags>{
                                                              DataModel::AttributeQualityFlags::kListAttribute },
                                                          Access::Privilege::kView, std::nullopt);
} // namespace ActiveNetworkFaults
