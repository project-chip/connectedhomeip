...
inline constexpr DataModel::AttributeEntry kMetadataEntry(NeighborTable::Id,
...
inline constexpr DataModel::AttributeEntry kMetadataEntry(ActiveNetworkFaultsList::Id,
                                                          BitFlags<DataModel::AttributeQualityFlags>{
                                                              DataModel::AttributeQualityFlags::kListAttribute },
                                                          Access::Privilege::kView, std::nullopt);
} // namespace ActiveNetworkFaultsList
