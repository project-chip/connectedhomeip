...
inline constexpr DataModel::AttributeEntry kMetadataEntry{
    NeighborTable::Id, BitFlags<DataModel::AttributeQualityFlags>{ DataModel::AttributeQualityFlags::kListAttribute },
    Access::Privilege::kView, std::nullopt
};
} // namespace NeighborTable
namespace RouteTable {
inline constexpr DataModel::AttributeEntry kMetadataEntry{
    RouteTable::Id, BitFlags<DataModel::AttributeQualityFlags>{ DataModel::AttributeQualityFlags::kListAttribute },
    Access::Privilege::kView, std::nullopt
};
} // namespace RouteTable
...
inline constexpr DataModel::AttributeEntry kMetadataEntry{ RxDestAddrFilteredCount::Id,
                                                           BitFlags<DataModel::AttributeQualityFlags>{}, Access::Privilege::kView,
                                                           std::nullopt };
} // namespace RxDestAddrFilteredCount
...
inline constexpr DataModel::AttributeEntry kMetadataEntry{
    ActiveNetworkFaultsList::Id, BitFlags<DataModel::AttributeQualityFlags>{ DataModel::AttributeQualityFlags::kListAttribute },
    Access::Privilege::kView, std::nullopt
};
} // namespace ActiveNetworkFaultsList
