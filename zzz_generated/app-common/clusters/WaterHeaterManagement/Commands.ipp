...
{
    constexpr uint32_t kRequiredFieldsBitmap = 0 | (1 << to_underlying(Fields::kBoostInfo));
    static_assert(to_underlying(Fields::kBoostInfo) < sizeof(kRequiredFieldsBitmap) * 8);
