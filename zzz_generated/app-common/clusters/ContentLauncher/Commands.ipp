...
{
    constexpr uint32_t kRequiredFieldsBitmap = 0 | (1 << to_underlying(Fields::kSearch)) | (1 << to_underlying(Fields::kAutoPlay));
    static_assert(to_underlying(Fields::kSearch) < sizeof(kRequiredFieldsBitmap) * 8);
    static_assert(to_underlying(Fields::kAutoPlay) < sizeof(kRequiredFieldsBitmap) * 8);
...
CHIP_ERROR DecodableType::Decode(TLV::TLVReader & reader)
{
    constexpr uint32_t kRequiredFieldsBitmap = 0 | (1 << to_underlying(Fields::kContentURL));
    static_assert(to_underlying(Fields::kContentURL) < sizeof(kRequiredFieldsBitmap) * 8);
    detail::StructDecodeIterator __iterator(reader, kRequiredFieldsBitmap);
    while (true)
    {
        uint8_t __context_tag = 0;
