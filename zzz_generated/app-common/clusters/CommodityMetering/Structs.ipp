...
CHIP_ERROR DecodableType::Decode(TLV::TLVReader & reader)
{
    constexpr uint32_t kRequiredFieldsBitmap =
        0 | (1 << to_underlying(Fields::kTariffComponentIDs)) | (1 << to_underlying(Fields::kQuantity));
    static_assert(to_underlying(Fields::kTariffComponentIDs) < sizeof(kRequiredFieldsBitmap) * 8);
    static_assert(to_underlying(Fields::kQuantity) < sizeof(kRequiredFieldsBitmap) * 8);
