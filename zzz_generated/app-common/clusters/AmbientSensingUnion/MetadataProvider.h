...
struct ClusterMetadataProvider<DataModel::AttributeEntry, Clusters::AmbientSensingUnion::Id>
{
    static constexpr std::optional<DataModel::AttributeEntry> EntryFor(AttributeId attributeId)
    {
        ...
        {
        case UnionID::Id:
            return UnionID::kMetadataEntry;
        case UnionName::Id:
            return UnionName::kMetadataEntry;
        case UnionHealth::Id:
            return UnionHealth::kMetadataEntry;
        case UnionSensorList::Id:
            return UnionSensorList::kMetadataEntry;
        case UnionSensorHealth::Id:
            return UnionSensorHealth::kMetadataEntry;
        case SensorID::Id:
            return SensorID::kMetadataEntry;
        case ZoneSensorList::Id:
            return ZoneSensorList::kMetadataEntry;
        default:
            return std::nullopt;
        }
    }
