...
inline constexpr DataModel::AttributeEntry kMetadataEntry(CalendarPeriods::Id,
                                                          BitFlags<DataModel::AttributeQualityFlags>{
                                                              DataModel::AttributeQualityFlags::kListAttribute },
                                                          Access::Privilege::kView, std::nullopt);
} // namespace CalendarPeriods
namespace IndividualDays {
inline constexpr DataModel::AttributeEntry kMetadataEntry(IndividualDays::Id,
                                                          BitFlags<DataModel::AttributeQualityFlags>{
                                                              DataModel::AttributeQualityFlags::kListAttribute },
                                                          Access::Privilege::kView, std::nullopt);
} // namespace IndividualDays
...
inline constexpr DataModel::AttributeEntry kMetadataEntry(TariffComponents::Id,
                                                          BitFlags<DataModel::AttributeQualityFlags>{
                                                              DataModel::AttributeQualityFlags::kListAttribute },
                                                          Access::Privilege::kView, std::nullopt);
} // namespace TariffComponents
namespace TariffPeriods {
inline constexpr DataModel::AttributeEntry kMetadataEntry(TariffPeriods::Id,
                                                          BitFlags<DataModel::AttributeQualityFlags>{
                                                              DataModel::AttributeQualityFlags::kListAttribute },
                                                          Access::Privilege::kView, std::nullopt);
} // namespace TariffPeriods
namespace CurrentTariffComponents {
inline constexpr DataModel::AttributeEntry kMetadataEntry(CurrentTariffComponents::Id,
                                                          BitFlags<DataModel::AttributeQualityFlags>{
                                                              DataModel::AttributeQualityFlags::kListAttribute },
                                                          Access::Privilege::kView, std::nullopt);
} // namespace CurrentTariffComponents
namespace NextTariffComponents {
inline constexpr DataModel::AttributeEntry kMetadataEntry(NextTariffComponents::Id,
                                                          BitFlags<DataModel::AttributeQualityFlags>{
                                                              DataModel::AttributeQualityFlags::kListAttribute },
                                                          Access::Privilege::kView, std::nullopt);
} // namespace NextTariffComponents
