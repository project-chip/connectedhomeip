...
{
    constexpr uint32_t kRequiredFieldsBitmap = 0 | (1 << to_underlying(Fields::kSecureState));
    static_assert(to_underlying(Fields::kSecureState) < sizeof(kRequiredFieldsBitmap) * 8);
