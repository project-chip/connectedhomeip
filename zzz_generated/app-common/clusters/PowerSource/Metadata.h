...
inline constexpr DataModel::AttributeEntry kMetadataEntry{
    ActiveWiredFaults::Id, BitFlags<DataModel::AttributeQualityFlags>{ DataModel::AttributeQualityFlags::kListAttribute },
    Access::Privilege::kView, std::nullopt
};
} // namespace ActiveWiredFaults
...
inline constexpr DataModel::AttributeEntry kMetadataEntry{
    ActiveBatFaults::Id, BitFlags<DataModel::AttributeQualityFlags>{ DataModel::AttributeQualityFlags::kListAttribute },
    Access::Privilege::kView, std::nullopt
};
} // namespace ActiveBatFaults
...
inline constexpr DataModel::AttributeEntry kMetadataEntry{
    ActiveBatChargeFaults::Id, BitFlags<DataModel::AttributeQualityFlags>{ DataModel::AttributeQualityFlags::kListAttribute },
    Access::Privilege::kView, std::nullopt
};
} // namespace ActiveBatChargeFaults
namespace EndpointList {
inline constexpr DataModel::AttributeEntry kMetadataEntry{
    EndpointList::Id, BitFlags<DataModel::AttributeQualityFlags>{ DataModel::AttributeQualityFlags::kListAttribute },
    Access::Privilege::kView, std::nullopt
};
} // namespace EndpointList
