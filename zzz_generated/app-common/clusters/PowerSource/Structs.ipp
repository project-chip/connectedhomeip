...
{
    constexpr uint32_t kRequiredFieldsBitmap = 0 | (1 << to_underlying(Fields::kCurrent)) | (1 << to_underlying(Fields::kPrevious));
    static_assert(to_underlying(Fields::kCurrent) < sizeof(kRequiredFieldsBitmap) * 8);
    static_assert(to_underlying(Fields::kPrevious) < sizeof(kRequiredFieldsBitmap) * 8);
