...
inline constexpr DataModel::AttributeEntry kMetadataEntry{
    SpinSpeeds::Id, BitFlags<DataModel::AttributeQualityFlags>{ DataModel::AttributeQualityFlags::kListAttribute },
...
inline constexpr DataModel::AttributeEntry kMetadataEntry{
    SupportedRinses::Id, BitFlags<DataModel::AttributeQualityFlags>{ DataModel::AttributeQualityFlags::kListAttribute },
    Access::Privilege::kView, std::nullopt
};
} // namespace SupportedRinses
