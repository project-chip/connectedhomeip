...
#define GENERATED_CLUSTERS                                                                                                         \
    {                                                                                                                              \
        { 0x0003, ZAP_ATTRIBUTE_INDEX(0), 3, 5, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 0, Cluster: Identify (server) */    \
            {                                                                                                                      \
                0x001D, ZAP_ATTRIBUTE_INDEX(3), 5, 1018, ZAP_CLUSTER_MASK(SERVER), NULL                                            \
            }, /* Endpoint: 0, Cluster: Descriptor (server) */                                                                     \
            {                                                                                                                      \
                0x0028, ZAP_ATTRIBUTE_INDEX(8), 19, 653, ZAP_CLUSTER_MASK(SERVER), NULL                                            \
            }, /* Endpoint: 0, Cluster: Basic (server) */                                                                          \
            {                                                                                                                      \
            ...
            {                                                                                                                      \
                0x0003, ZAP_ATTRIBUTE_INDEX(148), 3, 5, ZAP_CLUSTER_MASK(SERVER), NULL                                             \
            }, /* Endpoint: 1, Cluster: Identify (server) */                                                                       \
            {                                                                                                                      \
                0x0004, ZAP_ATTRIBUTE_INDEX(151), 2, 3, ZAP_CLUSTER_MASK(SERVER), NULL                                             \
            }, /* Endpoint: 1, Cluster: Groups (server) */                                                                         \
            {                                                                                                                      \
                0x0005, ZAP_ATTRIBUTE_INDEX(153), 6, 8, ZAP_CLUSTER_MASK(SERVER), NULL                                             \
            }, /* Endpoint: 1, Cluster: Scenes (server) */                                                                         \
            {                                                                                                                      \
                0x0006, ZAP_ATTRIBUTE_INDEX(159), 7, 13, ZAP_CLUSTER_MASK(SERVER), NULL                                            \
            }, /* Endpoint: 1, Cluster: On/Off (server) */                                                                         \
            {                                                                                                                      \
                0x0007, ZAP_ATTRIBUTE_INDEX(166), 3, 4, ZAP_CLUSTER_MASK(SERVER), NULL                                             \
            }, /* Endpoint: 1, Cluster: On/off Switch Configuration (server) */                                                    \
            {                                                                                                                      \
                0x0008, ZAP_ATTRIBUTE_INDEX(169), 15, 23, ZAP_CLUSTER_MASK(SERVER), NULL                                           \
            }, /* Endpoint: 1, Cluster: Level Control (server) */                                                                  \
            {                                                                                                                      \
            ...
            {                                                                                                                      \
                0x0101, ZAP_ATTRIBUTE_INDEX(226), 4, 5, ZAP_CLUSTER_MASK(SERVER), NULL                                             \
            }, /* Endpoint: 1, Cluster: Door Lock (server) */                                                                      \
            {                                                                                                                      \
            ...
            {                                                                                                                      \
                0x0200, ZAP_ATTRIBUTE_INDEX(254), 24, 48, ZAP_CLUSTER_MASK(SERVER), NULL                                           \
            }, /* Endpoint: 1, Cluster: Pump Configuration and Control (server) */                                                 \
            {                                                                                                                      \
            ...
            {                                                                                                                      \
                0x0300, ZAP_ATTRIBUTE_INDEX(300), 53, 341, ZAP_CLUSTER_MASK(SERVER), NULL                                          \
            }, /* Endpoint: 1, Cluster: Color Control (server) */                                                                  \
            {                                                                                                                      \
            ...
            {                                                                                                                      \
                0x0406, ZAP_ATTRIBUTE_INDEX(369), 4, 5, ZAP_CLUSTER_MASK(SERVER), NULL                                             \
            }, /* Endpoint: 1, Cluster: Occupancy Sensing (server) */                                                              \
            {                                                                                                                      \
                0x0500, ZAP_ATTRIBUTE_INDEX(373), 6, 16, ZAP_CLUSTER_MASK(SERVER), NULL                                            \
            }, /* Endpoint: 1, Cluster: IAS Zone (server) */                                                                       \
            {                                                                                                                      \
            ...
            {                                                                                                                      \
                0x0006, ZAP_ATTRIBUTE_INDEX(458), 7, 13, ZAP_CLUSTER_MASK(SERVER), NULL                                            \
            }, /* Endpoint: 2, Cluster: On/Off (server) */                                                                         \
            {                                                                                                                      \
                0x0406, ZAP_ATTRIBUTE_INDEX(465), 4, 5, ZAP_CLUSTER_MASK(SERVER), NULL                                             \
            }, /* Endpoint: 2, Cluster: Occupancy Sensing (server) */                                                              \
    }
