...
#define EMBER_AF_TIME_SYNC_CLUSTER_SERVER_ENDPOINT_COUNT (1)
...
// Use this macro to check if the server side of the Time Sync cluster is included
#define ZCL_USING_TIME_SYNC_CLUSTER_SERVER
#define EMBER_AF_PLUGIN_TIME_SYNC_SERVER
#define EMBER_AF_PLUGIN_TIME_SYNC
