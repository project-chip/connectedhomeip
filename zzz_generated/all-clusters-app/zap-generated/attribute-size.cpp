                                        ...
                                        TLV::TLVWriter & writer, uint64_t tag)
{
    ...
    case 0x050F: // Test Cluster Cluster
    {
        switch (attributeId)
        {
        case 0x0020: // simple_struct
        {
            // Struct _simplestruct
            _simplestruct entry;
            ReturnErrorOnFailure(_simplestruct::FromEmberBuffer(&entry, src, 12));
                         ...
                         int32_t index)
{
    ...
    case 0x0040: // Fixed Label Cluster
    {
        ...
        case 0x0000: // label list
        {
            ...
            {
                size_t unusedLen;
                _LabelStruct::ToEmberBuffer(entry, dest + entryOffset, 36, unusedLen);
            }
            else
            {
                _LabelStruct::FromEmberBuffer(entry, src + entryOffset, 36);
            }
            break;
        }
        }
    ...
    case 0x0030: // General Commissioning Cluster
    {
        ...
        case 0x0001: // BasicCommissioningInfoList
        {
            ...
            {
                size_t unusedLen;
                _BasicCommissioningInfoType::ToEmberBuffer(entry, dest + entryOffset, 4, unusedLen);
            }
            else
            {
                _BasicCommissioningInfoType::FromEmberBuffer(entry, src + entryOffset, 4);
            }
            break;
        }
        }
    ...
    case 0x003E: // Operational Credentials Cluster
    {
        ...
        case 0x0001: // fabrics list
        {
            ...
            {
                size_t unusedLen;
                _FabricDescriptor::ToEmberBuffer(entry, dest + entryOffset, 120, unusedLen);
            }
            else
            {
                _FabricDescriptor::FromEmberBuffer(entry, src + entryOffset, 120);
            }
            break;
        }
        case 0x0004: // TrustedRootCertificates
    ...
    case 0x050F: // Test Cluster Cluster
    {
        ...
        case 0x001C: // list_struct_octet_string
        {
            ...
            {
                size_t unusedLen;
                _TestListStructOctet::ToEmberBuffer(entry, dest + entryOffset, 42, unusedLen);
            }
            else
            {
                _TestListStructOctet::FromEmberBuffer(entry, src + entryOffset, 42);
            }
            break;
        }
        }
