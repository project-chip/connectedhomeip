...
void DispatchServerCommand(CommandHandler * apCommandObj, const ConcreteCommandPath & aCommandPath, TLV::TLVReader & aDataTlv)
{
    ...
    bool wasHandled     = false;
    {
        ...
        case Commands::SampleMfgExtensionCommand::Id: {
            Commands::SampleMfgExtensionCommand::DecodableType commandData;
            TLVError = DataModel::Decode(aDataTlv, commandData);
            if (TLVError == CHIP_NO_ERROR)
            {
                wasHandled = emberAfModeSelectClusterSampleMfgExtensionCommandCallback(apCommandObj, aCommandPath, commandData);
            }
            break;
        }
        default: {
