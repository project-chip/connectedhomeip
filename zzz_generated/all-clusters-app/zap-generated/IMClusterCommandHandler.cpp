...
void DispatchServerCommand(CommandHandler * apCommandObj, const ConcreteCommandPath & aCommandPath, TLV::TLVReader & aDataTlv)
{
    ...
    bool wasHandled     = false;
    {
        ...
        case Commands::TestEmitTestNullableFabricScopedEventRequest::Id: {
            Commands::TestEmitTestNullableFabricScopedEventRequest::DecodableType commandData;
            TLVError = DataModel::Decode(aDataTlv, commandData);
            if (TLVError == CHIP_NO_ERROR)
            {
                wasHandled = emberAfTestClusterClusterTestEmitTestNullableFabricScopedEventRequestCallback(
                    apCommandObj, aCommandPath, commandData);
            }
            break;
        }
