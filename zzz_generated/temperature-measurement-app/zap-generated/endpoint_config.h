...
#define GENERATED_DEFAULTS_COUNT (37)
...
#define GENERATED_ATTRIBUTE_COUNT 68
    ...
    {                                                                                                                              \
        ...
        { 0x0000, ZAP_TYPE(ARRAY), 254, ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE), ZAP_LONG_DEFAULTS_INDEX(0) }, /* device list */      \
            ...
            { 0x0000, ZAP_TYPE(ARRAY), 254, ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE),                                                  \
              ZAP_LONG_DEFAULTS_INDEX(2600) }, /* device list */                                                                   \
            { 0x0001, ZAP_TYPE(ARRAY), 254, ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE),                                                  \
              ZAP_LONG_DEFAULTS_INDEX(2854) }, /* server list */                                                                   \
            { 0x0002, ZAP_TYPE(ARRAY), 254, ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE),                                                  \
              ZAP_LONG_DEFAULTS_INDEX(3108) }, /* client list */                                                                   \
            { 0x0003, ZAP_TYPE(ARRAY), 254, ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE),                                                  \
              ZAP_LONG_DEFAULTS_INDEX(3362) },                         /* parts list */                                            \
            { 0xFFFD, ZAP_TYPE(INT16U), 2, 0, ZAP_SIMPLE_DEFAULT(1) }, /* ClusterRevision */                                       \
                                                                                                                                   \
...
#define GENERATED_CLUSTERS                                                                                                         \
    {                                                                                                                              \
        {                                                                                                                          \
            ...
            {                                                                                                                      \
                0x001D, ZAP_ATTRIBUTE_INDEX(59), 5, 1018, ZAP_CLUSTER_MASK(SERVER), NULL                                           \
            }, /* Endpoint: 1, Cluster: Descriptor (server) */                                                                     \
            {                                                                                                                      \
                0x0402, ZAP_ATTRIBUTE_INDEX(64), 4, 8, ZAP_CLUSTER_MASK(SERVER), NULL                                              \
            }, /* Endpoint: 1, Cluster: Temperature Measurement (server) */                                                        \
    }
...
#define GENERATED_ENDPOINT_TYPES                                                                                                   \
    {                                                                                                                              \
        { ZAP_CLUSTER_INDEX(0), 11, 2643 }, { ZAP_CLUSTER_INDEX(11), 2, 1026 },                                                    \
    }
...
#define ATTRIBUTE_MAX_SIZE (3669)
