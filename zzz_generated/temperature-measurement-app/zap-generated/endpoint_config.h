...
#define GENERATED_ATTRIBUTES                                                                                                       \
    {                                                                                                                              \
        ...
        { 0x0000, ZAP_TYPE(INT16U), 2, ZAP_ATTRIBUTE_MASK(SINGLETON), ZAP_EMPTY_DEFAULT() }, /* InteractionModelVersion */         \
            ...
            { 0x0000, ZAP_TYPE(ARRAY), 833, 0, ZAP_LONG_DEFAULTS_INDEX(798) },  /* NOCs */                                         \
    ...
    {                                                                                                                              \
        { 0x0028,                                                                                                                  \
          ...
          chipFuncArrayBasicServer }, /* Endpoint: 0, Cluster: Basic (server) */                                                   \
            ...
            {                                                                                                                      \
                0x003E, ZAP_ATTRIBUTE_INDEX(34), 7, 1558, ZAP_CLUSTER_MASK(SERVER), NULL                                           \
            }, /* Endpoint: 0, Cluster: Operational Credentials (server) */                                                        \
            {                                                                                                                      \
                0x0402, ZAP_ATTRIBUTE_INDEX(41), 4, 8, ZAP_CLUSTER_MASK(SERVER), NULL                                              \
            }, /* Endpoint: 1, Cluster: Temperature Measurement (server) */                                                        \
    }
...
#define GENERATED_ENDPOINT_TYPES                                                                                                   \
    {                                                                                                                              \
        { ZAP_CLUSTER_INDEX(0), 10, 2389 }, { ZAP_CLUSTER_INDEX(10), 1, 8 },                                                       \
    }
...
#define ATTRIBUTE_MAX_SIZE (2397)
