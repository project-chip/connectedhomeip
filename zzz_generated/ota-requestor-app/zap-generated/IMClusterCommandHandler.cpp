        ...
        case Commands::AnnounceOtaProvider::Id: {
            ...
            if (TLVError == CHIP_NO_ERROR)
            {
                wasHandled = emberAfOtaSoftwareUpdateRequestorClusterAnnounceOtaProviderCallback(
                    apCommandObj, aCommandPath, aCommandPath.mEndpointId, commandData.providerLocation, commandData.vendorId,
                    to_underlying(commandData.announcementReason), commandData.metadataForNode, commandData);
            }
            break;
        }
        default: {
