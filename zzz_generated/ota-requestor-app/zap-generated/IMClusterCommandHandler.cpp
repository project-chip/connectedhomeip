...
void DispatchServerCommand(CommandHandler * apCommandObj, CommandId aCommandId, EndpointId aEndpointId, TLV::TLVReader & aDataTlv)
{
    ...
    bool wasHandled              = false;
    {
        ...
        case Clusters::OtaSoftwareUpdateRequestor::Commands::Ids::AnnounceOtaProvider: {
            ...
            while ((TLVError = aDataTlv.Next()) == CHIP_NO_ERROR)
            {
                ...
                case 1:
                    ...
                    break;
                case 2:
                    TLVUnpackError = aDataTlv.Get(announcementReason);
                    break;
                case 3:
                    TLVUnpackError = aDataTlv.Get(metadataForNode);
                    break;
                default:
                    // Unsupported tag, ignore it.
                    ChipLogProgress(Zcl, "Unknown TLV tag during processing.");
        ...
        default: {
            // Unrecognized command ID, error status will apply.
            ReportCommandUnsupported(apCommandObj, aEndpointId, Clusters::OtaSoftwareUpdateRequestor::Id, aCommandId);
            return;
        }
        }
    }
    ...
    if (CHIP_NO_ERROR != TLVError || CHIP_NO_ERROR != TLVUnpackError || expectArgumentCount != validArgumentCount || !wasHandled)
    {
        CommandPathParams returnStatusParam = { aEndpointId,
                                                0, // GroupId
                                                Clusters::OtaSoftwareUpdateRequestor::Id, aCommandId,
                                                (CommandPathFlags::kEndpointIdValid) };
        apCommandObj->AddStatusCode(returnStatusParam, Protocols::SecureChannel::GeneralStatusCode::kBadRequest,
                                    Protocols::SecureChannel::Id, Protocols::InteractionModel::ProtocolCode::InvalidCommand);
        ChipLogProgress(Zcl,
                                  ...
                                  CommandHandler * apCommandObj)
{
    ...
    case Clusters::OtaSoftwareUpdateRequestor::Id:
        clusters::OtaSoftwareUpdateRequestor::DispatchServerCommand(apCommandObj, aCommandId, aEndPointId, aReader);
        break;
    default:
