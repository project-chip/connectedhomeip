    ...
    {                                                                                                                              \
        { 0x00000003,                                                                                                              \
          ...
          chipFuncArrayIdentifyServer }, /* Endpoint: 0, Cluster: Identify (server) */                                             \
            ...
            {                                                                                                                      \
                0x0000003F, ZAP_ATTRIBUTE_INDEX(168), 3, 510, ZAP_CLUSTER_MASK(SERVER), NULL                                       \
            }, /* Endpoint: 0, Cluster: Group Key Management (server) */                                                           \
            {                                                                                                                      \
            ...
            {                                                                                                                      \
                0x00000003, ZAP_ATTRIBUTE_INDEX(175), 1, 2, ZAP_CLUSTER_MASK(CLIENT), NULL                                         \
            }, /* Endpoint: 1, Cluster: Identify (client) */                                                                       \
            { 0x00000003,                                                                                                          \
...
#define GENERATED_ENDPOINT_TYPES                                                                                                   \
    {                                                                                                                              \
        { ZAP_CLUSTER_INDEX(0), 20, 1994 }, { ZAP_CLUSTER_INDEX(20), 6, 298 },                                                     \
    }
...
#define ATTRIBUTE_MAX_SIZE (2292)
