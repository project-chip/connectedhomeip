    ...
    {                                                                                                                              \
        { 0x00000003,                                                                                                              \
          ...
          chipFuncArrayIdentifyServer }, /* Endpoint: 0, Cluster: Identify (server) */                                             \
            ...
            {                                                                                                                      \
                0x0000002D, ZAP_ATTRIBUTE_INDEX(36), 3, 7, ZAP_CLUSTER_MASK(SERVER), NULL                                          \
            }, /* Endpoint: 0, Cluster: Unit Localization (server) */                                                              \
            {                                                                                                                      \
            ...
            {                                                                                                                      \
                0x00000003, ZAP_ATTRIBUTE_INDEX(179), 0, 0, ZAP_CLUSTER_MASK(CLIENT), NULL                                         \
            }, /* Endpoint: 1, Cluster: Identify (client) */                                                                       \
            { 0x00000003,                                                                                                          \
...
#define GENERATED_ENDPOINT_TYPES                                                                                                   \
    {                                                                                                                              \
<<<<<<< HEAD
        { ZAP_CLUSTER_INDEX(0), 22, 1103 }, { ZAP_CLUSTER_INDEX(22), 6, 89 },                                                      \
=======
        { ZAP_CLUSTER_INDEX(0), 21, 1355 }, { ZAP_CLUSTER_INDEX(21), 6, 89 },                                                      \
>>>>>>> Using responseRef instead of the complicated logic in the template
    }
...
=======
#define ATTRIBUTE_MAX_SIZE (1444)
>>>>>>> Using responseRef instead of the complicated logic in the template
