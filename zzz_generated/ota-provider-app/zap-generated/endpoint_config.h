...
#define GENERATED_ATTRIBUTES                                                                                                       \
    {                                                                                                                              \
        ...
        { 0xFFFD, ZAP_TYPE(INT16U), 2, 0, ZAP_SIMPLE_DEFAULT(0x0001) }, /* ClusterRevision */                                      \
            ...
            { 0x0000, ZAP_TYPE(ARRAY), 833, 0, ZAP_LONG_DEFAULTS_INDEX(0) },    /* NOCs */                                         \
            { 0x0001, ZAP_TYPE(ARRAY), 320, 0, ZAP_LONG_DEFAULTS_INDEX(833) },  /* fabrics list */                                 \
            ...
            { 0x0004, ZAP_TYPE(ARRAY), 400, 0, ZAP_LONG_DEFAULTS_INDEX(1153) }, /* TrustedRootCertificates */                      \
...
#define GENERATED_CLUSTERS                                                                                                         \
    {                                                                                                                              \
        {                                                                                                                          \
            ...
            {                                                                                                                      \
                0x003E, ZAP_ATTRIBUTE_INDEX(1), 7, 1558, ZAP_CLUSTER_MASK(SERVER), NULL                                            \
            }, /* Endpoint: 0, Cluster: Operational Credentials (server) */                                                        \
    }
