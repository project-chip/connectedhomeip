...
#define GENERATED_CLUSTERS                                                                                                         \
    {                                                                                                                              \
        { 0x001D, ZAP_ATTRIBUTE_INDEX(0), 5, 0, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 0, Cluster: Descriptor (server) */  \
            ...
            {                                                                                                                      \
                0x0504, ZAP_ATTRIBUTE_INDEX(169), 2, 256, ZAP_CLUSTER_MASK(SERVER), NULL                                           \
            }, /* Endpoint: 1, Cluster: TV Channel (server) */                                                                     \
            {                                                                                                                      \
                0x0505, ZAP_ATTRIBUTE_INDEX(171), 3, 257, ZAP_CLUSTER_MASK(SERVER), NULL                                           \
            }, /* Endpoint: 1, Cluster: Target Navigator (server) */                                                               \
            {                                                                                                                      \
                0x0507, ZAP_ATTRIBUTE_INDEX(174), 3, 257, ZAP_CLUSTER_MASK(SERVER), NULL                                           \
            }, /* Endpoint: 1, Cluster: Media Input (server) */                                                                    \
            {                                                                                                                      \
                0x0508, ZAP_ATTRIBUTE_INDEX(177), 1, 2, ZAP_CLUSTER_MASK(SERVER), NULL                                             \
            }, /* Endpoint: 1, Cluster: Low Power (server) */                                                                      \
            {                                                                                                                      \
                0x0509, ZAP_ATTRIBUTE_INDEX(178), 1, 2, ZAP_CLUSTER_MASK(SERVER), NULL                                             \
            }, /* Endpoint: 1, Cluster: Keypad Input (server) */                                                                   \
            {                                                                                                                      \
                0x050A, ZAP_ATTRIBUTE_INDEX(179), 3, 260, ZAP_CLUSTER_MASK(SERVER), NULL                                           \
            }, /* Endpoint: 1, Cluster: Content Launcher (server) */                                                               \
            {                                                                                                                      \
                0x050C, ZAP_ATTRIBUTE_INDEX(182), 3, 256, ZAP_CLUSTER_MASK(SERVER), NULL                                           \
            }, /* Endpoint: 1, Cluster: Application Launcher (server) */                                                           \
            { 0x0006,                                                                                                              \
            ...
            {                                                                                                                      \
                0x050B, ZAP_ATTRIBUTE_INDEX(207), 3, 257, ZAP_CLUSTER_MASK(SERVER), NULL                                           \
            }, /* Endpoint: 2, Cluster: Audio Output (server) */                                                                   \
            {                                                                                                                      \
                0x001D, ZAP_ATTRIBUTE_INDEX(210), 5, 0, ZAP_CLUSTER_MASK(SERVER), NULL                                             \
            }, /* Endpoint: 3, Cluster: Descriptor (server) */                                                                     \
            {                                                                                                                      \
                0x0506, ZAP_ATTRIBUTE_INDEX(215), 8, 39, ZAP_CLUSTER_MASK(SERVER), NULL                                            \
            }, /* Endpoint: 3, Cluster: Media Playback (server) */                                                                 \
            {                                                                                                                      \
                0x050A, ZAP_ATTRIBUTE_INDEX(223), 3, 260, ZAP_CLUSTER_MASK(SERVER), NULL                                           \
            }, /* Endpoint: 3, Cluster: Content Launcher (server) */                                                               \
            {                                                                                                                      \
                0x050D, ZAP_ATTRIBUTE_INDEX(226), 7, 106, ZAP_CLUSTER_MASK(SERVER), NULL                                           \
            }, /* Endpoint: 3, Cluster: Application Basic (server) */                                                              \
            {                                                                                                                      \
                0x050E, ZAP_ATTRIBUTE_INDEX(233), 1, 2, ZAP_CLUSTER_MASK(SERVER), NULL                                             \
            }, /* Endpoint: 3, Cluster: Account Login (server) */                                                                  \
            {                                                                                                                      \
                0x001D, ZAP_ATTRIBUTE_INDEX(234), 5, 0, ZAP_CLUSTER_MASK(SERVER), NULL                                             \
            }, /* Endpoint: 4, Cluster: Descriptor (server) */                                                                     \
            {                                                                                                                      \
            ...
            {                                                                                                                      \
                0x050D, ZAP_ATTRIBUTE_INDEX(254), 7, 106, ZAP_CLUSTER_MASK(SERVER), NULL                                           \
            }, /* Endpoint: 5, Cluster: Application Basic (server) */                                                              \
    }
