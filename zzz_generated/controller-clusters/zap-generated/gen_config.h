...
#define EMBER_AF_TIME_SYNC_CLUSTER_CLIENT_ENDPOINT_COUNT (1)
...
// Use this macro to check if the client side of the Time Sync cluster is included
#define ZCL_USING_TIME_SYNC_CLUSTER_CLIENT
