...
void PowerSourceClusterActiveWiredFaultsListAttributeFilter(chip::TLV::TLVReader * data,
                                                            chip::Callback::Cancelable * onSuccessCallback,
                                                            chip::Callback::Cancelable * onFailureCallback);
typedef void (*PowerSourceActiveWiredFaultsListAttributeCallback)(void * context, uint16_t count, uint8_t * entries);
...
void PowerSourceClusterActiveBatteryChargeFaultsListAttributeFilter(chip::TLV::TLVReader * data,
                                                                    chip::Callback::Cancelable * onSuccessCallback,
                                                                    chip::Callback::Cancelable * onFailureCallback);
typedef void (*PowerSourceActiveBatteryChargeFaultsListAttributeCallback)(void * context, uint16_t count, uint8_t * entries);
