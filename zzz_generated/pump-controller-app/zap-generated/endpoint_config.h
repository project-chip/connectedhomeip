...
\
  ...
  { 0x00000001, ZAP_TYPE(CHAR_STRING), 36, ZAP_ATTRIBUTE_MASK(TOKENIZE) | ZAP_ATTRIBUTE_MASK(WRITABLE), ZAP_LONG_DEFAULTS_INDEX(24) }, /* ActiveLocale */  \
...
\
  ...
  { 0x00000007, ZAP_TYPE(INT32S), 4, ZAP_ATTRIBUTE_MASK(NULLABLE), ZAP_LONG_DEFAULTS_INDEX(54) }, /* LastConnectErrorValue */  \
...
\
  ...
  { 0x00000002, ZAP_TYPE(CHAR_STRING), 17, 0, ZAP_LONG_DEFAULTS_INDEX(74) }, /* NetworkName */  \
...
#define GENERATED_ENDPOINT_TYPES { \
  { ZAP_CLUSTER_INDEX(0), 21, 498 }, \
  { ZAP_CLUSTER_INDEX(21), 6, 4 }, \
}
...
#define FIXED_DEVICE_TYPES {{0x0016,1},{0x0304,1}}
