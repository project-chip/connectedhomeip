    ...
    CHIP_ERROR DoTestStep(uint16_t testIndex) override
    {
        ...
        case 2: {
            LogStep(2, "Wait for Add Wifi Network Command");
                ...
                return WaitCommand(                   GetEndpoint(0), NetworkCommissioning::Id, NetworkCommissioning::Commands::AddOrUpdateWiFiNetwork::Id
            );
        }
        case 3: {
            LogStep(3, "Wait for Update Thread Network Command");
                ...
                return WaitCommand(                   GetEndpoint(0), NetworkCommissioning::Id, NetworkCommissioning::Commands::AddOrUpdateThreadNetwork::Id
            );
        }
        case 4: {
    ...
    CHIP_ERROR DoTestStep(uint16_t testIndex) override
    {
        ...
        case 2: {
            LogStep(2, "Wait for Attestation Certificate Chain Request");
                return WaitCommand(                   GetEndpoint(0), OperationalCredentials::Id, OperationalCredentials::Commands::CertificateChainRequest::Id
            );
        }
        case 3: {
        ...
        case 4: {
            LogStep(4, "Wait for Attestation Request");
                return WaitCommand(                   GetEndpoint(0), OperationalCredentials::Id, OperationalCredentials::Commands::AttestationRequest::Id
            );
        }
        case 5: {
        ...
        case 6: {
            LogStep(6, "Wait for Add Trusted Root Certificate Request");
                return WaitCommand(                   GetEndpoint(0), OperationalCredentials::Id, OperationalCredentials::Commands::AddTrustedRootCertificate::Id
            );
        }
        case 7: {
