...
#define GENERATED_ATTRIBUTES                                                                                                       \
    {                                                                                                                              \
        ...
        { ZAP_SIMPLE_DEFAULT(0x00), 0x00000000, 1, ZAP_TYPE(BOOLEAN), 0 },     /* OnOff */                                         \
            ...
            { ZAP_MIN_MAX_DEFAULTS_INDEX(3), 0x00000020, 1, ZAP_TYPE(ENUM8),                                                       \
              ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE) }, /* OperationMode */                                    \
            { ZAP_MIN_MAX_DEFAULTS_INDEX(4), 0x00000021, 1, ZAP_TYPE(ENUM8),                                                       \
            ...
            { ZAP_MIN_MAX_DEFAULTS_INDEX(5), 0x00000011, 2, ZAP_TYPE(INT16S),                                                      \
              ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE) }, /* OccupiedCoolingSetpoint */                          \
            { ZAP_MIN_MAX_DEFAULTS_INDEX(6), 0x00000012, 2, ZAP_TYPE(INT16S),                                                      \
            ...
            { ZAP_MIN_MAX_DEFAULTS_INDEX(16), 0x00000002, 1, ZAP_TYPE(ENUM8),                                                      \
