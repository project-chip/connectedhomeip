...
# e.g.
await devCtrl.WriteAttribute(1, [(1, Clusters.Test.Attributes.Int8u(value=1))])
await devCtrl.WriteAttribute(1, [(1, Clusters.Test.Attributes.Boolean(value=True))])
await devCtrl.WriteAttribute(1, [(1, Clusters.Test.Attributes.OctetString(value=b'123123\x00'))])
await devCtrl.WriteAttribute(1, [(1, Clusters.Test.Attributes.CharString(value='233233'))])
```
