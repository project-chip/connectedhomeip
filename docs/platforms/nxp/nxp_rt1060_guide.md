    ...
    -   [Building](#building)
        ...
        -   [GN Build System](#gn-build-system)
            ...
            -   [Build with Matter over Thread configuration on RT1060 + transceiver](#build-with-matter-over-thread-configuration-on-rt1060--transceiver)
                ...
                -   [Build with Matter over Thread configuration on RT1060-EVK-C + IW610](#build-with-matter-over-thread-configuration-on-rt1060-evk-c--iw610)
                -   [Build with Matter over Wi-Fi + OpenThread Border Router configuration on RT1060-EVK-C + IW610](#build-with-matter-over-wi-fi--openthread-border-router-configuration-on-rt1060-evk-c--iw610)
...
![](../../../examples/platform/nxp/rt/rt1060/doc/images/iw610_2LL.jpg) ![](../../../examples/platform/nxp/rt/rt1060/doc/images/iw610_hw_rework.jpg)
