...
To build the lighting app as an Wi-Fi MG24 + SiWx NCP, the default build
...
> `chip_enable_ble_siwx=true` enables the SiWx NCP bluetooth. The MG24 +
> SiWx NCP combo does not yet support external flash.
