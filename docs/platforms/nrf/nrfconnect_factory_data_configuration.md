...
multiple of one flash page. For nRF52 and nRF53 SoCs, a single flash page equals
4 kB. The nRF54L Series uses RRAM instead of flash, which the nRF Connect SDK
exposes with a 4 kB erase block size, so the same 4 kB alignment applies.
