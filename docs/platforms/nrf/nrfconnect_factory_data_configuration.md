...
|     `sw_ver_str`     |       software version string        |      <1, 64> B       |    uint16    |  optional  |                                                                                                                       A software version string parameter that specifies the version of the software of the device as a more user-friendly value than that presented by the software version integer value. The value meaning and the versioning scheme is defined by the vendor.                                                                                                                       |
