...
- Follow the instructions in this link to build the Matter application:
  https://stash.silabs.com/projects/WMN_TOOLS/repos/matter/browse/docs/silabs/wifi/SW_SETUP.md?at=refs%2Fheads%2Fsilabs_slc_1.0
...
- Flash the bootloader binary for your device along with the application (e.g., lighting , lock, thermostat, window covering, light-switch).
   ...
   https://stash.silabs.com/projects/WMN_TOOLS/repos/matter/browse/docs/silabs/wifi/RUN_DEMO.md
