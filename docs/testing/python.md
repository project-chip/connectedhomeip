...
-   `--pics-override`
    -   Set individual PICS items on top of the `--PICS` file, or in its
        absence, using the PICS file line format, ex
        `--pics-override DGGEN.S.E00=0`. May be repeated.
...
-   PICS
    ...
    -   use --pics-override to set individual PICS items over the PICS file
        values, or in absence of the file
