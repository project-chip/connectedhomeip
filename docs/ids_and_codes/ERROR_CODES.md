...
`python scripts/error_table.py > docs/ids_and_codes/ERROR_CODES.md`. DO NOT EDIT BY HAND!
...
| 52        | 0x34  | `CHIP_ERROR_UNSUPPORTED_DNSSD_SERVICE_NAME`        |
...
| 170       | 0xAA  | `CHIP_ERROR_CASE_WRONG_FABRIC`                     |
...
| 177       | 0xB1  | `CHIP_ERROR_CASE_WRONG_PEER_NODEID`                |
| 178       | 0xB2  | `CHIP_ERROR_CASE_NOCCHAIN_INVALID`                 |
...
| 183       | 0xB7  | `CHIP_ERROR_CASE_SIGMA_DECRYPT_FAILURE`            |
| 184       | 0xB8  | `CHIP_ERROR_CASE_SIGNATURE_MISMATCH`               |
...
| 190       | 0xBE  | `CHIP_ERROR_CASE_RESUME_MIC_MISMATCH`              |
