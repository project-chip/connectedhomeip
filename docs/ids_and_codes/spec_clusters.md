...
| ID (Decimal) | ID (hex) | Name                                                     | PICS Code     |1.0|1.1|1.2|1.3|1.4|1.4.1|1.4.2-mve-1|1.5|0.9-winter-2026|1.6-attempt-1|
|--------------|----------|----------------------------------------------------------|---------------|---|---|---|---|---|-----|-----------|---|---------------|-------------|
...
|1875          |0x0753    |Joint Fabric Administrator                                |JFADMIN        |   |   |   |   |P  |P    |P          |P  |P              |C            |
