...
-   [Matter SDK `CHIP_ERROR` enums values](#matter-sdk-chip_error-enums-values)
    -   [Table of contents](#table-of-contents)
    -   [SDK Core errors](#sdk-core-errors)
    -   [SDK Inet Layer errors](#sdk-inet-layer-errors)
    -   [SDK Device Layer errors](#sdk-device-layer-errors)
    -   [ASN1 Layer errors](#asn1-layer-errors)
    -   [BLE Layer errors](#ble-layer-errors)
    -   [IM Global errors errors](#im-global-errors-errors)
